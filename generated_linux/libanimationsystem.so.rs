...
pub mod AnimationSnapshot_t { // AnimationSnapshotBase_t
    pub const m_nEntIndex: usize = 0x108; // int32_t
...
pub mod CAnimationGroup {
    pub const m_nFlags: usize = 0xC; // uint32_t
    pub const m_name: usize = 0x10; // CBufferString
...
pub mod CBoneMaskUpdateNode { // CBinaryUpdateNode
    pub const m_nWeightListIndex: usize = 0x88; // int32_t
    pub const m_flRootMotionBlend: usize = 0x8C; // float
...
pub mod CDampedPathAnimMotorUpdater { // CPathAnimMotorUpdaterBase
    pub const m_flAnticipationTime: usize = 0x20; // float
    pub const m_flMinSpeedScale: usize = 0x24; // float
    ...
    pub const m_flSpringConstant: usize = 0x2C; // float
    pub const m_flMinSpringTension: usize = 0x30; // float
    pub const m_flMaxSpringTension: usize = 0x34; // float
}
...
pub mod CEnumAnimParameter { // CConcreteAnimParameter
    pub const m_defaultValue: usize = 0x78; // uint8_t
...
pub mod CFloatAnimParameter { // CConcreteAnimParameter
    pub const m_fDefaultValue: usize = 0x70; // float
    pub const m_fMinValue: usize = 0x74; // float
    pub const m_fMaxValue: usize = 0x78; // float
...
pub mod CIntAnimParameter { // CConcreteAnimParameter
    pub const m_defaultValue: usize = 0x70; // int32_t
    pub const m_minValue: usize = 0x74; // int32_t
    pub const m_maxValue: usize = 0x78; // int32_t
}
...
pub mod CJumpHelperUpdateNode { // CSequenceUpdateNode
    ...
    pub const m_flOriginalJumpDuration: usize = 0xB0; // float
    pub const m_flJumpStartCycle: usize = 0xB4; // float
    pub const m_flJumpEndCycle: usize = 0xB8; // float
...
pub mod CMorphSetData {
    pub const m_nWidth: usize = 0xC; // int32_t
    pub const m_nHeight: usize = 0x10; // int32_t
