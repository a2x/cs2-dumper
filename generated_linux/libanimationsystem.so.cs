...
public static class AnimationSnapshot_t { // AnimationSnapshotBase_t
    public const nint m_nEntIndex = 0x108; // int32_t
...
public static class CAnimationGroup {
    public const nint m_nFlags = 0xC; // uint32_t
    public const nint m_name = 0x10; // CBufferString
...
public static class CBoneMaskUpdateNode { // CBinaryUpdateNode
    public const nint m_nWeightListIndex = 0x88; // int32_t
    public const nint m_flRootMotionBlend = 0x8C; // float
...
public static class CDampedPathAnimMotorUpdater { // CPathAnimMotorUpdaterBase
    public const nint m_flAnticipationTime = 0x20; // float
    public const nint m_flMinSpeedScale = 0x24; // float
    ...
    public const nint m_flSpringConstant = 0x2C; // float
    public const nint m_flMinSpringTension = 0x30; // float
    public const nint m_flMaxSpringTension = 0x34; // float
}
...
public static class CEnumAnimParameter { // CConcreteAnimParameter
    public const nint m_defaultValue = 0x78; // uint8_t
...
public static class CFloatAnimParameter { // CConcreteAnimParameter
    public const nint m_fDefaultValue = 0x70; // float
    public const nint m_fMinValue = 0x74; // float
    public const nint m_fMaxValue = 0x78; // float
...
public static class CIntAnimParameter { // CConcreteAnimParameter
    public const nint m_defaultValue = 0x70; // int32_t
    public const nint m_minValue = 0x74; // int32_t
    public const nint m_maxValue = 0x78; // int32_t
}
...
public static class CJumpHelperUpdateNode { // CSequenceUpdateNode
    ...
    public const nint m_flOriginalJumpDuration = 0xB0; // float
    public const nint m_flJumpStartCycle = 0xB4; // float
    public const nint m_flJumpEndCycle = 0xB8; // float
...
public static class CMorphSetData {
    public const nint m_nWidth = 0xC; // int32_t
    public const nint m_nHeight = 0x10; // int32_t
