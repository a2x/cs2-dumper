...
namespace AnimationSnapshot_t { // AnimationSnapshotBase_t
    constexpr std::ptrdiff_t m_nEntIndex = 0x108; // int32_t
...
namespace CAnimationGroup {
    constexpr std::ptrdiff_t m_nFlags = 0xC; // uint32_t
    constexpr std::ptrdiff_t m_name = 0x10; // CBufferString
...
namespace CBoneMaskUpdateNode { // CBinaryUpdateNode
    constexpr std::ptrdiff_t m_nWeightListIndex = 0x88; // int32_t
    constexpr std::ptrdiff_t m_flRootMotionBlend = 0x8C; // float
...
namespace CDampedPathAnimMotorUpdater { // CPathAnimMotorUpdaterBase
    constexpr std::ptrdiff_t m_flAnticipationTime = 0x20; // float
    constexpr std::ptrdiff_t m_flMinSpeedScale = 0x24; // float
    ...
    constexpr std::ptrdiff_t m_flSpringConstant = 0x2C; // float
    constexpr std::ptrdiff_t m_flMinSpringTension = 0x30; // float
    constexpr std::ptrdiff_t m_flMaxSpringTension = 0x34; // float
}
...
namespace CEnumAnimParameter { // CConcreteAnimParameter
    constexpr std::ptrdiff_t m_defaultValue = 0x78; // uint8_t
...
namespace CFloatAnimParameter { // CConcreteAnimParameter
    constexpr std::ptrdiff_t m_fDefaultValue = 0x70; // float
    constexpr std::ptrdiff_t m_fMinValue = 0x74; // float
    constexpr std::ptrdiff_t m_fMaxValue = 0x78; // float
...
namespace CIntAnimParameter { // CConcreteAnimParameter
    constexpr std::ptrdiff_t m_defaultValue = 0x70; // int32_t
    constexpr std::ptrdiff_t m_minValue = 0x74; // int32_t
    constexpr std::ptrdiff_t m_maxValue = 0x78; // int32_t
}
...
namespace CJumpHelperUpdateNode { // CSequenceUpdateNode
    ...
    constexpr std::ptrdiff_t m_flOriginalJumpDuration = 0xB0; // float
    constexpr std::ptrdiff_t m_flJumpStartCycle = 0xB4; // float
    constexpr std::ptrdiff_t m_flJumpEndCycle = 0xB8; // float
...
namespace CMorphSetData {
    constexpr std::ptrdiff_t m_nWidth = 0xC; // int32_t
    constexpr std::ptrdiff_t m_nHeight = 0x10; // int32_t
