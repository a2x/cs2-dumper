...
pattern_map! {
    client => {
        ...
        "dwPlantedC4" => pattern!("488b1d${'} 4885db 74? 488d8b[4] e8[4] 4885c0") => None,
        ...
        "dwSensitivity_sensitivity" => pattern!("4d8d4bu1 490fbae20f 72? 85d2 4c0f4fce eb?") => None,
    ...
    engine2 => {
        ...
        "dwNetworkGameClient_isBackgroundMap" => pattern!("4138b6u4 0f85[4] b91c000000 ff15[4] 4885c0 74? 4533c9 488d15[4]") => None,
    ...
    soundsystem => {
        "dwSoundSystem" => pattern!("488d0d${'} e8[4] 488b0d${'}??? 4c8b82") => None,
