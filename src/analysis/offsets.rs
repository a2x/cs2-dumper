...
pattern_map! {
    client => {
        ...
        "dwPlantedC4" => pattern!("4989ae90110000 4989ae98110000 4c8935${'}") => None,
        ...
        "dwSensitivity" => pattern!("488d0d${[8]'} 660f6ecd") => Some(|_view, map, _rva| {
            // ConVar value float offset (+0x58). Two identical getters exist, so a
            // unique finds_code signature is not available after the 2026-07-09 update.
    ...
    engine2 => {
        ...
        "dwNetworkGameClient_isBackgroundMap" => pattern!("0fb681u4 c3 cccccccccccccccc 0fb681${} c3 cccccccccccccccc 4883ec28") => None,
    ...
    soundsystem => {
        "dwSoundSystem" => pattern!("488d05${'} c3 cccccccccccccccc 4883ec28 488915") => None,
