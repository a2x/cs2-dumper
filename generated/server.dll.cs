...
public static class CCSPlayerPawn {
    public const ulong m_pParachuteServices = 0x16d8;
    public const ulong m_pBulletServices = 0x16e0;
    public const ulong m_pHostageServices = 0x16e8;
    public const ulong m_pBuyServices = 0x16f0;
    public const ulong m_pPingServices = 0x16f8;
    public const ulong m_pRadioServices = 0x1700;
    public const ulong m_pDamageReactServices = 0x1708;
    public const ulong m_iRetakesOffering = 0x17d8;
    public const ulong m_iRetakesOfferingCard = 0x17dc;
    public const ulong m_bRetakesHasDefuseKit = 0x17e0;
    public const ulong m_bRetakesMVPLastRound = 0x17e1;
    public const ulong m_iRetakesMVPBoostItem = 0x17e4;
    public const ulong m_RetakesMVPBoostExtraUtility = 0x17e8;
    public const ulong m_bIsBuyMenuOpen = 0x17ec;
...
public static class CCSPlayerPawnBase {
    ...
    public const ulong m_pIntroCamera = 0x1260;
    public const ulong m_fIntroCamTime = 0x1264;
    public const ulong m_nMyCollisionGroup = 0x1268;
    public const ulong m_bInBombZone = 0x126c;
    public const ulong m_bInBuyZone = 0x126d;
    public const ulong m_bInNoDefuseArea = 0x126e;
    public const ulong m_bKilledByTaser = 0x126f;
    public const ulong m_iMoveState = 0x1270;
    public const ulong m_nPreviousModelIndex = 0x1278;
    public const ulong m_grenadeParameterStashTime = 0x1280;
    public const ulong m_bGrenadeParametersStashed = 0x1284;
    public const ulong m_angStashedShootAngles = 0x1288;
    public const ulong m_vecStashedGrenadeThrowPosition = 0x1294;
    public const ulong m_vecStashedVelocity = 0x12a0;
    public const ulong m_angShootAngleHistory = 0x12ac;
    public const ulong m_vecThrowPositionHistory = 0x12c4;
    public const ulong m_vecVelocityHistory = 0x12dc;
    public const ulong m_nCharacterDefIndex = 0x12f4;
    public const ulong m_bDiedAirborne = 0x12f6;
    public const ulong m_iBombSiteIndex = 0x12f8;
    public const ulong m_nWhichBombZone = 0x12fc;
    public const ulong m_bInBombZoneTrigger = 0x1300;
    public const ulong m_bWasInBombZoneTrigger = 0x1301;
    public const ulong m_bWasInHostageRescueZone = 0x1302;
    public const ulong m_bWasInBuyZone = 0x1303;
    public const ulong m_bInHostageRescueZone = 0x1304;
    public const ulong m_flStamina = 0x1308;
    public const ulong m_iDirection = 0x130c;
    public const ulong m_iShotsFired = 0x1310;
    public const ulong m_ArmorValue = 0x1314;
    public const ulong m_flFlinchStack = 0x1318;
    public const ulong m_flVelocityModifier = 0x131c;
    public const ulong m_flHitHeading = 0x1320;
    public const ulong m_nHitBodyPart = 0x1324;
    public const ulong m_iHostagesKilled = 0x1328;
    public const ulong m_vecTotalBulletForce = 0x132c;
    public const ulong m_flFlashDuration = 0x1338;
    public const ulong m_flFlashMaxAlpha = 0x133c;
    public const ulong m_flProgressBarStartTime = 0x1340;
    public const ulong m_iProgressBarDuration = 0x1344;
    public const ulong m_bWaitForNoAttack = 0x1348;
    public const ulong m_flLowerBodyYawTarget = 0x134c;
    public const ulong m_bStrafing = 0x1350;
    public const ulong m_lastStandingPos = 0x1354;
    public const ulong m_ignoreLadderJumpTime = 0x1360;
    public const ulong m_ladderSurpressionTimer = 0x1368;
    public const ulong m_lastLadderNormal = 0x1380;
    public const ulong m_lastLadderPos = 0x138c;
    public const ulong m_thirdPersonHeading = 0x1398;
    public const ulong m_flSlopeDropOffset = 0x13a4;
    public const ulong m_flSlopeDropHeight = 0x13a8;
    public const ulong m_vHeadConstraintOffset = 0x13ac;
    public const ulong m_iLastWeaponFireUsercmd = 0x13c0;
    public const ulong m_angEyeAngles = 0x13c4;
    public const ulong m_bVCollisionInitted = 0x13d0;
    public const ulong m_storedSpawnPosition = 0x13d4;
    public const ulong m_storedSpawnAngle = 0x13e0;
    public const ulong m_bIsSpawning = 0x13ec;
    public const ulong m_bHideTargetID = 0x13ed;
    public const ulong m_nNumDangerZoneDamageHits = 0x13f0;
    public const ulong m_bHud_MiniScoreHidden = 0x13f4;
    public const ulong m_bHud_RadarHidden = 0x13f5;
    public const ulong m_nLastKillerIndex = 0x13f8;
    public const ulong m_nLastConcurrentKilled = 0x13fc;
    public const ulong m_nDeathCamMusic = 0x1400;
    public const ulong m_iAddonBits = 0x1404;
    public const ulong m_iPrimaryAddon = 0x1408;
    public const ulong m_iSecondaryAddon = 0x140c;
    public const ulong m_nTeamDamageGivenForMatch = 0x1410;
    public const ulong m_bTDGaveProtectionWarning = 0x1414;
    public const ulong m_bTDGaveProtectionWarningThisRound = 0x1415;
    public const ulong m_flLastTHWarningTime = 0x1418;
    public const ulong m_currentDeafnessFilter = 0x141c;
    public const ulong m_enemyPlayersKilledThisRound = 0x1420;
    public const ulong m_NumEnemiesKilledThisSpawn = 0x1438;
    public const ulong m_maxNumEnemiesKillStreak = 0x143c;
    public const ulong m_NumEnemiesKilledThisRound = 0x1440;
    public const ulong m_NumEnemiesAtRoundStart = 0x1444;
    public const ulong m_iRoundsWon = 0x1448;
    public const ulong m_lastRoundResult = 0x144c;
    public const ulong m_wasNotKilledNaturally = 0x1450;
    public const ulong m_vecPlayerPatchEconIndices = 0x1454;
    public const ulong m_iDeathFlags = 0x1468;
    public const ulong m_hPet = 0x146c;
    public const ulong m_unCurrentEquipmentValue = 0x1638;
    public const ulong m_unRoundStartEquipmentValue = 0x163a;
    public const ulong m_unFreezetimeEndEquipmentValue = 0x163c;
    public const ulong m_szLastPlaceName = 0x163e;
    public const ulong m_nSuicides = 0x1650;
    public const ulong m_nSurvivalTeamNumber = 0x1654;
    public const ulong m_aimPunchAngle = 0x1658;
    public const ulong m_aimPunchAngleVel = 0x1664;
    public const ulong m_aimPunchTickBase = 0x1670;
    public const ulong m_aimPunchTickFraction = 0x1674;
    public const ulong m_aimPunchCache = 0x1678;
    public const ulong m_bHasDeathInfo = 0x1690;
    public const ulong m_flDeathInfoTime = 0x1694;
    public const ulong m_vecDeathInfoOrigin = 0x1698;
    public const ulong m_bKilledByHeadshot = 0x16a4;
    public const ulong m_LastHitBox = 0x16a8;
    public const ulong m_LastHealth = 0x16ac;
    public const ulong m_flLastCollisionCeiling = 0x16b0;
    public const ulong m_flLastCollisionCeilingChangeTime = 0x16b4;
    public const ulong m_strVOPrefix = 0x16b8;
    public const ulong m_flLandseconds = 0x16c0;
    public const ulong m_pBot = 0x16c8;
    public const ulong m_bBotAllowActive = 0x16d0;
...
public static class CPointCamera {
    ...
    public const ulong m_bDofEnabled = 0x4e4;
