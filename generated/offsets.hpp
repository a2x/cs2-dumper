...
namespace client_dll { // client.dll
    constexpr std::ptrdiff_t dwEntityList = 0x17B0D00;
    ...
    constexpr std::ptrdiff_t dwGameEntitySystem = 0x18DC3E0;
    constexpr std::ptrdiff_t dwGameEntitySystem_getHighestEntityIndex = 0x1510;
    constexpr std::ptrdiff_t dwGameRules = 0x180C9B0;
    constexpr std::ptrdiff_t dwGlobalVars = 0x16B14F0;
    constexpr std::ptrdiff_t dwGlowManager = 0x180C9D8;
    constexpr std::ptrdiff_t dwInterfaceLinkList = 0x190A078;
    constexpr std::ptrdiff_t dwLocalPlayerController = 0x1800018;
    constexpr std::ptrdiff_t dwLocalPlayerPawn = 0x16BC4B8;
    constexpr std::ptrdiff_t dwPlantedC4 = 0x1813F78;
    constexpr std::ptrdiff_t dwPrediction = 0x16BC380;
    constexpr std::ptrdiff_t dwSensitivity = 0x180DF68;
    constexpr std::ptrdiff_t dwSensitivity_sensitivity = 0x40;
    constexpr std::ptrdiff_t dwViewAngles = 0x186FFC0;
    constexpr std::ptrdiff_t dwViewMatrix = 0x180F340;
    constexpr std::ptrdiff_t dwViewRender = 0x180FBC0;
}
