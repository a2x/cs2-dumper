public static class CBaseRendererSource2 {
    ...
    public const nint m_nLightingControlPoint = 0x1208; // int32
    ...
    public const nint m_nHSVShiftControlPoint = 0x1620; // int32
    ...
    public const nint m_nRefractBlurRadius = 0x1CF8; // int32
    ...
    public const nint m_flDepthBias = 0x2218; // float32
...
public static class CBaseTrailRenderer {
    ...
    public const nint m_nOrientationControlPoint = 0x2474; // int32
    public const nint m_flMinSize = 0x2478; // float32
    public const nint m_flMaxSize = 0x247C; // float32
...
public static class C_INIT_InitSkinnedPositionFromCPSnapshot {
    ...
    public const nint m_nFullLoopIncrement = 0x1E0; // int32
    public const nint m_nSnapShotStartPoint = 0x1E4; // int32
    public const nint m_flBoneVelocity = 0x1E8; // float32
    public const nint m_flBoneVelocityMax = 0x1EC; // float32
...
public static class C_OP_ControlpointLight {
    public const nint m_flScale = 0x1C0; // float32
    public const nint m_nControlPoint1 = 0x690; // int32
    public const nint m_nControlPoint2 = 0x694; // int32
    public const nint m_nControlPoint3 = 0x698; // int32
    public const nint m_nControlPoint4 = 0x69C; // int32
    ...
    public const nint m_LightFiftyDist1 = 0x6D0; // float32
    public const nint m_LightZeroDist1 = 0x6D4; // float32
    public const nint m_LightFiftyDist2 = 0x6D8; // float32
    public const nint m_LightZeroDist2 = 0x6DC; // float32
    public const nint m_LightFiftyDist3 = 0x6E0; // float32
    public const nint m_LightZeroDist3 = 0x6E4; // float32
    public const nint m_LightFiftyDist4 = 0x6E8; // float32
    public const nint m_LightZeroDist4 = 0x6EC; // float32
...
public static class C_OP_RenderModels {
    ...
    public const nint m_flAnimationRate = 0x154C; // float32
    ...
    public const nint m_nLOD = 0x1948; // int32
...
public static class C_OP_RenderProjected {
    ...
    public const nint m_flAnimationTimeScale = 0x218; // float32
...
public static class C_OP_RenderRopes {
    ...
    public const nint m_flMinSize = 0x2474; // float32
    public const nint m_flMaxSize = 0x2478; // float32
    public const nint m_flStartFadeSize = 0x247C; // float32
    public const nint m_flEndFadeSize = 0x2480; // float32
    public const nint m_flStartFadeDot = 0x2484; // float32
    public const nint m_flEndFadeDot = 0x2488; // float32
    public const nint m_flRadiusTaper = 0x248C; // float32
    public const nint m_nMinTesselation = 0x2490; // int32
    public const nint m_nMaxTesselation = 0x2494; // int32
    public const nint m_flTessScale = 0x2498; // float32
    ...
    public const nint m_nTextureVParamsCP = 0x28A8; // int32
    public const nint m_bClampV = 0x28AC; // bool
    public const nint m_nScaleCP1 = 0x28B0; // int32
    public const nint m_nScaleCP2 = 0x28B4; // int32
    public const nint m_flScaleVSizeByControlPointDistance = 0x28B8; // float32
    public const nint m_flScaleVScrollByControlPointDistance = 0x28BC; // float32
    public const nint m_flScaleVOffsetByControlPointDistance = 0x28C0; // float32
    ...
    public const nint m_flScalarAttributeTextureCoordScale = 0x28CC; // float32
...
public static class C_OP_RenderSprites {
    ...
    public const nint m_nOrientationControlPoint = 0x25CC; // int32
    public const nint m_bUseYawWithNormalAligned = 0x25D0; // bool
    public const nint m_flMinSize = 0x25D4; // float32
    public const nint m_flMaxSize = 0x25D8; // float32
    public const nint m_flAlphaAdjustWithSizeAdjust = 0x25DC; // float32
    ...
    public const nint m_flStartFadeDot = 0x2890; // float32
    public const nint m_flEndFadeDot = 0x2894; // float32
    public const nint m_bDistanceAlpha = 0x2898; // bool
    public const nint m_bSoftEdges = 0x2899; // bool
    public const nint m_flEdgeSoftnessStart = 0x289C; // float32
    public const nint m_flEdgeSoftnessEnd = 0x28A0; // float32
    public const nint m_bOutline = 0x28A4; // bool
    public const nint m_OutlineColor = 0x28A5; // Color
    public const nint m_nOutlineAlpha = 0x28AC; // int32
    public const nint m_flOutlineStart0 = 0x28B0; // float32
    public const nint m_flOutlineStart1 = 0x28B4; // float32
    public const nint m_flOutlineEnd0 = 0x28B8; // float32
    public const nint m_flOutlineEnd1 = 0x28BC; // float32
    ...
    public const nint m_flShadowDensity = 0x2B7C; // float32
}
...
public static class C_OP_RenderTrails {
    ...
    public const nint m_flStartFadeDot = 0x2744; // float32
    public const nint m_flEndFadeDot = 0x2748; // float32
    public const nint m_nPrevPntSource = 0x274C; // ParticleAttributeIndex_t
    public const nint m_flMaxLength = 0x2750; // float32
    public const nint m_flMinLength = 0x2754; // float32
    public const nint m_bIgnoreDT = 0x2758; // bool
    public const nint m_flConstrainRadiusToLengthRatio = 0x275C; // float32
    public const nint m_flLengthScale = 0x2760; // float32
    public const nint m_flLengthFadeInTime = 0x2764; // float32
    ...
    public const nint m_flForwardShift = 0x3980; // float32
