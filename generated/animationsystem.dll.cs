...
public static class CAudioAnimTag {
    ...
    public const nint m_flVolume = 0x48; // float32
...
public static class CBodyGroupAnimTag {
    public const nint m_nPriority = 0x38; // int32
...
public static class CClothSettingsAnimTag {
    public const nint m_flStiffness = 0x38; // float32
    public const nint m_flEaseIn = 0x3C; // float32
    public const nint m_flEaseOut = 0x40; // float32
...
public static class CEnumAnimParameter {
    public const nint m_defaultValue = 0x68; // uint8
...
public static class CFingerBone {
    ...
    public const nint m_flMinAngle = 0x2C; // float32
    public const nint m_flMaxAngle = 0x30; // float32
    public const nint m_flRadius = 0x34; // float32
}
...
public static class CFingerChain {
    ...
    public const nint m_flSplayMinAngle = 0x64; // float32
    public const nint m_flSplayMaxAngle = 0x68; // float32
    public const nint m_flFingerScaleRatio = 0x6C; // float32
}

public static class CFingerSource {
    public const nint m_nFingerIndex = 0x0; // AnimVRFinger_t
    public const nint m_flFingerWeight = 0x4; // float32
}
...
public static class CFloatAnimParameter {
    public const nint m_fDefaultValue = 0x60; // float32
    public const nint m_fMinValue = 0x64; // float32
    public const nint m_fMaxValue = 0x68; // float32
...
public static class CIntAnimParameter {
    public const nint m_defaultValue = 0x60; // int32
    public const nint m_minValue = 0x64; // int32
    public const nint m_maxValue = 0x68; // int32
}
...
public static class CMaterialAttributeAnimTag {
    ...
    public const nint m_flValue = 0x44; // float32
...
public static class CMovementComponentUpdater {
    ...
    public const nint m_nDefaultMotorIndex = 0x7C; // int32
...
public static class CRagdollAnimTag {
    ...
    public const nint m_flFrequency = 0x3C; // float32
    public const nint m_flDampingRatio = 0x40; // float32
    public const nint m_flDecayDuration = 0x44; // float32
    public const nint m_flDecayBias = 0x48; // float32
...
public static class CSeqS1SeqDesc {
    ...
    public const nint m_nLocalWeightlist = 0x88; // int32
...
public static class FingerBone_t {
    ...
    public const nint m_flMinAngle = 0x28; // float32
    public const nint m_flMaxAngle = 0x2C; // float32
...
public static class FingerChain_t {
    ...
    public const nint m_tipParentBoneIndex = 0x48; // int32
    public const nint m_metacarpalBoneIndex = 0x4C; // int32
    public const nint m_flSplayMinAngle = 0x50; // float32
    public const nint m_flSplayMaxAngle = 0x54; // float32
    public const nint m_flFingerScaleRatio = 0x58; // float32
}
...
public static class SkeletalInputOpFixedSettings_t {
    ...
    public const nint m_outerKnuckle1 = 0x30; // int32
    public const nint m_outerKnuckle2 = 0x34; // int32
...
public static class WristBone_t {
    ...
    public const nint m_boneIndex = 0x20; // int32
}