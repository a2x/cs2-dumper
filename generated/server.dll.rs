...
pub mod CAISound {
    pub const m_iSoundType: usize = 0x4B0; // int32
    pub const m_iSoundContext: usize = 0x4B4; // int32
    pub const m_iVolume: usize = 0x4B8; // int32
    pub const m_iSoundIndex: usize = 0x4BC; // int32
...
pub mod CAI_ChangeHintGroup {
    pub const m_iSearchType: usize = 0x4B0; // int32
...
pub mod CAmbientGeneric {
    pub const m_radius: usize = 0x4B0; // float32
    pub const m_flMaxRadius: usize = 0x4B4; // float32
...
pub mod CAnimGraphTagRef {
    pub const m_nTagIndex: usize = 0x0; // int32
...
pub mod CBarnLight {
    ...
    pub const m_nColorMode: usize = 0x704; // int32
    pub const m_Color: usize = 0x708; // Color
    pub const m_flColorTemperature: usize = 0x70C; // float32
    pub const m_flBrightness: usize = 0x710; // float32
    pub const m_flBrightnessScale: usize = 0x714; // float32
    pub const m_nDirectLight: usize = 0x718; // int32
    pub const m_nBakedShadowIndex: usize = 0x71C; // int32
    pub const m_nLuminaireShape: usize = 0x720; // int32
    pub const m_flLuminaireSize: usize = 0x724; // float32
    pub const m_flLuminaireAnisotropy: usize = 0x728; // float32
    ...
    pub const m_StyleRadianceVar: usize = 0x828; // CUtlString
    pub const m_StyleVar: usize = 0x830; // CUtlString
...
pub mod CBaseAnimGraph {
    ...
    pub const m_flMaxSlopeDistance: usize = 0x714; // float32
    ...
    pub const m_nForceBone: usize = 0x734; // int32
...
pub mod CBaseAnimGraphController {
    ...
    pub const m_flLastEventCycle: usize = 0x21C; // float32
    pub const m_flLastEventAnimTime: usize = 0x220; // float32
    pub const m_flPlaybackRate: usize = 0x224; // CNetworkedQuantizedFloat
    pub const m_flPrevAnimTime: usize = 0x22C; // float32
    pub const m_bClientSideAnimation: usize = 0x230; // bool
    pub const m_bNetworkedAnimationInputsChanged: usize = 0x231; // bool
    pub const m_nNewSequenceParity: usize = 0x234; // int32
    pub const m_nResetEventsParity: usize = 0x238; // int32
...
pub mod CBaseButton {
    ...
    pub const m_nState: usize = 0x8A0; // int32
...
pub mod CBaseCSGrenade {
    ...
    pub const m_flThrowStrength: usize = 0xE04; // float32
    pub const m_flThrowStrengthApproach: usize = 0xE08; // float32
...
pub mod CBaseCSGrenadeProjectile {
    ...
    pub const m_nBounces: usize = 0x9D4; // int32
    pub const m_nExplodeEffectIndex: usize = 0x9D8; // CStrongHandle< InfoForResourceTypeIParticleSystemDefinition >
    pub const m_nExplodeEffectTickBegin: usize = 0x9E0; // int32
    pub const m_vecExplodeEffectOrigin: usize = 0x9E4; // Vector
    pub const m_unOGSExtraFlags: usize = 0x9F0; // uint8
    pub const m_bDetonationRecorded: usize = 0x9F1; // bool
    pub const m_flDetonateTime: usize = 0x9F4; // GameTime_t
    pub const m_nItemIndex: usize = 0x9F8; // uint16
    pub const m_vecOriginalSpawnLocation: usize = 0x9FC; // Vector
    pub const m_flLastBounceSoundTime: usize = 0xA08; // GameTime_t
    pub const m_vecGrenadeSpin: usize = 0xA0C; // RotationVector
    pub const m_vecLastHitSurfaceNormal: usize = 0xA18; // Vector
    pub const m_nTicksAtZeroVelocity: usize = 0xA24; // int32
}
...
pub mod CBaseCombatCharacter {
    ...
    pub const m_flFieldOfView: usize = 0x940; // float32
    pub const m_impactEnergyScale: usize = 0x944; // float32
    pub const m_LastHitGroup: usize = 0x948; // HitGroup_t
    pub const m_bApplyStressDamage: usize = 0x94C; // bool
    pub const m_bloodColor: usize = 0x950; // int32
    pub const m_navMeshID: usize = 0x9B0; // int32
    pub const m_iDamageCount: usize = 0x9B4; // int32
    ...
    pub const m_nNavHullIdx: usize = 0x9CC; // uint32
}
...
pub mod CBaseEntity {
    ...
    pub const m_iCurrentThinkContext: usize = 0x240; // int32
    ...
    pub const m_nWaterTouch: usize = 0x2C3; // uint8
    pub const m_nSlimeTouch: usize = 0x2C4; // uint8
    pub const m_bRestoreInHierarchy: usize = 0x2C5; // bool
    pub const m_target: usize = 0x2C8; // CUtlSymbolLarge
    pub const m_flMoveDoneTime: usize = 0x2D0; // float32
    ...
    pub const m_flAnimTime: usize = 0x2F0; // float32
    pub const m_flSimulationTime: usize = 0x2F4; // float32
    pub const m_flCreateTime: usize = 0x2F8; // GameTime_t
    pub const m_bClientSideRagdoll: usize = 0x2FC; // bool
    pub const m_ubInterpolationFrame: usize = 0x2FD; // uint8
    pub const m_vPrevVPhysicsUpdatePos: usize = 0x300; // Vector
    pub const m_iTeamNum: usize = 0x30C; // uint8
    pub const m_iGlobalname: usize = 0x310; // CUtlSymbolLarge
    pub const m_iSentToClients: usize = 0x318; // int32
    pub const m_flSpeed: usize = 0x31C; // float32
    pub const m_sUniqueHammerID: usize = 0x320; // CUtlString
    pub const m_spawnflags: usize = 0x328; // uint32
    pub const m_nNextThinkTick: usize = 0x32C; // GameTick_t
    pub const m_nSimulationTick: usize = 0x330; // int32
    pub const m_OnKilled: usize = 0x338; // CEntityIOOutput
    pub const m_fFlags: usize = 0x360; // uint32
    ...
    pub const m_nPushEnumCount: usize = 0x3AC; // int32
    ...
    pub const m_fEffects: usize = 0x3C0; // uint32
    pub const m_hGroundEntity: usize = 0x3C4; // CHandle< CBaseEntity >
    pub const m_flFriction: usize = 0x3C8; // float32
    pub const m_flElasticity: usize = 0x3CC; // float32
    pub const m_flGravityScale: usize = 0x3D0; // float32
    pub const m_flTimeScale: usize = 0x3D4; // float32
    pub const m_flWaterLevel: usize = 0x3D8; // float32
    ...
    pub const m_nWaterType: usize = 0x3DF; // uint8
    pub const m_iEFlags: usize = 0x3E0; // int32
    ...
    pub const m_iInitialTeamNum: usize = 0x488; // int32
    ...
    pub const m_flOverriddenFriction: usize = 0x4A0; // float32
    pub const m_pBlocker: usize = 0x4A4; // CHandle< CBaseEntity >
    pub const m_flLocalTime: usize = 0x4A8; // float32
    pub const m_flVPhysicsUpdateLocalTime: usize = 0x4AC; // float32
}
...
pub mod CBaseFire {
    pub const m_flScale: usize = 0x4B0; // float32
    pub const m_flStartScale: usize = 0x4B4; // float32
    pub const m_flScaleTime: usize = 0x4B8; // float32
    pub const m_nFlags: usize = 0x4BC; // uint32
}
...
pub mod CBaseFlex {
    ...
    pub const m_nNextSceneEventId: usize = 0x910; // uint32
...
pub mod CBaseModelEntity {
    ...
    pub const m_LightGroup: usize = 0x568; // CUtlStringToken
    pub const m_bRenderToCubemaps: usize = 0x56C; // bool
    pub const m_Collision: usize = 0x570; // CCollisionProperty
    pub const m_Glow: usize = 0x620; // CGlowProperty
    pub const m_flGlowBackfaceMult: usize = 0x678; // float32
    pub const m_fadeMinDist: usize = 0x67C; // float32
    pub const m_fadeMaxDist: usize = 0x680; // float32
    pub const m_flFadeScale: usize = 0x684; // float32
    pub const m_flShadowStrength: usize = 0x688; // float32
    pub const m_nObjectCulling: usize = 0x68C; // uint8
    pub const m_nAddDecal: usize = 0x690; // int32
    pub const m_vDecalPosition: usize = 0x694; // Vector
    pub const m_vDecalForwardAxis: usize = 0x6A0; // Vector
    pub const m_flDecalHealBloodRate: usize = 0x6AC; // float32
    pub const m_flDecalHealHeightRate: usize = 0x6B0; // float32
...
pub mod CBaseMoveBehavior {
    pub const m_iPositionInterpolator: usize = 0x510; // int32
    pub const m_iRotationInterpolator: usize = 0x514; // int32
    pub const m_flAnimStartTime: usize = 0x518; // float32
    pub const m_flAnimEndTime: usize = 0x51C; // float32
    pub const m_flAverageSpeedAcrossFrame: usize = 0x520; // float32
    ...
    pub const m_flTimeIntoFrame: usize = 0x548; // float32
    pub const m_iDirection: usize = 0x54C; // int32
}
...
pub mod CBasePlatTrain {
    ...
    pub const m_volume: usize = 0x798; // float32
    pub const m_flTWidth: usize = 0x79C; // float32
    pub const m_flTLength: usize = 0x7A0; // float32
}

pub mod CBasePlayerController {
    pub const m_nInButtonsWhichAreToggles: usize = 0x4B8; // uint64
    pub const m_nTickBase: usize = 0x4C0; // uint32
    ...
    pub const m_nHighestCommandNumberReceived: usize = 0x628; // int32
    pub const m_nUsecTimestampLastUserCmdReceived: usize = 0x630; // int64
    pub const m_iIgnoreGlobalChat: usize = 0x648; // ChatIgnoreType_t
    pub const m_flLastPlayerTalkTime: usize = 0x64C; // float32
    pub const m_flLastEntitySteadyState: usize = 0x650; // float32
    pub const m_nAvailableEntitySteadyState: usize = 0x654; // int32
    pub const m_bHasAnySteadyStateEnts: usize = 0x658; // bool
    pub const m_steamID: usize = 0x668; // uint64
    pub const m_iDesiredFOV: usize = 0x670; // uint32
}
...
pub mod CBasePlayerPawn {
    ...
    pub const m_nHighestGeneratedServerViewAngleChangeIndex: usize = 0xA70; // uint32
    pub const v_angle: usize = 0xA74; // QAngle
    pub const v_anglePrevious: usize = 0xA80; // QAngle
    pub const m_iHideHUD: usize = 0xA8C; // uint32
    ...
    pub const m_fHltvReplayDelay: usize = 0xB40; // float32
    pub const m_fHltvReplayEnd: usize = 0xB44; // float32
...
pub mod CBasePlayerWeapon {
    ...
    pub const m_flNextPrimaryAttackTickRatio: usize = 0xC1C; // float32
    pub const m_nNextSecondaryAttackTick: usize = 0xC20; // GameTick_t
    pub const m_flNextSecondaryAttackTickRatio: usize = 0xC24; // float32
    pub const m_iClip1: usize = 0xC28; // int32
    pub const m_iClip2: usize = 0xC2C; // int32
...
pub mod CBaseProp {
    ...
    pub const m_iShapeType: usize = 0x894; // int32
...
pub mod CBasePropDoor {
    pub const m_flAutoReturnDelay: usize = 0xB18; // float32
    pub const m_hDoorList: usize = 0xB20; // CUtlVector< CHandle< CBasePropDoor > >
    pub const m_nHardwareType: usize = 0xB38; // int32
    ...
    pub const m_numCloseAttempts: usize = 0xBF0; // int32
...
pub mod CBaseToggle {
    ...
    pub const m_flMoveDistance: usize = 0x704; // float32
    pub const m_flWait: usize = 0x708; // float32
    pub const m_flLip: usize = 0x70C; // float32
    ...
    pub const m_flHeight: usize = 0x750; // float32
    ...
    pub const m_movementType: usize = 0x770; // int32
...
pub mod CBaseViewModel {
    ...
    pub const m_nViewModelIndex: usize = 0x8A4; // uint32
    pub const m_nAnimationParity: usize = 0x8A8; // uint32
    pub const m_flAnimationStartTime: usize = 0x8AC; // float32
    ...
    pub const m_oldLayer: usize = 0x8CC; // int32
    pub const m_oldLayerStartTime: usize = 0x8D0; // float32
    pub const m_hControlPanel: usize = 0x8D4; // CHandle< CBaseEntity >
}

pub mod CBeam {
    pub const m_flFrameRate: usize = 0x700; // float32
    pub const m_flHDRColorScale: usize = 0x704; // float32
    pub const m_flFireTime: usize = 0x708; // GameTime_t
    pub const m_flDamage: usize = 0x70C; // float32
    pub const m_nNumBeamEnts: usize = 0x710; // uint8
    ...
    pub const m_nBeamFlags: usize = 0x72C; // uint32
    pub const m_hAttachEntity: usize = 0x730; // CHandle< CBaseEntity >[10]
    pub const m_nAttachIndex: usize = 0x758; // AttachmentHandle_t[10]
    pub const m_fWidth: usize = 0x764; // float32
    pub const m_fEndWidth: usize = 0x768; // float32
    pub const m_fFadeLength: usize = 0x76C; // float32
    pub const m_fHaloScale: usize = 0x770; // float32
    pub const m_fAmplitude: usize = 0x774; // float32
    pub const m_fStartFrame: usize = 0x778; // float32
    pub const m_fSpeed: usize = 0x77C; // float32
    pub const m_flFrame: usize = 0x780; // float32
    ...
    pub const m_nDissolveType: usize = 0x79C; // int32
}

pub mod CBlood {
    pub const m_vecSprayAngles: usize = 0x4B0; // QAngle
    pub const m_vecSprayDir: usize = 0x4BC; // Vector
    pub const m_flAmount: usize = 0x4C8; // float32
    pub const m_Color: usize = 0x4CC; // int32
}
...
pub mod CBombTarget {
    ...
    pub const m_nBombSiteDesignation: usize = 0x934; // int32
}
...
pub mod CBot {
    ...
    pub const m_isRunning: usize = 0x98; // bool
    pub const m_isCrouching: usize = 0x99; // bool
    pub const m_forwardSpeed: usize = 0x9C; // float32
    pub const m_leftSpeed: usize = 0xA0; // float32
    pub const m_verticalSpeed: usize = 0xA4; // float32
    pub const m_buttonFlags: usize = 0xA8; // uint64
    pub const m_jumpTimestamp: usize = 0xB0; // float32
    pub const m_viewForward: usize = 0xB4; // Vector
    pub const m_postureStackIndex: usize = 0xD0; // int32
}
...
pub mod CBreakable {
    ...
    pub const m_flPressureDelay: usize = 0x728; // float32
    pub const m_iMinHealthDmg: usize = 0x72C; // int32
    pub const m_iszPropData: usize = 0x730; // CUtlSymbolLarge
    pub const m_impactEnergyScale: usize = 0x738; // float32
    ...
    pub const m_flDmgModBullet: usize = 0x790; // float32
    pub const m_flDmgModClub: usize = 0x794; // float32
    pub const m_flDmgModExplosive: usize = 0x798; // float32
    pub const m_flDmgModFire: usize = 0x79C; // float32
    pub const m_iszPhysicsDamageTableName: usize = 0x7A0; // CUtlSymbolLarge
    pub const m_iszBasePropData: usize = 0x7A8; // CUtlSymbolLarge
    pub const m_iInteractions: usize = 0x7B0; // int32
...
pub mod CBreakableProp {
    ...
    pub const m_impactEnergyScale: usize = 0x958; // float32
    pub const m_iMinHealthDmg: usize = 0x95C; // int32
    pub const m_preferredCarryAngles: usize = 0x960; // QAngle
    pub const m_flPressureDelay: usize = 0x96C; // float32
    pub const m_hBreaker: usize = 0x970; // CHandle< CBaseEntity >
    pub const m_PerformanceMode: usize = 0x974; // PerformanceMode_t
    pub const m_flDmgModBullet: usize = 0x978; // float32
    pub const m_flDmgModClub: usize = 0x97C; // float32
    pub const m_flDmgModExplosive: usize = 0x980; // float32
    pub const m_flDmgModFire: usize = 0x984; // float32
    pub const m_iszPhysicsDamageTableName: usize = 0x988; // CUtlSymbolLarge
    pub const m_iszBasePropData: usize = 0x990; // CUtlSymbolLarge
    pub const m_iInteractions: usize = 0x998; // int32
    pub const m_flPreventDamageBeforeTime: usize = 0x99C; // GameTime_t
    pub const m_bHasBreakPiecesOrCommands: usize = 0x9A0; // bool
    pub const m_explodeDamage: usize = 0x9A4; // float32
    pub const m_explodeRadius: usize = 0x9A8; // float32
    pub const m_explosionDelay: usize = 0x9B0; // float32
    ...
    pub const m_flDefaultFadeScale: usize = 0x9E4; // float32
...
pub mod CBubbling {
    pub const m_density: usize = 0x700; // int32
    pub const m_frequency: usize = 0x704; // int32
    pub const m_state: usize = 0x708; // int32
}
...
pub mod CBuyZone {
    pub const m_LegacyTeamNum: usize = 0x8A8; // int32
}
...
pub mod CC4 {
    ...
    pub const m_nSpotRules: usize = 0xE18; // int32
...
pub mod CCSBot {
    pub const m_lastCoopSpawnPoint: usize = 0xD8; // CHandle< SpawnPointCoopEnemy >
    pub const m_eyePosition: usize = 0xE8; // Vector
    pub const m_name: usize = 0xF4; // char[64]
    pub const m_combatRange: usize = 0x134; // float32
    pub const m_isRogue: usize = 0x138; // bool
    pub const m_rogueTimer: usize = 0x140; // CountdownTimer
    pub const m_diedLastRound: usize = 0x15C; // bool
    pub const m_safeTime: usize = 0x160; // float32
    pub const m_wasSafe: usize = 0x164; // bool
    pub const m_blindFire: usize = 0x16C; // bool
    pub const m_surpriseTimer: usize = 0x170; // CountdownTimer
    pub const m_bAllowActive: usize = 0x188; // bool
    pub const m_isFollowing: usize = 0x189; // bool
    pub const m_leader: usize = 0x18C; // CHandle< CCSPlayerPawn >
    pub const m_followTimestamp: usize = 0x190; // float32
    pub const m_allowAutoFollowTime: usize = 0x194; // float32
    pub const m_hurryTimer: usize = 0x198; // CountdownTimer
    pub const m_alertTimer: usize = 0x1B0; // CountdownTimer
    pub const m_sneakTimer: usize = 0x1C8; // CountdownTimer
    pub const m_panicTimer: usize = 0x1E0; // CountdownTimer
    pub const m_stateTimestamp: usize = 0x4B0; // float32
    pub const m_isAttacking: usize = 0x4B4; // bool
    pub const m_isOpeningDoor: usize = 0x4B5; // bool
    pub const m_taskEntity: usize = 0x4BC; // CHandle< CBaseEntity >
    pub const m_goalPosition: usize = 0x4CC; // Vector
    pub const m_goalEntity: usize = 0x4D8; // CHandle< CBaseEntity >
    pub const m_avoid: usize = 0x4DC; // CHandle< CBaseEntity >
    pub const m_avoidTimestamp: usize = 0x4E0; // float32
    pub const m_isStopping: usize = 0x4E4; // bool
    pub const m_hasVisitedEnemySpawn: usize = 0x4E5; // bool
    pub const m_stillTimer: usize = 0x4E8; // IntervalTimer
    pub const m_bEyeAnglesUnderPathFinderControl: usize = 0x4F8; // bool
    pub const m_pathIndex: usize = 0x65F0; // int32
    pub const m_areaEnteredTimestamp: usize = 0x65F4; // GameTime_t
    pub const m_repathTimer: usize = 0x65F8; // CountdownTimer
    pub const m_avoidFriendTimer: usize = 0x6610; // CountdownTimer
    pub const m_isFriendInTheWay: usize = 0x6628; // bool
    pub const m_politeTimer: usize = 0x6630; // CountdownTimer
    pub const m_isWaitingBehindFriend: usize = 0x6648; // bool
    pub const m_pathLadderEnd: usize = 0x6674; // float32
    ...
    pub const m_travelDistancePhase: usize = 0x6808; // uint8
    pub const m_hostageEscortCount: usize = 0x69A0; // uint8
    pub const m_hostageEscortCountTimestamp: usize = 0x69A4; // float32
    pub const m_desiredTeam: usize = 0x69A8; // int32
    pub const m_hasJoined: usize = 0x69AC; // bool
    pub const m_isWaitingForHostage: usize = 0x69AD; // bool
    pub const m_inhibitWaitingForHostageTimer: usize = 0x69B0; // CountdownTimer
    pub const m_waitForHostageTimer: usize = 0x69C8; // CountdownTimer
    pub const m_noisePosition: usize = 0x69E0; // Vector
    pub const m_noiseTravelDistance: usize = 0x69EC; // float32
    pub const m_noiseTimestamp: usize = 0x69F0; // float32
    pub const m_noiseSource: usize = 0x69F8; // CCSPlayerPawn*
    pub const m_noiseBendTimer: usize = 0x6A10; // CountdownTimer
    pub const m_bentNoisePosition: usize = 0x6A28; // Vector
    pub const m_bendNoisePositionValid: usize = 0x6A34; // bool
    pub const m_lookAroundStateTimestamp: usize = 0x6A38; // float32
    pub const m_lookAheadAngle: usize = 0x6A3C; // float32
    pub const m_forwardAngle: usize = 0x6A40; // float32
    pub const m_inhibitLookAroundTimestamp: usize = 0x6A44; // float32
    pub const m_lookAtSpot: usize = 0x6A4C; // Vector
    pub const m_lookAtSpotDuration: usize = 0x6A5C; // float32
    pub const m_lookAtSpotTimestamp: usize = 0x6A60; // float32
    pub const m_lookAtSpotAngleTolerance: usize = 0x6A64; // float32
    pub const m_lookAtSpotClearIfClose: usize = 0x6A68; // bool
    pub const m_lookAtSpotAttack: usize = 0x6A69; // bool
    pub const m_lookAtDesc: usize = 0x6A70; // char*
    pub const m_peripheralTimestamp: usize = 0x6A78; // float32
    pub const m_approachPointCount: usize = 0x6C00; // uint8
    pub const m_approachPointViewPosition: usize = 0x6C04; // Vector
    pub const m_viewSteadyTimer: usize = 0x6C10; // IntervalTimer
    pub const m_tossGrenadeTimer: usize = 0x6C28; // CountdownTimer
    pub const m_isAvoidingGrenade: usize = 0x6C48; // CountdownTimer
    pub const m_spotCheckTimestamp: usize = 0x6C68; // float32
    pub const m_checkedHidingSpotCount: usize = 0x7070; // int32
    pub const m_lookPitch: usize = 0x7074; // float32
    pub const m_lookPitchVel: usize = 0x7078; // float32
    pub const m_lookYaw: usize = 0x707C; // float32
    pub const m_lookYawVel: usize = 0x7080; // float32
    pub const m_targetSpot: usize = 0x7084; // Vector
    pub const m_targetSpotVelocity: usize = 0x7090; // Vector
    pub const m_targetSpotPredicted: usize = 0x709C; // Vector
    pub const m_aimError: usize = 0x70A8; // QAngle
    pub const m_aimGoal: usize = 0x70B4; // QAngle
    pub const m_targetSpotTime: usize = 0x70C0; // GameTime_t
    pub const m_aimFocus: usize = 0x70C4; // float32
    pub const m_aimFocusInterval: usize = 0x70C8; // float32
    pub const m_aimFocusNextUpdate: usize = 0x70CC; // GameTime_t
    pub const m_ignoreEnemiesTimer: usize = 0x70D8; // CountdownTimer
    pub const m_enemy: usize = 0x70F0; // CHandle< CCSPlayerPawn >
    pub const m_isEnemyVisible: usize = 0x70F4; // bool
    pub const m_visibleEnemyParts: usize = 0x70F5; // uint8
    pub const m_lastEnemyPosition: usize = 0x70F8; // Vector
    pub const m_lastSawEnemyTimestamp: usize = 0x7104; // float32
    pub const m_firstSawEnemyTimestamp: usize = 0x7108; // float32
    pub const m_currentEnemyAcquireTimestamp: usize = 0x710C; // float32
    pub const m_enemyDeathTimestamp: usize = 0x7110; // float32
    pub const m_friendDeathTimestamp: usize = 0x7114; // float32
    pub const m_isLastEnemyDead: usize = 0x7118; // bool
    pub const m_nearbyEnemyCount: usize = 0x711C; // int32
    pub const m_bomber: usize = 0x7328; // CHandle< CCSPlayerPawn >
    pub const m_nearbyFriendCount: usize = 0x732C; // int32
    pub const m_closestVisibleFriend: usize = 0x7330; // CHandle< CCSPlayerPawn >
    pub const m_closestVisibleHumanFriend: usize = 0x7334; // CHandle< CCSPlayerPawn >
    pub const m_attentionInterval: usize = 0x7338; // IntervalTimer
    pub const m_attacker: usize = 0x7348; // CHandle< CCSPlayerPawn >
    pub const m_attackedTimestamp: usize = 0x734C; // float32
    pub const m_burnedByFlamesTimer: usize = 0x7350; // IntervalTimer
    pub const m_lastVictimID: usize = 0x7360; // int32
    pub const m_isAimingAtEnemy: usize = 0x7364; // bool
    pub const m_isRapidFiring: usize = 0x7365; // bool
    pub const m_equipTimer: usize = 0x7368; // IntervalTimer
    pub const m_zoomTimer: usize = 0x7378; // CountdownTimer
    pub const m_fireWeaponTimestamp: usize = 0x7390; // GameTime_t
    pub const m_lookForWeaponsOnGroundTimer: usize = 0x7398; // CountdownTimer
    pub const m_bIsSleeping: usize = 0x73B0; // bool
    pub const m_isEnemySniperVisible: usize = 0x73B1; // bool
    pub const m_sawEnemySniperTimer: usize = 0x73B8; // CountdownTimer
    pub const m_enemyQueueIndex: usize = 0x7470; // uint8
    pub const m_enemyQueueCount: usize = 0x7471; // uint8
    pub const m_enemyQueueAttendIndex: usize = 0x7472; // uint8
    pub const m_isStuck: usize = 0x7473; // bool
    pub const m_stuckTimestamp: usize = 0x7474; // GameTime_t
    pub const m_stuckSpot: usize = 0x7478; // Vector
    ...
    pub const m_avgVelIndex: usize = 0x74E4; // int32
    pub const m_avgVelCount: usize = 0x74E8; // int32
    pub const m_lastOrigin: usize = 0x74EC; // Vector
    pub const m_lastRadioRecievedTimestamp: usize = 0x74FC; // float32
    pub const m_lastRadioSentTimestamp: usize = 0x7500; // float32
    pub const m_radioSubject: usize = 0x7504; // CHandle< CCSPlayerPawn >
    pub const m_radioPosition: usize = 0x7508; // Vector
    pub const m_voiceEndTimestamp: usize = 0x7514; // float32
    pub const m_lastValidReactionQueueFrame: usize = 0x7520; // int32
}

pub mod CCSGOViewModel {
    pub const m_bShouldIgnoreOffsetAndAccuracy: usize = 0x8D8; // bool
    pub const m_nWeaponParity: usize = 0x8DC; // uint32
    pub const m_nOldWeaponParity: usize = 0x8E0; // uint32
}

pub mod CCSGO_TeamPreviewCharacterPosition {
    pub const m_nVariant: usize = 0x4B0; // int32
    pub const m_nRandom: usize = 0x4B4; // int32
    pub const m_nOrdinal: usize = 0x4B8; // int32
    pub const m_sWeaponName: usize = 0x4C0; // CUtlString
    pub const m_xuid: usize = 0x4C8; // uint64
...
pub mod CCSGameRules {
    ...
    pub const m_iNextCTSpawnPoint: usize = 0xF98; // int32
    ...
    pub const m_fAutobalanceDisplayTime: usize = 0xFD4; // float32
    ...
    pub const m_fNextUpdateTeamClanNamesTime: usize = 0x1248; // float32
    pub const m_flLastThinkTime: usize = 0x124C; // GameTime_t
    pub const m_fAccumulatedRoundOffDamage: usize = 0x1250; // float32
    pub const m_nShorthandedBonusLastEvalRound: usize = 0x1254; // int32
    ...
    pub const m_GuardianBotSkillLevelMax: usize = 0x174C; // int32
    pub const m_GuardianBotSkillLevelMin: usize = 0x1750; // int32
    ...
    pub const m_nMatchEndCount: usize = 0x17E0; // uint8
    pub const m_nTTeamIntroVariant: usize = 0x17E4; // int32
    pub const m_nCTTeamIntroVariant: usize = 0x17E8; // int32
    ...
    pub const m_flLastPerfSampleTime: usize = 0x27B0; // float64
...
pub mod CCSPlayerController {
    pub const m_pInGameMoneyServices: usize = 0x6A0; // CCSPlayerController_InGameMoneyServices*
    pub const m_pInventoryServices: usize = 0x6A8; // CCSPlayerController_InventoryServices*
    pub const m_pActionTrackingServices: usize = 0x6B0; // CCSPlayerController_ActionTrackingServices*
    pub const m_pDamageServices: usize = 0x6B8; // CCSPlayerController_DamageServices*
    pub const m_iPing: usize = 0x6C0; // uint32
    pub const m_bHasCommunicationAbuseMute: usize = 0x6C4; // bool
    pub const m_szCrosshairCodes: usize = 0x6C8; // CUtlSymbolLarge
    pub const m_iPendingTeamNum: usize = 0x6D0; // uint8
    pub const m_flForceTeamTime: usize = 0x6D4; // GameTime_t
    pub const m_iCompTeammateColor: usize = 0x6D8; // int32
    pub const m_bEverPlayedOnTeam: usize = 0x6DC; // bool
    pub const m_bAttemptedToGetColor: usize = 0x6DD; // bool
    pub const m_iTeammatePreferredColor: usize = 0x6E0; // int32
    pub const m_bTeamChanged: usize = 0x6E4; // bool
    pub const m_bInSwitchTeam: usize = 0x6E5; // bool
    pub const m_bHasSeenJoinGame: usize = 0x6E6; // bool
    pub const m_bJustBecameSpectator: usize = 0x6E7; // bool
    pub const m_bSwitchTeamsOnNextRoundReset: usize = 0x6E8; // bool
    pub const m_bRemoveAllItemsOnNextRoundReset: usize = 0x6E9; // bool
    pub const m_szClan: usize = 0x6F0; // CUtlSymbolLarge
    pub const m_szClanName: usize = 0x6F8; // char[32]
    pub const m_iCoachingTeam: usize = 0x718; // int32
    pub const m_nPlayerDominated: usize = 0x720; // uint64
    pub const m_nPlayerDominatingMe: usize = 0x728; // uint64
    pub const m_iCompetitiveRanking: usize = 0x730; // int32
    pub const m_iCompetitiveWins: usize = 0x734; // int32
    pub const m_iCompetitiveRankType: usize = 0x738; // int8
    pub const m_iCompetitiveRankingPredicted_Win: usize = 0x73C; // int32
    pub const m_iCompetitiveRankingPredicted_Loss: usize = 0x740; // int32
    pub const m_iCompetitiveRankingPredicted_Tie: usize = 0x744; // int32
    pub const m_nEndMatchNextMapVote: usize = 0x748; // int32
    pub const m_unActiveQuestId: usize = 0x74C; // uint16
    pub const m_nQuestProgressReason: usize = 0x750; // QuestProgress::Reason
    pub const m_unPlayerTvControlFlags: usize = 0x754; // uint32
    pub const m_iDraftIndex: usize = 0x7C0; // int32
    pub const m_msQueuedModeDisconnectionTimestamp: usize = 0x7C4; // uint32
    pub const m_uiAbandonRecordedReason: usize = 0x7C8; // uint32
    ...
    pub const m_nDisconnectionTick: usize = 0x7D4; // int32
    ...
    pub const m_nBotsControlledThisRound: usize = 0x7E4; // int32
    ...
    pub const m_DesiredObserverMode: usize = 0x7F4; // int32
    pub const m_hDesiredObserverTarget: usize = 0x7F8; // CEntityHandle
    pub const m_bPawnIsAlive: usize = 0x7FC; // bool
    pub const m_iPawnHealth: usize = 0x800; // uint32
    pub const m_iPawnArmor: usize = 0x804; // int32
    pub const m_bPawnHasDefuser: usize = 0x808; // bool
    pub const m_bPawnHasHelmet: usize = 0x809; // bool
    pub const m_nPawnCharacterDefIndex: usize = 0x80A; // uint16
    pub const m_iPawnLifetimeStart: usize = 0x80C; // int32
    pub const m_iPawnLifetimeEnd: usize = 0x810; // int32
    pub const m_iPawnBotDifficulty: usize = 0x814; // int32
    pub const m_hOriginalControllerOfCurrentPawn: usize = 0x818; // CHandle< CCSPlayerController >
    pub const m_iScore: usize = 0x81C; // int32
    pub const m_iRoundScore: usize = 0x820; // int32
    pub const m_vecKills: usize = 0x828; // CNetworkUtlVectorBase< EKillTypes_t >
    pub const m_iMVPs: usize = 0x840; // int32
    pub const m_nUpdateCounter: usize = 0x844; // int32
...
pub mod CCSPlayerPawn {
    ...
    pub const m_nCharacterDefIndex: usize = 0x1598; // uint16
    ...
    pub const m_iRetakesOffering: usize = 0x1680; // int32
    pub const m_iRetakesOfferingCard: usize = 0x1684; // int32
    pub const m_bRetakesHasDefuseKit: usize = 0x1688; // bool
    pub const m_bRetakesMVPLastRound: usize = 0x1689; // bool
    pub const m_iRetakesMVPBoostItem: usize = 0x168C; // int32
    ...
    pub const m_flLandseconds: usize = 0x1698; // float32
    pub const m_aimPunchAngle: usize = 0x169C; // QAngle
    pub const m_aimPunchAngleVel: usize = 0x16A8; // QAngle
    pub const m_aimPunchTickBase: usize = 0x16B4; // int32
    pub const m_aimPunchTickFraction: usize = 0x16B8; // float32
    ...
    pub const m_iPlayerLocked: usize = 0x1C58; // int32
    ...
    pub const m_nRagdollDamageBone: usize = 0x1C6C; // int32
...
pub mod CCSPlayerPawnBase {
    ...
    pub const m_iDisplayHistoryBits: usize = 0xBC0; // uint32
    pub const m_flLastAttackedTeammate: usize = 0xBC4; // float32
    ...
    pub const m_nSpotRules: usize = 0xBF0; // int32
    ...
    pub const m_flLastDistanceTraveledNotice: usize = 0xCDC; // float32
    pub const m_flAccumulatedDistanceTraveled: usize = 0xCE0; // float32
    pub const m_flLastFriendlyFireDamageReductionRatio: usize = 0xCE4; // float32
    pub const m_bRespawning: usize = 0xCE8; // bool
    pub const m_nLastPickupPriority: usize = 0xCEC; // int32
    pub const m_flLastPickupPriorityTime: usize = 0xCF0; // float32
    ...
    pub const m_unTotalRoundDamageDealt: usize = 0xD08; // uint32
    pub const m_fMolotovDamageTime: usize = 0xD0C; // float32
    pub const m_bHasMovedSinceSpawn: usize = 0xD10; // bool
    pub const m_bCanMoveDuringFreezePeriod: usize = 0xD11; // bool
    pub const m_flGuardianTooFarDistFrac: usize = 0xD14; // float32
    pub const m_flNextGuardianTooFarHurtTime: usize = 0xD18; // float32
    pub const m_flDetectedByEnemySensorTime: usize = 0xD1C; // GameTime_t
    pub const m_flDealtDamageToEnemyMostRecentTimestamp: usize = 0xD20; // float32
    pub const m_flLastEquippedHelmetTime: usize = 0xD24; // GameTime_t
    pub const m_flLastEquippedArmorTime: usize = 0xD28; // GameTime_t
    pub const m_nHeavyAssaultSuitCooldownRemaining: usize = 0xD2C; // int32
    ...
    pub const m_iNumSpawns: usize = 0xD3C; // int32
    pub const m_iShouldHaveCash: usize = 0xD40; // int32
    ...
    pub const m_iTeamKills: usize = 0xD48; // int32
    pub const m_flLastAction: usize = 0xD4C; // GameTime_t
    pub const m_flNameChangeHistory: usize = 0xD50; // float32[5]
    pub const m_fLastGivenDefuserTime: usize = 0xD64; // float32
    pub const m_fLastGivenBombTime: usize = 0xD68; // float32
    pub const m_bHasNightVision: usize = 0xD6C; // bool
    pub const m_bNightVisionOn: usize = 0xD6D; // bool
    pub const m_fNextRadarUpdateTime: usize = 0xD70; // float32
    pub const m_flLastMoneyUpdateTime: usize = 0xD74; // float32
    pub const m_MenuStringBuffer: usize = 0xD78; // char[1024]
    pub const m_fIntroCamTime: usize = 0x1178; // float32
    pub const m_nMyCollisionGroup: usize = 0x117C; // int32
    pub const m_bInNoDefuseArea: usize = 0x1180; // bool
    pub const m_bKilledByTaser: usize = 0x1181; // bool
    pub const m_iMoveState: usize = 0x1184; // int32
    ...
    pub const m_nWhichBombZone: usize = 0x1204; // int32
    pub const m_bInBombZoneTrigger: usize = 0x1208; // bool
    pub const m_bWasInBombZoneTrigger: usize = 0x1209; // bool
    pub const m_iDirection: usize = 0x120C; // int32
    pub const m_iShotsFired: usize = 0x1210; // int32
    pub const m_ArmorValue: usize = 0x1214; // int32
    pub const m_flFlinchStack: usize = 0x1218; // float32
    pub const m_flVelocityModifier: usize = 0x121C; // float32
    pub const m_flHitHeading: usize = 0x1220; // float32
    pub const m_nHitBodyPart: usize = 0x1224; // int32
    pub const m_iHostagesKilled: usize = 0x1228; // int32
    pub const m_vecTotalBulletForce: usize = 0x122C; // Vector
    pub const m_flFlashDuration: usize = 0x1238; // float32
    pub const m_flFlashMaxAlpha: usize = 0x123C; // float32
    pub const m_flProgressBarStartTime: usize = 0x1240; // float32
    pub const m_iProgressBarDuration: usize = 0x1244; // int32
    pub const m_bWaitForNoAttack: usize = 0x1248; // bool
    pub const m_flLowerBodyYawTarget: usize = 0x124C; // float32
    pub const m_bStrafing: usize = 0x1250; // bool
    pub const m_lastStandingPos: usize = 0x1254; // Vector
    pub const m_ignoreLadderJumpTime: usize = 0x1260; // float32
    ...
    pub const m_flSlopeDropOffset: usize = 0x12A4; // float32
    pub const m_flSlopeDropHeight: usize = 0x12A8; // float32
    pub const m_vHeadConstraintOffset: usize = 0x12AC; // Vector
    pub const m_iLastWeaponFireUsercmd: usize = 0x12C0; // int32
    ...
    pub const m_nNumDangerZoneDamageHits: usize = 0x12F0; // int32
    ...
    pub const m_nLastConcurrentKilled: usize = 0x12FC; // int32
    pub const m_nDeathCamMusic: usize = 0x1300; // int32
    pub const m_iAddonBits: usize = 0x1304; // int32
    pub const m_iPrimaryAddon: usize = 0x1308; // int32
    pub const m_iSecondaryAddon: usize = 0x130C; // int32
    pub const m_nTeamDamageGivenForMatch: usize = 0x1310; // int32
    pub const m_bTDGaveProtectionWarning: usize = 0x1314; // bool
    pub const m_bTDGaveProtectionWarningThisRound: usize = 0x1315; // bool
    pub const m_flLastTHWarningTime: usize = 0x1318; // float32
    pub const m_currentDeafnessFilter: usize = 0x131C; // CUtlStringToken
    pub const m_NumEnemiesKilledThisSpawn: usize = 0x1320; // int32
    pub const m_NumEnemiesKilledThisRound: usize = 0x1324; // int32
    pub const m_NumEnemiesAtRoundStart: usize = 0x1328; // int32
    pub const m_iRoundsWon: usize = 0x132C; // int32
    pub const m_lastRoundResult: usize = 0x1330; // int32
    pub const m_wasNotKilledNaturally: usize = 0x1334; // bool
    pub const m_vecPlayerPatchEconIndices: usize = 0x1338; // uint32[5]
    pub const m_iDeathFlags: usize = 0x134C; // int32
    pub const m_hPet: usize = 0x1350; // CHandle< CChicken >
    pub const m_unCurrentEquipmentValue: usize = 0x1520; // uint16
    pub const m_unRoundStartEquipmentValue: usize = 0x1522; // uint16
    pub const m_unFreezetimeEndEquipmentValue: usize = 0x1524; // uint16
    pub const m_nSuicides: usize = 0x1528; // int32
    pub const m_nSurvivalTeamNumber: usize = 0x152C; // int32
    pub const m_bHasDeathInfo: usize = 0x1530; // bool
    pub const m_flDeathInfoTime: usize = 0x1534; // float32
    pub const m_vecDeathInfoOrigin: usize = 0x1538; // Vector
    pub const m_bKilledByHeadshot: usize = 0x1544; // bool
    pub const m_LastHitBox: usize = 0x1548; // int32
    pub const m_LastHealth: usize = 0x154C; // int32
    pub const m_flLastCollisionCeiling: usize = 0x1550; // float32
    pub const m_flLastCollisionCeilingChangeTime: usize = 0x1554; // float32
...
pub mod CCSPlayer_MovementServices {
    pub const m_flMaxFallVelocity: usize = 0x220; // float32
...
pub mod CCSPlayer_WeaponServices {
    ...
    pub const m_nTimeToMelee: usize = 0xBC; // int32
    pub const m_nTimeToSecondary: usize = 0xC0; // int32
    pub const m_nTimeToPrimary: usize = 0xC4; // int32
    pub const m_nTimeToSniperRifle: usize = 0xC8; // int32
...
pub mod CCSTeam {
    pub const m_nLastRecievedShorthandedRoundBonus: usize = 0x568; // int32
    pub const m_nShorthandedRoundBonusStartRound: usize = 0x56C; // int32
    pub const m_bSurrendered: usize = 0x570; // bool
    pub const m_szTeamMatchStat: usize = 0x571; // char[512]
    pub const m_numMapVictories: usize = 0x774; // int32
    pub const m_scoreFirstHalf: usize = 0x778; // int32
    pub const m_scoreSecondHalf: usize = 0x77C; // int32
    pub const m_scoreOvertime: usize = 0x780; // int32
    pub const m_szClanTeamname: usize = 0x784; // char[129]
    pub const m_iClanID: usize = 0x808; // uint32
    pub const m_szTeamFlagImage: usize = 0x80C; // char[8]
    pub const m_szTeamLogoImage: usize = 0x814; // char[8]
    pub const m_flNextResourceTime: usize = 0x81C; // float32
    pub const m_iLastUpdateSentAt: usize = 0x820; // int32
}

pub mod CCSWeaponBase {
    pub const m_bRemoveable: usize = 0xC88; // bool
    pub const m_flFireSequenceStartTime: usize = 0xC8C; // float32
    pub const m_nFireSequenceStartTimeChange: usize = 0xC90; // int32
    pub const m_nFireSequenceStartTimeAck: usize = 0xC94; // int32
    pub const m_bPlayerFireEventIsPrimary: usize = 0xC98; // bool
    pub const m_seqIdle: usize = 0xC9C; // HSequence
    pub const m_seqFirePrimary: usize = 0xCA0; // HSequence
    pub const m_seqFireSecondary: usize = 0xCA4; // HSequence
    pub const m_bPlayerAmmoStockOnPickup: usize = 0xCB0; // bool
    pub const m_bRequireUseToTouch: usize = 0xCB1; // bool
    pub const m_iState: usize = 0xCB4; // CSWeaponState_t
    pub const m_flLastTimeInAir: usize = 0xCB8; // GameTime_t
    pub const m_flLastDeployTime: usize = 0xCBC; // GameTime_t
    pub const m_nViewModelIndex: usize = 0xCC0; // uint32
    pub const m_bReloadsWithClips: usize = 0xCC4; // bool
    pub const m_flTimeWeaponIdle: usize = 0xCE0; // GameTime_t
    pub const m_bFireOnEmpty: usize = 0xCE4; // bool
    pub const m_OnPlayerPickup: usize = 0xCE8; // CEntityIOOutput
    pub const m_weaponMode: usize = 0xD10; // CSWeaponMode
    pub const m_flTurningInaccuracyDelta: usize = 0xD14; // float32
    pub const m_vecTurningInaccuracyEyeDirLast: usize = 0xD18; // Vector
    pub const m_flTurningInaccuracy: usize = 0xD24; // float32
    pub const m_fAccuracyPenalty: usize = 0xD28; // float32
    pub const m_flLastAccuracyUpdateTime: usize = 0xD2C; // GameTime_t
    pub const m_fAccuracySmoothedForZoom: usize = 0xD30; // float32
    pub const m_fScopeZoomEndTime: usize = 0xD34; // GameTime_t
    pub const m_iRecoilIndex: usize = 0xD38; // int32
    pub const m_flRecoilIndex: usize = 0xD3C; // float32
    pub const m_bBurstMode: usize = 0xD40; // bool
    pub const m_flPostponeFireReadyTime: usize = 0xD44; // GameTime_t
    pub const m_bInReload: usize = 0xD48; // bool
    pub const m_bReloadVisuallyComplete: usize = 0xD49; // bool
    pub const m_flDroppedAtTime: usize = 0xD4C; // GameTime_t
    pub const m_bIsHauledBack: usize = 0xD50; // bool
    pub const m_bSilencerOn: usize = 0xD51; // bool
    pub const m_flTimeSilencerSwitchComplete: usize = 0xD54; // GameTime_t
    pub const m_iOriginalTeamNumber: usize = 0xD58; // int32
    pub const m_flNextAttackRenderTimeOffset: usize = 0xD5C; // float32
    ...
    pub const m_numRemoveUnownedWeaponThink: usize = 0xDA8; // int32
    pub const m_IronSightController: usize = 0xDB0; // CIronSightController
    pub const m_iIronSightMode: usize = 0xDC8; // int32
    pub const m_flLastLOSTraceFailureTime: usize = 0xDCC; // GameTime_t
    pub const m_iNumEmptyAttacks: usize = 0xDD0; // int32
}

pub mod CCSWeaponBaseGun {
    pub const m_zoomLevel: usize = 0xDD8; // int32
    pub const m_iBurstShotsRemaining: usize = 0xDDC; // int32
    pub const m_silencedModelIndex: usize = 0xDE8; // int32
...
pub mod CChicken {
    ...
    pub const m_OriginalOwnerXuidLow: usize = 0xDF0; // uint32
    pub const m_OriginalOwnerXuidHigh: usize = 0xDF4; // uint32
    ...
    pub const m_turnRate: usize = 0xE80; // float32
    ...
    pub const m_flLastJumpTime: usize = 0xF18; // float32
...
pub mod CColorCorrection {
    pub const m_flFadeInDuration: usize = 0x4B0; // float32
    pub const m_flFadeOutDuration: usize = 0x4B4; // float32
    pub const m_flStartFadeInWeight: usize = 0x4B8; // float32
    pub const m_flStartFadeOutWeight: usize = 0x4BC; // float32
    pub const m_flTimeStartFadeIn: usize = 0x4C0; // GameTime_t
    pub const m_flTimeStartFadeOut: usize = 0x4C4; // GameTime_t
    pub const m_flMaxWeight: usize = 0x4C8; // float32
    ...
    pub const m_MinFalloff: usize = 0x4D4; // float32
    pub const m_MaxFalloff: usize = 0x4D8; // float32
    pub const m_flCurWeight: usize = 0x4DC; // float32
...
pub mod CColorCorrectionVolume {
    ...
    pub const m_MaxWeight: usize = 0x8AC; // float32
    pub const m_FadeDuration: usize = 0x8B0; // float32
    pub const m_bStartDisabled: usize = 0x8B4; // bool
    pub const m_Weight: usize = 0x8B8; // float32
    pub const m_lookupFilename: usize = 0x8BC; // char[512]
    pub const m_LastEnterWeight: usize = 0xABC; // float32
    pub const m_LastEnterTime: usize = 0xAC0; // GameTime_t
    pub const m_LastExitWeight: usize = 0xAC4; // float32
...
pub mod CConstraintAnchor {
    pub const m_massScale: usize = 0x890; // float32
}
...
pub mod CCredits {
    ...
    pub const m_flLogoLength: usize = 0x4DC; // float32
}
...
pub mod CDebugHistory {
    pub const m_nNpcEvents: usize = 0x44F0; // int32
}

pub mod CDecoyProjectile {
    pub const m_shotsRemaining: usize = 0xA30; // int32
    pub const m_fExpireTime: usize = 0xA34; // GameTime_t
    pub const m_decoyWeaponDefIndex: usize = 0xA40; // uint16
}

pub mod CDynamicLight {
    pub const m_ActualFlags: usize = 0x700; // uint8
    pub const m_Flags: usize = 0x701; // uint8
    pub const m_LightStyle: usize = 0x702; // uint8
    pub const m_On: usize = 0x703; // bool
    pub const m_Radius: usize = 0x704; // float32
    pub const m_Exponent: usize = 0x708; // int32
    pub const m_InnerAngle: usize = 0x70C; // float32
    pub const m_OuterAngle: usize = 0x710; // float32
    pub const m_SpotRadius: usize = 0x714; // float32
}
...
pub mod CDynamicProp {
    ...
    pub const m_iInitialGlowState: usize = 0xAF4; // int32
    pub const m_nGlowRange: usize = 0xAF8; // int32
    pub const m_nGlowRangeMin: usize = 0xAFC; // int32
    pub const m_glowColor: usize = 0xB00; // Color
    pub const m_nGlowTeam: usize = 0xB04; // int32
}

pub mod CEconEntity {
    pub const m_AttributeManager: usize = 0x930; // CAttributeContainer
    pub const m_OriginalOwnerXuidLow: usize = 0xBF8; // uint32
    pub const m_OriginalOwnerXuidHigh: usize = 0xBFC; // uint32
    pub const m_nFallbackPaintKit: usize = 0xC00; // int32
    pub const m_nFallbackSeed: usize = 0xC04; // int32
    pub const m_flFallbackWear: usize = 0xC08; // float32
    pub const m_nFallbackStatTrak: usize = 0xC0C; // int32
    pub const m_hOldProvidee: usize = 0xC10; // CHandle< CBaseEntity >
    pub const m_iOldOwnerClass: usize = 0xC14; // int32
}
...
pub mod CEconWearable {
    pub const m_nForceSkin: usize = 0xC18; // int32
...
pub mod CEntityDissolve {
    pub const m_flFadeInStart: usize = 0x700; // float32
    pub const m_flFadeInLength: usize = 0x704; // float32
    pub const m_flFadeOutModelStart: usize = 0x708; // float32
    pub const m_flFadeOutModelLength: usize = 0x70C; // float32
    pub const m_flFadeOutStart: usize = 0x710; // float32
    pub const m_flFadeOutLength: usize = 0x714; // float32
    ...
    pub const m_nMagnitude: usize = 0x72C; // uint32
}

pub mod CEntityFlame {
    pub const m_hEntAttached: usize = 0x4B0; // CHandle< CBaseEntity >
    pub const m_bCheapEffect: usize = 0x4B4; // bool
    pub const m_flSize: usize = 0x4B8; // float32
    pub const m_bUseHitboxes: usize = 0x4BC; // bool
    pub const m_iNumHitboxFires: usize = 0x4C0; // int32
    pub const m_flHitboxFireScale: usize = 0x4C4; // float32
    pub const m_flLifetime: usize = 0x4C8; // GameTime_t
    pub const m_hAttacker: usize = 0x4CC; // CHandle< CBaseEntity >
    pub const m_iDangerSound: usize = 0x4D0; // int32
    pub const m_flDirectDamagePerSecond: usize = 0x4D4; // float32
    pub const m_iCustomDamageType: usize = 0x4D8; // int32
}
...
pub mod CEnvBeam {
    pub const m_active: usize = 0x7A0; // int32
    ...
    pub const m_life: usize = 0x7C0; // float32
    pub const m_boltWidth: usize = 0x7C4; // float32
    pub const m_noiseAmplitude: usize = 0x7C8; // float32
    pub const m_speed: usize = 0x7CC; // int32
    pub const m_restrike: usize = 0x7D0; // float32
    pub const m_iszSpriteName: usize = 0x7D8; // CUtlSymbolLarge
    pub const m_frameStart: usize = 0x7E0; // int32
    pub const m_vEndPointWorld: usize = 0x7E4; // Vector
    pub const m_vEndPointRelative: usize = 0x7F0; // Vector
    pub const m_radius: usize = 0x7FC; // float32
...
pub mod CEnvBeverage {
    ...
    pub const m_nBeverageType: usize = 0x4B4; // int32
}
...
pub mod CEnvCombinedLightProbeVolume {
    ...
    pub const m_LightGroups: usize = 0x1568; // CUtlSymbolLarge
    pub const m_bMoveable: usize = 0x1570; // bool
    pub const m_nHandshake: usize = 0x1574; // int32
    pub const m_nEnvCubeMapArrayIndex: usize = 0x1578; // int32
    pub const m_nPriority: usize = 0x157C; // int32
    pub const m_bStartDisabled: usize = 0x1580; // bool
    pub const m_flEdgeFadeDist: usize = 0x1584; // float32
    pub const m_vEdgeFadeDists: usize = 0x1588; // Vector
    pub const m_nLightProbeSizeX: usize = 0x1594; // int32
    pub const m_nLightProbeSizeY: usize = 0x1598; // int32
    pub const m_nLightProbeSizeZ: usize = 0x159C; // int32
    pub const m_nLightProbeAtlasX: usize = 0x15A0; // int32
    pub const m_nLightProbeAtlasY: usize = 0x15A4; // int32
    pub const m_nLightProbeAtlasZ: usize = 0x15A8; // int32
    pub const m_bEnabled: usize = 0x15C1; // bool
}

pub mod CEnvCubemap {
    pub const m_hCubemapTexture: usize = 0x538; // CStrongHandle< InfoForResourceTypeCTextureBase >
    pub const m_bCustomCubemapTexture: usize = 0x540; // bool
    pub const m_flInfluenceRadius: usize = 0x544; // float32
    pub const m_vBoxProjectMins: usize = 0x548; // Vector
    pub const m_vBoxProjectMaxs: usize = 0x554; // Vector
    pub const m_LightGroups: usize = 0x560; // CUtlSymbolLarge
...
pub mod CEnvCubemapFog {
    pub const m_flEndDistance: usize = 0x4B0; // float32
    pub const m_flStartDistance: usize = 0x4B4; // float32
    pub const m_flFogFalloffExponent: usize = 0x4B8; // float32
    pub const m_bHeightFogEnabled: usize = 0x4BC; // bool
    pub const m_flFogHeightWidth: usize = 0x4C0; // float32
    pub const m_flFogHeightEnd: usize = 0x4C4; // float32
    pub const m_flFogHeightStart: usize = 0x4C8; // float32
    pub const m_flFogHeightExponent: usize = 0x4CC; // float32
    pub const m_flLODBias: usize = 0x4D0; // float32
    pub const m_bActive: usize = 0x4D4; // bool
    pub const m_bStartDisabled: usize = 0x4D5; // bool
    pub const m_flFogMaxOpacity: usize = 0x4D8; // float32
    pub const m_nCubemapSourceType: usize = 0x4DC; // int32
...
pub mod CEnvDecal {
    ...
    pub const m_flWidth: usize = 0x708; // float32
    pub const m_flHeight: usize = 0x70C; // float32
    pub const m_flDepth: usize = 0x710; // float32
    pub const m_nRenderOrder: usize = 0x714; // uint32
    ...
    pub const m_flDepthSortBias: usize = 0x71C; // float32
}

pub mod CEnvDetailController {
    pub const m_flFadeStartDist: usize = 0x4B0; // float32
    pub const m_flFadeEndDist: usize = 0x4B4; // float32
}

pub mod CEnvEntityIgniter {
    pub const m_flLifetime: usize = 0x4B0; // float32
}
...
pub mod CEnvEntityMaker {
    ...
    pub const m_flPostSpawnDirectionVariance: usize = 0x4E8; // float32
    pub const m_flPostSpawnSpeed: usize = 0x4EC; // float32
...
pub mod CEnvExplosion {
    pub const m_iMagnitude: usize = 0x700; // int32
    pub const m_flPlayerDamage: usize = 0x704; // float32
    pub const m_iRadiusOverride: usize = 0x708; // int32
    pub const m_flInnerRadius: usize = 0x70C; // float32
    pub const m_spriteScale: usize = 0x710; // int32
    pub const m_flDamageForce: usize = 0x714; // float32
    pub const m_hInflictor: usize = 0x718; // CHandle< CBaseEntity >
    pub const m_iCustomDamageType: usize = 0x71C; // int32
...
pub mod CEnvFade {
    ...
    pub const m_Duration: usize = 0x4B4; // float32
    pub const m_HoldDuration: usize = 0x4B8; // float32
...
pub mod CEnvFireSensor {
    ...
    pub const m_targetLevel: usize = 0x4B8; // float32
    pub const m_targetTime: usize = 0x4BC; // float32
    pub const m_levelTime: usize = 0x4C0; // float32
...
pub mod CEnvFireSource {
    pub const m_bEnabled: usize = 0x4B0; // bool
    pub const m_radius: usize = 0x4B4; // float32
    pub const m_damage: usize = 0x4B8; // float32
}

pub mod CEnvGlobal {
    pub const m_outCounter: usize = 0x4B0; // CEntityOutputTemplate< int32 >
    pub const m_globalstate: usize = 0x4D8; // CUtlSymbolLarge
    pub const m_triggermode: usize = 0x4E0; // int32
    pub const m_initialstate: usize = 0x4E4; // int32
    pub const m_counter: usize = 0x4E8; // int32
}
...
pub mod CEnvInstructorHint {
    ...
    pub const m_iTimeout: usize = 0x4C8; // int32
    pub const m_iDisplayLimit: usize = 0x4CC; // int32
    ...
    pub const m_fIconOffset: usize = 0x4F4; // float32
    pub const m_fRange: usize = 0x4F8; // float32
    pub const m_iPulseOption: usize = 0x4FC; // uint8
    pub const m_iAlphaOption: usize = 0x4FD; // uint8
    pub const m_iShakeOption: usize = 0x4FE; // uint8
    pub const m_bStatic: usize = 0x4FF; // bool
    pub const m_bNoOffscreen: usize = 0x500; // bool
    pub const m_bForceCaption: usize = 0x501; // bool
    pub const m_iInstanceType: usize = 0x504; // int32
...
pub mod CEnvInstructorVRHint {
    ...
    pub const m_iLayoutFileType: usize = 0x4D8; // int32
    pub const m_iszCustomLayoutFile: usize = 0x4E0; // CUtlSymbolLarge
    pub const m_iAttachType: usize = 0x4E8; // int32
    pub const m_flHeightOffset: usize = 0x4EC; // float32
}
...
pub mod CEnvLightProbeVolume {
    pub const m_hLightProbeTexture: usize = 0x1490; // CStrongHandle< InfoForResourceTypeCTextureBase >
    pub const m_hLightProbeDirectLightIndicesTexture: usize = 0x1498; // CStrongHandle< InfoForResourceTypeCTextureBase >
    pub const m_hLightProbeDirectLightScalarsTexture: usize = 0x14A0; // CStrongHandle< InfoForResourceTypeCTextureBase >
    pub const m_hLightProbeDirectLightShadowsTexture: usize = 0x14A8; // CStrongHandle< InfoForResourceTypeCTextureBase >
    pub const m_vBoxMins: usize = 0x14B0; // Vector
    pub const m_vBoxMaxs: usize = 0x14BC; // Vector
    pub const m_LightGroups: usize = 0x14C8; // CUtlSymbolLarge
...
pub mod CEnvMicrophone {
    ...
    pub const m_nSoundMask: usize = 0x4B8; // int32
    pub const m_flSensitivity: usize = 0x4BC; // float32
    pub const m_flSmoothFactor: usize = 0x4C0; // float32
    pub const m_flMaxRange: usize = 0x4C4; // float32
    ...
    pub const m_iSpeakerDSPPreset: usize = 0x4D8; // int32
    ...
    pub const m_iLastRoutedFrame: usize = 0x668; // int32
}
...
pub mod CEnvParticleGlow {
    pub const m_flAlphaScale: usize = 0xC78; // float32
    pub const m_flRadiusScale: usize = 0xC7C; // float32
    pub const m_flSelfIllumScale: usize = 0xC80; // float32
...
pub mod CEnvProjectedTexture {
    ...
    pub const m_flLightFOV: usize = 0x708; // float32
    ...
    pub const m_flIntensity: usize = 0x71C; // float32
    pub const m_flLinearAttenuation: usize = 0x720; // float32
    pub const m_flQuadraticAttenuation: usize = 0x724; // float32
    pub const m_bVolumetric: usize = 0x728; // bool
    pub const m_flNoiseStrength: usize = 0x72C; // float32
    pub const m_flFlashlightTime: usize = 0x730; // float32
    pub const m_nNumPlanes: usize = 0x734; // uint32
    pub const m_flPlaneOffset: usize = 0x738; // float32
    pub const m_flVolumetricIntensity: usize = 0x73C; // float32
    pub const m_flColorTransitionTime: usize = 0x740; // float32
    pub const m_flAmbient: usize = 0x744; // float32
    pub const m_SpotlightTextureName: usize = 0x748; // char[512]
    pub const m_nSpotlightTextureFrame: usize = 0x948; // int32
    pub const m_nShadowQuality: usize = 0x94C; // uint32
    pub const m_flNearZ: usize = 0x950; // float32
    pub const m_flFarZ: usize = 0x954; // float32
    pub const m_flProjectionSize: usize = 0x958; // float32
    pub const m_flRotation: usize = 0x95C; // float32
...
pub mod CEnvScreenOverlay {
    ...
    pub const m_iDesiredOverlay: usize = 0x52C; // int32
    pub const m_bIsActive: usize = 0x530; // bool
}

pub mod CEnvShake {
    pub const m_limitToEntity: usize = 0x4B0; // CUtlSymbolLarge
    pub const m_Amplitude: usize = 0x4B8; // float32
    pub const m_Frequency: usize = 0x4BC; // float32
    ...
    pub const m_currentAmp: usize = 0x4D0; // float32
...
pub mod CEnvSky {
    ...
    pub const m_flBrightnessScale: usize = 0x71C; // float32
    pub const m_nFogType: usize = 0x720; // int32
    pub const m_flFogMinStart: usize = 0x724; // float32
    pub const m_flFogMinEnd: usize = 0x728; // float32
    pub const m_flFogMaxStart: usize = 0x72C; // float32
    pub const m_flFogMaxEnd: usize = 0x730; // float32
...
pub mod CEnvSoundscape {
    ...
    pub const m_soundscapeIndex: usize = 0x4F4; // int32
    pub const m_soundscapeEntityListId: usize = 0x4F8; // int32
    pub const m_soundEventHash: usize = 0x4FC; // uint32
...
pub mod CEnvSpark {
    pub const m_flDelay: usize = 0x4B0; // float32
    pub const m_nMagnitude: usize = 0x4B4; // int32
    pub const m_nTrailLength: usize = 0x4B8; // int32
    pub const m_nType: usize = 0x4BC; // int32
...
pub mod CEnvTilt {
    pub const m_Duration: usize = 0x4B0; // float32
    pub const m_Radius: usize = 0x4B4; // float32
    pub const m_TiltTime: usize = 0x4B8; // float32
    pub const m_stopTime: usize = 0x4BC; // GameTime_t
}

pub mod CEnvTracer {
    pub const m_vecEnd: usize = 0x4B0; // Vector
    pub const m_flDelay: usize = 0x4BC; // float32
}
...
pub mod CEnvVolumetricFogController {
    pub const m_flScattering: usize = 0x4B0; // float32
    pub const m_flAnisotropy: usize = 0x4B4; // float32
    pub const m_flFadeSpeed: usize = 0x4B8; // float32
    pub const m_flDrawDistance: usize = 0x4BC; // float32
    pub const m_flFadeInStart: usize = 0x4C0; // float32
    pub const m_flFadeInEnd: usize = 0x4C4; // float32
    pub const m_flIndirectStrength: usize = 0x4C8; // float32
    pub const m_nIndirectTextureDimX: usize = 0x4CC; // int32
    pub const m_nIndirectTextureDimY: usize = 0x4D0; // int32
    pub const m_nIndirectTextureDimZ: usize = 0x4D4; // int32
    ...
    pub const m_flStartAnisotropy: usize = 0x500; // float32
    pub const m_flStartScattering: usize = 0x504; // float32
    pub const m_flStartDrawDistance: usize = 0x508; // float32
    pub const m_flDefaultAnisotropy: usize = 0x50C; // float32
    pub const m_flDefaultScattering: usize = 0x510; // float32
    pub const m_flDefaultDrawDistance: usize = 0x514; // float32
...
pub mod CEnvVolumetricFogVolume {
    ...
    pub const m_bStartDisabled: usize = 0x4CC; // bool
    pub const m_flStrength: usize = 0x4D0; // float32
    pub const m_nFalloffShape: usize = 0x4D4; // int32
    pub const m_flFalloffExponent: usize = 0x4D8; // float32
}
...
pub mod CFilterEnemy {
    ...
    pub const m_flOuterRadius: usize = 0x514; // float32
    pub const m_nMaxSquadmatesPerEnemy: usize = 0x518; // int32
    pub const m_iszPlayerName: usize = 0x520; // CUtlSymbolLarge
}

pub mod CFilterMassGreater {
    pub const m_fFilterMass: usize = 0x508; // float32
}
...
pub mod CFilterMultiple {
    ...
    pub const m_nFilterCount: usize = 0x588; // int32
}
...
pub mod CFire {
    ...
    pub const m_nFireType: usize = 0x708; // int32
    pub const m_flFuel: usize = 0x70C; // float32
    pub const m_flDamageTime: usize = 0x710; // GameTime_t
    pub const m_lastDamage: usize = 0x714; // GameTime_t
    pub const m_flFireSize: usize = 0x718; // float32
    pub const m_flLastNavUpdateTime: usize = 0x71C; // GameTime_t
    pub const m_flHeatLevel: usize = 0x720; // float32
    pub const m_flHeatAbsorb: usize = 0x724; // float32
    pub const m_flDamageScale: usize = 0x728; // float32
    pub const m_flMaxHeat: usize = 0x72C; // float32
    pub const m_flLastHeatLevel: usize = 0x730; // float32
    pub const m_flAttackTime: usize = 0x734; // float32
...
pub mod CFireSmoke {
    pub const m_nFlameModelIndex: usize = 0x4C0; // int32
    pub const m_nFlameFromAboveModelIndex: usize = 0x4C4; // int32
}
...
pub mod CFish {
    ...
    pub const m_id: usize = 0x894; // uint32
    pub const m_x: usize = 0x898; // float32
    pub const m_y: usize = 0x89C; // float32
    pub const m_z: usize = 0x8A0; // float32
    pub const m_angle: usize = 0x8A4; // float32
    pub const m_angleChange: usize = 0x8A8; // float32
    pub const m_forward: usize = 0x8AC; // Vector
    pub const m_perp: usize = 0x8B8; // Vector
    pub const m_poolOrigin: usize = 0x8C4; // Vector
    pub const m_waterLevel: usize = 0x8D0; // float32
    pub const m_speed: usize = 0x8D4; // float32
    pub const m_desiredSpeed: usize = 0x8D8; // float32
    pub const m_calmSpeed: usize = 0x8DC; // float32
    pub const m_panicSpeed: usize = 0x8E0; // float32
    pub const m_avoidRange: usize = 0x8E4; // float32
...
pub mod CFishPool {
    pub const m_fishCount: usize = 0x4C0; // int32
    pub const m_maxRange: usize = 0x4C4; // float32
    pub const m_swimDepth: usize = 0x4C8; // float32
    pub const m_waterLevel: usize = 0x4CC; // float32
...
pub mod CFlashbangProjectile {
    pub const m_flTimeToDetonate: usize = 0xA28; // float32
    pub const m_numOpponentsHit: usize = 0xA2C; // uint8
    pub const m_numTeammatesHit: usize = 0xA2D; // uint8
}

pub mod CFogController {
    pub const m_fog: usize = 0x4B0; // fogparams_t
    pub const m_bUseAngles: usize = 0x518; // bool
    pub const m_iChangedVariables: usize = 0x51C; // int32
}
...
pub mod CFuncBrush {
    ...
    pub const m_iDisabled: usize = 0x704; // int32
...
pub mod CFuncConveyor {
    ...
    pub const m_flTransitionDurationSeconds: usize = 0x708; // float32
    pub const m_angMoveEntitySpace: usize = 0x70C; // QAngle
    pub const m_vecMoveDirEntitySpace: usize = 0x718; // Vector
    pub const m_flTargetSpeed: usize = 0x724; // float32
    pub const m_nTransitionStartTick: usize = 0x728; // GameTick_t
    pub const m_nTransitionDurationTicks: usize = 0x72C; // int32
    pub const m_flTransitionStartSpeed: usize = 0x730; // float32
...
pub mod CFuncLadder {
    ...
    pub const m_flAutoRideSpeed: usize = 0x74C; // float32
...
pub mod CFuncMonitor {
    ...
    pub const m_nResolutionEnum: usize = 0x728; // int32
...
pub mod CFuncMoveLinear {
    ...
    pub const m_flBlockDamage: usize = 0x7B8; // float32
    pub const m_flStartPosition: usize = 0x7BC; // float32
    pub const m_flMoveDistance: usize = 0x7C0; // float32
...
pub mod CFuncNavBlocker {
    pub const m_bDisabled: usize = 0x700; // bool
    pub const m_nBlockedTeamNumber: usize = 0x704; // int32
}
...
pub mod CFuncRotating {
    ...
    pub const m_flFanFriction: usize = 0x70C; // float32
    pub const m_flAttenuation: usize = 0x710; // float32
    pub const m_flVolume: usize = 0x714; // float32
    pub const m_flTargetSpeed: usize = 0x718; // float32
    pub const m_flMaxSpeed: usize = 0x71C; // float32
    pub const m_flBlockDamage: usize = 0x720; // float32
    pub const m_flTimeScale: usize = 0x724; // float32
...
pub mod CFuncShatterglass {
    ...
    pub const m_nNumShardsEverCreated: usize = 0x7B4; // int32
    ...
    pub const m_flGlassThickness: usize = 0x7C4; // float32
    pub const m_flSpawnInvulnerability: usize = 0x7C8; // float32
    ...
    pub const m_iInitialDamageType: usize = 0x7D3; // uint8
    ...
    pub const m_iSurfaceType: usize = 0x851; // uint8
}
...
pub mod CFuncTimescale {
    pub const m_flDesiredTimescale: usize = 0x4B0; // float32
    pub const m_flAcceleration: usize = 0x4B4; // float32
    pub const m_flMinBlendRate: usize = 0x4B8; // float32
    pub const m_flBlendDeltaMultiplier: usize = 0x4BC; // float32
...
pub mod CFuncTrackChange {
    ...
    pub const m_targetState: usize = 0x7FC; // int32
    pub const m_use: usize = 0x800; // int32
}

pub mod CFuncTrackTrain {
    pub const m_ppath: usize = 0x700; // CHandle< CPathTrack >
    pub const m_length: usize = 0x704; // float32
    ...
    pub const m_lastBlockTick: usize = 0x744; // int32
    pub const m_flVolume: usize = 0x748; // float32
    pub const m_flBank: usize = 0x74C; // float32
    pub const m_oldSpeed: usize = 0x750; // float32
    pub const m_flBlockDamage: usize = 0x754; // float32
    pub const m_height: usize = 0x758; // float32
    pub const m_maxSpeed: usize = 0x75C; // float32
    pub const m_dir: usize = 0x760; // float32
    ...
    pub const m_flMoveSoundMinDuration: usize = 0x790; // float32
    pub const m_flMoveSoundMaxDuration: usize = 0x794; // float32
    pub const m_flNextMoveSoundTime: usize = 0x798; // GameTime_t
    pub const m_flMoveSoundMinPitch: usize = 0x79C; // float32
    pub const m_flMoveSoundMaxPitch: usize = 0x7A0; // float32
    ...
    pub const m_flDesiredSpeed: usize = 0x834; // float32
    pub const m_flSpeedChangeTime: usize = 0x838; // GameTime_t
    pub const m_flAccelSpeed: usize = 0x83C; // float32
    pub const m_flDecelSpeed: usize = 0x840; // float32
    pub const m_bAccelToSpeed: usize = 0x844; // bool
    pub const m_flTimeScale: usize = 0x848; // float32
...
pub mod CFuncTrain {
    ...
    pub const m_flBlockDamage: usize = 0x7B4; // float32
...
pub mod CFuncWall {
    pub const m_nState: usize = 0x700; // int32
}
...
pub mod CGameGibManager {
    ...
    pub const m_iCurrentMaxPieces: usize = 0x4D4; // int32
    pub const m_iMaxPieces: usize = 0x4D8; // int32
    pub const m_iLastFrame: usize = 0x4DC; // int32
}
...
pub mod CGameScriptedMoveData {
    ...
    pub const m_flAngRate: usize = 0x3C; // float32
    pub const m_flDuration: usize = 0x40; // float32
...
pub mod CGradientFog {
    ...
    pub const m_flFogStartDistance: usize = 0x4B8; // float32
    pub const m_flFogEndDistance: usize = 0x4BC; // float32
    pub const m_bHeightFogEnabled: usize = 0x4C0; // bool
    pub const m_flFogStartHeight: usize = 0x4C4; // float32
    pub const m_flFogEndHeight: usize = 0x4C8; // float32
    pub const m_flFarZ: usize = 0x4CC; // float32
    pub const m_flFogMaxOpacity: usize = 0x4D0; // float32
    pub const m_flFogFalloffExponent: usize = 0x4D4; // float32
    pub const m_flFogVerticalExponent: usize = 0x4D8; // float32
    pub const m_fogColor: usize = 0x4DC; // Color
    pub const m_flFogStrength: usize = 0x4E0; // float32
    pub const m_flFadeTime: usize = 0x4E4; // float32
...
pub mod CHintMessage {
    ...
    pub const m_duration: usize = 0x28; // float32
}

pub mod CHintMessageQueue {
    pub const m_tmMessageEnd: usize = 0x8; // float32
...
pub mod CInferno {
    ...
    pub const m_fireCount: usize = 0x1050; // int32
    pub const m_nInfernoType: usize = 0x1054; // int32
    pub const m_nFireEffectTickBegin: usize = 0x1058; // int32
    pub const m_nFireLifetime: usize = 0x105C; // float32
    pub const m_bInPostEffectTime: usize = 0x1060; // bool
    pub const m_nFiresExtinguishCount: usize = 0x1064; // int32
    ...
    pub const m_fireSpawnOffset: usize = 0x12F8; // int32
    pub const m_nMaxFlames: usize = 0x12FC; // int32
    pub const m_BookkeepingTimer: usize = 0x1300; // CountdownTimer
    pub const m_NextSpreadTimer: usize = 0x1318; // CountdownTimer
    pub const m_nSourceItemDefIndex: usize = 0x1330; // uint16
}

pub mod CInfoDynamicShadowHint {
    pub const m_bDisabled: usize = 0x4B0; // bool
    pub const m_flRange: usize = 0x4B4; // float32
    pub const m_nImportance: usize = 0x4B8; // int32
    pub const m_nLightChoice: usize = 0x4BC; // int32
...
pub mod CInfoGameEventProxy {
    ...
    pub const m_flRange: usize = 0x4B8; // float32
}

pub mod CInfoOffscreenPanoramaTexture {
    pub const m_bDisabled: usize = 0x4B0; // bool
    pub const m_nResolutionX: usize = 0x4B4; // int32
    pub const m_nResolutionY: usize = 0x4B8; // int32
...
pub mod CInfoVisibilityBox {
    pub const m_nMode: usize = 0x4B4; // int32
...
pub mod CInfoWorldLayer {
    ...
    pub const m_hLayerSpawnGroup: usize = 0x4EC; // uint32
}

pub mod CInstancedSceneEntity {
    pub const m_hOwner: usize = 0xA08; // CHandle< CBaseEntity >
    pub const m_bHadOwner: usize = 0xA0C; // bool
    pub const m_flPostSpeakDelay: usize = 0xA10; // float32
    pub const m_flPreDelay: usize = 0xA14; // float32
...
pub mod CItemDefuser {
    ...
    pub const m_nSpotRules: usize = 0x980; // int32
}
...
pub mod CItemGeneric {
    ...
    pub const m_flPickupRadiusSqr: usize = 0x974; // float32
    pub const m_flTriggerRadiusSqr: usize = 0x978; // float32
    ...
    pub const m_flPickupRadius: usize = 0xAB8; // float32
    pub const m_flTriggerRadius: usize = 0xABC; // float32
...
pub mod CKeepUpright {
    ...
    pub const m_angularLimit: usize = 0x4E4; // float32
...
pub mod CLightComponent {
    ...
    pub const m_bPvsModifyEntity: usize = 0x1C8; // bool
}
...
pub mod CLightGlow {
    pub const m_nHorizontalSize: usize = 0x700; // uint32
    pub const m_nVerticalSize: usize = 0x704; // uint32
    pub const m_nMinDist: usize = 0x708; // uint32
    pub const m_nMaxDist: usize = 0x70C; // uint32
    pub const m_nOuterMaxDist: usize = 0x710; // uint32
    pub const m_flGlowProxySize: usize = 0x714; // float32
    pub const m_flHDRColorScale: usize = 0x718; // float32
}
...
pub mod CLogicActiveAutosave {
    pub const m_TriggerHitPoints: usize = 0x4C0; // int32
    pub const m_flTimeToTrigger: usize = 0x4C4; // float32
    pub const m_flStartTime: usize = 0x4C8; // GameTime_t
    pub const m_flDangerousTime: usize = 0x4CC; // float32
}
...
pub mod CLogicAutosave {
    ...
    pub const m_minHitPoints: usize = 0x4B4; // int32
    pub const m_minHitPointsToCommit: usize = 0x4B8; // int32
}
...
pub mod CLogicCase {
    ...
    pub const m_nShuffleCases: usize = 0x5B0; // int32
    pub const m_nLastShuffleCase: usize = 0x5B4; // int32
...
pub mod CLogicCompare {
    pub const m_flInValue: usize = 0x4B0; // float32
    pub const m_flCompareValue: usize = 0x4B4; // float32
...
pub mod CLogicDistanceAutosave {
    ...
    pub const m_flDistanceToPlayer: usize = 0x4B8; // float32
    ...
    pub const m_flDangerousTime: usize = 0x4C0; // float32
}
...
pub mod CLogicDistanceCheck {
    ...
    pub const m_flZone1Distance: usize = 0x4C0; // float32
    pub const m_flZone2Distance: usize = 0x4C4; // float32
...
pub mod CLogicMeasureMovement {
    ...
    pub const m_flScale: usize = 0x4D8; // float32
    pub const m_nMeasureType: usize = 0x4DC; // int32
}
...
pub mod CLogicNPCCounter {
    ...
    pub const m_flDistanceMax: usize = 0x740; // float32
    pub const m_bDisabled: usize = 0x744; // bool
    pub const m_nMinCountAll: usize = 0x748; // int32
    pub const m_nMaxCountAll: usize = 0x74C; // int32
    pub const m_nMinFactorAll: usize = 0x750; // int32
    pub const m_nMaxFactorAll: usize = 0x754; // int32
    pub const m_iszNPCClassname_1: usize = 0x760; // CUtlSymbolLarge
    pub const m_nNPCState_1: usize = 0x768; // int32
    pub const m_bInvertState_1: usize = 0x76C; // bool
    pub const m_nMinCount_1: usize = 0x770; // int32
    pub const m_nMaxCount_1: usize = 0x774; // int32
    pub const m_nMinFactor_1: usize = 0x778; // int32
    pub const m_nMaxFactor_1: usize = 0x77C; // int32
    pub const m_flDefaultDist_1: usize = 0x784; // float32
    pub const m_iszNPCClassname_2: usize = 0x788; // CUtlSymbolLarge
    pub const m_nNPCState_2: usize = 0x790; // int32
    pub const m_bInvertState_2: usize = 0x794; // bool
    pub const m_nMinCount_2: usize = 0x798; // int32
    pub const m_nMaxCount_2: usize = 0x79C; // int32
    pub const m_nMinFactor_2: usize = 0x7A0; // int32
    pub const m_nMaxFactor_2: usize = 0x7A4; // int32
    pub const m_flDefaultDist_2: usize = 0x7AC; // float32
    pub const m_iszNPCClassname_3: usize = 0x7B0; // CUtlSymbolLarge
    pub const m_nNPCState_3: usize = 0x7B8; // int32
    pub const m_bInvertState_3: usize = 0x7BC; // bool
    pub const m_nMinCount_3: usize = 0x7C0; // int32
    pub const m_nMaxCount_3: usize = 0x7C4; // int32
    pub const m_nMinFactor_3: usize = 0x7C8; // int32
    pub const m_nMaxFactor_3: usize = 0x7CC; // int32
    pub const m_flDefaultDist_3: usize = 0x7D4; // float32
}
...
pub mod CMapInfo {
    pub const m_iBuyingStatus: usize = 0x4B0; // int32
    pub const m_flBombRadius: usize = 0x4B4; // float32
    pub const m_iPetPopulation: usize = 0x4B8; // int32
    pub const m_bUseNormalSpawnsForDM: usize = 0x4BC; // bool
    pub const m_bDisableAutoGeneratedDMSpawns: usize = 0x4BD; // bool
    pub const m_flBotMaxVisionDistance: usize = 0x4C0; // float32
    pub const m_iHostageCount: usize = 0x4C4; // int32
...
pub mod CMapVetoPickController {
    ...
    pub const m_dblPreMatchDraftSequenceTime: usize = 0x4D0; // float64
    pub const m_bPreMatchDraftStateChanged: usize = 0x4D8; // bool
    pub const m_nDraftType: usize = 0x4DC; // int32
    pub const m_nTeamWinningCoinToss: usize = 0x4E0; // int32
    ...
    pub const m_nCurrentPhase: usize = 0xE00; // int32
    pub const m_nPhaseStartTick: usize = 0xE04; // int32
    pub const m_nPhaseDurationTicks: usize = 0xE08; // int32
...
pub mod CMarkupVolumeWithRef {
    ...
    pub const m_flRefDot: usize = 0x750; // float32
}

pub mod CMathColorBlend {
    pub const m_flInMin: usize = 0x4B0; // float32
    pub const m_flInMax: usize = 0x4B4; // float32
...
pub mod CMathCounter {
    pub const m_flMin: usize = 0x4B0; // float32
    pub const m_flMax: usize = 0x4B4; // float32
...
pub mod CMathRemap {
    pub const m_flInMin: usize = 0x4B0; // float32
    pub const m_flInMax: usize = 0x4B4; // float32
    pub const m_flOut1: usize = 0x4B8; // float32
    pub const m_flOut2: usize = 0x4BC; // float32
    pub const m_flOldInValue: usize = 0x4C0; // float32
    pub const m_bEnabled: usize = 0x4C4; // bool
...
pub mod CMessage {
    pub const m_iszMessage: usize = 0x4B0; // CUtlSymbolLarge
    pub const m_MessageVolume: usize = 0x4B8; // float32
    pub const m_MessageAttenuation: usize = 0x4BC; // int32
...
pub mod CMessageEntity {
    pub const m_radius: usize = 0x4B0; // int32
...
pub mod CMolotovProjectile {
    pub const m_bIsIncGrenade: usize = 0xA28; // bool
    pub const m_bDetonated: usize = 0xA34; // bool
    pub const m_stillTimer: usize = 0xA38; // IntervalTimer
    pub const m_bHasBouncedOffPlayer: usize = 0xB18; // bool
}
...
pub mod CMomentaryRotButton {
    ...
    pub const m_lastUsed: usize = 0x990; // int32
    pub const m_start: usize = 0x994; // QAngle
    pub const m_end: usize = 0x9A0; // QAngle
    pub const m_IdealYaw: usize = 0x9AC; // float32
    pub const m_sNoise: usize = 0x9B0; // CUtlSymbolLarge
    pub const m_bUpdateTarget: usize = 0x9B8; // bool
    pub const m_direction: usize = 0x9BC; // int32
    pub const m_returnSpeed: usize = 0x9C0; // float32
    pub const m_flStartPosition: usize = 0x9C4; // float32
}
...
pub mod CMultiLightProxy {
    ...
    pub const m_flLightRadiusFilter: usize = 0x4C0; // float32
    pub const m_flBrightnessDelta: usize = 0x4C4; // float32
    pub const m_bPerformScreenFade: usize = 0x4C8; // bool
    pub const m_flTargetBrightnessMultiplier: usize = 0x4CC; // float32
    pub const m_flCurrentBrightnessMultiplier: usize = 0x4D0; // float32
...
pub mod CMultiSource {
    ...
    pub const m_iTotal: usize = 0x5D8; // int32
...
pub mod CNavLinkAreaEntity {
    pub const m_flWidth: usize = 0x4B0; // float32
    ...
    pub const m_nNavLinkIdForward: usize = 0x4E0; // int32
    pub const m_nNavLinkIdReverse: usize = 0x4E4; // int32
...
pub mod CParticleSystem {
    ...
    pub const m_flFreezeTransitionDuration: usize = 0x904; // float32
    pub const m_nStopType: usize = 0x908; // int32
    ...
    pub const m_flPreSimTime: usize = 0x91C; // float32
    ...
    pub const m_nDataCP: usize = 0xC60; // int32
    pub const m_vecDataCPValue: usize = 0xC64; // Vector
    pub const m_nTintCP: usize = 0xC70; // int32
    pub const m_clrTint: usize = 0xC74; // Color
}

pub mod CPathCorner {
    pub const m_flWait: usize = 0x4B0; // float32
...
pub mod CPathTrack {
    ...
    pub const m_flRadius: usize = 0x4C8; // float32
    pub const m_length: usize = 0x4CC; // float32
    pub const m_altName: usize = 0x4D0; // CUtlSymbolLarge
    pub const m_nIterVal: usize = 0x4D8; // int32
...
pub mod CPhysBallSocket {
    pub const m_flFriction: usize = 0x508; // float32
...
pub mod CPhysBox {
    pub const m_damageType: usize = 0x7C0; // int32
    pub const m_massScale: usize = 0x7C4; // float32
    pub const m_damageToEnableMotion: usize = 0x7C8; // int32
    pub const m_flForceToEnableMotion: usize = 0x7CC; // float32
    ...
    pub const m_iExploitableByPlayer: usize = 0x7E0; // int32
    pub const m_flTouchOutputPerEntityDelay: usize = 0x7E4; // float32
...
pub mod CPhysConstraint {
    ...
    pub const m_forceLimit: usize = 0x4D0; // float32
    pub const m_torqueLimit: usize = 0x4D4; // float32
    pub const m_teleportTick: usize = 0x4D8; // uint32
    pub const m_minTeleportDistance: usize = 0x4DC; // float32
    pub const m_OnBreak: usize = 0x4E0; // CEntityIOOutput
}

pub mod CPhysExplosion {
    pub const m_bExplodeOnSpawn: usize = 0x4B0; // bool
    pub const m_flMagnitude: usize = 0x4B4; // float32
    pub const m_flDamage: usize = 0x4B8; // float32
...
pub mod CPhysForce {
    ...
    pub const m_force: usize = 0x4C0; // float32
    pub const m_forceTime: usize = 0x4C4; // float32
...
pub mod CPhysHinge {
    ...
    pub const m_hingeFriction: usize = 0x62C; // float32
    pub const m_systemLoadScale: usize = 0x630; // float32
    pub const m_bIsAxisLocal: usize = 0x634; // bool
    pub const m_flMinRotation: usize = 0x638; // float32
    pub const m_flMaxRotation: usize = 0x63C; // float32
    pub const m_flInitialRotation: usize = 0x640; // float32
    pub const m_flMotorFrequency: usize = 0x644; // float32
    pub const m_flMotorDampingRatio: usize = 0x648; // float32
    pub const m_flAngleSpeed: usize = 0x64C; // float32
    pub const m_flAngleSpeedThreshold: usize = 0x650; // float32
    pub const m_OnStartMoving: usize = 0x658; // CEntityIOOutput
    pub const m_OnStopMoving: usize = 0x680; // CEntityIOOutput
}

pub mod CPhysImpact {
    pub const m_damage: usize = 0x4B0; // float32
    pub const m_distance: usize = 0x4B4; // float32
...
pub mod CPhysMagnet {
    ...
    pub const m_massScale: usize = 0x8E0; // float32
    pub const m_forceLimit: usize = 0x8E4; // float32
    pub const m_torqueLimit: usize = 0x8E8; // float32
    ...
    pub const m_flTotalMass: usize = 0x90C; // float32
    pub const m_flRadius: usize = 0x910; // float32
    pub const m_flNextSuckTime: usize = 0x914; // GameTime_t
    pub const m_iMaxObjectsAttached: usize = 0x918; // int32
}

pub mod CPhysMotor {
    pub const m_nameAttach: usize = 0x4B0; // CUtlSymbolLarge
    pub const m_hAttachedObject: usize = 0x4B8; // CHandle< CBaseEntity >
    pub const m_spinUp: usize = 0x4BC; // float32
    pub const m_additionalAcceleration: usize = 0x4C0; // float32
    pub const m_angularAcceleration: usize = 0x4C4; // float32
...
pub mod CPhysicsEntitySolver {
    ...
    pub const m_separationDuration: usize = 0x4C0; // float32
...
pub mod CPhysicsProp {
    ...
    pub const m_massScale: usize = 0xB28; // float32
    pub const m_inertiaScale: usize = 0xB2C; // float32
    pub const m_buoyancyScale: usize = 0xB30; // float32
    pub const m_damageType: usize = 0xB34; // int32
    pub const m_damageToEnableMotion: usize = 0xB38; // int32
    pub const m_flForceToEnableMotion: usize = 0xB3C; // float32
    ...
    pub const m_iExploitableByPlayer: usize = 0xB44; // int32
    ...
    pub const m_iInitialGlowState: usize = 0xB50; // int32
    pub const m_nGlowRange: usize = 0xB54; // int32
    pub const m_nGlowRangeMin: usize = 0xB58; // int32
    ...
    pub const m_nCollisionGroupOverride: usize = 0xB70; // int32
}
...
pub mod CPhysicsPropRespawnable {
    ...
    pub const m_flRespawnDuration: usize = 0xBA8; // float32
}
...
pub mod CPhysicsSpring {
    pub const m_flFrequency: usize = 0x4B8; // float32
    pub const m_flDampingRatio: usize = 0x4BC; // float32
    pub const m_flRestLength: usize = 0x4C0; // float32
    ...
    pub const m_teleportTick: usize = 0x4F0; // uint32
}

pub mod CPhysicsWire {
    pub const m_nDensity: usize = 0x4B0; // int32
}

pub mod CPlantedC4 {
    pub const m_bBombTicking: usize = 0x890; // bool
    pub const m_flC4Blow: usize = 0x894; // GameTime_t
    pub const m_nBombSite: usize = 0x898; // int32
    pub const m_nSourceSoundscapeHash: usize = 0x89C; // int32
    ...
    pub const m_iProgressBarTime: usize = 0x968; // int32
...
pub mod CPlayerPing {
    ...
    pub const m_iType: usize = 0x4C0; // int32
    pub const m_bUrgent: usize = 0x4C4; // bool
    pub const m_szPlaceName: usize = 0x4C5; // char[18]
}

pub mod CPlayerSprayDecal {
    pub const m_nUniqueID: usize = 0x700; // int32
    pub const m_unAccountID: usize = 0x704; // uint32
    pub const m_unTraceID: usize = 0x708; // uint32
    pub const m_rtGcTime: usize = 0x70C; // uint32
    ...
    pub const m_nPlayer: usize = 0x740; // int32
    pub const m_nEntity: usize = 0x744; // int32
    pub const m_nHitbox: usize = 0x748; // int32
    pub const m_flCreationTime: usize = 0x74C; // float32
    pub const m_nTintID: usize = 0x750; // int32
    pub const m_nVersion: usize = 0x754; // uint8
    pub const m_ubSignature: usize = 0x755; // uint8[128]
}

pub mod CPlayerVisibility {
    pub const m_flVisibilityStrength: usize = 0x4B0; // float32
    pub const m_flFogDistanceMultiplier: usize = 0x4B4; // float32
    pub const m_flFogMaxDensityMultiplier: usize = 0x4B8; // float32
    pub const m_flFadeTime: usize = 0x4BC; // float32
...
pub mod CPlayer_MovementServices_Humanoid {
    ...
    pub const m_iTargetVolume: usize = 0x20C; // int32
...
pub mod CPointAngleSensor {
    ...
    pub const m_flDuration: usize = 0x4C8; // float32
    pub const m_flDotTolerance: usize = 0x4CC; // float32
...
pub mod CPointAngularVelocitySensor {
    ...
    pub const m_flThreshold: usize = 0x4B4; // float32
    pub const m_nLastCompareResult: usize = 0x4B8; // int32
    pub const m_nLastFireResult: usize = 0x4BC; // int32
    pub const m_flFireTime: usize = 0x4C0; // GameTime_t
    pub const m_flFireInterval: usize = 0x4C4; // float32
    pub const m_flLastAngVelocity: usize = 0x4C8; // float32
...
pub mod CPointCamera {
    pub const m_FOV: usize = 0x4B0; // float32
    pub const m_Resolution: usize = 0x4B4; // float32
    pub const m_bFogEnable: usize = 0x4B8; // bool
    pub const m_FogColor: usize = 0x4B9; // Color
    pub const m_flFogStart: usize = 0x4C0; // float32
    pub const m_flFogEnd: usize = 0x4C4; // float32
    pub const m_flFogMaxDensity: usize = 0x4C8; // float32
    pub const m_bActive: usize = 0x4CC; // bool
    pub const m_bUseScreenAspectRatio: usize = 0x4CD; // bool
    pub const m_flAspectRatio: usize = 0x4D0; // float32
    pub const m_bNoSky: usize = 0x4D4; // bool
    pub const m_fBrightness: usize = 0x4D8; // float32
    pub const m_flZFar: usize = 0x4DC; // float32
    pub const m_flZNear: usize = 0x4E0; // float32
    pub const m_bCanHLTVUse: usize = 0x4E4; // bool
    pub const m_bDofEnabled: usize = 0x4E5; // bool
    pub const m_flDofNearBlurry: usize = 0x4E8; // float32
    pub const m_flDofNearCrisp: usize = 0x4EC; // float32
    pub const m_flDofFarCrisp: usize = 0x4F0; // float32
    pub const m_flDofFarBlurry: usize = 0x4F4; // float32
    pub const m_flDofTiltToGround: usize = 0x4F8; // float32
    pub const m_TargetFOV: usize = 0x4FC; // float32
    pub const m_DegreesPerSecond: usize = 0x500; // float32
    pub const m_bIsOn: usize = 0x504; // bool
    pub const m_pNext: usize = 0x508; // CPointCamera*
}

pub mod CPointCameraVFOV {
    pub const m_flVerticalFOV: usize = 0x510; // float32
}
...
pub mod CPointClientUIWorldPanel {
    ...
    pub const m_flWidth: usize = 0x8B4; // float32
    pub const m_flHeight: usize = 0x8B8; // float32
    pub const m_flDPI: usize = 0x8BC; // float32
    pub const m_flInteractDistance: usize = 0x8C0; // float32
    pub const m_flDepthOffset: usize = 0x8C4; // float32
    pub const m_unOwnerContext: usize = 0x8C8; // uint32
    pub const m_unHorizontalAlign: usize = 0x8CC; // uint32
    pub const m_unVerticalAlign: usize = 0x8D0; // uint32
    pub const m_unOrientation: usize = 0x8D4; // uint32
    ...
    pub const m_nExplicitImageLayout: usize = 0x900; // int32
}
...
pub mod CPointCommentaryNode {
    ...
    pub const m_flStartTimeInCommentary: usize = 0x960; // float32
    pub const m_iszTitle: usize = 0x968; // CUtlSymbolLarge
    pub const m_iszSpeakers: usize = 0x970; // CUtlSymbolLarge
    pub const m_iNodeNumber: usize = 0x978; // int32
    pub const m_iNodeNumberMax: usize = 0x97C; // int32
...
pub mod CPointHurt {
    pub const m_nDamage: usize = 0x4B0; // int32
    pub const m_bitsDamageType: usize = 0x4B4; // int32
...
pub mod CPointPush {
    ...
    pub const m_flMagnitude: usize = 0x4B4; // float32
    pub const m_flRadius: usize = 0x4B8; // float32
    pub const m_flInnerRadius: usize = 0x4BC; // float32
    pub const m_flConeOfInfluence: usize = 0x4C0; // float32
...
pub mod CPointTemplate {
    ...
    pub const m_flTimeoutInterval: usize = 0x4C8; // float32
...
pub mod CPointValueRemapper {
    ...
    pub const m_flMaximumChangePerSecond: usize = 0x4D0; // float32
    pub const m_flDisengageDistance: usize = 0x4D4; // float32
    pub const m_flEngageDistance: usize = 0x4D8; // float32
    ...
    pub const m_flMomentumModifier: usize = 0x528; // float32
    pub const m_flSnapValue: usize = 0x52C; // float32
    pub const m_flCurrentMomentum: usize = 0x530; // float32
    pub const m_nRatchetType: usize = 0x534; // ValueRemapperRatchetType_t
    pub const m_flRatchetOffset: usize = 0x538; // float32
    pub const m_flInputOffset: usize = 0x53C; // float32
    pub const m_bEngaged: usize = 0x540; // bool
    pub const m_bFirstUpdate: usize = 0x541; // bool
    pub const m_flPreviousValue: usize = 0x544; // float32
    ...
    pub const m_flCustomOutputValue: usize = 0x55C; // float32
...
pub mod CPointVelocitySensor {
    ...
    pub const m_fPrevVelocity: usize = 0x4C4; // float32
    pub const m_flAvgInterval: usize = 0x4C8; // float32
...
pub mod CPointWorldText {
    ...
    pub const m_flWorldUnitsPerPx: usize = 0x944; // float32
    pub const m_flFontSize: usize = 0x948; // float32
    pub const m_flDepthOffset: usize = 0x94C; // float32
...
pub mod CPostProcessingVolume {
    ...
    pub const m_flFadeDuration: usize = 0x8C0; // float32
    pub const m_flMinLogExposure: usize = 0x8C4; // float32
    pub const m_flMaxLogExposure: usize = 0x8C8; // float32
    pub const m_flMinExposure: usize = 0x8CC; // float32
    pub const m_flMaxExposure: usize = 0x8D0; // float32
    pub const m_flExposureCompensation: usize = 0x8D4; // float32
    pub const m_flExposureFadeSpeedUp: usize = 0x8D8; // float32
    pub const m_flExposureFadeSpeedDown: usize = 0x8DC; // float32
    pub const m_flTonemapEVSmoothingRange: usize = 0x8E0; // float32
    pub const m_bMaster: usize = 0x8E4; // bool
    pub const m_bExposureControl: usize = 0x8E5; // bool
    pub const m_flRate: usize = 0x8E8; // float32
    pub const m_flTonemapPercentTarget: usize = 0x8EC; // float32
    pub const m_flTonemapPercentBrightPixels: usize = 0x8F0; // float32
    pub const m_flTonemapMinAvgLum: usize = 0x8F4; // float32
}
...
pub mod CProjectedDecal {
    pub const m_nTexture: usize = 0x4B0; // int32
    pub const m_flDistance: usize = 0x4B4; // float32
}

pub mod CPropDoorRotating {
    pub const m_vecAxis: usize = 0xD98; // Vector
    pub const m_flDistance: usize = 0xDA4; // float32
    ...
    pub const m_flAjarAngle: usize = 0xDB4; // float32
...
pub mod CPropDoorRotatingBreakable {
    ...
    pub const m_currentDamageState: usize = 0xE34; // int32
...
pub mod CRagdollManager {
    pub const m_iCurrentMaxRagdollCount: usize = 0x4B0; // int8
    pub const m_iMaxRagdollCount: usize = 0x4B4; // int32
...
pub mod CRagdollProp {
    ...
    pub const m_lastUpdateTickCount: usize = 0x90C; // uint32
    ...
    pub const m_flFadeTime: usize = 0x928; // float32
    ...
    pub const m_nBloodColor: usize = 0x940; // int32
    ...
    pub const m_flBlendWeight: usize = 0x95C; // float32
    pub const m_flDefaultFadeScale: usize = 0x960; // float32
...
pub mod CRagdollPropAttached {
    pub const m_boneIndexAttached: usize = 0xA38; // uint32
    pub const m_ragdollAttachedObjectIndex: usize = 0xA3C; // uint32
...
pub mod CResponseQueue_CDeferredResponse {
    ...
    pub const m_fDispatchTime: usize = 0x40; // float32
...
pub mod CRevertSaved {
    pub const m_loadTime: usize = 0x700; // float32
    pub const m_Duration: usize = 0x704; // float32
    pub const m_HoldTime: usize = 0x708; // float32
}

pub mod CRopeKeyframe {
    pub const m_RopeFlags: usize = 0x708; // uint16
    pub const m_iNextLinkName: usize = 0x710; // CUtlSymbolLarge
    pub const m_Slack: usize = 0x718; // int16
    pub const m_Width: usize = 0x71C; // float32
    pub const m_TextureScale: usize = 0x720; // float32
    pub const m_nSegments: usize = 0x724; // uint8
    ...
    pub const m_Subdiv: usize = 0x738; // uint8
    pub const m_nChangeCount: usize = 0x739; // uint8
    pub const m_RopeLength: usize = 0x73A; // int16
    pub const m_fLockedPoints: usize = 0x73C; // uint8
    pub const m_bCreatedFromMapFile: usize = 0x73D; // bool
    pub const m_flScrollSpeed: usize = 0x740; // float32
...
pub mod CRulePointEntity {
    pub const m_Score: usize = 0x708; // int32
}
...
pub mod CSMatchStats_t {
    ...
    pub const m_iEnemy2Ks: usize = 0x74; // int32
    pub const m_iUtility_Count: usize = 0x78; // int32
    pub const m_iUtility_Successes: usize = 0x7C; // int32
    pub const m_iUtility_Enemies: usize = 0x80; // int32
    pub const m_iFlash_Count: usize = 0x84; // int32
    pub const m_iFlash_Successes: usize = 0x88; // int32
    pub const m_nHealthPointsRemovedTotal: usize = 0x8C; // int32
    pub const m_nHealthPointsDealtTotal: usize = 0x90; // int32
    pub const m_nShotsFiredTotal: usize = 0x94; // int32
    pub const m_nShotsOnTargetTotal: usize = 0x98; // int32
    pub const m_i1v1Count: usize = 0x9C; // int32
    pub const m_i1v1Wins: usize = 0xA0; // int32
    pub const m_i1v2Count: usize = 0xA4; // int32
    pub const m_i1v2Wins: usize = 0xA8; // int32
    pub const m_iEntryCount: usize = 0xAC; // int32
    pub const m_iEntryWins: usize = 0xB0; // int32
}
...
pub mod CSceneEntity {
    ...
    pub const m_nSceneFlushCounter: usize = 0x5A0; // int32
    pub const m_nSceneStringIndex: usize = 0x5A4; // uint16
    ...
    pub const m_nInterruptCount: usize = 0x984; // int32
    ...
    pub const m_BusyActor: usize = 0x9F8; // int32
...
pub mod CSceneEventInfo {
    ...
    pub const m_flInitialYaw: usize = 0x14; // float32
    pub const m_flTargetYaw: usize = 0x18; // float32
    pub const m_flFacingYaw: usize = 0x1C; // float32
    pub const m_nType: usize = 0x20; // int32
    ...
    pub const m_nSceneEventId: usize = 0x58; // uint32
...
pub mod CScriptedSequence {
    ...
    pub const m_flRepeat: usize = 0x504; // float32
    pub const m_flPlayAnimFadeInTime: usize = 0x508; // float32
    pub const m_flMoveInterpTime: usize = 0x50C; // float32
    pub const m_flAngRate: usize = 0x510; // float32
    pub const m_iDelay: usize = 0x514; // int32
    pub const m_startTime: usize = 0x518; // GameTime_t
    pub const m_bWaitForBeginSequence: usize = 0x51C; // bool
    pub const m_saved_effects: usize = 0x520; // int32
    pub const m_savedFlags: usize = 0x524; // int32
    pub const m_savedCollisionGroup: usize = 0x528; // int32
    ...
    pub const m_iPlayerDeathBehavior: usize = 0x7B4; // int32
}

pub mod CSensorGrenadeProjectile {
    pub const m_fExpireTime: usize = 0xA28; // GameTime_t
    pub const m_fNextDetectPlayerSound: usize = 0xA2C; // GameTime_t
    pub const m_hDisplayGrenade: usize = 0xA30; // CHandle< CBaseEntity >
}
...
pub mod CShatterGlassShardPhysics {
    ...
    pub const m_hParentShard: usize = 0xB7C; // uint32
...
pub mod CSmokeGrenadeProjectile {
    pub const m_nSmokeEffectTickBegin: usize = 0xA40; // int32
    pub const m_bDidSmokeEffect: usize = 0xA44; // bool
    pub const m_nRandomSeed: usize = 0xA48; // int32
...
pub mod CSoundAreaEntitySphere {
    pub const m_flRadius: usize = 0x4D0; // float32
}

pub mod CSoundEnt {
    pub const m_iFreeSound: usize = 0x4B0; // int32
    pub const m_iActiveSound: usize = 0x4B4; // int32
    pub const m_cLastActiveSounds: usize = 0x4B8; // int32
...
pub mod CSoundEventEntity {
    ...
    pub const m_flSavedElapsedTime: usize = 0x4B8; // float32
...
pub mod CSoundEventParameter {
    ...
    pub const m_flFloatValue: usize = 0x4C0; // float32
}
...
pub mod CSoundOpvarSetAABBEntity {
    ...
    pub const m_nAABBDirection: usize = 0x678; // int32
...
pub mod CSoundOpvarSetEntity {
    ...
    pub const m_nOpvarType: usize = 0x4D0; // int32
    pub const m_nOpvarIndex: usize = 0x4D4; // int32
    pub const m_flOpvarValue: usize = 0x4D8; // float32
...
pub mod CSoundOpvarSetOBBWindEntity {
    ...
    pub const m_flWindMin: usize = 0x578; // float32
    pub const m_flWindMax: usize = 0x57C; // float32
    pub const m_flWindMapMin: usize = 0x580; // float32
    pub const m_flWindMapMax: usize = 0x584; // float32
}

pub mod CSoundOpvarSetPathCornerEntity {
    pub const m_flDistMinSqr: usize = 0x660; // float32
    pub const m_flDistMaxSqr: usize = 0x664; // float32
...
pub mod CSoundOpvarSetPointBase {
    ...
    pub const m_iOpvarIndex: usize = 0x540; // int32
...
pub mod CSoundOpvarSetPointEntity {
    ...
    pub const m_flDistanceMin: usize = 0x5DC; // float32
    pub const m_flDistanceMax: usize = 0x5E0; // float32
    pub const m_flDistanceMapMin: usize = 0x5E4; // float32
    pub const m_flDistanceMapMax: usize = 0x5E8; // float32
    pub const m_flOcclusionRadius: usize = 0x5EC; // float32
    pub const m_flOcclusionMin: usize = 0x5F0; // float32
    pub const m_flOcclusionMax: usize = 0x5F4; // float32
    pub const m_flValSetOnDisable: usize = 0x5F8; // float32
    pub const m_bSetValueOnDisable: usize = 0x5FC; // bool
    pub const m_nSimulationMode: usize = 0x600; // int32
    pub const m_nVisibilitySamples: usize = 0x604; // int32
    pub const m_vDynamicProxyPoint: usize = 0x608; // Vector
    pub const m_flDynamicMaximumOcclusion: usize = 0x614; // float32
    pub const m_hDynamicEntity: usize = 0x618; // CEntityHandle
    pub const m_iszDynamicEntityName: usize = 0x620; // CUtlSymbolLarge
    pub const m_flPathingDistanceNormFactor: usize = 0x628; // float32
    pub const m_vPathingSourcePos: usize = 0x62C; // Vector
    pub const m_vPathingListenerPos: usize = 0x638; // Vector
    pub const m_nPathingSourceIndex: usize = 0x644; // int32
}
...
pub mod CSpotlightEnd {
    pub const m_flLightScale: usize = 0x700; // float32
    pub const m_Radius: usize = 0x704; // float32
...
pub mod CSprite {
    ...
    pub const m_flSpriteFramerate: usize = 0x710; // float32
    pub const m_flFrame: usize = 0x714; // float32
    pub const m_flDieTime: usize = 0x718; // GameTime_t
    pub const m_nBrightness: usize = 0x728; // uint32
    pub const m_flBrightnessDuration: usize = 0x72C; // float32
    pub const m_flSpriteScale: usize = 0x730; // float32
    pub const m_flScaleDuration: usize = 0x734; // float32
    pub const m_bWorldSpaceScale: usize = 0x738; // bool
    pub const m_flGlowProxySize: usize = 0x73C; // float32
    pub const m_flHDRColorScale: usize = 0x740; // float32
    pub const m_flLastTime: usize = 0x744; // GameTime_t
    pub const m_flMaxFrame: usize = 0x748; // float32
    pub const m_flStartScale: usize = 0x74C; // float32
    pub const m_flDestScale: usize = 0x750; // float32
    pub const m_flScaleTimeStart: usize = 0x754; // GameTime_t
    pub const m_nStartBrightness: usize = 0x758; // int32
    pub const m_nDestBrightness: usize = 0x75C; // int32
    pub const m_flBrightnessTimeStart: usize = 0x760; // GameTime_t
    pub const m_nSpriteWidth: usize = 0x764; // int32
    pub const m_nSpriteHeight: usize = 0x768; // int32
}
...
pub mod CSun {
    ...
    pub const m_flSize: usize = 0x724; // float32
    pub const m_flRotation: usize = 0x728; // float32
    pub const m_flHazeScale: usize = 0x72C; // float32
    pub const m_flAlphaHaze: usize = 0x730; // float32
    pub const m_flAlphaHdr: usize = 0x734; // float32
    pub const m_flAlphaScale: usize = 0x738; // float32
    pub const m_flHDRColorScale: usize = 0x73C; // float32
    pub const m_flFarZScale: usize = 0x740; // float32
}
...
pub mod CTankTrainAI {
    ...
    pub const m_hTargetEntity: usize = 0x4B4; // CHandle< CBaseEntity >
    pub const m_soundPlaying: usize = 0x4B8; // int32
...
pub mod CTeam {
    ...
    pub const m_iScore: usize = 0x4E0; // int32
    pub const m_szTeamname: usize = 0x4E4; // char[129]
}

pub mod CTestEffect {
    pub const m_iLoop: usize = 0x4B0; // int32
    pub const m_iBeam: usize = 0x4B4; // int32
...
pub mod CTextureBasedAnimatable {
    ...
    pub const m_flFPS: usize = 0x704; // float32
    ...
    pub const m_flStartTime: usize = 0x730; // float32
    pub const m_flStartFrame: usize = 0x734; // float32
}
...
pub mod CTimerEntity {
    ...
    pub const m_iDisabled: usize = 0x528; // int32
    pub const m_flInitialDelay: usize = 0x52C; // float32
    pub const m_flRefireTime: usize = 0x530; // float32
    pub const m_bUpDownState: usize = 0x534; // bool
    pub const m_iUseRandomTime: usize = 0x538; // int32
    pub const m_bPauseAfterFiring: usize = 0x53C; // bool
    pub const m_flLowerRandomBound: usize = 0x540; // float32
    pub const m_flUpperRandomBound: usize = 0x544; // float32
    pub const m_flRemainingTime: usize = 0x548; // float32
    pub const m_bPaused: usize = 0x54C; // bool
}

pub mod CTonemapController2 {
    pub const m_flAutoExposureMin: usize = 0x4B0; // float32
    pub const m_flAutoExposureMax: usize = 0x4B4; // float32
    pub const m_flTonemapPercentTarget: usize = 0x4B8; // float32
    pub const m_flTonemapPercentBrightPixels: usize = 0x4BC; // float32
    pub const m_flTonemapMinAvgLum: usize = 0x4C0; // float32
    pub const m_flExposureAdaptationSpeedUp: usize = 0x4C4; // float32
    pub const m_flExposureAdaptationSpeedDown: usize = 0x4C8; // float32
    pub const m_flTonemapEVSmoothingRange: usize = 0x4CC; // float32
}
...
pub mod CTriggerBuoyancy {
    ...
    pub const m_flFluidDensity: usize = 0x8C8; // float32
}
...
pub mod CTriggerFan {
    ...
    pub const m_flForce: usize = 0x8CC; // float32
    pub const m_flPlayerForce: usize = 0x8D0; // float32
    pub const m_flRampTime: usize = 0x8D4; // float32
...
pub mod CTriggerHurt {
    pub const m_flOriginalDamage: usize = 0x8A8; // float32
    pub const m_flDamage: usize = 0x8AC; // float32
    pub const m_flDamageCap: usize = 0x8B0; // float32
    pub const m_flLastDmgTime: usize = 0x8B4; // GameTime_t
    pub const m_flForgivenessDelay: usize = 0x8B8; // float32
    pub const m_bitsDamageInflict: usize = 0x8BC; // int32
    pub const m_damageModel: usize = 0x8C0; // int32
    ...
    pub const m_hurtThinkPeriod: usize = 0x8D8; // float32
...
pub mod CTriggerImpact {
    pub const m_flMagnitude: usize = 0x8D0; // float32
    pub const m_flNoise: usize = 0x8D4; // float32
    pub const m_flViewkick: usize = 0x8D8; // float32
...
pub mod CTriggerLerpObject {
    ...
    pub const m_flLerpDuration: usize = 0x8C4; // float32
...
pub mod CTriggerLook {
    ...
    pub const m_flFieldOfView: usize = 0x8D4; // float32
    pub const m_flLookTime: usize = 0x8D8; // float32
    pub const m_flLookTimeTotal: usize = 0x8DC; // float32
    pub const m_flLookTimeLast: usize = 0x8E0; // GameTime_t
    pub const m_flTimeoutDuration: usize = 0x8E4; // float32
...
pub mod CTriggerPhysics {
    pub const m_gravityScale: usize = 0x8B8; // float32
    pub const m_linearLimit: usize = 0x8BC; // float32
    pub const m_linearDamping: usize = 0x8C0; // float32
    pub const m_angularLimit: usize = 0x8C4; // float32
    pub const m_angularDamping: usize = 0x8C8; // float32
    pub const m_linearForce: usize = 0x8CC; // float32
    pub const m_flFrequency: usize = 0x8D0; // float32
    pub const m_flDampingRatio: usize = 0x8D4; // float32
...
pub mod CTriggerProximity {
    ...
    pub const m_fRadius: usize = 0x8B8; // float32
    pub const m_nTouchers: usize = 0x8BC; // int32
...
pub mod CTriggerPush {
    ...
    pub const m_flAlternateTicksFix: usize = 0x8C4; // float32
    pub const m_flPushSpeed: usize = 0x8C8; // float32
}
...
pub mod CTriggerSave {
    ...
    pub const m_fDangerousTimer: usize = 0x8AC; // float32
    pub const m_minHitPoints: usize = 0x8B0; // int32
}
...
pub mod CTriggerSndSosOpvar {
    ...
    pub const m_flCenterSize: usize = 0x8CC; // float32
    pub const m_flMinVal: usize = 0x8D0; // float32
    pub const m_flMaxVal: usize = 0x8D4; // float32
    pub const m_flWait: usize = 0x8D8; // float32
    ...
    pub const m_flNormCenterSize: usize = 0xC08; // float32
}
...
pub mod CVoteController {
    pub const m_iActiveIssueIndex: usize = 0x4B0; // int32
    pub const m_iOnlyTeamToVote: usize = 0x4B4; // int32
    pub const m_nVoteOptionCount: usize = 0x4B8; // int32[5]
    pub const m_nPotentialVotes: usize = 0x4CC; // int32
    ...
    pub const m_nHighestCountIndex: usize = 0x628; // int32
...
pub mod CWeaponShield {
    pub const m_flBulletDamageAbsorbed: usize = 0xDF8; // float32
    pub const m_flLastBulletHitSoundTime: usize = 0xDFC; // GameTime_t
    pub const m_flDisplayHealth: usize = 0xE00; // float32
}
...
pub mod FilterDamageType {
    pub const m_iDamageType: usize = 0x508; // int32
}

pub mod FilterHealth {
    pub const m_bAdrenalineActive: usize = 0x508; // bool
    pub const m_iHealthMin: usize = 0x50C; // int32
    pub const m_iHealthMax: usize = 0x510; // int32
}

pub mod FilterTeam {
    pub const m_iFilterTeam: usize = 0x508; // int32
}
...
pub mod SpawnPoint {
    pub const m_iPriority: usize = 0x4B0; // int32
    pub const m_bEnabled: usize = 0x4B4; // bool
    pub const m_nType: usize = 0x4B8; // int32
}
