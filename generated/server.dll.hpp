...
namespace CPointCamera {
    ...
    constexpr std::ptrdiff_t m_bDofEnabled = 0x4e4;
...
namespace CInfoArmsRaceCounterterrorist {
}

namespace CInfoArmsRaceTerrorist {
}
...
namespace CInfoGasCanisterLaunchPoint {
}
...
namespace CTabletBlockerShim {
}

namespace CTabletBlocker {
}
...
namespace CTriggerCustomBounds {
}

namespace CTriggerSurvivalPlayArea {
}
...
namespace CPhysPropWeaponRefillHeavyArmor {
}

namespace CPhysPropWeaponUpgradeArmor {
}

namespace CPhysPropWeaponUpgradeHelmet {
}

namespace CPhysPropWeaponUpgradeArmorHelmet {
}

namespace CPhysPropWeaponUpgradeParachute {
}

namespace CPhysPropWeaponUpgradeContractKill {
}
...
namespace CPhysPropWeaponUpgradeTablet {
}

namespace CPhysPropWeaponUpgradeTabletHighres {
}

namespace CPhysPropWeaponUpgradeTabletZoneIntel {
}

namespace CPhysPropWeaponUpgradeTabletDroneIntel {
}
...
namespace CCSPlayerPawnBase {
    ...
    constexpr std::ptrdiff_t m_pIntroCamera = 0x1260;
    constexpr std::ptrdiff_t m_fIntroCamTime = 0x1264;
    constexpr std::ptrdiff_t m_nMyCollisionGroup = 0x1268;
    constexpr std::ptrdiff_t m_bInBombZone = 0x126c;
    constexpr std::ptrdiff_t m_bInBuyZone = 0x126d;
    constexpr std::ptrdiff_t m_bInNoDefuseArea = 0x126e;
    constexpr std::ptrdiff_t m_bKilledByTaser = 0x126f;
    constexpr std::ptrdiff_t m_iMoveState = 0x1270;
    constexpr std::ptrdiff_t m_nPreviousModelIndex = 0x1278;
    constexpr std::ptrdiff_t m_grenadeParameterStashTime = 0x1280;
    constexpr std::ptrdiff_t m_bGrenadeParametersStashed = 0x1284;
    constexpr std::ptrdiff_t m_angStashedShootAngles = 0x1288;
    constexpr std::ptrdiff_t m_vecStashedGrenadeThrowPosition = 0x1294;
    constexpr std::ptrdiff_t m_vecStashedVelocity = 0x12a0;
    constexpr std::ptrdiff_t m_angShootAngleHistory = 0x12ac;
    constexpr std::ptrdiff_t m_vecThrowPositionHistory = 0x12c4;
    constexpr std::ptrdiff_t m_vecVelocityHistory = 0x12dc;
    constexpr std::ptrdiff_t m_nCharacterDefIndex = 0x12f4;
    constexpr std::ptrdiff_t m_bDiedAirborne = 0x12f6;
    constexpr std::ptrdiff_t m_iBombSiteIndex = 0x12f8;
    constexpr std::ptrdiff_t m_nWhichBombZone = 0x12fc;
    constexpr std::ptrdiff_t m_bInBombZoneTrigger = 0x1300;
    constexpr std::ptrdiff_t m_bWasInBombZoneTrigger = 0x1301;
    constexpr std::ptrdiff_t m_bWasInHostageRescueZone = 0x1302;
    constexpr std::ptrdiff_t m_bWasInBuyZone = 0x1303;
    constexpr std::ptrdiff_t m_bInHostageRescueZone = 0x1304;
    constexpr std::ptrdiff_t m_flStamina = 0x1308;
    constexpr std::ptrdiff_t m_iDirection = 0x130c;
    constexpr std::ptrdiff_t m_iShotsFired = 0x1310;
    constexpr std::ptrdiff_t m_ArmorValue = 0x1314;
    constexpr std::ptrdiff_t m_flFlinchStack = 0x1318;
    constexpr std::ptrdiff_t m_flVelocityModifier = 0x131c;
    constexpr std::ptrdiff_t m_flHitHeading = 0x1320;
    constexpr std::ptrdiff_t m_nHitBodyPart = 0x1324;
    constexpr std::ptrdiff_t m_iHostagesKilled = 0x1328;
    constexpr std::ptrdiff_t m_vecTotalBulletForce = 0x132c;
    constexpr std::ptrdiff_t m_flFlashDuration = 0x1338;
    constexpr std::ptrdiff_t m_flFlashMaxAlpha = 0x133c;
    constexpr std::ptrdiff_t m_flProgressBarStartTime = 0x1340;
    constexpr std::ptrdiff_t m_iProgressBarDuration = 0x1344;
    constexpr std::ptrdiff_t m_bWaitForNoAttack = 0x1348;
    constexpr std::ptrdiff_t m_flLowerBodyYawTarget = 0x134c;
    constexpr std::ptrdiff_t m_bStrafing = 0x1350;
    constexpr std::ptrdiff_t m_lastStandingPos = 0x1354;
    constexpr std::ptrdiff_t m_ignoreLadderJumpTime = 0x1360;
    constexpr std::ptrdiff_t m_ladderSurpressionTimer = 0x1368;
    constexpr std::ptrdiff_t m_lastLadderNormal = 0x1380;
    constexpr std::ptrdiff_t m_lastLadderPos = 0x138c;
    constexpr std::ptrdiff_t m_thirdPersonHeading = 0x1398;
    constexpr std::ptrdiff_t m_flSlopeDropOffset = 0x13a4;
    constexpr std::ptrdiff_t m_flSlopeDropHeight = 0x13a8;
    constexpr std::ptrdiff_t m_vHeadConstraintOffset = 0x13ac;
    constexpr std::ptrdiff_t m_iLastWeaponFireUsercmd = 0x13c0;
    constexpr std::ptrdiff_t m_angEyeAngles = 0x13c4;
    constexpr std::ptrdiff_t m_bVCollisionInitted = 0x13d0;
    constexpr std::ptrdiff_t m_storedSpawnPosition = 0x13d4;
    constexpr std::ptrdiff_t m_storedSpawnAngle = 0x13e0;
    constexpr std::ptrdiff_t m_bIsSpawning = 0x13ec;
    constexpr std::ptrdiff_t m_bHideTargetID = 0x13ed;
    constexpr std::ptrdiff_t m_nNumDangerZoneDamageHits = 0x13f0;
    constexpr std::ptrdiff_t m_bHud_MiniScoreHidden = 0x13f4;
    constexpr std::ptrdiff_t m_bHud_RadarHidden = 0x13f5;
    constexpr std::ptrdiff_t m_nLastKillerIndex = 0x13f8;
    constexpr std::ptrdiff_t m_nLastConcurrentKilled = 0x13fc;
    constexpr std::ptrdiff_t m_nDeathCamMusic = 0x1400;
    constexpr std::ptrdiff_t m_iAddonBits = 0x1404;
    constexpr std::ptrdiff_t m_iPrimaryAddon = 0x1408;
    constexpr std::ptrdiff_t m_iSecondaryAddon = 0x140c;
    constexpr std::ptrdiff_t m_nTeamDamageGivenForMatch = 0x1410;
    constexpr std::ptrdiff_t m_bTDGaveProtectionWarning = 0x1414;
    constexpr std::ptrdiff_t m_bTDGaveProtectionWarningThisRound = 0x1415;
    constexpr std::ptrdiff_t m_flLastTHWarningTime = 0x1418;
    constexpr std::ptrdiff_t m_currentDeafnessFilter = 0x141c;
    constexpr std::ptrdiff_t m_enemyPlayersKilledThisRound = 0x1420;
    constexpr std::ptrdiff_t m_NumEnemiesKilledThisSpawn = 0x1438;
    constexpr std::ptrdiff_t m_maxNumEnemiesKillStreak = 0x143c;
    constexpr std::ptrdiff_t m_NumEnemiesKilledThisRound = 0x1440;
    constexpr std::ptrdiff_t m_NumEnemiesAtRoundStart = 0x1444;
    constexpr std::ptrdiff_t m_iRoundsWon = 0x1448;
    constexpr std::ptrdiff_t m_lastRoundResult = 0x144c;
    constexpr std::ptrdiff_t m_wasNotKilledNaturally = 0x1450;
    constexpr std::ptrdiff_t m_vecPlayerPatchEconIndices = 0x1454;
    constexpr std::ptrdiff_t m_iDeathFlags = 0x1468;
    constexpr std::ptrdiff_t m_hPet = 0x146c;
    constexpr std::ptrdiff_t m_unCurrentEquipmentValue = 0x1638;
    constexpr std::ptrdiff_t m_unRoundStartEquipmentValue = 0x163a;
    constexpr std::ptrdiff_t m_unFreezetimeEndEquipmentValue = 0x163c;
    constexpr std::ptrdiff_t m_szLastPlaceName = 0x163e;
    constexpr std::ptrdiff_t m_nSuicides = 0x1650;
    constexpr std::ptrdiff_t m_nSurvivalTeamNumber = 0x1654;
    constexpr std::ptrdiff_t m_aimPunchAngle = 0x1658;
    constexpr std::ptrdiff_t m_aimPunchAngleVel = 0x1664;
    constexpr std::ptrdiff_t m_aimPunchTickBase = 0x1670;
    constexpr std::ptrdiff_t m_aimPunchTickFraction = 0x1674;
    constexpr std::ptrdiff_t m_aimPunchCache = 0x1678;
    constexpr std::ptrdiff_t m_bHasDeathInfo = 0x1690;
    constexpr std::ptrdiff_t m_flDeathInfoTime = 0x1694;
    constexpr std::ptrdiff_t m_vecDeathInfoOrigin = 0x1698;
    constexpr std::ptrdiff_t m_bKilledByHeadshot = 0x16a4;
    constexpr std::ptrdiff_t m_LastHitBox = 0x16a8;
    constexpr std::ptrdiff_t m_LastHealth = 0x16ac;
    constexpr std::ptrdiff_t m_flLastCollisionCeiling = 0x16b0;
    constexpr std::ptrdiff_t m_flLastCollisionCeilingChangeTime = 0x16b4;
    constexpr std::ptrdiff_t m_strVOPrefix = 0x16b8;
    constexpr std::ptrdiff_t m_flLandseconds = 0x16c0;
    constexpr std::ptrdiff_t m_pBot = 0x16c8;
    constexpr std::ptrdiff_t m_bBotAllowActive = 0x16d0;
...
namespace CCSPlayerPawn {
    constexpr std::ptrdiff_t m_pParachuteServices = 0x16d8;
    constexpr std::ptrdiff_t m_pBulletServices = 0x16e0;
    constexpr std::ptrdiff_t m_pHostageServices = 0x16e8;
    constexpr std::ptrdiff_t m_pBuyServices = 0x16f0;
    constexpr std::ptrdiff_t m_pPingServices = 0x16f8;
    constexpr std::ptrdiff_t m_pRadioServices = 0x1700;
    constexpr std::ptrdiff_t m_pDamageReactServices = 0x1708;
    constexpr std::ptrdiff_t m_iRetakesOffering = 0x17d8;
    constexpr std::ptrdiff_t m_iRetakesOfferingCard = 0x17dc;
    constexpr std::ptrdiff_t m_bRetakesHasDefuseKit = 0x17e0;
    constexpr std::ptrdiff_t m_bRetakesMVPLastRound = 0x17e1;
    constexpr std::ptrdiff_t m_iRetakesMVPBoostItem = 0x17e4;
    constexpr std::ptrdiff_t m_RetakesMVPBoostExtraUtility = 0x17e8;
    constexpr std::ptrdiff_t m_bIsBuyMenuOpen = 0x17ec;
