...
namespace cs2_dumper {
    namespace offsets {
        ...
        namespace client_dll {
            constexpr std::ptrdiff_t dwCSGOInput = 0x1E39140;
            constexpr std::ptrdiff_t dwEntityList = 0x1D10CF8;
            constexpr std::ptrdiff_t dwGameEntitySystem = 0x1FB59E0;
            ...
            constexpr std::ptrdiff_t dwSensitivity = 0x1E2BD08;
            constexpr std::ptrdiff_t dwSensitivity_sensitivity = 0x50;
            constexpr std::ptrdiff_t dwViewAngles = 0x1E397F0;
            constexpr std::ptrdiff_t dwViewMatrix = 0x1E2F3D0;
            constexpr std::ptrdiff_t dwViewRender = 0x1E2FF48;
            constexpr std::ptrdiff_t dwWeaponC4 = 0x1DCC030;
        }
        // Module: engine2.dll
        namespace engine2_dll {
            constexpr std::ptrdiff_t dwBuildNumber = 0x5F03F4;
            ...
            constexpr std::ptrdiff_t dwWindowHeight = 0x8EE814;
            constexpr std::ptrdiff_t dwWindowWidth = 0x8EE810;
        }
