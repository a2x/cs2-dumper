...
namespace CS2Dumper.Schemas {
    ...
    public static class ClientDll {
        // Alignment: 8
        // Member count: 0
        public enum CFuncTrackAuto : ulong {

        }
        // Alignment: 8
        // Member count: 15
        public enum CEnvExplosion : ulong {
             = 0x0,
             = 0x0,
             = 0x0,
             = 0x0,
        ...
        // Alignment: 8
        // Member count: 0
        public enum CFuncLadderAlias_func_useableladder : ulong {

        }
        // Alignment: 8
        // Member count: 9
        public enum CFuncTrackChange : ulong {
             = 0x0,
             = 0x0,
             = 0x0,
             = 0x0,
        ...
        // Alignment: 8
        // Member count: 1
        public enum CMarkupVolumeTagged_Nav : ulong {
             = 0x0
        }
        // Alignment: 4
        // Member count: 0
        public enum CHandleDummy : uint {

        }
        // Alignment: 4
        // Member count: 0
        public enum CInfoTarget : uint {

        }
        // Alignment: 8
        // Member count: 4
        public enum CLogicNPCCounterAABB : ulong {
             = 0x0,
             = 0x0,
             = 0x0,
             = 0x0
        ...
        // Alignment: 4
        // Member count: 0
        public enum CPointClientCommand : uint {

        }
        // Alignment: 4
        // Member count: 1
        public enum CPointGiveAmmo : uint {
             = 0x0
        }
        // Alignment: 8
        // Member count: 10
        public enum CEntityDissolve : ulong {
             = 0x0,
             = 0x0,
             = 0x0,
             = 0x0,
        ...
        // Alignment: 8
        // Member count: 4
        public enum CMarkupVolumeWithRef : ulong {
             = 0x0,
             = 0x0,
             = 0x0,
             = 0x0
        ...
        // Alignment: 8
        // Member count: 0
        public enum CSpriteAlias_env_glow : ulong {

        }
        // Alignment: 8
        // Member count: 5
        public enum CEnvLaser : ulong {
             = 0x0,
             = 0x0,
             = 0x0,
             = 0x0,
        ...
        // Alignment: 4
        // Member count: 0
        public enum CFuncPropRespawnZone : uint {

        }
        // Alignment: 8
        // Member count: 14
        public enum CCSTeam : ulong {
             = 0x0,
             = 0x0,
             = 0x0,
             = 0x0,
        ...
        // Alignment: 4
        // Member count: 1
        public enum CEnvHudHint : uint {
             = 0x0
        }
        // Alignment: 4
        // Member count: 0
        public enum CInfoTargetServerOnly : uint {
