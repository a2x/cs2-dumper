    ...
    namespace schemas {
        ...
        namespace client_dll {
            ...
            namespace CCSPlayer_MovementServices {
                ...
                constexpr std::ptrdiff_t m_flGroundMoveEfficiency = 0x47C; // 
                constexpr std::ptrdiff_t m_nOldWaterLevel = 0x480; // 
                constexpr std::ptrdiff_t m_flWaterEntryTime = 0x484; // 
                constexpr std::ptrdiff_t m_vecForward = 0x488; // 
                constexpr std::ptrdiff_t m_vecLeft = 0x494; // 
                constexpr std::ptrdiff_t m_vecUp = 0x4A0; // 
                constexpr std::ptrdiff_t m_nGameCodeHasMovedPlayerAfterCommand = 0x4AC; // 
                constexpr std::ptrdiff_t m_bOldJumpPressed = 0x4B0; // 
                constexpr std::ptrdiff_t m_flJumpPressedTime = 0x4B4; // 
                constexpr std::ptrdiff_t m_flJumpUntil = 0x4B8; // 
                constexpr std::ptrdiff_t m_flJumpVel = 0x4BC; // 
                constexpr std::ptrdiff_t m_fStashGrenadeParameterWhen = 0x4C0; // 
                constexpr std::ptrdiff_t m_nButtonDownMaskPrev = 0x4C8; // 
                constexpr std::ptrdiff_t m_flOffsetTickCompleteTime = 0x4D0; // 
                constexpr std::ptrdiff_t m_flOffsetTickStashedSpeed = 0x4D4; // 
                constexpr std::ptrdiff_t m_flStamina = 0x4D8; // 
                constexpr std::ptrdiff_t m_flHeightAtJumpStart = 0x4DC; // 
                constexpr std::ptrdiff_t m_flMaxJumpHeightThisJump = 0x4E0; // 
                constexpr std::ptrdiff_t m_flMaxJumpHeightLastJump = 0x4E4; // 
            }
            // Parent: None
            // Field count: 6
            //
            ...
            // Field count: 1
            namespace C_Item {
                constexpr std::ptrdiff_t m_pReticleHintTextName = 0x1660; // 
            }
            ...
            namespace C_BaseModelEntity {
                ...
                constexpr std::ptrdiff_t m_bInitModelEffects = 0xAA0; // 
                constexpr std::ptrdiff_t m_bIsStaticProp = 0xAA1; // 
                constexpr std::ptrdiff_t m_nLastAddDecal = 0xAA4; // 
                constexpr std::ptrdiff_t m_nDecalsAdded = 0xAA8; // 
                constexpr std::ptrdiff_t m_iOldHealth = 0xAAC; // 
                constexpr std::ptrdiff_t m_nRenderMode = 0xAB0; // 
                constexpr std::ptrdiff_t m_nRenderFX = 0xAB1; // 
                constexpr std::ptrdiff_t m_bAllowFadeInView = 0xAB2; // 
                constexpr std::ptrdiff_t m_clrRender = 0xAD0; // 
                constexpr std::ptrdiff_t m_vecRenderAttributes = 0xAD8; // 
                constexpr std::ptrdiff_t m_bRenderToCubemaps = 0xB40; // 
                constexpr std::ptrdiff_t m_bNoInterpolate = 0xB41; // 
                constexpr std::ptrdiff_t m_Collision = 0xB48; // 
                constexpr std::ptrdiff_t m_Glow = 0xBF8; // 
                constexpr std::ptrdiff_t m_flGlowBackfaceMult = 0xC50; // 
                constexpr std::ptrdiff_t m_fadeMinDist = 0xC54; // 
                constexpr std::ptrdiff_t m_fadeMaxDist = 0xC58; // 
                constexpr std::ptrdiff_t m_flFadeScale = 0xC5C; // 
                constexpr std::ptrdiff_t m_flShadowStrength = 0xC60; // 
                constexpr std::ptrdiff_t m_nObjectCulling = 0xC64; // 
                constexpr std::ptrdiff_t m_nAddDecal = 0xC68; // 
                constexpr std::ptrdiff_t m_vDecalPosition = 0xC6C; // 
                constexpr std::ptrdiff_t m_vDecalForwardAxis = 0xC78; // 
                constexpr std::ptrdiff_t m_flDecalHealBloodRate = 0xC84; // 
                constexpr std::ptrdiff_t m_flDecalHealHeightRate = 0xC88; // 
                constexpr std::ptrdiff_t m_ConfigEntitiesToPropagateMaterialDecalsTo = 0xC90; // 
                constexpr std::ptrdiff_t m_vecViewOffset = 0xCA8; // 
                constexpr std::ptrdiff_t m_pClientAlphaProperty = 0xCD8; // 
                constexpr std::ptrdiff_t m_ClientOverrideTint = 0xCE0; // 
                constexpr std::ptrdiff_t m_bUseClientOverrideTint = 0xCE4; // 
            }
            // Parent: C_BaseTrigger
            // Field count: 2
            //
            ...
            namespace C_FootstepControl {
                constexpr std::ptrdiff_t m_source = 0xD28; // 
                constexpr std::ptrdiff_t m_destination = 0xD30; // 
            }
            ...
            namespace C_PointClientUIHUD {
                constexpr std::ptrdiff_t m_bCheckCSSClasses = 0xD58; // 
                constexpr std::ptrdiff_t m_bIgnoreInput = 0xED8; // 
                constexpr std::ptrdiff_t m_flWidth = 0xEDC; // 
                constexpr std::ptrdiff_t m_flHeight = 0xEE0; // 
                constexpr std::ptrdiff_t m_flDPI = 0xEE4; // 
                constexpr std::ptrdiff_t m_flInteractDistance = 0xEE8; // 
                constexpr std::ptrdiff_t m_flDepthOffset = 0xEEC; // 
                constexpr std::ptrdiff_t m_unOwnerContext = 0xEF0; // 
                constexpr std::ptrdiff_t m_unHorizontalAlign = 0xEF4; // 
                constexpr std::ptrdiff_t m_unVerticalAlign = 0xEF8; // 
                constexpr std::ptrdiff_t m_unOrientation = 0xEFC; // 
                constexpr std::ptrdiff_t m_bAllowInteractionFromAllSceneWorlds = 0xF00; // 
            ...
            namespace C_SpotlightEnd {
                constexpr std::ptrdiff_t m_flLightScale = 0xD20; // 
                constexpr std::ptrdiff_t m_Radius = 0xD24; // 
            }
            // Parent: None
            // Field count: 5
            //
            ...
            namespace C_BaseCombatCharacter {
                constexpr std::ptrdiff_t m_hMyWearables = 0x1118; // 
                constexpr std::ptrdiff_t m_leftFootAttachment = 0x1130; // 
                constexpr std::ptrdiff_t m_rightFootAttachment = 0x1131; // 
                constexpr std::ptrdiff_t m_nWaterWakeMode = 0x1134; // 
                constexpr std::ptrdiff_t m_flWaterWorldZ = 0x1138; // 
                constexpr std::ptrdiff_t m_flWaterNextTraceTime = 0x113C; // 
            }
            ...
            namespace C_BaseCSGrenade {
                constexpr std::ptrdiff_t m_bClientPredictDelete = 0x1B00; // 
                constexpr std::ptrdiff_t m_bRedraw = 0x1B01; // 
                constexpr std::ptrdiff_t m_bIsHeldByPlayer = 0x1B02; // 
                constexpr std::ptrdiff_t m_bPinPulled = 0x1B03; // 
                constexpr std::ptrdiff_t m_bJumpThrow = 0x1B04; // 
                constexpr std::ptrdiff_t m_bThrowAnimating = 0x1B05; // 
                constexpr std::ptrdiff_t m_fThrowTime = 0x1B08; // 
                constexpr std::ptrdiff_t m_flThrowStrength = 0x1B0C; // 
                constexpr std::ptrdiff_t m_flThrowStrengthApproach = 0x1B10; // 
                constexpr std::ptrdiff_t m_fDropTime = 0x1B14; // 
                constexpr std::ptrdiff_t m_fPinPullTime = 0x1B18; // 
                constexpr std::ptrdiff_t m_bJustPulledPin = 0x1B1C; // 
                constexpr std::ptrdiff_t m_nNextHoldTick = 0x1B20; // 
                constexpr std::ptrdiff_t m_flNextHoldFrac = 0x1B24; // 
                constexpr std::ptrdiff_t m_hSwitchToWeaponAfterThrow = 0x1B28; // 
            }
            // Parent: C_FuncBrush
            // Field count: 8
            //
            ...
            namespace C_FuncMonitor {
                constexpr std::ptrdiff_t m_targetCamera = 0xD20; // 
                constexpr std::ptrdiff_t m_nResolutionEnum = 0xD28; // 
                constexpr std::ptrdiff_t m_bRenderShadows = 0xD2C; // 
                constexpr std::ptrdiff_t m_bUseUniqueColorTarget = 0xD2D; // 
                constexpr std::ptrdiff_t m_brushModelName = 0xD30; // 
                constexpr std::ptrdiff_t m_hTargetCamera = 0xD38; // 
                constexpr std::ptrdiff_t m_bEnabled = 0xD3C; // 
                constexpr std::ptrdiff_t m_bDraw3DSkybox = 0xD3D; // 
            }
            // Parent: C_BaseTrigger
            // Field count: 0
            ...
            namespace C_LightGlow {
                constexpr std::ptrdiff_t m_nHorizontalSize = 0xD20; // 
                constexpr std::ptrdiff_t m_nVerticalSize = 0xD24; // 
                constexpr std::ptrdiff_t m_nMinDist = 0xD28; // 
                constexpr std::ptrdiff_t m_nMaxDist = 0xD2C; // 
                constexpr std::ptrdiff_t m_nOuterMaxDist = 0xD30; // 
                constexpr std::ptrdiff_t m_flGlowProxySize = 0xD34; // 
                constexpr std::ptrdiff_t m_flHDRColorScale = 0xD38; // 
                constexpr std::ptrdiff_t m_GlowOverlay = 0xD40; // 
            }
            // Parent: None
            // Field count: 4
            //
            ...
            namespace C_ClientRagdoll {
                constexpr std::ptrdiff_t m_bFadeOut = 0xF80; // 
                constexpr std::ptrdiff_t m_bImportant = 0xF81; // 
                constexpr std::ptrdiff_t m_flEffectTime = 0xF84; // 
                constexpr std::ptrdiff_t m_gibDespawnTime = 0xF88; // 
                constexpr std::ptrdiff_t m_iCurrentFriction = 0xF8C; // 
                constexpr std::ptrdiff_t m_iMinFriction = 0xF90; // 
                constexpr std::ptrdiff_t m_iMaxFriction = 0xF94; // 
                constexpr std::ptrdiff_t m_iFrictionAnimState = 0xF98; // 
                constexpr std::ptrdiff_t m_bReleaseRagdoll = 0xF9C; // 
                constexpr std::ptrdiff_t m_iEyeAttachment = 0xF9D; // 
                constexpr std::ptrdiff_t m_bFadingOut = 0xF9E; // 
                constexpr std::ptrdiff_t m_flScaleEnd = 0xFA0; // 
                constexpr std::ptrdiff_t m_flScaleTimeStart = 0xFC8; // 
                constexpr std::ptrdiff_t m_flScaleTimeEnd = 0xFF0; // 
            }
            // Parent: C_BaseEntity
            // Field count: 1
            ...
            namespace C_SmokeGrenadeProjectile {
                constexpr std::ptrdiff_t m_nSmokeEffectTickBegin = 0x1208; // 
                constexpr std::ptrdiff_t m_bDidSmokeEffect = 0x120C; // 
                constexpr std::ptrdiff_t m_nRandomSeed = 0x1210; // 
                constexpr std::ptrdiff_t m_vSmokeColor = 0x1214; // 
                constexpr std::ptrdiff_t m_vSmokeDetonationPos = 0x1220; // 
                constexpr std::ptrdiff_t m_VoxelFrameData = 0x1230; // 
                constexpr std::ptrdiff_t m_bSmokeVolumeDataReceived = 0x1248; // 
                constexpr std::ptrdiff_t m_bSmokeEffectSpawned = 0x1249; // 
            }
            // Parent: C_SoundEventEntity
            // Field count: 0
            ...
            namespace C_Inferno {
                constexpr std::ptrdiff_t m_nfxFireDamageEffect = 0xD60; // 
                constexpr std::ptrdiff_t m_hInfernoPointsSnapshot = 0xD68; // 
                constexpr std::ptrdiff_t m_hInfernoFillerPointsSnapshot = 0xD70; // 
                constexpr std::ptrdiff_t m_hInfernoOutlinePointsSnapshot = 0xD78; // 
                constexpr std::ptrdiff_t m_hInfernoClimbingOutlinePointsSnapshot = 0xD80; // 
                constexpr std::ptrdiff_t m_hInfernoDecalsSnapshot = 0xD88; // 
                constexpr std::ptrdiff_t m_firePositions = 0xD90; // 
                constexpr std::ptrdiff_t m_fireParentPositions = 0x1090; // 
                constexpr std::ptrdiff_t m_bFireIsBurning = 0x1390; // 
                constexpr std::ptrdiff_t m_BurnNormal = 0x13D0; // 
                constexpr std::ptrdiff_t m_fireCount = 0x16D0; // 
                constexpr std::ptrdiff_t m_nInfernoType = 0x16D4; // 
                constexpr std::ptrdiff_t m_nFireLifetime = 0x16D8; // 
                constexpr std::ptrdiff_t m_bInPostEffectTime = 0x16DC; // 
                constexpr std::ptrdiff_t m_lastFireCount = 0x16E0; // 
                constexpr std::ptrdiff_t m_nFireEffectTickBegin = 0x16E4; // 
            ...
            namespace C_CSPlayerPawn {
                constexpr std::ptrdiff_t m_pBulletServices = 0x1510; // 
                constexpr std::ptrdiff_t m_pHostageServices = 0x1518; // 
                constexpr std::ptrdiff_t m_pBuyServices = 0x1520; // 
                constexpr std::ptrdiff_t m_pGlowServices = 0x1528; // 
                constexpr std::ptrdiff_t m_pActionTrackingServices = 0x1530; // 
                constexpr std::ptrdiff_t m_flHealthShotBoostExpirationTime = 0x1538; // 
                constexpr std::ptrdiff_t m_flLastFiredWeaponTime = 0x153C; // 
                constexpr std::ptrdiff_t m_bHasFemaleVoice = 0x1540; // 
                constexpr std::ptrdiff_t m_flLandingTimeSeconds = 0x1544; // 
                constexpr std::ptrdiff_t m_flOldFallVelocity = 0x1548; // 
                constexpr std::ptrdiff_t m_szLastPlaceName = 0x154C; // 
                constexpr std::ptrdiff_t m_bPrevDefuser = 0x155E; // 
                constexpr std::ptrdiff_t m_bPrevHelmet = 0x155F; // 
                constexpr std::ptrdiff_t m_nPrevArmorVal = 0x1560; // 
                constexpr std::ptrdiff_t m_nPrevGrenadeAmmoCount = 0x1564; // 
                constexpr std::ptrdiff_t m_unPreviousWeaponHash = 0x1568; // 
                constexpr std::ptrdiff_t m_unWeaponHash = 0x156C; // 
                constexpr std::ptrdiff_t m_bInBuyZone = 0x1570; // 
                constexpr std::ptrdiff_t m_bPreviouslyInBuyZone = 0x1571; // 
                constexpr std::ptrdiff_t m_aimPunchAngle = 0x1574; // 
                constexpr std::ptrdiff_t m_aimPunchAngleVel = 0x1580; // 
                constexpr std::ptrdiff_t m_aimPunchTickBase = 0x158C; // 
                constexpr std::ptrdiff_t m_aimPunchTickFraction = 0x1590; // 
                constexpr std::ptrdiff_t m_aimPunchCache = 0x1598; // 
                constexpr std::ptrdiff_t m_bInLanding = 0x15B8; // 
                constexpr std::ptrdiff_t m_flLandingStartTime = 0x15BC; // 
                constexpr std::ptrdiff_t m_bInHostageRescueZone = 0x15C0; // 
                constexpr std::ptrdiff_t m_bInBombZone = 0x15C1; // 
                constexpr std::ptrdiff_t m_bIsBuyMenuOpen = 0x15C2; // 
                constexpr std::ptrdiff_t m_flTimeOfLastInjury = 0x15C4; // 
                constexpr std::ptrdiff_t m_flNextSprayDecalTime = 0x15C8; // 
                constexpr std::ptrdiff_t m_iRetakesOffering = 0x1700; // 
                constexpr std::ptrdiff_t m_iRetakesOfferingCard = 0x1704; // 
                constexpr std::ptrdiff_t m_bRetakesHasDefuseKit = 0x1708; // 
                constexpr std::ptrdiff_t m_bRetakesMVPLastRound = 0x1709; // 
                constexpr std::ptrdiff_t m_iRetakesMVPBoostItem = 0x170C; // 
                constexpr std::ptrdiff_t m_RetakesMVPBoostExtraUtility = 0x1710; // 
                constexpr std::ptrdiff_t m_bNeedToReApplyGloves = 0x1730; // 
                constexpr std::ptrdiff_t m_EconGloves = 0x1738; // 
                constexpr std::ptrdiff_t m_nEconGlovesChanged = 0x1B80; // 
                constexpr std::ptrdiff_t m_bMustSyncRagdollState = 0x1B81; // 
                constexpr std::ptrdiff_t m_nRagdollDamageBone = 0x1B84; // 
                constexpr std::ptrdiff_t m_vRagdollDamageForce = 0x1B88; // 
                constexpr std::ptrdiff_t m_vRagdollDamagePosition = 0x1B94; // 
                constexpr std::ptrdiff_t m_szRagdollDamageWeaponName = 0x1BA0; // 
                constexpr std::ptrdiff_t m_bRagdollDamageHeadshot = 0x1BE0; // 
                constexpr std::ptrdiff_t m_vRagdollServerOrigin = 0x1BE4; // 
                constexpr std::ptrdiff_t m_bLastHeadBoneTransformIsValid = 0x2268; // 
                constexpr std::ptrdiff_t m_lastLandTime = 0x226C; // 
                constexpr std::ptrdiff_t m_bOnGroundLastTick = 0x2270; // 
                constexpr std::ptrdiff_t m_qDeathEyeAngles = 0x228C; // 
                constexpr std::ptrdiff_t m_bSkipOneHeadConstraintUpdate = 0x2298; // 
                constexpr std::ptrdiff_t m_bLeftHanded = 0x2299; // 
                constexpr std::ptrdiff_t m_fSwitchedHandednessTime = 0x229C; // 
                constexpr std::ptrdiff_t m_flViewmodelOffsetX = 0x22A0; // 
                constexpr std::ptrdiff_t m_flViewmodelOffsetY = 0x22A4; // 
                constexpr std::ptrdiff_t m_flViewmodelOffsetZ = 0x22A8; // 
                constexpr std::ptrdiff_t m_flViewmodelFOV = 0x22AC; // 
                constexpr std::ptrdiff_t m_vecPlayerPatchEconIndices = 0x22B0; // 
                constexpr std::ptrdiff_t m_GunGameImmunityColor = 0x22E8; // 
                constexpr std::ptrdiff_t m_vecBulletHitModels = 0x2338; // 
                constexpr std::ptrdiff_t m_bIsWalking = 0x2350; // 
                constexpr std::ptrdiff_t m_thirdPersonHeading = 0x2358; // 
                constexpr std::ptrdiff_t m_flSlopeDropOffset = 0x2370; // 
                constexpr std::ptrdiff_t m_flSlopeDropHeight = 0x2380; // 
                constexpr std::ptrdiff_t m_vHeadConstraintOffset = 0x2390; // 
                constexpr std::ptrdiff_t m_entitySpottedState = 0x23A8; // 
                constexpr std::ptrdiff_t m_bIsScoped = 0x23C0; // 
                constexpr std::ptrdiff_t m_bResumeZoom = 0x23C1; // 
                constexpr std::ptrdiff_t m_bIsDefusing = 0x23C2; // 
                constexpr std::ptrdiff_t m_bIsGrabbingHostage = 0x23C3; // 
                constexpr std::ptrdiff_t m_iBlockingUseActionInProgress = 0x23C4; // 
                constexpr std::ptrdiff_t m_flEmitSoundTime = 0x23C8; // 
                constexpr std::ptrdiff_t m_bInNoDefuseArea = 0x23CC; // 
                constexpr std::ptrdiff_t m_nWhichBombZone = 0x23D0; // 
                constexpr std::ptrdiff_t m_iShotsFired = 0x23D4; // 
                constexpr std::ptrdiff_t m_flFlinchStack = 0x23D8; // 
                constexpr std::ptrdiff_t m_flVelocityModifier = 0x23DC; // 
                constexpr std::ptrdiff_t m_flHitHeading = 0x23E0; // 
                constexpr std::ptrdiff_t m_nHitBodyPart = 0x23E4; // 
                constexpr std::ptrdiff_t m_bWaitForNoAttack = 0x23E8; // 
                constexpr std::ptrdiff_t m_ignoreLadderJumpTime = 0x23EC; // 
                constexpr std::ptrdiff_t m_bKilledByHeadshot = 0x23F1; // 
                constexpr std::ptrdiff_t m_ArmorValue = 0x23F4; // 
                constexpr std::ptrdiff_t m_unCurrentEquipmentValue = 0x23F8; // 
                constexpr std::ptrdiff_t m_unRoundStartEquipmentValue = 0x23FA; // 
                constexpr std::ptrdiff_t m_unFreezetimeEndEquipmentValue = 0x23FC; // 
                constexpr std::ptrdiff_t m_nLastKillerIndex = 0x2400; // 
                constexpr std::ptrdiff_t m_bOldIsScoped = 0x2404; // 
                constexpr std::ptrdiff_t m_bHasDeathInfo = 0x2405; // 
                constexpr std::ptrdiff_t m_flDeathInfoTime = 0x2408; // 
                constexpr std::ptrdiff_t m_vecDeathInfoOrigin = 0x240C; // 
                constexpr std::ptrdiff_t m_grenadeParameterStashTime = 0x2418; // 
                constexpr std::ptrdiff_t m_bGrenadeParametersStashed = 0x241C; // 
                constexpr std::ptrdiff_t m_angStashedShootAngles = 0x2420; // 
                constexpr std::ptrdiff_t m_vecStashedGrenadeThrowPosition = 0x242C; // 
                constexpr std::ptrdiff_t m_vecStashedVelocity = 0x2438; // 
                constexpr std::ptrdiff_t m_angShootAngleHistory = 0x2444; // 
                constexpr std::ptrdiff_t m_vecThrowPositionHistory = 0x245C; // 
                constexpr std::ptrdiff_t m_vecVelocityHistory = 0x2474; // 
                constexpr std::ptrdiff_t m_PredictedDamageTags = 0x2490; // 
                constexpr std::ptrdiff_t m_nPrevHighestReceivedDamageTagTick = 0x24E0; // 
                constexpr std::ptrdiff_t m_nHighestAppliedDamageTagTick = 0x24E4; // 
            }
            ...
            namespace C_RagdollPropAttached {
                constexpr std::ptrdiff_t m_boneIndexAttached = 0xFF8; // 
                constexpr std::ptrdiff_t m_ragdollAttachedObjectIndex = 0xFFC; // 
                constexpr std::ptrdiff_t m_attachmentPointBoneSpace = 0x1000; // 
                constexpr std::ptrdiff_t m_attachmentPointRagdollSpace = 0x100C; // 
                constexpr std::ptrdiff_t m_vecOffset = 0x1018; // 
                constexpr std::ptrdiff_t m_parentTime = 0x1024; // 
                constexpr std::ptrdiff_t m_bHasParent = 0x1028; // 
            }
            ...
            namespace C_BaseCSGrenadeProjectile {
                constexpr std::ptrdiff_t m_vInitialPosition = 0x1168; // 
                constexpr std::ptrdiff_t m_vInitialVelocity = 0x1174; // 
                constexpr std::ptrdiff_t m_nBounces = 0x1180; // 
                constexpr std::ptrdiff_t m_nExplodeEffectIndex = 0x1188; // 
                constexpr std::ptrdiff_t m_nExplodeEffectTickBegin = 0x1190; // 
                constexpr std::ptrdiff_t m_vecExplodeEffectOrigin = 0x1194; // 
                constexpr std::ptrdiff_t m_flSpawnTime = 0x11A0; // 
                constexpr std::ptrdiff_t vecLastTrailLinePos = 0x11A4; // 
                constexpr std::ptrdiff_t flNextTrailLineTime = 0x11B0; // 
                constexpr std::ptrdiff_t m_bExplodeEffectBegan = 0x11B4; // 
                constexpr std::ptrdiff_t m_bCanCreateGrenadeTrail = 0x11B5; // 
                constexpr std::ptrdiff_t m_nSnapshotTrajectoryEffectIndex = 0x11B8; // 
                constexpr std::ptrdiff_t m_hSnapshotTrajectoryParticleSnapshot = 0x11C0; // 
                constexpr std::ptrdiff_t m_arrTrajectoryTrailPoints = 0x11C8; // 
                constexpr std::ptrdiff_t m_arrTrajectoryTrailPointCreationTimes = 0x11E0; // 
                constexpr std::ptrdiff_t m_flTrajectoryTrailEffectCreationTime = 0x11F8; // 
            }
            // Parent: C_BaseToggle
            // Field count: 2
            //
            ...
            namespace C_BaseTrigger {
                constexpr std::ptrdiff_t m_bDisabled = 0xD20; // 
                constexpr std::ptrdiff_t m_bClientSidePredicted = 0xD21; // 
            }
            // Parent: C_CSWeaponBase
            // Field count: 2
            //
            ...
            namespace C_WeaponBaseItem {
                constexpr std::ptrdiff_t m_SequenceCompleteTimer = 0x1B00; // 
                constexpr std::ptrdiff_t m_bRedraw = 0x1B18; // 
            }
            // Parent: None
            // Field count: 21
            //
            ...
            namespace C_BaseButton {
                constexpr std::ptrdiff_t m_glowEntity = 0xD20; // 
                constexpr std::ptrdiff_t m_usable = 0xD24; // 
                constexpr std::ptrdiff_t m_szDisplayText = 0xD28; // 
            }
            ...
            namespace C_PointClientUIWorldPanel {
                constexpr std::ptrdiff_t m_bForceRecreateNextUpdate = 0xD58; // 
                constexpr std::ptrdiff_t m_bMoveViewToPlayerNextThink = 0xD59; // 
                constexpr std::ptrdiff_t m_bCheckCSSClasses = 0xD5A; // 
                constexpr std::ptrdiff_t m_anchorDeltaTransform = 0xD60; // 
                constexpr std::ptrdiff_t m_pOffScreenIndicator = 0xEF8; // 
                constexpr std::ptrdiff_t m_bIgnoreInput = 0xF20; // 
                constexpr std::ptrdiff_t m_bLit = 0xF21; // 
                constexpr std::ptrdiff_t m_bFollowPlayerAcrossTeleport = 0xF22; // 
                constexpr std::ptrdiff_t m_flWidth = 0xF24; // 
                constexpr std::ptrdiff_t m_flHeight = 0xF28; // 
                constexpr std::ptrdiff_t m_flDPI = 0xF2C; // 
                constexpr std::ptrdiff_t m_flInteractDistance = 0xF30; // 
                constexpr std::ptrdiff_t m_flDepthOffset = 0xF34; // 
                constexpr std::ptrdiff_t m_unOwnerContext = 0xF38; // 
                constexpr std::ptrdiff_t m_unHorizontalAlign = 0xF3C; // 
                constexpr std::ptrdiff_t m_unVerticalAlign = 0xF40; // 
                constexpr std::ptrdiff_t m_unOrientation = 0xF44; // 
                constexpr std::ptrdiff_t m_bAllowInteractionFromAllSceneWorlds = 0xF48; // 
                constexpr std::ptrdiff_t m_vecCSSClasses = 0xF50; // C_NetworkUtlVectorBase<CUtlSymbolLarge>
                constexpr std::ptrdiff_t m_bOpaque = 0xF68; // 
                constexpr std::ptrdiff_t m_bNoDepth = 0xF69; // 
                constexpr std::ptrdiff_t m_bRenderBackface = 0xF6A; // 
                constexpr std::ptrdiff_t m_bUseOffScreenIndicator = 0xF6B; // 
                constexpr std::ptrdiff_t m_bExcludeFromSaveGames = 0xF6C; // 
                constexpr std::ptrdiff_t m_bGrabbable = 0xF6D; // 
                constexpr std::ptrdiff_t m_bOnlyRenderToTexture = 0xF6E; // 
                constexpr std::ptrdiff_t m_bDisableMipGen = 0xF6F; // 
                constexpr std::ptrdiff_t m_nExplicitImageLayout = 0xF70; // 
            }
            // Parent: C_BaseEntity
            // Field count: 0
            ...
            namespace C_TextureBasedAnimatable {
                constexpr std::ptrdiff_t m_bLoop = 0xD20; // 
                constexpr std::ptrdiff_t m_flFPS = 0xD24; // 
                constexpr std::ptrdiff_t m_hPositionKeys = 0xD28; // 
                constexpr std::ptrdiff_t m_hRotationKeys = 0xD30; // 
                constexpr std::ptrdiff_t m_vAnimationBoundsMin = 0xD38; // 
                constexpr std::ptrdiff_t m_vAnimationBoundsMax = 0xD44; // 
                constexpr std::ptrdiff_t m_flStartTime = 0xD50; // 
                constexpr std::ptrdiff_t m_flStartFrame = 0xD54; // 
            }
            ...
            namespace C_CSGOViewModel {
                constexpr std::ptrdiff_t m_bShouldIgnoreOffsetAndAccuracy = 0x1019; // 
                constexpr std::ptrdiff_t m_nLastKnownAssociatedWeaponEntIndex = 0x101C; // 
                constexpr std::ptrdiff_t m_bNeedToQueueHighResComposite = 0x1020; // 
                constexpr std::ptrdiff_t m_vLoweredWeaponOffset = 0x1070; // 
            }
            // Parent: CEntityComponent
            // Field count: 1
            ...
            namespace C_ViewmodelAttachmentModel {
                constexpr std::ptrdiff_t m_bShouldFrontFaceCullLeftHanded = 0xF88; // 
                constexpr std::ptrdiff_t m_bCreatedLeftHanded = 0xF89; // 
            }
            // Parent: None
            // Field count: 0
            //
            ...
            namespace CPointOffScreenIndicatorUi {
                constexpr std::ptrdiff_t m_bBeenEnabled = 0xF80; // 
                constexpr std::ptrdiff_t m_bHide = 0xF81; // 
                constexpr std::ptrdiff_t m_flSeenTargetTime = 0xF84; // 
                constexpr std::ptrdiff_t m_pTargetPanel = 0xF88; // 
            }
            // Parent: None
            // Field count: 0
            //
            ...
            namespace C_CSWeaponBaseGun {
                constexpr std::ptrdiff_t m_zoomLevel = 0x1B00; // 
                constexpr std::ptrdiff_t m_iBurstShotsRemaining = 0x1B04; // 
                constexpr std::ptrdiff_t m_iSilencerBodygroup = 0x1B08; // 
                constexpr std::ptrdiff_t m_silencedModelIndex = 0x1B18; // 
                constexpr std::ptrdiff_t m_inPrecache = 0x1B1C; // 
                constexpr std::ptrdiff_t m_bNeedsBoltAction = 0x1B1D; // 
            }
            // Parent: C_BaseEntity
            // Field count: 4
            //
            ...
            namespace C_EntityDissolve {
                constexpr std::ptrdiff_t m_flStartTime = 0xD28; // 
                constexpr std::ptrdiff_t m_flFadeInStart = 0xD2C; // 
                constexpr std::ptrdiff_t m_flFadeInLength = 0xD30; // 
                constexpr std::ptrdiff_t m_flFadeOutModelStart = 0xD34; // 
                constexpr std::ptrdiff_t m_flFadeOutModelLength = 0xD38; // 
                constexpr std::ptrdiff_t m_flFadeOutStart = 0xD3C; // 
                constexpr std::ptrdiff_t m_flFadeOutLength = 0xD40; // 
                constexpr std::ptrdiff_t m_flNextSparkTime = 0xD44; // 
                constexpr std::ptrdiff_t m_nDissolveType = 0xD48; // 
                constexpr std::ptrdiff_t m_vDissolverOrigin = 0xD4C; // 
                constexpr std::ptrdiff_t m_nMagnitude = 0xD58; // 
                constexpr std::ptrdiff_t m_bCoreExplode = 0xD5C; // 
                constexpr std::ptrdiff_t m_bLinkedToServerEnt = 0xD5D; // 
            }
            ...
            namespace C_CSPlayerPawnBase {
                constexpr std::ptrdiff_t m_pPingServices = 0x1358; // 
                constexpr std::ptrdiff_t m_pViewModelServices = 0x1360; // 
                constexpr std::ptrdiff_t m_fRenderingClipPlane = 0x1368; // 
                constexpr std::ptrdiff_t m_nLastClipPlaneSetupFrame = 0x1378; // 
                constexpr std::ptrdiff_t m_vecLastClipCameraPos = 0x137C; // 
                constexpr std::ptrdiff_t m_vecLastClipCameraForward = 0x1388; // 
                constexpr std::ptrdiff_t m_bClipHitStaticWorld = 0x1394; // 
                constexpr std::ptrdiff_t m_bCachedPlaneIsValid = 0x1395; // 
                constexpr std::ptrdiff_t m_pClippingWeapon = 0x1398; // 
                constexpr std::ptrdiff_t m_previousPlayerState = 0x13A0; // 
                constexpr std::ptrdiff_t m_iPlayerState = 0x13A4; // 
                constexpr std::ptrdiff_t m_bIsRescuing = 0x13A8; // 
                constexpr std::ptrdiff_t m_fImmuneToGunGameDamageTime = 0x13AC; // 
                constexpr std::ptrdiff_t m_fImmuneToGunGameDamageTimeLast = 0x13B0; // 
                constexpr std::ptrdiff_t m_bGunGameImmunity = 0x13B4; // 
                constexpr std::ptrdiff_t m_bHasMovedSinceSpawn = 0x13B5; // 
                constexpr std::ptrdiff_t m_fMolotovUseTime = 0x13B8; // 
                constexpr std::ptrdiff_t m_fMolotovDamageTime = 0x13BC; // 
                constexpr std::ptrdiff_t m_iThrowGrenadeCounter = 0x13C0; // 
                constexpr std::ptrdiff_t m_flLastSpawnTimeIndex = 0x13C4; // 
                constexpr std::ptrdiff_t m_iProgressBarDuration = 0x13C8; // 
                constexpr std::ptrdiff_t m_flProgressBarStartTime = 0x13CC; // 
                constexpr std::ptrdiff_t m_vecIntroStartEyePosition = 0x13D0; // 
                constexpr std::ptrdiff_t m_vecIntroStartPlayerForward = 0x13DC; // 
                constexpr std::ptrdiff_t m_flClientDeathTime = 0x13E8; // 
                constexpr std::ptrdiff_t m_bScreenTearFrameCaptured = 0x13EC; // 
                constexpr std::ptrdiff_t m_flFlashBangTime = 0x13F0; // 
                constexpr std::ptrdiff_t m_flFlashScreenshotAlpha = 0x13F4; // 
                constexpr std::ptrdiff_t m_flFlashOverlayAlpha = 0x13F8; // 
                constexpr std::ptrdiff_t m_bFlashBuildUp = 0x13FC; // 
                constexpr std::ptrdiff_t m_bFlashDspHasBeenCleared = 0x13FD; // 
                constexpr std::ptrdiff_t m_bFlashScreenshotHasBeenGrabbed = 0x13FE; // 
                constexpr std::ptrdiff_t m_flFlashMaxAlpha = 0x1400; // 
                constexpr std::ptrdiff_t m_flFlashDuration = 0x1404; // 
                constexpr std::ptrdiff_t m_iHealthBarRenderMaskIndex = 0x1408; // 
                constexpr std::ptrdiff_t m_flHealthFadeValue = 0x140C; // 
                constexpr std::ptrdiff_t m_flHealthFadeAlpha = 0x1410; // 
                constexpr std::ptrdiff_t m_flDeathCCWeight = 0x1420; // 
                constexpr std::ptrdiff_t m_flPrevRoundEndTime = 0x1424; // 
                constexpr std::ptrdiff_t m_flPrevMatchEndTime = 0x1428; // 
                constexpr std::ptrdiff_t m_angEyeAngles = 0x1430; // 
                constexpr std::ptrdiff_t m_fNextThinkPushAway = 0x1448; // 
                constexpr std::ptrdiff_t m_bShouldAutobuyDMWeapons = 0x144C; // 
                constexpr std::ptrdiff_t m_bShouldAutobuyNow = 0x144D; // 
                constexpr std::ptrdiff_t m_iIDEntIndex = 0x1450; // 
                constexpr std::ptrdiff_t m_delayTargetIDTimer = 0x1458; // 
                constexpr std::ptrdiff_t m_iTargetItemEntIdx = 0x1470; // 
                constexpr std::ptrdiff_t m_iOldIDEntIndex = 0x1474; // 
                constexpr std::ptrdiff_t m_holdTargetIDTimer = 0x1478; // 
                constexpr std::ptrdiff_t m_flCurrentMusicStartTime = 0x1494; // 
                constexpr std::ptrdiff_t m_flMusicRoundStartTime = 0x1498; // 
                constexpr std::ptrdiff_t m_bDeferStartMusicOnWarmup = 0x149C; // 
                constexpr std::ptrdiff_t m_cycleLatch = 0x14A0; // 
                constexpr std::ptrdiff_t m_serverIntendedCycle = 0x14A4; // 
                constexpr std::ptrdiff_t m_flLastSmokeOverlayAlpha = 0x14A8; // 
                constexpr std::ptrdiff_t m_flLastSmokeAge = 0x14AC; // 
                constexpr std::ptrdiff_t m_vLastSmokeOverlayColor = 0x14B0; // 
                constexpr std::ptrdiff_t m_nPlayerSmokedFx = 0x14BC; // 
                constexpr std::ptrdiff_t m_nPlayerInfernoBodyFx = 0x14C0; // 
                constexpr std::ptrdiff_t m_nPlayerInfernoFootFx = 0x14C4; // 
                constexpr std::ptrdiff_t m_flNextMagDropTime = 0x14C8; // 
                constexpr std::ptrdiff_t m_nLastMagDropAttachmentIndex = 0x14CC; // 
                constexpr std::ptrdiff_t m_vecLastAliveLocalVelocity = 0x14D0; // 
                constexpr std::ptrdiff_t m_bGuardianShouldSprayCustomXMark = 0x14F8; // 
                constexpr std::ptrdiff_t m_hOriginalController = 0x1500; // 
            }
            ...
            namespace C_PostProcessingVolume {
                constexpr std::ptrdiff_t m_hPostSettings = 0xD38; // 
                constexpr std::ptrdiff_t m_flFadeDuration = 0xD40; // 
                constexpr std::ptrdiff_t m_flMinLogExposure = 0xD44; // 
                constexpr std::ptrdiff_t m_flMaxLogExposure = 0xD48; // 
                constexpr std::ptrdiff_t m_flMinExposure = 0xD4C; // 
                constexpr std::ptrdiff_t m_flMaxExposure = 0xD50; // 
                constexpr std::ptrdiff_t m_flExposureCompensation = 0xD54; // 
                constexpr std::ptrdiff_t m_flExposureFadeSpeedUp = 0xD58; // 
                constexpr std::ptrdiff_t m_flExposureFadeSpeedDown = 0xD5C; // 
                constexpr std::ptrdiff_t m_flTonemapEVSmoothingRange = 0xD60; // 
                constexpr std::ptrdiff_t m_bMaster = 0xD64; // 
                constexpr std::ptrdiff_t m_bExposureControl = 0xD65; // 
                constexpr std::ptrdiff_t m_flRate = 0xD68; // 
                constexpr std::ptrdiff_t m_flTonemapPercentTarget = 0xD6C; // 
                constexpr std::ptrdiff_t m_flTonemapPercentBrightPixels = 0xD70; // 
                constexpr std::ptrdiff_t m_flTonemapMinAvgLum = 0xD74; // 
            }
            // Parent: CPlayerPawnComponent
            // Field count: 1
            //
            ...
            namespace C_DecoyProjectile {
                constexpr std::ptrdiff_t m_nDecoyShotTick = 0x1200; // 
                constexpr std::ptrdiff_t m_nClientLastKnownDecoyShotTick = 0x1204; // 
                constexpr std::ptrdiff_t m_flTimeParticleEffectSpawn = 0x1228; // 
            }
            // Parent: CBaseAnimGraph
            // Field count: 0
            ...
            namespace C_CSGO_PreviewPlayer {
                constexpr std::ptrdiff_t m_animgraph = 0x24E8; // 
                constexpr std::ptrdiff_t m_animgraphCharacterModeString = 0x24F0; // 
                constexpr std::ptrdiff_t m_flInitialModelScale = 0x24F8; // 
            }
            ...
            // NetworkVarNames: m_entitySpottedState (EntitySpottedState_t)
            namespace C_C4 {
                constexpr std::ptrdiff_t m_szScreenText = 0x1B00; // 
                constexpr std::ptrdiff_t m_activeLightParticleIndex = 0x1B20; // 
                constexpr std::ptrdiff_t m_eActiveLightEffect = 0x1B24; // 
                constexpr std::ptrdiff_t m_bStartedArming = 0x1B28; // 
                constexpr std::ptrdiff_t m_fArmedTime = 0x1B2C; // 
                constexpr std::ptrdiff_t m_bBombPlacedAnimation = 0x1B30; // 
                constexpr std::ptrdiff_t m_bIsPlantingViaUse = 0x1B31; // 
                constexpr std::ptrdiff_t m_entitySpottedState = 0x1B38; // 
                constexpr std::ptrdiff_t m_nSpotRules = 0x1B50; // 
                constexpr std::ptrdiff_t m_bPlayedArmingBeeps = 0x1B54; // 
                constexpr std::ptrdiff_t m_bBombPlanted = 0x1B5B; // 
            }
            // Parent: C_BaseModelEntity
            // Field count: 13
            //
            ...
            namespace CBaseAnimGraph {
                constexpr std::ptrdiff_t m_bInitiallyPopulateInterpHistory = 0xD98; // 
                constexpr std::ptrdiff_t m_bSuppressAnimEventSounds = 0xD9A; // 
                constexpr std::ptrdiff_t m_bAnimGraphUpdateEnabled = 0xDA8; // 
                constexpr std::ptrdiff_t m_flMaxSlopeDistance = 0xDAC; // 
                constexpr std::ptrdiff_t m_vLastSlopeCheckPos = 0xDB0; // 
                constexpr std::ptrdiff_t m_bAnimationUpdateScheduled = 0xDBC; // 
                constexpr std::ptrdiff_t m_vecForce = 0xDC0; // 
                constexpr std::ptrdiff_t m_nForceBone = 0xDCC; // 
                constexpr std::ptrdiff_t m_pClientsideRagdoll = 0xDD0; // 
                constexpr std::ptrdiff_t m_bBuiltRagdoll = 0xDD8; // 
                constexpr std::ptrdiff_t m_RagdollPose = 0xDF0; // 
                constexpr std::ptrdiff_t m_bRagdollClientSide = 0xE38; // 
                constexpr std::ptrdiff_t m_bHasAnimatedMaterialAttributes = 0xE48; // 
            }
            // Parent: C_CSWeaponBase
            // Field count: 0
            namespace C_Melee {
            ...
            namespace C_BasePlayerWeapon {
                constexpr std::ptrdiff_t m_nNextPrimaryAttackTick = 0x1660; // 
                constexpr std::ptrdiff_t m_flNextPrimaryAttackTickRatio = 0x1664; // 
                constexpr std::ptrdiff_t m_nNextSecondaryAttackTick = 0x1668; // 
                constexpr std::ptrdiff_t m_flNextSecondaryAttackTickRatio = 0x166C; // 
                constexpr std::ptrdiff_t m_iClip1 = 0x1670; // 
                constexpr std::ptrdiff_t m_iClip2 = 0x1674; // 
                constexpr std::ptrdiff_t m_pReserveAmmo = 0x1678; // 
            }
            ...
            namespace C_Fish {
                constexpr std::ptrdiff_t m_pos = 0xF80; // 
                constexpr std::ptrdiff_t m_vel = 0xF8C; // 
                constexpr std::ptrdiff_t m_angles = 0xF98; // 
                constexpr std::ptrdiff_t m_localLifeState = 0xFA4; // 
                constexpr std::ptrdiff_t m_deathDepth = 0xFA8; // 
                constexpr std::ptrdiff_t m_deathAngle = 0xFAC; // 
                constexpr std::ptrdiff_t m_buoyancy = 0xFB0; // 
                constexpr std::ptrdiff_t m_wiggleTimer = 0xFB8; // 
                constexpr std::ptrdiff_t m_wigglePhase = 0xFD0; // 
                constexpr std::ptrdiff_t m_wiggleRate = 0xFD4; // 
                constexpr std::ptrdiff_t m_actualPos = 0xFD8; // 
                constexpr std::ptrdiff_t m_actualAngles = 0xFE4; // 
                constexpr std::ptrdiff_t m_poolOrigin = 0xFF0; // 
                constexpr std::ptrdiff_t m_waterLevel = 0xFFC; // 
                constexpr std::ptrdiff_t m_gotUpdate = 0x1000; // 
                constexpr std::ptrdiff_t m_x = 0x1004; // 
                constexpr std::ptrdiff_t m_y = 0x1008; // 
                constexpr std::ptrdiff_t m_z = 0x100C; // 
                constexpr std::ptrdiff_t m_angle = 0x1010; // 
                constexpr std::ptrdiff_t m_errorHistory = 0x1014; // 
                constexpr std::ptrdiff_t m_errorHistoryIndex = 0x1064; // 
                constexpr std::ptrdiff_t m_errorHistoryCount = 0x1068; // 
                constexpr std::ptrdiff_t m_averageError = 0x106C; // 
            }
            ...
            namespace C_BasePlayerPawn {
                constexpr std::ptrdiff_t m_pWeaponServices = 0x11A0; // 
                constexpr std::ptrdiff_t m_pItemServices = 0x11A8; // 
                constexpr std::ptrdiff_t m_pAutoaimServices = 0x11B0; // 
                constexpr std::ptrdiff_t m_pObserverServices = 0x11B8; // 
                constexpr std::ptrdiff_t m_pWaterServices = 0x11C0; // 
                constexpr std::ptrdiff_t m_pUseServices = 0x11C8; // 
                constexpr std::ptrdiff_t m_pFlashlightServices = 0x11D0; // 
                constexpr std::ptrdiff_t m_pCameraServices = 0x11D8; // 
                constexpr std::ptrdiff_t m_pMovementServices = 0x11E0; // 
                constexpr std::ptrdiff_t m_ServerViewAngleChanges = 0x11F0; // 
                constexpr std::ptrdiff_t m_nHighestConsumedServerViewAngleChangeIndex = 0x1240; // 
                constexpr std::ptrdiff_t v_angle = 0x1244; // 
                constexpr std::ptrdiff_t v_anglePrevious = 0x1250; // 
                constexpr std::ptrdiff_t m_iHideHUD = 0x125C; // 
                constexpr std::ptrdiff_t m_skybox3d = 0x1260; // 
                constexpr std::ptrdiff_t m_flDeathTime = 0x12F0; // 
                constexpr std::ptrdiff_t m_vecPredictionError = 0x12F4; // 
                constexpr std::ptrdiff_t m_flPredictionErrorTime = 0x1300; // 
                constexpr std::ptrdiff_t m_vecLastCameraSetupLocalOrigin = 0x1304; // 
                constexpr std::ptrdiff_t m_flLastCameraSetupTime = 0x1310; // 
                constexpr std::ptrdiff_t m_flFOVSensitivityAdjust = 0x1314; // 
                constexpr std::ptrdiff_t m_flMouseSensitivity = 0x1318; // 
                constexpr std::ptrdiff_t m_vOldOrigin = 0x131C; // 
                constexpr std::ptrdiff_t m_flOldSimulationTime = 0x1328; // 
                constexpr std::ptrdiff_t m_nLastExecutedCommandNumber = 0x132C; // 
                constexpr std::ptrdiff_t m_nLastExecutedCommandTick = 0x1330; // 
                constexpr std::ptrdiff_t m_hController = 0x1334; // 
                constexpr std::ptrdiff_t m_bIsSwappingToPredictableController = 0x1338; // 
            }
            // Parent: None
            // Field count: 6
            //
            ...
            namespace C_TriggerBuoyancy {
                ...
                constexpr std::ptrdiff_t m_flFluidDensity = 0xDA8; // 
            }
            // Parent: C_BaseModelEntity
            // Field count: 41
            //
            ...
            namespace C_RopeKeyframe {
                constexpr std::ptrdiff_t m_LinksTouchingSomething = 0xD28; // 
                constexpr std::ptrdiff_t m_nLinksTouchingSomething = 0xD2C; // 
                constexpr std::ptrdiff_t m_bApplyWind = 0xD30; // 
                constexpr std::ptrdiff_t m_fPrevLockedPoints = 0xD34; // 
                constexpr std::ptrdiff_t m_iForcePointMoveCounter = 0xD38; // 
                constexpr std::ptrdiff_t m_bPrevEndPointPos = 0xD3C; // 
                constexpr std::ptrdiff_t m_vPrevEndPointPos = 0xD40; // 
                constexpr std::ptrdiff_t m_flCurScroll = 0xD58; // 
                constexpr std::ptrdiff_t m_flScrollSpeed = 0xD5C; // 
                constexpr std::ptrdiff_t m_RopeFlags = 0xD60; // 
                constexpr std::ptrdiff_t m_iRopeMaterialModelIndex = 0xD68; // 
                constexpr std::ptrdiff_t m_LightValues = 0xFE0; // 
                constexpr std::ptrdiff_t m_nSegments = 0x1058; // 
                constexpr std::ptrdiff_t m_hStartPoint = 0x105C; // 
                constexpr std::ptrdiff_t m_hEndPoint = 0x1060; // 
                constexpr std::ptrdiff_t m_iStartAttachment = 0x1064; // 
                constexpr std::ptrdiff_t m_iEndAttachment = 0x1065; // 
                constexpr std::ptrdiff_t m_Subdiv = 0x1066; // 
                constexpr std::ptrdiff_t m_RopeLength = 0x1068; // 
                constexpr std::ptrdiff_t m_Slack = 0x106A; // 
                constexpr std::ptrdiff_t m_TextureScale = 0x106C; // 
                constexpr std::ptrdiff_t m_fLockedPoints = 0x1070; // 
                constexpr std::ptrdiff_t m_nChangeCount = 0x1071; // 
                constexpr std::ptrdiff_t m_Width = 0x1074; // 
                constexpr std::ptrdiff_t m_PhysicsDelegate = 0x1078; // C_RopeKeyframe::CPhysicsDelegate
                constexpr std::ptrdiff_t m_hMaterial = 0x1088; // 
                constexpr std::ptrdiff_t m_TextureHeight = 0x1090; // 
                constexpr std::ptrdiff_t m_vecImpulse = 0x1094; // 
                constexpr std::ptrdiff_t m_vecPreviousImpulse = 0x10A0; // 
                constexpr std::ptrdiff_t m_flCurrentGustTimer = 0x10AC; // 
                constexpr std::ptrdiff_t m_flCurrentGustLifetime = 0x10B0; // 
                constexpr std::ptrdiff_t m_flTimeToNextGust = 0x10B4; // 
                constexpr std::ptrdiff_t m_vWindDir = 0x10B8; // 
                constexpr std::ptrdiff_t m_vColorMod = 0x10C4; // 
                constexpr std::ptrdiff_t m_vCachedEndPointAttachmentPos = 0x10D0; // 
                constexpr std::ptrdiff_t m_vCachedEndPointAttachmentAngle = 0x10E8; // 
                constexpr std::ptrdiff_t m_bConstrainBetweenEndpoints = 0x1100; // 
            ...
            namespace C_CSGO_TeamPreviewCamera {
                constexpr std::ptrdiff_t m_nVariant = 0x5D0; // 
                constexpr std::ptrdiff_t m_bDofEnabled = 0x5D4; // 
                constexpr std::ptrdiff_t m_flDofNearBlurry = 0x5D8; // 
                constexpr std::ptrdiff_t m_flDofNearCrisp = 0x5DC; // 
                constexpr std::ptrdiff_t m_flDofFarCrisp = 0x5E0; // 
                constexpr std::ptrdiff_t m_flDofFarBlurry = 0x5E4; // 
                constexpr std::ptrdiff_t m_flDofTiltToGround = 0x5E8; // 
            }
            ...
            namespace C_EconWearable {
                constexpr std::ptrdiff_t m_nForceSkin = 0x1660; // 
                constexpr std::ptrdiff_t m_bAlwaysAllow = 0x1664; // 
            }
            ...
            namespace C_BarnLight {
                constexpr std::ptrdiff_t m_bEnabled = 0xD20; // 
                constexpr std::ptrdiff_t m_nColorMode = 0xD24; // 
                constexpr std::ptrdiff_t m_Color = 0xD28; // 
                constexpr std::ptrdiff_t m_flColorTemperature = 0xD2C; // 
                constexpr std::ptrdiff_t m_flBrightness = 0xD30; // 
                constexpr std::ptrdiff_t m_flBrightnessScale = 0xD34; // 
                constexpr std::ptrdiff_t m_nDirectLight = 0xD38; // 
                constexpr std::ptrdiff_t m_nBakedShadowIndex = 0xD3C; // 
                constexpr std::ptrdiff_t m_nLuminaireShape = 0xD40; // 
                constexpr std::ptrdiff_t m_flLuminaireSize = 0xD44; // 
                constexpr std::ptrdiff_t m_flLuminaireAnisotropy = 0xD48; // 
                constexpr std::ptrdiff_t m_LightStyleString = 0xD50; // 
                ...
                constexpr std::ptrdiff_t m_flSoftX = 0xE54; // 
                constexpr std::ptrdiff_t m_flSoftY = 0xE58; // 
                constexpr std::ptrdiff_t m_flSkirt = 0xE5C; // 
                constexpr std::ptrdiff_t m_flSkirtNear = 0xE60; // 
                constexpr std::ptrdiff_t m_vSizeParams = 0xE64; // 
                constexpr std::ptrdiff_t m_flRange = 0xE70; // 
                constexpr std::ptrdiff_t m_vShear = 0xE74; // 
                constexpr std::ptrdiff_t m_nBakeSpecularToCubemaps = 0xE80; // 
                constexpr std::ptrdiff_t m_vBakeSpecularToCubemapsSize = 0xE84; // 
                constexpr std::ptrdiff_t m_nCastShadows = 0xE90; // 
                constexpr std::ptrdiff_t m_nShadowMapSize = 0xE94; // 
                constexpr std::ptrdiff_t m_nShadowPriority = 0xE98; // 
                constexpr std::ptrdiff_t m_bContactShadow = 0xE9C; // 
                constexpr std::ptrdiff_t m_nBounceLight = 0xEA0; // 
                constexpr std::ptrdiff_t m_flBounceScale = 0xEA4; // 
                constexpr std::ptrdiff_t m_flMinRoughness = 0xEA8; // 
                constexpr std::ptrdiff_t m_vAlternateColor = 0xEAC; // 
                constexpr std::ptrdiff_t m_fAlternateColorBrightness = 0xEB8; // 
                constexpr std::ptrdiff_t m_nFog = 0xEBC; // 
                constexpr std::ptrdiff_t m_flFogStrength = 0xEC0; // 
                constexpr std::ptrdiff_t m_nFogShadows = 0xEC4; // 
                constexpr std::ptrdiff_t m_flFogScale = 0xEC8; // 
                constexpr std::ptrdiff_t m_bFogMixedShadows = 0xECC; // 
                constexpr std::ptrdiff_t m_flFadeSizeStart = 0xED0; // 
                constexpr std::ptrdiff_t m_flFadeSizeEnd = 0xED4; // 
                constexpr std::ptrdiff_t m_flShadowFadeSizeStart = 0xED8; // 
                constexpr std::ptrdiff_t m_flShadowFadeSizeEnd = 0xEDC; // 
                constexpr std::ptrdiff_t m_bPrecomputedFieldsValid = 0xEE0; // 
                constexpr std::ptrdiff_t m_vPrecomputedBoundsMins = 0xEE4; // 
                constexpr std::ptrdiff_t m_vPrecomputedBoundsMaxs = 0xEF0; // 
                constexpr std::ptrdiff_t m_vPrecomputedOBBOrigin = 0xEFC; // 
                constexpr std::ptrdiff_t m_vPrecomputedOBBAngles = 0xF08; // 
                constexpr std::ptrdiff_t m_vPrecomputedOBBExtent = 0xF14; // 
                constexpr std::ptrdiff_t m_nPrecomputedSubFrusta = 0xF20; // 
                constexpr std::ptrdiff_t m_vPrecomputedOBBOrigin0 = 0xF24; // 
                constexpr std::ptrdiff_t m_vPrecomputedOBBAngles0 = 0xF30; // 
                constexpr std::ptrdiff_t m_vPrecomputedOBBExtent0 = 0xF3C; // 
                constexpr std::ptrdiff_t m_vPrecomputedOBBOrigin1 = 0xF48; // 
                constexpr std::ptrdiff_t m_vPrecomputedOBBAngles1 = 0xF54; // 
                constexpr std::ptrdiff_t m_vPrecomputedOBBExtent1 = 0xF60; // 
                constexpr std::ptrdiff_t m_vPrecomputedOBBOrigin2 = 0xF6C; // 
                constexpr std::ptrdiff_t m_vPrecomputedOBBAngles2 = 0xF78; // 
                constexpr std::ptrdiff_t m_vPrecomputedOBBExtent2 = 0xF84; // 
                constexpr std::ptrdiff_t m_vPrecomputedOBBOrigin3 = 0xF90; // 
                constexpr std::ptrdiff_t m_vPrecomputedOBBAngles3 = 0xF9C; // 
                constexpr std::ptrdiff_t m_vPrecomputedOBBExtent3 = 0xFA8; // 
                constexpr std::ptrdiff_t m_vPrecomputedOBBOrigin4 = 0xFB4; // 
                constexpr std::ptrdiff_t m_vPrecomputedOBBAngles4 = 0xFC0; // 
                constexpr std::ptrdiff_t m_vPrecomputedOBBExtent4 = 0xFCC; // 
                constexpr std::ptrdiff_t m_vPrecomputedOBBOrigin5 = 0xFD8; // 
                constexpr std::ptrdiff_t m_vPrecomputedOBBAngles5 = 0xFE4; // 
                constexpr std::ptrdiff_t m_vPrecomputedOBBExtent5 = 0xFF0; // 
                constexpr std::ptrdiff_t m_bInitialBoneSetup = 0x1040; // 
            ...
            namespace C_EconEntity {
                constexpr std::ptrdiff_t m_flFlexDelayTime = 0x1128; // 
                constexpr std::ptrdiff_t m_flFlexDelayedWeight = 0x1130; // 
                constexpr std::ptrdiff_t m_bAttributesInitialized = 0x1138; // 
                constexpr std::ptrdiff_t m_AttributeManager = 0x1140; // 
                constexpr std::ptrdiff_t m_OriginalOwnerXuidLow = 0x15E8; // 
                constexpr std::ptrdiff_t m_OriginalOwnerXuidHigh = 0x15EC; // 
                constexpr std::ptrdiff_t m_nFallbackPaintKit = 0x15F0; // 
                constexpr std::ptrdiff_t m_nFallbackSeed = 0x15F4; // 
                constexpr std::ptrdiff_t m_flFallbackWear = 0x15F8; // 
                constexpr std::ptrdiff_t m_nFallbackStatTrak = 0x15FC; // 
                constexpr std::ptrdiff_t m_bClientside = 0x1600; // 
                constexpr std::ptrdiff_t m_bParticleSystemsCreated = 0x1601; // 
                constexpr std::ptrdiff_t m_vecAttachedParticles = 0x1608; // 
                constexpr std::ptrdiff_t m_hViewmodelAttachment = 0x1620; // 
                constexpr std::ptrdiff_t m_iOldTeam = 0x1624; // 
                constexpr std::ptrdiff_t m_bAttachmentDirty = 0x1628; // 
                constexpr std::ptrdiff_t m_nUnloadedModelIndex = 0x162C; // 
                constexpr std::ptrdiff_t m_iNumOwnerValidationRetries = 0x1630; // 
                constexpr std::ptrdiff_t m_hOldProvidee = 0x1640; // 
            ...
            namespace C_RectLight {
                constexpr std::ptrdiff_t m_bShowLight = 0x1068; // 
            }
            // Parent: C_BaseModelEntity
            // Field count: 24
            //
            ...
            namespace C_ParticleSystem {
                constexpr std::ptrdiff_t m_szSnapshotFileName = 0xD20; // 
                constexpr std::ptrdiff_t m_bActive = 0xF20; // 
                constexpr std::ptrdiff_t m_bFrozen = 0xF21; // 
                constexpr std::ptrdiff_t m_flFreezeTransitionDuration = 0xF24; // 
                constexpr std::ptrdiff_t m_nStopType = 0xF28; // 
                constexpr std::ptrdiff_t m_bAnimateDuringGameplayPause = 0xF2C; // 
                constexpr std::ptrdiff_t m_iEffectIndex = 0xF30; // 
                constexpr std::ptrdiff_t m_flStartTime = 0xF38; // 
                constexpr std::ptrdiff_t m_flPreSimTime = 0xF3C; // 
                constexpr std::ptrdiff_t m_vServerControlPoints = 0xF40; // 
                constexpr std::ptrdiff_t m_iServerControlPointAssignments = 0xF70; // 
                constexpr std::ptrdiff_t m_hControlPointEnts = 0xF74; // 
                constexpr std::ptrdiff_t m_bNoSave = 0x1074; // 
                constexpr std::ptrdiff_t m_bNoFreeze = 0x1075; // 
                constexpr std::ptrdiff_t m_bNoRamp = 0x1076; // 
                constexpr std::ptrdiff_t m_bStartActive = 0x1077; // 
                constexpr std::ptrdiff_t m_iszEffectName = 0x1078; // 
                constexpr std::ptrdiff_t m_iszControlPointNames = 0x1080; // 
                constexpr std::ptrdiff_t m_nDataCP = 0x1280; // 
                constexpr std::ptrdiff_t m_vecDataCPValue = 0x1284; // 
                constexpr std::ptrdiff_t m_nTintCP = 0x1290; // 
                constexpr std::ptrdiff_t m_clrTint = 0x1294; // 
                constexpr std::ptrdiff_t m_bOldActive = 0x12B8; // 
                constexpr std::ptrdiff_t m_bOldFrozen = 0x12B9; // 
            }
            ...
            namespace C_Multimeter {
                constexpr std::ptrdiff_t m_hTargetC4 = 0xF88; // 
            }
            // Parent: C_BaseEntity
            // Field count: 2
            ...
            namespace C_EnvDecal {
                constexpr std::ptrdiff_t m_hDecalMaterial = 0xD20; // 
                constexpr std::ptrdiff_t m_flWidth = 0xD28; // 
                constexpr std::ptrdiff_t m_flHeight = 0xD2C; // 
                constexpr std::ptrdiff_t m_flDepth = 0xD30; // 
                constexpr std::ptrdiff_t m_nRenderOrder = 0xD34; // 
                constexpr std::ptrdiff_t m_bProjectOnWorld = 0xD38; // 
                constexpr std::ptrdiff_t m_bProjectOnCharacters = 0xD39; // 
                constexpr std::ptrdiff_t m_bProjectOnWater = 0xD3A; // 
                constexpr std::ptrdiff_t m_flDepthSortBias = 0xD3C; // 
            }
            // Parent: CCSGameModeRules
            // Field count: 0
            ...
            namespace C_BaseDoor {
                constexpr std::ptrdiff_t m_bIsUsable = 0xD20; // 
            }
            // Parent: C_BaseModelEntity
            // Field count: 2
            namespace CGrenadeTracer {
                constexpr std::ptrdiff_t m_flTracerDuration = 0xD38; // 
                constexpr std::ptrdiff_t m_nType = 0xD3C; // 
            }
            // Parent: C_BaseTrigger
            // Field count: 1
            //
            ...
            namespace CBombTarget {
                constexpr std::ptrdiff_t m_bBombPlantedHere = 0xD28; // 
            }
            // Parent: C_BaseClientUIEntity
            // Field count: 2
            //
            ...
            namespace C_PointClientUIDialog {
                constexpr std::ptrdiff_t m_hActivator = 0xD50; // 
                constexpr std::ptrdiff_t m_bStartEnabled = 0xD54; // 
            }
            // Parent: CCSGameModeRules
            // Field count: 1
            //
            ...
            namespace C_WeaponShield {
                constexpr std::ptrdiff_t m_flDisplayHealth = 0x1B20; // 
            }
            // Parent: C_PointClientUIWorldPanel
            // Field count: 1
            //
            ...
            namespace C_PointClientUIWorldTextPanel {
                constexpr std::ptrdiff_t m_messageText = 0xF80; // 
            }
            // Parent: CPlayer_UseServices
            // Field count: 0
            ...
            namespace C_EnvParticleGlow {
                constexpr std::ptrdiff_t m_flAlphaScale = 0x12D0; // 
                constexpr std::ptrdiff_t m_flRadiusScale = 0x12D4; // 
                constexpr std::ptrdiff_t m_flSelfIllumScale = 0x12D8; // 
                constexpr std::ptrdiff_t m_ColorTint = 0x12DC; // 
                constexpr std::ptrdiff_t m_hTextureOverride = 0x12E0; // 
            }
            // Parent: C_BaseEntity
            // Field count: 15
            ...
            namespace C_Sun {
                constexpr std::ptrdiff_t m_fxSSSunFlareEffectIndex = 0xD20; // 
                constexpr std::ptrdiff_t m_fxSunFlareEffectIndex = 0xD24; // 
                constexpr std::ptrdiff_t m_fdistNormalize = 0xD28; // 
                constexpr std::ptrdiff_t m_vSunPos = 0xD2C; // 
                constexpr std::ptrdiff_t m_vDirection = 0xD38; // 
                constexpr std::ptrdiff_t m_iszEffectName = 0xD48; // 
                constexpr std::ptrdiff_t m_iszSSEffectName = 0xD50; // 
                constexpr std::ptrdiff_t m_clrOverlay = 0xD58; // 
                constexpr std::ptrdiff_t m_bOn = 0xD5C; // 
                constexpr std::ptrdiff_t m_bmaxColor = 0xD5D; // 
                constexpr std::ptrdiff_t m_flSize = 0xD60; // 
                constexpr std::ptrdiff_t m_flHazeScale = 0xD64; // 
                constexpr std::ptrdiff_t m_flRotation = 0xD68; // 
                constexpr std::ptrdiff_t m_flHDRColorScale = 0xD6C; // 
                constexpr std::ptrdiff_t m_flAlphaHaze = 0xD70; // 
                constexpr std::ptrdiff_t m_flAlphaScale = 0xD74; // 
                constexpr std::ptrdiff_t m_flAlphaHdr = 0xD78; // 
                constexpr std::ptrdiff_t m_flFarZScale = 0xD7C; // 
            }
            // Parent: C_BaseEntity
            // Field count: 0
            ...
            namespace C_ColorCorrectionVolume {
                constexpr std::ptrdiff_t m_LastEnterWeight = 0xD28; // 
                constexpr std::ptrdiff_t m_LastEnterTime = 0xD2C; // 
                constexpr std::ptrdiff_t m_LastExitWeight = 0xD30; // 
                constexpr std::ptrdiff_t m_LastExitTime = 0xD34; // 
                constexpr std::ptrdiff_t m_bEnabled = 0xD38; // 
                constexpr std::ptrdiff_t m_MaxWeight = 0xD3C; // 
                constexpr std::ptrdiff_t m_FadeDuration = 0xD40; // 
                constexpr std::ptrdiff_t m_Weight = 0xD44; // 
                constexpr std::ptrdiff_t m_lookupFilename = 0xD48; // 
            }
            // Parent: C_BaseModelEntity
            // Field count: 0
            ...
            namespace C_BulletHitModel {
                constexpr std::ptrdiff_t m_matLocal = 0xF80; // 
                constexpr std::ptrdiff_t m_iBoneIndex = 0xFB0; // 
                constexpr std::ptrdiff_t m_hPlayerParent = 0xFB4; // 
                constexpr std::ptrdiff_t m_bIsHit = 0xFB8; // 
                constexpr std::ptrdiff_t m_flTimeCreated = 0xFBC; // 
                constexpr std::ptrdiff_t m_vecStartPos = 0xFC0; // 
            }
            // Parent: C_BaseEntity
            // Field count: 17
            //
            ...
            namespace C_OmniLight {
                constexpr std::ptrdiff_t m_flInnerAngle = 0x1068; // 
                constexpr std::ptrdiff_t m_flOuterAngle = 0x106C; // 
            ...
            namespace C_FuncLadder {
                constexpr std::ptrdiff_t m_vecLadderDir = 0xD20; // 
                constexpr std::ptrdiff_t m_Dismounts = 0xD30; // CUtlVector<CHandle<C_InfoLadderDismount>>
                constexpr std::ptrdiff_t m_vecLocalTop = 0xD48; // 
                constexpr std::ptrdiff_t m_vecPlayerMountPositionTop = 0xD54; // 
                constexpr std::ptrdiff_t m_vecPlayerMountPositionBottom = 0xD60; // 
                constexpr std::ptrdiff_t m_flAutoRideSpeed = 0xD6C; // 
                constexpr std::ptrdiff_t m_bDisabled = 0xD70; // 
                constexpr std::ptrdiff_t m_bFakeLadder = 0xD71; // 
                constexpr std::ptrdiff_t m_bHasSlack = 0xD72; // 
            }
            ...
            namespace C_BaseGrenade {
                constexpr std::ptrdiff_t m_bHasWarnedAI = 0x1118; // 
                constexpr std::ptrdiff_t m_bIsSmokeGrenade = 0x1119; // 
                constexpr std::ptrdiff_t m_bIsLive = 0x111A; // 
                constexpr std::ptrdiff_t m_DmgRadius = 0x111C; // 
                constexpr std::ptrdiff_t m_flDetonateTime = 0x1120; // 
                constexpr std::ptrdiff_t m_flWarnAITime = 0x1124; // 
            ...
            namespace C_PointCommentaryNode {
                constexpr std::ptrdiff_t m_bActive = 0xF88; // 
                constexpr std::ptrdiff_t m_bWasActive = 0xF89; // 
                constexpr std::ptrdiff_t m_flEndTime = 0xF8C; // 
                constexpr std::ptrdiff_t m_flStartTime = 0xF90; // 
                constexpr std::ptrdiff_t m_flStartTimeInCommentary = 0xF94; // 
                constexpr std::ptrdiff_t m_iszCommentaryFile = 0xF98; // 
                constexpr std::ptrdiff_t m_iszTitle = 0xFA0; // 
                constexpr std::ptrdiff_t m_iszSpeakers = 0xFA8; // 
                constexpr std::ptrdiff_t m_iNodeNumber = 0xFB0; // 
                constexpr std::ptrdiff_t m_iNodeNumberMax = 0xFB4; // 
                constexpr std::ptrdiff_t m_bListenedTo = 0xFB8; // 
                constexpr std::ptrdiff_t m_hViewPosition = 0xFC8; // 
                constexpr std::ptrdiff_t m_bRestartAfterRestore = 0xFCC; // 
            }
            // Parent: CCSPlayerBase_CameraServices
            // Field count: 0
            ...
            namespace C_FireSprite {
                constexpr std::ptrdiff_t m_vecMoveDir = 0xE30; // 
                constexpr std::ptrdiff_t m_bFadeFromAbove = 0xE3C; // 
            }
            // Parent: C_CSGO_TeamIntroCharacterPosition
            // Field count: 0
            ...
            namespace C_Precipitation {
                constexpr std::ptrdiff_t m_flDensity = 0xD28; // 
                constexpr std::ptrdiff_t m_flParticleInnerDist = 0xD38; // 
                constexpr std::ptrdiff_t m_pParticleDef = 0xD40; // 
                constexpr std::ptrdiff_t m_tParticlePrecipTraceTimer = 0xD68; // 
                constexpr std::ptrdiff_t m_bActiveParticlePrecipEmitter = 0xD70; // 
                constexpr std::ptrdiff_t m_bParticlePrecipInitialized = 0xD71; // 
                constexpr std::ptrdiff_t m_bHasSimulatedSinceLastSceneObjectUpdate = 0xD72; // 
                constexpr std::ptrdiff_t m_nAvailableSheetSequencesMaxIndex = 0xD74; // 
            }
            // Parent: CEntitySubclassVDataBase
            // Field count: 7
            //
            ...
            namespace C_BaseClientUIEntity {
                ...
                constexpr std::ptrdiff_t m_DialogXMLName = 0xD30; // 
                constexpr std::ptrdiff_t m_PanelClassName = 0xD38; // 
                constexpr std::ptrdiff_t m_PanelID = 0xD40; // 
            }
            // Parent: C_BaseModelEntity
            // Field count: 3
            namespace C_FuncTrackTrain {
                constexpr std::ptrdiff_t m_nLongAxis = 0xD20; // 
                constexpr std::ptrdiff_t m_flRadius = 0xD24; // 
                constexpr std::ptrdiff_t m_flLineLength = 0xD28; // 
            }
            // Parent: CPlayerPawnComponent
            // Field count: 4
            //
            ...
            // Field count: 4
            namespace CBaseProp {
                constexpr std::ptrdiff_t m_bModelOverrodeBlockLOS = 0xF80; // 
                constexpr std::ptrdiff_t m_iShapeType = 0xF84; // 
                constexpr std::ptrdiff_t m_bConformToCollisionBounds = 0xF88; // 
                constexpr std::ptrdiff_t m_mPreferredCatchTransform = 0xF8C; // 
            }
            // Parent: C_CSGO_PreviewPlayer
            // Field count: 0
            ...
            namespace C_CSGO_PreviewModel {
                constexpr std::ptrdiff_t m_animgraph = 0x1118; // 
                constexpr std::ptrdiff_t m_animgraphCharacterModeString = 0x1120; // 
                constexpr std::ptrdiff_t m_defaultAnim = 0x1128; // 
                constexpr std::ptrdiff_t m_nDefaultAnimLoopMode = 0x1130; // 
                constexpr std::ptrdiff_t m_flInitialModelScale = 0x1134; // 
                constexpr std::ptrdiff_t m_sInitialWeaponState = 0x1138; // 
            }
            // Parent: C_PointEntity
            // Field count: 5
            ...
            namespace C_TriggerPhysics {
                constexpr std::ptrdiff_t m_gravityScale = 0xD28; // 
                constexpr std::ptrdiff_t m_linearLimit = 0xD2C; // 
                constexpr std::ptrdiff_t m_linearDamping = 0xD30; // 
                constexpr std::ptrdiff_t m_angularLimit = 0xD34; // 
                constexpr std::ptrdiff_t m_angularDamping = 0xD38; // 
                constexpr std::ptrdiff_t m_linearForce = 0xD3C; // 
                constexpr std::ptrdiff_t m_flFrequency = 0xD40; // 
                constexpr std::ptrdiff_t m_flDampingRatio = 0xD44; // 
                constexpr std::ptrdiff_t m_vecLinearForcePointAt = 0xD48; // 
                constexpr std::ptrdiff_t m_bCollapseToForcePoint = 0xD54; // 
                constexpr std::ptrdiff_t m_vecLinearForcePointAtWorld = 0xD58; // 
                constexpr std::ptrdiff_t m_vecLinearForceDirection = 0xD64; // 
                constexpr std::ptrdiff_t m_bConvertToDebrisWhenPossible = 0xD70; // 
            }
            // Parent: CPlayerPawnComponent
            // Field count: 2
            //
            ...
            namespace C_PredictedViewModel {
                constexpr std::ptrdiff_t m_vPredictedLagOffset = 0xFE8; // 
                constexpr std::ptrdiff_t m_targetSpeed = 0xFF4; // 
                constexpr std::ptrdiff_t m_currentSpeed = 0x1000; // 
            }
            // Parent: C_CSWeaponBaseGun
            // Field count: 0
            ...
            namespace C_WeaponTaser {
                constexpr std::ptrdiff_t m_fFireTime = 0x1B20; // 
                constexpr std::ptrdiff_t m_nLastAttackTick = 0x1B24; // 
            }
            // Parent: C_CSWeaponBase
            // Field count: 2
            //
            ...
            namespace C_Fists {
                constexpr std::ptrdiff_t m_bPlayingUninterruptableAct = 0x1B00; // 
                constexpr std::ptrdiff_t m_nUninterruptableActivity = 0x1B04; // 
            }
            ...
            namespace C_PlayerSprayDecal {
                constexpr std::ptrdiff_t m_nUniqueID = 0xD20; // 
                constexpr std::ptrdiff_t m_unAccountID = 0xD24; // 
                constexpr std::ptrdiff_t m_unTraceID = 0xD28; // 
                constexpr std::ptrdiff_t m_rtGcTime = 0xD2C; // 
                constexpr std::ptrdiff_t m_vecEndPos = 0xD30; // 
                constexpr std::ptrdiff_t m_vecStart = 0xD3C; // 
                constexpr std::ptrdiff_t m_vecLeft = 0xD48; // 
                constexpr std::ptrdiff_t m_vecNormal = 0xD54; // 
                constexpr std::ptrdiff_t m_nPlayer = 0xD60; // 
                constexpr std::ptrdiff_t m_nEntity = 0xD64; // 
                constexpr std::ptrdiff_t m_nHitbox = 0xD68; // 
                constexpr std::ptrdiff_t m_flCreationTime = 0xD6C; // 
                constexpr std::ptrdiff_t m_nTintID = 0xD70; // 
                constexpr std::ptrdiff_t m_nVersion = 0xD74; // 
                constexpr std::ptrdiff_t m_ubSignature = 0xD75; // 
                constexpr std::ptrdiff_t m_SprayRenderHelper = 0xE00; // 
            }
            // Parent: None
            // Field count: 2
            //
            ...
            namespace C_ShatterGlassShardPhysics {
                constexpr std::ptrdiff_t m_ShardDesc = 0x1118; // 
            }
            // Parent: C_CSWeaponBaseGun
            // Field count: 0
            ...
            namespace C_LightEntity {
                constexpr std::ptrdiff_t m_CLightComponent = 0xD20; // 
            }
            // Parent: C_BaseEntity
            // Field count: 6
            //
            ...
            namespace C_BaseFlex {
                ...
                constexpr std::ptrdiff_t m_vLookTargetPosition = 0xFA8; // 
                constexpr std::ptrdiff_t m_blinktoggle = 0xFC0; // 
                constexpr std::ptrdiff_t m_nLastFlexUpdateFrameCount = 0x1020; // 
                constexpr std::ptrdiff_t m_CachedViewTarget = 0x1024; // 
                constexpr std::ptrdiff_t m_nNextSceneEventId = 0x1030; // 
                constexpr std::ptrdiff_t m_iBlink = 0x1034; // 
                constexpr std::ptrdiff_t m_blinktime = 0x1038; // 
                constexpr std::ptrdiff_t m_prevblinktoggle = 0x103C; // 
                constexpr std::ptrdiff_t m_iJawOpen = 0x1040; // 
                constexpr std::ptrdiff_t m_flJawOpenAmount = 0x1044; // 
                constexpr std::ptrdiff_t m_flBlinkAmount = 0x1048; // 
                constexpr std::ptrdiff_t m_iMouthAttachment = 0x104C; // 
                constexpr std::ptrdiff_t m_iEyeAttachment = 0x104D; // 
                constexpr std::ptrdiff_t m_bResetFlexWeightsOnModelChange = 0x104E; // 
                constexpr std::ptrdiff_t m_nEyeOcclusionRendererBone = 0x1068; // 
                constexpr std::ptrdiff_t m_mEyeOcclusionRendererCameraToBoneTransform = 0x106C; // 
                constexpr std::ptrdiff_t m_vEyeOcclusionRendererHalfExtent = 0x109C; // 
            ...
            // NetworkVarNames: m_bEnabled (bool)
            namespace C_EnvSky {
                constexpr std::ptrdiff_t m_hSkyMaterial = 0xD20; // 
                constexpr std::ptrdiff_t m_hSkyMaterialLightingOnly = 0xD28; // 
                constexpr std::ptrdiff_t m_bStartDisabled = 0xD30; // 
                constexpr std::ptrdiff_t m_vTintColor = 0xD31; // 
                constexpr std::ptrdiff_t m_vTintColorLightingOnly = 0xD35; // 
                constexpr std::ptrdiff_t m_flBrightnessScale = 0xD3C; // 
                constexpr std::ptrdiff_t m_nFogType = 0xD40; // 
                constexpr std::ptrdiff_t m_flFogMinStart = 0xD44; // 
                constexpr std::ptrdiff_t m_flFogMinEnd = 0xD48; // 
                constexpr std::ptrdiff_t m_flFogMaxStart = 0xD4C; // 
                constexpr std::ptrdiff_t m_flFogMaxEnd = 0xD50; // 
                constexpr std::ptrdiff_t m_bEnabled = 0xD54; // 
            }
            // Parent: C_PointEntity
            // Field count: 0
            ...
            namespace C_DynamicProp {
                constexpr std::ptrdiff_t m_bUseHitboxesForRenderBox = 0x1108; // 
                constexpr std::ptrdiff_t m_bUseAnimGraph = 0x1109; // 
                constexpr std::ptrdiff_t m_pOutputAnimBegun = 0x1110; // 
                constexpr std::ptrdiff_t m_pOutputAnimOver = 0x1138; // 
                constexpr std::ptrdiff_t m_pOutputAnimLoopCycleOver = 0x1160; // 
                constexpr std::ptrdiff_t m_OnAnimReachedStart = 0x1188; // 
                constexpr std::ptrdiff_t m_OnAnimReachedEnd = 0x11B0; // 
                constexpr std::ptrdiff_t m_iszIdleAnim = 0x11D8; // 
                constexpr std::ptrdiff_t m_nIdleAnimLoopMode = 0x11E0; // 
                constexpr std::ptrdiff_t m_bRandomizeCycle = 0x11E4; // 
                constexpr std::ptrdiff_t m_bStartDisabled = 0x11E5; // 
                constexpr std::ptrdiff_t m_bFiredStartEndOutput = 0x11E6; // 
                constexpr std::ptrdiff_t m_bForceNpcExclude = 0x11E7; // 
                constexpr std::ptrdiff_t m_bCreateNonSolid = 0x11E8; // 
                constexpr std::ptrdiff_t m_bIsOverrideProp = 0x11E9; // 
                constexpr std::ptrdiff_t m_iInitialGlowState = 0x11EC; // 
                constexpr std::ptrdiff_t m_nGlowRange = 0x11F0; // 
                constexpr std::ptrdiff_t m_nGlowRangeMin = 0x11F4; // 
                constexpr std::ptrdiff_t m_glowColor = 0x11F8; // 
                constexpr std::ptrdiff_t m_nGlowTeam = 0x11FC; // 
                constexpr std::ptrdiff_t m_iCachedFrameCount = 0x1200; // 
                constexpr std::ptrdiff_t m_vecCachedRenderMins = 0x1204; // 
                constexpr std::ptrdiff_t m_vecCachedRenderMaxs = 0x1210; // 
            }
            // Parent: CEntityComponent
            // Field count: 10
            ...
            namespace C_KeychainModule {
                constexpr std::ptrdiff_t m_nKeychainDefID = 0xF88; // 
                constexpr std::ptrdiff_t m_nKeychainSeed = 0xF8C; // 
            }
            // Parent: C_BaseEntity
            // Field count: 8
            //
            ...
            namespace C_LocalTempEntity {
                constexpr std::ptrdiff_t flags = 0xF80; // 
                constexpr std::ptrdiff_t die = 0xF84; // 
                constexpr std::ptrdiff_t m_flFrameMax = 0xF88; // 
                constexpr std::ptrdiff_t x = 0xF8C; // 
                constexpr std::ptrdiff_t y = 0xF90; // 
                constexpr std::ptrdiff_t fadeSpeed = 0xF94; // 
                constexpr std::ptrdiff_t bounceFactor = 0xF98; // 
                constexpr std::ptrdiff_t hitSound = 0xF9C; // 
                constexpr std::ptrdiff_t priority = 0xFA0; // 
                constexpr std::ptrdiff_t tentOffset = 0xFA4; // 
                constexpr std::ptrdiff_t m_vecTempEntAngVelocity = 0xFB0; // 
                constexpr std::ptrdiff_t tempent_renderamt = 0xFBC; // 
                constexpr std::ptrdiff_t m_vecNormal = 0xFC0; // 
                constexpr std::ptrdiff_t m_flSpriteScale = 0xFCC; // 
                constexpr std::ptrdiff_t m_nFlickerFrame = 0xFD0; // 
                constexpr std::ptrdiff_t m_flFrameRate = 0xFD4; // 
                constexpr std::ptrdiff_t m_flFrame = 0xFD8; // 
                constexpr std::ptrdiff_t m_pszImpactEffect = 0xFE0; // 
                constexpr std::ptrdiff_t m_pszParticleEffect = 0xFE8; // 
                constexpr std::ptrdiff_t m_bParticleCollision = 0xFF0; // 
                constexpr std::ptrdiff_t m_iLastCollisionFrame = 0xFF4; // 
                constexpr std::ptrdiff_t m_vLastCollisionOrigin = 0xFF8; // 
                constexpr std::ptrdiff_t m_vecTempEntVelocity = 0x1004; // 
                constexpr std::ptrdiff_t m_vecPrevAbsOrigin = 0x1010; // 
                constexpr std::ptrdiff_t m_vecTempEntAcceleration = 0x101C; // 
            }
            // Parent: None
            // Field count: 2
            ...
            namespace C_MolotovProjectile {
                constexpr std::ptrdiff_t m_bIsIncGrenade = 0x1200; // 
            }
            ...
            namespace C_DynamicLight {
                constexpr std::ptrdiff_t m_Flags = 0xD20; // 
                constexpr std::ptrdiff_t m_LightStyle = 0xD21; // 
                constexpr std::ptrdiff_t m_Radius = 0xD24; // 
                constexpr std::ptrdiff_t m_Exponent = 0xD28; // 
                constexpr std::ptrdiff_t m_InnerAngle = 0xD2C; // 
                constexpr std::ptrdiff_t m_OuterAngle = 0xD30; // 
                constexpr std::ptrdiff_t m_SpotRadius = 0xD34; // 
            }
            ...
            namespace C_CSWeaponBase {
                constexpr std::ptrdiff_t m_flFireSequenceStartTime = 0x16D4; // 
                constexpr std::ptrdiff_t m_nFireSequenceStartTimeChange = 0x16D8; // 
                constexpr std::ptrdiff_t m_nFireSequenceStartTimeAck = 0x16DC; // 
                constexpr std::ptrdiff_t m_ePlayerFireEvent = 0x16E0; // 
                constexpr std::ptrdiff_t m_ePlayerFireEventAttackType = 0x16E4; // 
                constexpr std::ptrdiff_t m_seqIdle = 0x16E8; // 
                constexpr std::ptrdiff_t m_seqFirePrimary = 0x16EC; // 
                constexpr std::ptrdiff_t m_seqFireSecondary = 0x16F0; // 
                constexpr std::ptrdiff_t m_thirdPersonFireSequences = 0x16F8; // 
                constexpr std::ptrdiff_t m_hCurrentThirdPersonSequence = 0x1710; // 
                constexpr std::ptrdiff_t m_nSilencerBoneIndex = 0x1714; // 
                constexpr std::ptrdiff_t m_thirdPersonSequences = 0x1718; // 
                constexpr std::ptrdiff_t m_ClientPreviousWeaponState = 0x1750; // 
                constexpr std::ptrdiff_t m_iState = 0x1754; // 
                constexpr std::ptrdiff_t m_flCrosshairDistance = 0x1758; // 
                constexpr std::ptrdiff_t m_iAmmoLastCheck = 0x175C; // 
                constexpr std::ptrdiff_t m_iAlpha = 0x1760; // 
                constexpr std::ptrdiff_t m_iScopeTextureID = 0x1764; // 
                constexpr std::ptrdiff_t m_iCrosshairTextureID = 0x1768; // 
                constexpr std::ptrdiff_t m_flGunAccuracyPositionDeprecated = 0x176C; // 
                constexpr std::ptrdiff_t m_nLastEmptySoundCmdNum = 0x1770; // 
                constexpr std::ptrdiff_t m_nViewModelIndex = 0x1774; // 
                constexpr std::ptrdiff_t m_bReloadsWithClips = 0x1778; // 
                constexpr std::ptrdiff_t m_flTimeWeaponIdle = 0x177C; // 
                constexpr std::ptrdiff_t m_bFireOnEmpty = 0x1780; // 
                constexpr std::ptrdiff_t m_OnPlayerPickup = 0x1788; // 
                constexpr std::ptrdiff_t m_weaponMode = 0x17B0; // 
                constexpr std::ptrdiff_t m_flTurningInaccuracyDelta = 0x17B4; // 
                constexpr std::ptrdiff_t m_vecTurningInaccuracyEyeDirLast = 0x17B8; // 
                constexpr std::ptrdiff_t m_flTurningInaccuracy = 0x17C4; // 
                constexpr std::ptrdiff_t m_fAccuracyPenalty = 0x17C8; // 
                constexpr std::ptrdiff_t m_flLastAccuracyUpdateTime = 0x17CC; // 
                constexpr std::ptrdiff_t m_fAccuracySmoothedForZoom = 0x17D0; // 
                constexpr std::ptrdiff_t m_fScopeZoomEndTime = 0x17D4; // 
                constexpr std::ptrdiff_t m_iRecoilIndex = 0x17D8; // 
                constexpr std::ptrdiff_t m_flRecoilIndex = 0x17DC; // 
                constexpr std::ptrdiff_t m_bBurstMode = 0x17E0; // 
                constexpr std::ptrdiff_t m_flLastBurstModeChangeTime = 0x17E4; // 
                constexpr std::ptrdiff_t m_nPostponeFireReadyTicks = 0x17E8; // 
                constexpr std::ptrdiff_t m_flPostponeFireReadyFrac = 0x17EC; // 
                constexpr std::ptrdiff_t m_bInReload = 0x17F0; // 
                constexpr std::ptrdiff_t m_bReloadVisuallyComplete = 0x17F1; // 
                constexpr std::ptrdiff_t m_flDroppedAtTime = 0x17F4; // 
                constexpr std::ptrdiff_t m_bIsHauledBack = 0x17F8; // 
                constexpr std::ptrdiff_t m_bSilencerOn = 0x17F9; // 
                constexpr std::ptrdiff_t m_flTimeSilencerSwitchComplete = 0x17FC; // 
                constexpr std::ptrdiff_t m_iOriginalTeamNumber = 0x1800; // 
                constexpr std::ptrdiff_t m_iMostRecentTeamNumber = 0x1804; // 
                constexpr std::ptrdiff_t m_bDroppedNearBuyZone = 0x1808; // 
                constexpr std::ptrdiff_t m_flNextAttackRenderTimeOffset = 0x180C; // 
                constexpr std::ptrdiff_t m_bClearWeaponIdentifyingUGC = 0x18A8; // 
                constexpr std::ptrdiff_t m_bVisualsDataSet = 0x18A9; // 
                ...
                constexpr std::ptrdiff_t m_bWasOwnedByCT = 0x18E4; // 
                constexpr std::ptrdiff_t m_bWasOwnedByTerrorist = 0x18E5; // 
                constexpr std::ptrdiff_t m_gunHeat = 0x18E8; // 
                constexpr std::ptrdiff_t m_smokeAttachments = 0x18EC; // 
                constexpr std::ptrdiff_t m_lastSmokeTime = 0x18F0; // 
                constexpr std::ptrdiff_t m_flNextClientFireBulletTime = 0x18F4; // 
                constexpr std::ptrdiff_t m_flNextClientFireBulletTime_Repredict = 0x18F8; // 
                constexpr std::ptrdiff_t m_IronSightController = 0x19D0; // 
                constexpr std::ptrdiff_t m_iIronSightMode = 0x1A80; // 
                constexpr std::ptrdiff_t m_flLastLOSTraceFailureTime = 0x1A90; // 
                constexpr std::ptrdiff_t m_iNumEmptyAttacks = 0x1A94; // 
                constexpr std::ptrdiff_t m_flLastMagDropRequestTime = 0x1AF0; // 
                constexpr std::ptrdiff_t m_flWatTickOffset = 0x1AF4; // 
            }
            // Parent: C_BaseModelEntity
            // Field count: 0
            ...
            namespace C_FuncElectrifiedVolume {
                constexpr std::ptrdiff_t m_nAmbientEffect = 0xD20; // 
                constexpr std::ptrdiff_t m_EffectName = 0xD28; // 
                constexpr std::ptrdiff_t m_bState = 0xD30; // 
            }
            ...
            namespace C_StattrakModule {
                constexpr std::ptrdiff_t m_bKnife = 0xF88; // 
            }
            // Parent: C_BreakableProp
            // Field count: 1
            //
            ...
            namespace C_PhysicsProp {
                constexpr std::ptrdiff_t m_bAwake = 0x1108; // 
            }
            // Parent: CBaseProp
            // Field count: 29
            //
            ...
            namespace C_BreakableProp {
                constexpr std::ptrdiff_t m_CPropDataComponent = 0xFC0; // 
                constexpr std::ptrdiff_t m_OnBreak = 0x1000; // 
                constexpr std::ptrdiff_t m_OnHealthChanged = 0x1028; // CEntityOutputTemplate<float32>
                constexpr std::ptrdiff_t m_OnTakeDamage = 0x1050; // 
                constexpr std::ptrdiff_t m_impactEnergyScale = 0x1078; // 
                constexpr std::ptrdiff_t m_iMinHealthDmg = 0x107C; // 
                constexpr std::ptrdiff_t m_flPressureDelay = 0x1080; // 
                constexpr std::ptrdiff_t m_flDefBurstScale = 0x1084; // 
                constexpr std::ptrdiff_t m_vDefBurstOffset = 0x1088; // 
                constexpr std::ptrdiff_t m_hBreaker = 0x1094; // 
                constexpr std::ptrdiff_t m_PerformanceMode = 0x1098; // 
                constexpr std::ptrdiff_t m_flPreventDamageBeforeTime = 0x109C; // 
                constexpr std::ptrdiff_t m_BreakableContentsType = 0x10A0; // 
                constexpr std::ptrdiff_t m_strBreakableContentsPropGroupOverride = 0x10A8; // 
                constexpr std::ptrdiff_t m_strBreakableContentsParticleOverride = 0x10B0; // 
                constexpr std::ptrdiff_t m_bHasBreakPiecesOrCommands = 0x10B8; // 
                constexpr std::ptrdiff_t m_explodeDamage = 0x10BC; // 
                constexpr std::ptrdiff_t m_explodeRadius = 0x10C0; // 
                constexpr std::ptrdiff_t m_explosionDelay = 0x10C8; // 
                constexpr std::ptrdiff_t m_explosionBuildupSound = 0x10D0; // 
                constexpr std::ptrdiff_t m_explosionCustomEffect = 0x10D8; // 
                constexpr std::ptrdiff_t m_explosionCustomSound = 0x10E0; // 
                constexpr std::ptrdiff_t m_explosionModifier = 0x10E8; // 
                constexpr std::ptrdiff_t m_hPhysicsAttacker = 0x10F0; // 
                constexpr std::ptrdiff_t m_flLastPhysicsInfluenceTime = 0x10F4; // 
                constexpr std::ptrdiff_t m_flDefaultFadeScale = 0x10F8; // 
                constexpr std::ptrdiff_t m_hLastAttacker = 0x10FC; // 
                constexpr std::ptrdiff_t m_hFlareEnt = 0x1100; // 
                constexpr std::ptrdiff_t m_noGhostCollision = 0x1104; // 
            }
            // Parent: C_BaseToggle
            // Field count: 0
            //
            ...
            // NetworkVarNames: m_vecEndPos (Vector)
            namespace C_Beam {
                constexpr std::ptrdiff_t m_flFrameRate = 0xD20; // 
                constexpr std::ptrdiff_t m_flHDRColorScale = 0xD24; // 
                constexpr std::ptrdiff_t m_flFireTime = 0xD28; // 
                constexpr std::ptrdiff_t m_flDamage = 0xD2C; // 
                constexpr std::ptrdiff_t m_nNumBeamEnts = 0xD30; // 
                constexpr std::ptrdiff_t m_queryHandleHalo = 0xD34; // 
                constexpr std::ptrdiff_t m_hBaseMaterial = 0xD58; // 
                constexpr std::ptrdiff_t m_nHaloIndex = 0xD60; // 
                constexpr std::ptrdiff_t m_nBeamType = 0xD68; // 
                constexpr std::ptrdiff_t m_nBeamFlags = 0xD6C; // 
                constexpr std::ptrdiff_t m_hAttachEntity = 0xD70; // 
                constexpr std::ptrdiff_t m_nAttachIndex = 0xD98; // 
                constexpr std::ptrdiff_t m_fWidth = 0xDA4; // 
                constexpr std::ptrdiff_t m_fEndWidth = 0xDA8; // 
                constexpr std::ptrdiff_t m_fFadeLength = 0xDAC; // 
                constexpr std::ptrdiff_t m_fHaloScale = 0xDB0; // 
                constexpr std::ptrdiff_t m_fAmplitude = 0xDB4; // 
                constexpr std::ptrdiff_t m_fStartFrame = 0xDB8; // 
                constexpr std::ptrdiff_t m_fSpeed = 0xDBC; // 
                constexpr std::ptrdiff_t m_flFrame = 0xDC0; // 
                constexpr std::ptrdiff_t m_nClipStyle = 0xDC4; // 
                constexpr std::ptrdiff_t m_bTurnedOff = 0xDC8; // 
                constexpr std::ptrdiff_t m_vecEndPos = 0xDCC; // 
                constexpr std::ptrdiff_t m_hEndEntity = 0xDD8; // 
            }
            // Parent: C_BaseEntity
            // Field count: 8
            //
            ...
            namespace C_PointWorldText {
                constexpr std::ptrdiff_t m_bForceRecreateNextUpdate = 0xD28; // 
                constexpr std::ptrdiff_t m_messageText = 0xD38; // 
                constexpr std::ptrdiff_t m_FontName = 0xF38; // 
                constexpr std::ptrdiff_t m_bEnabled = 0xF78; // 
                constexpr std::ptrdiff_t m_bFullbright = 0xF79; // 
                constexpr std::ptrdiff_t m_flWorldUnitsPerPx = 0xF7C; // 
                constexpr std::ptrdiff_t m_flFontSize = 0xF80; // 
                constexpr std::ptrdiff_t m_flDepthOffset = 0xF84; // 
                constexpr std::ptrdiff_t m_Color = 0xF88; // 
                constexpr std::ptrdiff_t m_nJustifyHorizontal = 0xF8C; // PointWorldTextJustifyHorizontal_t
                constexpr std::ptrdiff_t m_nJustifyVertical = 0xF90; // 
                constexpr std::ptrdiff_t m_nReorientMode = 0xF94; // 
            }
            // Parent: C_BaseGrenade
            // Field count: 0
            ...
            namespace CCSPlayerController {
                ...
                constexpr std::ptrdiff_t m_bMvpNoMusic = 0x850; // 
                constexpr std::ptrdiff_t m_eMvpReason = 0x854; // 
                constexpr std::ptrdiff_t m_iMusicKitID = 0x858; // 
                constexpr std::ptrdiff_t m_iMusicKitMVPs = 0x85C; // 
                constexpr std::ptrdiff_t m_iMVPs = 0x860; // 
                constexpr std::ptrdiff_t m_bIsPlayerNameDirty = 0x864; // 
            }
            // Parent: C_CSWeaponBaseGun
            // Field count: 0
            ...
            namespace C_BasePropDoor {
                constexpr std::ptrdiff_t m_eDoorState = 0x1230; // 
                constexpr std::ptrdiff_t m_modelChanged = 0x1234; // 
                constexpr std::ptrdiff_t m_bLocked = 0x1235; // 
                constexpr std::ptrdiff_t m_closedPosition = 0x1238; // 
                constexpr std::ptrdiff_t m_closedAngles = 0x1244; // 
                constexpr std::ptrdiff_t m_hMaster = 0x1250; // 
                constexpr std::ptrdiff_t m_vWhereToSetLightingOrigin = 0x1254; // 
            }
            // Parent: C_CSGO_TeamSelectCharacterPosition
            // Field count: 0
            ...
            namespace C_NametagModule {
                constexpr std::ptrdiff_t m_strNametagString = 0xF88; // 
            }
            // Parent: C_BreakableProp
            // Field count: 6
            namespace C_PhysPropClientside {
                constexpr std::ptrdiff_t m_flTouchDelta = 0x1108; // 
                constexpr std::ptrdiff_t m_fDeathTime = 0x110C; // 
                constexpr std::ptrdiff_t m_inertiaScale = 0x1110; // 
                constexpr std::ptrdiff_t m_vecDamagePosition = 0x1114; // 
                constexpr std::ptrdiff_t m_vecDamageDirection = 0x1120; // 
                constexpr std::ptrdiff_t m_nDamageType = 0x112C; // 
            }
            // Parent: C_CSGO_TeamPreviewCamera
            // Field count: 0
            ...
            namespace C_PhysMagnet {
                constexpr std::ptrdiff_t m_aAttachedObjectsFromServer = 0xF80; // 
            ...
            namespace C_FuncConveyor {
                constexpr std::ptrdiff_t m_vecMoveDirEntitySpace = 0xD28; // 
                constexpr std::ptrdiff_t m_flTargetSpeed = 0xD34; // 
                constexpr std::ptrdiff_t m_nTransitionStartTick = 0xD38; // 
                constexpr std::ptrdiff_t m_nTransitionDurationTicks = 0xD3C; // 
                constexpr std::ptrdiff_t m_flTransitionStartSpeed = 0xD40; // 
                constexpr std::ptrdiff_t m_hConveyorModels = 0xD48; // 
                constexpr std::ptrdiff_t m_flCurrentConveyorOffset = 0xD60; // 
                constexpr std::ptrdiff_t m_flCurrentConveyorSpeed = 0xD64; // 
            }
            // Parent: None
            // Field count: 4
            //
            ...
            namespace C_BaseViewModel {
                constexpr std::ptrdiff_t m_vecLastFacing = 0xF88; // 
                constexpr std::ptrdiff_t m_nViewModelIndex = 0xF94; // 
                constexpr std::ptrdiff_t m_nAnimationParity = 0xF98; // 
                constexpr std::ptrdiff_t m_flAnimationStartTime = 0xF9C; // 
                constexpr std::ptrdiff_t m_hWeapon = 0xFA0; // 
                constexpr std::ptrdiff_t m_sVMName = 0xFA8; // 
                constexpr std::ptrdiff_t m_sAnimationPrefix = 0xFB0; // 
                constexpr std::ptrdiff_t m_iCameraAttachment = 0xFB8; // 
                constexpr std::ptrdiff_t m_vecLastCameraAngles = 0xFBC; // 
                constexpr std::ptrdiff_t m_previousElapsedDuration = 0xFC8; // 
                constexpr std::ptrdiff_t m_previousCycle = 0xFCC; // 
                constexpr std::ptrdiff_t m_nOldAnimationParity = 0xFD0; // 
                constexpr std::ptrdiff_t m_hOldLayerSequence = 0xFD4; // 
                constexpr std::ptrdiff_t m_oldLayer = 0xFD8; // 
                constexpr std::ptrdiff_t m_oldLayerStartTime = 0xFDC; // 
                constexpr std::ptrdiff_t m_hControlPanel = 0xFE0; // 
            }
            // Parent: C_BaseEntity
            // Field count: 0
            ...
            namespace C_CSObserverPawn {
                constexpr std::ptrdiff_t m_hDetectParentChange = 0x1508; // 
            }
            // Parent: C_BaseEntity
            // Field count: 3
            //
            ...
            namespace C_Hostage {
                constexpr std::ptrdiff_t m_entitySpottedState = 0x11A0; // 
                constexpr std::ptrdiff_t m_leader = 0x11B8; // 
                constexpr std::ptrdiff_t m_reuseTimer = 0x11C0; // 
                constexpr std::ptrdiff_t m_vel = 0x11D8; // 
                constexpr std::ptrdiff_t m_isRescued = 0x11E4; // 
                ...
                constexpr std::ptrdiff_t m_flGrabSuccessTime = 0x1208; // 
                constexpr std::ptrdiff_t m_flDropStartTime = 0x120C; // 
                constexpr std::ptrdiff_t m_flDeadOrRescuedTime = 0x1210; // 
                constexpr std::ptrdiff_t m_blinkTimer = 0x1218; // 
                constexpr std::ptrdiff_t m_lookAt = 0x1230; // 
                constexpr std::ptrdiff_t m_lookAroundTimer = 0x1240; // 
                constexpr std::ptrdiff_t m_isInit = 0x1258; // 
                constexpr std::ptrdiff_t m_eyeAttachment = 0x1259; // 
                constexpr std::ptrdiff_t m_chestAttachment = 0x125A; // 
                constexpr std::ptrdiff_t m_pPredictionOwner = 0x1260; // 
                constexpr std::ptrdiff_t m_fNewestAlphaThinkTime = 0x1268; // 
            }
            // Parent: C_BaseModelEntity
            // Field count: 24
            //
            ...
            // NetworkVarNames: m_flHDRColorScale (float32)
            namespace C_Sprite {
                constexpr std::ptrdiff_t m_hSpriteMaterial = 0xD20; // 
                constexpr std::ptrdiff_t m_hAttachedToEntity = 0xD28; // 
                constexpr std::ptrdiff_t m_nAttachment = 0xD2C; // 
                constexpr std::ptrdiff_t m_flSpriteFramerate = 0xD30; // 
                constexpr std::ptrdiff_t m_flFrame = 0xD34; // 
                constexpr std::ptrdiff_t m_flDieTime = 0xD38; // 
                constexpr std::ptrdiff_t m_nBrightness = 0xD48; // 
                constexpr std::ptrdiff_t m_flBrightnessDuration = 0xD4C; // 
                constexpr std::ptrdiff_t m_flSpriteScale = 0xD50; // 
                constexpr std::ptrdiff_t m_flScaleDuration = 0xD54; // 
                constexpr std::ptrdiff_t m_bWorldSpaceScale = 0xD58; // 
                constexpr std::ptrdiff_t m_flGlowProxySize = 0xD5C; // 
                constexpr std::ptrdiff_t m_flHDRColorScale = 0xD60; // 
                constexpr std::ptrdiff_t m_flLastTime = 0xD64; // 
                constexpr std::ptrdiff_t m_flMaxFrame = 0xD68; // 
                constexpr std::ptrdiff_t m_flStartScale = 0xD6C; // 
                constexpr std::ptrdiff_t m_flDestScale = 0xD70; // 
                constexpr std::ptrdiff_t m_flScaleTimeStart = 0xD74; // 
                constexpr std::ptrdiff_t m_nStartBrightness = 0xD78; // 
                constexpr std::ptrdiff_t m_nDestBrightness = 0xD7C; // 
                constexpr std::ptrdiff_t m_flBrightnessTimeStart = 0xD80; // 
                constexpr std::ptrdiff_t m_hOldSpriteMaterial = 0xD88; // 
                constexpr std::ptrdiff_t m_nSpriteWidth = 0xE28; // 
                constexpr std::ptrdiff_t m_nSpriteHeight = 0xE2C; // 
            }
            // Parent: C_CSWeaponBaseGun
            // Field count: 0
            ...
            namespace C_PlantedC4 {
                constexpr std::ptrdiff_t m_bBombTicking = 0xF88; // 
                constexpr std::ptrdiff_t m_nBombSite = 0xF8C; // 
                constexpr std::ptrdiff_t m_nSourceSoundscapeHash = 0xF90; // 
                constexpr std::ptrdiff_t m_entitySpottedState = 0xF98; // 
                constexpr std::ptrdiff_t m_flNextGlow = 0xFB0; // 
                constexpr std::ptrdiff_t m_flNextBeep = 0xFB4; // 
                constexpr std::ptrdiff_t m_flC4Blow = 0xFB8; // 
                constexpr std::ptrdiff_t m_bCannotBeDefused = 0xFBC; // 
                constexpr std::ptrdiff_t m_bHasExploded = 0xFBD; // 
                constexpr std::ptrdiff_t m_flTimerLength = 0xFC0; // 
                constexpr std::ptrdiff_t m_bBeingDefused = 0xFC4; // 
                constexpr std::ptrdiff_t m_bTriggerWarning = 0xFC8; // 
                constexpr std::ptrdiff_t m_bExplodeWarning = 0xFCC; // 
                constexpr std::ptrdiff_t m_bC4Activated = 0xFD0; // 
                constexpr std::ptrdiff_t m_bTenSecWarning = 0xFD1; // 
                ...
                constexpr std::ptrdiff_t m_vecC4ExplodeSpectateAng = 0x14BC; // 
                constexpr std::ptrdiff_t m_flC4ExplodeSpectateDuration = 0x14C8; // 
            }
            // Parent: CBaseAnimGraph
            // Field count: 8
            //
            ...
            namespace C_RagdollProp {
                ...
                constexpr std::ptrdiff_t m_flBlendWeight = 0xFB8; // 
                constexpr std::ptrdiff_t m_hRagdollSource = 0xFBC; // 
                constexpr std::ptrdiff_t m_iEyeAttachment = 0xFC0; // 
                constexpr std::ptrdiff_t m_flBlendWeightCurrent = 0xFC4; // 
                constexpr std::ptrdiff_t m_parentPhysicsBoneIndices = 0xFC8; // 
                constexpr std::ptrdiff_t m_worldSpaceBoneComputationOrder = 0xFE0; // 
            }
            // Parent: C_CSGO_TeamPreviewCamera
            // Field count: 0
            ...
            namespace C_Chicken {
                ...
                constexpr std::ptrdiff_t m_bIsPreviewModel = 0x16E8; // 
            }
            // Parent: None
            // Field count: 2
            //
