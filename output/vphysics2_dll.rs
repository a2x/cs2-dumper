    ...
    pub mod schemas {
        ...
        pub mod vphysics2_dll {
            ...
            pub mod PhysFeModelDesc_t {
                ...
                pub const m_AxialEdges: usize = 0x168; // 
                pub const m_NodeInvMasses: usize = 0x180; // 
                pub const m_CtrlOffsets: usize = 0x198; // 
                pub const m_CtrlOsOffsets: usize = 0x1B0; // 
                pub const m_FollowNodes: usize = 0x1C8; // 
                ...
                pub const m_NodeCollisionRadii: usize = 0x270; // 
                pub const m_DynNodeFriction: usize = 0x288; // 
                pub const m_LocalRotation: usize = 0x2A0; // 
                pub const m_LocalForce: usize = 0x2B8; // 
                ...
                pub const m_SphereRigids: usize = 0x300; // 
                pub const m_WorldCollisionNodes: usize = 0x318; // 
                pub const m_TreeParents: usize = 0x330; // 
                pub const m_TreeCollisionMasks: usize = 0x348; // 
                pub const m_TreeChildren: usize = 0x360; // 
                pub const m_FreeNodes: usize = 0x378; // 
                pub const m_FitMatrices: usize = 0x390; // 
                pub const m_FitWeights: usize = 0x3A8; // 
                ...
                pub const m_KelagerBends: usize = 0x408; // 
                ...
                pub const m_SourceElems: usize = 0x450; // 
                pub const m_GoalDampedSpringIntegrators: usize = 0x468; // 
                pub const m_Tris: usize = 0x480; // 
                pub const m_nTriCount1: usize = 0x498; // 
                pub const m_nTriCount2: usize = 0x49A; // 
                pub const m_nReservedUint8: usize = 0x49C; // 
                pub const m_nExtraPressureIterations: usize = 0x49D; // 
                pub const m_nExtraGoalIterations: usize = 0x49E; // 
                pub const m_nExtraIterations: usize = 0x49F; // 
                pub const m_BoxRigids: usize = 0x4A0; // 
                pub const m_DynNodeVertexSet: usize = 0x4B8; // 
                pub const m_VertexSetNames: usize = 0x4D0; // 
                ...
                pub const m_MorphSetData: usize = 0x518; // 
                pub const m_VertexMaps: usize = 0x530; // 
                pub const m_VertexMapValues: usize = 0x548; // 
                pub const m_Effects: usize = 0x560; // 
                pub const m_LockToParent: usize = 0x578; // 
                pub const m_LockToGoal: usize = 0x590; // 
                pub const m_SkelParents: usize = 0x5A8; // 
                pub const m_DynNodeWindBases: usize = 0x5C0; // 
                pub const m_flInternalPressure: usize = 0x5D8; // 
                pub const m_flDefaultTimeDilation: usize = 0x5DC; // 
                pub const m_flWindage: usize = 0x5E0; // 
                pub const m_flWindDrag: usize = 0x5E4; // 
                pub const m_flDefaultSurfaceStretch: usize = 0x5E8; // 
                pub const m_flDefaultThreadStretch: usize = 0x5EC; // 
                pub const m_flDefaultGravityScale: usize = 0x5F0; // 
                pub const m_flDefaultVelAirDrag: usize = 0x5F4; // 
                pub const m_flDefaultExpAirDrag: usize = 0x5F8; // 
                pub const m_flDefaultVelQuadAirDrag: usize = 0x5FC; // 
                pub const m_flDefaultExpQuadAirDrag: usize = 0x600; // 
                pub const m_flRodVelocitySmoothRate: usize = 0x604; // 
                pub const m_flQuadVelocitySmoothRate: usize = 0x608; // 
                pub const m_flAddWorldCollisionRadius: usize = 0x60C; // 
                pub const m_flDefaultVolumetricSolveAmount: usize = 0x610; // 
                pub const m_flMotionSmoothCDT: usize = 0x614; // 
                pub const m_nRodVelocitySmoothIterations: usize = 0x618; // 
                pub const m_nQuadVelocitySmoothIterations: usize = 0x61A; // 
            }
            // Parent: RnBodyDesc_t
            // Field count: 1
            //
