    ...
    namespace schemas {
        ...
        namespace libanimationsystem_so {
            ...
            namespace CNmFootIKTask {
                constexpr std::ptrdiff_t m_nLeftEffectorBoneIdx = 0x60; // int32
                constexpr std::ptrdiff_t m_nRightEffectorBoneIdx = 0x64; // int32
                constexpr std::ptrdiff_t m_leftTargetTransform = 0x70; // CTransform
                constexpr std::ptrdiff_t m_rightTargetTransform = 0x90; // CTransform
                constexpr std::ptrdiff_t m_nLeftTargetBoneIdx = 0xB0; // int32
                constexpr std::ptrdiff_t m_nRightTargetBoneIdx = 0xB4; // int32
                constexpr std::ptrdiff_t m_leftTarget = 0xC0; // CNmTarget
                constexpr std::ptrdiff_t m_rightTarget = 0xF0; // CNmTarget
                constexpr std::ptrdiff_t m_blendMode = 0x120; // NmIKBlendMode_t
                constexpr std::ptrdiff_t m_flBlendWeight = 0x124; // float32
                constexpr std::ptrdiff_t m_bIsTargetInWorldSpace = 0x128; // bool
                constexpr std::ptrdiff_t m_bIsRunningFromDeserializedData = 0x129; // bool
            }
            // Parent: None
            // Fields count: 3
            //
            ...
            namespace CNmChainLookatNode__CDefinition {
                constexpr std::ptrdiff_t m_endEffectorBoneID = 0x10; // CGlobalSymbol
                constexpr std::ptrdiff_t m_endEffectorForwardAxis = 0x18; // Vector
                constexpr std::ptrdiff_t m_endEffectorOffset = 0x24; // Vector
                constexpr std::ptrdiff_t m_nLookatTargetNodeIdx = 0x30; // int16
                constexpr std::ptrdiff_t m_nEnabledNodeIdx = 0x32; // int16
                constexpr std::ptrdiff_t m_flBlendTimeSeconds = 0x34; // float32
                constexpr std::ptrdiff_t m_chainWeights = 0x38; // CUtlVectorFixedGrowable<float32,5>
                constexpr std::ptrdiff_t m_nChainLength = 0x68; // uint8
                constexpr std::ptrdiff_t m_bIsTargetInWorldSpace = 0x69; // bool
            }
            // Parent: None
            // Fields count: 4
            //
            ...
            namespace CNmBoneMaskSelectorNode__CDefinition {
                ...
                constexpr std::ptrdiff_t m_maskNodeIndices = 0x10; // CUtlLeanVectorFixedGrowable<int16,8>
                constexpr std::ptrdiff_t m_parameterValues = 0x28; // CUtlLeanVectorFixedGrowable<CGlobalSymbol,7>
                constexpr std::ptrdiff_t m_flBlendTimeSeconds = 0x68; // float32
            }
            // Parent: None
            // Fields count: 1
            //
            ...
            namespace CNmTwoBoneIKNode__CDefinition {
                ...
                constexpr std::ptrdiff_t m_flChainRotationWeight = 0x24; // float32
            }
            // Parent: None
            // Fields count: 0
            ...
            namespace CNmFloatSpringNode__CDefinition {
                constexpr std::ptrdiff_t m_flStartValue = 0xC; // float32
                constexpr std::ptrdiff_t m_flHertz = 0x10; // float32
                constexpr std::ptrdiff_t m_flDampingRatio = 0x14; // float32
                constexpr std::ptrdiff_t m_nInputValueNodeIdx = 0x18; // int16
                constexpr std::ptrdiff_t m_bUseStartValue = 0x1A; // bool
            }
            // Parent: None
            // Fields count: 7
            //
            ...
            namespace CNmTwoBoneIKTask {
                constexpr std::ptrdiff_t m_nEffectorBoneIdx = 0x60; // int32
                constexpr std::ptrdiff_t m_nEffectorTargetBoneIdx = 0x64; // int32
                constexpr std::ptrdiff_t m_targetTransform = 0x70; // CTransform
                ...
                constexpr std::ptrdiff_t m_flChainRotationWeight = 0xCC; // float32
            ...
            namespace CNmRootMotionOverrideNode__CDefinition {
                ...
                constexpr std::ptrdiff_t m_enabledNodeIdx = 0x14; // int16
                constexpr std::ptrdiff_t m_maxLinearVelocity = 0x18; // float32
                constexpr std::ptrdiff_t m_maxAngularVelocityRadians = 0x1C; // float32
                constexpr std::ptrdiff_t m_overrideFlags = 0x20; // CNmBitFlags
            }
            // Parent: None
            // Fields count: 11
            //
            ...
            namespace CNmTargetWarpNode__CDefinition {
                ...
                constexpr std::ptrdiff_t m_targetUpdateRule = 0xF; // CNmTargetWarpNode::TargetUpdateRule_t
                ...
                constexpr std::ptrdiff_t m_alignmentBoneID = 0x28; // CGlobalSymbol
            }
            // Parent: None
            // Fields count: 6
            //
            ...
            namespace CNmFootIKNode__CDefinition {
                constexpr std::ptrdiff_t m_leftEffectorBoneID = 0x10; // CGlobalSymbol
                constexpr std::ptrdiff_t m_rightEffectorBoneID = 0x18; // CGlobalSymbol
                constexpr std::ptrdiff_t m_nLeftTargetNodeIdx = 0x20; // int16
                constexpr std::ptrdiff_t m_nRightTargetNodeIdx = 0x22; // int16
                constexpr std::ptrdiff_t m_nEnabledNodeIdx = 0x24; // int16
                constexpr std::ptrdiff_t m_flBlendTimeSeconds = 0x28; // float32
                constexpr std::ptrdiff_t m_blendMode = 0x2C; // NmIKBlendMode_t
                constexpr std::ptrdiff_t m_bIsTargetInWorldSpace = 0x2D; // bool
            }
            // Parent: None
            // Fields count: 2
            //
