    ...
    namespace schemas {
        ...
        namespace libanimationsystem_so {
            ...
            namespace CSequenceUpdateNode {
                constexpr std::ptrdiff_t m_hSequence = 0x6C; // HSequence
                constexpr std::ptrdiff_t m_duration = 0x70; // float32
            ...
            namespace CNmBoneMaskSelectorNode__CDefinition {
                ...
                constexpr std::ptrdiff_t m_switchDynamically = 0xE; // bool
            ...
            namespace CNmFloatMathNode__CDefinition {
                ...
                constexpr std::ptrdiff_t m_operator = 0xF; // CNmFloatMathNode::Operator_t
                constexpr std::ptrdiff_t m_flValueB = 0x10; // float32
            }
            ...
            namespace CNmStateEventConditionNode__CDefinition {
                constexpr std::ptrdiff_t m_nSourceStateNodeIdx = 0xA; // int16
                constexpr std::ptrdiff_t m_eventConditionRules = 0xC; // CNmBitFlags
                constexpr std::ptrdiff_t m_conditions = 0x10; // CUtlVectorFixedGrowable<CNmStateEventConditionNode::Condition_t,5>
            }
            // Parent: CNmBoolValueNode__CDefinition
            // Fields count: 3
            //
            ...
            namespace CNmTargetWarpNode__CDefinition {
                ...
                constexpr std::ptrdiff_t m_flSamplingPositionErrorThresholdSq = 0x10; // float32
                constexpr std::ptrdiff_t m_flMaxTangentLength = 0x14; // float32
                constexpr std::ptrdiff_t m_flLerpFallbackDistanceThreshold = 0x18; // float32
                constexpr std::ptrdiff_t m_flTargetUpdateDistanceThreshold = 0x1C; // float32
                constexpr std::ptrdiff_t m_flTargetUpdateAngleThresholdRadians = 0x20; // float32
            }
            // Parent: None
            // Fields count: 9
            //
            ...
            namespace CNmOrientationWarpNode__CDefinition {
                ...
                constexpr std::ptrdiff_t m_samplingMode = 0x10; // CNmRootMotionData::SamplingMode_t
            }
            // Parent: None
            // Fields count: 1
            //
