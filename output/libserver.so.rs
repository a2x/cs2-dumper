    ...
    pub mod schemas {
        ...
        pub mod libserver_so {
            ...
            pub mod CAmbientGeneric {
                pub const m_radius: usize = 0x788; // float32
                pub const m_flMaxRadius: usize = 0x78C; // float32
                pub const m_iSoundLevel: usize = 0x790; // soundlevel_t
                pub const m_dpv: usize = 0x794; // dynpitchvol_t
                pub const m_fActive: usize = 0x7F8; // bool
                pub const m_fLooping: usize = 0x7F9; // bool
                pub const m_iszSound: usize = 0x800; // CGameSoundEventName
                pub const m_sSourceEntName: usize = 0x808; // CUtlSymbolLarge
                pub const m_hSoundSource: usize = 0x810; // CHandle<CBaseEntity>
                pub const m_nSoundSourceEntIndex: usize = 0x814; // CEntityIndex
            }
            // Parent: CPointEntity
            // Fields count: 12
            pub mod CEnvEntityMaker {
                pub const m_vecEntityMins: usize = 0x788; // Vector
                pub const m_vecEntityMaxs: usize = 0x794; // Vector
                pub const m_hCurrentInstance: usize = 0x7A0; // CHandle<CBaseEntity>
                pub const m_hCurrentBlocker: usize = 0x7A4; // CHandle<CBaseEntity>
                pub const m_vecBlockerOrigin: usize = 0x7A8; // VectorWS
                pub const m_angPostSpawnDirection: usize = 0x7B4; // QAngle
                pub const m_flPostSpawnDirectionVariance: usize = 0x7C0; // float32
                pub const m_flPostSpawnSpeed: usize = 0x7C4; // float32
                pub const m_bPostSpawnUseAngles: usize = 0x7C8; // bool
                pub const m_iszTemplate: usize = 0x7D0; // CUtlSymbolLarge
                pub const m_pOutputOnSpawned: usize = 0x7D8; // CEntityIOOutput
                pub const m_pOutputOnFailedSpawn: usize = 0x7F0; // CEntityIOOutput
            }
            // Parent: None
            // Fields count: 0
            ...
            pub mod CFilterEnemy {
                pub const m_iszEnemyName: usize = 0x7C0; // CUtlSymbolLarge
                pub const m_flRadius: usize = 0x7C8; // float32
                pub const m_flOuterRadius: usize = 0x7CC; // float32
            ...
            pub mod CScriptedSequence {
                pub const m_iszEntry: usize = 0x788; // CUtlSymbolLarge
                pub const m_iszPreIdle: usize = 0x790; // CUtlSymbolLarge
                pub const m_iszPlay: usize = 0x798; // CUtlSymbolLarge
                pub const m_iszPostIdle: usize = 0x7A0; // CUtlSymbolLarge
                pub const m_iszModifierToAddOnPlay: usize = 0x7A8; // CUtlSymbolLarge
                pub const m_iszNextScript: usize = 0x7B0; // CUtlSymbolLarge
                pub const m_iszEntity: usize = 0x7B8; // CUtlSymbolLarge
                pub const m_iszSyncGroup: usize = 0x7C0; // CUtlSymbolLarge
                pub const m_nMoveTo: usize = 0x7C8; // ScriptedMoveTo_t
                pub const m_nMoveToGait: usize = 0x7CC; // SharedMovementGait_t
                pub const m_nHeldWeaponBehavior: usize = 0x7D0; // ScriptedHeldWeaponBehavior_t
                pub const m_nForcedCrouchState: usize = 0x7D4; // ForcedCrouchState_t
                pub const m_bIsPlayingPreIdle: usize = 0x7D8; // bool
                pub const m_bIsPlayingEntry: usize = 0x7D9; // bool
                pub const m_bIsPlayingAction: usize = 0x7DA; // bool
                pub const m_bIsPlayingPostIdle: usize = 0x7DB; // bool
                pub const m_bDontRotateOther: usize = 0x7DC; // bool
                pub const m_bIsRepeatable: usize = 0x7DD; // bool
                pub const m_bShouldLeaveCorpse: usize = 0x7DE; // bool
                pub const m_bStartOnSpawn: usize = 0x7DF; // bool
                pub const m_bDisallowInterrupts: usize = 0x7E0; // bool
                pub const m_bCanOverrideNPCState: usize = 0x7E1; // bool
                pub const m_bDontTeleportAtEnd: usize = 0x7E2; // bool
                pub const m_bHighPriority: usize = 0x7E3; // bool
                pub const m_bHideDebugComplaints: usize = 0x7E4; // bool
                pub const m_bContinueOnDeath: usize = 0x7E5; // bool
                pub const m_bLoopPreIdleSequence: usize = 0x7E6; // bool
                pub const m_bLoopActionSequence: usize = 0x7E7; // bool
                pub const m_bLoopPostIdleSequence: usize = 0x7E8; // bool
                pub const m_bSynchPostIdles: usize = 0x7E9; // bool
                pub const m_bIgnoreLookAt: usize = 0x7EA; // bool
                pub const m_bIgnoreGravity: usize = 0x7EB; // bool
                pub const m_bDisableNPCCollisions: usize = 0x7EC; // bool
                pub const m_bKeepAnimgraphLockedPost: usize = 0x7ED; // bool
                pub const m_bDontAddModifiers: usize = 0x7EE; // bool
                pub const m_bDisableAimingWhileMoving: usize = 0x7EF; // bool
                pub const m_bIgnoreRotation: usize = 0x7F0; // bool
                pub const m_flRadius: usize = 0x7F4; // float32
                pub const m_flRepeat: usize = 0x7F8; // float32
                pub const m_flPlayAnimFadeInTime: usize = 0x7FC; // float32
                pub const m_flMoveInterpTime: usize = 0x800; // float32
                pub const m_flAngRate: usize = 0x804; // float32
                pub const m_flMoveSpeed: usize = 0x808; // float32
                pub const m_bWaitUntilMoveCompletesToStartAnimation: usize = 0x80C; // bool
                pub const m_nNotReadySequenceCount: usize = 0x810; // int32
                pub const m_startTime: usize = 0x814; // GameTime_t
                pub const m_bWaitForBeginSequence: usize = 0x818; // bool
                pub const m_saved_effects: usize = 0x81C; // int32
                pub const m_savedFlags: usize = 0x820; // int32
                pub const m_savedCollisionGroup: usize = 0x824; // int32
                pub const m_bInterruptable: usize = 0x828; // bool
                ...
                pub const m_hForcedTarget: usize = 0x838; // CHandle<CBaseAnimGraph>
                pub const m_bDontCancelOtherSequences: usize = 0x83C; // bool
                pub const m_bForceSynch: usize = 0x83D; // bool
                pub const m_bPreventUpdateYawOnFinish: usize = 0x83E; // bool
                pub const m_bEnsureOnNavmeshOnFinish: usize = 0x83F; // bool
                pub const m_onDeathBehavior: usize = 0x840; // ScriptedOnDeath_t
                pub const m_ConflictResponse: usize = 0x844; // ScriptedConflictResponse_t
                pub const m_OnBeginSequence: usize = 0x848; // CEntityIOOutput
                pub const m_OnActionStartOrLoop: usize = 0x860; // CEntityIOOutput
                pub const m_OnEndSequence: usize = 0x878; // CEntityIOOutput
                pub const m_OnPostIdleEndSequence: usize = 0x890; // CEntityIOOutput
                pub const m_OnCancelSequence: usize = 0x8A8; // CEntityIOOutput
                pub const m_OnCancelFailedSequence: usize = 0x8C0; // CEntityIOOutput
                pub const m_OnScriptEvent: usize = 0x8D8; // CEntityIOOutput[8]
                pub const m_matOtherToMain: usize = 0x9A0; // CTransform
                pub const m_hInteractionMainEntity: usize = 0x9C0; // CHandle<CBaseEntity>
                pub const m_iPlayerDeathBehavior: usize = 0x9C4; // int32
                pub const m_bSkipFadeIn: usize = 0x9C8; // bool
            }
            // Parent: CBaseTrigger
            // Fields count: 1
            pub mod CFogTrigger {
            ...
            pub mod CPhysicsSpring {
                pub const m_pSpringJoint: usize = 0x788; // IPhysicsJoint*
                pub const m_flFrequency: usize = 0x790; // float32
                pub const m_flDampingRatio: usize = 0x794; // float32
                pub const m_flRestLength: usize = 0x798; // float32
                pub const m_nameAttachStart: usize = 0x7A0; // CUtlSymbolLarge
                pub const m_nameAttachEnd: usize = 0x7A8; // CUtlSymbolLarge
                pub const m_start: usize = 0x7B0; // VectorWS
                pub const m_end: usize = 0x7BC; // VectorWS
                pub const m_teleportTick: usize = 0x7C8; // uint32
            }
            // Parent: CPointEntity
            // Fields count: 2
            pub mod CEnvMuzzleFlash {
                pub const m_flScale: usize = 0x788; // float32
                pub const m_iszParentAttachment: usize = 0x790; // CUtlSymbolLarge
            }
            // Parent: None
            // Fields count: 5
            ...
            // Fields count: 10
            pub mod CPathTrack {
                pub const m_pnext: usize = 0x788; // CHandle<CPathTrack>
                pub const m_pprevious: usize = 0x78C; // CHandle<CPathTrack>
                pub const m_paltpath: usize = 0x790; // CHandle<CPathTrack>
                pub const m_flSpeed: usize = 0x794; // float32
                pub const m_flRadius: usize = 0x798; // float32
                pub const m_length: usize = 0x79C; // float32
                pub const m_altName: usize = 0x7A0; // CUtlSymbolLarge
                pub const m_nIterVal: usize = 0x7A8; // int32
            ...
            pub mod CTankTrainAI {
                pub const m_hTrain: usize = 0x788; // CHandle<CFuncTrackTrain>
                pub const m_hTargetEntity: usize = 0x78C; // CHandle<CBaseEntity>
                pub const m_soundPlaying: usize = 0x790; // int32
                pub const m_startSoundName: usize = 0x7A8; // CUtlSymbolLarge
                pub const m_engineSoundName: usize = 0x7B0; // CUtlSymbolLarge
                pub const m_movementSoundName: usize = 0x7B8; // CUtlSymbolLarge
                pub const m_targetEntityName: usize = 0x7C0; // CUtlSymbolLarge
            }
            ...
            // Fields count: 6
            pub mod CLogicCase {
                pub const m_nCase: usize = 0x788; // CUtlSymbolLarge[32]
                pub const m_nShuffleCases: usize = 0x888; // int32
                pub const m_nLastShuffleCase: usize = 0x88C; // int32
                pub const m_uchShuffleCaseMap: usize = 0x890; // uint8[32]
                pub const m_OnCase: usize = 0x8B0; // CEntityIOOutput[32]
                pub const m_OnDefault: usize = 0xBB0; // CEntityOutputTemplate<CUtlString>
            }
            // Parent: None
            // Fields count: 1
            //
            ...
            pub mod CInfoGameEventProxy {
                pub const m_iszEventName: usize = 0x788; // CUtlSymbolLarge
                pub const m_flRange: usize = 0x790; // float32
            }
            // Parent: None
            // Fields count: 0
            ...
            // Fields count: 4
            pub mod CInfoFan {
                pub const m_fFanForceMaxRadius: usize = 0x7C8; // float32
                pub const m_fFanForceMinRadius: usize = 0x7CC; // float32
                pub const m_flCurveDistRange: usize = 0x7D0; // float32
            ...
            pub mod CCSBot {
                ...
                pub const m_stateTimestamp: usize = 0x5C0; // float32
                pub const m_isAttacking: usize = 0x5C4; // bool
                pub const m_isOpeningDoor: usize = 0x5C5; // bool
                pub const m_taskEntity: usize = 0x5CC; // CHandle<CBaseEntity>
                pub const m_goalPosition: usize = 0x5DC; // VectorWS
                pub const m_goalEntity: usize = 0x5E8; // CHandle<CBaseEntity>
                pub const m_avoid: usize = 0x5EC; // CHandle<CBaseEntity>
                pub const m_avoidTimestamp: usize = 0x5F0; // float32
                pub const m_isStopping: usize = 0x5F4; // bool
            ...
            pub mod CHandleTest {
                ...
                pub const m_bSendHandle: usize = 0x78C; // bool
            }
            // Parent: CBaseEntity
            // Fields count: 48
            pub mod CLogicNPCCounter {
                pub const m_OnMinCountAll: usize = 0x788; // CEntityIOOutput
                pub const m_OnMaxCountAll: usize = 0x7A0; // CEntityIOOutput
                pub const m_OnFactorAll: usize = 0x7B8; // CEntityOutputTemplate<float32>
                pub const m_OnMinPlayerDistAll: usize = 0x7D8; // CEntityOutputTemplate<float32>
                pub const m_OnMinCount_1: usize = 0x7F8; // CEntityIOOutput
                pub const m_OnMaxCount_1: usize = 0x810; // CEntityIOOutput
                pub const m_OnFactor_1: usize = 0x828; // CEntityOutputTemplate<float32>
                pub const m_OnMinPlayerDist_1: usize = 0x848; // CEntityOutputTemplate<float32>
                pub const m_OnMinCount_2: usize = 0x868; // CEntityIOOutput
                pub const m_OnMaxCount_2: usize = 0x880; // CEntityIOOutput
                pub const m_OnFactor_2: usize = 0x898; // CEntityOutputTemplate<float32>
                pub const m_OnMinPlayerDist_2: usize = 0x8B8; // CEntityOutputTemplate<float32>
                pub const m_OnMinCount_3: usize = 0x8D8; // CEntityIOOutput
                pub const m_OnMaxCount_3: usize = 0x8F0; // CEntityIOOutput
                pub const m_OnFactor_3: usize = 0x908; // CEntityOutputTemplate<float32>
                pub const m_OnMinPlayerDist_3: usize = 0x928; // CEntityOutputTemplate<float32>
                pub const m_hSource: usize = 0x948; // CEntityHandle
                pub const m_iszSourceEntityName: usize = 0x950; // CUtlSymbolLarge
                pub const m_flDistanceMax: usize = 0x958; // float32
                pub const m_bDisabled: usize = 0x95C; // bool
                pub const m_nMinCountAll: usize = 0x960; // int32
                pub const m_nMaxCountAll: usize = 0x964; // int32
                pub const m_nMinFactorAll: usize = 0x968; // int32
                pub const m_nMaxFactorAll: usize = 0x96C; // int32
                pub const m_iszNPCClassname_1: usize = 0x978; // CUtlSymbolLarge
                pub const m_nNPCState_1: usize = 0x980; // int32
                pub const m_bInvertState_1: usize = 0x984; // bool
                pub const m_nMinCount_1: usize = 0x988; // int32
                pub const m_nMaxCount_1: usize = 0x98C; // int32
                pub const m_nMinFactor_1: usize = 0x990; // int32
                pub const m_nMaxFactor_1: usize = 0x994; // int32
                pub const m_flDefaultDist_1: usize = 0x99C; // float32
                pub const m_iszNPCClassname_2: usize = 0x9A0; // CUtlSymbolLarge
                pub const m_nNPCState_2: usize = 0x9A8; // int32
                pub const m_bInvertState_2: usize = 0x9AC; // bool
                pub const m_nMinCount_2: usize = 0x9B0; // int32
                pub const m_nMaxCount_2: usize = 0x9B4; // int32
                pub const m_nMinFactor_2: usize = 0x9B8; // int32
                pub const m_nMaxFactor_2: usize = 0x9BC; // int32
                pub const m_flDefaultDist_2: usize = 0x9C4; // float32
                pub const m_iszNPCClassname_3: usize = 0x9C8; // CUtlSymbolLarge
                pub const m_nNPCState_3: usize = 0x9D0; // int32
                pub const m_bInvertState_3: usize = 0x9D4; // bool
                pub const m_nMinCount_3: usize = 0x9D8; // int32
                pub const m_nMaxCount_3: usize = 0x9DC; // int32
                pub const m_nMinFactor_3: usize = 0x9E0; // int32
            ...
            pub mod CRagdollConstraint {
                pub const m_xmin: usize = 0x7E8; // float32
                pub const m_xmax: usize = 0x7EC; // float32
                pub const m_ymin: usize = 0x7F0; // float32
                pub const m_ymax: usize = 0x7F4; // float32
                pub const m_zmin: usize = 0x7F8; // float32
                pub const m_zmax: usize = 0x7FC; // float32
                pub const m_xfriction: usize = 0x800; // float32
                pub const m_yfriction: usize = 0x804; // float32
                pub const m_zfriction: usize = 0x808; // float32
            }
            // Parent: CBaseModelEntity
            // Fields count: 0
            ...
            pub mod CPointPush {
                ...
                pub const m_flInnerRadius: usize = 0x794; // float32
                pub const m_flConeOfInfluence: usize = 0x798; // float32
                pub const m_iszFilterName: usize = 0x7A0; // CUtlSymbolLarge
                pub const m_hFilter: usize = 0x7A8; // CHandle<CBaseFilter>
            }
            // Parent: None
            // Fields count: 1
            //
            ...
            pub mod CPlayerPing {
                ...
                pub const m_hPingedEntity: usize = 0x794; // CHandle<CBaseEntity>
                pub const m_iType: usize = 0x798; // int32
            ...
            // Fields count: 7
            pub mod CLogicRelay {
                pub const m_OnSpawn: usize = 0x788; // CEntityIOOutput
                pub const m_OnTrigger: usize = 0x7A0; // CEntityIOOutput
                pub const m_bDisabled: usize = 0x7B8; // bool
                pub const m_bWaitForRefire: usize = 0x7B9; // bool
                pub const m_bTriggerOnce: usize = 0x7BA; // bool
                pub const m_bFastRetrigger: usize = 0x7BB; // bool
                pub const m_bPassthoughCaller: usize = 0x7BC; // bool
            }
            // Parent: None
            // Fields count: 6
            ...
            pub mod CTestPulseIO {
                pub const m_OnVariantVoid: usize = 0x788; // CEntityIOOutput
                pub const m_OnVariantBool: usize = 0x7A0; // CEntityOutputTemplate<bool>
                pub const m_OnVariantInt: usize = 0x7C0; // CEntityOutputTemplate<int32>
                pub const m_OnVariantFloat: usize = 0x7E0; // CEntityOutputTemplate<float32>
                pub const m_OnVariantString: usize = 0x800; // CEntityOutputTemplate<CUtlSymbolLarge>
                pub const m_OnVariantColor: usize = 0x820; // CEntityOutputTemplate<Color>
                pub const m_OnVariantVector: usize = 0x840; // CEntityOutputTemplate<Vector>
                pub const m_bAllowEmptyInputs: usize = 0x868; // bool
                pub const m_TestComponent: usize = 0x870; // CTestPulseIOComponent_Derived
                pub const m_OnInternalTestVoid: usize = 0x8A0; // CEntityIOOutput
                pub const m_OnInternalTestBool: usize = 0x8B8; // CEntityOutputTemplate<bool>
                pub const m_OnInternalTestInt: usize = 0x8D8; // CEntityOutputTemplate<int32>
                pub const m_OnInternalTestFloat: usize = 0x8F8; // CEntityOutputTemplate<float32>
                pub const m_OnInternalTestString: usize = 0x918; // CEntityOutputTemplate<CUtlSymbolLarge>
                pub const m_OnInternalTestColor: usize = 0x938; // CEntityOutputTemplate<Color>
                pub const m_OnInternalTestVector: usize = 0x958; // CEntityOutputTemplate<Vector>
                pub const m_OnInternalTestEntityName: usize = 0x980; // CEntityOutputTemplate<CEntityNameString>
                pub const m_OnInternalTestEntityHandle: usize = 0x9A0; // CEntityOutputTemplate<CHandle<CBaseEntity>>
                pub const m_OnInternalTestSchemaEnum: usize = 0x9C0; // CEntityOutputTemplate<TestInputOutputCombinationsEnum_t>
                pub const m_OnInternalTestFloatString: usize = 0x9E0; // CEntityOutputTemplate<CTestPulseIO::FloatStringArgs_t>
                pub const m_OnInternalTestEntityNameString: usize = 0xA08; // CEntityOutputTemplate<CTestPulseIO::EntityNameStringArgs_t>
            ...
            pub mod CPointEntityFinder {
                pub const m_hEntity: usize = 0x788; // CHandle<CBaseEntity>
                pub const m_iFilterName: usize = 0x790; // CUtlSymbolLarge
                pub const m_hFilter: usize = 0x798; // CHandle<CBaseFilter>
                pub const m_iRefName: usize = 0x7A0; // CUtlSymbolLarge
                pub const m_hReference: usize = 0x7A8; // CHandle<CBaseEntity>
                pub const m_FindMethod: usize = 0x7AC; // EntFinderMethod_t
            ...
            pub mod CRenderComponent {
                ...
                pub const m_bInterpolationReadyToDraw: usize = 0xB8; // bool
            }
            // Parent: CBaseAnimGraph
            // Fields count: 0
            ...
            pub mod CPointChildModifier {
                pub const m_bOrphanInsteadOfDeletingChildrenOnRemove: usize = 0x788; // bool
            }
            // Parent: None
            // Fields count: 2
            ...
            pub mod CPathParticleRope {
                pub const m_bStartActive: usize = 0x790; // bool
                pub const m_flMaxSimulationTime: usize = 0x794; // float32
                pub const m_iszEffectName: usize = 0x798; // CUtlSymbolLarge
                pub const m_PathNodes_Name: usize = 0x7A0; // CUtlVector<CUtlSymbolLarge>
                pub const m_flParticleSpacing: usize = 0x7B8; // float32
                pub const m_flSlack: usize = 0x7BC; // float32
                pub const m_flRadius: usize = 0x7C0; // float32
                pub const m_ColorTint: usize = 0x7C4; // Color
                pub const m_nEffectState: usize = 0x7C8; // int32
                pub const m_iEffectIndex: usize = 0x7D0; // CStrongHandle<InfoForResourceTypeIParticleSystemDefinition>
                pub const m_PathNodes_Position: usize = 0x7D8; // CNetworkUtlVectorBase<Vector>
                pub const m_PathNodes_TangentIn: usize = 0x7F0; // CNetworkUtlVectorBase<Vector>
                pub const m_PathNodes_TangentOut: usize = 0x808; // CNetworkUtlVectorBase<Vector>
                pub const m_PathNodes_Color: usize = 0x820; // CNetworkUtlVectorBase<Vector>
                pub const m_PathNodes_PinEnabled: usize = 0x838; // CNetworkUtlVectorBase<bool>
                pub const m_PathNodes_RadiusScale: usize = 0x850; // CNetworkUtlVectorBase<float32>
            }
            // Parent: CPointEntity
            // Fields count: 3
            pub mod CCredits {
                pub const m_OnCreditsDone: usize = 0x788; // CEntityIOOutput
            ...
            // Fields count: 7
            pub mod CFishPool {
                pub const m_fishCount: usize = 0x794; // int32
                pub const m_maxRange: usize = 0x798; // float32
                pub const m_swimDepth: usize = 0x79C; // float32
                pub const m_waterLevel: usize = 0x7A0; // float32
                pub const m_isDormant: usize = 0x7A4; // bool
            ...
            pub mod CInfoDynamicShadowHintBox {
                pub const m_vBoxMins: usize = 0x79C; // Vector
                pub const m_vBoxMaxs: usize = 0x7A8; // Vector
            }
            ...
            pub mod CFilterMultiple {
                pub const m_nFilterType: usize = 0x7C0; // filter_t
            ...
            pub mod CCSPlayerResource {
                ...
                pub const m_isHostageFollowingSomeone: usize = 0x794; // bool[12]
                pub const m_iHostageEntityIDs: usize = 0x7A0; // CEntityIndex[12]
                pub const m_bombsiteCenterA: usize = 0x7D0; // VectorWS
                pub const m_bombsiteCenterB: usize = 0x7DC; // VectorWS
                pub const m_hostageRescueX: usize = 0x7E8; // int32[4]
                pub const m_hostageRescueY: usize = 0x7F8; // int32[4]
                pub const m_hostageRescueZ: usize = 0x808; // int32[4]
                pub const m_bEndMatchNextMapAllVoted: usize = 0x818; // bool
                pub const m_foundGoalPositions: usize = 0x819; // bool
            }
            // Parent: None
            // Fields count: 3
            //
            ...
            pub mod CMoverPathNode {
                pub const m_OnStartFromOrInSegment: usize = 0x7D8; // CEntityOutputTemplate<CUtlString>
                pub const m_OnStoppedAtOrInSegment: usize = 0x7F8; // CEntityOutputTemplate<CUtlString>
                pub const m_OnPassThrough: usize = 0x818; // CEntityOutputTemplate<CUtlString>
                pub const m_OnPassThroughForward: usize = 0x838; // CEntityOutputTemplate<CUtlString>
                pub const m_OnPassThroughReverse: usize = 0x858; // CEntityOutputTemplate<CUtlString>
            }
            // Parent: CBaseEntity
            // Fields count: 11
            pub mod CEnvSoundscape {
                pub const m_OnPlay: usize = 0x788; // CEntityIOOutput
                pub const m_flRadius: usize = 0x7A0; // float32
                pub const m_soundEventName: usize = 0x7A8; // CGameSoundEventName
                pub const m_bOverrideWithEvent: usize = 0x7B0; // bool
                pub const m_soundscapeIndex: usize = 0x7B4; // int32
                pub const m_soundscapeEntityListId: usize = 0x7B8; // int32
                pub const m_positionNames: usize = 0x7C0; // CUtlSymbolLarge[8]
                pub const m_hProxySoundscape: usize = 0x800; // CHandle<CEnvSoundscape>
                pub const m_bDisabled: usize = 0x804; // bool
                pub const m_soundscapeName: usize = 0x808; // CUtlSymbolLarge
                pub const m_soundEventHash: usize = 0x810; // uint32
            }
            // Parent: CBaseModelEntity
            // Fields count: 6
            pub mod CFuncBrush {
            ...
            pub mod CLogicEventListener {
                pub const m_strEventName: usize = 0x798; // CUtlString
                pub const m_bIsEnabled: usize = 0x7A0; // bool
            ...
            pub mod FilterHealth {
                pub const m_bAdrenalineActive: usize = 0x7C0; // bool
            ...
            pub mod CMathColorBlend {
                pub const m_flInMin: usize = 0x788; // float32
                pub const m_flInMax: usize = 0x78C; // float32
                pub const m_OutColor1: usize = 0x790; // Color
            ...
            pub mod CLogicDistanceCheck {
                pub const m_iszEntityA: usize = 0x788; // CUtlSymbolLarge
                pub const m_iszEntityB: usize = 0x790; // CUtlSymbolLarge
                pub const m_flZone1Distance: usize = 0x798; // float32
                pub const m_flZone2Distance: usize = 0x79C; // float32
                pub const m_InZone1: usize = 0x7A0; // CEntityIOOutput
                pub const m_InZone2: usize = 0x7B8; // CEntityIOOutput
            ...
            pub mod CLogicDistanceAutosave {
                pub const m_iszTargetEntity: usize = 0x788; // CUtlSymbolLarge
                pub const m_flDistanceToPlayer: usize = 0x790; // float32
                pub const m_bForceNewLevelUnit: usize = 0x794; // bool
                pub const m_bCheckCough: usize = 0x795; // bool
                pub const m_bThinkDangerous: usize = 0x796; // bool
                pub const m_flDangerousTime: usize = 0x798; // float32
            }
            // Parent: CBaseEntity
            // Fields count: 4
            pub mod CLogicBranch {
                pub const m_bInValue: usize = 0x788; // bool
                pub const m_Listeners: usize = 0x790; // CUtlVector<CHandle<CBaseEntity>>
                pub const m_OnTrue: usize = 0x7A8; // CEntityIOOutput
                pub const m_OnFalse: usize = 0x7C0; // CEntityIOOutput
            }
            // Parent: None
            // Fields count: 9
            //
            ...
            pub mod CEnvInstructorHint {
                pub const m_iszName: usize = 0x788; // CUtlSymbolLarge
                pub const m_iszReplace_Key: usize = 0x790; // CUtlSymbolLarge
                pub const m_iszHintTargetEntity: usize = 0x798; // CUtlSymbolLarge
                pub const m_iTimeout: usize = 0x7A0; // int32
                pub const m_iDisplayLimit: usize = 0x7A4; // int32
                pub const m_iszIcon_Onscreen: usize = 0x7A8; // CUtlSymbolLarge
                pub const m_iszIcon_Offscreen: usize = 0x7B0; // CUtlSymbolLarge
                pub const m_iszCaption: usize = 0x7B8; // CUtlSymbolLarge
                pub const m_iszActivatorCaption: usize = 0x7C0; // CUtlSymbolLarge
                pub const m_Color: usize = 0x7C8; // Color
                pub const m_fIconOffset: usize = 0x7CC; // float32
                pub const m_fRange: usize = 0x7D0; // float32
                pub const m_iPulseOption: usize = 0x7D4; // uint8
                pub const m_iAlphaOption: usize = 0x7D5; // uint8
                pub const m_iShakeOption: usize = 0x7D6; // uint8
                pub const m_bStatic: usize = 0x7D7; // bool
                pub const m_bNoOffscreen: usize = 0x7D8; // bool
                pub const m_bForceCaption: usize = 0x7D9; // bool
                pub const m_iInstanceType: usize = 0x7DC; // int32
                pub const m_bSuppressRest: usize = 0x7E0; // bool
                pub const m_iszBinding: usize = 0x7E8; // CUtlSymbolLarge
                pub const m_bAllowNoDrawTarget: usize = 0x7F0; // bool
                pub const m_bAutoStart: usize = 0x7F1; // bool
                pub const m_bLocalPlayerOnly: usize = 0x7F2; // bool
            }
            // Parent: CBaseEntity
            // Fields count: 1
            pub mod CEnvWind {
            ...
            pub mod CCSPlayerPawn {
                ...
                pub const m_vecStashedVelocity: usize = 0x1610; // Vector
                pub const m_bCommittingSuicideOnTeamChange: usize = 0x1628; // bool
                pub const m_wasNotKilledNaturally: usize = 0x1629; // bool
                pub const m_fImmuneToGunGameDamageTime: usize = 0x162C; // GameTime_t
                pub const m_bGunGameImmunity: usize = 0x1630; // bool
                pub const m_fMolotovDamageTime: usize = 0x1634; // float32
                pub const m_angEyeAngles: usize = 0x1638; // QAngle
            }
            // Parent: CBaseEntity
            // Fields count: 22
            ...
            pub mod CRagdollManager {
                pub const m_iCurrentMaxRagdollCount: usize = 0x788; // int8
                pub const m_iMaxRagdollCount: usize = 0x78C; // int32
                pub const m_bSaveImportant: usize = 0x790; // bool
                pub const m_bCanTakeDamage: usize = 0x791; // bool
            }
            // Parent: CSoundOpvarSetPointEntity
            // Fields count: 9
            pub mod CSoundOpvarSetBoxEntity {
                pub const m_vDistanceInnerMins: usize = 0x91C; // Vector
                pub const m_vDistanceInnerMaxs: usize = 0x928; // Vector
                pub const m_vDistanceOuterMins: usize = 0x934; // Vector
                pub const m_vDistanceOuterMaxs: usize = 0x940; // Vector
                pub const m_nBoxDirection: usize = 0x94C; // int32
                pub const m_vInnerMins: usize = 0x950; // Vector
                pub const m_vInnerMaxs: usize = 0x95C; // Vector
                pub const m_vOuterMins: usize = 0x968; // Vector
                pub const m_vOuterMaxs: usize = 0x974; // Vector
            }
            // Parent: CBaseTrigger
            // Fields count: 12
            ...
            pub mod CPointProximitySensor {
                pub const m_bDisabled: usize = 0x788; // bool
                pub const m_hTargetEntity: usize = 0x78C; // CHandle<CBaseEntity>
                pub const m_Distance: usize = 0x790; // CEntityOutputTemplate<float32>
            }
            // Parent: None
            // Fields count: 5
            //
            ...
            // Fields count: 1
            pub mod CPhysTorque {
                pub const m_axis: usize = 0x7E8; // Vector
            }
            // Parent: CBaseEntity
            // Fields count: 5
            pub mod CMultiSource {
                pub const m_rgEntities: usize = 0x788; // CHandle<CBaseEntity>[32]
                pub const m_rgTriggered: usize = 0x808; // int32[32]
                pub const m_OnTrigger: usize = 0x888; // CEntityIOOutput
            ...
            // Fields count: 11
            pub mod CLogicAuto {
                pub const m_OnMapSpawn: usize = 0x788; // CEntityIOOutput
                pub const m_OnDemoMapSpawn: usize = 0x7A0; // CEntityIOOutput
                pub const m_OnNewGame: usize = 0x7B8; // CEntityIOOutput
                pub const m_OnLoadGame: usize = 0x7D0; // CEntityIOOutput
                pub const m_OnMapTransition: usize = 0x7E8; // CEntityIOOutput
                pub const m_OnBackgroundMap: usize = 0x800; // CEntityIOOutput
                pub const m_OnMultiNewMap: usize = 0x818; // CEntityIOOutput
                pub const m_OnMultiNewRound: usize = 0x830; // CEntityIOOutput
                pub const m_OnVREnabled: usize = 0x848; // CEntityIOOutput
                pub const m_OnVRNotEnabled: usize = 0x860; // CEntityIOOutput
                pub const m_globalstate: usize = 0x878; // CUtlSymbolLarge
            }
            // Parent: CBaseEntity
            // Fields count: 1
            ...
            pub mod CInfoDynamicShadowHint {
                pub const m_bDisabled: usize = 0x788; // bool
                pub const m_flRange: usize = 0x78C; // float32
                pub const m_nImportance: usize = 0x790; // int32
                pub const m_nLightChoice: usize = 0x794; // int32
                pub const m_hLight: usize = 0x798; // CHandle<CBaseEntity>
            }
            // Parent: CBaseModelEntity
            // Fields count: 1
            ...
            // Fields count: 6
            pub mod CPathNode {
                pub const m_vInTangentLocal: usize = 0x788; // Vector
                pub const m_vOutTangentLocal: usize = 0x794; // Vector
                pub const m_strParentPathUniqueID: usize = 0x7A0; // CUtlString
                pub const m_strPathNodeParameter: usize = 0x7A8; // CUtlString
            ...
            pub mod CLogicGameEventListener {
                pub const m_OnEventFired: usize = 0x798; // CEntityIOOutput
                pub const m_iszGameEventName: usize = 0x7B0; // CUtlSymbolLarge
                pub const m_iszGameEventItem: usize = 0x7B8; // CUtlSymbolLarge
                pub const m_bEnabled: usize = 0x7C0; // bool
                pub const m_bStartDisabled: usize = 0x7C1; // bool
            }
            // Parent: None
            // Fields count: 0
            ...
            pub mod CLogicAutosave {
                pub const m_bForceNewLevelUnit: usize = 0x788; // bool
            ...
            pub mod CSingleplayRules {
                pub const m_bSinglePlayerGameEnding: usize = 0xC9; // bool
            }
            // Parent: None
            // Fields count: 17
            //
            ...
            pub mod CPointPrefab {
                ...
                pub const m_forceWorldGroupID: usize = 0x790; // CUtlSymbolLarge
                pub const m_associatedRelayTargetName: usize = 0x798; // CUtlSymbolLarge
                pub const m_fixupNames: usize = 0x7A0; // bool
                pub const m_bLoadDynamic: usize = 0x7A1; // bool
                pub const m_associatedRelayEntity: usize = 0x7A4; // CHandle<CPointPrefab>
                pub const m_ProceduralRelaySources: usize = 0x7A8; // CUtlVector<CHandle<CBaseEntity>>
            }
            // Parent: None
            // Fields count: 1
            //
            ...
            pub mod CEnvInstructorVRHint {
                ...
                pub const m_iTimeout: usize = 0x798; // int32
                pub const m_iszCaption: usize = 0x7A0; // CUtlSymbolLarge
                pub const m_iszStartSound: usize = 0x7A8; // CUtlSymbolLarge
                pub const m_iLayoutFileType: usize = 0x7B0; // int32
                pub const m_iszCustomLayoutFile: usize = 0x7B8; // CUtlSymbolLarge
            ...
            // Fields count: 5
            pub mod CEnvGlobal {
                pub const m_outCounter: usize = 0x788; // CEntityOutputTemplate<int32>
                pub const m_globalstate: usize = 0x7A8; // CUtlSymbolLarge
                pub const m_triggermode: usize = 0x7B0; // int32
                pub const m_initialstate: usize = 0x7B4; // int32
                pub const m_counter: usize = 0x7B8; // int32
            }
            // Parent: None
            // Fields count: 0
            ...
            pub mod CSceneEntity {
                ...
                pub const m_iszTarget2: usize = 0x7A0; // CUtlSymbolLarge
                pub const m_iszTarget3: usize = 0x7A8; // CUtlSymbolLarge
                pub const m_iszTarget4: usize = 0x7B0; // CUtlSymbolLarge
                pub const m_iszTarget5: usize = 0x7B8; // CUtlSymbolLarge
                pub const m_iszTarget6: usize = 0x7C0; // CUtlSymbolLarge
                pub const m_iszTarget7: usize = 0x7C8; // CUtlSymbolLarge
                pub const m_iszTarget8: usize = 0x7D0; // CUtlSymbolLarge
                pub const m_hTarget1: usize = 0x7D8; // CHandle<CBaseEntity>
                pub const m_hTarget2: usize = 0x7DC; // CHandle<CBaseEntity>
                pub const m_hTarget3: usize = 0x7E0; // CHandle<CBaseEntity>
                pub const m_hTarget4: usize = 0x7E4; // CHandle<CBaseEntity>
                pub const m_hTarget5: usize = 0x7E8; // CHandle<CBaseEntity>
                pub const m_hTarget6: usize = 0x7EC; // CHandle<CBaseEntity>
                pub const m_hTarget7: usize = 0x7F0; // CHandle<CBaseEntity>
                pub const m_hTarget8: usize = 0x7F4; // CHandle<CBaseEntity>
                pub const m_hLocatorOrigin: usize = 0x7F8; // CHandle<CBaseEntity>
                pub const m_sTargetAttachment: usize = 0x800; // CUtlSymbolLarge
                pub const m_bIsPlayingBack: usize = 0x808; // bool
                pub const m_bPaused: usize = 0x809; // bool
                pub const m_bMultiplayer: usize = 0x80A; // bool
                pub const m_bAutogenerated: usize = 0x80B; // bool
                pub const m_flForceClientTime: usize = 0x80C; // float32
                ...
                pub const m_flAutomationDelay: usize = 0x828; // float32
                pub const m_flAutomationTime: usize = 0x82C; // float32
                pub const m_nSpeechPriority: usize = 0x830; // int32
                pub const m_bPausedViaInput: usize = 0x834; // bool
                pub const m_bPauseAtNextInterrupt: usize = 0x835; // bool
                pub const m_bWaitingForActor: usize = 0x836; // bool
                pub const m_bWaitingForInterrupt: usize = 0x837; // bool
                pub const m_bInterruptedActorsScenes: usize = 0x838; // bool
                pub const m_bBreakOnNonIdle: usize = 0x839; // bool
                pub const m_bSceneFinished: usize = 0x83A; // bool
                pub const m_hActorList: usize = 0x840; // CNetworkUtlVectorBase<CHandle<CBaseModelEntity>>
                pub const m_hRemoveActorList: usize = 0x858; // CUtlVector<CHandle<CBaseEntity>>
                pub const m_nSceneStringIndex: usize = 0x8A0; // uint16
                pub const m_OnStart: usize = 0x8A8; // CEntityIOOutput
                pub const m_OnCompletion: usize = 0x8C0; // CEntityIOOutput
                pub const m_OnCanceled: usize = 0x8D8; // CEntityIOOutput
            ...
            pub mod CTonemapController2 {
                pub const m_flAutoExposureMin: usize = 0x788; // float32
                pub const m_flAutoExposureMax: usize = 0x78C; // float32
                pub const m_flExposureAdaptationSpeedUp: usize = 0x790; // float32
                pub const m_flExposureAdaptationSpeedDown: usize = 0x794; // float32
                pub const m_flTonemapEVSmoothingRange: usize = 0x798; // float32
            }
            // Parent: CBaseEntity
            // Fields count: 1
            ...
            pub mod CGameGibManager {
                pub const m_bAllowNewGibs: usize = 0x7A0; // bool
                pub const m_iCurrentMaxPieces: usize = 0x7A4; // int32
            ...
            // Fields count: 4
            pub mod CSkyCamera {
                pub const m_skyboxData: usize = 0x788; // sky3dparams_t
                pub const m_skyboxSlotToken: usize = 0x818; // CUtlStringToken
            ...
            // Fields count: 4
            pub mod CPhysPulley {
                pub const m_position2: usize = 0x7E8; // VectorWS
                pub const m_offset: usize = 0x7F4; // Vector[2]
            ...
            pub mod CSoundStackSave {
                pub const m_iszStackName: usize = 0x788; // CUtlSymbolLarge
            }
            // Parent: None
            // Fields count: 1
            //
            ...
            pub mod CLogicMeasureMovement {
                pub const m_strMeasureTarget: usize = 0x788; // CUtlSymbolLarge
                pub const m_strMeasureReference: usize = 0x790; // CUtlSymbolLarge
                pub const m_strTargetReference: usize = 0x798; // CUtlSymbolLarge
                pub const m_hMeasureTarget: usize = 0x7A0; // CHandle<CBaseEntity>
                pub const m_hMeasureReference: usize = 0x7A4; // CHandle<CBaseEntity>
                pub const m_hTarget: usize = 0x7A8; // CHandle<CBaseEntity>
                pub const m_hTargetReference: usize = 0x7AC; // CHandle<CBaseEntity>
                pub const m_flScale: usize = 0x7B0; // float32
                pub const m_nMeasureType: usize = 0x7B4; // int32
            }
            // Parent: CBaseEntity
            // Fields count: 4
            pub mod CLogicActivityEvent {
                pub const m_nEventType: usize = 0x788; // int32
                pub const m_flDuration: usize = 0x78C; // float32
            ...
            pub mod CEnvDetailController {
                pub const m_flFadeStartDist: usize = 0x788; // float32
                pub const m_flFadeEndDist: usize = 0x78C; // float32
            }
            ...
            pub mod CEnvSoundscapeProxy {
                pub const m_MainSoundscapeName: usize = 0x818; // CUtlSymbolLarge
            }
            // Parent: None
            // Fields count: 1
            //
            ...
            pub mod CPhysThruster {
                pub const m_localOrigin: usize = 0x7E8; // Vector
            }
            // Parent: CPointEntity
            // Fields count: 3
            pub mod CInfoPlayerStart {
                pub const m_bDisabled: usize = 0x788; // bool
                pub const m_bIsMaster: usize = 0x789; // bool
                pub const m_pPawnSubclass: usize = 0x790; // CGlobalSymbol
            }
            // Parent: None
            // Fields count: 10
            pub mod CEntityFlame {
                pub const m_hEntAttached: usize = 0x788; // CHandle<CBaseEntity>
                pub const m_bCheapEffect: usize = 0x78C; // bool
                pub const m_flSize: usize = 0x790; // float32
                pub const m_bUseHitboxes: usize = 0x794; // bool
                pub const m_iNumHitboxFires: usize = 0x798; // int32
                pub const m_flHitboxFireScale: usize = 0x79C; // float32
                pub const m_flLifetime: usize = 0x7A0; // GameTime_t
                pub const m_hAttacker: usize = 0x7A4; // CHandle<CBaseEntity>
                pub const m_flDirectDamagePerSecond: usize = 0x7A8; // float32
                pub const m_iCustomDamageType: usize = 0x7AC; // int32
            }
            ...
            pub mod CSkeletonInstance {
                ...
                pub const m_bDirtyMotionType: usize = 0x3C2; // bool
                pub const m_bIsGeneratingLatchedParentSpaceState: usize = 0x3C3; // bool
                pub const m_materialGroup: usize = 0x3C8; // CUtlStringToken
                pub const m_nHitboxSet: usize = 0x3CC; // uint8
                pub const m_bForceServerConstraintsEnabled: usize = 0x42C; // bool
            }
            // Parent: None
            // Fields count: 0
            ...
            pub mod CPointTeleport {
                pub const m_vSaveOrigin: usize = 0x788; // VectorWS
                pub const m_vSaveAngles: usize = 0x794; // QAngle
                pub const m_bTeleportParentedEntities: usize = 0x7A0; // bool
                pub const m_bTeleportUseCurrentAngle: usize = 0x7A1; // bool
            }
            // Parent: CBaseTrigger
            // Fields count: 3
            ...
            pub mod CMessageEntity {
                pub const m_radius: usize = 0x788; // int32
                pub const m_messageText: usize = 0x790; // CUtlSymbolLarge
                pub const m_drawText: usize = 0x798; // bool
                pub const m_bDeveloperOnly: usize = 0x799; // bool
                pub const m_bEnabled: usize = 0x79A; // bool
            }
            // Parent: CBaseEntity
            // Fields count: 1
            pub mod CEnvEntityIgniter {
                pub const m_flLifetime: usize = 0x788; // float32
            }
            // Parent: None
            // Fields count: 2
            //
            ...
            pub mod CMultiLightProxy {
                pub const m_iszLightNameFilter: usize = 0x788; // CUtlSymbolLarge
                pub const m_iszLightClassFilter: usize = 0x790; // CUtlSymbolLarge
                pub const m_flLightRadiusFilter: usize = 0x798; // float32
                pub const m_flBrightnessDelta: usize = 0x79C; // float32
                pub const m_bPerformScreenFade: usize = 0x7A0; // bool
                pub const m_flTargetBrightnessMultiplier: usize = 0x7A4; // float32
                pub const m_flCurrentBrightnessMultiplier: usize = 0x7A8; // float32
                pub const m_vecLights: usize = 0x7B0; // CUtlVector<CHandle<CLightEntity>>
            }
            // Parent: None
            // Fields count: 0
            ...
            pub mod CFogController {
                pub const m_fog: usize = 0x788; // fogparams_t
            ...
            pub mod CInfoOffscreenPanoramaTexture {
                ...
                pub const m_szLayoutFileName: usize = 0x7A0; // CUtlSymbolLarge
                pub const m_RenderAttrName: usize = 0x7A8; // CUtlSymbolLarge
                pub const m_TargetEntities: usize = 0x7B0; // CNetworkUtlVectorBase<CHandle<CBaseModelEntity>>
                pub const m_nTargetChangeCount: usize = 0x7C8; // int32
                pub const m_vecCSSClasses: usize = 0x7D0; // CNetworkUtlVectorBase<CUtlSymbolLarge>
                pub const m_szTargetsName: usize = 0x7E8; // CUtlSymbolLarge
                pub const m_AdditionalTargetEntities: usize = 0x7F0; // CUtlVector<CHandle<CBaseModelEntity>>
            }
            // Parent: CPointEntity
            // Fields count: 16
            pub mod CPointAngularVelocitySensor {
                pub const m_hTargetEntity: usize = 0x788; // CHandle<CBaseEntity>
                pub const m_flThreshold: usize = 0x78C; // float32
                pub const m_nLastCompareResult: usize = 0x790; // int32
                pub const m_nLastFireResult: usize = 0x794; // int32
                pub const m_flFireTime: usize = 0x798; // GameTime_t
                pub const m_flFireInterval: usize = 0x79C; // float32
                pub const m_flLastAngVelocity: usize = 0x7A0; // float32
                pub const m_lastOrientation: usize = 0x7A4; // QAngle
                pub const m_vecAxis: usize = 0x7B0; // VectorWS
                pub const m_bUseHelper: usize = 0x7BC; // bool
                pub const m_AngularVelocity: usize = 0x7C0; // CEntityOutputTemplate<float32>
                pub const m_OnLessThan: usize = 0x7E0; // CEntityIOOutput
                pub const m_OnLessThanOrEqualTo: usize = 0x7F8; // CEntityIOOutput
                pub const m_OnGreaterThan: usize = 0x810; // CEntityIOOutput
                pub const m_OnGreaterThanOrEqualTo: usize = 0x828; // CEntityIOOutput
                pub const m_OnEqualTo: usize = 0x840; // CEntityIOOutput
            }
            // Parent: CBaseEntity
            // Fields count: 6
            pub mod CPlayerVisibility {
                pub const m_flVisibilityStrength: usize = 0x788; // float32
                pub const m_flFogDistanceMultiplier: usize = 0x78C; // float32
                pub const m_flFogMaxDensityMultiplier: usize = 0x790; // float32
                pub const m_flFadeTime: usize = 0x794; // float32
                pub const m_bStartDisabled: usize = 0x798; // bool
                pub const m_bIsEnabled: usize = 0x799; // bool
            }
            // Parent: None
            // Fields count: 2
            //
            ...
            pub mod CFilterAttributeInt {
                pub const m_sAttributeName: usize = 0x7C0; // CUtlSymbolLarge
            }
            // Parent: CPointEntity
            // Fields count: 8
            pub mod CKeepUpright {
                pub const m_worldGoalAxis: usize = 0x790; // Vector
                pub const m_localTestAxis: usize = 0x79C; // Vector
                pub const m_pController: usize = 0x7A8; // IPhysicsMotionController*
                pub const m_nameAttach: usize = 0x7B0; // CUtlSymbolLarge
                pub const m_attachedObject: usize = 0x7B8; // CHandle<CBaseEntity>
                pub const m_angularLimit: usize = 0x7BC; // float32
                pub const m_bActive: usize = 0x7C0; // bool
                pub const m_bDampAllRotation: usize = 0x7C1; // bool
            }
            // Parent: CBaseEntity
            // Fields count: 12
            pub mod CPointTemplate {
                pub const m_iszWorldName: usize = 0x788; // CUtlSymbolLarge
                pub const m_iszSource2EntityLumpName: usize = 0x790; // CUtlSymbolLarge
                pub const m_iszEntityFilterName: usize = 0x798; // CUtlSymbolLarge
                pub const m_flTimeoutInterval: usize = 0x7A0; // float32
                pub const m_bAsynchronouslySpawnEntities: usize = 0x7A4; // bool
                pub const m_clientOnlyEntityBehavior: usize = 0x7A8; // PointTemplateClientOnlyEntityBehavior_t
                pub const m_ownerSpawnGroupType: usize = 0x7AC; // PointTemplateOwnerSpawnGroupType_t
                pub const m_createdSpawnGroupHandles: usize = 0x7B0; // CUtlVector<uint32>
                pub const m_SpawnedEntityHandles: usize = 0x7C8; // CUtlVector<CEntityHandle>
                pub const m_ScriptSpawnCallback: usize = 0x7E0; // HSCRIPT
                pub const m_ScriptCallbackScope: usize = 0x7E8; // HSCRIPT
                pub const m_OnEntitySpawned: usize = 0x7F0; // CEntityOutputTemplate<CUtlVector<CEntityHandle>>
            }
            // Parent: CBaseEntity
            // Fields count: 36
            pub mod CEnvVolumetricFogController {
                pub const m_flScattering: usize = 0x788; // float32
                pub const m_TintColor: usize = 0x78C; // Color
                pub const m_flAnisotropy: usize = 0x790; // float32
                pub const m_flFadeSpeed: usize = 0x794; // float32
                pub const m_flDrawDistance: usize = 0x798; // float32
                pub const m_flFadeInStart: usize = 0x79C; // float32
                pub const m_flFadeInEnd: usize = 0x7A0; // float32
                pub const m_flIndirectStrength: usize = 0x7A4; // float32
                pub const m_nVolumeDepth: usize = 0x7A8; // int32
                pub const m_fFirstVolumeSliceThickness: usize = 0x7AC; // float32
                pub const m_nIndirectTextureDimX: usize = 0x7B0; // int32
                pub const m_nIndirectTextureDimY: usize = 0x7B4; // int32
                pub const m_nIndirectTextureDimZ: usize = 0x7B8; // int32
                pub const m_vBoxMins: usize = 0x7BC; // Vector
                pub const m_vBoxMaxs: usize = 0x7C8; // Vector
                pub const m_bActive: usize = 0x7D4; // bool
                pub const m_flStartAnisoTime: usize = 0x7D8; // GameTime_t
                pub const m_flStartScatterTime: usize = 0x7DC; // GameTime_t
                pub const m_flStartDrawDistanceTime: usize = 0x7E0; // GameTime_t
                pub const m_flStartAnisotropy: usize = 0x7E4; // float32
                pub const m_flStartScattering: usize = 0x7E8; // float32
                pub const m_flStartDrawDistance: usize = 0x7EC; // float32
                pub const m_flDefaultAnisotropy: usize = 0x7F0; // float32
                pub const m_flDefaultScattering: usize = 0x7F4; // float32
                pub const m_flDefaultDrawDistance: usize = 0x7F8; // float32
                pub const m_bStartDisabled: usize = 0x7FC; // bool
                pub const m_bEnableIndirect: usize = 0x7FD; // bool
                pub const m_bIsMaster: usize = 0x7FE; // bool
                pub const m_hFogIndirectTexture: usize = 0x800; // CStrongHandle<InfoForResourceTypeCTextureBase>
                pub const m_nForceRefreshCount: usize = 0x808; // int32
                pub const m_fNoiseSpeed: usize = 0x80C; // float32
                pub const m_fNoiseStrength: usize = 0x810; // float32
                pub const m_vNoiseScale: usize = 0x814; // Vector
                pub const m_fWindSpeed: usize = 0x820; // float32
                pub const m_vWindDirection: usize = 0x824; // Vector
            ...
            // Fields count: 5
            pub mod CPhysLength {
                pub const m_offset: usize = 0x7E8; // Vector[2]
                pub const m_vecAttach: usize = 0x800; // VectorWS
                pub const m_addLength: usize = 0x80C; // float32
                pub const m_minLength: usize = 0x810; // float32
                pub const m_totalLength: usize = 0x814; // float32
            }
            // Parent: CBaseEntity
            // Fields count: 4
            pub mod CTeam {
                pub const m_aPlayerControllers: usize = 0x788; // CNetworkUtlVectorBase<CHandle<CBasePlayerController>>
                pub const m_aPlayers: usize = 0x7A0; // CNetworkUtlVectorBase<CHandle<CBasePlayerPawn>>
            ...
            pub mod CLogicNPCCounterAABB {
                pub const m_vDistanceOuterMins: usize = 0xA08; // Vector
                pub const m_vDistanceOuterMaxs: usize = 0xA14; // Vector
                pub const m_vOuterMins: usize = 0xA20; // VectorWS
                pub const m_vOuterMaxs: usize = 0xA2C; // VectorWS
            }
            // Parent: None
            // Fields count: 1
            //
            ...
            // Fields count: 11
            pub mod CEnvShake {
                pub const m_limitToEntity: usize = 0x788; // CUtlSymbolLarge
                pub const m_Amplitude: usize = 0x790; // float32
                pub const m_Frequency: usize = 0x794; // float32
                pub const m_Duration: usize = 0x798; // float32
                pub const m_Radius: usize = 0x79C; // float32
                pub const m_stopTime: usize = 0x7A0; // GameTime_t
                pub const m_nextShake: usize = 0x7A4; // GameTime_t
                pub const m_currentAmp: usize = 0x7A8; // float32
                pub const m_maxForce: usize = 0x7AC; // Vector
            ...
            pub mod CSoundOpvarSetAutoRoomEntity {
                pub const m_traceResults: usize = 0x920; // CUtlVector<SoundOpvarTraceResult_t>
                pub const m_doorwayPairs: usize = 0x938; // CUtlVector<AutoRoomDoorwayPairs_t>
                pub const m_flSize: usize = 0x950; // float32
                pub const m_flHeightTolerance: usize = 0x954; // float32
            ...
            pub mod CPhysicsEntitySolver {
                pub const m_hMovingEntity: usize = 0x7A0; // CHandle<CBaseEntity>
                pub const m_hPhysicsBlocker: usize = 0x7A4; // CHandle<CBaseEntity>
                pub const m_separationDuration: usize = 0x7A8; // float32
                pub const m_cancelTime: usize = 0x7AC; // GameTime_t
            }
            // Parent: CBaseEntity
            // Fields count: 7
            pub mod CLogicCollisionPair {
                pub const m_nameAttach1: usize = 0x788; // CUtlSymbolLarge
                pub const m_nameAttach2: usize = 0x790; // CUtlSymbolLarge
                pub const m_includeHierarchy: usize = 0x798; // bool
                pub const m_supportMultipleEntitiesWithSameName: usize = 0x799; // bool
                pub const m_disabled: usize = 0x79A; // bool
                pub const m_succeeded: usize = 0x79B; // bool
                pub const m_allowMissing: usize = 0x79C; // bool
            }
            // Parent: None
            // Fields count: 5
            pub mod CTestEffect {
                pub const m_iLoop: usize = 0x788; // int32
                pub const m_iBeam: usize = 0x78C; // int32
                pub const m_pBeam: usize = 0x790; // CHandle<CBeam>[24]
                pub const m_flBeamTime: usize = 0x7F0; // GameTime_t[24]
                pub const m_flStartTime: usize = 0x850; // GameTime_t
            }
            // Parent: None
            // Fields count: 1
            //
            ...
            pub mod CMathRemap {
                pub const m_flInMin: usize = 0x788; // float32
                pub const m_flInMax: usize = 0x78C; // float32
                pub const m_flOut1: usize = 0x790; // float32
                pub const m_flOut2: usize = 0x794; // float32
                pub const m_flOldInValue: usize = 0x798; // float32
                pub const m_bEnabled: usize = 0x79C; // bool
                pub const m_OutValue: usize = 0x7A0; // CEntityOutputTemplate<float32>
                pub const m_OnRoseAboveMin: usize = 0x7C0; // CEntityIOOutput
            ...
            pub mod CSoundOpvarSetOBBWindEntity {
                pub const m_vMins: usize = 0x830; // Vector
                pub const m_vMaxs: usize = 0x83C; // Vector
                pub const m_vDistanceMins: usize = 0x848; // Vector
                pub const m_vDistanceMaxs: usize = 0x854; // Vector
                pub const m_flWindMin: usize = 0x860; // float32
                pub const m_flWindMax: usize = 0x864; // float32
                pub const m_flWindMapMin: usize = 0x868; // float32
                pub const m_flWindMapMax: usize = 0x86C; // float32
            }
            // Parent: None
            // Fields count: 3
            //
            ...
            pub mod CCSGO_TeamPreviewCharacterPosition {
                ...
                pub const m_nOrdinal: usize = 0x790; // int32
            ...
            pub mod CMessage {
                ...
                pub const m_MessageVolume: usize = 0x790; // float32
                pub const m_MessageAttenuation: usize = 0x794; // int32
                pub const m_Radius: usize = 0x798; // float32
                pub const m_sNoise: usize = 0x7A0; // CGameSoundEventName
                pub const m_OnShowMessage: usize = 0x7A8; // CEntityIOOutput
            }
            // Parent: CPointEntity
            // Fields count: 6
            pub mod CPointVelocitySensor {
                pub const m_hTargetEntity: usize = 0x788; // CHandle<CBaseEntity>
                pub const m_vecAxis: usize = 0x78C; // Vector
                pub const m_bEnabled: usize = 0x798; // bool
                pub const m_fPrevVelocity: usize = 0x79C; // float32
                pub const m_flAvgInterval: usize = 0x7A0; // float32
                pub const m_Velocity: usize = 0x7A8; // CEntityOutputTemplate<float32>
            }
            // Parent: None
            // Fields count: 28
            //
            ...
            // Fields count: 5
            pub mod CEnvSpark {
                pub const m_flDelay: usize = 0x788; // float32
                pub const m_nMagnitude: usize = 0x78C; // int32
                pub const m_nTrailLength: usize = 0x790; // int32
            ...
            pub mod CPointOrient {
                pub const m_iszSpawnTargetName: usize = 0x788; // CUtlSymbolLarge
                pub const m_hTarget: usize = 0x790; // CHandle<CBaseEntity>
                pub const m_bActive: usize = 0x794; // bool
                pub const m_nGoalDirection: usize = 0x798; // PointOrientGoalDirectionType_t
                pub const m_nConstraint: usize = 0x79C; // PointOrientConstraint_t
                pub const m_flMaxTurnRate: usize = 0x7A0; // float32
                pub const m_flLastGameTime: usize = 0x7A4; // GameTime_t
            }
            // Parent: None
            // Fields count: 6
            //
            ...
            pub mod CCSPlayerController_ActionTrackingServices {
                ...
                pub const m_matchStats: usize = 0xD0; // CSMatchStats_t
            ...
            pub mod CBodyComponentBaseAnimGraph {
                pub const m_animationController: usize = 0x4F0; // CBaseAnimGraphController
            }
            // Parent: None
            // Fields count: 2
            //
            ...
            pub mod CTimerEntity {
                pub const m_OnTimer: usize = 0x788; // CEntityIOOutput
                pub const m_OnTimerHigh: usize = 0x7A0; // CEntityIOOutput
                pub const m_OnTimerLow: usize = 0x7B8; // CEntityIOOutput
                pub const m_iDisabled: usize = 0x7D0; // int32
                pub const m_flInitialDelay: usize = 0x7D4; // float32
                pub const m_flRefireTime: usize = 0x7D8; // float32
                pub const m_bUpDownState: usize = 0x7DC; // bool
                pub const m_iUseRandomTime: usize = 0x7E0; // int32
                pub const m_bPauseAfterFiring: usize = 0x7E4; // bool
                pub const m_flLowerRandomBound: usize = 0x7E8; // float32
                pub const m_flUpperRandomBound: usize = 0x7EC; // float32
                pub const m_flRemainingTime: usize = 0x7F0; // float32
                pub const m_bPaused: usize = 0x7F4; // bool
            }
            // Parent: None
            // Fields count: 14
            ...
            pub mod CSMatchStats_t {
                ...
                pub const m_flHealthPointsRemovedTotal: usize = 0x90; // float32
                pub const m_flHealthPointsDealtTotal: usize = 0x94; // float32
            ...
            pub mod CInfoVisibilityBox {
                pub const m_nMode: usize = 0x78C; // int32
                pub const m_vBoxSize: usize = 0x790; // Vector
                pub const m_bEnabled: usize = 0x79C; // bool
            }
            // Parent: CBaseToggle
            // Fields count: 4
            ...
            pub mod CSoundEventConeEntity {
                pub const m_flEmitterAngle: usize = 0x844; // float32
                pub const m_flSweetSpotAngle: usize = 0x848; // float32
                pub const m_flAttenMin: usize = 0x84C; // float32
                pub const m_flAttenMax: usize = 0x850; // float32
                pub const m_iszParameterName: usize = 0x858; // CUtlSymbolLarge
            }
            // Parent: None
            // Fields count: 0
            ...
            pub mod CSoundOpvarSetPathCornerEntity {
                pub const m_bUseParentedPath: usize = 0x938; // bool
                pub const m_flDistMinSqr: usize = 0x93C; // float32
                pub const m_flDistMaxSqr: usize = 0x940; // float32
                pub const m_iszPathCornerEntityName: usize = 0x948; // CUtlSymbolLarge
            }
            // Parent: CPointEntity
            // Fields count: 0
            ...
            pub mod CModelState {
                ...
                pub const m_nBodyGroupChoices: usize = 0x248; // CNetworkUtlVectorBase<int32>
                pub const m_nIdealMotionType: usize = 0x292; // int8
                pub const m_nForceLOD: usize = 0x293; // int8
            ...
            pub mod CLogicActiveAutosave {
                pub const m_TriggerHitPoints: usize = 0x794; // int32
                pub const m_flTimeToTrigger: usize = 0x798; // float32
                pub const m_flStartTime: usize = 0x79C; // GameTime_t
                pub const m_flDangerousTime: usize = 0x7A0; // float32
            }
            // Parent: CBaseEntity
            // Fields count: 11
            pub mod CMathCounter {
                pub const m_flMin: usize = 0x788; // float32
                pub const m_flMax: usize = 0x78C; // float32
                pub const m_bHitMin: usize = 0x790; // bool
                pub const m_bHitMax: usize = 0x791; // bool
                pub const m_bDisabled: usize = 0x792; // bool
                pub const m_OutValue: usize = 0x798; // CEntityOutputTemplate<float32>
                pub const m_OnGetValue: usize = 0x7B8; // CEntityOutputTemplate<float32>
                pub const m_OnHitMin: usize = 0x7D8; // CEntityIOOutput
                pub const m_OnHitMax: usize = 0x7F0; // CEntityIOOutput
                pub const m_OnChangedFromMin: usize = 0x808; // CEntityIOOutput
                pub const m_OnChangedFromMax: usize = 0x820; // CEntityIOOutput
            }
            // Parent: None
            // Fields count: 1
            ...
            pub mod CEnvVolumetricFogVolume {
                ...
                pub const m_bIndirectUseLPVs: usize = 0x7A5; // bool
                pub const m_flStrength: usize = 0x7A8; // float32
                pub const m_nFalloffShape: usize = 0x7AC; // int32
                pub const m_flFalloffExponent: usize = 0x7B0; // float32
                pub const m_flHeightFogDepth: usize = 0x7B4; // float32
                pub const m_fHeightFogEdgeWidth: usize = 0x7B8; // float32
                pub const m_fIndirectLightStrength: usize = 0x7BC; // float32
                pub const m_fSunLightStrength: usize = 0x7C0; // float32
                pub const m_fNoiseStrength: usize = 0x7C4; // float32
                pub const m_TintColor: usize = 0x7C8; // Color
                pub const m_bOverrideTintColor: usize = 0x7CC; // bool
                pub const m_bOverrideIndirectLightStrength: usize = 0x7CD; // bool
                pub const m_bOverrideSunLightStrength: usize = 0x7CE; // bool
                pub const m_bOverrideNoiseStrength: usize = 0x7CF; // bool
            }
            // Parent: None
            // Fields count: 0
            ...
            pub mod CPointValueRemapper {
                pub const m_bDisabled: usize = 0x788; // bool
                pub const m_bUpdateOnClient: usize = 0x789; // bool
                pub const m_nInputType: usize = 0x78C; // ValueRemapperInputType_t
                pub const m_iszRemapLineStartName: usize = 0x790; // CUtlSymbolLarge
                pub const m_iszRemapLineEndName: usize = 0x798; // CUtlSymbolLarge
                pub const m_hRemapLineStart: usize = 0x7A0; // CHandle<CBaseEntity>
                pub const m_hRemapLineEnd: usize = 0x7A4; // CHandle<CBaseEntity>
                pub const m_flMaximumChangePerSecond: usize = 0x7A8; // float32
                pub const m_flDisengageDistance: usize = 0x7AC; // float32
                pub const m_flEngageDistance: usize = 0x7B0; // float32
                pub const m_bRequiresUseKey: usize = 0x7B4; // bool
                pub const m_nOutputType: usize = 0x7B8; // ValueRemapperOutputType_t
                pub const m_iszOutputEntityName: usize = 0x7C0; // CUtlSymbolLarge
                pub const m_iszOutputEntity2Name: usize = 0x7C8; // CUtlSymbolLarge
                pub const m_iszOutputEntity3Name: usize = 0x7D0; // CUtlSymbolLarge
                pub const m_iszOutputEntity4Name: usize = 0x7D8; // CUtlSymbolLarge
                pub const m_hOutputEntities: usize = 0x7E0; // CNetworkUtlVectorBase<CHandle<CBaseEntity>>
                pub const m_nHapticsType: usize = 0x7F8; // ValueRemapperHapticsType_t
                pub const m_nMomentumType: usize = 0x7FC; // ValueRemapperMomentumType_t
                pub const m_flMomentumModifier: usize = 0x800; // float32
                pub const m_flSnapValue: usize = 0x804; // float32
                pub const m_flCurrentMomentum: usize = 0x808; // float32
                pub const m_nRatchetType: usize = 0x80C; // ValueRemapperRatchetType_t
                pub const m_flRatchetOffset: usize = 0x810; // float32
                pub const m_flInputOffset: usize = 0x814; // float32
                pub const m_bEngaged: usize = 0x818; // bool
                pub const m_bFirstUpdate: usize = 0x819; // bool
                pub const m_flPreviousValue: usize = 0x81C; // float32
                pub const m_flPreviousUpdateTickTime: usize = 0x820; // GameTime_t
                pub const m_vecPreviousTestPoint: usize = 0x824; // VectorWS
                pub const m_hUsingPlayer: usize = 0x830; // CHandle<CBasePlayerPawn>
                pub const m_flCustomOutputValue: usize = 0x834; // float32
                pub const m_iszSoundEngage: usize = 0x838; // CUtlSymbolLarge
                pub const m_iszSoundDisengage: usize = 0x840; // CUtlSymbolLarge
                pub const m_iszSoundReachedValueZero: usize = 0x848; // CUtlSymbolLarge
                pub const m_iszSoundReachedValueOne: usize = 0x850; // CUtlSymbolLarge
                pub const m_iszSoundMovingLoop: usize = 0x858; // CUtlSymbolLarge
                pub const m_Position: usize = 0x878; // CEntityOutputTemplate<float32>
                pub const m_PositionDelta: usize = 0x898; // CEntityOutputTemplate<float32>
                pub const m_OnReachedValueZero: usize = 0x8B8; // CEntityIOOutput
                pub const m_OnReachedValueOne: usize = 0x8D0; // CEntityIOOutput
                pub const m_OnReachedValueCustom: usize = 0x8E8; // CEntityIOOutput
                pub const m_OnEngage: usize = 0x900; // CEntityIOOutput
                pub const m_OnDisengage: usize = 0x918; // CEntityIOOutput
            }
            // Parent: None
            // Fields count: 3
            ...
            pub mod CAI_ChangeHintGroup {
                pub const m_iSearchType: usize = 0x788; // int32
                pub const m_strSearchName: usize = 0x790; // CUtlSymbolLarge
            ...
            // Fields count: 19
            pub mod CPhysHinge {
                pub const m_soundInfo: usize = 0x7F0; // ConstraintSoundInfo
                pub const m_NotifyMinLimitReached: usize = 0x888; // CEntityIOOutput
                pub const m_NotifyMaxLimitReached: usize = 0x8A0; // CEntityIOOutput
                pub const m_bAtMinLimit: usize = 0x8B8; // bool
                pub const m_bAtMaxLimit: usize = 0x8B9; // bool
                pub const m_hinge: usize = 0x8BC; // constraint_hingeparams_t
                pub const m_hingeFriction: usize = 0x8FC; // float32
                pub const m_systemLoadScale: usize = 0x900; // float32
                pub const m_bIsAxisLocal: usize = 0x904; // bool
                pub const m_flMinRotation: usize = 0x908; // float32
                pub const m_flMaxRotation: usize = 0x90C; // float32
                pub const m_flInitialRotation: usize = 0x910; // float32
                pub const m_flMotorFrequency: usize = 0x914; // float32
                pub const m_flMotorDampingRatio: usize = 0x918; // float32
                pub const m_flAngleSpeed: usize = 0x91C; // float32
                pub const m_flAngleSpeedThreshold: usize = 0x920; // float32
                pub const m_flLimitsDebugVisRotation: usize = 0x924; // float32
                pub const m_OnStartMoving: usize = 0x928; // CEntityIOOutput
                pub const m_OnStopMoving: usize = 0x940; // CEntityIOOutput
            }
            // Parent: CBaseTrigger
            // Fields count: 1
            pub mod CBuyZone {
            ...
            pub mod CInfoChoreoAnchor {
                pub const m_vecTargetEntries: usize = 0x788; // CUtlVector<CInfoChoreoAnchorPosition>
                pub const m_vecTargetWarps: usize = 0x7A0; // CUtlVector<CInfoChoreoAnchorPosition>
            }
            // Parent: None
            // Fields count: 0
            ...
            pub mod CInfoWorldLayer {
                pub const m_pOutputOnEntitiesSpawned: usize = 0x788; // CEntityIOOutput
                pub const m_worldName: usize = 0x7A0; // CUtlSymbolLarge
                pub const m_layerName: usize = 0x7A8; // CUtlSymbolLarge
                pub const m_bWorldLayerVisible: usize = 0x7B0; // bool
                pub const m_bEntitiesSpawned: usize = 0x7B1; // bool
            ...
            pub mod FilterDamageType {
                pub const m_iDamageType: usize = 0x7C0; // int32
            }
            // Parent: CBaseEntity
            // Fields count: 26
            pub mod CPointCamera {
                ...
                pub const m_bUseScreenAspectRatio: usize = 0x7A5; // bool
                pub const m_flAspectRatio: usize = 0x7A8; // float32
                pub const m_bNoSky: usize = 0x7AC; // bool
                pub const m_fBrightness: usize = 0x7B0; // float32
                pub const m_flZFar: usize = 0x7B4; // float32
                pub const m_flZNear: usize = 0x7B8; // float32
                pub const m_bCanHLTVUse: usize = 0x7BC; // bool
                pub const m_bAlignWithParent: usize = 0x7BD; // bool
                pub const m_bDofEnabled: usize = 0x7BE; // bool
                pub const m_flDofNearBlurry: usize = 0x7C0; // float32
                pub const m_flDofNearCrisp: usize = 0x7C4; // float32
                pub const m_flDofFarCrisp: usize = 0x7C8; // float32
                pub const m_flDofFarBlurry: usize = 0x7CC; // float32
                pub const m_flDofTiltToGround: usize = 0x7D0; // float32
                pub const m_TargetFOV: usize = 0x7D4; // float32
            ...
            pub mod CCSGameRules {
                ...
                pub const m_hPlayerResource: usize = 0x1130; // CHandle<CBaseEntity>
                pub const m_RetakeRules: usize = 0x1138; // CRetakeGameRules
                pub const m_arrTeamUniqueKillWeaponsMatch: usize = 0x1328; // CUtlVector<int32>[4]
                pub const m_bTeamLastKillUsedUniqueWeaponMatch: usize = 0x1388; // bool[4]
                pub const m_nMatchEndCount: usize = 0x13B0; // uint8
                pub const m_nTTeamIntroVariant: usize = 0x13B4; // int32
                pub const m_nCTTeamIntroVariant: usize = 0x13B8; // int32
                pub const m_bTeamIntroPeriod: usize = 0x13BC; // bool
                pub const m_fTeamIntroPeriodEnd: usize = 0x13C0; // GameTime_t
                pub const m_bPlayedTeamIntroVO: usize = 0x13C4; // bool
                pub const m_iRoundEndWinnerTeam: usize = 0x13C8; // int32
                pub const m_eRoundEndReason: usize = 0x13CC; // int32
                pub const m_bRoundEndShowTimerDefend: usize = 0x13D0; // bool
                pub const m_iRoundEndTimerTime: usize = 0x13D4; // int32
                pub const m_sRoundEndFunFactToken: usize = 0x13D8; // CUtlString
                pub const m_iRoundEndFunFactPlayerSlot: usize = 0x13E0; // CPlayerSlot
                pub const m_iRoundEndFunFactData1: usize = 0x13E4; // int32
                pub const m_iRoundEndFunFactData2: usize = 0x13E8; // int32
                pub const m_iRoundEndFunFactData3: usize = 0x13EC; // int32
                pub const m_sRoundEndMessage: usize = 0x13F0; // CUtlString
                pub const m_iRoundEndPlayerCount: usize = 0x13F8; // int32
                pub const m_bRoundEndNoMusic: usize = 0x13FC; // bool
                pub const m_iRoundEndLegacy: usize = 0x1400; // int32
                pub const m_nRoundEndCount: usize = 0x1404; // uint8
                pub const m_iRoundStartRoundNumber: usize = 0x1408; // int32
                pub const m_nRoundStartCount: usize = 0x140C; // uint8
            ...
            pub mod CPhysConstraint {
                pub const m_hJoint: usize = 0x788; // IPhysicsJoint*
                pub const m_nameAttach1: usize = 0x790; // CUtlSymbolLarge
                pub const m_nameAttach2: usize = 0x798; // CUtlSymbolLarge
                pub const m_hAttach1: usize = 0x7A0; // CHandle<CBaseEntity>
                pub const m_hAttach2: usize = 0x7A4; // CHandle<CBaseEntity>
                pub const m_nameAttachment1: usize = 0x7A8; // CUtlSymbolLarge
                pub const m_nameAttachment2: usize = 0x7B0; // CUtlSymbolLarge
                pub const m_breakSound: usize = 0x7B8; // CGameSoundEventName
                pub const m_forceLimit: usize = 0x7C0; // float32
                pub const m_torqueLimit: usize = 0x7C4; // float32
                pub const m_minTeleportDistance: usize = 0x7C8; // float32
                pub const m_bSnapObjectPositions: usize = 0x7CC; // bool
                pub const m_bTreatEntity1AsInfiniteMass: usize = 0x7CD; // bool
                pub const m_OnBreak: usize = 0x7D0; // CEntityIOOutput
            }
            // Parent: CBaseEntity
            // Fields count: 3
            pub mod CLogicAchievement {
                pub const m_bDisabled: usize = 0x788; // bool
                pub const m_iszAchievementEventID: usize = 0x790; // CUtlSymbolLarge
                pub const m_OnFired: usize = 0x798; // CEntityIOOutput
            }
            // Parent: None
            // Fields count: 3
            ...
            pub mod CLogicLineToEntity {
                pub const m_Line: usize = 0x788; // CEntityOutputTemplate<Vector>
                pub const m_SourceName: usize = 0x7B0; // CUtlSymbolLarge
                pub const m_StartEntity: usize = 0x7B8; // CHandle<CBaseEntity>
                pub const m_EndEntity: usize = 0x7BC; // CHandle<CBaseEntity>
            }
            ...
            pub mod CInfoSpawnGroupLoadUnload {
                pub const m_OnSpawnGroupLoadStarted: usize = 0x788; // CEntityIOOutput
                pub const m_OnSpawnGroupLoadFinished: usize = 0x7A0; // CEntityIOOutput
                pub const m_OnSpawnGroupUnloadStarted: usize = 0x7B8; // CEntityIOOutput
                pub const m_OnSpawnGroupUnloadFinished: usize = 0x7D0; // CEntityIOOutput
                pub const m_iszSpawnGroupName: usize = 0x7E8; // CUtlSymbolLarge
                pub const m_iszSpawnGroupFilterName: usize = 0x7F0; // CUtlSymbolLarge
                pub const m_iszLandmarkName: usize = 0x7F8; // CUtlSymbolLarge
                pub const m_sFixedSpawnGroupName: usize = 0x800; // CUtlString
                pub const m_flTimeoutInterval: usize = 0x808; // float32
                pub const m_bAutoActivate: usize = 0x80C; // bool
                pub const m_bUnloadingStarted: usize = 0x80D; // bool
                pub const m_bQueueActiveSpawnGroupChange: usize = 0x80E; // bool
                pub const m_bQueueFinishLoading: usize = 0x80F; // bool
            }
            // Parent: CSoundAreaEntityBase
            // Fields count: 2
            ...
            pub mod CBaseModelEntity {
                ...
                pub const m_pChoreoComponent: usize = 0x7A8; // CChoreoComponent*
                pub const m_nDestructiblePartInitialStateDestructed0: usize = 0x7B0; // HitGroup_t
                pub const m_nDestructiblePartInitialStateDestructed1: usize = 0x7B4; // HitGroup_t
                pub const m_nDestructiblePartInitialStateDestructed2: usize = 0x7B8; // HitGroup_t
                pub const m_nDestructiblePartInitialStateDestructed3: usize = 0x7BC; // HitGroup_t
                pub const m_nDestructiblePartInitialStateDestructed4: usize = 0x7C0; // HitGroup_t
                pub const m_nDestructiblePartInitialStateDestructed0_PartIndex: usize = 0x7C4; // int32
                pub const m_nDestructiblePartInitialStateDestructed1_PartIndex: usize = 0x7C8; // int32
                pub const m_nDestructiblePartInitialStateDestructed2_PartIndex: usize = 0x7CC; // int32
                pub const m_nDestructiblePartInitialStateDestructed3_PartIndex: usize = 0x7D0; // int32
                pub const m_nDestructiblePartInitialStateDestructed4_PartIndex: usize = 0x7D4; // int32
                pub const m_bDestructiblePartInitialStateDestructed0_GenerateBreakpieces: usize = 0x7D8; // bool
                pub const m_bDestructiblePartInitialStateDestructed1_GenerateBreakpieces: usize = 0x7D9; // bool
                pub const m_bDestructiblePartInitialStateDestructed2_GenerateBreakpieces: usize = 0x7DA; // bool
                pub const m_bDestructiblePartInitialStateDestructed3_GenerateBreakpieces: usize = 0x7DB; // bool
                pub const m_bDestructiblePartInitialStateDestructed4_GenerateBreakpieces: usize = 0x7DC; // bool
                pub const m_pDestructiblePartsSystemComponent: usize = 0x7E0; // CDestructiblePartsComponent*
                pub const m_OnDestructibleHitGroupDamageLevelChanged: usize = 0x7E8; // CEntityOutputTemplate<CBaseModelEntity::OnDamageLevelChangedArgs_t>
                pub const m_flDissolveStartTime: usize = 0x810; // GameTime_t
                pub const m_OnIgnite: usize = 0x818; // CEntityIOOutput
                pub const m_nRenderMode: usize = 0x830; // RenderMode_t
                pub const m_nRenderFX: usize = 0x831; // RenderFx_t
                pub const m_bAllowFadeInView: usize = 0x832; // bool
                ...
                pub const m_fadeMinDist: usize = 0x9DC; // float32
                pub const m_fadeMaxDist: usize = 0x9E0; // float32
            ...
            pub mod CCitadelSoundOpvarSetOBB {
                pub const m_iszStackName: usize = 0x788; // CUtlSymbolLarge
                pub const m_iszOperatorName: usize = 0x790; // CUtlSymbolLarge
                pub const m_iszOpvarName: usize = 0x798; // CUtlSymbolLarge
                pub const m_vDistanceInnerMins: usize = 0x7A0; // Vector
                pub const m_vDistanceInnerMaxs: usize = 0x7AC; // Vector
                pub const m_vDistanceOuterMins: usize = 0x7B8; // Vector
                pub const m_vDistanceOuterMaxs: usize = 0x7C4; // Vector
                pub const m_nAABBDirection: usize = 0x7D0; // int32
            }
            // Parent: CBaseEntity
            // Fields count: 2
            ...
            pub mod CEnvViewPunch {
                pub const m_flRadius: usize = 0x788; // float32
                pub const m_angViewPunch: usize = 0x78C; // QAngle
            }
            // Parent: None
            // Fields count: 15
            ...
            pub mod CVoteController {
                ...
                pub const m_iOnlyTeamToVote: usize = 0x78C; // int32
                pub const m_nVoteOptionCount: usize = 0x790; // int32[5]
                pub const m_nPotentialVotes: usize = 0x7A4; // int32
                pub const m_bIsYesNoVote: usize = 0x7A8; // bool
                pub const m_acceptingVotesTimer: usize = 0x7B0; // CountdownTimer
                pub const m_executeCommandTimer: usize = 0x7C8; // CountdownTimer
                pub const m_resetVoteTimer: usize = 0x7E0; // CountdownTimer
                pub const m_nVotesCast: usize = 0x7F8; // int32[64]
                pub const m_playerHoldingVote: usize = 0x8F8; // CPlayerSlot
                pub const m_playerOverrideForVote: usize = 0x8FC; // CPlayerSlot
                pub const m_nHighestCountIndex: usize = 0x900; // int32
                pub const m_potentialIssues: usize = 0x908; // CUtlVector<CBaseIssue*>
            ...
            pub mod CBaseEntity {
                ...
                pub const m_think: usize = 0x540; // BASEPTR
                ...
                pub const m_pfnTouch: usize = 0x570; // ENTITYFUNCPTR
                pub const m_pfnUse: usize = 0x580; // USEPTR
                pub const m_pfnBlocked: usize = 0x590; // ENTITYFUNCPTR
                pub const m_pfnMoveDone: usize = 0x5A0; // BASEPTR
                ...
                pub const m_nPreviouslySetMoveType: usize = 0x5D4; // MoveType_t
                pub const m_nActualMoveType: usize = 0x5D5; // MoveType_t
                pub const m_nWaterTouch: usize = 0x5D6; // uint8
                pub const m_nSlimeTouch: usize = 0x5D7; // uint8
                pub const m_bRestoreInHierarchy: usize = 0x5D8; // bool
                pub const m_target: usize = 0x5E0; // CUtlSymbolLarge
                pub const m_hDamageFilter: usize = 0x5E8; // CHandle<CBaseFilter>
                pub const m_iszDamageFilterName: usize = 0x5F0; // CUtlSymbolLarge
                pub const m_flMoveDoneTime: usize = 0x5F8; // float32
                pub const m_nSubclassID: usize = 0x5FC; // CUtlStringToken
                pub const m_flAnimTime: usize = 0x608; // float32
                pub const m_flSimulationTime: usize = 0x60C; // float32
                pub const m_flCreateTime: usize = 0x610; // GameTime_t
                pub const m_bClientSideRagdoll: usize = 0x614; // bool
                pub const m_ubInterpolationFrame: usize = 0x615; // uint8
                pub const m_vPrevVPhysicsUpdatePos: usize = 0x618; // VectorWS
                pub const m_iTeamNum: usize = 0x624; // uint8
                pub const m_iGlobalname: usize = 0x628; // CUtlSymbolLarge
                pub const m_iSentToClients: usize = 0x630; // int32
                pub const m_sUniqueHammerID: usize = 0x638; // CUtlString
                pub const m_spawnflags: usize = 0x640; // uint32
                pub const m_nNextThinkTick: usize = 0x644; // GameTick_t
                pub const m_nSimulationTick: usize = 0x648; // int32
                pub const m_OnKilled: usize = 0x650; // CEntityIOOutput
                pub const m_fFlags: usize = 0x668; // uint32
                pub const m_vecAbsVelocity: usize = 0x66C; // Vector
                pub const m_vecVelocity: usize = 0x678; // CNetworkVelocityVector
                pub const m_vecBaseVelocity: usize = 0x6A8; // Vector
                pub const m_nPushEnumCount: usize = 0x6B4; // int32
                pub const m_pCollision: usize = 0x6B8; // CCollisionProperty*
                pub const m_hEffectEntity: usize = 0x6C0; // CHandle<CBaseEntity>
                pub const m_hOwnerEntity: usize = 0x6C4; // CHandle<CBaseEntity>
                pub const m_fEffects: usize = 0x6C8; // uint32
                pub const m_hGroundEntity: usize = 0x6CC; // CHandle<CBaseEntity>
                pub const m_nGroundBodyIndex: usize = 0x6D0; // int32
                pub const m_flFriction: usize = 0x6D4; // float32
                pub const m_flElasticity: usize = 0x6D8; // float32
                pub const m_flGravityScale: usize = 0x6DC; // float32
                pub const m_flTimeScale: usize = 0x6E0; // float32
                pub const m_flWaterLevel: usize = 0x6E4; // float32
                pub const m_bGravityDisabled: usize = 0x6E8; // bool
                pub const m_bAnimatedEveryTick: usize = 0x6E9; // bool
                pub const m_flActualGravityScale: usize = 0x6EC; // float32
                pub const m_bGravityActuallyDisabled: usize = 0x6F0; // bool
                ...
                pub const m_OnUser2: usize = 0x710; // CEntityIOOutput
                pub const m_OnUser3: usize = 0x728; // CEntityIOOutput
                pub const m_OnUser4: usize = 0x740; // CEntityIOOutput
                pub const m_iInitialTeamNum: usize = 0x758; // int32
                pub const m_flNavIgnoreUntilTime: usize = 0x75C; // GameTime_t
                pub const m_vecAngVelocity: usize = 0x760; // QAngle
                pub const m_bNetworkQuantizeOriginAndAngles: usize = 0x76C; // bool
                pub const m_bLagCompensate: usize = 0x76D; // bool
                pub const m_pBlocker: usize = 0x770; // CHandle<CBaseEntity>
                pub const m_flLocalTime: usize = 0x774; // float32
                pub const m_flVPhysicsUpdateLocalTime: usize = 0x778; // float32
            ...
            pub mod CRagdollMagnet {
                pub const m_bDisabled: usize = 0x788; // bool
                pub const m_radius: usize = 0x78C; // float32
                pub const m_force: usize = 0x790; // float32
                pub const m_axis: usize = 0x794; // VectorWS
            }
            // Parent: None
            // Fields count: 0
            ...
            pub mod CPointAngleSensor {
                pub const m_bDisabled: usize = 0x788; // bool
                pub const m_nLookAtName: usize = 0x790; // CUtlSymbolLarge
                pub const m_hTargetEntity: usize = 0x798; // CHandle<CBaseEntity>
                pub const m_hLookAtEntity: usize = 0x79C; // CHandle<CBaseEntity>
                pub const m_flDuration: usize = 0x7A0; // float32
                pub const m_flDotTolerance: usize = 0x7A4; // float32
                pub const m_flFacingTime: usize = 0x7A8; // GameTime_t
                pub const m_bFired: usize = 0x7AC; // bool
                pub const m_OnFacingLookat: usize = 0x7B0; // CEntityIOOutput
            ...
            pub mod CGenericConstraint {
                pub const m_bPlaceAnchorsAtConstraintTransform: usize = 0x7F0; // bool
                pub const m_nLinearMotionX: usize = 0x7F4; // JointMotion_t
                pub const m_nLinearMotionY: usize = 0x7F8; // JointMotion_t
                pub const m_nLinearMotionZ: usize = 0x7FC; // JointMotion_t
                pub const m_flLinearFrequencyX: usize = 0x800; // float32
                pub const m_flLinearFrequencyY: usize = 0x804; // float32
                pub const m_flLinearFrequencyZ: usize = 0x808; // float32
                pub const m_flLinearDampingRatioX: usize = 0x80C; // float32
                pub const m_flLinearDampingRatioY: usize = 0x810; // float32
                pub const m_flLinearDampingRatioZ: usize = 0x814; // float32
                pub const m_flMaxLinearImpulseX: usize = 0x818; // float32
                pub const m_flMaxLinearImpulseY: usize = 0x81C; // float32
                pub const m_flMaxLinearImpulseZ: usize = 0x820; // float32
                pub const m_flBreakAfterTimeX: usize = 0x824; // float32
                pub const m_flBreakAfterTimeY: usize = 0x828; // float32
                pub const m_flBreakAfterTimeZ: usize = 0x82C; // float32
                pub const m_flBreakAfterTimeStartTimeX: usize = 0x830; // GameTime_t
                pub const m_flBreakAfterTimeStartTimeY: usize = 0x834; // GameTime_t
                pub const m_flBreakAfterTimeStartTimeZ: usize = 0x838; // GameTime_t
                pub const m_flBreakAfterTimeThresholdX: usize = 0x83C; // float32
                pub const m_flBreakAfterTimeThresholdY: usize = 0x840; // float32
                pub const m_flBreakAfterTimeThresholdZ: usize = 0x844; // float32
                pub const m_flNotifyForceX: usize = 0x848; // float32
                pub const m_flNotifyForceY: usize = 0x84C; // float32
                pub const m_flNotifyForceZ: usize = 0x850; // float32
                pub const m_flNotifyForceMinTimeX: usize = 0x854; // float32
                pub const m_flNotifyForceMinTimeY: usize = 0x858; // float32
                pub const m_flNotifyForceMinTimeZ: usize = 0x85C; // float32
                pub const m_flNotifyForceLastTimeX: usize = 0x860; // GameTime_t
                pub const m_flNotifyForceLastTimeY: usize = 0x864; // GameTime_t
                pub const m_flNotifyForceLastTimeZ: usize = 0x868; // GameTime_t
                pub const m_bAxisNotifiedX: usize = 0x86C; // bool
                pub const m_bAxisNotifiedY: usize = 0x86D; // bool
                pub const m_bAxisNotifiedZ: usize = 0x86E; // bool
                pub const m_nAngularMotionX: usize = 0x870; // JointMotion_t
                pub const m_nAngularMotionY: usize = 0x874; // JointMotion_t
                pub const m_nAngularMotionZ: usize = 0x878; // JointMotion_t
                pub const m_flAngularFrequencyX: usize = 0x87C; // float32
                pub const m_flAngularFrequencyY: usize = 0x880; // float32
                pub const m_flAngularFrequencyZ: usize = 0x884; // float32
                pub const m_flAngularDampingRatioX: usize = 0x888; // float32
                pub const m_flAngularDampingRatioY: usize = 0x88C; // float32
                pub const m_flAngularDampingRatioZ: usize = 0x890; // float32
                pub const m_flMaxAngularImpulseX: usize = 0x894; // float32
                pub const m_flMaxAngularImpulseY: usize = 0x898; // float32
                pub const m_flMaxAngularImpulseZ: usize = 0x89C; // float32
                pub const m_NotifyForceReachedX: usize = 0x8A0; // CEntityIOOutput
                pub const m_NotifyForceReachedY: usize = 0x8B8; // CEntityIOOutput
                pub const m_NotifyForceReachedZ: usize = 0x8D0; // CEntityIOOutput
            }
            // Parent: None
            // Fields count: 1
            //
            ...
            pub mod CSoundOpvarSetEntity {
                pub const m_iszStackName: usize = 0x7A0; // CUtlSymbolLarge
                pub const m_iszOperatorName: usize = 0x7A8; // CUtlSymbolLarge
                pub const m_iszOpvarName: usize = 0x7B0; // CUtlSymbolLarge
                pub const m_nOpvarType: usize = 0x7B8; // int32
                pub const m_nOpvarIndex: usize = 0x7BC; // int32
                pub const m_flOpvarValue: usize = 0x7C0; // float32
                pub const m_OpvarValueString: usize = 0x7C8; // CUtlSymbolLarge
                pub const m_bSetOnSpawn: usize = 0x7D0; // bool
            }
            // Parent: CBaseEntity
            // Fields count: 2
            pub mod CEnvBeverage {
                pub const m_CanInDispenser: usize = 0x788; // bool
                pub const m_nBeverageType: usize = 0x78C; // int32
            }
            // Parent: CBaseEntity
            // Fields count: 15
            pub mod CPhysMotor {
                pub const m_nameAttach: usize = 0x788; // CUtlSymbolLarge
                pub const m_nameAnchor: usize = 0x790; // CUtlSymbolLarge
                pub const m_hAttachedObject: usize = 0x798; // CHandle<CBaseEntity>
                pub const m_hAnchorObject: usize = 0x79C; // CHandle<CBaseEntity>
                pub const m_spinUp: usize = 0x7A0; // float32
                pub const m_spinDown: usize = 0x7A4; // float32
                pub const m_flMotorFriction: usize = 0x7A8; // float32
                pub const m_additionalAcceleration: usize = 0x7AC; // float32
                pub const m_angularAcceleration: usize = 0x7B0; // float32
                pub const m_flTorqueScale: usize = 0x7B4; // float32
                pub const m_flTargetSpeed: usize = 0x7B8; // float32
                pub const m_flSpeedWhenSpinUpOrSpinDownStarted: usize = 0x7BC; // float32
                pub const m_pFixedWorldBody: usize = 0x7C0; // IPhysicsBody*
                pub const m_pMotorJoint: usize = 0x7C8; // IPhysicsJoint*
                pub const m_motor: usize = 0x7D0; // CMotorController
            }
            // Parent: CBaseEntity
            // Fields count: 1
            ...
            pub mod CSplineConstraint {
                pub const m_vAnchorOffsetRestore: usize = 0x838; // Vector
                pub const m_hSplineEntity: usize = 0x844; // CHandle<CBaseEntity>
                pub const m_pSplineBody: usize = 0x848; // IPhysicsBody*
                pub const m_bEnableLateralConstraint: usize = 0x850; // bool
                pub const m_bEnableVerticalConstraint: usize = 0x851; // bool
                pub const m_bEnableAngularConstraint: usize = 0x852; // bool
                pub const m_bEnableLimit: usize = 0x853; // bool
                pub const m_bFireEventsOnPath: usize = 0x854; // bool
                pub const m_flLinearFrequency: usize = 0x858; // float32
                pub const m_flLinarDampingRatio: usize = 0x85C; // float32
                pub const m_flJointFriction: usize = 0x860; // float32
                pub const m_flTransitionTime: usize = 0x864; // float32
                pub const m_vPreSolveAnchorPos: usize = 0x880; // VectorWS
                pub const m_StartTransitionTime: usize = 0x88C; // GameTime_t
                pub const m_vTangentSpaceAnchorAtTransitionStart: usize = 0x890; // Vector
            }
            // Parent: CBaseEntity
            // Fields count: 6
            pub mod CLogicCompare {
                pub const m_flInValue: usize = 0x788; // float32
                pub const m_flCompareValue: usize = 0x78C; // float32
                pub const m_OnLessThan: usize = 0x790; // CEntityOutputTemplate<float32>
                pub const m_OnEqualTo: usize = 0x7B0; // CEntityOutputTemplate<float32>
            ...
            pub mod CMapVetoPickController {
                pub const m_bPlayedIntroVcd: usize = 0x788; // bool
                pub const m_bNeedToPlayFiveSecondsRemaining: usize = 0x789; // bool
                pub const m_dblPreMatchDraftSequenceTime: usize = 0x7A8; // float64
                pub const m_bPreMatchDraftStateChanged: usize = 0x7B0; // bool
                pub const m_nDraftType: usize = 0x7B4; // int32
                pub const m_nTeamWinningCoinToss: usize = 0x7B8; // int32
                pub const m_nTeamWithFirstChoice: usize = 0x7BC; // int32[64]
                pub const m_nVoteMapIdsList: usize = 0x8BC; // int32[7]
                pub const m_nAccountIDs: usize = 0x8D8; // int32[64]
                pub const m_nMapId0: usize = 0x9D8; // int32[64]
                pub const m_nMapId1: usize = 0xAD8; // int32[64]
                pub const m_nMapId2: usize = 0xBD8; // int32[64]
                pub const m_nMapId3: usize = 0xCD8; // int32[64]
                pub const m_nMapId4: usize = 0xDD8; // int32[64]
                pub const m_nMapId5: usize = 0xED8; // int32[64]
                pub const m_nStartingSide0: usize = 0xFD8; // int32[64]
                pub const m_nCurrentPhase: usize = 0x10D8; // int32
                pub const m_nPhaseStartTick: usize = 0x10DC; // int32
                pub const m_nPhaseDurationTicks: usize = 0x10E0; // int32
                pub const m_OnMapVetoed: usize = 0x10E8; // CEntityOutputTemplate<CUtlSymbolLarge>
                pub const m_OnMapPicked: usize = 0x1108; // CEntityOutputTemplate<CUtlSymbolLarge>
                pub const m_OnSidesPicked: usize = 0x1128; // CEntityOutputTemplate<int32>
            ...
            pub mod CPhysSlideConstraint {
                pub const m_axisEnd: usize = 0x7F0; // VectorWS
                pub const m_slideFriction: usize = 0x7FC; // float32
                pub const m_systemLoadScale: usize = 0x800; // float32
                pub const m_initialOffset: usize = 0x804; // float32
                pub const m_bEnableLinearConstraint: usize = 0x808; // bool
                pub const m_bEnableAngularConstraint: usize = 0x809; // bool
                pub const m_flMotorFrequency: usize = 0x80C; // float32
                pub const m_flMotorDampingRatio: usize = 0x810; // float32
                pub const m_bUseEntityPivot: usize = 0x814; // bool
                pub const m_soundInfo: usize = 0x818; // ConstraintSoundInfo
            }
            // Parent: CBaseEntity
            // Fields count: 2
            ...
            pub mod CPointGamestatsCounter {
                pub const m_strStatisticName: usize = 0x788; // CUtlSymbolLarge
            ...
            // Fields count: 8
            pub mod CPhysFixed {
                pub const m_flLinearFrequency: usize = 0x7E8; // float32
                pub const m_flLinearDampingRatio: usize = 0x7EC; // float32
                pub const m_flAngularFrequency: usize = 0x7F0; // float32
                pub const m_flAngularDampingRatio: usize = 0x7F4; // float32
                pub const m_bEnableLinearConstraint: usize = 0x7F8; // bool
                pub const m_bEnableAngularConstraint: usize = 0x7F9; // bool
                pub const m_sBoneName1: usize = 0x800; // CUtlSymbolLarge
                pub const m_sBoneName2: usize = 0x808; // CUtlSymbolLarge
            }
            // Parent: CBaseEntity
            // Fields count: 2
            pub mod CLogicNavigation {
                pub const m_isOn: usize = 0x790; // bool
                pub const m_navProperty: usize = 0x794; // navproperties_t
            }
            // Parent: CBaseEntity
            // Fields count: 3
            pub mod CPathSimple {
                pub const m_CPathQueryComponent: usize = 0x790; // CPathQueryComponent
            ...
            pub mod CPhysBallSocket {
                pub const m_flJointFriction: usize = 0x7E8; // float32
                pub const m_bEnableSwingLimit: usize = 0x7EC; // bool
                pub const m_flSwingLimit: usize = 0x7F0; // float32
                pub const m_bEnableTwistLimit: usize = 0x7F4; // bool
                pub const m_flMinTwistAngle: usize = 0x7F8; // float32
                pub const m_flMaxTwistAngle: usize = 0x7FC; // float32
            }
            // Parent: None
            // Fields count: 1
            pub mod CDebugHistory {
                pub const m_nNpcEvents: usize = 0x3E87C8; // int32
            }
            // Parent: CBaseEntity
            // Fields count: 11
            pub mod CSoundOpvarSetPointBase {
                pub const m_bDisabled: usize = 0x788; // bool
                pub const m_hSource: usize = 0x78C; // CEntityHandle
                pub const m_iszSourceEntityName: usize = 0x7A8; // CUtlSymbolLarge
                pub const m_vLastPosition: usize = 0x800; // VectorWS
                pub const m_flRefreshTime: usize = 0x80C; // float32
                pub const m_iszStackName: usize = 0x810; // CUtlSymbolLarge
                pub const m_iszOperatorName: usize = 0x818; // CUtlSymbolLarge
                pub const m_iszOpvarName: usize = 0x820; // CUtlSymbolLarge
                pub const m_iOpvarIndex: usize = 0x828; // int32
                pub const m_bUseAutoCompare: usize = 0x82C; // bool
                pub const m_bFastRefresh: usize = 0x82D; // bool
            }
            // Parent: None
            // Fields count: 5
            //
            ...
            pub mod CPathKeyFrame {
                pub const m_Origin: usize = 0x788; // Vector
                pub const m_Angles: usize = 0x794; // QAngle
                pub const m_qAngle: usize = 0x7A0; // Quaternion
                pub const m_iNextKey: usize = 0x7B0; // CUtlSymbolLarge
                pub const m_flNextTime: usize = 0x7B8; // float32
                pub const m_pNextKey: usize = 0x7BC; // CHandle<CPathKeyFrame>
                pub const m_pPrevKey: usize = 0x7C0; // CHandle<CPathKeyFrame>
            ...
            // Fields count: 4
            pub mod CBlood {
                pub const m_vecSprayAngles: usize = 0x788; // QAngle
                pub const m_vecSprayDir: usize = 0x794; // Vector
            ...
            pub mod CCSTeam {
                ...
                pub const m_nShorthandedRoundBonusStartRound: usize = 0x844; // int32
                pub const m_bSurrendered: usize = 0x848; // bool
                pub const m_szTeamMatchStat: usize = 0x849; // char[512]
                pub const m_numMapVictories: usize = 0xA4C; // int32
                pub const m_scoreFirstHalf: usize = 0xA50; // int32
                pub const m_scoreSecondHalf: usize = 0xA54; // int32
                pub const m_scoreOvertime: usize = 0xA58; // int32
                pub const m_szClanTeamname: usize = 0xA5C; // char[129]
                pub const m_iClanID: usize = 0xAE0; // uint32
                pub const m_szTeamFlagImage: usize = 0xAE4; // char[8]
                pub const m_szTeamLogoImage: usize = 0xAEC; // char[8]
                pub const m_flNextResourceTime: usize = 0xAF4; // float32
                pub const m_iLastUpdateSentAt: usize = 0xAF8; // int32
            }
            // Parent: CRuleEntity
            // Fields count: 1
            ...
            pub mod CEnvCubemapFog {
                pub const m_flEndDistance: usize = 0x788; // float32
                pub const m_flStartDistance: usize = 0x78C; // float32
                pub const m_flFogFalloffExponent: usize = 0x790; // float32
                pub const m_bHeightFogEnabled: usize = 0x794; // bool
                pub const m_flFogHeightWidth: usize = 0x798; // float32
                pub const m_flFogHeightEnd: usize = 0x79C; // float32
                pub const m_flFogHeightStart: usize = 0x7A0; // float32
                pub const m_flFogHeightExponent: usize = 0x7A4; // float32
                pub const m_flLODBias: usize = 0x7A8; // float32
                pub const m_bActive: usize = 0x7AC; // bool
                pub const m_bStartDisabled: usize = 0x7AD; // bool
                pub const m_flFogMaxOpacity: usize = 0x7B0; // float32
                pub const m_nCubemapSourceType: usize = 0x7B4; // int32
                pub const m_hSkyMaterial: usize = 0x7B8; // CStrongHandle<InfoForResourceTypeIMaterial2>
                pub const m_iszSkyEntity: usize = 0x7C0; // CUtlSymbolLarge
                pub const m_nHeightFogType: usize = 0x7C8; // int32
                pub const m_nFogHeightBlendMode: usize = 0x7CC; // int32
                pub const m_nFogHeightCoordinateSpace: usize = 0x7D0; // int32
                pub const m_nDistanceFogType: usize = 0x7D4; // int32
                pub const m_DistanceFogCurveString: usize = 0x7D8; // CUtlSymbolLarge
                pub const m_HeightFogCurveString: usize = 0x7E0; // CUtlSymbolLarge
                pub const m_hFogCubemapTexture: usize = 0x878; // CStrongHandle<InfoForResourceTypeCTextureBase>
                pub const m_bHasHeightFogEnd: usize = 0x880; // bool
            ...
            pub mod CSceneListManager {
                pub const m_hListManagers: usize = 0x788; // CUtlVector<CHandle<CSceneListManager>>
                pub const m_iszScenes: usize = 0x7A0; // CUtlSymbolLarge[16]
                pub const m_hScenes: usize = 0x820; // CHandle<CBaseEntity>[16]
            }
            // Parent: CPointEntity
            // Fields count: 4
            pub mod CEnvTilt {
                pub const m_Duration: usize = 0x788; // float32
                pub const m_Radius: usize = 0x78C; // float32
                pub const m_TiltTime: usize = 0x790; // float32
                pub const m_stopTime: usize = 0x794; // GameTime_t
            }
            // Parent: None
            // Fields count: 0
            ...
            pub mod CPhysWheelConstraint {
                pub const m_flSuspensionFrequency: usize = 0x7E8; // float32
                pub const m_flSuspensionDampingRatio: usize = 0x7EC; // float32
                pub const m_flSuspensionHeightOffset: usize = 0x7F0; // float32
                pub const m_bEnableSuspensionLimit: usize = 0x7F4; // bool
                pub const m_flMinSuspensionOffset: usize = 0x7F8; // float32
                pub const m_flMaxSuspensionOffset: usize = 0x7FC; // float32
                pub const m_bEnableSteeringLimit: usize = 0x800; // bool
                pub const m_flMinSteeringAngle: usize = 0x804; // float32
                pub const m_flMaxSteeringAngle: usize = 0x808; // float32
                pub const m_flSteeringAxisFriction: usize = 0x80C; // float32
                pub const m_flSpinAxisFriction: usize = 0x810; // float32
                pub const m_hSteeringMimicsEntity: usize = 0x814; // CHandle<CBaseEntity>
            }
            // Parent: CBaseEntity
            // Fields count: 2
            pub mod CSkyboxReference {
                pub const m_worldGroupId: usize = 0x788; // WorldGroupId_t
                pub const m_hSkyCamera: usize = 0x78C; // CHandle<CSkyCamera>
            }
            // Parent: None
            // Fields count: 0
            pub mod CPointPulse {
            ...
            pub mod CColorCorrection {
                pub const m_flFadeInDuration: usize = 0x788; // float32
                pub const m_flFadeOutDuration: usize = 0x78C; // float32
                pub const m_flStartFadeInWeight: usize = 0x790; // float32
                pub const m_flStartFadeOutWeight: usize = 0x794; // float32
                pub const m_flTimeStartFadeIn: usize = 0x798; // GameTime_t
                pub const m_flTimeStartFadeOut: usize = 0x79C; // GameTime_t
                pub const m_flMaxWeight: usize = 0x7A0; // float32
                pub const m_bStartDisabled: usize = 0x7A4; // bool
                pub const m_bEnabled: usize = 0x7A5; // bool
                pub const m_bMaster: usize = 0x7A6; // bool
                pub const m_bClientSide: usize = 0x7A7; // bool
                pub const m_bExclusive: usize = 0x7A8; // bool
                pub const m_MinFalloff: usize = 0x7AC; // float32
                pub const m_MaxFalloff: usize = 0x7B0; // float32
                pub const m_flCurWeight: usize = 0x7B4; // float32
                pub const m_netlookupFilename: usize = 0x7B8; // char[512]
                pub const m_lookupFilename: usize = 0x9B8; // CUtlSymbolLarge
            }
            ...
            // Fields count: 3
            pub mod CBaseFilter {
                pub const m_bNegated: usize = 0x788; // bool
                pub const m_OnPass: usize = 0x790; // CEntityIOOutput
                pub const m_OnFail: usize = 0x7A8; // CEntityIOOutput
            }
            // Parent: None
            // Fields count: 1
            ...
            // Fields count: 15
            pub mod CMapInfo {
                pub const m_iBuyingStatus: usize = 0x788; // int32
                pub const m_flBombRadius: usize = 0x78C; // float32
                pub const m_iPetPopulation: usize = 0x790; // int32
                pub const m_bUseNormalSpawnsForDM: usize = 0x794; // bool
                pub const m_bDisableAutoGeneratedDMSpawns: usize = 0x795; // bool
                pub const m_flBotMaxVisionDistance: usize = 0x798; // float32
                pub const m_iHostageCount: usize = 0x79C; // int32
                pub const m_bFadePlayerVisibilityFarZ: usize = 0x7A0; // bool
                pub const m_bRainTraceToSkyEnabled: usize = 0x7A1; // bool
                pub const m_bGPUCullSkybox: usize = 0x7A2; // bool
                pub const m_flEnvRainStrength: usize = 0x7A4; // float32
                pub const m_flEnvPuddleRippleStrength: usize = 0x7A8; // float32
                pub const m_flEnvPuddleRippleDirection: usize = 0x7AC; // float32
                pub const m_flEnvWetnessCoverage: usize = 0x7B0; // float32
                pub const m_flEnvWetnessDryingAmount: usize = 0x7B4; // float32
            }
            // Parent: CBaseEntity
            // Fields count: 16
            pub mod CGradientFog {
                pub const m_hGradientFogTexture: usize = 0x788; // CStrongHandle<InfoForResourceTypeCTextureBase>
                pub const m_flFogStartDistance: usize = 0x790; // float32
                pub const m_flFogEndDistance: usize = 0x794; // float32
                pub const m_bHeightFogEnabled: usize = 0x798; // bool
                pub const m_flFogStartHeight: usize = 0x79C; // float32
                pub const m_flFogEndHeight: usize = 0x7A0; // float32
                pub const m_flFarZ: usize = 0x7A4; // float32
                pub const m_flFogMaxOpacity: usize = 0x7A8; // float32
                pub const m_flFogFalloffExponent: usize = 0x7AC; // float32
                pub const m_flFogVerticalExponent: usize = 0x7B0; // float32
                pub const m_fogColor: usize = 0x7B4; // Color
                pub const m_flFogStrength: usize = 0x7B8; // float32
                pub const m_flFadeTime: usize = 0x7BC; // float32
                pub const m_bStartDisabled: usize = 0x7C0; // bool
                pub const m_bIsEnabled: usize = 0x7C1; // bool
                pub const m_bGradientFogNeedsTextures: usize = 0x7C2; // bool
            }
            // Parent: None
            // Fields count: 0
            ...
            pub mod CSoundEventEntity {
                pub const m_bStartOnSpawn: usize = 0x788; // bool
                pub const m_bToLocalPlayer: usize = 0x789; // bool
                pub const m_bStopOnNew: usize = 0x78A; // bool
                pub const m_bSaveRestore: usize = 0x78B; // bool
                pub const m_bSavedIsPlaying: usize = 0x78C; // bool
                pub const m_flSavedElapsedTime: usize = 0x790; // float32
                pub const m_iszSourceEntityName: usize = 0x798; // CUtlSymbolLarge
                pub const m_iszAttachmentName: usize = 0x7A0; // CUtlSymbolLarge
                pub const m_onGUIDChanged: usize = 0x7A8; // CEntityOutputTemplate<SndOpEventGuid_t>
                pub const m_onSoundFinished: usize = 0x7D8; // CEntityIOOutput
                pub const m_flClientCullRadius: usize = 0x7F0; // float32
                pub const m_iszSoundName: usize = 0x820; // CUtlSymbolLarge
            ...
            // Fields count: 4
            pub mod CEnvFade {
                pub const m_fadeColor: usize = 0x788; // Color
                pub const m_Duration: usize = 0x78C; // float32
                pub const m_HoldDuration: usize = 0x790; // float32
                pub const m_OnBeginFade: usize = 0x798; // CEntityIOOutput
            }
            // Parent: None
            // Fields count: 15
            //
            ...
            pub mod CLogicBranchList {
                pub const m_nLogicBranchNames: usize = 0x788; // CUtlSymbolLarge[16]
                pub const m_LogicBranchList: usize = 0x808; // CUtlVector<CHandle<CBaseEntity>>
                pub const m_eLastState: usize = 0x820; // CLogicBranchList::LogicBranchListenerLastState_t
                pub const m_OnAllTrue: usize = 0x828; // CEntityIOOutput
                pub const m_OnAllFalse: usize = 0x840; // CEntityIOOutput
                pub const m_OnMixed: usize = 0x858; // CEntityIOOutput
            }
            // Parent: None
            // Fields count: 1
            ...
            pub mod CFuncTimescale {
                pub const m_flDesiredTimescale: usize = 0x788; // float32
                pub const m_flAcceleration: usize = 0x78C; // float32
            ...
            pub mod CSoundOpvarSetPointEntity {
                pub const m_OnEnter: usize = 0x830; // CEntityIOOutput
                pub const m_OnExit: usize = 0x848; // CEntityIOOutput
                pub const m_bAutoDisable: usize = 0x860; // bool
                pub const m_flDistanceMin: usize = 0x8A4; // float32
                pub const m_flDistanceMax: usize = 0x8A8; // float32
                pub const m_flDistanceMapMin: usize = 0x8AC; // float32
                pub const m_flDistanceMapMax: usize = 0x8B0; // float32
                pub const m_flOcclusionRadius: usize = 0x8B4; // float32
                pub const m_flOcclusionMin: usize = 0x8B8; // float32
                pub const m_flOcclusionMax: usize = 0x8BC; // float32
                pub const m_flValSetOnDisable: usize = 0x8C0; // float32
                pub const m_bSetValueOnDisable: usize = 0x8C4; // bool
                pub const m_bReloading: usize = 0x8C5; // bool
                pub const m_nSimulationMode: usize = 0x8C8; // int32
                pub const m_nVisibilitySamples: usize = 0x8CC; // int32
                pub const m_vDynamicProxyPoint: usize = 0x8D0; // Vector
                pub const m_flDynamicMaximumOcclusion: usize = 0x8DC; // float32
                pub const m_hDynamicEntity: usize = 0x8E0; // CEntityHandle
                pub const m_iszDynamicEntityName: usize = 0x8E8; // CUtlSymbolLarge
                pub const m_flPathingDistanceNormFactor: usize = 0x8F0; // float32
                pub const m_vPathingSourcePos: usize = 0x8F4; // VectorWS
                pub const m_vPathingListenerPos: usize = 0x900; // VectorWS
                pub const m_vPathingDirection: usize = 0x90C; // Vector
            ...
            // Fields count: 18
            pub mod CEnvCubemap {
                pub const m_Entity_hCubemapTexture: usize = 0x808; // CStrongHandle<InfoForResourceTypeCTextureBase>
                pub const m_Entity_bCustomCubemapTexture: usize = 0x810; // bool
                pub const m_Entity_flInfluenceRadius: usize = 0x814; // float32
                pub const m_Entity_vBoxProjectMins: usize = 0x818; // Vector
                pub const m_Entity_vBoxProjectMaxs: usize = 0x824; // Vector
                pub const m_Entity_bMoveable: usize = 0x830; // bool
                pub const m_Entity_nHandshake: usize = 0x834; // int32
                pub const m_Entity_nEnvCubeMapArrayIndex: usize = 0x838; // int32
                pub const m_Entity_nPriority: usize = 0x83C; // int32
                pub const m_Entity_flEdgeFadeDist: usize = 0x840; // float32
                pub const m_Entity_vEdgeFadeDists: usize = 0x844; // Vector
                pub const m_Entity_flDiffuseScale: usize = 0x850; // float32
                pub const m_Entity_bStartDisabled: usize = 0x854; // bool
                pub const m_Entity_bDefaultEnvMap: usize = 0x855; // bool
                pub const m_Entity_bDefaultSpecEnvMap: usize = 0x856; // bool
                pub const m_Entity_bIndoorCubeMap: usize = 0x857; // bool
            ...
            // Fields count: 6
            pub mod CPointHurt {
                pub const m_nDamage: usize = 0x788; // int32
                pub const m_bitsDamageType: usize = 0x78C; // DamageTypes_t
                pub const m_flRadius: usize = 0x790; // float32
                pub const m_flDelay: usize = 0x794; // float32
            ...
            pub mod CBasePlayerController {
                pub const m_nInButtonsWhichAreToggles: usize = 0x790; // uint64
            ...
            pub mod CNmAimCSNode__CDefinition {
                ...
                pub const m_nWeaponActionNodeIdx: usize = 0x14; // int16
                pub const m_nWeaponDropNodeIdx: usize = 0x16; // int16
                pub const m_nIsDefusingNodeIdx: usize = 0x18; // int16
                pub const m_nCrouchWeightNodeIdx: usize = 0x1A; // int16
                pub const m_flHandIKBlendInTimeSeconds: usize = 0x1C; // float32
                pub const m_flActionBlendTimeSeconds: usize = 0x20; // float32
                pub const m_flPlantingBlendTimeSeconds: usize = 0x24; // float32
            }
            // Parent: None
            // Fields count: 4
            //
            ...
            pub mod CNavPathCost {
                pub const m_bAllowLadders: usize = 0xC; // bool
                pub const m_bCanFly: usize = 0xD; // bool
                pub const m_bCanSwim: usize = 0xE; // bool
                pub const m_flWaterToGroundMaxHeight: usize = 0x10; // float32
                pub const m_flGroundToWaterMaxHeight: usize = 0x14; // float32
                pub const m_flGroundToWaterTransitionDistance: usize = 0x18; // float32
                pub const m_flWaterToGroundTransitionDistance: usize = 0x1C; // float32
                pub const m_flFlyingTransitionTolerance: usize = 0x20; // float32
                pub const m_bOptimizeFlySpacePathfinds: usize = 0x24; // bool
                pub const m_bStringPullFlySpacePathfinds: usize = 0x25; // bool
                pub const m_bSupportsTransitions: usize = 0x26; // bool
                pub const m_flTransitionPenalty: usize = 0x28; // float32
            }
            // Parent: None
            // Fields count: 3
            //
            ...
            pub mod CNmSnapWeaponNode__CDefinition {
                pub const m_nFlashedAmountNodeIdx: usize = 0xC; // int16
                pub const m_nWeaponCategoryNodeIdx: usize = 0xE; // int16
                pub const m_nWeaponTypeNodeIdx: usize = 0x10; // int16
            }
            // Parent: None
            // Fields count: 3
            //
            ...
            pub mod CNavVolumeBreadthFirstSearch {
                pub const m_vStartPos: usize = 0x88; // VectorWS
            ...
            pub mod CCSPlayerAnimationState {
                pub const m_currentMoveType: usize = 0x10; // CCSPlayerAnimationState::MoveType_t
                pub const m_groundMoveState: usize = 0x11; // CCSPlayerAnimationState::GroundMoveState_t
                pub const m_groundActionDirection: usize = 0x12; // CCSPlayerAnimationState::Direction_t
                pub const m_airAction: usize = 0x13; // CCSPlayerAnimationState::AirAction_t
                pub const m_bWasOnGroundLastUpdate: usize = 0x14; // bool
                pub const m_bWasStationaryLastUpdate: usize = 0x15; // bool
                pub const m_actionStartTick: usize = 0x18; // GameTick_t
                pub const m_staticAimTimerStartTick: usize = 0x1C; // GameTick_t
                pub const m_plantAndTurnStartTick: usize = 0x20; // GameTick_t
                pub const m_flTurnOnSpotAngle: usize = 0x24; // float32
                pub const m_flPreviousAimYaw: usize = 0x28; // float32
                pub const m_flPreviousHorizontalSpeed: usize = 0x2C; // float32
                pub const m_flFootIKOffsetLeft: usize = 0x30; // float32
                pub const m_flFootIKOffsetRight: usize = 0x34; // float32
                pub const m_flWeaponDropPercentageDueToMovement: usize = 0x38; // float32
                pub const m_flWeaponDropSmoothDampVelocity: usize = 0x3C; // float32
            }
            // Parent: None
            // Fields count: 6
            //
            ...
            pub mod CNavVolumeSphere {
                pub const m_vCenter: usize = 0x58; // VectorWS
