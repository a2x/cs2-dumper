    ...
    pub mod schemas {
        ...
        pub mod libserver_so {
            ...
            pub mod CTriggerSoundscape {
                pub const m_hSoundscape: usize = 0xBC4; // CHandle<CEnvSoundscapeTriggerable>
                pub const m_SoundscapeName: usize = 0xBC8; // CUtlSymbolLarge
                pub const m_spectators: usize = 0xBD0; // CUtlVector<CHandle<CBasePlayerPawn>>
            }
            ...
            pub mod CDynamicProp {
                pub const m_bCreateNavObstacle: usize = 0xD90; // bool
                pub const m_bUseHitboxesForRenderBox: usize = 0xD91; // bool
                pub const m_bUseAnimGraph: usize = 0xD92; // bool
                pub const m_pOutputAnimBegun: usize = 0xD98; // CEntityIOOutput
                pub const m_pOutputAnimOver: usize = 0xDC0; // CEntityIOOutput
                pub const m_pOutputAnimLoopCycleOver: usize = 0xDE8; // CEntityIOOutput
                pub const m_OnAnimReachedStart: usize = 0xE10; // CEntityIOOutput
                pub const m_OnAnimReachedEnd: usize = 0xE38; // CEntityIOOutput
                pub const m_iszIdleAnim: usize = 0xE60; // CUtlSymbolLarge
                pub const m_nIdleAnimLoopMode: usize = 0xE68; // AnimLoopMode_t
                pub const m_bRandomizeCycle: usize = 0xE6C; // bool
                pub const m_bStartDisabled: usize = 0xE6D; // bool
                pub const m_bFiredStartEndOutput: usize = 0xE6E; // bool
                pub const m_bForceNpcExclude: usize = 0xE6F; // bool
                pub const m_bCreateNonSolid: usize = 0xE70; // bool
                pub const m_bIsOverrideProp: usize = 0xE71; // bool
                pub const m_iInitialGlowState: usize = 0xE74; // int32
                pub const m_nGlowRange: usize = 0xE78; // int32
                pub const m_nGlowRangeMin: usize = 0xE7C; // int32
                pub const m_glowColor: usize = 0xE80; // Color
                pub const m_nGlowTeam: usize = 0xE84; // int32
            }
            ...
            pub mod CTriggerRemove {
                pub const m_OnRemove: usize = 0xBC8; // CEntityIOOutput
            }
            // Parent: CBaseFilter
            // Fields count: 1
            pub mod CFilterName {
                pub const m_iFilterName: usize = 0x7F8; // CUtlSymbolLarge
            }
            // Parent: CPointEntity
            // Fields count: 2
            pub mod CProjectedDecal {
                pub const m_nTexture: usize = 0x7A4; // int32
                pub const m_flDistance: usize = 0x7A8; // float32
            }
            ...
            pub mod CTriggerMultiple {
                pub const m_OnTrigger: usize = 0xBC8; // CEntityIOOutput
            }
            ...
            pub mod CTriggerPush {
                pub const m_angPushEntitySpace: usize = 0xBC4; // QAngle
                pub const m_vecPushDirEntitySpace: usize = 0xBD0; // Vector
                pub const m_bTriggerOnStartTouch: usize = 0xBDC; // bool
                pub const m_bUsePathSimple: usize = 0xBDD; // bool
                pub const m_iszPathSimpleName: usize = 0xBE0; // CUtlSymbolLarge
                pub const m_PathSimple: usize = 0xBE8; // CPathSimple*
                pub const m_splinePushType: usize = 0xBF0; // uint32
            }
            // Parent: CBaseFilter
            // Fields count: 3
            pub mod FilterHealth {
                pub const m_bAdrenalineActive: usize = 0x7F8; // bool
                pub const m_iHealthMin: usize = 0x7FC; // int32
                pub const m_iHealthMax: usize = 0x800; // int32
            }
            ...
            pub mod CTriggerProximity {
                pub const m_hMeasureTarget: usize = 0xBC4; // CHandle<CBaseEntity>
                pub const m_iszMeasureTarget: usize = 0xBC8; // CUtlSymbolLarge
                pub const m_fRadius: usize = 0xBD0; // float32
                pub const m_nTouchers: usize = 0xBD4; // int32
                pub const m_NearestEntityDistance: usize = 0xBD8; // CEntityOutputTemplate<float32>
            }
            // Parent: CFuncBrush
            // Fields count: 4
            //
            ...
            pub mod CTriggerBrush {
                ...
                pub const m_iInputFilter: usize = 0xA70; // int32
                pub const m_iDontMessageParent: usize = 0xA74; // int32
            }
            // Parent: CBeam
            // Fields count: 19
            pub mod CEnvBeam {
                pub const m_active: usize = 0xA98; // int32
                ...
                pub const m_life: usize = 0xAB8; // float32
                pub const m_boltWidth: usize = 0xABC; // float32
                pub const m_noiseAmplitude: usize = 0xAC0; // float32
                pub const m_speed: usize = 0xAC4; // int32
                pub const m_restrike: usize = 0xAC8; // float32
                pub const m_iszSpriteName: usize = 0xAD0; // CUtlSymbolLarge
                pub const m_frameStart: usize = 0xAD8; // int32
                pub const m_vEndPointWorld: usize = 0xADC; // Vector
                pub const m_vEndPointRelative: usize = 0xAE8; // Vector
                pub const m_radius: usize = 0xAF4; // float32
            ...
            pub mod CTonemapTrigger {
                pub const m_tonemapControllerName: usize = 0xBC8; // CUtlSymbolLarge
                pub const m_hTonemapController: usize = 0xBD0; // CEntityHandle
            }
            // Parent: None
            // Fields count: 5
            //
            ...
            // Fields count: 1
            pub mod CFogTrigger {
                pub const m_fog: usize = 0xBC8; // fogparams_t
            }
            ...
            pub mod CLogicCollisionPair {
                ...
                pub const m_supportMultipleEntitiesWithSameName: usize = 0x7B8; // bool
                pub const m_disabled: usize = 0x7B9; // bool
                pub const m_succeeded: usize = 0x7BA; // bool
            }
            // Parent: None
            // Fields count: 0
            //
            ...
            pub mod CPointTeleport {
                pub const m_vSaveOrigin: usize = 0x7A4; // Vector
                pub const m_vSaveAngles: usize = 0x7B0; // QAngle
                pub const m_bTeleportParentedEntities: usize = 0x7BC; // bool
                pub const m_bTeleportUseCurrentAngle: usize = 0x7BD; // bool
            }
            // Parent: CPointEntity
            // Fields count: 0
            ...
            pub mod CTriggerBuoyancy {
                pub const m_BuoyancyHelper: usize = 0xBC8; // CBuoyancyHelper
                pub const m_flFluidDensity: usize = 0xBE8; // float32
            }
            // Parent: CPointEntity
            // Fields count: 5
            pub mod CMoverPathNode {
                pub const m_vInTangentLocal: usize = 0x7A4; // Vector
                pub const m_vOutTangentLocal: usize = 0x7B0; // Vector
                pub const m_szParentPathUniqueID: usize = 0x7C0; // CUtlSymbolLarge
                pub const m_OnPassThrough: usize = 0x7C8; // CEntityIOOutput
                pub const m_hMover: usize = 0x7F0; // CHandle<CPathMover>
            }
            // Parent: CBtNode
            // Fields count: 12
            ...
            pub mod CDecoyProjectile {
                pub const m_nDecoyShotTick: usize = 0xD98; // int32
                pub const m_shotsRemaining: usize = 0xD9C; // int32
                pub const m_fExpireTime: usize = 0xDA0; // GameTime_t
                pub const m_decoyWeaponDefIndex: usize = 0xDB0; // uint16
            }
            // Parent: CBaseEntity
            // Fields count: 0
            ...
            pub mod CPlayerPing {
                pub const m_hPlayer: usize = 0x7AC; // CHandle<CCSPlayerPawn>
                pub const m_hPingedEntity: usize = 0x7B0; // CHandle<CBaseEntity>
                pub const m_iType: usize = 0x7B4; // int32
                pub const m_bUrgent: usize = 0x7B8; // bool
                pub const m_szPlaceName: usize = 0x7B9; // char[18]
            }
            ...
            pub mod CEnvFireSensor {
                ...
                pub const m_bHeatAtLevel: usize = 0x7A5; // bool
                pub const m_radius: usize = 0x7A8; // float32
                pub const m_targetLevel: usize = 0x7AC; // float32
                pub const m_targetTime: usize = 0x7B0; // float32
                pub const m_levelTime: usize = 0x7B4; // float32
                pub const m_OnHeatLevelStart: usize = 0x7B8; // CEntityIOOutput
                pub const m_OnHeatLevelEnd: usize = 0x7E0; // CEntityIOOutput
            }
            // Parent: CCSGO_WingmanIntroCharacterPosition
            // Fields count: 0
            ...
            pub mod CEnvShake {
                ...
                pub const m_Amplitude: usize = 0x7B0; // float32
                pub const m_Frequency: usize = 0x7B4; // float32
                pub const m_Duration: usize = 0x7B8; // float32
                ...
                pub const m_currentAmp: usize = 0x7C8; // float32
            ...
            pub mod CBaseMoveBehavior {
                pub const m_iPositionInterpolator: usize = 0x7F4; // int32
                pub const m_iRotationInterpolator: usize = 0x7F8; // int32
                pub const m_flAnimStartTime: usize = 0x7FC; // float32
                pub const m_flAnimEndTime: usize = 0x800; // float32
                pub const m_flAverageSpeedAcrossFrame: usize = 0x804; // float32
                ...
                pub const m_flTimeIntoFrame: usize = 0x828; // float32
                pub const m_iDirection: usize = 0x82C; // int32
            }
            // Parent: CBaseModelEntity
            // Fields count: 1
            ...
            // Fields count: 4
            pub mod CEnvTilt {
                pub const m_Duration: usize = 0x7A4; // float32
                pub const m_Radius: usize = 0x7A8; // float32
                pub const m_TiltTime: usize = 0x7AC; // float32
                pub const m_stopTime: usize = 0x7B0; // GameTime_t
            }
            // Parent: CCSWeaponBase
            // Fields count: 14
            //
            ...
            pub mod CLogicCase {
                ...
                pub const m_nShuffleCases: usize = 0x8A8; // int32
                pub const m_nLastShuffleCase: usize = 0x8AC; // int32
                pub const m_uchShuffleCaseMap: usize = 0x8B0; // uint8[32]
            ...
            pub mod CSoundEventEntity {
                pub const m_bStartOnSpawn: usize = 0x7A4; // bool
                pub const m_bToLocalPlayer: usize = 0x7A5; // bool
                pub const m_bStopOnNew: usize = 0x7A6; // bool
                pub const m_bSaveRestore: usize = 0x7A7; // bool
                pub const m_bSavedIsPlaying: usize = 0x7A8; // bool
                pub const m_flSavedElapsedTime: usize = 0x7AC; // float32
                pub const m_iszSourceEntityName: usize = 0x7B0; // CUtlSymbolLarge
                pub const m_iszAttachmentName: usize = 0x7B8; // CUtlSymbolLarge
                pub const m_onGUIDChanged: usize = 0x7C0; // CEntityOutputTemplate<uint64>
                pub const m_onSoundFinished: usize = 0x7E8; // CEntityIOOutput
                pub const m_iszSoundName: usize = 0x838; // CUtlSymbolLarge
                pub const m_hSource: usize = 0x848; // CEntityHandle
                pub const m_nEntityIndexSelection: usize = 0x84C; // int32
            }
            ...
            pub mod CWeaponBaseItem {
                pub const m_SequenceCompleteTimer: usize = 0x11A0; // CountdownTimer
                pub const m_bRedraw: usize = 0x11B8; // bool
            }
            // Parent: CPointEntity
            // Fields count: 0
            ...
            pub mod CEnvVolumetricFogController {
                pub const m_flScattering: usize = 0x7A4; // float32
                pub const m_flAnisotropy: usize = 0x7A8; // float32
                pub const m_flFadeSpeed: usize = 0x7AC; // float32
                pub const m_flDrawDistance: usize = 0x7B0; // float32
                pub const m_flFadeInStart: usize = 0x7B4; // float32
                pub const m_flFadeInEnd: usize = 0x7B8; // float32
                pub const m_flIndirectStrength: usize = 0x7BC; // float32
                pub const m_nIndirectTextureDimX: usize = 0x7C0; // int32
                pub const m_nIndirectTextureDimY: usize = 0x7C4; // int32
                pub const m_nIndirectTextureDimZ: usize = 0x7C8; // int32
                pub const m_vBoxMins: usize = 0x7CC; // Vector
                pub const m_vBoxMaxs: usize = 0x7D8; // Vector
                pub const m_bActive: usize = 0x7E4; // bool
                pub const m_flStartAnisoTime: usize = 0x7E8; // GameTime_t
                pub const m_flStartScatterTime: usize = 0x7EC; // GameTime_t
                pub const m_flStartDrawDistanceTime: usize = 0x7F0; // GameTime_t
                pub const m_flStartAnisotropy: usize = 0x7F4; // float32
                pub const m_flStartScattering: usize = 0x7F8; // float32
                pub const m_flStartDrawDistance: usize = 0x7FC; // float32
                pub const m_flDefaultAnisotropy: usize = 0x800; // float32
                pub const m_flDefaultScattering: usize = 0x804; // float32
                pub const m_flDefaultDrawDistance: usize = 0x808; // float32
                pub const m_bStartDisabled: usize = 0x80C; // bool
                pub const m_bEnableIndirect: usize = 0x80D; // bool
                pub const m_bIndirectUseLPVs: usize = 0x80E; // bool
                pub const m_bIsMaster: usize = 0x80F; // bool
                pub const m_hFogIndirectTexture: usize = 0x810; // CStrongHandle<InfoForResourceTypeCTextureBase>
                pub const m_nForceRefreshCount: usize = 0x818; // int32
                pub const m_fNoiseSpeed: usize = 0x81C; // float32
                pub const m_fNoiseStrength: usize = 0x820; // float32
                pub const m_vNoiseScale: usize = 0x824; // Vector
                pub const m_bFirstTime: usize = 0x830; // bool
            }
            // Parent: CPlayer_MovementServices
            // Fields count: 14
            //
            ...
            pub mod CPhysicsPropRespawnable {
                pub const m_vOriginalSpawnOrigin: usize = 0xEF0; // Vector
                pub const m_vOriginalSpawnAngles: usize = 0xEFC; // QAngle
                pub const m_vOriginalMins: usize = 0xF08; // Vector
                pub const m_vOriginalMaxs: usize = 0xF14; // Vector
                pub const m_flRespawnDuration: usize = 0xF20; // float32
            }
            ...
            pub mod CPhysBallSocket {
                pub const m_flJointFriction: usize = 0x820; // float32
                pub const m_bEnableSwingLimit: usize = 0x824; // bool
                pub const m_flSwingLimit: usize = 0x828; // float32
                pub const m_bEnableTwistLimit: usize = 0x82C; // bool
                pub const m_flMinTwistAngle: usize = 0x830; // float32
                pub const m_flMaxTwistAngle: usize = 0x834; // float32
            }
            ...
            pub mod CInfoPlayerStart {
                pub const m_bDisabled: usize = 0x7A4; // bool
            }
            ...
            pub mod CRagdollPropAttached {
                pub const m_boneIndexAttached: usize = 0xD90; // uint32
                pub const m_ragdollAttachedObjectIndex: usize = 0xD94; // uint32
                pub const m_attachmentPointBoneSpace: usize = 0xD98; // Vector
                pub const m_attachmentPointRagdollSpace: usize = 0xDA4; // Vector
                pub const m_bShouldDetach: usize = 0xDB0; // bool
                pub const m_bShouldDeleteAttachedActivationRecord: usize = 0xDC0; // bool
            }
            // Parent: CItem
            // Fields count: 2
            //
            ...
            pub mod CItemGeneric {
                ...
                pub const m_flPickupRadiusSqr: usize = 0xCD4; // float32
                pub const m_flTriggerRadiusSqr: usize = 0xCD8; // float32
                ...
                pub const m_flPickupRadius: usize = 0xE18; // float32
                pub const m_flTriggerRadius: usize = 0xE1C; // float32
            ...
            pub mod CSkyboxReference {
                pub const m_worldGroupId: usize = 0x7A4; // WorldGroupId_t
                pub const m_hSkyCamera: usize = 0x7A8; // CHandle<CSkyCamera>
            }
            // Parent: CBasePropDoor
            // Fields count: 17
            pub mod CPropDoorRotating {
                pub const m_vecAxis: usize = 0x1110; // Vector
                pub const m_flDistance: usize = 0x111C; // float32
                pub const m_eSpawnPosition: usize = 0x1120; // PropDoorRotatingSpawnPos_t
                pub const m_eOpenDirection: usize = 0x1124; // PropDoorRotatingOpenDirection_e
                pub const m_eCurrentOpenDirection: usize = 0x1128; // PropDoorRotatingOpenDirection_e
                pub const m_flAjarAngle: usize = 0x112C; // float32
                pub const m_angRotationAjarDeprecated: usize = 0x1130; // QAngle
                pub const m_angRotationClosed: usize = 0x113C; // QAngle
                pub const m_angRotationOpenForward: usize = 0x1148; // QAngle
                pub const m_angRotationOpenBack: usize = 0x1154; // QAngle
                pub const m_angGoal: usize = 0x1160; // QAngle
                pub const m_vecForwardBoundsMin: usize = 0x116C; // Vector
                pub const m_vecForwardBoundsMax: usize = 0x1178; // Vector
                pub const m_vecBackBoundsMin: usize = 0x1184; // Vector
                pub const m_vecBackBoundsMax: usize = 0x1190; // Vector
                pub const m_bAjarDoorShouldntAlwaysOpen: usize = 0x119C; // bool
                pub const m_hEntityBlocker: usize = 0x11A0; // CHandle<CEntityBlocker>
            }
            // Parent: CBaseModelEntity
            // Fields count: 21
            //
            ...
            pub mod CEnvViewPunch {
                ...
                pub const m_angViewPunch: usize = 0x7A8; // QAngle
            }
            // Parent: CCSWeaponBaseGun
            // Fields count: 0
            pub mod CDEagle {
            ...
            // Fields count: 3
            pub mod CPathCorner {
                pub const m_flWait: usize = 0x7A4; // float32
            ...
            pub mod CMultiSource {
                pub const m_rgEntities: usize = 0x7A4; // CHandle<CBaseEntity>[32]
                pub const m_rgTriggered: usize = 0x824; // int32[32]
                pub const m_OnTrigger: usize = 0x8A8; // CEntityIOOutput
                pub const m_iTotal: usize = 0x8D0; // int32
            ...
            pub mod CEnvEntityMaker {
                pub const m_vecEntityMins: usize = 0x7A4; // Vector
                pub const m_vecEntityMaxs: usize = 0x7B0; // Vector
                pub const m_hCurrentInstance: usize = 0x7BC; // CHandle<CBaseEntity>
                pub const m_hCurrentBlocker: usize = 0x7C0; // CHandle<CBaseEntity>
                pub const m_vecBlockerOrigin: usize = 0x7C4; // Vector
                pub const m_angPostSpawnDirection: usize = 0x7D0; // QAngle
                pub const m_flPostSpawnDirectionVariance: usize = 0x7DC; // float32
                pub const m_flPostSpawnSpeed: usize = 0x7E0; // float32
                pub const m_bPostSpawnUseAngles: usize = 0x7E4; // bool
                pub const m_iszTemplate: usize = 0x7E8; // CUtlSymbolLarge
                pub const m_pOutputOnSpawned: usize = 0x7F0; // CEntityIOOutput
                pub const m_pOutputOnFailedSpawn: usize = 0x818; // CEntityIOOutput
            }
            // Parent: CBaseEntity
            // Fields count: 0
            ...
            pub mod CLogicEventListener {
                ...
                pub const m_nTeam: usize = 0x7C4; // int32
                pub const m_OnEventFired: usize = 0x7C8; // CEntityIOOutput
            }
            // Parent: CBaseFilter
            // Fields count: 4
            pub mod CFilterMultiple {
                pub const m_nFilterType: usize = 0x7F8; // filter_t
                pub const m_iFilterName: usize = 0x800; // CUtlSymbolLarge[10]
                pub const m_hFilter: usize = 0x850; // CHandle<CBaseEntity>[10]
                pub const m_nFilterCount: usize = 0x878; // int32
            }
            // Parent: CPlayerPawnComponent
            // Fields count: 0
            ...
            pub mod CPhysicsWire {
                pub const m_nDensity: usize = 0x7A4; // int32
            }
            // Parent: CPropDoorRotating
            // Fields count: 4
            pub mod CPropDoorRotatingBreakable {
                pub const m_bBreakable: usize = 0x11A4; // bool
                pub const m_isAbleToCloseAreaPortals: usize = 0x11A5; // bool
                pub const m_currentDamageState: usize = 0x11A8; // int32
                pub const m_damageStates: usize = 0x11B0; // CUtlVector<CUtlSymbolLarge>
            }
            // Parent: None
            // Fields count: 0
            //
            ...
            pub mod CFireSmoke {
                pub const m_nFlameModelIndex: usize = 0x7B4; // int32
                pub const m_nFlameFromAboveModelIndex: usize = 0x7B8; // int32
            }
            // Parent: CCSWeaponBase
            // Fields count: 0
            pub mod CBumpMine {
            ...
            pub mod CBasePropDoor {
                pub const m_flAutoReturnDelay: usize = 0xE94; // float32
                pub const m_hDoorList: usize = 0xE98; // CUtlVector<CHandle<CBasePropDoor>>
                pub const m_nHardwareType: usize = 0xEB0; // int32
                pub const m_bNeedsHardware: usize = 0xEB4; // bool
                pub const m_eDoorState: usize = 0xEB8; // DoorState_t
                pub const m_bLocked: usize = 0xEBC; // bool
                pub const m_closedPosition: usize = 0xEC0; // Vector
                pub const m_closedAngles: usize = 0xECC; // QAngle
                pub const m_hBlocker: usize = 0xED8; // CHandle<CBaseEntity>
                pub const m_bFirstBlocked: usize = 0xEDC; // bool
                pub const m_ls: usize = 0xEE0; // locksound_t
                pub const m_bForceClosed: usize = 0xF00; // bool
                pub const m_vecLatchWorldPosition: usize = 0xF04; // Vector
                pub const m_hActivator: usize = 0xF10; // CHandle<CBaseEntity>
                pub const m_SoundMoving: usize = 0xF20; // CUtlSymbolLarge
                pub const m_SoundOpen: usize = 0xF28; // CUtlSymbolLarge
                pub const m_SoundClose: usize = 0xF30; // CUtlSymbolLarge
                pub const m_SoundLock: usize = 0xF38; // CUtlSymbolLarge
                pub const m_SoundUnlock: usize = 0xF40; // CUtlSymbolLarge
                pub const m_SoundLatch: usize = 0xF48; // CUtlSymbolLarge
                pub const m_SoundPound: usize = 0xF50; // CUtlSymbolLarge
                pub const m_SoundJiggle: usize = 0xF58; // CUtlSymbolLarge
                pub const m_SoundLockedAnim: usize = 0xF60; // CUtlSymbolLarge
                ...
                pub const m_OnBlockedOpening: usize = 0xFA8; // CEntityIOOutput
                pub const m_OnUnblockedClosing: usize = 0xFD0; // CEntityIOOutput
                pub const m_OnUnblockedOpening: usize = 0xFF8; // CEntityIOOutput
                pub const m_OnFullyClosed: usize = 0x1020; // CEntityIOOutput
                pub const m_OnFullyOpen: usize = 0x1048; // CEntityIOOutput
                pub const m_OnClose: usize = 0x1070; // CEntityIOOutput
                pub const m_OnOpen: usize = 0x1098; // CEntityIOOutput
                pub const m_OnLockedUse: usize = 0x10C0; // CEntityIOOutput
                pub const m_OnAjarOpen: usize = 0x10E8; // CEntityIOOutput
            }
            // Parent: CBaseEntity
            // Fields count: 3
            //
            ...
            pub mod CRagdollManager {
                pub const m_iCurrentMaxRagdollCount: usize = 0x7A4; // int8
                pub const m_iMaxRagdollCount: usize = 0x7A8; // int32
                pub const m_bSaveImportant: usize = 0x7AC; // bool
            }
            // Parent: CBaseTrigger
            // Fields count: 12
            pub mod CTriggerFan {
                pub const m_vFanOrigin: usize = 0xBC4; // Vector
                pub const m_vFanEnd: usize = 0xBD0; // Vector
                pub const m_vNoise: usize = 0xBDC; // Vector
                pub const m_flForce: usize = 0xBE8; // float32
                pub const m_flRopeForceScale: usize = 0xBEC; // float32
                pub const m_flPlayerForce: usize = 0xBF0; // float32
                pub const m_flRampTime: usize = 0xBF4; // float32
                pub const m_bFalloff: usize = 0xBF8; // bool
                pub const m_bPushPlayer: usize = 0xBF9; // bool
                pub const m_bRampDown: usize = 0xBFA; // bool
                pub const m_bAddNoise: usize = 0xBFB; // bool
            ...
            pub mod CHandleTest {
                pub const m_Handle: usize = 0x7A4; // CHandle<CBaseEntity>
                pub const m_bSendHandle: usize = 0x7A8; // bool
            }
            // Parent: CBaseEntity
            // Fields count: 8
            ...
            pub mod CNavSpaceInfo {
                pub const m_bCreateFlightSpace: usize = 0x7A4; // bool
            }
            // Parent: CLogicalEntity
            // Fields count: 3
            pub mod CLogicAchievement {
                pub const m_bDisabled: usize = 0x7A4; // bool
                pub const m_iszAchievementEventID: usize = 0x7A8; // CUtlSymbolLarge
                pub const m_OnFired: usize = 0x7B0; // CEntityIOOutput
            }
            // Parent: CBaseEntity
            // Fields count: 1
            pub mod CPathSimple {
                pub const m_pathString: usize = 0x7F8; // CUtlString
            }
            // Parent: CBtNode
            // Fields count: 1
            ...
            pub mod CItem {
                ...
                pub const m_OnPlayerPickup: usize = 0xC20; // CEntityIOOutput
                pub const m_bActivateWhenAtRest: usize = 0xC48; // bool
                pub const m_OnCacheInteraction: usize = 0xC50; // CEntityIOOutput
            ...
            pub mod CSoundOpvarSetPointBase {
                pub const m_bDisabled: usize = 0x7A4; // bool
                pub const m_hSource: usize = 0x7A8; // CEntityHandle
            ...
            pub mod CMessageEntity {
                pub const m_radius: usize = 0x7A4; // int32
                pub const m_messageText: usize = 0x7A8; // CUtlSymbolLarge
                pub const m_drawText: usize = 0x7B0; // bool
                pub const m_bDeveloperOnly: usize = 0x7B1; // bool
                pub const m_bEnabled: usize = 0x7B2; // bool
            }
            ...
            pub mod CBaseFire {
                pub const m_flScale: usize = 0x7A4; // float32
                pub const m_flStartScale: usize = 0x7A8; // float32
                pub const m_flScaleTime: usize = 0x7AC; // float32
                pub const m_nFlags: usize = 0x7B0; // uint32
            }
            // Parent: CCSWeaponBaseGun
            // Fields count: 0
            ...
            pub mod CTriggerActiveWeaponDetect {
                pub const m_OnTouchedActiveWeapon: usize = 0xBC8; // CEntityIOOutput
                pub const m_iszWeaponClassName: usize = 0xBF0; // CUtlSymbolLarge
            }
            // Parent: CPointEntity
            // Fields count: 18
            pub mod CEnvMicrophone {
                pub const m_bDisabled: usize = 0x7A4; // bool
                pub const m_hMeasureTarget: usize = 0x7A8; // CHandle<CBaseEntity>
                pub const m_nSoundType: usize = 0x7AC; // SoundTypes_t
                pub const m_nSoundFlags: usize = 0x7AE; // SoundFlags_t
                pub const m_flSensitivity: usize = 0x7B0; // float32
                pub const m_flSmoothFactor: usize = 0x7B4; // float32
                pub const m_flMaxRange: usize = 0x7B8; // float32
                ...
                pub const m_iLastRoutedFrame: usize = 0x960; // int32
            }
            // Parent: CLogicalEntity
            // Fields count: 11
            ...
            pub mod CBasePlayerController {
                ...
                pub const m_bKnownTeamMismatch: usize = 0x7EC; // bool
                pub const m_nSplitScreenSlot: usize = 0x7F0; // CSplitScreenSlot
                pub const m_hSplitOwner: usize = 0x7F4; // CHandle<CBasePlayerController>
                ...
                pub const m_iIgnoreGlobalChat: usize = 0x9D0; // ChatIgnoreType_t
                pub const m_flLastPlayerTalkTime: usize = 0x9D4; // float32
                pub const m_flLastEntitySteadyState: usize = 0x9D8; // float32
                pub const m_nAvailableEntitySteadyState: usize = 0x9DC; // int32
                pub const m_bHasAnySteadyStateEnts: usize = 0x9E0; // bool
                pub const m_steamID: usize = 0x9F0; // uint64
                pub const m_iDesiredFOV: usize = 0x9F8; // uint32
            }
            // Parent: None
            // Fields count: 0
            //
            ...
            pub mod CFuncTrackTrain {
                ...
                pub const m_flNextMPSoundTime: usize = 0xB40; // GameTime_t
            }
            ...
            pub mod CGenericConstraint {
                pub const m_nLinearMotionX: usize = 0x828; // JointMotion_t
                pub const m_nLinearMotionY: usize = 0x82C; // JointMotion_t
                pub const m_nLinearMotionZ: usize = 0x830; // JointMotion_t
                pub const m_flLinearFrequencyX: usize = 0x834; // float32
                pub const m_flLinearFrequencyY: usize = 0x838; // float32
                pub const m_flLinearFrequencyZ: usize = 0x83C; // float32
                pub const m_flLinearDampingRatioX: usize = 0x840; // float32
                pub const m_flLinearDampingRatioY: usize = 0x844; // float32
                pub const m_flLinearDampingRatioZ: usize = 0x848; // float32
                pub const m_flMaxLinearImpulseX: usize = 0x84C; // float32
                pub const m_flMaxLinearImpulseY: usize = 0x850; // float32
                pub const m_flMaxLinearImpulseZ: usize = 0x854; // float32
                pub const m_flBreakAfterTimeX: usize = 0x858; // float32
                pub const m_flBreakAfterTimeY: usize = 0x85C; // float32
                pub const m_flBreakAfterTimeZ: usize = 0x860; // float32
                pub const m_flBreakAfterTimeStartTimeX: usize = 0x864; // GameTime_t
                pub const m_flBreakAfterTimeStartTimeY: usize = 0x868; // GameTime_t
                pub const m_flBreakAfterTimeStartTimeZ: usize = 0x86C; // GameTime_t
                pub const m_flBreakAfterTimeThresholdX: usize = 0x870; // float32
                pub const m_flBreakAfterTimeThresholdY: usize = 0x874; // float32
                pub const m_flBreakAfterTimeThresholdZ: usize = 0x878; // float32
                pub const m_flNotifyForceX: usize = 0x87C; // float32
                pub const m_flNotifyForceY: usize = 0x880; // float32
                pub const m_flNotifyForceZ: usize = 0x884; // float32
                pub const m_flNotifyForceMinTimeX: usize = 0x888; // float32
                pub const m_flNotifyForceMinTimeY: usize = 0x88C; // float32
                pub const m_flNotifyForceMinTimeZ: usize = 0x890; // float32
                pub const m_flNotifyForceLastTimeX: usize = 0x894; // GameTime_t
                pub const m_flNotifyForceLastTimeY: usize = 0x898; // GameTime_t
                pub const m_flNotifyForceLastTimeZ: usize = 0x89C; // GameTime_t
                pub const m_bAxisNotifiedX: usize = 0x8A0; // bool
                pub const m_bAxisNotifiedY: usize = 0x8A1; // bool
                pub const m_bAxisNotifiedZ: usize = 0x8A2; // bool
                pub const m_nAngularMotionX: usize = 0x8A4; // JointMotion_t
                pub const m_nAngularMotionY: usize = 0x8A8; // JointMotion_t
                pub const m_nAngularMotionZ: usize = 0x8AC; // JointMotion_t
                pub const m_flAngularFrequencyX: usize = 0x8B0; // float32
                pub const m_flAngularFrequencyY: usize = 0x8B4; // float32
                pub const m_flAngularFrequencyZ: usize = 0x8B8; // float32
                pub const m_flAngularDampingRatioX: usize = 0x8BC; // float32
                pub const m_flAngularDampingRatioY: usize = 0x8C0; // float32
                pub const m_flAngularDampingRatioZ: usize = 0x8C4; // float32
                pub const m_flMaxAngularImpulseX: usize = 0x8C8; // float32
                pub const m_flMaxAngularImpulseY: usize = 0x8CC; // float32
                pub const m_flMaxAngularImpulseZ: usize = 0x8D0; // float32
                pub const m_NotifyForceReachedX: usize = 0x8D8; // CEntityIOOutput
                pub const m_NotifyForceReachedY: usize = 0x900; // CEntityIOOutput
                pub const m_NotifyForceReachedZ: usize = 0x928; // CEntityIOOutput
            }
            // Parent: CBaseCSGrenade
            // Fields count: 0
            ...
            pub mod CBaseAnimGraph {
                ...
                pub const m_bRagdollClientSide: usize = 0xAC0; // bool
            }
            // Parent: CPhysForce
            // Fields count: 1
            pub mod CPhysTorque {
            ...
            pub mod CRagdollProp {
                ...
                pub const m_strOriginClassName: usize = 0xCA0; // CUtlSymbolLarge
                pub const m_strSourceClassName: usize = 0xCA8; // CUtlSymbolLarge
                pub const m_bHasBeenPhysgunned: usize = 0xCB0; // bool
                pub const m_bShouldTeleportPhysics: usize = 0xCB1; // bool
                pub const m_flBlendWeight: usize = 0xCB4; // float32
                pub const m_flDefaultFadeScale: usize = 0xCB8; // float32
                pub const m_ragdollMins: usize = 0xCC0; // CUtlVector<Vector>
                pub const m_ragdollMaxs: usize = 0xCD8; // CUtlVector<Vector>
                pub const m_bShouldDeleteActivationRecord: usize = 0xCF0; // bool
                pub const m_bValidatePoweredRagdollPose: usize = 0xD50; // bool
            }
            // Parent: CBaseAnimGraph
            // Fields count: 0
            pub mod CItemSoda {
            ...
            pub mod CEnvDetailController {
                pub const m_flFadeStartDist: usize = 0x7A4; // float32
                pub const m_flFadeEndDist: usize = 0x7A8; // float32
            }
            // Parent: CTriggerOnce
            // Fields count: 14
            //
            ...
            pub mod CTriggerLook {
                pub const m_hLookTarget: usize = 0xBF0; // CHandle<CBaseEntity>
                pub const m_flFieldOfView: usize = 0xBF4; // float32
                pub const m_flLookTime: usize = 0xBF8; // float32
                pub const m_flLookTimeTotal: usize = 0xBFC; // float32
                pub const m_flLookTimeLast: usize = 0xC00; // GameTime_t
                pub const m_flTimeoutDuration: usize = 0xC04; // float32
                pub const m_bTimeoutFired: usize = 0xC08; // bool
                pub const m_bIsLooking: usize = 0xC09; // bool
                pub const m_b2DFOV: usize = 0xC0A; // bool
                pub const m_bUseVelocity: usize = 0xC0B; // bool
                pub const m_bTestOcclusion: usize = 0xC0C; // bool
                pub const m_OnTimeout: usize = 0xC10; // CEntityIOOutput
                pub const m_OnStartLook: usize = 0xC38; // CEntityIOOutput
                pub const m_OnEndLook: usize = 0xC60; // CEntityIOOutput
            }
            // Parent: CPointEntity
            // Fields count: 0
            ...
            // Fields count: 11
            pub mod CMathRemap {
                pub const m_flInMin: usize = 0x7A4; // float32
                pub const m_flInMax: usize = 0x7A8; // float32
                pub const m_flOut1: usize = 0x7AC; // float32
                pub const m_flOut2: usize = 0x7B0; // float32
                pub const m_flOldInValue: usize = 0x7B4; // float32
            ...
            pub mod CFootstepControl {
                pub const m_source: usize = 0xBC8; // CUtlSymbolLarge
                pub const m_destination: usize = 0xBD0; // CUtlSymbolLarge
            }
            // Parent: CBaseModelEntity
            // Fields count: 2
            ...
            pub mod CInstancedSceneEntity {
                pub const m_hOwner: usize = 0xD08; // CHandle<CBaseEntity>
                pub const m_bHadOwner: usize = 0xD0C; // bool
                pub const m_flPostSpeakDelay: usize = 0xD10; // float32
                pub const m_flPreDelay: usize = 0xD14; // float32
                pub const m_bIsBackground: usize = 0xD18; // bool
                pub const m_bRemoveOnCompletion: usize = 0xD19; // bool
                pub const m_hTarget: usize = 0xD1C; // CHandle<CBaseEntity>
            }
            // Parent: CPointEntity
            // Fields count: 1
            pub mod CEnvHudHint {
            ...
            // Fields count: 1
            pub mod CScriptItem {
                pub const m_MoveTypeOverride: usize = 0xCC8; // MoveType_t
            }
            ...
            pub mod CAmbientGeneric {
                pub const m_radius: usize = 0x7A4; // float32
                pub const m_flMaxRadius: usize = 0x7A8; // float32
                pub const m_iSoundLevel: usize = 0x7AC; // soundlevel_t
                pub const m_dpv: usize = 0x7B0; // dynpitchvol_t
                pub const m_fActive: usize = 0x814; // bool
                pub const m_fLooping: usize = 0x815; // bool
                pub const m_iszSound: usize = 0x818; // CUtlSymbolLarge
                pub const m_sSourceEntName: usize = 0x820; // CUtlSymbolLarge
                pub const m_hSoundSource: usize = 0x828; // CHandle<CBaseEntity>
                pub const m_nSoundSourceEntIndex: usize = 0x82C; // CEntityIndex
            }
            // Parent: CBaseModelEntity
            // Fields count: 9
            //
            ...
            pub mod CPhysicsProp {
                pub const m_MotionEnabled: usize = 0xD90; // CEntityIOOutput
                pub const m_OnAwakened: usize = 0xDB8; // CEntityIOOutput
                pub const m_OnAwake: usize = 0xDE0; // CEntityIOOutput
                pub const m_OnAsleep: usize = 0xE08; // CEntityIOOutput
                pub const m_OnPlayerUse: usize = 0xE30; // CEntityIOOutput
                pub const m_OnOutOfWorld: usize = 0xE58; // CEntityIOOutput
                pub const m_OnPlayerPickup: usize = 0xE80; // CEntityIOOutput
                pub const m_bForceNavIgnore: usize = 0xEA8; // bool
                pub const m_bNoNavmeshBlocker: usize = 0xEA9; // bool
                pub const m_bForceNpcExclude: usize = 0xEAA; // bool
                pub const m_massScale: usize = 0xEAC; // float32
                pub const m_inertiaScale: usize = 0xEB0; // float32
                pub const m_buoyancyScale: usize = 0xEB4; // float32
                pub const m_damageType: usize = 0xEB8; // int32
                pub const m_damageToEnableMotion: usize = 0xEBC; // int32
                pub const m_flForceToEnableMotion: usize = 0xEC0; // float32
                pub const m_bThrownByPlayer: usize = 0xEC4; // bool
                pub const m_bDroppedByPlayer: usize = 0xEC5; // bool
                pub const m_bTouchedByPlayer: usize = 0xEC6; // bool
                pub const m_bFirstCollisionAfterLaunch: usize = 0xEC7; // bool
                pub const m_iExploitableByPlayer: usize = 0xEC8; // int32
                pub const m_bHasBeenAwakened: usize = 0xECC; // bool
                pub const m_bIsOverrideProp: usize = 0xECD; // bool
                pub const m_fNextCheckDisableMotionContactsTime: usize = 0xED0; // GameTime_t
                pub const m_iInitialGlowState: usize = 0xED4; // int32
                pub const m_nGlowRange: usize = 0xED8; // int32
                pub const m_nGlowRangeMin: usize = 0xEDC; // int32
                pub const m_glowColor: usize = 0xEE0; // Color
                pub const m_bShouldAutoConvertBackFromDebris: usize = 0xEE4; // bool
                pub const m_bMuteImpactEffects: usize = 0xEE5; // bool
                pub const m_bAcceptDamageFromHeldObjects: usize = 0xEEC; // bool
                pub const m_bEnableUseOutput: usize = 0xEED; // bool
                pub const m_bAwake: usize = 0xEEE; // bool
            }
            // Parent: CFuncWall
            // Fields count: 0
            ...
            pub mod CSensorGrenadeProjectile {
                ...
                pub const m_fNextDetectPlayerSound: usize = 0xD94; // GameTime_t
                pub const m_hDisplayGrenade: usize = 0xD98; // CHandle<CBaseEntity>
            }
            ...
            pub mod CTriggerSndSosOpvar {
                pub const m_hTouchingPlayers: usize = 0xBC8; // CUtlVector<CHandle<CBaseEntity>>
                pub const m_flPosition: usize = 0xBE0; // Vector
                pub const m_flCenterSize: usize = 0xBEC; // float32
                pub const m_flMinVal: usize = 0xBF0; // float32
                pub const m_flMaxVal: usize = 0xBF4; // float32
                pub const m_opvarName: usize = 0xBF8; // CUtlSymbolLarge
                pub const m_stackName: usize = 0xC00; // CUtlSymbolLarge
                pub const m_operatorName: usize = 0xC08; // CUtlSymbolLarge
                pub const m_bVolIs2D: usize = 0xC10; // bool
                pub const m_opvarNameChar: usize = 0xC11; // char[256]
                pub const m_stackNameChar: usize = 0xD11; // char[256]
                pub const m_operatorNameChar: usize = 0xE11; // char[256]
                pub const m_VecNormPos: usize = 0xF14; // Vector
                pub const m_flNormCenterSize: usize = 0xF20; // float32
            }
            // Parent: CItem
            // Fields count: 0
            ...
            pub mod CScriptedSequence {
                ...
                pub const m_nMoveToGait: usize = 0x7EC; // MovementGait_t
                pub const m_bIsPlayingPreIdle: usize = 0x7ED; // bool
                pub const m_bIsPlayingEntry: usize = 0x7EE; // bool
                pub const m_bIsPlayingAction: usize = 0x7EF; // bool
                pub const m_bIsPlayingPostIdle: usize = 0x7F0; // bool
                pub const m_bDontRotateOther: usize = 0x7F1; // bool
                pub const m_bIsRepeatable: usize = 0x7F2; // bool
                pub const m_bShouldLeaveCorpse: usize = 0x7F3; // bool
                pub const m_bStartOnSpawn: usize = 0x7F4; // bool
                pub const m_bDisallowInterrupts: usize = 0x7F5; // bool
                pub const m_bCanOverrideNPCState: usize = 0x7F6; // bool
                pub const m_bDontTeleportAtEnd: usize = 0x7F7; // bool
                pub const m_bHighPriority: usize = 0x7F8; // bool
                pub const m_bHideDebugComplaints: usize = 0x7F9; // bool
                pub const m_bContinueOnDeath: usize = 0x7FA; // bool
                pub const m_bLoopPreIdleSequence: usize = 0x7FB; // bool
                pub const m_bLoopActionSequence: usize = 0x7FC; // bool
                pub const m_bLoopPostIdleSequence: usize = 0x7FD; // bool
                pub const m_bSynchPostIdles: usize = 0x7FE; // bool
                pub const m_bIgnoreLookAt: usize = 0x7FF; // bool
                pub const m_bIgnoreGravity: usize = 0x800; // bool
                pub const m_bDisableNPCCollisions: usize = 0x801; // bool
                pub const m_bKeepAnimgraphLockedPost: usize = 0x802; // bool
                pub const m_bDontAddModifiers: usize = 0x803; // bool
                pub const m_flRadius: usize = 0x804; // float32
                pub const m_flRepeat: usize = 0x808; // float32
                pub const m_flPlayAnimFadeInTime: usize = 0x80C; // float32
                pub const m_flMoveInterpTime: usize = 0x810; // float32
                pub const m_flAngRate: usize = 0x814; // float32
                pub const m_nNotReadySequenceCount: usize = 0x818; // int32
                pub const m_startTime: usize = 0x81C; // GameTime_t
                pub const m_bWaitForBeginSequence: usize = 0x820; // bool
                pub const m_saved_effects: usize = 0x824; // int32
                pub const m_savedFlags: usize = 0x828; // int32
                pub const m_savedCollisionGroup: usize = 0x82C; // int32
                pub const m_bInterruptable: usize = 0x830; // bool
                pub const m_sequenceStarted: usize = 0x831; // bool
                pub const m_bPositionRelativeToOtherEntity: usize = 0x832; // bool
                pub const m_hTargetEnt: usize = 0x834; // CHandle<CBaseEntity>
                pub const m_hNextCine: usize = 0x838; // CHandle<CScriptedSequence>
                pub const m_bThinking: usize = 0x83C; // bool
                pub const m_bInitiatedSelfDelete: usize = 0x83D; // bool
                pub const m_bIsTeleportingDueToMoveTo: usize = 0x83E; // bool
                pub const m_bAllowCustomInterruptConditions: usize = 0x83F; // bool
                pub const m_hForcedTarget: usize = 0x840; // CHandle<CBaseAnimGraph>
                pub const m_bDontCancelOtherSequences: usize = 0x844; // bool
                pub const m_bForceSynch: usize = 0x845; // bool
                pub const m_bPreventUpdateYawOnFinish: usize = 0x846; // bool
                pub const m_bEnsureOnNavmeshOnFinish: usize = 0x847; // bool
                pub const m_onDeathBehavior: usize = 0x848; // ScriptedOnDeath_t
                pub const m_ConflictResponse: usize = 0x84C; // ScriptedConflictResponse_t
                ...
                pub const m_iPlayerDeathBehavior: usize = 0xAA4; // int32
            }
            // Parent: CCSWeaponBaseGun
            // Fields count: 0
            ...
            pub mod CSplineConstraint {
                pub const m_vAnchorOffsetRestore: usize = 0x868; // Vector
            }
            // Parent: CPlayer_ViewModelServices
            // Fields count: 0
            ...
            pub mod CLogicCompare {
                pub const m_flInValue: usize = 0x7A4; // float32
                pub const m_flCompareValue: usize = 0x7A8; // float32
                pub const m_OnLessThan: usize = 0x7B0; // CEntityOutputTemplate<float32>
                pub const m_OnEqualTo: usize = 0x7D8; // CEntityOutputTemplate<float32>
                pub const m_OnNotEqualTo: usize = 0x800; // CEntityOutputTemplate<float32>
                pub const m_OnGreaterThan: usize = 0x828; // CEntityOutputTemplate<float32>
            }
            // Parent: CPlayerPawnComponent
            // Fields count: 1
            //
            ...
            pub mod CFuncTimescale {
                pub const m_flDesiredTimescale: usize = 0x7A4; // float32
                pub const m_flAcceleration: usize = 0x7A8; // float32
                pub const m_flMinBlendRate: usize = 0x7AC; // float32
                pub const m_flBlendDeltaMultiplier: usize = 0x7B0; // float32
                pub const m_isStarted: usize = 0x7B4; // bool
            }
            // Parent: CBtNode
            // Fields count: 14
            ...
            pub mod CTonemapController2 {
                pub const m_flAutoExposureMin: usize = 0x7A4; // float32
                pub const m_flAutoExposureMax: usize = 0x7A8; // float32
                pub const m_flTonemapPercentTarget: usize = 0x7AC; // float32
                pub const m_flTonemapPercentBrightPixels: usize = 0x7B0; // float32
                pub const m_flTonemapMinAvgLum: usize = 0x7B4; // float32
                pub const m_flExposureAdaptationSpeedUp: usize = 0x7B8; // float32
                pub const m_flExposureAdaptationSpeedDown: usize = 0x7BC; // float32
                pub const m_flTonemapEVSmoothingRange: usize = 0x7C0; // float32
            }
            ...
            // Fields count: 6
            pub mod CPointHurt {
                pub const m_nDamage: usize = 0x7A4; // int32
                pub const m_bitsDamageType: usize = 0x7A8; // int32
                pub const m_flRadius: usize = 0x7AC; // float32
                pub const m_flDelay: usize = 0x7B0; // float32
            ...
            pub mod CPointValueRemapper {
                pub const m_bDisabled: usize = 0x7A4; // bool
                pub const m_bUpdateOnClient: usize = 0x7A5; // bool
                pub const m_nInputType: usize = 0x7A8; // ValueRemapperInputType_t
            ...
            pub mod CLogicPlayerProxy {
                pub const m_hPlayer: usize = 0x7A4; // CHandle<CBaseEntity>
                pub const m_PlayerHasAmmo: usize = 0x7A8; // CEntityIOOutput
                pub const m_PlayerHasNoAmmo: usize = 0x7D0; // CEntityIOOutput
                pub const m_PlayerDied: usize = 0x7F8; // CEntityIOOutput
                pub const m_RequestedPlayerHealth: usize = 0x820; // CEntityOutputTemplate<int32>
            }
            // Parent: CPlayerPawnComponent
            // Fields count: 4
            //
            ...
            // Fields count: 3
            pub mod CPhysImpact {
                pub const m_damage: usize = 0x7A4; // float32
                pub const m_distance: usize = 0x7A8; // float32
            ...
            pub mod CEnvCombinedLightProbeVolume {
                ...
                pub const m_Entity_flBrightness: usize = 0x180C; // float32
                pub const m_Entity_hCubemapTexture: usize = 0x1810; // CStrongHandle<InfoForResourceTypeCTextureBase>
                pub const m_Entity_bCustomCubemapTexture: usize = 0x1818; // bool
                pub const m_Entity_hLightProbeTexture: usize = 0x1820; // CStrongHandle<InfoForResourceTypeCTextureBase>
                pub const m_Entity_hLightProbeDirectLightIndicesTexture: usize = 0x1828; // CStrongHandle<InfoForResourceTypeCTextureBase>
                pub const m_Entity_hLightProbeDirectLightScalarsTexture: usize = 0x1830; // CStrongHandle<InfoForResourceTypeCTextureBase>
                pub const m_Entity_hLightProbeDirectLightShadowsTexture: usize = 0x1838; // CStrongHandle<InfoForResourceTypeCTextureBase>
                pub const m_Entity_vBoxMins: usize = 0x1840; // Vector
                pub const m_Entity_vBoxMaxs: usize = 0x184C; // Vector
                pub const m_Entity_bMoveable: usize = 0x1858; // bool
                pub const m_Entity_nHandshake: usize = 0x185C; // int32
                pub const m_Entity_nEnvCubeMapArrayIndex: usize = 0x1860; // int32
                pub const m_Entity_nPriority: usize = 0x1864; // int32
                pub const m_Entity_bStartDisabled: usize = 0x1868; // bool
                pub const m_Entity_flEdgeFadeDist: usize = 0x186C; // float32
                pub const m_Entity_vEdgeFadeDists: usize = 0x1870; // Vector
                pub const m_Entity_nLightProbeSizeX: usize = 0x187C; // int32
                pub const m_Entity_nLightProbeSizeY: usize = 0x1880; // int32
                pub const m_Entity_nLightProbeSizeZ: usize = 0x1884; // int32
                pub const m_Entity_nLightProbeAtlasX: usize = 0x1888; // int32
                pub const m_Entity_nLightProbeAtlasY: usize = 0x188C; // int32
                pub const m_Entity_nLightProbeAtlasZ: usize = 0x1890; // int32
                pub const m_Entity_bEnabled: usize = 0x18A9; // bool
            }
            // Parent: CPlayerPawnComponent
            // Fields count: 0
            ...
            pub mod CPointAngularVelocitySensor {
                pub const m_hTargetEntity: usize = 0x7A4; // CHandle<CBaseEntity>
                pub const m_flThreshold: usize = 0x7A8; // float32
                pub const m_nLastCompareResult: usize = 0x7AC; // int32
                pub const m_nLastFireResult: usize = 0x7B0; // int32
                pub const m_flFireTime: usize = 0x7B4; // GameTime_t
                pub const m_flFireInterval: usize = 0x7B8; // float32
                pub const m_flLastAngVelocity: usize = 0x7BC; // float32
                pub const m_lastOrientation: usize = 0x7C0; // QAngle
                pub const m_vecAxis: usize = 0x7CC; // Vector
                pub const m_bUseHelper: usize = 0x7D8; // bool
            ...
            pub mod CMolotovProjectile {
                pub const m_bIsIncGrenade: usize = 0xD8E; // bool
                pub const m_bDetonated: usize = 0xD98; // bool
                pub const m_stillTimer: usize = 0xDA0; // IntervalTimer
                pub const m_bHasBouncedOffPlayer: usize = 0xE80; // bool
            }
            // Parent: CBaseTrigger
            // Fields count: 0
            ...
            pub mod CEnvInstructorHint {
                ...
                pub const m_iTimeout: usize = 0x7C0; // int32
                pub const m_iDisplayLimit: usize = 0x7C4; // int32
                ...
                pub const m_fIconOffset: usize = 0x7EC; // float32
                pub const m_fRange: usize = 0x7F0; // float32
                pub const m_iPulseOption: usize = 0x7F4; // uint8
                pub const m_iAlphaOption: usize = 0x7F5; // uint8
                pub const m_iShakeOption: usize = 0x7F6; // uint8
                pub const m_bStatic: usize = 0x7F7; // bool
                pub const m_bNoOffscreen: usize = 0x7F8; // bool
                pub const m_bForceCaption: usize = 0x7F9; // bool
                pub const m_iInstanceType: usize = 0x7FC; // int32
            ...
            // Fields count: 2
            pub mod CEnvTracer {
                pub const m_vecEnd: usize = 0x7A4; // Vector
                pub const m_flDelay: usize = 0x7B0; // float32
            }
            // Parent: CPointEntity
            // Fields count: 2
            pub mod CInfoGameEventProxy {
                ...
                pub const m_flRange: usize = 0x7B0; // float32
            }
            // Parent: CBaseEntity
            // Fields count: 25
            //
            ...
            pub mod CPointCamera {
                pub const m_FOV: usize = 0x7A4; // float32
                pub const m_Resolution: usize = 0x7A8; // float32
                pub const m_bFogEnable: usize = 0x7AC; // bool
                pub const m_FogColor: usize = 0x7AD; // Color
                pub const m_flFogStart: usize = 0x7B4; // float32
                pub const m_flFogEnd: usize = 0x7B8; // float32
                pub const m_flFogMaxDensity: usize = 0x7BC; // float32
                pub const m_bActive: usize = 0x7C0; // bool
                pub const m_bUseScreenAspectRatio: usize = 0x7C1; // bool
                pub const m_flAspectRatio: usize = 0x7C4; // float32
                pub const m_bNoSky: usize = 0x7C8; // bool
                pub const m_fBrightness: usize = 0x7CC; // float32
                pub const m_flZFar: usize = 0x7D0; // float32
                pub const m_flZNear: usize = 0x7D4; // float32
                pub const m_bCanHLTVUse: usize = 0x7D8; // bool
                pub const m_bDofEnabled: usize = 0x7D9; // bool
                pub const m_flDofNearBlurry: usize = 0x7DC; // float32
                pub const m_flDofNearCrisp: usize = 0x7E0; // float32
                pub const m_flDofFarCrisp: usize = 0x7E4; // float32
                pub const m_flDofFarBlurry: usize = 0x7E8; // float32
                pub const m_flDofTiltToGround: usize = 0x7EC; // float32
                pub const m_TargetFOV: usize = 0x7F0; // float32
                pub const m_DegreesPerSecond: usize = 0x7F4; // float32
                pub const m_bIsOn: usize = 0x7F8; // bool
            ...
            pub mod CPathKeyFrame {
                pub const m_Origin: usize = 0x7A4; // Vector
                pub const m_Angles: usize = 0x7B0; // QAngle
                ...
                pub const m_flMoveSpeed: usize = 0x7F0; // float32
            }
            // Parent: CBaseModelEntity
            // Fields count: 3
            ...
            pub mod COrnamentProp {
                pub const m_initialOwner: usize = 0xE88; // CUtlSymbolLarge
            }
            // Parent: CLogicalEntity
            // Fields count: 1
            ...
            pub mod CEnvMuzzleFlash {
                pub const m_flScale: usize = 0x7A4; // float32
                pub const m_iszParentAttachment: usize = 0x7A8; // CUtlSymbolLarge
            }
            // Parent: CModelPointEntity
            // Fields count: 15
            //
            ...
            pub mod CBombTarget {
                pub const m_OnBombExplode: usize = 0xBC8; // CEntityIOOutput
                pub const m_OnBombPlanted: usize = 0xBF0; // CEntityIOOutput
                pub const m_OnBombDefused: usize = 0xC18; // CEntityIOOutput
                pub const m_bIsBombSiteB: usize = 0xC40; // bool
                pub const m_bIsHeistBombTarget: usize = 0xC41; // bool
                pub const m_bBombPlantedHere: usize = 0xC42; // bool
                pub const m_szMountTarget: usize = 0xC48; // CUtlSymbolLarge
                pub const m_hInstructorHint: usize = 0xC50; // CHandle<CBaseEntity>
                pub const m_nBombSiteDesignation: usize = 0xC54; // int32
            }
            // Parent: CBaseEntity
            // Fields count: 8
            pub mod CPhysicsSpring {
                pub const m_flFrequency: usize = 0x7B0; // float32
                pub const m_flDampingRatio: usize = 0x7B4; // float32
                pub const m_flRestLength: usize = 0x7B8; // float32
                ...
                pub const m_teleportTick: usize = 0x7E8; // uint32
            }
            // Parent: CBaseEntity
            // Fields count: 17
            //
            ...
            pub mod CEnvLightProbeVolume {
                pub const m_Entity_hLightProbeTexture: usize = 0x1788; // CStrongHandle<InfoForResourceTypeCTextureBase>
                pub const m_Entity_hLightProbeDirectLightIndicesTexture: usize = 0x1790; // CStrongHandle<InfoForResourceTypeCTextureBase>
                pub const m_Entity_hLightProbeDirectLightScalarsTexture: usize = 0x1798; // CStrongHandle<InfoForResourceTypeCTextureBase>
                pub const m_Entity_hLightProbeDirectLightShadowsTexture: usize = 0x17A0; // CStrongHandle<InfoForResourceTypeCTextureBase>
                pub const m_Entity_vBoxMins: usize = 0x17A8; // Vector
                pub const m_Entity_vBoxMaxs: usize = 0x17B4; // Vector
                pub const m_Entity_bMoveable: usize = 0x17C0; // bool
                pub const m_Entity_nHandshake: usize = 0x17C4; // int32
                pub const m_Entity_nPriority: usize = 0x17C8; // int32
                pub const m_Entity_bStartDisabled: usize = 0x17CC; // bool
                pub const m_Entity_nLightProbeSizeX: usize = 0x17D0; // int32
                pub const m_Entity_nLightProbeSizeY: usize = 0x17D4; // int32
                pub const m_Entity_nLightProbeSizeZ: usize = 0x17D8; // int32
                pub const m_Entity_nLightProbeAtlasX: usize = 0x17DC; // int32
                pub const m_Entity_nLightProbeAtlasY: usize = 0x17E0; // int32
                pub const m_Entity_nLightProbeAtlasZ: usize = 0x17E4; // int32
            ...
            pub mod CScriptTriggerPush {
                pub const m_vExtent: usize = 0xBF4; // Vector
            }
            // Parent: CBaseEntity
            // Fields count: 1
            ...
            // Fields count: 1
            pub mod CFuncWall {
                pub const m_nState: usize = 0x9F8; // int32
            }
            // Parent: None
            // Fields count: 14
            //
            ...
            pub mod CLogicAutosave {
                pub const m_bForceNewLevelUnit: usize = 0x7A4; // bool
                pub const m_minHitPoints: usize = 0x7A8; // int32
                pub const m_minHitPointsToCommit: usize = 0x7AC; // int32
            }
            // Parent: CPlayerControllerComponent
            // Fields count: 2
            //
            ...
            pub mod CSoundEventPathCornerEntity {
                ...
                pub const m_bPlaying: usize = 0x868; // bool
                pub const m_vecCornerPairsNetworked: usize = 0x890; // CNetworkUtlVectorBase<SoundeventPathCornerPairNetworked_t>
            }
            // Parent: CEnvSoundscape
            // Fields count: 1
            ...
            pub mod CSmokeGrenadeProjectile {
                pub const m_nSmokeEffectTickBegin: usize = 0xDA8; // int32
                pub const m_bDidSmokeEffect: usize = 0xDAC; // bool
                pub const m_nRandomSeed: usize = 0xDB0; // int32
                pub const m_vSmokeColor: usize = 0xDB4; // Vector
                pub const m_vSmokeDetonationPos: usize = 0xDC0; // Vector
                pub const m_VoxelFrameData: usize = 0xDD0; // CUtlVector<uint8>
                pub const m_flLastBounce: usize = 0xDE8; // GameTime_t
                pub const m_fllastSimulationTime: usize = 0xDEC; // GameTime_t
                pub const m_bExplodeFromInferno: usize = 0x3070; // bool
            }
            // Parent: CTriggerMultiple
            // Fields count: 1
            pub mod CScriptTriggerMultiple {
                pub const m_vExtent: usize = 0xBF0; // Vector
            }
            ...
            pub mod FilterDamageType {
                pub const m_iDamageType: usize = 0x7F8; // int32
            }
            // Parent: CBot
            // Fields count: 139
            pub mod CCSBot {
                ...
                pub const m_combatRange: usize = 0x13C; // float32
                ...
                pub const m_safeTime: usize = 0x168; // float32
                ...
                pub const m_followTimestamp: usize = 0x198; // float32
                pub const m_allowAutoFollowTime: usize = 0x19C; // float32
                ...
                pub const m_stateTimestamp: usize = 0x4B8; // float32
                ...
                pub const m_avoidTimestamp: usize = 0x4E8; // float32
                ...
                pub const m_pathIndex: usize = 0x55D8; // int32
                pub const m_areaEnteredTimestamp: usize = 0x55DC; // GameTime_t
                pub const m_repathTimer: usize = 0x55E0; // CountdownTimer
                pub const m_avoidFriendTimer: usize = 0x55F8; // CountdownTimer
                pub const m_isFriendInTheWay: usize = 0x5610; // bool
                pub const m_politeTimer: usize = 0x5618; // CountdownTimer
                pub const m_isWaitingBehindFriend: usize = 0x5630; // bool
                pub const m_pathLadderEnd: usize = 0x565C; // float32
                pub const m_mustRunTimer: usize = 0x56A8; // CountdownTimer
                pub const m_waitTimer: usize = 0x56C0; // CountdownTimer
                pub const m_updateTravelDistanceTimer: usize = 0x56D8; // CountdownTimer
                pub const m_playerTravelDistance: usize = 0x56F0; // float32[64]
                pub const m_travelDistancePhase: usize = 0x57F0; // uint8
                pub const m_hostageEscortCount: usize = 0x5988; // uint8
                pub const m_hostageEscortCountTimestamp: usize = 0x598C; // float32
                pub const m_desiredTeam: usize = 0x5990; // int32
                pub const m_hasJoined: usize = 0x5994; // bool
                pub const m_isWaitingForHostage: usize = 0x5995; // bool
                pub const m_inhibitWaitingForHostageTimer: usize = 0x5998; // CountdownTimer
                pub const m_waitForHostageTimer: usize = 0x59B0; // CountdownTimer
                pub const m_noisePosition: usize = 0x59C8; // Vector
                pub const m_noiseTravelDistance: usize = 0x59D4; // float32
                pub const m_noiseTimestamp: usize = 0x59D8; // float32
                pub const m_noiseSource: usize = 0x59E0; // CCSPlayerPawn*
                pub const m_noiseBendTimer: usize = 0x59F8; // CountdownTimer
                pub const m_bentNoisePosition: usize = 0x5A10; // Vector
                pub const m_bendNoisePositionValid: usize = 0x5A1C; // bool
                pub const m_lookAroundStateTimestamp: usize = 0x5A20; // float32
                pub const m_lookAheadAngle: usize = 0x5A24; // float32
                pub const m_forwardAngle: usize = 0x5A28; // float32
                pub const m_inhibitLookAroundTimestamp: usize = 0x5A2C; // float32
                pub const m_lookAtSpot: usize = 0x5A34; // Vector
                pub const m_lookAtSpotDuration: usize = 0x5A44; // float32
                pub const m_lookAtSpotTimestamp: usize = 0x5A48; // float32
                pub const m_lookAtSpotAngleTolerance: usize = 0x5A4C; // float32
                pub const m_lookAtSpotClearIfClose: usize = 0x5A50; // bool
                pub const m_lookAtSpotAttack: usize = 0x5A51; // bool
                pub const m_lookAtDesc: usize = 0x5A58; // char*
                pub const m_peripheralTimestamp: usize = 0x5A60; // float32
                pub const m_approachPointCount: usize = 0x5BE8; // uint8
                pub const m_approachPointViewPosition: usize = 0x5BEC; // Vector
                pub const m_viewSteadyTimer: usize = 0x5BF8; // IntervalTimer
                pub const m_tossGrenadeTimer: usize = 0x5C10; // CountdownTimer
                pub const m_isAvoidingGrenade: usize = 0x5C30; // CountdownTimer
                pub const m_spotCheckTimestamp: usize = 0x5C50; // float32
                pub const m_checkedHidingSpotCount: usize = 0x6058; // int32
                pub const m_lookPitch: usize = 0x605C; // float32
                pub const m_lookPitchVel: usize = 0x6060; // float32
                pub const m_lookYaw: usize = 0x6064; // float32
                pub const m_lookYawVel: usize = 0x6068; // float32
                pub const m_targetSpot: usize = 0x606C; // Vector
                pub const m_targetSpotVelocity: usize = 0x6078; // Vector
                pub const m_targetSpotPredicted: usize = 0x6084; // Vector
                pub const m_aimError: usize = 0x6090; // QAngle
                pub const m_aimGoal: usize = 0x609C; // QAngle
                pub const m_targetSpotTime: usize = 0x60A8; // GameTime_t
                pub const m_aimFocus: usize = 0x60AC; // float32
                pub const m_aimFocusInterval: usize = 0x60B0; // float32
                pub const m_aimFocusNextUpdate: usize = 0x60B4; // GameTime_t
                pub const m_ignoreEnemiesTimer: usize = 0x60C0; // CountdownTimer
                pub const m_enemy: usize = 0x60D8; // CHandle<CCSPlayerPawn>
                pub const m_isEnemyVisible: usize = 0x60DC; // bool
                pub const m_visibleEnemyParts: usize = 0x60DD; // uint8
                pub const m_lastEnemyPosition: usize = 0x60E0; // Vector
                pub const m_lastSawEnemyTimestamp: usize = 0x60EC; // float32
                pub const m_firstSawEnemyTimestamp: usize = 0x60F0; // float32
                pub const m_currentEnemyAcquireTimestamp: usize = 0x60F4; // float32
                pub const m_enemyDeathTimestamp: usize = 0x60F8; // float32
                pub const m_friendDeathTimestamp: usize = 0x60FC; // float32
                pub const m_isLastEnemyDead: usize = 0x6100; // bool
                pub const m_nearbyEnemyCount: usize = 0x6104; // int32
                pub const m_bomber: usize = 0x6310; // CHandle<CCSPlayerPawn>
                pub const m_nearbyFriendCount: usize = 0x6314; // int32
                pub const m_closestVisibleFriend: usize = 0x6318; // CHandle<CCSPlayerPawn>
                pub const m_closestVisibleHumanFriend: usize = 0x631C; // CHandle<CCSPlayerPawn>
                pub const m_attentionInterval: usize = 0x6320; // IntervalTimer
                pub const m_attacker: usize = 0x6330; // CHandle<CCSPlayerPawn>
                pub const m_attackedTimestamp: usize = 0x6334; // float32
                pub const m_burnedByFlamesTimer: usize = 0x6338; // IntervalTimer
                pub const m_lastVictimID: usize = 0x6348; // int32
                pub const m_isAimingAtEnemy: usize = 0x634C; // bool
                pub const m_isRapidFiring: usize = 0x634D; // bool
                pub const m_equipTimer: usize = 0x6350; // IntervalTimer
                pub const m_zoomTimer: usize = 0x6360; // CountdownTimer
                pub const m_fireWeaponTimestamp: usize = 0x6378; // GameTime_t
                pub const m_lookForWeaponsOnGroundTimer: usize = 0x6380; // CountdownTimer
                pub const m_bIsSleeping: usize = 0x6398; // bool
                pub const m_isEnemySniperVisible: usize = 0x6399; // bool
                pub const m_sawEnemySniperTimer: usize = 0x63A0; // CountdownTimer
                pub const m_enemyQueueIndex: usize = 0x6458; // uint8
                pub const m_enemyQueueCount: usize = 0x6459; // uint8
                pub const m_enemyQueueAttendIndex: usize = 0x645A; // uint8
                pub const m_isStuck: usize = 0x645B; // bool
                pub const m_stuckTimestamp: usize = 0x645C; // GameTime_t
                pub const m_stuckSpot: usize = 0x6460; // Vector
                pub const m_wiggleTimer: usize = 0x6470; // CountdownTimer
                pub const m_stuckJumpTimer: usize = 0x6488; // CountdownTimer
                pub const m_nextCleanupCheckTimestamp: usize = 0x64A0; // GameTime_t
                pub const m_avgVel: usize = 0x64A4; // float32[10]
                pub const m_avgVelIndex: usize = 0x64CC; // int32
                pub const m_avgVelCount: usize = 0x64D0; // int32
                pub const m_lastOrigin: usize = 0x64D4; // Vector
                pub const m_lastRadioRecievedTimestamp: usize = 0x64E4; // float32
                pub const m_lastRadioSentTimestamp: usize = 0x64E8; // float32
                pub const m_radioSubject: usize = 0x64EC; // CHandle<CCSPlayerPawn>
                pub const m_radioPosition: usize = 0x64F0; // Vector
                pub const m_voiceEndTimestamp: usize = 0x64FC; // float32
                pub const m_lastValidReactionQueueFrame: usize = 0x6508; // int32
            }
            // Parent: CLogicalEntity
            // Fields count: 7
            pub mod CPhysMotor {
                ...
                pub const m_spinUp: usize = 0x7B4; // float32
                pub const m_additionalAcceleration: usize = 0x7B8; // float32
                pub const m_angularAcceleration: usize = 0x7BC; // float32
            ...
            pub mod CSoundAreaEntityBase {
                pub const m_bDisabled: usize = 0x7A4; // bool
                pub const m_iszSoundAreaType: usize = 0x7A8; // CUtlSymbolLarge
                pub const m_vPos: usize = 0x7B0; // Vector
            }
            // Parent: CPlayer_UseServices
            // Fields count: 3
            ...
            pub mod CTriggerHurt {
                pub const m_flOriginalDamage: usize = 0xBC4; // float32
                pub const m_flDamage: usize = 0xBC8; // float32
                pub const m_flDamageCap: usize = 0xBCC; // float32
                pub const m_flLastDmgTime: usize = 0xBD0; // GameTime_t
                pub const m_flForgivenessDelay: usize = 0xBD4; // float32
                pub const m_bitsDamageInflict: usize = 0xBD8; // int32
                pub const m_damageModel: usize = 0xBDC; // int32
                pub const m_bNoDmgForce: usize = 0xBE0; // bool
                pub const m_vDamageForce: usize = 0xBE4; // Vector
                pub const m_thinkAlways: usize = 0xBF0; // bool
                pub const m_hurtThinkPeriod: usize = 0xBF4; // float32
                pub const m_OnHurt: usize = 0xBF8; // CEntityIOOutput
                pub const m_OnHurtPlayer: usize = 0xC20; // CEntityIOOutput
                pub const m_hurtEntities: usize = 0xC48; // CUtlVector<CHandle<CBaseEntity>>
            }
            // Parent: CLogicalEntity
            // Fields count: 13
            pub mod CPhysConstraint {
                ...
                pub const m_hAttach1: usize = 0x7C0; // CHandle<CBaseEntity>
                pub const m_hAttach2: usize = 0x7C4; // CHandle<CBaseEntity>
                pub const m_nameAttachment1: usize = 0x7C8; // CUtlSymbolLarge
                pub const m_nameAttachment2: usize = 0x7D0; // CUtlSymbolLarge
                pub const m_breakSound: usize = 0x7D8; // CUtlSymbolLarge
                pub const m_forceLimit: usize = 0x7E0; // float32
                pub const m_torqueLimit: usize = 0x7E4; // float32
                pub const m_teleportTick: usize = 0x7E8; // uint32
                pub const m_minTeleportDistance: usize = 0x7EC; // float32
                pub const m_bSnapObjectPositions: usize = 0x7F0; // bool
            ...
            pub mod CMapVetoPickController {
                pub const m_bPlayedIntroVcd: usize = 0x7A4; // bool
                pub const m_bNeedToPlayFiveSecondsRemaining: usize = 0x7A5; // bool
                pub const m_dblPreMatchDraftSequenceTime: usize = 0x7C0; // float64
                pub const m_bPreMatchDraftStateChanged: usize = 0x7C8; // bool
                pub const m_nDraftType: usize = 0x7CC; // int32
                pub const m_nTeamWinningCoinToss: usize = 0x7D0; // int32
                pub const m_nTeamWithFirstChoice: usize = 0x7D4; // int32[64]
                pub const m_nVoteMapIdsList: usize = 0x8D4; // int32[7]
                pub const m_nAccountIDs: usize = 0x8F0; // int32[64]
                pub const m_nMapId0: usize = 0x9F0; // int32[64]
                pub const m_nMapId1: usize = 0xAF0; // int32[64]
                pub const m_nMapId2: usize = 0xBF0; // int32[64]
                pub const m_nMapId3: usize = 0xCF0; // int32[64]
                pub const m_nMapId4: usize = 0xDF0; // int32[64]
                pub const m_nMapId5: usize = 0xEF0; // int32[64]
                pub const m_nStartingSide0: usize = 0xFF0; // int32[64]
                pub const m_nCurrentPhase: usize = 0x10F0; // int32
                pub const m_nPhaseStartTick: usize = 0x10F4; // int32
                pub const m_nPhaseDurationTicks: usize = 0x10F8; // int32
                pub const m_OnMapVetoed: usize = 0x1100; // CEntityOutputTemplate<CUtlSymbolLarge>
                pub const m_OnMapPicked: usize = 0x1128; // CEntityOutputTemplate<CUtlSymbolLarge>
                pub const m_OnSidesPicked: usize = 0x1150; // CEntityOutputTemplate<int32>
                pub const m_OnNewPhaseStarted: usize = 0x1178; // CEntityOutputTemplate<int32>
                pub const m_OnLevelTransition: usize = 0x11A0; // CEntityOutputTemplate<int32>
            }
            // Parent: CBaseEntity
            // Fields count: 0
            ...
            // Fields count: 4
            pub mod CSoundEnt {
                pub const m_iFreeSound: usize = 0x7A4; // int32
                pub const m_iActiveSound: usize = 0x7A8; // int32
                pub const m_cLastActiveSounds: usize = 0x7AC; // int32
                pub const m_SoundPool: usize = 0x7B0; // CSound[128]
            }
            // Parent: CPointEntity
            // Fields count: 0
            ...
            pub mod CTriggerSave {
                pub const m_bForceNewLevelUnit: usize = 0xBC1; // bool
                pub const m_fDangerousTimer: usize = 0xBC4; // float32
                pub const m_minHitPoints: usize = 0xBC8; // int32
            }
            // Parent: CPhysConstraint
            // Fields count: 11
            pub mod CPhysWheelConstraint {
                pub const m_flSuspensionFrequency: usize = 0x820; // float32
                pub const m_flSuspensionDampingRatio: usize = 0x824; // float32
                pub const m_flSuspensionHeightOffset: usize = 0x828; // float32
                pub const m_bEnableSuspensionLimit: usize = 0x82C; // bool
                pub const m_flMinSuspensionOffset: usize = 0x830; // float32
                pub const m_flMaxSuspensionOffset: usize = 0x834; // float32
                pub const m_bEnableSteeringLimit: usize = 0x838; // bool
                pub const m_flMinSteeringAngle: usize = 0x83C; // float32
                pub const m_flMaxSteeringAngle: usize = 0x840; // float32
                pub const m_flSteeringAxisFriction: usize = 0x844; // float32
                pub const m_flSpinAxisFriction: usize = 0x848; // float32
            }
            // Parent: CPhysConstraint
            // Fields count: 6
            pub mod CPhysFixed {
                pub const m_flLinearFrequency: usize = 0x820; // float32
                pub const m_flLinearDampingRatio: usize = 0x824; // float32
                pub const m_flAngularFrequency: usize = 0x828; // float32
                pub const m_flAngularDampingRatio: usize = 0x82C; // float32
                pub const m_bEnableLinearConstraint: usize = 0x830; // bool
                pub const m_bEnableAngularConstraint: usize = 0x831; // bool
            }
            // Parent: CEntitySubclassVDataBase
            // Fields count: 14
            //
            ...
            // Fields count: 4
            pub mod CPhysPulley {
                pub const m_position2: usize = 0x820; // Vector
                pub const m_offset: usize = 0x82C; // Vector[2]
                pub const m_addLength: usize = 0x844; // float32
                pub const m_gearRatio: usize = 0x848; // float32
            }
            // Parent: CBaseEntity
            // Fields count: 0
            ...
            pub mod CEnvFireSource {
                pub const m_bEnabled: usize = 0x7A4; // bool
                pub const m_radius: usize = 0x7A8; // float32
                pub const m_damage: usize = 0x7AC; // float32
            }
            // Parent: CBaseEntity
            // Fields count: 0
            ...
            pub mod CTriggerGameEvent {
                pub const m_strStartTouchEventName: usize = 0xBC8; // CUtlString
                pub const m_strEndTouchEventName: usize = 0xBD0; // CUtlString
                pub const m_strTriggerID: usize = 0xBD8; // CUtlString
            }
            // Parent: CPhysConstraint
            // Fields count: 10
            pub mod CPhysSlideConstraint {
                pub const m_axisEnd: usize = 0x828; // Vector
                pub const m_slideFriction: usize = 0x834; // float32
                pub const m_systemLoadScale: usize = 0x838; // float32
                pub const m_initialOffset: usize = 0x83C; // float32
                pub const m_bEnableLinearConstraint: usize = 0x840; // bool
                pub const m_bEnableAngularConstraint: usize = 0x841; // bool
                pub const m_flMotorFrequency: usize = 0x844; // float32
                pub const m_flMotorDampingRatio: usize = 0x848; // float32
                pub const m_bUseEntityPivot: usize = 0x84C; // bool
                pub const m_soundInfo: usize = 0x850; // ConstraintSoundInfo
            }
            // Parent: CBaseEntity
            // Fields count: 1
            pub mod CDebugHistory {
                pub const m_nNpcEvents: usize = 0x1F47E8; // int32
            }
            // Parent: CServerOnlyEntity
            // Fields count: 0
            pub mod CInfoData {
            ...
            pub mod CBaseCSGrenadeProjectile {
                ...
                pub const m_nItemIndex: usize = 0xD5E; // uint16
                pub const m_vecOriginalSpawnLocation: usize = 0xD60; // Vector
                pub const m_flLastBounceSoundTime: usize = 0xD6C; // GameTime_t
                pub const m_vecGrenadeSpin: usize = 0xD70; // RotationVector
                pub const m_vecLastHitSurfaceNormal: usize = 0xD7C; // Vector
                pub const m_nTicksAtZeroVelocity: usize = 0xD88; // int32
                pub const m_bHasEverHitPlayer: usize = 0xD8C; // bool
                pub const m_bClearFromPlayers: usize = 0xD8D; // bool
            }
            // Parent: CServerOnlyModelEntity
            // Fields count: 1
            pub mod CCSPlace {
            ...
            pub mod CPointAngleSensor {
                pub const m_bDisabled: usize = 0x7A4; // bool
                pub const m_nLookAtName: usize = 0x7A8; // CUtlSymbolLarge
                pub const m_hTargetEntity: usize = 0x7B0; // CHandle<CBaseEntity>
                pub const m_hLookAtEntity: usize = 0x7B4; // CHandle<CBaseEntity>
                pub const m_flDuration: usize = 0x7B8; // float32
                pub const m_flDotTolerance: usize = 0x7BC; // float32
                pub const m_flFacingTime: usize = 0x7C0; // GameTime_t
                pub const m_bFired: usize = 0x7C4; // bool
                pub const m_OnFacingLookat: usize = 0x7C8; // CEntityIOOutput
                pub const m_OnNotFacingLookat: usize = 0x7F0; // CEntityIOOutput
                pub const m_TargetDir: usize = 0x818; // CEntityOutputTemplate<Vector>
                pub const m_FacingPercentage: usize = 0x840; // CEntityOutputTemplate<float32>
            }
            // Parent: CSoundEventEntity
            // Fields count: 2
            //
            ...
            pub mod CSoundEventOBBEntity {
                pub const m_vMins: usize = 0x850; // Vector
                pub const m_vMaxs: usize = 0x85C; // Vector
            }
            ...
            pub mod CEnvVolumetricFogVolume {
                pub const m_bActive: usize = 0x7A4; // bool
                pub const m_vBoxMins: usize = 0x7A8; // Vector
                pub const m_vBoxMaxs: usize = 0x7B4; // Vector
                pub const m_bStartDisabled: usize = 0x7C0; // bool
                pub const m_flStrength: usize = 0x7C4; // float32
                pub const m_nFalloffShape: usize = 0x7C8; // int32
                pub const m_flFalloffExponent: usize = 0x7CC; // float32
                pub const m_flHeightFogDepth: usize = 0x7D0; // float32
                pub const m_fHeightFogEdgeWidth: usize = 0x7D4; // float32
                pub const m_fIndirectLightStrength: usize = 0x7D8; // float32
                pub const m_fSunLightStrength: usize = 0x7DC; // float32
                pub const m_fNoiseStrength: usize = 0x7E0; // float32
                pub const m_bOverrideIndirectLightStrength: usize = 0x7E4; // bool
                pub const m_bOverrideSunLightStrength: usize = 0x7E5; // bool
                pub const m_bOverrideNoiseStrength: usize = 0x7E6; // bool
            }
            // Parent: CBaseModelEntity
            // Fields count: 24
            //
            ...
            pub mod CRagdollMagnet {
                pub const m_bDisabled: usize = 0x7A4; // bool
                pub const m_radius: usize = 0x7A8; // float32
                pub const m_force: usize = 0x7AC; // float32
                pub const m_axis: usize = 0x7B0; // Vector
            }
            // Parent: CBaseModelEntity
            // Fields count: 6
            pub mod CFuncBrush {
            ...
            pub mod CFilterClass {
                pub const m_iFilterClass: usize = 0x7F8; // CUtlSymbolLarge
            }
            // Parent: CCSWeaponBase
            // Fields count: 0
            pub mod CMelee {
            ...
            // Fields count: 15
            pub mod CPhysBox {
                pub const m_damageType: usize = 0xACC; // int32
                pub const m_massScale: usize = 0xAD0; // float32
                pub const m_damageToEnableMotion: usize = 0xAD4; // int32
                pub const m_flForceToEnableMotion: usize = 0xAD8; // float32
                pub const m_angPreferredCarryAngles: usize = 0xADC; // QAngle
                pub const m_bNotSolidToWorld: usize = 0xAE8; // bool
                pub const m_bEnableUseOutput: usize = 0xAE9; // bool
                pub const m_iExploitableByPlayer: usize = 0xAEC; // int32
                pub const m_flTouchOutputPerEntityDelay: usize = 0xAF0; // float32
                pub const m_OnDamaged: usize = 0xAF8; // CEntityIOOutput
                pub const m_OnAwakened: usize = 0xB20; // CEntityIOOutput
                pub const m_OnMotionEnabled: usize = 0xB48; // CEntityIOOutput
                pub const m_OnPlayerUse: usize = 0xB70; // CEntityIOOutput
                pub const m_OnStartTouch: usize = 0xB98; // CEntityIOOutput
                pub const m_hCarryingPlayer: usize = 0xBC0; // CHandle<CBasePlayerPawn>
            }
            // Parent: CBaseFlex
            // Fields count: 14
            //
            ...
            pub mod CTimerEntity {
                ...
                pub const m_iDisabled: usize = 0x820; // int32
                pub const m_flInitialDelay: usize = 0x824; // float32
                pub const m_flRefireTime: usize = 0x828; // float32
                pub const m_bUpDownState: usize = 0x82C; // bool
                pub const m_iUseRandomTime: usize = 0x830; // int32
                pub const m_bPauseAfterFiring: usize = 0x834; // bool
                pub const m_flLowerRandomBound: usize = 0x838; // float32
                pub const m_flUpperRandomBound: usize = 0x83C; // float32
                pub const m_flRemainingTime: usize = 0x840; // float32
            ...
            pub mod CCSWeaponBase {
                ...
                pub const m_iMostRecentTeamNumber: usize = 0x1110; // int32
                pub const m_bDroppedNearBuyZone: usize = 0x1114; // bool
                pub const m_flNextAttackRenderTimeOffset: usize = 0x1118; // float32
                pub const m_bCanBePickedUp: usize = 0x1130; // bool
                pub const m_bUseCanOverrideNextOwnerTouchTime: usize = 0x1131; // bool
                pub const m_nextOwnerTouchTime: usize = 0x1134; // GameTime_t
                pub const m_nextPrevOwnerTouchTime: usize = 0x1138; // GameTime_t
                pub const m_hPrevOwner: usize = 0x1140; // CHandle<CCSPlayerPawn>
                pub const m_nDropTick: usize = 0x1144; // GameTick_t
                pub const m_donated: usize = 0x1164; // bool
                pub const m_fLastShotTime: usize = 0x1168; // GameTime_t
                pub const m_bWasOwnedByCT: usize = 0x116C; // bool
                pub const m_bWasOwnedByTerrorist: usize = 0x116D; // bool
                pub const m_bFiredOutOfAmmoEvent: usize = 0x116E; // bool
                pub const m_numRemoveUnownedWeaponThink: usize = 0x1170; // int32
                pub const m_IronSightController: usize = 0x1178; // CIronSightController
                pub const m_iIronSightMode: usize = 0x1190; // int32
                pub const m_flLastLOSTraceFailureTime: usize = 0x1194; // GameTime_t
                pub const m_iNumEmptyAttacks: usize = 0x1198; // int32
                pub const m_flWatTickOffset: usize = 0x119C; // float32
            }
            // Parent: CBaseEntity
            // Fields count: 0
            ...
            pub mod CRagdollConstraint {
                pub const m_xmin: usize = 0x820; // float32
                pub const m_xmax: usize = 0x824; // float32
                pub const m_ymin: usize = 0x828; // float32
                pub const m_ymax: usize = 0x82C; // float32
                pub const m_zmin: usize = 0x830; // float32
                pub const m_zmax: usize = 0x834; // float32
                pub const m_xfriction: usize = 0x838; // float32
                pub const m_yfriction: usize = 0x83C; // float32
                pub const m_zfriction: usize = 0x840; // float32
            }
            // Parent: CPointEntity
            // Fields count: 9
            pub mod CPhysExplosion {
                pub const m_bExplodeOnSpawn: usize = 0x7A4; // bool
                pub const m_flMagnitude: usize = 0x7A8; // float32
                pub const m_flDamage: usize = 0x7AC; // float32
                pub const m_radius: usize = 0x7B0; // float32
                pub const m_targetEntityName: usize = 0x7B8; // CUtlSymbolLarge
                pub const m_flInnerRadius: usize = 0x7C0; // float32
                pub const m_flPushScale: usize = 0x7C4; // float32
            ...
            pub mod CPointPush {
                ...
                pub const m_flMagnitude: usize = 0x7A8; // float32
                pub const m_flRadius: usize = 0x7AC; // float32
                pub const m_flInnerRadius: usize = 0x7B0; // float32
                pub const m_flConeOfInfluence: usize = 0x7B4; // float32
                pub const m_iszFilterName: usize = 0x7B8; // CUtlSymbolLarge
                pub const m_hFilter: usize = 0x7C0; // CHandle<CBaseFilter>
            }
            // Parent: CPointEntity
            // Fields count: 3
            pub mod CCredits {
                ...
                pub const m_flLogoLength: usize = 0x7D4; // float32
            }
            // Parent: CBaseEntity
            // Fields count: 10
            //
            ...
            pub mod CCSPlayerResource {
                pub const m_bHostageAlive: usize = 0x7A4; // bool[12]
                pub const m_isHostageFollowingSomeone: usize = 0x7B0; // bool[12]
                pub const m_iHostageEntityIDs: usize = 0x7BC; // CEntityIndex[12]
                pub const m_bombsiteCenterA: usize = 0x7EC; // Vector
                pub const m_bombsiteCenterB: usize = 0x7F8; // Vector
                pub const m_hostageRescueX: usize = 0x804; // int32[4]
                pub const m_hostageRescueY: usize = 0x814; // int32[4]
                pub const m_hostageRescueZ: usize = 0x824; // int32[4]
                pub const m_bEndMatchNextMapAllVoted: usize = 0x834; // bool
                pub const m_foundGoalPositions: usize = 0x835; // bool
            }
            // Parent: CPlayerPawnComponent
            // Fields count: 5
            //
            ...
            pub mod CTriggerImpact {
                pub const m_flMagnitude: usize = 0xBF0; // float32
                pub const m_flNoise: usize = 0xBF4; // float32
                pub const m_flViewkick: usize = 0xBF8; // float32
                pub const m_pOutputForce: usize = 0xC00; // CEntityOutputTemplate<Vector>
            }
            // Parent: CBaseModelEntity
            // Fields count: 14
            //
            ...
            pub mod CTriggerDetectBulletFire {
                pub const m_bPlayerFireOnly: usize = 0xBC1; // bool
                pub const m_OnDetectedBulletFire: usize = 0xBC8; // CEntityIOOutput
            }
            // Parent: CBaseModelEntity
            // Fields count: 0
            pub mod CWorld {
            ...
            pub mod CPointGiveAmmo {
                pub const m_pActivator: usize = 0x7A4; // CHandle<CBaseEntity>
            }
            ...
            pub mod CPathParticleRope {
                pub const m_bStartActive: usize = 0x7A4; // bool
                pub const m_flMaxSimulationTime: usize = 0x7A8; // float32
            ...
            pub mod CPlayerVisibility {
                pub const m_flVisibilityStrength: usize = 0x7A4; // float32
                pub const m_flFogDistanceMultiplier: usize = 0x7A8; // float32
                pub const m_flFogMaxDensityMultiplier: usize = 0x7AC; // float32
                pub const m_flFadeTime: usize = 0x7B0; // float32
                pub const m_bStartDisabled: usize = 0x7B4; // bool
                pub const m_bIsEnabled: usize = 0x7B5; // bool
            }
            // Parent: CServerOnlyEntity
            // Fields count: 0
            ...
            pub mod CTriggerTeleport {
                pub const m_iLandmark: usize = 0xBC8; // CUtlSymbolLarge
                pub const m_bUseLandmarkAngles: usize = 0xBD0; // bool
                pub const m_bMirrorPlayer: usize = 0xBD1; // bool
            }
            // Parent: CCSPlayerBase_CameraServices
            // Fields count: 0
            ...
            // Fields count: 26
            pub mod CFuncMover {
                pub const m_iszPathName: usize = 0x9F8; // CUtlSymbolLarge
                pub const m_hPathMover: usize = 0xA00; // CHandle<CPathMover>
                pub const m_iszPathNodeStart: usize = 0xA08; // CUtlSymbolLarge
                pub const m_eMoveType: usize = 0xA10; // CFuncMover::Move_t
                pub const m_bIsReversing: usize = 0xA14; // bool
                pub const m_vTarget: usize = 0xA18; // Vector
                pub const m_flStartSpeed: usize = 0xA24; // float32
                pub const m_flPathLocation: usize = 0xA28; // float32
                pub const m_flT: usize = 0xA2C; // float32
                pub const m_nCurrentNodeIndex: usize = 0xA30; // int32
                pub const m_nPreviousNodeIndex: usize = 0xA34; // int32
                pub const m_bFixedOrientation: usize = 0xA38; // bool
                pub const m_bFixedPitch: usize = 0xA39; // bool
                pub const m_eSolidType: usize = 0xA3A; // SolidType_t
                pub const m_bIsMoving: usize = 0xA3B; // bool
                pub const m_flTimeToReachMaxSpeed: usize = 0xA3C; // float32
                pub const m_flTimeToReachZeroSpeed: usize = 0xA40; // float32
                pub const m_flTimeMovementStart: usize = 0xA44; // GameTime_t
                pub const m_flTimeMovementStop: usize = 0xA48; // GameTime_t
                pub const m_hStopAtNode: usize = 0xA4C; // CHandle<CMoverPathNode>
                pub const m_flPathLocationToBeginStop: usize = 0xA50; // float32
                pub const m_bMatchPathNodeUp: usize = 0xA54; // bool
                pub const m_bFacePlayer: usize = 0xA55; // bool
                pub const m_flTimeStartRoll: usize = 0xA58; // GameTime_t
                pub const m_vOriginalUp: usize = 0xA5C; // Vector
                pub const m_flTimeToRollToNewUp: usize = 0xA68; // float32
            }
            // Parent: None
            // Fields count: 5
            //
            ...
            pub mod CCSGameRules {
                ...
                pub const m_hPlayerResource: usize = 0x1548; // CHandle<CBaseEntity>
                pub const m_RetakeRules: usize = 0x1550; // CRetakeGameRules
                pub const m_arrTeamUniqueKillWeaponsMatch: usize = 0x16E8; // CUtlVector<int32>[4]
                pub const m_bTeamLastKillUsedUniqueWeaponMatch: usize = 0x1748; // bool[4]
                pub const m_nMatchEndCount: usize = 0x1770; // uint8
                pub const m_nTTeamIntroVariant: usize = 0x1774; // int32
                pub const m_nCTTeamIntroVariant: usize = 0x1778; // int32
                pub const m_bTeamIntroPeriod: usize = 0x177C; // bool
                pub const m_fTeamIntroPeriodEnd: usize = 0x1780; // GameTime_t
                pub const m_bPlayedTeamIntroVO: usize = 0x1784; // bool
                pub const m_iRoundEndWinnerTeam: usize = 0x1788; // int32
                pub const m_eRoundEndReason: usize = 0x178C; // int32
                pub const m_bRoundEndShowTimerDefend: usize = 0x1790; // bool
                pub const m_iRoundEndTimerTime: usize = 0x1794; // int32
                pub const m_sRoundEndFunFactToken: usize = 0x1798; // CUtlString
                pub const m_iRoundEndFunFactPlayerSlot: usize = 0x17A0; // CPlayerSlot
                pub const m_iRoundEndFunFactData1: usize = 0x17A4; // int32
                pub const m_iRoundEndFunFactData2: usize = 0x17A8; // int32
                pub const m_iRoundEndFunFactData3: usize = 0x17AC; // int32
                pub const m_sRoundEndMessage: usize = 0x17B0; // CUtlString
                pub const m_iRoundEndPlayerCount: usize = 0x17B8; // int32
                pub const m_bRoundEndNoMusic: usize = 0x17BC; // bool
                pub const m_iRoundEndLegacy: usize = 0x17C0; // int32
                pub const m_nRoundEndCount: usize = 0x17C4; // uint8
                pub const m_iRoundStartRoundNumber: usize = 0x17C8; // int32
                pub const m_nRoundStartCount: usize = 0x17CC; // uint8
                pub const m_flLastPerfSampleTime: usize = 0x57D8; // float64
            }
            // Parent: CPhysicsProp
            // Fields count: 0
            ...
            pub mod CAI_ChangeHintGroup {
                pub const m_iSearchType: usize = 0x7A4; // int32
                pub const m_strSearchName: usize = 0x7A8; // CUtlSymbolLarge
                pub const m_strNewHintGroup: usize = 0x7B0; // CUtlSymbolLarge
                pub const m_flRadius: usize = 0x7B8; // float32
            }
            // Parent: CBaseTrigger
            // Fields count: 10
            //
            ...
            pub mod CColorCorrectionVolume {
                pub const m_bEnabled: usize = 0xBC1; // bool
                pub const m_MaxWeight: usize = 0xBC4; // float32
                pub const m_FadeDuration: usize = 0xBC8; // float32
                pub const m_bStartDisabled: usize = 0xBCC; // bool
                pub const m_Weight: usize = 0xBD0; // float32
                pub const m_lookupFilename: usize = 0xBD4; // char[512]
                pub const m_LastEnterWeight: usize = 0xDD4; // float32
                pub const m_LastEnterTime: usize = 0xDD8; // GameTime_t
                pub const m_LastExitWeight: usize = 0xDDC; // float32
                pub const m_LastExitTime: usize = 0xDE0; // GameTime_t
            }
            // Parent: CBaseFilter
            // Fields count: 5
            pub mod CFilterEnemy {
                pub const m_iszEnemyName: usize = 0x7F8; // CUtlSymbolLarge
                pub const m_flRadius: usize = 0x800; // float32
                pub const m_flOuterRadius: usize = 0x804; // float32
                pub const m_nMaxSquadmatesPerEnemy: usize = 0x808; // int32
                pub const m_iszPlayerName: usize = 0x810; // CUtlSymbolLarge
            }
            // Parent: CModelPointEntity
            // Fields count: 0
            pub mod CShower {
            ...
            pub mod CEnvCubemapFog {
                pub const m_flEndDistance: usize = 0x7A4; // float32
                pub const m_flStartDistance: usize = 0x7A8; // float32
                pub const m_flFogFalloffExponent: usize = 0x7AC; // float32
                pub const m_bHeightFogEnabled: usize = 0x7B0; // bool
                pub const m_flFogHeightWidth: usize = 0x7B4; // float32
                pub const m_flFogHeightEnd: usize = 0x7B8; // float32
                pub const m_flFogHeightStart: usize = 0x7BC; // float32
                pub const m_flFogHeightExponent: usize = 0x7C0; // float32
                pub const m_flLODBias: usize = 0x7C4; // float32
                pub const m_bActive: usize = 0x7C8; // bool
                pub const m_bStartDisabled: usize = 0x7C9; // bool
                pub const m_flFogMaxOpacity: usize = 0x7CC; // float32
                pub const m_nCubemapSourceType: usize = 0x7D0; // int32
            ...
            pub mod CFilterContext {
                pub const m_iFilterContext: usize = 0x7F8; // CUtlSymbolLarge
            }
            ...
            pub mod CFilterAttributeInt {
                pub const m_sAttributeName: usize = 0x7F8; // CUtlStringToken
            }
            // Parent: CPlayerPawnComponent
            // Fields count: 4
            //
            ...
            // Fields count: 6
            pub mod CAISound {
                pub const m_iSoundType: usize = 0x7A4; // SoundTypes_t
                pub const m_iSoundFlags: usize = 0x7A6; // SoundFlags_t
                pub const m_iVolume: usize = 0x7A8; // int32
                pub const m_iSoundIndex: usize = 0x7AC; // int32
                pub const m_flDuration: usize = 0x7B0; // float32
                pub const m_iszProxyEntityName: usize = 0x7B8; // CUtlSymbolLarge
            }
            // Parent: CBaseEntity
            // Fields count: 7
            pub mod CPointEntityFinder {
                pub const m_hEntity: usize = 0x7A4; // CHandle<CBaseEntity>
                pub const m_iFilterName: usize = 0x7A8; // CUtlSymbolLarge
                pub const m_hFilter: usize = 0x7B0; // CHandle<CBaseFilter>
                pub const m_iRefName: usize = 0x7B8; // CUtlSymbolLarge
                pub const m_hReference: usize = 0x7C0; // CHandle<CBaseEntity>
                pub const m_FindMethod: usize = 0x7C4; // EntFinderMethod_t
                pub const m_OnFoundEntity: usize = 0x7C8; // CEntityIOOutput
            }
            // Parent: None
            // Fields count: 12
            //
            ...
            pub mod CBaseProp {
                ...
                pub const m_iShapeType: usize = 0xBF4; // int32
            ...
            pub mod CPointVelocitySensor {
                pub const m_hTargetEntity: usize = 0x7A4; // CHandle<CBaseEntity>
                pub const m_vecAxis: usize = 0x7A8; // Vector
                pub const m_bEnabled: usize = 0x7B4; // bool
                pub const m_fPrevVelocity: usize = 0x7B8; // float32
                pub const m_flAvgInterval: usize = 0x7BC; // float32
                pub const m_Velocity: usize = 0x7C0; // CEntityOutputTemplate<float32>
            }
            // Parent: CBaseFilter
            // Fields count: 1
            pub mod CFilterMassGreater {
                pub const m_fFilterMass: usize = 0x7F8; // float32
            }
            // Parent: CBaseFilter
            // Fields count: 1
            pub mod FilterTeam {
                pub const m_iFilterTeam: usize = 0x7F8; // int32
            }
            ...
            // Fields count: 1
            pub mod CBuyZone {
                pub const m_LegacyTeamNum: usize = 0xBC4; // int32
            }
            // Parent: CLogicalEntity
            // Fields count: 12
            ...
            pub mod CInfoDynamicShadowHint {
                pub const m_bDisabled: usize = 0x7A4; // bool
                pub const m_flRange: usize = 0x7A8; // float32
                pub const m_nImportance: usize = 0x7AC; // int32
                pub const m_nLightChoice: usize = 0x7B0; // int32
                pub const m_hLight: usize = 0x7B4; // CHandle<CBaseEntity>
            }
            // Parent: CSoundOpvarSetPointEntity
            // Fields count: 9
            ...
            pub mod CFlashbangProjectile {
                pub const m_flTimeToDetonate: usize = 0xD90; // float32
                pub const m_numOpponentsHit: usize = 0xD94; // uint8
                pub const m_numTeammatesHit: usize = 0xD95; // uint8
            }
            ...
            pub mod CLogicBranch {
                pub const m_bInValue: usize = 0x7A4; // bool
                pub const m_Listeners: usize = 0x7A8; // CUtlVector<CHandle<CBaseEntity>>
                pub const m_OnTrue: usize = 0x7C0; // CEntityIOOutput
                pub const m_OnFalse: usize = 0x7E8; // CEntityIOOutput
            }
            // Parent: CCSWeaponBaseGun
            // Fields count: 0
            ...
            pub mod CBaseButton {
                ...
                pub const m_sOverrideAnticipationName: usize = 0xAC0; // CUtlSymbolLarge
                pub const m_bLocked: usize = 0xAC8; // bool
                pub const m_bDisabled: usize = 0xAC9; // bool
                pub const m_flUseLockedTime: usize = 0xACC; // GameTime_t
                pub const m_bSolidBsp: usize = 0xAD0; // bool
                pub const m_OnDamaged: usize = 0xAD8; // CEntityIOOutput
                pub const m_OnPressed: usize = 0xB00; // CEntityIOOutput
                pub const m_OnUseLocked: usize = 0xB28; // CEntityIOOutput
                pub const m_OnIn: usize = 0xB50; // CEntityIOOutput
                pub const m_OnOut: usize = 0xB78; // CEntityIOOutput
            ...
            // Fields count: 6
            pub mod CPhysLength {
                pub const m_offset: usize = 0x820; // Vector[2]
                pub const m_vecAttach: usize = 0x838; // Vector
                pub const m_addLength: usize = 0x844; // float32
                pub const m_minLength: usize = 0x848; // float32
                pub const m_totalLength: usize = 0x84C; // float32
                pub const m_bEnableCollision: usize = 0x850; // bool
            }
            // Parent: CBaseEntity
            // Fields count: 48
            pub mod CLogicNPCCounter {
                ...
                pub const m_OnFactorAll: usize = 0x7F8; // CEntityOutputTemplate<float32>
                pub const m_OnMinPlayerDistAll: usize = 0x820; // CEntityOutputTemplate<float32>
                pub const m_OnMinCount_1: usize = 0x848; // CEntityIOOutput
                pub const m_OnMaxCount_1: usize = 0x870; // CEntityIOOutput
                pub const m_OnFactor_1: usize = 0x898; // CEntityOutputTemplate<float32>
                pub const m_OnMinPlayerDist_1: usize = 0x8C0; // CEntityOutputTemplate<float32>
                pub const m_OnMinCount_2: usize = 0x8E8; // CEntityIOOutput
                pub const m_OnMaxCount_2: usize = 0x910; // CEntityIOOutput
                pub const m_OnFactor_2: usize = 0x938; // CEntityOutputTemplate<float32>
                pub const m_OnMinPlayerDist_2: usize = 0x960; // CEntityOutputTemplate<float32>
                pub const m_OnMinCount_3: usize = 0x988; // CEntityIOOutput
                pub const m_OnMaxCount_3: usize = 0x9B0; // CEntityIOOutput
                pub const m_OnFactor_3: usize = 0x9D8; // CEntityOutputTemplate<float32>
                pub const m_OnMinPlayerDist_3: usize = 0xA00; // CEntityOutputTemplate<float32>
                pub const m_hSource: usize = 0xA28; // CEntityHandle
                pub const m_iszSourceEntityName: usize = 0xA30; // CUtlSymbolLarge
                pub const m_flDistanceMax: usize = 0xA38; // float32
                pub const m_bDisabled: usize = 0xA3C; // bool
                pub const m_nMinCountAll: usize = 0xA40; // int32
                pub const m_nMaxCountAll: usize = 0xA44; // int32
                pub const m_nMinFactorAll: usize = 0xA48; // int32
                pub const m_nMaxFactorAll: usize = 0xA4C; // int32
                pub const m_iszNPCClassname_1: usize = 0xA58; // CUtlSymbolLarge
                pub const m_nNPCState_1: usize = 0xA60; // int32
                pub const m_bInvertState_1: usize = 0xA64; // bool
                pub const m_nMinCount_1: usize = 0xA68; // int32
                pub const m_nMaxCount_1: usize = 0xA6C; // int32
                pub const m_nMinFactor_1: usize = 0xA70; // int32
                pub const m_nMaxFactor_1: usize = 0xA74; // int32
                pub const m_flDefaultDist_1: usize = 0xA7C; // float32
                pub const m_iszNPCClassname_2: usize = 0xA80; // CUtlSymbolLarge
                pub const m_nNPCState_2: usize = 0xA88; // int32
                pub const m_bInvertState_2: usize = 0xA8C; // bool
                pub const m_nMinCount_2: usize = 0xA90; // int32
                pub const m_nMaxCount_2: usize = 0xA94; // int32
                pub const m_nMinFactor_2: usize = 0xA98; // int32
                pub const m_nMaxFactor_2: usize = 0xA9C; // int32
                pub const m_flDefaultDist_2: usize = 0xAA4; // float32
                pub const m_iszNPCClassname_3: usize = 0xAA8; // CUtlSymbolLarge
                pub const m_nNPCState_3: usize = 0xAB0; // int32
                pub const m_bInvertState_3: usize = 0xAB4; // bool
                pub const m_nMinCount_3: usize = 0xAB8; // int32
                pub const m_nMaxCount_3: usize = 0xABC; // int32
                pub const m_nMinFactor_3: usize = 0xAC0; // int32
                pub const m_nMaxFactor_3: usize = 0xAC4; // int32
                pub const m_flDefaultDist_3: usize = 0xACC; // float32
            }
            ...
            pub mod CWeaponShield {
                pub const m_flBulletDamageAbsorbed: usize = 0x11BC; // float32
                pub const m_flLastBulletHitSoundTime: usize = 0x11C0; // GameTime_t
                pub const m_flDisplayHealth: usize = 0x11C4; // float32
            }
            // Parent: CPointEntity
            // Fields count: 4
            pub mod CBlood {
                pub const m_vecSprayAngles: usize = 0x7A4; // QAngle
                pub const m_vecSprayDir: usize = 0x7B0; // Vector
                pub const m_flAmount: usize = 0x7BC; // float32
                pub const m_Color: usize = 0x7C0; // BloodType
            }
            // Parent: CLogicalEntity
            // Fields count: 4
            //
            ...
            pub mod CEnvFade {
                pub const m_fadeColor: usize = 0x7A4; // Color
                pub const m_Duration: usize = 0x7A8; // float32
                pub const m_HoldDuration: usize = 0x7AC; // float32
                pub const m_OnBeginFade: usize = 0x7B0; // CEntityIOOutput
            }
            // Parent: CBaseProp
            // Fields count: 30
            //
            ...
            pub mod CBreakableProp {
                pub const m_CPropDataComponent: usize = 0xC38; // CPropDataComponent
                pub const m_OnBreak: usize = 0xC78; // CEntityIOOutput
                pub const m_OnHealthChanged: usize = 0xCA0; // CEntityOutputTemplate<float32>
                pub const m_OnTakeDamage: usize = 0xCC8; // CEntityIOOutput
                pub const m_impactEnergyScale: usize = 0xCF0; // float32
                pub const m_iMinHealthDmg: usize = 0xCF4; // int32
                pub const m_preferredCarryAngles: usize = 0xCF8; // QAngle
                pub const m_flPressureDelay: usize = 0xD04; // float32
                pub const m_flDefBurstScale: usize = 0xD08; // float32
                pub const m_vDefBurstOffset: usize = 0xD0C; // Vector
                pub const m_hBreaker: usize = 0xD18; // CHandle<CBaseEntity>
                pub const m_PerformanceMode: usize = 0xD1C; // PerformanceMode_t
                pub const m_flPreventDamageBeforeTime: usize = 0xD20; // GameTime_t
                pub const m_bHasBreakPiecesOrCommands: usize = 0xD24; // bool
                pub const m_explodeDamage: usize = 0xD28; // float32
                pub const m_explodeRadius: usize = 0xD2C; // float32
                pub const m_explosionDelay: usize = 0xD34; // float32
                pub const m_explosionBuildupSound: usize = 0xD38; // CUtlSymbolLarge
                pub const m_explosionCustomEffect: usize = 0xD40; // CUtlSymbolLarge
                pub const m_explosionCustomSound: usize = 0xD48; // CUtlSymbolLarge
                pub const m_explosionModifier: usize = 0xD50; // CUtlSymbolLarge
                pub const m_hPhysicsAttacker: usize = 0xD58; // CHandle<CBasePlayerPawn>
                pub const m_flLastPhysicsInfluenceTime: usize = 0xD5C; // GameTime_t
                pub const m_bOriginalBlockLOS: usize = 0xD60; // bool
                pub const m_flDefaultFadeScale: usize = 0xD64; // float32
                pub const m_hLastAttacker: usize = 0xD68; // CHandle<CBaseEntity>
                pub const m_hFlareEnt: usize = 0xD6C; // CHandle<CBaseEntity>
                pub const m_bUsePuntSound: usize = 0xD70; // bool
                pub const m_iszPuntSound: usize = 0xD78; // CUtlSymbolLarge
                pub const m_noGhostCollision: usize = 0xD80; // bool
            }
            // Parent: CPlayerPawnComponent
            // Fields count: 1
            //
            ...
            pub mod CBaseCombatCharacter {
                ...
                pub const m_iDamageCount: usize = 0xCF0; // int32
                pub const m_pVecRelationships: usize = 0xCF8; // CUtlVector<RelationshipOverride_t>*
                pub const m_strRelationships: usize = 0xD00; // CUtlSymbolLarge
                pub const m_eHull: usize = 0xD08; // Hull_t
                pub const m_nNavHullIdx: usize = 0xD0C; // uint32
            }
            // Parent: CBaseModelEntity
            // Fields count: 25
            //
            ...
            // Fields count: 5
            pub mod CEnvGlobal {
                pub const m_outCounter: usize = 0x7A8; // CEntityOutputTemplate<int32>
                pub const m_globalstate: usize = 0x7D0; // CUtlSymbolLarge
                pub const m_triggermode: usize = 0x7D8; // int32
                pub const m_initialstate: usize = 0x7DC; // int32
                pub const m_counter: usize = 0x7E0; // int32
            }
            // Parent: CLogicalEntity
            // Fields count: 3
            pub mod CBaseFilter {
                pub const m_bNegated: usize = 0x7A4; // bool
                pub const m_OnPass: usize = 0x7A8; // CEntityIOOutput
                pub const m_OnFail: usize = 0x7D0; // CEntityIOOutput
            }
            // Parent: CBaseEntity
            // Fields count: 4
            //
            ...
            pub mod CInfoDynamicShadowHintBox {
                pub const m_vBoxMins: usize = 0x7B8; // Vector
                pub const m_vBoxMaxs: usize = 0x7C4; // Vector
            }
            // Parent: CBaseEntity
            // Fields count: 3
            pub mod CPathMover {
                pub const m_vecPathNodes: usize = 0x7A8; // CUtlVector<CHandle<CMoverPathNode>>
                pub const m_flPathLength: usize = 0x7C0; // float32
                pub const m_bClosedLoop: usize = 0x7C4; // bool
            }
            // Parent: CBaseCSGrenade
            // Fields count: 0
            pub mod CFlashbang {
            ...
            pub mod CChicken {
                pub const m_AttributeManager: usize = 0xEA8; // CAttributeContainer
                pub const m_sActivityFinishedTag: usize = 0x1198; // CUtlStringToken
                pub const m_updateTimer: usize = 0x11A0; // CountdownTimer
                pub const m_stuckAnchor: usize = 0x11B8; // Vector
                pub const m_stuckTimer: usize = 0x11C8; // CountdownTimer
                pub const m_collisionStuckTimer: usize = 0x11E0; // CountdownTimer
                pub const m_isOnGround: usize = 0x11F8; // bool
                pub const m_vFallVelocity: usize = 0x11FC; // Vector
                pub const m_desiredActivity: usize = 0x1208; // ChickenActivity
                pub const m_currentActivity: usize = 0x120C; // ChickenActivity
                pub const m_activityTimer: usize = 0x1210; // CountdownTimer
                pub const m_turnRate: usize = 0x1228; // float32
                pub const m_fleeFrom: usize = 0x122C; // CHandle<CBaseEntity>
                pub const m_moveRateThrottleTimer: usize = 0x1230; // CountdownTimer
                pub const m_startleTimer: usize = 0x1248; // CountdownTimer
                pub const m_vocalizeTimer: usize = 0x1260; // CountdownTimer
                pub const m_flWhenZombified: usize = 0x1278; // GameTime_t
                pub const m_jumpedThisFrame: usize = 0x127C; // bool
                pub const m_leader: usize = 0x1280; // CHandle<CCSPlayerPawn>
                pub const m_reuseTimer: usize = 0x1298; // CountdownTimer
                pub const m_hasBeenUsed: usize = 0x12B0; // bool
                pub const m_jumpTimer: usize = 0x12B8; // CountdownTimer
                pub const m_flLastJumpTime: usize = 0x12D0; // float32
                pub const m_bInJump: usize = 0x12D4; // bool
                pub const m_isWaitingForLeader: usize = 0x12D5; // bool
                pub const m_repathTimer: usize = 0x32E0; // CountdownTimer
                pub const m_inhibitDoorTimer: usize = 0x32F8; // CountdownTimer
                pub const m_inhibitObstacleAvoidanceTimer: usize = 0x3388; // CountdownTimer
                pub const m_vecPathGoal: usize = 0x33A8; // Vector
                pub const m_flActiveFollowStartTime: usize = 0x33B4; // GameTime_t
                pub const m_followMinuteTimer: usize = 0x33B8; // CountdownTimer
                pub const m_vecLastEggPoopPosition: usize = 0x33D0; // Vector
                pub const m_vecEggsPooped: usize = 0x33E0; // CUtlVector<CHandle<CBaseEntity>>
                pub const m_BlockDirectionTimer: usize = 0x3400; // CountdownTimer
            }
            // Parent: CBaseTrigger
            // Fields count: 7
            pub mod CChangeLevel {
                pub const m_sMapName: usize = 0xBC8; // CUtlString
                pub const m_sLandmarkName: usize = 0xBD0; // CUtlString
                pub const m_OnChangeLevel: usize = 0xBD8; // CEntityIOOutput
                pub const m_bTouched: usize = 0xC00; // bool
                pub const m_bNoTouch: usize = 0xC01; // bool
                pub const m_bNewChapter: usize = 0xC02; // bool
                pub const m_bOnChangeLevelFired: usize = 0xC03; // bool
            }
            // Parent: CBaseTrigger
            // Fields count: 14
            pub mod CTriggerLerpObject {
                pub const m_iszLerpTarget: usize = 0xBC8; // CUtlSymbolLarge
                pub const m_hLerpTarget: usize = 0xBD0; // CHandle<CBaseEntity>
                pub const m_iszLerpTargetAttachment: usize = 0xBD8; // CUtlSymbolLarge
                pub const m_hLerpTargetAttachment: usize = 0xBE0; // AttachmentHandle_t
                pub const m_flLerpDuration: usize = 0xBE4; // float32
                pub const m_bLerpRestoreMoveType: usize = 0xBE8; // bool
                pub const m_bSingleLerpObject: usize = 0xBE9; // bool
                pub const m_vecLerpingObjects: usize = 0xBF0; // CUtlVector<lerpdata_t>
                pub const m_iszLerpEffect: usize = 0xC08; // CUtlSymbolLarge
                pub const m_iszLerpSound: usize = 0xC10; // CUtlSymbolLarge
                pub const m_bAttachTouchingObject: usize = 0xC18; // bool
                pub const m_hEntityToWaitForDisconnect: usize = 0xC1C; // CHandle<CBaseEntity>
                pub const m_OnLerpStarted: usize = 0xC20; // CEntityIOOutput
                pub const m_OnLerpFinished: usize = 0xC48; // CEntityIOOutput
            }
            // Parent: CBaseToggle
            // Fields count: 12
            //
            ...
            pub mod CBaseTrigger {
                ...
                pub const m_OnTouchingEachEntity: usize = 0xB58; // CEntityIOOutput
                pub const m_OnNotTouching: usize = 0xB80; // CEntityIOOutput
                pub const m_hTouchingEntities: usize = 0xBA8; // CUtlVector<CHandle<CBaseEntity>>
                pub const m_bClientSidePredicted: usize = 0xBC0; // bool
            }
            // Parent: CPointEntity
            // Fields count: 0
            ...
            pub mod CSoundAreaEntityOrientedBox {
                pub const m_vMin: usize = 0x7BC; // Vector
                pub const m_vMax: usize = 0x7C8; // Vector
            }
            // Parent: CBaseTrigger
            // Fields count: 13
            //
            ...
            pub mod CTriggerPhysics {
                pub const m_gravityScale: usize = 0xBD8; // float32
                pub const m_linearLimit: usize = 0xBDC; // float32
                pub const m_linearDamping: usize = 0xBE0; // float32
                pub const m_angularLimit: usize = 0xBE4; // float32
                pub const m_angularDamping: usize = 0xBE8; // float32
                pub const m_linearForce: usize = 0xBEC; // float32
                pub const m_flFrequency: usize = 0xBF0; // float32
                pub const m_flDampingRatio: usize = 0xBF4; // float32
                pub const m_vecLinearForcePointAt: usize = 0xBF8; // Vector
                pub const m_bCollapseToForcePoint: usize = 0xC04; // bool
                pub const m_vecLinearForcePointAtWorld: usize = 0xC08; // Vector
                pub const m_vecLinearForceDirection: usize = 0xC14; // Vector
                pub const m_bConvertToDebrisWhenPossible: usize = 0xC20; // bool
            }
            // Parent: None
            // Fields count: 2
            //
            ...
            pub mod CSoundEventSphereEntity {
                pub const m_flRadius: usize = 0x850; // float32
            }
            // Parent: CCSWeaponBaseGun
            // Fields count: 0
            ...
            pub mod CPointCameraVFOV {
                pub const m_flVerticalFOV: usize = 0x808; // float32
            }
            // Parent: CCSWeaponBaseGun
            // Fields count: 2
            //
            ...
            // NetworkVarNames: m_CPropDataComponent (CPropDataComponent::Storage_t)
            pub mod CBreakable {
                pub const m_CPropDataComponent: usize = 0xA00; // CPropDataComponent
                pub const m_Material: usize = 0xA40; // Materials
                pub const m_hBreaker: usize = 0xA44; // CHandle<CBaseEntity>
                pub const m_Explosion: usize = 0xA48; // Explosions
                pub const m_iszSpawnObject: usize = 0xA50; // CUtlSymbolLarge
                pub const m_flPressureDelay: usize = 0xA58; // float32
                pub const m_iMinHealthDmg: usize = 0xA5C; // int32
                pub const m_iszPropData: usize = 0xA60; // CUtlSymbolLarge
                pub const m_impactEnergyScale: usize = 0xA68; // float32
                pub const m_nOverrideBlockLOS: usize = 0xA6C; // EOverrideBlockLOS_t
                pub const m_OnBreak: usize = 0xA70; // CEntityIOOutput
                pub const m_OnHealthChanged: usize = 0xA98; // CEntityOutputTemplate<float32>
                pub const m_PerformanceMode: usize = 0xAC0; // PerformanceMode_t
                pub const m_hPhysicsAttacker: usize = 0xAC4; // CHandle<CBasePlayerPawn>
                pub const m_flLastPhysicsInfluenceTime: usize = 0xAC8; // GameTime_t
            }
            // Parent: CBaseModelEntity
            // Fields count: 16
            pub mod CBaseToggle {
                pub const m_toggle_state: usize = 0x9F8; // TOGGLE_STATE
                pub const m_flMoveDistance: usize = 0x9FC; // float32
                pub const m_flWait: usize = 0xA00; // float32
                pub const m_flLip: usize = 0xA04; // float32
                ...
                pub const m_movementType: usize = 0xA68; // int32
            ...
            pub mod CMomentaryRotButton {
                ...
                pub const m_OnUnpressed: usize = 0xBF0; // CEntityIOOutput
                pub const m_OnFullyOpen: usize = 0xC18; // CEntityIOOutput
                pub const m_OnFullyClosed: usize = 0xC40; // CEntityIOOutput
                pub const m_OnReachedPosition: usize = 0xC68; // CEntityIOOutput
                pub const m_lastUsed: usize = 0xC90; // int32
                pub const m_start: usize = 0xC94; // QAngle
                pub const m_end: usize = 0xCA0; // QAngle
                pub const m_IdealYaw: usize = 0xCAC; // float32
                pub const m_sNoise: usize = 0xCB0; // CUtlSymbolLarge
                pub const m_bUpdateTarget: usize = 0xCB8; // bool
                pub const m_direction: usize = 0xCBC; // int32
                pub const m_returnSpeed: usize = 0xCC0; // float32
                pub const m_flStartPosition: usize = 0xCC4; // float32
            }
            // Parent: CEntityComponent
            // Fields count: 10
            ...
            pub mod CMarkupVolumeWithRef {
                ...
                pub const m_flRefDot: usize = 0xA44; // float32
            }
            // Parent: CPhysForce
            // Fields count: 1
            ...
            pub mod CCitadelSoundOpvarSetOBB {
                ...
                pub const m_iszOperatorName: usize = 0x7B0; // CUtlSymbolLarge
                pub const m_iszOpvarName: usize = 0x7B8; // CUtlSymbolLarge
                pub const m_vDistanceInnerMins: usize = 0x7C0; // Vector
                pub const m_vDistanceInnerMaxs: usize = 0x7CC; // Vector
                pub const m_vDistanceOuterMins: usize = 0x7D8; // Vector
                pub const m_vDistanceOuterMaxs: usize = 0x7E4; // Vector
                pub const m_nAABBDirection: usize = 0x7F0; // int32
            }
            // Parent: None
            // Fields count: 5
            //
            ...
            pub mod CShatterGlassShardPhysics {
                pub const m_bDebris: usize = 0xEEF; // bool
                pub const m_hParentShard: usize = 0xEF0; // uint32
                pub const m_ShardDesc: usize = 0xEF8; // shard_model_desc_t
            }
            // Parent: CBaseFilter
            // Fields count: 1
            pub mod CFilterModel {
                pub const m_iFilterModel: usize = 0x7F8; // CUtlSymbolLarge
            }
            ...
            pub mod CCSPlayerPawnBase {
                pub const m_CTouchExpansionComponent: usize = 0xEB8; // CTouchExpansionComponent
                pub const m_pPingServices: usize = 0xF08; // CCSPlayer_PingServices*
                pub const m_pViewModelServices: usize = 0xF10; // CPlayer_ViewModelServices*
                pub const m_blindUntilTime: usize = 0xF18; // GameTime_t
                pub const m_blindStartTime: usize = 0xF1C; // GameTime_t
                pub const m_iPlayerState: usize = 0xF20; // CSPlayerState
                pub const m_bRespawning: usize = 0xFD0; // bool
                pub const m_fImmuneToGunGameDamageTime: usize = 0xFD4; // GameTime_t
                pub const m_bGunGameImmunity: usize = 0xFD8; // bool
                pub const m_fMolotovDamageTime: usize = 0xFDC; // float32
                pub const m_bHasMovedSinceSpawn: usize = 0xFE0; // bool
                pub const m_iNumSpawns: usize = 0xFE4; // int32
                pub const m_flIdleTimeSinceLastAction: usize = 0xFEC; // float32
                pub const m_fNextRadarUpdateTime: usize = 0xFF0; // float32
                pub const m_flFlashDuration: usize = 0xFF4; // float32
                pub const m_flFlashMaxAlpha: usize = 0xFF8; // float32
                pub const m_flProgressBarStartTime: usize = 0xFFC; // float32
                pub const m_iProgressBarDuration: usize = 0x1000; // int32
                pub const m_angEyeAngles: usize = 0x1004; // QAngle
                pub const m_wasNotKilledNaturally: usize = 0x1010; // bool
                pub const m_bCommittingSuicideOnTeamChange: usize = 0x1011; // bool
                pub const m_hOriginalController: usize = 0x1014; // CHandle<CCSPlayerController>
            }
            // Parent: CPointEntity
            // Fields count: 9
            pub mod CPathTrack {
                ...
                pub const m_flRadius: usize = 0x7C0; // float32
                pub const m_length: usize = 0x7C4; // float32
                pub const m_altName: usize = 0x7C8; // CUtlSymbolLarge
                pub const m_nIterVal: usize = 0x7D0; // int32
            ...
            pub mod CInfoOffscreenPanoramaTexture {
                pub const m_bDisabled: usize = 0x7A4; // bool
                pub const m_nResolutionX: usize = 0x7A8; // int32
                pub const m_nResolutionY: usize = 0x7AC; // int32
                pub const m_szLayoutFileName: usize = 0x7B0; // CUtlSymbolLarge
                pub const m_RenderAttrName: usize = 0x7B8; // CUtlSymbolLarge
                pub const m_TargetEntities: usize = 0x7C0; // CNetworkUtlVectorBase<CHandle<CBaseModelEntity>>
                pub const m_nTargetChangeCount: usize = 0x7D8; // int32
                pub const m_vecCSSClasses: usize = 0x7E0; // CNetworkUtlVectorBase<CUtlSymbolLarge>
                pub const m_szTargetsName: usize = 0x7F8; // CUtlSymbolLarge
                pub const m_AdditionalTargetEntities: usize = 0x800; // CUtlVector<CHandle<CBaseModelEntity>>
            }
            // Parent: CBaseEntity
            // Fields count: 3
            //
            ...
            pub mod CInfoVisibilityBox {
                pub const m_nMode: usize = 0x7A8; // int32
                pub const m_vBoxSize: usize = 0x7AC; // Vector
                pub const m_bEnabled: usize = 0x7B8; // bool
            }
            // Parent: CRulePointEntity
            // Fields count: 0
            ...
            pub mod CEntityFlame {
                pub const m_hEntAttached: usize = 0x7A4; // CHandle<CBaseEntity>
                pub const m_bCheapEffect: usize = 0x7A8; // bool
                pub const m_flSize: usize = 0x7AC; // float32
                pub const m_bUseHitboxes: usize = 0x7B0; // bool
                pub const m_iNumHitboxFires: usize = 0x7B4; // int32
                pub const m_flHitboxFireScale: usize = 0x7B8; // float32
                pub const m_flLifetime: usize = 0x7BC; // GameTime_t
                pub const m_hAttacker: usize = 0x7C0; // CHandle<CBaseEntity>
                pub const m_iDangerSound: usize = 0x7C4; // int32
                pub const m_flDirectDamagePerSecond: usize = 0x7C8; // float32
                pub const m_iCustomDamageType: usize = 0x7CC; // int32
            }
            // Parent: CCSWeaponBase
            // Fields count: 9
            //
            ...
            pub mod CCSWeaponBaseGun {
                pub const m_zoomLevel: usize = 0x11A0; // int32
                pub const m_iBurstShotsRemaining: usize = 0x11A4; // int32
                pub const m_silencedModelIndex: usize = 0x11B0; // int32
                pub const m_inPrecache: usize = 0x11B4; // bool
                pub const m_bNeedsBoltAction: usize = 0x11B5; // bool
                pub const m_bSkillReloadAvailable: usize = 0x11B6; // bool
                pub const m_bSkillReloadLiftedReloadKey: usize = 0x11B7; // bool
                pub const m_bSkillBoltInterruptAvailable: usize = 0x11B8; // bool
                pub const m_bSkillBoltLiftedFireKey: usize = 0x11B9; // bool
            }
            // Parent: None
            // Fields count: 13
            pub mod CBot {
                ...
                pub const m_forwardSpeed: usize = 0xAC; // float32
                pub const m_leftSpeed: usize = 0xB0; // float32
                pub const m_verticalSpeed: usize = 0xB4; // float32
                pub const m_buttonFlags: usize = 0xB8; // uint64
                pub const m_jumpTimestamp: usize = 0xC0; // float32
                pub const m_viewForward: usize = 0xC4; // Vector
                pub const m_postureStackIndex: usize = 0xE0; // int32
            }
            // Parent: None
            // Fields count: 11
            //
            ...
            pub mod CSoundEventParameter {
                ...
                pub const m_flFloatValue: usize = 0x7B8; // float32
            }
            ...
            // Fields count: 5
            pub mod CTestEffect {
                pub const m_iLoop: usize = 0x7A4; // int32
                pub const m_iBeam: usize = 0x7A8; // int32
            ...
            pub mod CConstraintAnchor {
                pub const m_massScale: usize = 0xBF0; // float32
            }
            // Parent: CCSWeaponBaseGun
            // Fields count: 0
            pub mod CWeaponTec9 {
            ...
            pub mod CSceneEntity {
                ...
                pub const m_sTargetAttachment: usize = 0x820; // CUtlSymbolLarge
                pub const m_bIsPlayingBack: usize = 0x828; // bool
                pub const m_bPaused: usize = 0x829; // bool
                pub const m_bMultiplayer: usize = 0x82A; // bool
                pub const m_bAutogenerated: usize = 0x82B; // bool
                pub const m_flForceClientTime: usize = 0x82C; // float32
                pub const m_flCurrentTime: usize = 0x830; // float32
                pub const m_flFrameTime: usize = 0x834; // float32
                pub const m_bCancelAtNextInterrupt: usize = 0x838; // bool
                pub const m_fPitch: usize = 0x83C; // float32
                pub const m_bAutomated: usize = 0x840; // bool
                pub const m_nAutomatedAction: usize = 0x844; // int32
                pub const m_flAutomationDelay: usize = 0x848; // float32
                pub const m_flAutomationTime: usize = 0x84C; // float32
                pub const m_hWaitingForThisResumeScene: usize = 0x850; // CHandle<CBaseEntity>
                pub const m_bWaitingForResumeScene: usize = 0x854; // bool
                pub const m_bPausedViaInput: usize = 0x855; // bool
                pub const m_bPauseAtNextInterrupt: usize = 0x856; // bool
                pub const m_bWaitingForActor: usize = 0x857; // bool
                pub const m_bWaitingForInterrupt: usize = 0x858; // bool
                pub const m_bInterruptedActorsScenes: usize = 0x859; // bool
                pub const m_bBreakOnNonIdle: usize = 0x85A; // bool
                pub const m_bSceneFinished: usize = 0x85B; // bool
                pub const m_hActorList: usize = 0x860; // CNetworkUtlVectorBase<CHandle<CBaseFlex>>
                pub const m_hRemoveActorList: usize = 0x878; // CUtlVector<CHandle<CBaseEntity>>
                pub const m_nSceneFlushCounter: usize = 0x8C0; // int32
                pub const m_nSceneStringIndex: usize = 0x8C4; // uint16
                pub const m_OnStart: usize = 0x8C8; // CEntityIOOutput
                pub const m_OnCompletion: usize = 0x8F0; // CEntityIOOutput
                pub const m_OnCanceled: usize = 0x918; // CEntityIOOutput
                pub const m_OnPaused: usize = 0x940; // CEntityIOOutput
                pub const m_OnResumed: usize = 0x968; // CEntityIOOutput
                pub const m_OnTrigger: usize = 0x990; // CEntityIOOutput[16]
                pub const m_hInterruptScene: usize = 0xCA0; // CHandle<CSceneEntity>
                pub const m_nInterruptCount: usize = 0xCA4; // int32
                pub const m_bSceneMissing: usize = 0xCA8; // bool
                pub const m_bInterrupted: usize = 0xCA9; // bool
                pub const m_bCompletedEarly: usize = 0xCAA; // bool
                pub const m_bInterruptSceneFinished: usize = 0xCAB; // bool
                pub const m_bRestoring: usize = 0xCAC; // bool
                pub const m_hNotifySceneCompletion: usize = 0xCB0; // CUtlVector<CHandle<CSceneEntity>>
                pub const m_hListManagers: usize = 0xCC8; // CUtlVector<CHandle<CSceneListManager>>
                pub const m_iszSoundName: usize = 0xCE0; // CUtlSymbolLarge
                pub const m_iszSequenceName: usize = 0xCE8; // CUtlSymbolLarge
                pub const m_hActor: usize = 0xCF0; // CHandle<CBaseFlex>
                pub const m_hActivator: usize = 0xCF4; // CHandle<CBaseEntity>
                pub const m_BusyActor: usize = 0xCF8; // int32
                pub const m_iPlayerDeathBehavior: usize = 0xCFC; // SceneOnPlayerDeath_t
            }
            ...
            pub mod CLogicActiveAutosave {
                pub const m_TriggerHitPoints: usize = 0x7B0; // int32
                pub const m_flTimeToTrigger: usize = 0x7B4; // float32
                pub const m_flStartTime: usize = 0x7B8; // GameTime_t
                pub const m_flDangerousTime: usize = 0x7BC; // float32
            }
            // Parent: CBaseEntity
            // Fields count: 2
            pub mod CEnvBeverage {
                pub const m_CanInDispenser: usize = 0x7A4; // bool
                pub const m_nBeverageType: usize = 0x7A8; // int32
            }
            // Parent: CBaseEntity
            // Fields count: 14
            //
            ...
            pub mod CVoteController {
                pub const m_iActiveIssueIndex: usize = 0x7A4; // int32
                pub const m_iOnlyTeamToVote: usize = 0x7A8; // int32
                pub const m_nVoteOptionCount: usize = 0x7AC; // int32[5]
                pub const m_nPotentialVotes: usize = 0x7C0; // int32
                pub const m_bIsYesNoVote: usize = 0x7C4; // bool
                pub const m_acceptingVotesTimer: usize = 0x7C8; // CountdownTimer
                pub const m_executeCommandTimer: usize = 0x7E0; // CountdownTimer
                pub const m_resetVoteTimer: usize = 0x7F8; // CountdownTimer
                pub const m_nVotesCast: usize = 0x810; // int32[64]
                pub const m_playerHoldingVote: usize = 0x910; // CPlayerSlot
                pub const m_playerOverrideForVote: usize = 0x914; // CPlayerSlot
                pub const m_nHighestCountIndex: usize = 0x918; // int32
                pub const m_potentialIssues: usize = 0x920; // CUtlVector<CBaseIssue*>
                pub const m_VoteOptions: usize = 0x938; // CUtlVector<char*>
            }
            // Parent: CCSWeaponBaseGun
            // Fields count: 0
            ...
            pub mod CBaseFlex {
                ...
                pub const m_nNextSceneEventId: usize = 0xC70; // SceneEventId_t
                pub const m_bUpdateLayerPriorities: usize = 0xC74; // bool
            }
            // Parent: CTriggerHurt
            // Fields count: 1
            pub mod CScriptTriggerHurt {
                pub const m_vExtent: usize = 0xC60; // Vector
            }
            ...
            pub mod CMathColorBlend {
                pub const m_flInMin: usize = 0x7A4; // float32
                pub const m_flInMax: usize = 0x7A8; // float32
                pub const m_OutColor1: usize = 0x7AC; // Color
                pub const m_OutColor2: usize = 0x7B0; // Color
            ...
            pub mod CCSPlayerPawn {
                pub const m_pBulletServices: usize = 0x1020; // CCSPlayer_BulletServices*
                pub const m_pHostageServices: usize = 0x1028; // CCSPlayer_HostageServices*
                pub const m_pBuyServices: usize = 0x1030; // CCSPlayer_BuyServices*
                pub const m_pActionTrackingServices: usize = 0x1038; // CCSPlayer_ActionTrackingServices*
                pub const m_pRadioServices: usize = 0x1040; // CCSPlayer_RadioServices*
                pub const m_pDamageReactServices: usize = 0x1048; // CCSPlayer_DamageReactServices*
                pub const m_nCharacterDefIndex: usize = 0x1050; // uint16
                pub const m_bHasFemaleVoice: usize = 0x1052; // bool
                pub const m_strVOPrefix: usize = 0x1058; // CUtlString
                pub const m_szLastPlaceName: usize = 0x1060; // char[18]
                pub const m_bInHostageResetZone: usize = 0x1120; // bool
                pub const m_bInBuyZone: usize = 0x1121; // bool
                pub const m_TouchingBuyZones: usize = 0x1128; // CUtlVector<CHandle<CBaseEntity>>
                pub const m_bWasInBuyZone: usize = 0x1140; // bool
                pub const m_bInHostageRescueZone: usize = 0x1141; // bool
                pub const m_bInBombZone: usize = 0x1142; // bool
                pub const m_bWasInHostageRescueZone: usize = 0x1143; // bool
                pub const m_iRetakesOffering: usize = 0x1144; // int32
                pub const m_iRetakesOfferingCard: usize = 0x1148; // int32
                pub const m_bRetakesHasDefuseKit: usize = 0x114C; // bool
                pub const m_bRetakesMVPLastRound: usize = 0x114D; // bool
                pub const m_iRetakesMVPBoostItem: usize = 0x1150; // int32
                pub const m_RetakesMVPBoostExtraUtility: usize = 0x1154; // loadout_slot_t
                pub const m_flHealthShotBoostExpirationTime: usize = 0x1158; // GameTime_t
                pub const m_flLandingTimeSeconds: usize = 0x115C; // float32
                pub const m_aimPunchAngle: usize = 0x1160; // QAngle
                pub const m_aimPunchAngleVel: usize = 0x116C; // QAngle
                pub const m_aimPunchTickBase: usize = 0x1178; // int32
                pub const m_aimPunchTickFraction: usize = 0x117C; // float32
                pub const m_aimPunchCache: usize = 0x1180; // CUtlVector<QAngle>
                pub const m_bIsBuyMenuOpen: usize = 0x1198; // bool
                pub const m_xLastHeadBoneTransform: usize = 0x17E0; // CTransform
                pub const m_bLastHeadBoneTransformIsValid: usize = 0x1800; // bool
                pub const m_lastLandTime: usize = 0x1804; // GameTime_t
                pub const m_bOnGroundLastTick: usize = 0x1808; // bool
                pub const m_iPlayerLocked: usize = 0x180C; // int32
                pub const m_flTimeOfLastInjury: usize = 0x1814; // GameTime_t
                pub const m_flNextSprayDecalTime: usize = 0x1818; // GameTime_t
                pub const m_bNextSprayDecalTimeExpedited: usize = 0x181C; // bool
                pub const m_nRagdollDamageBone: usize = 0x1820; // int32
                pub const m_vRagdollDamageForce: usize = 0x1824; // Vector
                pub const m_vRagdollDamagePosition: usize = 0x1830; // Vector
                pub const m_szRagdollDamageWeaponName: usize = 0x183C; // char[64]
                pub const m_bRagdollDamageHeadshot: usize = 0x187C; // bool
                pub const m_vRagdollServerOrigin: usize = 0x1880; // Vector
                pub const m_EconGloves: usize = 0x1890; // CEconItemView
                pub const m_nEconGlovesChanged: usize = 0x1B08; // uint8
                pub const m_qDeathEyeAngles: usize = 0x1B0C; // QAngle
                pub const m_bSkipOneHeadConstraintUpdate: usize = 0x1B18; // bool
                pub const m_bLeftHanded: usize = 0x1B19; // bool
                pub const m_fSwitchedHandednessTime: usize = 0x1B1C; // GameTime_t
                pub const m_flViewmodelOffsetX: usize = 0x1B20; // float32
                pub const m_flViewmodelOffsetY: usize = 0x1B24; // float32
                pub const m_flViewmodelOffsetZ: usize = 0x1B28; // float32
                pub const m_flViewmodelFOV: usize = 0x1B2C; // float32
                pub const m_bIsWalking: usize = 0x1B30; // bool
                pub const m_fLastGivenDefuserTime: usize = 0x1B34; // float32
                pub const m_fLastGivenBombTime: usize = 0x1B38; // float32
                pub const m_flDealtDamageToEnemyMostRecentTimestamp: usize = 0x1B3C; // float32
                pub const m_iDisplayHistoryBits: usize = 0x1B40; // uint32
                pub const m_flLastAttackedTeammate: usize = 0x1B44; // float32
                pub const m_allowAutoFollowTime: usize = 0x1B48; // GameTime_t
                pub const m_bResetArmorNextSpawn: usize = 0x1B4C; // bool
                pub const m_nLastKillerIndex: usize = 0x1B50; // CEntityIndex
                pub const m_entitySpottedState: usize = 0x1B58; // EntitySpottedState_t
                pub const m_nSpotRules: usize = 0x1B70; // int32
                pub const m_bIsScoped: usize = 0x1B74; // bool
                pub const m_bResumeZoom: usize = 0x1B75; // bool
                pub const m_bIsDefusing: usize = 0x1B76; // bool
                pub const m_bIsGrabbingHostage: usize = 0x1B77; // bool
                pub const m_iBlockingUseActionInProgress: usize = 0x1B78; // CSPlayerBlockingUseAction_t
                pub const m_flEmitSoundTime: usize = 0x1B7C; // GameTime_t
                pub const m_bInNoDefuseArea: usize = 0x1B80; // bool
                pub const m_iBombSiteIndex: usize = 0x1B84; // CEntityIndex
                pub const m_nWhichBombZone: usize = 0x1B88; // int32
                pub const m_bInBombZoneTrigger: usize = 0x1B8C; // bool
                pub const m_bWasInBombZoneTrigger: usize = 0x1B8D; // bool
                pub const m_iShotsFired: usize = 0x1B90; // int32
                pub const m_flFlinchStack: usize = 0x1B94; // float32
                pub const m_flVelocityModifier: usize = 0x1B98; // float32
                pub const m_flHitHeading: usize = 0x1B9C; // float32
                pub const m_nHitBodyPart: usize = 0x1BA0; // int32
                pub const m_vecTotalBulletForce: usize = 0x1BA4; // Vector
                pub const m_bWaitForNoAttack: usize = 0x1BB0; // bool
                pub const m_ignoreLadderJumpTime: usize = 0x1BB4; // float32
                pub const m_bKilledByHeadshot: usize = 0x1BB8; // bool
                pub const m_LastHitBox: usize = 0x1BBC; // int32
                pub const m_LastHealth: usize = 0x1BC0; // int32
                pub const m_pBot: usize = 0x1BC8; // CCSBot*
                pub const m_bBotAllowActive: usize = 0x1BD0; // bool
                pub const m_thirdPersonHeading: usize = 0x1BD4; // QAngle
                pub const m_flSlopeDropOffset: usize = 0x1BE0; // float32
                pub const m_flSlopeDropHeight: usize = 0x1BE4; // float32
                pub const m_vHeadConstraintOffset: usize = 0x1BE8; // Vector
                pub const m_nLastPickupPriority: usize = 0x1BF4; // int32
                pub const m_flLastPickupPriorityTime: usize = 0x1BF8; // float32
                pub const m_ArmorValue: usize = 0x1BFC; // int32
                pub const m_unCurrentEquipmentValue: usize = 0x1C00; // uint16
                pub const m_unRoundStartEquipmentValue: usize = 0x1C02; // uint16
                pub const m_unFreezetimeEndEquipmentValue: usize = 0x1C04; // uint16
                pub const m_iLastWeaponFireUsercmd: usize = 0x1C08; // int32
                pub const m_flLastFriendlyFireDamageReductionRatio: usize = 0x1C0C; // float32
                pub const m_bIsSpawning: usize = 0x1C10; // bool
                pub const m_iDeathFlags: usize = 0x1C20; // int32
                pub const m_bHasDeathInfo: usize = 0x1C24; // bool
                pub const m_flDeathInfoTime: usize = 0x1C28; // float32
                pub const m_vecDeathInfoOrigin: usize = 0x1C2C; // Vector
                pub const m_vecPlayerPatchEconIndices: usize = 0x1C38; // uint32[5]
                pub const m_GunGameImmunityColor: usize = 0x1C4C; // Color
                pub const m_grenadeParameterStashTime: usize = 0x1C50; // GameTime_t
                pub const m_bGrenadeParametersStashed: usize = 0x1C54; // bool
                pub const m_angStashedShootAngles: usize = 0x1C58; // QAngle
                pub const m_vecStashedGrenadeThrowPosition: usize = 0x1C64; // Vector
                pub const m_vecStashedVelocity: usize = 0x1C70; // Vector
                pub const m_angShootAngleHistory: usize = 0x1C7C; // QAngle[2]
                pub const m_vecThrowPositionHistory: usize = 0x1C94; // Vector[2]
                pub const m_vecVelocityHistory: usize = 0x1CAC; // Vector[2]
            }
            // Parent: CBaseGrenade
            // Fields count: 0
            ...
            pub mod CCSPlayerController {
                pub const m_pInGameMoneyServices: usize = 0xA38; // CCSPlayerController_InGameMoneyServices*
                pub const m_pInventoryServices: usize = 0xA40; // CCSPlayerController_InventoryServices*
                pub const m_pActionTrackingServices: usize = 0xA48; // CCSPlayerController_ActionTrackingServices*
                pub const m_pDamageServices: usize = 0xA50; // CCSPlayerController_DamageServices*
                pub const m_iPing: usize = 0xA58; // uint32
                pub const m_bHasCommunicationAbuseMute: usize = 0xA5C; // bool
                pub const m_szCrosshairCodes: usize = 0xA60; // CUtlSymbolLarge
                pub const m_iPendingTeamNum: usize = 0xA68; // uint8
                pub const m_flForceTeamTime: usize = 0xA6C; // GameTime_t
                pub const m_iCompTeammateColor: usize = 0xA70; // int32
                pub const m_bEverPlayedOnTeam: usize = 0xA74; // bool
                pub const m_bAttemptedToGetColor: usize = 0xA75; // bool
                pub const m_iTeammatePreferredColor: usize = 0xA78; // int32
                pub const m_bTeamChanged: usize = 0xA7C; // bool
                pub const m_bInSwitchTeam: usize = 0xA7D; // bool
                pub const m_bHasSeenJoinGame: usize = 0xA7E; // bool
                pub const m_bJustBecameSpectator: usize = 0xA7F; // bool
                pub const m_bSwitchTeamsOnNextRoundReset: usize = 0xA80; // bool
                pub const m_bRemoveAllItemsOnNextRoundReset: usize = 0xA81; // bool
                pub const m_szClan: usize = 0xA88; // CUtlSymbolLarge
                pub const m_szClanName: usize = 0xA90; // char[32]
                pub const m_iCoachingTeam: usize = 0xAB0; // int32
                pub const m_nPlayerDominated: usize = 0xAB8; // uint64
                pub const m_nPlayerDominatingMe: usize = 0xAC0; // uint64
                pub const m_iCompetitiveRanking: usize = 0xAC8; // int32
                pub const m_iCompetitiveWins: usize = 0xACC; // int32
                pub const m_iCompetitiveRankType: usize = 0xAD0; // int8
                pub const m_iCompetitiveRankingPredicted_Win: usize = 0xAD4; // int32
                pub const m_iCompetitiveRankingPredicted_Loss: usize = 0xAD8; // int32
                pub const m_iCompetitiveRankingPredicted_Tie: usize = 0xADC; // int32
                pub const m_nEndMatchNextMapVote: usize = 0xAE0; // int32
                pub const m_unActiveQuestId: usize = 0xAE4; // uint16
                pub const m_nQuestProgressReason: usize = 0xAE8; // QuestProgress::Reason
                pub const m_unPlayerTvControlFlags: usize = 0xAEC; // uint32
                pub const m_iDraftIndex: usize = 0xB18; // int32
                pub const m_msQueuedModeDisconnectionTimestamp: usize = 0xB1C; // uint32
                pub const m_uiAbandonRecordedReason: usize = 0xB20; // uint32
                pub const m_bCannotBeKicked: usize = 0xB24; // bool
                pub const m_bEverFullyConnected: usize = 0xB25; // bool
                pub const m_bAbandonAllowsSurrender: usize = 0xB26; // bool
                pub const m_bAbandonOffersInstantSurrender: usize = 0xB27; // bool
                pub const m_bDisconnection1MinWarningPrinted: usize = 0xB28; // bool
                pub const m_bScoreReported: usize = 0xB29; // bool
                pub const m_nDisconnectionTick: usize = 0xB2C; // int32
                pub const m_bControllingBot: usize = 0xB38; // bool
                pub const m_bHasControlledBotThisRound: usize = 0xB39; // bool
                pub const m_bHasBeenControlledByPlayerThisRound: usize = 0xB3A; // bool
                pub const m_nBotsControlledThisRound: usize = 0xB3C; // int32
                pub const m_bCanControlObservedBot: usize = 0xB40; // bool
                pub const m_hPlayerPawn: usize = 0xB44; // CHandle<CCSPlayerPawn>
                pub const m_hObserverPawn: usize = 0xB48; // CHandle<CCSObserverPawn>
                pub const m_DesiredObserverMode: usize = 0xB4C; // int32
                pub const m_hDesiredObserverTarget: usize = 0xB50; // CEntityHandle
                pub const m_bPawnIsAlive: usize = 0xB54; // bool
                pub const m_iPawnHealth: usize = 0xB58; // uint32
                pub const m_iPawnArmor: usize = 0xB5C; // int32
                pub const m_bPawnHasDefuser: usize = 0xB60; // bool
                pub const m_bPawnHasHelmet: usize = 0xB61; // bool
                pub const m_nPawnCharacterDefIndex: usize = 0xB62; // uint16
                pub const m_iPawnLifetimeStart: usize = 0xB64; // int32
                pub const m_iPawnLifetimeEnd: usize = 0xB68; // int32
                pub const m_iPawnBotDifficulty: usize = 0xB6C; // int32
                pub const m_hOriginalControllerOfCurrentPawn: usize = 0xB70; // CHandle<CCSPlayerController>
                pub const m_iScore: usize = 0xB74; // int32
                pub const m_iRoundScore: usize = 0xB78; // int32
                pub const m_iRoundsWon: usize = 0xB7C; // int32
                pub const m_vecKills: usize = 0xB80; // CNetworkUtlVectorBase<EKillTypes_t>
                pub const m_bMvpNoMusic: usize = 0xB98; // bool
                pub const m_eMvpReason: usize = 0xB9C; // int32
                pub const m_iMusicKitID: usize = 0xBA0; // int32
                pub const m_iMusicKitMVPs: usize = 0xBA4; // int32
                pub const m_iMVPs: usize = 0xBA8; // int32
                pub const m_nUpdateCounter: usize = 0xBAC; // int32
                pub const m_flSmoothedPing: usize = 0xBB0; // float32
                pub const m_lastHeldVoteTimer: usize = 0xFC58; // IntervalTimer
                pub const m_bShowHints: usize = 0xFC70; // bool
                pub const m_iNextTimeCheck: usize = 0xFC74; // int32
                pub const m_bJustDidTeamKill: usize = 0xFC78; // bool
                pub const m_bPunishForTeamKill: usize = 0xFC79; // bool
                pub const m_bGaveTeamDamageWarning: usize = 0xFC7A; // bool
                pub const m_bGaveTeamDamageWarningThisRound: usize = 0xFC7B; // bool
                pub const m_dblLastReceivedPacketPlatFloatTime: usize = 0xFC80; // float64
                pub const m_LastTeamDamageWarningTime: usize = 0xFC88; // GameTime_t
                pub const m_LastTimePlayerWasDisconnectedForPawnsRemove: usize = 0xFC8C; // GameTime_t
                pub const m_nSuspiciousHitCount: usize = 0xFC90; // uint32
                pub const m_nNonSuspiciousHitStreak: usize = 0xFC94; // uint32
            }
            ...
            pub mod CBasePlayerPawn {
                ...
                pub const m_nHighestGeneratedServerViewAngleChangeIndex: usize = 0xDB0; // uint32
                pub const v_angle: usize = 0xDB4; // QAngle
                pub const v_anglePrevious: usize = 0xDC0; // QAngle
                pub const m_iHideHUD: usize = 0xDCC; // uint32
                pub const m_skybox3d: usize = 0xDD0; // sky3dparams_t
                pub const m_fTimeLastHurt: usize = 0xE60; // GameTime_t
                pub const m_flDeathTime: usize = 0xE64; // GameTime_t
                pub const m_fNextSuicideTime: usize = 0xE68; // GameTime_t
                pub const m_fInitHUD: usize = 0xE6C; // bool
                pub const m_pExpresser: usize = 0xE70; // CAI_Expresser*
                pub const m_hController: usize = 0xE78; // CHandle<CBasePlayerController>
                pub const m_fHltvReplayDelay: usize = 0xE80; // float32
                pub const m_fHltvReplayEnd: usize = 0xE84; // float32
                pub const m_iHltvReplayEntity: usize = 0xE88; // CEntityIndex
                pub const m_sndOpvarLatchData: usize = 0xE90; // CUtlVector<sndopvarlatchdata_t>
            }
            // Parent: CBaseTrigger
            // Fields count: 16
            //
            ...
            pub mod CPostProcessingVolume {
                pub const m_hPostSettings: usize = 0xBD8; // CStrongHandle<InfoForResourceTypeCPostProcessingResource>
                pub const m_flFadeDuration: usize = 0xBE0; // float32
                pub const m_flMinLogExposure: usize = 0xBE4; // float32
                pub const m_flMaxLogExposure: usize = 0xBE8; // float32
                pub const m_flMinExposure: usize = 0xBEC; // float32
                pub const m_flMaxExposure: usize = 0xBF0; // float32
                pub const m_flExposureCompensation: usize = 0xBF4; // float32
                pub const m_flExposureFadeSpeedUp: usize = 0xBF8; // float32
                pub const m_flExposureFadeSpeedDown: usize = 0xBFC; // float32
                pub const m_flTonemapEVSmoothingRange: usize = 0xC00; // float32
                pub const m_bMaster: usize = 0xC04; // bool
                pub const m_bExposureControl: usize = 0xC05; // bool
                pub const m_flRate: usize = 0xC08; // float32
                pub const m_flTonemapPercentTarget: usize = 0xC0C; // float32
                pub const m_flTonemapPercentBrightPixels: usize = 0xC10; // float32
                pub const m_flTonemapMinAvgLum: usize = 0xC14; // float32
            }
            // Parent: CBaseModelEntity
            // Fields count: 4
            //
            ...
            pub mod CCSGO_TeamPreviewCharacterPosition {
                pub const m_nVariant: usize = 0x7A4; // int32
                pub const m_nRandom: usize = 0x7A8; // int32
                pub const m_nOrdinal: usize = 0x7AC; // int32
                pub const m_sWeaponName: usize = 0x7B0; // CUtlString
                pub const m_xuid: usize = 0x7B8; // uint64
                pub const m_agentItem: usize = 0x7C0; // CEconItemView
                pub const m_glovesItem: usize = 0xA38; // CEconItemView
                pub const m_weaponItem: usize = 0xCB0; // CEconItemView
            }
            // Parent: CBaseTrigger
            // Fields count: 1
            pub mod CTriggerDetectExplosion {
                pub const m_OnDetectedExplosion: usize = 0xC00; // CEntityIOOutput
            }
            // Parent: CLogicalEntity
            // Fields count: 1
            ...
            // Fields count: 18
            pub mod CPhysHinge {
                pub const m_soundInfo: usize = 0x828; // ConstraintSoundInfo
                pub const m_NotifyMinLimitReached: usize = 0x8B0; // CEntityIOOutput
                pub const m_NotifyMaxLimitReached: usize = 0x8D8; // CEntityIOOutput
                pub const m_bAtMinLimit: usize = 0x900; // bool
                pub const m_bAtMaxLimit: usize = 0x901; // bool
                pub const m_hinge: usize = 0x904; // constraint_hingeparams_t
                pub const m_hingeFriction: usize = 0x944; // float32
                pub const m_systemLoadScale: usize = 0x948; // float32
                pub const m_bIsAxisLocal: usize = 0x94C; // bool
                pub const m_flMinRotation: usize = 0x950; // float32
                pub const m_flMaxRotation: usize = 0x954; // float32
                pub const m_flInitialRotation: usize = 0x958; // float32
                pub const m_flMotorFrequency: usize = 0x95C; // float32
                pub const m_flMotorDampingRatio: usize = 0x960; // float32
                pub const m_flAngleSpeed: usize = 0x964; // float32
                pub const m_flAngleSpeedThreshold: usize = 0x968; // float32
                pub const m_OnStartMoving: usize = 0x970; // CEntityIOOutput
                pub const m_OnStopMoving: usize = 0x998; // CEntityIOOutput
            }
            // Parent: CGameRules
            // Fields count: 1
            ...
            pub mod CFilterProximity {
                pub const m_flRadius: usize = 0x7F8; // float32
            }
            // Parent: CEconEntity
            // Fields count: 2
            pub mod CEconWearable {
                pub const m_nForceSkin: usize = 0xF78; // int32
            ...
            pub mod CMathCounter {
                pub const m_flMin: usize = 0x7A4; // float32
                pub const m_flMax: usize = 0x7A8; // float32
                pub const m_bHitMin: usize = 0x7AC; // bool
                pub const m_bHitMax: usize = 0x7AD; // bool
                pub const m_bDisabled: usize = 0x7AE; // bool
                pub const m_OutValue: usize = 0x7B0; // CEntityOutputTemplate<float32>
                pub const m_OnGetValue: usize = 0x7D8; // CEntityOutputTemplate<float32>
                pub const m_OnHitMin: usize = 0x800; // CEntityIOOutput
                pub const m_OnHitMax: usize = 0x828; // CEntityIOOutput
                pub const m_OnChangedFromMin: usize = 0x850; // CEntityIOOutput
                pub const m_OnChangedFromMax: usize = 0x878; // CEntityIOOutput
            }
            // Parent: CBaseEntity
            // Fields count: 7
            //
            ...
            // NetworkVarNames: m_Entity_bEnabled (bool)
            pub mod CEnvCubemap {
                pub const m_Entity_hCubemapTexture: usize = 0x828; // CStrongHandle<InfoForResourceTypeCTextureBase>
                pub const m_Entity_bCustomCubemapTexture: usize = 0x830; // bool
                pub const m_Entity_flInfluenceRadius: usize = 0x834; // float32
                pub const m_Entity_vBoxProjectMins: usize = 0x838; // Vector
                pub const m_Entity_vBoxProjectMaxs: usize = 0x844; // Vector
                pub const m_Entity_bMoveable: usize = 0x850; // bool
                pub const m_Entity_nHandshake: usize = 0x854; // int32
                pub const m_Entity_nEnvCubeMapArrayIndex: usize = 0x858; // int32
                pub const m_Entity_nPriority: usize = 0x85C; // int32
                pub const m_Entity_flEdgeFadeDist: usize = 0x860; // float32
                pub const m_Entity_vEdgeFadeDists: usize = 0x864; // Vector
                pub const m_Entity_flDiffuseScale: usize = 0x870; // float32
                pub const m_Entity_bStartDisabled: usize = 0x874; // bool
                pub const m_Entity_bDefaultEnvMap: usize = 0x875; // bool
                pub const m_Entity_bDefaultSpecEnvMap: usize = 0x876; // bool
                pub const m_Entity_bIndoorCubeMap: usize = 0x877; // bool
                pub const m_Entity_bCopyDiffuseFromDefaultCubemap: usize = 0x878; // bool
                pub const m_Entity_bEnabled: usize = 0x888; // bool
            }
            // Parent: CPlayerPawnComponent
            // Fields count: 0
            ...
            pub mod CColorCorrection {
                pub const m_flFadeInDuration: usize = 0x7A4; // float32
                pub const m_flFadeOutDuration: usize = 0x7A8; // float32
                pub const m_flStartFadeInWeight: usize = 0x7AC; // float32
                pub const m_flStartFadeOutWeight: usize = 0x7B0; // float32
                pub const m_flTimeStartFadeIn: usize = 0x7B4; // GameTime_t
                pub const m_flTimeStartFadeOut: usize = 0x7B8; // GameTime_t
                pub const m_flMaxWeight: usize = 0x7BC; // float32
                pub const m_bStartDisabled: usize = 0x7C0; // bool
                pub const m_bEnabled: usize = 0x7C1; // bool
                pub const m_bMaster: usize = 0x7C2; // bool
                pub const m_bClientSide: usize = 0x7C3; // bool
                pub const m_bExclusive: usize = 0x7C4; // bool
                pub const m_MinFalloff: usize = 0x7C8; // float32
                pub const m_MaxFalloff: usize = 0x7CC; // float32
                pub const m_flCurWeight: usize = 0x7D0; // float32
                pub const m_netlookupFilename: usize = 0x7D4; // char[512]
            ...
            // NetworkVarNames: m_entitySpottedState (EntitySpottedState_t)
            pub mod CC4 {
                pub const m_vecLastValidPlayerHeldPosition: usize = 0x11A0; // Vector
                pub const m_vecLastValidDroppedPosition: usize = 0x11AC; // Vector
                pub const m_bDoValidDroppedPositionCheck: usize = 0x11B8; // bool
                pub const m_bStartedArming: usize = 0x11B9; // bool
                pub const m_fArmedTime: usize = 0x11BC; // GameTime_t
                pub const m_bBombPlacedAnimation: usize = 0x11C0; // bool
                pub const m_bIsPlantingViaUse: usize = 0x11C1; // bool
                pub const m_entitySpottedState: usize = 0x11C8; // EntitySpottedState_t
                pub const m_nSpotRules: usize = 0x11E0; // int32
                pub const m_bPlayedArmingBeeps: usize = 0x11E4; // bool[7]
                pub const m_bBombPlanted: usize = 0x11EB; // bool
            }
            ...
            pub mod CTankTrainAI {
                pub const m_hTrain: usize = 0x7A4; // CHandle<CFuncTrackTrain>
                pub const m_hTargetEntity: usize = 0x7A8; // CHandle<CBaseEntity>
                pub const m_soundPlaying: usize = 0x7AC; // int32
                pub const m_startSoundName: usize = 0x7C0; // CUtlSymbolLarge
                pub const m_engineSoundName: usize = 0x7C8; // CUtlSymbolLarge
                pub const m_movementSoundName: usize = 0x7D0; // CUtlSymbolLarge
            ...
            pub mod CGameGibManager {
                ...
                pub const m_iCurrentMaxPieces: usize = 0x7CC; // int32
                pub const m_iMaxPieces: usize = 0x7D0; // int32
                pub const m_iLastFrame: usize = 0x7D4; // int32
            }
            // Parent: CBasePulseGraphInstance
            // Fields count: 1
            //
            ...
            // Fields count: 3
            pub mod SpawnPoint {
                pub const m_iPriority: usize = 0x7A4; // int32
                pub const m_bEnabled: usize = 0x7A8; // bool
                pub const m_nType: usize = 0x7AC; // int32
            }
            // Parent: CCSWeaponBaseGun
            // Fields count: 0
            ...
            // Fields count: 5
            pub mod CEnvSpark {
                pub const m_flDelay: usize = 0x7A4; // float32
                pub const m_nMagnitude: usize = 0x7A8; // int32
                pub const m_nTrailLength: usize = 0x7AC; // int32
            ...
            pub mod CHostage {
                ...
                pub const m_OnFirstPickedUp: usize = 0xD50; // CEntityIOOutput
                pub const m_OnDroppedNotRescued: usize = 0xD78; // CEntityIOOutput
                pub const m_OnRescued: usize = 0xDA0; // CEntityIOOutput
                pub const m_entitySpottedState: usize = 0xDC8; // EntitySpottedState_t
                pub const m_nSpotRules: usize = 0xDE0; // int32
                pub const m_uiHostageSpawnExclusionGroupMask: usize = 0xDE4; // uint32
                pub const m_nHostageSpawnRandomFactor: usize = 0xDE8; // uint32
                pub const m_bRemove: usize = 0xDEC; // bool
                pub const m_vel: usize = 0xDF0; // Vector
                pub const m_isRescued: usize = 0xDFC; // bool
                pub const m_jumpedThisFrame: usize = 0xDFD; // bool
                pub const m_nHostageState: usize = 0xE00; // int32
                pub const m_leader: usize = 0xE04; // CHandle<CBaseEntity>
                pub const m_lastLeader: usize = 0xE08; // CHandle<CCSPlayerPawnBase>
                pub const m_reuseTimer: usize = 0xE10; // CountdownTimer
                pub const m_hasBeenUsed: usize = 0xE28; // bool
                pub const m_accel: usize = 0xE2C; // Vector
                pub const m_isRunning: usize = 0xE38; // bool
                pub const m_isCrouching: usize = 0xE39; // bool
                pub const m_jumpTimer: usize = 0xE40; // CountdownTimer
                pub const m_isWaitingForLeader: usize = 0xE58; // bool
                pub const m_repathTimer: usize = 0x2E68; // CountdownTimer
                pub const m_inhibitDoorTimer: usize = 0x2E80; // CountdownTimer
                pub const m_inhibitObstacleAvoidanceTimer: usize = 0x2F10; // CountdownTimer
                pub const m_wiggleTimer: usize = 0x2F30; // CountdownTimer
                pub const m_isAdjusted: usize = 0x2F4C; // bool
                pub const m_bHandsHaveBeenCut: usize = 0x2F4D; // bool
                pub const m_hHostageGrabber: usize = 0x2F50; // CHandle<CCSPlayerPawn>
                pub const m_fLastGrabTime: usize = 0x2F54; // GameTime_t
                pub const m_vecPositionWhenStartedDroppingToGround: usize = 0x2F58; // Vector
                pub const m_vecGrabbedPos: usize = 0x2F64; // Vector
                pub const m_flRescueStartTime: usize = 0x2F70; // GameTime_t
                pub const m_flGrabSuccessTime: usize = 0x2F74; // GameTime_t
                pub const m_flDropStartTime: usize = 0x2F78; // GameTime_t
                pub const m_nApproachRewardPayouts: usize = 0x2F7C; // int32
                pub const m_nPickupEventCount: usize = 0x2F80; // int32
                pub const m_vecSpawnGroundPos: usize = 0x2F84; // Vector
                pub const m_vecHostageResetPosition: usize = 0x2FA4; // Vector
            }
            // Parent: CPointEntity
            // Fields count: 13
            pub mod CNavLinkAreaEntity {
                pub const m_flWidth: usize = 0x7A4; // float32
                pub const m_vLocatorOffset: usize = 0x7A8; // Vector
                pub const m_qLocatorAnglesOffset: usize = 0x7B4; // QAngle
                pub const m_strMovementForward: usize = 0x7C0; // CUtlSymbolLarge
                pub const m_strMovementReverse: usize = 0x7C8; // CUtlSymbolLarge
                pub const m_nNavLinkIdForward: usize = 0x7D0; // int32
                pub const m_nNavLinkIdReverse: usize = 0x7D4; // int32
                pub const m_bEnabled: usize = 0x7D8; // bool
                pub const m_strFilterName: usize = 0x7E0; // CUtlSymbolLarge
                pub const m_hFilter: usize = 0x7E8; // CHandle<CBaseFilter>
                pub const m_OnNavLinkStart: usize = 0x7F0; // CEntityIOOutput
                pub const m_OnNavLinkFinish: usize = 0x818; // CEntityIOOutput
                pub const m_bIsTerminus: usize = 0x840; // bool
            }
            // Parent: CBaseToggle
            // Fields count: 12
            //
            ...
            pub mod CFuncMoveLinear {
                ...
                pub const m_OnFullyOpen: usize = 0xAC0; // CEntityIOOutput
                pub const m_OnFullyClosed: usize = 0xAE8; // CEntityIOOutput
                pub const m_bCreateMovableNavMesh: usize = 0xB10; // bool
                pub const m_bCreateNavObstacle: usize = 0xB11; // bool
            }
            // Parent: CBaseEntity
            // Fields count: 3
            ...
            // Fields count: 8
            pub mod CMapInfo {
                pub const m_iBuyingStatus: usize = 0x7A4; // int32
                pub const m_flBombRadius: usize = 0x7A8; // float32
                pub const m_iPetPopulation: usize = 0x7AC; // int32
                pub const m_bUseNormalSpawnsForDM: usize = 0x7B0; // bool
                pub const m_bDisableAutoGeneratedDMSpawns: usize = 0x7B1; // bool
                pub const m_flBotMaxVisionDistance: usize = 0x7B4; // float32
                pub const m_iHostageCount: usize = 0x7B8; // int32
                pub const m_bFadePlayerVisibilityFarZ: usize = 0x7BC; // bool
            }
            // Parent: CBaseTrigger
            // Fields count: 0
            ...
            pub mod CBaseEntity {
                ...
                pub const m_aThinkFunctions: usize = 0x4E0; // CUtlVector<thinkfunc_t>
                pub const m_iCurrentThinkContext: usize = 0x4F8; // int32
                pub const m_nLastThinkTick: usize = 0x4FC; // GameTick_t
                pub const m_bDisabledContextThinks: usize = 0x500; // bool
                pub const m_isSteadyState: usize = 0x510; // CBitVec<64>
                pub const m_lastNetworkChange: usize = 0x518; // float32
                pub const m_ResponseContexts: usize = 0x530; // CUtlVector<ResponseContext_t>
                pub const m_iszResponseContext: usize = 0x548; // CUtlSymbolLarge
                pub const m_iHealth: usize = 0x590; // int32
                pub const m_iMaxHealth: usize = 0x594; // int32
                pub const m_lifeState: usize = 0x598; // uint8
                pub const m_flDamageAccumulator: usize = 0x59C; // float32
                pub const m_bTakesDamage: usize = 0x5A0; // bool
                pub const m_nTakeDamageFlags: usize = 0x5A8; // TakeDamageFlags_t
                pub const m_bIsPlatform: usize = 0x5B0; // bool
                pub const m_MoveCollide: usize = 0x5B2; // MoveCollide_t
                pub const m_MoveType: usize = 0x5B3; // MoveType_t
                pub const m_nActualMoveType: usize = 0x5B4; // MoveType_t
                pub const m_nWaterTouch: usize = 0x5B5; // uint8
                pub const m_nSlimeTouch: usize = 0x5B6; // uint8
                pub const m_bRestoreInHierarchy: usize = 0x5B7; // bool
                pub const m_target: usize = 0x5B8; // CUtlSymbolLarge
                pub const m_hDamageFilter: usize = 0x5C0; // CHandle<CBaseFilter>
                pub const m_iszDamageFilterName: usize = 0x5C8; // CUtlSymbolLarge
                pub const m_flMoveDoneTime: usize = 0x5D0; // float32
                pub const m_nSubclassID: usize = 0x5D4; // CUtlStringToken
                pub const m_flAnimTime: usize = 0x5E0; // float32
                pub const m_flSimulationTime: usize = 0x5E4; // float32
                pub const m_flCreateTime: usize = 0x5E8; // GameTime_t
                pub const m_bClientSideRagdoll: usize = 0x5EC; // bool
                pub const m_ubInterpolationFrame: usize = 0x5ED; // uint8
                pub const m_vPrevVPhysicsUpdatePos: usize = 0x5F0; // Vector
                pub const m_iTeamNum: usize = 0x5FC; // uint8
                pub const m_iGlobalname: usize = 0x600; // CUtlSymbolLarge
                pub const m_iSentToClients: usize = 0x608; // int32
                pub const m_flSpeed: usize = 0x60C; // float32
                pub const m_sUniqueHammerID: usize = 0x610; // CUtlString
                pub const m_spawnflags: usize = 0x618; // uint32
                pub const m_nNextThinkTick: usize = 0x61C; // GameTick_t
                pub const m_nSimulationTick: usize = 0x620; // int32
                pub const m_OnKilled: usize = 0x628; // CEntityIOOutput
                pub const m_fFlags: usize = 0x650; // uint32
                pub const m_vecAbsVelocity: usize = 0x654; // Vector
                pub const m_vecVelocity: usize = 0x660; // CNetworkVelocityVector
                pub const m_vecBaseVelocity: usize = 0x690; // Vector
                pub const m_nPushEnumCount: usize = 0x69C; // int32
                pub const m_pCollision: usize = 0x6A0; // CCollisionProperty*
                pub const m_hEffectEntity: usize = 0x6A8; // CHandle<CBaseEntity>
                pub const m_hOwnerEntity: usize = 0x6AC; // CHandle<CBaseEntity>
                pub const m_fEffects: usize = 0x6B0; // uint32
                pub const m_hGroundEntity: usize = 0x6B4; // CHandle<CBaseEntity>
                pub const m_nGroundBodyIndex: usize = 0x6B8; // int32
                pub const m_flFriction: usize = 0x6BC; // float32
                pub const m_flElasticity: usize = 0x6C0; // float32
                pub const m_flGravityScale: usize = 0x6C4; // float32
                pub const m_flTimeScale: usize = 0x6C8; // float32
                pub const m_flWaterLevel: usize = 0x6CC; // float32
                pub const m_bAnimatedEveryTick: usize = 0x6D0; // bool
                pub const m_bDisableLowViolence: usize = 0x6D1; // bool
                pub const m_nWaterType: usize = 0x6D2; // uint8
                pub const m_iEFlags: usize = 0x6D4; // int32
                pub const m_OnUser1: usize = 0x6D8; // CEntityIOOutput
                pub const m_OnUser2: usize = 0x700; // CEntityIOOutput
                pub const m_OnUser3: usize = 0x728; // CEntityIOOutput
                pub const m_OnUser4: usize = 0x750; // CEntityIOOutput
                pub const m_iInitialTeamNum: usize = 0x778; // int32
                pub const m_flNavIgnoreUntilTime: usize = 0x77C; // GameTime_t
                pub const m_vecAngVelocity: usize = 0x780; // QAngle
                pub const m_bNetworkQuantizeOriginAndAngles: usize = 0x78C; // bool
                pub const m_bLagCompensate: usize = 0x78D; // bool
                pub const m_flOverriddenFriction: usize = 0x790; // float32
                pub const m_pBlocker: usize = 0x794; // CHandle<CBaseEntity>
                pub const m_flLocalTime: usize = 0x798; // float32
                pub const m_flVPhysicsUpdateLocalTime: usize = 0x79C; // float32
                pub const m_nBloodType: usize = 0x7A0; // BloodType
            }
            // Parent: CLogicalEntity
            // Fields count: 9
            pub mod CLogicMeasureMovement {
                ...
                pub const m_flScale: usize = 0x7D0; // float32
                pub const m_nMeasureType: usize = 0x7D4; // int32
            }
            // Parent: None
            // Fields count: 3
            //
