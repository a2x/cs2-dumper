...
namespace CS2Dumper.Schemas {
    ...
    public static class Vphysics2Dll {
        ...
        public static class PhysFeModelDesc_t {
            ...
            public const nint m_AxialEdges = 0x168; // 
            public const nint m_NodeInvMasses = 0x180; // 
            public const nint m_CtrlOffsets = 0x198; // 
            public const nint m_CtrlOsOffsets = 0x1B0; // 
            public const nint m_FollowNodes = 0x1C8; // 
            ...
            public const nint m_LegacyStretchForce = 0x258; // 
            public const nint m_NodeCollisionRadii = 0x270; // 
            public const nint m_DynNodeFriction = 0x288; // 
            public const nint m_LocalRotation = 0x2A0; // 
            public const nint m_LocalForce = 0x2B8; // 
            ...
            public const nint m_SphereRigids = 0x300; // 
            public const nint m_WorldCollisionNodes = 0x318; // 
            public const nint m_TreeParents = 0x330; // 
            public const nint m_TreeCollisionMasks = 0x348; // 
            public const nint m_TreeChildren = 0x360; // 
            public const nint m_FreeNodes = 0x378; // 
            public const nint m_FitMatrices = 0x390; // 
            public const nint m_FitWeights = 0x3A8; // 
            ...
            public const nint m_KelagerBends = 0x408; // 
            ...
            public const nint m_SourceElems = 0x450; // 
            public const nint m_GoalDampedSpringIntegrators = 0x468; // 
            public const nint m_Tris = 0x480; // 
            public const nint m_nTriCount1 = 0x498; // 
            public const nint m_nTriCount2 = 0x49A; // 
            public const nint m_nReservedUint8 = 0x49C; // 
            public const nint m_nExtraPressureIterations = 0x49D; // 
            public const nint m_nExtraGoalIterations = 0x49E; // 
            public const nint m_nExtraIterations = 0x49F; // 
            public const nint m_BoxRigids = 0x4A0; // 
            public const nint m_DynNodeVertexSet = 0x4B8; // 
            public const nint m_VertexSetNames = 0x4D0; // 
            ...
            public const nint m_MorphSetData = 0x518; // 
            public const nint m_VertexMaps = 0x530; // 
            public const nint m_VertexMapValues = 0x548; // 
            public const nint m_Effects = 0x560; // 
            public const nint m_LockToParent = 0x578; // 
            public const nint m_LockToGoal = 0x590; // 
            public const nint m_SkelParents = 0x5A8; // 
            public const nint m_DynNodeWindBases = 0x5C0; // 
            public const nint m_flInternalPressure = 0x5D8; // 
            public const nint m_flDefaultTimeDilation = 0x5DC; // 
            public const nint m_flWindage = 0x5E0; // 
            public const nint m_flWindDrag = 0x5E4; // 
            public const nint m_flDefaultSurfaceStretch = 0x5E8; // 
            public const nint m_flDefaultThreadStretch = 0x5EC; // 
            public const nint m_flDefaultGravityScale = 0x5F0; // 
            public const nint m_flDefaultVelAirDrag = 0x5F4; // 
            public const nint m_flDefaultExpAirDrag = 0x5F8; // 
            public const nint m_flDefaultVelQuadAirDrag = 0x5FC; // 
            public const nint m_flDefaultExpQuadAirDrag = 0x600; // 
            public const nint m_flRodVelocitySmoothRate = 0x604; // 
            public const nint m_flQuadVelocitySmoothRate = 0x608; // 
            public const nint m_flAddWorldCollisionRadius = 0x60C; // 
            public const nint m_flDefaultVolumetricSolveAmount = 0x610; // 
            public const nint m_flMotionSmoothCDT = 0x614; // 
            public const nint m_nRodVelocitySmoothIterations = 0x618; // 
            public const nint m_nQuadVelocitySmoothIterations = 0x61A; // 
        }
        // Parent: RnBodyDesc_t
        // Field count: 1
        //
