    ...
    pub mod schemas {
        ...
        pub mod libanimationsystem_so {
            ...
            pub mod CNmFootIKTask {
                pub const m_nLeftEffectorBoneIdx: usize = 0x60; // int32
                pub const m_nRightEffectorBoneIdx: usize = 0x64; // int32
                pub const m_leftTargetTransform: usize = 0x70; // CTransform
                pub const m_rightTargetTransform: usize = 0x90; // CTransform
                pub const m_nLeftTargetBoneIdx: usize = 0xB0; // int32
                pub const m_nRightTargetBoneIdx: usize = 0xB4; // int32
                pub const m_leftTarget: usize = 0xC0; // CNmTarget
                pub const m_rightTarget: usize = 0xF0; // CNmTarget
                pub const m_blendMode: usize = 0x120; // NmIKBlendMode_t
                pub const m_flBlendWeight: usize = 0x124; // float32
                pub const m_bIsTargetInWorldSpace: usize = 0x128; // bool
                pub const m_bIsRunningFromDeserializedData: usize = 0x129; // bool
            }
            // Parent: None
            // Fields count: 3
            //
            ...
            pub mod CNmIDEventNode__CDefinition {
                ...
                pub const m_defaultValue: usize = 0x10; // CGlobalSymbol
            }
            // Parent: None
            // Fields count: 17
            //
            ...
            pub mod CNmFloatEaseNode__CDefinition {
                ...
                pub const m_easingOp: usize = 0x16; // NmEasingOperation_t
                pub const m_bUseStartValue: usize = 0x17; // bool
            }
            // Parent: None
            // Fields count: 1
            //
            ...
            pub mod CNmChainLookatNode__CDefinition {
                pub const m_endEffectorBoneID: usize = 0x10; // CGlobalSymbol
                pub const m_endEffectorForwardAxis: usize = 0x18; // Vector
                pub const m_endEffectorOffset: usize = 0x24; // Vector
                pub const m_nLookatTargetNodeIdx: usize = 0x30; // int16
                pub const m_nEnabledNodeIdx: usize = 0x32; // int16
                pub const m_flBlendTimeSeconds: usize = 0x34; // float32
                pub const m_chainWeights: usize = 0x38; // CUtlVectorFixedGrowable<float32,5>
                pub const m_nChainLength: usize = 0x68; // uint8
                pub const m_bIsTargetInWorldSpace: usize = 0x69; // bool
            }
            // Parent: None
            // Fields count: 4
            //
            ...
            pub mod CNmIDEventConditionNode__CDefinition {
                pub const m_nSourceStateNodeIdx: usize = 0xA; // int16
                pub const m_eventConditionRules: usize = 0xC; // CNmBitFlags
                pub const m_eventIDs: usize = 0x10; // CUtlVectorFixedGrowable<CGlobalSymbol,5>
            }
            // Parent: None
            // Fields count: 3
            //
            ...
            pub mod CNmStateNode__CDefinition {
                ...
                pub const m_executeEvents: usize = 0x30; // CUtlLeanVectorFixedGrowable<CGlobalSymbol,3>
                pub const m_exitEvents: usize = 0x50; // CUtlLeanVectorFixedGrowable<CGlobalSymbol,3>
                pub const m_timedRemainingEvents: usize = 0x70; // CUtlLeanVectorFixedGrowable<CNmStateNode::TimedEvent_t,1>
                pub const m_timedElapsedEvents: usize = 0x88; // CUtlLeanVectorFixedGrowable<CNmStateNode::TimedEvent_t,1>
            ...
            pub mod CNmBoneMaskSelectorNode__CDefinition {
                ...
                pub const m_maskNodeIndices: usize = 0x10; // CUtlLeanVectorFixedGrowable<int16,8>
                pub const m_parameterValues: usize = 0x28; // CUtlLeanVectorFixedGrowable<CGlobalSymbol,7>
                pub const m_flBlendTimeSeconds: usize = 0x68; // float32
            }
            // Parent: None
            // Fields count: 1
            //
            ...
            pub mod CNmTimeConditionNode__CDefinition {
                ...
                pub const m_flComparand: usize = 0x10; // float32
            ...
            pub mod CNmSyncEventIndexConditionNode__CDefinition {
                ...
                pub const m_syncEventIdx: usize = 0x10; // int32
            }
            // Parent: None
            // Fields count: 3
            //
            ...
            pub mod CNmIDToFloatNode__CDefinition {
                ...
                pub const m_IDs: usize = 0x10; // CUtlLeanVectorFixedGrowable<CGlobalSymbol,5>
                pub const m_values: usize = 0x40; // CUtlLeanVectorFixedGrowable<float32,5>
            }
            // Parent: None
            // Fields count: 3
            //
            ...
            pub mod CAnimationGroup {
                ...
                pub const m_AdditionalExtRefs: usize = 0x120; // CUtlVector<CStrongHandleVoid>
            }
            // Parent: None
            // Fields count: 2
            //
            ...
            pub mod CNmTwoBoneIKNode__CDefinition {
                ...
                pub const m_flChainRotationWeight: usize = 0x24; // float32
            }
            // Parent: None
            // Fields count: 0
            ...
            pub mod CNmFloatSpringNode__CDefinition {
                pub const m_flStartValue: usize = 0xC; // float32
                pub const m_flHertz: usize = 0x10; // float32
                pub const m_flDampingRatio: usize = 0x14; // float32
                pub const m_nInputValueNodeIdx: usize = 0x18; // int16
                pub const m_bUseStartValue: usize = 0x1A; // bool
            }
            // Parent: None
            // Fields count: 7
            //
            ...
            pub mod CNmTwoBoneIKTask {
                pub const m_nEffectorBoneIdx: usize = 0x60; // int32
                pub const m_nEffectorTargetBoneIdx: usize = 0x64; // int32
                pub const m_targetTransform: usize = 0x70; // CTransform
                ...
                pub const m_flChainRotationWeight: usize = 0xCC; // float32
            ...
            pub mod CNmRootMotionOverrideNode__CDefinition {
                ...
                pub const m_linearVelocityLimitNodeIdx: usize = 0x10; // int16
                pub const m_angularVelocityLimitNodeIdx: usize = 0x12; // int16
                pub const m_enabledNodeIdx: usize = 0x14; // int16
                pub const m_maxLinearVelocity: usize = 0x18; // float32
                pub const m_maxAngularVelocityRadians: usize = 0x1C; // float32
                pub const m_overrideFlags: usize = 0x20; // CNmBitFlags
            }
            // Parent: None
            // Fields count: 11
            //
            ...
            pub mod CNmTargetWarpNode__CDefinition {
                ...
                pub const m_targetUpdateRule: usize = 0xF; // CNmTargetWarpNode::TargetUpdateRule_t
                ...
                pub const m_alignmentBoneID: usize = 0x28; // CGlobalSymbol
            }
            // Parent: None
            // Fields count: 6
            //
            ...
            pub mod CNmFloatComparisonNode__CDefinition {
                ...
                pub const m_comparison: usize = 0xE; // CNmFloatComparisonNode::Comparison_t
                pub const m_flEpsilon: usize = 0x10; // float32
            ...
            pub mod CNmLayerBlendNode__CDefinition {
                ...
                pub const m_layerDefinition: usize = 0x10; // CUtlLeanVectorFixedGrowable<CNmLayerBlendNode::LayerDefinition_t,3>
            }
            // Parent: None
            // Fields count: 8
            //
            ...
            pub mod CNmFootIKNode__CDefinition {
                pub const m_leftEffectorBoneID: usize = 0x10; // CGlobalSymbol
                pub const m_rightEffectorBoneID: usize = 0x18; // CGlobalSymbol
                pub const m_nLeftTargetNodeIdx: usize = 0x20; // int16
                pub const m_nRightTargetNodeIdx: usize = 0x22; // int16
                pub const m_nEnabledNodeIdx: usize = 0x24; // int16
                pub const m_flBlendTimeSeconds: usize = 0x28; // float32
                pub const m_blendMode: usize = 0x2C; // NmIKBlendMode_t
                pub const m_bIsTargetInWorldSpace: usize = 0x2D; // bool
            }
            // Parent: None
            // Fields count: 2
            //
            ...
            pub mod CNmFloatRemapNode__CDefinition {
                ...
                pub const m_outputRange: usize = 0x14; // CNmFloatRemapNode::RemapRange_t
            }
            // Parent: None
            // Fields count: 2
            //
            ...
            pub mod CNmAnimationPoseNode__CDefinition {
                ...
                pub const m_inputTimeRemapRange: usize = 0x10; // Range_t
                pub const m_flUserSpecifiedTime: usize = 0x18; // float32
                pub const m_bUseFramesAsInput: usize = 0x1C; // bool
            }
            // Parent: None
            // Fields count: 3
            //
