...
namespace cs2_dumper {
    namespace schemas {
        ...
        namespace libclient_so {
            ...
            // Fields count: 1
            namespace C_Item {
                constexpr std::ptrdiff_t m_pReticleHintTextName = 0x2460; // char[256]
            }
            ...
            namespace C_SoundEventPathCornerEntity {
                constexpr std::ptrdiff_t m_vecCornerPairsNetworked = 0x6D0; // C_NetworkUtlVectorBase<SoundeventPathCornerPairNetworked_t>
            }
            // Parent: C_CSWeaponBaseGun
            // Fields count: 0
            ...
            namespace C_CSGameRules {
                ...
                constexpr std::ptrdiff_t m_nMatchAbortedEarlyReason = 0xD20; // int32
                constexpr std::ptrdiff_t m_bHasTriggeredRoundStartMusic = 0xD24; // bool
                constexpr std::ptrdiff_t m_bSwitchingTeamsAtRoundReset = 0xD25; // bool
                constexpr std::ptrdiff_t m_pGameModeRules = 0xD40; // CCSGameModeRules*
                constexpr std::ptrdiff_t m_RetakeRules = 0xD48; // C_RetakeGameRules
                constexpr std::ptrdiff_t m_nMatchEndCount = 0xE60; // uint8
                constexpr std::ptrdiff_t m_nTTeamIntroVariant = 0xE64; // int32
                constexpr std::ptrdiff_t m_nCTTeamIntroVariant = 0xE68; // int32
                constexpr std::ptrdiff_t m_bTeamIntroPeriod = 0xE6C; // bool
                constexpr std::ptrdiff_t m_iRoundEndWinnerTeam = 0xE70; // int32
                constexpr std::ptrdiff_t m_eRoundEndReason = 0xE74; // int32
                constexpr std::ptrdiff_t m_bRoundEndShowTimerDefend = 0xE78; // bool
                constexpr std::ptrdiff_t m_iRoundEndTimerTime = 0xE7C; // int32
                constexpr std::ptrdiff_t m_sRoundEndFunFactToken = 0xE80; // CUtlString
                constexpr std::ptrdiff_t m_iRoundEndFunFactPlayerSlot = 0xE88; // CPlayerSlot
                constexpr std::ptrdiff_t m_iRoundEndFunFactData1 = 0xE8C; // int32
                constexpr std::ptrdiff_t m_iRoundEndFunFactData2 = 0xE90; // int32
                constexpr std::ptrdiff_t m_iRoundEndFunFactData3 = 0xE94; // int32
                constexpr std::ptrdiff_t m_sRoundEndMessage = 0xE98; // CUtlString
                constexpr std::ptrdiff_t m_iRoundEndPlayerCount = 0xEA0; // int32
                constexpr std::ptrdiff_t m_bRoundEndNoMusic = 0xEA4; // bool
                constexpr std::ptrdiff_t m_iRoundEndLegacy = 0xEA8; // int32
                constexpr std::ptrdiff_t m_nRoundEndCount = 0xEAC; // uint8
                constexpr std::ptrdiff_t m_iRoundStartRoundNumber = 0xEB0; // int32
                constexpr std::ptrdiff_t m_nRoundStartCount = 0xEB4; // uint8
                constexpr std::ptrdiff_t m_flLastPerfSampleTime = 0x4EC0; // float64
            }
            ...
            namespace C_PointClientUIHUD {
                ...
                constexpr std::ptrdiff_t m_bIgnoreInput = 0xE08; // bool
                constexpr std::ptrdiff_t m_flWidth = 0xE0C; // float32
                constexpr std::ptrdiff_t m_flHeight = 0xE10; // float32
                constexpr std::ptrdiff_t m_flDPI = 0xE14; // float32
                constexpr std::ptrdiff_t m_flInteractDistance = 0xE18; // float32
                constexpr std::ptrdiff_t m_flDepthOffset = 0xE1C; // float32
                constexpr std::ptrdiff_t m_unOwnerContext = 0xE20; // uint32
                constexpr std::ptrdiff_t m_unHorizontalAlign = 0xE24; // uint32
                constexpr std::ptrdiff_t m_unVerticalAlign = 0xE28; // uint32
                constexpr std::ptrdiff_t m_unOrientation = 0xE2C; // uint32
                constexpr std::ptrdiff_t m_bAllowInteractionFromAllSceneWorlds = 0xE30; // bool
                constexpr std::ptrdiff_t m_vecCSSClasses = 0xE38; // C_NetworkUtlVectorBase<CUtlSymbolLarge>
            }
            ...
            namespace C_PointCamera {
                constexpr std::ptrdiff_t m_FOV = 0x6CC; // float32
                constexpr std::ptrdiff_t m_Resolution = 0x6D0; // float32
                constexpr std::ptrdiff_t m_bFogEnable = 0x6D4; // bool
                constexpr std::ptrdiff_t m_FogColor = 0x6D5; // Color
                constexpr std::ptrdiff_t m_flFogStart = 0x6DC; // float32
                constexpr std::ptrdiff_t m_flFogEnd = 0x6E0; // float32
                constexpr std::ptrdiff_t m_flFogMaxDensity = 0x6E4; // float32
                constexpr std::ptrdiff_t m_bActive = 0x6E8; // bool
                constexpr std::ptrdiff_t m_bUseScreenAspectRatio = 0x6E9; // bool
                constexpr std::ptrdiff_t m_flAspectRatio = 0x6EC; // float32
                constexpr std::ptrdiff_t m_bNoSky = 0x6F0; // bool
                constexpr std::ptrdiff_t m_fBrightness = 0x6F4; // float32
                constexpr std::ptrdiff_t m_flZFar = 0x6F8; // float32
                constexpr std::ptrdiff_t m_flZNear = 0x6FC; // float32
                constexpr std::ptrdiff_t m_bCanHLTVUse = 0x700; // bool
                constexpr std::ptrdiff_t m_bDofEnabled = 0x701; // bool
                constexpr std::ptrdiff_t m_flDofNearBlurry = 0x704; // float32
                constexpr std::ptrdiff_t m_flDofNearCrisp = 0x708; // float32
                constexpr std::ptrdiff_t m_flDofFarCrisp = 0x70C; // float32
                constexpr std::ptrdiff_t m_flDofFarBlurry = 0x710; // float32
                constexpr std::ptrdiff_t m_flDofTiltToGround = 0x714; // float32
                constexpr std::ptrdiff_t m_TargetFOV = 0x718; // float32
                constexpr std::ptrdiff_t m_DegreesPerSecond = 0x71C; // float32
                constexpr std::ptrdiff_t m_bIsOn = 0x720; // bool
            ...
            namespace C_BaseCombatCharacter {
                ...
                constexpr std::ptrdiff_t m_leftFootAttachment = 0x1028; // AttachmentHandle_t
                constexpr std::ptrdiff_t m_rightFootAttachment = 0x1029; // AttachmentHandle_t
                constexpr std::ptrdiff_t m_nWaterWakeMode = 0x102C; // C_BaseCombatCharacter::WaterWakeMode_t
                constexpr std::ptrdiff_t m_flWaterWorldZ = 0x1030; // float32
                constexpr std::ptrdiff_t m_flWaterNextTraceTime = 0x1034; // float32
                constexpr std::ptrdiff_t m_flFieldOfView = 0x1038; // float32
            }
            ...
            namespace C_SoundEventSphereEntity {
                constexpr std::ptrdiff_t m_flRadius = 0x6CC; // float32
            }
            ...
            namespace C_LightGlow {
                ...
                constexpr std::ptrdiff_t m_GlowOverlay = 0xC70; // C_LightGlowOverlay
            }
            // Parent: None
            // Fields count: 4
            //
            ...
            namespace C_CSPlayerResource {
                constexpr std::ptrdiff_t m_bHostageAlive = 0x6CC; // bool[12]
                constexpr std::ptrdiff_t m_isHostageFollowingSomeone = 0x6D8; // bool[12]
                constexpr std::ptrdiff_t m_iHostageEntityIDs = 0x6E4; // CEntityIndex[12]
                constexpr std::ptrdiff_t m_bombsiteCenterA = 0x714; // Vector
                constexpr std::ptrdiff_t m_bombsiteCenterB = 0x720; // Vector
                constexpr std::ptrdiff_t m_hostageRescueX = 0x72C; // int32[4]
                constexpr std::ptrdiff_t m_hostageRescueY = 0x73C; // int32[4]
                constexpr std::ptrdiff_t m_hostageRescueZ = 0x74C; // int32[4]
                constexpr std::ptrdiff_t m_bEndMatchNextMapAllVoted = 0x75C; // bool
                constexpr std::ptrdiff_t m_foundGoalPositions = 0x75D; // bool
            }
            ...
            namespace C_CSGO_MapPreviewCameraPath {
                constexpr std::ptrdiff_t m_flZFar = 0x6CC; // float32
                constexpr std::ptrdiff_t m_flZNear = 0x6D0; // float32
                constexpr std::ptrdiff_t m_bLoop = 0x6D4; // bool
                constexpr std::ptrdiff_t m_bVerticalFOV = 0x6D5; // bool
                constexpr std::ptrdiff_t m_bConstantSpeed = 0x6D6; // bool
                constexpr std::ptrdiff_t m_flDuration = 0x6D8; // float32
            ...
            namespace C_Inferno {
                ...
                constexpr std::ptrdiff_t m_hInfernoPointsSnapshot = 0xC98; // CStrongHandle<InfoForResourceTypeIParticleSnapshot>
                constexpr std::ptrdiff_t m_hInfernoFillerPointsSnapshot = 0xCA0; // CStrongHandle<InfoForResourceTypeIParticleSnapshot>
                constexpr std::ptrdiff_t m_hInfernoOutlinePointsSnapshot = 0xCA8; // CStrongHandle<InfoForResourceTypeIParticleSnapshot>
                constexpr std::ptrdiff_t m_hInfernoClimbingOutlinePointsSnapshot = 0xCB0; // CStrongHandle<InfoForResourceTypeIParticleSnapshot>
                constexpr std::ptrdiff_t m_hInfernoDecalsSnapshot = 0xCB8; // CStrongHandle<InfoForResourceTypeIParticleSnapshot>
                constexpr std::ptrdiff_t m_firePositions = 0xCC0; // Vector[64]
                constexpr std::ptrdiff_t m_fireParentPositions = 0xFC0; // Vector[64]
                constexpr std::ptrdiff_t m_bFireIsBurning = 0x12C0; // bool[64]
                constexpr std::ptrdiff_t m_BurnNormal = 0x1300; // Vector[64]
                constexpr std::ptrdiff_t m_fireCount = 0x1600; // int32
                constexpr std::ptrdiff_t m_nInfernoType = 0x1604; // int32
                constexpr std::ptrdiff_t m_nFireLifetime = 0x1608; // float32
                constexpr std::ptrdiff_t m_bInPostEffectTime = 0x160C; // bool
                constexpr std::ptrdiff_t m_lastFireCount = 0x1610; // int32
                constexpr std::ptrdiff_t m_nFireEffectTickBegin = 0x1614; // int32
                constexpr std::ptrdiff_t m_drawableCount = 0x8220; // int32
                constexpr std::ptrdiff_t m_blosCheck = 0x8224; // bool
                constexpr std::ptrdiff_t m_nlosperiod = 0x8228; // int32
                constexpr std::ptrdiff_t m_maxFireHalfWidth = 0x822C; // float32
                constexpr std::ptrdiff_t m_maxFireHeight = 0x8230; // float32
                constexpr std::ptrdiff_t m_minBounds = 0x8234; // Vector
                constexpr std::ptrdiff_t m_maxBounds = 0x8240; // Vector
                constexpr std::ptrdiff_t m_flLastGrassBurnThink = 0x824C; // float32
            }
            // Parent: CBaseAnimGraph
            // Fields count: 0
            ...
            namespace C_CSGO_MapPreviewCameraPathNode {
                ...
                constexpr std::ptrdiff_t m_flCameraSpeed = 0x6F8; // float32
            ...
            namespace C_CSPlayerPawn {
                ...
                constexpr std::ptrdiff_t m_iRetakesOffering = 0x15F8; // int32
                constexpr std::ptrdiff_t m_iRetakesOfferingCard = 0x15FC; // int32
                constexpr std::ptrdiff_t m_bRetakesHasDefuseKit = 0x1600; // bool
                constexpr std::ptrdiff_t m_bRetakesMVPLastRound = 0x1601; // bool
                constexpr std::ptrdiff_t m_iRetakesMVPBoostItem = 0x1604; // int32
                constexpr std::ptrdiff_t m_RetakesMVPBoostExtraUtility = 0x1608; // loadout_slot_t
                constexpr std::ptrdiff_t m_bNeedToReApplyGloves = 0x1628; // bool
                constexpr std::ptrdiff_t m_EconGloves = 0x1630; // C_EconItemView
                constexpr std::ptrdiff_t m_nEconGlovesChanged = 0x2980; // uint8
                constexpr std::ptrdiff_t m_bMustSyncRagdollState = 0x2981; // bool
                constexpr std::ptrdiff_t m_nRagdollDamageBone = 0x2984; // int32
                constexpr std::ptrdiff_t m_vRagdollDamageForce = 0x2988; // Vector
                constexpr std::ptrdiff_t m_vRagdollDamagePosition = 0x2994; // Vector
                constexpr std::ptrdiff_t m_szRagdollDamageWeaponName = 0x29A0; // char[64]
                constexpr std::ptrdiff_t m_bRagdollDamageHeadshot = 0x29E0; // bool
                constexpr std::ptrdiff_t m_vRagdollServerOrigin = 0x29E4; // Vector
                constexpr std::ptrdiff_t m_bLastHeadBoneTransformIsValid = 0x2FF8; // bool
                constexpr std::ptrdiff_t m_lastLandTime = 0x2FFC; // GameTime_t
                constexpr std::ptrdiff_t m_bOnGroundLastTick = 0x3000; // bool
                constexpr std::ptrdiff_t m_qDeathEyeAngles = 0x301C; // QAngle
                constexpr std::ptrdiff_t m_bSkipOneHeadConstraintUpdate = 0x3028; // bool
                constexpr std::ptrdiff_t m_bLeftHanded = 0x3029; // bool
                constexpr std::ptrdiff_t m_fSwitchedHandednessTime = 0x302C; // GameTime_t
                constexpr std::ptrdiff_t m_flViewmodelOffsetX = 0x3030; // float32
                constexpr std::ptrdiff_t m_flViewmodelOffsetY = 0x3034; // float32
                constexpr std::ptrdiff_t m_flViewmodelOffsetZ = 0x3038; // float32
                constexpr std::ptrdiff_t m_flViewmodelFOV = 0x303C; // float32
                constexpr std::ptrdiff_t m_vecPlayerPatchEconIndices = 0x3040; // uint32[5]
                constexpr std::ptrdiff_t m_GunGameImmunityColor = 0x3078; // Color
                constexpr std::ptrdiff_t m_vecBulletHitModels = 0x30C8; // CUtlVector<C_BulletHitModel*>
                constexpr std::ptrdiff_t m_bIsWalking = 0x30E0; // bool
                constexpr std::ptrdiff_t m_thirdPersonHeading = 0x30E8; // QAngle
                constexpr std::ptrdiff_t m_flSlopeDropOffset = 0x3100; // float32
                constexpr std::ptrdiff_t m_flSlopeDropHeight = 0x3110; // float32
                constexpr std::ptrdiff_t m_vHeadConstraintOffset = 0x3120; // Vector
                constexpr std::ptrdiff_t m_entitySpottedState = 0x3138; // EntitySpottedState_t
                constexpr std::ptrdiff_t m_bIsScoped = 0x3150; // bool
                constexpr std::ptrdiff_t m_bResumeZoom = 0x3151; // bool
                constexpr std::ptrdiff_t m_bIsDefusing = 0x3152; // bool
                constexpr std::ptrdiff_t m_bIsGrabbingHostage = 0x3153; // bool
                constexpr std::ptrdiff_t m_iBlockingUseActionInProgress = 0x3154; // CSPlayerBlockingUseAction_t
                constexpr std::ptrdiff_t m_flEmitSoundTime = 0x3158; // GameTime_t
                constexpr std::ptrdiff_t m_bInNoDefuseArea = 0x315C; // bool
                constexpr std::ptrdiff_t m_nWhichBombZone = 0x3160; // int32
                constexpr std::ptrdiff_t m_iShotsFired = 0x3164; // int32
                constexpr std::ptrdiff_t m_flVelocityModifier = 0x3168; // float32
                constexpr std::ptrdiff_t m_flHitHeading = 0x316C; // float32
                constexpr std::ptrdiff_t m_nHitBodyPart = 0x3170; // int32
                constexpr std::ptrdiff_t m_bWaitForNoAttack = 0x3174; // bool
                constexpr std::ptrdiff_t m_ignoreLadderJumpTime = 0x3178; // float32
                constexpr std::ptrdiff_t m_bKilledByHeadshot = 0x317D; // bool
                constexpr std::ptrdiff_t m_ArmorValue = 0x3180; // int32
                constexpr std::ptrdiff_t m_unCurrentEquipmentValue = 0x3184; // uint16
                constexpr std::ptrdiff_t m_unRoundStartEquipmentValue = 0x3186; // uint16
                constexpr std::ptrdiff_t m_unFreezetimeEndEquipmentValue = 0x3188; // uint16
                constexpr std::ptrdiff_t m_nLastKillerIndex = 0x318C; // CEntityIndex
                constexpr std::ptrdiff_t m_bOldIsScoped = 0x3190; // bool
                constexpr std::ptrdiff_t m_bHasDeathInfo = 0x3191; // bool
                constexpr std::ptrdiff_t m_flDeathInfoTime = 0x3194; // float32
                constexpr std::ptrdiff_t m_vecDeathInfoOrigin = 0x3198; // Vector
                constexpr std::ptrdiff_t m_grenadeParameterStashTime = 0x31A4; // GameTime_t
                constexpr std::ptrdiff_t m_bGrenadeParametersStashed = 0x31A8; // bool
                constexpr std::ptrdiff_t m_angStashedShootAngles = 0x31AC; // QAngle
                constexpr std::ptrdiff_t m_vecStashedGrenadeThrowPosition = 0x31B8; // Vector
                constexpr std::ptrdiff_t m_vecStashedVelocity = 0x31C4; // Vector
                constexpr std::ptrdiff_t m_angShootAngleHistory = 0x31D0; // QAngle[2]
                constexpr std::ptrdiff_t m_vecThrowPositionHistory = 0x31E8; // Vector[2]
                constexpr std::ptrdiff_t m_vecVelocityHistory = 0x3200; // Vector[2]
            }
            ...
            namespace C_WeaponBaseItem {
                constexpr std::ptrdiff_t m_SequenceCompleteTimer = 0x2918; // CountdownTimer
                constexpr std::ptrdiff_t m_bRedraw = 0x2930; // bool
            }
            // Parent: None
            // Fields count: 21
            //
            ...
            namespace C_PointClientUIWorldPanel {
                ...
                constexpr std::ptrdiff_t m_pOffScreenIndicator = 0xE28; // CPointOffScreenIndicatorUi*
                constexpr std::ptrdiff_t m_bIgnoreInput = 0xE50; // bool
                constexpr std::ptrdiff_t m_bLit = 0xE51; // bool
                constexpr std::ptrdiff_t m_bFollowPlayerAcrossTeleport = 0xE52; // bool
                constexpr std::ptrdiff_t m_flWidth = 0xE54; // float32
                constexpr std::ptrdiff_t m_flHeight = 0xE58; // float32
                constexpr std::ptrdiff_t m_flDPI = 0xE5C; // float32
                constexpr std::ptrdiff_t m_flInteractDistance = 0xE60; // float32
                constexpr std::ptrdiff_t m_flDepthOffset = 0xE64; // float32
                constexpr std::ptrdiff_t m_unOwnerContext = 0xE68; // uint32
                constexpr std::ptrdiff_t m_unHorizontalAlign = 0xE6C; // uint32
                constexpr std::ptrdiff_t m_unVerticalAlign = 0xE70; // uint32
                constexpr std::ptrdiff_t m_unOrientation = 0xE74; // uint32
                constexpr std::ptrdiff_t m_bAllowInteractionFromAllSceneWorlds = 0xE78; // bool
                constexpr std::ptrdiff_t m_vecCSSClasses = 0xE80; // C_NetworkUtlVectorBase<CUtlSymbolLarge>
                constexpr std::ptrdiff_t m_bOpaque = 0xE98; // bool
                constexpr std::ptrdiff_t m_bNoDepth = 0xE99; // bool
                constexpr std::ptrdiff_t m_bRenderBackface = 0xE9A; // bool
                constexpr std::ptrdiff_t m_bUseOffScreenIndicator = 0xE9B; // bool
                constexpr std::ptrdiff_t m_bExcludeFromSaveGames = 0xE9C; // bool
                constexpr std::ptrdiff_t m_bGrabbable = 0xE9D; // bool
                constexpr std::ptrdiff_t m_bOnlyRenderToTexture = 0xE9E; // bool
                constexpr std::ptrdiff_t m_bDisableMipGen = 0xE9F; // bool
                constexpr std::ptrdiff_t m_nExplicitImageLayout = 0xEA0; // int32
            }
            // Parent: C_BaseEntity
            // Fields count: 0
            ...
            namespace C_SoundAreaEntityOrientedBox {
                constexpr std::ptrdiff_t m_vMin = 0x6EC; // Vector
                constexpr std::ptrdiff_t m_vMax = 0x6F8; // Vector
            }
            // Parent: C_BaseModelEntity
            // Fields count: 8
            //
            ...
            namespace CSkyboxReference {
                constexpr std::ptrdiff_t m_worldGroupId = 0x6CC; // WorldGroupId_t
                constexpr std::ptrdiff_t m_hSkyCamera = 0x6D0; // CHandle<C_SkyCamera>
            }
            ...
            namespace C_CSGOViewModel {
                ...
                constexpr std::ptrdiff_t m_vLoweredWeaponOffset = 0xF70; // QAngle
            }
            // Parent: CEntityComponent
            // Fields count: 1
            ...
            namespace C_EnvLightProbeVolume {
                constexpr std::ptrdiff_t m_Entity_hLightProbeTexture = 0x16B0; // CStrongHandle<InfoForResourceTypeCTextureBase>
                ...
                constexpr std::ptrdiff_t m_Entity_nPriority = 0x16F0; // int32
                constexpr std::ptrdiff_t m_Entity_bStartDisabled = 0x16F4; // bool
                constexpr std::ptrdiff_t m_Entity_nLightProbeSizeX = 0x16F8; // int32
                constexpr std::ptrdiff_t m_Entity_nLightProbeSizeY = 0x16FC; // int32
                constexpr std::ptrdiff_t m_Entity_nLightProbeSizeZ = 0x1700; // int32
                constexpr std::ptrdiff_t m_Entity_nLightProbeAtlasX = 0x1704; // int32
                constexpr std::ptrdiff_t m_Entity_nLightProbeAtlasY = 0x1708; // int32
                constexpr std::ptrdiff_t m_Entity_nLightProbeAtlasZ = 0x170C; // int32
                constexpr std::ptrdiff_t m_Entity_bEnabled = 0x1719; // bool
            }
            // Parent: CBaseAnimGraph
            // Fields count: 1
            ...
            namespace C_TeamRoundTimer {
                constexpr std::ptrdiff_t m_bTimerPaused = 0x6CC; // bool
                constexpr std::ptrdiff_t m_flTimeRemaining = 0x6D0; // float32
                constexpr std::ptrdiff_t m_flTimerEndTime = 0x6D4; // GameTime_t
                constexpr std::ptrdiff_t m_bIsDisabled = 0x6D8; // bool
                constexpr std::ptrdiff_t m_bShowInHUD = 0x6D9; // bool
                constexpr std::ptrdiff_t m_nTimerLength = 0x6DC; // int32
                constexpr std::ptrdiff_t m_nTimerInitialLength = 0x6E0; // int32
                constexpr std::ptrdiff_t m_nTimerMaxLength = 0x6E4; // int32
                constexpr std::ptrdiff_t m_bAutoCountdown = 0x6E8; // bool
                constexpr std::ptrdiff_t m_nSetupTimeLength = 0x6EC; // int32
                constexpr std::ptrdiff_t m_nState = 0x6F0; // int32
                constexpr std::ptrdiff_t m_bStartPaused = 0x6F4; // bool
                constexpr std::ptrdiff_t m_bInCaptureWatchState = 0x6F5; // bool
                constexpr std::ptrdiff_t m_flTotalTime = 0x6F8; // float32
                constexpr std::ptrdiff_t m_bStopWatchTimer = 0x6FC; // bool
                constexpr std::ptrdiff_t m_bFireFinished = 0x6FD; // bool
                constexpr std::ptrdiff_t m_bFire5MinRemain = 0x6FE; // bool
                constexpr std::ptrdiff_t m_bFire4MinRemain = 0x6FF; // bool
                constexpr std::ptrdiff_t m_bFire3MinRemain = 0x700; // bool
                constexpr std::ptrdiff_t m_bFire2MinRemain = 0x701; // bool
                constexpr std::ptrdiff_t m_bFire1MinRemain = 0x702; // bool
                constexpr std::ptrdiff_t m_bFire30SecRemain = 0x703; // bool
                constexpr std::ptrdiff_t m_bFire10SecRemain = 0x704; // bool
                constexpr std::ptrdiff_t m_bFire5SecRemain = 0x705; // bool
                constexpr std::ptrdiff_t m_bFire4SecRemain = 0x706; // bool
                constexpr std::ptrdiff_t m_bFire3SecRemain = 0x707; // bool
                constexpr std::ptrdiff_t m_bFire2SecRemain = 0x708; // bool
                constexpr std::ptrdiff_t m_bFire1SecRemain = 0x709; // bool
                constexpr std::ptrdiff_t m_nOldTimerLength = 0x70C; // int32
                constexpr std::ptrdiff_t m_nOldTimerState = 0x710; // int32
            }
            // Parent: None
            // Fields count: 2
            //
            ...
            namespace CPathSimple {
                constexpr std::ptrdiff_t m_pathString = 0x720; // CUtlString
            }
            ...
            namespace CPointOffScreenIndicatorUi {
                constexpr std::ptrdiff_t m_bBeenEnabled = 0xEA4; // bool
                constexpr std::ptrdiff_t m_bHide = 0xEA5; // bool
                constexpr std::ptrdiff_t m_flSeenTargetTime = 0xEA8; // float32
                constexpr std::ptrdiff_t m_pTargetPanel = 0xEB0; // C_PointClientUIWorldPanel*
            }
            // Parent: None
            // Fields count: 0
            //
            ...
            namespace C_CSWeaponBaseGun {
                constexpr std::ptrdiff_t m_zoomLevel = 0x2918; // int32
                constexpr std::ptrdiff_t m_iBurstShotsRemaining = 0x291C; // int32
                constexpr std::ptrdiff_t m_iSilencerBodygroup = 0x2920; // int32
                constexpr std::ptrdiff_t m_silencedModelIndex = 0x2930; // int32
                constexpr std::ptrdiff_t m_inPrecache = 0x2934; // bool
                constexpr std::ptrdiff_t m_bNeedsBoltAction = 0x2935; // bool
            }
            // Parent: C_BaseEntity
            // Fields count: 4
            //
            ...
            namespace C_CSPlayerPawnBase {
                ...
                constexpr std::ptrdiff_t m_iTargetItemEntIdx = 0x1370; // CEntityIndex
            ...
            namespace C_BaseFire {
                constexpr std::ptrdiff_t m_flScale = 0x6CC; // float32
                constexpr std::ptrdiff_t m_flStartScale = 0x6D0; // float32
                constexpr std::ptrdiff_t m_flScaleTime = 0x6D4; // float32
                constexpr std::ptrdiff_t m_nFlags = 0x6D8; // uint32
            }
            // Parent: C_BaseEntity
            // Fields count: 16
            //
            ...
            namespace CBasePlayerController {
                ...
                constexpr std::ptrdiff_t m_bKnownTeamMismatch = 0x788; // bool
                constexpr std::ptrdiff_t m_hPredictedPawn = 0x78C; // CHandle<C_BasePlayerPawn>
                constexpr std::ptrdiff_t m_nSplitScreenSlot = 0x790; // CSplitScreenSlot
                constexpr std::ptrdiff_t m_hSplitOwner = 0x794; // CHandle<CBasePlayerController>
            ...
            namespace C_CSGO_PreviewPlayer {
                constexpr std::ptrdiff_t m_animgraph = 0x3218; // CUtlString
                constexpr std::ptrdiff_t m_animgraphCharacterModeString = 0x3220; // CGlobalSymbol
                constexpr std::ptrdiff_t m_flInitialModelScale = 0x3228; // float32
            }
            ...
            // NetworkVarNames: m_entitySpottedState (EntitySpottedState_t)
            namespace C_C4 {
                constexpr std::ptrdiff_t m_szScreenText = 0x2918; // char[32]
                constexpr std::ptrdiff_t m_activeLightParticleIndex = 0x2938; // ParticleIndex_t
                constexpr std::ptrdiff_t m_eActiveLightEffect = 0x293C; // C4LightEffect_t
                constexpr std::ptrdiff_t m_bStartedArming = 0x2940; // bool
                constexpr std::ptrdiff_t m_fArmedTime = 0x2944; // GameTime_t
                constexpr std::ptrdiff_t m_bBombPlacedAnimation = 0x2948; // bool
                constexpr std::ptrdiff_t m_bIsPlantingViaUse = 0x2949; // bool
                constexpr std::ptrdiff_t m_entitySpottedState = 0x2950; // EntitySpottedState_t
                constexpr std::ptrdiff_t m_nSpotRules = 0x2968; // int32
                constexpr std::ptrdiff_t m_bPlayedArmingBeeps = 0x296C; // bool[7]
                constexpr std::ptrdiff_t m_bBombPlanted = 0x2973; // bool
            }
            // Parent: C_BaseModelEntity
            // Fields count: 13
            //
            ...
            namespace CBaseAnimGraph {
                ...
                constexpr std::ptrdiff_t m_bRagdollClientSide = 0xD28; // bool
            ...
            namespace C_PathParticleRope {
                constexpr std::ptrdiff_t m_bStartActive = 0x6CC; // bool
                constexpr std::ptrdiff_t m_flMaxSimulationTime = 0x6D0; // float32
            ...
            namespace C_SoundEventAABBEntity {
                constexpr std::ptrdiff_t m_vMins = 0x6CC; // Vector
                constexpr std::ptrdiff_t m_vMaxs = 0x6D8; // Vector
            }
            // Parent: C_CSWeaponBaseGun
            // Fields count: 0
            ...
            namespace C_CSGO_TeamPreviewCamera {
                constexpr std::ptrdiff_t m_nVariant = 0x734; // int32
                constexpr std::ptrdiff_t m_bDofEnabled = 0x738; // bool
                constexpr std::ptrdiff_t m_flDofNearBlurry = 0x73C; // float32
                constexpr std::ptrdiff_t m_flDofNearCrisp = 0x740; // float32
                constexpr std::ptrdiff_t m_flDofFarCrisp = 0x744; // float32
                constexpr std::ptrdiff_t m_flDofFarBlurry = 0x748; // float32
                constexpr std::ptrdiff_t m_flDofTiltToGround = 0x74C; // float32
            }
            ...
            namespace C_EnvVolumetricFogVolume {
                constexpr std::ptrdiff_t m_bActive = 0x6CC; // bool
                constexpr std::ptrdiff_t m_vBoxMins = 0x6D0; // Vector
                constexpr std::ptrdiff_t m_vBoxMaxs = 0x6DC; // Vector
                constexpr std::ptrdiff_t m_bStartDisabled = 0x6E8; // bool
                constexpr std::ptrdiff_t m_flStrength = 0x6EC; // float32
                constexpr std::ptrdiff_t m_nFalloffShape = 0x6F0; // int32
                constexpr std::ptrdiff_t m_flFalloffExponent = 0x6F4; // float32
                constexpr std::ptrdiff_t m_flHeightFogDepth = 0x6F8; // float32
                constexpr std::ptrdiff_t m_fHeightFogEdgeWidth = 0x6FC; // float32
                constexpr std::ptrdiff_t m_fIndirectLightStrength = 0x700; // float32
                constexpr std::ptrdiff_t m_fSunLightStrength = 0x704; // float32
                constexpr std::ptrdiff_t m_fNoiseStrength = 0x708; // float32
                constexpr std::ptrdiff_t m_bOverrideIndirectLightStrength = 0x70C; // bool
                constexpr std::ptrdiff_t m_bOverrideSunLightStrength = 0x70D; // bool
                constexpr std::ptrdiff_t m_bOverrideNoiseStrength = 0x70E; // bool
            }
            // Parent: C_BaseModelEntity
            // Fields count: 0
            ...
            namespace C_FireSmoke {
                constexpr std::ptrdiff_t m_nFlameModelIndex = 0x6DC; // int32
                constexpr std::ptrdiff_t m_nFlameFromAboveModelIndex = 0x6E0; // int32
                constexpr std::ptrdiff_t m_flScaleRegister = 0x6E4; // float32
                constexpr std::ptrdiff_t m_flScaleStart = 0x6E8; // float32
                constexpr std::ptrdiff_t m_flScaleEnd = 0x6EC; // float32
                constexpr std::ptrdiff_t m_flScaleTimeStart = 0x6F0; // GameTime_t
                constexpr std::ptrdiff_t m_flScaleTimeEnd = 0x6F4; // GameTime_t
                constexpr std::ptrdiff_t m_flChildFlameSpread = 0x6F8; // float32
                constexpr std::ptrdiff_t m_flClipPerc = 0x70C; // float32
                constexpr std::ptrdiff_t m_bClipTested = 0x710; // bool
                constexpr std::ptrdiff_t m_bFadingOut = 0x711; // bool
                constexpr std::ptrdiff_t m_tParticleSpawn = 0x714; // TimedEvent
            ...
            namespace C_EnvCombinedLightProbeVolume {
                constexpr std::ptrdiff_t m_Entity_Color = 0x1730; // Color
                constexpr std::ptrdiff_t m_Entity_flBrightness = 0x1734; // float32
                constexpr std::ptrdiff_t m_Entity_hCubemapTexture = 0x1738; // CStrongHandle<InfoForResourceTypeCTextureBase>
                constexpr std::ptrdiff_t m_Entity_bCustomCubemapTexture = 0x1740; // bool
                constexpr std::ptrdiff_t m_Entity_hLightProbeTexture = 0x1748; // CStrongHandle<InfoForResourceTypeCTextureBase>
                constexpr std::ptrdiff_t m_Entity_hLightProbeDirectLightIndicesTexture = 0x1750; // CStrongHandle<InfoForResourceTypeCTextureBase>
                constexpr std::ptrdiff_t m_Entity_hLightProbeDirectLightScalarsTexture = 0x1758; // CStrongHandle<InfoForResourceTypeCTextureBase>
                constexpr std::ptrdiff_t m_Entity_hLightProbeDirectLightShadowsTexture = 0x1760; // CStrongHandle<InfoForResourceTypeCTextureBase>
                constexpr std::ptrdiff_t m_Entity_vBoxMins = 0x1768; // Vector
                constexpr std::ptrdiff_t m_Entity_vBoxMaxs = 0x1774; // Vector
                constexpr std::ptrdiff_t m_Entity_bMoveable = 0x1780; // bool
                constexpr std::ptrdiff_t m_Entity_nHandshake = 0x1784; // int32
                constexpr std::ptrdiff_t m_Entity_nEnvCubeMapArrayIndex = 0x1788; // int32
                constexpr std::ptrdiff_t m_Entity_nPriority = 0x178C; // int32
                constexpr std::ptrdiff_t m_Entity_bStartDisabled = 0x1790; // bool
                constexpr std::ptrdiff_t m_Entity_flEdgeFadeDist = 0x1794; // float32
                constexpr std::ptrdiff_t m_Entity_vEdgeFadeDists = 0x1798; // Vector
                constexpr std::ptrdiff_t m_Entity_nLightProbeSizeX = 0x17A4; // int32
                constexpr std::ptrdiff_t m_Entity_nLightProbeSizeY = 0x17A8; // int32
                constexpr std::ptrdiff_t m_Entity_nLightProbeSizeZ = 0x17AC; // int32
                constexpr std::ptrdiff_t m_Entity_nLightProbeAtlasX = 0x17B0; // int32
                constexpr std::ptrdiff_t m_Entity_nLightProbeAtlasY = 0x17B4; // int32
                constexpr std::ptrdiff_t m_Entity_nLightProbeAtlasZ = 0x17B8; // int32
                constexpr std::ptrdiff_t m_Entity_bEnabled = 0x17D1; // bool
            }
            // Parent: C_SoundOpvarSetPointBase
            // Fields count: 0
            ...
            namespace C_TonemapController2 {
                constexpr std::ptrdiff_t m_flAutoExposureMin = 0x6CC; // float32
                constexpr std::ptrdiff_t m_flAutoExposureMax = 0x6D0; // float32
                constexpr std::ptrdiff_t m_flTonemapPercentTarget = 0x6D4; // float32
                constexpr std::ptrdiff_t m_flTonemapPercentBrightPixels = 0x6D8; // float32
                constexpr std::ptrdiff_t m_flTonemapMinAvgLum = 0x6DC; // float32
                constexpr std::ptrdiff_t m_flExposureAdaptationSpeedUp = 0x6E0; // float32
                constexpr std::ptrdiff_t m_flExposureAdaptationSpeedDown = 0x6E4; // float32
                constexpr std::ptrdiff_t m_flTonemapEVSmoothingRange = 0x6E8; // float32
            }
            // Parent: C_CSWeaponBaseGun
            // Fields count: 0
            ...
            namespace C_ColorCorrection {
                constexpr std::ptrdiff_t m_vecOrigin = 0x6CC; // Vector
                constexpr std::ptrdiff_t m_MinFalloff = 0x6D8; // float32
                constexpr std::ptrdiff_t m_MaxFalloff = 0x6DC; // float32
                constexpr std::ptrdiff_t m_flFadeInDuration = 0x6E0; // float32
                constexpr std::ptrdiff_t m_flFadeOutDuration = 0x6E4; // float32
                constexpr std::ptrdiff_t m_flMaxWeight = 0x6E8; // float32
                constexpr std::ptrdiff_t m_flCurWeight = 0x6EC; // float32
                constexpr std::ptrdiff_t m_netlookupFilename = 0x6F0; // char[512]
                constexpr std::ptrdiff_t m_bEnabled = 0x8F0; // bool
                constexpr std::ptrdiff_t m_bMaster = 0x8F1; // bool
                constexpr std::ptrdiff_t m_bClientSide = 0x8F2; // bool
                constexpr std::ptrdiff_t m_bExclusive = 0x8F3; // bool
                constexpr std::ptrdiff_t m_bEnabledOnClient = 0x8F4; // bool[1]
                constexpr std::ptrdiff_t m_flCurWeightOnClient = 0x8F8; // float32[1]
                constexpr std::ptrdiff_t m_bFadingIn = 0x8FC; // bool[1]
                constexpr std::ptrdiff_t m_flFadeStartWeight = 0x900; // float32[1]
                constexpr std::ptrdiff_t m_flFadeStartTime = 0x904; // float32[1]
                constexpr std::ptrdiff_t m_flFadeDuration = 0x908; // float32[1]
            }
            // Parent: C_BaseTrigger
            // Fields count: 0
            ...
            namespace CGrenadeTracer {
                constexpr std::ptrdiff_t m_flTracerDuration = 0xC70; // float32
            ...
            namespace C_HandleTest {
                constexpr std::ptrdiff_t m_Handle = 0x6CC; // CHandle<C_BaseEntity>
                constexpr std::ptrdiff_t m_bSendHandle = 0x6D0; // bool
            }
            // Parent: C_BaseEntity
            // Fields count: 1
            //
            ...
            namespace C_WeaponShield {
                constexpr std::ptrdiff_t m_flDisplayHealth = 0x2938; // float32
            }
            // Parent: C_PointClientUIWorldPanel
            // Fields count: 1
            //
            ...
            namespace C_PointClientUIWorldTextPanel {
                constexpr std::ptrdiff_t m_messageText = 0xEA4; // char[512]
            }
            // Parent: CPlayer_UseServices
            // Fields count: 0
            ...
            namespace C_EnvVolumetricFogController {
                constexpr std::ptrdiff_t m_flScattering = 0x6CC; // float32
                constexpr std::ptrdiff_t m_flAnisotropy = 0x6D0; // float32
                constexpr std::ptrdiff_t m_flFadeSpeed = 0x6D4; // float32
                constexpr std::ptrdiff_t m_flDrawDistance = 0x6D8; // float32
                constexpr std::ptrdiff_t m_flFadeInStart = 0x6DC; // float32
                constexpr std::ptrdiff_t m_flFadeInEnd = 0x6E0; // float32
                constexpr std::ptrdiff_t m_flIndirectStrength = 0x6E4; // float32
                constexpr std::ptrdiff_t m_nIndirectTextureDimX = 0x6E8; // int32
                constexpr std::ptrdiff_t m_nIndirectTextureDimY = 0x6EC; // int32
                constexpr std::ptrdiff_t m_nIndirectTextureDimZ = 0x6F0; // int32
                constexpr std::ptrdiff_t m_vBoxMins = 0x6F4; // Vector
                constexpr std::ptrdiff_t m_vBoxMaxs = 0x700; // Vector
                constexpr std::ptrdiff_t m_bActive = 0x70C; // bool
                constexpr std::ptrdiff_t m_flStartAnisoTime = 0x710; // GameTime_t
                constexpr std::ptrdiff_t m_flStartScatterTime = 0x714; // GameTime_t
                constexpr std::ptrdiff_t m_flStartDrawDistanceTime = 0x718; // GameTime_t
                constexpr std::ptrdiff_t m_flStartAnisotropy = 0x71C; // float32
                constexpr std::ptrdiff_t m_flStartScattering = 0x720; // float32
                constexpr std::ptrdiff_t m_flStartDrawDistance = 0x724; // float32
                constexpr std::ptrdiff_t m_flDefaultAnisotropy = 0x728; // float32
                constexpr std::ptrdiff_t m_flDefaultScattering = 0x72C; // float32
                constexpr std::ptrdiff_t m_flDefaultDrawDistance = 0x730; // float32
                constexpr std::ptrdiff_t m_bStartDisabled = 0x734; // bool
                constexpr std::ptrdiff_t m_bEnableIndirect = 0x735; // bool
                constexpr std::ptrdiff_t m_bIndirectUseLPVs = 0x736; // bool
                constexpr std::ptrdiff_t m_bIsMaster = 0x737; // bool
                constexpr std::ptrdiff_t m_hFogIndirectTexture = 0x738; // CStrongHandle<InfoForResourceTypeCTextureBase>
                constexpr std::ptrdiff_t m_nForceRefreshCount = 0x740; // int32
                constexpr std::ptrdiff_t m_fNoiseSpeed = 0x744; // float32
                constexpr std::ptrdiff_t m_fNoiseStrength = 0x748; // float32
                constexpr std::ptrdiff_t m_vNoiseScale = 0x74C; // Vector
                constexpr std::ptrdiff_t m_bFirstTime = 0x758; // bool
            }
            // Parent: C_CSWeaponBaseGun
            // Fields count: 0
            ...
            namespace C_InfoVisibilityBox {
                constexpr std::ptrdiff_t m_nMode = 0x6D0; // int32
                constexpr std::ptrdiff_t m_vBoxSize = 0x6D4; // Vector
                constexpr std::ptrdiff_t m_bEnabled = 0x6E0; // bool
            }
            // Parent: C_Sprite
            // Fields count: 2
            namespace C_FireSprite {
                constexpr std::ptrdiff_t m_vecMoveDir = 0xD60; // Vector
                constexpr std::ptrdiff_t m_bFadeFromAbove = 0xD6C; // bool
            }
            // Parent: C_CSGO_TeamIntroCharacterPosition
            // Fields count: 0
            ...
            namespace CBaseProp {
                ...
                constexpr std::ptrdiff_t m_iShapeType = 0xE7C; // int32
            ...
            namespace CInfoDynamicShadowHint {
                constexpr std::ptrdiff_t m_bDisabled = 0x6CC; // bool
                constexpr std::ptrdiff_t m_flRange = 0x6D0; // float32
                constexpr std::ptrdiff_t m_nImportance = 0x6D4; // int32
                constexpr std::ptrdiff_t m_nLightChoice = 0x6D8; // int32
                constexpr std::ptrdiff_t m_hLight = 0x6DC; // CHandle<C_BaseEntity>
            }
            // Parent: None
            // Fields count: 0
            //
            ...
            namespace C_EnvCubemap {
                constexpr std::ptrdiff_t m_Entity_hCubemapTexture = 0x750; // CStrongHandle<InfoForResourceTypeCTextureBase>
                constexpr std::ptrdiff_t m_Entity_bCustomCubemapTexture = 0x758; // bool
                constexpr std::ptrdiff_t m_Entity_flInfluenceRadius = 0x75C; // float32
                constexpr std::ptrdiff_t m_Entity_vBoxProjectMins = 0x760; // Vector
                constexpr std::ptrdiff_t m_Entity_vBoxProjectMaxs = 0x76C; // Vector
                constexpr std::ptrdiff_t m_Entity_bMoveable = 0x778; // bool
                constexpr std::ptrdiff_t m_Entity_nHandshake = 0x77C; // int32
                constexpr std::ptrdiff_t m_Entity_nEnvCubeMapArrayIndex = 0x780; // int32
                constexpr std::ptrdiff_t m_Entity_nPriority = 0x784; // int32
                constexpr std::ptrdiff_t m_Entity_flEdgeFadeDist = 0x788; // float32
                constexpr std::ptrdiff_t m_Entity_vEdgeFadeDists = 0x78C; // Vector
                constexpr std::ptrdiff_t m_Entity_flDiffuseScale = 0x798; // float32
                constexpr std::ptrdiff_t m_Entity_bStartDisabled = 0x79C; // bool
                constexpr std::ptrdiff_t m_Entity_bDefaultEnvMap = 0x79D; // bool
                constexpr std::ptrdiff_t m_Entity_bDefaultSpecEnvMap = 0x79E; // bool
                constexpr std::ptrdiff_t m_Entity_bIndoorCubeMap = 0x79F; // bool
                constexpr std::ptrdiff_t m_Entity_bCopyDiffuseFromDefaultCubemap = 0x7A0; // bool
                constexpr std::ptrdiff_t m_Entity_bEnabled = 0x7B0; // bool
            }
            ...
            namespace C_PointValueRemapper {
                constexpr std::ptrdiff_t m_bDisabled = 0x6CC; // bool
                constexpr std::ptrdiff_t m_bDisabledOld = 0x6CD; // bool
                constexpr std::ptrdiff_t m_bUpdateOnClient = 0x6CE; // bool
                constexpr std::ptrdiff_t m_nInputType = 0x6D0; // ValueRemapperInputType_t
                constexpr std::ptrdiff_t m_hRemapLineStart = 0x6D4; // CHandle<C_BaseEntity>
                constexpr std::ptrdiff_t m_hRemapLineEnd = 0x6D8; // CHandle<C_BaseEntity>
                constexpr std::ptrdiff_t m_flMaximumChangePerSecond = 0x6DC; // float32
                constexpr std::ptrdiff_t m_flDisengageDistance = 0x6E0; // float32
                constexpr std::ptrdiff_t m_flEngageDistance = 0x6E4; // float32
                constexpr std::ptrdiff_t m_bRequiresUseKey = 0x6E8; // bool
                constexpr std::ptrdiff_t m_nOutputType = 0x6EC; // ValueRemapperOutputType_t
                constexpr std::ptrdiff_t m_hOutputEntities = 0x6F0; // C_NetworkUtlVectorBase<CHandle<C_BaseEntity>>
                constexpr std::ptrdiff_t m_nHapticsType = 0x708; // ValueRemapperHapticsType_t
                constexpr std::ptrdiff_t m_nMomentumType = 0x70C; // ValueRemapperMomentumType_t
                constexpr std::ptrdiff_t m_flMomentumModifier = 0x710; // float32
                constexpr std::ptrdiff_t m_flSnapValue = 0x714; // float32
                constexpr std::ptrdiff_t m_flCurrentMomentum = 0x718; // float32
                constexpr std::ptrdiff_t m_nRatchetType = 0x71C; // ValueRemapperRatchetType_t
                constexpr std::ptrdiff_t m_flRatchetOffset = 0x720; // float32
                constexpr std::ptrdiff_t m_flInputOffset = 0x724; // float32
                constexpr std::ptrdiff_t m_bEngaged = 0x728; // bool
                constexpr std::ptrdiff_t m_bFirstUpdate = 0x729; // bool
                constexpr std::ptrdiff_t m_flPreviousValue = 0x72C; // float32
                constexpr std::ptrdiff_t m_flPreviousUpdateTickTime = 0x730; // GameTime_t
                constexpr std::ptrdiff_t m_vecPreviousTestPoint = 0x734; // Vector
            }
            // Parent: C_CSWeaponBase
            // Fields count: 0
            namespace C_Knife {
            ...
            namespace C_ItemDogtags {
                constexpr std::ptrdiff_t m_OwningPlayer = 0x2560; // CHandle<C_CSPlayerPawn>
                constexpr std::ptrdiff_t m_KillingPlayer = 0x2564; // CHandle<C_CSPlayerPawn>
            }
            // Parent: C_CSGO_TeamPreviewCamera
            // Fields count: 0
            ...
            namespace CInfoDynamicShadowHintBox {
                constexpr std::ptrdiff_t m_vBoxMins = 0x6E0; // Vector
                constexpr std::ptrdiff_t m_vBoxMaxs = 0x6EC; // Vector
            }
            // Parent: C_SoundOpvarSetPointEntity
            // Fields count: 0
            ...
            namespace C_EnvCubemapFog {
                constexpr std::ptrdiff_t m_flEndDistance = 0x6CC; // float32
                constexpr std::ptrdiff_t m_flStartDistance = 0x6D0; // float32
                constexpr std::ptrdiff_t m_flFogFalloffExponent = 0x6D4; // float32
                constexpr std::ptrdiff_t m_bHeightFogEnabled = 0x6D8; // bool
                constexpr std::ptrdiff_t m_flFogHeightWidth = 0x6DC; // float32
                constexpr std::ptrdiff_t m_flFogHeightEnd = 0x6E0; // float32
                constexpr std::ptrdiff_t m_flFogHeightStart = 0x6E4; // float32
                constexpr std::ptrdiff_t m_flFogHeightExponent = 0x6E8; // float32
                constexpr std::ptrdiff_t m_flLODBias = 0x6EC; // float32
                constexpr std::ptrdiff_t m_bActive = 0x6F0; // bool
                constexpr std::ptrdiff_t m_bStartDisabled = 0x6F1; // bool
                constexpr std::ptrdiff_t m_flFogMaxOpacity = 0x6F4; // float32
                constexpr std::ptrdiff_t m_nCubemapSourceType = 0x6F8; // int32
            ...
            namespace C_ShatterGlassShardPhysics {
                constexpr std::ptrdiff_t m_ShardDesc = 0xFF0; // shard_model_desc_t
            }
            // Parent: C_CSWeaponBaseGun
            // Fields count: 0
            ...
            namespace C_PlayerVisibility {
                constexpr std::ptrdiff_t m_flVisibilityStrength = 0x6CC; // float32
                constexpr std::ptrdiff_t m_flFogDistanceMultiplier = 0x6D0; // float32
                constexpr std::ptrdiff_t m_flFogMaxDensityMultiplier = 0x6D4; // float32
                constexpr std::ptrdiff_t m_flFadeTime = 0x6D8; // float32
                constexpr std::ptrdiff_t m_bStartDisabled = 0x6DC; // bool
                constexpr std::ptrdiff_t m_bIsEnabled = 0x6DD; // bool
            }
            // Parent: None
            // Fields count: 25
            //
            ...
            namespace C_BaseFlex {
                ...
                constexpr std::ptrdiff_t m_nNextSceneEventId = 0xF28; // SceneEventId_t
            ...
            namespace C_RagdollManager {
                constexpr std::ptrdiff_t m_iCurrentMaxRagdollCount = 0x6CC; // int8
            }
            // Parent: C_BaseModelEntity
            // Fields count: 12
            //
            ...
            namespace C_DynamicProp {
                constexpr std::ptrdiff_t m_bUseHitboxesForRenderBox = 0xFE5; // bool
                constexpr std::ptrdiff_t m_bUseAnimGraph = 0xFE6; // bool
                constexpr std::ptrdiff_t m_pOutputAnimBegun = 0xFE8; // CEntityIOOutput
                constexpr std::ptrdiff_t m_pOutputAnimOver = 0x1010; // CEntityIOOutput
                constexpr std::ptrdiff_t m_pOutputAnimLoopCycleOver = 0x1038; // CEntityIOOutput
                constexpr std::ptrdiff_t m_OnAnimReachedStart = 0x1060; // CEntityIOOutput
                constexpr std::ptrdiff_t m_OnAnimReachedEnd = 0x1088; // CEntityIOOutput
                constexpr std::ptrdiff_t m_iszIdleAnim = 0x10B0; // CUtlSymbolLarge
                constexpr std::ptrdiff_t m_nIdleAnimLoopMode = 0x10B8; // AnimLoopMode_t
                constexpr std::ptrdiff_t m_bRandomizeCycle = 0x10BC; // bool
                constexpr std::ptrdiff_t m_bStartDisabled = 0x10BD; // bool
                constexpr std::ptrdiff_t m_bFiredStartEndOutput = 0x10BE; // bool
                constexpr std::ptrdiff_t m_bForceNpcExclude = 0x10BF; // bool
                constexpr std::ptrdiff_t m_bCreateNonSolid = 0x10C0; // bool
                constexpr std::ptrdiff_t m_bIsOverrideProp = 0x10C1; // bool
                constexpr std::ptrdiff_t m_iInitialGlowState = 0x10C4; // int32
                constexpr std::ptrdiff_t m_nGlowRange = 0x10C8; // int32
                constexpr std::ptrdiff_t m_nGlowRangeMin = 0x10CC; // int32
                constexpr std::ptrdiff_t m_glowColor = 0x10D0; // Color
                constexpr std::ptrdiff_t m_nGlowTeam = 0x10D4; // int32
                constexpr std::ptrdiff_t m_iCachedFrameCount = 0x10D8; // int32
                constexpr std::ptrdiff_t m_vecCachedRenderMins = 0x10DC; // Vector
                constexpr std::ptrdiff_t m_vecCachedRenderMaxs = 0x10E8; // Vector
            }
            // Parent: CEntityComponent
            // Fields count: 10
            ...
            namespace CCitadelSoundOpvarSetOBB {
                constexpr std::ptrdiff_t m_iszStackName = 0x6E8; // CUtlSymbolLarge
                constexpr std::ptrdiff_t m_iszOperatorName = 0x6F0; // CUtlSymbolLarge
                constexpr std::ptrdiff_t m_iszOpvarName = 0x6F8; // CUtlSymbolLarge
                constexpr std::ptrdiff_t m_vDistanceInnerMins = 0x700; // Vector
                constexpr std::ptrdiff_t m_vDistanceInnerMaxs = 0x70C; // Vector
                constexpr std::ptrdiff_t m_vDistanceOuterMins = 0x718; // Vector
                constexpr std::ptrdiff_t m_vDistanceOuterMaxs = 0x724; // Vector
                constexpr std::ptrdiff_t m_nAABBDirection = 0x730; // int32
            }
            // Parent: None
            // Fields count: 5
            //
            ...
            namespace C_LocalTempEntity {
                constexpr std::ptrdiff_t flags = 0xE78; // int32
                constexpr std::ptrdiff_t die = 0xE7C; // GameTime_t
                constexpr std::ptrdiff_t m_flFrameMax = 0xE80; // float32
                constexpr std::ptrdiff_t x = 0xE84; // float32
                constexpr std::ptrdiff_t y = 0xE88; // float32
                constexpr std::ptrdiff_t fadeSpeed = 0xE8C; // float32
                constexpr std::ptrdiff_t bounceFactor = 0xE90; // float32
                constexpr std::ptrdiff_t hitSound = 0xE94; // int32
                constexpr std::ptrdiff_t priority = 0xE98; // int32
                constexpr std::ptrdiff_t tentOffset = 0xE9C; // Vector
                constexpr std::ptrdiff_t m_vecTempEntAngVelocity = 0xEA8; // QAngle
                constexpr std::ptrdiff_t tempent_renderamt = 0xEB4; // int32
                constexpr std::ptrdiff_t m_vecNormal = 0xEB8; // Vector
                constexpr std::ptrdiff_t m_flSpriteScale = 0xEC4; // float32
                constexpr std::ptrdiff_t m_nFlickerFrame = 0xEC8; // int32
                constexpr std::ptrdiff_t m_flFrameRate = 0xECC; // float32
                constexpr std::ptrdiff_t m_flFrame = 0xED0; // float32
                constexpr std::ptrdiff_t m_pszImpactEffect = 0xED8; // char*
                constexpr std::ptrdiff_t m_pszParticleEffect = 0xEE0; // char*
                constexpr std::ptrdiff_t m_bParticleCollision = 0xEE8; // bool
                constexpr std::ptrdiff_t m_iLastCollisionFrame = 0xEEC; // int32
                constexpr std::ptrdiff_t m_vLastCollisionOrigin = 0xEF0; // Vector
                constexpr std::ptrdiff_t m_vecTempEntVelocity = 0xEFC; // Vector
                constexpr std::ptrdiff_t m_vecPrevAbsOrigin = 0xF08; // Vector
                constexpr std::ptrdiff_t m_vecTempEntAcceleration = 0xF14; // Vector
            }
            // Parent: None
            // Fields count: 2
            ...
            namespace CInfoOffscreenPanoramaTexture {
                constexpr std::ptrdiff_t m_bDisabled = 0x6CC; // bool
                constexpr std::ptrdiff_t m_nResolutionX = 0x6D0; // int32
                constexpr std::ptrdiff_t m_nResolutionY = 0x6D4; // int32
                constexpr std::ptrdiff_t m_szLayoutFileName = 0x6D8; // CUtlSymbolLarge
                constexpr std::ptrdiff_t m_RenderAttrName = 0x6E0; // CUtlSymbolLarge
                constexpr std::ptrdiff_t m_TargetEntities = 0x6E8; // C_NetworkUtlVectorBase<CHandle<C_BaseModelEntity>>
                constexpr std::ptrdiff_t m_nTargetChangeCount = 0x700; // int32
                constexpr std::ptrdiff_t m_vecCSSClasses = 0x708; // C_NetworkUtlVectorBase<CUtlSymbolLarge>
                constexpr std::ptrdiff_t m_bCheckCSSClasses = 0x880; // bool
            }
            // Parent: C_BaseModelEntity
            // Fields count: 7
            //
            ...
            namespace C_CSWeaponBase {
                ...
                constexpr std::ptrdiff_t m_flLastBurstModeChangeTime = 0x25DC; // GameTime_t
                constexpr std::ptrdiff_t m_nPostponeFireReadyTicks = 0x25E0; // GameTick_t
                constexpr std::ptrdiff_t m_flPostponeFireReadyFrac = 0x25E4; // float32
                constexpr std::ptrdiff_t m_bInReload = 0x25E8; // bool
                constexpr std::ptrdiff_t m_bReloadVisuallyComplete = 0x25E9; // bool
                constexpr std::ptrdiff_t m_flDroppedAtTime = 0x25EC; // GameTime_t
                constexpr std::ptrdiff_t m_bIsHauledBack = 0x25F0; // bool
                constexpr std::ptrdiff_t m_bSilencerOn = 0x25F1; // bool
                constexpr std::ptrdiff_t m_flTimeSilencerSwitchComplete = 0x25F4; // GameTime_t
                constexpr std::ptrdiff_t m_iOriginalTeamNumber = 0x25F8; // int32
                constexpr std::ptrdiff_t m_iMostRecentTeamNumber = 0x25FC; // int32
                constexpr std::ptrdiff_t m_bDroppedNearBuyZone = 0x2600; // bool
                constexpr std::ptrdiff_t m_flNextAttackRenderTimeOffset = 0x2604; // float32
                constexpr std::ptrdiff_t m_bClearWeaponIdentifyingUGC = 0x26A0; // bool
                constexpr std::ptrdiff_t m_bVisualsDataSet = 0x26A1; // bool
                constexpr std::ptrdiff_t m_bOldFirstPersonSpectatedState = 0x26A2; // bool
                constexpr std::ptrdiff_t m_bUIWeapon = 0x26A3; // bool
                constexpr std::ptrdiff_t m_nCustomEconReloadEventId = 0x26A4; // int32
                constexpr std::ptrdiff_t m_hPrevOwner = 0x26B0; // CHandle<C_CSPlayerPawn>
                constexpr std::ptrdiff_t m_nDropTick = 0x26B4; // GameTick_t
                constexpr std::ptrdiff_t m_donated = 0x26D4; // bool
                constexpr std::ptrdiff_t m_fLastShotTime = 0x26D8; // GameTime_t
                constexpr std::ptrdiff_t m_bWasOwnedByCT = 0x26DC; // bool
                constexpr std::ptrdiff_t m_bWasOwnedByTerrorist = 0x26DD; // bool
                constexpr std::ptrdiff_t m_gunHeat = 0x26E0; // float32
                constexpr std::ptrdiff_t m_smokeAttachments = 0x26E4; // uint32
                constexpr std::ptrdiff_t m_lastSmokeTime = 0x26E8; // GameTime_t
                constexpr std::ptrdiff_t m_flNextClientFireBulletTime = 0x26EC; // float32
                constexpr std::ptrdiff_t m_flNextClientFireBulletTime_Repredict = 0x26F0; // float32
                constexpr std::ptrdiff_t m_IronSightController = 0x27D0; // C_IronSightController
                constexpr std::ptrdiff_t m_iIronSightMode = 0x2880; // int32
                constexpr std::ptrdiff_t m_flLastLOSTraceFailureTime = 0x2890; // GameTime_t
                constexpr std::ptrdiff_t m_iNumEmptyAttacks = 0x2894; // int32
                constexpr std::ptrdiff_t m_flLastMagDropRequestTime = 0x2910; // GameTime_t
                constexpr std::ptrdiff_t m_flWatTickOffset = 0x2914; // float32
            }
            // Parent: C_BaseModelEntity
            // Fields count: 0
            ...
            namespace C_EnvDetailController {
                constexpr std::ptrdiff_t m_flFadeStartDist = 0x6CC; // float32
                constexpr std::ptrdiff_t m_flFadeEndDist = 0x6D0; // float32
            }
            ...
            namespace C_BaseEntity {
                ...
                constexpr std::ptrdiff_t m_nLastThinkTick = 0x478; // GameTick_t
                constexpr std::ptrdiff_t m_pGameSceneNode = 0x480; // CGameSceneNode*
                constexpr std::ptrdiff_t m_pRenderComponent = 0x488; // CRenderComponent*
                constexpr std::ptrdiff_t m_pCollision = 0x490; // CCollisionProperty*
                constexpr std::ptrdiff_t m_iMaxHealth = 0x498; // int32
                constexpr std::ptrdiff_t m_iHealth = 0x49C; // int32
                constexpr std::ptrdiff_t m_lifeState = 0x4A0; // uint8
                constexpr std::ptrdiff_t m_bTakesDamage = 0x4A1; // bool
                constexpr std::ptrdiff_t m_nTakeDamageFlags = 0x4A8; // TakeDamageFlags_t
                constexpr std::ptrdiff_t m_bIsPlatform = 0x4B0; // bool
                constexpr std::ptrdiff_t m_ubInterpolationFrame = 0x4B1; // uint8
                constexpr std::ptrdiff_t m_hSceneObjectController = 0x4B4; // CHandle<C_BaseEntity>
                constexpr std::ptrdiff_t m_nNoInterpolationTick = 0x4B8; // int32
                constexpr std::ptrdiff_t m_nVisibilityNoInterpolationTick = 0x4BC; // int32
                constexpr std::ptrdiff_t m_flProxyRandomValue = 0x4C0; // float32
                constexpr std::ptrdiff_t m_iEFlags = 0x4C4; // int32
                constexpr std::ptrdiff_t m_nWaterType = 0x4C8; // uint8
                constexpr std::ptrdiff_t m_bInterpolateEvenWithNoModel = 0x4C9; // bool
                constexpr std::ptrdiff_t m_bPredictionEligible = 0x4CA; // bool
                constexpr std::ptrdiff_t m_bApplyLayerMatchIDToModel = 0x4CB; // bool
                constexpr std::ptrdiff_t m_tokLayerMatchID = 0x4CC; // CUtlStringToken
                constexpr std::ptrdiff_t m_nSubclassID = 0x4D0; // CUtlStringToken
                constexpr std::ptrdiff_t m_nSimulationTick = 0x4E0; // int32
                constexpr std::ptrdiff_t m_iCurrentThinkContext = 0x4E4; // int32
                constexpr std::ptrdiff_t m_aThinkFunctions = 0x4E8; // CUtlVector<thinkfunc_t>
                constexpr std::ptrdiff_t m_bDisabledContextThinks = 0x500; // bool
                constexpr std::ptrdiff_t m_flAnimTime = 0x504; // float32
                constexpr std::ptrdiff_t m_flSimulationTime = 0x508; // float32
                constexpr std::ptrdiff_t m_nSceneObjectOverrideFlags = 0x50C; // uint8
                constexpr std::ptrdiff_t m_bHasSuccessfullyInterpolated = 0x50D; // bool
                constexpr std::ptrdiff_t m_bHasAddedVarsToInterpolation = 0x50E; // bool
                constexpr std::ptrdiff_t m_bRenderEvenWhenNotSuccessfullyInterpolated = 0x50F; // bool
                constexpr std::ptrdiff_t m_nInterpolationLatchDirtyFlags = 0x510; // int32[2]
                constexpr std::ptrdiff_t m_ListEntry = 0x518; // uint16[11]
                constexpr std::ptrdiff_t m_flCreateTime = 0x530; // GameTime_t
                constexpr std::ptrdiff_t m_flSpeed = 0x534; // float32
                constexpr std::ptrdiff_t m_EntClientFlags = 0x538; // uint16
                constexpr std::ptrdiff_t m_bClientSideRagdoll = 0x53A; // bool
                constexpr std::ptrdiff_t m_iTeamNum = 0x53B; // uint8
                constexpr std::ptrdiff_t m_spawnflags = 0x53C; // uint32
                constexpr std::ptrdiff_t m_nNextThinkTick = 0x540; // GameTick_t
                constexpr std::ptrdiff_t m_fFlags = 0x544; // uint32
                constexpr std::ptrdiff_t m_vecAbsVelocity = 0x548; // Vector
                constexpr std::ptrdiff_t m_vecVelocity = 0x558; // CNetworkVelocityVector
                constexpr std::ptrdiff_t m_vecBaseVelocity = 0x588; // Vector
                constexpr std::ptrdiff_t m_hEffectEntity = 0x594; // CHandle<C_BaseEntity>
                constexpr std::ptrdiff_t m_hOwnerEntity = 0x598; // CHandle<C_BaseEntity>
                constexpr std::ptrdiff_t m_MoveCollide = 0x59C; // MoveCollide_t
                constexpr std::ptrdiff_t m_MoveType = 0x59D; // MoveType_t
                constexpr std::ptrdiff_t m_nActualMoveType = 0x59E; // MoveType_t
                constexpr std::ptrdiff_t m_flWaterLevel = 0x5A0; // float32
                constexpr std::ptrdiff_t m_fEffects = 0x5A4; // uint32
                constexpr std::ptrdiff_t m_hGroundEntity = 0x5A8; // CHandle<C_BaseEntity>
                constexpr std::ptrdiff_t m_nGroundBodyIndex = 0x5AC; // int32
                constexpr std::ptrdiff_t m_flFriction = 0x5B0; // float32
                constexpr std::ptrdiff_t m_flElasticity = 0x5B4; // float32
                constexpr std::ptrdiff_t m_flGravityScale = 0x5B8; // float32
                constexpr std::ptrdiff_t m_flTimeScale = 0x5BC; // float32
                constexpr std::ptrdiff_t m_bAnimatedEveryTick = 0x5C0; // bool
                constexpr std::ptrdiff_t m_flNavIgnoreUntilTime = 0x5C4; // GameTime_t
                constexpr std::ptrdiff_t m_hThink = 0x5C8; // uint16
                ...
                constexpr std::ptrdiff_t m_bAnimTimeChanged = 0x6B1; // bool
                constexpr std::ptrdiff_t m_bSimulationTimeChanged = 0x6B2; // bool
                constexpr std::ptrdiff_t m_sUniqueHammerID = 0x6C0; // CUtlString
                constexpr std::ptrdiff_t m_nBloodType = 0x6C8; // BloodType
            }
            // Parent: None
            // Fields count: 11
            //
            ...
            namespace C_PhysicsProp {
                constexpr std::ptrdiff_t m_bAwake = 0xFE5; // bool
            }
            // Parent: CBaseProp
            // Fields count: 26
            //
            ...
            namespace C_BreakableProp {
                constexpr std::ptrdiff_t m_CPropDataComponent = 0xEB8; // CPropDataComponent
                constexpr std::ptrdiff_t m_OnBreak = 0xEF8; // CEntityIOOutput
                constexpr std::ptrdiff_t m_OnHealthChanged = 0xF20; // CEntityOutputTemplate<float32>
                constexpr std::ptrdiff_t m_OnTakeDamage = 0xF48; // CEntityIOOutput
                constexpr std::ptrdiff_t m_impactEnergyScale = 0xF70; // float32
                constexpr std::ptrdiff_t m_iMinHealthDmg = 0xF74; // int32
                constexpr std::ptrdiff_t m_flPressureDelay = 0xF78; // float32
                constexpr std::ptrdiff_t m_flDefBurstScale = 0xF7C; // float32
                constexpr std::ptrdiff_t m_vDefBurstOffset = 0xF80; // Vector
                constexpr std::ptrdiff_t m_hBreaker = 0xF8C; // CHandle<C_BaseEntity>
                constexpr std::ptrdiff_t m_PerformanceMode = 0xF90; // PerformanceMode_t
                constexpr std::ptrdiff_t m_flPreventDamageBeforeTime = 0xF94; // GameTime_t
                constexpr std::ptrdiff_t m_bHasBreakPiecesOrCommands = 0xF98; // bool
                constexpr std::ptrdiff_t m_explodeDamage = 0xF9C; // float32
                constexpr std::ptrdiff_t m_explodeRadius = 0xFA0; // float32
                constexpr std::ptrdiff_t m_explosionDelay = 0xFA8; // float32
                constexpr std::ptrdiff_t m_explosionBuildupSound = 0xFB0; // CUtlSymbolLarge
                constexpr std::ptrdiff_t m_explosionCustomEffect = 0xFB8; // CUtlSymbolLarge
                constexpr std::ptrdiff_t m_explosionCustomSound = 0xFC0; // CUtlSymbolLarge
                constexpr std::ptrdiff_t m_explosionModifier = 0xFC8; // CUtlSymbolLarge
                constexpr std::ptrdiff_t m_hPhysicsAttacker = 0xFD0; // CHandle<C_BasePlayerPawn>
                constexpr std::ptrdiff_t m_flLastPhysicsInfluenceTime = 0xFD4; // GameTime_t
                constexpr std::ptrdiff_t m_flDefaultFadeScale = 0xFD8; // float32
                constexpr std::ptrdiff_t m_hLastAttacker = 0xFDC; // CHandle<C_BaseEntity>
                constexpr std::ptrdiff_t m_hFlareEnt = 0xFE0; // CHandle<C_BaseEntity>
                constexpr std::ptrdiff_t m_noGhostCollision = 0xFE4; // bool
            }
            // Parent: C_BaseToggle
            // Fields count: 0
            //
            ...
            namespace C_CSGO_TeamPreviewCharacterPosition {
                constexpr std::ptrdiff_t m_nVariant = 0x6CC; // int32
                constexpr std::ptrdiff_t m_nRandom = 0x6D0; // int32
                constexpr std::ptrdiff_t m_nOrdinal = 0x6D4; // int32
                constexpr std::ptrdiff_t m_sWeaponName = 0x6D8; // CUtlString
                constexpr std::ptrdiff_t m_xuid = 0x6E0; // uint64
                constexpr std::ptrdiff_t m_agentItem = 0x6E8; // C_EconItemView
                constexpr std::ptrdiff_t m_glovesItem = 0x1A38; // C_EconItemView
                constexpr std::ptrdiff_t m_weaponItem = 0x2D88; // C_EconItemView
            }
            // Parent: C_DynamicProp
            // Fields count: 0
            ...
            namespace C_BasePropDoor {
                constexpr std::ptrdiff_t m_eDoorState = 0x1104; // DoorState_t
                constexpr std::ptrdiff_t m_modelChanged = 0x1108; // bool
                constexpr std::ptrdiff_t m_bLocked = 0x1109; // bool
                constexpr std::ptrdiff_t m_closedPosition = 0x110C; // Vector
                constexpr std::ptrdiff_t m_closedAngles = 0x1118; // QAngle
                constexpr std::ptrdiff_t m_hMaster = 0x1124; // CHandle<C_BasePropDoor>
                constexpr std::ptrdiff_t m_vWhereToSetLightingOrigin = 0x1128; // Vector
            }
            // Parent: C_CSGO_TeamSelectCharacterPosition
            // Fields count: 0
            ...
            namespace C_PhysPropClientside {
                constexpr std::ptrdiff_t m_flTouchDelta = 0xFE8; // GameTime_t
                constexpr std::ptrdiff_t m_fDeathTime = 0xFEC; // GameTime_t
                constexpr std::ptrdiff_t m_inertiaScale = 0xFF0; // float32
                constexpr std::ptrdiff_t m_vecDamagePosition = 0xFF4; // Vector
                constexpr std::ptrdiff_t m_vecDamageDirection = 0x1000; // Vector
                constexpr std::ptrdiff_t m_nDamageType = 0x100C; // int32
            }
            // Parent: C_CSGO_TeamPreviewCamera
            // Fields count: 0
            ...
            namespace C_SoundAreaEntityBase {
                constexpr std::ptrdiff_t m_bDisabled = 0x6CC; // bool
                constexpr std::ptrdiff_t m_bWasEnabled = 0x6D4; // bool
                constexpr std::ptrdiff_t m_iszSoundAreaType = 0x6D8; // CUtlSymbolLarge
                constexpr std::ptrdiff_t m_vPos = 0x6E0; // Vector
            }
            // Parent: C_BaseEntity
            // Fields count: 3
            //
            ...
            namespace C_PhysMagnet {
                constexpr std::ptrdiff_t m_aAttachedObjectsFromServer = 0xE78; // CUtlVector<int32>
            ...
            namespace C_EntityFlame {
                constexpr std::ptrdiff_t m_hEntAttached = 0x6CC; // CHandle<C_BaseEntity>
                constexpr std::ptrdiff_t m_hOldAttached = 0x6F0; // CHandle<C_BaseEntity>
                constexpr std::ptrdiff_t m_bCheapEffect = 0x6F4; // bool
            }
            // Parent: C_BaseGrenade
            // Fields count: 0
            ...
            // NetworkVarNames: m_flHDRColorScale (float32)
            namespace C_Sprite {
                constexpr std::ptrdiff_t m_hSpriteMaterial = 0xC50; // CStrongHandle<InfoForResourceTypeIMaterial2>
                constexpr std::ptrdiff_t m_hAttachedToEntity = 0xC58; // CHandle<C_BaseEntity>
                constexpr std::ptrdiff_t m_nAttachment = 0xC5C; // AttachmentHandle_t
                constexpr std::ptrdiff_t m_flSpriteFramerate = 0xC60; // float32
                constexpr std::ptrdiff_t m_flFrame = 0xC64; // float32
                constexpr std::ptrdiff_t m_flDieTime = 0xC68; // GameTime_t
                constexpr std::ptrdiff_t m_nBrightness = 0xC78; // uint32
                constexpr std::ptrdiff_t m_flBrightnessDuration = 0xC7C; // float32
                constexpr std::ptrdiff_t m_flSpriteScale = 0xC80; // float32
                constexpr std::ptrdiff_t m_flScaleDuration = 0xC84; // float32
                constexpr std::ptrdiff_t m_bWorldSpaceScale = 0xC88; // bool
                constexpr std::ptrdiff_t m_flGlowProxySize = 0xC8C; // float32
                constexpr std::ptrdiff_t m_flHDRColorScale = 0xC90; // float32
                constexpr std::ptrdiff_t m_flLastTime = 0xC94; // GameTime_t
                constexpr std::ptrdiff_t m_flMaxFrame = 0xC98; // float32
                constexpr std::ptrdiff_t m_flStartScale = 0xC9C; // float32
                constexpr std::ptrdiff_t m_flDestScale = 0xCA0; // float32
                constexpr std::ptrdiff_t m_flScaleTimeStart = 0xCA4; // GameTime_t
                constexpr std::ptrdiff_t m_nStartBrightness = 0xCA8; // int32
                constexpr std::ptrdiff_t m_nDestBrightness = 0xCAC; // int32
                constexpr std::ptrdiff_t m_flBrightnessTimeStart = 0xCB0; // GameTime_t
                constexpr std::ptrdiff_t m_hOldSpriteMaterial = 0xCB8; // CWeakHandle<InfoForResourceTypeIMaterial2>
                constexpr std::ptrdiff_t m_nSpriteWidth = 0xD58; // int32
                constexpr std::ptrdiff_t m_nSpriteHeight = 0xD5C; // int32
            }
            // Parent: C_CSWeaponBaseGun
            // Fields count: 0
            ...
            // NetworkVarNames: m_AttributeManager (CAttributeContainer)
            namespace C_Chicken {
                constexpr std::ptrdiff_t m_hHolidayHatAddon = 0x1100; // CHandle<CBaseAnimGraph>
                constexpr std::ptrdiff_t m_jumpedThisFrame = 0x1104; // bool
                constexpr std::ptrdiff_t m_leader = 0x1108; // CHandle<C_CSPlayerPawn>
                constexpr std::ptrdiff_t m_AttributeManager = 0x1110; // C_AttributeContainer
                constexpr std::ptrdiff_t m_bAttributesInitialized = 0x24C0; // bool
                constexpr std::ptrdiff_t m_hWaterWakeParticles = 0x24C4; // ParticleIndex_t
                constexpr std::ptrdiff_t m_bIsPreviewModel = 0x24C8; // bool
            }
            // Parent: None
            // Fields count: 4
            //
