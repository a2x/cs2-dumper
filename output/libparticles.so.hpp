    ...
    namespace schemas {
        ...
        namespace libparticles_so {
            ...
            namespace C_OP_RenderScreenVelocityRotate {
                constexpr std::ptrdiff_t m_flRotateRateDegrees = 0x1F8; // float32
                constexpr std::ptrdiff_t m_flForwardDegrees = 0x1FC; // float32
            }
            // Parent: CParticleFunctionOperator
            // Fields count: 6
            //
            ...
            namespace C_OP_RenderLights {
                constexpr std::ptrdiff_t m_flAnimationRate = 0x200; // float32
                constexpr std::ptrdiff_t m_nAnimationType = 0x204; // AnimationType_t
                constexpr std::ptrdiff_t m_bAnimateInFPS = 0x208; // bool
                constexpr std::ptrdiff_t m_flMinSize = 0x20C; // float32
                constexpr std::ptrdiff_t m_flMaxSize = 0x210; // float32
                constexpr std::ptrdiff_t m_flStartFadeSize = 0x214; // float32
                constexpr std::ptrdiff_t m_flEndFadeSize = 0x218; // float32
            }
            // Parent: CParticleFunctionOperator
            // Fields count: 1
            //
