    ...
    namespace schemas {
        ...
        namespace libparticles_so {
            ...
            namespace C_OP_RenderDeferredLight {
                constexpr std::ptrdiff_t m_bUseAlphaTestWindow = 0x21A; // bool
                constexpr std::ptrdiff_t m_bUseTexture = 0x21B; // bool
                constexpr std::ptrdiff_t m_flRadiusScale = 0x21C; // float32
                constexpr std::ptrdiff_t m_flAlphaScale = 0x220; // float32
                constexpr std::ptrdiff_t m_nAlpha2Field = 0x224; // ParticleAttributeIndex_t
                constexpr std::ptrdiff_t m_vecColorScale = 0x228; // CParticleCollectionVecInput
                constexpr std::ptrdiff_t m_nColorBlendType = 0x8B8; // ParticleColorBlendType_t
                constexpr std::ptrdiff_t m_flLightDistance = 0x8BC; // float32
                constexpr std::ptrdiff_t m_flStartFalloff = 0x8C0; // float32
                constexpr std::ptrdiff_t m_flDistanceFalloff = 0x8C4; // float32
                constexpr std::ptrdiff_t m_flSpotFoV = 0x8C8; // float32
                constexpr std::ptrdiff_t m_nAlphaTestPointField = 0x8CC; // ParticleAttributeIndex_t
                constexpr std::ptrdiff_t m_nAlphaTestRangeField = 0x8D0; // ParticleAttributeIndex_t
                constexpr std::ptrdiff_t m_nAlphaTestSharpnessField = 0x8D4; // ParticleAttributeIndex_t
                constexpr std::ptrdiff_t m_hTexture = 0x8D8; // CStrongHandle<InfoForResourceTypeCTextureBase>
                constexpr std::ptrdiff_t m_nHSVShiftControlPoint = 0x8E0; // int32
            }
            // Parent: None
            // Fields count: 8
            //
            ...
            namespace C_OP_RemapSpeedtoCP {
                ...
                constexpr std::ptrdiff_t m_bUseDeltaV = 0x1F0; // bool
            }
            // Parent: None
            // Fields count: 1
            //
            ...
            namespace C_OP_SpringToVectorConstraint {
                ...
                constexpr std::ptrdiff_t m_flMinDistance = 0x338; // CPerParticleFloatInput
                constexpr std::ptrdiff_t m_flMaxDistance = 0x4A0; // CPerParticleFloatInput
                constexpr std::ptrdiff_t m_flRestingLength = 0x608; // CPerParticleFloatInput
                constexpr std::ptrdiff_t m_vecAnchorVector = 0x770; // CPerParticleVecInput
            }
            // Parent: None
            // Fields count: 33
            //
            ...
            namespace C_OP_RenderRopes {
                constexpr std::ptrdiff_t m_bEnableFadingAndClamping = 0x2D00; // bool
                constexpr std::ptrdiff_t m_flMinSize = 0x2D04; // float32
                constexpr std::ptrdiff_t m_flMaxSize = 0x2D08; // float32
                constexpr std::ptrdiff_t m_flStartFadeSize = 0x2D0C; // float32
                constexpr std::ptrdiff_t m_flEndFadeSize = 0x2D10; // float32
                constexpr std::ptrdiff_t m_flStartFadeDot = 0x2D14; // float32
                constexpr std::ptrdiff_t m_flEndFadeDot = 0x2D18; // float32
                constexpr std::ptrdiff_t m_flSubPixelAAScale = 0x2D20; // CParticleCollectionRendererFloatInput
                constexpr std::ptrdiff_t m_flRadiusTaper = 0x2E88; // float32
                constexpr std::ptrdiff_t m_nMinTesselation = 0x2E8C; // int32
                constexpr std::ptrdiff_t m_nMaxTesselation = 0x2E90; // int32
                constexpr std::ptrdiff_t m_flTessScale = 0x2E94; // float32
                constexpr std::ptrdiff_t m_flTextureVWorldSize = 0x2E98; // CParticleCollectionRendererFloatInput
                constexpr std::ptrdiff_t m_flTextureVScrollRate = 0x3000; // CParticleCollectionRendererFloatInput
                constexpr std::ptrdiff_t m_flTextureVOffset = 0x3168; // CParticleCollectionRendererFloatInput
                constexpr std::ptrdiff_t m_nTextureVParamsCP = 0x32D0; // int32
                constexpr std::ptrdiff_t m_bClampV = 0x32D4; // bool
                constexpr std::ptrdiff_t m_nScaleCP1 = 0x32D8; // int32
                constexpr std::ptrdiff_t m_nScaleCP2 = 0x32DC; // int32
                constexpr std::ptrdiff_t m_flScaleVSizeByControlPointDistance = 0x32E0; // float32
                constexpr std::ptrdiff_t m_flScaleVScrollByControlPointDistance = 0x32E4; // float32
                constexpr std::ptrdiff_t m_flScaleVOffsetByControlPointDistance = 0x32E8; // float32
                constexpr std::ptrdiff_t m_bUseScalarForTextureCoordinate = 0x32ED; // bool
                constexpr std::ptrdiff_t m_nScalarFieldForTextureCoordinate = 0x32F0; // ParticleAttributeIndex_t
                constexpr std::ptrdiff_t m_flScalarAttributeTextureCoordScale = 0x32F4; // float32
                constexpr std::ptrdiff_t m_bReverseOrder = 0x32F8; // bool
                constexpr std::ptrdiff_t m_bClosedLoop = 0x32F9; // bool
                constexpr std::ptrdiff_t m_nSplitField = 0x32FC; // ParticleAttributeIndex_t
                constexpr std::ptrdiff_t m_bSortBySegmentID = 0x3300; // bool
                constexpr std::ptrdiff_t m_nOrientationType = 0x3304; // ParticleOrientationChoiceList_t
                constexpr std::ptrdiff_t m_nVectorFieldForOrientation = 0x3308; // ParticleAttributeIndex_t
                constexpr std::ptrdiff_t m_bDrawAsOpaque = 0x330C; // bool
                constexpr std::ptrdiff_t m_bGenerateNormals = 0x330D; // bool
            }
            // Parent: None
            // Fields count: 19
            //
            ...
            namespace C_INIT_StatusEffectCitadel {
                constexpr std::ptrdiff_t m_flSFXColorWarpAmount = 0x1D4; // float32
                constexpr std::ptrdiff_t m_flSFXNormalAmount = 0x1D8; // float32
                constexpr std::ptrdiff_t m_flSFXMetalnessAmount = 0x1DC; // float32
                constexpr std::ptrdiff_t m_flSFXRoughnessAmount = 0x1E0; // float32
                constexpr std::ptrdiff_t m_flSFXSelfIllumAmount = 0x1E4; // float32
                constexpr std::ptrdiff_t m_flSFXSScale = 0x1E8; // float32
                constexpr std::ptrdiff_t m_flSFXSScrollX = 0x1EC; // float32
                constexpr std::ptrdiff_t m_flSFXSScrollY = 0x1F0; // float32
                constexpr std::ptrdiff_t m_flSFXSScrollZ = 0x1F4; // float32
                constexpr std::ptrdiff_t m_flSFXSOffsetX = 0x1F8; // float32
                constexpr std::ptrdiff_t m_flSFXSOffsetY = 0x1FC; // float32
                constexpr std::ptrdiff_t m_flSFXSOffsetZ = 0x200; // float32
                constexpr std::ptrdiff_t m_nDetailCombo = 0x204; // DetailCombo_t
                constexpr std::ptrdiff_t m_flSFXSDetailAmount = 0x208; // float32
                constexpr std::ptrdiff_t m_flSFXSDetailScale = 0x20C; // float32
                constexpr std::ptrdiff_t m_flSFXSDetailScrollX = 0x210; // float32
                constexpr std::ptrdiff_t m_flSFXSDetailScrollY = 0x214; // float32
                constexpr std::ptrdiff_t m_flSFXSDetailScrollZ = 0x218; // float32
                constexpr std::ptrdiff_t m_flSFXSUseModelUVs = 0x21C; // float32
            }
            // Parent: None
            // Fields count: 12
            //
            ...
            namespace C_OP_RenderSound {
                constexpr std::ptrdiff_t m_flDurationScale = 0x21C; // float32
                constexpr std::ptrdiff_t m_flSndLvlScale = 0x220; // float32
                constexpr std::ptrdiff_t m_flPitchScale = 0x224; // float32
                constexpr std::ptrdiff_t m_flVolumeScale = 0x228; // float32
                constexpr std::ptrdiff_t m_nSndLvlField = 0x22C; // ParticleAttributeIndex_t
                constexpr std::ptrdiff_t m_nDurationField = 0x230; // ParticleAttributeIndex_t
                constexpr std::ptrdiff_t m_nPitchField = 0x234; // ParticleAttributeIndex_t
                constexpr std::ptrdiff_t m_nVolumeField = 0x238; // ParticleAttributeIndex_t
                constexpr std::ptrdiff_t m_nChannel = 0x23C; // int32
                constexpr std::ptrdiff_t m_nCPReference = 0x240; // int32
                constexpr std::ptrdiff_t m_pszSoundName = 0x244; // char[256]
                constexpr std::ptrdiff_t m_bSuppressStopSoundEvent = 0x344; // bool
            }
            // Parent: None
            // Fields count: 19
            //
            ...
            namespace C_OP_PointVectorAtNextParticle {
                ...
                constexpr std::ptrdiff_t m_bPrevious = 0x340; // bool
            }
            // Parent: None
            // Fields count: 2
            //
            ...
            namespace C_INIT_StatusEffect {
                constexpr std::ptrdiff_t m_nDetail2Combo = 0x1D4; // Detail2Combo_t
                constexpr std::ptrdiff_t m_flDetail2Rotation = 0x1D8; // float32
                constexpr std::ptrdiff_t m_flDetail2Scale = 0x1DC; // float32
                constexpr std::ptrdiff_t m_flDetail2BlendFactor = 0x1E0; // float32
                constexpr std::ptrdiff_t m_flColorWarpIntensity = 0x1E4; // float32
                constexpr std::ptrdiff_t m_flDiffuseWarpBlendToFull = 0x1E8; // float32
                constexpr std::ptrdiff_t m_flEnvMapIntensity = 0x1EC; // float32
                constexpr std::ptrdiff_t m_flAmbientScale = 0x1F0; // float32
                constexpr std::ptrdiff_t m_specularColor = 0x1F4; // Color
                constexpr std::ptrdiff_t m_flSpecularScale = 0x1F8; // float32
                constexpr std::ptrdiff_t m_flSpecularExponent = 0x1FC; // float32
                constexpr std::ptrdiff_t m_flSpecularExponentBlendToFull = 0x200; // float32
                constexpr std::ptrdiff_t m_flSpecularBlendToFull = 0x204; // float32
                constexpr std::ptrdiff_t m_rimLightColor = 0x208; // Color
                constexpr std::ptrdiff_t m_flRimLightScale = 0x20C; // float32
                constexpr std::ptrdiff_t m_flReflectionsTintByBaseBlendToNone = 0x210; // float32
                constexpr std::ptrdiff_t m_flMetalnessBlendToFull = 0x214; // float32
                constexpr std::ptrdiff_t m_flSelfIllumBlendToFull = 0x218; // float32
            }
            // Parent: None
            // Fields count: 8
            //
            ...
            namespace C_INIT_RtEnvCull {
                constexpr std::ptrdiff_t m_vecTestDir = 0x1D4; // Vector
                constexpr std::ptrdiff_t m_vecTestNormal = 0x1E0; // Vector
                constexpr std::ptrdiff_t m_bUseVelocity = 0x1EC; // bool
                constexpr std::ptrdiff_t m_bCullOnMiss = 0x1ED; // bool
                constexpr std::ptrdiff_t m_bLifeAdjust = 0x1EE; // bool
                constexpr std::ptrdiff_t m_RtEnvName = 0x1EF; // char[128]
                constexpr std::ptrdiff_t m_nRTEnvCP = 0x270; // int32
                constexpr std::ptrdiff_t m_nComponent = 0x274; // int32
            }
            // Parent: None
            // Fields count: 5
            //
            ...
            namespace C_OP_ConstrainDistance {
                ...
                constexpr std::ptrdiff_t m_fMaxDistance = 0x338; // CParticleCollectionFloatInput
                constexpr std::ptrdiff_t m_nControlPointNumber = 0x4A0; // int32
                constexpr std::ptrdiff_t m_CenterOffset = 0x4A4; // Vector
                constexpr std::ptrdiff_t m_bGlobalCenter = 0x4B0; // bool
            }
            // Parent: None
            // Fields count: 4
            //
            ...
            namespace C_INIT_RandomVector {
                constexpr std::ptrdiff_t m_vecMin = 0x1D4; // Vector
                constexpr std::ptrdiff_t m_vecMax = 0x1E0; // Vector
                constexpr std::ptrdiff_t m_nFieldOutput = 0x1EC; // ParticleAttributeIndex_t
                constexpr std::ptrdiff_t m_randomnessParameters = 0x1F0; // CRandomNumberGeneratorParameters
            }
            // Parent: None
            // Fields count: 10
            //
            ...
            namespace C_INIT_InitialVelocityNoise {
                constexpr std::ptrdiff_t m_vecAbsVal = 0x1D4; // Vector
                constexpr std::ptrdiff_t m_vecAbsValInv = 0x1E0; // Vector
                constexpr std::ptrdiff_t m_vecOffsetLoc = 0x1F0; // CPerParticleVecInput
                constexpr std::ptrdiff_t m_flOffset = 0x880; // CPerParticleFloatInput
                constexpr std::ptrdiff_t m_vecOutputMin = 0x9E8; // CPerParticleVecInput
                constexpr std::ptrdiff_t m_vecOutputMax = 0x1078; // CPerParticleVecInput
                constexpr std::ptrdiff_t m_flNoiseScale = 0x1708; // CPerParticleFloatInput
                constexpr std::ptrdiff_t m_flNoiseScaleLoc = 0x1870; // CPerParticleFloatInput
                constexpr std::ptrdiff_t m_TransformInput = 0x19D8; // CParticleTransformInput
                constexpr std::ptrdiff_t m_bIgnoreDt = 0x1A38; // bool
            }
            // Parent: None
            // Fields count: 5
            //
            ...
            namespace C_OP_PlaneCull {
                ...
                constexpr std::ptrdiff_t m_bLocalSpace = 0x868; // bool
                constexpr std::ptrdiff_t m_flPlaneOffset = 0x86C; // float32
            }
            // Parent: None
            // Fields count: 7
            //
            ...
            namespace C_INIT_VelocityRandom {
                ...
                constexpr std::ptrdiff_t m_fSpeedMin = 0x1D8; // CPerParticleFloatInput
                constexpr std::ptrdiff_t m_fSpeedMax = 0x340; // CPerParticleFloatInput
                constexpr std::ptrdiff_t m_LocalCoordinateSystemSpeedMin = 0x4A8; // CPerParticleVecInput
                constexpr std::ptrdiff_t m_LocalCoordinateSystemSpeedMax = 0xB38; // CPerParticleVecInput
                constexpr std::ptrdiff_t m_bIgnoreDT = 0x11C8; // bool
                constexpr std::ptrdiff_t m_randomnessParameters = 0x11CC; // CRandomNumberGeneratorParameters
            }
            // Parent: None
            // Fields count: 7
            //
            ...
            namespace C_OP_ModelDampenMovement {
                ...
                constexpr std::ptrdiff_t m_fDrag = 0x8E8; // float32
            }
            // Parent: None
            // Fields count: 4
            //
            ...
            namespace C_OP_TwistAroundAxis {
                constexpr std::ptrdiff_t m_fForceAmount = 0x1DC; // float32
                constexpr std::ptrdiff_t m_TwistAxis = 0x1E0; // Vector
            ...
            namespace C_OP_RemapExternalWindToCP {
                ...
                constexpr std::ptrdiff_t m_nCPOutput = 0x1D8; // int32
                constexpr std::ptrdiff_t m_vecScale = 0x1E0; // CParticleCollectionVecInput
                constexpr std::ptrdiff_t m_bSetMagnitude = 0x870; // bool
                constexpr std::ptrdiff_t m_nOutVectorField = 0x874; // int32
            }
            // Parent: None
            // Fields count: 65
            //
            ...
            namespace CBaseRendererSource2 {
                ...
                constexpr std::ptrdiff_t m_flAlphaScale = 0x388; // CParticleCollectionRendererFloatInput
                constexpr std::ptrdiff_t m_flRollScale = 0x4F0; // CParticleCollectionRendererFloatInput
                constexpr std::ptrdiff_t m_nAlpha2Field = 0x658; // ParticleAttributeIndex_t
                constexpr std::ptrdiff_t m_vecColorScale = 0x660; // CParticleCollectionRendererVecInput
                constexpr std::ptrdiff_t m_nColorBlendType = 0xCF0; // ParticleColorBlendType_t
                constexpr std::ptrdiff_t m_nShaderType = 0xCF4; // SpriteCardShaderType_t
                constexpr std::ptrdiff_t m_strShaderOverride = 0xCF8; // CUtlString
                constexpr std::ptrdiff_t m_flCenterXOffset = 0xD00; // CParticleCollectionRendererFloatInput
                constexpr std::ptrdiff_t m_flCenterYOffset = 0xE68; // CParticleCollectionRendererFloatInput
                constexpr std::ptrdiff_t m_flBumpStrength = 0xFD0; // float32
                constexpr std::ptrdiff_t m_nCropTextureOverride = 0xFD4; // ParticleSequenceCropOverride_t
                constexpr std::ptrdiff_t m_vecTexturesInput = 0xFD8; // CUtlLeanVector<TextureGroup_t>
                constexpr std::ptrdiff_t m_flAnimationRate = 0xFE8; // float32
                constexpr std::ptrdiff_t m_nAnimationType = 0xFEC; // AnimationType_t
                constexpr std::ptrdiff_t m_bAnimateInFPS = 0xFF0; // bool
                constexpr std::ptrdiff_t m_flMotionVectorScaleU = 0xFF8; // CParticleCollectionRendererFloatInput
                constexpr std::ptrdiff_t m_flMotionVectorScaleV = 0x1160; // CParticleCollectionRendererFloatInput
                constexpr std::ptrdiff_t m_flSelfIllumAmount = 0x12C8; // CParticleCollectionRendererFloatInput
                constexpr std::ptrdiff_t m_flDiffuseAmount = 0x1430; // CParticleCollectionRendererFloatInput
                constexpr std::ptrdiff_t m_flDiffuseClamp = 0x1598; // CParticleCollectionRendererFloatInput
                constexpr std::ptrdiff_t m_nLightingControlPoint = 0x1700; // int32
                constexpr std::ptrdiff_t m_nOutputBlendMode = 0x1704; // ParticleOutputBlendMode_t
                constexpr std::ptrdiff_t m_bGammaCorrectVertexColors = 0x1708; // bool
                constexpr std::ptrdiff_t m_bSaturateColorPreAlphaBlend = 0x1709; // bool
                constexpr std::ptrdiff_t m_flAddSelfAmount = 0x1710; // CParticleCollectionRendererFloatInput
                constexpr std::ptrdiff_t m_flDesaturation = 0x1878; // CParticleCollectionRendererFloatInput
                constexpr std::ptrdiff_t m_flOverbrightFactor = 0x19E0; // CParticleCollectionRendererFloatInput
                constexpr std::ptrdiff_t m_nHSVShiftControlPoint = 0x1B48; // int32
                constexpr std::ptrdiff_t m_nFogType = 0x1B4C; // ParticleFogType_t
                constexpr std::ptrdiff_t m_flFogAmount = 0x1B50; // CParticleCollectionRendererFloatInput
                constexpr std::ptrdiff_t m_bTintByFOW = 0x1CB8; // bool
                constexpr std::ptrdiff_t m_bTintByGlobalLight = 0x1CB9; // bool
                constexpr std::ptrdiff_t m_nPerParticleAlphaReference = 0x1CBC; // SpriteCardPerParticleScale_t
                constexpr std::ptrdiff_t m_nPerParticleAlphaRefWindow = 0x1CC0; // SpriteCardPerParticleScale_t
                constexpr std::ptrdiff_t m_nAlphaReferenceType = 0x1CC4; // ParticleAlphaReferenceType_t
                constexpr std::ptrdiff_t m_flAlphaReferenceSoftness = 0x1CC8; // CParticleCollectionRendererFloatInput
                constexpr std::ptrdiff_t m_flSourceAlphaValueToMapToZero = 0x1E30; // CParticleCollectionRendererFloatInput
                constexpr std::ptrdiff_t m_flSourceAlphaValueToMapToOne = 0x1F98; // CParticleCollectionRendererFloatInput
                constexpr std::ptrdiff_t m_bRefract = 0x2100; // bool
                constexpr std::ptrdiff_t m_bRefractSolid = 0x2101; // bool
                constexpr std::ptrdiff_t m_bRefract2Passes = 0x2102; // bool
                constexpr std::ptrdiff_t m_flRefractAmount = 0x2108; // CParticleCollectionRendererFloatInput
                constexpr std::ptrdiff_t m_nRefractBlurRadius = 0x2270; // int32
                constexpr std::ptrdiff_t m_nRefractBlurType = 0x2274; // BlurFilterType_t
                constexpr std::ptrdiff_t m_bOnlyRenderInEffectsBloomPass = 0x2278; // bool
                constexpr std::ptrdiff_t m_bOnlyRenderInEffectsWaterPass = 0x2279; // bool
                constexpr std::ptrdiff_t m_bUseMixedResolutionRendering = 0x227A; // bool
                constexpr std::ptrdiff_t m_bOnlyRenderInEffecsGameOverlay = 0x227B; // bool
                constexpr std::ptrdiff_t m_stencilTestID = 0x227C; // char[128]
                constexpr std::ptrdiff_t m_bStencilTestExclude = 0x22FC; // bool
                constexpr std::ptrdiff_t m_stencilWriteID = 0x22FD; // char[128]
                constexpr std::ptrdiff_t m_bWriteStencilOnDepthPass = 0x237D; // bool
                constexpr std::ptrdiff_t m_bWriteStencilOnDepthFail = 0x237E; // bool
                constexpr std::ptrdiff_t m_bReverseZBuffering = 0x237F; // bool
                constexpr std::ptrdiff_t m_bDisableZBuffering = 0x2380; // bool
                constexpr std::ptrdiff_t m_nFeatheringMode = 0x2384; // ParticleDepthFeatheringMode_t
                constexpr std::ptrdiff_t m_flFeatheringMinDist = 0x2388; // CParticleCollectionRendererFloatInput
                constexpr std::ptrdiff_t m_flFeatheringMaxDist = 0x24F0; // CParticleCollectionRendererFloatInput
                constexpr std::ptrdiff_t m_flFeatheringFilter = 0x2658; // CParticleCollectionRendererFloatInput
                constexpr std::ptrdiff_t m_flFeatheringDepthMapFilter = 0x27C0; // CParticleCollectionRendererFloatInput
                constexpr std::ptrdiff_t m_flDepthBias = 0x2928; // CParticleCollectionRendererFloatInput
                constexpr std::ptrdiff_t m_nSortMethod = 0x2A90; // ParticleSortingChoiceList_t
                constexpr std::ptrdiff_t m_bBlendFramesSeq0 = 0x2A94; // bool
                constexpr std::ptrdiff_t m_bMaxLuminanceBlendingSequence0 = 0x2A95; // bool
            }
            // Parent: None
            // Fields count: 0
            //
            ...
            namespace C_OP_OrientTo2dDirection {
                constexpr std::ptrdiff_t m_vecInput = 0x1D0; // CPerParticleVecInput
                constexpr std::ptrdiff_t m_flRotOffset = 0x860; // float32
                constexpr std::ptrdiff_t m_flSpinStrength = 0x864; // float32
                constexpr std::ptrdiff_t m_nFieldOutput = 0x868; // ParticleAttributeIndex_t
            }
            // Parent: None
            // Fields count: 8
            //
            ...
            namespace C_OP_RemapDotProductToCP {
                constexpr std::ptrdiff_t m_nInputCP1 = 0x1D4; // int32
                constexpr std::ptrdiff_t m_nInputCP2 = 0x1D8; // int32
                constexpr std::ptrdiff_t m_nOutputCP = 0x1DC; // int32
                constexpr std::ptrdiff_t m_nOutVectorField = 0x1E0; // int32
                constexpr std::ptrdiff_t m_flInputMin = 0x1E8; // CParticleCollectionFloatInput
                constexpr std::ptrdiff_t m_flInputMax = 0x350; // CParticleCollectionFloatInput
                constexpr std::ptrdiff_t m_flOutputMin = 0x4B8; // CParticleCollectionFloatInput
                constexpr std::ptrdiff_t m_flOutputMax = 0x620; // CParticleCollectionFloatInput
            }
            // Parent: None
            // Fields count: 4
            //
            ...
            namespace C_INIT_RemapParticleCountToNamedModelElementScalar {
                ...
                constexpr std::ptrdiff_t m_outputMinName = 0x208; // CUtlString
                constexpr std::ptrdiff_t m_outputMaxName = 0x210; // CUtlString
            ...
            namespace C_OP_RenderTrails {
                constexpr std::ptrdiff_t m_bEnableFadingAndClamping = 0x3149; // bool
                constexpr std::ptrdiff_t m_flStartFadeDot = 0x314C; // float32
                constexpr std::ptrdiff_t m_flEndFadeDot = 0x3150; // float32
                constexpr std::ptrdiff_t m_nPrevPntSource = 0x3154; // ParticleAttributeIndex_t
                constexpr std::ptrdiff_t m_flMaxLength = 0x3158; // float32
                constexpr std::ptrdiff_t m_flMinLength = 0x315C; // float32
                constexpr std::ptrdiff_t m_bIgnoreDT = 0x3160; // bool
                constexpr std::ptrdiff_t m_flConstrainRadiusToLengthRatio = 0x3164; // float32
                constexpr std::ptrdiff_t m_flLengthScale = 0x3168; // float32
                constexpr std::ptrdiff_t m_flLengthFadeInTime = 0x316C; // float32
                constexpr std::ptrdiff_t m_flRadiusHeadTaper = 0x3170; // CPerParticleFloatInput
                constexpr std::ptrdiff_t m_vecHeadColorScale = 0x32D8; // CParticleCollectionVecInput
                constexpr std::ptrdiff_t m_flHeadAlphaScale = 0x3968; // CPerParticleFloatInput
                constexpr std::ptrdiff_t m_flRadiusTaper = 0x3AD0; // CPerParticleFloatInput
                constexpr std::ptrdiff_t m_vecTailColorScale = 0x3C38; // CParticleCollectionVecInput
                constexpr std::ptrdiff_t m_flTailAlphaScale = 0x42C8; // CPerParticleFloatInput
                constexpr std::ptrdiff_t m_nHorizCropField = 0x4430; // ParticleAttributeIndex_t
                constexpr std::ptrdiff_t m_nVertCropField = 0x4434; // ParticleAttributeIndex_t
                constexpr std::ptrdiff_t m_flForwardShift = 0x4438; // float32
                constexpr std::ptrdiff_t m_bFlipUVBasedOnPitchYaw = 0x443C; // bool
            }
            // Parent: None
            // Fields count: 3
            //
            ...
            namespace C_OP_SetControlPointPositionToTimeOfDayValue {
                constexpr std::ptrdiff_t m_nControlPointNumber = 0x1D4; // int32
                constexpr std::ptrdiff_t m_pszTimeOfDayParameter = 0x1D8; // char[128]
                constexpr std::ptrdiff_t m_vecDefaultValue = 0x258; // Vector
            }
            // Parent: None
            // Fields count: 7
            //
            ...
            namespace C_OP_DecayMaintainCount {
                ...
                constexpr std::ptrdiff_t m_bKillNewest = 0x358; // bool
            }
            // Parent: None
            // Fields count: 3
            //
            ...
            namespace C_INIT_RandomModelSequence {
                constexpr std::ptrdiff_t m_ActivityName = 0x1D4; // char[256]
                constexpr std::ptrdiff_t m_SequenceName = 0x2D4; // char[256]
            ...
            namespace C_OP_ExternalGameImpulseForce {
                ...
                constexpr std::ptrdiff_t m_bRopes = 0x348; // bool
                constexpr std::ptrdiff_t m_bRopesZOnly = 0x349; // bool
                constexpr std::ptrdiff_t m_bExplosions = 0x34A; // bool
                constexpr std::ptrdiff_t m_bParticles = 0x34B; // bool
            }
            // Parent: None
            // Fields count: 11
            //
            ...
            namespace C_OP_RemapAverageHitboxSpeedtoCP {
                ...
                constexpr std::ptrdiff_t m_nOutControlPointNumber = 0x1D8; // int32
                constexpr std::ptrdiff_t m_nField = 0x1DC; // int32
                constexpr std::ptrdiff_t m_nHitboxDataType = 0x1E0; // ParticleHitboxDataSelection_t
                constexpr std::ptrdiff_t m_flInputMin = 0x1E8; // CParticleCollectionFloatInput
                constexpr std::ptrdiff_t m_flInputMax = 0x350; // CParticleCollectionFloatInput
                constexpr std::ptrdiff_t m_flOutputMin = 0x4B8; // CParticleCollectionFloatInput
                constexpr std::ptrdiff_t m_flOutputMax = 0x620; // CParticleCollectionFloatInput
                constexpr std::ptrdiff_t m_nHeightControlPointNumber = 0x788; // int32
                constexpr std::ptrdiff_t m_vecComparisonVelocity = 0x790; // CParticleCollectionVecInput
                constexpr std::ptrdiff_t m_HitboxSetName = 0xE20; // char[128]
            }
            // Parent: None
            // Fields count: 4
            //
            ...
            namespace C_INIT_RandomAlpha {
                constexpr std::ptrdiff_t m_nFieldOutput = 0x1D4; // ParticleAttributeIndex_t
                constexpr std::ptrdiff_t m_nAlphaMin = 0x1D8; // int32
                constexpr std::ptrdiff_t m_nAlphaMax = 0x1DC; // int32
                constexpr std::ptrdiff_t m_flAlphaRandExponent = 0x1E8; // float32
            }
            // Parent: None
            // Fields count: 2
            //
            ...
            namespace C_OP_RepeatedTriggerChildGroup {
                constexpr std::ptrdiff_t m_nChildGroupID = 0x1D4; // int32
                constexpr std::ptrdiff_t m_flClusterRefireTime = 0x1D8; // CParticleCollectionFloatInput
                constexpr std::ptrdiff_t m_flClusterSize = 0x340; // CParticleCollectionFloatInput
                constexpr std::ptrdiff_t m_flClusterCooldown = 0x4A8; // CParticleCollectionFloatInput
                constexpr std::ptrdiff_t m_bLimitChildCount = 0x610; // bool
            }
            // Parent: None
            // Fields count: 3
            //
            ...
            namespace C_INIT_SetHitboxToClosest {
                ...
                constexpr std::ptrdiff_t m_HitboxSetName = 0x870; // char[128]
                constexpr std::ptrdiff_t m_bUseBones = 0x8F0; // bool
                constexpr std::ptrdiff_t m_bUseClosestPointOnHitbox = 0x8F1; // bool
                constexpr std::ptrdiff_t m_nTestType = 0x8F4; // ClosestPointTestType_t
                constexpr std::ptrdiff_t m_flHybridRatio = 0x8F8; // CParticleCollectionFloatInput
                constexpr std::ptrdiff_t m_bUpdatePosition = 0xA60; // bool
            }
            // Parent: None
            // Fields count: 11
            //
            ...
            namespace C_INIT_RingWave {
                ...
                constexpr std::ptrdiff_t m_flParticlesPerOrbit = 0x238; // CParticleCollectionFloatInput
                constexpr std::ptrdiff_t m_flInitialRadius = 0x3A0; // CPerParticleFloatInput
                constexpr std::ptrdiff_t m_flThickness = 0x508; // CPerParticleFloatInput
                constexpr std::ptrdiff_t m_flInitialSpeedMin = 0x670; // CPerParticleFloatInput
                constexpr std::ptrdiff_t m_flInitialSpeedMax = 0x7D8; // CPerParticleFloatInput
                constexpr std::ptrdiff_t m_flRoll = 0x940; // CPerParticleFloatInput
                constexpr std::ptrdiff_t m_flPitch = 0xAA8; // CPerParticleFloatInput
                constexpr std::ptrdiff_t m_flYaw = 0xC10; // CPerParticleFloatInput
                constexpr std::ptrdiff_t m_bEvenDistribution = 0xD78; // bool
                constexpr std::ptrdiff_t m_bXYVelocityOnly = 0xD79; // bool
            }
            // Parent: None
            // Fields count: 3
            //
            ...
            namespace C_INIT_RandomTrailLength {
                constexpr std::ptrdiff_t m_flMinLength = 0x1D4; // float32
                constexpr std::ptrdiff_t m_flMaxLength = 0x1D8; // float32
                constexpr std::ptrdiff_t m_flLengthRandExponent = 0x1DC; // float32
            }
            // Parent: None
            // Fields count: 7
            //
            ...
            namespace C_OP_DistanceBetweenTransforms {
                ...
                constexpr std::ptrdiff_t m_flInputMax = 0x400; // CPerParticleFloatInput
                constexpr std::ptrdiff_t m_flOutputMin = 0x568; // CPerParticleFloatInput
                constexpr std::ptrdiff_t m_flOutputMax = 0x6D0; // CPerParticleFloatInput
                constexpr std::ptrdiff_t m_flMaxTraceLength = 0x838; // float32
                constexpr std::ptrdiff_t m_flLOSScale = 0x83C; // float32
                constexpr std::ptrdiff_t m_CollisionGroupName = 0x840; // char[128]
                constexpr std::ptrdiff_t m_nTraceSet = 0x8C0; // ParticleTraceSet_t
                constexpr std::ptrdiff_t m_bLOS = 0x8C4; // bool
                constexpr std::ptrdiff_t m_nSetMethod = 0x8C8; // ParticleSetMethod_t
            }
            // Parent: None
            // Fields count: 1
            //
            ...
            namespace C_INIT_CreateSequentialPath {
                constexpr std::ptrdiff_t m_fMaxDistance = 0x1D4; // float32
                constexpr std::ptrdiff_t m_flNumToAssign = 0x1D8; // float32
                constexpr std::ptrdiff_t m_bLoop = 0x1DC; // bool
                constexpr std::ptrdiff_t m_bCPPairs = 0x1DD; // bool
                constexpr std::ptrdiff_t m_bSaveOffset = 0x1DE; // bool
            ...
            namespace C_OP_ContinuousEmitter {
                ...
                constexpr std::ptrdiff_t m_flStartTime = 0x340; // CParticleCollectionFloatInput
                constexpr std::ptrdiff_t m_flEmitRate = 0x4A8; // CParticleCollectionFloatInput
                constexpr std::ptrdiff_t m_flEmissionScale = 0x610; // float32
                constexpr std::ptrdiff_t m_flScalePerParentParticle = 0x614; // float32
                constexpr std::ptrdiff_t m_bInitFromKilledParentParticles = 0x618; // bool
                constexpr std::ptrdiff_t m_nEventType = 0x61C; // EventTypeSelection_t
                constexpr std::ptrdiff_t m_nSnapshotControlPoint = 0x620; // int32
                constexpr std::ptrdiff_t m_strSnapshotSubset = 0x628; // CUtlString
                constexpr std::ptrdiff_t m_nLimitPerUpdate = 0x630; // int32
                constexpr std::ptrdiff_t m_bForceEmitOnFirstUpdate = 0x634; // bool
                constexpr std::ptrdiff_t m_bForceEmitOnLastUpdate = 0x635; // bool
            }
            // Parent: None
            // Fields count: 6
            //
            ...
            namespace C_INIT_SequenceLifeTime {
                constexpr std::ptrdiff_t m_flFramerate = 0x1D4; // float32
            }
            // Parent: None
            // Fields count: 7
            //
            ...
            namespace C_INIT_MoveBetweenPoints {
                ...
                constexpr std::ptrdiff_t m_flSpeedMax = 0x340; // CPerParticleFloatInput
                constexpr std::ptrdiff_t m_flEndSpread = 0x4A8; // CPerParticleFloatInput
                constexpr std::ptrdiff_t m_flStartOffset = 0x610; // CPerParticleFloatInput
                constexpr std::ptrdiff_t m_flEndOffset = 0x778; // CPerParticleFloatInput
                constexpr std::ptrdiff_t m_nEndControlPointNumber = 0x8E0; // int32
                constexpr std::ptrdiff_t m_bTrailBias = 0x8E4; // bool
            }
            // Parent: None
            // Fields count: 5
            //
            ...
            namespace C_OP_SetUserEvent {
                ...
                constexpr std::ptrdiff_t m_flRisingEdge = 0x338; // CPerParticleFloatInput
                constexpr std::ptrdiff_t m_nRisingEventType = 0x4A0; // EventTypeSelection_t
                constexpr std::ptrdiff_t m_flFallingEdge = 0x4A8; // CPerParticleFloatInput
                constexpr std::ptrdiff_t m_nFallingEventType = 0x610; // EventTypeSelection_t
            }
            // Parent: None
            // Fields count: 2
            //
            ...
            namespace C_OP_BasicMovement {
                ...
                constexpr std::ptrdiff_t m_fDrag = 0x860; // CParticleCollectionFloatInput
                constexpr std::ptrdiff_t m_massControls = 0x9C8; // CParticleMassCalculationParameters
                constexpr std::ptrdiff_t m_nMaxConstraintPasses = 0xE08; // int32
                constexpr std::ptrdiff_t m_bUseNewCode = 0xE0C; // bool
            }
            // Parent: None
            // Fields count: 6
            //
            ...
            namespace C_INIT_InitFromParentKilled {
                constexpr std::ptrdiff_t m_nAttributeToCopy = 0x1D4; // ParticleAttributeIndex_t
                constexpr std::ptrdiff_t m_nEventType = 0x1D8; // EventTypeSelection_t
            }
            // Parent: None
            // Fields count: 0
            //
            ...
            namespace CParticleFunction {
                ...
                constexpr std::ptrdiff_t m_nToolsState = 0x174; // ParticleToolsState_t
                constexpr std::ptrdiff_t m_flOpStartFadeInTime = 0x178; // float32
                constexpr std::ptrdiff_t m_flOpEndFadeInTime = 0x17C; // float32
                constexpr std::ptrdiff_t m_flOpStartFadeOutTime = 0x180; // float32
                constexpr std::ptrdiff_t m_flOpEndFadeOutTime = 0x184; // float32
                constexpr std::ptrdiff_t m_flOpFadeOscillatePeriod = 0x188; // float32
                constexpr std::ptrdiff_t m_bNormalizeToStopTime = 0x18C; // bool
                constexpr std::ptrdiff_t m_flOpTimeOffsetMin = 0x190; // float32
                constexpr std::ptrdiff_t m_flOpTimeOffsetMax = 0x194; // float32
                constexpr std::ptrdiff_t m_nOpTimeOffsetSeed = 0x198; // int32
                constexpr std::ptrdiff_t m_nOpTimeScaleSeed = 0x19C; // int32
                constexpr std::ptrdiff_t m_flOpTimeScaleMin = 0x1A0; // float32
                constexpr std::ptrdiff_t m_flOpTimeScaleMax = 0x1A4; // float32
                constexpr std::ptrdiff_t m_bDisableOperator = 0x1AA; // bool
            ...
            namespace C_OP_SetParentControlPointsToChildCP {
                constexpr std::ptrdiff_t m_nChildGroupID = 0x1D4; // int32
                constexpr std::ptrdiff_t m_nChildControlPoint = 0x1D8; // int32
                constexpr std::ptrdiff_t m_nNumControlPoints = 0x1DC; // int32
                constexpr std::ptrdiff_t m_nFirstSourcePoint = 0x1E0; // int32
                constexpr std::ptrdiff_t m_bSetOrientation = 0x1E4; // bool
            }
            // Parent: None
            // Fields count: 5
            //
            ...
            namespace C_OP_BoxConstraint {
                ...
                constexpr std::ptrdiff_t m_vecMax = 0x860; // CParticleCollectionVecInput
                constexpr std::ptrdiff_t m_nCP = 0xEF0; // int32
                constexpr std::ptrdiff_t m_bLocalSpace = 0xEF4; // bool
                constexpr std::ptrdiff_t m_bAccountForRadius = 0xEF5; // bool
            }
            // Parent: None
            // Fields count: 14
            //
            ...
            namespace C_INIT_CreatePhyllotaxis {
                ...
                constexpr std::ptrdiff_t m_fRadCentCore = 0x1E0; // float32
                constexpr std::ptrdiff_t m_fRadPerPoint = 0x1E4; // float32
                constexpr std::ptrdiff_t m_fRadPerPointTo = 0x1E8; // float32
                constexpr std::ptrdiff_t m_fpointAngle = 0x1EC; // float32
                constexpr std::ptrdiff_t m_fsizeOverall = 0x1F0; // float32
                constexpr std::ptrdiff_t m_fRadBias = 0x1F4; // float32
                constexpr std::ptrdiff_t m_fMinRad = 0x1F8; // float32
                constexpr std::ptrdiff_t m_fDistBias = 0x1FC; // float32
                constexpr std::ptrdiff_t m_bUseLocalCoords = 0x200; // bool
                constexpr std::ptrdiff_t m_bUseWithContEmit = 0x201; // bool
                constexpr std::ptrdiff_t m_bUseOrigRadius = 0x202; // bool
            }
            // Parent: None
            // Fields count: 7
            //
            ...
            namespace C_OP_AttractToControlPoint {
                constexpr std::ptrdiff_t m_vecComponentScale = 0x1DC; // Vector
                constexpr std::ptrdiff_t m_fForceAmount = 0x1E8; // CPerParticleFloatInput
                constexpr std::ptrdiff_t m_fMinimumDistance = 0x350; // CPerParticleFloatInput
                constexpr std::ptrdiff_t m_fFalloffPower = 0x4B8; // float32
                constexpr std::ptrdiff_t m_TransformInput = 0x4C0; // CParticleTransformInput
                constexpr std::ptrdiff_t m_fForceAmountMin = 0x520; // CPerParticleFloatInput
                constexpr std::ptrdiff_t m_bApplyMinForce = 0x688; // bool
            }
            // Parent: None
            // Fields count: 3
            //
            ...
            namespace C_INIT_RandomLifeTime {
                constexpr std::ptrdiff_t m_fLifetimeMin = 0x1D4; // float32
                constexpr std::ptrdiff_t m_fLifetimeMax = 0x1D8; // float32
                constexpr std::ptrdiff_t m_fLifetimeRandExponent = 0x1DC; // float32
            }
            // Parent: None
            // Fields count: 0
            //
            ...
            namespace C_INIT_VelocityRadialRandom {
                constexpr std::ptrdiff_t m_bPerParticleCenter = 0x1D4; // bool
                ...
                constexpr std::ptrdiff_t m_vecFwd = 0x870; // CPerParticleVecInput
                constexpr std::ptrdiff_t m_fSpeedMin = 0xF00; // CPerParticleFloatInput
                constexpr std::ptrdiff_t m_fSpeedMax = 0x1068; // CPerParticleFloatInput
                constexpr std::ptrdiff_t m_vecLocalCoordinateSystemSpeedScale = 0x11D0; // Vector
                constexpr std::ptrdiff_t m_bIgnoreDelta = 0x11DD; // bool
            }
            // Parent: None
            // Fields count: 3
            //
            ...
            namespace C_INIT_RandomRadius {
                constexpr std::ptrdiff_t m_flRadiusMin = 0x1D4; // float32
                constexpr std::ptrdiff_t m_flRadiusMax = 0x1D8; // float32
                constexpr std::ptrdiff_t m_flRadiusRandExponent = 0x1DC; // float32
            }
            // Parent: None
            // Fields count: 4
            //
            ...
            namespace C_OP_SetControlPointToVectorExpression {
                constexpr std::ptrdiff_t m_nExpression = 0x1D4; // VectorExpressionType_t
                constexpr std::ptrdiff_t m_nOutputCP = 0x1D8; // int32
                constexpr std::ptrdiff_t m_vInput1 = 0x1E0; // CParticleCollectionVecInput
                constexpr std::ptrdiff_t m_vInput2 = 0x870; // CParticleCollectionVecInput
                constexpr std::ptrdiff_t m_flLerp = 0xF00; // CPerParticleFloatInput
                constexpr std::ptrdiff_t m_bNormalizedOutput = 0x1068; // bool
            }
            // Parent: None
            // Fields count: 20
            //
            ...
            namespace C_OP_LightningSnapshotGenerator {
                constexpr std::ptrdiff_t m_nCPSnapshot = 0x1D4; // int32
                constexpr std::ptrdiff_t m_nCPStartPnt = 0x1D8; // int32
                constexpr std::ptrdiff_t m_nCPEndPnt = 0x1DC; // int32
                constexpr std::ptrdiff_t m_flSegments = 0x1E0; // CParticleCollectionFloatInput
                constexpr std::ptrdiff_t m_flOffset = 0x348; // CParticleCollectionFloatInput
                constexpr std::ptrdiff_t m_flOffsetDecay = 0x4B0; // CParticleCollectionFloatInput
                constexpr std::ptrdiff_t m_flRecalcRate = 0x618; // CParticleCollectionFloatInput
                constexpr std::ptrdiff_t m_flUVScale = 0x780; // CParticleCollectionFloatInput
                constexpr std::ptrdiff_t m_flUVOffset = 0x8E8; // CParticleCollectionFloatInput
                constexpr std::ptrdiff_t m_flSplitRate = 0xA50; // CParticleCollectionFloatInput
                constexpr std::ptrdiff_t m_flRecursionSplitScale = 0xBB8; // CParticleCollectionFloatInput
                constexpr std::ptrdiff_t m_bScaleBranchDistance = 0xD20; // bool
                constexpr std::ptrdiff_t m_flBranchDistanceScale = 0xD28; // CParticleCollectionFloatInput
                constexpr std::ptrdiff_t m_bScaleBranchOffset = 0xE90; // bool
                constexpr std::ptrdiff_t m_flBranchOffsetScale = 0xE98; // CParticleCollectionFloatInput
                constexpr std::ptrdiff_t m_flBranchTwist = 0x1000; // CParticleCollectionFloatInput
                constexpr std::ptrdiff_t m_nBranchBehavior = 0x1168; // ParticleLightnintBranchBehavior_t
                constexpr std::ptrdiff_t m_flRadiusStart = 0x1170; // CParticleCollectionFloatInput
                constexpr std::ptrdiff_t m_flRadiusEnd = 0x12D8; // CParticleCollectionFloatInput
                constexpr std::ptrdiff_t m_flDedicatedPool = 0x1440; // CParticleCollectionFloatInput
            }
            // Parent: None
            // Fields count: 0
            //
            ...
            namespace C_INIT_PositionWarp {
                ...
                constexpr std::ptrdiff_t m_vecWarpMax = 0x868; // CParticleCollectionVecInput
                constexpr std::ptrdiff_t m_nScaleControlPointNumber = 0xEF8; // int32
                constexpr std::ptrdiff_t m_nControlPointNumber = 0xEFC; // int32
                constexpr std::ptrdiff_t m_nRadiusComponent = 0xF00; // int32
                constexpr std::ptrdiff_t m_flWarpTime = 0xF04; // float32
                constexpr std::ptrdiff_t m_flWarpStartTime = 0xF08; // float32
                constexpr std::ptrdiff_t m_flPrevPosScale = 0xF0C; // float32
                constexpr std::ptrdiff_t m_bInvertWarp = 0xF10; // bool
                constexpr std::ptrdiff_t m_bUseCount = 0xF11; // bool
            }
            // Parent: None
            // Fields count: 7
            //
            ...
            namespace C_OP_SetControlPointFieldToScalarExpression {
                constexpr std::ptrdiff_t m_nExpression = 0x1D4; // ScalarExpressionType_t
                constexpr std::ptrdiff_t m_flInput1 = 0x1D8; // CParticleCollectionFloatInput
                constexpr std::ptrdiff_t m_flInput2 = 0x340; // CParticleCollectionFloatInput
                constexpr std::ptrdiff_t m_flOutputRemap = 0x4A8; // CParticleRemapFloatInput
                constexpr std::ptrdiff_t m_nOutputCP = 0x610; // int32
                constexpr std::ptrdiff_t m_nOutVectorField = 0x614; // int32
                constexpr std::ptrdiff_t m_flInterpolation = 0x618; // CParticleCollectionFloatInput
            }
            // Parent: None
            // Fields count: 5
            //
            ...
            namespace C_INIT_RandomVectorComponent {
                constexpr std::ptrdiff_t m_flMin = 0x1D4; // float32
                constexpr std::ptrdiff_t m_flMax = 0x1D8; // float32
                constexpr std::ptrdiff_t m_nFieldOutput = 0x1DC; // ParticleAttributeIndex_t
            ...
            namespace C_INIT_SetVectorAttributeToVectorExpression {
                ...
                constexpr std::ptrdiff_t m_vInput2 = 0x868; // CPerParticleVecInput
                constexpr std::ptrdiff_t m_flLerp = 0xEF8; // CPerParticleFloatInput
                constexpr std::ptrdiff_t m_nOutputField = 0x1060; // ParticleAttributeIndex_t
                constexpr std::ptrdiff_t m_nSetMethod = 0x1064; // ParticleSetMethod_t
                constexpr std::ptrdiff_t m_bNormalizedOutput = 0x1068; // bool
            }
            // Parent: None
            // Fields count: 8
            ...
            namespace C_OP_RemapTransformVisibilityToVector {
                ...
                constexpr std::ptrdiff_t m_flInputMin = 0x23C; // float32
                constexpr std::ptrdiff_t m_flInputMax = 0x240; // float32
            ...
            namespace C_OP_DirectionBetweenVecsToVec {
                ...
                constexpr std::ptrdiff_t m_vecPoint2 = 0x868; // CPerParticleVecInput
            }
            // Parent: None
            // Fields count: 4
            //
            ...
            namespace C_OP_MovementLoopInsideSphere {
                ...
                constexpr std::ptrdiff_t m_vecScale = 0x340; // CParticleCollectionVecInput
                constexpr std::ptrdiff_t m_nDistSqrAttr = 0x9D0; // ParticleAttributeIndex_t
            }
            // Parent: None
            // Fields count: 9
            //
            ...
            namespace C_OP_RenderSimpleModelCollection {
                constexpr std::ptrdiff_t m_bCenterOffset = 0x21A; // bool
                constexpr std::ptrdiff_t m_hModel = 0x220; // CStrongHandle<InfoForResourceTypeCModel>
                constexpr std::ptrdiff_t m_modelInput = 0x228; // CParticleModelInput
                constexpr std::ptrdiff_t m_fSizeCullScale = 0x280; // CParticleCollectionFloatInput
                constexpr std::ptrdiff_t m_bDisableShadows = 0x3E8; // bool
                constexpr std::ptrdiff_t m_bDisableMotionBlur = 0x3E9; // bool
                constexpr std::ptrdiff_t m_bAcceptsDecals = 0x3EA; // bool
                constexpr std::ptrdiff_t m_fDrawFilter = 0x3F0; // CPerParticleFloatInput
                constexpr std::ptrdiff_t m_nAngularVelocityField = 0x558; // ParticleAttributeIndex_t
            }
            // Parent: None
            // Fields count: 4
            //
            ...
            namespace C_OP_QuantizeCPComponent {
                ...
                constexpr std::ptrdiff_t m_nCPOutput = 0x340; // int32
                constexpr std::ptrdiff_t m_nOutVectorField = 0x344; // int32
                constexpr std::ptrdiff_t m_flQuantizeValue = 0x348; // CParticleCollectionFloatInput
            }
            // Parent: None
            // Fields count: 2
            //
            ...
            namespace C_OP_PlayEndCapWhenFinished {
                constexpr std::ptrdiff_t m_bFireOnEmissionEnd = 0x1D1; // bool
                constexpr std::ptrdiff_t m_bIncludeChildren = 0x1D2; // bool
            }
            // Parent: None
            // Fields count: 2
            //
            ...
            namespace C_INIT_CreateFromPlaneCache {
                constexpr std::ptrdiff_t m_vecOffsetMin = 0x1D4; // Vector
                constexpr std::ptrdiff_t m_vecOffsetMax = 0x1E0; // Vector
                constexpr std::ptrdiff_t m_bUseNormal = 0x1ED; // bool
            }
            // Parent: None
            // Fields count: 3
            //
            ...
            namespace C_OP_LazyCullCompareFloat {
                ...
                constexpr std::ptrdiff_t m_flComparsion2 = 0x338; // CPerParticleFloatInput
                constexpr std::ptrdiff_t m_flCullTime = 0x4A0; // CPerParticleFloatInput
            }
            // Parent: None
            // Fields count: 5
            //
            ...
            namespace C_OP_ControlPointToRadialScreenSpace {
                ...
                constexpr std::ptrdiff_t m_nCPOut = 0x1E4; // int32
                constexpr std::ptrdiff_t m_nCPOutField = 0x1E8; // int32
                constexpr std::ptrdiff_t m_nCPSSPosOut = 0x1EC; // int32
            }
            // Parent: None
            // Fields count: 0
            //
            ...
            namespace C_INIT_NormalOffset {
                constexpr std::ptrdiff_t m_OffsetMin = 0x1D4; // Vector
                constexpr std::ptrdiff_t m_OffsetMax = 0x1E0; // Vector
                constexpr std::ptrdiff_t m_nControlPointNumber = 0x1EC; // int32
                constexpr std::ptrdiff_t m_bLocalCoords = 0x1F0; // bool
                constexpr std::ptrdiff_t m_bNormalize = 0x1F1; // bool
            }
            // Parent: None
            // Fields count: 3
            //
            ...
            namespace C_OP_RemapDistanceToLineSegmentToVector {
                ...
                constexpr std::ptrdiff_t m_vMinOutputValue = 0x1E8; // Vector
                constexpr std::ptrdiff_t m_vMaxOutputValue = 0x1F4; // Vector
            }
            // Parent: None
            // Fields count: 8
            //
            ...
            namespace C_OP_GameLiquidSpill {
                ...
                constexpr std::ptrdiff_t m_flExpirationTime = 0x388; // CParticleCollectionFloatInput
                constexpr std::ptrdiff_t m_flRadius = 0x4F0; // CParticleCollectionFloatInput
                constexpr std::ptrdiff_t m_bCheckExposedToSky = 0x658; // bool
                constexpr std::ptrdiff_t m_nAmountAttribute = 0x65C; // ParticleAttributeIndex_t
            }
            // Parent: None
            // Fields count: 8
            //
            ...
            namespace C_OP_InstantaneousEmitter {
                ...
                constexpr std::ptrdiff_t m_flStartTime = 0x340; // CParticleCollectionFloatInput
                constexpr std::ptrdiff_t m_flInitFromKilledParentParticles = 0x4A8; // float32
                constexpr std::ptrdiff_t m_nEventType = 0x4AC; // EventTypeSelection_t
                constexpr std::ptrdiff_t m_flParentParticleScale = 0x4B0; // CParticleCollectionFloatInput
                constexpr std::ptrdiff_t m_nMaxEmittedPerFrame = 0x618; // int32
                constexpr std::ptrdiff_t m_nSnapshotControlPoint = 0x61C; // int32
            ...
            namespace C_INIT_LifespanFromVelocity {
                ...
                constexpr std::ptrdiff_t m_flTraceOffset = 0x1E0; // float32
                constexpr std::ptrdiff_t m_flMaxTraceLength = 0x1E4; // float32
                constexpr std::ptrdiff_t m_flTraceTolerance = 0x1E8; // float32
                constexpr std::ptrdiff_t m_nMaxPlanes = 0x1EC; // int32
                constexpr std::ptrdiff_t m_CollisionGroupName = 0x1F4; // char[128]
                constexpr std::ptrdiff_t m_nTraceSet = 0x274; // ParticleTraceSet_t
            ...
            namespace CBaseTrailRenderer {
                constexpr std::ptrdiff_t m_nOrientationType = 0x2D00; // ParticleOrientationChoiceList_t
                constexpr std::ptrdiff_t m_nOrientationControlPoint = 0x2D04; // int32
                constexpr std::ptrdiff_t m_flMinSize = 0x2D08; // float32
                constexpr std::ptrdiff_t m_flMaxSize = 0x2D0C; // float32
                constexpr std::ptrdiff_t m_flStartFadeSize = 0x2D10; // CParticleCollectionRendererFloatInput
                constexpr std::ptrdiff_t m_flEndFadeSize = 0x2E78; // CParticleCollectionRendererFloatInput
                constexpr std::ptrdiff_t m_flSubPixelAAScale = 0x2FE0; // CParticleCollectionRendererFloatInput
                constexpr std::ptrdiff_t m_bClampV = 0x3148; // bool
            }
            // Parent: None
            // Fields count: 4
            //
            ...
            namespace C_INIT_VelocityFromCP {
                ...
                constexpr std::ptrdiff_t m_transformInput = 0x868; // CParticleTransformInput
                constexpr std::ptrdiff_t m_flVelocityScale = 0x8C8; // float32
                constexpr std::ptrdiff_t m_bDirectionOnly = 0x8CC; // bool
            }
            // Parent: None
            // Fields count: 8
            //
            ...
            namespace C_OP_SetControlPointOrientation {
                constexpr std::ptrdiff_t m_bUseWorldLocation = 0x1D1; // bool
                constexpr std::ptrdiff_t m_bRandomize = 0x1D3; // bool
                constexpr std::ptrdiff_t m_bSetOnce = 0x1D4; // bool
                constexpr std::ptrdiff_t m_nCP = 0x1D8; // int32
                constexpr std::ptrdiff_t m_nHeadLocation = 0x1DC; // int32
                constexpr std::ptrdiff_t m_vecRotation = 0x1E0; // QAngle
                constexpr std::ptrdiff_t m_vecRotationB = 0x1EC; // QAngle
            ...
            namespace C_OP_MovementSkinnedPositionFromCPSnapshot {
                ...
                constexpr std::ptrdiff_t m_flIncrement = 0x350; // CParticleCollectionFloatInput
                constexpr std::ptrdiff_t m_nFullLoopIncrement = 0x4B8; // CParticleCollectionFloatInput
                constexpr std::ptrdiff_t m_nSnapShotStartPoint = 0x620; // CParticleCollectionFloatInput
                constexpr std::ptrdiff_t m_flInterpolation = 0x788; // CPerParticleFloatInput
            }
            // Parent: None
            // Fields count: 15
            //
            ...
            namespace C_OP_MultiSegmentDisplaySnapshotGenerator {
                constexpr std::ptrdiff_t m_nCPSnapshot = 0x1D4; // int32
                constexpr std::ptrdiff_t m_nSegCount = 0x1D8; // ParticleMultiSegmentCountSelection_t
                constexpr std::ptrdiff_t m_nInputType = 0x1DC; // ParticleMultiSegmentInputSelection_t
                constexpr std::ptrdiff_t m_strDefaultString = 0x1E0; // CUtlString
                constexpr std::ptrdiff_t m_flValue = 0x1E8; // CParticleCollectionFloatInput
                constexpr std::ptrdiff_t m_flScollOffset = 0x350; // CParticleCollectionFloatInput
                constexpr std::ptrdiff_t m_SpecialCharList = 0x4B8; // CUtlVector<ParticleMultiSegmentSpecialCharacter_t>
                constexpr std::ptrdiff_t m_vecColorUnlit = 0x4D0; // CParticleCollectionVecInput
                constexpr std::ptrdiff_t m_vecColorLit = 0xB60; // CParticleCollectionVecInput
                constexpr std::ptrdiff_t m_flRadius = 0x11F0; // CParticleCollectionFloatInput
                constexpr std::ptrdiff_t m_flSpacing = 0x1358; // CParticleCollectionFloatInput
                constexpr std::ptrdiff_t m_flMinCount = 0x14C0; // CParticleCollectionFloatInput
                constexpr std::ptrdiff_t m_flMaxCount = 0x1628; // CParticleCollectionFloatInput
                constexpr std::ptrdiff_t m_bPrependEmpty = 0x1790; // bool
                constexpr std::ptrdiff_t m_flDigitsAfterDecimal = 0x1798; // CParticleCollectionFloatInput
            }
            // Parent: None
            // Fields count: 15
            //
            ...
            namespace C_OP_OscillateVector {
                ...
                constexpr std::ptrdiff_t m_flOscAdd = 0x380; // CPerParticleFloatInput
                constexpr std::ptrdiff_t m_flRateScale = 0x4E8; // CPerParticleFloatInput
            }
            // Parent: None
            // Fields count: 15
            //
            ...
            namespace C_OP_PositionLock {
                constexpr std::ptrdiff_t m_TransformInput = 0x1D0; // CParticleTransformInput
                constexpr std::ptrdiff_t m_flStartTime_min = 0x230; // float32
                constexpr std::ptrdiff_t m_flStartTime_max = 0x234; // float32
                constexpr std::ptrdiff_t m_flStartTime_exp = 0x238; // float32
                constexpr std::ptrdiff_t m_flEndTime_min = 0x23C; // float32
                constexpr std::ptrdiff_t m_flEndTime_max = 0x240; // float32
                constexpr std::ptrdiff_t m_flEndTime_exp = 0x244; // float32
                constexpr std::ptrdiff_t m_flRange = 0x248; // float32
                constexpr std::ptrdiff_t m_flRangeBias = 0x250; // CParticleCollectionFloatInput
                constexpr std::ptrdiff_t m_flJumpThreshold = 0x3B8; // float32
                constexpr std::ptrdiff_t m_flPrevPosScale = 0x3BC; // float32
                constexpr std::ptrdiff_t m_bLockRot = 0x3C0; // bool
                constexpr std::ptrdiff_t m_vecScale = 0x3C8; // CParticleCollectionVecInput
                constexpr std::ptrdiff_t m_nFieldOutput = 0xA58; // ParticleAttributeIndex_t
                constexpr std::ptrdiff_t m_nFieldOutputPrev = 0xA5C; // ParticleAttributeIndex_t
            }
            // Parent: None
            // Fields count: 4
            //
            ...
            namespace C_OP_RenderVRHapticEvent {
                constexpr std::ptrdiff_t m_nHand = 0x21C; // ParticleVRHandChoiceList_t
                constexpr std::ptrdiff_t m_nOutputHandCP = 0x220; // int32
                constexpr std::ptrdiff_t m_nOutputField = 0x224; // int32
                constexpr std::ptrdiff_t m_flAmplitude = 0x228; // CPerParticleFloatInput
            }
            // Parent: None
            // Fields count: 12
            //
            ...
            namespace C_OP_SetControlPointToImpactPoint {
                constexpr std::ptrdiff_t m_nCPOut = 0x1D4; // int32
                constexpr std::ptrdiff_t m_nCPIn = 0x1D8; // int32
                constexpr std::ptrdiff_t m_flUpdateRate = 0x1DC; // float32
                constexpr std::ptrdiff_t m_flTraceLength = 0x1E0; // CParticleCollectionFloatInput
                constexpr std::ptrdiff_t m_flStartOffset = 0x348; // float32
                constexpr std::ptrdiff_t m_flOffset = 0x34C; // float32
                constexpr std::ptrdiff_t m_vecTraceDir = 0x350; // Vector
                constexpr std::ptrdiff_t m_CollisionGroupName = 0x35C; // char[128]
                constexpr std::ptrdiff_t m_nTraceSet = 0x3DC; // ParticleTraceSet_t
                constexpr std::ptrdiff_t m_bSetToEndpoint = 0x3E0; // bool
                constexpr std::ptrdiff_t m_bTraceToClosestSurface = 0x3E1; // bool
                constexpr std::ptrdiff_t m_bIncludeWater = 0x3E2; // bool
            }
            // Parent: None
            // Fields count: 6
            //
            ...
            namespace C_OP_TurbulenceForce {
                constexpr std::ptrdiff_t m_flNoiseCoordScale0 = 0x1DC; // float32
                constexpr std::ptrdiff_t m_flNoiseCoordScale1 = 0x1E0; // float32
                constexpr std::ptrdiff_t m_flNoiseCoordScale2 = 0x1E4; // float32
                constexpr std::ptrdiff_t m_flNoiseCoordScale3 = 0x1E8; // float32
                constexpr std::ptrdiff_t m_vecNoiseAmount0 = 0x1EC; // Vector
                constexpr std::ptrdiff_t m_vecNoiseAmount1 = 0x1F8; // Vector
                constexpr std::ptrdiff_t m_vecNoiseAmount2 = 0x204; // Vector
                constexpr std::ptrdiff_t m_vecNoiseAmount3 = 0x210; // Vector
            }
            // Parent: None
            // Fields count: 9
            //
            ...
            namespace C_OP_SetControlPointToPlayer {
                constexpr std::ptrdiff_t m_nCP1 = 0x1D4; // int32
                constexpr std::ptrdiff_t m_vecCP1Pos = 0x1D8; // Vector
                constexpr std::ptrdiff_t m_bOrientToEyes = 0x1E4; // bool
                constexpr std::ptrdiff_t m_nPosition = 0x1E8; // ParticleEntityPos_t
                constexpr std::ptrdiff_t m_nRadiusCP = 0x1EC; // int32
                constexpr std::ptrdiff_t m_nRadiusCPField = 0x1F0; // int32
            }
            // Parent: None
            // Fields count: 1
            //
            ...
            namespace C_OP_RenderGpuImplicit {
                constexpr std::ptrdiff_t m_bUsePerParticleRadius = 0x21A; // bool
                constexpr std::ptrdiff_t m_nVertexCountKb = 0x21C; // uint32
                constexpr std::ptrdiff_t m_nIndexCountKb = 0x220; // uint32
                constexpr std::ptrdiff_t m_fGridSize = 0x228; // CParticleCollectionRendererFloatInput
                constexpr std::ptrdiff_t m_fRadiusScale = 0x390; // CParticleCollectionRendererFloatInput
                constexpr std::ptrdiff_t m_fIsosurfaceThreshold = 0x4F8; // CParticleCollectionRendererFloatInput
                constexpr std::ptrdiff_t m_nScaleCP = 0x660; // int32
                constexpr std::ptrdiff_t m_hMaterial = 0x668; // CStrongHandle<InfoForResourceTypeIMaterial2>
            }
            // Parent: None
            // Fields count: 8
            //
            ...
            namespace C_OP_SetRandomControlPointPosition {
                constexpr std::ptrdiff_t m_bUseWorldLocation = 0x1D1; // bool
                constexpr std::ptrdiff_t m_bOrient = 0x1D2; // bool
                constexpr std::ptrdiff_t m_nCP1 = 0x1D4; // int32
                ...
                constexpr std::ptrdiff_t m_vecCPMinPos = 0x348; // Vector
                constexpr std::ptrdiff_t m_vecCPMaxPos = 0x354; // Vector
                constexpr std::ptrdiff_t m_flInterpolation = 0x360; // CParticleCollectionFloatInput
            }
            // Parent: None
            // Fields count: 15
            //
            ...
            namespace C_OP_RenderVolumetricEmitter {
                constexpr std::ptrdiff_t m_strChannelType = 0x220; // CUtlString
                constexpr std::ptrdiff_t m_nType = 0x228; // ParticleVolumetricSmokeType_t
                constexpr std::ptrdiff_t m_nCreationType = 0x22C; // ParticleVolumetricSmokeCreationType_t
                constexpr std::ptrdiff_t m_nEventType = 0x230; // EventTypeSelection_t
                constexpr std::ptrdiff_t m_vecPos = 0x238; // CPerParticleVecInput
                constexpr std::ptrdiff_t m_vecVelocity = 0x8C8; // CPerParticleVecInput
                constexpr std::ptrdiff_t m_vPrevPosition = 0xF58; // CPerParticleVecInput
                constexpr std::ptrdiff_t m_flSpeed = 0x15E8; // CPerParticleFloatInput
                constexpr std::ptrdiff_t m_flRadius = 0x1750; // CPerParticleFloatInput
                constexpr std::ptrdiff_t m_flDensity = 0x18B8; // CPerParticleFloatInput
                constexpr std::ptrdiff_t m_flTemperature = 0x1A20; // CPerParticleFloatInput
                constexpr std::ptrdiff_t m_flMagnitude = 0x1B88; // CPerParticleFloatInput
                constexpr std::ptrdiff_t m_flKillRadius = 0x1CF0; // CPerParticleFloatInput
                constexpr std::ptrdiff_t m_flKillDensityScale = 0x1E58; // CPerParticleFloatInput
                constexpr std::ptrdiff_t m_flFalloff = 0x1FC0; // CPerParticleFloatInput
            }
            // Parent: None
            // Fields count: 8
            //
            ...
            namespace C_OP_RemapTransformVisibilityToScalar {
                ...
                constexpr std::ptrdiff_t m_flInputMin = 0x23C; // float32
                constexpr std::ptrdiff_t m_flInputMax = 0x240; // float32
                constexpr std::ptrdiff_t m_flOutputMin = 0x244; // float32
                constexpr std::ptrdiff_t m_flOutputMax = 0x248; // float32
                constexpr std::ptrdiff_t m_flRadius = 0x24C; // float32
            }
            // Parent: None
            // Fields count: 3
            //
            ...
            namespace C_OP_ScreenSpacePositionOfTarget {
                ...
                constexpr std::ptrdiff_t m_nBehindSetMethod = 0x9D0; // ParticleSetMethod_t
            }
            // Parent: None
            // Fields count: 0
            //
            ...
            namespace C_OP_DragRelativeToPlane {
                ...
                constexpr std::ptrdiff_t m_flFalloff = 0x338; // CParticleCollectionFloatInput
                constexpr std::ptrdiff_t m_bDirectional = 0x4A0; // bool
                constexpr std::ptrdiff_t m_vecPlaneNormal = 0x4A8; // CParticleCollectionVecInput
                constexpr std::ptrdiff_t m_nControlPointNumber = 0xB38; // int32
            }
            // Parent: None
            // Fields count: 2
            //
            ...
            namespace C_OP_SetSingleControlPointPosition {
                constexpr std::ptrdiff_t m_bSetOnce = 0x1D1; // bool
                constexpr std::ptrdiff_t m_nCP1 = 0x1D4; // int32
            ...
            namespace C_INIT_DistanceToNeighborCull {
                ...
                constexpr std::ptrdiff_t m_bIncludeRadii = 0x340; // bool
                constexpr std::ptrdiff_t m_flLifespanOverlap = 0x348; // CPerParticleFloatInput
                constexpr std::ptrdiff_t m_nFieldModify = 0x4B0; // ParticleAttributeIndex_t
                constexpr std::ptrdiff_t m_flModify = 0x4B8; // CPerParticleFloatInput
                constexpr std::ptrdiff_t m_nSetMethod = 0x620; // ParticleSetMethod_t
                constexpr std::ptrdiff_t m_bUseNeighbor = 0x624; // bool
            }
            // Parent: None
            // Fields count: 11
            //
            ...
            namespace C_OP_RenderScreenVelocityRotate {
                constexpr std::ptrdiff_t m_flRotateRateDegrees = 0x21C; // float32
                constexpr std::ptrdiff_t m_flForwardDegrees = 0x220; // float32
            }
            // Parent: None
            // Fields count: 6
            //
            ...
            namespace C_INIT_CreateWithinBox {
                ...
                constexpr std::ptrdiff_t m_vecMax = 0x868; // CPerParticleVecInput
                constexpr std::ptrdiff_t m_nControlPointNumber = 0xEF8; // int32
                constexpr std::ptrdiff_t m_bLocalSpace = 0xEFC; // bool
                constexpr std::ptrdiff_t m_randomnessParameters = 0xF00; // CRandomNumberGeneratorParameters
                constexpr std::ptrdiff_t m_bUseNewCode = 0xF08; // bool
            }
            // Parent: None
            // Fields count: 2
            //
            ...
            namespace C_OP_VectorFieldSnapshot {
                ...
                constexpr std::ptrdiff_t m_vecScale = 0x348; // CPerParticleVecInput
                constexpr std::ptrdiff_t m_flBoundaryDampening = 0x9D8; // float32
                constexpr std::ptrdiff_t m_bSetVelocity = 0x9DC; // bool
                constexpr std::ptrdiff_t m_bLockToSurface = 0x9DD; // bool
                constexpr std::ptrdiff_t m_flGridSpacing = 0x9E0; // float32
            }
            // Parent: None
            // Fields count: 11
            //
            ...
            namespace C_OP_CylindricalDistanceToTransform {
                ...
                constexpr std::ptrdiff_t m_flInputMax = 0x340; // CPerParticleFloatInput
                constexpr std::ptrdiff_t m_flOutputMin = 0x4A8; // CPerParticleFloatInput
                constexpr std::ptrdiff_t m_flOutputMax = 0x610; // CPerParticleFloatInput
                constexpr std::ptrdiff_t m_TransformStart = 0x778; // CParticleTransformInput
                constexpr std::ptrdiff_t m_TransformEnd = 0x7D8; // CParticleTransformInput
                constexpr std::ptrdiff_t m_nSetMethod = 0x838; // ParticleSetMethod_t
                constexpr std::ptrdiff_t m_bActiveRange = 0x83C; // bool
                constexpr std::ptrdiff_t m_bAdditive = 0x83D; // bool
                constexpr std::ptrdiff_t m_bCapsule = 0x83E; // bool
            }
            // Parent: None
            // Fields count: 15
            //
            ...
            namespace C_INIT_PositionPlaceOnGround {
                ...
                constexpr std::ptrdiff_t m_flMaxTraceLength = 0x340; // CPerParticleFloatInput
                constexpr std::ptrdiff_t m_vecTraceDir = 0x4A8; // CPerParticleVecInput
                constexpr std::ptrdiff_t m_CollisionGroupName = 0xB38; // char[128]
                constexpr std::ptrdiff_t m_nTraceSet = 0xBB8; // ParticleTraceSet_t
                constexpr std::ptrdiff_t m_nTraceMissBehavior = 0xBC8; // ParticleTraceMissBehavior_t
                constexpr std::ptrdiff_t m_bIncludeWater = 0xBCC; // bool
                constexpr std::ptrdiff_t m_nAttribute = 0xBD0; // ParticleAttributeIndex_t
                constexpr std::ptrdiff_t m_bSetPXYZOnly = 0xBD4; // bool
                constexpr std::ptrdiff_t m_bSetNormal = 0xBD5; // bool
                constexpr std::ptrdiff_t m_nGroundNormalAttribute = 0xBD8; // ParticleAttributeIndex_t
                constexpr std::ptrdiff_t m_bOffsetonColOnly = 0xBDC; // bool
                constexpr std::ptrdiff_t m_flOffsetByRadiusFactor = 0xBE0; // float32
                constexpr std::ptrdiff_t m_nPreserveOffsetCP = 0xBE4; // int32
                constexpr std::ptrdiff_t m_nIgnoreCP = 0xBE8; // int32
            }
            // Parent: None
            // Fields count: 4
            //
            ...
            namespace C_INIT_RandomScalar {
                constexpr std::ptrdiff_t m_flMin = 0x1D4; // float32
                constexpr std::ptrdiff_t m_flMax = 0x1D8; // float32
                constexpr std::ptrdiff_t m_flExponent = 0x1DC; // float32
            ...
            namespace C_OP_RenderPostProcessing {
                ...
                constexpr std::ptrdiff_t m_hPostTexture = 0x388; // CStrongHandle<InfoForResourceTypeCPostProcessingResource>
                constexpr std::ptrdiff_t m_nPriority = 0x390; // ParticlePostProcessPriorityGroup_t
            }
            // Parent: None
            // Fields count: 27
            //
            ...
            namespace C_OP_WorldTraceConstraint {
                ...
                constexpr std::ptrdiff_t m_flBounceAmount = 0x3F0; // CPerParticleFloatInput
                constexpr std::ptrdiff_t m_flSlideAmount = 0x558; // CPerParticleFloatInput
                constexpr std::ptrdiff_t m_flRandomDirScale = 0x6C0; // CPerParticleFloatInput
                constexpr std::ptrdiff_t m_bDecayBounce = 0x828; // bool
                constexpr std::ptrdiff_t m_bKillonContact = 0x829; // bool
                constexpr std::ptrdiff_t m_flMinSpeed = 0x82C; // float32
                constexpr std::ptrdiff_t m_bSetNormal = 0x830; // bool
                constexpr std::ptrdiff_t m_nStickOnCollisionField = 0x834; // ParticleAttributeIndex_t
                constexpr std::ptrdiff_t m_flStopSpeed = 0x838; // CPerParticleFloatInput
                constexpr std::ptrdiff_t m_nEntityStickDataField = 0x9A0; // ParticleAttributeIndex_t
                constexpr std::ptrdiff_t m_nEntityStickNormalField = 0x9A4; // ParticleAttributeIndex_t
            }
            // Parent: None
            // Fields count: 8
            //
            ...
            namespace C_OP_RenderBlobs {
                ...
                constexpr std::ptrdiff_t m_cutoffRadius = 0x388; // CParticleCollectionRendererFloatInput
                constexpr std::ptrdiff_t m_renderRadius = 0x4F0; // CParticleCollectionRendererFloatInput
                constexpr std::ptrdiff_t m_nVertexCountKb = 0x658; // uint32
                constexpr std::ptrdiff_t m_nIndexCountKb = 0x65C; // uint32
                constexpr std::ptrdiff_t m_nScaleCP = 0x660; // int32
                constexpr std::ptrdiff_t m_MaterialVars = 0x668; // CUtlVector<MaterialVariable_t>
                constexpr std::ptrdiff_t m_hMaterial = 0x698; // CStrongHandle<InfoForResourceTypeIMaterial2>
            }
            // Parent: None
            // Fields count: 13
            //
            ...
            namespace C_OP_WaterImpulseRenderer {
                ...
                constexpr std::ptrdiff_t m_flRadius = 0x8B0; // CPerParticleFloatInput
                constexpr std::ptrdiff_t m_flMagnitude = 0xA18; // CPerParticleFloatInput
                constexpr std::ptrdiff_t m_flShape = 0xB80; // CPerParticleFloatInput
                constexpr std::ptrdiff_t m_flWindSpeed = 0xCE8; // CPerParticleFloatInput
                constexpr std::ptrdiff_t m_flWobble = 0xE50; // CPerParticleFloatInput
                constexpr std::ptrdiff_t m_bIsRadialWind = 0xFB8; // bool
                constexpr std::ptrdiff_t m_nEventType = 0xFBC; // EventTypeSelection_t
            }
            // Parent: None
            // Fields count: 5
            //
            ...
            namespace C_INIT_RandomSequence {
                constexpr std::ptrdiff_t m_nSequenceMin = 0x1D4; // int32
                constexpr std::ptrdiff_t m_nSequenceMax = 0x1D8; // int32
                constexpr std::ptrdiff_t m_bShuffle = 0x1DC; // bool
                constexpr std::ptrdiff_t m_bLinear = 0x1DD; // bool
                constexpr std::ptrdiff_t m_WeightedList = 0x1E0; // CUtlVector<SequenceWeightedList_t>
            }
            // Parent: None
            // Fields count: 5
            //
            ...
            namespace C_INIT_DistanceCull {
                constexpr std::ptrdiff_t m_nControlPoint = 0x1D4; // int32
                constexpr std::ptrdiff_t m_flDistance = 0x1D8; // CParticleCollectionFloatInput
            ...
            namespace C_OP_CollideWithParentParticles {
                ...
                constexpr std::ptrdiff_t m_flRadiusScale = 0x338; // CPerParticleFloatInput
            }
            // Parent: None
            // Fields count: 5
            //
            ...
            namespace C_INIT_InitFromVectorFieldSnapshot {
                constexpr std::ptrdiff_t m_nControlPointNumber = 0x1D4; // int32
                constexpr std::ptrdiff_t m_nLocalSpaceCP = 0x1D8; // int32
                constexpr std::ptrdiff_t m_nWeightUpdateCP = 0x1DC; // int32
                constexpr std::ptrdiff_t m_bUseVerticalVelocity = 0x1E0; // bool
            ...
            namespace C_INIT_AddVectorToVector {
                constexpr std::ptrdiff_t m_vecScale = 0x1D4; // Vector
                constexpr std::ptrdiff_t m_nFieldOutput = 0x1E0; // ParticleAttributeIndex_t
                constexpr std::ptrdiff_t m_nFieldInput = 0x1E4; // ParticleAttributeIndex_t
                constexpr std::ptrdiff_t m_vOffsetMin = 0x1E8; // Vector
                constexpr std::ptrdiff_t m_vOffsetMax = 0x1F4; // Vector
            ...
            namespace C_OP_RemapTransformOrientationToYaw {
                ...
                constexpr std::ptrdiff_t m_flRotOffset = 0x234; // float32
                constexpr std::ptrdiff_t m_flSpinStrength = 0x238; // float32
            }
            // Parent: None
            // Fields count: 7
            //
            ...
            namespace C_OP_RandomForce {
                constexpr std::ptrdiff_t m_MinForce = 0x1DC; // Vector
                constexpr std::ptrdiff_t m_MaxForce = 0x1E8; // Vector
            }
            // Parent: None
            // Fields count: 7
            //
            ...
            namespace C_OP_LocalAccelerationForce {
                ...
                constexpr std::ptrdiff_t m_nScaleCP = 0x1E0; // int32
            ...
            namespace C_OP_SetFloat {
                ...
                constexpr std::ptrdiff_t m_Lerp = 0x340; // CPerParticleFloatInput
            }
            // Parent: None
            // Fields count: 13
            //
            ...
            namespace C_INIT_RemapTransformToVector {
                constexpr std::ptrdiff_t m_nFieldOutput = 0x1D4; // ParticleAttributeIndex_t
                constexpr std::ptrdiff_t m_vInputMin = 0x1D8; // Vector
                constexpr std::ptrdiff_t m_vInputMax = 0x1E4; // Vector
                constexpr std::ptrdiff_t m_vOutputMin = 0x1F0; // Vector
                constexpr std::ptrdiff_t m_vOutputMax = 0x1FC; // Vector
            ...
            namespace C_OP_RemapDistanceToLineSegmentToScalar {
                constexpr std::ptrdiff_t m_nFieldOutput = 0x1E4; // ParticleAttributeIndex_t
                constexpr std::ptrdiff_t m_flMinOutputValue = 0x1E8; // float32
                constexpr std::ptrdiff_t m_flMaxOutputValue = 0x1EC; // float32
            }
            // Parent: None
            // Fields count: 3
            //
            ...
            namespace C_OP_SetFromCPSnapshot {
                ...
                constexpr std::ptrdiff_t m_nSnapShotIncrement = 0x360; // CParticleCollectionFloatInput
                constexpr std::ptrdiff_t m_flInterpolation = 0x4C8; // CPerParticleFloatInput
                constexpr std::ptrdiff_t m_bSubSample = 0x630; // bool
                constexpr std::ptrdiff_t m_bPrev = 0x631; // bool
            }
            // Parent: None
            // Fields count: 15
            //
            ...
            namespace C_OP_DistanceBetweenCPsToCP {
                ...
                constexpr std::ptrdiff_t m_nOutputCP = 0x1DC; // int32
                constexpr std::ptrdiff_t m_nOutputCPField = 0x1E0; // int32
                constexpr std::ptrdiff_t m_bSetOnce = 0x1E4; // bool
                ...
                constexpr std::ptrdiff_t m_flLOSScale = 0x1FC; // float32
                constexpr std::ptrdiff_t m_bLOS = 0x200; // bool
                constexpr std::ptrdiff_t m_CollisionGroupName = 0x201; // char[128]
                constexpr std::ptrdiff_t m_nTraceSet = 0x284; // ParticleTraceSet_t
                constexpr std::ptrdiff_t m_nSetParent = 0x288; // ParticleParentSetMode_t
            }
            // Parent: None
            // Fields count: 4
            //
            ...
            namespace C_OP_SetControlPointToHand {
                constexpr std::ptrdiff_t m_nCP1 = 0x1D4; // int32
                constexpr std::ptrdiff_t m_nHand = 0x1D8; // int32
                constexpr std::ptrdiff_t m_vecCP1Pos = 0x1DC; // Vector
                constexpr std::ptrdiff_t m_bOrientToHand = 0x1E8; // bool
            }
            // Parent: None
            // Fields count: 8
            //
            ...
            namespace C_OP_DistanceCull {
                ...
                constexpr std::ptrdiff_t m_bCullInside = 0x348; // bool
                constexpr std::ptrdiff_t m_nAttribute = 0x34C; // ParticleAttributeIndex_t
            }
            // Parent: None
            // Fields count: 5
            //
            ...
            namespace C_OP_GameDecalRenderer {
                ...
                constexpr std::ptrdiff_t m_vecEndPos = 0x8D0; // CPerParticleVecInput
                constexpr std::ptrdiff_t m_flTraceBloat = 0xF60; // CPerParticleFloatInput
                constexpr std::ptrdiff_t m_flDecalSize = 0x10C8; // CPerParticleFloatInput
                constexpr std::ptrdiff_t m_nDecalGroupIndex = 0x1230; // CPerParticleFloatInput
                constexpr std::ptrdiff_t m_flDecalRotation = 0x1398; // CPerParticleFloatInput
                constexpr std::ptrdiff_t m_vModulationColor = 0x1500; // CPerParticleVecInput
                constexpr std::ptrdiff_t m_bUseGameDefaultDecalSize = 0x1B90; // bool
                constexpr std::ptrdiff_t m_bRandomDecalRotation = 0x1B91; // bool
                constexpr std::ptrdiff_t m_bRandomlySelectDecalInGroup = 0x1B92; // bool
                constexpr std::ptrdiff_t m_bNoDecalsOnOwner = 0x1B93; // bool
                constexpr std::ptrdiff_t m_bVisualizeTraces = 0x1B94; // bool
            }
            // Parent: None
            // Fields count: 7
            //
            ...
            namespace C_INIT_ColorLitPerParticle {
                constexpr std::ptrdiff_t m_ColorMin = 0x1EC; // Color
                constexpr std::ptrdiff_t m_ColorMax = 0x1F0; // Color
                constexpr std::ptrdiff_t m_TintMin = 0x1F4; // Color
                constexpr std::ptrdiff_t m_TintMax = 0x1F8; // Color
                constexpr std::ptrdiff_t m_flTintPerc = 0x1FC; // float32
                constexpr std::ptrdiff_t m_nTintBlendMode = 0x200; // ParticleColorBlendMode_t
                constexpr std::ptrdiff_t m_flLightAmplification = 0x204; // float32
            }
            // Parent: None
            // Fields count: 1
            //
            ...
            namespace C_INIT_SetAttributeToScalarExpression {
                ...
                constexpr std::ptrdiff_t m_flInput2 = 0x340; // CPerParticleFloatInput
                constexpr std::ptrdiff_t m_flOutputRemap = 0x4A8; // CParticleRemapFloatInput
                constexpr std::ptrdiff_t m_nOutputField = 0x610; // ParticleAttributeIndex_t
                constexpr std::ptrdiff_t m_nSetMethod = 0x614; // ParticleSetMethod_t
            }
            // Parent: None
            // Fields count: 10
            //
            ...
            namespace C_INIT_CreateOnGrid {
                ...
                constexpr std::ptrdiff_t m_nYCount = 0x340; // CParticleCollectionFloatInput
                constexpr std::ptrdiff_t m_nZCount = 0x4A8; // CParticleCollectionFloatInput
                constexpr std::ptrdiff_t m_nXSpacing = 0x610; // CParticleCollectionFloatInput
                constexpr std::ptrdiff_t m_nYSpacing = 0x778; // CParticleCollectionFloatInput
                constexpr std::ptrdiff_t m_nZSpacing = 0x8E0; // CParticleCollectionFloatInput
                constexpr std::ptrdiff_t m_nControlPointNumber = 0xA48; // int32
                constexpr std::ptrdiff_t m_bLocalSpace = 0xA4C; // bool
                constexpr std::ptrdiff_t m_bCenter = 0xA4D; // bool
                constexpr std::ptrdiff_t m_bHollow = 0xA4E; // bool
            }
            // Parent: None
            // Fields count: 3
            //
            ...
            namespace C_OP_RampCPLinearRandom {
                ...
                constexpr std::ptrdiff_t m_vecRateMin = 0x1D8; // Vector
                constexpr std::ptrdiff_t m_vecRateMax = 0x1E4; // Vector
            }
            // Parent: None
            // Fields count: 6
            //
            ...
            namespace C_INIT_CreateOnModelAtHeight {
                constexpr std::ptrdiff_t m_bUseBones = 0x1D4; // bool
                constexpr std::ptrdiff_t m_bForceZ = 0x1D5; // bool
                constexpr std::ptrdiff_t m_nControlPointNumber = 0x1D8; // int32
                constexpr std::ptrdiff_t m_nHeightCP = 0x1DC; // int32
                constexpr std::ptrdiff_t m_bUseWaterHeight = 0x1E0; // bool
                constexpr std::ptrdiff_t m_flDesiredHeight = 0x1E8; // CParticleCollectionFloatInput
                constexpr std::ptrdiff_t m_vecHitBoxScale = 0x350; // CParticleCollectionVecInput
                constexpr std::ptrdiff_t m_vecDirectionBias = 0x9E0; // CParticleCollectionVecInput
                constexpr std::ptrdiff_t m_nBiasType = 0x1070; // ParticleHitboxBiasType_t
                constexpr std::ptrdiff_t m_bLocalCoords = 0x1074; // bool
                constexpr std::ptrdiff_t m_bPreferMovingBoxes = 0x1075; // bool
                constexpr std::ptrdiff_t m_HitboxSetName = 0x1076; // char[128]
                constexpr std::ptrdiff_t m_flHitboxVelocityScale = 0x10F8; // CParticleCollectionFloatInput
                constexpr std::ptrdiff_t m_flMaxBoneVelocity = 0x1260; // CParticleCollectionFloatInput
            }
            // Parent: None
            // Fields count: 10
            //
            ...
            namespace C_OP_ModelSurfaceSnapshotGenerator {
                ...
                constexpr std::ptrdiff_t m_flRecalcRate = 0x230; // CParticleCollectionFloatInput
                constexpr std::ptrdiff_t m_flUSpacing = 0x398; // CParticleCollectionFloatInput
                constexpr std::ptrdiff_t m_flVSpacing = 0x500; // CParticleCollectionFloatInput
                constexpr std::ptrdiff_t m_flSurfaceOffset = 0x668; // CParticleCollectionFloatInput
                constexpr std::ptrdiff_t m_bSetNormal = 0x7D0; // bool
                constexpr std::ptrdiff_t m_bSetUp = 0x7D1; // bool
                constexpr std::ptrdiff_t m_bSetGravity = 0x7D2; // bool
                constexpr std::ptrdiff_t m_bSetUV = 0x7D3; // bool
            }
            // Parent: None
            // Fields count: 6
            //
            ...
            namespace C_INIT_CreateSequentialPathV2 {
                ...
                constexpr std::ptrdiff_t m_flNumToAssign = 0x340; // CParticleCollectionFloatInput
                constexpr std::ptrdiff_t m_bLoop = 0x4A8; // bool
                constexpr std::ptrdiff_t m_bCPPairs = 0x4A9; // bool
                constexpr std::ptrdiff_t m_bSaveOffset = 0x4AA; // bool
            ...
            namespace C_INIT_RemapInitialDirectionToTransformToVector {
                constexpr std::ptrdiff_t m_TransformInput = 0x1D8; // CParticleTransformInput
                constexpr std::ptrdiff_t m_nFieldOutput = 0x238; // ParticleAttributeIndex_t
                constexpr std::ptrdiff_t m_flScale = 0x23C; // float32
                constexpr std::ptrdiff_t m_flOffsetRot = 0x240; // float32
                constexpr std::ptrdiff_t m_vecOffsetAxis = 0x244; // Vector
                constexpr std::ptrdiff_t m_bNormalize = 0x250; // bool
            }
            // Parent: None
            // Fields count: 4
            //
            ...
            namespace C_INIT_RandomYawFlip {
                constexpr std::ptrdiff_t m_flPercent = 0x1D4; // float32
            }
            // Parent: None
            // Fields count: 2
            //
            ...
            namespace C_OP_RenderText {
                constexpr std::ptrdiff_t m_OutlineColor = 0x21A; // Color
                constexpr std::ptrdiff_t m_DefaultText = 0x220; // CUtlString
            }
            // Parent: None
            // Fields count: 5
            //
            ...
            namespace C_OP_LerpToInitialPosition {
                constexpr std::ptrdiff_t m_nControlPointNumber = 0x1D0; // int32
                constexpr std::ptrdiff_t m_flInterpolation = 0x1D8; // CPerParticleFloatInput
                constexpr std::ptrdiff_t m_nCacheField = 0x340; // ParticleAttributeIndex_t
                constexpr std::ptrdiff_t m_flScale = 0x348; // CParticleCollectionFloatInput
                constexpr std::ptrdiff_t m_vecScale = 0x4B0; // CParticleCollectionVecInput
            }
            // Parent: None
            // Fields count: 0
            //
            ...
            namespace C_OP_SetCPOrientationToPointAtCP {
                ...
                constexpr std::ptrdiff_t m_b2DOrientation = 0x348; // bool
                constexpr std::ptrdiff_t m_bAvoidSingularity = 0x349; // bool
                constexpr std::ptrdiff_t m_bPointAway = 0x34A; // bool
            }
            // Parent: None
            // Fields count: 5
            //
            ...
            namespace C_OP_MovementPlaceOnGround {
                ...
                constexpr std::ptrdiff_t m_flMaxTraceLength = 0x338; // float32
                constexpr std::ptrdiff_t m_flTolerance = 0x33C; // float32
                constexpr std::ptrdiff_t m_vecTraceDir = 0x340; // CPerParticleVecInput
                constexpr std::ptrdiff_t m_flTraceOffset = 0x9D0; // float32
                constexpr std::ptrdiff_t m_flLerpRate = 0x9D4; // float32
                constexpr std::ptrdiff_t m_CollisionGroupName = 0x9D8; // char[128]
                constexpr std::ptrdiff_t m_nTraceSet = 0xA58; // ParticleTraceSet_t
                constexpr std::ptrdiff_t m_nRefCP1 = 0xA5C; // int32
                constexpr std::ptrdiff_t m_nRefCP2 = 0xA60; // int32
                constexpr std::ptrdiff_t m_nLerpCP = 0xA64; // int32
                constexpr std::ptrdiff_t m_nTraceMissBehavior = 0xA70; // ParticleTraceMissBehavior_t
                constexpr std::ptrdiff_t m_bIncludeShotHull = 0xA74; // bool
                constexpr std::ptrdiff_t m_bIncludeWater = 0xA75; // bool
                constexpr std::ptrdiff_t m_bSetNormal = 0xA78; // bool
                constexpr std::ptrdiff_t m_bScaleOffset = 0xA79; // bool
                constexpr std::ptrdiff_t m_nPreserveOffsetCP = 0xA7C; // int32
                constexpr std::ptrdiff_t m_nIgnoreCP = 0xA80; // int32
            }
            // Parent: None
            // Fields count: 2
            //
            ...
            namespace C_OP_RemapCrossProductOfTwoVectorsToVector {
                ...
                constexpr std::ptrdiff_t m_InputVec2 = 0x860; // CPerParticleVecInput
                constexpr std::ptrdiff_t m_nFieldOutput = 0xEF0; // ParticleAttributeIndex_t
                constexpr std::ptrdiff_t m_bNormalize = 0xEF4; // bool
            }
            // Parent: None
            // Fields count: 4
            //
            ...
            namespace C_OP_InheritFromParentParticlesV2 {
                ...
                constexpr std::ptrdiff_t m_nIncrement = 0x340; // CPerParticleFloatInput
                constexpr std::ptrdiff_t m_bSubSample = 0x4A8; // bool
                constexpr std::ptrdiff_t m_bRandomDistribution = 0x4A9; // bool
                constexpr std::ptrdiff_t m_bReverse = 0x4AA; // bool
                constexpr std::ptrdiff_t m_nMissingParentBehavior = 0x4AC; // MissingParentInheritBehavior_t
                constexpr std::ptrdiff_t m_flInterpolation = 0x4B0; // CPerParticleFloatInput
            }
            // Parent: None
            // Fields count: 2
            //
            ...
            namespace C_OP_SetFloatCollection {
                ...
                constexpr std::ptrdiff_t m_nOutputField = 0x338; // ParticleAttributeIndex_t
                constexpr std::ptrdiff_t m_nSetMethod = 0x33C; // ParticleSetMethod_t
                constexpr std::ptrdiff_t m_Lerp = 0x340; // CParticleCollectionFloatInput
            }
            // Parent: None
            // Fields count: 3
            //
            ...
            namespace C_OP_SetControlPointPositionToRandomActiveCP {
                constexpr std::ptrdiff_t m_nCP1 = 0x1D4; // int32
                constexpr std::ptrdiff_t m_nHeadLocationMin = 0x1D8; // int32
                constexpr std::ptrdiff_t m_nHeadLocationMax = 0x1DC; // int32
            ...
            namespace C_INIT_AgeNoise {
                ...
                constexpr std::ptrdiff_t m_flAgeMin = 0x1DC; // float32
                constexpr std::ptrdiff_t m_flAgeMax = 0x1E0; // float32
                constexpr std::ptrdiff_t m_flNoiseScale = 0x1E4; // float32
                constexpr std::ptrdiff_t m_flNoiseScaleLoc = 0x1E8; // float32
            ...
            namespace CGeneralRandomRotation {
                constexpr std::ptrdiff_t m_nFieldOutput = 0x1D4; // ParticleAttributeIndex_t
                constexpr std::ptrdiff_t m_flDegrees = 0x1D8; // float32
                constexpr std::ptrdiff_t m_flDegreesMin = 0x1DC; // float32
                constexpr std::ptrdiff_t m_flDegreesMax = 0x1E0; // float32
                constexpr std::ptrdiff_t m_flRotationRandExponent = 0x1E4; // float32
                constexpr std::ptrdiff_t m_bRandomlyFlipDirection = 0x1E8; // bool
            }
            // Parent: None
            // Fields count: 9
            //
            ...
            namespace C_OP_DistanceBetweenVecs {
                ...
                constexpr std::ptrdiff_t m_vecPoint1 = 0x1D8; // CPerParticleVecInput
                constexpr std::ptrdiff_t m_vecPoint2 = 0x868; // CPerParticleVecInput
                constexpr std::ptrdiff_t m_flInputMin = 0xEF8; // CPerParticleFloatInput
                constexpr std::ptrdiff_t m_flInputMax = 0x1060; // CPerParticleFloatInput
                constexpr std::ptrdiff_t m_flOutputMin = 0x11C8; // CPerParticleFloatInput
                constexpr std::ptrdiff_t m_flOutputMax = 0x1330; // CPerParticleFloatInput
                constexpr std::ptrdiff_t m_nSetMethod = 0x1498; // ParticleSetMethod_t
                constexpr std::ptrdiff_t m_bDeltaTime = 0x149C; // bool
            }
            // Parent: None
            // Fields count: 3
            //
            ...
            namespace C_OP_LockToBone {
                ...
                constexpr std::ptrdiff_t m_flRotLerp = 0x9C0; // CPerParticleFloatInput
            }
            // Parent: None
            // Fields count: 0
            //
            ...
            namespace C_OP_ScreenSpaceRotateTowardTarget {
                constexpr std::ptrdiff_t m_vecTargetPosition = 0x1D0; // CPerParticleVecInput
                constexpr std::ptrdiff_t m_flOutputRemap = 0x860; // CParticleRemapFloatInput
                constexpr std::ptrdiff_t m_nSetMethod = 0x9C8; // ParticleSetMethod_t
                constexpr std::ptrdiff_t m_flScreenEdgeAlignmentDistance = 0x9D0; // CPerParticleFloatInput
            }
            // Parent: None
            // Fields count: 3
            //
            ...
            namespace C_INIT_CreateWithinCapsuleTransform {
                ...
                constexpr std::ptrdiff_t m_fRadiusMax = 0x340; // CPerParticleFloatInput
                constexpr std::ptrdiff_t m_fHeight = 0x4A8; // CPerParticleFloatInput
                constexpr std::ptrdiff_t m_TransformInput = 0x610; // CParticleTransformInput
                constexpr std::ptrdiff_t m_fSpeedMin = 0x670; // CPerParticleFloatInput
                constexpr std::ptrdiff_t m_fSpeedMax = 0x7D8; // CPerParticleFloatInput
                constexpr std::ptrdiff_t m_fSpeedRandExp = 0x940; // float32
                constexpr std::ptrdiff_t m_LocalCoordinateSystemSpeedMin = 0x948; // CPerParticleVecInput
                constexpr std::ptrdiff_t m_LocalCoordinateSystemSpeedMax = 0xFD8; // CPerParticleVecInput
                constexpr std::ptrdiff_t m_nFieldOutput = 0x1668; // ParticleAttributeIndex_t
                constexpr std::ptrdiff_t m_nFieldVelocity = 0x166C; // ParticleAttributeIndex_t
            }
            // Parent: None
            // Fields count: 5
            //
            ...
            namespace C_OP_SetVec {
                ...
                constexpr std::ptrdiff_t m_nOutputField = 0x860; // ParticleAttributeIndex_t
                constexpr std::ptrdiff_t m_nSetMethod = 0x864; // ParticleSetMethod_t
                constexpr std::ptrdiff_t m_Lerp = 0x868; // CPerParticleFloatInput
                constexpr std::ptrdiff_t m_bNormalizedOutput = 0x9D0; // bool
            }
            // Parent: None
            // Fields count: 6
            //
            ...
            namespace C_INIT_CreateFromParentParticles {
                constexpr std::ptrdiff_t m_flVelocityScale = 0x1D4; // float32
                constexpr std::ptrdiff_t m_flIncrement = 0x1D8; // float32
                constexpr std::ptrdiff_t m_bRandomDistribution = 0x1DC; // bool
                constexpr std::ptrdiff_t m_nRandomSeed = 0x1E0; // int32
                constexpr std::ptrdiff_t m_bSubFrame = 0x1E4; // bool
                constexpr std::ptrdiff_t m_bSetRopeSegmentID = 0x1E5; // bool
            }
            // Parent: None
            // Fields count: 4
            //
            ...
            namespace C_INIT_CheckParticleForWater {
                ...
                constexpr std::ptrdiff_t m_nSetMethod = 0x4B0; // ParticleSetMethod_t
            }
            // Parent: None
            // Fields count: 0
            //
            ...
            namespace C_OP_RenderOmni2Light {
                constexpr std::ptrdiff_t m_nLightType = 0x21C; // ParticleOmni2LightTypeChoiceList_t
                constexpr std::ptrdiff_t m_nMaxAllowed = 0x220; // uint16
                constexpr std::ptrdiff_t m_vColorBlend = 0x228; // CParticleCollectionVecInput
                constexpr std::ptrdiff_t m_nColorBlendType = 0x8B8; // ParticleColorBlendType_t
                constexpr std::ptrdiff_t m_strLightStyle = 0x8C0; // CUtlString
                constexpr std::ptrdiff_t m_flLightStyleTime = 0x8C8; // CPerParticleFloatInput
                constexpr std::ptrdiff_t m_nBrightnessUnit = 0xA30; // ParticleLightUnitChoiceList_t
                constexpr std::ptrdiff_t m_flBrightnessLumens = 0xA38; // CPerParticleFloatInput
                constexpr std::ptrdiff_t m_flBrightnessCandelas = 0xBA0; // CPerParticleFloatInput
                constexpr std::ptrdiff_t m_bCastShadows = 0xD08; // bool
                constexpr std::ptrdiff_t m_bDynamicBounce = 0xD09; // bool
                constexpr std::ptrdiff_t m_flBounceScale = 0xD10; // CParticleCollectionFloatInput
                constexpr std::ptrdiff_t m_bFog = 0xE78; // bool
                constexpr std::ptrdiff_t m_flFogScale = 0xE80; // CPerParticleFloatInput
                constexpr std::ptrdiff_t m_flLuminaireRadius = 0xFE8; // CPerParticleFloatInput
                constexpr std::ptrdiff_t m_flSkirt = 0x1150; // CPerParticleFloatInput
                constexpr std::ptrdiff_t m_flRange = 0x12B8; // CPerParticleFloatInput
                constexpr std::ptrdiff_t m_flInnerConeAngle = 0x1420; // CPerParticleFloatInput
                constexpr std::ptrdiff_t m_flOuterConeAngle = 0x1588; // CPerParticleFloatInput
                constexpr std::ptrdiff_t m_hLightCookie = 0x16F0; // CStrongHandle<InfoForResourceTypeCTextureBase>
                constexpr std::ptrdiff_t m_bSphericalCookie = 0x16F8; // bool
            }
            // Parent: None
            // Fields count: 5
            //
            ...
            namespace C_OP_ConnectParentParticleToNearest {
                ...
                constexpr std::ptrdiff_t m_flParentRadiusScale = 0x348; // CParticleCollectionFloatInput
            }
            // Parent: None
            // Fields count: 3
            //
            ...
            namespace C_INIT_InitSkinnedPositionFromCPSnapshot {
                ...
                constexpr std::ptrdiff_t m_nRandomSeed = 0x1E0; // int32
                constexpr std::ptrdiff_t m_bRigid = 0x1E4; // bool
                constexpr std::ptrdiff_t m_bSetNormal = 0x1E5; // bool
                constexpr std::ptrdiff_t m_bIgnoreDt = 0x1E6; // bool
                constexpr std::ptrdiff_t m_flMinNormalVelocity = 0x1E8; // float32
                constexpr std::ptrdiff_t m_flMaxNormalVelocity = 0x1EC; // float32
                constexpr std::ptrdiff_t m_nIndexType = 0x1F0; // SnapshotIndexType_t
                constexpr std::ptrdiff_t m_flReadIndex = 0x1F8; // CPerParticleFloatInput
                constexpr std::ptrdiff_t m_flIncrement = 0x360; // float32
                constexpr std::ptrdiff_t m_nFullLoopIncrement = 0x364; // int32
                constexpr std::ptrdiff_t m_nSnapShotStartPoint = 0x368; // int32
                constexpr std::ptrdiff_t m_flBoneVelocity = 0x36C; // float32
                constexpr std::ptrdiff_t m_flBoneVelocityMax = 0x370; // float32
                constexpr std::ptrdiff_t m_bCopyColor = 0x374; // bool
                constexpr std::ptrdiff_t m_bCopyAlpha = 0x375; // bool
                constexpr std::ptrdiff_t m_bSetRadius = 0x376; // bool
            }
            // Parent: None
            // Fields count: 4
            //
            ...
            namespace C_OP_CollideWithSelf {
                ...
                constexpr std::ptrdiff_t m_flMinimumSpeed = 0x338; // CPerParticleFloatInput
            }
            // Parent: None
            // Fields count: 6
            //
            ...
            namespace C_OP_ColorAdjustHSL {
                ...
                constexpr std::ptrdiff_t m_flSaturationAdjust = 0x338; // CPerParticleFloatInput
                constexpr std::ptrdiff_t m_flLightnessAdjust = 0x4A0; // CPerParticleFloatInput
            }
            // Parent: None
            // Fields count: 4
            //
            ...
            namespace C_INIT_InitVec {
                ...
                constexpr std::ptrdiff_t m_nOutputField = 0x868; // ParticleAttributeIndex_t
                constexpr std::ptrdiff_t m_nSetMethod = 0x86C; // ParticleSetMethod_t
                constexpr std::ptrdiff_t m_bNormalizedOutput = 0x870; // bool
                constexpr std::ptrdiff_t m_bWritePreviousPosition = 0x871; // bool
            }
            // Parent: None
            // Fields count: 10
            //
            ...
            namespace C_INIT_SetHitboxToModel {
                constexpr std::ptrdiff_t m_nControlPointNumber = 0x1D4; // int32
                constexpr std::ptrdiff_t m_nForceInModel = 0x1D8; // int32
                constexpr std::ptrdiff_t m_bEvenDistribution = 0x1DC; // bool
                constexpr std::ptrdiff_t m_nDesiredHitbox = 0x1E0; // int32
                constexpr std::ptrdiff_t m_vecHitBoxScale = 0x1E8; // CParticleCollectionVecInput
                constexpr std::ptrdiff_t m_vecDirectionBias = 0x878; // Vector
                constexpr std::ptrdiff_t m_bMaintainHitbox = 0x884; // bool
                constexpr std::ptrdiff_t m_bUseBones = 0x885; // bool
                constexpr std::ptrdiff_t m_HitboxSetName = 0x886; // char[128]
                constexpr std::ptrdiff_t m_flShellSize = 0x908; // CParticleCollectionFloatInput
            }
            // Parent: None
            // Fields count: 6
            //
            ...
            namespace C_OP_MovementMoveAlongSkinnedCPSnapshot {
                ...
                constexpr std::ptrdiff_t m_flInterpolation = 0x1E0; // CPerParticleFloatInput
                constexpr std::ptrdiff_t m_flTValue = 0x348; // CPerParticleFloatInput
            }
            // Parent: None
            // Fields count: 4
            //
            ...
            namespace C_OP_LerpScalar {
                ...
                constexpr std::ptrdiff_t m_flStartTime = 0x340; // float32
                constexpr std::ptrdiff_t m_flEndTime = 0x344; // float32
            }
            // Parent: None
            // Fields count: 13
            //
            ...
            namespace C_INIT_InitialRepulsionVelocity {
                ...
                constexpr std::ptrdiff_t m_vecOutputMin = 0x258; // Vector
                constexpr std::ptrdiff_t m_vecOutputMax = 0x264; // Vector
                constexpr std::ptrdiff_t m_nControlPointNumber = 0x270; // int32
                constexpr std::ptrdiff_t m_bPerParticle = 0x274; // bool
                constexpr std::ptrdiff_t m_bTranslate = 0x275; // bool
                constexpr std::ptrdiff_t m_bProportional = 0x276; // bool
                constexpr std::ptrdiff_t m_flTraceLength = 0x278; // float32
                constexpr std::ptrdiff_t m_bPerParticleTR = 0x27C; // bool
                constexpr std::ptrdiff_t m_bInherit = 0x27D; // bool
                constexpr std::ptrdiff_t m_nChildCP = 0x280; // int32
                constexpr std::ptrdiff_t m_nChildGroupID = 0x284; // int32
            }
            // Parent: None
            // Fields count: 3
            //
            ...
            namespace C_OP_ClampScalar {
                ...
                constexpr std::ptrdiff_t m_flOutputMax = 0x340; // CPerParticleFloatInput
            }
            // Parent: None
            // Fields count: 3
            //
            ...
            namespace C_OP_SetControlPointToHMD {
                constexpr std::ptrdiff_t m_nCP1 = 0x1D4; // int32
                constexpr std::ptrdiff_t m_vecCP1Pos = 0x1D8; // Vector
                constexpr std::ptrdiff_t m_bOrientToHMD = 0x1E4; // bool
            }
            // Parent: None
            // Fields count: 9
            //
            ...
            namespace C_OP_SetControlPointFieldFromVectorExpression {
                constexpr std::ptrdiff_t m_nExpression = 0x1D4; // VectorFloatExpressionType_t
                constexpr std::ptrdiff_t m_vecInput1 = 0x1D8; // CParticleCollectionVecInput
                constexpr std::ptrdiff_t m_vecInput2 = 0x868; // CParticleCollectionVecInput
                constexpr std::ptrdiff_t m_flLerp = 0xEF8; // CPerParticleFloatInput
                constexpr std::ptrdiff_t m_flOutputRemap = 0x1060; // CParticleRemapFloatInput
                constexpr std::ptrdiff_t m_nOutputCP = 0x11C8; // int32
                constexpr std::ptrdiff_t m_nOutVectorField = 0x11CC; // int32
            }
            // Parent: None
            // Fields count: 10
            //
            ...
            namespace C_INIT_InitFromCPSnapshot {
                ...
                constexpr std::ptrdiff_t m_bRandom = 0x1EC; // bool
                constexpr std::ptrdiff_t m_bReverse = 0x1ED; // bool
                constexpr std::ptrdiff_t m_nSnapShotIncrement = 0x1F0; // CParticleCollectionFloatInput
                constexpr std::ptrdiff_t m_nManualSnapshotIndex = 0x358; // CPerParticleFloatInput
                constexpr std::ptrdiff_t m_nRandomSeed = 0x4C0; // int32
                constexpr std::ptrdiff_t m_bLocalSpaceAngles = 0x4C4; // bool
            }
            // Parent: None
            // Fields count: 24
            //
            ...
            namespace C_OP_RenderCables {
                ...
                constexpr std::ptrdiff_t m_flAlphaScale = 0x388; // CParticleCollectionFloatInput
                constexpr std::ptrdiff_t m_vecColorScale = 0x4F0; // CParticleCollectionVecInput
                constexpr std::ptrdiff_t m_nColorBlendType = 0xB80; // ParticleColorBlendType_t
                constexpr std::ptrdiff_t m_hMaterial = 0xB88; // CStrongHandle<InfoForResourceTypeIMaterial2>
                constexpr std::ptrdiff_t m_nTextureRepetitionMode = 0xB90; // TextureRepetitionMode_t
                constexpr std::ptrdiff_t m_flTextureRepeatsPerSegment = 0xB98; // CParticleCollectionFloatInput
                constexpr std::ptrdiff_t m_flTextureRepeatsCircumference = 0xD00; // CParticleCollectionFloatInput
                constexpr std::ptrdiff_t m_flColorMapOffsetV = 0xE68; // CParticleCollectionFloatInput
                constexpr std::ptrdiff_t m_flColorMapOffsetU = 0xFD0; // CParticleCollectionFloatInput
                constexpr std::ptrdiff_t m_flNormalMapOffsetV = 0x1138; // CParticleCollectionFloatInput
                constexpr std::ptrdiff_t m_flNormalMapOffsetU = 0x12A0; // CParticleCollectionFloatInput
                constexpr std::ptrdiff_t m_bDrawCableCaps = 0x1408; // bool
                constexpr std::ptrdiff_t m_flCapRoundness = 0x140C; // float32
                constexpr std::ptrdiff_t m_flCapOffsetAmount = 0x1410; // float32
                constexpr std::ptrdiff_t m_flTessScale = 0x1414; // float32
                constexpr std::ptrdiff_t m_nMinTesselation = 0x1418; // int32
                constexpr std::ptrdiff_t m_nMaxTesselation = 0x141C; // int32
                constexpr std::ptrdiff_t m_nRoundness = 0x1420; // int32
                constexpr std::ptrdiff_t m_nForceRoundnessFixed = 0x1424; // bool
                constexpr std::ptrdiff_t m_bOnlyRenderInEffectsBloomPass = 0x1425; // bool
                constexpr std::ptrdiff_t m_LightingTransform = 0x1428; // CParticleTransformInput
                constexpr std::ptrdiff_t m_MaterialFloatVars = 0x1488; // CUtlLeanVector<FloatInputMaterialVariable_t>
                constexpr std::ptrdiff_t m_MaterialVecVars = 0x14A8; // CUtlLeanVector<VecInputMaterialVariable_t>
            }
            // Parent: None
            // Fields count: 2
            //
            ...
            namespace C_OP_SetControlPointToWaterSurface {
                constexpr std::ptrdiff_t m_nSourceCP = 0x1D4; // int32
                constexpr std::ptrdiff_t m_nDestCP = 0x1D8; // int32
                constexpr std::ptrdiff_t m_nFlowCP = 0x1DC; // int32
                constexpr std::ptrdiff_t m_nActiveCP = 0x1E0; // int32
                constexpr std::ptrdiff_t m_nActiveCPField = 0x1E4; // int32
                constexpr std::ptrdiff_t m_flRetestRate = 0x1E8; // CParticleCollectionFloatInput
                constexpr std::ptrdiff_t m_bAdaptiveThreshold = 0x350; // bool
            }
            // Parent: None
            // Fields count: 6
            //
            ...
            namespace C_INIT_PositionOffset {
                ...
                constexpr std::ptrdiff_t m_OffsetMax = 0x868; // CPerParticleVecInput
                constexpr std::ptrdiff_t m_TransformInput = 0xEF8; // CParticleTransformInput
                constexpr std::ptrdiff_t m_bLocalCoords = 0xF58; // bool
                constexpr std::ptrdiff_t m_bProportional = 0xF59; // bool
                constexpr std::ptrdiff_t m_randomnessParameters = 0xF5C; // CRandomNumberGeneratorParameters
            }
            // Parent: None
            // Fields count: 2
            //
            ...
            namespace C_INIT_NormalAlignToCP {
                constexpr std::ptrdiff_t m_transformInput = 0x1D8; // CParticleTransformInput
                constexpr std::ptrdiff_t m_nControlPointAxis = 0x238; // ParticleControlPointAxis_t
            }
            // Parent: None
            // Fields count: 1
            //
            ...
            namespace C_OP_SetChildControlPoints {
                ...
                constexpr std::ptrdiff_t m_bReverse = 0x348; // bool
                constexpr std::ptrdiff_t m_bSetOrientation = 0x349; // bool
                constexpr std::ptrdiff_t m_nOrientation = 0x34C; // ParticleOrientationType_t
            }
            // Parent: None
            // Fields count: 10
            //
            ...
            namespace C_OP_ChladniWave {
                ...
                constexpr std::ptrdiff_t m_flOutputMin = 0x4A8; // CPerParticleFloatInput
                constexpr std::ptrdiff_t m_flOutputMax = 0x610; // CPerParticleFloatInput
                constexpr std::ptrdiff_t m_vecWaveLength = 0x778; // CPerParticleVecInput
                constexpr std::ptrdiff_t m_vecHarmonics = 0xE08; // CPerParticleVecInput
                constexpr std::ptrdiff_t m_nSetMethod = 0x1498; // ParticleSetMethod_t
                constexpr std::ptrdiff_t m_nLocalSpaceControlPoint = 0x149C; // int32
                constexpr std::ptrdiff_t m_b3D = 0x14A0; // bool
            }
            // Parent: None
            // Fields count: 7
            //
            ...
            namespace C_INIT_ScreenSpacePositionOfTarget {
                ...
                constexpr std::ptrdiff_t m_bOututBehindness = 0x868; // bool
                constexpr std::ptrdiff_t m_nBehindFieldOutput = 0x86C; // ParticleAttributeIndex_t
                constexpr std::ptrdiff_t m_flBehindOutputRemap = 0x870; // CParticleRemapFloatInput
            }
            // Parent: None
            // Fields count: 7
            //
            ...
            namespace C_OP_PinParticleToCP {
                ...
                constexpr std::ptrdiff_t m_bOffsetLocal = 0x868; // bool
                constexpr std::ptrdiff_t m_nParticleSelection = 0x86C; // ParticleSelection_t
                constexpr std::ptrdiff_t m_nParticleNumber = 0x870; // CParticleCollectionFloatInput
                constexpr std::ptrdiff_t m_nPinBreakType = 0x9D8; // ParticlePinDistance_t
                constexpr std::ptrdiff_t m_flBreakDistance = 0x9E0; // CParticleCollectionFloatInput
                constexpr std::ptrdiff_t m_flBreakSpeed = 0xB48; // CParticleCollectionFloatInput
                constexpr std::ptrdiff_t m_flAge = 0xCB0; // CParticleCollectionFloatInput
                constexpr std::ptrdiff_t m_nBreakControlPointNumber = 0xE18; // int32
                constexpr std::ptrdiff_t m_nBreakControlPointNumber2 = 0xE1C; // int32
                constexpr std::ptrdiff_t m_flBreakValue = 0xE20; // CParticleCollectionFloatInput
                constexpr std::ptrdiff_t m_flInterpolation = 0xF88; // CPerParticleFloatInput
                constexpr std::ptrdiff_t m_bRetainInitialVelocity = 0x10F0; // bool
            }
            // Parent: None
            // Fields count: 13
            //
            ...
            namespace C_INIT_CreateParticleImpulse {
                ...
                constexpr std::ptrdiff_t m_InputMagnitude = 0x340; // CPerParticleFloatInput
                constexpr std::ptrdiff_t m_nFalloffFunction = 0x4A8; // ParticleFalloffFunction_t
                constexpr std::ptrdiff_t m_InputFalloffExp = 0x4B0; // CPerParticleFloatInput
                constexpr std::ptrdiff_t m_nImpulseType = 0x618; // ParticleImpulseType_t
            }
            // Parent: None
            // Fields count: 3
            //
            ...
            namespace C_OP_DensityForce {
                constexpr std::ptrdiff_t m_flRadiusScale = 0x1DC; // float32
                constexpr std::ptrdiff_t m_flForceScale = 0x1E0; // float32
                constexpr std::ptrdiff_t m_flTargetDensity = 0x1E4; // float32
            }
            // Parent: None
            // Fields count: 10
            //
            ...
            namespace C_INIT_CreateInEpitrochoid {
                constexpr std::ptrdiff_t m_nComponent1 = 0x1D4; // int32
                constexpr std::ptrdiff_t m_nComponent2 = 0x1D8; // int32
                constexpr std::ptrdiff_t m_TransformInput = 0x1E0; // CParticleTransformInput
                constexpr std::ptrdiff_t m_flParticleDensity = 0x240; // CPerParticleFloatInput
                constexpr std::ptrdiff_t m_flOffset = 0x3A8; // CPerParticleFloatInput
                constexpr std::ptrdiff_t m_flRadius1 = 0x510; // CPerParticleFloatInput
                constexpr std::ptrdiff_t m_flRadius2 = 0x678; // CPerParticleFloatInput
                constexpr std::ptrdiff_t m_bUseCount = 0x7E0; // bool
                constexpr std::ptrdiff_t m_bUseLocalCoords = 0x7E1; // bool
                constexpr std::ptrdiff_t m_bOffsetExistingPos = 0x7E2; // bool
            }
            // Parent: None
            // Fields count: 5
            //
            ...
            namespace C_OP_SetFloatAttributeToVectorExpression {
                ...
                constexpr std::ptrdiff_t m_vInput1 = 0x1D8; // CPerParticleVecInput
                constexpr std::ptrdiff_t m_vInput2 = 0x868; // CPerParticleVecInput
                constexpr std::ptrdiff_t m_flOutputRemap = 0xEF8; // CParticleRemapFloatInput
                constexpr std::ptrdiff_t m_nOutputField = 0x1060; // ParticleAttributeIndex_t
                constexpr std::ptrdiff_t m_nSetMethod = 0x1064; // ParticleSetMethod_t
            }
            // Parent: None
            ...
            namespace C_OP_MovementRotateParticleAroundAxis {
                ...
                constexpr std::ptrdiff_t m_TransformInput = 0x9C8; // CParticleTransformInput
                constexpr std::ptrdiff_t m_bLocalSpace = 0xA28; // bool
            }
            // Parent: None
            // Fields count: 7
            //
            ...
            namespace C_OP_IntraParticleForce {
                constexpr std::ptrdiff_t m_flAttractionMinDistance = 0x1DC; // float32
                constexpr std::ptrdiff_t m_flAttractionMaxDistance = 0x1E0; // float32
                constexpr std::ptrdiff_t m_flAttractionMaxStrength = 0x1E4; // float32
                constexpr std::ptrdiff_t m_flRepulsionMinDistance = 0x1E8; // float32
                constexpr std::ptrdiff_t m_flRepulsionMaxDistance = 0x1EC; // float32
                constexpr std::ptrdiff_t m_flRepulsionMaxStrength = 0x1F0; // float32
                constexpr std::ptrdiff_t m_bUseAABB = 0x1F4; // bool
            }
            // Parent: None
            // Fields count: 4
            //
            ...
            namespace C_INIT_InitFloat {
                ...
                constexpr std::ptrdiff_t m_InputStrength = 0x348; // CPerParticleFloatInput
            }
            // Parent: None
            // Fields count: 16
            //
            ...
            namespace C_INIT_CreateOnModel {
                ...
                constexpr std::ptrdiff_t m_nHitboxValueFromControlPointIndex = 0x400; // int32
                constexpr std::ptrdiff_t m_vecHitBoxScale = 0x408; // CParticleCollectionVecInput
                constexpr std::ptrdiff_t m_flBoneVelocity = 0xA98; // float32
                constexpr std::ptrdiff_t m_flMaxBoneVelocity = 0xA9C; // float32
                constexpr std::ptrdiff_t m_vecDirectionBias = 0xAA0; // CParticleCollectionVecInput
                constexpr std::ptrdiff_t m_HitboxSetName = 0x1130; // char[128]
                constexpr std::ptrdiff_t m_bLocalCoords = 0x11B0; // bool
                constexpr std::ptrdiff_t m_bUseBones = 0x11B1; // bool
                constexpr std::ptrdiff_t m_bUseMesh = 0x11B2; // bool
                constexpr std::ptrdiff_t m_flShellSize = 0x11B8; // CParticleCollectionFloatInput
            }
            // Parent: None
            // Fields count: 4
            //
            ...
            namespace C_OP_PerParticleForce {
                constexpr std::ptrdiff_t m_flForceScale = 0x1E0; // CPerParticleFloatInput
                constexpr std::ptrdiff_t m_vForce = 0x348; // CPerParticleVecInput
                constexpr std::ptrdiff_t m_nCP = 0x9D8; // int32
            }
            // Parent: None
            // Fields count: 0
            //
            ...
            namespace C_OP_RenderProjected {
                constexpr std::ptrdiff_t m_bProjectCharacter = 0x21A; // bool
                constexpr std::ptrdiff_t m_bProjectWorld = 0x21B; // bool
                constexpr std::ptrdiff_t m_bProjectWater = 0x21C; // bool
                constexpr std::ptrdiff_t m_bFlipHorizontal = 0x21D; // bool
                constexpr std::ptrdiff_t m_bEnableProjectedDepthControls = 0x21E; // bool
                constexpr std::ptrdiff_t m_flMinProjectionDepth = 0x220; // float32
                constexpr std::ptrdiff_t m_flMaxProjectionDepth = 0x224; // float32
                constexpr std::ptrdiff_t m_vecProjectedMaterials = 0x228; // CUtlVector<RenderProjectedMaterial_t>
                constexpr std::ptrdiff_t m_flMaterialSelection = 0x240; // CPerParticleFloatInput
                constexpr std::ptrdiff_t m_flAnimationTimeScale = 0x3A8; // float32
                constexpr std::ptrdiff_t m_bOrientToNormal = 0x3AC; // bool
                constexpr std::ptrdiff_t m_MaterialVars = 0x3B0; // CUtlVector<MaterialVariable_t>
                constexpr std::ptrdiff_t m_flRadiusScale = 0x3C8; // CParticleCollectionFloatInput
                constexpr std::ptrdiff_t m_flAlphaScale = 0x530; // CParticleCollectionFloatInput
                constexpr std::ptrdiff_t m_flRollScale = 0x698; // CParticleCollectionFloatInput
                constexpr std::ptrdiff_t m_nAlpha2Field = 0x800; // ParticleAttributeIndex_t
                constexpr std::ptrdiff_t m_vecColorScale = 0x808; // CParticleCollectionVecInput
                constexpr std::ptrdiff_t m_nColorBlendType = 0xE98; // ParticleColorBlendType_t
            }
            // Parent: None
            // Fields count: 2
            //
            ...
            namespace C_OP_MaxVelocity {
                constexpr std::ptrdiff_t m_flMaxVelocity = 0x1D0; // CPerParticleFloatInput
                constexpr std::ptrdiff_t m_flMinVelocity = 0x338; // CPerParticleFloatInput
            }
            // Parent: None
            // Fields count: 3
            //
            ...
            namespace C_INIT_VelocityFromNormal {
                constexpr std::ptrdiff_t m_fSpeedMin = 0x1D4; // float32
                constexpr std::ptrdiff_t m_fSpeedMax = 0x1D8; // float32
                constexpr std::ptrdiff_t m_bIgnoreDt = 0x1DC; // bool
            }
            // Parent: None
            // Fields count: 9
            //
            ...
            namespace C_OP_MaintainEmitter {
                ...
                constexpr std::ptrdiff_t m_flStartTime = 0x340; // float32
                constexpr std::ptrdiff_t m_flEmissionDuration = 0x348; // CParticleCollectionFloatInput
                constexpr std::ptrdiff_t m_flEmissionRate = 0x4B0; // float32
                constexpr std::ptrdiff_t m_nSnapshotControlPoint = 0x4B4; // int32
                constexpr std::ptrdiff_t m_strSnapshotSubset = 0x4B8; // CUtlString
                constexpr std::ptrdiff_t m_bEmitInstantaneously = 0x4C0; // bool
                constexpr std::ptrdiff_t m_bFinalEmitOnStop = 0x4C1; // bool
                constexpr std::ptrdiff_t m_flScale = 0x4C8; // CParticleCollectionFloatInput
            }
            // Parent: None
            // Fields count: 3
            //
            ...
            namespace C_INIT_PositionOffsetToCP {
                constexpr std::ptrdiff_t m_nControlPointNumberStart = 0x1D4; // int32
                constexpr std::ptrdiff_t m_nControlPointNumberEnd = 0x1D8; // int32
            ...
            namespace C_INIT_RemapInitialTransformDirectionToRotation {
                constexpr std::ptrdiff_t m_TransformInput = 0x1D8; // CParticleTransformInput
                constexpr std::ptrdiff_t m_nFieldOutput = 0x238; // ParticleAttributeIndex_t
                constexpr std::ptrdiff_t m_flOffsetRot = 0x23C; // float32
                constexpr std::ptrdiff_t m_nComponent = 0x240; // int32
            }
            // Parent: None
            // Fields count: 7
            //
            ...
            namespace C_OP_SetControlPointFromObjectScale {
                constexpr std::ptrdiff_t m_nCPInput = 0x1D4; // int32
                constexpr std::ptrdiff_t m_nCPOutput = 0x1D8; // int32
            }
            // Parent: None
            // Fields count: 7
            ...
            namespace C_OP_StopAfterCPDuration {
                ...
                constexpr std::ptrdiff_t m_bDestroyImmediately = 0x340; // bool
                constexpr std::ptrdiff_t m_bPlayEndCap = 0x341; // bool
            }
            // Parent: None
            // Fields count: 3
            //
            ...
            namespace C_OP_ClampVector {
                ...
                constexpr std::ptrdiff_t m_vecOutputMax = 0x868; // CPerParticleVecInput
            }
            // Parent: None
            // Fields count: 6
            //
            ...
            namespace C_OP_WindForce {
                constexpr std::ptrdiff_t m_vForce = 0x1DC; // Vector
            }
            // Parent: None
            // Fields count: 6
            //
            ...
            namespace C_OP_SetVariable {
                ...
                constexpr std::ptrdiff_t m_transformInput = 0x228; // CParticleTransformInput
                constexpr std::ptrdiff_t m_positionOffset = 0x288; // Vector
                constexpr std::ptrdiff_t m_rotationOffset = 0x294; // QAngle
                constexpr std::ptrdiff_t m_vecInput = 0x2A0; // CParticleCollectionVecInput
                constexpr std::ptrdiff_t m_floatInput = 0x930; // CParticleCollectionFloatInput
            }
            // Parent: None
            // Fields count: 34
            //
            ...
            namespace C_OP_RenderStandardLight {
                constexpr std::ptrdiff_t m_nLightType = 0x21C; // ParticleLightTypeChoiceList_t
                constexpr std::ptrdiff_t m_nMaxAllowed = 0x220; // uint16
                constexpr std::ptrdiff_t m_vecColorScale = 0x228; // CParticleCollectionVecInput
                constexpr std::ptrdiff_t m_nColorBlendType = 0x8B8; // ParticleColorBlendType_t
                constexpr std::ptrdiff_t m_strLightStyle = 0x8C0; // CUtlString
                constexpr std::ptrdiff_t m_flLightStyleTime = 0x8C8; // CPerParticleFloatInput
                constexpr std::ptrdiff_t m_flIntensity = 0xA30; // CPerParticleFloatInput
                constexpr std::ptrdiff_t m_bCastShadows = 0xB98; // bool
                constexpr std::ptrdiff_t m_bDynamicBounce = 0xB99; // bool
                constexpr std::ptrdiff_t m_flBounceScale = 0xBA0; // CParticleCollectionFloatInput
                constexpr std::ptrdiff_t m_flTheta = 0xD08; // CParticleCollectionFloatInput
                constexpr std::ptrdiff_t m_flPhi = 0xE70; // CParticleCollectionFloatInput
                constexpr std::ptrdiff_t m_flRadiusMultiplier = 0xFD8; // CParticleCollectionFloatInput
                constexpr std::ptrdiff_t m_nAttenuationStyle = 0x1140; // StandardLightingAttenuationStyle_t
                constexpr std::ptrdiff_t m_flFalloffLinearity = 0x1148; // CParticleCollectionFloatInput
                constexpr std::ptrdiff_t m_flFiftyPercentFalloff = 0x12B0; // CParticleCollectionFloatInput
                constexpr std::ptrdiff_t m_flZeroPercentFalloff = 0x1418; // CParticleCollectionFloatInput
                constexpr std::ptrdiff_t m_bRenderDiffuse = 0x1580; // bool
                constexpr std::ptrdiff_t m_bRenderSpecular = 0x1581; // bool
                constexpr std::ptrdiff_t m_lightCookie = 0x1588; // CUtlString
                constexpr std::ptrdiff_t m_nPriority = 0x1590; // int32
                constexpr std::ptrdiff_t m_nFogLightingMode = 0x1594; // ParticleLightFogLightingMode_t
                constexpr std::ptrdiff_t m_flFogContribution = 0x1598; // CParticleCollectionRendererFloatInput
                constexpr std::ptrdiff_t m_nCapsuleLightBehavior = 0x1700; // ParticleLightBehaviorChoiceList_t
                constexpr std::ptrdiff_t m_flCapsuleLength = 0x1704; // float32
                constexpr std::ptrdiff_t m_bReverseOrder = 0x1708; // bool
                constexpr std::ptrdiff_t m_bClosedLoop = 0x1709; // bool
                constexpr std::ptrdiff_t m_nPrevPntSource = 0x170C; // ParticleAttributeIndex_t
                constexpr std::ptrdiff_t m_flMaxLength = 0x1710; // float32
                constexpr std::ptrdiff_t m_flMinLength = 0x1714; // float32
                constexpr std::ptrdiff_t m_bIgnoreDT = 0x1718; // bool
                constexpr std::ptrdiff_t m_flConstrainRadiusToLengthRatio = 0x171C; // float32
                constexpr std::ptrdiff_t m_flLengthScale = 0x1720; // float32
                constexpr std::ptrdiff_t m_flLengthFadeInTime = 0x1724; // float32
            }
            // Parent: None
            // Fields count: 15
            //
            ...
            namespace C_OP_DistanceToTransform {
                ...
                constexpr std::ptrdiff_t m_flOutputMax = 0x610; // CPerParticleFloatInput
                constexpr std::ptrdiff_t m_TransformStart = 0x778; // CParticleTransformInput
                constexpr std::ptrdiff_t m_bLOS = 0x7D8; // bool
                constexpr std::ptrdiff_t m_CollisionGroupName = 0x7D9; // char[128]
                constexpr std::ptrdiff_t m_nTraceSet = 0x85C; // ParticleTraceSet_t
                constexpr std::ptrdiff_t m_flMaxTraceLength = 0x860; // float32
                constexpr std::ptrdiff_t m_flLOSScale = 0x864; // float32
                ...
                constexpr std::ptrdiff_t m_vecComponentScale = 0x870; // CPerParticleVecInput
            }
            // Parent: None
            // Fields count: 4
            //
            ...
            namespace C_OP_SetControlPointToCenter {
                constexpr std::ptrdiff_t m_nCP1 = 0x1D4; // int32
                constexpr std::ptrdiff_t m_vecCP1Pos = 0x1D8; // Vector
                constexpr std::ptrdiff_t m_bUseAvgParticlePos = 0x1E4; // bool
                constexpr std::ptrdiff_t m_nSetParent = 0x1E8; // ParticleParentSetMode_t
            }
            // Parent: None
            // Fields count: 6
            ...
            namespace C_OP_RemapAverageScalarValuetoCP {
                constexpr std::ptrdiff_t m_nExpression = 0x1D4; // SetStatisticExpressionType_t
                constexpr std::ptrdiff_t m_flDecimalPlaces = 0x1D8; // CParticleCollectionFloatInput
                constexpr std::ptrdiff_t m_nOutControlPointNumber = 0x340; // int32
                constexpr std::ptrdiff_t m_nOutVectorField = 0x344; // int32
                constexpr std::ptrdiff_t m_nField = 0x348; // ParticleAttributeIndex_t
            ...
            namespace C_OP_RemapCPtoCP {
                constexpr std::ptrdiff_t m_nInputControlPoint = 0x1D4; // int32
                constexpr std::ptrdiff_t m_nOutputControlPoint = 0x1D8; // int32
                constexpr std::ptrdiff_t m_nInputField = 0x1DC; // int32
                constexpr std::ptrdiff_t m_nOutputField = 0x1E0; // int32
                ...
                constexpr std::ptrdiff_t m_bDerivative = 0x1F4; // bool
                constexpr std::ptrdiff_t m_flInterpRate = 0x1F8; // float32
            }
            // Parent: None
            // Fields count: 4
            //
            ...
            namespace C_OP_SetControlPointRotation {
                ...
                constexpr std::ptrdiff_t m_flRotRate = 0x868; // CParticleCollectionFloatInput
                constexpr std::ptrdiff_t m_nCP = 0x9D0; // int32
                constexpr std::ptrdiff_t m_nLocalCP = 0x9D4; // int32
            }
            // Parent: None
            // Fields count: 7
            //
            ...
            namespace C_OP_CurlNoiseForce {
                constexpr std::ptrdiff_t m_nNoiseType = 0x1DC; // ParticleDirectionNoiseType_t
                constexpr std::ptrdiff_t m_vecNoiseFreq = 0x1E0; // CPerParticleVecInput
                constexpr std::ptrdiff_t m_vecNoiseScale = 0x870; // CPerParticleVecInput
                constexpr std::ptrdiff_t m_vecOffset = 0xF00; // CPerParticleVecInput
                constexpr std::ptrdiff_t m_vecOffsetRate = 0x1590; // CPerParticleVecInput
                constexpr std::ptrdiff_t m_flWorleySeed = 0x1C20; // CPerParticleFloatInput
                constexpr std::ptrdiff_t m_flWorleyJitter = 0x1D88; // CPerParticleFloatInput
            }
            // Parent: None
            // Fields count: 3
            //
            ...
            namespace C_INIT_Orient2DRelToCP {
                constexpr std::ptrdiff_t m_nCP = 0x1D4; // int32
                constexpr std::ptrdiff_t m_nFieldOutput = 0x1D8; // ParticleAttributeIndex_t
                constexpr std::ptrdiff_t m_flRotOffset = 0x1DC; // float32
            }
            // Parent: None
            // Fields count: 1
            //
            ...
            namespace C_OP_RenderScreenShake {
                constexpr std::ptrdiff_t m_flDurationScale = 0x21C; // float32
                constexpr std::ptrdiff_t m_flRadiusScale = 0x220; // float32
                constexpr std::ptrdiff_t m_flFrequencyScale = 0x224; // float32
                constexpr std::ptrdiff_t m_flAmplitudeScale = 0x228; // float32
                constexpr std::ptrdiff_t m_nRadiusField = 0x22C; // ParticleAttributeIndex_t
                constexpr std::ptrdiff_t m_nDurationField = 0x230; // ParticleAttributeIndex_t
                constexpr std::ptrdiff_t m_nFrequencyField = 0x234; // ParticleAttributeIndex_t
                constexpr std::ptrdiff_t m_nAmplitudeField = 0x238; // ParticleAttributeIndex_t
                constexpr std::ptrdiff_t m_nFilterCP = 0x23C; // int32
            }
            // Parent: None
            // Fields count: 5
            //
            ...
            namespace C_OP_HSVShiftToCP {
                constexpr std::ptrdiff_t m_nColorCP = 0x1D4; // int32
                constexpr std::ptrdiff_t m_nColorGemEnableCP = 0x1D8; // int32
                constexpr std::ptrdiff_t m_nOutputCP = 0x1DC; // int32
                constexpr std::ptrdiff_t m_DefaultHSVColor = 0x1E0; // Color
            }
            // Parent: None
            // Fields count: 2
            //
            ...
            namespace C_OP_RemapVectorToRotations {
                constexpr std::ptrdiff_t m_vecInput = 0x1D0; // CPerParticleVecInput
                constexpr std::ptrdiff_t m_vecRotation = 0x860; // CPerParticleVecInput
            }
            // Parent: None
            // Fields count: 6
            //
            ...
            namespace C_INIT_GlobalScale {
                constexpr std::ptrdiff_t m_flScale = 0x1D4; // float32
                constexpr std::ptrdiff_t m_nScaleControlPointNumber = 0x1D8; // int32
                constexpr std::ptrdiff_t m_nControlPointNumber = 0x1DC; // int32
                constexpr std::ptrdiff_t m_bScaleRadius = 0x1E0; // bool
                constexpr std::ptrdiff_t m_bScalePosition = 0x1E1; // bool
                constexpr std::ptrdiff_t m_bScaleVelocity = 0x1E2; // bool
            }
            // Parent: None
            // Fields count: 1
            //
            ...
            namespace C_INIT_InitialVelocityFromHitbox {
                constexpr std::ptrdiff_t m_flVelocityMin = 0x1D4; // float32
                constexpr std::ptrdiff_t m_flVelocityMax = 0x1D8; // float32
                constexpr std::ptrdiff_t m_nControlPointNumber = 0x1DC; // int32
                constexpr std::ptrdiff_t m_HitboxSetName = 0x1E0; // char[128]
                constexpr std::ptrdiff_t m_bUseBones = 0x260; // bool
            }
            // Parent: None
            // Fields count: 5
            //
            ...
            namespace C_OP_TimeVaryingForce {
                constexpr std::ptrdiff_t m_flStartLerpTime = 0x1DC; // float32
                constexpr std::ptrdiff_t m_StartingForce = 0x1E0; // Vector
                constexpr std::ptrdiff_t m_flEndLerpTime = 0x1EC; // float32
                constexpr std::ptrdiff_t m_EndingForce = 0x1F0; // Vector
            }
            // Parent: None
            // Fields count: 9
            //
            ...
            namespace C_INIT_CreateWithinSphereTransform {
                constexpr std::ptrdiff_t m_fRadiusMin = 0x1D8; // CPerParticleFloatInput
                constexpr std::ptrdiff_t m_fRadiusMax = 0x340; // CPerParticleFloatInput
                constexpr std::ptrdiff_t m_vecDistanceBias = 0x4A8; // CPerParticleVecInput
                constexpr std::ptrdiff_t m_vecDistanceBiasAbs = 0xB38; // Vector
                constexpr std::ptrdiff_t m_TransformInput = 0xB48; // CParticleTransformInput
                constexpr std::ptrdiff_t m_fSpeedMin = 0xBA8; // CPerParticleFloatInput
                constexpr std::ptrdiff_t m_fSpeedMax = 0xD10; // CPerParticleFloatInput
                constexpr std::ptrdiff_t m_fSpeedRandExp = 0xE78; // float32
                constexpr std::ptrdiff_t m_bLocalCoords = 0xE7C; // bool
                constexpr std::ptrdiff_t m_LocalCoordinateSystemSpeedMin = 0xE80; // CPerParticleVecInput
                constexpr std::ptrdiff_t m_LocalCoordinateSystemSpeedMax = 0x1510; // CPerParticleVecInput
                constexpr std::ptrdiff_t m_nFieldOutput = 0x1BA0; // ParticleAttributeIndex_t
                constexpr std::ptrdiff_t m_nFieldVelocity = 0x1BA4; // ParticleAttributeIndex_t
            }
            // Parent: None
            // Fields count: 1
            //
            ...
            namespace C_INIT_RemapScalarToVector {
                ...
                constexpr std::ptrdiff_t m_nControlPointNumber = 0x208; // int32
                constexpr std::ptrdiff_t m_bLocalCoords = 0x20C; // bool
                constexpr std::ptrdiff_t m_flRemapBias = 0x210; // float32
            }
            // Parent: None
            // Fields count: 8
            //
            ...
            namespace C_INIT_InitialSequenceFromModel {
                constexpr std::ptrdiff_t m_nControlPointNumber = 0x1D4; // int32
                constexpr std::ptrdiff_t m_nFieldOutput = 0x1D8; // ParticleAttributeIndex_t
                constexpr std::ptrdiff_t m_nFieldOutputAnim = 0x1DC; // ParticleAttributeIndex_t
                constexpr std::ptrdiff_t m_flInputMin = 0x1E0; // float32
                constexpr std::ptrdiff_t m_flInputMax = 0x1E4; // float32
                constexpr std::ptrdiff_t m_flOutputMin = 0x1E8; // float32
                constexpr std::ptrdiff_t m_flOutputMax = 0x1EC; // float32
            ...
            namespace C_OP_NoiseEmitter {
                constexpr std::ptrdiff_t m_flEmissionDuration = 0x1D4; // float32
                constexpr std::ptrdiff_t m_flStartTime = 0x1D8; // float32
                constexpr std::ptrdiff_t m_flEmissionScale = 0x1DC; // float32
                constexpr std::ptrdiff_t m_nScaleControlPoint = 0x1E0; // int32
                constexpr std::ptrdiff_t m_nScaleControlPointField = 0x1E4; // int32
                constexpr std::ptrdiff_t m_nWorldNoisePoint = 0x1E8; // int32
                ...
                constexpr std::ptrdiff_t m_flWorldNoiseScale = 0x200; // float32
            ...
            namespace C_OP_SelectivelyEnableChildren {
                ...
                constexpr std::ptrdiff_t m_nFirstChild = 0x340; // CParticleCollectionFloatInput
                constexpr std::ptrdiff_t m_nNumChildrenToEnable = 0x4A8; // CParticleCollectionFloatInput
                constexpr std::ptrdiff_t m_bPlayEndcapOnStop = 0x610; // bool
                constexpr std::ptrdiff_t m_bDestroyImmediately = 0x611; // bool
            }
            // Parent: None
            // Fields count: 2
            //
            ...
            namespace C_OP_PlanarConstraint {
                ...
                constexpr std::ptrdiff_t m_flMaximumDistanceToCP = 0x358; // CParticleCollectionFloatInput
                constexpr std::ptrdiff_t m_bUseOldCode = 0x4C0; // bool
            }
            // Parent: None
            // Fields count: 4
            //
            ...
            namespace C_INIT_CreateFromCPs {
                ...
                constexpr std::ptrdiff_t m_nMinCP = 0x1D8; // int32
                constexpr std::ptrdiff_t m_nMaxCP = 0x1DC; // int32
                constexpr std::ptrdiff_t m_nDynamicCPCount = 0x1E0; // CParticleCollectionFloatInput
            }
            // Parent: None
            // Fields count: 6
            //
            ...
            namespace C_INIT_CreateSpiralSphere {
                constexpr std::ptrdiff_t m_TransformInput = 0x1D8; // CParticleTransformInput
                constexpr std::ptrdiff_t m_flDensity = 0x238; // CPerParticleFloatInput
                constexpr std::ptrdiff_t m_flInitialRadius = 0x3A0; // CPerParticleFloatInput
                constexpr std::ptrdiff_t m_flInitialSpeedMin = 0x508; // CPerParticleFloatInput
                constexpr std::ptrdiff_t m_flInitialSpeedMax = 0x670; // CPerParticleFloatInput
                constexpr std::ptrdiff_t m_bUseParticleCount = 0x7D8; // bool
            }
            // Parent: None
            // Fields count: 2
            //
            ...
            namespace C_OP_LerpToOtherAttribute {
                ...
                constexpr std::ptrdiff_t m_nFieldInputFrom = 0x338; // ParticleAttributeIndex_t
                constexpr std::ptrdiff_t m_nFieldInput = 0x33C; // ParticleAttributeIndex_t
                constexpr std::ptrdiff_t m_nFieldOutput = 0x340; // ParticleAttributeIndex_t
            }
            // Parent: None
            // Fields count: 10
            ...
            namespace C_INIT_RandomColor {
                ...
                constexpr std::ptrdiff_t m_flUpdateThreshold = 0x204; // float32
                constexpr std::ptrdiff_t m_nTintCP = 0x208; // int32
                constexpr std::ptrdiff_t m_nFieldOutput = 0x20C; // ParticleAttributeIndex_t
                constexpr std::ptrdiff_t m_nTintBlendMode = 0x210; // ParticleColorBlendMode_t
                constexpr std::ptrdiff_t m_flLightAmplification = 0x214; // float32
            }
            // Parent: None
            // Fields count: 6
            //
            ...
            namespace C_OP_SetGravityToCP {
                ...
                constexpr std::ptrdiff_t m_bSetPosition = 0x348; // bool
                constexpr std::ptrdiff_t m_bSetOrientation = 0x349; // bool
                constexpr std::ptrdiff_t m_bSetZDown = 0x34A; // bool
            }
            // Parent: None
            // Fields count: 12
            //
            ...
            namespace C_INIT_RemapParticleCountToScalar {
                constexpr std::ptrdiff_t m_nFieldOutput = 0x1D4; // ParticleAttributeIndex_t
                constexpr std::ptrdiff_t m_nInputMin = 0x1D8; // int32
                constexpr std::ptrdiff_t m_nInputMax = 0x1DC; // int32
                constexpr std::ptrdiff_t m_nScaleControlPoint = 0x1E0; // int32
                constexpr std::ptrdiff_t m_nScaleControlPointField = 0x1E4; // int32
                constexpr std::ptrdiff_t m_flOutputMin = 0x1E8; // float32
                constexpr std::ptrdiff_t m_flOutputMax = 0x1EC; // float32
                constexpr std::ptrdiff_t m_nSetMethod = 0x1F0; // ParticleSetMethod_t
                constexpr std::ptrdiff_t m_bActiveRange = 0x1F4; // bool
                constexpr std::ptrdiff_t m_bInvert = 0x1F5; // bool
                constexpr std::ptrdiff_t m_bWrap = 0x1F6; // bool
            ...
            namespace C_INIT_InheritFromParentParticles {
                constexpr std::ptrdiff_t m_flScale = 0x1D4; // float32
                constexpr std::ptrdiff_t m_nFieldOutput = 0x1D8; // ParticleAttributeIndex_t
                constexpr std::ptrdiff_t m_nIncrement = 0x1DC; // int32
            ...
            namespace C_INIT_ChaoticAttractor {
                constexpr std::ptrdiff_t m_flAParm = 0x1D4; // float32
                constexpr std::ptrdiff_t m_flBParm = 0x1D8; // float32
                constexpr std::ptrdiff_t m_flCParm = 0x1DC; // float32
                constexpr std::ptrdiff_t m_flDParm = 0x1E0; // float32
                constexpr std::ptrdiff_t m_flScale = 0x1E4; // float32
                constexpr std::ptrdiff_t m_flSpeedMin = 0x1E8; // float32
                constexpr std::ptrdiff_t m_flSpeedMax = 0x1EC; // float32
                constexpr std::ptrdiff_t m_nBaseCP = 0x1F0; // int32
                constexpr std::ptrdiff_t m_bUniformSpeed = 0x1F4; // bool
            }
            // Parent: None
            // Fields count: 6
            //
            ...
            namespace C_OP_RenderFlattenGrass {
                constexpr std::ptrdiff_t m_flFlattenStrength = 0x21C; // float32
                constexpr std::ptrdiff_t m_nStrengthFieldOverride = 0x220; // ParticleAttributeIndex_t
            ...
            namespace C_OP_RenderLightBeam {
                constexpr std::ptrdiff_t m_nMaxAllowed = 0x21A; // uint16
                ...
                constexpr std::ptrdiff_t m_strLightStyle = 0x8B8; // CUtlString
                constexpr std::ptrdiff_t m_flLightStyleTime = 0x8C0; // CPerParticleFloatInput
                constexpr std::ptrdiff_t m_flBrightnessLumensPerMeter = 0xA28; // CParticleCollectionFloatInput
                constexpr std::ptrdiff_t m_flNumberOfLightsToCreate = 0xB90; // CParticleCollectionFloatInput
                constexpr std::ptrdiff_t m_bCastShadows = 0xCF8; // bool
                constexpr std::ptrdiff_t m_bDynamicBounce = 0xCF9; // bool
                constexpr std::ptrdiff_t m_flBounceScale = 0xD00; // CParticleCollectionFloatInput
                constexpr std::ptrdiff_t m_flSkirt = 0xE68; // CParticleCollectionFloatInput
                constexpr std::ptrdiff_t m_flRange = 0xFD0; // CParticleCollectionFloatInput
                constexpr std::ptrdiff_t m_flThickness = 0x1138; // CParticleCollectionFloatInput
                constexpr std::ptrdiff_t m_flInnerConeAngle = 0x12A0; // CParticleCollectionFloatInput
                constexpr std::ptrdiff_t m_flOuterConeAngle = 0x1408; // CParticleCollectionFloatInput
                constexpr std::ptrdiff_t m_vecConeRotationOffset = 0x1570; // CParticleCollectionVecInput
                constexpr std::ptrdiff_t m_nFogLightingMode = 0x1C00; // ParticleLightFogLightingMode_t
                constexpr std::ptrdiff_t m_flFogContribution = 0x1C08; // CParticleCollectionRendererFloatInput
                constexpr std::ptrdiff_t m_flRenderFilter = 0x1D70; // CPerParticleFloatInput
                constexpr std::ptrdiff_t m_bDebugOrientation = 0x1ED8; // bool
            }
            // Parent: None
            // Fields count: 3
            //
            ...
            namespace C_INIT_SkyVisCull {
                constexpr std::ptrdiff_t m_vecTestDir = 0x1D8; // CParticleCollectionVecInput
                constexpr std::ptrdiff_t m_nTraceSet = 0x868; // ParticleTraceSet_t
                constexpr std::ptrdiff_t m_bCullOnSky = 0x86C; // bool
            }
            // Parent: None
            // Fields count: 6
            //
            ...
            namespace C_OP_EnableChildrenFromParentParticleCount {
                constexpr std::ptrdiff_t m_nChildGroupID = 0x1D4; // int32
                constexpr std::ptrdiff_t m_nFirstChild = 0x1D8; // int32
                constexpr std::ptrdiff_t m_nNumChildrenToEnable = 0x1E0; // CParticleCollectionFloatInput
                constexpr std::ptrdiff_t m_bDisableChildren = 0x348; // bool
                constexpr std::ptrdiff_t m_bPlayEndcapOnStop = 0x349; // bool
                constexpr std::ptrdiff_t m_bDestroyImmediately = 0x34A; // bool
            }
            // Parent: None
            // Fields count: 15
            //
            ...
            namespace C_INIT_DistanceToCPInit {
                ...
                constexpr std::ptrdiff_t m_flOutputMin = 0x4A8; // CPerParticleFloatInput
                constexpr std::ptrdiff_t m_flOutputMax = 0x610; // CPerParticleFloatInput
                constexpr std::ptrdiff_t m_nStartCP = 0x778; // int32
                constexpr std::ptrdiff_t m_bLOS = 0x77C; // bool
                constexpr std::ptrdiff_t m_CollisionGroupName = 0x77D; // char[128]
                constexpr std::ptrdiff_t m_nTraceSet = 0x800; // ParticleTraceSet_t
                constexpr std::ptrdiff_t m_flMaxTraceLength = 0x808; // CPerParticleFloatInput
                constexpr std::ptrdiff_t m_flLOSScale = 0x970; // float32
                constexpr std::ptrdiff_t m_nSetMethod = 0x974; // ParticleSetMethod_t
                constexpr std::ptrdiff_t m_bActiveRange = 0x978; // bool
                constexpr std::ptrdiff_t m_vecDistanceScale = 0x97C; // Vector
                constexpr std::ptrdiff_t m_flRemapBias = 0x988; // float32
            }
            // Parent: None
            // Fields count: 7
            //
            ...
            namespace C_OP_ForceBasedOnDistanceToPlane {
                constexpr std::ptrdiff_t m_flMinDist = 0x1DC; // float32
                constexpr std::ptrdiff_t m_vecForceAtMinDist = 0x1E0; // Vector
                constexpr std::ptrdiff_t m_flMaxDist = 0x1EC; // float32
                constexpr std::ptrdiff_t m_vecForceAtMaxDist = 0x1F0; // Vector
                constexpr std::ptrdiff_t m_vecPlaneNormal = 0x1FC; // Vector
                constexpr std::ptrdiff_t m_nControlPointNumber = 0x208; // int32
                constexpr std::ptrdiff_t m_flExponent = 0x20C; // float32
            }
            // Parent: None
            // Fields count: 8
            //
            ...
            namespace C_OP_RenderModels {
                constexpr std::ptrdiff_t m_bOnlyRenderInEffectsBloomPass = 0x21A; // bool
                constexpr std::ptrdiff_t m_bOnlyRenderInEffectsWaterPass = 0x21B; // bool
                constexpr std::ptrdiff_t m_bUseMixedResolutionRendering = 0x21C; // bool
                constexpr std::ptrdiff_t m_bOnlyRenderInEffecsGameOverlay = 0x21D; // bool
                constexpr std::ptrdiff_t m_ModelList = 0x220; // CUtlVector<ModelReference_t>
                constexpr std::ptrdiff_t m_nBodyGroupField = 0x238; // ParticleAttributeIndex_t
                constexpr std::ptrdiff_t m_nSubModelField = 0x23C; // ParticleAttributeIndex_t
                constexpr std::ptrdiff_t m_bIgnoreNormal = 0x240; // bool
                constexpr std::ptrdiff_t m_bOrientZ = 0x241; // bool
                constexpr std::ptrdiff_t m_bCenterOffset = 0x242; // bool
                constexpr std::ptrdiff_t m_vecLocalOffset = 0x248; // CPerParticleVecInput
                constexpr std::ptrdiff_t m_vecLocalRotation = 0x8D8; // CPerParticleVecInput
                constexpr std::ptrdiff_t m_bIgnoreRadius = 0xF68; // bool
                constexpr std::ptrdiff_t m_nModelScaleCP = 0xF6C; // int32
                constexpr std::ptrdiff_t m_vecComponentScale = 0xF70; // CPerParticleVecInput
                constexpr std::ptrdiff_t m_bLocalScale = 0x1600; // bool
                constexpr std::ptrdiff_t m_nSizeCullBloat = 0x1604; // int32
                constexpr std::ptrdiff_t m_bAnimated = 0x1608; // bool
                constexpr std::ptrdiff_t m_flAnimationRate = 0x1610; // CPerParticleFloatInput
                constexpr std::ptrdiff_t m_bScaleAnimationRate = 0x1778; // bool
                constexpr std::ptrdiff_t m_bForceLoopingAnimation = 0x1779; // bool
                constexpr std::ptrdiff_t m_bResetAnimOnStop = 0x177A; // bool
                constexpr std::ptrdiff_t m_bManualAnimFrame = 0x177B; // bool
                constexpr std::ptrdiff_t m_nAnimationScaleField = 0x177C; // ParticleAttributeIndex_t
                constexpr std::ptrdiff_t m_nAnimationField = 0x1780; // ParticleAttributeIndex_t
                constexpr std::ptrdiff_t m_nManualFrameField = 0x1784; // ParticleAttributeIndex_t
                constexpr std::ptrdiff_t m_ActivityName = 0x1788; // char[256]
                constexpr std::ptrdiff_t m_SequenceName = 0x1888; // char[256]
                constexpr std::ptrdiff_t m_bEnableClothSimulation = 0x1988; // bool
                constexpr std::ptrdiff_t m_bDisableClothGroundCollision = 0x1989; // bool
                constexpr std::ptrdiff_t m_ClothEffectName = 0x198A; // char[64]
                constexpr std::ptrdiff_t m_hOverrideMaterial = 0x19D0; // CStrongHandle<InfoForResourceTypeIMaterial2>
                constexpr std::ptrdiff_t m_bOverrideTranslucentMaterials = 0x19D8; // bool
                constexpr std::ptrdiff_t m_nSkin = 0x19E0; // CPerParticleFloatInput
                constexpr std::ptrdiff_t m_MaterialVars = 0x1B48; // CUtlVector<MaterialVariable_t>
                constexpr std::ptrdiff_t m_flRenderFilter = 0x1B60; // CPerParticleFloatInput
                constexpr std::ptrdiff_t m_flManualModelSelection = 0x1CC8; // CPerParticleFloatInput
                constexpr std::ptrdiff_t m_modelInput = 0x1E30; // CParticleModelInput
                constexpr std::ptrdiff_t m_nLOD = 0x1E88; // int32
                constexpr std::ptrdiff_t m_EconSlotName = 0x1E8C; // char[256]
                constexpr std::ptrdiff_t m_bOriginalModel = 0x1F8C; // bool
                constexpr std::ptrdiff_t m_bSuppressTint = 0x1F8D; // bool
                constexpr std::ptrdiff_t m_nSubModelFieldType = 0x1F90; // RenderModelSubModelFieldType_t
                constexpr std::ptrdiff_t m_bDisableShadows = 0x1F94; // bool
                constexpr std::ptrdiff_t m_bDisableDepthPrepass = 0x1F95; // bool
                constexpr std::ptrdiff_t m_bAcceptsDecals = 0x1F96; // bool
                constexpr std::ptrdiff_t m_bForceDrawInterlevedWithSiblings = 0x1F97; // bool
                constexpr std::ptrdiff_t m_bDoNotDrawInParticlePass = 0x1F98; // bool
                constexpr std::ptrdiff_t m_bAllowApproximateTransforms = 0x1F99; // bool
                constexpr std::ptrdiff_t m_szRenderAttribute = 0x1F9A; // char[4096]
                constexpr std::ptrdiff_t m_flRadiusScale = 0x2FA0; // CParticleCollectionFloatInput
                constexpr std::ptrdiff_t m_flAlphaScale = 0x3108; // CParticleCollectionFloatInput
                constexpr std::ptrdiff_t m_flRollScale = 0x3270; // CParticleCollectionFloatInput
                constexpr std::ptrdiff_t m_nAlpha2Field = 0x33D8; // ParticleAttributeIndex_t
                constexpr std::ptrdiff_t m_vecColorScale = 0x33E0; // CParticleCollectionVecInput
                constexpr std::ptrdiff_t m_nColorBlendType = 0x3A70; // ParticleColorBlendType_t
                constexpr std::ptrdiff_t m_strLightStyle = 0x3A78; // CUtlString
                constexpr std::ptrdiff_t m_flLightStyleTime = 0x3A80; // CPerParticleFloatInput
            }
            // Parent: None
            // Fields count: 3
            //
            ...
            namespace C_OP_RenderClientPhysicsImpulse {
                ...
                constexpr std::ptrdiff_t m_flMagnitude = 0x388; // CPerParticleFloatInput
                constexpr std::ptrdiff_t m_nSimIdFilter = 0x4F0; // int32
            }
            // Parent: None
            // Fields count: 1
            //
            ...
            namespace C_OP_RopeSpringConstraint {
                ...
                constexpr std::ptrdiff_t m_flMinDistance = 0x338; // CParticleCollectionFloatInput
                constexpr std::ptrdiff_t m_flMaxDistance = 0x4A0; // CParticleCollectionFloatInput
                constexpr std::ptrdiff_t m_flAdjustmentScale = 0x608; // float32
                constexpr std::ptrdiff_t m_flInitialRestingLength = 0x610; // CParticleCollectionFloatInput
            }
            // Parent: None
            // Fields count: 6
            //
            ...
            namespace C_INIT_PositionWarpScalar {
                constexpr std::ptrdiff_t m_vecWarpMin = 0x1D4; // Vector
                constexpr std::ptrdiff_t m_vecWarpMax = 0x1E0; // Vector
                constexpr std::ptrdiff_t m_InputValue = 0x1F0; // CPerParticleFloatInput
                constexpr std::ptrdiff_t m_flPrevPosScale = 0x358; // float32
                constexpr std::ptrdiff_t m_nScaleControlPointNumber = 0x35C; // int32
                constexpr std::ptrdiff_t m_nControlPointNumber = 0x360; // int32
            }
            // Parent: None
            // Fields count: 1
            //
            ...
            namespace C_OP_ForceControlPointStub {
                constexpr std::ptrdiff_t m_ControlPoint = 0x1D4; // int32
            }
            // Parent: None
            // Fields count: 7
            //
            ...
            namespace C_OP_RemapParticleCountToScalar {
                ...
                constexpr std::ptrdiff_t m_nInputMax = 0x340; // CParticleCollectionFloatInput
                constexpr std::ptrdiff_t m_flOutputMin = 0x4A8; // CParticleCollectionFloatInput
                constexpr std::ptrdiff_t m_flOutputMax = 0x610; // CParticleCollectionFloatInput
                constexpr std::ptrdiff_t m_bActiveRange = 0x778; // bool
                constexpr std::ptrdiff_t m_nSetMethod = 0x77C; // ParticleSetMethod_t
            }
            // Parent: None
            // Fields count: 2
            //
            ...
            namespace C_OP_RemapModelVolumetoCP {
                constexpr std::ptrdiff_t m_nBBoxType = 0x1D4; // BBoxVolumeType_t
                constexpr std::ptrdiff_t m_nInControlPointNumber = 0x1D8; // int32
                constexpr std::ptrdiff_t m_nOutControlPointNumber = 0x1DC; // int32
                constexpr std::ptrdiff_t m_nOutControlPointMaxNumber = 0x1E0; // int32
                constexpr std::ptrdiff_t m_nField = 0x1E4; // int32
                constexpr std::ptrdiff_t m_flInputMin = 0x1E8; // float32
                constexpr std::ptrdiff_t m_flInputMax = 0x1EC; // float32
                constexpr std::ptrdiff_t m_flOutputMin = 0x1F0; // float32
                constexpr std::ptrdiff_t m_flOutputMax = 0x1F4; // float32
                constexpr std::ptrdiff_t m_bBBoxOnly = 0x1F8; // bool
                constexpr std::ptrdiff_t m_bCubeRoot = 0x1F9; // bool
            }
            // Parent: None
            // Fields count: 3
            //
            ...
            namespace C_OP_ParentVortices {
                constexpr std::ptrdiff_t m_flForceScale = 0x1DC; // float32
                constexpr std::ptrdiff_t m_vecTwistAxis = 0x1E0; // Vector
                constexpr std::ptrdiff_t m_bFlipBasedOnYaw = 0x1EC; // bool
            }
            // Parent: None
            // Fields count: 6
            //
            ...
            namespace C_OP_SetControlPointToCPVelocity {
                constexpr std::ptrdiff_t m_nCPInput = 0x1D4; // int32
                constexpr std::ptrdiff_t m_nCPOutputVel = 0x1D8; // int32
                constexpr std::ptrdiff_t m_bNormalize = 0x1DC; // bool
                constexpr std::ptrdiff_t m_nCPOutputMag = 0x1E0; // int32
            ...
            namespace C_OP_ClientPhysics {
                ...
                constexpr std::ptrdiff_t m_flVehicleWakeRadius = 0x398; // CParticleCollectionFloatInput
                constexpr std::ptrdiff_t m_bUseHighQualitySimulation = 0x500; // bool
                constexpr std::ptrdiff_t m_nMaxParticleCount = 0x504; // int32
                constexpr std::ptrdiff_t m_bRespectExclusionVolumes = 0x508; // bool
                constexpr std::ptrdiff_t m_bKillParticles = 0x509; // bool
                constexpr std::ptrdiff_t m_bDeleteSim = 0x50A; // bool
                constexpr std::ptrdiff_t m_nControlPoint = 0x50C; // int32
                constexpr std::ptrdiff_t m_nForcedSimId = 0x510; // int32
                constexpr std::ptrdiff_t m_nColorBlendType = 0x514; // ParticleColorBlendType_t
                constexpr std::ptrdiff_t m_nForcedStatusEffects = 0x518; // ParticleAttrBoxFlags_t
                constexpr std::ptrdiff_t m_nNoCollisionAttribute = 0x51C; // ParticleAttributeIndex_t
                constexpr std::ptrdiff_t m_nZeroGravityAttribute = 0x520; // ParticleAttributeIndex_t
            }
            // Parent: None
            // Fields count: 0
            //
            ...
            namespace C_OP_ExternalWindForce {
                ...
                constexpr std::ptrdiff_t m_vecScale = 0x870; // CPerParticleVecInput
                constexpr std::ptrdiff_t m_bSampleWind = 0xF00; // bool
                constexpr std::ptrdiff_t m_bSampleWater = 0xF01; // bool
                constexpr std::ptrdiff_t m_bDampenNearWaterPlane = 0xF02; // bool
                constexpr std::ptrdiff_t m_bSampleGravity = 0xF03; // bool
                constexpr std::ptrdiff_t m_vecGravityForce = 0xF08; // CPerParticleVecInput
                constexpr std::ptrdiff_t m_bUseBasicMovementGravity = 0x1598; // bool
                constexpr std::ptrdiff_t m_flLocalGravityScale = 0x15A0; // CPerParticleFloatInput
                constexpr std::ptrdiff_t m_flLocalBuoyancyScale = 0x1708; // CPerParticleFloatInput
                constexpr std::ptrdiff_t m_vecBuoyancyForce = 0x1870; // CPerParticleVecInput
            }
            // Parent: None
            // Fields count: 5
            //
            ...
            namespace C_INIT_ModelCull {
                constexpr std::ptrdiff_t m_nControlPointNumber = 0x1D4; // int32
                constexpr std::ptrdiff_t m_bBoundBox = 0x1D8; // bool
                constexpr std::ptrdiff_t m_bCullOutside = 0x1D9; // bool
                constexpr std::ptrdiff_t m_bUseBones = 0x1DA; // bool
                constexpr std::ptrdiff_t m_HitboxSetName = 0x1DB; // char[128]
            }
            // Parent: None
            // Fields count: 30
            //
            ...
            namespace C_OP_RenderSprites {
                constexpr std::ptrdiff_t m_nSequenceOverride = 0x2D00; // CParticleCollectionRendererFloatInput
                constexpr std::ptrdiff_t m_bSequenceNumbersAreRawSequenceIndices = 0x2E68; // bool
                constexpr std::ptrdiff_t m_nOrientationType = 0x2E6C; // ParticleOrientationChoiceList_t
                constexpr std::ptrdiff_t m_nOrientationControlPoint = 0x2E70; // int32
                constexpr std::ptrdiff_t m_bUseYawWithNormalAligned = 0x2E74; // bool
                constexpr std::ptrdiff_t m_flMinSize = 0x2E78; // CParticleCollectionRendererFloatInput
                constexpr std::ptrdiff_t m_flMaxSize = 0x2FE0; // CParticleCollectionRendererFloatInput
                constexpr std::ptrdiff_t m_flSubPixelAAScale = 0x3148; // CParticleCollectionRendererFloatInput
                constexpr std::ptrdiff_t m_flStartFadeSize = 0x32B0; // CParticleCollectionRendererFloatInput
                constexpr std::ptrdiff_t m_flEndFadeSize = 0x3418; // CParticleCollectionRendererFloatInput
                constexpr std::ptrdiff_t m_flStartFadeDot = 0x3580; // float32
                constexpr std::ptrdiff_t m_flEndFadeDot = 0x3584; // float32
                constexpr std::ptrdiff_t m_bDistanceAlpha = 0x3588; // bool
                constexpr std::ptrdiff_t m_bSoftEdges = 0x3589; // bool
                constexpr std::ptrdiff_t m_flEdgeSoftnessStart = 0x358C; // float32
                constexpr std::ptrdiff_t m_flEdgeSoftnessEnd = 0x3590; // float32
                constexpr std::ptrdiff_t m_bOutline = 0x3594; // bool
                constexpr std::ptrdiff_t m_OutlineColor = 0x3595; // Color
                constexpr std::ptrdiff_t m_nOutlineAlpha = 0x359C; // int32
                constexpr std::ptrdiff_t m_flOutlineStart0 = 0x35A0; // float32
                constexpr std::ptrdiff_t m_flOutlineStart1 = 0x35A4; // float32
                constexpr std::ptrdiff_t m_flOutlineEnd0 = 0x35A8; // float32
                constexpr std::ptrdiff_t m_flOutlineEnd1 = 0x35AC; // float32
                constexpr std::ptrdiff_t m_nLightingMode = 0x35B0; // ParticleLightingQuality_t
                constexpr std::ptrdiff_t m_vecLightingOverride = 0x35B8; // CParticleCollectionRendererVecInput
                constexpr std::ptrdiff_t m_flLightingTessellation = 0x3C48; // CParticleCollectionRendererFloatInput
                constexpr std::ptrdiff_t m_flLightingDirectionality = 0x3DB0; // CParticleCollectionRendererFloatInput
                constexpr std::ptrdiff_t m_bParticleShadows = 0x3F18; // bool
                constexpr std::ptrdiff_t m_flShadowDensity = 0x3F1C; // float32
                constexpr std::ptrdiff_t m_replicationParameters = 0x3F20; // CReplicationParameters
            }
            // Parent: None
            // Fields count: 12
            //
            ...
            namespace C_OP_SetPerChildControlPoint {
                ...
                constexpr std::ptrdiff_t m_nFirstSourcePoint = 0x348; // CParticleCollectionFloatInput
                constexpr std::ptrdiff_t m_bSetOrientation = 0x4B0; // bool
                constexpr std::ptrdiff_t m_nOrientationField = 0x4B4; // ParticleAttributeIndex_t
                constexpr std::ptrdiff_t m_bNumBasedOnParticleCount = 0x4B8; // bool
            }
            // Parent: None
            // Fields count: 10
            //
            ...
            namespace C_OP_RenderTreeShake {
                constexpr std::ptrdiff_t m_flPeakStrength = 0x21C; // float32
                constexpr std::ptrdiff_t m_nPeakStrengthFieldOverride = 0x220; // ParticleAttributeIndex_t
                constexpr std::ptrdiff_t m_flRadius = 0x224; // float32
                constexpr std::ptrdiff_t m_nRadiusFieldOverride = 0x228; // ParticleAttributeIndex_t
                constexpr std::ptrdiff_t m_flShakeDuration = 0x22C; // float32
                constexpr std::ptrdiff_t m_flTransitionTime = 0x230; // float32
                constexpr std::ptrdiff_t m_flTwistAmount = 0x234; // float32
                constexpr std::ptrdiff_t m_flRadialAmount = 0x238; // float32
                constexpr std::ptrdiff_t m_flControlPointOrientationAmount = 0x23C; // float32
                constexpr std::ptrdiff_t m_nControlPointForLinearDirection = 0x240; // int32
            }
            // Parent: None
            // Fields count: 0
            //
            ...
            namespace C_OP_RenderMaterialProxy {
                constexpr std::ptrdiff_t m_nMaterialControlPoint = 0x21C; // int32
                constexpr std::ptrdiff_t m_nProxyType = 0x220; // MaterialProxyType_t
                ...
                constexpr std::ptrdiff_t m_vecColorScale = 0x3B0; // CParticleCollectionVecInput
                constexpr std::ptrdiff_t m_flAlpha = 0xA40; // CPerParticleFloatInput
                constexpr std::ptrdiff_t m_nColorBlendType = 0xBA8; // ParticleColorBlendType_t
            }
            // Parent: None
            // Fields count: 2
            //
            ...
            namespace C_INIT_SequenceFromCP {
                constexpr std::ptrdiff_t m_bKillUnused = 0x1D4; // bool
                constexpr std::ptrdiff_t m_bRadiusScale = 0x1D5; // bool
                constexpr std::ptrdiff_t m_nCP = 0x1D8; // int32
