    ...
    namespace schemas {
        ...
        namespace animationsystem_dll {
            ...
            namespace CNmFrameSnapEvent {
                constexpr std::ptrdiff_t m_frameSnapMode = 0x10; // 
            }
            // Parent: None
            // Field count: 2
            //
            ...
            namespace CAimCameraUpdateNode {
                ...
                constexpr std::ptrdiff_t m_hParameterWeaponDepenetrationDistance = 0x72; // 
                constexpr std::ptrdiff_t m_hParameterCameraClearanceDistance = 0x74; // 
                constexpr std::ptrdiff_t m_opFixedSettings = 0x78; // 
            }
            // Parent: None
            // Field count: 11
            //
            ...
            namespace CNmStateMachineNode__StateDefinition_t {
                ...
                constexpr std::ptrdiff_t m_entryConditionNodeIdx = 0x2; // 
            ...
            namespace CNmTransitionNode__CDefinition {
                constexpr std::ptrdiff_t m_targetCNmStateNodeIdx = 0x10; // 
                constexpr std::ptrdiff_t m_durationOverrideNodeIdx = 0x12; // 
                ...
                constexpr std::ptrdiff_t m_targetSyncIDNodeIdx = 0x26; // 
                constexpr std::ptrdiff_t m_blendWeightEasing = 0x28; // 
                constexpr std::ptrdiff_t m_rootMotionBlend = 0x29; // 
            }
            // Parent: None
            // Field count: 7
            //
            ...
            namespace CMaterialDrawDescriptor {
                ...
                constexpr std::ptrdiff_t m_nFirstMeshlet = 0x18; // 
                constexpr std::ptrdiff_t m_nNumMeshlets = 0x1C; // 
            ...
            namespace CPhysSurfaceProperties {
                ...
                constexpr std::ptrdiff_t m_audioParams = 0xA0; // 
            }
            // Parent: CNmValueNode__CDefinition
            // Field count: 0
            ...
            namespace CNmStateNode__TimedEvent_t {
                constexpr std::ptrdiff_t m_ID = 0x0; // 
                constexpr std::ptrdiff_t m_timeValue = 0x8; // 
            }
            // Parent: CMotionMetricEvaluator
            // Field count: 2
            //
            ...
            namespace CNmTransitionEvent {
                constexpr std::ptrdiff_t m_rule = 0x10; // 
            ...
            namespace CRenderMesh {
                ...
                constexpr std::ptrdiff_t m_meshDeformParams = 0x1E0; // 
                constexpr std::ptrdiff_t m_pGroomData = 0x1F0; // 
            }
            // Parent: None
            // Field count: 8
            //
            ...
            namespace CNmIDEvent {
                constexpr std::ptrdiff_t m_ID = 0x10; // 
            }
            // Parent: None
            // Field count: 2
            //
            ...
            namespace CRenderGroom {
                ...
                constexpr std::ptrdiff_t m_hSimParamsMat = 0x20; // 
                constexpr std::ptrdiff_t m_nSegmentsPerHairStrand = 0x28; // 
                constexpr std::ptrdiff_t m_nGuideHairCount = 0x2C; // 
                constexpr std::ptrdiff_t m_nHairCount = 0x30; // 
                constexpr std::ptrdiff_t m_nGroomGroupID = 0x34; // 
                constexpr std::ptrdiff_t m_nAttachBoneIdx = 0x38; // 
                constexpr std::ptrdiff_t m_nAttachMeshIdx = 0x3C; // 
                constexpr std::ptrdiff_t m_nAttachMeshDrawCallIdx = 0x40; // 
                constexpr std::ptrdiff_t m_flSumOfAllHairLengths = 0x44; // 
                constexpr std::ptrdiff_t m_bEnableSimulation = 0x48; // 
            }
            // Parent: CBaseConstraint
            // Field count: 2
            //
            ...
            namespace CNmFootEvent {
                constexpr std::ptrdiff_t m_phase = 0x10; // 
            }
            // Parent: None
            // Field count: 8
            //
