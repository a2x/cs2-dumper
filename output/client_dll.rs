    ...
    pub mod schemas {
        ...
        pub mod client_dll {
            ...
            pub mod CCSPlayer_MovementServices {
                ...
                pub const m_nOldWaterLevel: usize = 0x47C; // 
                pub const m_flWaterEntryTime: usize = 0x480; // 
                pub const m_vecForward: usize = 0x484; // 
                pub const m_vecLeft: usize = 0x490; // 
                pub const m_vecUp: usize = 0x49C; // 
                pub const m_nGameCodeHasMovedPlayerAfterCommand: usize = 0x4A8; // 
                ...
                pub const m_flStamina: usize = 0x4D0; // 
                pub const m_flHeightAtJumpStart: usize = 0x4D4; // 
                pub const m_flMaxJumpHeightThisJump: usize = 0x4D8; // 
            }
            // Parent: None
            // Field count: 6
            //
            ...
            // Field count: 1
            pub mod C_Item {
                pub const m_pReticleHintTextName: usize = 0x15B0; // 
            }
            ...
            pub mod C_SoundEventPathCornerEntity {
                pub const m_vecCornerPairsNetworked: usize = 0x548; // 
            }
            // Parent: C_CSWeaponBaseGun
            // Field count: 0
            ...
            pub mod C_CSGameRules {
                ...
                pub const m_nMatchAbortedEarlyReason: usize = 0xD28; // 
                pub const m_bHasTriggeredRoundStartMusic: usize = 0xD2C; // 
                pub const m_bSwitchingTeamsAtRoundReset: usize = 0xD2D; // 
                pub const m_pGameModeRules: usize = 0xD48; // 
                pub const m_RetakeRules: usize = 0xD50; // 
                pub const m_nMatchEndCount: usize = 0xE68; // 
                pub const m_nTTeamIntroVariant: usize = 0xE6C; // 
                pub const m_nCTTeamIntroVariant: usize = 0xE70; // 
                pub const m_bTeamIntroPeriod: usize = 0xE74; // 
                pub const m_iRoundEndWinnerTeam: usize = 0xE78; // 
                pub const m_eRoundEndReason: usize = 0xE7C; // 
                pub const m_bRoundEndShowTimerDefend: usize = 0xE80; // 
                pub const m_iRoundEndTimerTime: usize = 0xE84; // 
                pub const m_sRoundEndFunFactToken: usize = 0xE88; // 
                pub const m_iRoundEndFunFactPlayerSlot: usize = 0xE90; // 
                pub const m_iRoundEndFunFactData1: usize = 0xE94; // 
                pub const m_iRoundEndFunFactData2: usize = 0xE98; // 
                pub const m_iRoundEndFunFactData3: usize = 0xE9C; // 
                pub const m_sRoundEndMessage: usize = 0xEA0; // 
                pub const m_iRoundEndPlayerCount: usize = 0xEA8; // 
                pub const m_bRoundEndNoMusic: usize = 0xEAC; // 
                pub const m_iRoundEndLegacy: usize = 0xEB0; // 
                pub const m_nRoundEndCount: usize = 0xEB4; // 
                pub const m_iRoundStartRoundNumber: usize = 0xEB8; // 
                pub const m_nRoundStartCount: usize = 0xEBC; // 
                pub const m_flLastPerfSampleTime: usize = 0x4EC8; // 
            }
            ...
            pub mod C_BaseModelEntity {
                pub const m_CRenderComponent: usize = 0xA18; // 
                pub const m_CHitboxComponent: usize = 0xA20; // 
                pub const m_bInitModelEffects: usize = 0xA68; // 
                pub const m_bIsStaticProp: usize = 0xA69; // 
                pub const m_nLastAddDecal: usize = 0xA6C; // 
                pub const m_nDecalsAdded: usize = 0xA70; // 
                pub const m_iOldHealth: usize = 0xA74; // 
                pub const m_nRenderMode: usize = 0xA78; // 
                pub const m_nRenderFX: usize = 0xA79; // 
                pub const m_bAllowFadeInView: usize = 0xA7A; // 
                pub const m_clrRender: usize = 0xA7B; // 
                pub const m_vecRenderAttributes: usize = 0xA80; // 
                pub const m_bRenderToCubemaps: usize = 0xAE8; // 
                pub const m_Collision: usize = 0xAF0; // 
                pub const m_Glow: usize = 0xBA0; // 
                pub const m_flGlowBackfaceMult: usize = 0xBF8; // 
                pub const m_fadeMinDist: usize = 0xBFC; // 
                pub const m_fadeMaxDist: usize = 0xC00; // 
                pub const m_flFadeScale: usize = 0xC04; // 
                pub const m_flShadowStrength: usize = 0xC08; // 
                pub const m_nObjectCulling: usize = 0xC0C; // 
                pub const m_nAddDecal: usize = 0xC10; // 
                pub const m_vDecalPosition: usize = 0xC14; // 
                pub const m_vDecalForwardAxis: usize = 0xC20; // 
                pub const m_flDecalHealBloodRate: usize = 0xC2C; // 
                pub const m_flDecalHealHeightRate: usize = 0xC30; // 
                pub const m_ConfigEntitiesToPropagateMaterialDecalsTo: usize = 0xC38; // 
                pub const m_vecViewOffset: usize = 0xC50; // 
                pub const m_pClientAlphaProperty: usize = 0xC80; // 
                pub const m_ClientOverrideTint: usize = 0xC88; // 
                pub const m_bUseClientOverrideTint: usize = 0xC8C; // 
            }
            // Parent: C_BaseTrigger
            // Field count: 2
            //
            ...
            pub mod C_FootstepControl {
                pub const m_source: usize = 0xCD0; // 
                pub const m_destination: usize = 0xCD8; // 
            }
            ...
            pub mod C_PointClientUIHUD {
                pub const m_bCheckCSSClasses: usize = 0xD00; // 
            ...
            pub mod C_SpotlightEnd {
                pub const m_flLightScale: usize = 0xCC8; // 
                pub const m_Radius: usize = 0xCCC; // 
            }
            // Parent: None
            // Field count: 5
            //
            ...
            pub mod C_PointCamera {
                pub const m_FOV: usize = 0x548; // 
                pub const m_Resolution: usize = 0x54C; // 
                pub const m_bFogEnable: usize = 0x550; // 
                pub const m_FogColor: usize = 0x551; // 
                pub const m_flFogStart: usize = 0x558; // 
                pub const m_flFogEnd: usize = 0x55C; // 
                pub const m_flFogMaxDensity: usize = 0x560; // 
                pub const m_bActive: usize = 0x564; // 
                pub const m_bUseScreenAspectRatio: usize = 0x565; // 
                pub const m_flAspectRatio: usize = 0x568; // 
                pub const m_bNoSky: usize = 0x56C; // 
                pub const m_fBrightness: usize = 0x570; // 
                pub const m_flZFar: usize = 0x574; // 
                pub const m_flZNear: usize = 0x578; // 
                pub const m_bCanHLTVUse: usize = 0x57C; // 
                pub const m_bDofEnabled: usize = 0x57D; // 
                pub const m_flDofNearBlurry: usize = 0x580; // 
                pub const m_flDofNearCrisp: usize = 0x584; // 
                pub const m_flDofFarCrisp: usize = 0x588; // 
                pub const m_flDofFarBlurry: usize = 0x58C; // 
                pub const m_flDofTiltToGround: usize = 0x590; // 
                pub const m_TargetFOV: usize = 0x594; // 
                pub const m_DegreesPerSecond: usize = 0x598; // 
                pub const m_bIsOn: usize = 0x59C; // 
                pub const m_pNext: usize = 0x5A0; // 
            }
            // Parent: None
            // Field count: 0
            //
            ...
            pub mod C_EnvWind {
                pub const m_EnvWindShared: usize = 0x548; // 
            }
            // Parent: C_BaseEntity
            // Field count: 0
            ...
            pub mod C_BaseCombatCharacter {
                pub const m_hMyWearables: usize = 0x1068; // 
                pub const m_leftFootAttachment: usize = 0x1080; // 
                pub const m_rightFootAttachment: usize = 0x1081; // 
                pub const m_nWaterWakeMode: usize = 0x1084; // 
                pub const m_flWaterWorldZ: usize = 0x1088; // 
                pub const m_flWaterNextTraceTime: usize = 0x108C; // 
                pub const m_flFieldOfView: usize = 0x1090; // 
            }
            ...
            pub mod C_SoundEventSphereEntity {
                pub const m_flRadius: usize = 0x548; // 
            }
            ...
            pub mod C_SceneEntity {
                pub const m_bIsPlayingBack: usize = 0x550; // 
                pub const m_bPaused: usize = 0x551; // 
                pub const m_bMultiplayer: usize = 0x552; // 
                pub const m_bAutogenerated: usize = 0x553; // 
                pub const m_flForceClientTime: usize = 0x554; // 
                pub const m_nSceneStringIndex: usize = 0x558; // 
                pub const m_bClientOnly: usize = 0x55A; // 
                pub const m_hOwner: usize = 0x55C; // 
                pub const m_hActorList: usize = 0x560; // 
                pub const m_bWasPlaying: usize = 0x578; // 
                pub const m_QueuedEvents: usize = 0x588; // 
                pub const m_flCurrentTime: usize = 0x5A0; // 
            }
            // Parent: CPlayerPawnComponent
            // Field count: 20
            //
            ...
            pub mod C_BaseCSGrenade {
                pub const m_bClientPredictDelete: usize = 0x1A70; // 
                pub const m_bRedraw: usize = 0x1A71; // 
                pub const m_bIsHeldByPlayer: usize = 0x1A72; // 
                pub const m_bPinPulled: usize = 0x1A73; // 
                pub const m_bJumpThrow: usize = 0x1A74; // 
                pub const m_bThrowAnimating: usize = 0x1A75; // 
                pub const m_fThrowTime: usize = 0x1A78; // 
                pub const m_flThrowStrength: usize = 0x1A7C; // 
                pub const m_flThrowStrengthApproach: usize = 0x1A80; // 
                pub const m_fDropTime: usize = 0x1A84; // 
                pub const m_fPinPullTime: usize = 0x1A88; // 
                pub const m_bJustPulledPin: usize = 0x1A8C; // 
                pub const m_nNextHoldTick: usize = 0x1A90; // 
                pub const m_flNextHoldFrac: usize = 0x1A94; // 
                pub const m_hSwitchToWeaponAfterThrow: usize = 0x1A98; // 
            }
            // Parent: C_FuncBrush
            // Field count: 8
            //
            ...
            pub mod C_FuncMonitor {
                pub const m_targetCamera: usize = 0xCC8; // 
                pub const m_nResolutionEnum: usize = 0xCD0; // 
                pub const m_bRenderShadows: usize = 0xCD4; // 
                pub const m_bUseUniqueColorTarget: usize = 0xCD5; // 
                pub const m_brushModelName: usize = 0xCD8; // 
                pub const m_hTargetCamera: usize = 0xCE0; // 
                pub const m_bEnabled: usize = 0xCE4; // 
                pub const m_bDraw3DSkybox: usize = 0xCE5; // 
            }
            // Parent: C_BaseTrigger
            // Field count: 0
            ...
            pub mod C_LightGlow {
                pub const m_nHorizontalSize: usize = 0xCC8; // 
                pub const m_nVerticalSize: usize = 0xCCC; // 
                pub const m_nMinDist: usize = 0xCD0; // 
                pub const m_nMaxDist: usize = 0xCD4; // 
                pub const m_nOuterMaxDist: usize = 0xCD8; // 
                pub const m_flGlowProxySize: usize = 0xCDC; // 
                pub const m_flHDRColorScale: usize = 0xCE0; // 
                pub const m_GlowOverlay: usize = 0xCE8; // 
            }
            // Parent: None
            // Field count: 4
            //
            ...
            pub mod C_ClientRagdoll {
                pub const m_bFadeOut: usize = 0xED0; // 
                pub const m_bImportant: usize = 0xED1; // 
                pub const m_flEffectTime: usize = 0xED4; // 
                pub const m_gibDespawnTime: usize = 0xED8; // 
                pub const m_iCurrentFriction: usize = 0xEDC; // 
                pub const m_iMinFriction: usize = 0xEE0; // 
                pub const m_iMaxFriction: usize = 0xEE4; // 
                pub const m_iFrictionAnimState: usize = 0xEE8; // 
                pub const m_bReleaseRagdoll: usize = 0xEEC; // 
                pub const m_iEyeAttachment: usize = 0xEED; // 
                pub const m_bFadingOut: usize = 0xEEE; // 
                pub const m_flScaleEnd: usize = 0xEF0; // 
                pub const m_flScaleTimeStart: usize = 0xF18; // 
                pub const m_flScaleTimeEnd: usize = 0xF40; // 
            }
            // Parent: C_BaseEntity
            // Field count: 1
            pub mod C_GlobalLight {
                pub const m_WindClothForceHandle: usize = 0xA10; // 
            }
            // Parent: C_BaseEntity
            // Field count: 10
            //
            ...
            pub mod C_CSPlayerResource {
                pub const m_bHostageAlive: usize = 0x548; // 
                pub const m_isHostageFollowingSomeone: usize = 0x554; // 
                pub const m_iHostageEntityIDs: usize = 0x560; // 
                pub const m_bombsiteCenterA: usize = 0x590; // 
                pub const m_bombsiteCenterB: usize = 0x59C; // 
                pub const m_hostageRescueX: usize = 0x5A8; // 
                pub const m_hostageRescueY: usize = 0x5B8; // 
                pub const m_hostageRescueZ: usize = 0x5C8; // 
                pub const m_bEndMatchNextMapAllVoted: usize = 0x5D8; // 
                pub const m_foundGoalPositions: usize = 0x5D9; // 
            }
            ...
            pub mod C_SmokeGrenadeProjectile {
                pub const m_nSmokeEffectTickBegin: usize = 0x1158; // 
                pub const m_bDidSmokeEffect: usize = 0x115C; // 
                pub const m_nRandomSeed: usize = 0x1160; // 
                pub const m_vSmokeColor: usize = 0x1164; // 
                pub const m_vSmokeDetonationPos: usize = 0x1170; // 
                pub const m_VoxelFrameData: usize = 0x1180; // 
                pub const m_bSmokeVolumeDataReceived: usize = 0x1198; // 
                pub const m_bSmokeEffectSpawned: usize = 0x1199; // 
            }
            // Parent: C_SoundEventEntity
            // Field count: 0
            ...
            pub mod C_CSGO_MapPreviewCameraPath {
                pub const m_flZFar: usize = 0x548; // 
                pub const m_flZNear: usize = 0x54C; // 
                pub const m_bLoop: usize = 0x550; // 
                pub const m_bVerticalFOV: usize = 0x551; // 
                pub const m_bConstantSpeed: usize = 0x552; // 
                pub const m_flDuration: usize = 0x554; // 
                pub const m_flPathLength: usize = 0x598; // 
                pub const m_flPathDuration: usize = 0x59C; // 
            }
            // Parent: CCSGO_WingmanIntroCharacterPosition
            // Field count: 0
            ...
            pub mod C_Inferno {
                pub const m_nfxFireDamageEffect: usize = 0xD08; // 
                pub const m_hInfernoPointsSnapshot: usize = 0xD10; // 
                pub const m_hInfernoFillerPointsSnapshot: usize = 0xD18; // 
                pub const m_hInfernoOutlinePointsSnapshot: usize = 0xD20; // 
                pub const m_hInfernoClimbingOutlinePointsSnapshot: usize = 0xD28; // 
                pub const m_hInfernoDecalsSnapshot: usize = 0xD30; // 
                pub const m_firePositions: usize = 0xD38; // 
                pub const m_fireParentPositions: usize = 0x1038; // 
                pub const m_bFireIsBurning: usize = 0x1338; // 
                pub const m_BurnNormal: usize = 0x1378; // 
                pub const m_fireCount: usize = 0x1678; // 
                pub const m_nInfernoType: usize = 0x167C; // 
                pub const m_nFireLifetime: usize = 0x1680; // 
                pub const m_bInPostEffectTime: usize = 0x1684; // 
                pub const m_lastFireCount: usize = 0x1688; // 
                pub const m_nFireEffectTickBegin: usize = 0x168C; // 
                pub const m_drawableCount: usize = 0x8290; // 
                pub const m_blosCheck: usize = 0x8294; // 
                pub const m_nlosperiod: usize = 0x8298; // 
                pub const m_maxFireHalfWidth: usize = 0x829C; // 
                pub const m_maxFireHeight: usize = 0x82A0; // 
                pub const m_minBounds: usize = 0x82A4; // 
                pub const m_maxBounds: usize = 0x82B0; // 
                pub const m_flLastGrassBurnThink: usize = 0x82BC; // 
            }
            // Parent: CBaseAnimGraph
            // Field count: 0
            ...
            pub mod C_PlayerPing {
                pub const m_hPlayer: usize = 0x578; // 
                pub const m_hPingedEntity: usize = 0x57C; // 
                pub const m_iType: usize = 0x580; // 
                pub const m_bUrgent: usize = 0x584; // 
                pub const m_szPlaceName: usize = 0x585; // 
            }
            // Parent: C_CSWeaponBaseGun
            // Field count: 0
            pub mod C_WeaponMP7 {
            ...
            pub mod C_CSTeam {
                pub const m_szTeamMatchStat: usize = 0x600; // 
                pub const m_numMapVictories: usize = 0x800; // 
                pub const m_bSurrendered: usize = 0x804; // 
                pub const m_scoreFirstHalf: usize = 0x808; // 
                pub const m_scoreSecondHalf: usize = 0x80C; // 
                pub const m_scoreOvertime: usize = 0x810; // 
                pub const m_szClanTeamname: usize = 0x814; // 
                pub const m_iClanID: usize = 0x898; // 
            ...
            pub mod C_CSGO_MapPreviewCameraPathNode {
                pub const m_szParentPathUniqueID: usize = 0x548; // 
                pub const m_nPathIndex: usize = 0x550; // 
                pub const m_vInTangentLocal: usize = 0x554; // 
                pub const m_vOutTangentLocal: usize = 0x560; // 
                pub const m_flFOV: usize = 0x56C; // 
                pub const m_flCameraSpeed: usize = 0x570; // 
                pub const m_flEaseIn: usize = 0x574; // 
                pub const m_flEaseOut: usize = 0x578; // 
                pub const m_vInTangentWorld: usize = 0x57C; // 
                pub const m_vOutTangentWorld: usize = 0x588; // 
            }
            // Parent: C_CSWeaponBaseGun
            // Field count: 0
            ...
            pub mod C_CSPlayerPawn {
                pub const m_pBulletServices: usize = 0x1468; // 
                pub const m_pHostageServices: usize = 0x1470; // 
                pub const m_pBuyServices: usize = 0x1478; // 
                pub const m_pGlowServices: usize = 0x1480; // 
                pub const m_pActionTrackingServices: usize = 0x1488; // CCSPlayer_ActionTrackingServices*
                pub const m_flHealthShotBoostExpirationTime: usize = 0x1490; // 
                pub const m_flLastFiredWeaponTime: usize = 0x1494; // 
                pub const m_bHasFemaleVoice: usize = 0x1498; // 
                pub const m_flLandingTimeSeconds: usize = 0x149C; // 
                pub const m_flOldFallVelocity: usize = 0x14A0; // 
                pub const m_szLastPlaceName: usize = 0x14A4; // 
                pub const m_bPrevDefuser: usize = 0x14B6; // 
                pub const m_bPrevHelmet: usize = 0x14B7; // 
                pub const m_nPrevArmorVal: usize = 0x14B8; // 
                pub const m_nPrevGrenadeAmmoCount: usize = 0x14BC; // 
                pub const m_unPreviousWeaponHash: usize = 0x14C0; // 
                pub const m_unWeaponHash: usize = 0x14C4; // 
                pub const m_bInBuyZone: usize = 0x14C8; // 
                pub const m_bPreviouslyInBuyZone: usize = 0x14C9; // 
                pub const m_aimPunchAngle: usize = 0x14CC; // 
                pub const m_aimPunchAngleVel: usize = 0x14D8; // 
                pub const m_aimPunchTickBase: usize = 0x14E4; // 
                pub const m_aimPunchTickFraction: usize = 0x14E8; // 
                pub const m_aimPunchCache: usize = 0x14F0; // 
                pub const m_bInLanding: usize = 0x1510; // 
                pub const m_flLandingStartTime: usize = 0x1514; // 
                pub const m_bInHostageRescueZone: usize = 0x1518; // 
                pub const m_bInBombZone: usize = 0x1519; // 
                pub const m_bIsBuyMenuOpen: usize = 0x151A; // 
                pub const m_flTimeOfLastInjury: usize = 0x151C; // 
                pub const m_flNextSprayDecalTime: usize = 0x1520; // 
                pub const m_iRetakesOffering: usize = 0x1650; // 
                pub const m_iRetakesOfferingCard: usize = 0x1654; // 
                pub const m_bRetakesHasDefuseKit: usize = 0x1658; // 
                pub const m_bRetakesMVPLastRound: usize = 0x1659; // 
                pub const m_iRetakesMVPBoostItem: usize = 0x165C; // 
                pub const m_RetakesMVPBoostExtraUtility: usize = 0x1660; // 
                pub const m_bNeedToReApplyGloves: usize = 0x1680; // 
                pub const m_EconGloves: usize = 0x1688; // 
                pub const m_nEconGlovesChanged: usize = 0x1AD0; // 
                pub const m_bMustSyncRagdollState: usize = 0x1AD1; // 
                pub const m_nRagdollDamageBone: usize = 0x1AD4; // 
                pub const m_vRagdollDamageForce: usize = 0x1AD8; // 
                pub const m_vRagdollDamagePosition: usize = 0x1AE4; // 
                pub const m_szRagdollDamageWeaponName: usize = 0x1AF0; // 
                pub const m_bRagdollDamageHeadshot: usize = 0x1B30; // 
                pub const m_vRagdollServerOrigin: usize = 0x1B34; // 
                pub const m_bLastHeadBoneTransformIsValid: usize = 0x2148; // 
                pub const m_lastLandTime: usize = 0x214C; // 
                pub const m_bOnGroundLastTick: usize = 0x2150; // 
                pub const m_qDeathEyeAngles: usize = 0x216C; // 
                pub const m_bSkipOneHeadConstraintUpdate: usize = 0x2178; // 
                pub const m_bLeftHanded: usize = 0x2179; // 
                pub const m_fSwitchedHandednessTime: usize = 0x217C; // 
                pub const m_flViewmodelOffsetX: usize = 0x2180; // 
                pub const m_flViewmodelOffsetY: usize = 0x2184; // 
                pub const m_flViewmodelOffsetZ: usize = 0x2188; // 
                pub const m_flViewmodelFOV: usize = 0x218C; // 
                pub const m_vecPlayerPatchEconIndices: usize = 0x2190; // 
                pub const m_GunGameImmunityColor: usize = 0x21C8; // 
                pub const m_vecBulletHitModels: usize = 0x2218; // 
                pub const m_bIsWalking: usize = 0x2230; // 
                pub const m_thirdPersonHeading: usize = 0x2238; // 
                pub const m_flSlopeDropOffset: usize = 0x2250; // 
                pub const m_flSlopeDropHeight: usize = 0x2260; // 
                pub const m_vHeadConstraintOffset: usize = 0x2270; // 
                pub const m_entitySpottedState: usize = 0x2288; // 
                pub const m_bIsScoped: usize = 0x22A0; // 
                pub const m_bResumeZoom: usize = 0x22A1; // 
                pub const m_bIsDefusing: usize = 0x22A2; // 
                pub const m_bIsGrabbingHostage: usize = 0x22A3; // 
                pub const m_iBlockingUseActionInProgress: usize = 0x22A4; // 
                pub const m_flEmitSoundTime: usize = 0x22A8; // 
                pub const m_bInNoDefuseArea: usize = 0x22AC; // 
                pub const m_nWhichBombZone: usize = 0x22B0; // 
                pub const m_iShotsFired: usize = 0x22B4; // 
                pub const m_flVelocityModifier: usize = 0x22B8; // 
                pub const m_flHitHeading: usize = 0x22BC; // 
                pub const m_nHitBodyPart: usize = 0x22C0; // 
                pub const m_bWaitForNoAttack: usize = 0x22C4; // 
                pub const m_ignoreLadderJumpTime: usize = 0x22C8; // 
                pub const m_bKilledByHeadshot: usize = 0x22CD; // 
                pub const m_ArmorValue: usize = 0x22D0; // 
                pub const m_unCurrentEquipmentValue: usize = 0x22D4; // 
                pub const m_unRoundStartEquipmentValue: usize = 0x22D6; // 
                pub const m_unFreezetimeEndEquipmentValue: usize = 0x22D8; // 
                pub const m_nLastKillerIndex: usize = 0x22DC; // 
                pub const m_bOldIsScoped: usize = 0x22E0; // 
                pub const m_bHasDeathInfo: usize = 0x22E1; // 
                pub const m_flDeathInfoTime: usize = 0x22E4; // 
                pub const m_vecDeathInfoOrigin: usize = 0x22E8; // 
                pub const m_grenadeParameterStashTime: usize = 0x22F4; // 
                pub const m_bGrenadeParametersStashed: usize = 0x22F8; // 
                pub const m_angStashedShootAngles: usize = 0x22FC; // 
                pub const m_vecStashedGrenadeThrowPosition: usize = 0x2308; // 
                pub const m_vecStashedVelocity: usize = 0x2314; // 
                pub const m_angShootAngleHistory: usize = 0x2320; // 
                pub const m_vecThrowPositionHistory: usize = 0x2338; // 
                pub const m_vecVelocityHistory: usize = 0x2350; // 
            }
            ...
            pub mod C_RagdollPropAttached {
                pub const m_boneIndexAttached: usize = 0xF48; // 
                pub const m_ragdollAttachedObjectIndex: usize = 0xF4C; // 
                pub const m_attachmentPointBoneSpace: usize = 0xF50; // 
                pub const m_attachmentPointRagdollSpace: usize = 0xF5C; // 
                pub const m_vecOffset: usize = 0xF68; // 
                pub const m_parentTime: usize = 0xF74; // 
                pub const m_bHasParent: usize = 0xF78; // 
            }
            ...
            pub mod C_BaseCSGrenadeProjectile {
                pub const m_vInitialPosition: usize = 0x10B8; // 
                pub const m_vInitialVelocity: usize = 0x10C4; // 
                pub const m_nBounces: usize = 0x10D0; // 
                pub const m_nExplodeEffectIndex: usize = 0x10D8; // 
                pub const m_nExplodeEffectTickBegin: usize = 0x10E0; // 
                pub const m_vecExplodeEffectOrigin: usize = 0x10E4; // 
                pub const m_flSpawnTime: usize = 0x10F0; // 
                pub const vecLastTrailLinePos: usize = 0x10F4; // 
                pub const flNextTrailLineTime: usize = 0x1100; // 
                pub const m_bExplodeEffectBegan: usize = 0x1104; // 
                pub const m_bCanCreateGrenadeTrail: usize = 0x1105; // 
                pub const m_nSnapshotTrajectoryEffectIndex: usize = 0x1108; // 
                pub const m_hSnapshotTrajectoryParticleSnapshot: usize = 0x1110; // 
                pub const m_arrTrajectoryTrailPoints: usize = 0x1118; // 
                pub const m_arrTrajectoryTrailPointCreationTimes: usize = 0x1130; // 
                pub const m_flTrajectoryTrailEffectCreationTime: usize = 0x1148; // 
            }
            // Parent: C_BaseToggle
            // Field count: 2
            //
            ...
            pub mod C_BaseTrigger {
                pub const m_bDisabled: usize = 0xCC8; // 
                pub const m_bClientSidePredicted: usize = 0xCC9; // 
            }
            // Parent: C_CSWeaponBase
            // Field count: 2
            //
            ...
            pub mod C_WeaponBaseItem {
                pub const m_SequenceCompleteTimer: usize = 0x1A70; // 
                pub const m_bRedraw: usize = 0x1A88; // 
            }
            // Parent: None
            // Field count: 21
            //
            ...
            pub mod C_BaseButton {
                pub const m_glowEntity: usize = 0xCC8; // 
                pub const m_usable: usize = 0xCCC; // 
                pub const m_szDisplayText: usize = 0xCD0; // 
            }
            ...
            pub mod C_PointClientUIWorldPanel {
                pub const m_bForceRecreateNextUpdate: usize = 0xD00; // 
                pub const m_bMoveViewToPlayerNextThink: usize = 0xD01; // 
                pub const m_bCheckCSSClasses: usize = 0xD02; // 
                pub const m_anchorDeltaTransform: usize = 0xD10; // 
                pub const m_pOffScreenIndicator: usize = 0xEA8; // 
                pub const m_bIgnoreInput: usize = 0xED0; // 
                pub const m_bLit: usize = 0xED1; // 
                pub const m_bFollowPlayerAcrossTeleport: usize = 0xED2; // 
                pub const m_flWidth: usize = 0xED4; // 
                pub const m_flHeight: usize = 0xED8; // 
                pub const m_flDPI: usize = 0xEDC; // 
                pub const m_flInteractDistance: usize = 0xEE0; // 
                pub const m_flDepthOffset: usize = 0xEE4; // 
                pub const m_unOwnerContext: usize = 0xEE8; // 
                pub const m_unHorizontalAlign: usize = 0xEEC; // 
                pub const m_unVerticalAlign: usize = 0xEF0; // 
                pub const m_unOrientation: usize = 0xEF4; // 
                pub const m_bAllowInteractionFromAllSceneWorlds: usize = 0xEF8; // 
                pub const m_vecCSSClasses: usize = 0xF00; // 
                pub const m_bOpaque: usize = 0xF18; // 
                pub const m_bNoDepth: usize = 0xF19; // 
                pub const m_bRenderBackface: usize = 0xF1A; // 
                pub const m_bUseOffScreenIndicator: usize = 0xF1B; // 
                pub const m_bExcludeFromSaveGames: usize = 0xF1C; // 
                pub const m_bGrabbable: usize = 0xF1D; // 
                pub const m_bOnlyRenderToTexture: usize = 0xF1E; // 
                pub const m_bDisableMipGen: usize = 0xF1F; // 
                pub const m_nExplicitImageLayout: usize = 0xF20; // 
            }
            // Parent: C_BaseEntity
            // Field count: 0
            ...
            pub mod C_Team {
                pub const m_aPlayerControllers: usize = 0x548; // 
                pub const m_aPlayers: usize = 0x560; // 
                pub const m_iScore: usize = 0x578; // 
                pub const m_szTeamname: usize = 0x57C; // 
            }
            // Parent: C_SoundAreaEntityBase
            // Field count: 2
            //
            ...
            pub mod C_SoundAreaEntityOrientedBox {
                pub const m_vMin: usize = 0x570; // 
                pub const m_vMax: usize = 0x57C; // 
            }
            // Parent: C_BaseModelEntity
            // Field count: 8
            //
            ...
            pub mod C_TextureBasedAnimatable {
                pub const m_bLoop: usize = 0xCC8; // 
                pub const m_flFPS: usize = 0xCCC; // 
                pub const m_hPositionKeys: usize = 0xCD0; // 
                pub const m_hRotationKeys: usize = 0xCD8; // 
                pub const m_vAnimationBoundsMin: usize = 0xCE0; // 
                pub const m_vAnimationBoundsMax: usize = 0xCEC; // 
                pub const m_flStartTime: usize = 0xCF8; // 
                pub const m_flStartFrame: usize = 0xCFC; // 
            }
            ...
            pub mod CSkyboxReference {
                pub const m_worldGroupId: usize = 0x548; // 
                pub const m_hSkyCamera: usize = 0x54C; // 
            }
            ...
            pub mod C_CSGOViewModel {
                pub const m_bShouldIgnoreOffsetAndAccuracy: usize = 0xF68; // 
                pub const m_nWeaponParity: usize = 0xF6C; // 
                pub const m_nOldWeaponParity: usize = 0xF70; // 
                pub const m_nLastKnownAssociatedWeaponEntIndex: usize = 0xF74; // 
                pub const m_bNeedToQueueHighResComposite: usize = 0xF78; // 
                pub const m_vLoweredWeaponOffset: usize = 0xFC8; // 
            }
            // Parent: CEntityComponent
            // Field count: 1
            ...
            pub mod C_EnvLightProbeVolume {
                ...
                pub const m_Entity_hLightProbeDirectLightIndicesTexture: usize = 0x1530; // 
                pub const m_Entity_hLightProbeDirectLightScalarsTexture: usize = 0x1538; // 
                pub const m_Entity_hLightProbeDirectLightShadowsTexture: usize = 0x1540; // 
                pub const m_Entity_vBoxMins: usize = 0x1548; // 
                pub const m_Entity_vBoxMaxs: usize = 0x1554; // 
                pub const m_Entity_bMoveable: usize = 0x1560; // 
                pub const m_Entity_nHandshake: usize = 0x1564; // 
                pub const m_Entity_nPriority: usize = 0x1568; // 
                pub const m_Entity_bStartDisabled: usize = 0x156C; // 
                pub const m_Entity_nLightProbeSizeX: usize = 0x1570; // 
                pub const m_Entity_nLightProbeSizeY: usize = 0x1574; // 
                pub const m_Entity_nLightProbeSizeZ: usize = 0x1578; // 
                pub const m_Entity_nLightProbeAtlasX: usize = 0x157C; // 
                pub const m_Entity_nLightProbeAtlasY: usize = 0x1580; // 
                pub const m_Entity_nLightProbeAtlasZ: usize = 0x1584; // 
                pub const m_Entity_bEnabled: usize = 0x1591; // 
            }
            // Parent: CBaseAnimGraph
            // Field count: 1
            pub mod C_ViewmodelAttachmentModel {
                pub const m_bShouldFrontFaceCullLeftHanded: usize = 0xED0; // 
            }
            // Parent: None
            // Field count: 0
            //
            ...
            pub mod C_TeamRoundTimer {
                pub const m_bTimerPaused: usize = 0x548; // 
                pub const m_flTimeRemaining: usize = 0x54C; // 
                pub const m_flTimerEndTime: usize = 0x550; // 
                pub const m_bIsDisabled: usize = 0x554; // 
                pub const m_bShowInHUD: usize = 0x555; // 
                pub const m_nTimerLength: usize = 0x558; // 
                pub const m_nTimerInitialLength: usize = 0x55C; // 
                pub const m_nTimerMaxLength: usize = 0x560; // 
                pub const m_bAutoCountdown: usize = 0x564; // 
                pub const m_nSetupTimeLength: usize = 0x568; // 
                pub const m_nState: usize = 0x56C; // 
                pub const m_bStartPaused: usize = 0x570; // 
                pub const m_bInCaptureWatchState: usize = 0x571; // 
                pub const m_flTotalTime: usize = 0x574; // 
                pub const m_bStopWatchTimer: usize = 0x578; // 
                pub const m_bFireFinished: usize = 0x579; // 
                pub const m_bFire5MinRemain: usize = 0x57A; // 
                pub const m_bFire4MinRemain: usize = 0x57B; // 
                pub const m_bFire3MinRemain: usize = 0x57C; // 
                pub const m_bFire2MinRemain: usize = 0x57D; // 
                pub const m_bFire1MinRemain: usize = 0x57E; // 
                pub const m_bFire30SecRemain: usize = 0x57F; // 
                pub const m_bFire10SecRemain: usize = 0x580; // 
                pub const m_bFire5SecRemain: usize = 0x581; // 
                pub const m_bFire4SecRemain: usize = 0x582; // 
                pub const m_bFire3SecRemain: usize = 0x583; // 
                pub const m_bFire2SecRemain: usize = 0x584; // 
                pub const m_bFire1SecRemain: usize = 0x585; // 
                pub const m_nOldTimerLength: usize = 0x588; // 
                pub const m_nOldTimerState: usize = 0x58C; // 
            }
            // Parent: None
            // Field count: 2
            //
            ...
            // Field count: 1
            pub mod CPathSimple {
                pub const m_pathString: usize = 0x598; // 
            }
            ...
            pub mod CPointOffScreenIndicatorUi {
                pub const m_bBeenEnabled: usize = 0xF30; // 
                pub const m_bHide: usize = 0xF31; // 
                pub const m_flSeenTargetTime: usize = 0xF34; // 
                pub const m_pTargetPanel: usize = 0xF38; // 
            }
            // Parent: None
            // Field count: 0
            //
            ...
            pub mod C_CSWeaponBaseGun {
                pub const m_zoomLevel: usize = 0x1A70; // 
                pub const m_iBurstShotsRemaining: usize = 0x1A74; // 
                pub const m_iSilencerBodygroup: usize = 0x1A78; // 
                pub const m_silencedModelIndex: usize = 0x1A88; // 
                pub const m_inPrecache: usize = 0x1A8C; // 
                pub const m_bNeedsBoltAction: usize = 0x1A8D; // 
            }
            // Parent: C_BaseEntity
            // Field count: 4
            //
            ...
            pub mod C_SkyCamera {
                pub const m_skyboxData: usize = 0x548; // 
                pub const m_skyboxSlotToken: usize = 0x5D8; // 
                pub const m_bUseAngles: usize = 0x5DC; // 
                pub const m_pNext: usize = 0x5E0; // 
            }
            // Parent: C_BaseModelEntity
            // Field count: 0
            pub mod C_World {
            ...
            pub mod C_EntityDissolve {
                ...
                pub const m_flFadeInStart: usize = 0xCD4; // 
                pub const m_flFadeInLength: usize = 0xCD8; // 
                pub const m_flFadeOutModelStart: usize = 0xCDC; // 
                pub const m_flFadeOutModelLength: usize = 0xCE0; // 
                pub const m_flFadeOutStart: usize = 0xCE4; // 
                pub const m_flFadeOutLength: usize = 0xCE8; // 
                pub const m_flNextSparkTime: usize = 0xCEC; // 
                pub const m_nDissolveType: usize = 0xCF0; // 
                pub const m_vDissolverOrigin: usize = 0xCF4; // 
                pub const m_nMagnitude: usize = 0xD00; // 
                pub const m_bCoreExplode: usize = 0xD04; // 
                pub const m_bLinkedToServerEnt: usize = 0xD05; // 
            }
            ...
            pub mod C_CSPlayerPawnBase {
                pub const m_pPingServices: usize = 0x12B0; // 
                pub const m_pViewModelServices: usize = 0x12B8; // 
                pub const m_fRenderingClipPlane: usize = 0x12C0; // 
                pub const m_nLastClipPlaneSetupFrame: usize = 0x12D0; // 
                pub const m_vecLastClipCameraPos: usize = 0x12D4; // 
                pub const m_vecLastClipCameraForward: usize = 0x12E0; // 
                pub const m_bClipHitStaticWorld: usize = 0x12EC; // 
                pub const m_bCachedPlaneIsValid: usize = 0x12ED; // 
                pub const m_pClippingWeapon: usize = 0x12F0; // 
                pub const m_previousPlayerState: usize = 0x12F8; // 
                pub const m_iPlayerState: usize = 0x12FC; // 
                pub const m_bIsRescuing: usize = 0x1300; // 
                pub const m_fImmuneToGunGameDamageTime: usize = 0x1304; // 
                pub const m_fImmuneToGunGameDamageTimeLast: usize = 0x1308; // 
                pub const m_bGunGameImmunity: usize = 0x130C; // 
                pub const m_bHasMovedSinceSpawn: usize = 0x130D; // 
                pub const m_fMolotovUseTime: usize = 0x1310; // 
                pub const m_fMolotovDamageTime: usize = 0x1314; // 
                pub const m_iThrowGrenadeCounter: usize = 0x1318; // 
                pub const m_flLastSpawnTimeIndex: usize = 0x131C; // 
                pub const m_iProgressBarDuration: usize = 0x1320; // 
                pub const m_flProgressBarStartTime: usize = 0x1324; // 
                pub const m_vecIntroStartEyePosition: usize = 0x1328; // 
                pub const m_vecIntroStartPlayerForward: usize = 0x1334; // 
                pub const m_flClientDeathTime: usize = 0x1340; // 
                pub const m_bScreenTearFrameCaptured: usize = 0x1344; // 
                pub const m_flFlashBangTime: usize = 0x1348; // 
                pub const m_flFlashScreenshotAlpha: usize = 0x134C; // 
                pub const m_flFlashOverlayAlpha: usize = 0x1350; // 
                pub const m_bFlashBuildUp: usize = 0x1354; // 
                pub const m_bFlashDspHasBeenCleared: usize = 0x1355; // 
                pub const m_bFlashScreenshotHasBeenGrabbed: usize = 0x1356; // 
                pub const m_flFlashMaxAlpha: usize = 0x1358; // 
                pub const m_flFlashDuration: usize = 0x135C; // 
                pub const m_iHealthBarRenderMaskIndex: usize = 0x1360; // 
                pub const m_flHealthFadeValue: usize = 0x1364; // 
                pub const m_flHealthFadeAlpha: usize = 0x1368; // 
                pub const m_flDeathCCWeight: usize = 0x1378; // 
                pub const m_flPrevRoundEndTime: usize = 0x137C; // 
                pub const m_flPrevMatchEndTime: usize = 0x1380; // 
                pub const m_angEyeAngles: usize = 0x1388; // 
                pub const m_fNextThinkPushAway: usize = 0x13A0; // 
                pub const m_bShouldAutobuyDMWeapons: usize = 0x13A4; // 
                pub const m_bShouldAutobuyNow: usize = 0x13A5; // 
                pub const m_iIDEntIndex: usize = 0x13A8; // 
                pub const m_delayTargetIDTimer: usize = 0x13B0; // 
                pub const m_iTargetItemEntIdx: usize = 0x13C8; // 
                pub const m_iOldIDEntIndex: usize = 0x13CC; // 
                pub const m_holdTargetIDTimer: usize = 0x13D0; // 
                pub const m_flCurrentMusicStartTime: usize = 0x13EC; // 
                pub const m_flMusicRoundStartTime: usize = 0x13F0; // 
                pub const m_bDeferStartMusicOnWarmup: usize = 0x13F4; // 
                pub const m_cycleLatch: usize = 0x13F8; // 
                pub const m_serverIntendedCycle: usize = 0x13FC; // 
                pub const m_flLastSmokeOverlayAlpha: usize = 0x1400; // 
                pub const m_flLastSmokeAge: usize = 0x1404; // 
                pub const m_vLastSmokeOverlayColor: usize = 0x1408; // 
                pub const m_nPlayerSmokedFx: usize = 0x1414; // 
                pub const m_nPlayerInfernoBodyFx: usize = 0x1418; // 
                pub const m_nPlayerInfernoFootFx: usize = 0x141C; // 
                pub const m_flNextMagDropTime: usize = 0x1420; // 
                pub const m_nLastMagDropAttachmentIndex: usize = 0x1424; // 
                pub const m_vecLastAliveLocalVelocity: usize = 0x1428; // 
                pub const m_bGuardianShouldSprayCustomXMark: usize = 0x1450; // 
                pub const m_hOriginalController: usize = 0x1458; // 
            }
            ...
            pub mod C_PostProcessingVolume {
                pub const m_hPostSettings: usize = 0xCE0; // 
                pub const m_flFadeDuration: usize = 0xCE8; // 
                pub const m_flMinLogExposure: usize = 0xCEC; // 
                pub const m_flMaxLogExposure: usize = 0xCF0; // 
                pub const m_flMinExposure: usize = 0xCF4; // 
                pub const m_flMaxExposure: usize = 0xCF8; // 
                pub const m_flExposureCompensation: usize = 0xCFC; // 
                pub const m_flExposureFadeSpeedUp: usize = 0xD00; // 
                pub const m_flExposureFadeSpeedDown: usize = 0xD04; // 
                pub const m_flTonemapEVSmoothingRange: usize = 0xD08; // 
                pub const m_bMaster: usize = 0xD0C; // 
                pub const m_bExposureControl: usize = 0xD0D; // 
                pub const m_flRate: usize = 0xD10; // 
                pub const m_flTonemapPercentTarget: usize = 0xD14; // 
                pub const m_flTonemapPercentBrightPixels: usize = 0xD18; // 
                pub const m_flTonemapMinAvgLum: usize = 0xD1C; // 
            }
            // Parent: CPlayerPawnComponent
            // Field count: 1
            //
            ...
            pub mod C_BaseFire {
                pub const m_flScale: usize = 0x548; // 
                pub const m_flStartScale: usize = 0x54C; // 
                pub const m_flScaleTime: usize = 0x550; // 
                pub const m_nFlags: usize = 0x554; // 
            }
            // Parent: C_BaseEntity
            // Field count: 16
            //
            ...
            pub mod CBasePlayerController {
                pub const m_nFinalPredictedTick: usize = 0x550; // 
                pub const m_CommandContext: usize = 0x558; // 
                pub const m_nInButtonsWhichAreToggles: usize = 0x5F0; // 
                pub const m_nTickBase: usize = 0x5F8; // 
                pub const m_hPawn: usize = 0x5FC; // 
                pub const m_bKnownTeamMismatch: usize = 0x600; // 
                pub const m_hPredictedPawn: usize = 0x604; // 
                pub const m_nSplitScreenSlot: usize = 0x608; // 
                pub const m_hSplitOwner: usize = 0x60C; // 
                pub const m_hSplitScreenPlayers: usize = 0x610; // 
                pub const m_bIsHLTV: usize = 0x628; // 
                pub const m_iConnected: usize = 0x62C; // 
                pub const m_iszPlayerName: usize = 0x630; // 
                pub const m_steamID: usize = 0x6B8; // 
                pub const m_bIsLocalPlayerController: usize = 0x6C0; // 
                pub const m_iDesiredFOV: usize = 0x6C4; // 
            }
            // Parent: None
            // Field count: 0
            //
            ...
            pub mod C_DecoyProjectile {
                pub const m_nDecoyShotTick: usize = 0x1150; // 
                pub const m_nClientLastKnownDecoyShotTick: usize = 0x1154; // 
                pub const m_flTimeParticleEffectSpawn: usize = 0x1178; // 
            }
            // Parent: CBaseAnimGraph
            // Field count: 0
            ...
            pub mod C_CSGO_PreviewPlayer {
                pub const m_animgraph: usize = 0x2368; // 
                pub const m_animgraphCharacterModeString: usize = 0x2370; // 
                pub const m_flInitialModelScale: usize = 0x2378; // 
            }
            ...
            // NetworkVarNames: m_entitySpottedState (EntitySpottedState_t)
            pub mod C_C4 {
                pub const m_szScreenText: usize = 0x1A70; // 
                pub const m_activeLightParticleIndex: usize = 0x1A90; // 
                pub const m_eActiveLightEffect: usize = 0x1A94; // 
                pub const m_bStartedArming: usize = 0x1A98; // 
                pub const m_fArmedTime: usize = 0x1A9C; // 
                pub const m_bBombPlacedAnimation: usize = 0x1AA0; // 
                pub const m_bIsPlantingViaUse: usize = 0x1AA1; // 
                pub const m_entitySpottedState: usize = 0x1AA8; // 
                pub const m_nSpotRules: usize = 0x1AC0; // 
                pub const m_bPlayedArmingBeeps: usize = 0x1AC4; // 
                pub const m_bBombPlanted: usize = 0x1ACB; // 
            }
            // Parent: C_BaseModelEntity
            // Field count: 13
            //
            ...
            pub mod CBaseAnimGraph {
                pub const m_bInitiallyPopulateInterpHistory: usize = 0xD40; // 
                pub const m_bSuppressAnimEventSounds: usize = 0xD42; // 
                pub const m_bAnimGraphUpdateEnabled: usize = 0xD50; // 
                pub const m_flMaxSlopeDistance: usize = 0xD54; // 
                pub const m_vLastSlopeCheckPos: usize = 0xD58; // 
                pub const m_bAnimationUpdateScheduled: usize = 0xD64; // 
                pub const m_vecForce: usize = 0xD68; // 
                pub const m_nForceBone: usize = 0xD74; // 
                pub const m_pClientsideRagdoll: usize = 0xD78; // 
                pub const m_bBuiltRagdoll: usize = 0xD80; // 
                pub const m_pRagdollPose: usize = 0xD98; // 
                pub const m_bRagdollClientSide: usize = 0xDA0; // 
                pub const m_bHasAnimatedMaterialAttributes: usize = 0xDB0; // 
            }
            // Parent: C_CSWeaponBase
            // Field count: 0
            pub mod C_Melee {
            ...
            pub mod C_PathParticleRope {
                pub const m_bStartActive: usize = 0x548; // 
                pub const m_flMaxSimulationTime: usize = 0x54C; // 
                pub const m_iszEffectName: usize = 0x550; // 
                pub const m_PathNodes_Name: usize = 0x558; // 
                pub const m_flParticleSpacing: usize = 0x570; // 
                pub const m_flSlack: usize = 0x574; // 
                pub const m_flRadius: usize = 0x578; // 
                pub const m_ColorTint: usize = 0x57C; // 
                pub const m_nEffectState: usize = 0x580; // 
                pub const m_iEffectIndex: usize = 0x588; // 
                pub const m_PathNodes_Position: usize = 0x590; // 
                pub const m_PathNodes_TangentIn: usize = 0x5A8; // 
                pub const m_PathNodes_TangentOut: usize = 0x5C0; // 
                pub const m_PathNodes_Color: usize = 0x5D8; // 
                pub const m_PathNodes_PinEnabled: usize = 0x5F0; // 
                pub const m_PathNodes_RadiusScale: usize = 0x608; // 
            }
            // Parent: None
            // Field count: 0
            //
            ...
            pub mod C_BasePlayerWeapon {
                pub const m_nNextPrimaryAttackTick: usize = 0x15B0; // 
                pub const m_flNextPrimaryAttackTickRatio: usize = 0x15B4; // 
                pub const m_nNextSecondaryAttackTick: usize = 0x15B8; // 
                pub const m_flNextSecondaryAttackTickRatio: usize = 0x15BC; // 
                pub const m_iClip1: usize = 0x15C0; // 
                pub const m_iClip2: usize = 0x15C4; // 
                pub const m_pReserveAmmo: usize = 0x15C8; // 
            }
            ...
            pub mod C_Fish {
                pub const m_pos: usize = 0xED0; // 
                pub const m_vel: usize = 0xEDC; // 
                pub const m_angles: usize = 0xEE8; // 
                pub const m_localLifeState: usize = 0xEF4; // 
                pub const m_deathDepth: usize = 0xEF8; // 
                pub const m_deathAngle: usize = 0xEFC; // 
                pub const m_buoyancy: usize = 0xF00; // 
                pub const m_wiggleTimer: usize = 0xF08; // 
                pub const m_wigglePhase: usize = 0xF20; // 
                pub const m_wiggleRate: usize = 0xF24; // 
                pub const m_actualPos: usize = 0xF28; // 
                pub const m_actualAngles: usize = 0xF34; // 
                pub const m_poolOrigin: usize = 0xF40; // 
                pub const m_waterLevel: usize = 0xF4C; // 
                pub const m_gotUpdate: usize = 0xF50; // 
                pub const m_x: usize = 0xF54; // 
                pub const m_y: usize = 0xF58; // 
                pub const m_z: usize = 0xF5C; // 
                pub const m_angle: usize = 0xF60; // 
                pub const m_errorHistory: usize = 0xF64; // 
                pub const m_errorHistoryIndex: usize = 0xFB4; // 
                pub const m_errorHistoryCount: usize = 0xFB8; // 
                pub const m_averageError: usize = 0xFBC; // 
            }
            ...
            pub mod C_BasePlayerPawn {
                pub const m_pWeaponServices: usize = 0x10F8; // 
                pub const m_pItemServices: usize = 0x1100; // 
                pub const m_pAutoaimServices: usize = 0x1108; // 
                pub const m_pObserverServices: usize = 0x1110; // 
                pub const m_pWaterServices: usize = 0x1118; // 
                pub const m_pUseServices: usize = 0x1120; // 
                pub const m_pFlashlightServices: usize = 0x1128; // 
                pub const m_pCameraServices: usize = 0x1130; // 
                pub const m_pMovementServices: usize = 0x1138; // 
                pub const m_ServerViewAngleChanges: usize = 0x1148; // 
                pub const m_nHighestConsumedServerViewAngleChangeIndex: usize = 0x1198; // 
                pub const v_angle: usize = 0x119C; // 
                pub const v_anglePrevious: usize = 0x11A8; // 
                pub const m_iHideHUD: usize = 0x11B4; // 
                pub const m_skybox3d: usize = 0x11B8; // 
                pub const m_flDeathTime: usize = 0x1248; // 
                pub const m_vecPredictionError: usize = 0x124C; // 
                pub const m_flPredictionErrorTime: usize = 0x1258; // 
                pub const m_vecLastCameraSetupLocalOrigin: usize = 0x125C; // 
                pub const m_flLastCameraSetupTime: usize = 0x1268; // 
                pub const m_flFOVSensitivityAdjust: usize = 0x126C; // 
                pub const m_flMouseSensitivity: usize = 0x1270; // 
                pub const m_vOldOrigin: usize = 0x1274; // 
                pub const m_flOldSimulationTime: usize = 0x1280; // 
                pub const m_nLastExecutedCommandNumber: usize = 0x1284; // 
                pub const m_nLastExecutedCommandTick: usize = 0x1288; // 
                pub const m_hController: usize = 0x128C; // 
                pub const m_bIsSwappingToPredictableController: usize = 0x1290; // 
            }
            // Parent: None
            // Field count: 6
            //
            ...
            pub mod C_TriggerBuoyancy {
                pub const m_BuoyancyHelper: usize = 0xCD0; // 
            ...
            pub mod C_RopeKeyframe {
                pub const m_LinksTouchingSomething: usize = 0xCD0; // 
                pub const m_nLinksTouchingSomething: usize = 0xCD4; // 
                pub const m_bApplyWind: usize = 0xCD8; // 
                pub const m_fPrevLockedPoints: usize = 0xCDC; // 
                pub const m_iForcePointMoveCounter: usize = 0xCE0; // 
                pub const m_bPrevEndPointPos: usize = 0xCE4; // 
                pub const m_vPrevEndPointPos: usize = 0xCE8; // 
                pub const m_flCurScroll: usize = 0xD00; // 
                pub const m_flScrollSpeed: usize = 0xD04; // 
                pub const m_RopeFlags: usize = 0xD08; // 
                pub const m_iRopeMaterialModelIndex: usize = 0xD10; // CStrongHandle<InfoForResourceTypeIMaterial2>
                pub const m_LightValues: usize = 0xF88; // 
                pub const m_nSegments: usize = 0x1000; // 
                pub const m_hStartPoint: usize = 0x1004; // 
                pub const m_hEndPoint: usize = 0x1008; // 
                pub const m_iStartAttachment: usize = 0x100C; // 
                pub const m_iEndAttachment: usize = 0x100D; // 
                pub const m_Subdiv: usize = 0x100E; // 
                pub const m_RopeLength: usize = 0x1010; // 
                pub const m_Slack: usize = 0x1012; // 
                pub const m_TextureScale: usize = 0x1014; // 
                pub const m_fLockedPoints: usize = 0x1018; // 
                pub const m_nChangeCount: usize = 0x1019; // 
                pub const m_Width: usize = 0x101C; // 
                ...
                pub const m_TextureHeight: usize = 0x1038; // 
                pub const m_vecImpulse: usize = 0x103C; // 
                pub const m_vecPreviousImpulse: usize = 0x1048; // 
                pub const m_flCurrentGustTimer: usize = 0x1054; // 
                pub const m_flCurrentGustLifetime: usize = 0x1058; // 
                pub const m_flTimeToNextGust: usize = 0x105C; // 
                pub const m_vWindDir: usize = 0x1060; // 
                pub const m_vColorMod: usize = 0x106C; // 
                pub const m_vCachedEndPointAttachmentPos: usize = 0x1078; // 
                pub const m_vCachedEndPointAttachmentAngle: usize = 0x1090; // 
                pub const m_bConstrainBetweenEndpoints: usize = 0x10A8; // 
            ...
            pub mod C_GradientFog {
                pub const m_hGradientFogTexture: usize = 0x548; // 
                pub const m_flFogStartDistance: usize = 0x550; // 
                pub const m_flFogEndDistance: usize = 0x554; // 
                pub const m_bHeightFogEnabled: usize = 0x558; // 
                pub const m_flFogStartHeight: usize = 0x55C; // 
                pub const m_flFogEndHeight: usize = 0x560; // 
                pub const m_flFarZ: usize = 0x564; // 
                pub const m_flFogMaxOpacity: usize = 0x568; // 
                pub const m_flFogFalloffExponent: usize = 0x56C; // 
                pub const m_flFogVerticalExponent: usize = 0x570; // 
                pub const m_fogColor: usize = 0x574; // 
                pub const m_flFogStrength: usize = 0x578; // 
                pub const m_flFadeTime: usize = 0x57C; // 
                pub const m_bStartDisabled: usize = 0x580; // 
                pub const m_bIsEnabled: usize = 0x581; // 
                pub const m_bGradientFogNeedsTextures: usize = 0x582; // 
            }
            // Parent: None
            // Field count: 2
            //
            ...
            pub mod C_CSGO_TeamPreviewCamera {
                pub const m_nVariant: usize = 0x5B0; // 
                pub const m_bDofEnabled: usize = 0x5B4; // 
                pub const m_flDofNearBlurry: usize = 0x5B8; // 
                pub const m_flDofNearCrisp: usize = 0x5BC; // 
                pub const m_flDofFarCrisp: usize = 0x5C0; // 
                pub const m_flDofFarBlurry: usize = 0x5C4; // 
                pub const m_flDofTiltToGround: usize = 0x5C8; // 
            }
            ...
            pub mod C_EconWearable {
                pub const m_nForceSkin: usize = 0x15B0; // 
                pub const m_bAlwaysAllow: usize = 0x15B4; // 
            }
            ...
            pub mod C_EnvVolumetricFogVolume {
                pub const m_bActive: usize = 0x548; // 
                pub const m_vBoxMins: usize = 0x54C; // 
                pub const m_vBoxMaxs: usize = 0x558; // 
                pub const m_bStartDisabled: usize = 0x564; // 
                pub const m_flStrength: usize = 0x568; // 
                pub const m_nFalloffShape: usize = 0x56C; // 
                pub const m_flFalloffExponent: usize = 0x570; // 
                pub const m_flHeightFogDepth: usize = 0x574; // 
                pub const m_fHeightFogEdgeWidth: usize = 0x578; // 
                pub const m_fIndirectLightStrength: usize = 0x57C; // 
                pub const m_fSunLightStrength: usize = 0x580; // 
                pub const m_fNoiseStrength: usize = 0x584; // 
                pub const m_bOverrideIndirectLightStrength: usize = 0x588; // 
                pub const m_bOverrideSunLightStrength: usize = 0x589; // 
                pub const m_bOverrideNoiseStrength: usize = 0x58A; // 
            }
            // Parent: C_BaseModelEntity
            // Field count: 0
            ...
            pub mod C_FireSmoke {
                pub const m_nFlameModelIndex: usize = 0x558; // 
                pub const m_nFlameFromAboveModelIndex: usize = 0x55C; // 
                pub const m_flScaleRegister: usize = 0x560; // 
                pub const m_flScaleStart: usize = 0x564; // 
                pub const m_flScaleEnd: usize = 0x568; // 
                pub const m_flScaleTimeStart: usize = 0x56C; // 
                pub const m_flScaleTimeEnd: usize = 0x570; // 
                pub const m_flChildFlameSpread: usize = 0x574; // 
                pub const m_flClipPerc: usize = 0x588; // 
                pub const m_bClipTested: usize = 0x58C; // 
                pub const m_bFadingOut: usize = 0x58D; // 
                pub const m_tParticleSpawn: usize = 0x590; // 
                pub const m_pFireOverlay: usize = 0x598; // 
            }
            // Parent: C_CSWeaponBaseGun
            // Field count: 0
            ...
            pub mod C_EnvCombinedLightProbeVolume {
                pub const m_Entity_Color: usize = 0x15A8; // 
                pub const m_Entity_flBrightness: usize = 0x15AC; // 
                pub const m_Entity_hCubemapTexture: usize = 0x15B0; // 
                pub const m_Entity_bCustomCubemapTexture: usize = 0x15B8; // 
                pub const m_Entity_hLightProbeTexture: usize = 0x15C0; // 
                pub const m_Entity_hLightProbeDirectLightIndicesTexture: usize = 0x15C8; // 
                pub const m_Entity_hLightProbeDirectLightScalarsTexture: usize = 0x15D0; // 
                pub const m_Entity_hLightProbeDirectLightShadowsTexture: usize = 0x15D8; // 
                pub const m_Entity_vBoxMins: usize = 0x15E0; // 
                pub const m_Entity_vBoxMaxs: usize = 0x15EC; // 
                pub const m_Entity_bMoveable: usize = 0x15F8; // 
                pub const m_Entity_nHandshake: usize = 0x15FC; // 
                pub const m_Entity_nEnvCubeMapArrayIndex: usize = 0x1600; // 
                pub const m_Entity_nPriority: usize = 0x1604; // 
                pub const m_Entity_bStartDisabled: usize = 0x1608; // 
                pub const m_Entity_flEdgeFadeDist: usize = 0x160C; // 
                pub const m_Entity_vEdgeFadeDists: usize = 0x1610; // 
                pub const m_Entity_nLightProbeSizeX: usize = 0x161C; // 
                pub const m_Entity_nLightProbeSizeY: usize = 0x1620; // 
                pub const m_Entity_nLightProbeSizeZ: usize = 0x1624; // 
                pub const m_Entity_nLightProbeAtlasX: usize = 0x1628; // 
                pub const m_Entity_nLightProbeAtlasY: usize = 0x162C; // 
                pub const m_Entity_nLightProbeAtlasZ: usize = 0x1630; // 
                pub const m_Entity_bEnabled: usize = 0x1649; // 
            }
            // Parent: C_SoundOpvarSetPointBase
            // Field count: 0
            ...
            // Field count: 7
            pub mod CLogicRelay {
                pub const m_OnTrigger: usize = 0x548; // 
                pub const m_OnSpawn: usize = 0x570; // 
                pub const m_bDisabled: usize = 0x598; // 
                pub const m_bWaitForRefire: usize = 0x599; // 
                pub const m_bTriggerOnce: usize = 0x59A; // 
                pub const m_bFastRetrigger: usize = 0x59B; // 
                pub const m_bPassthoughCaller: usize = 0x59C; // 
            }
            // Parent: C_PointCamera
            // Field count: 1
            pub mod C_PointCameraVFOV {
                pub const m_flVerticalFOV: usize = 0x5A8; // 
            }
            ...
            pub mod C_BarnLight {
                ...
                pub const m_nColorMode: usize = 0xCCC; // 
                pub const m_Color: usize = 0xCD0; // 
                pub const m_flColorTemperature: usize = 0xCD4; // 
                pub const m_flBrightness: usize = 0xCD8; // 
                pub const m_flBrightnessScale: usize = 0xCDC; // 
                pub const m_nDirectLight: usize = 0xCE0; // 
                pub const m_nBakedShadowIndex: usize = 0xCE4; // 
                pub const m_nLuminaireShape: usize = 0xCE8; // 
                pub const m_flLuminaireSize: usize = 0xCEC; // 
                pub const m_flLuminaireAnisotropy: usize = 0xCF0; // 
                pub const m_LightStyleString: usize = 0xCF8; // 
                pub const m_flLightStyleStartTime: usize = 0xD00; // 
                ...
                pub const m_LightStyleTargets: usize = 0xD38; // 
                pub const m_StyleEvent: usize = 0xD50; // 
                pub const m_hLightCookie: usize = 0xDF0; // 
                pub const m_flShape: usize = 0xDF8; // 
                pub const m_flSoftX: usize = 0xDFC; // 
                pub const m_flSoftY: usize = 0xE00; // 
                pub const m_flSkirt: usize = 0xE04; // 
                pub const m_flSkirtNear: usize = 0xE08; // 
                pub const m_vSizeParams: usize = 0xE0C; // 
                pub const m_flRange: usize = 0xE18; // 
                pub const m_vShear: usize = 0xE1C; // 
                pub const m_nBakeSpecularToCubemaps: usize = 0xE28; // 
                pub const m_vBakeSpecularToCubemapsSize: usize = 0xE2C; // 
                pub const m_nCastShadows: usize = 0xE38; // 
                pub const m_nShadowMapSize: usize = 0xE3C; // 
                pub const m_nShadowPriority: usize = 0xE40; // 
                pub const m_bContactShadow: usize = 0xE44; // 
                pub const m_nBounceLight: usize = 0xE48; // 
                pub const m_flBounceScale: usize = 0xE4C; // 
                pub const m_flMinRoughness: usize = 0xE50; // 
                pub const m_vAlternateColor: usize = 0xE54; // 
                pub const m_fAlternateColorBrightness: usize = 0xE60; // 
                pub const m_nFog: usize = 0xE64; // 
                pub const m_flFogStrength: usize = 0xE68; // 
                pub const m_nFogShadows: usize = 0xE6C; // 
                pub const m_flFogScale: usize = 0xE70; // 
                pub const m_flFadeSizeStart: usize = 0xE74; // 
                pub const m_flFadeSizeEnd: usize = 0xE78; // 
                pub const m_flShadowFadeSizeStart: usize = 0xE7C; // 
                pub const m_flShadowFadeSizeEnd: usize = 0xE80; // 
                pub const m_bPrecomputedFieldsValid: usize = 0xE84; // 
                pub const m_vPrecomputedBoundsMins: usize = 0xE88; // 
                pub const m_vPrecomputedBoundsMaxs: usize = 0xE94; // 
                pub const m_vPrecomputedOBBOrigin: usize = 0xEA0; // 
                pub const m_vPrecomputedOBBAngles: usize = 0xEAC; // 
                pub const m_vPrecomputedOBBExtent: usize = 0xEB8; // 
            }
            // Parent: C_BaseEntity
            // Field count: 8
            //
            ...
            pub mod C_TonemapController2 {
                pub const m_flAutoExposureMin: usize = 0x548; // 
                pub const m_flAutoExposureMax: usize = 0x54C; // 
                pub const m_flTonemapPercentTarget: usize = 0x550; // 
                pub const m_flTonemapPercentBrightPixels: usize = 0x554; // 
                pub const m_flTonemapMinAvgLum: usize = 0x558; // 
                pub const m_flExposureAdaptationSpeedUp: usize = 0x55C; // 
                pub const m_flExposureAdaptationSpeedDown: usize = 0x560; // 
                pub const m_flTonemapEVSmoothingRange: usize = 0x564; // 
            }
            // Parent: C_CSWeaponBaseGun
            // Field count: 0
            ...
            pub mod C_EconEntity {
                pub const m_flFlexDelayTime: usize = 0x1078; // 
                pub const m_flFlexDelayedWeight: usize = 0x1080; // 
                pub const m_bAttributesInitialized: usize = 0x1088; // 
                pub const m_AttributeManager: usize = 0x1090; // 
                pub const m_OriginalOwnerXuidLow: usize = 0x1538; // 
                pub const m_OriginalOwnerXuidHigh: usize = 0x153C; // 
                pub const m_nFallbackPaintKit: usize = 0x1540; // 
                pub const m_nFallbackSeed: usize = 0x1544; // 
                pub const m_flFallbackWear: usize = 0x1548; // 
                pub const m_nFallbackStatTrak: usize = 0x154C; // 
                pub const m_bClientside: usize = 0x1550; // 
                pub const m_bParticleSystemsCreated: usize = 0x1551; // 
                pub const m_vecAttachedParticles: usize = 0x1558; // 
                pub const m_hViewmodelAttachment: usize = 0x1570; // 
                pub const m_iOldTeam: usize = 0x1574; // 
                pub const m_bAttachmentDirty: usize = 0x1578; // 
                pub const m_nUnloadedModelIndex: usize = 0x157C; // 
                pub const m_iNumOwnerValidationRetries: usize = 0x1580; // 
                pub const m_hOldProvidee: usize = 0x1590; // 
            ...
            pub mod C_ParticleSystem {
                pub const m_szSnapshotFileName: usize = 0xCC8; // 
                pub const m_bActive: usize = 0xEC8; // 
                pub const m_bFrozen: usize = 0xEC9; // 
                pub const m_flFreezeTransitionDuration: usize = 0xECC; // 
                pub const m_nStopType: usize = 0xED0; // 
                pub const m_bAnimateDuringGameplayPause: usize = 0xED4; // 
                pub const m_iEffectIndex: usize = 0xED8; // 
                pub const m_flStartTime: usize = 0xEE0; // 
                pub const m_flPreSimTime: usize = 0xEE4; // 
                pub const m_vServerControlPoints: usize = 0xEE8; // 
                pub const m_iServerControlPointAssignments: usize = 0xF18; // 
                pub const m_hControlPointEnts: usize = 0xF1C; // 
                pub const m_bNoSave: usize = 0x101C; // 
                pub const m_bNoFreeze: usize = 0x101D; // 
                pub const m_bNoRamp: usize = 0x101E; // 
                pub const m_bStartActive: usize = 0x101F; // 
                pub const m_iszEffectName: usize = 0x1020; // 
                pub const m_iszControlPointNames: usize = 0x1028; // 
                pub const m_nDataCP: usize = 0x1228; // 
                pub const m_vecDataCPValue: usize = 0x122C; // 
                pub const m_nTintCP: usize = 0x1238; // 
                pub const m_clrTint: usize = 0x123C; // 
                pub const m_bOldActive: usize = 0x1260; // 
                pub const m_bOldFrozen: usize = 0x1261; // 
            }
            ...
            pub mod C_CSGameRulesProxy {
                pub const m_pGameRules: usize = 0x548; // 
            }
            // Parent: CPlayerPawnComponent
            // Field count: 6
            //
            ...
            pub mod C_Multimeter {
                pub const m_hTargetC4: usize = 0xED8; // 
            }
            // Parent: C_BaseEntity
            // Field count: 2
            pub mod C_CsmFovOverride {
                pub const m_cameraName: usize = 0x548; // 
                pub const m_flCsmFovOverrideValue: usize = 0x550; // 
            }
            // Parent: C_BaseModelEntity
            // Field count: 9
            //
            ...
            pub mod C_EnvDecal {
                ...
                pub const m_flWidth: usize = 0xCD0; // 
                pub const m_flHeight: usize = 0xCD4; // 
                pub const m_flDepth: usize = 0xCD8; // 
                pub const m_nRenderOrder: usize = 0xCDC; // 
                pub const m_bProjectOnWorld: usize = 0xCE0; // 
                pub const m_bProjectOnCharacters: usize = 0xCE1; // 
                pub const m_bProjectOnWater: usize = 0xCE2; // 
                pub const m_flDepthSortBias: usize = 0xCE4; // 
            }
            // Parent: CCSGameModeRules
            // Field count: 0
            ...
            pub mod C_ColorCorrection {
                pub const m_vecOrigin: usize = 0x548; // 
                pub const m_MinFalloff: usize = 0x554; // 
                pub const m_MaxFalloff: usize = 0x558; // 
                pub const m_flFadeInDuration: usize = 0x55C; // 
                pub const m_flFadeOutDuration: usize = 0x560; // 
                pub const m_flMaxWeight: usize = 0x564; // 
                pub const m_flCurWeight: usize = 0x568; // 
                pub const m_netlookupFilename: usize = 0x56C; // 
                pub const m_bEnabled: usize = 0x76C; // 
                pub const m_bMaster: usize = 0x76D; // 
                pub const m_bClientSide: usize = 0x76E; // 
                pub const m_bExclusive: usize = 0x76F; // 
                pub const m_bEnabledOnClient: usize = 0x770; // 
                pub const m_flCurWeightOnClient: usize = 0x774; // 
                pub const m_bFadingIn: usize = 0x778; // 
                pub const m_flFadeStartWeight: usize = 0x77C; // 
                pub const m_flFadeStartTime: usize = 0x780; // 
                pub const m_flFadeDuration: usize = 0x784; // 
            }
            // Parent: C_BaseTrigger
            // Field count: 0
            ...
            pub mod C_BaseDoor {
                pub const m_bIsUsable: usize = 0xCC8; // 
            }
            // Parent: C_BaseModelEntity
            // Field count: 2
            pub mod CGrenadeTracer {
                pub const m_flTracerDuration: usize = 0xCE8; // 
                pub const m_nType: usize = 0xCEC; // 
            }
            // Parent: C_BaseTrigger
            // Field count: 1
            //
            ...
            pub mod CBombTarget {
                pub const m_bBombPlantedHere: usize = 0xCD0; // 
            }
            // Parent: C_BaseClientUIEntity
            // Field count: 2
            //
            ...
            pub mod C_PointClientUIDialog {
                pub const m_hActivator: usize = 0xCF8; // 
                pub const m_bStartEnabled: usize = 0xCFC; // 
            }
            // Parent: CCSGameModeRules
            // Field count: 1
            //
            ...
            pub mod C_HandleTest {
                pub const m_Handle: usize = 0x548; // 
                pub const m_bSendHandle: usize = 0x54C; // 
            }
            // Parent: C_BaseEntity
            // Field count: 1
            //
            ...
            pub mod C_WeaponShield {
                pub const m_flDisplayHealth: usize = 0x1A90; // 
            }
            // Parent: C_PointClientUIWorldPanel
            // Field count: 1
            //
            ...
            pub mod C_PointClientUIWorldTextPanel {
                pub const m_messageText: usize = 0xF30; // 
            }
            // Parent: CPlayer_UseServices
            // Field count: 0
            ...
            pub mod C_EnvParticleGlow {
                pub const m_flAlphaScale: usize = 0x1278; // 
                pub const m_flRadiusScale: usize = 0x127C; // 
                pub const m_flSelfIllumScale: usize = 0x1280; // 
                pub const m_ColorTint: usize = 0x1284; // 
                pub const m_hTextureOverride: usize = 0x1288; // 
            }
            // Parent: C_BaseEntity
            // Field count: 0
            ...
            pub mod C_Sun {
                pub const m_fxSSSunFlareEffectIndex: usize = 0xCC8; // 
                pub const m_fxSunFlareEffectIndex: usize = 0xCCC; // 
                pub const m_fdistNormalize: usize = 0xCD0; // 
                pub const m_vSunPos: usize = 0xCD4; // 
                pub const m_vDirection: usize = 0xCE0; // 
                pub const m_iszEffectName: usize = 0xCF0; // 
                pub const m_iszSSEffectName: usize = 0xCF8; // 
                pub const m_clrOverlay: usize = 0xD00; // 
                pub const m_bOn: usize = 0xD04; // 
                pub const m_bmaxColor: usize = 0xD05; // 
                pub const m_flSize: usize = 0xD08; // 
                pub const m_flHazeScale: usize = 0xD0C; // 
                pub const m_flRotation: usize = 0xD10; // 
                pub const m_flHDRColorScale: usize = 0xD14; // 
                pub const m_flAlphaHaze: usize = 0xD18; // 
                pub const m_flAlphaScale: usize = 0xD1C; // 
                pub const m_flAlphaHdr: usize = 0xD20; // 
                pub const m_flFarZScale: usize = 0xD24; // 
            }
            // Parent: C_BaseEntity
            // Field count: 0
            ...
            pub mod C_ColorCorrectionVolume {
                pub const m_LastEnterWeight: usize = 0xCD0; // 
                pub const m_LastEnterTime: usize = 0xCD4; // 
                pub const m_LastExitWeight: usize = 0xCD8; // 
                pub const m_LastExitTime: usize = 0xCDC; // 
                pub const m_bEnabled: usize = 0xCE0; // 
                pub const m_MaxWeight: usize = 0xCE4; // 
                pub const m_FadeDuration: usize = 0xCE8; // 
                pub const m_Weight: usize = 0xCEC; // 
                pub const m_lookupFilename: usize = 0xCF0; // 
            }
            // Parent: C_BaseModelEntity
            // Field count: 0
            ...
            pub mod C_BulletHitModel {
                pub const m_matLocal: usize = 0xED0; // 
                pub const m_iBoneIndex: usize = 0xF00; // 
                pub const m_hPlayerParent: usize = 0xF04; // 
                pub const m_bIsHit: usize = 0xF08; // 
                pub const m_flTimeCreated: usize = 0xF0C; // 
                pub const m_vecStartPos: usize = 0xF10; // 
            }
            // Parent: C_BaseEntity
            // Field count: 17
            //
            ...
            pub mod C_MapVetoPickController {
                pub const m_nDraftType: usize = 0x558; // 
                pub const m_nTeamWinningCoinToss: usize = 0x55C; // 
                pub const m_nTeamWithFirstChoice: usize = 0x560; // 
                pub const m_nVoteMapIdsList: usize = 0x660; // 
                pub const m_nAccountIDs: usize = 0x67C; // 
                pub const m_nMapId0: usize = 0x77C; // 
                pub const m_nMapId1: usize = 0x87C; // 
                pub const m_nMapId2: usize = 0x97C; // 
                pub const m_nMapId3: usize = 0xA7C; // 
                pub const m_nMapId4: usize = 0xB7C; // 
                pub const m_nMapId5: usize = 0xC7C; // 
                pub const m_nStartingSide0: usize = 0xD7C; // 
                pub const m_nCurrentPhase: usize = 0xE7C; // 
                pub const m_nPhaseStartTick: usize = 0xE80; // 
                pub const m_nPhaseDurationTicks: usize = 0xE84; // 
                pub const m_nPostDataUpdateTick: usize = 0xE88; // 
                pub const m_bDisabledHud: usize = 0xE8C; // 
            }
            // Parent: None
            // Field count: 0
            //
            ...
            // NetworkVarNames: m_bShowLight (bool)
            pub mod C_OmniLight {
                pub const m_flInnerAngle: usize = 0xF10; // 
                pub const m_flOuterAngle: usize = 0xF14; // 
                pub const m_bShowLight: usize = 0xF18; // 
            }
            // Parent: C_Inferno
            // Field count: 0
            ...
            pub mod C_FuncLadder {
                pub const m_vecLadderDir: usize = 0xCC8; // 
                pub const m_Dismounts: usize = 0xCD8; // 
                pub const m_vecLocalTop: usize = 0xCF0; // 
                pub const m_vecPlayerMountPositionTop: usize = 0xCFC; // 
                pub const m_vecPlayerMountPositionBottom: usize = 0xD08; // 
                pub const m_flAutoRideSpeed: usize = 0xD14; // 
                pub const m_bDisabled: usize = 0xD18; // 
                pub const m_bFakeLadder: usize = 0xD19; // 
                pub const m_bHasSlack: usize = 0xD1A; // 
            }
            ...
            pub mod C_BaseGrenade {
                pub const m_bHasWarnedAI: usize = 0x1068; // 
                pub const m_bIsSmokeGrenade: usize = 0x1069; // 
                pub const m_bIsLive: usize = 0x106A; // 
                pub const m_DmgRadius: usize = 0x106C; // 
                pub const m_flDetonateTime: usize = 0x1070; // 
                pub const m_flWarnAITime: usize = 0x1074; // 
                pub const m_flDamage: usize = 0x1078; // 
                pub const m_iszBounceSound: usize = 0x1080; // 
                pub const m_ExplosionSound: usize = 0x1088; // 
                pub const m_hThrower: usize = 0x1094; // 
                pub const m_flNextAttack: usize = 0x10AC; // 
                pub const m_hOriginalThrower: usize = 0x10B0; // 
            }
            // Parent: None
            // Field count: 1
            ...
            pub mod C_EnvVolumetricFogController {
                pub const m_flScattering: usize = 0x548; // 
                pub const m_flAnisotropy: usize = 0x54C; // 
                pub const m_flFadeSpeed: usize = 0x550; // 
                pub const m_flDrawDistance: usize = 0x554; // 
                pub const m_flFadeInStart: usize = 0x558; // 
                pub const m_flFadeInEnd: usize = 0x55C; // 
                pub const m_flIndirectStrength: usize = 0x560; // 
                pub const m_nIndirectTextureDimX: usize = 0x564; // 
                pub const m_nIndirectTextureDimY: usize = 0x568; // 
                pub const m_nIndirectTextureDimZ: usize = 0x56C; // 
                pub const m_vBoxMins: usize = 0x570; // 
                pub const m_vBoxMaxs: usize = 0x57C; // 
                pub const m_bActive: usize = 0x588; // 
                pub const m_flStartAnisoTime: usize = 0x58C; // 
                pub const m_flStartScatterTime: usize = 0x590; // 
                pub const m_flStartDrawDistanceTime: usize = 0x594; // 
                pub const m_flStartAnisotropy: usize = 0x598; // 
                pub const m_flStartScattering: usize = 0x59C; // 
                pub const m_flStartDrawDistance: usize = 0x5A0; // 
                pub const m_flDefaultAnisotropy: usize = 0x5A4; // 
                pub const m_flDefaultScattering: usize = 0x5A8; // 
                pub const m_flDefaultDrawDistance: usize = 0x5AC; // 
                pub const m_bStartDisabled: usize = 0x5B0; // 
                pub const m_bEnableIndirect: usize = 0x5B1; // 
                pub const m_bIndirectUseLPVs: usize = 0x5B2; // 
                pub const m_bIsMaster: usize = 0x5B3; // 
                pub const m_hFogIndirectTexture: usize = 0x5B8; // 
                pub const m_nForceRefreshCount: usize = 0x5C0; // 
                pub const m_fNoiseSpeed: usize = 0x5C4; // 
                pub const m_fNoiseStrength: usize = 0x5C8; // 
                pub const m_vNoiseScale: usize = 0x5CC; // 
                pub const m_bFirstTime: usize = 0x5D8; // 
            }
            // Parent: C_CSWeaponBaseGun
            // Field count: 0
            ...
            pub mod C_PointCommentaryNode {
                pub const m_bActive: usize = 0xED8; // 
                pub const m_bWasActive: usize = 0xED9; // 
                pub const m_flEndTime: usize = 0xEDC; // 
                pub const m_flStartTime: usize = 0xEE0; // 
                pub const m_flStartTimeInCommentary: usize = 0xEE4; // 
                pub const m_iszCommentaryFile: usize = 0xEE8; // 
                pub const m_iszTitle: usize = 0xEF0; // 
                pub const m_iszSpeakers: usize = 0xEF8; // 
                pub const m_iNodeNumber: usize = 0xF00; // 
                pub const m_iNodeNumberMax: usize = 0xF04; // 
                pub const m_bListenedTo: usize = 0xF08; // 
                pub const m_hViewPosition: usize = 0xF18; // 
                pub const m_bRestartAfterRestore: usize = 0xF1C; // 
            }
            // Parent: CCSPlayerBase_CameraServices
            // Field count: 0
            ...
            pub mod C_InfoVisibilityBox {
                pub const m_nMode: usize = 0x54C; // 
                pub const m_vBoxSize: usize = 0x550; // 
                pub const m_bEnabled: usize = 0x55C; // 
            }
            // Parent: C_Sprite
            // Field count: 2
            pub mod C_FireSprite {
                pub const m_vecMoveDir: usize = 0xDD8; // 
                pub const m_bFadeFromAbove: usize = 0xDE4; // 
            }
            // Parent: C_CSGO_TeamIntroCharacterPosition
            // Field count: 0
            ...
            pub mod C_Precipitation {
                pub const m_flDensity: usize = 0xCD0; // 
                pub const m_flParticleInnerDist: usize = 0xCE0; // 
                pub const m_pParticleDef: usize = 0xCE8; // 
                pub const m_tParticlePrecipTraceTimer: usize = 0xD10; // 
                pub const m_bActiveParticlePrecipEmitter: usize = 0xD18; // 
                pub const m_bParticlePrecipInitialized: usize = 0xD19; // 
                pub const m_bHasSimulatedSinceLastSceneObjectUpdate: usize = 0xD1A; // 
                pub const m_nAvailableSheetSequencesMaxIndex: usize = 0xD1C; // 
            }
            // Parent: CEntitySubclassVDataBase
            // Field count: 7
            //
            ...
            pub mod C_BaseClientUIEntity {
                pub const m_bEnabled: usize = 0xCD0; // 
                pub const m_DialogXMLName: usize = 0xCD8; // 
                pub const m_PanelClassName: usize = 0xCE0; // 
                pub const m_PanelID: usize = 0xCE8; // 
            }
            // Parent: C_BaseModelEntity
            // Field count: 3
            pub mod C_FuncTrackTrain {
                pub const m_nLongAxis: usize = 0xCC8; // 
                pub const m_flRadius: usize = 0xCCC; // 
                pub const m_flLineLength: usize = 0xCD0; // 
            }
            // Parent: CPlayerPawnComponent
            // Field count: 4
            //
            ...
            // Field count: 4
            pub mod CBaseProp {
                pub const m_bModelOverrodeBlockLOS: usize = 0xED0; // 
                pub const m_iShapeType: usize = 0xED4; // 
                pub const m_bConformToCollisionBounds: usize = 0xED8; // 
                pub const m_mPreferredCatchTransform: usize = 0xEDC; // 
            }
            // Parent: C_CSGO_PreviewPlayer
            // Field count: 0
            ...
            pub mod CPointTemplate {
                pub const m_iszWorldName: usize = 0x548; // 
                pub const m_iszSource2EntityLumpName: usize = 0x550; // 
                pub const m_iszEntityFilterName: usize = 0x558; // 
                pub const m_flTimeoutInterval: usize = 0x560; // 
                pub const m_bAsynchronouslySpawnEntities: usize = 0x564; // 
                pub const m_pOutputOnSpawned: usize = 0x568; // 
                ...
                pub const m_createdSpawnGroupHandles: usize = 0x598; // 
                pub const m_SpawnedEntityHandles: usize = 0x5B0; // 
                pub const m_ScriptSpawnCallback: usize = 0x5C8; // 
                pub const m_ScriptCallbackScope: usize = 0x5D0; // 
            }
            // Parent: C_CSWeaponBaseGun
            // Field count: 0
            ...
            pub mod C_CSGO_PreviewModel {
                pub const m_animgraph: usize = 0x1068; // 
                pub const m_animgraphCharacterModeString: usize = 0x1070; // 
                pub const m_defaultAnim: usize = 0x1078; // 
                pub const m_nDefaultAnimLoopMode: usize = 0x1080; // 
                pub const m_flInitialModelScale: usize = 0x1084; // 
                pub const m_sInitialWeaponState: usize = 0x1088; // 
            }
            // Parent: C_PointEntity
            // Field count: 5
            pub mod CInfoDynamicShadowHint {
                pub const m_bDisabled: usize = 0x548; // 
                pub const m_flRange: usize = 0x54C; // 
                pub const m_nImportance: usize = 0x550; // 
                pub const m_nLightChoice: usize = 0x554; // 
                pub const m_hLight: usize = 0x558; // 
            }
            // Parent: None
            // Field count: 0
            //
            ...
            pub mod C_TriggerPhysics {
                pub const m_gravityScale: usize = 0xCD0; // 
                pub const m_linearLimit: usize = 0xCD4; // 
                pub const m_linearDamping: usize = 0xCD8; // 
                pub const m_angularLimit: usize = 0xCDC; // 
                pub const m_angularDamping: usize = 0xCE0; // 
                pub const m_linearForce: usize = 0xCE4; // 
                pub const m_flFrequency: usize = 0xCE8; // 
                pub const m_flDampingRatio: usize = 0xCEC; // 
                pub const m_vecLinearForcePointAt: usize = 0xCF0; // 
                pub const m_bCollapseToForcePoint: usize = 0xCFC; // 
                pub const m_vecLinearForcePointAtWorld: usize = 0xD00; // 
                pub const m_vecLinearForceDirection: usize = 0xD0C; // 
                pub const m_bConvertToDebrisWhenPossible: usize = 0xD18; // 
            }
            // Parent: CPlayerPawnComponent
            // Field count: 2
            //
            ...
            pub mod C_EnvCubemap {
                pub const m_Entity_hCubemapTexture: usize = 0x5C8; // 
                pub const m_Entity_bCustomCubemapTexture: usize = 0x5D0; // 
                pub const m_Entity_flInfluenceRadius: usize = 0x5D4; // 
                pub const m_Entity_vBoxProjectMins: usize = 0x5D8; // 
                pub const m_Entity_vBoxProjectMaxs: usize = 0x5E4; // 
                pub const m_Entity_bMoveable: usize = 0x5F0; // 
                pub const m_Entity_nHandshake: usize = 0x5F4; // 
                pub const m_Entity_nEnvCubeMapArrayIndex: usize = 0x5F8; // 
                pub const m_Entity_nPriority: usize = 0x5FC; // 
                pub const m_Entity_flEdgeFadeDist: usize = 0x600; // 
                pub const m_Entity_vEdgeFadeDists: usize = 0x604; // 
                pub const m_Entity_flDiffuseScale: usize = 0x610; // 
                pub const m_Entity_bStartDisabled: usize = 0x614; // 
                pub const m_Entity_bDefaultEnvMap: usize = 0x615; // 
                pub const m_Entity_bDefaultSpecEnvMap: usize = 0x616; // 
                pub const m_Entity_bIndoorCubeMap: usize = 0x617; // 
                pub const m_Entity_bCopyDiffuseFromDefaultCubemap: usize = 0x618; // 
                pub const m_Entity_bEnabled: usize = 0x628; // 
            }
            // Parent: C_BaseViewModel
            // Field count: 3
            pub mod C_PredictedViewModel {
                pub const m_vPredictedLagOffset: usize = 0xF38; // 
                pub const m_targetSpeed: usize = 0xF44; // 
                pub const m_currentSpeed: usize = 0xF50; // 
            }
            // Parent: C_CSWeaponBaseGun
            // Field count: 0
            ...
            pub mod C_PointValueRemapper {
                pub const m_bDisabled: usize = 0x548; // 
                pub const m_bDisabledOld: usize = 0x549; // 
                pub const m_bUpdateOnClient: usize = 0x54A; // 
                pub const m_nInputType: usize = 0x54C; // 
                pub const m_hRemapLineStart: usize = 0x550; // 
                pub const m_hRemapLineEnd: usize = 0x554; // 
                pub const m_flMaximumChangePerSecond: usize = 0x558; // 
                pub const m_flDisengageDistance: usize = 0x55C; // 
                pub const m_flEngageDistance: usize = 0x560; // 
                pub const m_bRequiresUseKey: usize = 0x564; // 
                pub const m_nOutputType: usize = 0x568; // 
                pub const m_hOutputEntities: usize = 0x570; // 
                pub const m_nHapticsType: usize = 0x588; // 
                pub const m_nMomentumType: usize = 0x58C; // 
                pub const m_flMomentumModifier: usize = 0x590; // 
                pub const m_flSnapValue: usize = 0x594; // 
                pub const m_flCurrentMomentum: usize = 0x598; // 
                pub const m_nRatchetType: usize = 0x59C; // 
                pub const m_flRatchetOffset: usize = 0x5A0; // 
                pub const m_flInputOffset: usize = 0x5A4; // 
                pub const m_bEngaged: usize = 0x5A8; // 
                pub const m_bFirstUpdate: usize = 0x5A9; // 
                pub const m_flPreviousValue: usize = 0x5AC; // 
                pub const m_flPreviousUpdateTickTime: usize = 0x5B0; // 
                pub const m_vecPreviousTestPoint: usize = 0x5B4; // 
            }
            // Parent: C_CSWeaponBase
            // Field count: 0
            pub mod C_Knife {
            ...
            pub mod C_ItemDogtags {
                pub const m_OwningPlayer: usize = 0x16B0; // 
                pub const m_KillingPlayer: usize = 0x16B4; // 
            }
            // Parent: C_CSGO_TeamPreviewCamera
            // Field count: 0
            ...
            pub mod C_SoundOpvarSetPointBase {
                pub const m_iszStackName: usize = 0x548; // 
                pub const m_iszOperatorName: usize = 0x550; // 
                pub const m_iszOpvarName: usize = 0x558; // 
                pub const m_iOpvarIndex: usize = 0x560; // 
                pub const m_bUseAutoCompare: usize = 0x564; // 
            }
            // Parent: C_Breakable
            // Field count: 0
            pub mod C_PhysBox {
            ...
            pub mod C_WeaponTaser {
                pub const m_fFireTime: usize = 0x1A90; // 
                pub const m_nLastAttackTick: usize = 0x1A94; // 
            }
            // Parent: C_CSWeaponBase
            // Field count: 2
            //
            ...
            pub mod C_Fists {
                pub const m_bPlayingUninterruptableAct: usize = 0x1A70; // 
                pub const m_nUninterruptableActivity: usize = 0x1A74; // 
            }
            ...
            pub mod CInfoDynamicShadowHintBox {
                pub const m_vBoxMins: usize = 0x560; // 
                pub const m_vBoxMaxs: usize = 0x56C; // 
            }
            // Parent: C_SoundOpvarSetPointEntity
            // Field count: 0
            ...
            pub mod C_EnvCubemapFog {
                pub const m_flEndDistance: usize = 0x548; // 
                pub const m_flStartDistance: usize = 0x54C; // 
                pub const m_flFogFalloffExponent: usize = 0x550; // 
                pub const m_bHeightFogEnabled: usize = 0x554; // 
                pub const m_flFogHeightWidth: usize = 0x558; // 
                pub const m_flFogHeightEnd: usize = 0x55C; // 
                pub const m_flFogHeightStart: usize = 0x560; // 
                pub const m_flFogHeightExponent: usize = 0x564; // 
                pub const m_flLODBias: usize = 0x568; // 
                pub const m_bActive: usize = 0x56C; // 
                pub const m_bStartDisabled: usize = 0x56D; // 
                pub const m_flFogMaxOpacity: usize = 0x570; // 
                pub const m_nCubemapSourceType: usize = 0x574; // 
                pub const m_hSkyMaterial: usize = 0x578; // CStrongHandle<InfoForResourceTypeIMaterial2>
                pub const m_iszSkyEntity: usize = 0x580; // 
                pub const m_hFogCubemapTexture: usize = 0x588; // 
                pub const m_bHasHeightFogEnd: usize = 0x590; // 
                pub const m_bFirstTime: usize = 0x591; // 
            }
            // Parent: C_CSWeaponBase
            // Field count: 0
            ...
            pub mod C_PlayerSprayDecal {
                pub const m_nUniqueID: usize = 0xCC8; // 
                pub const m_unAccountID: usize = 0xCCC; // 
                pub const m_unTraceID: usize = 0xCD0; // 
                pub const m_rtGcTime: usize = 0xCD4; // 
                pub const m_vecEndPos: usize = 0xCD8; // 
                pub const m_vecStart: usize = 0xCE4; // 
                pub const m_vecLeft: usize = 0xCF0; // 
                pub const m_vecNormal: usize = 0xCFC; // 
                pub const m_nPlayer: usize = 0xD08; // 
                pub const m_nEntity: usize = 0xD0C; // 
                pub const m_nHitbox: usize = 0xD10; // 
                pub const m_flCreationTime: usize = 0xD14; // 
                pub const m_nTintID: usize = 0xD18; // 
                pub const m_nVersion: usize = 0xD1C; // 
                pub const m_ubSignature: usize = 0xD1D; // 
                pub const m_SprayRenderHelper: usize = 0xDA8; // 
            }
            // Parent: None
            // Field count: 2
            //
            ...
            pub mod C_ShatterGlassShardPhysics {
                pub const m_ShardDesc: usize = 0x1050; // 
            }
            // Parent: C_CSWeaponBaseGun
            // Field count: 0
            ...
            pub mod C_LightEntity {
                pub const m_CLightComponent: usize = 0xCC8; // 
            }
            // Parent: C_BaseEntity
            // Field count: 6
            //
            ...
            pub mod C_PlayerVisibility {
                pub const m_flVisibilityStrength: usize = 0x548; // 
                pub const m_flFogDistanceMultiplier: usize = 0x54C; // 
                pub const m_flFogMaxDensityMultiplier: usize = 0x550; // 
                pub const m_flFadeTime: usize = 0x554; // 
                pub const m_bStartDisabled: usize = 0x558; // 
                pub const m_bIsEnabled: usize = 0x559; // 
            }
            // Parent: None
            // Field count: 25
            //
            ...
            pub mod C_BaseFlex {
                ...
                pub const m_vLookTargetPosition: usize = 0xEF8; // 
                pub const m_blinktoggle: usize = 0xF10; // 
                pub const m_nLastFlexUpdateFrameCount: usize = 0xF70; // 
                pub const m_CachedViewTarget: usize = 0xF74; // 
                pub const m_nNextSceneEventId: usize = 0xF80; // 
                pub const m_iBlink: usize = 0xF84; // 
                pub const m_blinktime: usize = 0xF88; // 
                pub const m_prevblinktoggle: usize = 0xF8C; // 
                pub const m_iJawOpen: usize = 0xF90; // 
                pub const m_flJawOpenAmount: usize = 0xF94; // 
                pub const m_flBlinkAmount: usize = 0xF98; // 
                pub const m_iMouthAttachment: usize = 0xF9C; // 
                pub const m_iEyeAttachment: usize = 0xF9D; // 
                pub const m_bResetFlexWeightsOnModelChange: usize = 0xF9E; // 
                pub const m_nEyeOcclusionRendererBone: usize = 0xFB8; // 
                pub const m_mEyeOcclusionRendererCameraToBoneTransform: usize = 0xFBC; // 
                pub const m_vEyeOcclusionRendererHalfExtent: usize = 0xFEC; // 
            ...
            pub mod C_RagdollManager {
                pub const m_iCurrentMaxRagdollCount: usize = 0x548; // 
            }
            // Parent: C_BaseModelEntity
            // Field count: 12
            //
            ...
            pub mod C_EnvSky {
                ...
                pub const m_bStartDisabled: usize = 0xCD8; // 
                pub const m_vTintColor: usize = 0xCD9; // 
                pub const m_vTintColorLightingOnly: usize = 0xCDD; // 
                pub const m_flBrightnessScale: usize = 0xCE4; // 
                pub const m_nFogType: usize = 0xCE8; // 
                pub const m_flFogMinStart: usize = 0xCEC; // 
                pub const m_flFogMinEnd: usize = 0xCF0; // 
                pub const m_flFogMaxStart: usize = 0xCF4; // 
                pub const m_flFogMaxEnd: usize = 0xCF8; // 
                pub const m_bEnabled: usize = 0xCFC; // 
            }
            // Parent: C_PointEntity
            // Field count: 0
            pub mod CInfoTarget {
            ...
            pub mod C_DynamicProp {
                ...
                pub const m_bUseAnimGraph: usize = 0x1041; // 
                pub const m_pOutputAnimBegun: usize = 0x1048; // 
                pub const m_pOutputAnimOver: usize = 0x1070; // 
                pub const m_pOutputAnimLoopCycleOver: usize = 0x1098; // 
                pub const m_OnAnimReachedStart: usize = 0x10C0; // 
                pub const m_OnAnimReachedEnd: usize = 0x10E8; // 
                pub const m_iszIdleAnim: usize = 0x1110; // 
                pub const m_nIdleAnimLoopMode: usize = 0x1118; // 
                pub const m_bRandomizeCycle: usize = 0x111C; // 
                pub const m_bStartDisabled: usize = 0x111D; // 
                pub const m_bFiredStartEndOutput: usize = 0x111E; // 
                pub const m_bForceNpcExclude: usize = 0x111F; // 
                pub const m_bCreateNonSolid: usize = 0x1120; // 
                pub const m_bIsOverrideProp: usize = 0x1121; // 
                pub const m_iInitialGlowState: usize = 0x1124; // 
                pub const m_nGlowRange: usize = 0x1128; // 
                pub const m_nGlowRangeMin: usize = 0x112C; // 
                pub const m_glowColor: usize = 0x1130; // 
                pub const m_nGlowTeam: usize = 0x1134; // 
                pub const m_iCachedFrameCount: usize = 0x1138; // 
                pub const m_vecCachedRenderMins: usize = 0x113C; // 
                pub const m_vecCachedRenderMaxs: usize = 0x1148; // 
            }
            // Parent: CEntityComponent
            // Field count: 10
            ...
            pub mod CCitadelSoundOpvarSetOBB {
                ...
                pub const m_vDistanceInnerMins: usize = 0x578; // 
                pub const m_vDistanceInnerMaxs: usize = 0x584; // 
                pub const m_vDistanceOuterMins: usize = 0x590; // 
                pub const m_vDistanceOuterMaxs: usize = 0x59C; // 
                pub const m_nAABBDirection: usize = 0x5A8; // 
            }
            // Parent: None
            // Field count: 5
            //
            ...
            pub mod C_LocalTempEntity {
                pub const flags: usize = 0xED0; // 
                pub const die: usize = 0xED4; // 
                pub const m_flFrameMax: usize = 0xED8; // 
                pub const x: usize = 0xEDC; // 
                pub const y: usize = 0xEE0; // 
                pub const fadeSpeed: usize = 0xEE4; // 
                pub const bounceFactor: usize = 0xEE8; // 
                pub const hitSound: usize = 0xEEC; // 
                pub const priority: usize = 0xEF0; // 
                pub const tentOffset: usize = 0xEF4; // 
                pub const m_vecTempEntAngVelocity: usize = 0xF00; // 
                pub const tempent_renderamt: usize = 0xF0C; // 
                pub const m_vecNormal: usize = 0xF10; // 
                pub const m_flSpriteScale: usize = 0xF1C; // 
                pub const m_nFlickerFrame: usize = 0xF20; // 
                pub const m_flFrameRate: usize = 0xF24; // 
                pub const m_flFrame: usize = 0xF28; // 
                pub const m_pszImpactEffect: usize = 0xF30; // 
                pub const m_pszParticleEffect: usize = 0xF38; // 
                pub const m_bParticleCollision: usize = 0xF40; // 
                pub const m_iLastCollisionFrame: usize = 0xF44; // 
                pub const m_vLastCollisionOrigin: usize = 0xF48; // 
                pub const m_vecTempEntVelocity: usize = 0xF54; // 
                pub const m_vecPrevAbsOrigin: usize = 0xF60; // 
                pub const m_vecTempEntAcceleration: usize = 0xF6C; // 
            }
            // Parent: None
            // Field count: 2
            ...
            pub mod C_MolotovProjectile {
                pub const m_bIsIncGrenade: usize = 0x1150; // 
            }
            ...
            pub mod CInfoOffscreenPanoramaTexture {
                pub const m_bDisabled: usize = 0x548; // 
                pub const m_nResolutionX: usize = 0x54C; // 
                pub const m_nResolutionY: usize = 0x550; // 
                pub const m_szLayoutFileName: usize = 0x558; // 
                pub const m_RenderAttrName: usize = 0x560; // 
                pub const m_TargetEntities: usize = 0x568; // 
                pub const m_nTargetChangeCount: usize = 0x580; // 
                pub const m_vecCSSClasses: usize = 0x588; // C_NetworkUtlVectorBase<CUtlSymbolLarge>
                pub const m_bCheckCSSClasses: usize = 0x700; // 
            }
            // Parent: C_BaseModelEntity
            // Field count: 7
            //
            ...
            pub mod C_DynamicLight {
                pub const m_Flags: usize = 0xCC8; // 
                pub const m_LightStyle: usize = 0xCC9; // 
                pub const m_Radius: usize = 0xCCC; // 
                pub const m_Exponent: usize = 0xCD0; // 
                pub const m_InnerAngle: usize = 0xCD4; // 
                pub const m_OuterAngle: usize = 0xCD8; // 
                pub const m_SpotRadius: usize = 0xCDC; // 
            }
            ...
            pub mod C_CSWeaponBase {
                pub const m_flFireSequenceStartTime: usize = 0x1624; // 
                pub const m_nFireSequenceStartTimeChange: usize = 0x1628; // 
                pub const m_nFireSequenceStartTimeAck: usize = 0x162C; // 
                pub const m_ePlayerFireEvent: usize = 0x1630; // 
                pub const m_ePlayerFireEventAttackType: usize = 0x1634; // 
                pub const m_seqIdle: usize = 0x1638; // 
                pub const m_seqFirePrimary: usize = 0x163C; // 
                pub const m_seqFireSecondary: usize = 0x1640; // 
                pub const m_thirdPersonFireSequences: usize = 0x1648; // 
                pub const m_hCurrentThirdPersonSequence: usize = 0x1660; // 
                pub const m_nSilencerBoneIndex: usize = 0x1664; // 
                pub const m_thirdPersonSequences: usize = 0x1668; // 
                pub const m_ClientPreviousWeaponState: usize = 0x16A0; // 
                pub const m_iState: usize = 0x16A4; // 
                pub const m_flCrosshairDistance: usize = 0x16A8; // 
                pub const m_iAmmoLastCheck: usize = 0x16AC; // 
                pub const m_iAlpha: usize = 0x16B0; // 
                pub const m_iScopeTextureID: usize = 0x16B4; // 
                pub const m_iCrosshairTextureID: usize = 0x16B8; // 
                pub const m_flGunAccuracyPositionDeprecated: usize = 0x16BC; // 
                pub const m_nLastEmptySoundCmdNum: usize = 0x16C0; // 
                pub const m_nViewModelIndex: usize = 0x16C4; // 
                pub const m_bReloadsWithClips: usize = 0x16C8; // 
                pub const m_flTimeWeaponIdle: usize = 0x16CC; // 
                pub const m_bFireOnEmpty: usize = 0x16D0; // 
                pub const m_OnPlayerPickup: usize = 0x16D8; // 
                pub const m_weaponMode: usize = 0x1700; // 
                pub const m_flTurningInaccuracyDelta: usize = 0x1704; // 
                pub const m_vecTurningInaccuracyEyeDirLast: usize = 0x1708; // 
                pub const m_flTurningInaccuracy: usize = 0x1714; // 
                pub const m_fAccuracyPenalty: usize = 0x1718; // 
                pub const m_flLastAccuracyUpdateTime: usize = 0x171C; // 
                pub const m_fAccuracySmoothedForZoom: usize = 0x1720; // 
                pub const m_fScopeZoomEndTime: usize = 0x1724; // 
                pub const m_iRecoilIndex: usize = 0x1728; // 
                pub const m_flRecoilIndex: usize = 0x172C; // 
                pub const m_bBurstMode: usize = 0x1730; // 
                pub const m_flLastBurstModeChangeTime: usize = 0x1734; // 
                pub const m_nPostponeFireReadyTicks: usize = 0x1738; // 
                pub const m_flPostponeFireReadyFrac: usize = 0x173C; // 
                pub const m_bInReload: usize = 0x1740; // 
                pub const m_bReloadVisuallyComplete: usize = 0x1741; // 
                pub const m_flDroppedAtTime: usize = 0x1744; // 
                pub const m_bIsHauledBack: usize = 0x1748; // 
                pub const m_bSilencerOn: usize = 0x1749; // 
                pub const m_flTimeSilencerSwitchComplete: usize = 0x174C; // 
                pub const m_iOriginalTeamNumber: usize = 0x1750; // 
                pub const m_iMostRecentTeamNumber: usize = 0x1754; // 
                pub const m_bDroppedNearBuyZone: usize = 0x1758; // 
                pub const m_flNextAttackRenderTimeOffset: usize = 0x175C; // 
                pub const m_bClearWeaponIdentifyingUGC: usize = 0x17F8; // 
                pub const m_bVisualsDataSet: usize = 0x17F9; // 
                pub const m_bOldFirstPersonSpectatedState: usize = 0x17FA; // 
                pub const m_bUIWeapon: usize = 0x17FB; // 
                pub const m_nCustomEconReloadEventId: usize = 0x17FC; // 
                pub const m_hPrevOwner: usize = 0x1808; // 
                pub const m_nDropTick: usize = 0x180C; // 
                pub const m_donated: usize = 0x182C; // 
                pub const m_fLastShotTime: usize = 0x1830; // 
                pub const m_bWasOwnedByCT: usize = 0x1834; // 
                pub const m_bWasOwnedByTerrorist: usize = 0x1835; // 
                pub const m_gunHeat: usize = 0x1838; // 
                pub const m_smokeAttachments: usize = 0x183C; // 
                pub const m_lastSmokeTime: usize = 0x1840; // 
                pub const m_flNextClientFireBulletTime: usize = 0x1844; // 
                pub const m_flNextClientFireBulletTime_Repredict: usize = 0x1848; // 
                pub const m_IronSightController: usize = 0x1920; // 
                pub const m_iIronSightMode: usize = 0x19D0; // 
                pub const m_flLastLOSTraceFailureTime: usize = 0x19E0; // 
                pub const m_iNumEmptyAttacks: usize = 0x19E4; // 
                pub const m_flLastMagDropRequestTime: usize = 0x1A60; // 
                pub const m_flWatTickOffset: usize = 0x1A64; // 
            }
            // Parent: C_BaseModelEntity
            // Field count: 0
            ...
            pub mod C_FuncElectrifiedVolume {
                pub const m_nAmbientEffect: usize = 0xCC8; // 
                pub const m_EffectName: usize = 0xCD0; // 
                pub const m_bState: usize = 0xCD8; // 
            }
            ...
            pub mod C_EnvDetailController {
                pub const m_flFadeStartDist: usize = 0x548; // 
                pub const m_flFadeEndDist: usize = 0x54C; // 
            }
            ...
            pub mod C_BaseEntity {
                ...
                pub const m_nLastThinkTick: usize = 0x300; // 
                pub const m_pGameSceneNode: usize = 0x308; // 
                pub const m_pRenderComponent: usize = 0x310; // 
                pub const m_pCollision: usize = 0x318; // 
                pub const m_iMaxHealth: usize = 0x320; // 
                pub const m_iHealth: usize = 0x324; // 
                pub const m_lifeState: usize = 0x328; // 
                pub const m_bTakesDamage: usize = 0x329; // 
                pub const m_nTakeDamageFlags: usize = 0x330; // 
                pub const m_bIsPlatform: usize = 0x338; // 
                pub const m_ubInterpolationFrame: usize = 0x339; // 
                ...
                pub const m_bDisabledContextThinks: usize = 0x388; // 
                pub const m_flAnimTime: usize = 0x38C; // 
                pub const m_flSimulationTime: usize = 0x390; // 
                pub const m_nSceneObjectOverrideFlags: usize = 0x394; // 
                pub const m_bHasSuccessfullyInterpolated: usize = 0x395; // 
                pub const m_bHasAddedVarsToInterpolation: usize = 0x396; // 
                pub const m_bRenderEvenWhenNotSuccessfullyInterpolated: usize = 0x397; // 
                pub const m_nInterpolationLatchDirtyFlags: usize = 0x398; // 
                pub const m_ListEntry: usize = 0x3A0; // 
                pub const m_flCreateTime: usize = 0x3B8; // 
                pub const m_flSpeed: usize = 0x3BC; // 
                pub const m_EntClientFlags: usize = 0x3C0; // 
                pub const m_bClientSideRagdoll: usize = 0x3C2; // 
                pub const m_iTeamNum: usize = 0x3C3; // 
                pub const m_spawnflags: usize = 0x3C4; // 
                pub const m_nNextThinkTick: usize = 0x3C8; // 
                pub const m_fFlags: usize = 0x3CC; // 
                pub const m_vecAbsVelocity: usize = 0x3D0; // 
                pub const m_vecVelocity: usize = 0x3E0; // CNetworkVelocityVector
                pub const m_vecBaseVelocity: usize = 0x410; // 
                pub const m_hEffectEntity: usize = 0x41C; // 
                pub const m_hOwnerEntity: usize = 0x420; // 
                pub const m_MoveCollide: usize = 0x424; // 
                pub const m_MoveType: usize = 0x425; // 
                pub const m_nActualMoveType: usize = 0x426; // 
                pub const m_flWaterLevel: usize = 0x428; // 
                pub const m_fEffects: usize = 0x42C; // 
                pub const m_hGroundEntity: usize = 0x430; // 
                pub const m_nGroundBodyIndex: usize = 0x434; // 
                pub const m_flFriction: usize = 0x438; // 
                pub const m_flElasticity: usize = 0x43C; // 
                pub const m_flGravityScale: usize = 0x440; // 
                pub const m_flTimeScale: usize = 0x444; // 
                pub const m_bAnimatedEveryTick: usize = 0x448; // 
                pub const m_flNavIgnoreUntilTime: usize = 0x44C; // 
                pub const m_hThink: usize = 0x450; // 
                pub const m_fBBoxVisFlags: usize = 0x460; // 
                pub const m_bPredictable: usize = 0x461; // 
                pub const m_bRenderWithViewModels: usize = 0x462; // 
                pub const m_nSplitUserPlayerPredictionSlot: usize = 0x464; // 
                pub const m_nFirstPredictableCommand: usize = 0x468; // 
                pub const m_nLastPredictableCommand: usize = 0x46C; // 
                pub const m_hOldMoveParent: usize = 0x470; // 
                pub const m_Particles: usize = 0x478; // 
                pub const m_vecPredictedScriptFloats: usize = 0x4A0; // 
                pub const m_vecPredictedScriptFloatIDs: usize = 0x4B8; // 
                pub const m_nNextScriptVarRecordID: usize = 0x4E8; // 
                pub const m_vecAngVelocity: usize = 0x4F8; // 
                pub const m_DataChangeEventRef: usize = 0x504; // 
                pub const m_dependencies: usize = 0x508; // 
                pub const m_nCreationTick: usize = 0x520; // 
                pub const m_bAnimTimeChanged: usize = 0x52D; // 
                pub const m_bSimulationTimeChanged: usize = 0x52E; // 
                pub const m_sUniqueHammerID: usize = 0x538; // 
                pub const m_nBloodType: usize = 0x540; // 
            }
            // Parent: None
            // Field count: 11
            //
            ...
            pub mod C_PhysicsProp {
                pub const m_bAwake: usize = 0x1040; // 
            }
            // Parent: CBaseProp
            // Field count: 26
            //
            ...
            pub mod C_BreakableProp {
                pub const m_CPropDataComponent: usize = 0xF10; // 
                pub const m_OnBreak: usize = 0xF50; // 
                pub const m_OnHealthChanged: usize = 0xF78; // CEntityOutputTemplate<float32>
                pub const m_OnTakeDamage: usize = 0xFA0; // 
                pub const m_impactEnergyScale: usize = 0xFC8; // 
                pub const m_iMinHealthDmg: usize = 0xFCC; // 
                pub const m_flPressureDelay: usize = 0xFD0; // 
                pub const m_flDefBurstScale: usize = 0xFD4; // 
                pub const m_vDefBurstOffset: usize = 0xFD8; // 
                pub const m_hBreaker: usize = 0xFE4; // 
                pub const m_PerformanceMode: usize = 0xFE8; // 
                pub const m_flPreventDamageBeforeTime: usize = 0xFEC; // 
                pub const m_bHasBreakPiecesOrCommands: usize = 0xFF0; // 
                pub const m_explodeDamage: usize = 0xFF4; // 
                pub const m_explodeRadius: usize = 0xFF8; // 
                pub const m_explosionDelay: usize = 0x1000; // 
                pub const m_explosionBuildupSound: usize = 0x1008; // 
                pub const m_explosionCustomEffect: usize = 0x1010; // 
                pub const m_explosionCustomSound: usize = 0x1018; // 
                pub const m_explosionModifier: usize = 0x1020; // 
                pub const m_hPhysicsAttacker: usize = 0x1028; // 
                pub const m_flLastPhysicsInfluenceTime: usize = 0x102C; // 
                pub const m_flDefaultFadeScale: usize = 0x1030; // 
                pub const m_hLastAttacker: usize = 0x1034; // 
                pub const m_hFlareEnt: usize = 0x1038; // 
                pub const m_noGhostCollision: usize = 0x103C; // 
            }
            // Parent: C_BaseToggle
            // Field count: 0
            //
            ...
            // NetworkVarNames: m_vecEndPos (Vector)
            pub mod C_Beam {
                pub const m_flFrameRate: usize = 0xCC8; // 
                pub const m_flHDRColorScale: usize = 0xCCC; // 
                pub const m_flFireTime: usize = 0xCD0; // 
                pub const m_flDamage: usize = 0xCD4; // 
                pub const m_nNumBeamEnts: usize = 0xCD8; // 
                pub const m_queryHandleHalo: usize = 0xCDC; // 
                ...
                pub const m_nBeamType: usize = 0xD10; // 
                pub const m_nBeamFlags: usize = 0xD14; // 
                pub const m_hAttachEntity: usize = 0xD18; // 
                pub const m_nAttachIndex: usize = 0xD40; // 
                pub const m_fWidth: usize = 0xD4C; // 
                pub const m_fEndWidth: usize = 0xD50; // 
                pub const m_fFadeLength: usize = 0xD54; // 
                pub const m_fHaloScale: usize = 0xD58; // 
                pub const m_fAmplitude: usize = 0xD5C; // 
                pub const m_fStartFrame: usize = 0xD60; // 
                pub const m_fSpeed: usize = 0xD64; // 
                pub const m_flFrame: usize = 0xD68; // 
                pub const m_nClipStyle: usize = 0xD6C; // 
                pub const m_bTurnedOff: usize = 0xD70; // 
                pub const m_vecEndPos: usize = 0xD74; // 
                pub const m_hEndEntity: usize = 0xD80; // 
            }
            // Parent: C_BaseEntity
            // Field count: 8
            //
            ...
            pub mod C_CSGO_TeamPreviewCharacterPosition {
                pub const m_nVariant: usize = 0x548; // 
                pub const m_nRandom: usize = 0x54C; // 
                pub const m_nOrdinal: usize = 0x550; // 
                pub const m_sWeaponName: usize = 0x558; // 
                pub const m_xuid: usize = 0x560; // 
                pub const m_agentItem: usize = 0x568; // 
                pub const m_glovesItem: usize = 0x9B0; // 
                pub const m_weaponItem: usize = 0xDF8; // 
            }
            // Parent: C_DynamicProp
            // Field count: 0
            ...
            pub mod C_EnvScreenOverlay {
                pub const m_iszOverlayNames: usize = 0x548; // 
                pub const m_flOverlayTimes: usize = 0x598; // 
                pub const m_flStartTime: usize = 0x5C0; // 
                pub const m_iDesiredOverlay: usize = 0x5C4; // 
                pub const m_bIsActive: usize = 0x5C8; // 
                pub const m_bWasActive: usize = 0x5C9; // 
                pub const m_iCachedDesiredOverlay: usize = 0x5CC; // 
                pub const m_iCurrentOverlay: usize = 0x5D0; // 
                pub const m_flCurrentOverlayTime: usize = 0x5D4; // 
            }
            ...
            pub mod C_PointWorldText {
                pub const m_bForceRecreateNextUpdate: usize = 0xCD0; // 
                pub const m_messageText: usize = 0xCE0; // 
                pub const m_FontName: usize = 0xEE0; // 
                pub const m_bEnabled: usize = 0xF20; // 
                pub const m_bFullbright: usize = 0xF21; // 
                pub const m_flWorldUnitsPerPx: usize = 0xF24; // 
                pub const m_flFontSize: usize = 0xF28; // 
                pub const m_flDepthOffset: usize = 0xF2C; // 
                pub const m_Color: usize = 0xF30; // 
                pub const m_nJustifyHorizontal: usize = 0xF34; // PointWorldTextJustifyHorizontal_t
                pub const m_nJustifyVertical: usize = 0xF38; // 
                pub const m_nReorientMode: usize = 0xF3C; // 
            }
            // Parent: C_BaseGrenade
            // Field count: 0
            ...
            pub mod CCSPlayerController {
                ...
                pub const m_iPing: usize = 0x710; // 
                pub const m_bHasCommunicationAbuseMute: usize = 0x714; // 
                pub const m_szCrosshairCodes: usize = 0x718; // 
                pub const m_iPendingTeamNum: usize = 0x720; // 
                pub const m_flForceTeamTime: usize = 0x724; // 
                pub const m_iCompTeammateColor: usize = 0x728; // 
                pub const m_bEverPlayedOnTeam: usize = 0x72C; // 
                pub const m_flPreviousForceJoinTeamTime: usize = 0x730; // 
                pub const m_szClan: usize = 0x738; // 
                pub const m_sSanitizedPlayerName: usize = 0x740; // 
                pub const m_iCoachingTeam: usize = 0x748; // 
                pub const m_nPlayerDominated: usize = 0x750; // 
                pub const m_nPlayerDominatingMe: usize = 0x758; // 
                pub const m_iCompetitiveRanking: usize = 0x760; // 
                pub const m_iCompetitiveWins: usize = 0x764; // 
                pub const m_iCompetitiveRankType: usize = 0x768; // 
                pub const m_iCompetitiveRankingPredicted_Win: usize = 0x76C; // 
                pub const m_iCompetitiveRankingPredicted_Loss: usize = 0x770; // 
                pub const m_iCompetitiveRankingPredicted_Tie: usize = 0x774; // 
                pub const m_nEndMatchNextMapVote: usize = 0x778; // 
                pub const m_unActiveQuestId: usize = 0x77C; // 
                pub const m_nQuestProgressReason: usize = 0x780; // 
                pub const m_unPlayerTvControlFlags: usize = 0x784; // 
                pub const m_iDraftIndex: usize = 0x7B0; // 
                pub const m_msQueuedModeDisconnectionTimestamp: usize = 0x7B4; // 
                pub const m_uiAbandonRecordedReason: usize = 0x7B8; // 
                pub const m_bCannotBeKicked: usize = 0x7BC; // 
                pub const m_bEverFullyConnected: usize = 0x7BD; // 
                pub const m_bAbandonAllowsSurrender: usize = 0x7BE; // 
                pub const m_bAbandonOffersInstantSurrender: usize = 0x7BF; // 
                pub const m_bDisconnection1MinWarningPrinted: usize = 0x7C0; // 
                pub const m_bScoreReported: usize = 0x7C1; // 
                pub const m_nDisconnectionTick: usize = 0x7C4; // 
                pub const m_bControllingBot: usize = 0x7D0; // 
                pub const m_bHasControlledBotThisRound: usize = 0x7D1; // 
                pub const m_bHasBeenControlledByPlayerThisRound: usize = 0x7D2; // 
                pub const m_nBotsControlledThisRound: usize = 0x7D4; // 
                pub const m_bCanControlObservedBot: usize = 0x7D8; // 
                pub const m_hPlayerPawn: usize = 0x7DC; // 
                pub const m_hObserverPawn: usize = 0x7E0; // 
                pub const m_bPawnIsAlive: usize = 0x7E4; // 
                pub const m_iPawnHealth: usize = 0x7E8; // 
                pub const m_iPawnArmor: usize = 0x7EC; // 
                pub const m_bPawnHasDefuser: usize = 0x7F0; // 
                pub const m_bPawnHasHelmet: usize = 0x7F1; // 
                pub const m_nPawnCharacterDefIndex: usize = 0x7F2; // 
                pub const m_iPawnLifetimeStart: usize = 0x7F4; // 
                pub const m_iPawnLifetimeEnd: usize = 0x7F8; // 
                pub const m_iPawnBotDifficulty: usize = 0x7FC; // 
                pub const m_hOriginalControllerOfCurrentPawn: usize = 0x800; // 
                pub const m_iScore: usize = 0x804; // 
                pub const m_vecKills: usize = 0x808; // C_NetworkUtlVectorBase<EKillTypes_t>
                pub const m_bMvpNoMusic: usize = 0x820; // 
                pub const m_eMvpReason: usize = 0x824; // 
                pub const m_iMusicKitID: usize = 0x828; // 
                pub const m_iMusicKitMVPs: usize = 0x82C; // 
                pub const m_iMVPs: usize = 0x830; // 
                pub const m_bIsPlayerNameDirty: usize = 0x834; // 
            }
            // Parent: C_CSWeaponBaseGun
            // Field count: 0
            ...
            pub mod C_BasePropDoor {
                pub const m_eDoorState: usize = 0x1168; // 
                pub const m_modelChanged: usize = 0x116C; // 
                pub const m_bLocked: usize = 0x116D; // 
                pub const m_closedPosition: usize = 0x1170; // 
                pub const m_closedAngles: usize = 0x117C; // 
                pub const m_hMaster: usize = 0x1188; // 
                pub const m_vWhereToSetLightingOrigin: usize = 0x118C; // 
            }
            // Parent: C_CSGO_TeamSelectCharacterPosition
            // Field count: 0
            ...
            pub mod C_PhysPropClientside {
                pub const m_flTouchDelta: usize = 0x1040; // 
                pub const m_fDeathTime: usize = 0x1044; // 
                pub const m_inertiaScale: usize = 0x1048; // 
                pub const m_vecDamagePosition: usize = 0x104C; // 
                pub const m_vecDamageDirection: usize = 0x1058; // 
                pub const m_nDamageType: usize = 0x1064; // 
            }
            // Parent: C_CSGO_TeamPreviewCamera
            // Field count: 0
            ...
            pub mod C_SoundAreaEntityBase {
                pub const m_bDisabled: usize = 0x548; // 
                pub const m_bWasEnabled: usize = 0x550; // 
                pub const m_iszSoundAreaType: usize = 0x558; // 
                pub const m_vPos: usize = 0x560; // 
            }
            // Parent: C_BaseEntity
            // Field count: 3
            //
            ...
            pub mod C_FogController {
                pub const m_fog: usize = 0x548; // 
                pub const m_bUseAngles: usize = 0x5B0; // 
                pub const m_iChangedVariables: usize = 0x5B4; // 
            }
            // Parent: CPlayerPawnComponent
            // Field count: 0
            ...
            pub mod CInfoWorldLayer {
                pub const m_pOutputOnEntitiesSpawned: usize = 0x548; // 
                pub const m_worldName: usize = 0x570; // 
                pub const m_layerName: usize = 0x578; // 
                pub const m_bWorldLayerVisible: usize = 0x580; // 
                pub const m_bEntitiesSpawned: usize = 0x581; // 
                pub const m_bCreateAsChildSpawnGroup: usize = 0x582; // 
                pub const m_hLayerSpawnGroup: usize = 0x584; // 
                pub const m_bWorldLayerActuallyVisible: usize = 0x588; // 
            }
            // Parent: C_BaseCombatCharacter
            // Field count: 0
            ...
            pub mod C_ViewmodelWeapon {
                pub const m_worldModel: usize = 0xED0; // 
            }
            // Parent: CBaseAnimGraph
            // Field count: 2
            pub mod C_PhysMagnet {
                pub const m_aAttachedObjectsFromServer: usize = 0xED0; // 
                pub const m_aAttachedObjects: usize = 0xEE8; // 
            }
            // Parent: C_BaseModelEntity
            // Field count: 8
            //
            ...
            pub mod C_FuncConveyor {
                pub const m_vecMoveDirEntitySpace: usize = 0xCD0; // 
                pub const m_flTargetSpeed: usize = 0xCDC; // 
                pub const m_nTransitionStartTick: usize = 0xCE0; // 
                pub const m_nTransitionDurationTicks: usize = 0xCE4; // 
                pub const m_flTransitionStartSpeed: usize = 0xCE8; // 
                pub const m_hConveyorModels: usize = 0xCF0; // 
                pub const m_flCurrentConveyorOffset: usize = 0xD08; // 
                pub const m_flCurrentConveyorSpeed: usize = 0xD0C; // 
            }
            // Parent: None
            // Field count: 4
            //
            ...
            pub mod C_BaseViewModel {
                pub const m_vecLastFacing: usize = 0xED8; // 
                pub const m_nViewModelIndex: usize = 0xEE4; // 
                pub const m_nAnimationParity: usize = 0xEE8; // 
                pub const m_flAnimationStartTime: usize = 0xEEC; // 
                pub const m_hWeapon: usize = 0xEF0; // 
                pub const m_sVMName: usize = 0xEF8; // 
                pub const m_sAnimationPrefix: usize = 0xF00; // 
                pub const m_hWeaponModel: usize = 0xF08; // 
                pub const m_iCameraAttachment: usize = 0xF0C; // 
                pub const m_vecLastCameraAngles: usize = 0xF10; // 
                pub const m_previousElapsedDuration: usize = 0xF1C; // 
                pub const m_previousCycle: usize = 0xF20; // 
                pub const m_nOldAnimationParity: usize = 0xF24; // 
                pub const m_hOldLayerSequence: usize = 0xF28; // 
                pub const m_oldLayer: usize = 0xF2C; // 
                pub const m_oldLayerStartTime: usize = 0xF30; // 
                pub const m_hControlPanel: usize = 0xF34; // 
            }
            ...
            pub mod C_CSObserverPawn {
                pub const m_hDetectParentChange: usize = 0x1460; // 
            }
            // Parent: C_BaseEntity
            // Field count: 3
            //
            ...
            pub mod C_EntityFlame {
                pub const m_hEntAttached: usize = 0x548; // 
                pub const m_hOldAttached: usize = 0x570; // 
                pub const m_bCheapEffect: usize = 0x574; // 
            }
            // Parent: C_BaseGrenade
            // Field count: 0
            ...
            pub mod C_Hostage {
                pub const m_entitySpottedState: usize = 0x10F8; // 
                pub const m_leader: usize = 0x1110; // 
                pub const m_reuseTimer: usize = 0x1118; // 
                pub const m_vel: usize = 0x1130; // 
                pub const m_isRescued: usize = 0x113C; // 
                pub const m_jumpedThisFrame: usize = 0x113D; // 
                pub const m_nHostageState: usize = 0x1140; // 
                pub const m_bHandsHaveBeenCut: usize = 0x1144; // 
                pub const m_hHostageGrabber: usize = 0x1148; // 
                pub const m_fLastGrabTime: usize = 0x114C; // 
                pub const m_vecGrabbedPos: usize = 0x1150; // 
                pub const m_flRescueStartTime: usize = 0x115C; // 
                pub const m_flGrabSuccessTime: usize = 0x1160; // 
                pub const m_flDropStartTime: usize = 0x1164; // 
                pub const m_flDeadOrRescuedTime: usize = 0x1168; // 
                pub const m_blinkTimer: usize = 0x1170; // 
                pub const m_lookAt: usize = 0x1188; // 
                pub const m_lookAroundTimer: usize = 0x1198; // 
                pub const m_isInit: usize = 0x11B0; // 
                pub const m_eyeAttachment: usize = 0x11B1; // 
                pub const m_chestAttachment: usize = 0x11B2; // 
                pub const m_pPredictionOwner: usize = 0x11B8; // 
                pub const m_fNewestAlphaThinkTime: usize = 0x11C0; // 
            }
            // Parent: C_BaseModelEntity
            // Field count: 24
            //
            ...
            pub mod C_Sprite {
                ...
                pub const m_hAttachedToEntity: usize = 0xCD0; // 
                pub const m_nAttachment: usize = 0xCD4; // 
                pub const m_flSpriteFramerate: usize = 0xCD8; // 
                pub const m_flFrame: usize = 0xCDC; // 
                pub const m_flDieTime: usize = 0xCE0; // 
                pub const m_nBrightness: usize = 0xCF0; // 
                pub const m_flBrightnessDuration: usize = 0xCF4; // 
                pub const m_flSpriteScale: usize = 0xCF8; // 
                pub const m_flScaleDuration: usize = 0xCFC; // 
                pub const m_bWorldSpaceScale: usize = 0xD00; // 
                pub const m_flGlowProxySize: usize = 0xD04; // 
                pub const m_flHDRColorScale: usize = 0xD08; // 
                pub const m_flLastTime: usize = 0xD0C; // 
                pub const m_flMaxFrame: usize = 0xD10; // 
                pub const m_flStartScale: usize = 0xD14; // 
                pub const m_flDestScale: usize = 0xD18; // 
                pub const m_flScaleTimeStart: usize = 0xD1C; // 
                pub const m_nStartBrightness: usize = 0xD20; // 
                pub const m_nDestBrightness: usize = 0xD24; // 
                pub const m_flBrightnessTimeStart: usize = 0xD28; // 
                pub const m_hOldSpriteMaterial: usize = 0xD30; // 
                pub const m_nSpriteWidth: usize = 0xDD0; // 
                pub const m_nSpriteHeight: usize = 0xDD4; // 
            }
            // Parent: C_CSWeaponBaseGun
            // Field count: 0
            ...
            // NetworkVarNames: m_hControlPanel (CHandle<CBaseEntity>)
            pub mod C_PlantedC4 {
                pub const m_bBombTicking: usize = 0xED0; // 
                pub const m_nBombSite: usize = 0xED4; // 
                pub const m_nSourceSoundscapeHash: usize = 0xED8; // 
                pub const m_entitySpottedState: usize = 0xEE0; // 
                pub const m_flNextGlow: usize = 0xEF8; // 
                pub const m_flNextBeep: usize = 0xEFC; // 
                pub const m_flC4Blow: usize = 0xF00; // 
                pub const m_bCannotBeDefused: usize = 0xF04; // 
                pub const m_bHasExploded: usize = 0xF05; // 
                pub const m_flTimerLength: usize = 0xF08; // 
                pub const m_bBeingDefused: usize = 0xF0C; // 
                pub const m_bTriggerWarning: usize = 0xF10; // 
                pub const m_bExplodeWarning: usize = 0xF14; // 
                pub const m_bC4Activated: usize = 0xF18; // 
                pub const m_bTenSecWarning: usize = 0xF19; // 
                pub const m_flDefuseLength: usize = 0xF1C; // 
                pub const m_flDefuseCountDown: usize = 0xF20; // 
                pub const m_bBombDefused: usize = 0xF24; // 
                pub const m_hBombDefuser: usize = 0xF28; // 
                pub const m_hControlPanel: usize = 0xF2C; // 
                pub const m_hDefuserMultimeter: usize = 0xF30; // 
                pub const m_flNextRadarFlashTime: usize = 0xF34; // 
                pub const m_bRadarFlash: usize = 0xF38; // 
                pub const m_pBombDefuser: usize = 0xF3C; // 
                pub const m_fLastDefuseTime: usize = 0xF40; // 
                pub const m_pPredictionOwner: usize = 0xF48; // 
                pub const m_vecC4ExplodeSpectatePos: usize = 0xF50; // 
                pub const m_vecC4ExplodeSpectateAng: usize = 0xF5C; // 
                pub const m_flC4ExplodeSpectateDuration: usize = 0xF68; // 
            }
            // Parent: CBaseAnimGraph
            // Field count: 8
            //
            ...
            pub mod C_RagdollProp {
                ...
                pub const m_flBlendWeight: usize = 0xF08; // 
                pub const m_hRagdollSource: usize = 0xF0C; // 
                pub const m_iEyeAttachment: usize = 0xF10; // 
                pub const m_flBlendWeightCurrent: usize = 0xF14; // 
                pub const m_parentPhysicsBoneIndices: usize = 0xF18; // 
                pub const m_worldSpaceBoneComputationOrder: usize = 0xF30; // 
            }
            // Parent: C_CSGO_TeamPreviewCamera
            // Field count: 0
            ...
            pub mod C_VoteController {
                pub const m_iActiveIssueIndex: usize = 0x558; // 
                pub const m_iOnlyTeamToVote: usize = 0x55C; // 
                pub const m_nVoteOptionCount: usize = 0x560; // 
                pub const m_nPotentialVotes: usize = 0x574; // 
                pub const m_bVotesDirty: usize = 0x578; // 
                pub const m_bTypeDirty: usize = 0x579; // 
                pub const m_bIsYesNoVote: usize = 0x57A; // 
            }
            // Parent: None
            // Field count: 3
            //
            ...
            // NetworkVarNames: m_AttributeManager (CAttributeContainer)
            pub mod C_Chicken {
                pub const m_hHolidayHatAddon: usize = 0x1160; // 
                pub const m_jumpedThisFrame: usize = 0x1164; // 
                pub const m_leader: usize = 0x1168; // 
                pub const m_AttributeManager: usize = 0x1170; // 
                pub const m_bAttributesInitialized: usize = 0x1618; // 
                pub const m_hWaterWakeParticles: usize = 0x161C; // 
                pub const m_bIsPreviewModel: usize = 0x1620; // 
            }
            // Parent: None
            // Field count: 4
            //
