...
pub mod cs2_dumper {
    pub mod schemas {
        ...
        pub mod client_dll {
            ...
            // Field count: 1
            pub mod C_Item {
                pub const m_pReticleHintTextName: usize = 0x1660; // 
            }
            ...
            pub mod C_BaseModelEntity {
                ...
                pub const m_bInitModelEffects: usize = 0xAA0; // 
                pub const m_bIsStaticProp: usize = 0xAA1; // 
                pub const m_nLastAddDecal: usize = 0xAA4; // 
                pub const m_nDecalsAdded: usize = 0xAA8; // 
                pub const m_iOldHealth: usize = 0xAAC; // 
                pub const m_nRenderMode: usize = 0xAB0; // 
                pub const m_nRenderFX: usize = 0xAB1; // 
                pub const m_bAllowFadeInView: usize = 0xAB2; // 
                pub const m_clrRender: usize = 0xAD0; // 
                pub const m_vecRenderAttributes: usize = 0xAD8; // 
                pub const m_bRenderToCubemaps: usize = 0xB40; // 
                pub const m_bNoInterpolate: usize = 0xB41; // 
                pub const m_Collision: usize = 0xB48; // 
                pub const m_Glow: usize = 0xBF8; // 
                pub const m_flGlowBackfaceMult: usize = 0xC50; // 
                pub const m_fadeMinDist: usize = 0xC54; // 
                pub const m_fadeMaxDist: usize = 0xC58; // 
                pub const m_flFadeScale: usize = 0xC5C; // 
                pub const m_flShadowStrength: usize = 0xC60; // 
                pub const m_nObjectCulling: usize = 0xC64; // 
                pub const m_nAddDecal: usize = 0xC68; // 
                pub const m_vDecalPosition: usize = 0xC6C; // 
                pub const m_vDecalForwardAxis: usize = 0xC78; // 
                pub const m_flDecalHealBloodRate: usize = 0xC84; // 
                pub const m_flDecalHealHeightRate: usize = 0xC88; // 
                pub const m_ConfigEntitiesToPropagateMaterialDecalsTo: usize = 0xC90; // 
                pub const m_vecViewOffset: usize = 0xCA8; // 
                pub const m_pClientAlphaProperty: usize = 0xCD8; // 
                pub const m_ClientOverrideTint: usize = 0xCE0; // 
                pub const m_bUseClientOverrideTint: usize = 0xCE4; // 
            }
            // Parent: C_BaseTrigger
            // Field count: 2
            //
            ...
            pub mod C_FootstepControl {
                pub const m_source: usize = 0xD28; // 
                pub const m_destination: usize = 0xD30; // 
            }
            ...
            pub mod C_PointClientUIHUD {
                pub const m_bCheckCSSClasses: usize = 0xD58; // 
                pub const m_bIgnoreInput: usize = 0xED8; // 
                pub const m_flWidth: usize = 0xEDC; // 
                pub const m_flHeight: usize = 0xEE0; // 
                pub const m_flDPI: usize = 0xEE4; // 
                pub const m_flInteractDistance: usize = 0xEE8; // 
                pub const m_flDepthOffset: usize = 0xEEC; // 
                pub const m_unOwnerContext: usize = 0xEF0; // 
                pub const m_unHorizontalAlign: usize = 0xEF4; // 
                pub const m_unVerticalAlign: usize = 0xEF8; // 
                pub const m_unOrientation: usize = 0xEFC; // 
                pub const m_bAllowInteractionFromAllSceneWorlds: usize = 0xF00; // 
            ...
            pub mod C_SpotlightEnd {
                pub const m_flLightScale: usize = 0xD20; // 
                pub const m_Radius: usize = 0xD24; // 
            }
            // Parent: None
            // Field count: 5
            //
            ...
            pub mod C_BaseCombatCharacter {
                pub const m_hMyWearables: usize = 0x1118; // 
                pub const m_leftFootAttachment: usize = 0x1130; // 
                pub const m_rightFootAttachment: usize = 0x1131; // 
                pub const m_nWaterWakeMode: usize = 0x1134; // 
                pub const m_flWaterWorldZ: usize = 0x1138; // 
                pub const m_flWaterNextTraceTime: usize = 0x113C; // 
            }
            ...
            pub mod C_BaseCSGrenade {
                pub const m_bClientPredictDelete: usize = 0x1B00; // 
                pub const m_bRedraw: usize = 0x1B01; // 
                pub const m_bIsHeldByPlayer: usize = 0x1B02; // 
                pub const m_bPinPulled: usize = 0x1B03; // 
                pub const m_bJumpThrow: usize = 0x1B04; // 
                pub const m_bThrowAnimating: usize = 0x1B05; // 
                pub const m_fThrowTime: usize = 0x1B08; // 
                pub const m_flThrowStrength: usize = 0x1B0C; // 
                pub const m_flThrowStrengthApproach: usize = 0x1B10; // 
                pub const m_fDropTime: usize = 0x1B14; // 
                pub const m_fPinPullTime: usize = 0x1B18; // 
                pub const m_bJustPulledPin: usize = 0x1B1C; // 
                pub const m_nNextHoldTick: usize = 0x1B20; // 
                pub const m_flNextHoldFrac: usize = 0x1B24; // 
                pub const m_hSwitchToWeaponAfterThrow: usize = 0x1B28; // 
            }
            // Parent: C_FuncBrush
            // Field count: 8
            //
            ...
            pub mod C_FuncMonitor {
                pub const m_targetCamera: usize = 0xD20; // 
                pub const m_nResolutionEnum: usize = 0xD28; // 
                pub const m_bRenderShadows: usize = 0xD2C; // 
                pub const m_bUseUniqueColorTarget: usize = 0xD2D; // 
                pub const m_brushModelName: usize = 0xD30; // 
                pub const m_hTargetCamera: usize = 0xD38; // 
                pub const m_bEnabled: usize = 0xD3C; // 
                pub const m_bDraw3DSkybox: usize = 0xD3D; // 
            }
            // Parent: C_BaseTrigger
            // Field count: 0
            ...
            pub mod C_LightGlow {
                pub const m_nHorizontalSize: usize = 0xD20; // 
                pub const m_nVerticalSize: usize = 0xD24; // 
                pub const m_nMinDist: usize = 0xD28; // 
                pub const m_nMaxDist: usize = 0xD2C; // 
                pub const m_nOuterMaxDist: usize = 0xD30; // 
                pub const m_flGlowProxySize: usize = 0xD34; // 
                pub const m_flHDRColorScale: usize = 0xD38; // 
                pub const m_GlowOverlay: usize = 0xD40; // 
            }
            // Parent: None
            // Field count: 4
            //
            ...
            pub mod C_ClientRagdoll {
                pub const m_bFadeOut: usize = 0xF80; // 
                pub const m_bImportant: usize = 0xF81; // 
                pub const m_flEffectTime: usize = 0xF84; // 
                pub const m_gibDespawnTime: usize = 0xF88; // 
                pub const m_iCurrentFriction: usize = 0xF8C; // 
                pub const m_iMinFriction: usize = 0xF90; // 
                pub const m_iMaxFriction: usize = 0xF94; // 
                pub const m_iFrictionAnimState: usize = 0xF98; // 
                pub const m_bReleaseRagdoll: usize = 0xF9C; // 
                pub const m_iEyeAttachment: usize = 0xF9D; // 
                pub const m_bFadingOut: usize = 0xF9E; // 
                pub const m_flScaleEnd: usize = 0xFA0; // 
                pub const m_flScaleTimeStart: usize = 0xFC8; // 
                pub const m_flScaleTimeEnd: usize = 0xFF0; // 
            }
            // Parent: C_BaseEntity
            // Field count: 1
            ...
            pub mod C_SmokeGrenadeProjectile {
                pub const m_nSmokeEffectTickBegin: usize = 0x1208; // 
                pub const m_bDidSmokeEffect: usize = 0x120C; // 
                pub const m_nRandomSeed: usize = 0x1210; // 
                pub const m_vSmokeColor: usize = 0x1214; // 
                pub const m_vSmokeDetonationPos: usize = 0x1220; // 
                pub const m_VoxelFrameData: usize = 0x1230; // 
                pub const m_bSmokeVolumeDataReceived: usize = 0x1248; // 
                pub const m_bSmokeEffectSpawned: usize = 0x1249; // 
            }
            // Parent: C_SoundEventEntity
            // Field count: 0
            ...
            pub mod C_Inferno {
                pub const m_nfxFireDamageEffect: usize = 0xD60; // 
                pub const m_hInfernoPointsSnapshot: usize = 0xD68; // 
                pub const m_hInfernoFillerPointsSnapshot: usize = 0xD70; // 
                pub const m_hInfernoOutlinePointsSnapshot: usize = 0xD78; // 
                pub const m_hInfernoClimbingOutlinePointsSnapshot: usize = 0xD80; // 
                pub const m_hInfernoDecalsSnapshot: usize = 0xD88; // 
                pub const m_firePositions: usize = 0xD90; // 
                pub const m_fireParentPositions: usize = 0x1090; // 
                pub const m_bFireIsBurning: usize = 0x1390; // 
                pub const m_BurnNormal: usize = 0x13D0; // 
                pub const m_fireCount: usize = 0x16D0; // 
                pub const m_nInfernoType: usize = 0x16D4; // 
                pub const m_nFireLifetime: usize = 0x16D8; // 
                pub const m_bInPostEffectTime: usize = 0x16DC; // 
                pub const m_lastFireCount: usize = 0x16E0; // 
                pub const m_nFireEffectTickBegin: usize = 0x16E4; // 
            ...
            pub mod C_CSPlayerPawn {
                pub const m_pBulletServices: usize = 0x1510; // 
                pub const m_pHostageServices: usize = 0x1518; // 
                pub const m_pBuyServices: usize = 0x1520; // 
                pub const m_pGlowServices: usize = 0x1528; // 
                pub const m_pActionTrackingServices: usize = 0x1530; // 
                pub const m_flHealthShotBoostExpirationTime: usize = 0x1538; // 
                pub const m_flLastFiredWeaponTime: usize = 0x153C; // 
                pub const m_bHasFemaleVoice: usize = 0x1540; // 
                pub const m_flLandingTimeSeconds: usize = 0x1544; // 
                pub const m_flOldFallVelocity: usize = 0x1548; // 
                pub const m_szLastPlaceName: usize = 0x154C; // 
                pub const m_bPrevDefuser: usize = 0x155E; // 
                pub const m_bPrevHelmet: usize = 0x155F; // 
                pub const m_nPrevArmorVal: usize = 0x1560; // 
                pub const m_nPrevGrenadeAmmoCount: usize = 0x1564; // 
                pub const m_unPreviousWeaponHash: usize = 0x1568; // 
                pub const m_unWeaponHash: usize = 0x156C; // 
                pub const m_bInBuyZone: usize = 0x1570; // 
                pub const m_bPreviouslyInBuyZone: usize = 0x1571; // 
                pub const m_aimPunchAngle: usize = 0x1574; // 
                pub const m_aimPunchAngleVel: usize = 0x1580; // 
                pub const m_aimPunchTickBase: usize = 0x158C; // 
                pub const m_aimPunchTickFraction: usize = 0x1590; // 
                pub const m_aimPunchCache: usize = 0x1598; // 
                pub const m_bInLanding: usize = 0x15B8; // 
                pub const m_flLandingStartTime: usize = 0x15BC; // 
                pub const m_bInHostageRescueZone: usize = 0x15C0; // 
                pub const m_bInBombZone: usize = 0x15C1; // 
                pub const m_bIsBuyMenuOpen: usize = 0x15C2; // 
                pub const m_flTimeOfLastInjury: usize = 0x15C4; // 
                pub const m_flNextSprayDecalTime: usize = 0x15C8; // 
                pub const m_iRetakesOffering: usize = 0x1700; // 
                pub const m_iRetakesOfferingCard: usize = 0x1704; // 
                pub const m_bRetakesHasDefuseKit: usize = 0x1708; // 
                pub const m_bRetakesMVPLastRound: usize = 0x1709; // 
                pub const m_iRetakesMVPBoostItem: usize = 0x170C; // 
                pub const m_RetakesMVPBoostExtraUtility: usize = 0x1710; // 
                pub const m_bNeedToReApplyGloves: usize = 0x1730; // 
                pub const m_EconGloves: usize = 0x1738; // 
                pub const m_nEconGlovesChanged: usize = 0x1B80; // 
                pub const m_bMustSyncRagdollState: usize = 0x1B81; // 
                pub const m_nRagdollDamageBone: usize = 0x1B84; // 
                pub const m_vRagdollDamageForce: usize = 0x1B88; // 
                pub const m_vRagdollDamagePosition: usize = 0x1B94; // 
                pub const m_szRagdollDamageWeaponName: usize = 0x1BA0; // 
                pub const m_bRagdollDamageHeadshot: usize = 0x1BE0; // 
                pub const m_vRagdollServerOrigin: usize = 0x1BE4; // 
                pub const m_bLastHeadBoneTransformIsValid: usize = 0x2268; // 
                pub const m_lastLandTime: usize = 0x226C; // 
                pub const m_bOnGroundLastTick: usize = 0x2270; // 
                pub const m_qDeathEyeAngles: usize = 0x228C; // 
                pub const m_bSkipOneHeadConstraintUpdate: usize = 0x2298; // 
                pub const m_bLeftHanded: usize = 0x2299; // 
                pub const m_fSwitchedHandednessTime: usize = 0x229C; // 
                pub const m_flViewmodelOffsetX: usize = 0x22A0; // 
                pub const m_flViewmodelOffsetY: usize = 0x22A4; // 
                pub const m_flViewmodelOffsetZ: usize = 0x22A8; // 
                pub const m_flViewmodelFOV: usize = 0x22AC; // 
                pub const m_vecPlayerPatchEconIndices: usize = 0x22B0; // 
                pub const m_GunGameImmunityColor: usize = 0x22E8; // 
                pub const m_vecBulletHitModels: usize = 0x2338; // 
                pub const m_bIsWalking: usize = 0x2350; // 
                pub const m_thirdPersonHeading: usize = 0x2358; // 
                pub const m_flSlopeDropOffset: usize = 0x2370; // 
                pub const m_flSlopeDropHeight: usize = 0x2380; // 
                pub const m_vHeadConstraintOffset: usize = 0x2390; // 
                pub const m_entitySpottedState: usize = 0x23A8; // 
                pub const m_bIsScoped: usize = 0x23C0; // 
                pub const m_bResumeZoom: usize = 0x23C1; // 
                pub const m_bIsDefusing: usize = 0x23C2; // 
                pub const m_bIsGrabbingHostage: usize = 0x23C3; // 
                pub const m_iBlockingUseActionInProgress: usize = 0x23C4; // 
                pub const m_flEmitSoundTime: usize = 0x23C8; // 
                pub const m_bInNoDefuseArea: usize = 0x23CC; // 
                pub const m_nWhichBombZone: usize = 0x23D0; // 
                pub const m_iShotsFired: usize = 0x23D4; // 
                pub const m_flFlinchStack: usize = 0x23D8; // 
                pub const m_flVelocityModifier: usize = 0x23DC; // 
                pub const m_flHitHeading: usize = 0x23E0; // 
                pub const m_nHitBodyPart: usize = 0x23E4; // 
                pub const m_bWaitForNoAttack: usize = 0x23E8; // 
                pub const m_ignoreLadderJumpTime: usize = 0x23EC; // 
                pub const m_bKilledByHeadshot: usize = 0x23F1; // 
                pub const m_ArmorValue: usize = 0x23F4; // 
                pub const m_unCurrentEquipmentValue: usize = 0x23F8; // 
                pub const m_unRoundStartEquipmentValue: usize = 0x23FA; // 
                pub const m_unFreezetimeEndEquipmentValue: usize = 0x23FC; // 
                pub const m_nLastKillerIndex: usize = 0x2400; // 
                pub const m_bOldIsScoped: usize = 0x2404; // 
                pub const m_bHasDeathInfo: usize = 0x2405; // 
                pub const m_flDeathInfoTime: usize = 0x2408; // 
                pub const m_vecDeathInfoOrigin: usize = 0x240C; // 
                pub const m_grenadeParameterStashTime: usize = 0x2418; // 
                pub const m_bGrenadeParametersStashed: usize = 0x241C; // 
                pub const m_angStashedShootAngles: usize = 0x2420; // 
                pub const m_vecStashedGrenadeThrowPosition: usize = 0x242C; // 
                pub const m_vecStashedVelocity: usize = 0x2438; // 
                pub const m_angShootAngleHistory: usize = 0x2444; // 
                pub const m_vecThrowPositionHistory: usize = 0x245C; // 
                pub const m_vecVelocityHistory: usize = 0x2474; // 
                pub const m_PredictedDamageTags: usize = 0x2490; // 
                pub const m_nPrevHighestReceivedDamageTagTick: usize = 0x24E0; // 
                pub const m_nHighestAppliedDamageTagTick: usize = 0x24E4; // 
            }
            ...
            pub mod C_RagdollPropAttached {
                pub const m_boneIndexAttached: usize = 0xFF8; // 
                pub const m_ragdollAttachedObjectIndex: usize = 0xFFC; // 
                pub const m_attachmentPointBoneSpace: usize = 0x1000; // 
                pub const m_attachmentPointRagdollSpace: usize = 0x100C; // 
                pub const m_vecOffset: usize = 0x1018; // 
                pub const m_parentTime: usize = 0x1024; // 
                pub const m_bHasParent: usize = 0x1028; // 
            }
            ...
            pub mod C_BaseCSGrenadeProjectile {
                pub const m_vInitialPosition: usize = 0x1168; // 
                pub const m_vInitialVelocity: usize = 0x1174; // 
                pub const m_nBounces: usize = 0x1180; // 
                pub const m_nExplodeEffectIndex: usize = 0x1188; // 
                pub const m_nExplodeEffectTickBegin: usize = 0x1190; // 
                pub const m_vecExplodeEffectOrigin: usize = 0x1194; // 
                pub const m_flSpawnTime: usize = 0x11A0; // 
                pub const vecLastTrailLinePos: usize = 0x11A4; // 
                pub const flNextTrailLineTime: usize = 0x11B0; // 
                pub const m_bExplodeEffectBegan: usize = 0x11B4; // 
                pub const m_bCanCreateGrenadeTrail: usize = 0x11B5; // 
                pub const m_nSnapshotTrajectoryEffectIndex: usize = 0x11B8; // 
                pub const m_hSnapshotTrajectoryParticleSnapshot: usize = 0x11C0; // 
                pub const m_arrTrajectoryTrailPoints: usize = 0x11C8; // 
                pub const m_arrTrajectoryTrailPointCreationTimes: usize = 0x11E0; // 
                pub const m_flTrajectoryTrailEffectCreationTime: usize = 0x11F8; // 
            }
            // Parent: C_BaseToggle
            // Field count: 2
            //
            ...
            pub mod C_BaseTrigger {
                pub const m_bDisabled: usize = 0xD20; // 
                pub const m_bClientSidePredicted: usize = 0xD21; // 
            }
            // Parent: C_CSWeaponBase
            // Field count: 2
            //
            ...
            pub mod C_WeaponBaseItem {
                pub const m_SequenceCompleteTimer: usize = 0x1B00; // 
                pub const m_bRedraw: usize = 0x1B18; // 
            }
            // Parent: None
            // Field count: 21
            //
            ...
            pub mod C_BaseButton {
                pub const m_glowEntity: usize = 0xD20; // 
                pub const m_usable: usize = 0xD24; // 
                pub const m_szDisplayText: usize = 0xD28; // 
            }
            ...
            pub mod C_PointClientUIWorldPanel {
                pub const m_bForceRecreateNextUpdate: usize = 0xD58; // 
                pub const m_bMoveViewToPlayerNextThink: usize = 0xD59; // 
                pub const m_bCheckCSSClasses: usize = 0xD5A; // 
                pub const m_anchorDeltaTransform: usize = 0xD60; // 
                pub const m_pOffScreenIndicator: usize = 0xEF8; // 
                pub const m_bIgnoreInput: usize = 0xF20; // 
                pub const m_bLit: usize = 0xF21; // 
                pub const m_bFollowPlayerAcrossTeleport: usize = 0xF22; // 
                pub const m_flWidth: usize = 0xF24; // 
                pub const m_flHeight: usize = 0xF28; // 
                pub const m_flDPI: usize = 0xF2C; // 
                pub const m_flInteractDistance: usize = 0xF30; // 
                pub const m_flDepthOffset: usize = 0xF34; // 
                pub const m_unOwnerContext: usize = 0xF38; // 
                pub const m_unHorizontalAlign: usize = 0xF3C; // 
                pub const m_unVerticalAlign: usize = 0xF40; // 
                pub const m_unOrientation: usize = 0xF44; // 
                pub const m_bAllowInteractionFromAllSceneWorlds: usize = 0xF48; // 
                pub const m_vecCSSClasses: usize = 0xF50; // C_NetworkUtlVectorBase<CUtlSymbolLarge>
                pub const m_bOpaque: usize = 0xF68; // 
                pub const m_bNoDepth: usize = 0xF69; // 
                pub const m_bRenderBackface: usize = 0xF6A; // 
                pub const m_bUseOffScreenIndicator: usize = 0xF6B; // 
                pub const m_bExcludeFromSaveGames: usize = 0xF6C; // 
                pub const m_bGrabbable: usize = 0xF6D; // 
                pub const m_bOnlyRenderToTexture: usize = 0xF6E; // 
                pub const m_bDisableMipGen: usize = 0xF6F; // 
                pub const m_nExplicitImageLayout: usize = 0xF70; // 
            }
            // Parent: C_BaseEntity
            // Field count: 0
            ...
            pub mod C_TextureBasedAnimatable {
                ...
                pub const m_flFPS: usize = 0xD24; // 
                pub const m_hPositionKeys: usize = 0xD28; // 
                pub const m_hRotationKeys: usize = 0xD30; // 
                pub const m_vAnimationBoundsMin: usize = 0xD38; // 
                pub const m_vAnimationBoundsMax: usize = 0xD44; // 
                pub const m_flStartTime: usize = 0xD50; // 
                pub const m_flStartFrame: usize = 0xD54; // 
            }
            ...
            pub mod CCSPlayerController_InventoryServices {
                ...
                pub const m_vecServerAuthoritativeWeaponSlots: usize = 0x70; // 
            }
            ...
            pub mod C_CSGOViewModel {
                pub const m_bShouldIgnoreOffsetAndAccuracy: usize = 0x1019; // 
                pub const m_nLastKnownAssociatedWeaponEntIndex: usize = 0x101C; // 
                pub const m_bNeedToQueueHighResComposite: usize = 0x1020; // 
                pub const m_vLoweredWeaponOffset: usize = 0x1070; // 
            }
            // Parent: CEntityComponent
            // Field count: 1
            ...
            pub mod C_ViewmodelAttachmentModel {
                pub const m_bShouldFrontFaceCullLeftHanded: usize = 0xF88; // 
                pub const m_bCreatedLeftHanded: usize = 0xF89; // 
            }
            // Parent: None
            // Field count: 0
            //
            ...
            pub mod CPointOffScreenIndicatorUi {
                pub const m_bBeenEnabled: usize = 0xF80; // 
                pub const m_bHide: usize = 0xF81; // 
                pub const m_flSeenTargetTime: usize = 0xF84; // 
                pub const m_pTargetPanel: usize = 0xF88; // 
            }
            // Parent: None
            // Field count: 0
            //
            ...
            pub mod C_CSWeaponBaseGun {
                pub const m_zoomLevel: usize = 0x1B00; // 
                pub const m_iBurstShotsRemaining: usize = 0x1B04; // 
                pub const m_iSilencerBodygroup: usize = 0x1B08; // 
                pub const m_silencedModelIndex: usize = 0x1B18; // 
                pub const m_inPrecache: usize = 0x1B1C; // 
                pub const m_bNeedsBoltAction: usize = 0x1B1D; // 
            }
            // Parent: C_BaseEntity
            // Field count: 4
            //
            ...
            pub mod C_EntityDissolve {
                pub const m_flStartTime: usize = 0xD28; // 
                pub const m_flFadeInStart: usize = 0xD2C; // 
                pub const m_flFadeInLength: usize = 0xD30; // 
                pub const m_flFadeOutModelStart: usize = 0xD34; // 
                pub const m_flFadeOutModelLength: usize = 0xD38; // 
                pub const m_flFadeOutStart: usize = 0xD3C; // 
                pub const m_flFadeOutLength: usize = 0xD40; // 
                pub const m_flNextSparkTime: usize = 0xD44; // 
                pub const m_nDissolveType: usize = 0xD48; // 
                pub const m_vDissolverOrigin: usize = 0xD4C; // 
                pub const m_nMagnitude: usize = 0xD58; // 
                pub const m_bCoreExplode: usize = 0xD5C; // 
                pub const m_bLinkedToServerEnt: usize = 0xD5D; // 
            }
            ...
            pub mod C_CSPlayerPawnBase {
                pub const m_pPingServices: usize = 0x1358; // 
                pub const m_pViewModelServices: usize = 0x1360; // 
                pub const m_fRenderingClipPlane: usize = 0x1368; // 
                pub const m_nLastClipPlaneSetupFrame: usize = 0x1378; // 
                pub const m_vecLastClipCameraPos: usize = 0x137C; // 
                pub const m_vecLastClipCameraForward: usize = 0x1388; // 
                pub const m_bClipHitStaticWorld: usize = 0x1394; // 
                pub const m_bCachedPlaneIsValid: usize = 0x1395; // 
                pub const m_pClippingWeapon: usize = 0x1398; // 
                pub const m_previousPlayerState: usize = 0x13A0; // 
                pub const m_iPlayerState: usize = 0x13A4; // 
                pub const m_bIsRescuing: usize = 0x13A8; // 
                pub const m_fImmuneToGunGameDamageTime: usize = 0x13AC; // 
                pub const m_fImmuneToGunGameDamageTimeLast: usize = 0x13B0; // 
                pub const m_bGunGameImmunity: usize = 0x13B4; // 
                pub const m_bHasMovedSinceSpawn: usize = 0x13B5; // 
                pub const m_fMolotovUseTime: usize = 0x13B8; // 
                pub const m_fMolotovDamageTime: usize = 0x13BC; // 
                pub const m_iThrowGrenadeCounter: usize = 0x13C0; // 
                pub const m_flLastSpawnTimeIndex: usize = 0x13C4; // 
                pub const m_iProgressBarDuration: usize = 0x13C8; // 
                pub const m_flProgressBarStartTime: usize = 0x13CC; // 
                pub const m_vecIntroStartEyePosition: usize = 0x13D0; // 
                pub const m_vecIntroStartPlayerForward: usize = 0x13DC; // 
                pub const m_flClientDeathTime: usize = 0x13E8; // 
                pub const m_bScreenTearFrameCaptured: usize = 0x13EC; // 
                pub const m_flFlashBangTime: usize = 0x13F0; // 
                pub const m_flFlashScreenshotAlpha: usize = 0x13F4; // 
                pub const m_flFlashOverlayAlpha: usize = 0x13F8; // 
                pub const m_bFlashBuildUp: usize = 0x13FC; // 
                pub const m_bFlashDspHasBeenCleared: usize = 0x13FD; // 
                pub const m_bFlashScreenshotHasBeenGrabbed: usize = 0x13FE; // 
                pub const m_flFlashMaxAlpha: usize = 0x1400; // 
                pub const m_flFlashDuration: usize = 0x1404; // 
                pub const m_iHealthBarRenderMaskIndex: usize = 0x1408; // 
                pub const m_flHealthFadeValue: usize = 0x140C; // 
                pub const m_flHealthFadeAlpha: usize = 0x1410; // 
                pub const m_flDeathCCWeight: usize = 0x1420; // 
                pub const m_flPrevRoundEndTime: usize = 0x1424; // 
                pub const m_flPrevMatchEndTime: usize = 0x1428; // 
                pub const m_angEyeAngles: usize = 0x1430; // 
                pub const m_fNextThinkPushAway: usize = 0x1448; // 
                pub const m_bShouldAutobuyDMWeapons: usize = 0x144C; // 
                pub const m_bShouldAutobuyNow: usize = 0x144D; // 
                pub const m_iIDEntIndex: usize = 0x1450; // 
                pub const m_delayTargetIDTimer: usize = 0x1458; // 
                pub const m_iTargetItemEntIdx: usize = 0x1470; // 
                pub const m_iOldIDEntIndex: usize = 0x1474; // 
                pub const m_holdTargetIDTimer: usize = 0x1478; // 
                pub const m_flCurrentMusicStartTime: usize = 0x1494; // 
                pub const m_flMusicRoundStartTime: usize = 0x1498; // 
                pub const m_bDeferStartMusicOnWarmup: usize = 0x149C; // 
                pub const m_cycleLatch: usize = 0x14A0; // 
                pub const m_serverIntendedCycle: usize = 0x14A4; // 
                pub const m_flLastSmokeOverlayAlpha: usize = 0x14A8; // 
                pub const m_flLastSmokeAge: usize = 0x14AC; // 
                pub const m_vLastSmokeOverlayColor: usize = 0x14B0; // 
                pub const m_nPlayerSmokedFx: usize = 0x14BC; // 
                pub const m_nPlayerInfernoBodyFx: usize = 0x14C0; // 
                pub const m_nPlayerInfernoFootFx: usize = 0x14C4; // 
                pub const m_flNextMagDropTime: usize = 0x14C8; // 
                pub const m_nLastMagDropAttachmentIndex: usize = 0x14CC; // 
                pub const m_vecLastAliveLocalVelocity: usize = 0x14D0; // 
                pub const m_bGuardianShouldSprayCustomXMark: usize = 0x14F8; // 
                pub const m_hOriginalController: usize = 0x1500; // 
            }
            ...
            pub mod C_PostProcessingVolume {
                pub const m_hPostSettings: usize = 0xD38; // 
                pub const m_flFadeDuration: usize = 0xD40; // 
                pub const m_flMinLogExposure: usize = 0xD44; // 
                pub const m_flMaxLogExposure: usize = 0xD48; // 
                pub const m_flMinExposure: usize = 0xD4C; // 
                pub const m_flMaxExposure: usize = 0xD50; // 
                pub const m_flExposureCompensation: usize = 0xD54; // 
                pub const m_flExposureFadeSpeedUp: usize = 0xD58; // 
                pub const m_flExposureFadeSpeedDown: usize = 0xD5C; // 
                pub const m_flTonemapEVSmoothingRange: usize = 0xD60; // 
                pub const m_bMaster: usize = 0xD64; // 
                pub const m_bExposureControl: usize = 0xD65; // 
                pub const m_flRate: usize = 0xD68; // 
                pub const m_flTonemapPercentTarget: usize = 0xD6C; // 
                pub const m_flTonemapPercentBrightPixels: usize = 0xD70; // 
                pub const m_flTonemapMinAvgLum: usize = 0xD74; // 
            }
            // Parent: CPlayerPawnComponent
            // Field count: 1
            //
            ...
            pub mod C_DecoyProjectile {
                pub const m_nDecoyShotTick: usize = 0x1200; // 
                pub const m_nClientLastKnownDecoyShotTick: usize = 0x1204; // 
                pub const m_flTimeParticleEffectSpawn: usize = 0x1228; // 
            }
            // Parent: CBaseAnimGraph
            // Field count: 0
            ...
            pub mod C_CSGO_PreviewPlayer {
                pub const m_animgraph: usize = 0x24E8; // 
                pub const m_animgraphCharacterModeString: usize = 0x24F0; // 
                pub const m_flInitialModelScale: usize = 0x24F8; // 
            }
            ...
            // NetworkVarNames: m_entitySpottedState (EntitySpottedState_t)
            pub mod C_C4 {
                pub const m_szScreenText: usize = 0x1B00; // 
                pub const m_activeLightParticleIndex: usize = 0x1B20; // 
                pub const m_eActiveLightEffect: usize = 0x1B24; // 
                pub const m_bStartedArming: usize = 0x1B28; // 
                pub const m_fArmedTime: usize = 0x1B2C; // 
                pub const m_bBombPlacedAnimation: usize = 0x1B30; // 
                pub const m_bIsPlantingViaUse: usize = 0x1B31; // 
                pub const m_entitySpottedState: usize = 0x1B38; // 
                pub const m_nSpotRules: usize = 0x1B50; // 
                pub const m_bPlayedArmingBeeps: usize = 0x1B54; // 
                pub const m_bBombPlanted: usize = 0x1B5B; // 
            }
            // Parent: C_BaseModelEntity
            // Field count: 13
            //
            ...
            pub mod CBaseAnimGraph {
                pub const m_bInitiallyPopulateInterpHistory: usize = 0xD98; // 
                pub const m_bSuppressAnimEventSounds: usize = 0xD9A; // 
                pub const m_bAnimGraphUpdateEnabled: usize = 0xDA8; // 
                pub const m_flMaxSlopeDistance: usize = 0xDAC; // 
                pub const m_vLastSlopeCheckPos: usize = 0xDB0; // 
                pub const m_bAnimationUpdateScheduled: usize = 0xDBC; // 
                pub const m_vecForce: usize = 0xDC0; // 
                pub const m_nForceBone: usize = 0xDCC; // 
                pub const m_pClientsideRagdoll: usize = 0xDD0; // 
                pub const m_bBuiltRagdoll: usize = 0xDD8; // 
                pub const m_RagdollPose: usize = 0xDF0; // 
                pub const m_bRagdollClientSide: usize = 0xE38; // 
                pub const m_bHasAnimatedMaterialAttributes: usize = 0xE48; // 
            }
            // Parent: C_CSWeaponBase
            // Field count: 0
            pub mod C_Melee {
            ...
            pub mod C_BasePlayerWeapon {
                pub const m_nNextPrimaryAttackTick: usize = 0x1660; // 
                pub const m_flNextPrimaryAttackTickRatio: usize = 0x1664; // 
                pub const m_nNextSecondaryAttackTick: usize = 0x1668; // 
                pub const m_flNextSecondaryAttackTickRatio: usize = 0x166C; // 
                pub const m_iClip1: usize = 0x1670; // 
                pub const m_iClip2: usize = 0x1674; // 
                pub const m_pReserveAmmo: usize = 0x1678; // 
            }
            ...
            pub mod CBasePlayerWeaponVData {
                ...
                pub const m_sMuzzleAttachment: usize = 0x1F0; // 
            ...
            pub mod C_Fish {
                pub const m_pos: usize = 0xF80; // 
                pub const m_vel: usize = 0xF8C; // 
                pub const m_angles: usize = 0xF98; // 
                pub const m_localLifeState: usize = 0xFA4; // 
                pub const m_deathDepth: usize = 0xFA8; // 
                pub const m_deathAngle: usize = 0xFAC; // 
                pub const m_buoyancy: usize = 0xFB0; // 
                pub const m_wiggleTimer: usize = 0xFB8; // 
                pub const m_wigglePhase: usize = 0xFD0; // 
                pub const m_wiggleRate: usize = 0xFD4; // 
                pub const m_actualPos: usize = 0xFD8; // 
                pub const m_actualAngles: usize = 0xFE4; // 
                pub const m_poolOrigin: usize = 0xFF0; // 
                pub const m_waterLevel: usize = 0xFFC; // 
                pub const m_gotUpdate: usize = 0x1000; // 
                pub const m_x: usize = 0x1004; // 
                pub const m_y: usize = 0x1008; // 
                pub const m_z: usize = 0x100C; // 
                pub const m_angle: usize = 0x1010; // 
                pub const m_errorHistory: usize = 0x1014; // 
                pub const m_errorHistoryIndex: usize = 0x1064; // 
                pub const m_errorHistoryCount: usize = 0x1068; // 
                pub const m_averageError: usize = 0x106C; // 
            }
            ...
            pub mod C_BasePlayerPawn {
                pub const m_pWeaponServices: usize = 0x11A0; // 
                pub const m_pItemServices: usize = 0x11A8; // 
                pub const m_pAutoaimServices: usize = 0x11B0; // 
                pub const m_pObserverServices: usize = 0x11B8; // 
                pub const m_pWaterServices: usize = 0x11C0; // 
                pub const m_pUseServices: usize = 0x11C8; // 
                pub const m_pFlashlightServices: usize = 0x11D0; // 
                pub const m_pCameraServices: usize = 0x11D8; // 
                pub const m_pMovementServices: usize = 0x11E0; // 
                pub const m_ServerViewAngleChanges: usize = 0x11F0; // 
                pub const m_nHighestConsumedServerViewAngleChangeIndex: usize = 0x1240; // 
                pub const v_angle: usize = 0x1244; // 
                pub const v_anglePrevious: usize = 0x1250; // 
                pub const m_iHideHUD: usize = 0x125C; // 
                pub const m_skybox3d: usize = 0x1260; // 
                pub const m_flDeathTime: usize = 0x12F0; // 
                pub const m_vecPredictionError: usize = 0x12F4; // 
                pub const m_flPredictionErrorTime: usize = 0x1300; // 
                pub const m_vecLastCameraSetupLocalOrigin: usize = 0x1304; // 
                pub const m_flLastCameraSetupTime: usize = 0x1310; // 
                pub const m_flFOVSensitivityAdjust: usize = 0x1314; // 
                pub const m_flMouseSensitivity: usize = 0x1318; // 
                pub const m_vOldOrigin: usize = 0x131C; // 
                pub const m_flOldSimulationTime: usize = 0x1328; // 
                pub const m_nLastExecutedCommandNumber: usize = 0x132C; // 
                pub const m_nLastExecutedCommandTick: usize = 0x1330; // 
                pub const m_hController: usize = 0x1334; // 
                pub const m_bIsSwappingToPredictableController: usize = 0x1338; // 
            }
            // Parent: None
            // Field count: 6
            //
            ...
            pub mod C_TriggerBuoyancy {
                ...
                pub const m_flFluidDensity: usize = 0xDA8; // 
            }
            // Parent: C_BaseModelEntity
            // Field count: 41
            //
            ...
            pub mod C_RopeKeyframe {
                pub const m_LinksTouchingSomething: usize = 0xD28; // 
                pub const m_nLinksTouchingSomething: usize = 0xD2C; // 
                pub const m_bApplyWind: usize = 0xD30; // 
                pub const m_fPrevLockedPoints: usize = 0xD34; // 
                pub const m_iForcePointMoveCounter: usize = 0xD38; // 
                pub const m_bPrevEndPointPos: usize = 0xD3C; // 
                pub const m_vPrevEndPointPos: usize = 0xD40; // 
                pub const m_flCurScroll: usize = 0xD58; // 
                pub const m_flScrollSpeed: usize = 0xD5C; // 
                pub const m_RopeFlags: usize = 0xD60; // 
                pub const m_iRopeMaterialModelIndex: usize = 0xD68; // 
                pub const m_LightValues: usize = 0xFE0; // 
                pub const m_nSegments: usize = 0x1058; // 
                pub const m_hStartPoint: usize = 0x105C; // 
                pub const m_hEndPoint: usize = 0x1060; // 
                pub const m_iStartAttachment: usize = 0x1064; // 
                pub const m_iEndAttachment: usize = 0x1065; // 
                pub const m_Subdiv: usize = 0x1066; // 
                pub const m_RopeLength: usize = 0x1068; // 
                pub const m_Slack: usize = 0x106A; // 
                pub const m_TextureScale: usize = 0x106C; // 
                pub const m_fLockedPoints: usize = 0x1070; // 
                pub const m_nChangeCount: usize = 0x1071; // 
                pub const m_Width: usize = 0x1074; // 
                pub const m_PhysicsDelegate: usize = 0x1078; // C_RopeKeyframe::CPhysicsDelegate
                pub const m_hMaterial: usize = 0x1088; // 
                pub const m_TextureHeight: usize = 0x1090; // 
                pub const m_vecImpulse: usize = 0x1094; // 
                pub const m_vecPreviousImpulse: usize = 0x10A0; // 
                pub const m_flCurrentGustTimer: usize = 0x10AC; // 
                pub const m_flCurrentGustLifetime: usize = 0x10B0; // 
                pub const m_flTimeToNextGust: usize = 0x10B4; // 
                pub const m_vWindDir: usize = 0x10B8; // 
                pub const m_vColorMod: usize = 0x10C4; // 
                pub const m_vCachedEndPointAttachmentPos: usize = 0x10D0; // 
                pub const m_vCachedEndPointAttachmentAngle: usize = 0x10E8; // 
                pub const m_bConstrainBetweenEndpoints: usize = 0x1100; // 
            ...
            pub mod C_EconWearable {
                pub const m_nForceSkin: usize = 0x1660; // 
                pub const m_bAlwaysAllow: usize = 0x1664; // 
            }
            ...
            pub mod C_BarnLight {
                pub const m_bEnabled: usize = 0xD20; // 
                pub const m_nColorMode: usize = 0xD24; // 
                pub const m_Color: usize = 0xD28; // 
                pub const m_flColorTemperature: usize = 0xD2C; // 
                pub const m_flBrightness: usize = 0xD30; // 
                pub const m_flBrightnessScale: usize = 0xD34; // 
                pub const m_nDirectLight: usize = 0xD38; // 
                pub const m_nBakedShadowIndex: usize = 0xD3C; // 
                pub const m_nLuminaireShape: usize = 0xD40; // 
                pub const m_flLuminaireSize: usize = 0xD44; // 
                pub const m_flLuminaireAnisotropy: usize = 0xD48; // 
                pub const m_LightStyleString: usize = 0xD50; // 
                ...
                pub const m_flSoftX: usize = 0xE54; // 
                pub const m_flSoftY: usize = 0xE58; // 
                pub const m_flSkirt: usize = 0xE5C; // 
                pub const m_flSkirtNear: usize = 0xE60; // 
                pub const m_vSizeParams: usize = 0xE64; // 
                pub const m_flRange: usize = 0xE70; // 
                pub const m_vShear: usize = 0xE74; // 
                pub const m_nBakeSpecularToCubemaps: usize = 0xE80; // 
                pub const m_vBakeSpecularToCubemapsSize: usize = 0xE84; // 
                pub const m_nCastShadows: usize = 0xE90; // 
                pub const m_nShadowMapSize: usize = 0xE94; // 
                pub const m_nShadowPriority: usize = 0xE98; // 
                pub const m_bContactShadow: usize = 0xE9C; // 
                pub const m_nBounceLight: usize = 0xEA0; // 
                pub const m_flBounceScale: usize = 0xEA4; // 
                pub const m_flMinRoughness: usize = 0xEA8; // 
                pub const m_vAlternateColor: usize = 0xEAC; // 
                pub const m_fAlternateColorBrightness: usize = 0xEB8; // 
                pub const m_nFog: usize = 0xEBC; // 
                pub const m_flFogStrength: usize = 0xEC0; // 
                pub const m_nFogShadows: usize = 0xEC4; // 
                pub const m_flFogScale: usize = 0xEC8; // 
                pub const m_bFogMixedShadows: usize = 0xECC; // 
                pub const m_flFadeSizeStart: usize = 0xED0; // 
                pub const m_flFadeSizeEnd: usize = 0xED4; // 
                pub const m_flShadowFadeSizeStart: usize = 0xED8; // 
                pub const m_flShadowFadeSizeEnd: usize = 0xEDC; // 
                pub const m_bPrecomputedFieldsValid: usize = 0xEE0; // 
                pub const m_vPrecomputedBoundsMins: usize = 0xEE4; // 
                pub const m_vPrecomputedBoundsMaxs: usize = 0xEF0; // 
                pub const m_vPrecomputedOBBOrigin: usize = 0xEFC; // 
                pub const m_vPrecomputedOBBAngles: usize = 0xF08; // 
                pub const m_vPrecomputedOBBExtent: usize = 0xF14; // 
                pub const m_nPrecomputedSubFrusta: usize = 0xF20; // 
                pub const m_vPrecomputedOBBOrigin0: usize = 0xF24; // 
                pub const m_vPrecomputedOBBAngles0: usize = 0xF30; // 
                pub const m_vPrecomputedOBBExtent0: usize = 0xF3C; // 
                pub const m_vPrecomputedOBBOrigin1: usize = 0xF48; // 
                pub const m_vPrecomputedOBBAngles1: usize = 0xF54; // 
                pub const m_vPrecomputedOBBExtent1: usize = 0xF60; // 
                pub const m_vPrecomputedOBBOrigin2: usize = 0xF6C; // 
                pub const m_vPrecomputedOBBAngles2: usize = 0xF78; // 
                pub const m_vPrecomputedOBBExtent2: usize = 0xF84; // 
                pub const m_vPrecomputedOBBOrigin3: usize = 0xF90; // 
                pub const m_vPrecomputedOBBAngles3: usize = 0xF9C; // 
                pub const m_vPrecomputedOBBExtent3: usize = 0xFA8; // 
                pub const m_vPrecomputedOBBOrigin4: usize = 0xFB4; // 
                pub const m_vPrecomputedOBBAngles4: usize = 0xFC0; // 
                pub const m_vPrecomputedOBBExtent4: usize = 0xFCC; // 
                pub const m_vPrecomputedOBBOrigin5: usize = 0xFD8; // 
                pub const m_vPrecomputedOBBAngles5: usize = 0xFE4; // 
                pub const m_vPrecomputedOBBExtent5: usize = 0xFF0; // 
                pub const m_bInitialBoneSetup: usize = 0x1040; // 
            ...
            // Field count: 1
            pub mod CFuncWater {
                pub const m_BuoyancyHelper: usize = 0xD20; // 
            }
            // Parent: C_SoundOpvarSetPointEntity
            // Field count: 0
            ...
            pub mod C_EconEntity {
                pub const m_flFlexDelayTime: usize = 0x1128; // 
                pub const m_flFlexDelayedWeight: usize = 0x1130; // 
                pub const m_bAttributesInitialized: usize = 0x1138; // 
                pub const m_AttributeManager: usize = 0x1140; // 
                pub const m_OriginalOwnerXuidLow: usize = 0x15E8; // 
                pub const m_OriginalOwnerXuidHigh: usize = 0x15EC; // 
                pub const m_nFallbackPaintKit: usize = 0x15F0; // 
                pub const m_nFallbackSeed: usize = 0x15F4; // 
                pub const m_flFallbackWear: usize = 0x15F8; // 
                pub const m_nFallbackStatTrak: usize = 0x15FC; // 
                pub const m_bClientside: usize = 0x1600; // 
                pub const m_bParticleSystemsCreated: usize = 0x1601; // 
                pub const m_vecAttachedParticles: usize = 0x1608; // 
                pub const m_hViewmodelAttachment: usize = 0x1620; // 
                pub const m_iOldTeam: usize = 0x1624; // 
                pub const m_bAttachmentDirty: usize = 0x1628; // 
                pub const m_nUnloadedModelIndex: usize = 0x162C; // 
                pub const m_iNumOwnerValidationRetries: usize = 0x1630; // 
                pub const m_hOldProvidee: usize = 0x1640; // 
            ...
            pub mod C_RectLight {
                pub const m_bShowLight: usize = 0x1068; // 
            }
            // Parent: C_BaseModelEntity
            // Field count: 24
            //
            ...
            pub mod C_ParticleSystem {
                pub const m_szSnapshotFileName: usize = 0xD20; // 
                pub const m_bActive: usize = 0xF20; // 
                pub const m_bFrozen: usize = 0xF21; // 
                pub const m_flFreezeTransitionDuration: usize = 0xF24; // 
                pub const m_nStopType: usize = 0xF28; // 
                pub const m_bAnimateDuringGameplayPause: usize = 0xF2C; // 
                pub const m_iEffectIndex: usize = 0xF30; // 
                pub const m_flStartTime: usize = 0xF38; // 
                pub const m_flPreSimTime: usize = 0xF3C; // 
                pub const m_vServerControlPoints: usize = 0xF40; // 
                pub const m_iServerControlPointAssignments: usize = 0xF70; // 
                pub const m_hControlPointEnts: usize = 0xF74; // 
                pub const m_bNoSave: usize = 0x1074; // 
                pub const m_bNoFreeze: usize = 0x1075; // 
                pub const m_bNoRamp: usize = 0x1076; // 
                pub const m_bStartActive: usize = 0x1077; // 
                pub const m_iszEffectName: usize = 0x1078; // 
                pub const m_iszControlPointNames: usize = 0x1080; // 
                pub const m_nDataCP: usize = 0x1280; // 
                pub const m_vecDataCPValue: usize = 0x1284; // 
                pub const m_nTintCP: usize = 0x1290; // 
                pub const m_clrTint: usize = 0x1294; // 
                pub const m_bOldActive: usize = 0x12B8; // 
                pub const m_bOldFrozen: usize = 0x12B9; // 
            }
            ...
            pub mod C_Multimeter {
                pub const m_hTargetC4: usize = 0xF88; // 
            }
            // Parent: C_BaseEntity
            // Field count: 2
            ...
            pub mod C_EnvDecal {
                pub const m_hDecalMaterial: usize = 0xD20; // 
                pub const m_flWidth: usize = 0xD28; // 
                pub const m_flHeight: usize = 0xD2C; // 
                pub const m_flDepth: usize = 0xD30; // 
                pub const m_nRenderOrder: usize = 0xD34; // 
                pub const m_bProjectOnWorld: usize = 0xD38; // 
                pub const m_bProjectOnCharacters: usize = 0xD39; // 
                pub const m_bProjectOnWater: usize = 0xD3A; // 
                pub const m_flDepthSortBias: usize = 0xD3C; // 
            }
            // Parent: CCSGameModeRules
            // Field count: 0
            ...
            pub mod C_BaseDoor {
                pub const m_bIsUsable: usize = 0xD20; // 
            }
            // Parent: C_BaseModelEntity
            // Field count: 2
            pub mod CGrenadeTracer {
                pub const m_flTracerDuration: usize = 0xD38; // 
                pub const m_nType: usize = 0xD3C; // 
            }
            // Parent: C_BaseTrigger
            // Field count: 1
            //
            ...
            pub mod CBombTarget {
                pub const m_bBombPlantedHere: usize = 0xD28; // 
            }
            // Parent: C_BaseClientUIEntity
            // Field count: 2
            //
            ...
            pub mod C_PointClientUIDialog {
                pub const m_hActivator: usize = 0xD50; // 
                pub const m_bStartEnabled: usize = 0xD54; // 
            }
            // Parent: CCSGameModeRules
            // Field count: 1
            //
            ...
            pub mod C_WeaponShield {
                pub const m_flDisplayHealth: usize = 0x1B20; // 
            }
            // Parent: C_PointClientUIWorldPanel
            // Field count: 1
            //
            ...
            pub mod C_PointClientUIWorldTextPanel {
                pub const m_messageText: usize = 0xF80; // 
            }
            // Parent: CPlayer_UseServices
            // Field count: 0
            ...
            pub mod C_EnvParticleGlow {
                pub const m_flAlphaScale: usize = 0x12D0; // 
                pub const m_flRadiusScale: usize = 0x12D4; // 
                pub const m_flSelfIllumScale: usize = 0x12D8; // 
                pub const m_ColorTint: usize = 0x12DC; // 
                pub const m_hTextureOverride: usize = 0x12E0; // 
            }
            // Parent: C_BaseEntity
            // Field count: 15
            ...
            pub mod C_Sun {
                pub const m_fxSSSunFlareEffectIndex: usize = 0xD20; // 
                pub const m_fxSunFlareEffectIndex: usize = 0xD24; // 
                pub const m_fdistNormalize: usize = 0xD28; // 
                pub const m_vSunPos: usize = 0xD2C; // 
                pub const m_vDirection: usize = 0xD38; // 
                pub const m_iszEffectName: usize = 0xD48; // 
                pub const m_iszSSEffectName: usize = 0xD50; // 
                pub const m_clrOverlay: usize = 0xD58; // 
                pub const m_bOn: usize = 0xD5C; // 
                pub const m_bmaxColor: usize = 0xD5D; // 
                pub const m_flSize: usize = 0xD60; // 
                pub const m_flHazeScale: usize = 0xD64; // 
                pub const m_flRotation: usize = 0xD68; // 
                pub const m_flHDRColorScale: usize = 0xD6C; // 
                pub const m_flAlphaHaze: usize = 0xD70; // 
                pub const m_flAlphaScale: usize = 0xD74; // 
                pub const m_flAlphaHdr: usize = 0xD78; // 
                pub const m_flFarZScale: usize = 0xD7C; // 
            }
            // Parent: C_BaseEntity
            // Field count: 0
            ...
            pub mod C_ColorCorrectionVolume {
                pub const m_LastEnterWeight: usize = 0xD28; // 
                pub const m_LastEnterTime: usize = 0xD2C; // 
                pub const m_LastExitWeight: usize = 0xD30; // 
                pub const m_LastExitTime: usize = 0xD34; // 
                pub const m_bEnabled: usize = 0xD38; // 
                pub const m_MaxWeight: usize = 0xD3C; // 
                pub const m_FadeDuration: usize = 0xD40; // 
                pub const m_Weight: usize = 0xD44; // 
                pub const m_lookupFilename: usize = 0xD48; // 
            }
            // Parent: C_BaseModelEntity
            // Field count: 0
            ...
            pub mod C_BulletHitModel {
                pub const m_matLocal: usize = 0xF80; // 
                pub const m_iBoneIndex: usize = 0xFB0; // 
                pub const m_hPlayerParent: usize = 0xFB4; // 
                pub const m_bIsHit: usize = 0xFB8; // 
                pub const m_flTimeCreated: usize = 0xFBC; // 
                pub const m_vecStartPos: usize = 0xFC0; // 
            }
            // Parent: C_BaseEntity
            // Field count: 17
            //
            ...
            // NetworkVarNames: m_bShowLight (bool)
            pub mod C_OmniLight {
                pub const m_flInnerAngle: usize = 0x1068; // 
                pub const m_flOuterAngle: usize = 0x106C; // 
            ...
            pub mod C_FuncLadder {
                pub const m_vecLadderDir: usize = 0xD20; // 
                pub const m_Dismounts: usize = 0xD30; // CUtlVector<CHandle<C_InfoLadderDismount>>
                pub const m_vecLocalTop: usize = 0xD48; // 
                pub const m_vecPlayerMountPositionTop: usize = 0xD54; // 
                pub const m_vecPlayerMountPositionBottom: usize = 0xD60; // 
                pub const m_flAutoRideSpeed: usize = 0xD6C; // 
                pub const m_bDisabled: usize = 0xD70; // 
                pub const m_bFakeLadder: usize = 0xD71; // 
                pub const m_bHasSlack: usize = 0xD72; // 
            }
            ...
            pub mod C_BaseGrenade {
                pub const m_bHasWarnedAI: usize = 0x1118; // 
                pub const m_bIsSmokeGrenade: usize = 0x1119; // 
                pub const m_bIsLive: usize = 0x111A; // 
                pub const m_DmgRadius: usize = 0x111C; // 
                pub const m_flDetonateTime: usize = 0x1120; // 
                pub const m_flWarnAITime: usize = 0x1124; // 
            ...
            pub mod C_PointCommentaryNode {
                pub const m_bActive: usize = 0xF88; // 
                pub const m_bWasActive: usize = 0xF89; // 
                pub const m_flEndTime: usize = 0xF8C; // 
                pub const m_flStartTime: usize = 0xF90; // 
                pub const m_flStartTimeInCommentary: usize = 0xF94; // 
                pub const m_iszCommentaryFile: usize = 0xF98; // 
                pub const m_iszTitle: usize = 0xFA0; // 
                pub const m_iszSpeakers: usize = 0xFA8; // 
                pub const m_iNodeNumber: usize = 0xFB0; // 
                pub const m_iNodeNumberMax: usize = 0xFB4; // 
                pub const m_bListenedTo: usize = 0xFB8; // 
                pub const m_hViewPosition: usize = 0xFC8; // 
                pub const m_bRestartAfterRestore: usize = 0xFCC; // 
            }
            // Parent: CCSPlayerBase_CameraServices
            // Field count: 0
            ...
            pub mod C_FireSprite {
                pub const m_vecMoveDir: usize = 0xE30; // 
                pub const m_bFadeFromAbove: usize = 0xE3C; // 
            }
            // Parent: C_CSGO_TeamIntroCharacterPosition
            // Field count: 0
            ...
            pub mod C_Precipitation {
                pub const m_flDensity: usize = 0xD28; // 
                pub const m_flParticleInnerDist: usize = 0xD38; // 
                pub const m_pParticleDef: usize = 0xD40; // 
                pub const m_tParticlePrecipTraceTimer: usize = 0xD68; // 
                pub const m_bActiveParticlePrecipEmitter: usize = 0xD70; // 
                pub const m_bParticlePrecipInitialized: usize = 0xD71; // 
                pub const m_bHasSimulatedSinceLastSceneObjectUpdate: usize = 0xD72; // 
                pub const m_nAvailableSheetSequencesMaxIndex: usize = 0xD74; // 
            }
            // Parent: CEntitySubclassVDataBase
            // Field count: 7
            //
            ...
            pub mod C_BaseClientUIEntity {
                ...
                pub const m_DialogXMLName: usize = 0xD30; // 
                pub const m_PanelClassName: usize = 0xD38; // 
                pub const m_PanelID: usize = 0xD40; // 
            }
            // Parent: C_BaseModelEntity
            // Field count: 3
            pub mod C_FuncTrackTrain {
                pub const m_nLongAxis: usize = 0xD20; // 
                pub const m_flRadius: usize = 0xD24; // 
                pub const m_flLineLength: usize = 0xD28; // 
            }
            // Parent: CPlayerPawnComponent
            // Field count: 4
            //
            ...
            // Field count: 4
            pub mod CBaseProp {
                pub const m_bModelOverrodeBlockLOS: usize = 0xF80; // 
                pub const m_iShapeType: usize = 0xF84; // 
                pub const m_bConformToCollisionBounds: usize = 0xF88; // 
                pub const m_mPreferredCatchTransform: usize = 0xF8C; // 
            }
            // Parent: C_CSGO_PreviewPlayer
            // Field count: 0
            ...
            pub mod C_CSGO_PreviewModel {
                pub const m_animgraph: usize = 0x1118; // 
                pub const m_animgraphCharacterModeString: usize = 0x1120; // 
                pub const m_defaultAnim: usize = 0x1128; // 
                pub const m_nDefaultAnimLoopMode: usize = 0x1130; // 
                pub const m_flInitialModelScale: usize = 0x1134; // 
                pub const m_sInitialWeaponState: usize = 0x1138; // 
            }
            // Parent: C_PointEntity
            // Field count: 5
            ...
            pub mod C_TriggerPhysics {
                pub const m_gravityScale: usize = 0xD28; // 
                pub const m_linearLimit: usize = 0xD2C; // 
                pub const m_linearDamping: usize = 0xD30; // 
                pub const m_angularLimit: usize = 0xD34; // 
                pub const m_angularDamping: usize = 0xD38; // 
                pub const m_linearForce: usize = 0xD3C; // 
                pub const m_flFrequency: usize = 0xD40; // 
                pub const m_flDampingRatio: usize = 0xD44; // 
                pub const m_vecLinearForcePointAt: usize = 0xD48; // 
                pub const m_bCollapseToForcePoint: usize = 0xD54; // 
                pub const m_vecLinearForcePointAtWorld: usize = 0xD58; // 
                pub const m_vecLinearForceDirection: usize = 0xD64; // 
                pub const m_bConvertToDebrisWhenPossible: usize = 0xD70; // 
            }
            // Parent: CPlayerPawnComponent
            // Field count: 2
            //
            ...
            pub mod C_PredictedViewModel {
                pub const m_vPredictedLagOffset: usize = 0xFE8; // 
                pub const m_targetSpeed: usize = 0xFF4; // 
                pub const m_currentSpeed: usize = 0x1000; // 
            }
            // Parent: C_CSWeaponBaseGun
            // Field count: 0
            ...
            pub mod C_WeaponTaser {
                pub const m_fFireTime: usize = 0x1B20; // 
                pub const m_nLastAttackTick: usize = 0x1B24; // 
            }
            // Parent: C_CSWeaponBase
            // Field count: 2
            //
            ...
            pub mod C_Fists {
                pub const m_bPlayingUninterruptableAct: usize = 0x1B00; // 
                pub const m_nUninterruptableActivity: usize = 0x1B04; // 
            }
            ...
            pub mod C_PlayerSprayDecal {
                ...
                pub const m_unAccountID: usize = 0xD24; // 
                pub const m_unTraceID: usize = 0xD28; // 
                pub const m_rtGcTime: usize = 0xD2C; // 
                pub const m_vecEndPos: usize = 0xD30; // 
                pub const m_vecStart: usize = 0xD3C; // 
                pub const m_vecLeft: usize = 0xD48; // 
                pub const m_vecNormal: usize = 0xD54; // 
                pub const m_nPlayer: usize = 0xD60; // 
                pub const m_nEntity: usize = 0xD64; // 
                pub const m_nHitbox: usize = 0xD68; // 
                pub const m_flCreationTime: usize = 0xD6C; // 
                pub const m_nTintID: usize = 0xD70; // 
                pub const m_nVersion: usize = 0xD74; // 
                pub const m_ubSignature: usize = 0xD75; // 
                pub const m_SprayRenderHelper: usize = 0xE00; // 
            }
            // Parent: None
            // Field count: 2
            //
            ...
            pub mod C_ShatterGlassShardPhysics {
                pub const m_ShardDesc: usize = 0x1118; // 
            }
            // Parent: C_CSWeaponBaseGun
            // Field count: 0
            ...
            pub mod C_LightEntity {
                pub const m_CLightComponent: usize = 0xD20; // 
            }
            // Parent: C_BaseEntity
            // Field count: 6
            //
            ...
            pub mod C_BaseFlex {
                ...
                pub const m_vLookTargetPosition: usize = 0xFA8; // 
                pub const m_blinktoggle: usize = 0xFC0; // 
                pub const m_nLastFlexUpdateFrameCount: usize = 0x1020; // 
                pub const m_CachedViewTarget: usize = 0x1024; // 
                pub const m_nNextSceneEventId: usize = 0x1030; // 
                pub const m_iBlink: usize = 0x1034; // 
                pub const m_blinktime: usize = 0x1038; // 
                pub const m_prevblinktoggle: usize = 0x103C; // 
                pub const m_iJawOpen: usize = 0x1040; // 
                pub const m_flJawOpenAmount: usize = 0x1044; // 
                pub const m_flBlinkAmount: usize = 0x1048; // 
                pub const m_iMouthAttachment: usize = 0x104C; // 
                pub const m_iEyeAttachment: usize = 0x104D; // 
                pub const m_bResetFlexWeightsOnModelChange: usize = 0x104E; // 
                pub const m_nEyeOcclusionRendererBone: usize = 0x1068; // 
                pub const m_mEyeOcclusionRendererCameraToBoneTransform: usize = 0x106C; // 
                pub const m_vEyeOcclusionRendererHalfExtent: usize = 0x109C; // 
            ...
            // NetworkVarNames: m_bEnabled (bool)
            pub mod C_EnvSky {
                pub const m_hSkyMaterial: usize = 0xD20; // 
                pub const m_hSkyMaterialLightingOnly: usize = 0xD28; // 
                pub const m_bStartDisabled: usize = 0xD30; // 
                pub const m_vTintColor: usize = 0xD31; // 
                pub const m_vTintColorLightingOnly: usize = 0xD35; // 
                pub const m_flBrightnessScale: usize = 0xD3C; // 
                pub const m_nFogType: usize = 0xD40; // 
                pub const m_flFogMinStart: usize = 0xD44; // 
                pub const m_flFogMinEnd: usize = 0xD48; // 
                pub const m_flFogMaxStart: usize = 0xD4C; // 
                pub const m_flFogMaxEnd: usize = 0xD50; // 
                pub const m_bEnabled: usize = 0xD54; // 
            }
            // Parent: C_PointEntity
            // Field count: 0
            pub mod CInfoTarget {
            ...
            pub mod C_DynamicProp {
                pub const m_bUseHitboxesForRenderBox: usize = 0x1108; // 
                pub const m_bUseAnimGraph: usize = 0x1109; // 
                pub const m_pOutputAnimBegun: usize = 0x1110; // 
                pub const m_pOutputAnimOver: usize = 0x1138; // 
                pub const m_pOutputAnimLoopCycleOver: usize = 0x1160; // 
                pub const m_OnAnimReachedStart: usize = 0x1188; // 
                pub const m_OnAnimReachedEnd: usize = 0x11B0; // 
                pub const m_iszIdleAnim: usize = 0x11D8; // 
                pub const m_nIdleAnimLoopMode: usize = 0x11E0; // 
                pub const m_bRandomizeCycle: usize = 0x11E4; // 
                pub const m_bStartDisabled: usize = 0x11E5; // 
                pub const m_bFiredStartEndOutput: usize = 0x11E6; // 
                pub const m_bForceNpcExclude: usize = 0x11E7; // 
                pub const m_bCreateNonSolid: usize = 0x11E8; // 
                pub const m_bIsOverrideProp: usize = 0x11E9; // 
                pub const m_iInitialGlowState: usize = 0x11EC; // 
                pub const m_nGlowRange: usize = 0x11F0; // 
                pub const m_nGlowRangeMin: usize = 0x11F4; // 
                pub const m_glowColor: usize = 0x11F8; // 
                pub const m_nGlowTeam: usize = 0x11FC; // 
                pub const m_iCachedFrameCount: usize = 0x1200; // 
                pub const m_vecCachedRenderMins: usize = 0x1204; // 
                pub const m_vecCachedRenderMaxs: usize = 0x1210; // 
            }
            // Parent: CEntityComponent
            // Field count: 10
            ...
            pub mod C_KeychainModule {
                pub const m_nKeychainDefID: usize = 0xF88; // 
                pub const m_nKeychainSeed: usize = 0xF8C; // 
            }
            // Parent: C_BaseEntity
            // Field count: 8
            //
            ...
            pub mod C_LocalTempEntity {
                pub const flags: usize = 0xF80; // 
                pub const die: usize = 0xF84; // 
                pub const m_flFrameMax: usize = 0xF88; // 
                pub const x: usize = 0xF8C; // 
                pub const y: usize = 0xF90; // 
                pub const fadeSpeed: usize = 0xF94; // 
                pub const bounceFactor: usize = 0xF98; // 
                pub const hitSound: usize = 0xF9C; // 
                pub const priority: usize = 0xFA0; // 
                pub const tentOffset: usize = 0xFA4; // 
                pub const m_vecTempEntAngVelocity: usize = 0xFB0; // 
                pub const tempent_renderamt: usize = 0xFBC; // 
                pub const m_vecNormal: usize = 0xFC0; // 
                pub const m_flSpriteScale: usize = 0xFCC; // 
                pub const m_nFlickerFrame: usize = 0xFD0; // 
                pub const m_flFrameRate: usize = 0xFD4; // 
                pub const m_flFrame: usize = 0xFD8; // 
                pub const m_pszImpactEffect: usize = 0xFE0; // 
                pub const m_pszParticleEffect: usize = 0xFE8; // 
                pub const m_bParticleCollision: usize = 0xFF0; // 
                pub const m_iLastCollisionFrame: usize = 0xFF4; // 
                pub const m_vLastCollisionOrigin: usize = 0xFF8; // 
                pub const m_vecTempEntVelocity: usize = 0x1004; // 
                pub const m_vecPrevAbsOrigin: usize = 0x1010; // 
                pub const m_vecTempEntAcceleration: usize = 0x101C; // 
            }
            // Parent: None
            // Field count: 2
            ...
            pub mod C_MolotovProjectile {
                pub const m_bIsIncGrenade: usize = 0x1200; // 
            }
            ...
            pub mod C_DynamicLight {
                pub const m_Flags: usize = 0xD20; // 
                pub const m_LightStyle: usize = 0xD21; // 
                pub const m_Radius: usize = 0xD24; // 
                pub const m_Exponent: usize = 0xD28; // 
                pub const m_InnerAngle: usize = 0xD2C; // 
                pub const m_OuterAngle: usize = 0xD30; // 
                pub const m_SpotRadius: usize = 0xD34; // 
            }
            ...
            pub mod C_CSWeaponBase {
                pub const m_flFireSequenceStartTime: usize = 0x16D4; // 
                pub const m_nFireSequenceStartTimeChange: usize = 0x16D8; // 
                pub const m_nFireSequenceStartTimeAck: usize = 0x16DC; // 
                pub const m_ePlayerFireEvent: usize = 0x16E0; // 
                pub const m_ePlayerFireEventAttackType: usize = 0x16E4; // 
                pub const m_seqIdle: usize = 0x16E8; // 
                pub const m_seqFirePrimary: usize = 0x16EC; // 
                pub const m_seqFireSecondary: usize = 0x16F0; // 
                pub const m_thirdPersonFireSequences: usize = 0x16F8; // 
                pub const m_hCurrentThirdPersonSequence: usize = 0x1710; // 
                pub const m_nSilencerBoneIndex: usize = 0x1714; // 
                pub const m_thirdPersonSequences: usize = 0x1718; // 
                pub const m_ClientPreviousWeaponState: usize = 0x1750; // 
                pub const m_iState: usize = 0x1754; // 
                pub const m_flCrosshairDistance: usize = 0x1758; // 
                pub const m_iAmmoLastCheck: usize = 0x175C; // 
                pub const m_iAlpha: usize = 0x1760; // 
                pub const m_iScopeTextureID: usize = 0x1764; // 
                pub const m_iCrosshairTextureID: usize = 0x1768; // 
                pub const m_flGunAccuracyPositionDeprecated: usize = 0x176C; // 
                pub const m_nLastEmptySoundCmdNum: usize = 0x1770; // 
                pub const m_nViewModelIndex: usize = 0x1774; // 
                pub const m_bReloadsWithClips: usize = 0x1778; // 
                pub const m_flTimeWeaponIdle: usize = 0x177C; // 
                pub const m_bFireOnEmpty: usize = 0x1780; // 
                pub const m_OnPlayerPickup: usize = 0x1788; // 
                pub const m_weaponMode: usize = 0x17B0; // 
                pub const m_flTurningInaccuracyDelta: usize = 0x17B4; // 
                pub const m_vecTurningInaccuracyEyeDirLast: usize = 0x17B8; // 
                pub const m_flTurningInaccuracy: usize = 0x17C4; // 
                pub const m_fAccuracyPenalty: usize = 0x17C8; // 
                pub const m_flLastAccuracyUpdateTime: usize = 0x17CC; // 
                pub const m_fAccuracySmoothedForZoom: usize = 0x17D0; // 
                pub const m_fScopeZoomEndTime: usize = 0x17D4; // 
                pub const m_iRecoilIndex: usize = 0x17D8; // 
                pub const m_flRecoilIndex: usize = 0x17DC; // 
                pub const m_bBurstMode: usize = 0x17E0; // 
                pub const m_flLastBurstModeChangeTime: usize = 0x17E4; // 
                pub const m_nPostponeFireReadyTicks: usize = 0x17E8; // 
                pub const m_flPostponeFireReadyFrac: usize = 0x17EC; // 
                pub const m_bInReload: usize = 0x17F0; // 
                pub const m_bReloadVisuallyComplete: usize = 0x17F1; // 
                pub const m_flDroppedAtTime: usize = 0x17F4; // 
                pub const m_bIsHauledBack: usize = 0x17F8; // 
                pub const m_bSilencerOn: usize = 0x17F9; // 
                pub const m_flTimeSilencerSwitchComplete: usize = 0x17FC; // 
                pub const m_iOriginalTeamNumber: usize = 0x1800; // 
                pub const m_iMostRecentTeamNumber: usize = 0x1804; // 
                pub const m_bDroppedNearBuyZone: usize = 0x1808; // 
                pub const m_flNextAttackRenderTimeOffset: usize = 0x180C; // 
                pub const m_bClearWeaponIdentifyingUGC: usize = 0x18A8; // 
                pub const m_bVisualsDataSet: usize = 0x18A9; // 
                ...
                pub const m_bWasOwnedByCT: usize = 0x18E4; // 
                pub const m_bWasOwnedByTerrorist: usize = 0x18E5; // 
                pub const m_gunHeat: usize = 0x18E8; // 
                pub const m_smokeAttachments: usize = 0x18EC; // 
                pub const m_lastSmokeTime: usize = 0x18F0; // 
                pub const m_flNextClientFireBulletTime: usize = 0x18F4; // 
                pub const m_flNextClientFireBulletTime_Repredict: usize = 0x18F8; // 
                pub const m_IronSightController: usize = 0x19D0; // 
                pub const m_iIronSightMode: usize = 0x1A80; // 
                pub const m_flLastLOSTraceFailureTime: usize = 0x1A90; // 
                pub const m_iNumEmptyAttacks: usize = 0x1A94; // 
                pub const m_flLastMagDropRequestTime: usize = 0x1AF0; // 
                pub const m_flWatTickOffset: usize = 0x1AF4; // 
            }
            // Parent: C_BaseModelEntity
            // Field count: 0
            ...
            pub mod C_FuncElectrifiedVolume {
                pub const m_nAmbientEffect: usize = 0xD20; // 
                pub const m_EffectName: usize = 0xD28; // 
                pub const m_bState: usize = 0xD30; // 
            }
            ...
            pub mod C_StattrakModule {
                pub const m_bKnife: usize = 0xF88; // 
            }
            // Parent: C_BreakableProp
            // Field count: 1
            //
            ...
            pub mod C_PhysicsProp {
                pub const m_bAwake: usize = 0x1108; // 
            }
            // Parent: CBaseProp
            // Field count: 29
            //
            ...
            pub mod C_BreakableProp {
                pub const m_CPropDataComponent: usize = 0xFC0; // 
                pub const m_OnBreak: usize = 0x1000; // 
                pub const m_OnHealthChanged: usize = 0x1028; // CEntityOutputTemplate<float32>
                pub const m_OnTakeDamage: usize = 0x1050; // 
                pub const m_impactEnergyScale: usize = 0x1078; // 
                pub const m_iMinHealthDmg: usize = 0x107C; // 
                pub const m_flPressureDelay: usize = 0x1080; // 
                pub const m_flDefBurstScale: usize = 0x1084; // 
                pub const m_vDefBurstOffset: usize = 0x1088; // 
                pub const m_hBreaker: usize = 0x1094; // 
                pub const m_PerformanceMode: usize = 0x1098; // 
                pub const m_flPreventDamageBeforeTime: usize = 0x109C; // 
                pub const m_BreakableContentsType: usize = 0x10A0; // 
                pub const m_strBreakableContentsPropGroupOverride: usize = 0x10A8; // 
                pub const m_strBreakableContentsParticleOverride: usize = 0x10B0; // 
                pub const m_bHasBreakPiecesOrCommands: usize = 0x10B8; // 
                pub const m_explodeDamage: usize = 0x10BC; // 
                pub const m_explodeRadius: usize = 0x10C0; // 
                pub const m_explosionDelay: usize = 0x10C8; // 
                pub const m_explosionBuildupSound: usize = 0x10D0; // 
                pub const m_explosionCustomEffect: usize = 0x10D8; // 
                pub const m_explosionCustomSound: usize = 0x10E0; // 
                pub const m_explosionModifier: usize = 0x10E8; // 
                pub const m_hPhysicsAttacker: usize = 0x10F0; // 
                pub const m_flLastPhysicsInfluenceTime: usize = 0x10F4; // 
                pub const m_flDefaultFadeScale: usize = 0x10F8; // 
                pub const m_hLastAttacker: usize = 0x10FC; // 
                pub const m_hFlareEnt: usize = 0x1100; // 
                pub const m_noGhostCollision: usize = 0x1104; // 
            }
            // Parent: C_BaseToggle
            // Field count: 0
            //
            ...
            // NetworkVarNames: m_vecEndPos (Vector)
            pub mod C_Beam {
                pub const m_flFrameRate: usize = 0xD20; // 
                pub const m_flHDRColorScale: usize = 0xD24; // 
                pub const m_flFireTime: usize = 0xD28; // 
                pub const m_flDamage: usize = 0xD2C; // 
                pub const m_nNumBeamEnts: usize = 0xD30; // 
                pub const m_queryHandleHalo: usize = 0xD34; // 
                pub const m_hBaseMaterial: usize = 0xD58; // 
                pub const m_nHaloIndex: usize = 0xD60; // 
                pub const m_nBeamType: usize = 0xD68; // 
                pub const m_nBeamFlags: usize = 0xD6C; // 
                pub const m_hAttachEntity: usize = 0xD70; // 
                pub const m_nAttachIndex: usize = 0xD98; // 
                pub const m_fWidth: usize = 0xDA4; // 
                pub const m_fEndWidth: usize = 0xDA8; // 
                pub const m_fFadeLength: usize = 0xDAC; // 
                pub const m_fHaloScale: usize = 0xDB0; // 
                pub const m_fAmplitude: usize = 0xDB4; // 
                pub const m_fStartFrame: usize = 0xDB8; // 
                pub const m_fSpeed: usize = 0xDBC; // 
                pub const m_flFrame: usize = 0xDC0; // 
                pub const m_nClipStyle: usize = 0xDC4; // 
                pub const m_bTurnedOff: usize = 0xDC8; // 
                pub const m_vecEndPos: usize = 0xDCC; // 
                pub const m_hEndEntity: usize = 0xDD8; // 
            }
            // Parent: C_BaseEntity
            // Field count: 8
            //
            ...
            pub mod C_PointWorldText {
                pub const m_bForceRecreateNextUpdate: usize = 0xD28; // 
                pub const m_messageText: usize = 0xD38; // 
                pub const m_FontName: usize = 0xF38; // 
                pub const m_bEnabled: usize = 0xF78; // 
                pub const m_bFullbright: usize = 0xF79; // 
                pub const m_flWorldUnitsPerPx: usize = 0xF7C; // 
                pub const m_flFontSize: usize = 0xF80; // 
                pub const m_flDepthOffset: usize = 0xF84; // 
                pub const m_Color: usize = 0xF88; // 
                pub const m_nJustifyHorizontal: usize = 0xF8C; // PointWorldTextJustifyHorizontal_t
                pub const m_nJustifyVertical: usize = 0xF90; // 
                pub const m_nReorientMode: usize = 0xF94; // 
            }
            // Parent: C_BaseGrenade
            // Field count: 0
            ...
            pub mod C_BasePropDoor {
                pub const m_eDoorState: usize = 0x1230; // 
                pub const m_modelChanged: usize = 0x1234; // 
                pub const m_bLocked: usize = 0x1235; // 
                pub const m_closedPosition: usize = 0x1238; // 
                pub const m_closedAngles: usize = 0x1244; // 
                pub const m_hMaster: usize = 0x1250; // 
                pub const m_vWhereToSetLightingOrigin: usize = 0x1254; // 
            }
            // Parent: C_CSGO_TeamSelectCharacterPosition
            // Field count: 0
            ...
            pub mod C_NametagModule {
                pub const m_strNametagString: usize = 0xF88; // 
            }
            // Parent: C_BreakableProp
            // Field count: 6
            pub mod C_PhysPropClientside {
                pub const m_flTouchDelta: usize = 0x1108; // 
                pub const m_fDeathTime: usize = 0x110C; // 
                pub const m_inertiaScale: usize = 0x1110; // 
                pub const m_vecDamagePosition: usize = 0x1114; // 
                pub const m_vecDamageDirection: usize = 0x1120; // 
                pub const m_nDamageType: usize = 0x112C; // 
            }
            // Parent: C_CSGO_TeamPreviewCamera
            // Field count: 0
            ...
            pub mod C_PhysMagnet {
                pub const m_aAttachedObjectsFromServer: usize = 0xF80; // 
                pub const m_aAttachedObjects: usize = 0xF98; // 
            }
            // Parent: C_BaseModelEntity
            // Field count: 8
            //
            ...
            pub mod C_FuncConveyor {
                pub const m_vecMoveDirEntitySpace: usize = 0xD28; // 
                pub const m_flTargetSpeed: usize = 0xD34; // 
                pub const m_nTransitionStartTick: usize = 0xD38; // 
                pub const m_nTransitionDurationTicks: usize = 0xD3C; // 
                pub const m_flTransitionStartSpeed: usize = 0xD40; // 
                pub const m_hConveyorModels: usize = 0xD48; // 
                pub const m_flCurrentConveyorOffset: usize = 0xD60; // 
                pub const m_flCurrentConveyorSpeed: usize = 0xD64; // 
            }
            // Parent: None
            // Field count: 4
            //
            ...
            pub mod C_BaseViewModel {
                pub const m_vecLastFacing: usize = 0xF88; // 
                pub const m_nViewModelIndex: usize = 0xF94; // 
                pub const m_nAnimationParity: usize = 0xF98; // 
                pub const m_flAnimationStartTime: usize = 0xF9C; // 
                pub const m_hWeapon: usize = 0xFA0; // 
                pub const m_sVMName: usize = 0xFA8; // 
                pub const m_sAnimationPrefix: usize = 0xFB0; // 
                pub const m_iCameraAttachment: usize = 0xFB8; // 
                pub const m_vecLastCameraAngles: usize = 0xFBC; // 
                pub const m_previousElapsedDuration: usize = 0xFC8; // 
                pub const m_previousCycle: usize = 0xFCC; // 
                pub const m_nOldAnimationParity: usize = 0xFD0; // 
                pub const m_hOldLayerSequence: usize = 0xFD4; // 
                pub const m_oldLayer: usize = 0xFD8; // 
                pub const m_oldLayerStartTime: usize = 0xFDC; // 
                pub const m_hControlPanel: usize = 0xFE0; // 
            }
            // Parent: C_BaseEntity
            // Field count: 0
            ...
            pub mod C_CSObserverPawn {
                pub const m_hDetectParentChange: usize = 0x1508; // 
            }
            // Parent: C_BaseEntity
            // Field count: 3
            //
            ...
            pub mod C_Hostage {
                pub const m_entitySpottedState: usize = 0x11A0; // 
                pub const m_leader: usize = 0x11B8; // 
                pub const m_reuseTimer: usize = 0x11C0; // 
                pub const m_vel: usize = 0x11D8; // 
                pub const m_isRescued: usize = 0x11E4; // 
                ...
                pub const m_flGrabSuccessTime: usize = 0x1208; // 
                pub const m_flDropStartTime: usize = 0x120C; // 
                pub const m_flDeadOrRescuedTime: usize = 0x1210; // 
                pub const m_blinkTimer: usize = 0x1218; // 
                pub const m_lookAt: usize = 0x1230; // 
                pub const m_lookAroundTimer: usize = 0x1240; // 
                pub const m_isInit: usize = 0x1258; // 
                pub const m_eyeAttachment: usize = 0x1259; // 
                pub const m_chestAttachment: usize = 0x125A; // 
                pub const m_pPredictionOwner: usize = 0x1260; // 
                pub const m_fNewestAlphaThinkTime: usize = 0x1268; // 
            }
            // Parent: C_BaseModelEntity
            // Field count: 24
            //
            ...
            // NetworkVarNames: m_flHDRColorScale (float32)
            pub mod C_Sprite {
                pub const m_hSpriteMaterial: usize = 0xD20; // 
                pub const m_hAttachedToEntity: usize = 0xD28; // 
                pub const m_nAttachment: usize = 0xD2C; // 
                pub const m_flSpriteFramerate: usize = 0xD30; // 
                pub const m_flFrame: usize = 0xD34; // 
                pub const m_flDieTime: usize = 0xD38; // 
                pub const m_nBrightness: usize = 0xD48; // 
                pub const m_flBrightnessDuration: usize = 0xD4C; // 
                pub const m_flSpriteScale: usize = 0xD50; // 
                pub const m_flScaleDuration: usize = 0xD54; // 
                pub const m_bWorldSpaceScale: usize = 0xD58; // 
                pub const m_flGlowProxySize: usize = 0xD5C; // 
                pub const m_flHDRColorScale: usize = 0xD60; // 
                pub const m_flLastTime: usize = 0xD64; // 
                pub const m_flMaxFrame: usize = 0xD68; // 
                pub const m_flStartScale: usize = 0xD6C; // 
                pub const m_flDestScale: usize = 0xD70; // 
                pub const m_flScaleTimeStart: usize = 0xD74; // 
                pub const m_nStartBrightness: usize = 0xD78; // 
                pub const m_nDestBrightness: usize = 0xD7C; // 
                pub const m_flBrightnessTimeStart: usize = 0xD80; // 
                pub const m_hOldSpriteMaterial: usize = 0xD88; // 
                pub const m_nSpriteWidth: usize = 0xE28; // 
                pub const m_nSpriteHeight: usize = 0xE2C; // 
            }
            // Parent: C_CSWeaponBaseGun
            // Field count: 0
            ...
            // NetworkVarNames: m_AttributeManager (CAttributeContainer)
            pub mod C_PlantedC4 {
                pub const m_bBombTicking: usize = 0xF88; // 
                pub const m_nBombSite: usize = 0xF8C; // 
                pub const m_nSourceSoundscapeHash: usize = 0xF90; // 
                pub const m_entitySpottedState: usize = 0xF98; // 
                pub const m_flNextGlow: usize = 0xFB0; // 
                pub const m_flNextBeep: usize = 0xFB4; // 
                pub const m_flC4Blow: usize = 0xFB8; // 
                pub const m_bCannotBeDefused: usize = 0xFBC; // 
                pub const m_bHasExploded: usize = 0xFBD; // 
                pub const m_flTimerLength: usize = 0xFC0; // 
                pub const m_bBeingDefused: usize = 0xFC4; // 
                pub const m_bTriggerWarning: usize = 0xFC8; // 
                pub const m_bExplodeWarning: usize = 0xFCC; // 
                pub const m_bC4Activated: usize = 0xFD0; // 
                pub const m_bTenSecWarning: usize = 0xFD1; // 
                ...
                pub const m_vecC4ExplodeSpectateAng: usize = 0x14BC; // 
                pub const m_flC4ExplodeSpectateDuration: usize = 0x14C8; // 
            }
            // Parent: CBaseAnimGraph
            // Field count: 8
            //
            ...
            pub mod C_RagdollProp {
                ...
                pub const m_flBlendWeight: usize = 0xFB8; // 
                pub const m_hRagdollSource: usize = 0xFBC; // 
                pub const m_iEyeAttachment: usize = 0xFC0; // 
                pub const m_flBlendWeightCurrent: usize = 0xFC4; // 
                pub const m_parentPhysicsBoneIndices: usize = 0xFC8; // 
            ...
            pub mod C_Chicken {
                ...
                pub const m_bIsPreviewModel: usize = 0x16E8; // 
            }
            // Parent: None
            // Field count: 2
            //
