    ...
    pub mod schemas {
        ...
        pub mod particles_dll {
            ...
            pub mod C_OP_RemapGravityToVector {
                ...
                pub const m_nOutputField: usize = 0x838; // 
                pub const m_nSetMethod: usize = 0x83C; // 
                pub const m_bNormalizedOutput: usize = 0x840; // 
            }
            // Parent: CParticleFunctionOperator
            // Field count: 2
            //
            ...
            pub mod C_OP_RenderDeferredLight {
                pub const m_bUseAlphaTestWindow: usize = 0x210; // 
                pub const m_bUseTexture: usize = 0x211; // 
                pub const m_flRadiusScale: usize = 0x214; // 
                pub const m_flAlphaScale: usize = 0x218; // 
                pub const m_nAlpha2Field: usize = 0x21C; // 
                pub const m_vecColorScale: usize = 0x220; // 
                pub const m_nColorBlendType: usize = 0x898; // 
                pub const m_flLightDistance: usize = 0x89C; // 
                pub const m_flStartFalloff: usize = 0x8A0; // 
                pub const m_flDistanceFalloff: usize = 0x8A4; // 
                pub const m_flSpotFoV: usize = 0x8A8; // 
                pub const m_nAlphaTestPointField: usize = 0x8AC; // 
                pub const m_nAlphaTestRangeField: usize = 0x8B0; // 
                pub const m_nAlphaTestSharpnessField: usize = 0x8B4; // 
                pub const m_hTexture: usize = 0x8B8; // 
                pub const m_nHSVShiftControlPoint: usize = 0x8C0; // 
            }
            ...
            pub mod C_OP_RemapSpeedtoCP {
                pub const m_nInControlPointNumber: usize = 0x1C8; // 
                pub const m_nOutControlPointNumber: usize = 0x1CC; // 
                ...
                pub const m_bUseDeltaV: usize = 0x1E4; // 
            }
            // Parent: CParticleFunctionOperator
            // Field count: 1
            //
            ...
            pub mod C_OP_SpringToVectorConstraint {
                ...
                pub const m_flMinDistance: usize = 0x320; // 
                pub const m_flMaxDistance: usize = 0x480; // 
                pub const m_flRestingLength: usize = 0x5E0; // 
                pub const m_vecAnchorVector: usize = 0x740; // 
            }
            ...
            pub mod C_OP_RenderRopes {
                pub const m_bEnableFadingAndClamping: usize = 0x2AA8; // 
                pub const m_flMinSize: usize = 0x2AAC; // 
                pub const m_flMaxSize: usize = 0x2AB0; // 
                pub const m_flStartFadeSize: usize = 0x2AB4; // 
                pub const m_flEndFadeSize: usize = 0x2AB8; // 
                pub const m_flStartFadeDot: usize = 0x2ABC; // 
                pub const m_flEndFadeDot: usize = 0x2AC0; // 
                pub const m_flRadiusTaper: usize = 0x2AC4; // 
                pub const m_nMinTesselation: usize = 0x2AC8; // 
                pub const m_nMaxTesselation: usize = 0x2ACC; // 
                pub const m_flTessScale: usize = 0x2AD0; // 
                ...
                pub const m_nTextureVParamsCP: usize = 0x2EF8; // 
                pub const m_bClampV: usize = 0x2EFC; // 
                pub const m_nScaleCP1: usize = 0x2F00; // 
                pub const m_nScaleCP2: usize = 0x2F04; // 
                pub const m_flScaleVSizeByControlPointDistance: usize = 0x2F08; // 
                pub const m_flScaleVScrollByControlPointDistance: usize = 0x2F0C; // 
                pub const m_flScaleVOffsetByControlPointDistance: usize = 0x2F10; // 
                pub const m_bUseScalarForTextureCoordinate: usize = 0x2F15; // 
                pub const m_nScalarFieldForTextureCoordinate: usize = 0x2F18; // 
                pub const m_flScalarAttributeTextureCoordScale: usize = 0x2F1C; // 
                pub const m_bReverseOrder: usize = 0x2F20; // 
                pub const m_bClosedLoop: usize = 0x2F21; // 
                pub const m_nOrientationType: usize = 0x2F24; // 
                pub const m_nVectorFieldForOrientation: usize = 0x2F28; // 
                pub const m_bDrawAsOpaque: usize = 0x2F2C; // 
                pub const m_bGenerateNormals: usize = 0x2F2D; // 
            }
            ...
            pub mod C_INIT_StatusEffectCitadel {
                pub const m_flSFXColorWarpAmount: usize = 0x1C8; // 
                pub const m_flSFXNormalAmount: usize = 0x1CC; // 
                pub const m_flSFXMetalnessAmount: usize = 0x1D0; // 
                pub const m_flSFXRoughnessAmount: usize = 0x1D4; // 
                pub const m_flSFXSelfIllumAmount: usize = 0x1D8; // 
                pub const m_flSFXSScale: usize = 0x1DC; // 
                pub const m_flSFXSScrollX: usize = 0x1E0; // 
                pub const m_flSFXSScrollY: usize = 0x1E4; // 
                pub const m_flSFXSScrollZ: usize = 0x1E8; // 
                pub const m_flSFXSOffsetX: usize = 0x1EC; // 
                pub const m_flSFXSOffsetY: usize = 0x1F0; // 
                pub const m_flSFXSOffsetZ: usize = 0x1F4; // 
                pub const m_nDetailCombo: usize = 0x1F8; // 
                pub const m_flSFXSDetailAmount: usize = 0x1FC; // 
                pub const m_flSFXSDetailScale: usize = 0x200; // 
                pub const m_flSFXSDetailScrollX: usize = 0x204; // 
                pub const m_flSFXSDetailScrollY: usize = 0x208; // 
                pub const m_flSFXSDetailScrollZ: usize = 0x20C; // 
                pub const m_flSFXSUseModelUVs: usize = 0x210; // 
            }
            // Parent: CParticleFunctionRenderer
            // Field count: 12
            //
            ...
            pub mod C_OP_RenderSound {
                pub const m_flDurationScale: usize = 0x210; // 
                pub const m_flSndLvlScale: usize = 0x214; // 
                pub const m_flPitchScale: usize = 0x218; // 
                pub const m_flVolumeScale: usize = 0x21C; // 
                pub const m_nSndLvlField: usize = 0x220; // 
                pub const m_nDurationField: usize = 0x224; // 
                pub const m_nPitchField: usize = 0x228; // 
                pub const m_nVolumeField: usize = 0x22C; // 
                pub const m_nChannel: usize = 0x230; // 
                pub const m_nCPReference: usize = 0x234; // 
                pub const m_pszSoundName: usize = 0x238; // 
                pub const m_bSuppressStopSoundEvent: usize = 0x338; // 
            }
            // Parent: None
            // Field count: 19
            //
            ...
            pub mod C_OP_RemapSDFDistanceToVectorAttribute {
                ...
                pub const m_flMaxDistance: usize = 0x328; // 
                pub const m_vValueBelowMin: usize = 0x488; // 
                pub const m_vValueAtMin: usize = 0x494; // 
                pub const m_vValueAtMax: usize = 0x4A0; // 
                pub const m_vValueAboveMax: usize = 0x4AC; // 
            }
            // Parent: CParticleFunctionOperator
            // Field count: 4
            //
            ...
            pub mod C_INIT_StatusEffect {
                ...
                pub const m_flDetail2Rotation: usize = 0x1CC; // 
                pub const m_flDetail2Scale: usize = 0x1D0; // 
                pub const m_flDetail2BlendFactor: usize = 0x1D4; // 
                pub const m_flColorWarpIntensity: usize = 0x1D8; // 
                pub const m_flDiffuseWarpBlendToFull: usize = 0x1DC; // 
                pub const m_flEnvMapIntensity: usize = 0x1E0; // 
                pub const m_flAmbientScale: usize = 0x1E4; // 
                pub const m_specularColor: usize = 0x1E8; // 
                pub const m_flSpecularScale: usize = 0x1EC; // 
                pub const m_flSpecularExponent: usize = 0x1F0; // 
                pub const m_flSpecularExponentBlendToFull: usize = 0x1F4; // 
                pub const m_flSpecularBlendToFull: usize = 0x1F8; // 
                pub const m_rimLightColor: usize = 0x1FC; // 
                pub const m_flRimLightScale: usize = 0x200; // 
                pub const m_flReflectionsTintByBaseBlendToNone: usize = 0x204; // 
                pub const m_flMetalnessBlendToFull: usize = 0x208; // 
                pub const m_flSelfIllumBlendToFull: usize = 0x20C; // 
            }
            // Parent: CParticleFunctionInitializer
            // Field count: 8
            //
            ...
            pub mod C_INIT_RtEnvCull {
                pub const m_vecTestDir: usize = 0x1C8; // 
                pub const m_vecTestNormal: usize = 0x1D4; // 
                pub const m_bUseVelocity: usize = 0x1E0; // 
                pub const m_bCullOnMiss: usize = 0x1E1; // 
                pub const m_bLifeAdjust: usize = 0x1E2; // 
                pub const m_RtEnvName: usize = 0x1E3; // 
                pub const m_nRTEnvCP: usize = 0x264; // 
                pub const m_nComponent: usize = 0x268; // 
            }
            // Parent: CParticleFunctionConstraint
            // Field count: 5
            //
            ...
            pub mod C_OP_ConstrainDistance {
                ...
                pub const m_fMaxDistance: usize = 0x320; // 
                pub const m_nControlPointNumber: usize = 0x480; // 
                pub const m_CenterOffset: usize = 0x484; // 
                pub const m_bGlobalCenter: usize = 0x490; // 
            }
            // Parent: CParticleFunctionInitializer
            // Field count: 4
            //
            ...
            pub mod C_INIT_RandomVector {
                pub const m_vecMin: usize = 0x1C8; // 
                pub const m_vecMax: usize = 0x1D4; // 
            ...
            pub mod C_INIT_InitialVelocityNoise {
                pub const m_vecAbsVal: usize = 0x1C8; // 
                pub const m_vecAbsValInv: usize = 0x1D4; // 
                pub const m_vecOffsetLoc: usize = 0x1E0; // 
                pub const m_flOffset: usize = 0x858; // 
                pub const m_vecOutputMin: usize = 0x9B8; // 
                pub const m_vecOutputMax: usize = 0x1030; // 
                pub const m_flNoiseScale: usize = 0x16A8; // 
                pub const m_flNoiseScaleLoc: usize = 0x1808; // 
                pub const m_TransformInput: usize = 0x1968; // 
                pub const m_bIgnoreDt: usize = 0x19D0; // 
            }
            // Parent: None
            // Field count: 5
            //
            ...
            pub mod C_INIT_VelocityRandom {
                ...
                pub const m_fSpeedMin: usize = 0x1D0; // 
                pub const m_fSpeedMax: usize = 0x330; // 
                pub const m_LocalCoordinateSystemSpeedMin: usize = 0x490; // 
                pub const m_LocalCoordinateSystemSpeedMax: usize = 0xB08; // 
                pub const m_bIgnoreDT: usize = 0x1180; // 
            ...
            pub mod C_OP_RemapExternalWindToCP {
                ...
                pub const m_nCPOutput: usize = 0x1CC; // 
                pub const m_vecScale: usize = 0x1D0; // 
                pub const m_bSetMagnitude: usize = 0x848; // 
                pub const m_nOutVectorField: usize = 0x84C; // 
            }
            // Parent: CParticleFunctionRenderer
            // Field count: 64
            //
            ...
            pub mod CBaseRendererSource2 {
                ...
                pub const m_nAlpha2Field: usize = 0x630; // 
                pub const m_vecColorScale: usize = 0x638; // CParticleCollectionRendererVecInput
                pub const m_nColorBlendType: usize = 0xCB0; // 
                pub const m_nShaderType: usize = 0xCB4; // 
                pub const m_strShaderOverride: usize = 0xCB8; // 
                ...
                pub const m_flBumpStrength: usize = 0xF80; // 
                pub const m_nCropTextureOverride: usize = 0xF84; // 
                pub const m_vecTexturesInput: usize = 0xF88; // 
                pub const m_flAnimationRate: usize = 0xFA0; // 
                pub const m_nAnimationType: usize = 0xFA4; // 
                pub const m_bAnimateInFPS: usize = 0xFA8; // 
                ...
                pub const m_nLightingControlPoint: usize = 0x1690; // 
                pub const m_nSelfIllumPerParticle: usize = 0x1694; // 
                pub const m_nOutputBlendMode: usize = 0x1698; // 
                pub const m_bGammaCorrectVertexColors: usize = 0x169C; // 
                pub const m_bSaturateColorPreAlphaBlend: usize = 0x169D; // 
                ...
                pub const m_nHSVShiftControlPoint: usize = 0x1AC0; // 
                pub const m_nFogType: usize = 0x1AC4; // 
                pub const m_flFogAmount: usize = 0x1AC8; // CParticleCollectionRendererFloatInput
                pub const m_bTintByFOW: usize = 0x1C28; // 
                pub const m_bTintByGlobalLight: usize = 0x1C29; // 
                ...
                pub const m_bRefract: usize = 0x2058; // 
                ...
                pub const m_bOnlyRenderInEffecsGameOverlay: usize = 0x21CB; // 
                pub const m_stencilTestID: usize = 0x21CC; // 
                pub const m_bStencilTestExclude: usize = 0x224C; // 
                pub const m_stencilWriteID: usize = 0x224D; // 
                pub const m_bWriteStencilOnDepthPass: usize = 0x22CD; // 
                pub const m_bWriteStencilOnDepthFail: usize = 0x22CE; // 
                pub const m_bReverseZBuffering: usize = 0x22CF; // 
                pub const m_bDisableZBuffering: usize = 0x22D0; // 
                pub const m_nFeatheringMode: usize = 0x22D4; // 
                ...
                pub const m_bBlendFramesSeq0: usize = 0x285C; // 
                pub const m_bMaxLuminanceBlendingSequence0: usize = 0x285D; // 
            }
            // Parent: CParticleFunctionOperator
            // Field count: 0
            //
            ...
            pub mod C_OP_RemapDotProductToCP {
                pub const m_nInputCP1: usize = 0x1C8; // 
                pub const m_nInputCP2: usize = 0x1CC; // 
                pub const m_nOutputCP: usize = 0x1D0; // 
                pub const m_nOutVectorField: usize = 0x1D4; // 
                pub const m_flInputMin: usize = 0x1D8; // 
                pub const m_flInputMax: usize = 0x338; // 
                pub const m_flOutputMin: usize = 0x498; // 
                pub const m_flOutputMax: usize = 0x5F8; // 
            }
            ...
            pub mod C_INIT_RemapParticleCountToNamedModelElementScalar {
                ...
                pub const m_outputMinName: usize = 0x200; // 
                pub const m_outputMaxName: usize = 0x208; // 
            ...
            pub mod C_OP_RenderTrails {
                ...
                pub const m_flStartFadeDot: usize = 0x2D84; // 
                pub const m_flEndFadeDot: usize = 0x2D88; // 
                pub const m_nPrevPntSource: usize = 0x2D8C; // 
                pub const m_flMaxLength: usize = 0x2D90; // 
                pub const m_flMinLength: usize = 0x2D94; // 
                pub const m_bIgnoreDT: usize = 0x2D98; // 
                pub const m_flConstrainRadiusToLengthRatio: usize = 0x2D9C; // 
                pub const m_flLengthScale: usize = 0x2DA0; // 
                pub const m_flLengthFadeInTime: usize = 0x2DA4; // 
                pub const m_flRadiusHeadTaper: usize = 0x2DA8; // 
                pub const m_vecHeadColorScale: usize = 0x2F08; // 
                pub const m_flHeadAlphaScale: usize = 0x3580; // 
                pub const m_flRadiusTaper: usize = 0x36E0; // 
                pub const m_vecTailColorScale: usize = 0x3840; // 
                pub const m_flTailAlphaScale: usize = 0x3EB8; // 
                pub const m_nHorizCropField: usize = 0x4018; // 
                pub const m_nVertCropField: usize = 0x401C; // 
                pub const m_flForwardShift: usize = 0x4020; // 
                pub const m_bFlipUVBasedOnPitchYaw: usize = 0x4024; // 
            }
            // Parent: CParticleFunctionPreEmission
            // Field count: 3
            //
            ...
            pub mod C_OP_SetControlPointPositionToTimeOfDayValue {
                pub const m_nControlPointNumber: usize = 0x1C8; // 
                pub const m_pszTimeOfDayParameter: usize = 0x1CC; // 
                pub const m_vecDefaultValue: usize = 0x24C; // 
            }
            // Parent: CParticleFunctionOperator
            // Field count: 6
            //
            ...
            pub mod C_OP_DecayMaintainCount {
                ...
                pub const m_bKillNewest: usize = 0x330; // 
            }
            // Parent: CParticleFunctionInitializer
            // Field count: 3
            //
            ...
            pub mod C_INIT_RandomModelSequence {
                pub const m_ActivityName: usize = 0x1C8; // 
                pub const m_SequenceName: usize = 0x2C8; // 
            ...
            pub mod C_OP_ExternalGameImpulseForce {
                ...
                pub const m_bRopes: usize = 0x330; // 
                pub const m_bRopesZOnly: usize = 0x331; // 
                pub const m_bExplosions: usize = 0x332; // 
                pub const m_bParticles: usize = 0x333; // 
            }
            // Parent: CParticleFunctionPreEmission
            // Field count: 11
            //
            ...
            pub mod C_OP_RemapAverageHitboxSpeedtoCP {
                ...
                pub const m_flOutputMin: usize = 0x498; // 
                pub const m_flOutputMax: usize = 0x5F8; // 
                pub const m_nHeightControlPointNumber: usize = 0x758; // 
                pub const m_vecComparisonVelocity: usize = 0x760; // 
                pub const m_HitboxSetName: usize = 0xDD8; // 
            }
            // Parent: CParticleFunctionInitializer
            // Field count: 4
            //
            ...
            pub mod C_INIT_RandomAlpha {
                pub const m_nFieldOutput: usize = 0x1C8; // 
                pub const m_nAlphaMin: usize = 0x1CC; // 
                pub const m_nAlphaMax: usize = 0x1D0; // 
                pub const m_flAlphaRandExponent: usize = 0x1DC; // 
            }
            // Parent: CParticleFunctionOperator
            // Field count: 2
            //
            ...
            pub mod C_OP_RepeatedTriggerChildGroup {
                ...
                pub const m_flClusterRefireTime: usize = 0x1D0; // 
                pub const m_flClusterSize: usize = 0x330; // 
                pub const m_flClusterCooldown: usize = 0x490; // 
                pub const m_bLimitChildCount: usize = 0x5F0; // 
            }
            // Parent: CParticleFunctionRenderer
            // Field count: 4
            //
            ...
            pub mod C_OP_RenderTonemapController {
                pub const m_flTonemapLevel: usize = 0x210; // 
                pub const m_flTonemapWeight: usize = 0x214; // 
                pub const m_nTonemapLevelField: usize = 0x218; // 
                pub const m_nTonemapWeightField: usize = 0x21C; // 
            }
            // Parent: CParticleFunctionOperator
            // Field count: 3
            //
            ...
            pub mod C_INIT_SetHitboxToClosest {
                ...
                pub const m_HitboxSetName: usize = 0x848; // 
                pub const m_bUseBones: usize = 0x8C8; // 
                pub const m_bUseClosestPointOnHitbox: usize = 0x8C9; // 
                pub const m_nTestType: usize = 0x8CC; // 
                pub const m_flHybridRatio: usize = 0x8D0; // 
                pub const m_bUpdatePosition: usize = 0xA30; // 
            }
            // Parent: CParticleFunctionInitializer
            // Field count: 11
            //
            ...
            pub mod C_INIT_RingWave {
                ...
                pub const m_flParticlesPerOrbit: usize = 0x230; // 
                pub const m_flInitialRadius: usize = 0x390; // 
                pub const m_flThickness: usize = 0x4F0; // 
                pub const m_flInitialSpeedMin: usize = 0x650; // 
                pub const m_flInitialSpeedMax: usize = 0x7B0; // 
                pub const m_flRoll: usize = 0x910; // 
                pub const m_flPitch: usize = 0xA70; // 
                pub const m_flYaw: usize = 0xBD0; // 
                pub const m_bEvenDistribution: usize = 0xD30; // 
                pub const m_bXYVelocityOnly: usize = 0xD31; // 
            }
            // Parent: CParticleFunctionInitializer
            // Field count: 3
            //
            ...
            pub mod C_INIT_RandomTrailLength {
                pub const m_flMinLength: usize = 0x1C8; // 
                pub const m_flMaxLength: usize = 0x1CC; // 
                pub const m_flLengthRandExponent: usize = 0x1D0; // 
            }
            // Parent: CParticleFunctionOperator
            // Field count: 7
            //
            ...
            pub mod C_OP_DistanceBetweenTransforms {
                ...
                pub const m_flInputMax: usize = 0x3F8; // 
                pub const m_flOutputMin: usize = 0x558; // 
                pub const m_flOutputMax: usize = 0x6B8; // 
                pub const m_flMaxTraceLength: usize = 0x818; // 
                pub const m_flLOSScale: usize = 0x81C; // 
                pub const m_CollisionGroupName: usize = 0x820; // 
                pub const m_nTraceSet: usize = 0x8A0; // 
                pub const m_bLOS: usize = 0x8A4; // 
            ...
            pub mod C_INIT_CreateSequentialPath {
                pub const m_fMaxDistance: usize = 0x1C8; // 
                pub const m_flNumToAssign: usize = 0x1CC; // 
                pub const m_bLoop: usize = 0x1D0; // 
                pub const m_bCPPairs: usize = 0x1D1; // 
                pub const m_bSaveOffset: usize = 0x1D2; // 
            ...
            pub mod C_OP_ContinuousEmitter {
                pub const m_flEmissionDuration: usize = 0x1C8; // 
                pub const m_flStartTime: usize = 0x328; // 
                pub const m_flEmitRate: usize = 0x488; // 
                pub const m_flEmissionScale: usize = 0x5E8; // 
                pub const m_flScalePerParentParticle: usize = 0x5EC; // 
                pub const m_bInitFromKilledParentParticles: usize = 0x5F0; // 
                pub const m_nEventType: usize = 0x5F4; // 
                pub const m_nSnapshotControlPoint: usize = 0x5F8; // 
                pub const m_nLimitPerUpdate: usize = 0x5FC; // 
                pub const m_bForceEmitOnFirstUpdate: usize = 0x600; // 
                pub const m_bForceEmitOnLastUpdate: usize = 0x601; // 
            }
            // Parent: CParticleFunctionOperator
            // Field count: 6
            //
            ...
            pub mod C_INIT_SequenceLifeTime {
                pub const m_flFramerate: usize = 0x1C8; // 
            }
            // Parent: CParticleFunctionInitializer
            // Field count: 7
            //
            ...
            pub mod C_INIT_MoveBetweenPoints {
                pub const m_flSpeedMin: usize = 0x1C8; // 
                pub const m_flSpeedMax: usize = 0x328; // 
                pub const m_flEndSpread: usize = 0x488; // 
                pub const m_flStartOffset: usize = 0x5E8; // 
                pub const m_flEndOffset: usize = 0x748; // 
                pub const m_nEndControlPointNumber: usize = 0x8A8; // 
                pub const m_bTrailBias: usize = 0x8AC; // 
            }
            // Parent: CParticleFunctionInitializer
            // Field count: 11
            //
            ...
            pub mod C_INIT_RemapScalar {
                pub const m_nFieldInput: usize = 0x1C8; // 
                ...
                pub const m_flStartTime: usize = 0x1E0; // 
                pub const m_flEndTime: usize = 0x1E4; // 
                pub const m_nSetMethod: usize = 0x1E8; // 
                pub const m_bActiveRange: usize = 0x1EC; // 
                pub const m_flRemapBias: usize = 0x1F0; // 
            }
            // Parent: CParticleFunctionOperator
            // Field count: 5
            //
            ...
            pub mod C_OP_SetUserEvent {
                pub const m_flInput: usize = 0x1C0; // 
                pub const m_flRisingEdge: usize = 0x320; // 
                pub const m_nRisingEventType: usize = 0x480; // 
                pub const m_flFallingEdge: usize = 0x488; // 
            ...
            pub mod C_OP_QuantizeFloat {
                ...
                pub const m_nOutputField: usize = 0x320; // 
            }
            ...
            pub mod C_OP_BasicMovement {
                ...
                pub const m_fDrag: usize = 0x838; // 
                pub const m_massControls: usize = 0x998; // 
                pub const m_nMaxConstraintPasses: usize = 0xDC0; // 
                pub const m_bUseNewCode: usize = 0xDC4; // 
            }
            // Parent: CParticleFunctionInitializer
            // Field count: 6
            //
            ...
            pub mod C_INIT_RandomNamedModelElement {
                ...
                pub const m_names: usize = 0x1D0; // 
                pub const m_bShuffle: usize = 0x1E8; // 
                pub const m_bLinear: usize = 0x1E9; // 
                pub const m_bModelFromRenderer: usize = 0x1EA; // 
            ...
            pub mod C_INIT_InitFromParentKilled {
                pub const m_nAttributeToCopy: usize = 0x1C8; // 
            ...
            pub mod CParticleFunction {
                ...
                pub const m_flOpStartFadeInTime: usize = 0x16C; // 
                pub const m_flOpEndFadeInTime: usize = 0x170; // 
                pub const m_flOpStartFadeOutTime: usize = 0x174; // 
                pub const m_flOpEndFadeOutTime: usize = 0x178; // 
                pub const m_flOpFadeOscillatePeriod: usize = 0x17C; // 
                pub const m_bNormalizeToStopTime: usize = 0x180; // 
                pub const m_flOpTimeOffsetMin: usize = 0x184; // 
                pub const m_flOpTimeOffsetMax: usize = 0x188; // 
                pub const m_nOpTimeOffsetSeed: usize = 0x18C; // 
                pub const m_nOpTimeScaleSeed: usize = 0x190; // 
                pub const m_flOpTimeScaleMin: usize = 0x194; // 
                pub const m_flOpTimeScaleMax: usize = 0x198; // 
                pub const m_bDisableOperator: usize = 0x19E; // 
                pub const m_Notes: usize = 0x1A0; // 
            }
            // Parent: CParticleFunctionOperator
            // Field count: 3
            //
            ...
            pub mod C_OP_SetParentControlPointsToChildCP {
                pub const m_nChildGroupID: usize = 0x1C8; // 
                pub const m_nChildControlPoint: usize = 0x1CC; // 
                pub const m_nNumControlPoints: usize = 0x1D0; // 
                pub const m_nFirstSourcePoint: usize = 0x1D4; // 
                pub const m_bSetOrientation: usize = 0x1D8; // 
            }
            // Parent: CParticleFunctionForce
            // Field count: 1
            //
            ...
            pub mod C_OP_BoxConstraint {
                ...
                pub const m_vecMax: usize = 0x838; // 
                pub const m_nCP: usize = 0xEB0; // 
                pub const m_bLocalSpace: usize = 0xEB4; // 
                pub const m_bAccountForRadius: usize = 0xEB5; // 
            }
            // Parent: CParticleFunctionInitializer
            // Field count: 14
            //
            ...
            pub mod C_INIT_CreatePhyllotaxis {
                ...
                pub const m_nComponent: usize = 0x1D0; // 
                pub const m_fRadCentCore: usize = 0x1D4; // 
                pub const m_fRadPerPoint: usize = 0x1D8; // 
                pub const m_fRadPerPointTo: usize = 0x1DC; // 
                pub const m_fpointAngle: usize = 0x1E0; // 
                pub const m_fsizeOverall: usize = 0x1E4; // 
                pub const m_fRadBias: usize = 0x1E8; // 
                pub const m_fMinRad: usize = 0x1EC; // 
                pub const m_fDistBias: usize = 0x1F0; // 
                pub const m_bUseLocalCoords: usize = 0x1F4; // 
                pub const m_bUseWithContEmit: usize = 0x1F5; // 
                pub const m_bUseOrigRadius: usize = 0x1F6; // 
            }
            // Parent: CParticleFunctionForce
            // Field count: 6
            //
            ...
            pub mod C_OP_AttractToControlPoint {
                ...
                pub const m_fFalloffPower: usize = 0x340; // 
                pub const m_TransformInput: usize = 0x348; // 
                pub const m_fForceAmountMin: usize = 0x3B0; // 
                pub const m_bApplyMinForce: usize = 0x510; // 
            }
            // Parent: CParticleFunctionInitializer
            // Field count: 3
            //
            ...
            pub mod C_INIT_RandomLifeTime {
                pub const m_fLifetimeMin: usize = 0x1C8; // 
                pub const m_fLifetimeMax: usize = 0x1CC; // 
                pub const m_fLifetimeRandExponent: usize = 0x1D0; // 
            }
            ...
            pub mod C_INIT_VelocityRadialRandom {
                ...
                pub const m_fSpeedMin: usize = 0x1D0; // 
                pub const m_fSpeedMax: usize = 0x330; // 
                pub const m_vecLocalCoordinateSystemSpeedScale: usize = 0x490; // 
                pub const m_bIgnoreDelta: usize = 0x49D; // 
            }
            // Parent: CParticleFunctionInitializer
            // Field count: 3
            //
            ...
            pub mod C_INIT_RandomRadius {
                pub const m_flRadiusMin: usize = 0x1C8; // 
                pub const m_flRadiusMax: usize = 0x1CC; // 
                pub const m_flRadiusRandExponent: usize = 0x1D0; // 
            }
            // Parent: CParticleFunctionOperator
            // Field count: 4
            //
            ...
            pub mod TextureControls_t {
                ...
                pub const m_bRandomizeOffsets: usize = 0x9A0; // 
                pub const m_bClampUVs: usize = 0x9A1; // 
            ...
            pub mod C_OP_SetControlPointToVectorExpression {
                ...
                pub const m_nOutputCP: usize = 0x1CC; // 
                pub const m_vInput1: usize = 0x1D0; // 
                pub const m_vInput2: usize = 0x848; // 
                pub const m_bNormalizedOutput: usize = 0xEC0; // 
            }
            // Parent: CParticleFunctionPreEmission
            // Field count: 15
            //
            ...
            pub mod C_OP_LightningSnapshotGenerator {
                pub const m_nCPSnapshot: usize = 0x1C8; // 
                pub const m_nCPStartPnt: usize = 0x1CC; // 
                pub const m_nCPEndPnt: usize = 0x1D0; // 
                pub const m_flSegments: usize = 0x1D8; // 
                pub const m_flOffset: usize = 0x338; // 
                pub const m_flOffsetDecay: usize = 0x498; // 
                pub const m_flRecalcRate: usize = 0x5F8; // 
                pub const m_flUVScale: usize = 0x758; // 
                pub const m_flUVOffset: usize = 0x8B8; // 
                pub const m_flSplitRate: usize = 0xA18; // 
                pub const m_flBranchTwist: usize = 0xB78; // 
                pub const m_nBranchBehavior: usize = 0xCD8; // ParticleLightnintBranchBehavior_t
                pub const m_flRadiusStart: usize = 0xCE0; // 
                pub const m_flRadiusEnd: usize = 0xE40; // 
                pub const m_flDedicatedPool: usize = 0xFA0; // 
            }
            ...
            pub mod C_INIT_RemapSpeedToScalar {
                pub const m_nFieldOutput: usize = 0x1C8; // 
                pub const m_nControlPointNumber: usize = 0x1CC; // 
                ...
                pub const m_nSetMethod: usize = 0x1E8; // 
                pub const m_bPerParticle: usize = 0x1EC; // 
            }
            // Parent: CParticleFunctionInitializer
            // Field count: 1
            //
            ...
            pub mod C_INIT_PositionWarp {
                pub const m_vecWarpMin: usize = 0x1C8; // 
                pub const m_vecWarpMax: usize = 0x840; // 
                pub const m_nScaleControlPointNumber: usize = 0xEB8; // 
                pub const m_nControlPointNumber: usize = 0xEBC; // 
                pub const m_nRadiusComponent: usize = 0xEC0; // 
                pub const m_flWarpTime: usize = 0xEC4; // 
                pub const m_flWarpStartTime: usize = 0xEC8; // 
                pub const m_flPrevPosScale: usize = 0xECC; // 
                pub const m_bInvertWarp: usize = 0xED0; // 
                pub const m_bUseCount: usize = 0xED1; // 
            }
            // Parent: CParticleFunctionConstraint
            // Field count: 3
            //
            ...
            pub mod C_OP_SDFConstraint {
                ...
                pub const m_flMaxDist: usize = 0x320; // 
                pub const m_nMaxIterations: usize = 0x480; // 
            }
            // Parent: CParticleFunctionPreEmission
            // Field count: 6
            //
            ...
            pub mod C_OP_SetControlPointFieldToScalarExpression {
                pub const m_nExpression: usize = 0x1C8; // 
                pub const m_flInput1: usize = 0x1D0; // 
                pub const m_flInput2: usize = 0x330; // 
                pub const m_flOutputRemap: usize = 0x490; // 
                pub const m_nOutputCP: usize = 0x5F0; // 
                pub const m_nOutVectorField: usize = 0x5F4; // 
            }
            ...
            pub mod C_INIT_RandomVectorComponent {
                pub const m_flMin: usize = 0x1C8; // 
                pub const m_flMax: usize = 0x1CC; // 
                pub const m_nFieldOutput: usize = 0x1D0; // 
                pub const m_nComponent: usize = 0x1D4; // 
            }
            // Parent: CParticleFunctionOperator
            // Field count: 4
            //
            ...
            pub mod C_INIT_SetVectorAttributeToVectorExpression {
                ...
                pub const m_vInput1: usize = 0x1D0; // 
                pub const m_vInput2: usize = 0x848; // 
                pub const m_nOutputField: usize = 0xEC0; // 
                pub const m_nSetMethod: usize = 0xEC4; // 
                pub const m_bNormalizedOutput: usize = 0xEC8; // 
            }
            // Parent: CParticleFunctionOperator
            // Field count: 8
            //
            ...
            pub mod C_OP_DirectionBetweenVecsToVec {
                ...
                pub const m_vecPoint2: usize = 0x840; // 
            }
            // Parent: CParticleFunctionOperator
            // Field count: 4
            //
            ...
            pub mod C_OP_MovementLoopInsideSphere {
                ...
                pub const m_nDistSqrAttr: usize = 0x9A0; // 
            }
            // Parent: CParticleFunctionRenderer
            // Field count: 8
            //
            ...
            pub mod C_OP_RenderSimpleModelCollection {
                pub const m_bCenterOffset: usize = 0x210; // 
                pub const m_hModel: usize = 0x218; // 
                pub const m_modelInput: usize = 0x220; // 
                pub const m_fSizeCullScale: usize = 0x280; // 
                pub const m_bDisableShadows: usize = 0x3E0; // 
                pub const m_bDisableMotionBlur: usize = 0x3E1; // 
                pub const m_bAcceptsDecals: usize = 0x3E2; // 
                pub const m_nAngularVelocityField: usize = 0x3E4; // 
            }
            // Parent: CParticleFunctionPreEmission
            // Field count: 4
            //
            ...
            pub mod C_OP_QuantizeCPComponent {
                pub const m_flInputValue: usize = 0x1C8; // 
            ...
            pub mod C_OP_PlayEndCapWhenFinished {
                pub const m_bFireOnEmissionEnd: usize = 0x1C8; // 
                pub const m_bIncludeChildren: usize = 0x1C9; // 
            }
            // Parent: CParticleFunctionInitializer
            // Field count: 2
            //
            ...
            pub mod C_INIT_InitFloatCollection {
                pub const m_InputValue: usize = 0x1C8; // 
                pub const m_nOutputField: usize = 0x328; // 
            }
            // Parent: None
            // Field count: 8
            //
            ...
            pub mod C_INIT_CreateFromPlaneCache {
                pub const m_vecOffsetMin: usize = 0x1C8; // 
                pub const m_vecOffsetMax: usize = 0x1D4; // 
                pub const m_bUseNormal: usize = 0x1E1; // 
            }
            // Parent: CParticleFunctionPreEmission
            // Field count: 5
            //
            ...
            pub mod C_OP_ControlPointToRadialScreenSpace {
                pub const m_nCPIn: usize = 0x1C8; // 
                pub const m_vecCP1Pos: usize = 0x1CC; // 
                pub const m_nCPOut: usize = 0x1D8; // 
                pub const m_nCPOutField: usize = 0x1DC; // 
                pub const m_nCPSSPosOut: usize = 0x1E0; // 
            }
            ...
            pub mod C_INIT_NormalOffset {
                pub const m_OffsetMin: usize = 0x1C8; // 
                pub const m_OffsetMax: usize = 0x1D4; // 
                pub const m_nControlPointNumber: usize = 0x1E0; // 
                pub const m_bLocalCoords: usize = 0x1E4; // 
                pub const m_bNormalize: usize = 0x1E5; // 
            }
            ...
            pub mod C_OP_RemapDistanceToLineSegmentToVector {
                ...
                pub const m_vMinOutputValue: usize = 0x1DC; // 
                pub const m_vMaxOutputValue: usize = 0x1E8; // 
            }
            // Parent: CParticleFunctionRenderer
            // Field count: 8
            //
            ...
            pub mod C_OP_RenderAsModels {
                ...
                pub const m_flModelScale: usize = 0x22C; // 
                pub const m_bFitToModelSize: usize = 0x230; // 
                pub const m_bNonUniformScaling: usize = 0x231; // 
                pub const m_nXAxisScalingAttribute: usize = 0x234; // 
                pub const m_nYAxisScalingAttribute: usize = 0x238; // 
                pub const m_nZAxisScalingAttribute: usize = 0x23C; // 
                pub const m_nSizeCullBloat: usize = 0x240; // 
            }
            // Parent: CParticleFunctionInitializer
            // Field count: 10
            //
            ...
            pub mod C_INIT_CreationNoise {
                pub const m_nFieldOutput: usize = 0x1C8; // 
                pub const m_bAbsVal: usize = 0x1CC; // 
                pub const m_bAbsValInv: usize = 0x1CD; // 
                pub const m_flOffset: usize = 0x1D0; // 
                pub const m_flOutputMin: usize = 0x1D4; // 
                pub const m_flOutputMax: usize = 0x1D8; // 
                pub const m_flNoiseScale: usize = 0x1DC; // 
                pub const m_flNoiseScaleLoc: usize = 0x1E0; // 
                pub const m_vecOffsetLoc: usize = 0x1E4; // 
                pub const m_flWorldTimeScale: usize = 0x1F0; // 
            }
            // Parent: CGeneralSpin
            // Field count: 0
            //
            ...
            pub mod CParticleVecInput {
                ...
                pub const m_FloatComponentY: usize = 0x208; // 
                pub const m_FloatComponentZ: usize = 0x368; // 
                pub const m_FloatInterp: usize = 0x4C8; // 
                pub const m_flInterpInput0: usize = 0x628; // 
                pub const m_flInterpInput1: usize = 0x62C; // 
                pub const m_vInterpOutput0: usize = 0x630; // 
                pub const m_vInterpOutput1: usize = 0x63C; // 
                pub const m_Gradient: usize = 0x648; // 
                pub const m_vRandomMin: usize = 0x660; // 
                pub const m_vRandomMax: usize = 0x66C; // 
            }
            // Parent: CParticleFunctionEmitter
            // Field count: 7
            //
            ...
            pub mod C_OP_InstantaneousEmitter {
                pub const m_nParticlesToEmit: usize = 0x1C8; // 
                pub const m_flStartTime: usize = 0x328; // 
                pub const m_flInitFromKilledParentParticles: usize = 0x488; // 
                pub const m_nEventType: usize = 0x48C; // 
                pub const m_flParentParticleScale: usize = 0x490; // 
                pub const m_nMaxEmittedPerFrame: usize = 0x5F0; // 
                pub const m_nSnapshotControlPoint: usize = 0x5F4; // 
            }
            // Parent: CParticleFunctionConstraint
            // Field count: 2
            //
            ...
            pub mod C_INIT_LifespanFromVelocity {
                ...
                pub const m_flTraceOffset: usize = 0x1D4; // 
                pub const m_flMaxTraceLength: usize = 0x1D8; // 
                pub const m_flTraceTolerance: usize = 0x1DC; // 
                pub const m_nMaxPlanes: usize = 0x1E0; // 
                pub const m_CollisionGroupName: usize = 0x1E8; // 
                pub const m_nTraceSet: usize = 0x268; // 
                pub const m_bIncludeWater: usize = 0x278; // 
            }
            // Parent: CBaseRendererSource2
            // Field count: 7
            //
            ...
            pub mod CBaseTrailRenderer {
                ...
                pub const m_nOrientationControlPoint: usize = 0x2AAC; // 
                pub const m_flMinSize: usize = 0x2AB0; // 
                pub const m_flMaxSize: usize = 0x2AB4; // 
                ...
                pub const m_bClampV: usize = 0x2D78; // 
            }
            // Parent: CParticleFunctionInitializer
            // Field count: 4
            //
            ...
            pub mod C_INIT_VelocityFromCP {
                pub const m_velocityInput: usize = 0x1C8; // 
                pub const m_transformInput: usize = 0x840; // 
                pub const m_flVelocityScale: usize = 0x8A8; // 
                pub const m_bDirectionOnly: usize = 0x8AC; // 
            }
            // Parent: CParticleFunctionPreEmission
            // Field count: 8
            //
            ...
            pub mod C_OP_SetControlPointOrientation {
                pub const m_bUseWorldLocation: usize = 0x1C8; // 
                pub const m_bRandomize: usize = 0x1CA; // 
                pub const m_bSetOnce: usize = 0x1CB; // 
                pub const m_nCP: usize = 0x1CC; // 
                pub const m_nHeadLocation: usize = 0x1D0; // 
                pub const m_vecRotation: usize = 0x1D4; // 
                pub const m_vecRotationB: usize = 0x1E0; // 
                pub const m_flInterpolation: usize = 0x1F0; // 
            }
            // Parent: CParticleFunctionOperator
            // Field count: 12
            //
            ...
            pub mod C_OP_MovementSkinnedPositionFromCPSnapshot {
                ...
                pub const m_flReadIndex: usize = 0x1D8; // 
                pub const m_flIncrement: usize = 0x338; // 
                pub const m_nFullLoopIncrement: usize = 0x498; // 
                pub const m_nSnapShotStartPoint: usize = 0x5F8; // 
                pub const m_flInterpolation: usize = 0x758; // 
            }
            // Parent: CParticleFunctionOperator
            // Field count: 15
            //
            ...
            pub mod C_OP_OscillateVector {
                ...
                pub const m_flOscAdd: usize = 0x368; // 
                pub const m_flRateScale: usize = 0x4C8; // 
            }
            // Parent: CParticleFunctionOperator
            // Field count: 15
            //
            ...
            pub mod C_OP_PositionLock {
                ...
                pub const m_flJumpThreshold: usize = 0x3A8; // 
                pub const m_flPrevPosScale: usize = 0x3AC; // 
                pub const m_bLockRot: usize = 0x3B0; // 
                pub const m_vecScale: usize = 0x3B8; // 
                pub const m_nFieldOutput: usize = 0xA30; // 
                pub const m_nFieldOutputPrev: usize = 0xA34; // 
            }
            // Parent: CParticleFunctionRenderer
            // Field count: 4
            //
            ...
            pub mod C_OP_RenderVRHapticEvent {
                ...
                pub const m_nOutputHandCP: usize = 0x214; // 
                pub const m_nOutputField: usize = 0x218; // 
                pub const m_flAmplitude: usize = 0x220; // 
            }
            // Parent: CParticleFunctionPreEmission
            // Field count: 12
            //
            ...
            pub mod C_OP_SetControlPointToImpactPoint {
                pub const m_nCPOut: usize = 0x1C8; // 
                pub const m_nCPIn: usize = 0x1CC; // 
                pub const m_flUpdateRate: usize = 0x1D0; // 
                pub const m_flTraceLength: usize = 0x1D8; // 
            ...
            pub mod C_OP_SetControlPointToPlayer {
                pub const m_nCP1: usize = 0x1C8; // 
                pub const m_vecCP1Pos: usize = 0x1CC; // 
                pub const m_bOrientToEyes: usize = 0x1D8; // 
            }
            // Parent: CParticleFunctionOperator
            // Field count: 1
            //
            ...
            pub mod C_OP_RenderGpuImplicit {
                pub const m_bUsePerParticleRadius: usize = 0x210; // 
                pub const m_nVertexCountKb: usize = 0x214; // 
                pub const m_nIndexCountKb: usize = 0x218; // 
                ...
                pub const m_nScaleCP: usize = 0x640; // 
                pub const m_hMaterial: usize = 0x648; // 
            }
            ...
            pub mod C_OP_SetRandomControlPointPosition {
                pub const m_bUseWorldLocation: usize = 0x1C8; // 
                pub const m_bOrient: usize = 0x1C9; // 
                pub const m_nCP1: usize = 0x1CC; // 
                pub const m_nHeadLocation: usize = 0x1D0; // 
                pub const m_flReRandomRate: usize = 0x1D8; // 
            ...
            pub mod C_OP_DragRelativeToPlane {
                ...
                pub const m_flFalloff: usize = 0x320; // 
                pub const m_bDirectional: usize = 0x480; // 
                pub const m_vecPlaneNormal: usize = 0x488; // 
                pub const m_nControlPointNumber: usize = 0xB00; // 
            }
            // Parent: CParticleFunctionOperator
            // Field count: 2
            //
            ...
            pub mod C_OP_SetSingleControlPointPosition {
                pub const m_bSetOnce: usize = 0x1C8; // 
                pub const m_nCP1: usize = 0x1CC; // 
                pub const m_vecCP1Pos: usize = 0x1D0; // 
                pub const m_transformInput: usize = 0x848; // 
            }
            // Parent: CParticleFunctionInitializer
            // Field count: 2
            //
            ...
            pub mod C_INIT_DistanceToNeighborCull {
                pub const m_flDistance: usize = 0x1C8; // 
                pub const m_bIncludeRadii: usize = 0x328; // 
            }
            // Parent: CParticleFunctionOperator
            // Field count: 11
            //
            ...
            pub mod CParticleFunctionRenderer {
                ...
                pub const m_bCannotBeRefracted: usize = 0x208; // 
                pub const m_bSkipRenderingOnMobile: usize = 0x209; // 
            }
            ...
            pub mod C_OP_RenderScreenVelocityRotate {
                pub const m_flRotateRateDegrees: usize = 0x210; // 
                pub const m_flForwardDegrees: usize = 0x214; // 
            }
            // Parent: CParticleFunctionOperator
            // Field count: 6
            //
            ...
            pub mod C_INIT_CreateWithinBox {
                pub const m_vecMin: usize = 0x1C8; // 
                pub const m_vecMax: usize = 0x840; // 
                pub const m_nControlPointNumber: usize = 0xEB8; // 
                pub const m_bLocalSpace: usize = 0xEBC; // 
            ...
            pub mod C_OP_ChooseRandomChildrenInGroup {
                pub const m_nChildGroupID: usize = 0x1C8; // 
                pub const m_flNumberOfChildren: usize = 0x1D0; // 
            }
            // Parent: CParticleFunctionOperator
            // Field count: 33
            //
            ...
            pub mod C_OP_ControlpointLight {
                pub const m_flScale: usize = 0x1C0; // 
                pub const m_nControlPoint1: usize = 0x650; // 
                pub const m_nControlPoint2: usize = 0x654; // 
                pub const m_nControlPoint3: usize = 0x658; // 
                pub const m_nControlPoint4: usize = 0x65C; // 
                ...
                pub const m_LightFiftyDist1: usize = 0x690; // 
                pub const m_LightZeroDist1: usize = 0x694; // 
                pub const m_LightFiftyDist2: usize = 0x698; // 
                pub const m_LightZeroDist2: usize = 0x69C; // 
                pub const m_LightFiftyDist3: usize = 0x6A0; // 
                pub const m_LightZeroDist3: usize = 0x6A4; // 
                pub const m_LightFiftyDist4: usize = 0x6A8; // 
                pub const m_LightZeroDist4: usize = 0x6AC; // 
                pub const m_LightColor1: usize = 0x6B0; // 
                pub const m_LightColor2: usize = 0x6B4; // 
                pub const m_LightColor3: usize = 0x6B8; // 
                pub const m_LightColor4: usize = 0x6BC; // 
                pub const m_bLightType1: usize = 0x6C0; // 
                pub const m_bLightType2: usize = 0x6C1; // 
                pub const m_bLightType3: usize = 0x6C2; // 
                pub const m_bLightType4: usize = 0x6C3; // 
                pub const m_bLightDynamic1: usize = 0x6C4; // 
                pub const m_bLightDynamic2: usize = 0x6C5; // 
                pub const m_bLightDynamic3: usize = 0x6C6; // 
                pub const m_bLightDynamic4: usize = 0x6C7; // 
                pub const m_bUseNormal: usize = 0x6C8; // 
                pub const m_bUseHLambert: usize = 0x6C9; // 
                pub const m_bClampLowerRange: usize = 0x6CE; // 
                pub const m_bClampUpperRange: usize = 0x6CF; // 
            }
            // Parent: CParticleFunctionOperator
            // Field count: 9
            //
            ...
            pub mod C_OP_VectorFieldSnapshot {
                ...
                pub const m_vecScale: usize = 0x330; // 
                pub const m_flBoundaryDampening: usize = 0x9A8; // 
                pub const m_bSetVelocity: usize = 0x9AC; // 
                pub const m_bLockToSurface: usize = 0x9AD; // 
                pub const m_flGridSpacing: usize = 0x9B0; // 
            }
            // Parent: CParticleFunctionOperator
            // Field count: 11
            //
            ...
            pub mod C_OP_CylindricalDistanceToTransform {
                ...
                pub const m_flOutputMin: usize = 0x488; // 
                pub const m_flOutputMax: usize = 0x5E8; // 
                pub const m_TransformStart: usize = 0x748; // 
                pub const m_TransformEnd: usize = 0x7B0; // 
                pub const m_nSetMethod: usize = 0x818; // 
                pub const m_bActiveRange: usize = 0x81C; // 
                pub const m_bAdditive: usize = 0x81D; // 
                pub const m_bCapsule: usize = 0x81E; // 
            }
            // Parent: CParticleFunctionInitializer
            // Field count: 13
            //
            ...
            pub mod C_INIT_PositionPlaceOnGround {
                ...
                pub const m_flMaxTraceLength: usize = 0x328; // 
                pub const m_CollisionGroupName: usize = 0x488; // 
                pub const m_nTraceSet: usize = 0x508; // 
                pub const m_nTraceMissBehavior: usize = 0x518; // 
                pub const m_bIncludeWater: usize = 0x51C; // 
                pub const m_bSetNormal: usize = 0x51D; // 
                pub const m_bSetPXYZOnly: usize = 0x51E; // 
                pub const m_bTraceAlongNormal: usize = 0x51F; // 
                pub const m_bOffsetonColOnly: usize = 0x520; // 
                pub const m_flOffsetByRadiusFactor: usize = 0x524; // 
                pub const m_nPreserveOffsetCP: usize = 0x528; // 
                pub const m_nIgnoreCP: usize = 0x52C; // 
            }
            // Parent: CParticleFunctionInitializer
            // Field count: 4
            //
            ...
            pub mod C_INIT_RandomScalar {
                pub const m_flMin: usize = 0x1C8; // 
                pub const m_flMax: usize = 0x1CC; // 
                pub const m_flExponent: usize = 0x1D0; // 
                pub const m_nFieldOutput: usize = 0x1D4; // 
            }
            // Parent: CParticleFunctionRenderer
            // Field count: 3
            //
            ...
            pub mod C_OP_RenderPostProcessing {
                pub const m_flPostProcessStrength: usize = 0x210; // 
                pub const m_hPostTexture: usize = 0x370; // 
                pub const m_nPriority: usize = 0x378; // 
            }
            // Parent: CParticleFunctionConstraint
            // Field count: 27
            //
            ...
            pub mod C_OP_WorldTraceConstraint {
                ...
                pub const m_flBounceAmount: usize = 0x3D8; // 
                pub const m_flSlideAmount: usize = 0x538; // 
                pub const m_flRandomDirScale: usize = 0x698; // 
                pub const m_bDecayBounce: usize = 0x7F8; // 
                pub const m_bKillonContact: usize = 0x7F9; // 
                pub const m_flMinSpeed: usize = 0x7FC; // 
                pub const m_bSetNormal: usize = 0x800; // 
                pub const m_nStickOnCollisionField: usize = 0x804; // 
                pub const m_flStopSpeed: usize = 0x808; // 
                pub const m_nEntityStickDataField: usize = 0x968; // 
                pub const m_nEntityStickNormalField: usize = 0x96C; // 
            }
            // Parent: CParticleVecInput
            // Field count: 0
            //
            ...
            pub mod C_OP_RenderBlobs {
                ...
                pub const m_nVertexCountKb: usize = 0x630; // 
                pub const m_nIndexCountKb: usize = 0x634; // 
                pub const m_nScaleCP: usize = 0x638; // 
                pub const m_MaterialVars: usize = 0x640; // 
                pub const m_hMaterial: usize = 0x670; // 
            }
            // Parent: CParticleFunctionOperator
            // Field count: 13
            //
            ...
            pub mod C_INIT_RandomSequence {
                pub const m_nSequenceMin: usize = 0x1C8; // 
                pub const m_nSequenceMax: usize = 0x1CC; // 
                pub const m_bShuffle: usize = 0x1D0; // 
                pub const m_bLinear: usize = 0x1D1; // 
            ...
            pub mod C_INIT_DistanceCull {
                ...
                pub const m_bCullInside: usize = 0x330; // 
            }
            // Parent: CParticleFunctionConstraint
            // Field count: 2
            //
            ...
            pub mod C_OP_CollideWithParentParticles {
                ...
                pub const m_flRadiusScale: usize = 0x320; // 
            }
            // Parent: CParticleFunctionInitializer
            // Field count: 5
            //
            ...
            pub mod C_INIT_InitFromVectorFieldSnapshot {
                ...
                pub const m_nWeightUpdateCP: usize = 0x1D0; // 
                pub const m_bUseVerticalVelocity: usize = 0x1D4; // 
            ...
            pub mod C_OP_SetVectorAttributeToVectorExpression {
                ...
                pub const m_vInput2: usize = 0x840; // 
                pub const m_nOutputField: usize = 0xEB8; // 
            ...
            pub mod C_INIT_AddVectorToVector {
                ...
                pub const m_nFieldOutput: usize = 0x1D4; // 
                pub const m_nFieldInput: usize = 0x1D8; // 
                pub const m_vOffsetMin: usize = 0x1DC; // 
                pub const m_vOffsetMax: usize = 0x1E8; // 
            ...
            pub mod C_OP_RenderStatusEffect {
                pub const m_pTextureColorWarp: usize = 0x210; // 
                pub const m_pTextureDetail2: usize = 0x218; // 
                pub const m_pTextureDiffuseWarp: usize = 0x220; // 
                pub const m_pTextureFresnelColorWarp: usize = 0x228; // 
                pub const m_pTextureFresnelWarp: usize = 0x230; // 
                pub const m_pTextureSpecularWarp: usize = 0x238; // 
                pub const m_pTextureEnvMap: usize = 0x240; // 
            }
            // Parent: CParticleFunctionForce
            // Field count: 2
            //
            ...
            pub mod C_INIT_RemapTransformToVector {
                ...
                pub const m_TransformInput: usize = 0x200; // 
                pub const m_LocalSpaceTransform: usize = 0x268; // 
                pub const m_flStartTime: usize = 0x2D0; // 
                pub const m_flEndTime: usize = 0x2D4; // 
                pub const m_nSetMethod: usize = 0x2D8; // 
                pub const m_bOffset: usize = 0x2DC; // 
                pub const m_bAccelerate: usize = 0x2DD; // 
                pub const m_flRemapBias: usize = 0x2E0; // 
            }
            // Parent: CParticleFunctionOperator
            // Field count: 3
            //
            ...
            pub mod C_OP_RemapDistanceToLineSegmentToScalar {
                pub const m_nFieldOutput: usize = 0x1D8; // 
                pub const m_flMinOutputValue: usize = 0x1DC; // 
                pub const m_flMaxOutputValue: usize = 0x1E0; // 
            }
            ...
            pub mod C_OP_SetFromCPSnapshot {
                ...
                pub const m_nSnapShotIncrement: usize = 0x338; // 
                pub const m_flInterpolation: usize = 0x498; // 
                pub const m_bSubSample: usize = 0x5F8; // 
                pub const m_bPrev: usize = 0x5F9; // 
            }
            // Parent: CParticleFunctionPreEmission
            // Field count: 15
            //
            ...
            pub mod C_OP_DistanceBetweenCPsToCP {
                pub const m_nStartCP: usize = 0x1C8; // 
                pub const m_nEndCP: usize = 0x1CC; // 
                pub const m_nOutputCP: usize = 0x1D0; // 
                pub const m_nOutputCPField: usize = 0x1D4; // 
                pub const m_bSetOnce: usize = 0x1D8; // 
                ...
                pub const m_flMaxTraceLength: usize = 0x1EC; // 
                pub const m_flLOSScale: usize = 0x1F0; // 
                pub const m_bLOS: usize = 0x1F4; // 
                pub const m_CollisionGroupName: usize = 0x1F5; // 
                pub const m_nTraceSet: usize = 0x278; // 
            ...
            pub mod C_OP_SetControlPointToHand {
                pub const m_nCP1: usize = 0x1C8; // 
                pub const m_nHand: usize = 0x1CC; // 
                pub const m_vecCP1Pos: usize = 0x1D0; // 
                pub const m_bOrientToHand: usize = 0x1DC; // 
            }
            // Parent: CParticleFunctionConstraint
            // Field count: 8
            //
            ...
            pub mod C_OP_RemapSDFDistanceToScalarAttribute {
                ...
                pub const m_flMinDistance: usize = 0x1C8; // 
                pub const m_flMaxDistance: usize = 0x328; // 
                pub const m_flValueBelowMin: usize = 0x488; // 
                pub const m_flValueAtMin: usize = 0x5E8; // 
                pub const m_flValueAtMax: usize = 0x748; // 
                pub const m_flValueAboveMax: usize = 0x8A8; // 
            }
            // Parent: CParticleFunctionInitializer
            // Field count: 5
            //
            ...
            pub mod C_OP_RenderLights {
                pub const m_flAnimationRate: usize = 0x218; // 
                pub const m_nAnimationType: usize = 0x21C; // 
                pub const m_bAnimateInFPS: usize = 0x220; // 
                pub const m_flMinSize: usize = 0x224; // 
                pub const m_flMaxSize: usize = 0x228; // 
                pub const m_flStartFadeSize: usize = 0x22C; // 
                pub const m_flEndFadeSize: usize = 0x230; // 
            }
            // Parent: CParticleFunctionOperator
            // Field count: 1
            //
            ...
            pub mod C_INIT_ColorLitPerParticle {
                pub const m_ColorMin: usize = 0x1E0; // 
                pub const m_ColorMax: usize = 0x1E4; // 
                pub const m_TintMin: usize = 0x1E8; // 
                pub const m_TintMax: usize = 0x1EC; // 
                pub const m_flTintPerc: usize = 0x1F0; // 
                pub const m_nTintBlendMode: usize = 0x1F4; // 
                pub const m_flLightAmplification: usize = 0x1F8; // 
            }
            // Parent: CParticleFunctionRenderer
            // Field count: 1
            //
            ...
            pub mod C_OP_RenderPoints {
                pub const m_hMaterial: usize = 0x210; // 
            }
            // Parent: CParticleFunctionInitializer
            // Field count: 6
            //
            ...
            pub mod C_INIT_SetAttributeToScalarExpression {
                ...
                pub const m_flInput2: usize = 0x330; // 
                pub const m_flOutputRemap: usize = 0x490; // 
                pub const m_nOutputField: usize = 0x5F0; // 
            ...
            pub mod C_INIT_CreateOnGrid {
                pub const m_nXCount: usize = 0x1C8; // 
                pub const m_nYCount: usize = 0x328; // 
                pub const m_nZCount: usize = 0x488; // 
                pub const m_nXSpacing: usize = 0x5E8; // 
                pub const m_nYSpacing: usize = 0x748; // 
                pub const m_nZSpacing: usize = 0x8A8; // 
                pub const m_nControlPointNumber: usize = 0xA08; // 
                pub const m_bLocalSpace: usize = 0xA0C; // 
                pub const m_bCenter: usize = 0xA0D; // 
                pub const m_bHollow: usize = 0xA0E; // 
            }
            // Parent: CParticleFunctionPreEmission
            // Field count: 3
            //
            ...
            pub mod C_OP_RampCPLinearRandom {
                ...
                pub const m_vecRateMin: usize = 0x1CC; // 
                pub const m_vecRateMax: usize = 0x1D8; // 
            }
            // Parent: CParticleFunctionOperator
            // Field count: 6
            //
            ...
            pub mod C_OP_VelocityMatchingForce {
                ...
                pub const m_flNeighborDistance: usize = 0x1C8; // 
                pub const m_flFacingStrength: usize = 0x1CC; // 
                pub const m_bUseAABB: usize = 0x1D0; // 
                pub const m_nCPBroadcast: usize = 0x1D4; // 
            }
            // Parent: CParticleFunctionInitializer
            // Field count: 3
            //
            ...
            pub mod C_INIT_CreateOnModelAtHeight {
                pub const m_bUseBones: usize = 0x1C8; // 
                pub const m_bForceZ: usize = 0x1C9; // 
                pub const m_nControlPointNumber: usize = 0x1CC; // 
                pub const m_nHeightCP: usize = 0x1D0; // 
                pub const m_bUseWaterHeight: usize = 0x1D4; // 
                pub const m_flDesiredHeight: usize = 0x1D8; // 
                pub const m_vecHitBoxScale: usize = 0x338; // 
                pub const m_vecDirectionBias: usize = 0x9B0; // 
                pub const m_nBiasType: usize = 0x1028; // 
                pub const m_bLocalCoords: usize = 0x102C; // 
                pub const m_bPreferMovingBoxes: usize = 0x102D; // 
                pub const m_HitboxSetName: usize = 0x102E; // 
                pub const m_flHitboxVelocityScale: usize = 0x10B0; // 
                pub const m_flMaxBoneVelocity: usize = 0x1210; // 
            }
            // Parent: None
            // Field count: 2
            //
            ...
            pub mod C_INIT_CreateSequentialPathV2 {
                pub const m_fMaxDistance: usize = 0x1C8; // 
                pub const m_flNumToAssign: usize = 0x328; // 
                pub const m_bLoop: usize = 0x488; // 
                pub const m_bCPPairs: usize = 0x489; // 
                pub const m_bSaveOffset: usize = 0x48A; // 
            ...
            pub mod C_INIT_RemapInitialDirectionToTransformToVector {
                pub const m_TransformInput: usize = 0x1C8; // 
                pub const m_nFieldOutput: usize = 0x230; // 
                pub const m_flScale: usize = 0x234; // 
                pub const m_flOffsetRot: usize = 0x238; // 
                pub const m_vecOffsetAxis: usize = 0x23C; // 
                pub const m_bNormalize: usize = 0x248; // 
            }
            // Parent: CParticleFunctionOperator
            // Field count: 4
            //
            ...
            pub mod C_INIT_RemapTransformOrientationToRotations {
                pub const m_TransformInput: usize = 0x1C8; // 
                pub const m_vecRotation: usize = 0x230; // 
                pub const m_bUseQuat: usize = 0x23C; // 
                pub const m_bWriteNormal: usize = 0x23D; // 
            }
            // Parent: CParticleFunctionOperator
            // Field count: 4
            //
            ...
            pub mod C_INIT_RandomYawFlip {
                pub const m_flPercent: usize = 0x1C8; // 
            }
            // Parent: CParticleFunctionOperator
            // Field count: 1
            //
            ...
            pub mod C_OP_ReadFromNeighboringParticle {
                ...
                pub const m_flInterpolation: usize = 0x330; // 
            }
            // Parent: CParticleFunctionRenderer
            // Field count: 2
            //
            ...
            pub mod C_OP_RenderText {
                pub const m_OutlineColor: usize = 0x210; // 
                pub const m_DefaultText: usize = 0x218; // 
            }
            // Parent: CParticleFunctionOperator
            // Field count: 5
            //
            ...
            pub mod C_OP_LerpToInitialPosition {
                pub const m_nControlPointNumber: usize = 0x1C0; // 
                pub const m_flInterpolation: usize = 0x1C8; // 
                pub const m_nCacheField: usize = 0x328; // 
                pub const m_flScale: usize = 0x330; // 
                pub const m_vecScale: usize = 0x490; // 
            }
            // Parent: CGeneralRandomRotation
            // Field count: 0
            //
            ...
            pub mod C_OP_SetCPOrientationToPointAtCP {
                pub const m_nInputCP: usize = 0x1C8; // 
                pub const m_nOutputCP: usize = 0x1CC; // 
                pub const m_flInterpolation: usize = 0x1D0; // 
            ...
            pub mod C_OP_MovementPlaceOnGround {
                ...
                pub const m_flMaxTraceLength: usize = 0x320; // 
                pub const m_flTolerance: usize = 0x324; // 
                pub const m_flTraceOffset: usize = 0x328; // 
                pub const m_flLerpRate: usize = 0x32C; // 
                pub const m_CollisionGroupName: usize = 0x330; // 
                pub const m_nTraceSet: usize = 0x3B0; // 
                pub const m_nRefCP1: usize = 0x3B4; // 
                pub const m_nRefCP2: usize = 0x3B8; // 
                pub const m_nLerpCP: usize = 0x3BC; // 
                pub const m_nTraceMissBehavior: usize = 0x3C8; // 
                pub const m_bIncludeShotHull: usize = 0x3CC; // 
                pub const m_bIncludeWater: usize = 0x3CD; // 
                pub const m_bSetNormal: usize = 0x3D0; // 
                pub const m_bScaleOffset: usize = 0x3D1; // 
                pub const m_nPreserveOffsetCP: usize = 0x3D4; // 
                pub const m_nIgnoreCP: usize = 0x3D8; // 
            }
            // Parent: CParticleFunctionOperator
            // Field count: 2
            //
            ...
            pub mod C_OP_RemapCrossProductOfTwoVectorsToVector {
                ...
                pub const m_InputVec2: usize = 0x838; // 
                pub const m_nFieldOutput: usize = 0xEB0; // 
                pub const m_bNormalize: usize = 0xEB4; // 
            }
            // Parent: CParticleFunctionOperator
            // Field count: 4
            //
            ...
            pub mod C_OP_SetControlPointPositionToRandomActiveCP {
                pub const m_nCP1: usize = 0x1C8; // 
                pub const m_nHeadLocationMin: usize = 0x1CC; // 
                pub const m_nHeadLocationMax: usize = 0x1D0; // 
                pub const m_flResetRate: usize = 0x1D8; // 
            }
            // Parent: CParticleFunctionOperator
            // Field count: 3
            //
            ...
            pub mod C_INIT_AgeNoise {
                pub const m_bAbsVal: usize = 0x1C8; // 
                pub const m_bAbsValInv: usize = 0x1C9; // 
                pub const m_flOffset: usize = 0x1CC; // 
                pub const m_flAgeMin: usize = 0x1D0; // 
                pub const m_flAgeMax: usize = 0x1D4; // 
                pub const m_flNoiseScale: usize = 0x1D8; // 
                pub const m_flNoiseScaleLoc: usize = 0x1DC; // 
                pub const m_vecOffsetLoc: usize = 0x1E0; // 
            }
            // Parent: CParticleFunctionOperator
            // Field count: 3
            ...
            pub mod CGeneralRandomRotation {
                pub const m_nFieldOutput: usize = 0x1C8; // 
                pub const m_flDegrees: usize = 0x1CC; // 
                pub const m_flDegreesMin: usize = 0x1D0; // 
                pub const m_flDegreesMax: usize = 0x1D4; // 
                pub const m_flRotationRandExponent: usize = 0x1D8; // 
                pub const m_bRandomlyFlipDirection: usize = 0x1DC; // 
            }
            // Parent: CParticleFunctionOperator
            // Field count: 9
            //
            ...
            pub mod C_OP_DistanceBetweenVecs {
                ...
                pub const m_vecPoint1: usize = 0x1C8; // 
                pub const m_vecPoint2: usize = 0x840; // 
                pub const m_flInputMin: usize = 0xEB8; // 
                pub const m_flInputMax: usize = 0x1018; // 
                pub const m_flOutputMin: usize = 0x1178; // 
                pub const m_flOutputMax: usize = 0x12D8; // 
                pub const m_nSetMethod: usize = 0x1438; // 
                pub const m_bDeltaTime: usize = 0x143C; // 
            }
            // Parent: CParticleFunctionOperator
            // Field count: 3
            //
            ...
            pub mod C_OP_LockToBone {
                ...
                pub const m_flRotLerp: usize = 0x9A8; // 
            }
            // Parent: C_OP_RemapNamedModelElementOnceTimed
            // Field count: 0
            //
            ...
            pub mod C_OP_SetVec {
                ...
                pub const m_nOutputField: usize = 0x838; // 
                pub const m_nSetMethod: usize = 0x83C; // 
                pub const m_Lerp: usize = 0x840; // 
                pub const m_bNormalizedOutput: usize = 0x9A0; // 
            }
            // Parent: CParticleFunctionInitializer
            // Field count: 5
            //
            ...
            pub mod C_INIT_CreateFromParentParticles {
                pub const m_flVelocityScale: usize = 0x1C8; // 
                pub const m_flIncrement: usize = 0x1CC; // 
                pub const m_bRandomDistribution: usize = 0x1D0; // 
                pub const m_nRandomSeed: usize = 0x1D4; // 
                pub const m_bSubFrame: usize = 0x1D8; // 
            }
            // Parent: None
            // Field count: 0
            ...
            pub mod C_OP_RenderOmni2Light {
                ...
                pub const m_vColorBlend: usize = 0x218; // 
                pub const m_nColorBlendType: usize = 0x890; // 
                pub const m_nBrightnessUnit: usize = 0x894; // 
                pub const m_flBrightnessLumens: usize = 0x898; // 
                pub const m_flBrightnessCandelas: usize = 0x9F8; // 
                pub const m_bCastShadows: usize = 0xB58; // 
                pub const m_bFog: usize = 0xB59; // 
                pub const m_flFogScale: usize = 0xB60; // 
                pub const m_flLuminaireRadius: usize = 0xCC0; // 
                pub const m_flSkirt: usize = 0xE20; // 
                pub const m_flRange: usize = 0xF80; // 
                pub const m_flInnerConeAngle: usize = 0x10E0; // 
                pub const m_flOuterConeAngle: usize = 0x1240; // 
                pub const m_hLightCookie: usize = 0x13A0; // 
                pub const m_bSphericalCookie: usize = 0x13A8; // 
            }
            // Parent: CParticleFunctionOperator
            // Field count: 5
            //
            ...
            pub mod C_OP_ConnectParentParticleToNearest {
                ...
                pub const m_bUseRadius: usize = 0x1C8; // 
                pub const m_flRadiusScale: usize = 0x1D0; // 
                pub const m_flParentRadiusScale: usize = 0x330; // 
            }
            // Parent: CParticleFloatInput
            // Field count: 0
            //
            ...
            pub mod C_INIT_InitSkinnedPositionFromCPSnapshot {
                pub const m_nSnapshotControlPointNumber: usize = 0x1C8; // 
                pub const m_nControlPointNumber: usize = 0x1CC; // 
                pub const m_bRandom: usize = 0x1D0; // 
                pub const m_nRandomSeed: usize = 0x1D4; // 
                pub const m_bRigid: usize = 0x1D8; // 
                pub const m_bSetNormal: usize = 0x1D9; // 
                pub const m_bIgnoreDt: usize = 0x1DA; // 
                pub const m_flMinNormalVelocity: usize = 0x1DC; // 
                pub const m_flMaxNormalVelocity: usize = 0x1E0; // 
                pub const m_nIndexType: usize = 0x1E4; // 
                pub const m_flReadIndex: usize = 0x1E8; // 
                pub const m_flIncrement: usize = 0x348; // 
                pub const m_nFullLoopIncrement: usize = 0x34C; // 
                pub const m_nSnapShotStartPoint: usize = 0x350; // 
                pub const m_flBoneVelocity: usize = 0x354; // 
                pub const m_flBoneVelocityMax: usize = 0x358; // 
                pub const m_bCopyColor: usize = 0x35C; // 
                pub const m_bCopyAlpha: usize = 0x35D; // 
                pub const m_bSetRadius: usize = 0x35E; // 
            }
            // Parent: CParticleFunctionOperator
            // Field count: 4
            //
            ...
            pub mod C_OP_CollideWithSelf {
                pub const m_flRadiusScale: usize = 0x1C0; // 
                pub const m_flMinimumSpeed: usize = 0x320; // 
            }
            // Parent: CParticleFunctionOperator
            // Field count: 6
            //
            ...
            pub mod C_OP_ColorAdjustHSL {
                ...
                pub const m_flSaturationAdjust: usize = 0x320; // 
                pub const m_flLightnessAdjust: usize = 0x480; // 
            }
            // Parent: None
            // Field count: 4
            //
            ...
            pub mod CParticleMassCalculationParameters {
                ...
                pub const m_flNominalRadius: usize = 0x168; // 
                pub const m_flScale: usize = 0x2C8; // 
            }
            // Parent: CParticleFunctionOperator
            // Field count: 8
            //
            ...
            pub mod C_INIT_InitVec {
                pub const m_InputValue: usize = 0x1C8; // 
                pub const m_nOutputField: usize = 0x840; // 
                pub const m_nSetMethod: usize = 0x844; // 
                pub const m_bNormalizedOutput: usize = 0x848; // 
                pub const m_bWritePreviousPosition: usize = 0x849; // 
            }
            // Parent: CParticleFunctionInitializer
            // Field count: 10
            //
            ...
            pub mod C_INIT_SetHitboxToModel {
                pub const m_nControlPointNumber: usize = 0x1C8; // 
                pub const m_nForceInModel: usize = 0x1CC; // 
                pub const m_bEvenDistribution: usize = 0x1D0; // 
                pub const m_nDesiredHitbox: usize = 0x1D4; // 
                pub const m_vecHitBoxScale: usize = 0x1D8; // 
                pub const m_vecDirectionBias: usize = 0x850; // 
                pub const m_bMaintainHitbox: usize = 0x85C; // 
                pub const m_bUseBones: usize = 0x85D; // 
                pub const m_HitboxSetName: usize = 0x85E; // 
                pub const m_flShellSize: usize = 0x8E0; // 
            }
            // Parent: CParticleFunctionOperator
            // Field count: 6
            //
            ...
            pub mod C_OP_MovementMoveAlongSkinnedCPSnapshot {
                ...
                pub const m_flInterpolation: usize = 0x1D0; // 
                pub const m_flTValue: usize = 0x330; // 
            }
            // Parent: CParticleFunctionOperator
            // Field count: 4
            //
            ...
            pub mod C_OP_LerpScalar {
                ...
                pub const m_flStartTime: usize = 0x328; // 
                pub const m_flEndTime: usize = 0x32C; // 
            }
            // Parent: CParticleFunctionInitializer
            // Field count: 13
            //
            ...
            pub mod C_INIT_InitialRepulsionVelocity {
                ...
                pub const m_vecOutputMin: usize = 0x24C; // 
                pub const m_vecOutputMax: usize = 0x258; // 
                pub const m_nControlPointNumber: usize = 0x264; // 
                pub const m_bPerParticle: usize = 0x268; // 
                pub const m_bTranslate: usize = 0x269; // 
                pub const m_bProportional: usize = 0x26A; // 
                pub const m_flTraceLength: usize = 0x26C; // 
                pub const m_bPerParticleTR: usize = 0x270; // 
                pub const m_bInherit: usize = 0x271; // 
                pub const m_nChildCP: usize = 0x274; // 
                pub const m_nChildGroupID: usize = 0x278; // 
            }
            // Parent: CParticleFunctionOperator
            // Field count: 3
            //
            ...
            pub mod C_OP_ClampScalar {
                ...
                pub const m_flOutputMax: usize = 0x328; // 
            }
            // Parent: CParticleFunctionPreEmission
            // Field count: 3
            //
            ...
            pub mod C_OP_SetControlPointToHMD {
                pub const m_nCP1: usize = 0x1C8; // 
                pub const m_vecCP1Pos: usize = 0x1CC; // 
                pub const m_bOrientToHMD: usize = 0x1D8; // 
            }
            // Parent: CParticleFunctionOperator
            // Field count: 9
            //
            ...
            pub mod C_OP_SetControlPointFieldFromVectorExpression {
                pub const m_nExpression: usize = 0x1C8; // 
                pub const m_vecInput1: usize = 0x1D0; // 
                pub const m_vecInput2: usize = 0x848; // 
                pub const m_flOutputRemap: usize = 0xEC0; // 
                pub const m_nOutputCP: usize = 0x1020; // 
                pub const m_nOutVectorField: usize = 0x1024; // 
            }
            // Parent: CParticleFunctionOperator
            // Field count: 10
            //
            ...
            pub mod C_INIT_InitFromCPSnapshot {
                pub const m_nControlPointNumber: usize = 0x1C8; // 
                pub const m_nAttributeToRead: usize = 0x1CC; // 
                pub const m_nAttributeToWrite: usize = 0x1D0; // 
                pub const m_nLocalSpaceCP: usize = 0x1D4; // 
                pub const m_bRandom: usize = 0x1D8; // 
                pub const m_bReverse: usize = 0x1D9; // 
                pub const m_nSnapShotIncrement: usize = 0x1E0; // 
                pub const m_nManualSnapshotIndex: usize = 0x340; // 
                pub const m_nRandomSeed: usize = 0x4A0; // 
                pub const m_bLocalSpaceAngles: usize = 0x4A4; // 
            }
            // Parent: CParticleFunctionRenderer
            // Field count: 22
            //
            ...
            pub mod C_OP_RenderCables {
                ...
                pub const m_flAlphaScale: usize = 0x370; // 
                pub const m_vecColorScale: usize = 0x4D0; // 
                pub const m_nColorBlendType: usize = 0xB48; // 
                pub const m_hMaterial: usize = 0xB50; // 
                pub const m_nTextureRepetitionMode: usize = 0xB58; // 
                pub const m_flTextureRepeatsPerSegment: usize = 0xB60; // 
                pub const m_flTextureRepeatsCircumference: usize = 0xCC0; // 
                pub const m_flColorMapOffsetV: usize = 0xE20; // 
                pub const m_flColorMapOffsetU: usize = 0xF80; // 
                pub const m_flNormalMapOffsetV: usize = 0x10E0; // 
                pub const m_flNormalMapOffsetU: usize = 0x1240; // 
                pub const m_bDrawCableCaps: usize = 0x13A0; // 
                pub const m_flCapRoundness: usize = 0x13A4; // 
                pub const m_flCapOffsetAmount: usize = 0x13A8; // 
                pub const m_flTessScale: usize = 0x13AC; // 
                pub const m_nMinTesselation: usize = 0x13B0; // 
                pub const m_nMaxTesselation: usize = 0x13B4; // 
                pub const m_nRoundness: usize = 0x13B8; // 
                pub const m_LightingTransform: usize = 0x13C0; // 
            ...
            pub mod C_INIT_InheritVelocity {
                pub const m_nControlPointNumber: usize = 0x1C8; // 
                pub const m_flVelocityScale: usize = 0x1CC; // 
            }
            // Parent: CParticleFunctionPreEmission
            // Field count: 7
            //
            ...
            pub mod C_OP_SetControlPointToWaterSurface {
                pub const m_nSourceCP: usize = 0x1C8; // 
                pub const m_nDestCP: usize = 0x1CC; // 
                pub const m_nFlowCP: usize = 0x1D0; // 
                pub const m_nActiveCP: usize = 0x1D4; // 
                pub const m_nActiveCPField: usize = 0x1D8; // 
                pub const m_flRetestRate: usize = 0x1E0; // 
            ...
            pub mod C_INIT_PositionOffset {
                pub const m_OffsetMin: usize = 0x1C8; // 
                pub const m_OffsetMax: usize = 0x840; // 
                pub const m_TransformInput: usize = 0xEB8; // 
                pub const m_bLocalCoords: usize = 0xF20; // 
                pub const m_bProportional: usize = 0xF21; // 
            ...
            pub mod C_INIT_NormalAlignToCP {
                pub const m_transformInput: usize = 0x1C8; // 
                pub const m_nControlPointAxis: usize = 0x230; // 
            }
            // Parent: CParticleFunctionConstraint
            // Field count: 1
            //
            ...
            pub mod C_OP_SetChildControlPoints {
                ...
                pub const m_nNumControlPoints: usize = 0x1C8; // 
                pub const m_nFirstSourcePoint: usize = 0x1D0; // 
                pub const m_bReverse: usize = 0x330; // 
                pub const m_bSetOrientation: usize = 0x331; // 
            }
            // Parent: CParticleFunctionOperator
            // Field count: 10
            //
            ...
            pub mod C_OP_ChladniWave {
                ...
                pub const m_flOutputMin: usize = 0x488; // 
                pub const m_flOutputMax: usize = 0x5E8; // 
                pub const m_vecWaveLength: usize = 0x748; // 
                pub const m_vecHarmonics: usize = 0xDC0; // 
                pub const m_nSetMethod: usize = 0x1438; // 
                pub const m_nLocalSpaceControlPoint: usize = 0x143C; // 
                pub const m_b3D: usize = 0x1440; // 
            }
            // Parent: CParticleFunctionOperator
            // Field count: 7
            //
            ...
            pub mod C_OP_DriveCPFromGlobalSoundFloat {
                pub const m_nOutputControlPoint: usize = 0x1C8; // 
                pub const m_nOutputField: usize = 0x1CC; // 
                pub const m_flInputMin: usize = 0x1D0; // 
                pub const m_flInputMax: usize = 0x1D4; // 
                pub const m_flOutputMin: usize = 0x1D8; // 
                pub const m_flOutputMax: usize = 0x1DC; // 
                pub const m_StackName: usize = 0x1E0; // 
                pub const m_OperatorName: usize = 0x1E8; // 
                pub const m_FieldName: usize = 0x1F0; // 
            }
            // Parent: CParticleFunctionOperator
            // Field count: 7
            //
            ...
            pub mod C_OP_PinParticleToCP {
                ...
                pub const m_bOffsetLocal: usize = 0x840; // 
                pub const m_nParticleSelection: usize = 0x844; // 
                pub const m_nParticleNumber: usize = 0x848; // 
                pub const m_nPinBreakType: usize = 0x9A8; // 
                pub const m_flBreakDistance: usize = 0x9B0; // 
                pub const m_flBreakSpeed: usize = 0xB10; // 
                pub const m_flAge: usize = 0xC70; // 
                pub const m_nBreakControlPointNumber: usize = 0xDD0; // 
                pub const m_nBreakControlPointNumber2: usize = 0xDD4; // 
                pub const m_flBreakValue: usize = 0xDD8; // 
                pub const m_flInterpolation: usize = 0xF38; // 
            }
            // Parent: CParticleFunctionOperator
            // Field count: 13
            //
            ...
            pub mod C_INIT_CreateParticleImpulse {
                pub const m_InputRadius: usize = 0x1C8; // 
                pub const m_InputMagnitude: usize = 0x328; // 
                pub const m_nFalloffFunction: usize = 0x488; // 
                pub const m_InputFalloffExp: usize = 0x490; // 
            ...
            pub mod C_INIT_CreateInEpitrochoid {
                pub const m_nComponent1: usize = 0x1C8; // 
                pub const m_nComponent2: usize = 0x1CC; // 
                pub const m_TransformInput: usize = 0x1D0; // 
                pub const m_flParticleDensity: usize = 0x238; // 
                pub const m_flOffset: usize = 0x398; // 
                pub const m_flRadius1: usize = 0x4F8; // 
                pub const m_flRadius2: usize = 0x658; // 
                pub const m_bUseCount: usize = 0x7B8; // 
                pub const m_bUseLocalCoords: usize = 0x7B9; // 
                pub const m_bOffsetExistingPos: usize = 0x7BA; // 
            }
            // Parent: CParticleFunctionConstraint
            // Field count: 5
            //
            ...
            pub mod C_OP_SetControlPointPositions {
                pub const m_bUseWorldLocation: usize = 0x1C8; // 
                pub const m_bOrient: usize = 0x1C9; // 
                pub const m_bSetOnce: usize = 0x1CA; // 
                pub const m_nCP1: usize = 0x1CC; // 
                pub const m_nCP2: usize = 0x1D0; // 
                pub const m_nCP3: usize = 0x1D4; // 
                pub const m_nCP4: usize = 0x1D8; // 
                pub const m_vecCP1Pos: usize = 0x1DC; // 
                pub const m_vecCP2Pos: usize = 0x1E8; // 
                pub const m_vecCP3Pos: usize = 0x1F4; // 
                pub const m_vecCP4Pos: usize = 0x200; // 
                pub const m_nHeadLocation: usize = 0x20C; // 
            }
            // Parent: CParticleFunctionOperator
            // Field count: 6
            //
            ...
            pub mod C_OP_SetFloatAttributeToVectorExpression {
                ...
                pub const m_vInput1: usize = 0x1C8; // 
                pub const m_vInput2: usize = 0x840; // 
                pub const m_flOutputRemap: usize = 0xEB8; // 
                pub const m_nOutputField: usize = 0x1018; // 
            ...
            pub mod C_OP_MovementRotateParticleAroundAxis {
                ...
                pub const m_flRotRate: usize = 0x838; // 
                pub const m_TransformInput: usize = 0x998; // 
                pub const m_bLocalSpace: usize = 0xA00; // 
            }
            // Parent: CParticleFunctionForce
            // Field count: 8
            //
            ...
            pub mod C_OP_IntraParticleForce {
                pub const m_flAttractionMinDistance: usize = 0x1D0; // 
                pub const m_flAttractionMaxDistance: usize = 0x1D4; // 
                pub const m_flAttractionMaxStrength: usize = 0x1D8; // 
                pub const m_flRepulsionMinDistance: usize = 0x1DC; // 
                pub const m_flRepulsionMaxDistance: usize = 0x1E0; // 
                pub const m_flRepulsionMaxStrength: usize = 0x1E4; // 
                pub const m_bUseAABB: usize = 0x1E8; // 
                pub const m_bThreadIt: usize = 0x1E9; // 
            }
            // Parent: CParticleFunctionInitializer
            // Field count: 4
            //
            ...
            pub mod C_INIT_InitFloat {
                ...
                pub const m_InputStrength: usize = 0x330; // 
            }
            // Parent: CParticleFunctionInitializer
            // Field count: 16
            //
            ...
            pub mod C_INIT_CreateOnModel {
                pub const m_modelInput: usize = 0x1C8; // 
                pub const m_transformInput: usize = 0x228; // 
                pub const m_nForceInModel: usize = 0x290; // 
                pub const m_bScaleToVolume: usize = 0x294; // 
                pub const m_bEvenDistribution: usize = 0x295; // 
                pub const m_nDesiredHitbox: usize = 0x298; // 
                pub const m_nHitboxValueFromControlPointIndex: usize = 0x3F8; // 
                pub const m_vecHitBoxScale: usize = 0x400; // 
                pub const m_flBoneVelocity: usize = 0xA78; // 
                pub const m_flMaxBoneVelocity: usize = 0xA7C; // 
                pub const m_vecDirectionBias: usize = 0xA80; // 
                pub const m_HitboxSetName: usize = 0x10F8; // 
                pub const m_bLocalCoords: usize = 0x1178; // 
                pub const m_bUseBones: usize = 0x1179; // 
                pub const m_bUseMesh: usize = 0x117A; // 
                pub const m_flShellSize: usize = 0x1180; // 
            }
            // Parent: CParticleFunctionOperator
            // Field count: 4
            //
            ...
            pub mod C_OP_PerParticleForce {
                pub const m_flForceScale: usize = 0x1D0; // 
                pub const m_vForce: usize = 0x330; // 
                pub const m_nCP: usize = 0x9A8; // 
            }
            // Parent: C_INIT_RandomNamedModelElement
            // Field count: 0
            //
            ...
            pub mod C_OP_RenderProjected {
                pub const m_bProjectCharacter: usize = 0x210; // 
                pub const m_bProjectWorld: usize = 0x211; // 
                pub const m_bProjectWater: usize = 0x212; // 
                pub const m_bFlipHorizontal: usize = 0x213; // 
                pub const m_bEnableProjectedDepthControls: usize = 0x214; // 
                pub const m_flMinProjectionDepth: usize = 0x218; // 
                pub const m_flMaxProjectionDepth: usize = 0x21C; // 
                pub const m_vecProjectedMaterials: usize = 0x220; // 
                pub const m_flMaterialSelection: usize = 0x238; // 
                pub const m_flAnimationTimeScale: usize = 0x398; // 
                pub const m_bOrientToNormal: usize = 0x39C; // 
                pub const m_MaterialVars: usize = 0x3A0; // 
                pub const m_flRadiusScale: usize = 0x3B8; // 
                pub const m_flAlphaScale: usize = 0x518; // 
                pub const m_flRollScale: usize = 0x678; // 
                pub const m_nAlpha2Field: usize = 0x7D8; // 
                pub const m_vecColorScale: usize = 0x7E0; // 
            ...
            pub mod C_INIT_VelocityFromNormal {
                ...
                pub const m_fSpeedMax: usize = 0x1CC; // 
                pub const m_bIgnoreDt: usize = 0x1D0; // 
            }
            // Parent: CParticleFunctionEmitter
            // Field count: 8
            //
            ...
            pub mod C_OP_MaintainEmitter {
                pub const m_nParticlesToMaintain: usize = 0x1C8; // 
                pub const m_flStartTime: usize = 0x328; // 
                pub const m_flEmissionDuration: usize = 0x330; // 
                pub const m_flEmissionRate: usize = 0x490; // 
                pub const m_nSnapshotControlPoint: usize = 0x494; // 
                pub const m_bEmitInstantaneously: usize = 0x498; // 
                pub const m_bFinalEmitOnStop: usize = 0x499; // 
            ...
            pub mod C_INIT_PositionOffsetToCP {
                pub const m_nControlPointNumberStart: usize = 0x1C8; // 
                pub const m_nControlPointNumberEnd: usize = 0x1CC; // 
                pub const m_bLocalCoords: usize = 0x1D0; // 
            }
            // Parent: CParticleFunctionInitializer
            // Field count: 4
            //
            ...
            pub mod C_INIT_RemapInitialTransformDirectionToRotation {
                pub const m_TransformInput: usize = 0x1C8; // 
                pub const m_nFieldOutput: usize = 0x230; // 
                pub const m_flOffsetRot: usize = 0x234; // 
                pub const m_nComponent: usize = 0x238; // 
            }
            // Parent: CParticleFunctionOperator
            // Field count: 7
            //
            ...
            pub mod C_OP_SetControlPointFromObjectScale {
                pub const m_nCPInput: usize = 0x1C8; // 
                pub const m_nCPOutput: usize = 0x1CC; // 
            }
            // Parent: CParticleFunctionOperator
            // Field count: 7
            ...
            pub mod C_OP_StopAfterCPDuration {
                pub const m_flDuration: usize = 0x1C8; // 
            ...
            pub mod C_INIT_RemapNamedModelElementToScalar {
                ...
                pub const m_nFieldInput: usize = 0x200; // 
                pub const m_nFieldOutput: usize = 0x204; // 
                pub const m_nSetMethod: usize = 0x208; // 
                pub const m_bModelFromRenderer: usize = 0x20C; // 
            }
            // Parent: CParticleFunctionOperator
            // Field count: 3
            //
            ...
            pub mod C_OP_ClampVector {
                ...
                pub const m_vecOutputMax: usize = 0x840; // 
            }
            // Parent: CParticleFunctionRenderer
            // Field count: 6
            //
            ...
            pub mod C_OP_RenderStatusEffectCitadel {
                pub const m_pTextureColorWarp: usize = 0x210; // 
                pub const m_pTextureNormal: usize = 0x218; // 
                pub const m_pTextureMetalness: usize = 0x220; // 
                pub const m_pTextureRoughness: usize = 0x228; // 
                pub const m_pTextureSelfIllum: usize = 0x230; // 
                pub const m_pTextureDetail: usize = 0x238; // 
            }
            // Parent: CParticleFunctionInitializer
            // Field count: 11
            //
            ...
            pub mod C_INIT_RemapCPtoScalar {
                ...
                pub const m_flOutputMin: usize = 0x1DC; // 
                pub const m_flOutputMax: usize = 0x1E0; // 
                pub const m_flStartTime: usize = 0x1E4; // 
                pub const m_flEndTime: usize = 0x1E8; // 
            ...
            pub mod C_OP_SetVariable {
                pub const m_variableReference: usize = 0x1C8; // 
                pub const m_transformInput: usize = 0x208; // 
                pub const m_positionOffset: usize = 0x270; // 
                pub const m_rotationOffset: usize = 0x27C; // 
                pub const m_vecInput: usize = 0x288; // 
                pub const m_floatInput: usize = 0x900; // 
            }
            // Parent: CParticleFunctionRenderer
            // Field count: 29
            //
            ...
            pub mod C_OP_RenderStandardLight {
                ...
                pub const m_bCastShadows: usize = 0x9F8; // 
                pub const m_flTheta: usize = 0xA00; // 
                pub const m_flPhi: usize = 0xB60; // 
                pub const m_flRadiusMultiplier: usize = 0xCC0; // 
                pub const m_nAttenuationStyle: usize = 0xE20; // StandardLightingAttenuationStyle_t
                pub const m_flFalloffLinearity: usize = 0xE28; // 
                pub const m_flFiftyPercentFalloff: usize = 0xF88; // 
                pub const m_flZeroPercentFalloff: usize = 0x10E8; // 
                pub const m_bRenderDiffuse: usize = 0x1248; // 
                pub const m_bRenderSpecular: usize = 0x1249; // 
                pub const m_lightCookie: usize = 0x1250; // 
                pub const m_nPriority: usize = 0x1258; // 
                ...
                pub const m_flCapsuleLength: usize = 0x13C4; // 
                pub const m_bReverseOrder: usize = 0x13C8; // 
                pub const m_bClosedLoop: usize = 0x13C9; // 
                pub const m_nPrevPntSource: usize = 0x13CC; // 
                pub const m_flMaxLength: usize = 0x13D0; // 
                pub const m_flMinLength: usize = 0x13D4; // 
                pub const m_bIgnoreDT: usize = 0x13D8; // 
                pub const m_flConstrainRadiusToLengthRatio: usize = 0x13DC; // 
                pub const m_flLengthScale: usize = 0x13E0; // 
                pub const m_flLengthFadeInTime: usize = 0x13E4; // 
            }
            // Parent: CParticleFunctionOperator
            // Field count: 15
            //
            ...
            pub mod C_OP_DistanceToTransform {
                ...
                pub const m_flOutputMax: usize = 0x5E8; // 
                pub const m_TransformStart: usize = 0x748; // 
                pub const m_bLOS: usize = 0x7B0; // 
                pub const m_CollisionGroupName: usize = 0x7B1; // 
                pub const m_nTraceSet: usize = 0x834; // 
                pub const m_flMaxTraceLength: usize = 0x838; // 
                pub const m_flLOSScale: usize = 0x83C; // 
                pub const m_nSetMethod: usize = 0x840; // 
                pub const m_bActiveRange: usize = 0x844; // 
                pub const m_bAdditive: usize = 0x845; // 
                pub const m_vecComponentScale: usize = 0x848; // 
            }
            // Parent: CParticleFunctionOperator
            // Field count: 4
            //
            ...
            pub mod C_OP_SetControlPointToCenter {
                pub const m_nCP1: usize = 0x1C8; // 
                pub const m_vecCP1Pos: usize = 0x1CC; // 
                pub const m_bUseAvgParticlePos: usize = 0x1D8; // 
            ...
            pub mod C_OP_RemapCPtoCP {
                pub const m_nInputControlPoint: usize = 0x1C8; // 
                pub const m_nOutputControlPoint: usize = 0x1CC; // 
                pub const m_nInputField: usize = 0x1D0; // 
                pub const m_nOutputField: usize = 0x1D4; // 
                pub const m_flInputMin: usize = 0x1D8; // 
                pub const m_flInputMax: usize = 0x1DC; // 
                pub const m_flOutputMin: usize = 0x1E0; // 
                pub const m_flOutputMax: usize = 0x1E4; // 
                pub const m_bDerivative: usize = 0x1E8; // 
                pub const m_flInterpRate: usize = 0x1EC; // 
            }
            // Parent: CParticleFunctionPreEmission
            // Field count: 4
            //
            ...
            pub mod C_OP_SetControlPointRotation {
                pub const m_vecRotAxis: usize = 0x1C8; // 
                pub const m_flRotRate: usize = 0x840; // 
                pub const m_nCP: usize = 0x9A0; // 
                pub const m_nLocalCP: usize = 0x9A4; // 
            }
            // Parent: CParticleFunctionForce
            // Field count: 7
            //
            ...
            pub mod C_OP_CurlNoiseForce {
                ...
                pub const m_vecNoiseScale: usize = 0x850; // 
                pub const m_vecOffset: usize = 0xEC8; // 
                pub const m_vecOffsetRate: usize = 0x1540; // 
                pub const m_flWorleySeed: usize = 0x1BB8; // 
                pub const m_flWorleyJitter: usize = 0x1D18; // 
            }
            // Parent: CParticleFunctionInitializer
            // Field count: 3
            //
            ...
            pub mod C_INIT_Orient2DRelToCP {
                pub const m_nCP: usize = 0x1C8; // 
                pub const m_nFieldOutput: usize = 0x1CC; // 
                pub const m_flRotOffset: usize = 0x1D0; // 
            }
            // Parent: CParticleFunctionPreEmission
            // Field count: 1
            //
            ...
            pub mod C_OP_SetSimulationRate {
                pub const m_flSimulationScale: usize = 0x1C8; // 
            }
            // Parent: CParticleFunctionOperator
            // Field count: 4
            //
            ...
            pub mod C_OP_RenderScreenShake {
                pub const m_flDurationScale: usize = 0x210; // 
                pub const m_flRadiusScale: usize = 0x214; // 
                pub const m_flFrequencyScale: usize = 0x218; // 
                pub const m_flAmplitudeScale: usize = 0x21C; // 
                pub const m_nRadiusField: usize = 0x220; // 
                pub const m_nDurationField: usize = 0x224; // 
                pub const m_nFrequencyField: usize = 0x228; // 
                pub const m_nAmplitudeField: usize = 0x22C; // 
                pub const m_nFilterCP: usize = 0x230; // 
            }
            // Parent: CParticleFunctionPreEmission
            // Field count: 5
            //
            ...
            pub mod C_OP_HSVShiftToCP {
                pub const m_nColorCP: usize = 0x1C8; // 
                pub const m_nColorGemEnableCP: usize = 0x1CC; // 
                pub const m_nOutputCP: usize = 0x1D0; // 
                pub const m_DefaultHSVColor: usize = 0x1D4; // 
            }
            // Parent: CParticleFunctionInitializer
            // Field count: 6
            //
            ...
            pub mod C_INIT_GlobalScale {
                pub const m_flScale: usize = 0x1C8; // 
                pub const m_nScaleControlPointNumber: usize = 0x1CC; // 
                pub const m_nControlPointNumber: usize = 0x1D0; // 
                pub const m_bScaleRadius: usize = 0x1D4; // 
                pub const m_bScalePosition: usize = 0x1D5; // 
                pub const m_bScaleVelocity: usize = 0x1D6; // 
            }
            // Parent: CParticleFunctionInitializer
            // Field count: 1
            //
            ...
            pub mod C_INIT_InitialVelocityFromHitbox {
                pub const m_flVelocityMin: usize = 0x1C8; // 
                pub const m_flVelocityMax: usize = 0x1CC; // 
                pub const m_nControlPointNumber: usize = 0x1D0; // 
                pub const m_HitboxSetName: usize = 0x1D4; // 
                pub const m_bUseBones: usize = 0x254; // 
            }
            // Parent: CParticleFunctionOperator
            // Field count: 5
            //
            ...
            pub mod TextureGroup_t {
                ...
                pub const m_TextureControls: usize = 0x198; // 
            }
            // Parent: CParticleFunctionForce
            // Field count: 4
            //
            ...
            pub mod C_INIT_CreateWithinSphereTransform {
                pub const m_fRadiusMin: usize = 0x1C8; // 
                pub const m_fRadiusMax: usize = 0x328; // 
                pub const m_vecDistanceBias: usize = 0x488; // 
                pub const m_vecDistanceBiasAbs: usize = 0xB00; // 
                pub const m_TransformInput: usize = 0xB10; // 
                pub const m_fSpeedMin: usize = 0xB78; // 
                pub const m_fSpeedMax: usize = 0xCD8; // 
                pub const m_fSpeedRandExp: usize = 0xE38; // 
                pub const m_bLocalCoords: usize = 0xE3C; // 
                pub const m_flEndCPGrowthTime: usize = 0xE40; // 
                pub const m_LocalCoordinateSystemSpeedMin: usize = 0xE48; // 
                pub const m_LocalCoordinateSystemSpeedMax: usize = 0x14C0; // 
                pub const m_nFieldOutput: usize = 0x1B38; // 
                pub const m_nFieldVelocity: usize = 0x1B3C; // 
            }
            // Parent: CParticleFunctionOperator
            // Field count: 1
            //
            ...
            pub mod C_INIT_RemapScalarToVector {
                ...
                pub const m_flInputMin: usize = 0x1D0; // 
                pub const m_flInputMax: usize = 0x1D4; // 
                pub const m_vecOutputMin: usize = 0x1D8; // 
                pub const m_vecOutputMax: usize = 0x1E4; // 
                pub const m_flStartTime: usize = 0x1F0; // 
                pub const m_flEndTime: usize = 0x1F4; // 
                pub const m_nSetMethod: usize = 0x1F8; // 
                pub const m_nControlPointNumber: usize = 0x1FC; // 
                pub const m_bLocalCoords: usize = 0x200; // 
                pub const m_flRemapBias: usize = 0x204; // 
            }
            // Parent: CParticleFunctionInitializer
            // Field count: 8
            //
            ...
            pub mod C_INIT_InitialSequenceFromModel {
                pub const m_nControlPointNumber: usize = 0x1C8; // 
                pub const m_nFieldOutput: usize = 0x1CC; // 
                pub const m_nFieldOutputAnim: usize = 0x1D0; // 
                pub const m_flInputMin: usize = 0x1D4; // 
                pub const m_flInputMax: usize = 0x1D8; // 
                pub const m_flOutputMin: usize = 0x1DC; // 
                pub const m_flOutputMax: usize = 0x1E0; // 
            ...
            pub mod C_OP_NoiseEmitter {
                pub const m_flEmissionDuration: usize = 0x1C8; // 
                pub const m_flStartTime: usize = 0x1CC; // 
                pub const m_flEmissionScale: usize = 0x1D0; // 
                pub const m_nScaleControlPoint: usize = 0x1D4; // 
                pub const m_nScaleControlPointField: usize = 0x1D8; // 
                pub const m_nWorldNoisePoint: usize = 0x1DC; // 
                pub const m_bAbsVal: usize = 0x1E0; // 
                pub const m_bAbsValInv: usize = 0x1E1; // 
                pub const m_flOffset: usize = 0x1E4; // 
                pub const m_flOutputMin: usize = 0x1E8; // 
                pub const m_flOutputMax: usize = 0x1EC; // 
                pub const m_flNoiseScale: usize = 0x1F0; // 
                pub const m_flWorldNoiseScale: usize = 0x1F4; // 
                pub const m_vecOffsetLoc: usize = 0x1F8; // 
                pub const m_flWorldTimeScale: usize = 0x204; // 
            }
            // Parent: CParticleFunction
            // Field count: 1
            //
            ...
            pub mod CParticleFunctionInitializer {
                pub const m_nAssociatedEmitterIndex: usize = 0x1C0; // 
            }
            // Parent: CParticleFunctionPreEmission
            // Field count: 5
            //
            ...
            pub mod C_OP_SelectivelyEnableChildren {
                ...
                pub const m_nNumChildrenToEnable: usize = 0x488; // 
                pub const m_bPlayEndcapOnStop: usize = 0x5E8; // 
                pub const m_bDestroyImmediately: usize = 0x5E9; // 
            }
            // Parent: None
            // Field count: 2
            //
            ...
            pub mod C_OP_PlanarConstraint {
                ...
                pub const m_flMaximumDistanceToCP: usize = 0x340; // 
                pub const m_bUseOldCode: usize = 0x4A0; // 
            }
            // Parent: CParticleFunctionInitializer
            // Field count: 4
            //
            ...
            pub mod C_INIT_CreateFromCPs {
                pub const m_nIncrement: usize = 0x1C8; // 
                pub const m_nMinCP: usize = 0x1CC; // 
                pub const m_nMaxCP: usize = 0x1D0; // 
                pub const m_nDynamicCPCount: usize = 0x1D8; // 
            }
            // Parent: CParticleFunctionOperator
            // Field count: 6
            //
            ...
            pub mod C_INIT_CreateSpiralSphere {
                pub const m_nControlPointNumber: usize = 0x1C8; // 
                pub const m_nOverrideCP: usize = 0x1CC; // 
                pub const m_nDensity: usize = 0x1D0; // 
                pub const m_flInitialRadius: usize = 0x1D4; // 
                pub const m_flInitialSpeedMin: usize = 0x1D8; // 
                pub const m_flInitialSpeedMax: usize = 0x1DC; // 
                pub const m_bUseParticleCount: usize = 0x1E0; // 
            }
            // Parent: CParticleFunctionForce
            // Field count: 2
            //
            ...
            pub mod CParticleFloatInput {
                ...
                pub const m_nBiasType: usize = 0x114; // 
                pub const m_flBiasParameter: usize = 0x118; // 
                pub const m_Curve: usize = 0x120; // 
            }
            // Parent: CParticleFunctionInitializer
            // Field count: 5
            //
            ...
            pub mod C_INIT_PointList {
                ...
                pub const m_bPlaceAlongPath: usize = 0x1E8; // 
                pub const m_bClosedLoop: usize = 0x1E9; // 
                pub const m_nNumPointsAlongPath: usize = 0x1EC; // 
            }
            // Parent: CParticleFunctionOperator
            // Field count: 4
            //
            ...
            pub mod C_OP_LerpToOtherAttribute {
                ...
                pub const m_nFieldInputFrom: usize = 0x320; // 
                pub const m_nFieldInput: usize = 0x324; // 
                pub const m_nFieldOutput: usize = 0x328; // 
            }
            // Parent: CParticleFunctionInitializer
            // Field count: 10
            //
            ...
            pub mod C_INIT_RandomColor {
                pub const m_ColorMin: usize = 0x1E4; // 
                pub const m_ColorMax: usize = 0x1E8; // 
                pub const m_TintMin: usize = 0x1EC; // 
                pub const m_TintMax: usize = 0x1F0; // 
                pub const m_flTintPerc: usize = 0x1F4; // 
                pub const m_flUpdateThreshold: usize = 0x1F8; // 
                pub const m_nTintCP: usize = 0x1FC; // 
                pub const m_nFieldOutput: usize = 0x200; // 
                pub const m_nTintBlendMode: usize = 0x204; // 
                pub const m_flLightAmplification: usize = 0x208; // 
            }
            // Parent: CParticleFunctionPreEmission
            // Field count: 5
            //
            ...
            pub mod C_INIT_RemapParticleCountToScalar {
                pub const m_nFieldOutput: usize = 0x1C8; // 
                pub const m_nInputMin: usize = 0x1CC; // 
                pub const m_nInputMax: usize = 0x1D0; // 
                pub const m_nScaleControlPoint: usize = 0x1D4; // 
                pub const m_nScaleControlPointField: usize = 0x1D8; // 
                pub const m_flOutputMin: usize = 0x1DC; // 
                pub const m_flOutputMax: usize = 0x1E0; // 
                pub const m_nSetMethod: usize = 0x1E4; // 
                pub const m_bActiveRange: usize = 0x1E8; // 
                pub const m_bInvert: usize = 0x1E9; // 
                pub const m_bWrap: usize = 0x1EA; // 
                pub const m_flRemapBias: usize = 0x1EC; // 
            }
            // Parent: CParticleFunctionInitializer
            // Field count: 5
            //
            ...
            pub mod C_INIT_InheritFromParentParticles {
                pub const m_flScale: usize = 0x1C8; // 
                pub const m_nFieldOutput: usize = 0x1CC; // 
                pub const m_nIncrement: usize = 0x1D0; // 
                pub const m_bRandomDistribution: usize = 0x1D4; // 
                pub const m_nRandomSeed: usize = 0x1D8; // 
            }
            // Parent: CParticleFunctionOperator
            // Field count: 4
            //
            ...
            pub mod C_INIT_ChaoticAttractor {
                pub const m_flAParm: usize = 0x1C8; // 
                pub const m_flBParm: usize = 0x1CC; // 
                pub const m_flCParm: usize = 0x1D0; // 
                pub const m_flDParm: usize = 0x1D4; // 
                pub const m_flScale: usize = 0x1D8; // 
                pub const m_flSpeedMin: usize = 0x1DC; // 
                pub const m_flSpeedMax: usize = 0x1E0; // 
                pub const m_nBaseCP: usize = 0x1E4; // 
                pub const m_bUniformSpeed: usize = 0x1E8; // 
            }
            // Parent: CParticleFunctionOperator
            // Field count: 6
            //
            ...
            pub mod C_OP_RenderFlattenGrass {
                pub const m_flFlattenStrength: usize = 0x210; // 
                pub const m_nStrengthFieldOverride: usize = 0x214; // 
                pub const m_flRadiusScale: usize = 0x218; // 
            }
            // Parent: CParticleFunctionRenderer
            // Field count: 7
            //
            ...
            pub mod C_OP_RenderLightBeam {
                ...
                pub const m_flBrightnessLumensPerMeter: usize = 0x890; // 
                pub const m_bCastShadows: usize = 0x9F0; // 
                pub const m_flSkirt: usize = 0x9F8; // 
                pub const m_flRange: usize = 0xB58; // 
                pub const m_flThickness: usize = 0xCB8; // 
            }
            // Parent: CParticleFunctionPreEmission
            // Field count: 6
            //
            ...
            pub mod C_OP_EnableChildrenFromParentParticleCount {
                pub const m_nChildGroupID: usize = 0x1C8; // 
                pub const m_nFirstChild: usize = 0x1CC; // 
                pub const m_nNumChildrenToEnable: usize = 0x1D0; // 
            ...
            pub mod C_INIT_DistanceToCPInit {
                pub const m_nFieldOutput: usize = 0x1C8; // 
                pub const m_flInputMin: usize = 0x1D0; // 
                pub const m_flInputMax: usize = 0x330; // 
                pub const m_flOutputMin: usize = 0x490; // 
                pub const m_flOutputMax: usize = 0x5F0; // 
                pub const m_nStartCP: usize = 0x750; // 
                pub const m_bLOS: usize = 0x754; // 
                pub const m_CollisionGroupName: usize = 0x755; // 
                pub const m_nTraceSet: usize = 0x7D8; // 
                pub const m_flMaxTraceLength: usize = 0x7E0; // 
                pub const m_flLOSScale: usize = 0x940; // 
                pub const m_nSetMethod: usize = 0x944; // 
                pub const m_bActiveRange: usize = 0x948; // 
                pub const m_vecDistanceScale: usize = 0x94C; // 
                pub const m_flRemapBias: usize = 0x958; // 
            }
            // Parent: None
            // Field count: 7
            //
            ...
            pub mod CReplicationParameters {
                ...
                pub const m_flMaxRandomRadiusScale: usize = 0x168; // 
                pub const m_vMinRandomDisplacement: usize = 0x2C8; // 
                pub const m_vMaxRandomDisplacement: usize = 0x940; // 
                pub const m_flModellingScale: usize = 0xFB8; // 
            }
            // Parent: CParticleFunctionOperator
            // Field count: 0
            //
            ...
            pub mod C_INIT_SetRigidAttachment {
                ...
                pub const m_nFieldInput: usize = 0x1CC; // 
                pub const m_nFieldOutput: usize = 0x1D0; // 
                pub const m_bLocalSpace: usize = 0x1D4; // 
            }
            // Parent: None
            // Field count: 3
            //
            ...
            pub mod C_OP_RenderModels {
                pub const m_bOnlyRenderInEffectsBloomPass: usize = 0x210; // 
                pub const m_bOnlyRenderInEffectsWaterPass: usize = 0x211; // 
                pub const m_bUseMixedResolutionRendering: usize = 0x212; // 
                pub const m_bOnlyRenderInEffecsGameOverlay: usize = 0x213; // 
                pub const m_ModelList: usize = 0x218; // 
                pub const m_nBodyGroupField: usize = 0x230; // 
                pub const m_nSubModelField: usize = 0x234; // 
                pub const m_bIgnoreNormal: usize = 0x238; // 
                pub const m_bOrientZ: usize = 0x239; // 
                pub const m_bCenterOffset: usize = 0x23A; // 
                pub const m_vecLocalOffset: usize = 0x240; // 
                pub const m_vecLocalRotation: usize = 0x8B8; // 
                pub const m_bIgnoreRadius: usize = 0xF30; // 
                pub const m_nModelScaleCP: usize = 0xF34; // 
                pub const m_vecComponentScale: usize = 0xF38; // 
                pub const m_bLocalScale: usize = 0x15B0; // 
                pub const m_nSizeCullBloat: usize = 0x15B4; // 
                pub const m_bAnimated: usize = 0x15B8; // 
                pub const m_flAnimationRate: usize = 0x15C0; // 
                pub const m_bScaleAnimationRate: usize = 0x1720; // 
                pub const m_bForceLoopingAnimation: usize = 0x1721; // 
                pub const m_bResetAnimOnStop: usize = 0x1722; // 
                pub const m_bManualAnimFrame: usize = 0x1723; // 
                pub const m_nAnimationScaleField: usize = 0x1724; // 
                pub const m_nAnimationField: usize = 0x1728; // 
                pub const m_nManualFrameField: usize = 0x172C; // 
                pub const m_ActivityName: usize = 0x1730; // 
                pub const m_SequenceName: usize = 0x1830; // 
                pub const m_bEnableClothSimulation: usize = 0x1930; // 
                pub const m_ClothEffectName: usize = 0x1931; // 
                pub const m_hOverrideMaterial: usize = 0x1978; // 
                pub const m_bOverrideTranslucentMaterials: usize = 0x1980; // 
                pub const m_nSkin: usize = 0x1988; // 
                pub const m_MaterialVars: usize = 0x1AE8; // 
                pub const m_flManualModelSelection: usize = 0x1B00; // 
                pub const m_modelInput: usize = 0x1C60; // 
                pub const m_nLOD: usize = 0x1CC0; // 
                pub const m_EconSlotName: usize = 0x1CC4; // 
                pub const m_bOriginalModel: usize = 0x1DC4; // 
                pub const m_bSuppressTint: usize = 0x1DC5; // 
                pub const m_nSubModelFieldType: usize = 0x1DC8; // 
                pub const m_bDisableShadows: usize = 0x1DCC; // 
                pub const m_bDisableDepthPrepass: usize = 0x1DCD; // 
                pub const m_bAcceptsDecals: usize = 0x1DCE; // 
                pub const m_bForceDrawInterlevedWithSiblings: usize = 0x1DCF; // 
                pub const m_bDoNotDrawInParticlePass: usize = 0x1DD0; // 
                pub const m_bAllowApproximateTransforms: usize = 0x1DD1; // 
                pub const m_szRenderAttribute: usize = 0x1DD2; // 
                pub const m_flRadiusScale: usize = 0x1ED8; // 
                pub const m_flAlphaScale: usize = 0x2038; // 
                pub const m_flRollScale: usize = 0x2198; // 
                pub const m_nAlpha2Field: usize = 0x22F8; // 
                pub const m_vecColorScale: usize = 0x2300; // 
            ...
            pub mod C_OP_RenderClientPhysicsImpulse {
                ...
                pub const m_flMagnitude: usize = 0x370; // 
                pub const m_nSimIdFilter: usize = 0x4D0; // 
            }
            // Parent: CParticleFunction
            // Field count: 1
            //
            ...
            pub mod CParticleFunctionEmitter {
                pub const m_nEmitterIndex: usize = 0x1C0; // 
            }
            // Parent: C_INIT_RemapNamedModelElementToScalar
            // Field count: 0
            //
            ...
            pub mod C_OP_RopeSpringConstraint {
                ...
                pub const m_flMinDistance: usize = 0x320; // 
                pub const m_flMaxDistance: usize = 0x480; // 
                pub const m_flAdjustmentScale: usize = 0x5E0; // 
                pub const m_flInitialRestingLength: usize = 0x5E8; // 
            }
            // Parent: CParticleFunctionInitializer
            // Field count: 6
            //
            ...
            pub mod C_INIT_PositionWarpScalar {
                pub const m_vecWarpMin: usize = 0x1C8; // 
                pub const m_vecWarpMax: usize = 0x1D4; // 
                pub const m_InputValue: usize = 0x1E0; // 
                pub const m_flPrevPosScale: usize = 0x340; // 
                pub const m_nScaleControlPointNumber: usize = 0x344; // 
                pub const m_nControlPointNumber: usize = 0x348; // 
            }
            // Parent: CParticleFunctionPreEmission
            // Field count: 1
            //
            ...
            pub mod C_OP_ForceControlPointStub {
                pub const m_ControlPoint: usize = 0x1C8; // 
            }
            // Parent: CParticleFunctionOperator
            // Field count: 7
            //
            ...
            pub mod C_OP_RemapParticleCountToScalar {
                ...
                pub const m_nInputMax: usize = 0x328; // 
                pub const m_flOutputMin: usize = 0x488; // 
                pub const m_flOutputMax: usize = 0x5E8; // 
                pub const m_bActiveRange: usize = 0x748; // 
            ...
            pub mod C_OP_RemapModelVolumetoCP {
                pub const m_nBBoxType: usize = 0x1C8; // 
                pub const m_nInControlPointNumber: usize = 0x1CC; // 
                pub const m_nOutControlPointNumber: usize = 0x1D0; // 
                pub const m_nOutControlPointMaxNumber: usize = 0x1D4; // 
                pub const m_nField: usize = 0x1D8; // 
                pub const m_flInputMin: usize = 0x1DC; // 
                pub const m_flInputMax: usize = 0x1E0; // 
                pub const m_flOutputMin: usize = 0x1E4; // 
                pub const m_flOutputMax: usize = 0x1E8; // 
                pub const m_bBBoxOnly: usize = 0x1EC; // 
                pub const m_bCubeRoot: usize = 0x1ED; // 
            }
            // Parent: CParticleFunctionOperator
            // Field count: 3
            //
            ...
            pub mod C_OP_SetControlPointToCPVelocity {
                pub const m_nCPInput: usize = 0x1C8; // 
                pub const m_nCPOutputVel: usize = 0x1CC; // 
                pub const m_bNormalize: usize = 0x1D0; // 
                pub const m_nCPOutputMag: usize = 0x1D4; // 
                pub const m_nCPField: usize = 0x1D8; // 
                pub const m_vecComparisonVelocity: usize = 0x1E0; // 
            }
            // Parent: CParticleFunctionRenderer
            // Field count: 11
            //
            ...
            pub mod C_OP_ClientPhysics {
                pub const m_strPhysicsType: usize = 0x210; // 
                pub const m_bStartAsleep: usize = 0x218; // 
                pub const m_flPlayerWakeRadius: usize = 0x220; // 
                pub const m_flVehicleWakeRadius: usize = 0x380; // 
                pub const m_bUseHighQualitySimulation: usize = 0x4E0; // 
                pub const m_nMaxParticleCount: usize = 0x4E4; // 
                pub const m_bRespectExclusionVolumes: usize = 0x4E8; // 
                pub const m_bKillParticles: usize = 0x4E9; // 
                pub const m_bDeleteSim: usize = 0x4EA; // 
                pub const m_nControlPoint: usize = 0x4EC; // 
            ...
            pub mod RenderProjectedMaterial_t {
                pub const m_hMaterial: usize = 0x0; // 
            }
            // Parent: CParticleFunctionForce
            // Field count: 11
            //
            ...
            pub mod C_OP_ExternalWindForce {
                ...
                pub const m_vecScale: usize = 0x848; // 
                pub const m_bSampleWind: usize = 0xEC0; // 
                pub const m_bSampleWater: usize = 0xEC1; // 
                pub const m_bDampenNearWaterPlane: usize = 0xEC2; // 
                pub const m_bSampleGravity: usize = 0xEC3; // 
                pub const m_vecGravityForce: usize = 0xEC8; // 
                pub const m_bUseBasicMovementGravity: usize = 0x1540; // 
                pub const m_flLocalGravityScale: usize = 0x1548; // 
                pub const m_flLocalBuoyancyScale: usize = 0x16A8; // 
                pub const m_vecBuoyancyForce: usize = 0x1808; // 
            }
            // Parent: CParticleFunctionInitializer
            // Field count: 5
            //
            ...
            pub mod C_INIT_ModelCull {
                pub const m_nControlPointNumber: usize = 0x1C8; // 
                pub const m_bBoundBox: usize = 0x1CC; // 
                pub const m_bCullOutside: usize = 0x1CD; // 
                pub const m_bUseBones: usize = 0x1CE; // 
                pub const m_HitboxSetName: usize = 0x1CF; // 
            }
            // Parent: CBaseRendererSource2
            // Field count: 28
            //
            ...
            pub mod C_OP_RenderSprites {
                ...
                pub const m_nOrientationControlPoint: usize = 0x2C0C; // 
                pub const m_bUseYawWithNormalAligned: usize = 0x2C10; // 
                ...
                pub const m_flStartFadeDot: usize = 0x32F8; // 
                pub const m_flEndFadeDot: usize = 0x32FC; // 
                pub const m_bDistanceAlpha: usize = 0x3300; // 
                pub const m_bSoftEdges: usize = 0x3301; // 
                pub const m_flEdgeSoftnessStart: usize = 0x3304; // 
                pub const m_flEdgeSoftnessEnd: usize = 0x3308; // 
                pub const m_bOutline: usize = 0x330C; // 
                pub const m_OutlineColor: usize = 0x330D; // 
                pub const m_nOutlineAlpha: usize = 0x3314; // 
                pub const m_flOutlineStart0: usize = 0x3318; // 
                pub const m_flOutlineStart1: usize = 0x331C; // 
                pub const m_flOutlineEnd0: usize = 0x3320; // 
                pub const m_flOutlineEnd1: usize = 0x3324; // 
                ...
                pub const m_bParticleShadows: usize = 0x35F0; // 
                pub const m_flShadowDensity: usize = 0x35F4; // 
            ...
            pub mod C_OP_SetPerChildControlPoint {
                ...
                pub const m_nFirstSourcePoint: usize = 0x330; // 
                pub const m_bSetOrientation: usize = 0x490; // 
                pub const m_nOrientationField: usize = 0x494; // 
                pub const m_bNumBasedOnParticleCount: usize = 0x498; // 
            }
            // Parent: CParticleFunctionRenderer
            // Field count: 10
            //
            ...
            pub mod C_OP_RenderTreeShake {
                pub const m_flPeakStrength: usize = 0x210; // 
                pub const m_nPeakStrengthFieldOverride: usize = 0x214; // 
                pub const m_flRadius: usize = 0x218; // 
                pub const m_nRadiusFieldOverride: usize = 0x21C; // 
                pub const m_flShakeDuration: usize = 0x220; // 
                pub const m_flTransitionTime: usize = 0x224; // 
                pub const m_flTwistAmount: usize = 0x228; // 
                pub const m_flRadialAmount: usize = 0x22C; // 
                pub const m_flControlPointOrientationAmount: usize = 0x230; // 
                pub const m_nControlPointForLinearDirection: usize = 0x234; // 
            }
            // Parent: CParticleFunctionConstraint
            // Field count: 0
            //
            ...
            pub mod C_OP_SetAttributeToScalarExpression {
                ...
                pub const m_flInput2: usize = 0x328; // 
                pub const m_flOutputRemap: usize = 0x488; // 
                pub const m_nOutputField: usize = 0x5E8; // 
            ...
            pub mod C_OP_RenderMaterialProxy {
                pub const m_nMaterialControlPoint: usize = 0x210; // 
                pub const m_nProxyType: usize = 0x214; // 
                pub const m_MaterialVars: usize = 0x218; // 
                pub const m_hOverrideMaterial: usize = 0x230; // 
                pub const m_flMaterialOverrideEnabled: usize = 0x238; // 
                pub const m_vecColorScale: usize = 0x398; // 
                pub const m_flAlpha: usize = 0xA10; // 
            ...
            pub mod C_INIT_SequenceFromCP {
                pub const m_bKillUnused: usize = 0x1C8; // 
                pub const m_bRadiusScale: usize = 0x1C9; // 
                pub const m_nCP: usize = 0x1CC; // 
                pub const m_vecOffset: usize = 0x1D0; // 
            }
            // Parent: CParticleFunctionOperator
            // Field count: 11
            //
