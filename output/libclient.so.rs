...
pub mod cs2_dumper {
    pub mod schemas {
        ...
        pub mod libclient_so {
            ...
            // Fields count: 1
            pub mod C_Item {
                pub const m_pReticleHintTextName: usize = 0x2460; // char[256]
            }
            ...
            pub mod C_SoundEventPathCornerEntity {
                pub const m_vecCornerPairsNetworked: usize = 0x6D0; // C_NetworkUtlVectorBase<SoundeventPathCornerPairNetworked_t>
            }
            // Parent: C_CSWeaponBaseGun
            // Fields count: 0
            ...
            pub mod C_CSGameRules {
                ...
                pub const m_nMatchAbortedEarlyReason: usize = 0xD20; // int32
                pub const m_bHasTriggeredRoundStartMusic: usize = 0xD24; // bool
                pub const m_bSwitchingTeamsAtRoundReset: usize = 0xD25; // bool
                pub const m_pGameModeRules: usize = 0xD40; // CCSGameModeRules*
                pub const m_RetakeRules: usize = 0xD48; // C_RetakeGameRules
                pub const m_nMatchEndCount: usize = 0xE60; // uint8
                pub const m_nTTeamIntroVariant: usize = 0xE64; // int32
                pub const m_nCTTeamIntroVariant: usize = 0xE68; // int32
                pub const m_bTeamIntroPeriod: usize = 0xE6C; // bool
                pub const m_iRoundEndWinnerTeam: usize = 0xE70; // int32
                pub const m_eRoundEndReason: usize = 0xE74; // int32
                pub const m_bRoundEndShowTimerDefend: usize = 0xE78; // bool
                pub const m_iRoundEndTimerTime: usize = 0xE7C; // int32
                pub const m_sRoundEndFunFactToken: usize = 0xE80; // CUtlString
                pub const m_iRoundEndFunFactPlayerSlot: usize = 0xE88; // CPlayerSlot
                pub const m_iRoundEndFunFactData1: usize = 0xE8C; // int32
                pub const m_iRoundEndFunFactData2: usize = 0xE90; // int32
                pub const m_iRoundEndFunFactData3: usize = 0xE94; // int32
                pub const m_sRoundEndMessage: usize = 0xE98; // CUtlString
                pub const m_iRoundEndPlayerCount: usize = 0xEA0; // int32
                pub const m_bRoundEndNoMusic: usize = 0xEA4; // bool
                pub const m_iRoundEndLegacy: usize = 0xEA8; // int32
                pub const m_nRoundEndCount: usize = 0xEAC; // uint8
                pub const m_iRoundStartRoundNumber: usize = 0xEB0; // int32
                pub const m_nRoundStartCount: usize = 0xEB4; // uint8
                pub const m_flLastPerfSampleTime: usize = 0x4EC0; // float64
            }
            ...
            pub mod C_PointClientUIHUD {
                ...
                pub const m_bIgnoreInput: usize = 0xE08; // bool
                pub const m_flWidth: usize = 0xE0C; // float32
                pub const m_flHeight: usize = 0xE10; // float32
                pub const m_flDPI: usize = 0xE14; // float32
                pub const m_flInteractDistance: usize = 0xE18; // float32
                pub const m_flDepthOffset: usize = 0xE1C; // float32
                pub const m_unOwnerContext: usize = 0xE20; // uint32
                pub const m_unHorizontalAlign: usize = 0xE24; // uint32
                pub const m_unVerticalAlign: usize = 0xE28; // uint32
                pub const m_unOrientation: usize = 0xE2C; // uint32
                pub const m_bAllowInteractionFromAllSceneWorlds: usize = 0xE30; // bool
                pub const m_vecCSSClasses: usize = 0xE38; // C_NetworkUtlVectorBase<CUtlSymbolLarge>
            }
            ...
            pub mod C_PointCamera {
                pub const m_FOV: usize = 0x6CC; // float32
                pub const m_Resolution: usize = 0x6D0; // float32
                pub const m_bFogEnable: usize = 0x6D4; // bool
                pub const m_FogColor: usize = 0x6D5; // Color
                pub const m_flFogStart: usize = 0x6DC; // float32
                pub const m_flFogEnd: usize = 0x6E0; // float32
                pub const m_flFogMaxDensity: usize = 0x6E4; // float32
                pub const m_bActive: usize = 0x6E8; // bool
                pub const m_bUseScreenAspectRatio: usize = 0x6E9; // bool
                pub const m_flAspectRatio: usize = 0x6EC; // float32
                pub const m_bNoSky: usize = 0x6F0; // bool
                pub const m_fBrightness: usize = 0x6F4; // float32
                pub const m_flZFar: usize = 0x6F8; // float32
                pub const m_flZNear: usize = 0x6FC; // float32
                pub const m_bCanHLTVUse: usize = 0x700; // bool
                pub const m_bDofEnabled: usize = 0x701; // bool
                pub const m_flDofNearBlurry: usize = 0x704; // float32
                pub const m_flDofNearCrisp: usize = 0x708; // float32
                pub const m_flDofFarCrisp: usize = 0x70C; // float32
                pub const m_flDofFarBlurry: usize = 0x710; // float32
                pub const m_flDofTiltToGround: usize = 0x714; // float32
                pub const m_TargetFOV: usize = 0x718; // float32
                pub const m_DegreesPerSecond: usize = 0x71C; // float32
                pub const m_bIsOn: usize = 0x720; // bool
            ...
            pub mod C_BaseCombatCharacter {
                ...
                pub const m_leftFootAttachment: usize = 0x1028; // AttachmentHandle_t
                pub const m_rightFootAttachment: usize = 0x1029; // AttachmentHandle_t
                pub const m_nWaterWakeMode: usize = 0x102C; // C_BaseCombatCharacter::WaterWakeMode_t
                pub const m_flWaterWorldZ: usize = 0x1030; // float32
                pub const m_flWaterNextTraceTime: usize = 0x1034; // float32
                pub const m_flFieldOfView: usize = 0x1038; // float32
            }
            ...
            pub mod C_SoundEventSphereEntity {
                pub const m_flRadius: usize = 0x6CC; // float32
            }
            ...
            pub mod C_SoundAreaEntitySphere {
                pub const m_flRadius: usize = 0x6EC; // float32
            }
            ...
            pub mod C_LightGlow {
                ...
                pub const m_GlowOverlay: usize = 0xC70; // C_LightGlowOverlay
            }
            // Parent: None
            // Fields count: 4
            //
            ...
            pub mod C_CSPlayerResource {
                pub const m_bHostageAlive: usize = 0x6CC; // bool[12]
                pub const m_isHostageFollowingSomeone: usize = 0x6D8; // bool[12]
                pub const m_iHostageEntityIDs: usize = 0x6E4; // CEntityIndex[12]
                pub const m_bombsiteCenterA: usize = 0x714; // Vector
                pub const m_bombsiteCenterB: usize = 0x720; // Vector
                pub const m_hostageRescueX: usize = 0x72C; // int32[4]
                pub const m_hostageRescueY: usize = 0x73C; // int32[4]
                pub const m_hostageRescueZ: usize = 0x74C; // int32[4]
                pub const m_bEndMatchNextMapAllVoted: usize = 0x75C; // bool
                pub const m_foundGoalPositions: usize = 0x75D; // bool
            }
            ...
            pub mod C_CSGO_MapPreviewCameraPath {
                pub const m_flZFar: usize = 0x6CC; // float32
                pub const m_flZNear: usize = 0x6D0; // float32
                pub const m_bLoop: usize = 0x6D4; // bool
                pub const m_bVerticalFOV: usize = 0x6D5; // bool
                pub const m_bConstantSpeed: usize = 0x6D6; // bool
                pub const m_flDuration: usize = 0x6D8; // float32
            ...
            pub mod C_Inferno {
                ...
                pub const m_hInfernoPointsSnapshot: usize = 0xC98; // CStrongHandle<InfoForResourceTypeIParticleSnapshot>
                pub const m_hInfernoFillerPointsSnapshot: usize = 0xCA0; // CStrongHandle<InfoForResourceTypeIParticleSnapshot>
                pub const m_hInfernoOutlinePointsSnapshot: usize = 0xCA8; // CStrongHandle<InfoForResourceTypeIParticleSnapshot>
                pub const m_hInfernoClimbingOutlinePointsSnapshot: usize = 0xCB0; // CStrongHandle<InfoForResourceTypeIParticleSnapshot>
                pub const m_hInfernoDecalsSnapshot: usize = 0xCB8; // CStrongHandle<InfoForResourceTypeIParticleSnapshot>
                pub const m_firePositions: usize = 0xCC0; // Vector[64]
                pub const m_fireParentPositions: usize = 0xFC0; // Vector[64]
                pub const m_bFireIsBurning: usize = 0x12C0; // bool[64]
                pub const m_BurnNormal: usize = 0x1300; // Vector[64]
                pub const m_fireCount: usize = 0x1600; // int32
                pub const m_nInfernoType: usize = 0x1604; // int32
                pub const m_nFireLifetime: usize = 0x1608; // float32
                pub const m_bInPostEffectTime: usize = 0x160C; // bool
                pub const m_lastFireCount: usize = 0x1610; // int32
                pub const m_nFireEffectTickBegin: usize = 0x1614; // int32
                pub const m_drawableCount: usize = 0x8220; // int32
                pub const m_blosCheck: usize = 0x8224; // bool
                pub const m_nlosperiod: usize = 0x8228; // int32
                pub const m_maxFireHalfWidth: usize = 0x822C; // float32
                pub const m_maxFireHeight: usize = 0x8230; // float32
                pub const m_minBounds: usize = 0x8234; // Vector
                pub const m_maxBounds: usize = 0x8240; // Vector
                pub const m_flLastGrassBurnThink: usize = 0x824C; // float32
            }
            // Parent: CBaseAnimGraph
            // Fields count: 0
            ...
            pub mod C_CSGO_MapPreviewCameraPathNode {
                ...
                pub const m_flCameraSpeed: usize = 0x6F8; // float32
            ...
            pub mod C_CSPlayerPawn {
                ...
                pub const m_iRetakesOffering: usize = 0x15F8; // int32
                pub const m_iRetakesOfferingCard: usize = 0x15FC; // int32
                pub const m_bRetakesHasDefuseKit: usize = 0x1600; // bool
                pub const m_bRetakesMVPLastRound: usize = 0x1601; // bool
                pub const m_iRetakesMVPBoostItem: usize = 0x1604; // int32
                pub const m_RetakesMVPBoostExtraUtility: usize = 0x1608; // loadout_slot_t
                pub const m_bNeedToReApplyGloves: usize = 0x1628; // bool
                pub const m_EconGloves: usize = 0x1630; // C_EconItemView
                pub const m_nEconGlovesChanged: usize = 0x2980; // uint8
                pub const m_bMustSyncRagdollState: usize = 0x2981; // bool
                pub const m_nRagdollDamageBone: usize = 0x2984; // int32
                pub const m_vRagdollDamageForce: usize = 0x2988; // Vector
                pub const m_vRagdollDamagePosition: usize = 0x2994; // Vector
                pub const m_szRagdollDamageWeaponName: usize = 0x29A0; // char[64]
                pub const m_bRagdollDamageHeadshot: usize = 0x29E0; // bool
                pub const m_vRagdollServerOrigin: usize = 0x29E4; // Vector
                pub const m_bLastHeadBoneTransformIsValid: usize = 0x2FF8; // bool
                pub const m_lastLandTime: usize = 0x2FFC; // GameTime_t
                pub const m_bOnGroundLastTick: usize = 0x3000; // bool
                pub const m_qDeathEyeAngles: usize = 0x301C; // QAngle
                pub const m_bSkipOneHeadConstraintUpdate: usize = 0x3028; // bool
                pub const m_bLeftHanded: usize = 0x3029; // bool
                pub const m_fSwitchedHandednessTime: usize = 0x302C; // GameTime_t
                pub const m_flViewmodelOffsetX: usize = 0x3030; // float32
                pub const m_flViewmodelOffsetY: usize = 0x3034; // float32
                pub const m_flViewmodelOffsetZ: usize = 0x3038; // float32
                pub const m_flViewmodelFOV: usize = 0x303C; // float32
                pub const m_vecPlayerPatchEconIndices: usize = 0x3040; // uint32[5]
                pub const m_GunGameImmunityColor: usize = 0x3078; // Color
                pub const m_vecBulletHitModels: usize = 0x30C8; // CUtlVector<C_BulletHitModel*>
                pub const m_bIsWalking: usize = 0x30E0; // bool
                pub const m_thirdPersonHeading: usize = 0x30E8; // QAngle
                pub const m_flSlopeDropOffset: usize = 0x3100; // float32
                pub const m_flSlopeDropHeight: usize = 0x3110; // float32
                pub const m_vHeadConstraintOffset: usize = 0x3120; // Vector
                pub const m_entitySpottedState: usize = 0x3138; // EntitySpottedState_t
                pub const m_bIsScoped: usize = 0x3150; // bool
                pub const m_bResumeZoom: usize = 0x3151; // bool
                pub const m_bIsDefusing: usize = 0x3152; // bool
                pub const m_bIsGrabbingHostage: usize = 0x3153; // bool
                pub const m_iBlockingUseActionInProgress: usize = 0x3154; // CSPlayerBlockingUseAction_t
                pub const m_flEmitSoundTime: usize = 0x3158; // GameTime_t
                pub const m_bInNoDefuseArea: usize = 0x315C; // bool
                pub const m_nWhichBombZone: usize = 0x3160; // int32
                pub const m_iShotsFired: usize = 0x3164; // int32
                pub const m_flVelocityModifier: usize = 0x3168; // float32
                pub const m_flHitHeading: usize = 0x316C; // float32
                pub const m_nHitBodyPart: usize = 0x3170; // int32
                pub const m_bWaitForNoAttack: usize = 0x3174; // bool
                pub const m_ignoreLadderJumpTime: usize = 0x3178; // float32
                pub const m_bKilledByHeadshot: usize = 0x317D; // bool
                pub const m_ArmorValue: usize = 0x3180; // int32
                pub const m_unCurrentEquipmentValue: usize = 0x3184; // uint16
                pub const m_unRoundStartEquipmentValue: usize = 0x3186; // uint16
                pub const m_unFreezetimeEndEquipmentValue: usize = 0x3188; // uint16
                pub const m_nLastKillerIndex: usize = 0x318C; // CEntityIndex
                pub const m_bOldIsScoped: usize = 0x3190; // bool
                pub const m_bHasDeathInfo: usize = 0x3191; // bool
                pub const m_flDeathInfoTime: usize = 0x3194; // float32
                pub const m_vecDeathInfoOrigin: usize = 0x3198; // Vector
                pub const m_grenadeParameterStashTime: usize = 0x31A4; // GameTime_t
                pub const m_bGrenadeParametersStashed: usize = 0x31A8; // bool
                pub const m_angStashedShootAngles: usize = 0x31AC; // QAngle
                pub const m_vecStashedGrenadeThrowPosition: usize = 0x31B8; // Vector
                pub const m_vecStashedVelocity: usize = 0x31C4; // Vector
                pub const m_angShootAngleHistory: usize = 0x31D0; // QAngle[2]
                pub const m_vecThrowPositionHistory: usize = 0x31E8; // Vector[2]
                pub const m_vecVelocityHistory: usize = 0x3200; // Vector[2]
            }
            ...
            pub mod C_WeaponBaseItem {
                pub const m_SequenceCompleteTimer: usize = 0x2918; // CountdownTimer
                pub const m_bRedraw: usize = 0x2930; // bool
            }
            // Parent: None
            // Fields count: 21
            //
            ...
            pub mod C_PointClientUIWorldPanel {
                ...
                pub const m_pOffScreenIndicator: usize = 0xE28; // CPointOffScreenIndicatorUi*
                pub const m_bIgnoreInput: usize = 0xE50; // bool
                pub const m_bLit: usize = 0xE51; // bool
                pub const m_bFollowPlayerAcrossTeleport: usize = 0xE52; // bool
                pub const m_flWidth: usize = 0xE54; // float32
                pub const m_flHeight: usize = 0xE58; // float32
                pub const m_flDPI: usize = 0xE5C; // float32
                pub const m_flInteractDistance: usize = 0xE60; // float32
                pub const m_flDepthOffset: usize = 0xE64; // float32
                pub const m_unOwnerContext: usize = 0xE68; // uint32
                pub const m_unHorizontalAlign: usize = 0xE6C; // uint32
                pub const m_unVerticalAlign: usize = 0xE70; // uint32
                pub const m_unOrientation: usize = 0xE74; // uint32
                pub const m_bAllowInteractionFromAllSceneWorlds: usize = 0xE78; // bool
                pub const m_vecCSSClasses: usize = 0xE80; // C_NetworkUtlVectorBase<CUtlSymbolLarge>
                pub const m_bOpaque: usize = 0xE98; // bool
                pub const m_bNoDepth: usize = 0xE99; // bool
                pub const m_bRenderBackface: usize = 0xE9A; // bool
                pub const m_bUseOffScreenIndicator: usize = 0xE9B; // bool
                pub const m_bExcludeFromSaveGames: usize = 0xE9C; // bool
                pub const m_bGrabbable: usize = 0xE9D; // bool
                pub const m_bOnlyRenderToTexture: usize = 0xE9E; // bool
                pub const m_bDisableMipGen: usize = 0xE9F; // bool
                pub const m_nExplicitImageLayout: usize = 0xEA0; // int32
            }
            // Parent: C_BaseEntity
            // Fields count: 0
            ...
            pub mod C_SoundAreaEntityOrientedBox {
                pub const m_vMin: usize = 0x6EC; // Vector
                pub const m_vMax: usize = 0x6F8; // Vector
            }
            // Parent: C_BaseModelEntity
            // Fields count: 8
            //
            ...
            pub mod CSkyboxReference {
                pub const m_worldGroupId: usize = 0x6CC; // WorldGroupId_t
                pub const m_hSkyCamera: usize = 0x6D0; // CHandle<C_SkyCamera>
            }
            ...
            pub mod C_CSGOViewModel {
                ...
                pub const m_vLoweredWeaponOffset: usize = 0xF70; // QAngle
            }
            // Parent: CEntityComponent
            // Fields count: 1
            ...
            pub mod C_EnvLightProbeVolume {
                pub const m_Entity_hLightProbeTexture: usize = 0x16B0; // CStrongHandle<InfoForResourceTypeCTextureBase>
                ...
                pub const m_Entity_nPriority: usize = 0x16F0; // int32
                pub const m_Entity_bStartDisabled: usize = 0x16F4; // bool
                pub const m_Entity_nLightProbeSizeX: usize = 0x16F8; // int32
                pub const m_Entity_nLightProbeSizeY: usize = 0x16FC; // int32
                pub const m_Entity_nLightProbeSizeZ: usize = 0x1700; // int32
                pub const m_Entity_nLightProbeAtlasX: usize = 0x1704; // int32
                pub const m_Entity_nLightProbeAtlasY: usize = 0x1708; // int32
                pub const m_Entity_nLightProbeAtlasZ: usize = 0x170C; // int32
                pub const m_Entity_bEnabled: usize = 0x1719; // bool
            }
            // Parent: CBaseAnimGraph
            // Fields count: 1
            ...
            pub mod C_TeamRoundTimer {
                pub const m_bTimerPaused: usize = 0x6CC; // bool
                pub const m_flTimeRemaining: usize = 0x6D0; // float32
                pub const m_flTimerEndTime: usize = 0x6D4; // GameTime_t
                pub const m_bIsDisabled: usize = 0x6D8; // bool
                pub const m_bShowInHUD: usize = 0x6D9; // bool
                pub const m_nTimerLength: usize = 0x6DC; // int32
                pub const m_nTimerInitialLength: usize = 0x6E0; // int32
                pub const m_nTimerMaxLength: usize = 0x6E4; // int32
                pub const m_bAutoCountdown: usize = 0x6E8; // bool
                pub const m_nSetupTimeLength: usize = 0x6EC; // int32
                pub const m_nState: usize = 0x6F0; // int32
                pub const m_bStartPaused: usize = 0x6F4; // bool
                pub const m_bInCaptureWatchState: usize = 0x6F5; // bool
                pub const m_flTotalTime: usize = 0x6F8; // float32
                pub const m_bStopWatchTimer: usize = 0x6FC; // bool
                pub const m_bFireFinished: usize = 0x6FD; // bool
                pub const m_bFire5MinRemain: usize = 0x6FE; // bool
                pub const m_bFire4MinRemain: usize = 0x6FF; // bool
                pub const m_bFire3MinRemain: usize = 0x700; // bool
                pub const m_bFire2MinRemain: usize = 0x701; // bool
                pub const m_bFire1MinRemain: usize = 0x702; // bool
                pub const m_bFire30SecRemain: usize = 0x703; // bool
                pub const m_bFire10SecRemain: usize = 0x704; // bool
                pub const m_bFire5SecRemain: usize = 0x705; // bool
                pub const m_bFire4SecRemain: usize = 0x706; // bool
                pub const m_bFire3SecRemain: usize = 0x707; // bool
                pub const m_bFire2SecRemain: usize = 0x708; // bool
                pub const m_bFire1SecRemain: usize = 0x709; // bool
                pub const m_nOldTimerLength: usize = 0x70C; // int32
                pub const m_nOldTimerState: usize = 0x710; // int32
            }
            // Parent: None
            // Fields count: 2
            //
            ...
            // Fields count: 1
            pub mod CPathSimple {
                pub const m_pathString: usize = 0x720; // CUtlString
            }
            ...
            pub mod CPointOffScreenIndicatorUi {
                pub const m_bBeenEnabled: usize = 0xEA4; // bool
                pub const m_bHide: usize = 0xEA5; // bool
                pub const m_flSeenTargetTime: usize = 0xEA8; // float32
                pub const m_pTargetPanel: usize = 0xEB0; // C_PointClientUIWorldPanel*
            }
            // Parent: None
            // Fields count: 0
            //
            ...
            pub mod C_CSWeaponBaseGun {
                pub const m_zoomLevel: usize = 0x2918; // int32
                pub const m_iBurstShotsRemaining: usize = 0x291C; // int32
                pub const m_iSilencerBodygroup: usize = 0x2920; // int32
                pub const m_silencedModelIndex: usize = 0x2930; // int32
                pub const m_inPrecache: usize = 0x2934; // bool
                pub const m_bNeedsBoltAction: usize = 0x2935; // bool
            }
            // Parent: C_BaseEntity
            // Fields count: 4
            //
            ...
            pub mod C_CSPlayerPawnBase {
                ...
                pub const m_iTargetItemEntIdx: usize = 0x1370; // CEntityIndex
            ...
            pub mod C_BaseFire {
                pub const m_flScale: usize = 0x6CC; // float32
                pub const m_flStartScale: usize = 0x6D0; // float32
                pub const m_flScaleTime: usize = 0x6D4; // float32
                pub const m_nFlags: usize = 0x6D8; // uint32
            }
            // Parent: C_BaseEntity
            // Fields count: 16
            //
            ...
            pub mod CBasePlayerController {
                ...
                pub const m_bKnownTeamMismatch: usize = 0x788; // bool
                pub const m_hPredictedPawn: usize = 0x78C; // CHandle<C_BasePlayerPawn>
                pub const m_nSplitScreenSlot: usize = 0x790; // CSplitScreenSlot
                pub const m_hSplitOwner: usize = 0x794; // CHandle<CBasePlayerController>
            ...
            pub mod C_CSGO_PreviewPlayer {
                pub const m_animgraph: usize = 0x3218; // CUtlString
                pub const m_animgraphCharacterModeString: usize = 0x3220; // CGlobalSymbol
                pub const m_flInitialModelScale: usize = 0x3228; // float32
            }
            ...
            // NetworkVarNames: m_entitySpottedState (EntitySpottedState_t)
            pub mod C_C4 {
                pub const m_szScreenText: usize = 0x2918; // char[32]
                pub const m_activeLightParticleIndex: usize = 0x2938; // ParticleIndex_t
                pub const m_eActiveLightEffect: usize = 0x293C; // C4LightEffect_t
                pub const m_bStartedArming: usize = 0x2940; // bool
                pub const m_fArmedTime: usize = 0x2944; // GameTime_t
                pub const m_bBombPlacedAnimation: usize = 0x2948; // bool
                pub const m_bIsPlantingViaUse: usize = 0x2949; // bool
                pub const m_entitySpottedState: usize = 0x2950; // EntitySpottedState_t
                pub const m_nSpotRules: usize = 0x2968; // int32
                pub const m_bPlayedArmingBeeps: usize = 0x296C; // bool[7]
                pub const m_bBombPlanted: usize = 0x2973; // bool
            }
            // Parent: C_BaseModelEntity
            // Fields count: 13
            //
            ...
            pub mod CBaseAnimGraph {
                ...
                pub const m_bRagdollClientSide: usize = 0xD28; // bool
            ...
            pub mod C_PathParticleRope {
                pub const m_bStartActive: usize = 0x6CC; // bool
                pub const m_flMaxSimulationTime: usize = 0x6D0; // float32
            ...
            pub mod C_SoundEventAABBEntity {
                pub const m_vMins: usize = 0x6CC; // Vector
                pub const m_vMaxs: usize = 0x6D8; // Vector
            }
            // Parent: C_CSWeaponBaseGun
            // Fields count: 0
            pub mod C_WeaponP90 {
            ...
            pub mod C_CSGO_TeamPreviewCamera {
                pub const m_nVariant: usize = 0x734; // int32
                pub const m_bDofEnabled: usize = 0x738; // bool
                pub const m_flDofNearBlurry: usize = 0x73C; // float32
                pub const m_flDofNearCrisp: usize = 0x740; // float32
                pub const m_flDofFarCrisp: usize = 0x744; // float32
                pub const m_flDofFarBlurry: usize = 0x748; // float32
                pub const m_flDofTiltToGround: usize = 0x74C; // float32
            }
            ...
            pub mod C_EnvVolumetricFogVolume {
                pub const m_bActive: usize = 0x6CC; // bool
                pub const m_vBoxMins: usize = 0x6D0; // Vector
                pub const m_vBoxMaxs: usize = 0x6DC; // Vector
                pub const m_bStartDisabled: usize = 0x6E8; // bool
                pub const m_flStrength: usize = 0x6EC; // float32
                pub const m_nFalloffShape: usize = 0x6F0; // int32
                pub const m_flFalloffExponent: usize = 0x6F4; // float32
                pub const m_flHeightFogDepth: usize = 0x6F8; // float32
                pub const m_fHeightFogEdgeWidth: usize = 0x6FC; // float32
                pub const m_fIndirectLightStrength: usize = 0x700; // float32
                pub const m_fSunLightStrength: usize = 0x704; // float32
                pub const m_fNoiseStrength: usize = 0x708; // float32
                pub const m_bOverrideIndirectLightStrength: usize = 0x70C; // bool
                pub const m_bOverrideSunLightStrength: usize = 0x70D; // bool
                pub const m_bOverrideNoiseStrength: usize = 0x70E; // bool
            }
            // Parent: C_BaseModelEntity
            // Fields count: 0
            ...
            pub mod C_FireSmoke {
                pub const m_nFlameModelIndex: usize = 0x6DC; // int32
                pub const m_nFlameFromAboveModelIndex: usize = 0x6E0; // int32
                pub const m_flScaleRegister: usize = 0x6E4; // float32
                pub const m_flScaleStart: usize = 0x6E8; // float32
                pub const m_flScaleEnd: usize = 0x6EC; // float32
                pub const m_flScaleTimeStart: usize = 0x6F0; // GameTime_t
                pub const m_flScaleTimeEnd: usize = 0x6F4; // GameTime_t
                pub const m_flChildFlameSpread: usize = 0x6F8; // float32
                pub const m_flClipPerc: usize = 0x70C; // float32
                pub const m_bClipTested: usize = 0x710; // bool
                pub const m_bFadingOut: usize = 0x711; // bool
                pub const m_tParticleSpawn: usize = 0x714; // TimedEvent
            ...
            pub mod C_EnvCombinedLightProbeVolume {
                pub const m_Entity_Color: usize = 0x1730; // Color
                pub const m_Entity_flBrightness: usize = 0x1734; // float32
                pub const m_Entity_hCubemapTexture: usize = 0x1738; // CStrongHandle<InfoForResourceTypeCTextureBase>
                pub const m_Entity_bCustomCubemapTexture: usize = 0x1740; // bool
                pub const m_Entity_hLightProbeTexture: usize = 0x1748; // CStrongHandle<InfoForResourceTypeCTextureBase>
                pub const m_Entity_hLightProbeDirectLightIndicesTexture: usize = 0x1750; // CStrongHandle<InfoForResourceTypeCTextureBase>
                pub const m_Entity_hLightProbeDirectLightScalarsTexture: usize = 0x1758; // CStrongHandle<InfoForResourceTypeCTextureBase>
                pub const m_Entity_hLightProbeDirectLightShadowsTexture: usize = 0x1760; // CStrongHandle<InfoForResourceTypeCTextureBase>
                pub const m_Entity_vBoxMins: usize = 0x1768; // Vector
                pub const m_Entity_vBoxMaxs: usize = 0x1774; // Vector
                pub const m_Entity_bMoveable: usize = 0x1780; // bool
                pub const m_Entity_nHandshake: usize = 0x1784; // int32
                pub const m_Entity_nEnvCubeMapArrayIndex: usize = 0x1788; // int32
                pub const m_Entity_nPriority: usize = 0x178C; // int32
                pub const m_Entity_bStartDisabled: usize = 0x1790; // bool
                pub const m_Entity_flEdgeFadeDist: usize = 0x1794; // float32
                pub const m_Entity_vEdgeFadeDists: usize = 0x1798; // Vector
                pub const m_Entity_nLightProbeSizeX: usize = 0x17A4; // int32
                pub const m_Entity_nLightProbeSizeY: usize = 0x17A8; // int32
                pub const m_Entity_nLightProbeSizeZ: usize = 0x17AC; // int32
                pub const m_Entity_nLightProbeAtlasX: usize = 0x17B0; // int32
                pub const m_Entity_nLightProbeAtlasY: usize = 0x17B4; // int32
                pub const m_Entity_nLightProbeAtlasZ: usize = 0x17B8; // int32
                pub const m_Entity_bEnabled: usize = 0x17D1; // bool
            }
            // Parent: C_SoundOpvarSetPointBase
            // Fields count: 0
            ...
            pub mod C_TonemapController2 {
                pub const m_flAutoExposureMin: usize = 0x6CC; // float32
                pub const m_flAutoExposureMax: usize = 0x6D0; // float32
                pub const m_flTonemapPercentTarget: usize = 0x6D4; // float32
                pub const m_flTonemapPercentBrightPixels: usize = 0x6D8; // float32
                pub const m_flTonemapMinAvgLum: usize = 0x6DC; // float32
                pub const m_flExposureAdaptationSpeedUp: usize = 0x6E0; // float32
                pub const m_flExposureAdaptationSpeedDown: usize = 0x6E4; // float32
                pub const m_flTonemapEVSmoothingRange: usize = 0x6E8; // float32
            }
            // Parent: C_CSWeaponBaseGun
            // Fields count: 0
            ...
            pub mod C_ColorCorrection {
                pub const m_vecOrigin: usize = 0x6CC; // Vector
                pub const m_MinFalloff: usize = 0x6D8; // float32
                pub const m_MaxFalloff: usize = 0x6DC; // float32
                pub const m_flFadeInDuration: usize = 0x6E0; // float32
                pub const m_flFadeOutDuration: usize = 0x6E4; // float32
                pub const m_flMaxWeight: usize = 0x6E8; // float32
                pub const m_flCurWeight: usize = 0x6EC; // float32
                pub const m_netlookupFilename: usize = 0x6F0; // char[512]
                pub const m_bEnabled: usize = 0x8F0; // bool
                pub const m_bMaster: usize = 0x8F1; // bool
                pub const m_bClientSide: usize = 0x8F2; // bool
                pub const m_bExclusive: usize = 0x8F3; // bool
                pub const m_bEnabledOnClient: usize = 0x8F4; // bool[1]
                pub const m_flCurWeightOnClient: usize = 0x8F8; // float32[1]
                pub const m_bFadingIn: usize = 0x8FC; // bool[1]
                pub const m_flFadeStartWeight: usize = 0x900; // float32[1]
                pub const m_flFadeStartTime: usize = 0x904; // float32[1]
                pub const m_flFadeDuration: usize = 0x908; // float32[1]
            }
            // Parent: C_BaseTrigger
            // Fields count: 0
            ...
            pub mod CGrenadeTracer {
                pub const m_flTracerDuration: usize = 0xC70; // float32
            ...
            pub mod C_HandleTest {
                pub const m_Handle: usize = 0x6CC; // CHandle<C_BaseEntity>
                pub const m_bSendHandle: usize = 0x6D0; // bool
            }
            // Parent: C_BaseEntity
            // Fields count: 1
            //
            ...
            pub mod C_WeaponShield {
                pub const m_flDisplayHealth: usize = 0x2938; // float32
            }
            // Parent: C_PointClientUIWorldPanel
            // Fields count: 1
            //
            ...
            pub mod C_PointClientUIWorldTextPanel {
                pub const m_messageText: usize = 0xEA4; // char[512]
            }
            // Parent: CPlayer_UseServices
            // Fields count: 0
            ...
            pub mod C_EnvVolumetricFogController {
                pub const m_flScattering: usize = 0x6CC; // float32
                pub const m_flAnisotropy: usize = 0x6D0; // float32
                pub const m_flFadeSpeed: usize = 0x6D4; // float32
                pub const m_flDrawDistance: usize = 0x6D8; // float32
                pub const m_flFadeInStart: usize = 0x6DC; // float32
                pub const m_flFadeInEnd: usize = 0x6E0; // float32
                pub const m_flIndirectStrength: usize = 0x6E4; // float32
                pub const m_nIndirectTextureDimX: usize = 0x6E8; // int32
                pub const m_nIndirectTextureDimY: usize = 0x6EC; // int32
                pub const m_nIndirectTextureDimZ: usize = 0x6F0; // int32
                pub const m_vBoxMins: usize = 0x6F4; // Vector
                pub const m_vBoxMaxs: usize = 0x700; // Vector
                pub const m_bActive: usize = 0x70C; // bool
                pub const m_flStartAnisoTime: usize = 0x710; // GameTime_t
                pub const m_flStartScatterTime: usize = 0x714; // GameTime_t
                pub const m_flStartDrawDistanceTime: usize = 0x718; // GameTime_t
                pub const m_flStartAnisotropy: usize = 0x71C; // float32
                pub const m_flStartScattering: usize = 0x720; // float32
                pub const m_flStartDrawDistance: usize = 0x724; // float32
                pub const m_flDefaultAnisotropy: usize = 0x728; // float32
                pub const m_flDefaultScattering: usize = 0x72C; // float32
                pub const m_flDefaultDrawDistance: usize = 0x730; // float32
                pub const m_bStartDisabled: usize = 0x734; // bool
                pub const m_bEnableIndirect: usize = 0x735; // bool
                pub const m_bIndirectUseLPVs: usize = 0x736; // bool
                pub const m_bIsMaster: usize = 0x737; // bool
                pub const m_hFogIndirectTexture: usize = 0x738; // CStrongHandle<InfoForResourceTypeCTextureBase>
                pub const m_nForceRefreshCount: usize = 0x740; // int32
                pub const m_fNoiseSpeed: usize = 0x744; // float32
                pub const m_fNoiseStrength: usize = 0x748; // float32
                pub const m_vNoiseScale: usize = 0x74C; // Vector
                pub const m_bFirstTime: usize = 0x758; // bool
            }
            // Parent: C_CSWeaponBaseGun
            // Fields count: 0
            ...
            pub mod C_InfoVisibilityBox {
                pub const m_nMode: usize = 0x6D0; // int32
                pub const m_vBoxSize: usize = 0x6D4; // Vector
                pub const m_bEnabled: usize = 0x6E0; // bool
            }
            // Parent: C_Sprite
            // Fields count: 2
            pub mod C_FireSprite {
                pub const m_vecMoveDir: usize = 0xD60; // Vector
                pub const m_bFadeFromAbove: usize = 0xD6C; // bool
            }
            // Parent: C_CSGO_TeamIntroCharacterPosition
            // Fields count: 0
            ...
            pub mod CBaseProp {
                ...
                pub const m_iShapeType: usize = 0xE7C; // int32
            ...
            pub mod CInfoDynamicShadowHint {
                pub const m_bDisabled: usize = 0x6CC; // bool
                pub const m_flRange: usize = 0x6D0; // float32
                pub const m_nImportance: usize = 0x6D4; // int32
                pub const m_nLightChoice: usize = 0x6D8; // int32
                pub const m_hLight: usize = 0x6DC; // CHandle<C_BaseEntity>
            }
            // Parent: None
            // Fields count: 0
            //
            ...
            pub mod C_EnvCubemap {
                pub const m_Entity_hCubemapTexture: usize = 0x750; // CStrongHandle<InfoForResourceTypeCTextureBase>
                pub const m_Entity_bCustomCubemapTexture: usize = 0x758; // bool
                pub const m_Entity_flInfluenceRadius: usize = 0x75C; // float32
                pub const m_Entity_vBoxProjectMins: usize = 0x760; // Vector
                pub const m_Entity_vBoxProjectMaxs: usize = 0x76C; // Vector
                pub const m_Entity_bMoveable: usize = 0x778; // bool
                pub const m_Entity_nHandshake: usize = 0x77C; // int32
                pub const m_Entity_nEnvCubeMapArrayIndex: usize = 0x780; // int32
                pub const m_Entity_nPriority: usize = 0x784; // int32
                pub const m_Entity_flEdgeFadeDist: usize = 0x788; // float32
                pub const m_Entity_vEdgeFadeDists: usize = 0x78C; // Vector
                pub const m_Entity_flDiffuseScale: usize = 0x798; // float32
                pub const m_Entity_bStartDisabled: usize = 0x79C; // bool
                pub const m_Entity_bDefaultEnvMap: usize = 0x79D; // bool
                pub const m_Entity_bDefaultSpecEnvMap: usize = 0x79E; // bool
                pub const m_Entity_bIndoorCubeMap: usize = 0x79F; // bool
                pub const m_Entity_bCopyDiffuseFromDefaultCubemap: usize = 0x7A0; // bool
                pub const m_Entity_bEnabled: usize = 0x7B0; // bool
            }
            ...
            pub mod C_PointValueRemapper {
                pub const m_bDisabled: usize = 0x6CC; // bool
                pub const m_bDisabledOld: usize = 0x6CD; // bool
                pub const m_bUpdateOnClient: usize = 0x6CE; // bool
                pub const m_nInputType: usize = 0x6D0; // ValueRemapperInputType_t
                pub const m_hRemapLineStart: usize = 0x6D4; // CHandle<C_BaseEntity>
                pub const m_hRemapLineEnd: usize = 0x6D8; // CHandle<C_BaseEntity>
                pub const m_flMaximumChangePerSecond: usize = 0x6DC; // float32
                pub const m_flDisengageDistance: usize = 0x6E0; // float32
                pub const m_flEngageDistance: usize = 0x6E4; // float32
                pub const m_bRequiresUseKey: usize = 0x6E8; // bool
                pub const m_nOutputType: usize = 0x6EC; // ValueRemapperOutputType_t
                pub const m_hOutputEntities: usize = 0x6F0; // C_NetworkUtlVectorBase<CHandle<C_BaseEntity>>
                pub const m_nHapticsType: usize = 0x708; // ValueRemapperHapticsType_t
                pub const m_nMomentumType: usize = 0x70C; // ValueRemapperMomentumType_t
                pub const m_flMomentumModifier: usize = 0x710; // float32
                pub const m_flSnapValue: usize = 0x714; // float32
                pub const m_flCurrentMomentum: usize = 0x718; // float32
                pub const m_nRatchetType: usize = 0x71C; // ValueRemapperRatchetType_t
                pub const m_flRatchetOffset: usize = 0x720; // float32
                pub const m_flInputOffset: usize = 0x724; // float32
                pub const m_bEngaged: usize = 0x728; // bool
                pub const m_bFirstUpdate: usize = 0x729; // bool
                pub const m_flPreviousValue: usize = 0x72C; // float32
                pub const m_flPreviousUpdateTickTime: usize = 0x730; // GameTime_t
                pub const m_vecPreviousTestPoint: usize = 0x734; // Vector
            }
            // Parent: C_CSWeaponBase
            // Fields count: 0
            pub mod C_Knife {
            ...
            pub mod C_ItemDogtags {
                pub const m_OwningPlayer: usize = 0x2560; // CHandle<C_CSPlayerPawn>
                pub const m_KillingPlayer: usize = 0x2564; // CHandle<C_CSPlayerPawn>
            }
            // Parent: C_CSGO_TeamPreviewCamera
            // Fields count: 0
            ...
            pub mod CInfoDynamicShadowHintBox {
                pub const m_vBoxMins: usize = 0x6E0; // Vector
                pub const m_vBoxMaxs: usize = 0x6EC; // Vector
            }
            // Parent: C_SoundOpvarSetPointEntity
            // Fields count: 0
            ...
            pub mod C_EnvCubemapFog {
                pub const m_flEndDistance: usize = 0x6CC; // float32
                pub const m_flStartDistance: usize = 0x6D0; // float32
                pub const m_flFogFalloffExponent: usize = 0x6D4; // float32
                pub const m_bHeightFogEnabled: usize = 0x6D8; // bool
                pub const m_flFogHeightWidth: usize = 0x6DC; // float32
                pub const m_flFogHeightEnd: usize = 0x6E0; // float32
                pub const m_flFogHeightStart: usize = 0x6E4; // float32
                pub const m_flFogHeightExponent: usize = 0x6E8; // float32
                pub const m_flLODBias: usize = 0x6EC; // float32
                pub const m_bActive: usize = 0x6F0; // bool
                pub const m_bStartDisabled: usize = 0x6F1; // bool
                pub const m_flFogMaxOpacity: usize = 0x6F4; // float32
                pub const m_nCubemapSourceType: usize = 0x6F8; // int32
            ...
            pub mod C_PlayerVisibility {
                pub const m_flVisibilityStrength: usize = 0x6CC; // float32
                pub const m_flFogDistanceMultiplier: usize = 0x6D0; // float32
                pub const m_flFogMaxDensityMultiplier: usize = 0x6D4; // float32
                pub const m_flFadeTime: usize = 0x6D8; // float32
                pub const m_bStartDisabled: usize = 0x6DC; // bool
                pub const m_bIsEnabled: usize = 0x6DD; // bool
            }
            // Parent: None
            // Fields count: 25
            //
            ...
            pub mod C_BaseFlex {
                ...
                pub const m_nNextSceneEventId: usize = 0xF28; // SceneEventId_t
            ...
            pub mod C_RagdollManager {
                pub const m_iCurrentMaxRagdollCount: usize = 0x6CC; // int8
            }
            // Parent: C_BaseModelEntity
            // Fields count: 12
            //
            ...
            pub mod C_DynamicProp {
                pub const m_bUseHitboxesForRenderBox: usize = 0xFE5; // bool
                pub const m_bUseAnimGraph: usize = 0xFE6; // bool
                pub const m_pOutputAnimBegun: usize = 0xFE8; // CEntityIOOutput
                pub const m_pOutputAnimOver: usize = 0x1010; // CEntityIOOutput
                pub const m_pOutputAnimLoopCycleOver: usize = 0x1038; // CEntityIOOutput
                pub const m_OnAnimReachedStart: usize = 0x1060; // CEntityIOOutput
                pub const m_OnAnimReachedEnd: usize = 0x1088; // CEntityIOOutput
                pub const m_iszIdleAnim: usize = 0x10B0; // CUtlSymbolLarge
                pub const m_nIdleAnimLoopMode: usize = 0x10B8; // AnimLoopMode_t
                pub const m_bRandomizeCycle: usize = 0x10BC; // bool
                pub const m_bStartDisabled: usize = 0x10BD; // bool
                pub const m_bFiredStartEndOutput: usize = 0x10BE; // bool
                pub const m_bForceNpcExclude: usize = 0x10BF; // bool
                pub const m_bCreateNonSolid: usize = 0x10C0; // bool
                pub const m_bIsOverrideProp: usize = 0x10C1; // bool
                pub const m_iInitialGlowState: usize = 0x10C4; // int32
                pub const m_nGlowRange: usize = 0x10C8; // int32
                pub const m_nGlowRangeMin: usize = 0x10CC; // int32
                pub const m_glowColor: usize = 0x10D0; // Color
                pub const m_nGlowTeam: usize = 0x10D4; // int32
                pub const m_iCachedFrameCount: usize = 0x10D8; // int32
                pub const m_vecCachedRenderMins: usize = 0x10DC; // Vector
                pub const m_vecCachedRenderMaxs: usize = 0x10E8; // Vector
            }
            // Parent: CEntityComponent
            // Fields count: 10
            ...
            pub mod CCitadelSoundOpvarSetOBB {
                pub const m_iszStackName: usize = 0x6E8; // CUtlSymbolLarge
                pub const m_iszOperatorName: usize = 0x6F0; // CUtlSymbolLarge
                pub const m_iszOpvarName: usize = 0x6F8; // CUtlSymbolLarge
                pub const m_vDistanceInnerMins: usize = 0x700; // Vector
                pub const m_vDistanceInnerMaxs: usize = 0x70C; // Vector
                pub const m_vDistanceOuterMins: usize = 0x718; // Vector
                pub const m_vDistanceOuterMaxs: usize = 0x724; // Vector
                pub const m_nAABBDirection: usize = 0x730; // int32
            }
            // Parent: None
            // Fields count: 5
            //
            ...
            pub mod C_LocalTempEntity {
                pub const flags: usize = 0xE78; // int32
                pub const die: usize = 0xE7C; // GameTime_t
                pub const m_flFrameMax: usize = 0xE80; // float32
                pub const x: usize = 0xE84; // float32
                pub const y: usize = 0xE88; // float32
                pub const fadeSpeed: usize = 0xE8C; // float32
                pub const bounceFactor: usize = 0xE90; // float32
                pub const hitSound: usize = 0xE94; // int32
                pub const priority: usize = 0xE98; // int32
                pub const tentOffset: usize = 0xE9C; // Vector
                pub const m_vecTempEntAngVelocity: usize = 0xEA8; // QAngle
                pub const tempent_renderamt: usize = 0xEB4; // int32
                pub const m_vecNormal: usize = 0xEB8; // Vector
                pub const m_flSpriteScale: usize = 0xEC4; // float32
                pub const m_nFlickerFrame: usize = 0xEC8; // int32
                pub const m_flFrameRate: usize = 0xECC; // float32
                pub const m_flFrame: usize = 0xED0; // float32
                pub const m_pszImpactEffect: usize = 0xED8; // char*
                pub const m_pszParticleEffect: usize = 0xEE0; // char*
                pub const m_bParticleCollision: usize = 0xEE8; // bool
                pub const m_iLastCollisionFrame: usize = 0xEEC; // int32
                pub const m_vLastCollisionOrigin: usize = 0xEF0; // Vector
                pub const m_vecTempEntVelocity: usize = 0xEFC; // Vector
                pub const m_vecPrevAbsOrigin: usize = 0xF08; // Vector
                pub const m_vecTempEntAcceleration: usize = 0xF14; // Vector
            }
            // Parent: None
            // Fields count: 2
            ...
            pub mod CInfoOffscreenPanoramaTexture {
                pub const m_bDisabled: usize = 0x6CC; // bool
                pub const m_nResolutionX: usize = 0x6D0; // int32
                pub const m_nResolutionY: usize = 0x6D4; // int32
                pub const m_szLayoutFileName: usize = 0x6D8; // CUtlSymbolLarge
                pub const m_RenderAttrName: usize = 0x6E0; // CUtlSymbolLarge
                pub const m_TargetEntities: usize = 0x6E8; // C_NetworkUtlVectorBase<CHandle<C_BaseModelEntity>>
                pub const m_nTargetChangeCount: usize = 0x700; // int32
                pub const m_vecCSSClasses: usize = 0x708; // C_NetworkUtlVectorBase<CUtlSymbolLarge>
                pub const m_bCheckCSSClasses: usize = 0x880; // bool
            }
            // Parent: C_BaseModelEntity
            // Fields count: 7
            //
            ...
            pub mod C_CSWeaponBase {
                ...
                pub const m_flLastBurstModeChangeTime: usize = 0x25DC; // GameTime_t
                pub const m_nPostponeFireReadyTicks: usize = 0x25E0; // GameTick_t
                pub const m_flPostponeFireReadyFrac: usize = 0x25E4; // float32
                pub const m_bInReload: usize = 0x25E8; // bool
                pub const m_bReloadVisuallyComplete: usize = 0x25E9; // bool
                pub const m_flDroppedAtTime: usize = 0x25EC; // GameTime_t
                pub const m_bIsHauledBack: usize = 0x25F0; // bool
                pub const m_bSilencerOn: usize = 0x25F1; // bool
                pub const m_flTimeSilencerSwitchComplete: usize = 0x25F4; // GameTime_t
                pub const m_iOriginalTeamNumber: usize = 0x25F8; // int32
                pub const m_iMostRecentTeamNumber: usize = 0x25FC; // int32
                pub const m_bDroppedNearBuyZone: usize = 0x2600; // bool
                pub const m_flNextAttackRenderTimeOffset: usize = 0x2604; // float32
                pub const m_bClearWeaponIdentifyingUGC: usize = 0x26A0; // bool
                pub const m_bVisualsDataSet: usize = 0x26A1; // bool
                pub const m_bOldFirstPersonSpectatedState: usize = 0x26A2; // bool
                pub const m_bUIWeapon: usize = 0x26A3; // bool
                pub const m_nCustomEconReloadEventId: usize = 0x26A4; // int32
                pub const m_hPrevOwner: usize = 0x26B0; // CHandle<C_CSPlayerPawn>
                pub const m_nDropTick: usize = 0x26B4; // GameTick_t
                pub const m_donated: usize = 0x26D4; // bool
                pub const m_fLastShotTime: usize = 0x26D8; // GameTime_t
                pub const m_bWasOwnedByCT: usize = 0x26DC; // bool
                pub const m_bWasOwnedByTerrorist: usize = 0x26DD; // bool
                pub const m_gunHeat: usize = 0x26E0; // float32
                pub const m_smokeAttachments: usize = 0x26E4; // uint32
                pub const m_lastSmokeTime: usize = 0x26E8; // GameTime_t
                pub const m_flNextClientFireBulletTime: usize = 0x26EC; // float32
                pub const m_flNextClientFireBulletTime_Repredict: usize = 0x26F0; // float32
                pub const m_IronSightController: usize = 0x27D0; // C_IronSightController
                pub const m_iIronSightMode: usize = 0x2880; // int32
                pub const m_flLastLOSTraceFailureTime: usize = 0x2890; // GameTime_t
                pub const m_iNumEmptyAttacks: usize = 0x2894; // int32
                pub const m_flLastMagDropRequestTime: usize = 0x2910; // GameTime_t
                pub const m_flWatTickOffset: usize = 0x2914; // float32
            }
            // Parent: C_BaseModelEntity
            // Fields count: 0
            ...
            pub mod C_EnvDetailController {
                pub const m_flFadeStartDist: usize = 0x6CC; // float32
                pub const m_flFadeEndDist: usize = 0x6D0; // float32
            }
            ...
            pub mod C_BaseEntity {
                ...
                pub const m_nLastThinkTick: usize = 0x478; // GameTick_t
                pub const m_pGameSceneNode: usize = 0x480; // CGameSceneNode*
                pub const m_pRenderComponent: usize = 0x488; // CRenderComponent*
                pub const m_pCollision: usize = 0x490; // CCollisionProperty*
                pub const m_iMaxHealth: usize = 0x498; // int32
                pub const m_iHealth: usize = 0x49C; // int32
                pub const m_lifeState: usize = 0x4A0; // uint8
                pub const m_bTakesDamage: usize = 0x4A1; // bool
                pub const m_nTakeDamageFlags: usize = 0x4A8; // TakeDamageFlags_t
                pub const m_bIsPlatform: usize = 0x4B0; // bool
                pub const m_ubInterpolationFrame: usize = 0x4B1; // uint8
                pub const m_hSceneObjectController: usize = 0x4B4; // CHandle<C_BaseEntity>
                pub const m_nNoInterpolationTick: usize = 0x4B8; // int32
                pub const m_nVisibilityNoInterpolationTick: usize = 0x4BC; // int32
                pub const m_flProxyRandomValue: usize = 0x4C0; // float32
                pub const m_iEFlags: usize = 0x4C4; // int32
                pub const m_nWaterType: usize = 0x4C8; // uint8
                pub const m_bInterpolateEvenWithNoModel: usize = 0x4C9; // bool
                pub const m_bPredictionEligible: usize = 0x4CA; // bool
                pub const m_bApplyLayerMatchIDToModel: usize = 0x4CB; // bool
                pub const m_tokLayerMatchID: usize = 0x4CC; // CUtlStringToken
                pub const m_nSubclassID: usize = 0x4D0; // CUtlStringToken
                pub const m_nSimulationTick: usize = 0x4E0; // int32
                pub const m_iCurrentThinkContext: usize = 0x4E4; // int32
                pub const m_aThinkFunctions: usize = 0x4E8; // CUtlVector<thinkfunc_t>
                pub const m_bDisabledContextThinks: usize = 0x500; // bool
                pub const m_flAnimTime: usize = 0x504; // float32
                pub const m_flSimulationTime: usize = 0x508; // float32
                pub const m_nSceneObjectOverrideFlags: usize = 0x50C; // uint8
                pub const m_bHasSuccessfullyInterpolated: usize = 0x50D; // bool
                pub const m_bHasAddedVarsToInterpolation: usize = 0x50E; // bool
                pub const m_bRenderEvenWhenNotSuccessfullyInterpolated: usize = 0x50F; // bool
                pub const m_nInterpolationLatchDirtyFlags: usize = 0x510; // int32[2]
                pub const m_ListEntry: usize = 0x518; // uint16[11]
                pub const m_flCreateTime: usize = 0x530; // GameTime_t
                pub const m_flSpeed: usize = 0x534; // float32
                pub const m_EntClientFlags: usize = 0x538; // uint16
                pub const m_bClientSideRagdoll: usize = 0x53A; // bool
                pub const m_iTeamNum: usize = 0x53B; // uint8
                pub const m_spawnflags: usize = 0x53C; // uint32
                pub const m_nNextThinkTick: usize = 0x540; // GameTick_t
                pub const m_fFlags: usize = 0x544; // uint32
                pub const m_vecAbsVelocity: usize = 0x548; // Vector
                pub const m_vecVelocity: usize = 0x558; // CNetworkVelocityVector
                pub const m_vecBaseVelocity: usize = 0x588; // Vector
                pub const m_hEffectEntity: usize = 0x594; // CHandle<C_BaseEntity>
                pub const m_hOwnerEntity: usize = 0x598; // CHandle<C_BaseEntity>
                pub const m_MoveCollide: usize = 0x59C; // MoveCollide_t
                pub const m_MoveType: usize = 0x59D; // MoveType_t
                pub const m_nActualMoveType: usize = 0x59E; // MoveType_t
                pub const m_flWaterLevel: usize = 0x5A0; // float32
                pub const m_fEffects: usize = 0x5A4; // uint32
                pub const m_hGroundEntity: usize = 0x5A8; // CHandle<C_BaseEntity>
                pub const m_nGroundBodyIndex: usize = 0x5AC; // int32
                pub const m_flFriction: usize = 0x5B0; // float32
                pub const m_flElasticity: usize = 0x5B4; // float32
                pub const m_flGravityScale: usize = 0x5B8; // float32
                pub const m_flTimeScale: usize = 0x5BC; // float32
                pub const m_bAnimatedEveryTick: usize = 0x5C0; // bool
                pub const m_flNavIgnoreUntilTime: usize = 0x5C4; // GameTime_t
                pub const m_hThink: usize = 0x5C8; // uint16
                ...
                pub const m_bAnimTimeChanged: usize = 0x6B1; // bool
                pub const m_bSimulationTimeChanged: usize = 0x6B2; // bool
                pub const m_sUniqueHammerID: usize = 0x6C0; // CUtlString
                pub const m_nBloodType: usize = 0x6C8; // BloodType
            }
            // Parent: None
            // Fields count: 11
            //
            ...
            pub mod C_PhysicsProp {
                pub const m_bAwake: usize = 0xFE5; // bool
            }
            // Parent: CBaseProp
            // Fields count: 26
            //
            ...
            pub mod C_BreakableProp {
                pub const m_CPropDataComponent: usize = 0xEB8; // CPropDataComponent
                pub const m_OnBreak: usize = 0xEF8; // CEntityIOOutput
                pub const m_OnHealthChanged: usize = 0xF20; // CEntityOutputTemplate<float32>
                pub const m_OnTakeDamage: usize = 0xF48; // CEntityIOOutput
                pub const m_impactEnergyScale: usize = 0xF70; // float32
                pub const m_iMinHealthDmg: usize = 0xF74; // int32
                pub const m_flPressureDelay: usize = 0xF78; // float32
                pub const m_flDefBurstScale: usize = 0xF7C; // float32
                pub const m_vDefBurstOffset: usize = 0xF80; // Vector
                pub const m_hBreaker: usize = 0xF8C; // CHandle<C_BaseEntity>
                pub const m_PerformanceMode: usize = 0xF90; // PerformanceMode_t
                pub const m_flPreventDamageBeforeTime: usize = 0xF94; // GameTime_t
                pub const m_bHasBreakPiecesOrCommands: usize = 0xF98; // bool
                pub const m_explodeDamage: usize = 0xF9C; // float32
                pub const m_explodeRadius: usize = 0xFA0; // float32
                pub const m_explosionDelay: usize = 0xFA8; // float32
                pub const m_explosionBuildupSound: usize = 0xFB0; // CUtlSymbolLarge
                pub const m_explosionCustomEffect: usize = 0xFB8; // CUtlSymbolLarge
                pub const m_explosionCustomSound: usize = 0xFC0; // CUtlSymbolLarge
                pub const m_explosionModifier: usize = 0xFC8; // CUtlSymbolLarge
                pub const m_hPhysicsAttacker: usize = 0xFD0; // CHandle<C_BasePlayerPawn>
                pub const m_flLastPhysicsInfluenceTime: usize = 0xFD4; // GameTime_t
                pub const m_flDefaultFadeScale: usize = 0xFD8; // float32
                pub const m_hLastAttacker: usize = 0xFDC; // CHandle<C_BaseEntity>
                pub const m_hFlareEnt: usize = 0xFE0; // CHandle<C_BaseEntity>
                pub const m_noGhostCollision: usize = 0xFE4; // bool
            }
            // Parent: C_BaseToggle
            // Fields count: 0
            //
            ...
            pub mod C_CSGO_TeamPreviewCharacterPosition {
                pub const m_nVariant: usize = 0x6CC; // int32
                pub const m_nRandom: usize = 0x6D0; // int32
                pub const m_nOrdinal: usize = 0x6D4; // int32
                pub const m_sWeaponName: usize = 0x6D8; // CUtlString
                pub const m_xuid: usize = 0x6E0; // uint64
                pub const m_agentItem: usize = 0x6E8; // C_EconItemView
                pub const m_glovesItem: usize = 0x1A38; // C_EconItemView
                pub const m_weaponItem: usize = 0x2D88; // C_EconItemView
            }
            // Parent: C_DynamicProp
            // Fields count: 0
            ...
            pub mod C_BasePropDoor {
                pub const m_eDoorState: usize = 0x1104; // DoorState_t
                pub const m_modelChanged: usize = 0x1108; // bool
                pub const m_bLocked: usize = 0x1109; // bool
                pub const m_closedPosition: usize = 0x110C; // Vector
                pub const m_closedAngles: usize = 0x1118; // QAngle
                pub const m_hMaster: usize = 0x1124; // CHandle<C_BasePropDoor>
                pub const m_vWhereToSetLightingOrigin: usize = 0x1128; // Vector
            }
            // Parent: C_CSGO_TeamSelectCharacterPosition
            // Fields count: 0
            ...
            pub mod C_PhysPropClientside {
                pub const m_flTouchDelta: usize = 0xFE8; // GameTime_t
                pub const m_fDeathTime: usize = 0xFEC; // GameTime_t
                pub const m_inertiaScale: usize = 0xFF0; // float32
                pub const m_vecDamagePosition: usize = 0xFF4; // Vector
                pub const m_vecDamageDirection: usize = 0x1000; // Vector
                pub const m_nDamageType: usize = 0x100C; // int32
            }
            // Parent: C_CSGO_TeamPreviewCamera
            // Fields count: 0
            ...
            pub mod C_SoundAreaEntityBase {
                pub const m_bDisabled: usize = 0x6CC; // bool
                pub const m_bWasEnabled: usize = 0x6D4; // bool
                pub const m_iszSoundAreaType: usize = 0x6D8; // CUtlSymbolLarge
                pub const m_vPos: usize = 0x6E0; // Vector
            }
            // Parent: C_BaseEntity
            // Fields count: 3
            //
            ...
            pub mod C_PhysMagnet {
                pub const m_aAttachedObjectsFromServer: usize = 0xE78; // CUtlVector<int32>
            ...
            pub mod C_EntityFlame {
                pub const m_hEntAttached: usize = 0x6CC; // CHandle<C_BaseEntity>
                pub const m_hOldAttached: usize = 0x6F0; // CHandle<C_BaseEntity>
                pub const m_bCheapEffect: usize = 0x6F4; // bool
            }
            // Parent: C_BaseGrenade
            // Fields count: 0
            ...
            // NetworkVarNames: m_flHDRColorScale (float32)
            pub mod C_Sprite {
                pub const m_hSpriteMaterial: usize = 0xC50; // CStrongHandle<InfoForResourceTypeIMaterial2>
                pub const m_hAttachedToEntity: usize = 0xC58; // CHandle<C_BaseEntity>
                pub const m_nAttachment: usize = 0xC5C; // AttachmentHandle_t
                pub const m_flSpriteFramerate: usize = 0xC60; // float32
                pub const m_flFrame: usize = 0xC64; // float32
                pub const m_flDieTime: usize = 0xC68; // GameTime_t
                pub const m_nBrightness: usize = 0xC78; // uint32
                pub const m_flBrightnessDuration: usize = 0xC7C; // float32
                pub const m_flSpriteScale: usize = 0xC80; // float32
                pub const m_flScaleDuration: usize = 0xC84; // float32
                pub const m_bWorldSpaceScale: usize = 0xC88; // bool
                pub const m_flGlowProxySize: usize = 0xC8C; // float32
                pub const m_flHDRColorScale: usize = 0xC90; // float32
                pub const m_flLastTime: usize = 0xC94; // GameTime_t
                pub const m_flMaxFrame: usize = 0xC98; // float32
                pub const m_flStartScale: usize = 0xC9C; // float32
                pub const m_flDestScale: usize = 0xCA0; // float32
                pub const m_flScaleTimeStart: usize = 0xCA4; // GameTime_t
                pub const m_nStartBrightness: usize = 0xCA8; // int32
                pub const m_nDestBrightness: usize = 0xCAC; // int32
                pub const m_flBrightnessTimeStart: usize = 0xCB0; // GameTime_t
                pub const m_hOldSpriteMaterial: usize = 0xCB8; // CWeakHandle<InfoForResourceTypeIMaterial2>
                pub const m_nSpriteWidth: usize = 0xD58; // int32
                pub const m_nSpriteHeight: usize = 0xD5C; // int32
            }
            // Parent: C_CSWeaponBaseGun
            // Fields count: 0
            ...
            // NetworkVarNames: m_AttributeManager (CAttributeContainer)
            pub mod C_Chicken {
                pub const m_hHolidayHatAddon: usize = 0x1100; // CHandle<CBaseAnimGraph>
                pub const m_jumpedThisFrame: usize = 0x1104; // bool
                pub const m_leader: usize = 0x1108; // CHandle<C_CSPlayerPawn>
                pub const m_AttributeManager: usize = 0x1110; // C_AttributeContainer
                pub const m_bAttributesInitialized: usize = 0x24C0; // bool
                pub const m_hWaterWakeParticles: usize = 0x24C4; // ParticleIndex_t
                pub const m_bIsPreviewModel: usize = 0x24C8; // bool
            }
            // Parent: None
            // Fields count: 4
            //
