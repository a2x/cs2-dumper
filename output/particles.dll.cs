...
namespace CS2Dumper.Schemas {
    ...
    public static class ParticlesDll {
        ...
        public static class C_OP_RenderDeferredLight {
            public const nint m_bUseAlphaTestWindow = 0x208; // bool
            public const nint m_bUseTexture = 0x209; // bool
            public const nint m_flRadiusScale = 0x20C; // float32
            public const nint m_flAlphaScale = 0x210; // float32
            public const nint m_nAlpha2Field = 0x214; // ParticleAttributeIndex_t
            public const nint m_vecColorScale = 0x218; // CParticleCollectionVecInput
            public const nint m_nColorBlendType = 0x870; // ParticleColorBlendType_t
            public const nint m_flLightDistance = 0x874; // float32
            public const nint m_flStartFalloff = 0x878; // float32
            public const nint m_flDistanceFalloff = 0x87C; // float32
            public const nint m_flSpotFoV = 0x880; // float32
            public const nint m_nAlphaTestPointField = 0x884; // ParticleAttributeIndex_t
            public const nint m_nAlphaTestRangeField = 0x888; // ParticleAttributeIndex_t
            public const nint m_nAlphaTestSharpnessField = 0x88C; // ParticleAttributeIndex_t
            public const nint m_hTexture = 0x890; // CStrongHandle<InfoForResourceTypeCTextureBase>
            public const nint m_nHSVShiftControlPoint = 0x898; // int32
        }
        ...
        public static class C_OP_RemapSpeedtoCP {
            ...
            public const nint m_bUseDeltaV = 0x1DC; // bool
        }
        // Parent: CParticleFunctionOperator
        // Fields count: 1
        //
        ...
        public static class C_OP_RenderRopes {
            public const nint m_bEnableFadingAndClamping = 0x2718; // bool
            public const nint m_flMinSize = 0x271C; // float32
            public const nint m_flMaxSize = 0x2720; // float32
            public const nint m_flStartFadeSize = 0x2724; // float32
            public const nint m_flEndFadeSize = 0x2728; // float32
            public const nint m_flStartFadeDot = 0x272C; // float32
            public const nint m_flEndFadeDot = 0x2730; // float32
            public const nint m_flRadiusTaper = 0x2734; // float32
            public const nint m_nMinTesselation = 0x2738; // int32
            public const nint m_nMaxTesselation = 0x273C; // int32
            public const nint m_flTessScale = 0x2740; // float32
            ...
            public const nint m_bClampV = 0x2B54; // bool
            public const nint m_nScaleCP1 = 0x2B58; // int32
            public const nint m_nScaleCP2 = 0x2B5C; // int32
            public const nint m_flScaleVSizeByControlPointDistance = 0x2B60; // float32
            public const nint m_flScaleVScrollByControlPointDistance = 0x2B64; // float32
            public const nint m_flScaleVOffsetByControlPointDistance = 0x2B68; // float32
            public const nint m_bUseScalarForTextureCoordinate = 0x2B6D; // bool
            public const nint m_nScalarFieldForTextureCoordinate = 0x2B70; // ParticleAttributeIndex_t
            public const nint m_flScalarAttributeTextureCoordScale = 0x2B74; // float32
            public const nint m_bReverseOrder = 0x2B78; // bool
            public const nint m_bClosedLoop = 0x2B79; // bool
            public const nint m_nOrientationType = 0x2B7C; // ParticleOrientationChoiceList_t
            public const nint m_nVectorFieldForOrientation = 0x2B80; // ParticleAttributeIndex_t
            public const nint m_bDrawAsOpaque = 0x2B84; // bool
            public const nint m_bGenerateNormals = 0x2B85; // bool
        }
        ...
        public static class C_OP_RenderSound {
            public const nint m_flDurationScale = 0x208; // float32
            public const nint m_flSndLvlScale = 0x20C; // float32
            public const nint m_flPitchScale = 0x210; // float32
            public const nint m_flVolumeScale = 0x214; // float32
            public const nint m_nSndLvlField = 0x218; // ParticleAttributeIndex_t
            public const nint m_nDurationField = 0x21C; // ParticleAttributeIndex_t
            public const nint m_nPitchField = 0x220; // ParticleAttributeIndex_t
            public const nint m_nVolumeField = 0x224; // ParticleAttributeIndex_t
            public const nint m_nChannel = 0x228; // int32
            public const nint m_nCPReference = 0x22C; // int32
            public const nint m_pszSoundName = 0x230; // char[256]
            public const nint m_bSuppressStopSoundEvent = 0x330; // bool
        }
        // Parent: None
        // Fields count: 19
        //
        ...
        public static class C_OP_ModelDampenMovement {
            ...
            public const nint m_fDrag = 0x898; // float32
        }
        ...
        public static class C_OP_TwistAroundAxis {
            public const nint m_fForceAmount = 0x1C8; // float32
            public const nint m_TwistAxis = 0x1CC; // Vector
            public const nint m_bLocalSpace = 0x1D8; // bool
        ...
        public static class C_OP_RemapExternalWindToCP {
            ...
            public const nint m_nCPOutput = 0x1C4; // int32
            public const nint m_vecScale = 0x1C8; // CParticleCollectionVecInput
            public const nint m_bSetMagnitude = 0x820; // bool
            public const nint m_nOutVectorField = 0x824; // int32
        }
        // Parent: CParticleFunctionRenderer
        // Fields count: 62
        //
        ...
        public static class CBaseRendererSource2 {
            ...
            public const nint m_nColorBlendType = 0xC70; // ParticleColorBlendType_t
            public const nint m_nShaderType = 0xC74; // SpriteCardShaderType_t
            public const nint m_strShaderOverride = 0xC78; // CUtlString
            ...
            public const nint m_flBumpStrength = 0xF30; // float32
            public const nint m_nCropTextureOverride = 0xF34; // ParticleSequenceCropOverride_t
            public const nint m_vecTexturesInput = 0xF38; // CUtlVector<TextureGroup_t>
            public const nint m_flAnimationRate = 0xF50; // float32
            public const nint m_nAnimationType = 0xF54; // AnimationType_t
            public const nint m_bAnimateInFPS = 0xF58; // bool
            ...
            public const nint m_nLightingControlPoint = 0x1368; // int32
            public const nint m_nSelfIllumPerParticle = 0x136C; // ParticleAttributeIndex_t
            public const nint m_nOutputBlendMode = 0x1370; // ParticleOutputBlendMode_t
            public const nint m_bGammaCorrectVertexColors = 0x1374; // bool
            public const nint m_bSaturateColorPreAlphaBlend = 0x1375; // bool
            ...
            public const nint m_nHSVShiftControlPoint = 0x1780; // int32
            public const nint m_nFogType = 0x1784; // ParticleFogType_t
            public const nint m_flFogAmount = 0x1788; // CParticleCollectionRendererFloatInput
            public const nint m_bTintByFOW = 0x18E0; // bool
            public const nint m_bTintByGlobalLight = 0x18E1; // bool
            public const nint m_nPerParticleAlphaReference = 0x18E4; // SpriteCardPerParticleScale_t
            public const nint m_nPerParticleAlphaRefWindow = 0x18E8; // SpriteCardPerParticleScale_t
            public const nint m_nAlphaReferenceType = 0x18EC; // ParticleAlphaReferenceType_t
            ...
            public const nint m_bRefract = 0x1CF8; // bool
            public const nint m_bRefractSolid = 0x1CF9; // bool
            public const nint m_flRefractAmount = 0x1D00; // CParticleCollectionRendererFloatInput
            public const nint m_nRefractBlurRadius = 0x1E58; // int32
            public const nint m_nRefractBlurType = 0x1E5C; // BlurFilterType_t
            public const nint m_bOnlyRenderInEffectsBloomPass = 0x1E60; // bool
            public const nint m_bOnlyRenderInEffectsWaterPass = 0x1E61; // bool
            public const nint m_bUseMixedResolutionRendering = 0x1E62; // bool
            public const nint m_bOnlyRenderInEffecsGameOverlay = 0x1E63; // bool
            public const nint m_stencilTestID = 0x1E64; // char[128]
            public const nint m_bStencilTestExclude = 0x1EE4; // bool
            public const nint m_stencilWriteID = 0x1EE5; // char[128]
            public const nint m_bWriteStencilOnDepthPass = 0x1F65; // bool
            public const nint m_bWriteStencilOnDepthFail = 0x1F66; // bool
            public const nint m_bReverseZBuffering = 0x1F67; // bool
            public const nint m_bDisableZBuffering = 0x1F68; // bool
            public const nint m_nFeatheringMode = 0x1F6C; // ParticleDepthFeatheringMode_t
            ...
            public const nint m_nSortMethod = 0x24D0; // ParticleSortingChoiceList_t
            public const nint m_bBlendFramesSeq0 = 0x24D4; // bool
            public const nint m_bMaxLuminanceBlendingSequence0 = 0x24D5; // bool
        }
        // Parent: CParticleFunctionOperator
        // Fields count: 0
        //
        ...
        public static class C_OP_RemapDotProductToCP {
            ...
            public const nint m_nOutputCP = 0x1C8; // int32
        ...
        public static class C_OP_SetControlPointPositionToTimeOfDayValue {
            public const nint m_nControlPointNumber = 0x1C0; // int32
            public const nint m_pszTimeOfDayParameter = 0x1C4; // char[128]
            public const nint m_vecDefaultValue = 0x244; // Vector
        }
        // Parent: CParticleFunctionOperator
        // Fields count: 6
        //
        ...
        public static class C_OP_RemapAverageHitboxSpeedtoCP {
            ...
            public const nint m_nOutControlPointNumber = 0x1C4; // int32
            public const nint m_nField = 0x1C8; // int32
            public const nint m_nHitboxDataType = 0x1CC; // ParticleHitboxDataSelection_t
            public const nint m_flInputMin = 0x1D0; // CParticleCollectionFloatInput
            public const nint m_flInputMax = 0x328; // CParticleCollectionFloatInput
            public const nint m_flOutputMin = 0x480; // CParticleCollectionFloatInput
            public const nint m_flOutputMax = 0x5D8; // CParticleCollectionFloatInput
            ...
            public const nint m_HitboxSetName = 0xD90; // char[128]
        }
        // Parent: CParticleFunctionInitializer
        // Fields count: 4
        //
        ...
        public static class C_OP_RepeatedTriggerChildGroup {
            ...
            public const nint m_flClusterRefireTime = 0x1C8; // CParticleCollectionFloatInput
            public const nint m_flClusterSize = 0x320; // CParticleCollectionFloatInput
            public const nint m_flClusterCooldown = 0x478; // CParticleCollectionFloatInput
            public const nint m_bLimitChildCount = 0x5D0; // bool
        }
        // Parent: CParticleFunctionRenderer
        // Fields count: 4
        //
        ...
        public static class C_OP_RenderTonemapController {
            public const nint m_flTonemapLevel = 0x208; // float32
            public const nint m_flTonemapWeight = 0x20C; // float32
            public const nint m_nTonemapLevelField = 0x210; // ParticleAttributeIndex_t
            public const nint m_nTonemapWeightField = 0x214; // ParticleAttributeIndex_t
        }
        // Parent: CParticleFunctionOperator
        // Fields count: 3
        //
        ...
        public static class C_OP_DistanceBetweenTransforms {
            ...
            public const nint m_flInputMin = 0x290; // CPerParticleFloatInput
            public const nint m_flInputMax = 0x3E8; // CPerParticleFloatInput
            public const nint m_flOutputMin = 0x540; // CPerParticleFloatInput
            public const nint m_flOutputMax = 0x698; // CPerParticleFloatInput
            public const nint m_flMaxTraceLength = 0x7F0; // float32
            public const nint m_flLOSScale = 0x7F4; // float32
            public const nint m_CollisionGroupName = 0x7F8; // char[128]
            public const nint m_nTraceSet = 0x878; // ParticleTraceSet_t
            public const nint m_bLOS = 0x87C; // bool
            public const nint m_nSetMethod = 0x880; // ParticleSetMethod_t
        }
        // Parent: CParticleFunctionOperator
        // Fields count: 1
        //
        ...
        public static class C_OP_BasicMovement {
            ...
            public const nint m_fDrag = 0x810; // CParticleCollectionFloatInput
            public const nint m_massControls = 0x968; // CParticleMassCalculationParameters
            public const nint m_nMaxConstraintPasses = 0xD78; // int32
            public const nint m_bUseNewCode = 0xD7C; // bool
        }
        // Parent: CParticleFunctionInitializer
        // Fields count: 6
        //
        ...
        public static class C_INIT_InitFromParentKilled {
            ...
            public const nint m_nEventType = 0x1C4; // EventTypeSelection_t
        }
        // Parent: CParticleFunctionRenderer
        // Fields count: 0
        //
        ...
        public static class C_OP_SetParentControlPointsToChildCP {
            public const nint m_nChildGroupID = 0x1C0; // int32
            public const nint m_nChildControlPoint = 0x1C4; // int32
        ...
        public static class C_OP_BoxConstraint {
            ...
            public const nint m_vecMax = 0x810; // CParticleCollectionVecInput
            public const nint m_nCP = 0xE68; // int32
            public const nint m_bLocalSpace = 0xE6C; // bool
            public const nint m_bAccountForRadius = 0xE6D; // bool
        }
        // Parent: CParticleFunctionInitializer
        // Fields count: 14
        //
        ...
        public static class C_OP_AttractToControlPoint {
            ...
            public const nint m_fForceAmount = 0x1D8; // CPerParticleFloatInput
            public const nint m_fFalloffPower = 0x330; // float32
            public const nint m_TransformInput = 0x338; // CParticleTransformInput
            public const nint m_fForceAmountMin = 0x3A0; // CPerParticleFloatInput
            public const nint m_bApplyMinForce = 0x4F8; // bool
        }
        // Parent: CParticleFunctionInitializer
        // Fields count: 3
        //
        ...
        public static class C_OP_SetControlPointToVectorExpression {
            ...
            public const nint m_vInput2 = 0x820; // CParticleCollectionVecInput
            public const nint m_bNormalizedOutput = 0xE78; // bool
        }
        // Parent: CParticleFunctionPreEmission
        // Fields count: 15
        //
        ...
        public static class C_OP_LightningSnapshotGenerator {
            public const nint m_nCPSnapshot = 0x1C0; // int32
            public const nint m_nCPStartPnt = 0x1C4; // int32
            public const nint m_nCPEndPnt = 0x1C8; // int32
            public const nint m_flSegments = 0x1D0; // CParticleCollectionFloatInput
            public const nint m_flOffset = 0x328; // CParticleCollectionFloatInput
            public const nint m_flOffsetDecay = 0x480; // CParticleCollectionFloatInput
            public const nint m_flRecalcRate = 0x5D8; // CParticleCollectionFloatInput
            public const nint m_flUVScale = 0x730; // CParticleCollectionFloatInput
            public const nint m_flUVOffset = 0x888; // CParticleCollectionFloatInput
            public const nint m_flSplitRate = 0x9E0; // CParticleCollectionFloatInput
            public const nint m_flBranchTwist = 0xB38; // CParticleCollectionFloatInput
            public const nint m_nBranchBehavior = 0xC90; // ParticleLightnintBranchBehavior_t
            public const nint m_flRadiusStart = 0xC98; // CParticleCollectionFloatInput
            public const nint m_flRadiusEnd = 0xDF0; // CParticleCollectionFloatInput
            public const nint m_flDedicatedPool = 0xF48; // CParticleCollectionFloatInput
        }
        ...
        public static class C_OP_SetControlPointFieldToScalarExpression {
            ...
            public const nint m_flInput1 = 0x1C8; // CParticleCollectionFloatInput
            public const nint m_flInput2 = 0x320; // CParticleCollectionFloatInput
            public const nint m_flOutputRemap = 0x478; // CParticleRemapFloatInput
            public const nint m_nOutputCP = 0x5D0; // int32
            public const nint m_nOutVectorField = 0x5D4; // int32
        }
        ...
        public static class C_OP_RemapTransformVisibilityToVector {
            ...
            public const nint m_flInputMin = 0x22C; // float32
            public const nint m_flInputMax = 0x230; // float32
            public const nint m_vecOutputMin = 0x234; // Vector
            public const nint m_vecOutputMax = 0x240; // Vector
        ...
        public static class C_OP_DirectionBetweenVecsToVec {
            ...
            public const nint m_vecPoint2 = 0x818; // CPerParticleVecInput
        }
        // Parent: CParticleFunctionOperator
        // Fields count: 4
        //
        ...
        public static class C_OP_MovementLoopInsideSphere {
            ...
            public const nint m_nDistSqrAttr = 0x970; // ParticleAttributeIndex_t
        }
        // Parent: CParticleFunctionRenderer
        // Fields count: 8
        //
        ...
        public static class C_OP_RenderSimpleModelCollection {
            public const nint m_bCenterOffset = 0x208; // bool
            public const nint m_hModel = 0x210; // CStrongHandle<InfoForResourceTypeCModel>
            public const nint m_modelInput = 0x218; // CParticleModelInput
            public const nint m_nLOD = 0x278; // int32
            public const nint m_bDisableShadows = 0x27C; // bool
            public const nint m_bDisableMotionBlur = 0x27D; // bool
            public const nint m_bAcceptsDecals = 0x27E; // bool
            public const nint m_nAngularVelocityField = 0x280; // ParticleAttributeIndex_t
        }
        // Parent: CParticleFunctionPreEmission
        // Fields count: 4
        //
        ...
        public static class C_OP_PlayEndCapWhenFinished {
            public const nint m_bFireOnEmissionEnd = 0x1C0; // bool
            public const nint m_bIncludeChildren = 0x1C1; // bool
        }
        // Parent: CParticleFunctionInitializer
        // Fields count: 2
        //
        ...
        public static class C_OP_ControlPointToRadialScreenSpace {
            ...
            public const nint m_nCPOutField = 0x1D4; // int32
            public const nint m_nCPSSPosOut = 0x1D8; // int32
        }
        ...
        public static class C_OP_RemapDistanceToLineSegmentToVector {
            ...
            public const nint m_vMinOutputValue = 0x1D4; // Vector
            public const nint m_vMaxOutputValue = 0x1E0; // Vector
        }
        // Parent: CParticleFunctionRenderer
        // Fields count: 8
        //
        ...
        public static class CBaseTrailRenderer {
            public const nint m_nOrientationType = 0x2718; // ParticleOrientationChoiceList_t
            public const nint m_nOrientationControlPoint = 0x271C; // int32
            public const nint m_flMinSize = 0x2720; // float32
            public const nint m_flMaxSize = 0x2724; // float32
            ...
            public const nint m_bClampV = 0x29D8; // bool
        }
        // Parent: CParticleFunctionInitializer
        // Fields count: 4
        //
        ...
        public static class C_OP_SetControlPointOrientation {
            public const nint m_bUseWorldLocation = 0x1C0; // bool
            public const nint m_bRandomize = 0x1C2; // bool
            public const nint m_bSetOnce = 0x1C3; // bool
            public const nint m_nCP = 0x1C4; // int32
            public const nint m_nHeadLocation = 0x1C8; // int32
            public const nint m_vecRotation = 0x1CC; // QAngle
            public const nint m_vecRotationB = 0x1D8; // QAngle
        ...
        public static class C_OP_PositionLock {
            public const nint m_TransformInput = 0x1B8; // CParticleTransformInput
            public const nint m_flStartTime_min = 0x220; // float32
            public const nint m_flStartTime_max = 0x224; // float32
            public const nint m_flStartTime_exp = 0x228; // float32
            public const nint m_flEndTime_min = 0x22C; // float32
            public const nint m_flEndTime_max = 0x230; // float32
            public const nint m_flEndTime_exp = 0x234; // float32
            public const nint m_flRange = 0x238; // float32
            public const nint m_flRangeBias = 0x240; // CParticleCollectionFloatInput
            public const nint m_flJumpThreshold = 0x398; // float32
            public const nint m_flPrevPosScale = 0x39C; // float32
            public const nint m_bLockRot = 0x3A0; // bool
            public const nint m_vecScale = 0x3A8; // CParticleCollectionVecInput
            public const nint m_nFieldOutput = 0xA00; // ParticleAttributeIndex_t
            public const nint m_nFieldOutputPrev = 0xA04; // ParticleAttributeIndex_t
        }
        // Parent: CParticleFunctionRenderer
        // Fields count: 4
        //
        ...
        public static class C_OP_RenderVRHapticEvent {
            public const nint m_nHand = 0x208; // ParticleVRHandChoiceList_t
            public const nint m_nOutputHandCP = 0x20C; // int32
            public const nint m_nOutputField = 0x210; // int32
            public const nint m_flAmplitude = 0x218; // CPerParticleFloatInput
        }
        // Parent: CParticleFunctionPreEmission
        // Fields count: 12
        //
        ...
        public static class C_OP_SetControlPointToImpactPoint {
            public const nint m_nCPOut = 0x1C0; // int32
            public const nint m_nCPIn = 0x1C4; // int32
            public const nint m_flUpdateRate = 0x1C8; // float32
            public const nint m_flTraceLength = 0x1D0; // CParticleCollectionFloatInput
            public const nint m_flStartOffset = 0x328; // float32
            public const nint m_flOffset = 0x32C; // float32
            public const nint m_vecTraceDir = 0x330; // Vector
            public const nint m_CollisionGroupName = 0x33C; // char[128]
            public const nint m_nTraceSet = 0x3BC; // ParticleTraceSet_t
            public const nint m_bSetToEndpoint = 0x3C0; // bool
            public const nint m_bTraceToClosestSurface = 0x3C1; // bool
            public const nint m_bIncludeWater = 0x3C2; // bool
        }
        // Parent: CParticleFunctionOperator
        // Fields count: 6
        //
        ...
        public static class C_OP_TurbulenceForce {
            public const nint m_flNoiseCoordScale0 = 0x1C8; // float32
            public const nint m_flNoiseCoordScale1 = 0x1CC; // float32
            public const nint m_flNoiseCoordScale2 = 0x1D0; // float32
            public const nint m_flNoiseCoordScale3 = 0x1D4; // float32
            public const nint m_vecNoiseAmount0 = 0x1D8; // Vector
            public const nint m_vecNoiseAmount1 = 0x1E4; // Vector
            public const nint m_vecNoiseAmount2 = 0x1F0; // Vector
            public const nint m_vecNoiseAmount3 = 0x1FC; // Vector
        }
        // Parent: CParticleFunctionOperator
        // Fields count: 9
        //
        ...
        public static class C_OP_SetControlPointToPlayer {
            public const nint m_nCP1 = 0x1C0; // int32
            public const nint m_vecCP1Pos = 0x1C4; // Vector
            public const nint m_bOrientToEyes = 0x1D0; // bool
        }
        // Parent: CParticleFunctionOperator
        // Fields count: 1
        //
        ...
        public static class C_OP_RenderGpuImplicit {
            public const nint m_bUsePerParticleRadius = 0x208; // bool
            public const nint m_nVertexCountKb = 0x20C; // uint32
            public const nint m_nIndexCountKb = 0x210; // uint32
            ...
            public const nint m_nScaleCP = 0x620; // int32
        ...
        public static class C_OP_SetRandomControlPointPosition {
            public const nint m_bUseWorldLocation = 0x1C0; // bool
            public const nint m_bOrient = 0x1C1; // bool
            public const nint m_nCP1 = 0x1C4; // int32
            public const nint m_nHeadLocation = 0x1C8; // int32
            public const nint m_flReRandomRate = 0x1D0; // CParticleCollectionFloatInput
            public const nint m_vecCPMinPos = 0x328; // Vector
            public const nint m_vecCPMaxPos = 0x334; // Vector
            public const nint m_flInterpolation = 0x340; // CParticleCollectionFloatInput
        }
        // Parent: CParticleFunctionOperator
        // Fields count: 8
        //
        ...
        public static class C_OP_RemapTransformVisibilityToScalar {
            ...
            public const nint m_flInputMin = 0x22C; // float32
            public const nint m_flInputMax = 0x230; // float32
            public const nint m_flOutputMin = 0x234; // float32
            public const nint m_flOutputMax = 0x238; // float32
        ...
        public static class C_OP_DragRelativeToPlane {
            ...
            public const nint m_nControlPointNumber = 0xAC8; // int32
        }
        // Parent: CParticleFunctionOperator
        // Fields count: 2
        //
        ...
        public static class C_OP_SetSingleControlPointPosition {
            public const nint m_bSetOnce = 0x1C0; // bool
            public const nint m_nCP1 = 0x1C4; // int32
            public const nint m_vecCP1Pos = 0x1C8; // CParticleCollectionVecInput
        ...
        public static class C_OP_RenderScreenVelocityRotate {
            public const nint m_flRotateRateDegrees = 0x208; // float32
            public const nint m_flForwardDegrees = 0x20C; // float32
        }
        // Parent: CParticleFunctionOperator
        // Fields count: 6
        //
        ...
        public static class C_OP_ChooseRandomChildrenInGroup {
            public const nint m_nChildGroupID = 0x1C0; // int32
            public const nint m_flNumberOfChildren = 0x1C8; // CParticleCollectionFloatInput
        }
        // Parent: CParticleFunctionOperator
        // Fields count: 33
        //
        ...
        public static class C_OP_VectorFieldSnapshot {
            ...
            public const nint m_flBoundaryDampening = 0x978; // float32
            public const nint m_bSetVelocity = 0x97C; // bool
            public const nint m_bLockToSurface = 0x97D; // bool
            public const nint m_flGridSpacing = 0x980; // float32
        }
        // Parent: CParticleFunctionOperator
        // Fields count: 11
        //
        ...
        public static class C_OP_CylindricalDistanceToTransform {
            ...
            public const nint m_nSetMethod = 0x7F0; // ParticleSetMethod_t
            public const nint m_bActiveRange = 0x7F4; // bool
            public const nint m_bAdditive = 0x7F5; // bool
            public const nint m_bCapsule = 0x7F6; // bool
        }
        // Parent: CParticleFunctionInitializer
        // Fields count: 13
        //
        ...
        public static class C_OP_SetVectorAttributeToVectorExpression {
            ...
            public const nint m_vInput2 = 0x818; // CPerParticleVecInput
            public const nint m_nOutputField = 0xE70; // ParticleAttributeIndex_t
            public const nint m_nSetMethod = 0xE74; // ParticleSetMethod_t
            public const nint m_bNormalizedOutput = 0xE78; // bool
        }
        // Parent: CParticleFunctionInitializer
        // Fields count: 6
        ...
        public static class C_OP_RemapTransformOrientationToYaw {
            ...
            public const nint m_flRotOffset = 0x224; // float32
            public const nint m_flSpinStrength = 0x228; // float32
        }
        // Parent: CParticleFunctionRenderer
        // Fields count: 7
        //
        ...
        public static class C_OP_RandomForce {
            public const nint m_MinForce = 0x1C8; // Vector
            public const nint m_MaxForce = 0x1D4; // Vector
        }
        // Parent: CParticleFunctionOperator
        // Fields count: 7
        //
        ...
        public static class C_OP_RemapDistanceToLineSegmentToScalar {
            public const nint m_nFieldOutput = 0x1D0; // ParticleAttributeIndex_t
            public const nint m_flMinOutputValue = 0x1D4; // float32
            public const nint m_flMaxOutputValue = 0x1D8; // float32
        }
        ...
        public static class C_OP_DistanceBetweenCPsToCP {
            public const nint m_nStartCP = 0x1C0; // int32
            public const nint m_nEndCP = 0x1C4; // int32
            public const nint m_nOutputCP = 0x1C8; // int32
            public const nint m_nOutputCPField = 0x1CC; // int32
            ...
            public const nint m_flLOSScale = 0x1E8; // float32
            public const nint m_bLOS = 0x1EC; // bool
            public const nint m_CollisionGroupName = 0x1ED; // char[128]
            public const nint m_nTraceSet = 0x270; // ParticleTraceSet_t
            public const nint m_nSetParent = 0x274; // ParticleParentSetMode_t
        }
        // Parent: CParticleFunctionPreEmission
        // Fields count: 4
        //
        ...
        public static class C_OP_SetControlPointToHand {
            public const nint m_nCP1 = 0x1C0; // int32
            public const nint m_nHand = 0x1C4; // int32
            public const nint m_vecCP1Pos = 0x1C8; // Vector
            public const nint m_bOrientToHand = 0x1D4; // bool
        }
        // Parent: CParticleFunctionConstraint
        // Fields count: 8
        //
        ...
        public static class C_OP_RampCPLinearRandom {
            ...
            public const nint m_vecRateMin = 0x1C4; // Vector
            public const nint m_vecRateMax = 0x1D0; // Vector
        }
        // Parent: CParticleFunctionOperator
        // Fields count: 3
        //
        ...
        public static class C_OP_VelocityMatchingForce {
            ...
            public const nint m_nCPBroadcast = 0x1C0; // int32
        }
        // Parent: CParticleFunctionInitializer
        // Fields count: 3
        //
        ...
        public static class C_OP_RenderText {
            public const nint m_OutlineColor = 0x208; // Color
            public const nint m_DefaultText = 0x210; // CUtlString
        }
        // Parent: CParticleFunctionOperator
        // Fields count: 5
        //
        ...
        public static class C_OP_SetCPOrientationToPointAtCP {
            public const nint m_nInputCP = 0x1C0; // int32
            public const nint m_nOutputCP = 0x1C4; // int32
        ...
        public static class C_OP_RemapCrossProductOfTwoVectorsToVector {
            ...
            public const nint m_InputVec2 = 0x810; // CPerParticleVecInput
            public const nint m_nFieldOutput = 0xE68; // ParticleAttributeIndex_t
            public const nint m_bNormalize = 0xE6C; // bool
        }
        // Parent: CParticleFunctionOperator
        // Fields count: 4
        //
        ...
        public static class C_OP_SetControlPointPositionToRandomActiveCP {
            public const nint m_nCP1 = 0x1C0; // int32
            public const nint m_nHeadLocationMin = 0x1C4; // int32
            public const nint m_nHeadLocationMax = 0x1C8; // int32
            public const nint m_flResetRate = 0x1D0; // CParticleCollectionFloatInput
        }
        // Parent: CParticleFunctionOperator
        // Fields count: 3
        //
        ...
        public static class C_OP_DistanceBetweenVecs {
            ...
            public const nint m_vecPoint1 = 0x1C0; // CPerParticleVecInput
            public const nint m_vecPoint2 = 0x818; // CPerParticleVecInput
            public const nint m_flInputMin = 0xE70; // CPerParticleFloatInput
            public const nint m_flInputMax = 0xFC8; // CPerParticleFloatInput
            public const nint m_flOutputMin = 0x1120; // CPerParticleFloatInput
            public const nint m_flOutputMax = 0x1278; // CPerParticleFloatInput
            public const nint m_nSetMethod = 0x13D0; // ParticleSetMethod_t
            public const nint m_bDeltaTime = 0x13D4; // bool
        }
        // Parent: CParticleFunctionOperator
        // Fields count: 3
        //
        ...
        public static class C_OP_LockToBone {
            ...
            public const nint m_flLifeTimeFadeStart = 0x280; // float32
            public const nint m_flLifeTimeFadeEnd = 0x284; // float32
            public const nint m_flJumpThreshold = 0x288; // float32
            public const nint m_flPrevPosScale = 0x28C; // float32
            public const nint m_HitboxSetName = 0x290; // char[128]
            public const nint m_bRigid = 0x310; // bool
            public const nint m_bUseBones = 0x311; // bool
            public const nint m_nFieldOutput = 0x314; // ParticleAttributeIndex_t
            public const nint m_nFieldOutputPrev = 0x318; // ParticleAttributeIndex_t
            public const nint m_nRotationSetType = 0x31C; // ParticleRotationLockType_t
            public const nint m_bRigidRotationLock = 0x320; // bool
            public const nint m_vecRotation = 0x328; // CPerParticleVecInput
            public const nint m_flRotLerp = 0x980; // CPerParticleFloatInput
        }
        // Parent: C_OP_RemapNamedModelElementOnceTimed
        // Fields count: 0
        //
        ...
        public static class C_OP_SetVec {
            ...
            public const nint m_nOutputField = 0x810; // ParticleAttributeIndex_t
            public const nint m_nSetMethod = 0x814; // ParticleSetMethod_t
            public const nint m_Lerp = 0x818; // CPerParticleFloatInput
            public const nint m_bNormalizedOutput = 0x970; // bool
        }
        // Parent: CParticleFunctionInitializer
        // Fields count: 5
        //
        ...
        public static class C_OP_RenderOmni2Light {
            ...
            public const nint m_flBrightnessLumens = 0x870; // CPerParticleFloatInput
            public const nint m_flBrightnessCandelas = 0x9C8; // CPerParticleFloatInput
            public const nint m_bCastShadows = 0xB20; // bool
            public const nint m_flLuminaireRadius = 0xB28; // CPerParticleFloatInput
            public const nint m_flSkirt = 0xC80; // CPerParticleFloatInput
            public const nint m_flRange = 0xDD8; // CPerParticleFloatInput
            public const nint m_flInnerConeAngle = 0xF30; // CPerParticleFloatInput
            public const nint m_flOuterConeAngle = 0x1088; // CPerParticleFloatInput
            public const nint m_hLightCookie = 0x11E0; // CStrongHandle<InfoForResourceTypeCTextureBase>
            public const nint m_bSphericalCookie = 0x11E8; // bool
        }
        // Parent: CParticleFunctionOperator
        // Fields count: 5
        //
        ...
        public static class C_INIT_SetHitboxToModel {
            ...
            public const nint m_bEvenDistribution = 0x1C8; // bool
        ...
        public static class C_OP_SetControlPointToHMD {
            public const nint m_nCP1 = 0x1C0; // int32
            public const nint m_vecCP1Pos = 0x1C4; // Vector
            public const nint m_bOrientToHMD = 0x1D0; // bool
        }
        // Parent: CParticleFunctionOperator
        // Fields count: 9
        //
        ...
        public static class C_OP_SetControlPointFieldFromVectorExpression {
            ...
            public const nint m_vecInput2 = 0x820; // CParticleCollectionVecInput
            public const nint m_flOutputRemap = 0xE78; // CParticleRemapFloatInput
            public const nint m_nOutputCP = 0xFD0; // int32
            public const nint m_nOutVectorField = 0xFD4; // int32
        }
        // Parent: CParticleFunctionOperator
        // Fields count: 10
        //
        ...
        public static class C_OP_RenderCables {
            ...
            public const nint m_nColorBlendType = 0xB10; // ParticleColorBlendType_t
            public const nint m_hMaterial = 0xB18; // CStrongHandle<InfoForResourceTypeIMaterial2>
            public const nint m_nTextureRepetitionMode = 0xB20; // TextureRepetitionMode_t
            public const nint m_flTextureRepeatsPerSegment = 0xB28; // CParticleCollectionFloatInput
            public const nint m_flTextureRepeatsCircumference = 0xC80; // CParticleCollectionFloatInput
            public const nint m_flColorMapOffsetV = 0xDD8; // CParticleCollectionFloatInput
            public const nint m_flColorMapOffsetU = 0xF30; // CParticleCollectionFloatInput
            public const nint m_flNormalMapOffsetV = 0x1088; // CParticleCollectionFloatInput
            public const nint m_flNormalMapOffsetU = 0x11E0; // CParticleCollectionFloatInput
            public const nint m_bDrawCableCaps = 0x1338; // bool
            public const nint m_flCapRoundness = 0x133C; // float32
            public const nint m_flCapOffsetAmount = 0x1340; // float32
            public const nint m_flTessScale = 0x1344; // float32
            public const nint m_nMinTesselation = 0x1348; // int32
            public const nint m_nMaxTesselation = 0x134C; // int32
            public const nint m_nRoundness = 0x1350; // int32
        ...
        public static class C_OP_SetControlPointToWaterSurface {
            public const nint m_nSourceCP = 0x1C0; // int32
            public const nint m_nDestCP = 0x1C4; // int32
            public const nint m_nFlowCP = 0x1C8; // int32
            public const nint m_nActiveCP = 0x1CC; // int32
            public const nint m_nActiveCPField = 0x1D0; // int32
            public const nint m_flRetestRate = 0x1D8; // CParticleCollectionFloatInput
            public const nint m_bAdaptiveThreshold = 0x330; // bool
        }
        // Parent: CParticleFunctionInitializer
        // Fields count: 6
        //
        ...
        public static class C_OP_ChladniWave {
            ...
            public const nint m_vecHarmonics = 0xD78; // CPerParticleVecInput
            public const nint m_nSetMethod = 0x13D0; // ParticleSetMethod_t
            public const nint m_nLocalSpaceControlPoint = 0x13D4; // int32
            public const nint m_b3D = 0x13D8; // bool
        }
        // Parent: CParticleFunctionOperator
        // Fields count: 7
        //
        ...
        public static class C_OP_DriveCPFromGlobalSoundFloat {
            ...
            public const nint m_nOutputField = 0x1C4; // int32
            public const nint m_flInputMin = 0x1C8; // float32
            public const nint m_flInputMax = 0x1CC; // float32
            public const nint m_flOutputMin = 0x1D0; // float32
            public const nint m_flOutputMax = 0x1D4; // float32
        ...
        public static class C_OP_PinParticleToCP {
            ...
            public const nint m_bOffsetLocal = 0x818; // bool
            public const nint m_nParticleSelection = 0x81C; // ParticleSelection_t
            public const nint m_nParticleNumber = 0x820; // CParticleCollectionFloatInput
            public const nint m_nPinBreakType = 0x978; // ParticlePinDistance_t
            public const nint m_flBreakDistance = 0x980; // CParticleCollectionFloatInput
            public const nint m_flBreakSpeed = 0xAD8; // CParticleCollectionFloatInput
            public const nint m_flAge = 0xC30; // CParticleCollectionFloatInput
            public const nint m_nBreakControlPointNumber = 0xD88; // int32
            public const nint m_nBreakControlPointNumber2 = 0xD8C; // int32
            public const nint m_flBreakValue = 0xD90; // CParticleCollectionFloatInput
            public const nint m_flInterpolation = 0xEE8; // CPerParticleFloatInput
        }
        // Parent: CParticleFunctionOperator
        // Fields count: 13
        //
        ...
        public static class C_OP_DensityForce {
            ...
            public const nint m_flForceScale = 0x1CC; // float32
            public const nint m_flTargetDensity = 0x1D0; // float32
        }
        // Parent: CParticleFunctionInitializer
        // Fields count: 10
        //
        ...
        public static class C_OP_SetControlPointPositions {
            public const nint m_bUseWorldLocation = 0x1C0; // bool
            public const nint m_bOrient = 0x1C1; // bool
            public const nint m_bSetOnce = 0x1C2; // bool
            public const nint m_nCP1 = 0x1C4; // int32
            public const nint m_nCP2 = 0x1C8; // int32
            public const nint m_nCP3 = 0x1CC; // int32
            public const nint m_nCP4 = 0x1D0; // int32
            public const nint m_vecCP1Pos = 0x1D4; // Vector
            public const nint m_vecCP2Pos = 0x1E0; // Vector
            public const nint m_vecCP3Pos = 0x1EC; // Vector
            public const nint m_vecCP4Pos = 0x1F8; // Vector
            public const nint m_nHeadLocation = 0x204; // int32
        }
        // Parent: CParticleFunctionOperator
        // Fields count: 6
        //
        ...
        public static class C_OP_SetFloatAttributeToVectorExpression {
            ...
            public const nint m_vInput1 = 0x1C0; // CPerParticleVecInput
            public const nint m_vInput2 = 0x818; // CPerParticleVecInput
            public const nint m_flOutputRemap = 0xE70; // CParticleRemapFloatInput
            public const nint m_nOutputField = 0xFC8; // ParticleAttributeIndex_t
            public const nint m_nSetMethod = 0xFCC; // ParticleSetMethod_t
        }
        // Parent: CParticleFunctionOperator
        // Fields count: 4
        //
        ...
        public static class C_OP_MovementRotateParticleAroundAxis {
            ...
            public const nint m_bLocalSpace = 0x9D0; // bool
        }
        // Parent: CParticleFunctionForce
        // Fields count: 8
        //
        ...
        public static class C_OP_IntraParticleForce {
            public const nint m_flAttractionMinDistance = 0x1C8; // float32
            public const nint m_flAttractionMaxDistance = 0x1CC; // float32
            public const nint m_flAttractionMaxStrength = 0x1D0; // float32
            public const nint m_flRepulsionMinDistance = 0x1D4; // float32
            public const nint m_flRepulsionMaxDistance = 0x1D8; // float32
            public const nint m_flRepulsionMaxStrength = 0x1DC; // float32
            public const nint m_bUseAABB = 0x1E0; // bool
            public const nint m_bThreadIt = 0x1E1; // bool
        }
        // Parent: CParticleFunctionInitializer
        // Fields count: 4
        //
        ...
        public static class C_INIT_CreateOnModel {
            ...
            public const nint m_bScaleToVolume = 0x28C; // bool
            public const nint m_bEvenDistribution = 0x28D; // bool
            public const nint m_nDesiredHitbox = 0x290; // CParticleCollectionFloatInput
            public const nint m_nHitboxValueFromControlPointIndex = 0x3E8; // int32
            public const nint m_vecHitBoxScale = 0x3F0; // CParticleCollectionVecInput
            public const nint m_flBoneVelocity = 0xA48; // float32
            public const nint m_flMaxBoneVelocity = 0xA4C; // float32
            public const nint m_vecDirectionBias = 0xA50; // CParticleCollectionVecInput
            public const nint m_HitboxSetName = 0x10A8; // char[128]
            public const nint m_bLocalCoords = 0x1128; // bool
            public const nint m_bUseBones = 0x1129; // bool
            public const nint m_bUseMesh = 0x112A; // bool
            public const nint m_flShellSize = 0x1130; // CParticleCollectionFloatInput
        }
        // Parent: CParticleFunctionOperator
        // Fields count: 4
        //
        ...
        public static class C_OP_PerParticleForce {
            ...
            public const nint m_nCP = 0x978; // int32
        }
        // Parent: C_INIT_RandomNamedModelElement
        // Fields count: 0
        //
        ...
        public static class C_OP_RenderProjected {
            public const nint m_bProjectCharacter = 0x208; // bool
            public const nint m_bProjectWorld = 0x209; // bool
            public const nint m_bProjectWater = 0x20A; // bool
            public const nint m_bFlipHorizontal = 0x20B; // bool
            public const nint m_bEnableProjectedDepthControls = 0x20C; // bool
            public const nint m_flMinProjectionDepth = 0x210; // float32
            public const nint m_flMaxProjectionDepth = 0x214; // float32
            public const nint m_vecProjectedMaterials = 0x218; // CUtlVector<RenderProjectedMaterial_t>
            public const nint m_flMaterialSelection = 0x230; // CPerParticleFloatInput
            public const nint m_flAnimationTimeScale = 0x388; // float32
            public const nint m_bOrientToNormal = 0x38C; // bool
            public const nint m_MaterialVars = 0x390; // CUtlVector<MaterialVariable_t>
            public const nint m_flRadiusScale = 0x3A8; // CParticleCollectionFloatInput
            public const nint m_flAlphaScale = 0x500; // CParticleCollectionFloatInput
            public const nint m_flRollScale = 0x658; // CParticleCollectionFloatInput
            public const nint m_nAlpha2Field = 0x7B0; // ParticleAttributeIndex_t
            public const nint m_vecColorScale = 0x7B8; // CParticleCollectionVecInput
            public const nint m_nColorBlendType = 0xE10; // ParticleColorBlendType_t
        }
        // Parent: CParticleFunctionOperator
        // Fields count: 4
        //
        ...
        public static class C_OP_ClampVector {
            ...
            public const nint m_vecOutputMax = 0x818; // CPerParticleVecInput
        }
        // Parent: CParticleFunctionRenderer
        // Fields count: 6
        //
        ...
        public static class C_OP_WindForce {
            public const nint m_vForce = 0x1C8; // Vector
        }
        // Parent: CParticleFunctionPreEmission
        // Fields count: 6
        //
        ...
        public static class C_OP_SetVariable {
            ...
            public const nint m_positionOffset = 0x268; // Vector
            public const nint m_rotationOffset = 0x274; // QAngle
            public const nint m_vecInput = 0x280; // CParticleCollectionVecInput
            public const nint m_floatInput = 0x8D8; // CParticleCollectionFloatInput
        }
        // Parent: CParticleFunctionRenderer
        // Fields count: 29
        //
        ...
        public static class C_OP_RenderStandardLight {
            public const nint m_nLightType = 0x208; // ParticleLightTypeChoiceList_t
            public const nint m_vecColorScale = 0x210; // CParticleCollectionVecInput
            public const nint m_nColorBlendType = 0x868; // ParticleColorBlendType_t
            public const nint m_flIntensity = 0x870; // CParticleCollectionFloatInput
            public const nint m_bCastShadows = 0x9C8; // bool
            public const nint m_flTheta = 0x9D0; // CParticleCollectionFloatInput
            public const nint m_flPhi = 0xB28; // CParticleCollectionFloatInput
            public const nint m_flRadiusMultiplier = 0xC80; // CParticleCollectionFloatInput
            public const nint m_nAttenuationStyle = 0xDD8; // StandardLightingAttenuationStyle_t
            public const nint m_flFalloffLinearity = 0xDE0; // CParticleCollectionFloatInput
            public const nint m_flFiftyPercentFalloff = 0xF38; // CParticleCollectionFloatInput
            public const nint m_flZeroPercentFalloff = 0x1090; // CParticleCollectionFloatInput
            public const nint m_bRenderDiffuse = 0x11E8; // bool
            public const nint m_bRenderSpecular = 0x11E9; // bool
            public const nint m_lightCookie = 0x11F0; // CUtlString
            public const nint m_nPriority = 0x11F8; // int32
            public const nint m_nFogLightingMode = 0x11FC; // ParticleLightFogLightingMode_t
            ...
            public const nint m_flCapsuleLength = 0x135C; // float32
            public const nint m_bReverseOrder = 0x1360; // bool
            public const nint m_bClosedLoop = 0x1361; // bool
            public const nint m_nPrevPntSource = 0x1364; // ParticleAttributeIndex_t
            public const nint m_flMaxLength = 0x1368; // float32
            public const nint m_flMinLength = 0x136C; // float32
            public const nint m_bIgnoreDT = 0x1370; // bool
            public const nint m_flConstrainRadiusToLengthRatio = 0x1374; // float32
            public const nint m_flLengthScale = 0x1378; // float32
            public const nint m_flLengthFadeInTime = 0x137C; // float32
        }
        // Parent: CParticleFunctionOperator
        // Fields count: 15
        //
        ...
        public static class C_OP_DistanceToTransform {
            ...
            public const nint m_flOutputMax = 0x5C8; // CPerParticleFloatInput
            public const nint m_TransformStart = 0x720; // CParticleTransformInput
            public const nint m_bLOS = 0x788; // bool
            public const nint m_CollisionGroupName = 0x789; // char[128]
            public const nint m_nTraceSet = 0x80C; // ParticleTraceSet_t
            public const nint m_flMaxTraceLength = 0x810; // float32
            public const nint m_flLOSScale = 0x814; // float32
            ...
            public const nint m_vecComponentScale = 0x820; // CPerParticleVecInput
        }
        // Parent: CParticleFunctionOperator
        // Fields count: 4
        //
        ...
        public static class C_OP_RemapAverageScalarValuetoCP {
            public const nint m_nOutControlPointNumber = 0x1C0; // int32
            public const nint m_nOutVectorField = 0x1C4; // int32
            public const nint m_nField = 0x1C8; // ParticleAttributeIndex_t
            public const nint m_flInputMin = 0x1CC; // float32
            public const nint m_flInputMax = 0x1D0; // float32
            public const nint m_flOutputMin = 0x1D4; // float32
        ...
        public static class C_OP_RemapCPtoCP {
            ...
            public const nint m_nInputField = 0x1C8; // int32
            public const nint m_nOutputField = 0x1CC; // int32
            public const nint m_flInputMin = 0x1D0; // float32
            public const nint m_flInputMax = 0x1D4; // float32
            public const nint m_flOutputMin = 0x1D8; // float32
            public const nint m_flOutputMax = 0x1DC; // float32
            public const nint m_bDerivative = 0x1E0; // bool
        ...
        public static class C_OP_SetControlPointRotation {
            ...
            public const nint m_nLocalCP = 0x974; // int32
        }
        // Parent: CParticleFunctionForce
        // Fields count: 7
        //
        ...
        public static class C_OP_CurlNoiseForce {
            public const nint m_nNoiseType = 0x1C8; // ParticleDirectionNoiseType_t
            public const nint m_vecNoiseFreq = 0x1D0; // CPerParticleVecInput
            public const nint m_vecNoiseScale = 0x828; // CPerParticleVecInput
            public const nint m_vecOffset = 0xE80; // CPerParticleVecInput
            public const nint m_vecOffsetRate = 0x14D8; // CPerParticleVecInput
            public const nint m_flWorleySeed = 0x1B30; // CPerParticleFloatInput
            public const nint m_flWorleyJitter = 0x1C88; // CPerParticleFloatInput
        }
        // Parent: CParticleFunctionInitializer
        // Fields count: 3
        //
        ...
        public static class C_OP_RenderScreenShake {
            public const nint m_flDurationScale = 0x208; // float32
            public const nint m_flRadiusScale = 0x20C; // float32
            public const nint m_flFrequencyScale = 0x210; // float32
            public const nint m_flAmplitudeScale = 0x214; // float32
            public const nint m_nRadiusField = 0x218; // ParticleAttributeIndex_t
            public const nint m_nDurationField = 0x21C; // ParticleAttributeIndex_t
            public const nint m_nFrequencyField = 0x220; // ParticleAttributeIndex_t
            public const nint m_nAmplitudeField = 0x224; // ParticleAttributeIndex_t
            public const nint m_nFilterCP = 0x228; // int32
        }
        // Parent: CParticleFunctionPreEmission
        // Fields count: 5
        //
        ...
        public static class C_OP_HSVShiftToCP {
            public const nint m_nColorCP = 0x1C0; // int32
            public const nint m_nColorGemEnableCP = 0x1C4; // int32
            public const nint m_nOutputCP = 0x1C8; // int32
            public const nint m_DefaultHSVColor = 0x1CC; // Color
        }
        // Parent: CParticleFunctionInitializer
        // Fields count: 6
        //
        ...
        public static class C_OP_SetControlPointFieldToWater {
            public const nint m_nSourceCP = 0x1C0; // int32
            public const nint m_nDestCP = 0x1C4; // int32
            public const nint m_nCPField = 0x1C8; // int32
        }
        // Parent: None
        // Fields count: 9
        //
        ...
        public static class C_OP_TimeVaryingForce {
            public const nint m_flStartLerpTime = 0x1C8; // float32
            public const nint m_StartingForce = 0x1CC; // Vector
            public const nint m_flEndLerpTime = 0x1D8; // float32
            public const nint m_EndingForce = 0x1DC; // Vector
        }
        // Parent: CParticleFunctionOperator
        // Fields count: 9
        //
        ...
        public static class C_OP_MoveToHitbox {
            public const nint m_modelInput = 0x1B8; // CParticleModelInput
            public const nint m_transformInput = 0x218; // CParticleTransformInput
            public const nint m_flLifeTimeLerpStart = 0x284; // float32
            public const nint m_flLifeTimeLerpEnd = 0x288; // float32
            public const nint m_flPrevPosScale = 0x28C; // float32
            public const nint m_HitboxSetName = 0x290; // char[128]
            public const nint m_bUseBones = 0x310; // bool
            public const nint m_nLerpType = 0x314; // HitboxLerpType_t
            public const nint m_flInterpolation = 0x318; // CPerParticleFloatInput
        }
        // Parent: CParticleInput
        // Fields count: 46
        //
        ...
        public static class C_OP_RenderFlattenGrass {
            public const nint m_flFlattenStrength = 0x208; // float32
            public const nint m_nStrengthFieldOverride = 0x20C; // ParticleAttributeIndex_t
            public const nint m_flRadiusScale = 0x210; // float32
        }
        // Parent: CParticleFunctionRenderer
        // Fields count: 7
        //
        ...
        public static class C_OP_RenderLightBeam {
            ...
            public const nint m_flBrightnessLumensPerMeter = 0x868; // CParticleCollectionFloatInput
            public const nint m_bCastShadows = 0x9C0; // bool
            public const nint m_flSkirt = 0x9C8; // CParticleCollectionFloatInput
            public const nint m_flRange = 0xB20; // CParticleCollectionFloatInput
            public const nint m_flThickness = 0xC78; // CParticleCollectionFloatInput
        }
        // Parent: CParticleFunctionPreEmission
        // Fields count: 6
        //
        ...
        public static class C_OP_EnableChildrenFromParentParticleCount {
            public const nint m_nChildGroupID = 0x1C0; // int32
            public const nint m_nFirstChild = 0x1C4; // int32
        ...
        public static class CReplicationParameters {
            ...
            public const nint m_vMaxRandomDisplacement = 0x910; // CParticleCollectionVecInput
        ...
        public static class C_OP_ForceBasedOnDistanceToPlane {
            public const nint m_flMinDist = 0x1C8; // float32
            public const nint m_vecForceAtMinDist = 0x1CC; // Vector
            public const nint m_flMaxDist = 0x1D8; // float32
            public const nint m_vecForceAtMaxDist = 0x1DC; // Vector
            public const nint m_vecPlaneNormal = 0x1E8; // Vector
            public const nint m_nControlPointNumber = 0x1F4; // int32
            public const nint m_flExponent = 0x1F8; // float32
        }
        // Parent: CParticleFunctionOperator
        // Fields count: 8
        //
        ...
        public static class C_OP_RenderModels {
            public const nint m_bOnlyRenderInEffectsBloomPass = 0x208; // bool
            public const nint m_bOnlyRenderInEffectsWaterPass = 0x209; // bool
            public const nint m_bUseMixedResolutionRendering = 0x20A; // bool
            public const nint m_bOnlyRenderInEffecsGameOverlay = 0x20B; // bool
            public const nint m_ModelList = 0x210; // CUtlVector<ModelReference_t>
            public const nint m_nBodyGroupField = 0x228; // ParticleAttributeIndex_t
            public const nint m_nSubModelField = 0x22C; // ParticleAttributeIndex_t
            public const nint m_bIgnoreNormal = 0x230; // bool
            public const nint m_bOrientZ = 0x231; // bool
            public const nint m_bCenterOffset = 0x232; // bool
            public const nint m_vecLocalOffset = 0x238; // CPerParticleVecInput
            public const nint m_vecLocalRotation = 0x890; // CPerParticleVecInput
            public const nint m_bIgnoreRadius = 0xEE8; // bool
            public const nint m_nModelScaleCP = 0xEEC; // int32
            public const nint m_vecComponentScale = 0xEF0; // CPerParticleVecInput
            public const nint m_bLocalScale = 0x1548; // bool
            public const nint m_nSizeCullBloat = 0x154C; // int32
            public const nint m_bAnimated = 0x1550; // bool
            public const nint m_flAnimationRate = 0x1558; // CPerParticleFloatInput
            public const nint m_bScaleAnimationRate = 0x16B0; // bool
            public const nint m_bForceLoopingAnimation = 0x16B1; // bool
            public const nint m_bResetAnimOnStop = 0x16B2; // bool
            public const nint m_bManualAnimFrame = 0x16B3; // bool
            public const nint m_nAnimationScaleField = 0x16B4; // ParticleAttributeIndex_t
            public const nint m_nAnimationField = 0x16B8; // ParticleAttributeIndex_t
            public const nint m_nManualFrameField = 0x16BC; // ParticleAttributeIndex_t
            public const nint m_ActivityName = 0x16C0; // char[256]
            public const nint m_SequenceName = 0x17C0; // char[256]
            public const nint m_bEnableClothSimulation = 0x18C0; // bool
            public const nint m_ClothEffectName = 0x18C1; // char[64]
            public const nint m_hOverrideMaterial = 0x1908; // CStrongHandle<InfoForResourceTypeIMaterial2>
            public const nint m_bOverrideTranslucentMaterials = 0x1910; // bool
            public const nint m_nSkin = 0x1918; // CPerParticleFloatInput
            public const nint m_MaterialVars = 0x1A70; // CUtlVector<MaterialVariable_t>
            public const nint m_flManualModelSelection = 0x1A88; // CPerParticleFloatInput
            public const nint m_modelInput = 0x1BE0; // CParticleModelInput
            public const nint m_nLOD = 0x1C40; // int32
            public const nint m_EconSlotName = 0x1C44; // char[256]
            public const nint m_bOriginalModel = 0x1D44; // bool
            public const nint m_bSuppressTint = 0x1D45; // bool
            public const nint m_nSubModelFieldType = 0x1D48; // RenderModelSubModelFieldType_t
            public const nint m_bDisableShadows = 0x1D4C; // bool
            public const nint m_bDisableDepthPrepass = 0x1D4D; // bool
            public const nint m_bAcceptsDecals = 0x1D4E; // bool
            public const nint m_bForceDrawInterlevedWithSiblings = 0x1D4F; // bool
            public const nint m_bDoNotDrawInParticlePass = 0x1D50; // bool
            public const nint m_bAllowApproximateTransforms = 0x1D51; // bool
            public const nint m_szRenderAttribute = 0x1D52; // char[260]
            public const nint m_flRadiusScale = 0x1E58; // CParticleCollectionFloatInput
            public const nint m_flAlphaScale = 0x1FB0; // CParticleCollectionFloatInput
            public const nint m_flRollScale = 0x2108; // CParticleCollectionFloatInput
            public const nint m_nAlpha2Field = 0x2260; // ParticleAttributeIndex_t
            public const nint m_vecColorScale = 0x2268; // CParticleCollectionVecInput
            public const nint m_nColorBlendType = 0x28C0; // ParticleColorBlendType_t
        }
        // Parent: CParticleFunction
        // Fields count: 1
        //
        ...
        public static class C_OP_ForceControlPointStub {
            public const nint m_ControlPoint = 0x1C0; // int32
        }
        // Parent: CParticleFunctionOperator
        // Fields count: 7
        //
        ...
        public static class C_OP_RemapModelVolumetoCP {
            public const nint m_nBBoxType = 0x1C0; // BBoxVolumeType_t
            public const nint m_nInControlPointNumber = 0x1C4; // int32
            public const nint m_nOutControlPointNumber = 0x1C8; // int32
            public const nint m_nOutControlPointMaxNumber = 0x1CC; // int32
        ...
        public static class C_OP_ParentVortices {
            public const nint m_flForceScale = 0x1C8; // float32
            public const nint m_vecTwistAxis = 0x1CC; // Vector
            public const nint m_bFlipBasedOnYaw = 0x1D8; // bool
        }
        // Parent: CParticleFunctionPreEmission
        // Fields count: 6
        //
        ...
        public static class C_OP_SetControlPointToCPVelocity {
            public const nint m_nCPInput = 0x1C0; // int32
            public const nint m_nCPOutputVel = 0x1C4; // int32
            public const nint m_bNormalize = 0x1C8; // bool
            public const nint m_nCPOutputMag = 0x1CC; // int32
            public const nint m_nCPField = 0x1D0; // int32
            public const nint m_vecComparisonVelocity = 0x1D8; // CParticleCollectionVecInput
        }
        // Parent: CParticleFunctionRenderer
        // Fields count: 5
        //
        ...
        public static class C_OP_ClientPhysics {
            ...
            public const nint m_bKillParticles = 0x210; // bool
            public const nint m_bDeleteSim = 0x211; // bool
            public const nint m_nControlPoint = 0x214; // int32
            public const nint m_nColorBlendType = 0x218; // ParticleColorBlendType_t
        }
        // Parent: CGeneralSpin
        // Fields count: 0
        //
        ...
        public static class C_OP_ExternalWindForce {
            ...
            public const nint m_vecScale = 0x820; // CPerParticleVecInput
            public const nint m_bSampleWind = 0xE78; // bool
            public const nint m_bSampleWater = 0xE79; // bool
            public const nint m_bDampenNearWaterPlane = 0xE7A; // bool
            public const nint m_bSampleGravity = 0xE7B; // bool
            public const nint m_vecGravityForce = 0xE80; // CPerParticleVecInput
            public const nint m_bUseBasicMovementGravity = 0x14D8; // bool
            public const nint m_flLocalGravityScale = 0x14E0; // CPerParticleFloatInput
            public const nint m_flLocalBuoyancyScale = 0x1638; // CPerParticleFloatInput
            public const nint m_vecBuoyancyForce = 0x1790; // CPerParticleVecInput
        }
        // Parent: CParticleFunctionInitializer
        // Fields count: 5
        //
        ...
        public static class C_OP_RenderSprites {
            ...
            public const nint m_nOrientationType = 0x2870; // ParticleOrientationChoiceList_t
            public const nint m_nOrientationControlPoint = 0x2874; // int32
            public const nint m_bUseYawWithNormalAligned = 0x2878; // bool
            ...
            public const nint m_flStartFadeDot = 0x2F38; // float32
            public const nint m_flEndFadeDot = 0x2F3C; // float32
            public const nint m_bDistanceAlpha = 0x2F40; // bool
            public const nint m_bSoftEdges = 0x2F41; // bool
            public const nint m_flEdgeSoftnessStart = 0x2F44; // float32
            public const nint m_flEdgeSoftnessEnd = 0x2F48; // float32
            public const nint m_bOutline = 0x2F4C; // bool
            public const nint m_OutlineColor = 0x2F4D; // Color
            public const nint m_nOutlineAlpha = 0x2F54; // int32
            public const nint m_flOutlineStart0 = 0x2F58; // float32
            public const nint m_flOutlineStart1 = 0x2F5C; // float32
            public const nint m_flOutlineEnd0 = 0x2F60; // float32
            public const nint m_flOutlineEnd1 = 0x2F64; // float32
            public const nint m_nLightingMode = 0x2F68; // ParticleLightingQuality_t
            ...
            public const nint m_bParticleShadows = 0x3220; // bool
            public const nint m_flShadowDensity = 0x3224; // float32
            public const nint m_replicationParameters = 0x3228; // CReplicationParameters
        }
        // Parent: CParticleFunctionOperator
        // Fields count: 12
        //
        ...
        public static class C_OP_PercentageBetweenTransformLerpCPs {
            ...
            public const nint m_nOutputStartCP = 0x298; // int32
            public const nint m_nOutputStartField = 0x29C; // int32
            public const nint m_nOutputEndCP = 0x2A0; // int32
            public const nint m_nOutputEndField = 0x2A4; // int32
        ...
        public static class C_OP_RenderTreeShake {
            public const nint m_flPeakStrength = 0x208; // float32
            public const nint m_nPeakStrengthFieldOverride = 0x20C; // ParticleAttributeIndex_t
            public const nint m_flRadius = 0x210; // float32
            public const nint m_nRadiusFieldOverride = 0x214; // ParticleAttributeIndex_t
            public const nint m_flShakeDuration = 0x218; // float32
            public const nint m_flTransitionTime = 0x21C; // float32
            public const nint m_flTwistAmount = 0x220; // float32
            public const nint m_flRadialAmount = 0x224; // float32
            public const nint m_flControlPointOrientationAmount = 0x228; // float32
            public const nint m_nControlPointForLinearDirection = 0x22C; // int32
        }
        // Parent: CParticleFunctionConstraint
        // Fields count: 0
        //
        ...
        public static class C_OP_RenderMaterialProxy {
            public const nint m_nMaterialControlPoint = 0x208; // int32
            public const nint m_nProxyType = 0x20C; // MaterialProxyType_t
            ...
            public const nint m_flAlpha = 0x9E0; // CPerParticleFloatInput
            public const nint m_nColorBlendType = 0xB38; // ParticleColorBlendType_t
        }
        // Parent: None
        // Fields count: 2
        //
