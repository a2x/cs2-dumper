    ...
    namespace schemas {
        ...
        namespace libserver_so {
            ...
            namespace CTriggerSoundscape {
                constexpr std::ptrdiff_t m_hSoundscape = 0xBC4; // CHandle<CEnvSoundscapeTriggerable>
                constexpr std::ptrdiff_t m_SoundscapeName = 0xBC8; // CUtlSymbolLarge
                constexpr std::ptrdiff_t m_spectators = 0xBD0; // CUtlVector<CHandle<CBasePlayerPawn>>
            }
            ...
            namespace CDynamicProp {
                constexpr std::ptrdiff_t m_bCreateNavObstacle = 0xD90; // bool
                constexpr std::ptrdiff_t m_bUseHitboxesForRenderBox = 0xD91; // bool
                constexpr std::ptrdiff_t m_bUseAnimGraph = 0xD92; // bool
                constexpr std::ptrdiff_t m_pOutputAnimBegun = 0xD98; // CEntityIOOutput
                constexpr std::ptrdiff_t m_pOutputAnimOver = 0xDC0; // CEntityIOOutput
                constexpr std::ptrdiff_t m_pOutputAnimLoopCycleOver = 0xDE8; // CEntityIOOutput
                constexpr std::ptrdiff_t m_OnAnimReachedStart = 0xE10; // CEntityIOOutput
                constexpr std::ptrdiff_t m_OnAnimReachedEnd = 0xE38; // CEntityIOOutput
                constexpr std::ptrdiff_t m_iszIdleAnim = 0xE60; // CUtlSymbolLarge
                constexpr std::ptrdiff_t m_nIdleAnimLoopMode = 0xE68; // AnimLoopMode_t
                constexpr std::ptrdiff_t m_bRandomizeCycle = 0xE6C; // bool
                constexpr std::ptrdiff_t m_bStartDisabled = 0xE6D; // bool
                constexpr std::ptrdiff_t m_bFiredStartEndOutput = 0xE6E; // bool
                constexpr std::ptrdiff_t m_bForceNpcExclude = 0xE6F; // bool
                constexpr std::ptrdiff_t m_bCreateNonSolid = 0xE70; // bool
                constexpr std::ptrdiff_t m_bIsOverrideProp = 0xE71; // bool
                constexpr std::ptrdiff_t m_iInitialGlowState = 0xE74; // int32
                constexpr std::ptrdiff_t m_nGlowRange = 0xE78; // int32
                constexpr std::ptrdiff_t m_nGlowRangeMin = 0xE7C; // int32
                constexpr std::ptrdiff_t m_glowColor = 0xE80; // Color
                constexpr std::ptrdiff_t m_nGlowTeam = 0xE84; // int32
            }
            ...
            namespace CTriggerRemove {
                constexpr std::ptrdiff_t m_OnRemove = 0xBC8; // CEntityIOOutput
            }
            // Parent: CBaseFilter
            // Fields count: 1
            namespace CFilterName {
                constexpr std::ptrdiff_t m_iFilterName = 0x7F8; // CUtlSymbolLarge
            }
            // Parent: CPointEntity
            // Fields count: 2
            namespace CProjectedDecal {
                constexpr std::ptrdiff_t m_nTexture = 0x7A4; // int32
                constexpr std::ptrdiff_t m_flDistance = 0x7A8; // float32
            }
            ...
            namespace CTriggerMultiple {
                constexpr std::ptrdiff_t m_OnTrigger = 0xBC8; // CEntityIOOutput
            }
            ...
            namespace CTriggerPush {
                constexpr std::ptrdiff_t m_angPushEntitySpace = 0xBC4; // QAngle
                constexpr std::ptrdiff_t m_vecPushDirEntitySpace = 0xBD0; // Vector
                constexpr std::ptrdiff_t m_bTriggerOnStartTouch = 0xBDC; // bool
                constexpr std::ptrdiff_t m_bUsePathSimple = 0xBDD; // bool
                constexpr std::ptrdiff_t m_iszPathSimpleName = 0xBE0; // CUtlSymbolLarge
                constexpr std::ptrdiff_t m_PathSimple = 0xBE8; // CPathSimple*
                constexpr std::ptrdiff_t m_splinePushType = 0xBF0; // uint32
            }
            // Parent: CBaseFilter
            // Fields count: 3
            namespace FilterHealth {
                constexpr std::ptrdiff_t m_bAdrenalineActive = 0x7F8; // bool
                constexpr std::ptrdiff_t m_iHealthMin = 0x7FC; // int32
                constexpr std::ptrdiff_t m_iHealthMax = 0x800; // int32
            }
            ...
            namespace CTriggerProximity {
                constexpr std::ptrdiff_t m_hMeasureTarget = 0xBC4; // CHandle<CBaseEntity>
                constexpr std::ptrdiff_t m_iszMeasureTarget = 0xBC8; // CUtlSymbolLarge
                constexpr std::ptrdiff_t m_fRadius = 0xBD0; // float32
                constexpr std::ptrdiff_t m_nTouchers = 0xBD4; // int32
                constexpr std::ptrdiff_t m_NearestEntityDistance = 0xBD8; // CEntityOutputTemplate<float32>
            }
            // Parent: CFuncBrush
            // Fields count: 4
            //
            ...
            namespace CTriggerBrush {
                ...
                constexpr std::ptrdiff_t m_iInputFilter = 0xA70; // int32
                constexpr std::ptrdiff_t m_iDontMessageParent = 0xA74; // int32
            }
            // Parent: CBeam
            // Fields count: 19
            namespace CEnvBeam {
                constexpr std::ptrdiff_t m_active = 0xA98; // int32
                ...
                constexpr std::ptrdiff_t m_life = 0xAB8; // float32
                constexpr std::ptrdiff_t m_boltWidth = 0xABC; // float32
                constexpr std::ptrdiff_t m_noiseAmplitude = 0xAC0; // float32
                constexpr std::ptrdiff_t m_speed = 0xAC4; // int32
                constexpr std::ptrdiff_t m_restrike = 0xAC8; // float32
                constexpr std::ptrdiff_t m_iszSpriteName = 0xAD0; // CUtlSymbolLarge
                constexpr std::ptrdiff_t m_frameStart = 0xAD8; // int32
                constexpr std::ptrdiff_t m_vEndPointWorld = 0xADC; // Vector
                constexpr std::ptrdiff_t m_vEndPointRelative = 0xAE8; // Vector
                constexpr std::ptrdiff_t m_radius = 0xAF4; // float32
            ...
            namespace CTonemapTrigger {
                constexpr std::ptrdiff_t m_tonemapControllerName = 0xBC8; // CUtlSymbolLarge
                constexpr std::ptrdiff_t m_hTonemapController = 0xBD0; // CEntityHandle
            }
            // Parent: None
            // Fields count: 5
            //
            ...
            namespace CFogTrigger {
                constexpr std::ptrdiff_t m_fog = 0xBC8; // fogparams_t
            }
            ...
            namespace CLogicCollisionPair {
                ...
                constexpr std::ptrdiff_t m_supportMultipleEntitiesWithSameName = 0x7B8; // bool
                constexpr std::ptrdiff_t m_disabled = 0x7B9; // bool
                constexpr std::ptrdiff_t m_succeeded = 0x7BA; // bool
            }
            // Parent: None
            // Fields count: 0
            //
            ...
            namespace CPointTeleport {
                constexpr std::ptrdiff_t m_vSaveOrigin = 0x7A4; // Vector
                constexpr std::ptrdiff_t m_vSaveAngles = 0x7B0; // QAngle
                constexpr std::ptrdiff_t m_bTeleportParentedEntities = 0x7BC; // bool
                constexpr std::ptrdiff_t m_bTeleportUseCurrentAngle = 0x7BD; // bool
            }
            // Parent: CPointEntity
            // Fields count: 0
            ...
            namespace CTriggerBuoyancy {
                constexpr std::ptrdiff_t m_BuoyancyHelper = 0xBC8; // CBuoyancyHelper
                constexpr std::ptrdiff_t m_flFluidDensity = 0xBE8; // float32
            }
            // Parent: CPointEntity
            // Fields count: 5
            namespace CMoverPathNode {
                constexpr std::ptrdiff_t m_vInTangentLocal = 0x7A4; // Vector
                constexpr std::ptrdiff_t m_vOutTangentLocal = 0x7B0; // Vector
                constexpr std::ptrdiff_t m_szParentPathUniqueID = 0x7C0; // CUtlSymbolLarge
                constexpr std::ptrdiff_t m_OnPassThrough = 0x7C8; // CEntityIOOutput
                constexpr std::ptrdiff_t m_hMover = 0x7F0; // CHandle<CPathMover>
            }
            // Parent: CBtNode
            // Fields count: 12
            ...
            namespace CFogController {
                ...
                constexpr std::ptrdiff_t m_iChangedVariables = 0x814; // int32
            }
            ...
            namespace CDecoyProjectile {
                constexpr std::ptrdiff_t m_nDecoyShotTick = 0xD98; // int32
                constexpr std::ptrdiff_t m_shotsRemaining = 0xD9C; // int32
                constexpr std::ptrdiff_t m_fExpireTime = 0xDA0; // GameTime_t
                constexpr std::ptrdiff_t m_decoyWeaponDefIndex = 0xDB0; // uint16
            }
            // Parent: CBaseEntity
            // Fields count: 0
            ...
            namespace CPlayerPing {
                constexpr std::ptrdiff_t m_hPlayer = 0x7AC; // CHandle<CCSPlayerPawn>
                constexpr std::ptrdiff_t m_hPingedEntity = 0x7B0; // CHandle<CBaseEntity>
                constexpr std::ptrdiff_t m_iType = 0x7B4; // int32
                constexpr std::ptrdiff_t m_bUrgent = 0x7B8; // bool
                constexpr std::ptrdiff_t m_szPlaceName = 0x7B9; // char[18]
            }
            ...
            namespace CEnvFireSensor {
                ...
                constexpr std::ptrdiff_t m_bHeatAtLevel = 0x7A5; // bool
                constexpr std::ptrdiff_t m_radius = 0x7A8; // float32
                constexpr std::ptrdiff_t m_targetLevel = 0x7AC; // float32
                constexpr std::ptrdiff_t m_targetTime = 0x7B0; // float32
                constexpr std::ptrdiff_t m_levelTime = 0x7B4; // float32
                constexpr std::ptrdiff_t m_OnHeatLevelStart = 0x7B8; // CEntityIOOutput
                constexpr std::ptrdiff_t m_OnHeatLevelEnd = 0x7E0; // CEntityIOOutput
            }
            // Parent: CCSGO_WingmanIntroCharacterPosition
            // Fields count: 0
            ...
            namespace CEnvShake {
                ...
                constexpr std::ptrdiff_t m_Amplitude = 0x7B0; // float32
                constexpr std::ptrdiff_t m_Frequency = 0x7B4; // float32
                constexpr std::ptrdiff_t m_Duration = 0x7B8; // float32
                constexpr std::ptrdiff_t m_Radius = 0x7BC; // float32
                constexpr std::ptrdiff_t m_stopTime = 0x7C0; // GameTime_t
                constexpr std::ptrdiff_t m_nextShake = 0x7C4; // GameTime_t
                constexpr std::ptrdiff_t m_currentAmp = 0x7C8; // float32
            ...
            namespace CBaseMoveBehavior {
                constexpr std::ptrdiff_t m_iPositionInterpolator = 0x7F4; // int32
                constexpr std::ptrdiff_t m_iRotationInterpolator = 0x7F8; // int32
                constexpr std::ptrdiff_t m_flAnimStartTime = 0x7FC; // float32
                constexpr std::ptrdiff_t m_flAnimEndTime = 0x800; // float32
                constexpr std::ptrdiff_t m_flAverageSpeedAcrossFrame = 0x804; // float32
                ...
                constexpr std::ptrdiff_t m_flTimeIntoFrame = 0x828; // float32
                constexpr std::ptrdiff_t m_iDirection = 0x82C; // int32
            }
            // Parent: CBaseModelEntity
            // Fields count: 1
            ...
            // Fields count: 4
            namespace CEnvTilt {
                constexpr std::ptrdiff_t m_Duration = 0x7A4; // float32
                constexpr std::ptrdiff_t m_Radius = 0x7A8; // float32
                constexpr std::ptrdiff_t m_TiltTime = 0x7AC; // float32
                constexpr std::ptrdiff_t m_stopTime = 0x7B0; // GameTime_t
            }
            // Parent: CCSWeaponBase
            // Fields count: 14
            //
            ...
            namespace CLogicCase {
                ...
                constexpr std::ptrdiff_t m_nShuffleCases = 0x8A8; // int32
                constexpr std::ptrdiff_t m_nLastShuffleCase = 0x8AC; // int32
                constexpr std::ptrdiff_t m_uchShuffleCaseMap = 0x8B0; // uint8[32]
            ...
            namespace CSoundEventEntity {
                constexpr std::ptrdiff_t m_bStartOnSpawn = 0x7A4; // bool
                constexpr std::ptrdiff_t m_bToLocalPlayer = 0x7A5; // bool
                constexpr std::ptrdiff_t m_bStopOnNew = 0x7A6; // bool
                constexpr std::ptrdiff_t m_bSaveRestore = 0x7A7; // bool
                constexpr std::ptrdiff_t m_bSavedIsPlaying = 0x7A8; // bool
                constexpr std::ptrdiff_t m_flSavedElapsedTime = 0x7AC; // float32
                constexpr std::ptrdiff_t m_iszSourceEntityName = 0x7B0; // CUtlSymbolLarge
                constexpr std::ptrdiff_t m_iszAttachmentName = 0x7B8; // CUtlSymbolLarge
                constexpr std::ptrdiff_t m_onGUIDChanged = 0x7C0; // CEntityOutputTemplate<uint64>
                constexpr std::ptrdiff_t m_onSoundFinished = 0x7E8; // CEntityIOOutput
                constexpr std::ptrdiff_t m_iszSoundName = 0x838; // CUtlSymbolLarge
                constexpr std::ptrdiff_t m_hSource = 0x848; // CEntityHandle
                constexpr std::ptrdiff_t m_nEntityIndexSelection = 0x84C; // int32
            }
            ...
            namespace CWeaponBaseItem {
                constexpr std::ptrdiff_t m_SequenceCompleteTimer = 0x11A0; // CountdownTimer
                constexpr std::ptrdiff_t m_bRedraw = 0x11B8; // bool
            }
            // Parent: CPointEntity
            // Fields count: 0
            ...
            namespace CEnvVolumetricFogController {
                constexpr std::ptrdiff_t m_flScattering = 0x7A4; // float32
                constexpr std::ptrdiff_t m_flAnisotropy = 0x7A8; // float32
                constexpr std::ptrdiff_t m_flFadeSpeed = 0x7AC; // float32
                constexpr std::ptrdiff_t m_flDrawDistance = 0x7B0; // float32
                constexpr std::ptrdiff_t m_flFadeInStart = 0x7B4; // float32
                constexpr std::ptrdiff_t m_flFadeInEnd = 0x7B8; // float32
                constexpr std::ptrdiff_t m_flIndirectStrength = 0x7BC; // float32
                constexpr std::ptrdiff_t m_nIndirectTextureDimX = 0x7C0; // int32
                constexpr std::ptrdiff_t m_nIndirectTextureDimY = 0x7C4; // int32
                constexpr std::ptrdiff_t m_nIndirectTextureDimZ = 0x7C8; // int32
                constexpr std::ptrdiff_t m_vBoxMins = 0x7CC; // Vector
                constexpr std::ptrdiff_t m_vBoxMaxs = 0x7D8; // Vector
                constexpr std::ptrdiff_t m_bActive = 0x7E4; // bool
                constexpr std::ptrdiff_t m_flStartAnisoTime = 0x7E8; // GameTime_t
                constexpr std::ptrdiff_t m_flStartScatterTime = 0x7EC; // GameTime_t
                constexpr std::ptrdiff_t m_flStartDrawDistanceTime = 0x7F0; // GameTime_t
                constexpr std::ptrdiff_t m_flStartAnisotropy = 0x7F4; // float32
                constexpr std::ptrdiff_t m_flStartScattering = 0x7F8; // float32
                constexpr std::ptrdiff_t m_flStartDrawDistance = 0x7FC; // float32
                constexpr std::ptrdiff_t m_flDefaultAnisotropy = 0x800; // float32
                constexpr std::ptrdiff_t m_flDefaultScattering = 0x804; // float32
                constexpr std::ptrdiff_t m_flDefaultDrawDistance = 0x808; // float32
                constexpr std::ptrdiff_t m_bStartDisabled = 0x80C; // bool
                constexpr std::ptrdiff_t m_bEnableIndirect = 0x80D; // bool
                constexpr std::ptrdiff_t m_bIndirectUseLPVs = 0x80E; // bool
                constexpr std::ptrdiff_t m_bIsMaster = 0x80F; // bool
                constexpr std::ptrdiff_t m_hFogIndirectTexture = 0x810; // CStrongHandle<InfoForResourceTypeCTextureBase>
                constexpr std::ptrdiff_t m_nForceRefreshCount = 0x818; // int32
                constexpr std::ptrdiff_t m_fNoiseSpeed = 0x81C; // float32
                constexpr std::ptrdiff_t m_fNoiseStrength = 0x820; // float32
                constexpr std::ptrdiff_t m_vNoiseScale = 0x824; // Vector
                constexpr std::ptrdiff_t m_bFirstTime = 0x830; // bool
            }
            // Parent: CPlayer_MovementServices
            // Fields count: 14
            //
            ...
            namespace CPhysicsPropRespawnable {
                constexpr std::ptrdiff_t m_vOriginalSpawnOrigin = 0xEF0; // Vector
                constexpr std::ptrdiff_t m_vOriginalSpawnAngles = 0xEFC; // QAngle
                constexpr std::ptrdiff_t m_vOriginalMins = 0xF08; // Vector
                constexpr std::ptrdiff_t m_vOriginalMaxs = 0xF14; // Vector
                constexpr std::ptrdiff_t m_flRespawnDuration = 0xF20; // float32
            }
            ...
            namespace CPhysBallSocket {
                constexpr std::ptrdiff_t m_flJointFriction = 0x820; // float32
                constexpr std::ptrdiff_t m_bEnableSwingLimit = 0x824; // bool
                constexpr std::ptrdiff_t m_flSwingLimit = 0x828; // float32
                constexpr std::ptrdiff_t m_bEnableTwistLimit = 0x82C; // bool
                constexpr std::ptrdiff_t m_flMinTwistAngle = 0x830; // float32
                constexpr std::ptrdiff_t m_flMaxTwistAngle = 0x834; // float32
            }
            ...
            namespace CInfoPlayerStart {
                constexpr std::ptrdiff_t m_bDisabled = 0x7A4; // bool
            }
            ...
            namespace CRagdollPropAttached {
                constexpr std::ptrdiff_t m_boneIndexAttached = 0xD90; // uint32
                constexpr std::ptrdiff_t m_ragdollAttachedObjectIndex = 0xD94; // uint32
                constexpr std::ptrdiff_t m_attachmentPointBoneSpace = 0xD98; // Vector
                constexpr std::ptrdiff_t m_attachmentPointRagdollSpace = 0xDA4; // Vector
                constexpr std::ptrdiff_t m_bShouldDetach = 0xDB0; // bool
                constexpr std::ptrdiff_t m_bShouldDeleteAttachedActivationRecord = 0xDC0; // bool
            }
            // Parent: CItem
            // Fields count: 2
            //
            ...
            namespace CItemGeneric {
                ...
                constexpr std::ptrdiff_t m_flPickupRadiusSqr = 0xCD4; // float32
                constexpr std::ptrdiff_t m_flTriggerRadiusSqr = 0xCD8; // float32
                ...
                constexpr std::ptrdiff_t m_flPickupRadius = 0xE18; // float32
                constexpr std::ptrdiff_t m_flTriggerRadius = 0xE1C; // float32
            ...
            namespace CSkyboxReference {
                constexpr std::ptrdiff_t m_worldGroupId = 0x7A4; // WorldGroupId_t
                constexpr std::ptrdiff_t m_hSkyCamera = 0x7A8; // CHandle<CSkyCamera>
            }
            // Parent: CBasePropDoor
            // Fields count: 17
            namespace CPropDoorRotating {
                constexpr std::ptrdiff_t m_vecAxis = 0x1110; // Vector
                constexpr std::ptrdiff_t m_flDistance = 0x111C; // float32
                constexpr std::ptrdiff_t m_eSpawnPosition = 0x1120; // PropDoorRotatingSpawnPos_t
                constexpr std::ptrdiff_t m_eOpenDirection = 0x1124; // PropDoorRotatingOpenDirection_e
                constexpr std::ptrdiff_t m_eCurrentOpenDirection = 0x1128; // PropDoorRotatingOpenDirection_e
                constexpr std::ptrdiff_t m_flAjarAngle = 0x112C; // float32
                constexpr std::ptrdiff_t m_angRotationAjarDeprecated = 0x1130; // QAngle
                constexpr std::ptrdiff_t m_angRotationClosed = 0x113C; // QAngle
                constexpr std::ptrdiff_t m_angRotationOpenForward = 0x1148; // QAngle
                constexpr std::ptrdiff_t m_angRotationOpenBack = 0x1154; // QAngle
                constexpr std::ptrdiff_t m_angGoal = 0x1160; // QAngle
                constexpr std::ptrdiff_t m_vecForwardBoundsMin = 0x116C; // Vector
                constexpr std::ptrdiff_t m_vecForwardBoundsMax = 0x1178; // Vector
                constexpr std::ptrdiff_t m_vecBackBoundsMin = 0x1184; // Vector
                constexpr std::ptrdiff_t m_vecBackBoundsMax = 0x1190; // Vector
                constexpr std::ptrdiff_t m_bAjarDoorShouldntAlwaysOpen = 0x119C; // bool
                constexpr std::ptrdiff_t m_hEntityBlocker = 0x11A0; // CHandle<CEntityBlocker>
            }
            // Parent: CBaseModelEntity
            // Fields count: 21
            //
            ...
            namespace CEnvViewPunch {
                ...
                constexpr std::ptrdiff_t m_angViewPunch = 0x7A8; // QAngle
            }
            // Parent: CCSWeaponBaseGun
            // Fields count: 0
            namespace CDEagle {
            ...
            namespace CPathCorner {
                constexpr std::ptrdiff_t m_flWait = 0x7A4; // float32
            ...
            namespace CMultiSource {
                constexpr std::ptrdiff_t m_rgEntities = 0x7A4; // CHandle<CBaseEntity>[32]
                constexpr std::ptrdiff_t m_rgTriggered = 0x824; // int32[32]
                constexpr std::ptrdiff_t m_OnTrigger = 0x8A8; // CEntityIOOutput
                constexpr std::ptrdiff_t m_iTotal = 0x8D0; // int32
            ...
            namespace CEnvEntityMaker {
                constexpr std::ptrdiff_t m_vecEntityMins = 0x7A4; // Vector
                constexpr std::ptrdiff_t m_vecEntityMaxs = 0x7B0; // Vector
                constexpr std::ptrdiff_t m_hCurrentInstance = 0x7BC; // CHandle<CBaseEntity>
                constexpr std::ptrdiff_t m_hCurrentBlocker = 0x7C0; // CHandle<CBaseEntity>
                constexpr std::ptrdiff_t m_vecBlockerOrigin = 0x7C4; // Vector
                constexpr std::ptrdiff_t m_angPostSpawnDirection = 0x7D0; // QAngle
                constexpr std::ptrdiff_t m_flPostSpawnDirectionVariance = 0x7DC; // float32
                constexpr std::ptrdiff_t m_flPostSpawnSpeed = 0x7E0; // float32
                constexpr std::ptrdiff_t m_bPostSpawnUseAngles = 0x7E4; // bool
                constexpr std::ptrdiff_t m_iszTemplate = 0x7E8; // CUtlSymbolLarge
                constexpr std::ptrdiff_t m_pOutputOnSpawned = 0x7F0; // CEntityIOOutput
                constexpr std::ptrdiff_t m_pOutputOnFailedSpawn = 0x818; // CEntityIOOutput
            }
            // Parent: CBaseEntity
            // Fields count: 0
            ...
            namespace CLogicEventListener {
                ...
                constexpr std::ptrdiff_t m_nTeam = 0x7C4; // int32
            ...
            namespace CFilterMultiple {
                ...
                constexpr std::ptrdiff_t m_iFilterName = 0x800; // CUtlSymbolLarge[10]
                constexpr std::ptrdiff_t m_hFilter = 0x850; // CHandle<CBaseEntity>[10]
                constexpr std::ptrdiff_t m_nFilterCount = 0x878; // int32
            }
            // Parent: CPlayerPawnComponent
            // Fields count: 0
            ...
            namespace CPhysicsWire {
                constexpr std::ptrdiff_t m_nDensity = 0x7A4; // int32
            }
            // Parent: CPropDoorRotating
            // Fields count: 4
            namespace CPropDoorRotatingBreakable {
                constexpr std::ptrdiff_t m_bBreakable = 0x11A4; // bool
                constexpr std::ptrdiff_t m_isAbleToCloseAreaPortals = 0x11A5; // bool
                constexpr std::ptrdiff_t m_currentDamageState = 0x11A8; // int32
                constexpr std::ptrdiff_t m_damageStates = 0x11B0; // CUtlVector<CUtlSymbolLarge>
            }
            // Parent: None
            // Fields count: 0
            //
            ...
            namespace CFireSmoke {
                constexpr std::ptrdiff_t m_nFlameModelIndex = 0x7B4; // int32
                constexpr std::ptrdiff_t m_nFlameFromAboveModelIndex = 0x7B8; // int32
            }
            // Parent: CCSWeaponBase
            // Fields count: 0
            namespace CBumpMine {
            ...
            namespace CLightGlow {
                constexpr std::ptrdiff_t m_nHorizontalSize = 0x9F8; // uint32
                constexpr std::ptrdiff_t m_nVerticalSize = 0x9FC; // uint32
                constexpr std::ptrdiff_t m_nMinDist = 0xA00; // uint32
                constexpr std::ptrdiff_t m_nMaxDist = 0xA04; // uint32
                constexpr std::ptrdiff_t m_nOuterMaxDist = 0xA08; // uint32
                constexpr std::ptrdiff_t m_flGlowProxySize = 0xA0C; // float32
                constexpr std::ptrdiff_t m_flHDRColorScale = 0xA10; // float32
            }
            // Parent: None
            // Fields count: 13
            //
            ...
            namespace CBasePropDoor {
                constexpr std::ptrdiff_t m_flAutoReturnDelay = 0xE94; // float32
                constexpr std::ptrdiff_t m_hDoorList = 0xE98; // CUtlVector<CHandle<CBasePropDoor>>
                constexpr std::ptrdiff_t m_nHardwareType = 0xEB0; // int32
                constexpr std::ptrdiff_t m_bNeedsHardware = 0xEB4; // bool
                constexpr std::ptrdiff_t m_eDoorState = 0xEB8; // DoorState_t
                constexpr std::ptrdiff_t m_bLocked = 0xEBC; // bool
                constexpr std::ptrdiff_t m_closedPosition = 0xEC0; // Vector
                constexpr std::ptrdiff_t m_closedAngles = 0xECC; // QAngle
                constexpr std::ptrdiff_t m_hBlocker = 0xED8; // CHandle<CBaseEntity>
                constexpr std::ptrdiff_t m_bFirstBlocked = 0xEDC; // bool
                constexpr std::ptrdiff_t m_ls = 0xEE0; // locksound_t
                constexpr std::ptrdiff_t m_bForceClosed = 0xF00; // bool
                constexpr std::ptrdiff_t m_vecLatchWorldPosition = 0xF04; // Vector
                constexpr std::ptrdiff_t m_hActivator = 0xF10; // CHandle<CBaseEntity>
                constexpr std::ptrdiff_t m_SoundMoving = 0xF20; // CUtlSymbolLarge
                constexpr std::ptrdiff_t m_SoundOpen = 0xF28; // CUtlSymbolLarge
                constexpr std::ptrdiff_t m_SoundClose = 0xF30; // CUtlSymbolLarge
                constexpr std::ptrdiff_t m_SoundLock = 0xF38; // CUtlSymbolLarge
                constexpr std::ptrdiff_t m_SoundUnlock = 0xF40; // CUtlSymbolLarge
                constexpr std::ptrdiff_t m_SoundLatch = 0xF48; // CUtlSymbolLarge
                constexpr std::ptrdiff_t m_SoundPound = 0xF50; // CUtlSymbolLarge
                constexpr std::ptrdiff_t m_SoundJiggle = 0xF58; // CUtlSymbolLarge
                constexpr std::ptrdiff_t m_SoundLockedAnim = 0xF60; // CUtlSymbolLarge
                ...
                constexpr std::ptrdiff_t m_OnBlockedOpening = 0xFA8; // CEntityIOOutput
                constexpr std::ptrdiff_t m_OnUnblockedClosing = 0xFD0; // CEntityIOOutput
                constexpr std::ptrdiff_t m_OnUnblockedOpening = 0xFF8; // CEntityIOOutput
                constexpr std::ptrdiff_t m_OnFullyClosed = 0x1020; // CEntityIOOutput
                constexpr std::ptrdiff_t m_OnFullyOpen = 0x1048; // CEntityIOOutput
                constexpr std::ptrdiff_t m_OnClose = 0x1070; // CEntityIOOutput
                constexpr std::ptrdiff_t m_OnOpen = 0x1098; // CEntityIOOutput
                constexpr std::ptrdiff_t m_OnLockedUse = 0x10C0; // CEntityIOOutput
                constexpr std::ptrdiff_t m_OnAjarOpen = 0x10E8; // CEntityIOOutput
            }
            // Parent: CBaseEntity
            // Fields count: 3
            //
            ...
            namespace CRagdollManager {
                constexpr std::ptrdiff_t m_iCurrentMaxRagdollCount = 0x7A4; // int8
                constexpr std::ptrdiff_t m_iMaxRagdollCount = 0x7A8; // int32
                constexpr std::ptrdiff_t m_bSaveImportant = 0x7AC; // bool
            }
            // Parent: CBaseTrigger
            // Fields count: 12
            namespace CTriggerFan {
                constexpr std::ptrdiff_t m_vFanOrigin = 0xBC4; // Vector
                constexpr std::ptrdiff_t m_vFanEnd = 0xBD0; // Vector
                constexpr std::ptrdiff_t m_vNoise = 0xBDC; // Vector
                constexpr std::ptrdiff_t m_flForce = 0xBE8; // float32
                constexpr std::ptrdiff_t m_flRopeForceScale = 0xBEC; // float32
                constexpr std::ptrdiff_t m_flPlayerForce = 0xBF0; // float32
                constexpr std::ptrdiff_t m_flRampTime = 0xBF4; // float32
                constexpr std::ptrdiff_t m_bFalloff = 0xBF8; // bool
                constexpr std::ptrdiff_t m_bPushPlayer = 0xBF9; // bool
                constexpr std::ptrdiff_t m_bRampDown = 0xBFA; // bool
                constexpr std::ptrdiff_t m_bAddNoise = 0xBFB; // bool
            ...
            namespace CHandleTest {
                constexpr std::ptrdiff_t m_Handle = 0x7A4; // CHandle<CBaseEntity>
                constexpr std::ptrdiff_t m_bSendHandle = 0x7A8; // bool
            }
            // Parent: CBaseEntity
            // Fields count: 8
            ...
            namespace CNavSpaceInfo {
                constexpr std::ptrdiff_t m_bCreateFlightSpace = 0x7A4; // bool
            }
            // Parent: CLogicalEntity
            // Fields count: 3
            namespace CLogicAchievement {
                constexpr std::ptrdiff_t m_bDisabled = 0x7A4; // bool
                constexpr std::ptrdiff_t m_iszAchievementEventID = 0x7A8; // CUtlSymbolLarge
                constexpr std::ptrdiff_t m_OnFired = 0x7B0; // CEntityIOOutput
            }
            // Parent: CBaseEntity
            // Fields count: 1
            namespace CPathSimple {
                constexpr std::ptrdiff_t m_pathString = 0x7F8; // CUtlString
            }
            // Parent: CBtNode
            // Fields count: 1
            ...
            namespace CItem {
                ...
                constexpr std::ptrdiff_t m_OnPlayerPickup = 0xC20; // CEntityIOOutput
                constexpr std::ptrdiff_t m_bActivateWhenAtRest = 0xC48; // bool
                constexpr std::ptrdiff_t m_OnCacheInteraction = 0xC50; // CEntityIOOutput
            ...
            namespace CEnvDecal {
                ...
                constexpr std::ptrdiff_t m_flWidth = 0xA00; // float32
                constexpr std::ptrdiff_t m_flHeight = 0xA04; // float32
                constexpr std::ptrdiff_t m_flDepth = 0xA08; // float32
                constexpr std::ptrdiff_t m_nRenderOrder = 0xA0C; // uint32
                ...
                constexpr std::ptrdiff_t m_flDepthSortBias = 0xA14; // float32
            }
            // Parent: None
            // Fields count: 0
            //
            ...
            namespace CSoundOpvarSetPointBase {
                constexpr std::ptrdiff_t m_bDisabled = 0x7A4; // bool
                constexpr std::ptrdiff_t m_hSource = 0x7A8; // CEntityHandle
            ...
            namespace CMessageEntity {
                constexpr std::ptrdiff_t m_radius = 0x7A4; // int32
                constexpr std::ptrdiff_t m_messageText = 0x7A8; // CUtlSymbolLarge
                constexpr std::ptrdiff_t m_drawText = 0x7B0; // bool
                constexpr std::ptrdiff_t m_bDeveloperOnly = 0x7B1; // bool
                constexpr std::ptrdiff_t m_bEnabled = 0x7B2; // bool
            }
            ...
            namespace CBaseFire {
                constexpr std::ptrdiff_t m_flScale = 0x7A4; // float32
                constexpr std::ptrdiff_t m_flStartScale = 0x7A8; // float32
                constexpr std::ptrdiff_t m_flScaleTime = 0x7AC; // float32
                constexpr std::ptrdiff_t m_nFlags = 0x7B0; // uint32
            }
            // Parent: CCSWeaponBaseGun
            // Fields count: 0
            ...
            namespace CTriggerActiveWeaponDetect {
                constexpr std::ptrdiff_t m_OnTouchedActiveWeapon = 0xBC8; // CEntityIOOutput
                constexpr std::ptrdiff_t m_iszWeaponClassName = 0xBF0; // CUtlSymbolLarge
            }
            // Parent: CPointEntity
            // Fields count: 18
            namespace CEnvMicrophone {
                constexpr std::ptrdiff_t m_bDisabled = 0x7A4; // bool
                constexpr std::ptrdiff_t m_hMeasureTarget = 0x7A8; // CHandle<CBaseEntity>
                constexpr std::ptrdiff_t m_nSoundType = 0x7AC; // SoundTypes_t
                constexpr std::ptrdiff_t m_nSoundFlags = 0x7AE; // SoundFlags_t
                constexpr std::ptrdiff_t m_flSensitivity = 0x7B0; // float32
                constexpr std::ptrdiff_t m_flSmoothFactor = 0x7B4; // float32
                constexpr std::ptrdiff_t m_flMaxRange = 0x7B8; // float32
                ...
                constexpr std::ptrdiff_t m_iSpeakerDSPPreset = 0x7D0; // int32
                ...
                constexpr std::ptrdiff_t m_SoundLevel = 0x7E8; // CEntityOutputTemplate<float32>
                ...
                constexpr std::ptrdiff_t m_iLastRoutedFrame = 0x960; // int32
            }
            // Parent: CLogicalEntity
            // Fields count: 11
            ...
            namespace CBasePlayerController {
                constexpr std::ptrdiff_t m_nInButtonsWhichAreToggles = 0x7B0; // uint64
                constexpr std::ptrdiff_t m_nTickBase = 0x7B8; // uint32
                constexpr std::ptrdiff_t m_hPawn = 0x7E8; // CHandle<CBasePlayerPawn>
                constexpr std::ptrdiff_t m_bKnownTeamMismatch = 0x7EC; // bool
                constexpr std::ptrdiff_t m_nSplitScreenSlot = 0x7F0; // CSplitScreenSlot
                constexpr std::ptrdiff_t m_hSplitOwner = 0x7F4; // CHandle<CBasePlayerController>
                ...
                constexpr std::ptrdiff_t m_fLerpTime = 0x8A0; // float32
                ...
                constexpr std::ptrdiff_t m_iIgnoreGlobalChat = 0x9D0; // ChatIgnoreType_t
                constexpr std::ptrdiff_t m_flLastPlayerTalkTime = 0x9D4; // float32
                constexpr std::ptrdiff_t m_flLastEntitySteadyState = 0x9D8; // float32
                constexpr std::ptrdiff_t m_nAvailableEntitySteadyState = 0x9DC; // int32
                constexpr std::ptrdiff_t m_bHasAnySteadyStateEnts = 0x9E0; // bool
                constexpr std::ptrdiff_t m_steamID = 0x9F0; // uint64
                constexpr std::ptrdiff_t m_iDesiredFOV = 0x9F8; // uint32
            }
            // Parent: None
            // Fields count: 0
            //
            ...
            namespace CFuncTrackTrain {
                ...
                constexpr std::ptrdiff_t m_flNextMPSoundTime = 0xB40; // GameTime_t
            }
            ...
            namespace CGenericConstraint {
                constexpr std::ptrdiff_t m_nLinearMotionX = 0x828; // JointMotion_t
                constexpr std::ptrdiff_t m_nLinearMotionY = 0x82C; // JointMotion_t
                constexpr std::ptrdiff_t m_nLinearMotionZ = 0x830; // JointMotion_t
                constexpr std::ptrdiff_t m_flLinearFrequencyX = 0x834; // float32
                constexpr std::ptrdiff_t m_flLinearFrequencyY = 0x838; // float32
                constexpr std::ptrdiff_t m_flLinearFrequencyZ = 0x83C; // float32
                constexpr std::ptrdiff_t m_flLinearDampingRatioX = 0x840; // float32
                constexpr std::ptrdiff_t m_flLinearDampingRatioY = 0x844; // float32
                constexpr std::ptrdiff_t m_flLinearDampingRatioZ = 0x848; // float32
                constexpr std::ptrdiff_t m_flMaxLinearImpulseX = 0x84C; // float32
                constexpr std::ptrdiff_t m_flMaxLinearImpulseY = 0x850; // float32
                constexpr std::ptrdiff_t m_flMaxLinearImpulseZ = 0x854; // float32
                constexpr std::ptrdiff_t m_flBreakAfterTimeX = 0x858; // float32
                constexpr std::ptrdiff_t m_flBreakAfterTimeY = 0x85C; // float32
                constexpr std::ptrdiff_t m_flBreakAfterTimeZ = 0x860; // float32
                constexpr std::ptrdiff_t m_flBreakAfterTimeStartTimeX = 0x864; // GameTime_t
                constexpr std::ptrdiff_t m_flBreakAfterTimeStartTimeY = 0x868; // GameTime_t
                constexpr std::ptrdiff_t m_flBreakAfterTimeStartTimeZ = 0x86C; // GameTime_t
                constexpr std::ptrdiff_t m_flBreakAfterTimeThresholdX = 0x870; // float32
                constexpr std::ptrdiff_t m_flBreakAfterTimeThresholdY = 0x874; // float32
                constexpr std::ptrdiff_t m_flBreakAfterTimeThresholdZ = 0x878; // float32
                constexpr std::ptrdiff_t m_flNotifyForceX = 0x87C; // float32
                constexpr std::ptrdiff_t m_flNotifyForceY = 0x880; // float32
                constexpr std::ptrdiff_t m_flNotifyForceZ = 0x884; // float32
                constexpr std::ptrdiff_t m_flNotifyForceMinTimeX = 0x888; // float32
                constexpr std::ptrdiff_t m_flNotifyForceMinTimeY = 0x88C; // float32
                constexpr std::ptrdiff_t m_flNotifyForceMinTimeZ = 0x890; // float32
                constexpr std::ptrdiff_t m_flNotifyForceLastTimeX = 0x894; // GameTime_t
                constexpr std::ptrdiff_t m_flNotifyForceLastTimeY = 0x898; // GameTime_t
                constexpr std::ptrdiff_t m_flNotifyForceLastTimeZ = 0x89C; // GameTime_t
                constexpr std::ptrdiff_t m_bAxisNotifiedX = 0x8A0; // bool
                constexpr std::ptrdiff_t m_bAxisNotifiedY = 0x8A1; // bool
                constexpr std::ptrdiff_t m_bAxisNotifiedZ = 0x8A2; // bool
                constexpr std::ptrdiff_t m_nAngularMotionX = 0x8A4; // JointMotion_t
                constexpr std::ptrdiff_t m_nAngularMotionY = 0x8A8; // JointMotion_t
                constexpr std::ptrdiff_t m_nAngularMotionZ = 0x8AC; // JointMotion_t
                constexpr std::ptrdiff_t m_flAngularFrequencyX = 0x8B0; // float32
                constexpr std::ptrdiff_t m_flAngularFrequencyY = 0x8B4; // float32
                constexpr std::ptrdiff_t m_flAngularFrequencyZ = 0x8B8; // float32
                constexpr std::ptrdiff_t m_flAngularDampingRatioX = 0x8BC; // float32
                constexpr std::ptrdiff_t m_flAngularDampingRatioY = 0x8C0; // float32
                constexpr std::ptrdiff_t m_flAngularDampingRatioZ = 0x8C4; // float32
                constexpr std::ptrdiff_t m_flMaxAngularImpulseX = 0x8C8; // float32
                constexpr std::ptrdiff_t m_flMaxAngularImpulseY = 0x8CC; // float32
                constexpr std::ptrdiff_t m_flMaxAngularImpulseZ = 0x8D0; // float32
                constexpr std::ptrdiff_t m_NotifyForceReachedX = 0x8D8; // CEntityIOOutput
                constexpr std::ptrdiff_t m_NotifyForceReachedY = 0x900; // CEntityIOOutput
                constexpr std::ptrdiff_t m_NotifyForceReachedZ = 0x928; // CEntityIOOutput
            }
            // Parent: CBaseCSGrenade
            // Fields count: 0
            ...
            namespace CBaseAnimGraph {
                ...
                constexpr std::ptrdiff_t m_flMaxSlopeDistance = 0xA84; // float32
                ...
                constexpr std::ptrdiff_t m_nForceBone = 0xAA4; // int32
                constexpr std::ptrdiff_t m_pRagdollPose = 0xAB8; // PhysicsRagdollPose_t*
                constexpr std::ptrdiff_t m_bRagdollClientSide = 0xAC0; // bool
            }
            // Parent: CPhysForce
            // Fields count: 1
            ...
            namespace CRagdollProp {
                ...
                constexpr std::ptrdiff_t m_lastUpdateTickCount = 0xC6C; // uint32
                ...
                constexpr std::ptrdiff_t m_flFadeTime = 0xC88; // float32
                ...
                constexpr std::ptrdiff_t m_strOriginClassName = 0xCA0; // CUtlSymbolLarge
                constexpr std::ptrdiff_t m_strSourceClassName = 0xCA8; // CUtlSymbolLarge
                constexpr std::ptrdiff_t m_bHasBeenPhysgunned = 0xCB0; // bool
                constexpr std::ptrdiff_t m_bShouldTeleportPhysics = 0xCB1; // bool
                constexpr std::ptrdiff_t m_flBlendWeight = 0xCB4; // float32
                constexpr std::ptrdiff_t m_flDefaultFadeScale = 0xCB8; // float32
                constexpr std::ptrdiff_t m_ragdollMins = 0xCC0; // CUtlVector<Vector>
                constexpr std::ptrdiff_t m_ragdollMaxs = 0xCD8; // CUtlVector<Vector>
                constexpr std::ptrdiff_t m_bShouldDeleteActivationRecord = 0xCF0; // bool
                constexpr std::ptrdiff_t m_bValidatePoweredRagdollPose = 0xD50; // bool
            }
            // Parent: CBaseAnimGraph
            // Fields count: 0
            namespace CItemSoda {
            ...
            namespace CEnvDetailController {
                constexpr std::ptrdiff_t m_flFadeStartDist = 0x7A4; // float32
                constexpr std::ptrdiff_t m_flFadeEndDist = 0x7A8; // float32
            }
            // Parent: CTriggerOnce
            // Fields count: 14
            //
            ...
            namespace CTriggerLook {
                constexpr std::ptrdiff_t m_hLookTarget = 0xBF0; // CHandle<CBaseEntity>
                constexpr std::ptrdiff_t m_flFieldOfView = 0xBF4; // float32
                constexpr std::ptrdiff_t m_flLookTime = 0xBF8; // float32
                constexpr std::ptrdiff_t m_flLookTimeTotal = 0xBFC; // float32
                constexpr std::ptrdiff_t m_flLookTimeLast = 0xC00; // GameTime_t
                constexpr std::ptrdiff_t m_flTimeoutDuration = 0xC04; // float32
                constexpr std::ptrdiff_t m_bTimeoutFired = 0xC08; // bool
                constexpr std::ptrdiff_t m_bIsLooking = 0xC09; // bool
                constexpr std::ptrdiff_t m_b2DFOV = 0xC0A; // bool
                constexpr std::ptrdiff_t m_bUseVelocity = 0xC0B; // bool
                constexpr std::ptrdiff_t m_bTestOcclusion = 0xC0C; // bool
                constexpr std::ptrdiff_t m_OnTimeout = 0xC10; // CEntityIOOutput
                constexpr std::ptrdiff_t m_OnStartLook = 0xC38; // CEntityIOOutput
                constexpr std::ptrdiff_t m_OnEndLook = 0xC60; // CEntityIOOutput
            }
            // Parent: CPointEntity
            // Fields count: 0
            ...
            namespace CMathRemap {
                constexpr std::ptrdiff_t m_flInMin = 0x7A4; // float32
                constexpr std::ptrdiff_t m_flInMax = 0x7A8; // float32
                constexpr std::ptrdiff_t m_flOut1 = 0x7AC; // float32
                constexpr std::ptrdiff_t m_flOut2 = 0x7B0; // float32
                constexpr std::ptrdiff_t m_flOldInValue = 0x7B4; // float32
            ...
            namespace CFootstepControl {
                constexpr std::ptrdiff_t m_source = 0xBC8; // CUtlSymbolLarge
                constexpr std::ptrdiff_t m_destination = 0xBD0; // CUtlSymbolLarge
            }
            // Parent: CBaseModelEntity
            // Fields count: 2
            ...
            namespace CInstancedSceneEntity {
                constexpr std::ptrdiff_t m_hOwner = 0xD08; // CHandle<CBaseEntity>
                constexpr std::ptrdiff_t m_bHadOwner = 0xD0C; // bool
                constexpr std::ptrdiff_t m_flPostSpeakDelay = 0xD10; // float32
                constexpr std::ptrdiff_t m_flPreDelay = 0xD14; // float32
                constexpr std::ptrdiff_t m_bIsBackground = 0xD18; // bool
                constexpr std::ptrdiff_t m_bRemoveOnCompletion = 0xD19; // bool
                constexpr std::ptrdiff_t m_hTarget = 0xD1C; // CHandle<CBaseEntity>
            }
            // Parent: CPointEntity
            // Fields count: 1
            ...
            namespace CScriptItem {
                constexpr std::ptrdiff_t m_MoveTypeOverride = 0xCC8; // MoveType_t
            }
            ...
            namespace CAmbientGeneric {
                constexpr std::ptrdiff_t m_radius = 0x7A4; // float32
                constexpr std::ptrdiff_t m_flMaxRadius = 0x7A8; // float32
                constexpr std::ptrdiff_t m_iSoundLevel = 0x7AC; // soundlevel_t
                constexpr std::ptrdiff_t m_dpv = 0x7B0; // dynpitchvol_t
                constexpr std::ptrdiff_t m_fActive = 0x814; // bool
                constexpr std::ptrdiff_t m_fLooping = 0x815; // bool
                constexpr std::ptrdiff_t m_iszSound = 0x818; // CUtlSymbolLarge
                constexpr std::ptrdiff_t m_sSourceEntName = 0x820; // CUtlSymbolLarge
                constexpr std::ptrdiff_t m_hSoundSource = 0x828; // CHandle<CBaseEntity>
                constexpr std::ptrdiff_t m_nSoundSourceEntIndex = 0x82C; // CEntityIndex
            }
            // Parent: CBaseModelEntity
            // Fields count: 9
            //
            ...
            namespace CDynamicLight {
                constexpr std::ptrdiff_t m_ActualFlags = 0x9F8; // uint8
                constexpr std::ptrdiff_t m_Flags = 0x9F9; // uint8
                constexpr std::ptrdiff_t m_LightStyle = 0x9FA; // uint8
                constexpr std::ptrdiff_t m_On = 0x9FB; // bool
                constexpr std::ptrdiff_t m_Radius = 0x9FC; // float32
                constexpr std::ptrdiff_t m_Exponent = 0xA00; // int32
                constexpr std::ptrdiff_t m_InnerAngle = 0xA04; // float32
                constexpr std::ptrdiff_t m_OuterAngle = 0xA08; // float32
                constexpr std::ptrdiff_t m_SpotRadius = 0xA0C; // float32
            }
            // Parent: CCSWeaponBaseGun
            // Fields count: 0
            ...
            namespace CPhysicsProp {
                constexpr std::ptrdiff_t m_MotionEnabled = 0xD90; // CEntityIOOutput
                constexpr std::ptrdiff_t m_OnAwakened = 0xDB8; // CEntityIOOutput
                constexpr std::ptrdiff_t m_OnAwake = 0xDE0; // CEntityIOOutput
                constexpr std::ptrdiff_t m_OnAsleep = 0xE08; // CEntityIOOutput
                constexpr std::ptrdiff_t m_OnPlayerUse = 0xE30; // CEntityIOOutput
                constexpr std::ptrdiff_t m_OnOutOfWorld = 0xE58; // CEntityIOOutput
                constexpr std::ptrdiff_t m_OnPlayerPickup = 0xE80; // CEntityIOOutput
                constexpr std::ptrdiff_t m_bForceNavIgnore = 0xEA8; // bool
                constexpr std::ptrdiff_t m_bNoNavmeshBlocker = 0xEA9; // bool
                constexpr std::ptrdiff_t m_bForceNpcExclude = 0xEAA; // bool
                constexpr std::ptrdiff_t m_massScale = 0xEAC; // float32
                constexpr std::ptrdiff_t m_inertiaScale = 0xEB0; // float32
                constexpr std::ptrdiff_t m_buoyancyScale = 0xEB4; // float32
                constexpr std::ptrdiff_t m_damageType = 0xEB8; // int32
                constexpr std::ptrdiff_t m_damageToEnableMotion = 0xEBC; // int32
                constexpr std::ptrdiff_t m_flForceToEnableMotion = 0xEC0; // float32
                constexpr std::ptrdiff_t m_bThrownByPlayer = 0xEC4; // bool
                constexpr std::ptrdiff_t m_bDroppedByPlayer = 0xEC5; // bool
                constexpr std::ptrdiff_t m_bTouchedByPlayer = 0xEC6; // bool
                constexpr std::ptrdiff_t m_bFirstCollisionAfterLaunch = 0xEC7; // bool
                constexpr std::ptrdiff_t m_iExploitableByPlayer = 0xEC8; // int32
                constexpr std::ptrdiff_t m_bHasBeenAwakened = 0xECC; // bool
                constexpr std::ptrdiff_t m_bIsOverrideProp = 0xECD; // bool
                constexpr std::ptrdiff_t m_fNextCheckDisableMotionContactsTime = 0xED0; // GameTime_t
                constexpr std::ptrdiff_t m_iInitialGlowState = 0xED4; // int32
                constexpr std::ptrdiff_t m_nGlowRange = 0xED8; // int32
                constexpr std::ptrdiff_t m_nGlowRangeMin = 0xEDC; // int32
                constexpr std::ptrdiff_t m_glowColor = 0xEE0; // Color
                constexpr std::ptrdiff_t m_bShouldAutoConvertBackFromDebris = 0xEE4; // bool
                constexpr std::ptrdiff_t m_bMuteImpactEffects = 0xEE5; // bool
                constexpr std::ptrdiff_t m_bAcceptDamageFromHeldObjects = 0xEEC; // bool
                constexpr std::ptrdiff_t m_bEnableUseOutput = 0xEED; // bool
                constexpr std::ptrdiff_t m_bAwake = 0xEEE; // bool
            }
            // Parent: CFuncWall
            // Fields count: 0
            ...
            namespace CSensorGrenadeProjectile {
                ...
                constexpr std::ptrdiff_t m_fNextDetectPlayerSound = 0xD94; // GameTime_t
                constexpr std::ptrdiff_t m_hDisplayGrenade = 0xD98; // CHandle<CBaseEntity>
            }
            ...
            namespace CTriggerSndSosOpvar {
                constexpr std::ptrdiff_t m_hTouchingPlayers = 0xBC8; // CUtlVector<CHandle<CBaseEntity>>
                constexpr std::ptrdiff_t m_flPosition = 0xBE0; // Vector
                constexpr std::ptrdiff_t m_flCenterSize = 0xBEC; // float32
                constexpr std::ptrdiff_t m_flMinVal = 0xBF0; // float32
                constexpr std::ptrdiff_t m_flMaxVal = 0xBF4; // float32
                constexpr std::ptrdiff_t m_opvarName = 0xBF8; // CUtlSymbolLarge
                constexpr std::ptrdiff_t m_stackName = 0xC00; // CUtlSymbolLarge
                constexpr std::ptrdiff_t m_operatorName = 0xC08; // CUtlSymbolLarge
                constexpr std::ptrdiff_t m_bVolIs2D = 0xC10; // bool
                constexpr std::ptrdiff_t m_opvarNameChar = 0xC11; // char[256]
                constexpr std::ptrdiff_t m_stackNameChar = 0xD11; // char[256]
                constexpr std::ptrdiff_t m_operatorNameChar = 0xE11; // char[256]
                constexpr std::ptrdiff_t m_VecNormPos = 0xF14; // Vector
                constexpr std::ptrdiff_t m_flNormCenterSize = 0xF20; // float32
            }
            // Parent: CItem
            // Fields count: 0
            ...
            namespace CScriptedSequence {
                ...
                constexpr std::ptrdiff_t m_nMoveToGait = 0x7EC; // MovementGait_t
                constexpr std::ptrdiff_t m_bIsPlayingPreIdle = 0x7ED; // bool
                constexpr std::ptrdiff_t m_bIsPlayingEntry = 0x7EE; // bool
                constexpr std::ptrdiff_t m_bIsPlayingAction = 0x7EF; // bool
                constexpr std::ptrdiff_t m_bIsPlayingPostIdle = 0x7F0; // bool
                constexpr std::ptrdiff_t m_bDontRotateOther = 0x7F1; // bool
                constexpr std::ptrdiff_t m_bIsRepeatable = 0x7F2; // bool
                constexpr std::ptrdiff_t m_bShouldLeaveCorpse = 0x7F3; // bool
                constexpr std::ptrdiff_t m_bStartOnSpawn = 0x7F4; // bool
                constexpr std::ptrdiff_t m_bDisallowInterrupts = 0x7F5; // bool
                constexpr std::ptrdiff_t m_bCanOverrideNPCState = 0x7F6; // bool
                constexpr std::ptrdiff_t m_bDontTeleportAtEnd = 0x7F7; // bool
                constexpr std::ptrdiff_t m_bHighPriority = 0x7F8; // bool
                constexpr std::ptrdiff_t m_bHideDebugComplaints = 0x7F9; // bool
                constexpr std::ptrdiff_t m_bContinueOnDeath = 0x7FA; // bool
                constexpr std::ptrdiff_t m_bLoopPreIdleSequence = 0x7FB; // bool
                constexpr std::ptrdiff_t m_bLoopActionSequence = 0x7FC; // bool
                constexpr std::ptrdiff_t m_bLoopPostIdleSequence = 0x7FD; // bool
                constexpr std::ptrdiff_t m_bSynchPostIdles = 0x7FE; // bool
                constexpr std::ptrdiff_t m_bIgnoreLookAt = 0x7FF; // bool
                constexpr std::ptrdiff_t m_bIgnoreGravity = 0x800; // bool
                constexpr std::ptrdiff_t m_bDisableNPCCollisions = 0x801; // bool
                constexpr std::ptrdiff_t m_bKeepAnimgraphLockedPost = 0x802; // bool
                constexpr std::ptrdiff_t m_bDontAddModifiers = 0x803; // bool
                constexpr std::ptrdiff_t m_flRadius = 0x804; // float32
                constexpr std::ptrdiff_t m_flRepeat = 0x808; // float32
                constexpr std::ptrdiff_t m_flPlayAnimFadeInTime = 0x80C; // float32
                constexpr std::ptrdiff_t m_flMoveInterpTime = 0x810; // float32
                constexpr std::ptrdiff_t m_flAngRate = 0x814; // float32
                constexpr std::ptrdiff_t m_nNotReadySequenceCount = 0x818; // int32
                constexpr std::ptrdiff_t m_startTime = 0x81C; // GameTime_t
                constexpr std::ptrdiff_t m_bWaitForBeginSequence = 0x820; // bool
                constexpr std::ptrdiff_t m_saved_effects = 0x824; // int32
                constexpr std::ptrdiff_t m_savedFlags = 0x828; // int32
                constexpr std::ptrdiff_t m_savedCollisionGroup = 0x82C; // int32
                constexpr std::ptrdiff_t m_bInterruptable = 0x830; // bool
                constexpr std::ptrdiff_t m_sequenceStarted = 0x831; // bool
                constexpr std::ptrdiff_t m_bPositionRelativeToOtherEntity = 0x832; // bool
                constexpr std::ptrdiff_t m_hTargetEnt = 0x834; // CHandle<CBaseEntity>
                constexpr std::ptrdiff_t m_hNextCine = 0x838; // CHandle<CScriptedSequence>
                constexpr std::ptrdiff_t m_bThinking = 0x83C; // bool
                constexpr std::ptrdiff_t m_bInitiatedSelfDelete = 0x83D; // bool
                constexpr std::ptrdiff_t m_bIsTeleportingDueToMoveTo = 0x83E; // bool
                constexpr std::ptrdiff_t m_bAllowCustomInterruptConditions = 0x83F; // bool
                constexpr std::ptrdiff_t m_hForcedTarget = 0x840; // CHandle<CBaseAnimGraph>
                constexpr std::ptrdiff_t m_bDontCancelOtherSequences = 0x844; // bool
                constexpr std::ptrdiff_t m_bForceSynch = 0x845; // bool
                constexpr std::ptrdiff_t m_bPreventUpdateYawOnFinish = 0x846; // bool
                constexpr std::ptrdiff_t m_bEnsureOnNavmeshOnFinish = 0x847; // bool
                constexpr std::ptrdiff_t m_onDeathBehavior = 0x848; // ScriptedOnDeath_t
                constexpr std::ptrdiff_t m_ConflictResponse = 0x84C; // ScriptedConflictResponse_t
                ...
                constexpr std::ptrdiff_t m_iPlayerDeathBehavior = 0xAA4; // int32
            }
            // Parent: CCSWeaponBaseGun
            // Fields count: 0
            ...
            namespace CEnvProjectedTexture {
                ...
                constexpr std::ptrdiff_t m_flLightFOV = 0xA00; // float32
                ...
                constexpr std::ptrdiff_t m_flIntensity = 0xA14; // float32
                constexpr std::ptrdiff_t m_flLinearAttenuation = 0xA18; // float32
                constexpr std::ptrdiff_t m_flQuadraticAttenuation = 0xA1C; // float32
                constexpr std::ptrdiff_t m_bVolumetric = 0xA20; // bool
                constexpr std::ptrdiff_t m_flNoiseStrength = 0xA24; // float32
                constexpr std::ptrdiff_t m_flFlashlightTime = 0xA28; // float32
                constexpr std::ptrdiff_t m_nNumPlanes = 0xA2C; // uint32
                constexpr std::ptrdiff_t m_flPlaneOffset = 0xA30; // float32
                constexpr std::ptrdiff_t m_flVolumetricIntensity = 0xA34; // float32
                constexpr std::ptrdiff_t m_flColorTransitionTime = 0xA38; // float32
                constexpr std::ptrdiff_t m_flAmbient = 0xA3C; // float32
                constexpr std::ptrdiff_t m_SpotlightTextureName = 0xA40; // char[512]
                constexpr std::ptrdiff_t m_nSpotlightTextureFrame = 0xC40; // int32
                constexpr std::ptrdiff_t m_nShadowQuality = 0xC44; // uint32
                constexpr std::ptrdiff_t m_flNearZ = 0xC48; // float32
                constexpr std::ptrdiff_t m_flFarZ = 0xC4C; // float32
                constexpr std::ptrdiff_t m_flProjectionSize = 0xC50; // float32
                constexpr std::ptrdiff_t m_flRotation = 0xC54; // float32
            ...
            namespace CSplineConstraint {
                constexpr std::ptrdiff_t m_vAnchorOffsetRestore = 0x868; // Vector
            }
            // Parent: CPlayer_ViewModelServices
            // Fields count: 0
            ...
            namespace CLogicCompare {
                constexpr std::ptrdiff_t m_flInValue = 0x7A4; // float32
                constexpr std::ptrdiff_t m_flCompareValue = 0x7A8; // float32
                constexpr std::ptrdiff_t m_OnLessThan = 0x7B0; // CEntityOutputTemplate<float32>
                constexpr std::ptrdiff_t m_OnEqualTo = 0x7D8; // CEntityOutputTemplate<float32>
                constexpr std::ptrdiff_t m_OnNotEqualTo = 0x800; // CEntityOutputTemplate<float32>
                constexpr std::ptrdiff_t m_OnGreaterThan = 0x828; // CEntityOutputTemplate<float32>
            }
            // Parent: CPlayerPawnComponent
            // Fields count: 1
            //
            ...
            namespace CFuncTimescale {
                constexpr std::ptrdiff_t m_flDesiredTimescale = 0x7A4; // float32
                constexpr std::ptrdiff_t m_flAcceleration = 0x7A8; // float32
                constexpr std::ptrdiff_t m_flMinBlendRate = 0x7AC; // float32
                constexpr std::ptrdiff_t m_flBlendDeltaMultiplier = 0x7B0; // float32
                constexpr std::ptrdiff_t m_isStarted = 0x7B4; // bool
            }
            // Parent: CBtNode
            // Fields count: 14
            ...
            namespace CTonemapController2 {
                constexpr std::ptrdiff_t m_flAutoExposureMin = 0x7A4; // float32
                constexpr std::ptrdiff_t m_flAutoExposureMax = 0x7A8; // float32
                constexpr std::ptrdiff_t m_flTonemapPercentTarget = 0x7AC; // float32
                constexpr std::ptrdiff_t m_flTonemapPercentBrightPixels = 0x7B0; // float32
                constexpr std::ptrdiff_t m_flTonemapMinAvgLum = 0x7B4; // float32
                constexpr std::ptrdiff_t m_flExposureAdaptationSpeedUp = 0x7B8; // float32
                constexpr std::ptrdiff_t m_flExposureAdaptationSpeedDown = 0x7BC; // float32
                constexpr std::ptrdiff_t m_flTonemapEVSmoothingRange = 0x7C0; // float32
            }
            ...
            namespace CPointHurt {
                constexpr std::ptrdiff_t m_nDamage = 0x7A4; // int32
                constexpr std::ptrdiff_t m_bitsDamageType = 0x7A8; // int32
                constexpr std::ptrdiff_t m_flRadius = 0x7AC; // float32
                constexpr std::ptrdiff_t m_flDelay = 0x7B0; // float32
            ...
            namespace CPointValueRemapper {
                constexpr std::ptrdiff_t m_bDisabled = 0x7A4; // bool
                constexpr std::ptrdiff_t m_bUpdateOnClient = 0x7A5; // bool
                constexpr std::ptrdiff_t m_nInputType = 0x7A8; // ValueRemapperInputType_t
                ...
                constexpr std::ptrdiff_t m_flMaximumChangePerSecond = 0x7C8; // float32
                constexpr std::ptrdiff_t m_flDisengageDistance = 0x7CC; // float32
                constexpr std::ptrdiff_t m_flEngageDistance = 0x7D0; // float32
                ...
                constexpr std::ptrdiff_t m_flMomentumModifier = 0x820; // float32
                constexpr std::ptrdiff_t m_flSnapValue = 0x824; // float32
                constexpr std::ptrdiff_t m_flCurrentMomentum = 0x828; // float32
                constexpr std::ptrdiff_t m_nRatchetType = 0x82C; // ValueRemapperRatchetType_t
                constexpr std::ptrdiff_t m_flRatchetOffset = 0x830; // float32
                constexpr std::ptrdiff_t m_flInputOffset = 0x834; // float32
                constexpr std::ptrdiff_t m_bEngaged = 0x838; // bool
                constexpr std::ptrdiff_t m_bFirstUpdate = 0x839; // bool
                constexpr std::ptrdiff_t m_flPreviousValue = 0x83C; // float32
                ...
                constexpr std::ptrdiff_t m_flCustomOutputValue = 0x854; // float32
                ...
                constexpr std::ptrdiff_t m_Position = 0x888; // CEntityOutputTemplate<float32>
                constexpr std::ptrdiff_t m_PositionDelta = 0x8B0; // CEntityOutputTemplate<float32>
            ...
            namespace CLogicPlayerProxy {
                constexpr std::ptrdiff_t m_hPlayer = 0x7A4; // CHandle<CBaseEntity>
                constexpr std::ptrdiff_t m_PlayerHasAmmo = 0x7A8; // CEntityIOOutput
                constexpr std::ptrdiff_t m_PlayerHasNoAmmo = 0x7D0; // CEntityIOOutput
                constexpr std::ptrdiff_t m_PlayerDied = 0x7F8; // CEntityIOOutput
                constexpr std::ptrdiff_t m_RequestedPlayerHealth = 0x820; // CEntityOutputTemplate<int32>
            }
            // Parent: CPlayerPawnComponent
            // Fields count: 4
            //
            ...
            namespace CPhysImpact {
                constexpr std::ptrdiff_t m_damage = 0x7A4; // float32
                constexpr std::ptrdiff_t m_distance = 0x7A8; // float32
            ...
            namespace CEnvCombinedLightProbeVolume {
                ...
                constexpr std::ptrdiff_t m_Entity_flBrightness = 0x180C; // float32
                constexpr std::ptrdiff_t m_Entity_hCubemapTexture = 0x1810; // CStrongHandle<InfoForResourceTypeCTextureBase>
                constexpr std::ptrdiff_t m_Entity_bCustomCubemapTexture = 0x1818; // bool
                constexpr std::ptrdiff_t m_Entity_hLightProbeTexture = 0x1820; // CStrongHandle<InfoForResourceTypeCTextureBase>
                constexpr std::ptrdiff_t m_Entity_hLightProbeDirectLightIndicesTexture = 0x1828; // CStrongHandle<InfoForResourceTypeCTextureBase>
                constexpr std::ptrdiff_t m_Entity_hLightProbeDirectLightScalarsTexture = 0x1830; // CStrongHandle<InfoForResourceTypeCTextureBase>
                constexpr std::ptrdiff_t m_Entity_hLightProbeDirectLightShadowsTexture = 0x1838; // CStrongHandle<InfoForResourceTypeCTextureBase>
                constexpr std::ptrdiff_t m_Entity_vBoxMins = 0x1840; // Vector
                constexpr std::ptrdiff_t m_Entity_vBoxMaxs = 0x184C; // Vector
                constexpr std::ptrdiff_t m_Entity_bMoveable = 0x1858; // bool
                constexpr std::ptrdiff_t m_Entity_nHandshake = 0x185C; // int32
                constexpr std::ptrdiff_t m_Entity_nEnvCubeMapArrayIndex = 0x1860; // int32
                constexpr std::ptrdiff_t m_Entity_nPriority = 0x1864; // int32
                constexpr std::ptrdiff_t m_Entity_bStartDisabled = 0x1868; // bool
                constexpr std::ptrdiff_t m_Entity_flEdgeFadeDist = 0x186C; // float32
                constexpr std::ptrdiff_t m_Entity_vEdgeFadeDists = 0x1870; // Vector
                constexpr std::ptrdiff_t m_Entity_nLightProbeSizeX = 0x187C; // int32
                constexpr std::ptrdiff_t m_Entity_nLightProbeSizeY = 0x1880; // int32
                constexpr std::ptrdiff_t m_Entity_nLightProbeSizeZ = 0x1884; // int32
                constexpr std::ptrdiff_t m_Entity_nLightProbeAtlasX = 0x1888; // int32
                constexpr std::ptrdiff_t m_Entity_nLightProbeAtlasY = 0x188C; // int32
                constexpr std::ptrdiff_t m_Entity_nLightProbeAtlasZ = 0x1890; // int32
                constexpr std::ptrdiff_t m_Entity_bEnabled = 0x18A9; // bool
            }
            // Parent: CPlayerPawnComponent
            // Fields count: 0
            ...
            namespace CEnvParticleGlow {
                constexpr std::ptrdiff_t m_flAlphaScale = 0xF70; // float32
                constexpr std::ptrdiff_t m_flRadiusScale = 0xF74; // float32
                constexpr std::ptrdiff_t m_flSelfIllumScale = 0xF78; // float32
            ...
            namespace CSoundAreaEntitySphere {
                constexpr std::ptrdiff_t m_flRadius = 0x7BC; // float32
            }
            // Parent: CFuncBrush
            // Fields count: 9
            //
            ...
            namespace CFuncMonitor {
                ...
                constexpr std::ptrdiff_t m_nResolutionEnum = 0xA20; // int32
            ...
            namespace CPointAngularVelocitySensor {
                constexpr std::ptrdiff_t m_hTargetEntity = 0x7A4; // CHandle<CBaseEntity>
                constexpr std::ptrdiff_t m_flThreshold = 0x7A8; // float32
                constexpr std::ptrdiff_t m_nLastCompareResult = 0x7AC; // int32
                constexpr std::ptrdiff_t m_nLastFireResult = 0x7B0; // int32
                constexpr std::ptrdiff_t m_flFireTime = 0x7B4; // GameTime_t
                constexpr std::ptrdiff_t m_flFireInterval = 0x7B8; // float32
                constexpr std::ptrdiff_t m_flLastAngVelocity = 0x7BC; // float32
                constexpr std::ptrdiff_t m_lastOrientation = 0x7C0; // QAngle
                constexpr std::ptrdiff_t m_vecAxis = 0x7CC; // Vector
                constexpr std::ptrdiff_t m_bUseHelper = 0x7D8; // bool
            ...
            namespace CMolotovProjectile {
                constexpr std::ptrdiff_t m_bIsIncGrenade = 0xD8E; // bool
                constexpr std::ptrdiff_t m_bDetonated = 0xD98; // bool
                constexpr std::ptrdiff_t m_stillTimer = 0xDA0; // IntervalTimer
                constexpr std::ptrdiff_t m_bHasBouncedOffPlayer = 0xE80; // bool
            }
            // Parent: CBaseTrigger
            // Fields count: 0
            ...
            namespace CEnvInstructorHint {
                ...
                constexpr std::ptrdiff_t m_iTimeout = 0x7C0; // int32
                constexpr std::ptrdiff_t m_iDisplayLimit = 0x7C4; // int32
                ...
                constexpr std::ptrdiff_t m_fIconOffset = 0x7EC; // float32
                constexpr std::ptrdiff_t m_fRange = 0x7F0; // float32
                constexpr std::ptrdiff_t m_iPulseOption = 0x7F4; // uint8
                constexpr std::ptrdiff_t m_iAlphaOption = 0x7F5; // uint8
                constexpr std::ptrdiff_t m_iShakeOption = 0x7F6; // uint8
                ...
                constexpr std::ptrdiff_t m_iInstanceType = 0x7FC; // int32
            ...
            namespace CEnvTracer {
                constexpr std::ptrdiff_t m_vecEnd = 0x7A4; // Vector
                constexpr std::ptrdiff_t m_flDelay = 0x7B0; // float32
            }
            // Parent: CPointEntity
            // Fields count: 2
            namespace CInfoGameEventProxy {
                ...
                constexpr std::ptrdiff_t m_flRange = 0x7B0; // float32
            }
            // Parent: CBaseEntity
            // Fields count: 25
            //
            ...
            namespace CPointCamera {
                constexpr std::ptrdiff_t m_FOV = 0x7A4; // float32
                constexpr std::ptrdiff_t m_Resolution = 0x7A8; // float32
                constexpr std::ptrdiff_t m_bFogEnable = 0x7AC; // bool
                constexpr std::ptrdiff_t m_FogColor = 0x7AD; // Color
                constexpr std::ptrdiff_t m_flFogStart = 0x7B4; // float32
                constexpr std::ptrdiff_t m_flFogEnd = 0x7B8; // float32
                constexpr std::ptrdiff_t m_flFogMaxDensity = 0x7BC; // float32
                constexpr std::ptrdiff_t m_bActive = 0x7C0; // bool
                constexpr std::ptrdiff_t m_bUseScreenAspectRatio = 0x7C1; // bool
                constexpr std::ptrdiff_t m_flAspectRatio = 0x7C4; // float32
                constexpr std::ptrdiff_t m_bNoSky = 0x7C8; // bool
                constexpr std::ptrdiff_t m_fBrightness = 0x7CC; // float32
                constexpr std::ptrdiff_t m_flZFar = 0x7D0; // float32
                constexpr std::ptrdiff_t m_flZNear = 0x7D4; // float32
                constexpr std::ptrdiff_t m_bCanHLTVUse = 0x7D8; // bool
                constexpr std::ptrdiff_t m_bDofEnabled = 0x7D9; // bool
                constexpr std::ptrdiff_t m_flDofNearBlurry = 0x7DC; // float32
                constexpr std::ptrdiff_t m_flDofNearCrisp = 0x7E0; // float32
                constexpr std::ptrdiff_t m_flDofFarCrisp = 0x7E4; // float32
                constexpr std::ptrdiff_t m_flDofFarBlurry = 0x7E8; // float32
                constexpr std::ptrdiff_t m_flDofTiltToGround = 0x7EC; // float32
                constexpr std::ptrdiff_t m_TargetFOV = 0x7F0; // float32
                constexpr std::ptrdiff_t m_DegreesPerSecond = 0x7F4; // float32
                constexpr std::ptrdiff_t m_bIsOn = 0x7F8; // bool
            ...
            namespace CFuncLadder {
                ...
                constexpr std::ptrdiff_t m_flAutoRideSpeed = 0xA44; // float32
            ...
            namespace CPathKeyFrame {
                constexpr std::ptrdiff_t m_Origin = 0x7A4; // Vector
                constexpr std::ptrdiff_t m_Angles = 0x7B0; // QAngle
                ...
                constexpr std::ptrdiff_t m_flMoveSpeed = 0x7F0; // float32
            }
            // Parent: CBaseModelEntity
            // Fields count: 3
            ...
            namespace COrnamentProp {
                constexpr std::ptrdiff_t m_initialOwner = 0xE88; // CUtlSymbolLarge
            }
            // Parent: CLogicalEntity
            // Fields count: 1
            ...
            namespace CEnvMuzzleFlash {
                constexpr std::ptrdiff_t m_flScale = 0x7A4; // float32
                constexpr std::ptrdiff_t m_iszParentAttachment = 0x7A8; // CUtlSymbolLarge
            }
            // Parent: CModelPointEntity
            // Fields count: 15
            //
            ...
            namespace CPlayerSprayDecal {
                constexpr std::ptrdiff_t m_nUniqueID = 0x9F8; // int32
                constexpr std::ptrdiff_t m_unAccountID = 0x9FC; // uint32
                constexpr std::ptrdiff_t m_unTraceID = 0xA00; // uint32
                constexpr std::ptrdiff_t m_rtGcTime = 0xA04; // uint32
                ...
                constexpr std::ptrdiff_t m_nPlayer = 0xA38; // int32
                constexpr std::ptrdiff_t m_nEntity = 0xA3C; // int32
                constexpr std::ptrdiff_t m_nHitbox = 0xA40; // int32
                constexpr std::ptrdiff_t m_flCreationTime = 0xA44; // float32
                constexpr std::ptrdiff_t m_nTintID = 0xA48; // int32
                constexpr std::ptrdiff_t m_nVersion = 0xA4C; // uint8
                constexpr std::ptrdiff_t m_ubSignature = 0xA4D; // uint8[128]
            }
            // Parent: CBaseTrigger
            // Fields count: 9
            //
            ...
            namespace CBombTarget {
                constexpr std::ptrdiff_t m_OnBombExplode = 0xBC8; // CEntityIOOutput
                constexpr std::ptrdiff_t m_OnBombPlanted = 0xBF0; // CEntityIOOutput
                constexpr std::ptrdiff_t m_OnBombDefused = 0xC18; // CEntityIOOutput
                constexpr std::ptrdiff_t m_bIsBombSiteB = 0xC40; // bool
                constexpr std::ptrdiff_t m_bIsHeistBombTarget = 0xC41; // bool
                constexpr std::ptrdiff_t m_bBombPlantedHere = 0xC42; // bool
                constexpr std::ptrdiff_t m_szMountTarget = 0xC48; // CUtlSymbolLarge
                constexpr std::ptrdiff_t m_hInstructorHint = 0xC50; // CHandle<CBaseEntity>
                constexpr std::ptrdiff_t m_nBombSiteDesignation = 0xC54; // int32
            }
            // Parent: CBaseEntity
            // Fields count: 8
            namespace CPhysicsSpring {
                constexpr std::ptrdiff_t m_flFrequency = 0x7B0; // float32
                constexpr std::ptrdiff_t m_flDampingRatio = 0x7B4; // float32
                constexpr std::ptrdiff_t m_flRestLength = 0x7B8; // float32
                ...
                constexpr std::ptrdiff_t m_teleportTick = 0x7E8; // uint32
            }
            // Parent: CBaseEntity
            // Fields count: 17
            //
            ...
            namespace CEnvLightProbeVolume {
                constexpr std::ptrdiff_t m_Entity_hLightProbeTexture = 0x1788; // CStrongHandle<InfoForResourceTypeCTextureBase>
                constexpr std::ptrdiff_t m_Entity_hLightProbeDirectLightIndicesTexture = 0x1790; // CStrongHandle<InfoForResourceTypeCTextureBase>
                constexpr std::ptrdiff_t m_Entity_hLightProbeDirectLightScalarsTexture = 0x1798; // CStrongHandle<InfoForResourceTypeCTextureBase>
                constexpr std::ptrdiff_t m_Entity_hLightProbeDirectLightShadowsTexture = 0x17A0; // CStrongHandle<InfoForResourceTypeCTextureBase>
                constexpr std::ptrdiff_t m_Entity_vBoxMins = 0x17A8; // Vector
                constexpr std::ptrdiff_t m_Entity_vBoxMaxs = 0x17B4; // Vector
                constexpr std::ptrdiff_t m_Entity_bMoveable = 0x17C0; // bool
                constexpr std::ptrdiff_t m_Entity_nHandshake = 0x17C4; // int32
                constexpr std::ptrdiff_t m_Entity_nPriority = 0x17C8; // int32
                constexpr std::ptrdiff_t m_Entity_bStartDisabled = 0x17CC; // bool
                constexpr std::ptrdiff_t m_Entity_nLightProbeSizeX = 0x17D0; // int32
                constexpr std::ptrdiff_t m_Entity_nLightProbeSizeY = 0x17D4; // int32
                constexpr std::ptrdiff_t m_Entity_nLightProbeSizeZ = 0x17D8; // int32
                constexpr std::ptrdiff_t m_Entity_nLightProbeAtlasX = 0x17DC; // int32
                constexpr std::ptrdiff_t m_Entity_nLightProbeAtlasY = 0x17E0; // int32
                constexpr std::ptrdiff_t m_Entity_nLightProbeAtlasZ = 0x17E4; // int32
            ...
            namespace CScriptTriggerPush {
                constexpr std::ptrdiff_t m_vExtent = 0xBF4; // Vector
            }
            // Parent: CBaseEntity
            // Fields count: 1
            ...
            // Fields count: 1
            namespace CFuncWall {
                constexpr std::ptrdiff_t m_nState = 0x9F8; // int32
            }
            // Parent: None
            // Fields count: 14
            //
            ...
            namespace CLogicAutosave {
                constexpr std::ptrdiff_t m_bForceNewLevelUnit = 0x7A4; // bool
                constexpr std::ptrdiff_t m_minHitPoints = 0x7A8; // int32
                constexpr std::ptrdiff_t m_minHitPointsToCommit = 0x7AC; // int32
            }
            // Parent: CPlayerControllerComponent
            // Fields count: 2
            //
            ...
            namespace CSoundEventPathCornerEntity {
                ...
                constexpr std::ptrdiff_t m_bPlaying = 0x868; // bool
                constexpr std::ptrdiff_t m_vecCornerPairsNetworked = 0x890; // CNetworkUtlVectorBase<SoundeventPathCornerPairNetworked_t>
            }
            // Parent: CEnvSoundscape
            // Fields count: 1
            ...
            namespace CSmokeGrenadeProjectile {
                constexpr std::ptrdiff_t m_nSmokeEffectTickBegin = 0xDA8; // int32
                constexpr std::ptrdiff_t m_bDidSmokeEffect = 0xDAC; // bool
                constexpr std::ptrdiff_t m_nRandomSeed = 0xDB0; // int32
                constexpr std::ptrdiff_t m_vSmokeColor = 0xDB4; // Vector
                constexpr std::ptrdiff_t m_vSmokeDetonationPos = 0xDC0; // Vector
            ...
            namespace CScriptTriggerMultiple {
                constexpr std::ptrdiff_t m_vExtent = 0xBF0; // Vector
            }
            ...
            namespace FilterDamageType {
                constexpr std::ptrdiff_t m_iDamageType = 0x7F8; // int32
            }
            // Parent: CBot
            // Fields count: 139
            namespace CCSBot {
                ...
                constexpr std::ptrdiff_t m_combatRange = 0x13C; // float32
                ...
                constexpr std::ptrdiff_t m_safeTime = 0x168; // float32
                ...
                constexpr std::ptrdiff_t m_followTimestamp = 0x198; // float32
                constexpr std::ptrdiff_t m_allowAutoFollowTime = 0x19C; // float32
                ...
                constexpr std::ptrdiff_t m_stateTimestamp = 0x4B8; // float32
                ...
                constexpr std::ptrdiff_t m_avoidTimestamp = 0x4E8; // float32
                ...
                constexpr std::ptrdiff_t m_pathIndex = 0x55D8; // int32
                constexpr std::ptrdiff_t m_areaEnteredTimestamp = 0x55DC; // GameTime_t
                constexpr std::ptrdiff_t m_repathTimer = 0x55E0; // CountdownTimer
                constexpr std::ptrdiff_t m_avoidFriendTimer = 0x55F8; // CountdownTimer
                constexpr std::ptrdiff_t m_isFriendInTheWay = 0x5610; // bool
                constexpr std::ptrdiff_t m_politeTimer = 0x5618; // CountdownTimer
                constexpr std::ptrdiff_t m_isWaitingBehindFriend = 0x5630; // bool
                constexpr std::ptrdiff_t m_pathLadderEnd = 0x565C; // float32
                constexpr std::ptrdiff_t m_mustRunTimer = 0x56A8; // CountdownTimer
                constexpr std::ptrdiff_t m_waitTimer = 0x56C0; // CountdownTimer
                constexpr std::ptrdiff_t m_updateTravelDistanceTimer = 0x56D8; // CountdownTimer
                constexpr std::ptrdiff_t m_playerTravelDistance = 0x56F0; // float32[64]
                constexpr std::ptrdiff_t m_travelDistancePhase = 0x57F0; // uint8
                constexpr std::ptrdiff_t m_hostageEscortCount = 0x5988; // uint8
                constexpr std::ptrdiff_t m_hostageEscortCountTimestamp = 0x598C; // float32
                constexpr std::ptrdiff_t m_desiredTeam = 0x5990; // int32
                constexpr std::ptrdiff_t m_hasJoined = 0x5994; // bool
                constexpr std::ptrdiff_t m_isWaitingForHostage = 0x5995; // bool
                constexpr std::ptrdiff_t m_inhibitWaitingForHostageTimer = 0x5998; // CountdownTimer
                constexpr std::ptrdiff_t m_waitForHostageTimer = 0x59B0; // CountdownTimer
                constexpr std::ptrdiff_t m_noisePosition = 0x59C8; // Vector
                constexpr std::ptrdiff_t m_noiseTravelDistance = 0x59D4; // float32
                constexpr std::ptrdiff_t m_noiseTimestamp = 0x59D8; // float32
                constexpr std::ptrdiff_t m_noiseSource = 0x59E0; // CCSPlayerPawn*
                constexpr std::ptrdiff_t m_noiseBendTimer = 0x59F8; // CountdownTimer
                constexpr std::ptrdiff_t m_bentNoisePosition = 0x5A10; // Vector
                constexpr std::ptrdiff_t m_bendNoisePositionValid = 0x5A1C; // bool
                constexpr std::ptrdiff_t m_lookAroundStateTimestamp = 0x5A20; // float32
                constexpr std::ptrdiff_t m_lookAheadAngle = 0x5A24; // float32
                constexpr std::ptrdiff_t m_forwardAngle = 0x5A28; // float32
                constexpr std::ptrdiff_t m_inhibitLookAroundTimestamp = 0x5A2C; // float32
                constexpr std::ptrdiff_t m_lookAtSpot = 0x5A34; // Vector
                constexpr std::ptrdiff_t m_lookAtSpotDuration = 0x5A44; // float32
                constexpr std::ptrdiff_t m_lookAtSpotTimestamp = 0x5A48; // float32
                constexpr std::ptrdiff_t m_lookAtSpotAngleTolerance = 0x5A4C; // float32
                constexpr std::ptrdiff_t m_lookAtSpotClearIfClose = 0x5A50; // bool
                constexpr std::ptrdiff_t m_lookAtSpotAttack = 0x5A51; // bool
                constexpr std::ptrdiff_t m_lookAtDesc = 0x5A58; // char*
                constexpr std::ptrdiff_t m_peripheralTimestamp = 0x5A60; // float32
                constexpr std::ptrdiff_t m_approachPointCount = 0x5BE8; // uint8
                constexpr std::ptrdiff_t m_approachPointViewPosition = 0x5BEC; // Vector
                constexpr std::ptrdiff_t m_viewSteadyTimer = 0x5BF8; // IntervalTimer
                constexpr std::ptrdiff_t m_tossGrenadeTimer = 0x5C10; // CountdownTimer
                constexpr std::ptrdiff_t m_isAvoidingGrenade = 0x5C30; // CountdownTimer
                constexpr std::ptrdiff_t m_spotCheckTimestamp = 0x5C50; // float32
                constexpr std::ptrdiff_t m_checkedHidingSpotCount = 0x6058; // int32
                constexpr std::ptrdiff_t m_lookPitch = 0x605C; // float32
                constexpr std::ptrdiff_t m_lookPitchVel = 0x6060; // float32
                constexpr std::ptrdiff_t m_lookYaw = 0x6064; // float32
                constexpr std::ptrdiff_t m_lookYawVel = 0x6068; // float32
                constexpr std::ptrdiff_t m_targetSpot = 0x606C; // Vector
                constexpr std::ptrdiff_t m_targetSpotVelocity = 0x6078; // Vector
                constexpr std::ptrdiff_t m_targetSpotPredicted = 0x6084; // Vector
                constexpr std::ptrdiff_t m_aimError = 0x6090; // QAngle
                constexpr std::ptrdiff_t m_aimGoal = 0x609C; // QAngle
                constexpr std::ptrdiff_t m_targetSpotTime = 0x60A8; // GameTime_t
                constexpr std::ptrdiff_t m_aimFocus = 0x60AC; // float32
                constexpr std::ptrdiff_t m_aimFocusInterval = 0x60B0; // float32
                constexpr std::ptrdiff_t m_aimFocusNextUpdate = 0x60B4; // GameTime_t
                constexpr std::ptrdiff_t m_ignoreEnemiesTimer = 0x60C0; // CountdownTimer
                constexpr std::ptrdiff_t m_enemy = 0x60D8; // CHandle<CCSPlayerPawn>
                constexpr std::ptrdiff_t m_isEnemyVisible = 0x60DC; // bool
                constexpr std::ptrdiff_t m_visibleEnemyParts = 0x60DD; // uint8
                constexpr std::ptrdiff_t m_lastEnemyPosition = 0x60E0; // Vector
                constexpr std::ptrdiff_t m_lastSawEnemyTimestamp = 0x60EC; // float32
                constexpr std::ptrdiff_t m_firstSawEnemyTimestamp = 0x60F0; // float32
                constexpr std::ptrdiff_t m_currentEnemyAcquireTimestamp = 0x60F4; // float32
                constexpr std::ptrdiff_t m_enemyDeathTimestamp = 0x60F8; // float32
                constexpr std::ptrdiff_t m_friendDeathTimestamp = 0x60FC; // float32
                constexpr std::ptrdiff_t m_isLastEnemyDead = 0x6100; // bool
                constexpr std::ptrdiff_t m_nearbyEnemyCount = 0x6104; // int32
                constexpr std::ptrdiff_t m_bomber = 0x6310; // CHandle<CCSPlayerPawn>
                constexpr std::ptrdiff_t m_nearbyFriendCount = 0x6314; // int32
                constexpr std::ptrdiff_t m_closestVisibleFriend = 0x6318; // CHandle<CCSPlayerPawn>
                constexpr std::ptrdiff_t m_closestVisibleHumanFriend = 0x631C; // CHandle<CCSPlayerPawn>
                constexpr std::ptrdiff_t m_attentionInterval = 0x6320; // IntervalTimer
                constexpr std::ptrdiff_t m_attacker = 0x6330; // CHandle<CCSPlayerPawn>
                constexpr std::ptrdiff_t m_attackedTimestamp = 0x6334; // float32
                constexpr std::ptrdiff_t m_burnedByFlamesTimer = 0x6338; // IntervalTimer
                constexpr std::ptrdiff_t m_lastVictimID = 0x6348; // int32
                constexpr std::ptrdiff_t m_isAimingAtEnemy = 0x634C; // bool
                constexpr std::ptrdiff_t m_isRapidFiring = 0x634D; // bool
                constexpr std::ptrdiff_t m_equipTimer = 0x6350; // IntervalTimer
                constexpr std::ptrdiff_t m_zoomTimer = 0x6360; // CountdownTimer
                constexpr std::ptrdiff_t m_fireWeaponTimestamp = 0x6378; // GameTime_t
                constexpr std::ptrdiff_t m_lookForWeaponsOnGroundTimer = 0x6380; // CountdownTimer
                constexpr std::ptrdiff_t m_bIsSleeping = 0x6398; // bool
                constexpr std::ptrdiff_t m_isEnemySniperVisible = 0x6399; // bool
                constexpr std::ptrdiff_t m_sawEnemySniperTimer = 0x63A0; // CountdownTimer
                constexpr std::ptrdiff_t m_enemyQueueIndex = 0x6458; // uint8
                constexpr std::ptrdiff_t m_enemyQueueCount = 0x6459; // uint8
                constexpr std::ptrdiff_t m_enemyQueueAttendIndex = 0x645A; // uint8
                constexpr std::ptrdiff_t m_isStuck = 0x645B; // bool
                constexpr std::ptrdiff_t m_stuckTimestamp = 0x645C; // GameTime_t
                constexpr std::ptrdiff_t m_stuckSpot = 0x6460; // Vector
                constexpr std::ptrdiff_t m_wiggleTimer = 0x6470; // CountdownTimer
                constexpr std::ptrdiff_t m_stuckJumpTimer = 0x6488; // CountdownTimer
                constexpr std::ptrdiff_t m_nextCleanupCheckTimestamp = 0x64A0; // GameTime_t
                constexpr std::ptrdiff_t m_avgVel = 0x64A4; // float32[10]
                constexpr std::ptrdiff_t m_avgVelIndex = 0x64CC; // int32
                constexpr std::ptrdiff_t m_avgVelCount = 0x64D0; // int32
                constexpr std::ptrdiff_t m_lastOrigin = 0x64D4; // Vector
                constexpr std::ptrdiff_t m_lastRadioRecievedTimestamp = 0x64E4; // float32
                constexpr std::ptrdiff_t m_lastRadioSentTimestamp = 0x64E8; // float32
                constexpr std::ptrdiff_t m_radioSubject = 0x64EC; // CHandle<CCSPlayerPawn>
                constexpr std::ptrdiff_t m_radioPosition = 0x64F0; // Vector
                constexpr std::ptrdiff_t m_voiceEndTimestamp = 0x64FC; // float32
                constexpr std::ptrdiff_t m_lastValidReactionQueueFrame = 0x6508; // int32
            }
            // Parent: CLogicalEntity
            // Fields count: 7
            namespace CPhysMotor {
                ...
                constexpr std::ptrdiff_t m_spinUp = 0x7B4; // float32
                constexpr std::ptrdiff_t m_additionalAcceleration = 0x7B8; // float32
                constexpr std::ptrdiff_t m_angularAcceleration = 0x7BC; // float32
            ...
            namespace CSoundAreaEntityBase {
                constexpr std::ptrdiff_t m_bDisabled = 0x7A4; // bool
                constexpr std::ptrdiff_t m_iszSoundAreaType = 0x7A8; // CUtlSymbolLarge
                constexpr std::ptrdiff_t m_vPos = 0x7B0; // Vector
            }
            // Parent: CPlayer_UseServices
            // Fields count: 3
            ...
            namespace CTriggerHurt {
                constexpr std::ptrdiff_t m_flOriginalDamage = 0xBC4; // float32
                constexpr std::ptrdiff_t m_flDamage = 0xBC8; // float32
                constexpr std::ptrdiff_t m_flDamageCap = 0xBCC; // float32
                constexpr std::ptrdiff_t m_flLastDmgTime = 0xBD0; // GameTime_t
                constexpr std::ptrdiff_t m_flForgivenessDelay = 0xBD4; // float32
                constexpr std::ptrdiff_t m_bitsDamageInflict = 0xBD8; // int32
                constexpr std::ptrdiff_t m_damageModel = 0xBDC; // int32
                constexpr std::ptrdiff_t m_bNoDmgForce = 0xBE0; // bool
                constexpr std::ptrdiff_t m_vDamageForce = 0xBE4; // Vector
                constexpr std::ptrdiff_t m_thinkAlways = 0xBF0; // bool
                constexpr std::ptrdiff_t m_hurtThinkPeriod = 0xBF4; // float32
                constexpr std::ptrdiff_t m_OnHurt = 0xBF8; // CEntityIOOutput
                constexpr std::ptrdiff_t m_OnHurtPlayer = 0xC20; // CEntityIOOutput
                constexpr std::ptrdiff_t m_hurtEntities = 0xC48; // CUtlVector<CHandle<CBaseEntity>>
            }
            // Parent: CLogicalEntity
            // Fields count: 13
            namespace CPhysConstraint {
                ...
                constexpr std::ptrdiff_t m_hAttach1 = 0x7C0; // CHandle<CBaseEntity>
                constexpr std::ptrdiff_t m_hAttach2 = 0x7C4; // CHandle<CBaseEntity>
                constexpr std::ptrdiff_t m_nameAttachment1 = 0x7C8; // CUtlSymbolLarge
                constexpr std::ptrdiff_t m_nameAttachment2 = 0x7D0; // CUtlSymbolLarge
                constexpr std::ptrdiff_t m_breakSound = 0x7D8; // CUtlSymbolLarge
                constexpr std::ptrdiff_t m_forceLimit = 0x7E0; // float32
                constexpr std::ptrdiff_t m_torqueLimit = 0x7E4; // float32
                constexpr std::ptrdiff_t m_teleportTick = 0x7E8; // uint32
                constexpr std::ptrdiff_t m_minTeleportDistance = 0x7EC; // float32
                constexpr std::ptrdiff_t m_bSnapObjectPositions = 0x7F0; // bool
            ...
            namespace CMapVetoPickController {
                constexpr std::ptrdiff_t m_bPlayedIntroVcd = 0x7A4; // bool
                constexpr std::ptrdiff_t m_bNeedToPlayFiveSecondsRemaining = 0x7A5; // bool
                constexpr std::ptrdiff_t m_dblPreMatchDraftSequenceTime = 0x7C0; // float64
                constexpr std::ptrdiff_t m_bPreMatchDraftStateChanged = 0x7C8; // bool
                constexpr std::ptrdiff_t m_nDraftType = 0x7CC; // int32
                constexpr std::ptrdiff_t m_nTeamWinningCoinToss = 0x7D0; // int32
                constexpr std::ptrdiff_t m_nTeamWithFirstChoice = 0x7D4; // int32[64]
                constexpr std::ptrdiff_t m_nVoteMapIdsList = 0x8D4; // int32[7]
                constexpr std::ptrdiff_t m_nAccountIDs = 0x8F0; // int32[64]
                constexpr std::ptrdiff_t m_nMapId0 = 0x9F0; // int32[64]
                constexpr std::ptrdiff_t m_nMapId1 = 0xAF0; // int32[64]
                constexpr std::ptrdiff_t m_nMapId2 = 0xBF0; // int32[64]
                constexpr std::ptrdiff_t m_nMapId3 = 0xCF0; // int32[64]
                constexpr std::ptrdiff_t m_nMapId4 = 0xDF0; // int32[64]
                constexpr std::ptrdiff_t m_nMapId5 = 0xEF0; // int32[64]
                constexpr std::ptrdiff_t m_nStartingSide0 = 0xFF0; // int32[64]
                constexpr std::ptrdiff_t m_nCurrentPhase = 0x10F0; // int32
                constexpr std::ptrdiff_t m_nPhaseStartTick = 0x10F4; // int32
                constexpr std::ptrdiff_t m_nPhaseDurationTicks = 0x10F8; // int32
                constexpr std::ptrdiff_t m_OnMapVetoed = 0x1100; // CEntityOutputTemplate<CUtlSymbolLarge>
                constexpr std::ptrdiff_t m_OnMapPicked = 0x1128; // CEntityOutputTemplate<CUtlSymbolLarge>
                constexpr std::ptrdiff_t m_OnSidesPicked = 0x1150; // CEntityOutputTemplate<int32>
                constexpr std::ptrdiff_t m_OnNewPhaseStarted = 0x1178; // CEntityOutputTemplate<int32>
                constexpr std::ptrdiff_t m_OnLevelTransition = 0x11A0; // CEntityOutputTemplate<int32>
            }
            // Parent: CBaseEntity
            // Fields count: 0
            ...
            // Fields count: 4
            namespace CSoundEnt {
                constexpr std::ptrdiff_t m_iFreeSound = 0x7A4; // int32
                constexpr std::ptrdiff_t m_iActiveSound = 0x7A8; // int32
                constexpr std::ptrdiff_t m_cLastActiveSounds = 0x7AC; // int32
                constexpr std::ptrdiff_t m_SoundPool = 0x7B0; // CSound[128]
            }
            // Parent: CPointEntity
            // Fields count: 0
            ...
            namespace CTriggerSave {
                constexpr std::ptrdiff_t m_bForceNewLevelUnit = 0xBC1; // bool
                constexpr std::ptrdiff_t m_fDangerousTimer = 0xBC4; // float32
                constexpr std::ptrdiff_t m_minHitPoints = 0xBC8; // int32
            }
            // Parent: CPhysConstraint
            // Fields count: 11
            namespace CPhysWheelConstraint {
                constexpr std::ptrdiff_t m_flSuspensionFrequency = 0x820; // float32
                constexpr std::ptrdiff_t m_flSuspensionDampingRatio = 0x824; // float32
                constexpr std::ptrdiff_t m_flSuspensionHeightOffset = 0x828; // float32
                constexpr std::ptrdiff_t m_bEnableSuspensionLimit = 0x82C; // bool
                constexpr std::ptrdiff_t m_flMinSuspensionOffset = 0x830; // float32
                constexpr std::ptrdiff_t m_flMaxSuspensionOffset = 0x834; // float32
                constexpr std::ptrdiff_t m_bEnableSteeringLimit = 0x838; // bool
                constexpr std::ptrdiff_t m_flMinSteeringAngle = 0x83C; // float32
                constexpr std::ptrdiff_t m_flMaxSteeringAngle = 0x840; // float32
                constexpr std::ptrdiff_t m_flSteeringAxisFriction = 0x844; // float32
                constexpr std::ptrdiff_t m_flSpinAxisFriction = 0x848; // float32
            }
            // Parent: CPhysConstraint
            // Fields count: 6
            namespace CPhysFixed {
                constexpr std::ptrdiff_t m_flLinearFrequency = 0x820; // float32
                constexpr std::ptrdiff_t m_flLinearDampingRatio = 0x824; // float32
                constexpr std::ptrdiff_t m_flAngularFrequency = 0x828; // float32
                constexpr std::ptrdiff_t m_flAngularDampingRatio = 0x82C; // float32
                constexpr std::ptrdiff_t m_bEnableLinearConstraint = 0x830; // bool
                constexpr std::ptrdiff_t m_bEnableAngularConstraint = 0x831; // bool
            }
            // Parent: CEntitySubclassVDataBase
            // Fields count: 14
            //
            ...
            namespace CPhysPulley {
                constexpr std::ptrdiff_t m_position2 = 0x820; // Vector
                constexpr std::ptrdiff_t m_offset = 0x82C; // Vector[2]
                constexpr std::ptrdiff_t m_addLength = 0x844; // float32
                constexpr std::ptrdiff_t m_gearRatio = 0x848; // float32
            }
            // Parent: CBaseEntity
            // Fields count: 0
            ...
            namespace CEnvFireSource {
                constexpr std::ptrdiff_t m_bEnabled = 0x7A4; // bool
                constexpr std::ptrdiff_t m_radius = 0x7A8; // float32
                constexpr std::ptrdiff_t m_damage = 0x7AC; // float32
            }
            // Parent: CBaseEntity
            // Fields count: 0
            ...
            namespace CTriggerGameEvent {
                constexpr std::ptrdiff_t m_strStartTouchEventName = 0xBC8; // CUtlString
                constexpr std::ptrdiff_t m_strEndTouchEventName = 0xBD0; // CUtlString
                constexpr std::ptrdiff_t m_strTriggerID = 0xBD8; // CUtlString
            }
            // Parent: CPhysConstraint
            // Fields count: 10
            namespace CPhysSlideConstraint {
                constexpr std::ptrdiff_t m_axisEnd = 0x828; // Vector
                constexpr std::ptrdiff_t m_slideFriction = 0x834; // float32
                constexpr std::ptrdiff_t m_systemLoadScale = 0x838; // float32
                constexpr std::ptrdiff_t m_initialOffset = 0x83C; // float32
                constexpr std::ptrdiff_t m_bEnableLinearConstraint = 0x840; // bool
                constexpr std::ptrdiff_t m_bEnableAngularConstraint = 0x841; // bool
                constexpr std::ptrdiff_t m_flMotorFrequency = 0x844; // float32
                constexpr std::ptrdiff_t m_flMotorDampingRatio = 0x848; // float32
                constexpr std::ptrdiff_t m_bUseEntityPivot = 0x84C; // bool
                constexpr std::ptrdiff_t m_soundInfo = 0x850; // ConstraintSoundInfo
            }
            // Parent: CBaseEntity
            // Fields count: 1
            namespace CDebugHistory {
                constexpr std::ptrdiff_t m_nNpcEvents = 0x1F47E8; // int32
            }
            // Parent: CServerOnlyEntity
            // Fields count: 0
            namespace CInfoData {
            ...
            namespace CFuncRotating {
                ...
                constexpr std::ptrdiff_t m_flFanFriction = 0xA7C; // float32
                constexpr std::ptrdiff_t m_flAttenuation = 0xA80; // float32
                constexpr std::ptrdiff_t m_flVolume = 0xA84; // float32
                constexpr std::ptrdiff_t m_flTargetSpeed = 0xA88; // float32
                constexpr std::ptrdiff_t m_flMaxSpeed = 0xA8C; // float32
                constexpr std::ptrdiff_t m_flBlockDamage = 0xA90; // float32
            ...
            namespace CBaseCSGrenadeProjectile {
                ...
                constexpr std::ptrdiff_t m_nItemIndex = 0xD5E; // uint16
                constexpr std::ptrdiff_t m_vecOriginalSpawnLocation = 0xD60; // Vector
                constexpr std::ptrdiff_t m_flLastBounceSoundTime = 0xD6C; // GameTime_t
                constexpr std::ptrdiff_t m_vecGrenadeSpin = 0xD70; // RotationVector
                constexpr std::ptrdiff_t m_vecLastHitSurfaceNormal = 0xD7C; // Vector
                constexpr std::ptrdiff_t m_nTicksAtZeroVelocity = 0xD88; // int32
                constexpr std::ptrdiff_t m_bHasEverHitPlayer = 0xD8C; // bool
                constexpr std::ptrdiff_t m_bClearFromPlayers = 0xD8D; // bool
            }
            // Parent: CServerOnlyModelEntity
            // Fields count: 1
            namespace CCSPlace {
            ...
            namespace CPointAngleSensor {
                constexpr std::ptrdiff_t m_bDisabled = 0x7A4; // bool
                constexpr std::ptrdiff_t m_nLookAtName = 0x7A8; // CUtlSymbolLarge
                constexpr std::ptrdiff_t m_hTargetEntity = 0x7B0; // CHandle<CBaseEntity>
                constexpr std::ptrdiff_t m_hLookAtEntity = 0x7B4; // CHandle<CBaseEntity>
                constexpr std::ptrdiff_t m_flDuration = 0x7B8; // float32
                constexpr std::ptrdiff_t m_flDotTolerance = 0x7BC; // float32
                constexpr std::ptrdiff_t m_flFacingTime = 0x7C0; // GameTime_t
                constexpr std::ptrdiff_t m_bFired = 0x7C4; // bool
                constexpr std::ptrdiff_t m_OnFacingLookat = 0x7C8; // CEntityIOOutput
                constexpr std::ptrdiff_t m_OnNotFacingLookat = 0x7F0; // CEntityIOOutput
                constexpr std::ptrdiff_t m_TargetDir = 0x818; // CEntityOutputTemplate<Vector>
                constexpr std::ptrdiff_t m_FacingPercentage = 0x840; // CEntityOutputTemplate<float32>
            }
            // Parent: CSoundEventEntity
            // Fields count: 2
            //
            ...
            namespace CSoundEventOBBEntity {
                constexpr std::ptrdiff_t m_vMins = 0x850; // Vector
                constexpr std::ptrdiff_t m_vMaxs = 0x85C; // Vector
            }
            ...
            namespace CEnvVolumetricFogVolume {
                constexpr std::ptrdiff_t m_bActive = 0x7A4; // bool
                constexpr std::ptrdiff_t m_vBoxMins = 0x7A8; // Vector
                constexpr std::ptrdiff_t m_vBoxMaxs = 0x7B4; // Vector
                constexpr std::ptrdiff_t m_bStartDisabled = 0x7C0; // bool
                constexpr std::ptrdiff_t m_flStrength = 0x7C4; // float32
                constexpr std::ptrdiff_t m_nFalloffShape = 0x7C8; // int32
                constexpr std::ptrdiff_t m_flFalloffExponent = 0x7CC; // float32
                constexpr std::ptrdiff_t m_flHeightFogDepth = 0x7D0; // float32
                constexpr std::ptrdiff_t m_fHeightFogEdgeWidth = 0x7D4; // float32
                constexpr std::ptrdiff_t m_fIndirectLightStrength = 0x7D8; // float32
                constexpr std::ptrdiff_t m_fSunLightStrength = 0x7DC; // float32
                constexpr std::ptrdiff_t m_fNoiseStrength = 0x7E0; // float32
                constexpr std::ptrdiff_t m_bOverrideIndirectLightStrength = 0x7E4; // bool
                constexpr std::ptrdiff_t m_bOverrideSunLightStrength = 0x7E5; // bool
                constexpr std::ptrdiff_t m_bOverrideNoiseStrength = 0x7E6; // bool
            }
            // Parent: CBaseModelEntity
            // Fields count: 24
            //
            ...
            // NetworkVarNames: m_vecEndPos (Vector)
            namespace CBeam {
                constexpr std::ptrdiff_t m_flFrameRate = 0x9F8; // float32
                constexpr std::ptrdiff_t m_flHDRColorScale = 0x9FC; // float32
                constexpr std::ptrdiff_t m_flFireTime = 0xA00; // GameTime_t
                constexpr std::ptrdiff_t m_flDamage = 0xA04; // float32
                constexpr std::ptrdiff_t m_nNumBeamEnts = 0xA08; // uint8
                ...
                constexpr std::ptrdiff_t m_nBeamFlags = 0xA24; // uint32
                ...
                constexpr std::ptrdiff_t m_fWidth = 0xA5C; // float32
                constexpr std::ptrdiff_t m_fEndWidth = 0xA60; // float32
                constexpr std::ptrdiff_t m_fFadeLength = 0xA64; // float32
                constexpr std::ptrdiff_t m_fHaloScale = 0xA68; // float32
                constexpr std::ptrdiff_t m_fAmplitude = 0xA6C; // float32
                constexpr std::ptrdiff_t m_fStartFrame = 0xA70; // float32
                constexpr std::ptrdiff_t m_fSpeed = 0xA74; // float32
                constexpr std::ptrdiff_t m_flFrame = 0xA78; // float32
                ...
                constexpr std::ptrdiff_t m_nDissolveType = 0xA94; // int32
            }
            // Parent: CBaseEntity
            // Fields count: 25
            //
            ...
            namespace CBaseModelEntity {
                ...
                constexpr std::ptrdiff_t m_flGlowBackfaceMult = 0x970; // float32
                constexpr std::ptrdiff_t m_fadeMinDist = 0x974; // float32
                constexpr std::ptrdiff_t m_fadeMaxDist = 0x978; // float32
                constexpr std::ptrdiff_t m_flFadeScale = 0x97C; // float32
                constexpr std::ptrdiff_t m_flShadowStrength = 0x980; // float32
                constexpr std::ptrdiff_t m_nObjectCulling = 0x984; // uint8
                constexpr std::ptrdiff_t m_nAddDecal = 0x988; // int32
                constexpr std::ptrdiff_t m_vDecalPosition = 0x98C; // Vector
                constexpr std::ptrdiff_t m_vDecalForwardAxis = 0x998; // Vector
                constexpr std::ptrdiff_t m_flDecalHealBloodRate = 0x9A4; // float32
                constexpr std::ptrdiff_t m_flDecalHealHeightRate = 0x9A8; // float32
            ...
            namespace CRagdollMagnet {
                constexpr std::ptrdiff_t m_bDisabled = 0x7A4; // bool
                constexpr std::ptrdiff_t m_radius = 0x7A8; // float32
                constexpr std::ptrdiff_t m_force = 0x7AC; // float32
                constexpr std::ptrdiff_t m_axis = 0x7B0; // Vector
            }
            // Parent: CBaseModelEntity
            // Fields count: 6
            ...
            namespace CFilterClass {
                constexpr std::ptrdiff_t m_iFilterClass = 0x7F8; // CUtlSymbolLarge
            }
            // Parent: CCSWeaponBase
            // Fields count: 0
            namespace CMelee {
            ...
            // Fields count: 15
            namespace CPhysBox {
                constexpr std::ptrdiff_t m_damageType = 0xACC; // int32
                constexpr std::ptrdiff_t m_massScale = 0xAD0; // float32
                constexpr std::ptrdiff_t m_damageToEnableMotion = 0xAD4; // int32
                constexpr std::ptrdiff_t m_flForceToEnableMotion = 0xAD8; // float32
                constexpr std::ptrdiff_t m_angPreferredCarryAngles = 0xADC; // QAngle
                constexpr std::ptrdiff_t m_bNotSolidToWorld = 0xAE8; // bool
                constexpr std::ptrdiff_t m_bEnableUseOutput = 0xAE9; // bool
                constexpr std::ptrdiff_t m_iExploitableByPlayer = 0xAEC; // int32
                constexpr std::ptrdiff_t m_flTouchOutputPerEntityDelay = 0xAF0; // float32
                constexpr std::ptrdiff_t m_OnDamaged = 0xAF8; // CEntityIOOutput
                constexpr std::ptrdiff_t m_OnAwakened = 0xB20; // CEntityIOOutput
                constexpr std::ptrdiff_t m_OnMotionEnabled = 0xB48; // CEntityIOOutput
                constexpr std::ptrdiff_t m_OnPlayerUse = 0xB70; // CEntityIOOutput
                constexpr std::ptrdiff_t m_OnStartTouch = 0xB98; // CEntityIOOutput
                constexpr std::ptrdiff_t m_hCarryingPlayer = 0xBC0; // CHandle<CBasePlayerPawn>
            }
            // Parent: CBaseFlex
            // Fields count: 14
            //
            ...
            namespace CBaseGrenade {
                ...
                constexpr std::ptrdiff_t m_DmgRadius = 0xCDC; // float32
                constexpr std::ptrdiff_t m_flDetonateTime = 0xCE0; // GameTime_t
                constexpr std::ptrdiff_t m_flWarnAITime = 0xCE4; // float32
                constexpr std::ptrdiff_t m_flDamage = 0xCE8; // float32
            ...
            namespace CTimerEntity {
                ...
                constexpr std::ptrdiff_t m_iDisabled = 0x820; // int32
                constexpr std::ptrdiff_t m_flInitialDelay = 0x824; // float32
                constexpr std::ptrdiff_t m_flRefireTime = 0x828; // float32
                constexpr std::ptrdiff_t m_bUpDownState = 0x82C; // bool
                constexpr std::ptrdiff_t m_iUseRandomTime = 0x830; // int32
                constexpr std::ptrdiff_t m_bPauseAfterFiring = 0x834; // bool
                constexpr std::ptrdiff_t m_flLowerRandomBound = 0x838; // float32
                constexpr std::ptrdiff_t m_flUpperRandomBound = 0x83C; // float32
                constexpr std::ptrdiff_t m_flRemainingTime = 0x840; // float32
            ...
            namespace CCSWeaponBase {
                ...
                constexpr std::ptrdiff_t m_flFireSequenceStartTime = 0xFF0; // float32
                constexpr std::ptrdiff_t m_nFireSequenceStartTimeChange = 0xFF4; // int32
                constexpr std::ptrdiff_t m_nFireSequenceStartTimeAck = 0xFF8; // int32
                ...
                constexpr std::ptrdiff_t m_nSilencerBoneIndex = 0x102C; // int32
                ...
                constexpr std::ptrdiff_t m_nLastEmptySoundCmdNum = 0x1068; // int32
                constexpr std::ptrdiff_t m_nViewModelIndex = 0x106C; // uint32
                ...
                constexpr std::ptrdiff_t m_flTurningInaccuracyDelta = 0x10C4; // float32
                constexpr std::ptrdiff_t m_vecTurningInaccuracyEyeDirLast = 0x10C8; // Vector
                constexpr std::ptrdiff_t m_flTurningInaccuracy = 0x10D4; // float32
                constexpr std::ptrdiff_t m_fAccuracyPenalty = 0x10D8; // float32
                constexpr std::ptrdiff_t m_flLastAccuracyUpdateTime = 0x10DC; // GameTime_t
                constexpr std::ptrdiff_t m_fAccuracySmoothedForZoom = 0x10E0; // float32
                constexpr std::ptrdiff_t m_fScopeZoomEndTime = 0x10E4; // GameTime_t
                constexpr std::ptrdiff_t m_iRecoilIndex = 0x10E8; // int32
                constexpr std::ptrdiff_t m_flRecoilIndex = 0x10EC; // float32
                constexpr std::ptrdiff_t m_bBurstMode = 0x10F0; // bool
                constexpr std::ptrdiff_t m_nPostponeFireReadyTicks = 0x10F4; // GameTick_t
                constexpr std::ptrdiff_t m_flPostponeFireReadyFrac = 0x10F8; // float32
                ...
                constexpr std::ptrdiff_t m_iOriginalTeamNumber = 0x110C; // int32
                constexpr std::ptrdiff_t m_iMostRecentTeamNumber = 0x1110; // int32
                constexpr std::ptrdiff_t m_bDroppedNearBuyZone = 0x1114; // bool
                constexpr std::ptrdiff_t m_flNextAttackRenderTimeOffset = 0x1118; // float32
                constexpr std::ptrdiff_t m_bCanBePickedUp = 0x1130; // bool
                constexpr std::ptrdiff_t m_bUseCanOverrideNextOwnerTouchTime = 0x1131; // bool
                constexpr std::ptrdiff_t m_nextOwnerTouchTime = 0x1134; // GameTime_t
                constexpr std::ptrdiff_t m_nextPrevOwnerTouchTime = 0x1138; // GameTime_t
                constexpr std::ptrdiff_t m_hPrevOwner = 0x1140; // CHandle<CCSPlayerPawn>
                constexpr std::ptrdiff_t m_nDropTick = 0x1144; // GameTick_t
                constexpr std::ptrdiff_t m_donated = 0x1164; // bool
                constexpr std::ptrdiff_t m_fLastShotTime = 0x1168; // GameTime_t
                constexpr std::ptrdiff_t m_bWasOwnedByCT = 0x116C; // bool
                constexpr std::ptrdiff_t m_bWasOwnedByTerrorist = 0x116D; // bool
                constexpr std::ptrdiff_t m_bFiredOutOfAmmoEvent = 0x116E; // bool
                constexpr std::ptrdiff_t m_numRemoveUnownedWeaponThink = 0x1170; // int32
                constexpr std::ptrdiff_t m_IronSightController = 0x1178; // CIronSightController
                constexpr std::ptrdiff_t m_iIronSightMode = 0x1190; // int32
                constexpr std::ptrdiff_t m_flLastLOSTraceFailureTime = 0x1194; // GameTime_t
                constexpr std::ptrdiff_t m_iNumEmptyAttacks = 0x1198; // int32
                constexpr std::ptrdiff_t m_flWatTickOffset = 0x119C; // float32
            }
            // Parent: CBaseEntity
            // Fields count: 0
            ...
            namespace CRagdollConstraint {
                constexpr std::ptrdiff_t m_xmin = 0x820; // float32
                constexpr std::ptrdiff_t m_xmax = 0x824; // float32
                constexpr std::ptrdiff_t m_ymin = 0x828; // float32
                constexpr std::ptrdiff_t m_ymax = 0x82C; // float32
                constexpr std::ptrdiff_t m_zmin = 0x830; // float32
                constexpr std::ptrdiff_t m_zmax = 0x834; // float32
                constexpr std::ptrdiff_t m_xfriction = 0x838; // float32
                constexpr std::ptrdiff_t m_yfriction = 0x83C; // float32
                constexpr std::ptrdiff_t m_zfriction = 0x840; // float32
            }
            // Parent: CPointEntity
            // Fields count: 9
            namespace CPhysExplosion {
                constexpr std::ptrdiff_t m_bExplodeOnSpawn = 0x7A4; // bool
                constexpr std::ptrdiff_t m_flMagnitude = 0x7A8; // float32
                constexpr std::ptrdiff_t m_flDamage = 0x7AC; // float32
                constexpr std::ptrdiff_t m_radius = 0x7B0; // float32
                constexpr std::ptrdiff_t m_targetEntityName = 0x7B8; // CUtlSymbolLarge
                constexpr std::ptrdiff_t m_flInnerRadius = 0x7C0; // float32
                constexpr std::ptrdiff_t m_flPushScale = 0x7C4; // float32
            ...
            namespace CPointPush {
                ...
                constexpr std::ptrdiff_t m_flMagnitude = 0x7A8; // float32
                constexpr std::ptrdiff_t m_flRadius = 0x7AC; // float32
                constexpr std::ptrdiff_t m_flInnerRadius = 0x7B0; // float32
                constexpr std::ptrdiff_t m_flConeOfInfluence = 0x7B4; // float32
                constexpr std::ptrdiff_t m_iszFilterName = 0x7B8; // CUtlSymbolLarge
                constexpr std::ptrdiff_t m_hFilter = 0x7C0; // CHandle<CBaseFilter>
            }
            // Parent: CPointEntity
            // Fields count: 3
            namespace CCredits {
                ...
                constexpr std::ptrdiff_t m_flLogoLength = 0x7D4; // float32
            }
            // Parent: CBaseEntity
            // Fields count: 10
            //
            ...
            namespace CCSPlayerResource {
                constexpr std::ptrdiff_t m_bHostageAlive = 0x7A4; // bool[12]
                constexpr std::ptrdiff_t m_isHostageFollowingSomeone = 0x7B0; // bool[12]
                constexpr std::ptrdiff_t m_iHostageEntityIDs = 0x7BC; // CEntityIndex[12]
                constexpr std::ptrdiff_t m_bombsiteCenterA = 0x7EC; // Vector
                constexpr std::ptrdiff_t m_bombsiteCenterB = 0x7F8; // Vector
                constexpr std::ptrdiff_t m_hostageRescueX = 0x804; // int32[4]
                constexpr std::ptrdiff_t m_hostageRescueY = 0x814; // int32[4]
                constexpr std::ptrdiff_t m_hostageRescueZ = 0x824; // int32[4]
                constexpr std::ptrdiff_t m_bEndMatchNextMapAllVoted = 0x834; // bool
                constexpr std::ptrdiff_t m_foundGoalPositions = 0x835; // bool
            }
            // Parent: CPlayerPawnComponent
            // Fields count: 5
            //
            ...
            namespace CTriggerImpact {
                constexpr std::ptrdiff_t m_flMagnitude = 0xBF0; // float32
                constexpr std::ptrdiff_t m_flNoise = 0xBF4; // float32
                constexpr std::ptrdiff_t m_flViewkick = 0xBF8; // float32
                constexpr std::ptrdiff_t m_pOutputForce = 0xC00; // CEntityOutputTemplate<Vector>
            }
            // Parent: CBaseModelEntity
            // Fields count: 14
            //
            ...
            namespace CTriggerDetectBulletFire {
                constexpr std::ptrdiff_t m_bPlayerFireOnly = 0xBC1; // bool
                constexpr std::ptrdiff_t m_OnDetectedBulletFire = 0xBC8; // CEntityIOOutput
            }
            // Parent: CBaseModelEntity
            // Fields count: 0
            namespace CWorld {
            ...
            namespace CPointGiveAmmo {
                constexpr std::ptrdiff_t m_pActivator = 0x7A4; // CHandle<CBaseEntity>
            }
            ...
            namespace CPathParticleRope {
                constexpr std::ptrdiff_t m_bStartActive = 0x7A4; // bool
                constexpr std::ptrdiff_t m_flMaxSimulationTime = 0x7A8; // float32
                ...
                constexpr std::ptrdiff_t m_flParticleSpacing = 0x7D0; // float32
                constexpr std::ptrdiff_t m_flSlack = 0x7D4; // float32
                constexpr std::ptrdiff_t m_flRadius = 0x7D8; // float32
                constexpr std::ptrdiff_t m_ColorTint = 0x7DC; // Color
                constexpr std::ptrdiff_t m_nEffectState = 0x7E0; // int32
                ...
                constexpr std::ptrdiff_t m_PathNodes_RadiusScale = 0x868; // CNetworkUtlVectorBase<float32>
            }
            // Parent: CBaseEntity
            // Fields count: 6
            //
            ...
            namespace CPlayerVisibility {
                constexpr std::ptrdiff_t m_flVisibilityStrength = 0x7A4; // float32
                constexpr std::ptrdiff_t m_flFogDistanceMultiplier = 0x7A8; // float32
                constexpr std::ptrdiff_t m_flFogMaxDensityMultiplier = 0x7AC; // float32
                constexpr std::ptrdiff_t m_flFadeTime = 0x7B0; // float32
                constexpr std::ptrdiff_t m_bStartDisabled = 0x7B4; // bool
                constexpr std::ptrdiff_t m_bIsEnabled = 0x7B5; // bool
            }
            // Parent: CServerOnlyEntity
            // Fields count: 0
            ...
            namespace CTriggerTeleport {
                constexpr std::ptrdiff_t m_iLandmark = 0xBC8; // CUtlSymbolLarge
                constexpr std::ptrdiff_t m_bUseLandmarkAngles = 0xBD0; // bool
                constexpr std::ptrdiff_t m_bMirrorPlayer = 0xBD1; // bool
            }
            // Parent: CCSPlayerBase_CameraServices
            // Fields count: 0
            ...
            namespace CFuncMover {
                constexpr std::ptrdiff_t m_iszPathName = 0x9F8; // CUtlSymbolLarge
                constexpr std::ptrdiff_t m_hPathMover = 0xA00; // CHandle<CPathMover>
                constexpr std::ptrdiff_t m_iszPathNodeStart = 0xA08; // CUtlSymbolLarge
                constexpr std::ptrdiff_t m_eMoveType = 0xA10; // CFuncMover::Move_t
                constexpr std::ptrdiff_t m_bIsReversing = 0xA14; // bool
                constexpr std::ptrdiff_t m_vTarget = 0xA18; // Vector
                constexpr std::ptrdiff_t m_flStartSpeed = 0xA24; // float32
                constexpr std::ptrdiff_t m_flPathLocation = 0xA28; // float32
                constexpr std::ptrdiff_t m_flT = 0xA2C; // float32
                constexpr std::ptrdiff_t m_nCurrentNodeIndex = 0xA30; // int32
                constexpr std::ptrdiff_t m_nPreviousNodeIndex = 0xA34; // int32
                constexpr std::ptrdiff_t m_bFixedOrientation = 0xA38; // bool
                constexpr std::ptrdiff_t m_bFixedPitch = 0xA39; // bool
                constexpr std::ptrdiff_t m_eSolidType = 0xA3A; // SolidType_t
                constexpr std::ptrdiff_t m_bIsMoving = 0xA3B; // bool
                constexpr std::ptrdiff_t m_flTimeToReachMaxSpeed = 0xA3C; // float32
                constexpr std::ptrdiff_t m_flTimeToReachZeroSpeed = 0xA40; // float32
                constexpr std::ptrdiff_t m_flTimeMovementStart = 0xA44; // GameTime_t
                constexpr std::ptrdiff_t m_flTimeMovementStop = 0xA48; // GameTime_t
                constexpr std::ptrdiff_t m_hStopAtNode = 0xA4C; // CHandle<CMoverPathNode>
                constexpr std::ptrdiff_t m_flPathLocationToBeginStop = 0xA50; // float32
                constexpr std::ptrdiff_t m_bMatchPathNodeUp = 0xA54; // bool
                constexpr std::ptrdiff_t m_bFacePlayer = 0xA55; // bool
                constexpr std::ptrdiff_t m_flTimeStartRoll = 0xA58; // GameTime_t
                constexpr std::ptrdiff_t m_vOriginalUp = 0xA5C; // Vector
                constexpr std::ptrdiff_t m_flTimeToRollToNewUp = 0xA68; // float32
            }
            // Parent: None
            // Fields count: 5
            //
            ...
            namespace CCSGameRules {
                ...
                constexpr std::ptrdiff_t m_hPlayerResource = 0x1548; // CHandle<CBaseEntity>
                constexpr std::ptrdiff_t m_RetakeRules = 0x1550; // CRetakeGameRules
                constexpr std::ptrdiff_t m_arrTeamUniqueKillWeaponsMatch = 0x16E8; // CUtlVector<int32>[4]
                constexpr std::ptrdiff_t m_bTeamLastKillUsedUniqueWeaponMatch = 0x1748; // bool[4]
                constexpr std::ptrdiff_t m_nMatchEndCount = 0x1770; // uint8
                constexpr std::ptrdiff_t m_nTTeamIntroVariant = 0x1774; // int32
                constexpr std::ptrdiff_t m_nCTTeamIntroVariant = 0x1778; // int32
                constexpr std::ptrdiff_t m_bTeamIntroPeriod = 0x177C; // bool
                constexpr std::ptrdiff_t m_fTeamIntroPeriodEnd = 0x1780; // GameTime_t
                constexpr std::ptrdiff_t m_bPlayedTeamIntroVO = 0x1784; // bool
                constexpr std::ptrdiff_t m_iRoundEndWinnerTeam = 0x1788; // int32
                constexpr std::ptrdiff_t m_eRoundEndReason = 0x178C; // int32
                constexpr std::ptrdiff_t m_bRoundEndShowTimerDefend = 0x1790; // bool
                constexpr std::ptrdiff_t m_iRoundEndTimerTime = 0x1794; // int32
                constexpr std::ptrdiff_t m_sRoundEndFunFactToken = 0x1798; // CUtlString
                constexpr std::ptrdiff_t m_iRoundEndFunFactPlayerSlot = 0x17A0; // CPlayerSlot
                constexpr std::ptrdiff_t m_iRoundEndFunFactData1 = 0x17A4; // int32
                constexpr std::ptrdiff_t m_iRoundEndFunFactData2 = 0x17A8; // int32
                constexpr std::ptrdiff_t m_iRoundEndFunFactData3 = 0x17AC; // int32
                constexpr std::ptrdiff_t m_sRoundEndMessage = 0x17B0; // CUtlString
                constexpr std::ptrdiff_t m_iRoundEndPlayerCount = 0x17B8; // int32
                constexpr std::ptrdiff_t m_bRoundEndNoMusic = 0x17BC; // bool
                constexpr std::ptrdiff_t m_iRoundEndLegacy = 0x17C0; // int32
                constexpr std::ptrdiff_t m_nRoundEndCount = 0x17C4; // uint8
                constexpr std::ptrdiff_t m_iRoundStartRoundNumber = 0x17C8; // int32
                constexpr std::ptrdiff_t m_nRoundStartCount = 0x17CC; // uint8
                constexpr std::ptrdiff_t m_flLastPerfSampleTime = 0x57D8; // float64
            }
            // Parent: CPhysicsProp
            // Fields count: 0
            ...
            namespace CAI_ChangeHintGroup {
                constexpr std::ptrdiff_t m_iSearchType = 0x7A4; // int32
                constexpr std::ptrdiff_t m_strSearchName = 0x7A8; // CUtlSymbolLarge
                constexpr std::ptrdiff_t m_strNewHintGroup = 0x7B0; // CUtlSymbolLarge
            ...
            namespace CColorCorrectionVolume {
                constexpr std::ptrdiff_t m_bEnabled = 0xBC1; // bool
                constexpr std::ptrdiff_t m_MaxWeight = 0xBC4; // float32
                constexpr std::ptrdiff_t m_FadeDuration = 0xBC8; // float32
                constexpr std::ptrdiff_t m_bStartDisabled = 0xBCC; // bool
                constexpr std::ptrdiff_t m_Weight = 0xBD0; // float32
                constexpr std::ptrdiff_t m_lookupFilename = 0xBD4; // char[512]
                constexpr std::ptrdiff_t m_LastEnterWeight = 0xDD4; // float32
                constexpr std::ptrdiff_t m_LastEnterTime = 0xDD8; // GameTime_t
                constexpr std::ptrdiff_t m_LastExitWeight = 0xDDC; // float32
                constexpr std::ptrdiff_t m_LastExitTime = 0xDE0; // GameTime_t
            }
            // Parent: CBaseFilter
            // Fields count: 5
            namespace CFilterEnemy {
                constexpr std::ptrdiff_t m_iszEnemyName = 0x7F8; // CUtlSymbolLarge
                constexpr std::ptrdiff_t m_flRadius = 0x800; // float32
                constexpr std::ptrdiff_t m_flOuterRadius = 0x804; // float32
                constexpr std::ptrdiff_t m_nMaxSquadmatesPerEnemy = 0x808; // int32
                constexpr std::ptrdiff_t m_iszPlayerName = 0x810; // CUtlSymbolLarge
            }
            // Parent: CModelPointEntity
            // Fields count: 0
            namespace CShower {
            ...
            namespace CEnvCubemapFog {
                constexpr std::ptrdiff_t m_flEndDistance = 0x7A4; // float32
                constexpr std::ptrdiff_t m_flStartDistance = 0x7A8; // float32
                constexpr std::ptrdiff_t m_flFogFalloffExponent = 0x7AC; // float32
                constexpr std::ptrdiff_t m_bHeightFogEnabled = 0x7B0; // bool
                constexpr std::ptrdiff_t m_flFogHeightWidth = 0x7B4; // float32
                constexpr std::ptrdiff_t m_flFogHeightEnd = 0x7B8; // float32
                constexpr std::ptrdiff_t m_flFogHeightStart = 0x7BC; // float32
                constexpr std::ptrdiff_t m_flFogHeightExponent = 0x7C0; // float32
                constexpr std::ptrdiff_t m_flLODBias = 0x7C4; // float32
                constexpr std::ptrdiff_t m_bActive = 0x7C8; // bool
                constexpr std::ptrdiff_t m_bStartDisabled = 0x7C9; // bool
                constexpr std::ptrdiff_t m_flFogMaxOpacity = 0x7CC; // float32
                constexpr std::ptrdiff_t m_nCubemapSourceType = 0x7D0; // int32
            ...
            namespace CPointCommentaryNode {
                ...
                constexpr std::ptrdiff_t m_flStartTimeInCommentary = 0xCC0; // float32
                constexpr std::ptrdiff_t m_iszTitle = 0xCC8; // CUtlSymbolLarge
                constexpr std::ptrdiff_t m_iszSpeakers = 0xCD0; // CUtlSymbolLarge
                constexpr std::ptrdiff_t m_iNodeNumber = 0xCD8; // int32
                constexpr std::ptrdiff_t m_iNodeNumberMax = 0xCDC; // int32
            ...
            namespace CPointClientUIWorldPanel {
                ...
                constexpr std::ptrdiff_t m_nExplicitImageLayout = 0xBF8; // int32
            }
            // Parent: CBaseFilter
            // Fields count: 1
            namespace CFilterContext {
                constexpr std::ptrdiff_t m_iFilterContext = 0x7F8; // CUtlSymbolLarge
            }
            ...
            namespace CFilterAttributeInt {
                constexpr std::ptrdiff_t m_sAttributeName = 0x7F8; // CUtlStringToken
            }
            // Parent: CPlayerPawnComponent
            // Fields count: 4
            //
            ...
            // Fields count: 6
            namespace CAISound {
                constexpr std::ptrdiff_t m_iSoundType = 0x7A4; // SoundTypes_t
                constexpr std::ptrdiff_t m_iSoundFlags = 0x7A6; // SoundFlags_t
                constexpr std::ptrdiff_t m_iVolume = 0x7A8; // int32
                constexpr std::ptrdiff_t m_iSoundIndex = 0x7AC; // int32
                constexpr std::ptrdiff_t m_flDuration = 0x7B0; // float32
                constexpr std::ptrdiff_t m_iszProxyEntityName = 0x7B8; // CUtlSymbolLarge
            }
            // Parent: CBaseEntity
            // Fields count: 7
            namespace CPointEntityFinder {
                constexpr std::ptrdiff_t m_hEntity = 0x7A4; // CHandle<CBaseEntity>
                constexpr std::ptrdiff_t m_iFilterName = 0x7A8; // CUtlSymbolLarge
                constexpr std::ptrdiff_t m_hFilter = 0x7B0; // CHandle<CBaseFilter>
                constexpr std::ptrdiff_t m_iRefName = 0x7B8; // CUtlSymbolLarge
                constexpr std::ptrdiff_t m_hReference = 0x7C0; // CHandle<CBaseEntity>
                constexpr std::ptrdiff_t m_FindMethod = 0x7C4; // EntFinderMethod_t
                constexpr std::ptrdiff_t m_OnFoundEntity = 0x7C8; // CEntityIOOutput
            }
            // Parent: None
            // Fields count: 12
            //
            ...
            namespace CBaseProp {
                ...
                constexpr std::ptrdiff_t m_iShapeType = 0xBF4; // int32
            ...
            namespace CEnvSky {
                ...
                constexpr std::ptrdiff_t m_flBrightnessScale = 0xA14; // float32
                constexpr std::ptrdiff_t m_nFogType = 0xA18; // int32
                constexpr std::ptrdiff_t m_flFogMinStart = 0xA1C; // float32
                constexpr std::ptrdiff_t m_flFogMinEnd = 0xA20; // float32
                constexpr std::ptrdiff_t m_flFogMaxStart = 0xA24; // float32
                constexpr std::ptrdiff_t m_flFogMaxEnd = 0xA28; // float32
            ...
            namespace CPointVelocitySensor {
                constexpr std::ptrdiff_t m_hTargetEntity = 0x7A4; // CHandle<CBaseEntity>
                constexpr std::ptrdiff_t m_vecAxis = 0x7A8; // Vector
                constexpr std::ptrdiff_t m_bEnabled = 0x7B4; // bool
                constexpr std::ptrdiff_t m_fPrevVelocity = 0x7B8; // float32
                constexpr std::ptrdiff_t m_flAvgInterval = 0x7BC; // float32
                constexpr std::ptrdiff_t m_Velocity = 0x7C0; // CEntityOutputTemplate<float32>
            }
            // Parent: CBaseFilter
            // Fields count: 1
            namespace CFilterMassGreater {
                constexpr std::ptrdiff_t m_fFilterMass = 0x7F8; // float32
            }
            // Parent: CBaseFilter
            // Fields count: 1
            namespace FilterTeam {
                constexpr std::ptrdiff_t m_iFilterTeam = 0x7F8; // int32
            }
            ...
            // Fields count: 1
            namespace CBuyZone {
                constexpr std::ptrdiff_t m_LegacyTeamNum = 0xBC4; // int32
            }
            // Parent: CLogicalEntity
            // Fields count: 12
            ...
            namespace CInfoDynamicShadowHint {
                constexpr std::ptrdiff_t m_bDisabled = 0x7A4; // bool
                constexpr std::ptrdiff_t m_flRange = 0x7A8; // float32
                constexpr std::ptrdiff_t m_nImportance = 0x7AC; // int32
                constexpr std::ptrdiff_t m_nLightChoice = 0x7B0; // int32
                constexpr std::ptrdiff_t m_hLight = 0x7B4; // CHandle<CBaseEntity>
            }
            // Parent: CSoundOpvarSetPointEntity
            // Fields count: 9
            ...
            namespace CFlashbangProjectile {
                constexpr std::ptrdiff_t m_flTimeToDetonate = 0xD90; // float32
                constexpr std::ptrdiff_t m_numOpponentsHit = 0xD94; // uint8
                constexpr std::ptrdiff_t m_numTeammatesHit = 0xD95; // uint8
            }
            ...
            namespace CLogicBranch {
                constexpr std::ptrdiff_t m_bInValue = 0x7A4; // bool
                constexpr std::ptrdiff_t m_Listeners = 0x7A8; // CUtlVector<CHandle<CBaseEntity>>
                constexpr std::ptrdiff_t m_OnTrue = 0x7C0; // CEntityIOOutput
                constexpr std::ptrdiff_t m_OnFalse = 0x7E8; // CEntityIOOutput
            }
            // Parent: CCSWeaponBaseGun
            // Fields count: 0
            ...
            namespace CBaseButton {
                ...
                constexpr std::ptrdiff_t m_sOverrideAnticipationName = 0xAC0; // CUtlSymbolLarge
                constexpr std::ptrdiff_t m_bLocked = 0xAC8; // bool
                constexpr std::ptrdiff_t m_bDisabled = 0xAC9; // bool
                constexpr std::ptrdiff_t m_flUseLockedTime = 0xACC; // GameTime_t
                constexpr std::ptrdiff_t m_bSolidBsp = 0xAD0; // bool
                constexpr std::ptrdiff_t m_OnDamaged = 0xAD8; // CEntityIOOutput
                constexpr std::ptrdiff_t m_OnPressed = 0xB00; // CEntityIOOutput
                constexpr std::ptrdiff_t m_OnUseLocked = 0xB28; // CEntityIOOutput
                constexpr std::ptrdiff_t m_OnIn = 0xB50; // CEntityIOOutput
                constexpr std::ptrdiff_t m_OnOut = 0xB78; // CEntityIOOutput
            ...
            namespace CPhysLength {
                constexpr std::ptrdiff_t m_offset = 0x820; // Vector[2]
                constexpr std::ptrdiff_t m_vecAttach = 0x838; // Vector
                constexpr std::ptrdiff_t m_addLength = 0x844; // float32
                constexpr std::ptrdiff_t m_minLength = 0x848; // float32
                constexpr std::ptrdiff_t m_totalLength = 0x84C; // float32
                constexpr std::ptrdiff_t m_bEnableCollision = 0x850; // bool
            }
            // Parent: CBaseEntity
            // Fields count: 48
            namespace CLogicNPCCounter {
                ...
                constexpr std::ptrdiff_t m_OnFactorAll = 0x7F8; // CEntityOutputTemplate<float32>
                constexpr std::ptrdiff_t m_OnMinPlayerDistAll = 0x820; // CEntityOutputTemplate<float32>
                constexpr std::ptrdiff_t m_OnMinCount_1 = 0x848; // CEntityIOOutput
                constexpr std::ptrdiff_t m_OnMaxCount_1 = 0x870; // CEntityIOOutput
                constexpr std::ptrdiff_t m_OnFactor_1 = 0x898; // CEntityOutputTemplate<float32>
                constexpr std::ptrdiff_t m_OnMinPlayerDist_1 = 0x8C0; // CEntityOutputTemplate<float32>
                constexpr std::ptrdiff_t m_OnMinCount_2 = 0x8E8; // CEntityIOOutput
                constexpr std::ptrdiff_t m_OnMaxCount_2 = 0x910; // CEntityIOOutput
                constexpr std::ptrdiff_t m_OnFactor_2 = 0x938; // CEntityOutputTemplate<float32>
                constexpr std::ptrdiff_t m_OnMinPlayerDist_2 = 0x960; // CEntityOutputTemplate<float32>
                constexpr std::ptrdiff_t m_OnMinCount_3 = 0x988; // CEntityIOOutput
                constexpr std::ptrdiff_t m_OnMaxCount_3 = 0x9B0; // CEntityIOOutput
                constexpr std::ptrdiff_t m_OnFactor_3 = 0x9D8; // CEntityOutputTemplate<float32>
                constexpr std::ptrdiff_t m_OnMinPlayerDist_3 = 0xA00; // CEntityOutputTemplate<float32>
                constexpr std::ptrdiff_t m_hSource = 0xA28; // CEntityHandle
                constexpr std::ptrdiff_t m_iszSourceEntityName = 0xA30; // CUtlSymbolLarge
                constexpr std::ptrdiff_t m_flDistanceMax = 0xA38; // float32
                constexpr std::ptrdiff_t m_bDisabled = 0xA3C; // bool
                constexpr std::ptrdiff_t m_nMinCountAll = 0xA40; // int32
                constexpr std::ptrdiff_t m_nMaxCountAll = 0xA44; // int32
                constexpr std::ptrdiff_t m_nMinFactorAll = 0xA48; // int32
                constexpr std::ptrdiff_t m_nMaxFactorAll = 0xA4C; // int32
                constexpr std::ptrdiff_t m_iszNPCClassname_1 = 0xA58; // CUtlSymbolLarge
                constexpr std::ptrdiff_t m_nNPCState_1 = 0xA60; // int32
                constexpr std::ptrdiff_t m_bInvertState_1 = 0xA64; // bool
                constexpr std::ptrdiff_t m_nMinCount_1 = 0xA68; // int32
                constexpr std::ptrdiff_t m_nMaxCount_1 = 0xA6C; // int32
                constexpr std::ptrdiff_t m_nMinFactor_1 = 0xA70; // int32
                constexpr std::ptrdiff_t m_nMaxFactor_1 = 0xA74; // int32
                constexpr std::ptrdiff_t m_flDefaultDist_1 = 0xA7C; // float32
                constexpr std::ptrdiff_t m_iszNPCClassname_2 = 0xA80; // CUtlSymbolLarge
                constexpr std::ptrdiff_t m_nNPCState_2 = 0xA88; // int32
                constexpr std::ptrdiff_t m_bInvertState_2 = 0xA8C; // bool
                constexpr std::ptrdiff_t m_nMinCount_2 = 0xA90; // int32
                constexpr std::ptrdiff_t m_nMaxCount_2 = 0xA94; // int32
                constexpr std::ptrdiff_t m_nMinFactor_2 = 0xA98; // int32
                constexpr std::ptrdiff_t m_nMaxFactor_2 = 0xA9C; // int32
                constexpr std::ptrdiff_t m_flDefaultDist_2 = 0xAA4; // float32
                constexpr std::ptrdiff_t m_iszNPCClassname_3 = 0xAA8; // CUtlSymbolLarge
                constexpr std::ptrdiff_t m_nNPCState_3 = 0xAB0; // int32
                constexpr std::ptrdiff_t m_bInvertState_3 = 0xAB4; // bool
                constexpr std::ptrdiff_t m_nMinCount_3 = 0xAB8; // int32
                constexpr std::ptrdiff_t m_nMaxCount_3 = 0xABC; // int32
                constexpr std::ptrdiff_t m_nMinFactor_3 = 0xAC0; // int32
                constexpr std::ptrdiff_t m_nMaxFactor_3 = 0xAC4; // int32
                constexpr std::ptrdiff_t m_flDefaultDist_3 = 0xACC; // float32
            }
            ...
            namespace CCSGOViewModel {
                ...
                constexpr std::ptrdiff_t m_nWeaponParity = 0xC3C; // uint32
                constexpr std::ptrdiff_t m_nOldWeaponParity = 0xC40; // uint32
            }
            // Parent: CCSWeaponBaseGun
            // Fields count: 3
            //
            ...
            namespace CWeaponShield {
                constexpr std::ptrdiff_t m_flBulletDamageAbsorbed = 0x11BC; // float32
                constexpr std::ptrdiff_t m_flLastBulletHitSoundTime = 0x11C0; // GameTime_t
                constexpr std::ptrdiff_t m_flDisplayHealth = 0x11C4; // float32
            }
            // Parent: CPointEntity
            // Fields count: 4
            namespace CBlood {
                constexpr std::ptrdiff_t m_vecSprayAngles = 0x7A4; // QAngle
                constexpr std::ptrdiff_t m_vecSprayDir = 0x7B0; // Vector
                constexpr std::ptrdiff_t m_flAmount = 0x7BC; // float32
                constexpr std::ptrdiff_t m_Color = 0x7C0; // BloodType
            }
            // Parent: CLogicalEntity
            // Fields count: 4
            //
            ...
            namespace CEnvFade {
                constexpr std::ptrdiff_t m_fadeColor = 0x7A4; // Color
                constexpr std::ptrdiff_t m_Duration = 0x7A8; // float32
                constexpr std::ptrdiff_t m_HoldDuration = 0x7AC; // float32
                constexpr std::ptrdiff_t m_OnBeginFade = 0x7B0; // CEntityIOOutput
            }
            // Parent: CBaseProp
            // Fields count: 30
            //
            ...
            namespace CBreakableProp {
                constexpr std::ptrdiff_t m_CPropDataComponent = 0xC38; // CPropDataComponent
                constexpr std::ptrdiff_t m_OnBreak = 0xC78; // CEntityIOOutput
                constexpr std::ptrdiff_t m_OnHealthChanged = 0xCA0; // CEntityOutputTemplate<float32>
                constexpr std::ptrdiff_t m_OnTakeDamage = 0xCC8; // CEntityIOOutput
                constexpr std::ptrdiff_t m_impactEnergyScale = 0xCF0; // float32
                constexpr std::ptrdiff_t m_iMinHealthDmg = 0xCF4; // int32
                constexpr std::ptrdiff_t m_preferredCarryAngles = 0xCF8; // QAngle
                constexpr std::ptrdiff_t m_flPressureDelay = 0xD04; // float32
                constexpr std::ptrdiff_t m_flDefBurstScale = 0xD08; // float32
                constexpr std::ptrdiff_t m_vDefBurstOffset = 0xD0C; // Vector
                constexpr std::ptrdiff_t m_hBreaker = 0xD18; // CHandle<CBaseEntity>
                constexpr std::ptrdiff_t m_PerformanceMode = 0xD1C; // PerformanceMode_t
                constexpr std::ptrdiff_t m_flPreventDamageBeforeTime = 0xD20; // GameTime_t
                constexpr std::ptrdiff_t m_bHasBreakPiecesOrCommands = 0xD24; // bool
                constexpr std::ptrdiff_t m_explodeDamage = 0xD28; // float32
                constexpr std::ptrdiff_t m_explodeRadius = 0xD2C; // float32
                constexpr std::ptrdiff_t m_explosionDelay = 0xD34; // float32
                constexpr std::ptrdiff_t m_explosionBuildupSound = 0xD38; // CUtlSymbolLarge
                constexpr std::ptrdiff_t m_explosionCustomEffect = 0xD40; // CUtlSymbolLarge
                constexpr std::ptrdiff_t m_explosionCustomSound = 0xD48; // CUtlSymbolLarge
                constexpr std::ptrdiff_t m_explosionModifier = 0xD50; // CUtlSymbolLarge
                constexpr std::ptrdiff_t m_hPhysicsAttacker = 0xD58; // CHandle<CBasePlayerPawn>
                constexpr std::ptrdiff_t m_flLastPhysicsInfluenceTime = 0xD5C; // GameTime_t
                constexpr std::ptrdiff_t m_bOriginalBlockLOS = 0xD60; // bool
                constexpr std::ptrdiff_t m_flDefaultFadeScale = 0xD64; // float32
                constexpr std::ptrdiff_t m_hLastAttacker = 0xD68; // CHandle<CBaseEntity>
                constexpr std::ptrdiff_t m_hFlareEnt = 0xD6C; // CHandle<CBaseEntity>
                constexpr std::ptrdiff_t m_bUsePuntSound = 0xD70; // bool
                constexpr std::ptrdiff_t m_iszPuntSound = 0xD78; // CUtlSymbolLarge
                constexpr std::ptrdiff_t m_noGhostCollision = 0xD80; // bool
            }
            // Parent: CPlayerPawnComponent
            // Fields count: 1
            //
            ...
            namespace CBaseCombatCharacter {
                ...
                constexpr std::ptrdiff_t m_flFieldOfView = 0xCA0; // float32
                constexpr std::ptrdiff_t m_impactEnergyScale = 0xCA4; // float32
                constexpr std::ptrdiff_t m_LastHitGroup = 0xCA8; // HitGroup_t
                constexpr std::ptrdiff_t m_bApplyStressDamage = 0xCAC; // bool
                constexpr std::ptrdiff_t m_iDamageCount = 0xCF0; // int32
                constexpr std::ptrdiff_t m_pVecRelationships = 0xCF8; // CUtlVector<RelationshipOverride_t>*
                constexpr std::ptrdiff_t m_strRelationships = 0xD00; // CUtlSymbolLarge
                constexpr std::ptrdiff_t m_eHull = 0xD08; // Hull_t
                constexpr std::ptrdiff_t m_nNavHullIdx = 0xD0C; // uint32
            }
            // Parent: CBaseModelEntity
            // Fields count: 25
            //
            ...
            namespace CInferno {
                ...
                constexpr std::ptrdiff_t m_fireCount = 0x1344; // int32
                constexpr std::ptrdiff_t m_nInfernoType = 0x1348; // int32
                constexpr std::ptrdiff_t m_nFireEffectTickBegin = 0x134C; // int32
                constexpr std::ptrdiff_t m_nFireLifetime = 0x1350; // float32
                constexpr std::ptrdiff_t m_bInPostEffectTime = 0x1354; // bool
                constexpr std::ptrdiff_t m_nFiresExtinguishCount = 0x1358; // int32
                ...
                constexpr std::ptrdiff_t m_fireSpawnOffset = 0x15E8; // int32
                constexpr std::ptrdiff_t m_nMaxFlames = 0x15EC; // int32
                constexpr std::ptrdiff_t m_nSpreadCount = 0x15F0; // int32
                ...
                constexpr std::ptrdiff_t m_nSourceItemDefIndex = 0x1628; // uint16
            }
            // Parent: CLogicalEntity
            // Fields count: 5
            namespace CEnvGlobal {
                constexpr std::ptrdiff_t m_outCounter = 0x7A8; // CEntityOutputTemplate<int32>
                constexpr std::ptrdiff_t m_globalstate = 0x7D0; // CUtlSymbolLarge
                constexpr std::ptrdiff_t m_triggermode = 0x7D8; // int32
                constexpr std::ptrdiff_t m_initialstate = 0x7DC; // int32
                constexpr std::ptrdiff_t m_counter = 0x7E0; // int32
            }
            // Parent: CLogicalEntity
            // Fields count: 3
            namespace CBaseFilter {
                constexpr std::ptrdiff_t m_bNegated = 0x7A4; // bool
                constexpr std::ptrdiff_t m_OnPass = 0x7A8; // CEntityIOOutput
                constexpr std::ptrdiff_t m_OnFail = 0x7D0; // CEntityIOOutput
            }
            // Parent: CBaseEntity
            // Fields count: 4
            //
            ...
            namespace CTeam {
                ...
                constexpr std::ptrdiff_t m_iScore = 0x7D8; // int32
            ...
            namespace CInfoDynamicShadowHintBox {
                constexpr std::ptrdiff_t m_vBoxMins = 0x7B8; // Vector
                constexpr std::ptrdiff_t m_vBoxMaxs = 0x7C4; // Vector
            }
            // Parent: CBaseEntity
            // Fields count: 3
            namespace CPathMover {
                constexpr std::ptrdiff_t m_vecPathNodes = 0x7A8; // CUtlVector<CHandle<CMoverPathNode>>
                constexpr std::ptrdiff_t m_flPathLength = 0x7C0; // float32
                constexpr std::ptrdiff_t m_bClosedLoop = 0x7C4; // bool
            }
            // Parent: CBaseCSGrenade
            // Fields count: 0
            ...
            namespace CChicken {
                constexpr std::ptrdiff_t m_AttributeManager = 0xEA8; // CAttributeContainer
                constexpr std::ptrdiff_t m_sActivityFinishedTag = 0x1198; // CUtlStringToken
                constexpr std::ptrdiff_t m_updateTimer = 0x11A0; // CountdownTimer
                constexpr std::ptrdiff_t m_stuckAnchor = 0x11B8; // Vector
                constexpr std::ptrdiff_t m_stuckTimer = 0x11C8; // CountdownTimer
                constexpr std::ptrdiff_t m_collisionStuckTimer = 0x11E0; // CountdownTimer
                constexpr std::ptrdiff_t m_isOnGround = 0x11F8; // bool
                constexpr std::ptrdiff_t m_vFallVelocity = 0x11FC; // Vector
                constexpr std::ptrdiff_t m_desiredActivity = 0x1208; // ChickenActivity
                constexpr std::ptrdiff_t m_currentActivity = 0x120C; // ChickenActivity
                constexpr std::ptrdiff_t m_activityTimer = 0x1210; // CountdownTimer
                constexpr std::ptrdiff_t m_turnRate = 0x1228; // float32
                constexpr std::ptrdiff_t m_fleeFrom = 0x122C; // CHandle<CBaseEntity>
                constexpr std::ptrdiff_t m_moveRateThrottleTimer = 0x1230; // CountdownTimer
                constexpr std::ptrdiff_t m_startleTimer = 0x1248; // CountdownTimer
                constexpr std::ptrdiff_t m_vocalizeTimer = 0x1260; // CountdownTimer
                constexpr std::ptrdiff_t m_flWhenZombified = 0x1278; // GameTime_t
                constexpr std::ptrdiff_t m_jumpedThisFrame = 0x127C; // bool
                constexpr std::ptrdiff_t m_leader = 0x1280; // CHandle<CCSPlayerPawn>
                constexpr std::ptrdiff_t m_reuseTimer = 0x1298; // CountdownTimer
                constexpr std::ptrdiff_t m_hasBeenUsed = 0x12B0; // bool
                constexpr std::ptrdiff_t m_jumpTimer = 0x12B8; // CountdownTimer
                constexpr std::ptrdiff_t m_flLastJumpTime = 0x12D0; // float32
                constexpr std::ptrdiff_t m_bInJump = 0x12D4; // bool
                constexpr std::ptrdiff_t m_isWaitingForLeader = 0x12D5; // bool
                constexpr std::ptrdiff_t m_repathTimer = 0x32E0; // CountdownTimer
                constexpr std::ptrdiff_t m_inhibitDoorTimer = 0x32F8; // CountdownTimer
                constexpr std::ptrdiff_t m_inhibitObstacleAvoidanceTimer = 0x3388; // CountdownTimer
                constexpr std::ptrdiff_t m_vecPathGoal = 0x33A8; // Vector
                constexpr std::ptrdiff_t m_flActiveFollowStartTime = 0x33B4; // GameTime_t
                constexpr std::ptrdiff_t m_followMinuteTimer = 0x33B8; // CountdownTimer
                constexpr std::ptrdiff_t m_vecLastEggPoopPosition = 0x33D0; // Vector
                constexpr std::ptrdiff_t m_vecEggsPooped = 0x33E0; // CUtlVector<CHandle<CBaseEntity>>
                constexpr std::ptrdiff_t m_BlockDirectionTimer = 0x3400; // CountdownTimer
            }
            // Parent: CBaseTrigger
            // Fields count: 7
            namespace CChangeLevel {
                constexpr std::ptrdiff_t m_sMapName = 0xBC8; // CUtlString
                constexpr std::ptrdiff_t m_sLandmarkName = 0xBD0; // CUtlString
                constexpr std::ptrdiff_t m_OnChangeLevel = 0xBD8; // CEntityIOOutput
                constexpr std::ptrdiff_t m_bTouched = 0xC00; // bool
                constexpr std::ptrdiff_t m_bNoTouch = 0xC01; // bool
                constexpr std::ptrdiff_t m_bNewChapter = 0xC02; // bool
                constexpr std::ptrdiff_t m_bOnChangeLevelFired = 0xC03; // bool
            }
            // Parent: CBaseTrigger
            // Fields count: 14
            namespace CTriggerLerpObject {
                constexpr std::ptrdiff_t m_iszLerpTarget = 0xBC8; // CUtlSymbolLarge
                constexpr std::ptrdiff_t m_hLerpTarget = 0xBD0; // CHandle<CBaseEntity>
                constexpr std::ptrdiff_t m_iszLerpTargetAttachment = 0xBD8; // CUtlSymbolLarge
                constexpr std::ptrdiff_t m_hLerpTargetAttachment = 0xBE0; // AttachmentHandle_t
                constexpr std::ptrdiff_t m_flLerpDuration = 0xBE4; // float32
                constexpr std::ptrdiff_t m_bLerpRestoreMoveType = 0xBE8; // bool
                constexpr std::ptrdiff_t m_bSingleLerpObject = 0xBE9; // bool
                constexpr std::ptrdiff_t m_vecLerpingObjects = 0xBF0; // CUtlVector<lerpdata_t>
                constexpr std::ptrdiff_t m_iszLerpEffect = 0xC08; // CUtlSymbolLarge
                constexpr std::ptrdiff_t m_iszLerpSound = 0xC10; // CUtlSymbolLarge
                constexpr std::ptrdiff_t m_bAttachTouchingObject = 0xC18; // bool
                constexpr std::ptrdiff_t m_hEntityToWaitForDisconnect = 0xC1C; // CHandle<CBaseEntity>
                constexpr std::ptrdiff_t m_OnLerpStarted = 0xC20; // CEntityIOOutput
                constexpr std::ptrdiff_t m_OnLerpFinished = 0xC48; // CEntityIOOutput
            }
            // Parent: CBaseToggle
            // Fields count: 12
            //
            ...
            namespace CBaseTrigger {
                ...
                constexpr std::ptrdiff_t m_OnTouchingEachEntity = 0xB58; // CEntityIOOutput
                constexpr std::ptrdiff_t m_OnNotTouching = 0xB80; // CEntityIOOutput
                constexpr std::ptrdiff_t m_hTouchingEntities = 0xBA8; // CUtlVector<CHandle<CBaseEntity>>
                constexpr std::ptrdiff_t m_bClientSidePredicted = 0xBC0; // bool
            }
            // Parent: CPointEntity
            // Fields count: 0
            ...
            namespace CPointWorldText {
                ...
                constexpr std::ptrdiff_t m_flWorldUnitsPerPx = 0xC3C; // float32
                constexpr std::ptrdiff_t m_flFontSize = 0xC40; // float32
                constexpr std::ptrdiff_t m_flDepthOffset = 0xC44; // float32
            ...
            namespace CSoundAreaEntityOrientedBox {
                constexpr std::ptrdiff_t m_vMin = 0x7BC; // Vector
                constexpr std::ptrdiff_t m_vMax = 0x7C8; // Vector
            }
            // Parent: CBaseTrigger
            // Fields count: 13
            //
            ...
            namespace CTriggerPhysics {
                constexpr std::ptrdiff_t m_gravityScale = 0xBD8; // float32
                constexpr std::ptrdiff_t m_linearLimit = 0xBDC; // float32
                constexpr std::ptrdiff_t m_linearDamping = 0xBE0; // float32
                constexpr std::ptrdiff_t m_angularLimit = 0xBE4; // float32
                constexpr std::ptrdiff_t m_angularDamping = 0xBE8; // float32
                constexpr std::ptrdiff_t m_linearForce = 0xBEC; // float32
                constexpr std::ptrdiff_t m_flFrequency = 0xBF0; // float32
                constexpr std::ptrdiff_t m_flDampingRatio = 0xBF4; // float32
                constexpr std::ptrdiff_t m_vecLinearForcePointAt = 0xBF8; // Vector
                constexpr std::ptrdiff_t m_bCollapseToForcePoint = 0xC04; // bool
                constexpr std::ptrdiff_t m_vecLinearForcePointAtWorld = 0xC08; // Vector
                constexpr std::ptrdiff_t m_vecLinearForceDirection = 0xC14; // Vector
                constexpr std::ptrdiff_t m_bConvertToDebrisWhenPossible = 0xC20; // bool
            }
            // Parent: None
            // Fields count: 2
            //
            ...
            namespace CSoundEventSphereEntity {
                constexpr std::ptrdiff_t m_flRadius = 0x850; // float32
            }
            // Parent: CCSWeaponBaseGun
            // Fields count: 0
            ...
            namespace CPlantedC4 {
                ...
                constexpr std::ptrdiff_t m_nBombSite = 0xBF8; // int32
                constexpr std::ptrdiff_t m_nSourceSoundscapeHash = 0xBFC; // int32
                ...
                constexpr std::ptrdiff_t m_iProgressBarTime = 0xCC8; // int32
            ...
            namespace CPointCameraVFOV {
                constexpr std::ptrdiff_t m_flVerticalFOV = 0x808; // float32
            }
            // Parent: CCSWeaponBaseGun
            // Fields count: 2
            //
            ...
            namespace CBreakable {
                constexpr std::ptrdiff_t m_CPropDataComponent = 0xA00; // CPropDataComponent
                constexpr std::ptrdiff_t m_Material = 0xA40; // Materials
                constexpr std::ptrdiff_t m_hBreaker = 0xA44; // CHandle<CBaseEntity>
                constexpr std::ptrdiff_t m_Explosion = 0xA48; // Explosions
                constexpr std::ptrdiff_t m_iszSpawnObject = 0xA50; // CUtlSymbolLarge
                constexpr std::ptrdiff_t m_flPressureDelay = 0xA58; // float32
                constexpr std::ptrdiff_t m_iMinHealthDmg = 0xA5C; // int32
                constexpr std::ptrdiff_t m_iszPropData = 0xA60; // CUtlSymbolLarge
                constexpr std::ptrdiff_t m_impactEnergyScale = 0xA68; // float32
                constexpr std::ptrdiff_t m_nOverrideBlockLOS = 0xA6C; // EOverrideBlockLOS_t
                constexpr std::ptrdiff_t m_OnBreak = 0xA70; // CEntityIOOutput
                constexpr std::ptrdiff_t m_OnHealthChanged = 0xA98; // CEntityOutputTemplate<float32>
                constexpr std::ptrdiff_t m_PerformanceMode = 0xAC0; // PerformanceMode_t
                constexpr std::ptrdiff_t m_hPhysicsAttacker = 0xAC4; // CHandle<CBasePlayerPawn>
                constexpr std::ptrdiff_t m_flLastPhysicsInfluenceTime = 0xAC8; // GameTime_t
            }
            // Parent: CBaseModelEntity
            // Fields count: 16
            namespace CBaseToggle {
                constexpr std::ptrdiff_t m_toggle_state = 0x9F8; // TOGGLE_STATE
                constexpr std::ptrdiff_t m_flMoveDistance = 0x9FC; // float32
                constexpr std::ptrdiff_t m_flWait = 0xA00; // float32
                constexpr std::ptrdiff_t m_flLip = 0xA04; // float32
                ...
                constexpr std::ptrdiff_t m_flHeight = 0xA48; // float32
                ...
                constexpr std::ptrdiff_t m_movementType = 0xA68; // int32
            ...
            namespace CMomentaryRotButton {
                ...
                constexpr std::ptrdiff_t m_OnUnpressed = 0xBF0; // CEntityIOOutput
                constexpr std::ptrdiff_t m_OnFullyOpen = 0xC18; // CEntityIOOutput
                constexpr std::ptrdiff_t m_OnFullyClosed = 0xC40; // CEntityIOOutput
                constexpr std::ptrdiff_t m_OnReachedPosition = 0xC68; // CEntityIOOutput
                constexpr std::ptrdiff_t m_lastUsed = 0xC90; // int32
                constexpr std::ptrdiff_t m_start = 0xC94; // QAngle
                constexpr std::ptrdiff_t m_end = 0xCA0; // QAngle
                constexpr std::ptrdiff_t m_IdealYaw = 0xCAC; // float32
                constexpr std::ptrdiff_t m_sNoise = 0xCB0; // CUtlSymbolLarge
                constexpr std::ptrdiff_t m_bUpdateTarget = 0xCB8; // bool
                constexpr std::ptrdiff_t m_direction = 0xCBC; // int32
                constexpr std::ptrdiff_t m_returnSpeed = 0xCC0; // float32
                constexpr std::ptrdiff_t m_flStartPosition = 0xCC4; // float32
            }
            // Parent: CEntityComponent
            // Fields count: 10
            ...
            namespace CTextureBasedAnimatable {
                ...
                constexpr std::ptrdiff_t m_flFPS = 0x9FC; // float32
                ...
                constexpr std::ptrdiff_t m_flStartTime = 0xA28; // float32
                constexpr std::ptrdiff_t m_flStartFrame = 0xA2C; // float32
            }
            // Parent: CMarkupVolumeTagged
            // Fields count: 3
            namespace CMarkupVolumeWithRef {
                ...
                constexpr std::ptrdiff_t m_flRefDot = 0xA44; // float32
            }
            // Parent: CPhysForce
            // Fields count: 1
            ...
            namespace CCitadelSoundOpvarSetOBB {
                ...
                constexpr std::ptrdiff_t m_iszOperatorName = 0x7B0; // CUtlSymbolLarge
                constexpr std::ptrdiff_t m_iszOpvarName = 0x7B8; // CUtlSymbolLarge
                constexpr std::ptrdiff_t m_vDistanceInnerMins = 0x7C0; // Vector
                constexpr std::ptrdiff_t m_vDistanceInnerMaxs = 0x7CC; // Vector
                constexpr std::ptrdiff_t m_vDistanceOuterMins = 0x7D8; // Vector
                constexpr std::ptrdiff_t m_vDistanceOuterMaxs = 0x7E4; // Vector
                constexpr std::ptrdiff_t m_nAABBDirection = 0x7F0; // int32
            }
            // Parent: None
            // Fields count: 5
            //
            ...
            namespace CShatterGlassShardPhysics {
                constexpr std::ptrdiff_t m_bDebris = 0xEEF; // bool
                constexpr std::ptrdiff_t m_hParentShard = 0xEF0; // uint32
                constexpr std::ptrdiff_t m_ShardDesc = 0xEF8; // shard_model_desc_t
            }
            // Parent: CBaseFilter
            // Fields count: 1
            namespace CFilterModel {
                constexpr std::ptrdiff_t m_iFilterModel = 0x7F8; // CUtlSymbolLarge
            }
            ...
            namespace CCSPlayerPawnBase {
                constexpr std::ptrdiff_t m_CTouchExpansionComponent = 0xEB8; // CTouchExpansionComponent
                constexpr std::ptrdiff_t m_pPingServices = 0xF08; // CCSPlayer_PingServices*
                constexpr std::ptrdiff_t m_pViewModelServices = 0xF10; // CPlayer_ViewModelServices*
                constexpr std::ptrdiff_t m_blindUntilTime = 0xF18; // GameTime_t
                constexpr std::ptrdiff_t m_blindStartTime = 0xF1C; // GameTime_t
                constexpr std::ptrdiff_t m_iPlayerState = 0xF20; // CSPlayerState
                constexpr std::ptrdiff_t m_bRespawning = 0xFD0; // bool
                constexpr std::ptrdiff_t m_fImmuneToGunGameDamageTime = 0xFD4; // GameTime_t
                constexpr std::ptrdiff_t m_bGunGameImmunity = 0xFD8; // bool
                constexpr std::ptrdiff_t m_fMolotovDamageTime = 0xFDC; // float32
                constexpr std::ptrdiff_t m_bHasMovedSinceSpawn = 0xFE0; // bool
                constexpr std::ptrdiff_t m_iNumSpawns = 0xFE4; // int32
                constexpr std::ptrdiff_t m_flIdleTimeSinceLastAction = 0xFEC; // float32
                constexpr std::ptrdiff_t m_fNextRadarUpdateTime = 0xFF0; // float32
                constexpr std::ptrdiff_t m_flFlashDuration = 0xFF4; // float32
                constexpr std::ptrdiff_t m_flFlashMaxAlpha = 0xFF8; // float32
                constexpr std::ptrdiff_t m_flProgressBarStartTime = 0xFFC; // float32
                constexpr std::ptrdiff_t m_iProgressBarDuration = 0x1000; // int32
                constexpr std::ptrdiff_t m_angEyeAngles = 0x1004; // QAngle
                constexpr std::ptrdiff_t m_wasNotKilledNaturally = 0x1010; // bool
                constexpr std::ptrdiff_t m_bCommittingSuicideOnTeamChange = 0x1011; // bool
                constexpr std::ptrdiff_t m_hOriginalController = 0x1014; // CHandle<CCSPlayerController>
            }
            // Parent: CPointEntity
            // Fields count: 9
            ...
            namespace COmniLight {
                constexpr std::ptrdiff_t m_flInnerAngle = 0xC20; // float32
                constexpr std::ptrdiff_t m_flOuterAngle = 0xC24; // float32
            ...
            namespace CInfoOffscreenPanoramaTexture {
                constexpr std::ptrdiff_t m_bDisabled = 0x7A4; // bool
                constexpr std::ptrdiff_t m_nResolutionX = 0x7A8; // int32
                constexpr std::ptrdiff_t m_nResolutionY = 0x7AC; // int32
                constexpr std::ptrdiff_t m_szLayoutFileName = 0x7B0; // CUtlSymbolLarge
                constexpr std::ptrdiff_t m_RenderAttrName = 0x7B8; // CUtlSymbolLarge
                constexpr std::ptrdiff_t m_TargetEntities = 0x7C0; // CNetworkUtlVectorBase<CHandle<CBaseModelEntity>>
                constexpr std::ptrdiff_t m_nTargetChangeCount = 0x7D8; // int32
                constexpr std::ptrdiff_t m_vecCSSClasses = 0x7E0; // CNetworkUtlVectorBase<CUtlSymbolLarge>
                constexpr std::ptrdiff_t m_szTargetsName = 0x7F8; // CUtlSymbolLarge
                constexpr std::ptrdiff_t m_AdditionalTargetEntities = 0x800; // CUtlVector<CHandle<CBaseModelEntity>>
            }
            // Parent: CBaseEntity
            // Fields count: 3
            //
            ...
            namespace CInfoVisibilityBox {
                constexpr std::ptrdiff_t m_nMode = 0x7A8; // int32
                constexpr std::ptrdiff_t m_vBoxSize = 0x7AC; // Vector
                constexpr std::ptrdiff_t m_bEnabled = 0x7B8; // bool
            }
            // Parent: CRulePointEntity
            // Fields count: 0
            ...
            namespace CEntityFlame {
                constexpr std::ptrdiff_t m_hEntAttached = 0x7A4; // CHandle<CBaseEntity>
                constexpr std::ptrdiff_t m_bCheapEffect = 0x7A8; // bool
                constexpr std::ptrdiff_t m_flSize = 0x7AC; // float32
                constexpr std::ptrdiff_t m_bUseHitboxes = 0x7B0; // bool
                constexpr std::ptrdiff_t m_iNumHitboxFires = 0x7B4; // int32
                constexpr std::ptrdiff_t m_flHitboxFireScale = 0x7B8; // float32
                constexpr std::ptrdiff_t m_flLifetime = 0x7BC; // GameTime_t
                constexpr std::ptrdiff_t m_hAttacker = 0x7C0; // CHandle<CBaseEntity>
                constexpr std::ptrdiff_t m_iDangerSound = 0x7C4; // int32
                constexpr std::ptrdiff_t m_flDirectDamagePerSecond = 0x7C8; // float32
                constexpr std::ptrdiff_t m_iCustomDamageType = 0x7CC; // int32
            }
            // Parent: CCSWeaponBase
            // Fields count: 9
            //
            ...
            namespace CCSWeaponBaseGun {
                constexpr std::ptrdiff_t m_zoomLevel = 0x11A0; // int32
                constexpr std::ptrdiff_t m_iBurstShotsRemaining = 0x11A4; // int32
                constexpr std::ptrdiff_t m_silencedModelIndex = 0x11B0; // int32
                constexpr std::ptrdiff_t m_inPrecache = 0x11B4; // bool
                constexpr std::ptrdiff_t m_bNeedsBoltAction = 0x11B5; // bool
                constexpr std::ptrdiff_t m_bSkillReloadAvailable = 0x11B6; // bool
                constexpr std::ptrdiff_t m_bSkillReloadLiftedReloadKey = 0x11B7; // bool
                constexpr std::ptrdiff_t m_bSkillBoltInterruptAvailable = 0x11B8; // bool
                constexpr std::ptrdiff_t m_bSkillBoltLiftedFireKey = 0x11B9; // bool
            }
            // Parent: None
            // Fields count: 13
            namespace CBot {
                ...
                constexpr std::ptrdiff_t m_forwardSpeed = 0xAC; // float32
                constexpr std::ptrdiff_t m_leftSpeed = 0xB0; // float32
                constexpr std::ptrdiff_t m_verticalSpeed = 0xB4; // float32
                constexpr std::ptrdiff_t m_buttonFlags = 0xB8; // uint64
                constexpr std::ptrdiff_t m_jumpTimestamp = 0xC0; // float32
                constexpr std::ptrdiff_t m_viewForward = 0xC4; // Vector
                constexpr std::ptrdiff_t m_postureStackIndex = 0xE0; // int32
            }
            // Parent: None
            // Fields count: 11
            //
            ...
            namespace CSoundEventParameter {
                ...
                constexpr std::ptrdiff_t m_flFloatValue = 0x7B8; // float32
            }
            ...
            namespace CTestEffect {
                constexpr std::ptrdiff_t m_iLoop = 0x7A4; // int32
                constexpr std::ptrdiff_t m_iBeam = 0x7A8; // int32
            ...
            namespace CConstraintAnchor {
                constexpr std::ptrdiff_t m_massScale = 0xBF0; // float32
            }
            // Parent: CCSWeaponBaseGun
            // Fields count: 0
            ...
            namespace CSceneEntity {
                ...
                constexpr std::ptrdiff_t m_sTargetAttachment = 0x820; // CUtlSymbolLarge
                constexpr std::ptrdiff_t m_bIsPlayingBack = 0x828; // bool
                constexpr std::ptrdiff_t m_bPaused = 0x829; // bool
                constexpr std::ptrdiff_t m_bMultiplayer = 0x82A; // bool
                constexpr std::ptrdiff_t m_bAutogenerated = 0x82B; // bool
                constexpr std::ptrdiff_t m_flForceClientTime = 0x82C; // float32
                constexpr std::ptrdiff_t m_flCurrentTime = 0x830; // float32
                constexpr std::ptrdiff_t m_flFrameTime = 0x834; // float32
                constexpr std::ptrdiff_t m_bCancelAtNextInterrupt = 0x838; // bool
                constexpr std::ptrdiff_t m_fPitch = 0x83C; // float32
                constexpr std::ptrdiff_t m_bAutomated = 0x840; // bool
                constexpr std::ptrdiff_t m_nAutomatedAction = 0x844; // int32
                constexpr std::ptrdiff_t m_flAutomationDelay = 0x848; // float32
                constexpr std::ptrdiff_t m_flAutomationTime = 0x84C; // float32
                constexpr std::ptrdiff_t m_hWaitingForThisResumeScene = 0x850; // CHandle<CBaseEntity>
                constexpr std::ptrdiff_t m_bWaitingForResumeScene = 0x854; // bool
                constexpr std::ptrdiff_t m_bPausedViaInput = 0x855; // bool
                constexpr std::ptrdiff_t m_bPauseAtNextInterrupt = 0x856; // bool
                constexpr std::ptrdiff_t m_bWaitingForActor = 0x857; // bool
                constexpr std::ptrdiff_t m_bWaitingForInterrupt = 0x858; // bool
                constexpr std::ptrdiff_t m_bInterruptedActorsScenes = 0x859; // bool
                constexpr std::ptrdiff_t m_bBreakOnNonIdle = 0x85A; // bool
                constexpr std::ptrdiff_t m_bSceneFinished = 0x85B; // bool
                constexpr std::ptrdiff_t m_hActorList = 0x860; // CNetworkUtlVectorBase<CHandle<CBaseFlex>>
                constexpr std::ptrdiff_t m_hRemoveActorList = 0x878; // CUtlVector<CHandle<CBaseEntity>>
                constexpr std::ptrdiff_t m_nSceneFlushCounter = 0x8C0; // int32
                constexpr std::ptrdiff_t m_nSceneStringIndex = 0x8C4; // uint16
                constexpr std::ptrdiff_t m_OnStart = 0x8C8; // CEntityIOOutput
                constexpr std::ptrdiff_t m_OnCompletion = 0x8F0; // CEntityIOOutput
                constexpr std::ptrdiff_t m_OnCanceled = 0x918; // CEntityIOOutput
                constexpr std::ptrdiff_t m_OnPaused = 0x940; // CEntityIOOutput
                constexpr std::ptrdiff_t m_OnResumed = 0x968; // CEntityIOOutput
                constexpr std::ptrdiff_t m_OnTrigger = 0x990; // CEntityIOOutput[16]
                constexpr std::ptrdiff_t m_hInterruptScene = 0xCA0; // CHandle<CSceneEntity>
                constexpr std::ptrdiff_t m_nInterruptCount = 0xCA4; // int32
                constexpr std::ptrdiff_t m_bSceneMissing = 0xCA8; // bool
                constexpr std::ptrdiff_t m_bInterrupted = 0xCA9; // bool
                constexpr std::ptrdiff_t m_bCompletedEarly = 0xCAA; // bool
                constexpr std::ptrdiff_t m_bInterruptSceneFinished = 0xCAB; // bool
                constexpr std::ptrdiff_t m_bRestoring = 0xCAC; // bool
                constexpr std::ptrdiff_t m_hNotifySceneCompletion = 0xCB0; // CUtlVector<CHandle<CSceneEntity>>
                constexpr std::ptrdiff_t m_hListManagers = 0xCC8; // CUtlVector<CHandle<CSceneListManager>>
                constexpr std::ptrdiff_t m_iszSoundName = 0xCE0; // CUtlSymbolLarge
                constexpr std::ptrdiff_t m_iszSequenceName = 0xCE8; // CUtlSymbolLarge
                constexpr std::ptrdiff_t m_hActor = 0xCF0; // CHandle<CBaseFlex>
                constexpr std::ptrdiff_t m_hActivator = 0xCF4; // CHandle<CBaseEntity>
                constexpr std::ptrdiff_t m_BusyActor = 0xCF8; // int32
                constexpr std::ptrdiff_t m_iPlayerDeathBehavior = 0xCFC; // SceneOnPlayerDeath_t
            }
            ...
            namespace CLogicActiveAutosave {
                constexpr std::ptrdiff_t m_TriggerHitPoints = 0x7B0; // int32
                constexpr std::ptrdiff_t m_flTimeToTrigger = 0x7B4; // float32
                constexpr std::ptrdiff_t m_flStartTime = 0x7B8; // GameTime_t
                constexpr std::ptrdiff_t m_flDangerousTime = 0x7BC; // float32
            }
            // Parent: CBaseEntity
            // Fields count: 2
            namespace CEnvBeverage {
                constexpr std::ptrdiff_t m_CanInDispenser = 0x7A4; // bool
                constexpr std::ptrdiff_t m_nBeverageType = 0x7A8; // int32
            }
            // Parent: CBaseEntity
            // Fields count: 14
            //
            ...
            namespace CVoteController {
                constexpr std::ptrdiff_t m_iActiveIssueIndex = 0x7A4; // int32
                constexpr std::ptrdiff_t m_iOnlyTeamToVote = 0x7A8; // int32
                constexpr std::ptrdiff_t m_nVoteOptionCount = 0x7AC; // int32[5]
                constexpr std::ptrdiff_t m_nPotentialVotes = 0x7C0; // int32
                constexpr std::ptrdiff_t m_bIsYesNoVote = 0x7C4; // bool
                constexpr std::ptrdiff_t m_acceptingVotesTimer = 0x7C8; // CountdownTimer
                constexpr std::ptrdiff_t m_executeCommandTimer = 0x7E0; // CountdownTimer
                constexpr std::ptrdiff_t m_resetVoteTimer = 0x7F8; // CountdownTimer
                constexpr std::ptrdiff_t m_nVotesCast = 0x810; // int32[64]
                constexpr std::ptrdiff_t m_playerHoldingVote = 0x910; // CPlayerSlot
                constexpr std::ptrdiff_t m_playerOverrideForVote = 0x914; // CPlayerSlot
                constexpr std::ptrdiff_t m_nHighestCountIndex = 0x918; // int32
                constexpr std::ptrdiff_t m_potentialIssues = 0x920; // CUtlVector<CBaseIssue*>
                constexpr std::ptrdiff_t m_VoteOptions = 0x938; // CUtlVector<char*>
            }
            // Parent: CCSWeaponBaseGun
            // Fields count: 0
            ...
            namespace CBaseFlex {
                constexpr std::ptrdiff_t m_flexWeight = 0xBF0; // CNetworkUtlVectorBase<float32>
                ...
                constexpr std::ptrdiff_t m_nNextSceneEventId = 0xC70; // SceneEventId_t
                constexpr std::ptrdiff_t m_bUpdateLayerPriorities = 0xC74; // bool
            }
            // Parent: CTriggerHurt
            // Fields count: 1
            namespace CScriptTriggerHurt {
                constexpr std::ptrdiff_t m_vExtent = 0xC60; // Vector
            }
            ...
            namespace CMathColorBlend {
                constexpr std::ptrdiff_t m_flInMin = 0x7A4; // float32
                constexpr std::ptrdiff_t m_flInMax = 0x7A8; // float32
                constexpr std::ptrdiff_t m_OutColor1 = 0x7AC; // Color
                constexpr std::ptrdiff_t m_OutColor2 = 0x7B0; // Color
            ...
            namespace CEnvScreenOverlay {
                ...
                constexpr std::ptrdiff_t m_flOverlayTimes = 0x7F8; // float32[10]
                constexpr std::ptrdiff_t m_flStartTime = 0x820; // GameTime_t
                constexpr std::ptrdiff_t m_iDesiredOverlay = 0x824; // int32
            ...
            namespace CCSPlayerPawn {
                constexpr std::ptrdiff_t m_pBulletServices = 0x1020; // CCSPlayer_BulletServices*
                constexpr std::ptrdiff_t m_pHostageServices = 0x1028; // CCSPlayer_HostageServices*
                constexpr std::ptrdiff_t m_pBuyServices = 0x1030; // CCSPlayer_BuyServices*
                constexpr std::ptrdiff_t m_pActionTrackingServices = 0x1038; // CCSPlayer_ActionTrackingServices*
                constexpr std::ptrdiff_t m_pRadioServices = 0x1040; // CCSPlayer_RadioServices*
                constexpr std::ptrdiff_t m_pDamageReactServices = 0x1048; // CCSPlayer_DamageReactServices*
                constexpr std::ptrdiff_t m_nCharacterDefIndex = 0x1050; // uint16
                constexpr std::ptrdiff_t m_bHasFemaleVoice = 0x1052; // bool
                constexpr std::ptrdiff_t m_strVOPrefix = 0x1058; // CUtlString
                constexpr std::ptrdiff_t m_szLastPlaceName = 0x1060; // char[18]
                constexpr std::ptrdiff_t m_bInHostageResetZone = 0x1120; // bool
                constexpr std::ptrdiff_t m_bInBuyZone = 0x1121; // bool
                constexpr std::ptrdiff_t m_TouchingBuyZones = 0x1128; // CUtlVector<CHandle<CBaseEntity>>
                constexpr std::ptrdiff_t m_bWasInBuyZone = 0x1140; // bool
                constexpr std::ptrdiff_t m_bInHostageRescueZone = 0x1141; // bool
                constexpr std::ptrdiff_t m_bInBombZone = 0x1142; // bool
                constexpr std::ptrdiff_t m_bWasInHostageRescueZone = 0x1143; // bool
                constexpr std::ptrdiff_t m_iRetakesOffering = 0x1144; // int32
                constexpr std::ptrdiff_t m_iRetakesOfferingCard = 0x1148; // int32
                constexpr std::ptrdiff_t m_bRetakesHasDefuseKit = 0x114C; // bool
                constexpr std::ptrdiff_t m_bRetakesMVPLastRound = 0x114D; // bool
                constexpr std::ptrdiff_t m_iRetakesMVPBoostItem = 0x1150; // int32
                constexpr std::ptrdiff_t m_RetakesMVPBoostExtraUtility = 0x1154; // loadout_slot_t
                constexpr std::ptrdiff_t m_flHealthShotBoostExpirationTime = 0x1158; // GameTime_t
                constexpr std::ptrdiff_t m_flLandingTimeSeconds = 0x115C; // float32
                constexpr std::ptrdiff_t m_aimPunchAngle = 0x1160; // QAngle
                constexpr std::ptrdiff_t m_aimPunchAngleVel = 0x116C; // QAngle
                constexpr std::ptrdiff_t m_aimPunchTickBase = 0x1178; // int32
                constexpr std::ptrdiff_t m_aimPunchTickFraction = 0x117C; // float32
                constexpr std::ptrdiff_t m_aimPunchCache = 0x1180; // CUtlVector<QAngle>
                constexpr std::ptrdiff_t m_bIsBuyMenuOpen = 0x1198; // bool
                constexpr std::ptrdiff_t m_xLastHeadBoneTransform = 0x17E0; // CTransform
                constexpr std::ptrdiff_t m_bLastHeadBoneTransformIsValid = 0x1800; // bool
                constexpr std::ptrdiff_t m_lastLandTime = 0x1804; // GameTime_t
                constexpr std::ptrdiff_t m_bOnGroundLastTick = 0x1808; // bool
                constexpr std::ptrdiff_t m_iPlayerLocked = 0x180C; // int32
                constexpr std::ptrdiff_t m_flTimeOfLastInjury = 0x1814; // GameTime_t
                constexpr std::ptrdiff_t m_flNextSprayDecalTime = 0x1818; // GameTime_t
                constexpr std::ptrdiff_t m_bNextSprayDecalTimeExpedited = 0x181C; // bool
                constexpr std::ptrdiff_t m_nRagdollDamageBone = 0x1820; // int32
                constexpr std::ptrdiff_t m_vRagdollDamageForce = 0x1824; // Vector
                constexpr std::ptrdiff_t m_vRagdollDamagePosition = 0x1830; // Vector
                constexpr std::ptrdiff_t m_szRagdollDamageWeaponName = 0x183C; // char[64]
                constexpr std::ptrdiff_t m_bRagdollDamageHeadshot = 0x187C; // bool
                constexpr std::ptrdiff_t m_vRagdollServerOrigin = 0x1880; // Vector
                constexpr std::ptrdiff_t m_EconGloves = 0x1890; // CEconItemView
                constexpr std::ptrdiff_t m_nEconGlovesChanged = 0x1B08; // uint8
                constexpr std::ptrdiff_t m_qDeathEyeAngles = 0x1B0C; // QAngle
                constexpr std::ptrdiff_t m_bSkipOneHeadConstraintUpdate = 0x1B18; // bool
                constexpr std::ptrdiff_t m_bLeftHanded = 0x1B19; // bool
                constexpr std::ptrdiff_t m_fSwitchedHandednessTime = 0x1B1C; // GameTime_t
                constexpr std::ptrdiff_t m_flViewmodelOffsetX = 0x1B20; // float32
                constexpr std::ptrdiff_t m_flViewmodelOffsetY = 0x1B24; // float32
                constexpr std::ptrdiff_t m_flViewmodelOffsetZ = 0x1B28; // float32
                constexpr std::ptrdiff_t m_flViewmodelFOV = 0x1B2C; // float32
                constexpr std::ptrdiff_t m_bIsWalking = 0x1B30; // bool
                constexpr std::ptrdiff_t m_fLastGivenDefuserTime = 0x1B34; // float32
                constexpr std::ptrdiff_t m_fLastGivenBombTime = 0x1B38; // float32
                constexpr std::ptrdiff_t m_flDealtDamageToEnemyMostRecentTimestamp = 0x1B3C; // float32
                constexpr std::ptrdiff_t m_iDisplayHistoryBits = 0x1B40; // uint32
                constexpr std::ptrdiff_t m_flLastAttackedTeammate = 0x1B44; // float32
                constexpr std::ptrdiff_t m_allowAutoFollowTime = 0x1B48; // GameTime_t
                constexpr std::ptrdiff_t m_bResetArmorNextSpawn = 0x1B4C; // bool
                constexpr std::ptrdiff_t m_nLastKillerIndex = 0x1B50; // CEntityIndex
                ...
                constexpr std::ptrdiff_t m_bIsScoped = 0x1B74; // bool
                constexpr std::ptrdiff_t m_bResumeZoom = 0x1B75; // bool
                constexpr std::ptrdiff_t m_bIsDefusing = 0x1B76; // bool
                constexpr std::ptrdiff_t m_bIsGrabbingHostage = 0x1B77; // bool
                constexpr std::ptrdiff_t m_iBlockingUseActionInProgress = 0x1B78; // CSPlayerBlockingUseAction_t
                constexpr std::ptrdiff_t m_flEmitSoundTime = 0x1B7C; // GameTime_t
                constexpr std::ptrdiff_t m_bInNoDefuseArea = 0x1B80; // bool
                constexpr std::ptrdiff_t m_iBombSiteIndex = 0x1B84; // CEntityIndex
                constexpr std::ptrdiff_t m_nWhichBombZone = 0x1B88; // int32
                constexpr std::ptrdiff_t m_bInBombZoneTrigger = 0x1B8C; // bool
                constexpr std::ptrdiff_t m_bWasInBombZoneTrigger = 0x1B8D; // bool
                constexpr std::ptrdiff_t m_iShotsFired = 0x1B90; // int32
                constexpr std::ptrdiff_t m_flFlinchStack = 0x1B94; // float32
                constexpr std::ptrdiff_t m_flVelocityModifier = 0x1B98; // float32
                constexpr std::ptrdiff_t m_flHitHeading = 0x1B9C; // float32
                constexpr std::ptrdiff_t m_nHitBodyPart = 0x1BA0; // int32
                constexpr std::ptrdiff_t m_vecTotalBulletForce = 0x1BA4; // Vector
                constexpr std::ptrdiff_t m_bWaitForNoAttack = 0x1BB0; // bool
                constexpr std::ptrdiff_t m_ignoreLadderJumpTime = 0x1BB4; // float32
                constexpr std::ptrdiff_t m_bKilledByHeadshot = 0x1BB8; // bool
                constexpr std::ptrdiff_t m_LastHitBox = 0x1BBC; // int32
                constexpr std::ptrdiff_t m_LastHealth = 0x1BC0; // int32
                constexpr std::ptrdiff_t m_pBot = 0x1BC8; // CCSBot*
                constexpr std::ptrdiff_t m_bBotAllowActive = 0x1BD0; // bool
                constexpr std::ptrdiff_t m_thirdPersonHeading = 0x1BD4; // QAngle
                constexpr std::ptrdiff_t m_flSlopeDropOffset = 0x1BE0; // float32
                constexpr std::ptrdiff_t m_flSlopeDropHeight = 0x1BE4; // float32
                constexpr std::ptrdiff_t m_vHeadConstraintOffset = 0x1BE8; // Vector
                constexpr std::ptrdiff_t m_nLastPickupPriority = 0x1BF4; // int32
                constexpr std::ptrdiff_t m_flLastPickupPriorityTime = 0x1BF8; // float32
                constexpr std::ptrdiff_t m_ArmorValue = 0x1BFC; // int32
                constexpr std::ptrdiff_t m_unCurrentEquipmentValue = 0x1C00; // uint16
                constexpr std::ptrdiff_t m_unRoundStartEquipmentValue = 0x1C02; // uint16
                constexpr std::ptrdiff_t m_unFreezetimeEndEquipmentValue = 0x1C04; // uint16
                constexpr std::ptrdiff_t m_iLastWeaponFireUsercmd = 0x1C08; // int32
                constexpr std::ptrdiff_t m_flLastFriendlyFireDamageReductionRatio = 0x1C0C; // float32
                constexpr std::ptrdiff_t m_bIsSpawning = 0x1C10; // bool
                constexpr std::ptrdiff_t m_iDeathFlags = 0x1C20; // int32
                constexpr std::ptrdiff_t m_bHasDeathInfo = 0x1C24; // bool
                constexpr std::ptrdiff_t m_flDeathInfoTime = 0x1C28; // float32
                constexpr std::ptrdiff_t m_vecDeathInfoOrigin = 0x1C2C; // Vector
                constexpr std::ptrdiff_t m_vecPlayerPatchEconIndices = 0x1C38; // uint32[5]
                constexpr std::ptrdiff_t m_GunGameImmunityColor = 0x1C4C; // Color
                constexpr std::ptrdiff_t m_grenadeParameterStashTime = 0x1C50; // GameTime_t
                constexpr std::ptrdiff_t m_bGrenadeParametersStashed = 0x1C54; // bool
                constexpr std::ptrdiff_t m_angStashedShootAngles = 0x1C58; // QAngle
                constexpr std::ptrdiff_t m_vecStashedGrenadeThrowPosition = 0x1C64; // Vector
                constexpr std::ptrdiff_t m_vecStashedVelocity = 0x1C70; // Vector
                constexpr std::ptrdiff_t m_angShootAngleHistory = 0x1C7C; // QAngle[2]
                constexpr std::ptrdiff_t m_vecThrowPositionHistory = 0x1C94; // Vector[2]
                constexpr std::ptrdiff_t m_vecVelocityHistory = 0x1CAC; // Vector[2]
            }
            // Parent: CBaseGrenade
            // Fields count: 0
            ...
            namespace CCSPlayerController {
                constexpr std::ptrdiff_t m_pInGameMoneyServices = 0xA38; // CCSPlayerController_InGameMoneyServices*
                constexpr std::ptrdiff_t m_pInventoryServices = 0xA40; // CCSPlayerController_InventoryServices*
                constexpr std::ptrdiff_t m_pActionTrackingServices = 0xA48; // CCSPlayerController_ActionTrackingServices*
                constexpr std::ptrdiff_t m_pDamageServices = 0xA50; // CCSPlayerController_DamageServices*
                constexpr std::ptrdiff_t m_iPing = 0xA58; // uint32
                constexpr std::ptrdiff_t m_bHasCommunicationAbuseMute = 0xA5C; // bool
                constexpr std::ptrdiff_t m_szCrosshairCodes = 0xA60; // CUtlSymbolLarge
                constexpr std::ptrdiff_t m_iPendingTeamNum = 0xA68; // uint8
                constexpr std::ptrdiff_t m_flForceTeamTime = 0xA6C; // GameTime_t
                constexpr std::ptrdiff_t m_iCompTeammateColor = 0xA70; // int32
                constexpr std::ptrdiff_t m_bEverPlayedOnTeam = 0xA74; // bool
                constexpr std::ptrdiff_t m_bAttemptedToGetColor = 0xA75; // bool
                constexpr std::ptrdiff_t m_iTeammatePreferredColor = 0xA78; // int32
                constexpr std::ptrdiff_t m_bTeamChanged = 0xA7C; // bool
                constexpr std::ptrdiff_t m_bInSwitchTeam = 0xA7D; // bool
                constexpr std::ptrdiff_t m_bHasSeenJoinGame = 0xA7E; // bool
                constexpr std::ptrdiff_t m_bJustBecameSpectator = 0xA7F; // bool
                constexpr std::ptrdiff_t m_bSwitchTeamsOnNextRoundReset = 0xA80; // bool
                constexpr std::ptrdiff_t m_bRemoveAllItemsOnNextRoundReset = 0xA81; // bool
                constexpr std::ptrdiff_t m_szClan = 0xA88; // CUtlSymbolLarge
                constexpr std::ptrdiff_t m_szClanName = 0xA90; // char[32]
                constexpr std::ptrdiff_t m_iCoachingTeam = 0xAB0; // int32
                constexpr std::ptrdiff_t m_nPlayerDominated = 0xAB8; // uint64
                constexpr std::ptrdiff_t m_nPlayerDominatingMe = 0xAC0; // uint64
                constexpr std::ptrdiff_t m_iCompetitiveRanking = 0xAC8; // int32
                constexpr std::ptrdiff_t m_iCompetitiveWins = 0xACC; // int32
                constexpr std::ptrdiff_t m_iCompetitiveRankType = 0xAD0; // int8
                constexpr std::ptrdiff_t m_iCompetitiveRankingPredicted_Win = 0xAD4; // int32
                constexpr std::ptrdiff_t m_iCompetitiveRankingPredicted_Loss = 0xAD8; // int32
                constexpr std::ptrdiff_t m_iCompetitiveRankingPredicted_Tie = 0xADC; // int32
                constexpr std::ptrdiff_t m_nEndMatchNextMapVote = 0xAE0; // int32
                constexpr std::ptrdiff_t m_unActiveQuestId = 0xAE4; // uint16
                constexpr std::ptrdiff_t m_nQuestProgressReason = 0xAE8; // QuestProgress::Reason
                constexpr std::ptrdiff_t m_unPlayerTvControlFlags = 0xAEC; // uint32
                constexpr std::ptrdiff_t m_iDraftIndex = 0xB18; // int32
                constexpr std::ptrdiff_t m_msQueuedModeDisconnectionTimestamp = 0xB1C; // uint32
                constexpr std::ptrdiff_t m_uiAbandonRecordedReason = 0xB20; // uint32
                constexpr std::ptrdiff_t m_bCannotBeKicked = 0xB24; // bool
                constexpr std::ptrdiff_t m_bEverFullyConnected = 0xB25; // bool
                constexpr std::ptrdiff_t m_bAbandonAllowsSurrender = 0xB26; // bool
                constexpr std::ptrdiff_t m_bAbandonOffersInstantSurrender = 0xB27; // bool
                constexpr std::ptrdiff_t m_bDisconnection1MinWarningPrinted = 0xB28; // bool
                constexpr std::ptrdiff_t m_bScoreReported = 0xB29; // bool
                constexpr std::ptrdiff_t m_nDisconnectionTick = 0xB2C; // int32
                constexpr std::ptrdiff_t m_bControllingBot = 0xB38; // bool
                constexpr std::ptrdiff_t m_bHasControlledBotThisRound = 0xB39; // bool
                constexpr std::ptrdiff_t m_bHasBeenControlledByPlayerThisRound = 0xB3A; // bool
                constexpr std::ptrdiff_t m_nBotsControlledThisRound = 0xB3C; // int32
                constexpr std::ptrdiff_t m_bCanControlObservedBot = 0xB40; // bool
                constexpr std::ptrdiff_t m_hPlayerPawn = 0xB44; // CHandle<CCSPlayerPawn>
                constexpr std::ptrdiff_t m_hObserverPawn = 0xB48; // CHandle<CCSObserverPawn>
                constexpr std::ptrdiff_t m_DesiredObserverMode = 0xB4C; // int32
                constexpr std::ptrdiff_t m_hDesiredObserverTarget = 0xB50; // CEntityHandle
                constexpr std::ptrdiff_t m_bPawnIsAlive = 0xB54; // bool
                constexpr std::ptrdiff_t m_iPawnHealth = 0xB58; // uint32
                constexpr std::ptrdiff_t m_iPawnArmor = 0xB5C; // int32
                constexpr std::ptrdiff_t m_bPawnHasDefuser = 0xB60; // bool
                constexpr std::ptrdiff_t m_bPawnHasHelmet = 0xB61; // bool
                constexpr std::ptrdiff_t m_nPawnCharacterDefIndex = 0xB62; // uint16
                constexpr std::ptrdiff_t m_iPawnLifetimeStart = 0xB64; // int32
                constexpr std::ptrdiff_t m_iPawnLifetimeEnd = 0xB68; // int32
                constexpr std::ptrdiff_t m_iPawnBotDifficulty = 0xB6C; // int32
                constexpr std::ptrdiff_t m_hOriginalControllerOfCurrentPawn = 0xB70; // CHandle<CCSPlayerController>
                constexpr std::ptrdiff_t m_iScore = 0xB74; // int32
                constexpr std::ptrdiff_t m_iRoundScore = 0xB78; // int32
                constexpr std::ptrdiff_t m_iRoundsWon = 0xB7C; // int32
                constexpr std::ptrdiff_t m_vecKills = 0xB80; // CNetworkUtlVectorBase<EKillTypes_t>
                constexpr std::ptrdiff_t m_bMvpNoMusic = 0xB98; // bool
                constexpr std::ptrdiff_t m_eMvpReason = 0xB9C; // int32
                constexpr std::ptrdiff_t m_iMusicKitID = 0xBA0; // int32
                constexpr std::ptrdiff_t m_iMusicKitMVPs = 0xBA4; // int32
                constexpr std::ptrdiff_t m_iMVPs = 0xBA8; // int32
                constexpr std::ptrdiff_t m_nUpdateCounter = 0xBAC; // int32
                constexpr std::ptrdiff_t m_flSmoothedPing = 0xBB0; // float32
                constexpr std::ptrdiff_t m_lastHeldVoteTimer = 0xFC58; // IntervalTimer
                constexpr std::ptrdiff_t m_bShowHints = 0xFC70; // bool
                constexpr std::ptrdiff_t m_iNextTimeCheck = 0xFC74; // int32
                constexpr std::ptrdiff_t m_bJustDidTeamKill = 0xFC78; // bool
                constexpr std::ptrdiff_t m_bPunishForTeamKill = 0xFC79; // bool
                constexpr std::ptrdiff_t m_bGaveTeamDamageWarning = 0xFC7A; // bool
                constexpr std::ptrdiff_t m_bGaveTeamDamageWarningThisRound = 0xFC7B; // bool
                constexpr std::ptrdiff_t m_dblLastReceivedPacketPlatFloatTime = 0xFC80; // float64
                constexpr std::ptrdiff_t m_LastTeamDamageWarningTime = 0xFC88; // GameTime_t
                constexpr std::ptrdiff_t m_LastTimePlayerWasDisconnectedForPawnsRemove = 0xFC8C; // GameTime_t
                constexpr std::ptrdiff_t m_nSuspiciousHitCount = 0xFC90; // uint32
                constexpr std::ptrdiff_t m_nNonSuspiciousHitStreak = 0xFC94; // uint32
            }
            ...
            namespace CBasePlayerPawn {
                ...
                constexpr std::ptrdiff_t m_nHighestGeneratedServerViewAngleChangeIndex = 0xDB0; // uint32
                constexpr std::ptrdiff_t v_angle = 0xDB4; // QAngle
                constexpr std::ptrdiff_t v_anglePrevious = 0xDC0; // QAngle
                constexpr std::ptrdiff_t m_iHideHUD = 0xDCC; // uint32
                constexpr std::ptrdiff_t m_skybox3d = 0xDD0; // sky3dparams_t
                constexpr std::ptrdiff_t m_fTimeLastHurt = 0xE60; // GameTime_t
                constexpr std::ptrdiff_t m_flDeathTime = 0xE64; // GameTime_t
                constexpr std::ptrdiff_t m_fNextSuicideTime = 0xE68; // GameTime_t
                constexpr std::ptrdiff_t m_fInitHUD = 0xE6C; // bool
                constexpr std::ptrdiff_t m_pExpresser = 0xE70; // CAI_Expresser*
                constexpr std::ptrdiff_t m_hController = 0xE78; // CHandle<CBasePlayerController>
                constexpr std::ptrdiff_t m_fHltvReplayDelay = 0xE80; // float32
                constexpr std::ptrdiff_t m_fHltvReplayEnd = 0xE84; // float32
                constexpr std::ptrdiff_t m_iHltvReplayEntity = 0xE88; // CEntityIndex
                constexpr std::ptrdiff_t m_sndOpvarLatchData = 0xE90; // CUtlVector<sndopvarlatchdata_t>
            }
            // Parent: CBaseTrigger
            // Fields count: 16
            //
            ...
            namespace CPostProcessingVolume {
                constexpr std::ptrdiff_t m_hPostSettings = 0xBD8; // CStrongHandle<InfoForResourceTypeCPostProcessingResource>
                constexpr std::ptrdiff_t m_flFadeDuration = 0xBE0; // float32
                constexpr std::ptrdiff_t m_flMinLogExposure = 0xBE4; // float32
                constexpr std::ptrdiff_t m_flMaxLogExposure = 0xBE8; // float32
                constexpr std::ptrdiff_t m_flMinExposure = 0xBEC; // float32
                constexpr std::ptrdiff_t m_flMaxExposure = 0xBF0; // float32
                constexpr std::ptrdiff_t m_flExposureCompensation = 0xBF4; // float32
                constexpr std::ptrdiff_t m_flExposureFadeSpeedUp = 0xBF8; // float32
                constexpr std::ptrdiff_t m_flExposureFadeSpeedDown = 0xBFC; // float32
                constexpr std::ptrdiff_t m_flTonemapEVSmoothingRange = 0xC00; // float32
                constexpr std::ptrdiff_t m_bMaster = 0xC04; // bool
                constexpr std::ptrdiff_t m_bExposureControl = 0xC05; // bool
                constexpr std::ptrdiff_t m_flRate = 0xC08; // float32
                constexpr std::ptrdiff_t m_flTonemapPercentTarget = 0xC0C; // float32
                constexpr std::ptrdiff_t m_flTonemapPercentBrightPixels = 0xC10; // float32
                constexpr std::ptrdiff_t m_flTonemapMinAvgLum = 0xC14; // float32
            }
            // Parent: CBaseModelEntity
            // Fields count: 4
            //
            ...
            namespace CSpotlightEnd {
                constexpr std::ptrdiff_t m_flLightScale = 0x9F8; // float32
                constexpr std::ptrdiff_t m_Radius = 0x9FC; // float32
            ...
            namespace CCSGO_TeamPreviewCharacterPosition {
                constexpr std::ptrdiff_t m_nVariant = 0x7A4; // int32
                constexpr std::ptrdiff_t m_nRandom = 0x7A8; // int32
                constexpr std::ptrdiff_t m_nOrdinal = 0x7AC; // int32
                constexpr std::ptrdiff_t m_sWeaponName = 0x7B0; // CUtlString
                constexpr std::ptrdiff_t m_xuid = 0x7B8; // uint64
                constexpr std::ptrdiff_t m_agentItem = 0x7C0; // CEconItemView
                constexpr std::ptrdiff_t m_glovesItem = 0xA38; // CEconItemView
                constexpr std::ptrdiff_t m_weaponItem = 0xCB0; // CEconItemView
            }
            // Parent: CBaseTrigger
            // Fields count: 1
            namespace CTriggerDetectExplosion {
                constexpr std::ptrdiff_t m_OnDetectedExplosion = 0xC00; // CEntityIOOutput
            }
            // Parent: CLogicalEntity
            // Fields count: 1
            ...
            namespace CPhysHinge {
                constexpr std::ptrdiff_t m_soundInfo = 0x828; // ConstraintSoundInfo
                constexpr std::ptrdiff_t m_NotifyMinLimitReached = 0x8B0; // CEntityIOOutput
                constexpr std::ptrdiff_t m_NotifyMaxLimitReached = 0x8D8; // CEntityIOOutput
                constexpr std::ptrdiff_t m_bAtMinLimit = 0x900; // bool
                constexpr std::ptrdiff_t m_bAtMaxLimit = 0x901; // bool
                constexpr std::ptrdiff_t m_hinge = 0x904; // constraint_hingeparams_t
                constexpr std::ptrdiff_t m_hingeFriction = 0x944; // float32
                constexpr std::ptrdiff_t m_systemLoadScale = 0x948; // float32
                constexpr std::ptrdiff_t m_bIsAxisLocal = 0x94C; // bool
                constexpr std::ptrdiff_t m_flMinRotation = 0x950; // float32
                constexpr std::ptrdiff_t m_flMaxRotation = 0x954; // float32
                constexpr std::ptrdiff_t m_flInitialRotation = 0x958; // float32
                constexpr std::ptrdiff_t m_flMotorFrequency = 0x95C; // float32
                constexpr std::ptrdiff_t m_flMotorDampingRatio = 0x960; // float32
                constexpr std::ptrdiff_t m_flAngleSpeed = 0x964; // float32
                constexpr std::ptrdiff_t m_flAngleSpeedThreshold = 0x968; // float32
                constexpr std::ptrdiff_t m_OnStartMoving = 0x970; // CEntityIOOutput
                constexpr std::ptrdiff_t m_OnStopMoving = 0x998; // CEntityIOOutput
            }
            // Parent: CGameRules
            // Fields count: 1
            ...
            namespace CFilterProximity {
                constexpr std::ptrdiff_t m_flRadius = 0x7F8; // float32
            }
            // Parent: CEconEntity
            // Fields count: 2
            namespace CEconWearable {
                constexpr std::ptrdiff_t m_nForceSkin = 0xF78; // int32
            ...
            namespace CFuncConveyor {
                ...
                constexpr std::ptrdiff_t m_flTransitionDurationSeconds = 0xA00; // float32
                constexpr std::ptrdiff_t m_angMoveEntitySpace = 0xA04; // QAngle
                constexpr std::ptrdiff_t m_vecMoveDirEntitySpace = 0xA10; // Vector
                constexpr std::ptrdiff_t m_flTargetSpeed = 0xA1C; // float32
                constexpr std::ptrdiff_t m_nTransitionStartTick = 0xA20; // GameTick_t
                constexpr std::ptrdiff_t m_nTransitionDurationTicks = 0xA24; // int32
                constexpr std::ptrdiff_t m_flTransitionStartSpeed = 0xA28; // float32
            ...
            namespace CMathCounter {
                constexpr std::ptrdiff_t m_flMin = 0x7A4; // float32
                constexpr std::ptrdiff_t m_flMax = 0x7A8; // float32
                constexpr std::ptrdiff_t m_bHitMin = 0x7AC; // bool
                constexpr std::ptrdiff_t m_bHitMax = 0x7AD; // bool
                constexpr std::ptrdiff_t m_bDisabled = 0x7AE; // bool
                constexpr std::ptrdiff_t m_OutValue = 0x7B0; // CEntityOutputTemplate<float32>
                constexpr std::ptrdiff_t m_OnGetValue = 0x7D8; // CEntityOutputTemplate<float32>
                constexpr std::ptrdiff_t m_OnHitMin = 0x800; // CEntityIOOutput
                constexpr std::ptrdiff_t m_OnHitMax = 0x828; // CEntityIOOutput
                constexpr std::ptrdiff_t m_OnChangedFromMin = 0x850; // CEntityIOOutput
                constexpr std::ptrdiff_t m_OnChangedFromMax = 0x878; // CEntityIOOutput
            }
            // Parent: CBaseEntity
            // Fields count: 7
            //
            ...
            namespace CInfoWorldLayer {
                ...
                constexpr std::ptrdiff_t m_hLayerSpawnGroup = 0x7E4; // uint32
            }
            // Parent: CBarnLight
            // Fields count: 1
            //
            ...
            namespace CEnvCubemap {
                constexpr std::ptrdiff_t m_Entity_hCubemapTexture = 0x828; // CStrongHandle<InfoForResourceTypeCTextureBase>
                constexpr std::ptrdiff_t m_Entity_bCustomCubemapTexture = 0x830; // bool
                constexpr std::ptrdiff_t m_Entity_flInfluenceRadius = 0x834; // float32
                constexpr std::ptrdiff_t m_Entity_vBoxProjectMins = 0x838; // Vector
                constexpr std::ptrdiff_t m_Entity_vBoxProjectMaxs = 0x844; // Vector
                constexpr std::ptrdiff_t m_Entity_bMoveable = 0x850; // bool
                constexpr std::ptrdiff_t m_Entity_nHandshake = 0x854; // int32
                constexpr std::ptrdiff_t m_Entity_nEnvCubeMapArrayIndex = 0x858; // int32
                constexpr std::ptrdiff_t m_Entity_nPriority = 0x85C; // int32
                constexpr std::ptrdiff_t m_Entity_flEdgeFadeDist = 0x860; // float32
                constexpr std::ptrdiff_t m_Entity_vEdgeFadeDists = 0x864; // Vector
                constexpr std::ptrdiff_t m_Entity_flDiffuseScale = 0x870; // float32
                constexpr std::ptrdiff_t m_Entity_bStartDisabled = 0x874; // bool
                constexpr std::ptrdiff_t m_Entity_bDefaultEnvMap = 0x875; // bool
                constexpr std::ptrdiff_t m_Entity_bDefaultSpecEnvMap = 0x876; // bool
                constexpr std::ptrdiff_t m_Entity_bIndoorCubeMap = 0x877; // bool
                constexpr std::ptrdiff_t m_Entity_bCopyDiffuseFromDefaultCubemap = 0x878; // bool
                constexpr std::ptrdiff_t m_Entity_bEnabled = 0x888; // bool
            }
            // Parent: CPlayerPawnComponent
            // Fields count: 0
            ...
            namespace CColorCorrection {
                constexpr std::ptrdiff_t m_flFadeInDuration = 0x7A4; // float32
                constexpr std::ptrdiff_t m_flFadeOutDuration = 0x7A8; // float32
                constexpr std::ptrdiff_t m_flStartFadeInWeight = 0x7AC; // float32
                constexpr std::ptrdiff_t m_flStartFadeOutWeight = 0x7B0; // float32
                constexpr std::ptrdiff_t m_flTimeStartFadeIn = 0x7B4; // GameTime_t
                constexpr std::ptrdiff_t m_flTimeStartFadeOut = 0x7B8; // GameTime_t
                constexpr std::ptrdiff_t m_flMaxWeight = 0x7BC; // float32
                constexpr std::ptrdiff_t m_bStartDisabled = 0x7C0; // bool
                constexpr std::ptrdiff_t m_bEnabled = 0x7C1; // bool
                constexpr std::ptrdiff_t m_bMaster = 0x7C2; // bool
                constexpr std::ptrdiff_t m_bClientSide = 0x7C3; // bool
                constexpr std::ptrdiff_t m_bExclusive = 0x7C4; // bool
                constexpr std::ptrdiff_t m_MinFalloff = 0x7C8; // float32
                constexpr std::ptrdiff_t m_MaxFalloff = 0x7CC; // float32
                constexpr std::ptrdiff_t m_flCurWeight = 0x7D0; // float32
                constexpr std::ptrdiff_t m_netlookupFilename = 0x7D4; // char[512]
            ...
            // NetworkVarNames: m_entitySpottedState (EntitySpottedState_t)
            namespace CC4 {
                constexpr std::ptrdiff_t m_vecLastValidPlayerHeldPosition = 0x11A0; // Vector
                constexpr std::ptrdiff_t m_vecLastValidDroppedPosition = 0x11AC; // Vector
                constexpr std::ptrdiff_t m_bDoValidDroppedPositionCheck = 0x11B8; // bool
                constexpr std::ptrdiff_t m_bStartedArming = 0x11B9; // bool
                constexpr std::ptrdiff_t m_fArmedTime = 0x11BC; // GameTime_t
                constexpr std::ptrdiff_t m_bBombPlacedAnimation = 0x11C0; // bool
                constexpr std::ptrdiff_t m_bIsPlantingViaUse = 0x11C1; // bool
                constexpr std::ptrdiff_t m_entitySpottedState = 0x11C8; // EntitySpottedState_t
                constexpr std::ptrdiff_t m_nSpotRules = 0x11E0; // int32
                constexpr std::ptrdiff_t m_bPlayedArmingBeeps = 0x11E4; // bool[7]
                constexpr std::ptrdiff_t m_bBombPlanted = 0x11EB; // bool
            }
            ...
            namespace CBaseDoor {
                ...
                constexpr std::ptrdiff_t m_flBlockDamage = 0xAC8; // float32
            ...
            namespace CTankTrainAI {
                constexpr std::ptrdiff_t m_hTrain = 0x7A4; // CHandle<CFuncTrackTrain>
                constexpr std::ptrdiff_t m_hTargetEntity = 0x7A8; // CHandle<CBaseEntity>
                constexpr std::ptrdiff_t m_soundPlaying = 0x7AC; // int32
                constexpr std::ptrdiff_t m_startSoundName = 0x7C0; // CUtlSymbolLarge
                constexpr std::ptrdiff_t m_engineSoundName = 0x7C8; // CUtlSymbolLarge
                constexpr std::ptrdiff_t m_movementSoundName = 0x7D0; // CUtlSymbolLarge
            ...
            namespace CGameGibManager {
                ...
                constexpr std::ptrdiff_t m_iCurrentMaxPieces = 0x7CC; // int32
                constexpr std::ptrdiff_t m_iMaxPieces = 0x7D0; // int32
                constexpr std::ptrdiff_t m_iLastFrame = 0x7D4; // int32
            }
            // Parent: CBasePulseGraphInstance
            // Fields count: 1
            //
            ...
            namespace SpawnPoint {
                constexpr std::ptrdiff_t m_iPriority = 0x7A4; // int32
                constexpr std::ptrdiff_t m_bEnabled = 0x7A8; // bool
                constexpr std::ptrdiff_t m_nType = 0x7AC; // int32
            }
            // Parent: CCSWeaponBaseGun
            // Fields count: 0
            ...
            // Fields count: 5
            namespace CEnvSpark {
                constexpr std::ptrdiff_t m_flDelay = 0x7A4; // float32
                constexpr std::ptrdiff_t m_nMagnitude = 0x7A8; // int32
                constexpr std::ptrdiff_t m_nTrailLength = 0x7AC; // int32
            ...
            namespace CFuncTrain {
                ...
                constexpr std::ptrdiff_t m_flBlockDamage = 0xAA8; // float32
            ...
            namespace CHostage {
                ...
                constexpr std::ptrdiff_t m_OnFirstPickedUp = 0xD50; // CEntityIOOutput
                constexpr std::ptrdiff_t m_OnDroppedNotRescued = 0xD78; // CEntityIOOutput
                constexpr std::ptrdiff_t m_OnRescued = 0xDA0; // CEntityIOOutput
                constexpr std::ptrdiff_t m_entitySpottedState = 0xDC8; // EntitySpottedState_t
                constexpr std::ptrdiff_t m_nSpotRules = 0xDE0; // int32
                constexpr std::ptrdiff_t m_uiHostageSpawnExclusionGroupMask = 0xDE4; // uint32
                constexpr std::ptrdiff_t m_nHostageSpawnRandomFactor = 0xDE8; // uint32
                constexpr std::ptrdiff_t m_bRemove = 0xDEC; // bool
                constexpr std::ptrdiff_t m_vel = 0xDF0; // Vector
                constexpr std::ptrdiff_t m_isRescued = 0xDFC; // bool
                constexpr std::ptrdiff_t m_jumpedThisFrame = 0xDFD; // bool
                constexpr std::ptrdiff_t m_nHostageState = 0xE00; // int32
                constexpr std::ptrdiff_t m_leader = 0xE04; // CHandle<CBaseEntity>
                constexpr std::ptrdiff_t m_lastLeader = 0xE08; // CHandle<CCSPlayerPawnBase>
                constexpr std::ptrdiff_t m_reuseTimer = 0xE10; // CountdownTimer
                constexpr std::ptrdiff_t m_hasBeenUsed = 0xE28; // bool
                constexpr std::ptrdiff_t m_accel = 0xE2C; // Vector
                constexpr std::ptrdiff_t m_isRunning = 0xE38; // bool
                constexpr std::ptrdiff_t m_isCrouching = 0xE39; // bool
                constexpr std::ptrdiff_t m_jumpTimer = 0xE40; // CountdownTimer
                constexpr std::ptrdiff_t m_isWaitingForLeader = 0xE58; // bool
                constexpr std::ptrdiff_t m_repathTimer = 0x2E68; // CountdownTimer
                constexpr std::ptrdiff_t m_inhibitDoorTimer = 0x2E80; // CountdownTimer
                constexpr std::ptrdiff_t m_inhibitObstacleAvoidanceTimer = 0x2F10; // CountdownTimer
                constexpr std::ptrdiff_t m_wiggleTimer = 0x2F30; // CountdownTimer
                constexpr std::ptrdiff_t m_isAdjusted = 0x2F4C; // bool
                constexpr std::ptrdiff_t m_bHandsHaveBeenCut = 0x2F4D; // bool
                constexpr std::ptrdiff_t m_hHostageGrabber = 0x2F50; // CHandle<CCSPlayerPawn>
                constexpr std::ptrdiff_t m_fLastGrabTime = 0x2F54; // GameTime_t
                constexpr std::ptrdiff_t m_vecPositionWhenStartedDroppingToGround = 0x2F58; // Vector
                constexpr std::ptrdiff_t m_vecGrabbedPos = 0x2F64; // Vector
                constexpr std::ptrdiff_t m_flRescueStartTime = 0x2F70; // GameTime_t
                constexpr std::ptrdiff_t m_flGrabSuccessTime = 0x2F74; // GameTime_t
                constexpr std::ptrdiff_t m_flDropStartTime = 0x2F78; // GameTime_t
                constexpr std::ptrdiff_t m_nApproachRewardPayouts = 0x2F7C; // int32
                constexpr std::ptrdiff_t m_nPickupEventCount = 0x2F80; // int32
                constexpr std::ptrdiff_t m_vecSpawnGroundPos = 0x2F84; // Vector
                constexpr std::ptrdiff_t m_vecHostageResetPosition = 0x2FA4; // Vector
            }
            // Parent: CPointEntity
            // Fields count: 13
            namespace CNavLinkAreaEntity {
                constexpr std::ptrdiff_t m_flWidth = 0x7A4; // float32
                constexpr std::ptrdiff_t m_vLocatorOffset = 0x7A8; // Vector
                constexpr std::ptrdiff_t m_qLocatorAnglesOffset = 0x7B4; // QAngle
                constexpr std::ptrdiff_t m_strMovementForward = 0x7C0; // CUtlSymbolLarge
                constexpr std::ptrdiff_t m_strMovementReverse = 0x7C8; // CUtlSymbolLarge
                constexpr std::ptrdiff_t m_nNavLinkIdForward = 0x7D0; // int32
                constexpr std::ptrdiff_t m_nNavLinkIdReverse = 0x7D4; // int32
                constexpr std::ptrdiff_t m_bEnabled = 0x7D8; // bool
                constexpr std::ptrdiff_t m_strFilterName = 0x7E0; // CUtlSymbolLarge
                constexpr std::ptrdiff_t m_hFilter = 0x7E8; // CHandle<CBaseFilter>
                constexpr std::ptrdiff_t m_OnNavLinkStart = 0x7F0; // CEntityIOOutput
                constexpr std::ptrdiff_t m_OnNavLinkFinish = 0x818; // CEntityIOOutput
                constexpr std::ptrdiff_t m_bIsTerminus = 0x840; // bool
            }
            // Parent: CBaseToggle
            // Fields count: 12
            //
            ...
            namespace CFuncMoveLinear {
                ...
                constexpr std::ptrdiff_t m_flBlockDamage = 0xAB0; // float32
                constexpr std::ptrdiff_t m_flStartPosition = 0xAB4; // float32
                constexpr std::ptrdiff_t m_OnFullyOpen = 0xAC0; // CEntityIOOutput
                constexpr std::ptrdiff_t m_OnFullyClosed = 0xAE8; // CEntityIOOutput
                constexpr std::ptrdiff_t m_bCreateMovableNavMesh = 0xB10; // bool
                constexpr std::ptrdiff_t m_bCreateNavObstacle = 0xB11; // bool
            }
            // Parent: CBaseEntity
            // Fields count: 3
            ...
            // Fields count: 8
            namespace CMapInfo {
                constexpr std::ptrdiff_t m_iBuyingStatus = 0x7A4; // int32
                constexpr std::ptrdiff_t m_flBombRadius = 0x7A8; // float32
                constexpr std::ptrdiff_t m_iPetPopulation = 0x7AC; // int32
                constexpr std::ptrdiff_t m_bUseNormalSpawnsForDM = 0x7B0; // bool
                constexpr std::ptrdiff_t m_bDisableAutoGeneratedDMSpawns = 0x7B1; // bool
                constexpr std::ptrdiff_t m_flBotMaxVisionDistance = 0x7B4; // float32
                constexpr std::ptrdiff_t m_iHostageCount = 0x7B8; // int32
                constexpr std::ptrdiff_t m_bFadePlayerVisibilityFarZ = 0x7BC; // bool
            }
            // Parent: CBaseTrigger
            // Fields count: 0
            ...
            namespace CBaseEntity {
                ...
                constexpr std::ptrdiff_t m_aThinkFunctions = 0x4E0; // CUtlVector<thinkfunc_t>
                constexpr std::ptrdiff_t m_iCurrentThinkContext = 0x4F8; // int32
                constexpr std::ptrdiff_t m_nLastThinkTick = 0x4FC; // GameTick_t
                constexpr std::ptrdiff_t m_bDisabledContextThinks = 0x500; // bool
                constexpr std::ptrdiff_t m_isSteadyState = 0x510; // CBitVec<64>
                constexpr std::ptrdiff_t m_lastNetworkChange = 0x518; // float32
                constexpr std::ptrdiff_t m_ResponseContexts = 0x530; // CUtlVector<ResponseContext_t>
                constexpr std::ptrdiff_t m_iszResponseContext = 0x548; // CUtlSymbolLarge
                constexpr std::ptrdiff_t m_iHealth = 0x590; // int32
                constexpr std::ptrdiff_t m_iMaxHealth = 0x594; // int32
                constexpr std::ptrdiff_t m_lifeState = 0x598; // uint8
                constexpr std::ptrdiff_t m_flDamageAccumulator = 0x59C; // float32
                constexpr std::ptrdiff_t m_bTakesDamage = 0x5A0; // bool
                constexpr std::ptrdiff_t m_nTakeDamageFlags = 0x5A8; // TakeDamageFlags_t
                constexpr std::ptrdiff_t m_bIsPlatform = 0x5B0; // bool
                constexpr std::ptrdiff_t m_MoveCollide = 0x5B2; // MoveCollide_t
                constexpr std::ptrdiff_t m_MoveType = 0x5B3; // MoveType_t
                constexpr std::ptrdiff_t m_nActualMoveType = 0x5B4; // MoveType_t
                constexpr std::ptrdiff_t m_nWaterTouch = 0x5B5; // uint8
                constexpr std::ptrdiff_t m_nSlimeTouch = 0x5B6; // uint8
                constexpr std::ptrdiff_t m_bRestoreInHierarchy = 0x5B7; // bool
                constexpr std::ptrdiff_t m_target = 0x5B8; // CUtlSymbolLarge
                constexpr std::ptrdiff_t m_hDamageFilter = 0x5C0; // CHandle<CBaseFilter>
                constexpr std::ptrdiff_t m_iszDamageFilterName = 0x5C8; // CUtlSymbolLarge
                constexpr std::ptrdiff_t m_flMoveDoneTime = 0x5D0; // float32
                constexpr std::ptrdiff_t m_nSubclassID = 0x5D4; // CUtlStringToken
                constexpr std::ptrdiff_t m_flAnimTime = 0x5E0; // float32
                constexpr std::ptrdiff_t m_flSimulationTime = 0x5E4; // float32
                constexpr std::ptrdiff_t m_flCreateTime = 0x5E8; // GameTime_t
                constexpr std::ptrdiff_t m_bClientSideRagdoll = 0x5EC; // bool
                constexpr std::ptrdiff_t m_ubInterpolationFrame = 0x5ED; // uint8
                constexpr std::ptrdiff_t m_vPrevVPhysicsUpdatePos = 0x5F0; // Vector
                constexpr std::ptrdiff_t m_iTeamNum = 0x5FC; // uint8
                constexpr std::ptrdiff_t m_iGlobalname = 0x600; // CUtlSymbolLarge
                constexpr std::ptrdiff_t m_iSentToClients = 0x608; // int32
                constexpr std::ptrdiff_t m_flSpeed = 0x60C; // float32
                constexpr std::ptrdiff_t m_sUniqueHammerID = 0x610; // CUtlString
                constexpr std::ptrdiff_t m_spawnflags = 0x618; // uint32
                constexpr std::ptrdiff_t m_nNextThinkTick = 0x61C; // GameTick_t
                constexpr std::ptrdiff_t m_nSimulationTick = 0x620; // int32
                constexpr std::ptrdiff_t m_OnKilled = 0x628; // CEntityIOOutput
                constexpr std::ptrdiff_t m_fFlags = 0x650; // uint32
                constexpr std::ptrdiff_t m_vecAbsVelocity = 0x654; // Vector
                constexpr std::ptrdiff_t m_vecVelocity = 0x660; // CNetworkVelocityVector
                constexpr std::ptrdiff_t m_vecBaseVelocity = 0x690; // Vector
                constexpr std::ptrdiff_t m_nPushEnumCount = 0x69C; // int32
                constexpr std::ptrdiff_t m_pCollision = 0x6A0; // CCollisionProperty*
                constexpr std::ptrdiff_t m_hEffectEntity = 0x6A8; // CHandle<CBaseEntity>
                constexpr std::ptrdiff_t m_hOwnerEntity = 0x6AC; // CHandle<CBaseEntity>
                constexpr std::ptrdiff_t m_fEffects = 0x6B0; // uint32
                constexpr std::ptrdiff_t m_hGroundEntity = 0x6B4; // CHandle<CBaseEntity>
                constexpr std::ptrdiff_t m_nGroundBodyIndex = 0x6B8; // int32
                constexpr std::ptrdiff_t m_flFriction = 0x6BC; // float32
                constexpr std::ptrdiff_t m_flElasticity = 0x6C0; // float32
                constexpr std::ptrdiff_t m_flGravityScale = 0x6C4; // float32
                constexpr std::ptrdiff_t m_flTimeScale = 0x6C8; // float32
                constexpr std::ptrdiff_t m_flWaterLevel = 0x6CC; // float32
                constexpr std::ptrdiff_t m_bAnimatedEveryTick = 0x6D0; // bool
                constexpr std::ptrdiff_t m_bDisableLowViolence = 0x6D1; // bool
                constexpr std::ptrdiff_t m_nWaterType = 0x6D2; // uint8
                constexpr std::ptrdiff_t m_iEFlags = 0x6D4; // int32
                constexpr std::ptrdiff_t m_OnUser1 = 0x6D8; // CEntityIOOutput
                constexpr std::ptrdiff_t m_OnUser2 = 0x700; // CEntityIOOutput
                constexpr std::ptrdiff_t m_OnUser3 = 0x728; // CEntityIOOutput
                constexpr std::ptrdiff_t m_OnUser4 = 0x750; // CEntityIOOutput
                constexpr std::ptrdiff_t m_iInitialTeamNum = 0x778; // int32
                constexpr std::ptrdiff_t m_flNavIgnoreUntilTime = 0x77C; // GameTime_t
                constexpr std::ptrdiff_t m_vecAngVelocity = 0x780; // QAngle
                constexpr std::ptrdiff_t m_bNetworkQuantizeOriginAndAngles = 0x78C; // bool
                constexpr std::ptrdiff_t m_bLagCompensate = 0x78D; // bool
                constexpr std::ptrdiff_t m_flOverriddenFriction = 0x790; // float32
                constexpr std::ptrdiff_t m_pBlocker = 0x794; // CHandle<CBaseEntity>
                constexpr std::ptrdiff_t m_flLocalTime = 0x798; // float32
                constexpr std::ptrdiff_t m_flVPhysicsUpdateLocalTime = 0x79C; // float32
                constexpr std::ptrdiff_t m_nBloodType = 0x7A0; // BloodType
            }
            // Parent: CLogicalEntity
            // Fields count: 9
            namespace CLogicMeasureMovement {
                ...
                constexpr std::ptrdiff_t m_flScale = 0x7D0; // float32
                constexpr std::ptrdiff_t m_nMeasureType = 0x7D4; // int32
            }
            // Parent: None
            // Fields count: 3
            //
