    ...
    namespace schemas {
        ...
        namespace libserver_so {
            ...
            namespace CAmbientGeneric {
                constexpr std::ptrdiff_t m_radius = 0x788; // float32
                constexpr std::ptrdiff_t m_flMaxRadius = 0x78C; // float32
                constexpr std::ptrdiff_t m_iSoundLevel = 0x790; // soundlevel_t
                constexpr std::ptrdiff_t m_dpv = 0x794; // dynpitchvol_t
                constexpr std::ptrdiff_t m_fActive = 0x7F8; // bool
                constexpr std::ptrdiff_t m_fLooping = 0x7F9; // bool
                constexpr std::ptrdiff_t m_iszSound = 0x800; // CGameSoundEventName
                constexpr std::ptrdiff_t m_sSourceEntName = 0x808; // CUtlSymbolLarge
                constexpr std::ptrdiff_t m_hSoundSource = 0x810; // CHandle<CBaseEntity>
                constexpr std::ptrdiff_t m_nSoundSourceEntIndex = 0x814; // CEntityIndex
            }
            // Parent: CPointEntity
            // Fields count: 12
            namespace CEnvEntityMaker {
                constexpr std::ptrdiff_t m_vecEntityMins = 0x788; // Vector
                constexpr std::ptrdiff_t m_vecEntityMaxs = 0x794; // Vector
                constexpr std::ptrdiff_t m_hCurrentInstance = 0x7A0; // CHandle<CBaseEntity>
                constexpr std::ptrdiff_t m_hCurrentBlocker = 0x7A4; // CHandle<CBaseEntity>
                constexpr std::ptrdiff_t m_vecBlockerOrigin = 0x7A8; // VectorWS
                constexpr std::ptrdiff_t m_angPostSpawnDirection = 0x7B4; // QAngle
                constexpr std::ptrdiff_t m_flPostSpawnDirectionVariance = 0x7C0; // float32
                constexpr std::ptrdiff_t m_flPostSpawnSpeed = 0x7C4; // float32
                constexpr std::ptrdiff_t m_bPostSpawnUseAngles = 0x7C8; // bool
                constexpr std::ptrdiff_t m_iszTemplate = 0x7D0; // CUtlSymbolLarge
                constexpr std::ptrdiff_t m_pOutputOnSpawned = 0x7D8; // CEntityIOOutput
                constexpr std::ptrdiff_t m_pOutputOnFailedSpawn = 0x7F0; // CEntityIOOutput
            }
            // Parent: None
            // Fields count: 0
            ...
            namespace CFilterEnemy {
                constexpr std::ptrdiff_t m_iszEnemyName = 0x7C0; // CUtlSymbolLarge
                constexpr std::ptrdiff_t m_flRadius = 0x7C8; // float32
                constexpr std::ptrdiff_t m_flOuterRadius = 0x7CC; // float32
            ...
            namespace CScriptedSequence {
                constexpr std::ptrdiff_t m_iszEntry = 0x788; // CUtlSymbolLarge
                constexpr std::ptrdiff_t m_iszPreIdle = 0x790; // CUtlSymbolLarge
                constexpr std::ptrdiff_t m_iszPlay = 0x798; // CUtlSymbolLarge
                constexpr std::ptrdiff_t m_iszPostIdle = 0x7A0; // CUtlSymbolLarge
                constexpr std::ptrdiff_t m_iszModifierToAddOnPlay = 0x7A8; // CUtlSymbolLarge
                constexpr std::ptrdiff_t m_iszNextScript = 0x7B0; // CUtlSymbolLarge
                constexpr std::ptrdiff_t m_iszEntity = 0x7B8; // CUtlSymbolLarge
                constexpr std::ptrdiff_t m_iszSyncGroup = 0x7C0; // CUtlSymbolLarge
                constexpr std::ptrdiff_t m_nMoveTo = 0x7C8; // ScriptedMoveTo_t
                constexpr std::ptrdiff_t m_nMoveToGait = 0x7CC; // SharedMovementGait_t
                constexpr std::ptrdiff_t m_nHeldWeaponBehavior = 0x7D0; // ScriptedHeldWeaponBehavior_t
                constexpr std::ptrdiff_t m_nForcedCrouchState = 0x7D4; // ForcedCrouchState_t
                constexpr std::ptrdiff_t m_bIsPlayingPreIdle = 0x7D8; // bool
                constexpr std::ptrdiff_t m_bIsPlayingEntry = 0x7D9; // bool
                constexpr std::ptrdiff_t m_bIsPlayingAction = 0x7DA; // bool
                constexpr std::ptrdiff_t m_bIsPlayingPostIdle = 0x7DB; // bool
                constexpr std::ptrdiff_t m_bDontRotateOther = 0x7DC; // bool
                constexpr std::ptrdiff_t m_bIsRepeatable = 0x7DD; // bool
                constexpr std::ptrdiff_t m_bShouldLeaveCorpse = 0x7DE; // bool
                constexpr std::ptrdiff_t m_bStartOnSpawn = 0x7DF; // bool
                constexpr std::ptrdiff_t m_bDisallowInterrupts = 0x7E0; // bool
                constexpr std::ptrdiff_t m_bCanOverrideNPCState = 0x7E1; // bool
                constexpr std::ptrdiff_t m_bDontTeleportAtEnd = 0x7E2; // bool
                constexpr std::ptrdiff_t m_bHighPriority = 0x7E3; // bool
                constexpr std::ptrdiff_t m_bHideDebugComplaints = 0x7E4; // bool
                constexpr std::ptrdiff_t m_bContinueOnDeath = 0x7E5; // bool
                constexpr std::ptrdiff_t m_bLoopPreIdleSequence = 0x7E6; // bool
                constexpr std::ptrdiff_t m_bLoopActionSequence = 0x7E7; // bool
                constexpr std::ptrdiff_t m_bLoopPostIdleSequence = 0x7E8; // bool
                constexpr std::ptrdiff_t m_bSynchPostIdles = 0x7E9; // bool
                constexpr std::ptrdiff_t m_bIgnoreLookAt = 0x7EA; // bool
                constexpr std::ptrdiff_t m_bIgnoreGravity = 0x7EB; // bool
                constexpr std::ptrdiff_t m_bDisableNPCCollisions = 0x7EC; // bool
                constexpr std::ptrdiff_t m_bKeepAnimgraphLockedPost = 0x7ED; // bool
                constexpr std::ptrdiff_t m_bDontAddModifiers = 0x7EE; // bool
                constexpr std::ptrdiff_t m_bDisableAimingWhileMoving = 0x7EF; // bool
                constexpr std::ptrdiff_t m_bIgnoreRotation = 0x7F0; // bool
                constexpr std::ptrdiff_t m_flRadius = 0x7F4; // float32
                constexpr std::ptrdiff_t m_flRepeat = 0x7F8; // float32
                constexpr std::ptrdiff_t m_flPlayAnimFadeInTime = 0x7FC; // float32
                constexpr std::ptrdiff_t m_flMoveInterpTime = 0x800; // float32
                constexpr std::ptrdiff_t m_flAngRate = 0x804; // float32
                constexpr std::ptrdiff_t m_flMoveSpeed = 0x808; // float32
                constexpr std::ptrdiff_t m_bWaitUntilMoveCompletesToStartAnimation = 0x80C; // bool
                constexpr std::ptrdiff_t m_nNotReadySequenceCount = 0x810; // int32
                constexpr std::ptrdiff_t m_startTime = 0x814; // GameTime_t
                constexpr std::ptrdiff_t m_bWaitForBeginSequence = 0x818; // bool
                constexpr std::ptrdiff_t m_saved_effects = 0x81C; // int32
                constexpr std::ptrdiff_t m_savedFlags = 0x820; // int32
                constexpr std::ptrdiff_t m_savedCollisionGroup = 0x824; // int32
                constexpr std::ptrdiff_t m_bInterruptable = 0x828; // bool
                ...
                constexpr std::ptrdiff_t m_hForcedTarget = 0x838; // CHandle<CBaseAnimGraph>
                constexpr std::ptrdiff_t m_bDontCancelOtherSequences = 0x83C; // bool
                constexpr std::ptrdiff_t m_bForceSynch = 0x83D; // bool
                constexpr std::ptrdiff_t m_bPreventUpdateYawOnFinish = 0x83E; // bool
                constexpr std::ptrdiff_t m_bEnsureOnNavmeshOnFinish = 0x83F; // bool
                constexpr std::ptrdiff_t m_onDeathBehavior = 0x840; // ScriptedOnDeath_t
                constexpr std::ptrdiff_t m_ConflictResponse = 0x844; // ScriptedConflictResponse_t
                constexpr std::ptrdiff_t m_OnBeginSequence = 0x848; // CEntityIOOutput
                constexpr std::ptrdiff_t m_OnActionStartOrLoop = 0x860; // CEntityIOOutput
                constexpr std::ptrdiff_t m_OnEndSequence = 0x878; // CEntityIOOutput
                constexpr std::ptrdiff_t m_OnPostIdleEndSequence = 0x890; // CEntityIOOutput
                constexpr std::ptrdiff_t m_OnCancelSequence = 0x8A8; // CEntityIOOutput
                constexpr std::ptrdiff_t m_OnCancelFailedSequence = 0x8C0; // CEntityIOOutput
                constexpr std::ptrdiff_t m_OnScriptEvent = 0x8D8; // CEntityIOOutput[8]
                constexpr std::ptrdiff_t m_matOtherToMain = 0x9A0; // CTransform
                constexpr std::ptrdiff_t m_hInteractionMainEntity = 0x9C0; // CHandle<CBaseEntity>
                constexpr std::ptrdiff_t m_iPlayerDeathBehavior = 0x9C4; // int32
                constexpr std::ptrdiff_t m_bSkipFadeIn = 0x9C8; // bool
            }
            // Parent: CBaseTrigger
            // Fields count: 1
            ...
            namespace CPhysicsSpring {
                constexpr std::ptrdiff_t m_pSpringJoint = 0x788; // IPhysicsJoint*
                constexpr std::ptrdiff_t m_flFrequency = 0x790; // float32
                constexpr std::ptrdiff_t m_flDampingRatio = 0x794; // float32
                constexpr std::ptrdiff_t m_flRestLength = 0x798; // float32
                constexpr std::ptrdiff_t m_nameAttachStart = 0x7A0; // CUtlSymbolLarge
                constexpr std::ptrdiff_t m_nameAttachEnd = 0x7A8; // CUtlSymbolLarge
                constexpr std::ptrdiff_t m_start = 0x7B0; // VectorWS
                constexpr std::ptrdiff_t m_end = 0x7BC; // VectorWS
                constexpr std::ptrdiff_t m_teleportTick = 0x7C8; // uint32
            }
            // Parent: CPointEntity
            // Fields count: 2
            namespace CEnvMuzzleFlash {
                constexpr std::ptrdiff_t m_flScale = 0x788; // float32
                constexpr std::ptrdiff_t m_iszParentAttachment = 0x790; // CUtlSymbolLarge
            }
            // Parent: None
            // Fields count: 5
            ...
            namespace CPathTrack {
                constexpr std::ptrdiff_t m_pnext = 0x788; // CHandle<CPathTrack>
                constexpr std::ptrdiff_t m_pprevious = 0x78C; // CHandle<CPathTrack>
                constexpr std::ptrdiff_t m_paltpath = 0x790; // CHandle<CPathTrack>
                constexpr std::ptrdiff_t m_flSpeed = 0x794; // float32
                constexpr std::ptrdiff_t m_flRadius = 0x798; // float32
                constexpr std::ptrdiff_t m_length = 0x79C; // float32
                constexpr std::ptrdiff_t m_altName = 0x7A0; // CUtlSymbolLarge
                constexpr std::ptrdiff_t m_nIterVal = 0x7A8; // int32
            ...
            namespace CTankTrainAI {
                constexpr std::ptrdiff_t m_hTrain = 0x788; // CHandle<CFuncTrackTrain>
                constexpr std::ptrdiff_t m_hTargetEntity = 0x78C; // CHandle<CBaseEntity>
                constexpr std::ptrdiff_t m_soundPlaying = 0x790; // int32
                constexpr std::ptrdiff_t m_startSoundName = 0x7A8; // CUtlSymbolLarge
                constexpr std::ptrdiff_t m_engineSoundName = 0x7B0; // CUtlSymbolLarge
                constexpr std::ptrdiff_t m_movementSoundName = 0x7B8; // CUtlSymbolLarge
                constexpr std::ptrdiff_t m_targetEntityName = 0x7C0; // CUtlSymbolLarge
            }
            ...
            namespace CLogicCase {
                constexpr std::ptrdiff_t m_nCase = 0x788; // CUtlSymbolLarge[32]
                constexpr std::ptrdiff_t m_nShuffleCases = 0x888; // int32
                constexpr std::ptrdiff_t m_nLastShuffleCase = 0x88C; // int32
                constexpr std::ptrdiff_t m_uchShuffleCaseMap = 0x890; // uint8[32]
                constexpr std::ptrdiff_t m_OnCase = 0x8B0; // CEntityIOOutput[32]
                constexpr std::ptrdiff_t m_OnDefault = 0xBB0; // CEntityOutputTemplate<CUtlString>
            }
            // Parent: None
            // Fields count: 1
            //
            ...
            namespace CInfoGameEventProxy {
                constexpr std::ptrdiff_t m_iszEventName = 0x788; // CUtlSymbolLarge
                constexpr std::ptrdiff_t m_flRange = 0x790; // float32
            }
            // Parent: None
            // Fields count: 0
            ...
            // Fields count: 4
            namespace CInfoFan {
                constexpr std::ptrdiff_t m_fFanForceMaxRadius = 0x7C8; // float32
                constexpr std::ptrdiff_t m_fFanForceMinRadius = 0x7CC; // float32
                constexpr std::ptrdiff_t m_flCurveDistRange = 0x7D0; // float32
            ...
            namespace CCSBot {
                ...
                constexpr std::ptrdiff_t m_stateTimestamp = 0x5C0; // float32
                constexpr std::ptrdiff_t m_isAttacking = 0x5C4; // bool
                constexpr std::ptrdiff_t m_isOpeningDoor = 0x5C5; // bool
                constexpr std::ptrdiff_t m_taskEntity = 0x5CC; // CHandle<CBaseEntity>
                constexpr std::ptrdiff_t m_goalPosition = 0x5DC; // VectorWS
                constexpr std::ptrdiff_t m_goalEntity = 0x5E8; // CHandle<CBaseEntity>
                constexpr std::ptrdiff_t m_avoid = 0x5EC; // CHandle<CBaseEntity>
                constexpr std::ptrdiff_t m_avoidTimestamp = 0x5F0; // float32
                constexpr std::ptrdiff_t m_isStopping = 0x5F4; // bool
            ...
            namespace CHandleTest {
                ...
                constexpr std::ptrdiff_t m_bSendHandle = 0x78C; // bool
            }
            // Parent: CBaseEntity
            // Fields count: 48
            namespace CLogicNPCCounter {
                constexpr std::ptrdiff_t m_OnMinCountAll = 0x788; // CEntityIOOutput
                constexpr std::ptrdiff_t m_OnMaxCountAll = 0x7A0; // CEntityIOOutput
                constexpr std::ptrdiff_t m_OnFactorAll = 0x7B8; // CEntityOutputTemplate<float32>
                constexpr std::ptrdiff_t m_OnMinPlayerDistAll = 0x7D8; // CEntityOutputTemplate<float32>
                constexpr std::ptrdiff_t m_OnMinCount_1 = 0x7F8; // CEntityIOOutput
                constexpr std::ptrdiff_t m_OnMaxCount_1 = 0x810; // CEntityIOOutput
                constexpr std::ptrdiff_t m_OnFactor_1 = 0x828; // CEntityOutputTemplate<float32>
                constexpr std::ptrdiff_t m_OnMinPlayerDist_1 = 0x848; // CEntityOutputTemplate<float32>
                constexpr std::ptrdiff_t m_OnMinCount_2 = 0x868; // CEntityIOOutput
                constexpr std::ptrdiff_t m_OnMaxCount_2 = 0x880; // CEntityIOOutput
                constexpr std::ptrdiff_t m_OnFactor_2 = 0x898; // CEntityOutputTemplate<float32>
                constexpr std::ptrdiff_t m_OnMinPlayerDist_2 = 0x8B8; // CEntityOutputTemplate<float32>
                constexpr std::ptrdiff_t m_OnMinCount_3 = 0x8D8; // CEntityIOOutput
                constexpr std::ptrdiff_t m_OnMaxCount_3 = 0x8F0; // CEntityIOOutput
                constexpr std::ptrdiff_t m_OnFactor_3 = 0x908; // CEntityOutputTemplate<float32>
                constexpr std::ptrdiff_t m_OnMinPlayerDist_3 = 0x928; // CEntityOutputTemplate<float32>
                constexpr std::ptrdiff_t m_hSource = 0x948; // CEntityHandle
                constexpr std::ptrdiff_t m_iszSourceEntityName = 0x950; // CUtlSymbolLarge
                constexpr std::ptrdiff_t m_flDistanceMax = 0x958; // float32
                constexpr std::ptrdiff_t m_bDisabled = 0x95C; // bool
                constexpr std::ptrdiff_t m_nMinCountAll = 0x960; // int32
                constexpr std::ptrdiff_t m_nMaxCountAll = 0x964; // int32
                constexpr std::ptrdiff_t m_nMinFactorAll = 0x968; // int32
                constexpr std::ptrdiff_t m_nMaxFactorAll = 0x96C; // int32
                constexpr std::ptrdiff_t m_iszNPCClassname_1 = 0x978; // CUtlSymbolLarge
                constexpr std::ptrdiff_t m_nNPCState_1 = 0x980; // int32
                constexpr std::ptrdiff_t m_bInvertState_1 = 0x984; // bool
                constexpr std::ptrdiff_t m_nMinCount_1 = 0x988; // int32
                constexpr std::ptrdiff_t m_nMaxCount_1 = 0x98C; // int32
                constexpr std::ptrdiff_t m_nMinFactor_1 = 0x990; // int32
                constexpr std::ptrdiff_t m_nMaxFactor_1 = 0x994; // int32
                constexpr std::ptrdiff_t m_flDefaultDist_1 = 0x99C; // float32
                constexpr std::ptrdiff_t m_iszNPCClassname_2 = 0x9A0; // CUtlSymbolLarge
                constexpr std::ptrdiff_t m_nNPCState_2 = 0x9A8; // int32
                constexpr std::ptrdiff_t m_bInvertState_2 = 0x9AC; // bool
                constexpr std::ptrdiff_t m_nMinCount_2 = 0x9B0; // int32
                constexpr std::ptrdiff_t m_nMaxCount_2 = 0x9B4; // int32
                constexpr std::ptrdiff_t m_nMinFactor_2 = 0x9B8; // int32
                constexpr std::ptrdiff_t m_nMaxFactor_2 = 0x9BC; // int32
                constexpr std::ptrdiff_t m_flDefaultDist_2 = 0x9C4; // float32
                constexpr std::ptrdiff_t m_iszNPCClassname_3 = 0x9C8; // CUtlSymbolLarge
                constexpr std::ptrdiff_t m_nNPCState_3 = 0x9D0; // int32
                constexpr std::ptrdiff_t m_bInvertState_3 = 0x9D4; // bool
                constexpr std::ptrdiff_t m_nMinCount_3 = 0x9D8; // int32
                constexpr std::ptrdiff_t m_nMaxCount_3 = 0x9DC; // int32
                constexpr std::ptrdiff_t m_nMinFactor_3 = 0x9E0; // int32
            ...
            namespace CRagdollConstraint {
                constexpr std::ptrdiff_t m_xmin = 0x7E8; // float32
                constexpr std::ptrdiff_t m_xmax = 0x7EC; // float32
                constexpr std::ptrdiff_t m_ymin = 0x7F0; // float32
                constexpr std::ptrdiff_t m_ymax = 0x7F4; // float32
                constexpr std::ptrdiff_t m_zmin = 0x7F8; // float32
                constexpr std::ptrdiff_t m_zmax = 0x7FC; // float32
                constexpr std::ptrdiff_t m_xfriction = 0x800; // float32
                constexpr std::ptrdiff_t m_yfriction = 0x804; // float32
                constexpr std::ptrdiff_t m_zfriction = 0x808; // float32
            }
            // Parent: CBaseModelEntity
            // Fields count: 0
            ...
            namespace CPointPush {
                ...
                constexpr std::ptrdiff_t m_flInnerRadius = 0x794; // float32
                constexpr std::ptrdiff_t m_flConeOfInfluence = 0x798; // float32
                constexpr std::ptrdiff_t m_iszFilterName = 0x7A0; // CUtlSymbolLarge
                constexpr std::ptrdiff_t m_hFilter = 0x7A8; // CHandle<CBaseFilter>
            }
            // Parent: None
            // Fields count: 1
            //
            ...
            namespace CPlayerPing {
                ...
                constexpr std::ptrdiff_t m_hPingedEntity = 0x794; // CHandle<CBaseEntity>
                constexpr std::ptrdiff_t m_iType = 0x798; // int32
            ...
            namespace CLogicRelay {
                constexpr std::ptrdiff_t m_OnSpawn = 0x788; // CEntityIOOutput
                constexpr std::ptrdiff_t m_OnTrigger = 0x7A0; // CEntityIOOutput
                constexpr std::ptrdiff_t m_bDisabled = 0x7B8; // bool
                constexpr std::ptrdiff_t m_bWaitForRefire = 0x7B9; // bool
                constexpr std::ptrdiff_t m_bTriggerOnce = 0x7BA; // bool
                constexpr std::ptrdiff_t m_bFastRetrigger = 0x7BB; // bool
                constexpr std::ptrdiff_t m_bPassthoughCaller = 0x7BC; // bool
            }
            // Parent: None
            // Fields count: 6
            ...
            namespace CTestPulseIO {
                constexpr std::ptrdiff_t m_OnVariantVoid = 0x788; // CEntityIOOutput
                constexpr std::ptrdiff_t m_OnVariantBool = 0x7A0; // CEntityOutputTemplate<bool>
                constexpr std::ptrdiff_t m_OnVariantInt = 0x7C0; // CEntityOutputTemplate<int32>
                constexpr std::ptrdiff_t m_OnVariantFloat = 0x7E0; // CEntityOutputTemplate<float32>
                constexpr std::ptrdiff_t m_OnVariantString = 0x800; // CEntityOutputTemplate<CUtlSymbolLarge>
                constexpr std::ptrdiff_t m_OnVariantColor = 0x820; // CEntityOutputTemplate<Color>
                constexpr std::ptrdiff_t m_OnVariantVector = 0x840; // CEntityOutputTemplate<Vector>
                constexpr std::ptrdiff_t m_bAllowEmptyInputs = 0x868; // bool
                constexpr std::ptrdiff_t m_TestComponent = 0x870; // CTestPulseIOComponent_Derived
                constexpr std::ptrdiff_t m_OnInternalTestVoid = 0x8A0; // CEntityIOOutput
                constexpr std::ptrdiff_t m_OnInternalTestBool = 0x8B8; // CEntityOutputTemplate<bool>
                constexpr std::ptrdiff_t m_OnInternalTestInt = 0x8D8; // CEntityOutputTemplate<int32>
                constexpr std::ptrdiff_t m_OnInternalTestFloat = 0x8F8; // CEntityOutputTemplate<float32>
                constexpr std::ptrdiff_t m_OnInternalTestString = 0x918; // CEntityOutputTemplate<CUtlSymbolLarge>
                constexpr std::ptrdiff_t m_OnInternalTestColor = 0x938; // CEntityOutputTemplate<Color>
                constexpr std::ptrdiff_t m_OnInternalTestVector = 0x958; // CEntityOutputTemplate<Vector>
                constexpr std::ptrdiff_t m_OnInternalTestEntityName = 0x980; // CEntityOutputTemplate<CEntityNameString>
                constexpr std::ptrdiff_t m_OnInternalTestEntityHandle = 0x9A0; // CEntityOutputTemplate<CHandle<CBaseEntity>>
                constexpr std::ptrdiff_t m_OnInternalTestSchemaEnum = 0x9C0; // CEntityOutputTemplate<TestInputOutputCombinationsEnum_t>
                constexpr std::ptrdiff_t m_OnInternalTestFloatString = 0x9E0; // CEntityOutputTemplate<CTestPulseIO::FloatStringArgs_t>
                constexpr std::ptrdiff_t m_OnInternalTestEntityNameString = 0xA08; // CEntityOutputTemplate<CTestPulseIO::EntityNameStringArgs_t>
            ...
            namespace CPointEntityFinder {
                constexpr std::ptrdiff_t m_hEntity = 0x788; // CHandle<CBaseEntity>
                constexpr std::ptrdiff_t m_iFilterName = 0x790; // CUtlSymbolLarge
                constexpr std::ptrdiff_t m_hFilter = 0x798; // CHandle<CBaseFilter>
                constexpr std::ptrdiff_t m_iRefName = 0x7A0; // CUtlSymbolLarge
                constexpr std::ptrdiff_t m_hReference = 0x7A8; // CHandle<CBaseEntity>
                constexpr std::ptrdiff_t m_FindMethod = 0x7AC; // EntFinderMethod_t
            ...
            namespace CPointChildModifier {
                constexpr std::ptrdiff_t m_bOrphanInsteadOfDeletingChildrenOnRemove = 0x788; // bool
            }
            // Parent: None
            // Fields count: 2
            ...
            namespace CPathParticleRope {
                constexpr std::ptrdiff_t m_bStartActive = 0x790; // bool
                constexpr std::ptrdiff_t m_flMaxSimulationTime = 0x794; // float32
                constexpr std::ptrdiff_t m_iszEffectName = 0x798; // CUtlSymbolLarge
                constexpr std::ptrdiff_t m_PathNodes_Name = 0x7A0; // CUtlVector<CUtlSymbolLarge>
                constexpr std::ptrdiff_t m_flParticleSpacing = 0x7B8; // float32
                constexpr std::ptrdiff_t m_flSlack = 0x7BC; // float32
                constexpr std::ptrdiff_t m_flRadius = 0x7C0; // float32
                constexpr std::ptrdiff_t m_ColorTint = 0x7C4; // Color
                constexpr std::ptrdiff_t m_nEffectState = 0x7C8; // int32
                constexpr std::ptrdiff_t m_iEffectIndex = 0x7D0; // CStrongHandle<InfoForResourceTypeIParticleSystemDefinition>
                constexpr std::ptrdiff_t m_PathNodes_Position = 0x7D8; // CNetworkUtlVectorBase<Vector>
                constexpr std::ptrdiff_t m_PathNodes_TangentIn = 0x7F0; // CNetworkUtlVectorBase<Vector>
                constexpr std::ptrdiff_t m_PathNodes_TangentOut = 0x808; // CNetworkUtlVectorBase<Vector>
                constexpr std::ptrdiff_t m_PathNodes_Color = 0x820; // CNetworkUtlVectorBase<Vector>
                constexpr std::ptrdiff_t m_PathNodes_PinEnabled = 0x838; // CNetworkUtlVectorBase<bool>
                constexpr std::ptrdiff_t m_PathNodes_RadiusScale = 0x850; // CNetworkUtlVectorBase<float32>
            }
            // Parent: CPointEntity
            // Fields count: 3
            namespace CCredits {
                constexpr std::ptrdiff_t m_OnCreditsDone = 0x788; // CEntityIOOutput
            ...
            // Fields count: 7
            namespace CFishPool {
                constexpr std::ptrdiff_t m_fishCount = 0x794; // int32
                constexpr std::ptrdiff_t m_maxRange = 0x798; // float32
                constexpr std::ptrdiff_t m_swimDepth = 0x79C; // float32
                constexpr std::ptrdiff_t m_waterLevel = 0x7A0; // float32
                constexpr std::ptrdiff_t m_isDormant = 0x7A4; // bool
            ...
            namespace CInfoDynamicShadowHintBox {
                constexpr std::ptrdiff_t m_vBoxMins = 0x79C; // Vector
                constexpr std::ptrdiff_t m_vBoxMaxs = 0x7A8; // Vector
            }
            ...
            namespace CFilterMultiple {
                constexpr std::ptrdiff_t m_nFilterType = 0x7C0; // filter_t
            ...
            namespace CCSPlayerResource {
                ...
                constexpr std::ptrdiff_t m_isHostageFollowingSomeone = 0x794; // bool[12]
                constexpr std::ptrdiff_t m_iHostageEntityIDs = 0x7A0; // CEntityIndex[12]
                constexpr std::ptrdiff_t m_bombsiteCenterA = 0x7D0; // VectorWS
                constexpr std::ptrdiff_t m_bombsiteCenterB = 0x7DC; // VectorWS
                constexpr std::ptrdiff_t m_hostageRescueX = 0x7E8; // int32[4]
                constexpr std::ptrdiff_t m_hostageRescueY = 0x7F8; // int32[4]
                constexpr std::ptrdiff_t m_hostageRescueZ = 0x808; // int32[4]
                constexpr std::ptrdiff_t m_bEndMatchNextMapAllVoted = 0x818; // bool
                constexpr std::ptrdiff_t m_foundGoalPositions = 0x819; // bool
            }
            // Parent: None
            // Fields count: 3
            //
            ...
            namespace CMoverPathNode {
                constexpr std::ptrdiff_t m_OnStartFromOrInSegment = 0x7D8; // CEntityOutputTemplate<CUtlString>
                constexpr std::ptrdiff_t m_OnStoppedAtOrInSegment = 0x7F8; // CEntityOutputTemplate<CUtlString>
                constexpr std::ptrdiff_t m_OnPassThrough = 0x818; // CEntityOutputTemplate<CUtlString>
                constexpr std::ptrdiff_t m_OnPassThroughForward = 0x838; // CEntityOutputTemplate<CUtlString>
                constexpr std::ptrdiff_t m_OnPassThroughReverse = 0x858; // CEntityOutputTemplate<CUtlString>
            }
            // Parent: CBaseEntity
            // Fields count: 11
            namespace CEnvSoundscape {
                constexpr std::ptrdiff_t m_OnPlay = 0x788; // CEntityIOOutput
                constexpr std::ptrdiff_t m_flRadius = 0x7A0; // float32
                constexpr std::ptrdiff_t m_soundEventName = 0x7A8; // CGameSoundEventName
                constexpr std::ptrdiff_t m_bOverrideWithEvent = 0x7B0; // bool
                constexpr std::ptrdiff_t m_soundscapeIndex = 0x7B4; // int32
                constexpr std::ptrdiff_t m_soundscapeEntityListId = 0x7B8; // int32
                constexpr std::ptrdiff_t m_positionNames = 0x7C0; // CUtlSymbolLarge[8]
                constexpr std::ptrdiff_t m_hProxySoundscape = 0x800; // CHandle<CEnvSoundscape>
                constexpr std::ptrdiff_t m_bDisabled = 0x804; // bool
                constexpr std::ptrdiff_t m_soundscapeName = 0x808; // CUtlSymbolLarge
                constexpr std::ptrdiff_t m_soundEventHash = 0x810; // uint32
            }
            // Parent: CBaseModelEntity
            // Fields count: 6
            ...
            namespace CLogicEventListener {
                constexpr std::ptrdiff_t m_strEventName = 0x798; // CUtlString
                constexpr std::ptrdiff_t m_bIsEnabled = 0x7A0; // bool
            ...
            namespace FilterHealth {
                constexpr std::ptrdiff_t m_bAdrenalineActive = 0x7C0; // bool
            ...
            namespace CMathColorBlend {
                constexpr std::ptrdiff_t m_flInMin = 0x788; // float32
                constexpr std::ptrdiff_t m_flInMax = 0x78C; // float32
                constexpr std::ptrdiff_t m_OutColor1 = 0x790; // Color
            ...
            namespace CLogicDistanceCheck {
                constexpr std::ptrdiff_t m_iszEntityA = 0x788; // CUtlSymbolLarge
                constexpr std::ptrdiff_t m_iszEntityB = 0x790; // CUtlSymbolLarge
                constexpr std::ptrdiff_t m_flZone1Distance = 0x798; // float32
                constexpr std::ptrdiff_t m_flZone2Distance = 0x79C; // float32
                constexpr std::ptrdiff_t m_InZone1 = 0x7A0; // CEntityIOOutput
                constexpr std::ptrdiff_t m_InZone2 = 0x7B8; // CEntityIOOutput
            ...
            namespace CLogicDistanceAutosave {
                constexpr std::ptrdiff_t m_iszTargetEntity = 0x788; // CUtlSymbolLarge
                constexpr std::ptrdiff_t m_flDistanceToPlayer = 0x790; // float32
                constexpr std::ptrdiff_t m_bForceNewLevelUnit = 0x794; // bool
                constexpr std::ptrdiff_t m_bCheckCough = 0x795; // bool
                constexpr std::ptrdiff_t m_bThinkDangerous = 0x796; // bool
                constexpr std::ptrdiff_t m_flDangerousTime = 0x798; // float32
            }
            // Parent: CBaseEntity
            // Fields count: 4
            namespace CLogicBranch {
                constexpr std::ptrdiff_t m_bInValue = 0x788; // bool
                constexpr std::ptrdiff_t m_Listeners = 0x790; // CUtlVector<CHandle<CBaseEntity>>
                constexpr std::ptrdiff_t m_OnTrue = 0x7A8; // CEntityIOOutput
                constexpr std::ptrdiff_t m_OnFalse = 0x7C0; // CEntityIOOutput
            }
            // Parent: None
            // Fields count: 9
            //
            ...
            namespace CEnvInstructorHint {
                constexpr std::ptrdiff_t m_iszName = 0x788; // CUtlSymbolLarge
                constexpr std::ptrdiff_t m_iszReplace_Key = 0x790; // CUtlSymbolLarge
                constexpr std::ptrdiff_t m_iszHintTargetEntity = 0x798; // CUtlSymbolLarge
                constexpr std::ptrdiff_t m_iTimeout = 0x7A0; // int32
                constexpr std::ptrdiff_t m_iDisplayLimit = 0x7A4; // int32
                constexpr std::ptrdiff_t m_iszIcon_Onscreen = 0x7A8; // CUtlSymbolLarge
                constexpr std::ptrdiff_t m_iszIcon_Offscreen = 0x7B0; // CUtlSymbolLarge
                constexpr std::ptrdiff_t m_iszCaption = 0x7B8; // CUtlSymbolLarge
                constexpr std::ptrdiff_t m_iszActivatorCaption = 0x7C0; // CUtlSymbolLarge
                constexpr std::ptrdiff_t m_Color = 0x7C8; // Color
                constexpr std::ptrdiff_t m_fIconOffset = 0x7CC; // float32
                constexpr std::ptrdiff_t m_fRange = 0x7D0; // float32
                constexpr std::ptrdiff_t m_iPulseOption = 0x7D4; // uint8
                constexpr std::ptrdiff_t m_iAlphaOption = 0x7D5; // uint8
                constexpr std::ptrdiff_t m_iShakeOption = 0x7D6; // uint8
                constexpr std::ptrdiff_t m_bStatic = 0x7D7; // bool
                constexpr std::ptrdiff_t m_bNoOffscreen = 0x7D8; // bool
                constexpr std::ptrdiff_t m_bForceCaption = 0x7D9; // bool
                constexpr std::ptrdiff_t m_iInstanceType = 0x7DC; // int32
                constexpr std::ptrdiff_t m_bSuppressRest = 0x7E0; // bool
                constexpr std::ptrdiff_t m_iszBinding = 0x7E8; // CUtlSymbolLarge
                constexpr std::ptrdiff_t m_bAllowNoDrawTarget = 0x7F0; // bool
                constexpr std::ptrdiff_t m_bAutoStart = 0x7F1; // bool
                constexpr std::ptrdiff_t m_bLocalPlayerOnly = 0x7F2; // bool
            }
            // Parent: CBaseEntity
            // Fields count: 1
            namespace CEnvWind {
            ...
            namespace CCSPlayerPawn {
                ...
                constexpr std::ptrdiff_t m_vecStashedVelocity = 0x1610; // Vector
                constexpr std::ptrdiff_t m_bCommittingSuicideOnTeamChange = 0x1628; // bool
                constexpr std::ptrdiff_t m_wasNotKilledNaturally = 0x1629; // bool
                constexpr std::ptrdiff_t m_fImmuneToGunGameDamageTime = 0x162C; // GameTime_t
                constexpr std::ptrdiff_t m_bGunGameImmunity = 0x1630; // bool
                constexpr std::ptrdiff_t m_fMolotovDamageTime = 0x1634; // float32
                constexpr std::ptrdiff_t m_angEyeAngles = 0x1638; // QAngle
            }
            // Parent: CBaseEntity
            // Fields count: 22
            ...
            namespace CRagdollManager {
                constexpr std::ptrdiff_t m_iCurrentMaxRagdollCount = 0x788; // int8
                constexpr std::ptrdiff_t m_iMaxRagdollCount = 0x78C; // int32
                constexpr std::ptrdiff_t m_bSaveImportant = 0x790; // bool
                constexpr std::ptrdiff_t m_bCanTakeDamage = 0x791; // bool
            }
            // Parent: CSoundOpvarSetPointEntity
            // Fields count: 9
            namespace CSoundOpvarSetBoxEntity {
                constexpr std::ptrdiff_t m_vDistanceInnerMins = 0x91C; // Vector
                constexpr std::ptrdiff_t m_vDistanceInnerMaxs = 0x928; // Vector
                constexpr std::ptrdiff_t m_vDistanceOuterMins = 0x934; // Vector
                constexpr std::ptrdiff_t m_vDistanceOuterMaxs = 0x940; // Vector
                constexpr std::ptrdiff_t m_nBoxDirection = 0x94C; // int32
                constexpr std::ptrdiff_t m_vInnerMins = 0x950; // Vector
                constexpr std::ptrdiff_t m_vInnerMaxs = 0x95C; // Vector
                constexpr std::ptrdiff_t m_vOuterMins = 0x968; // Vector
                constexpr std::ptrdiff_t m_vOuterMaxs = 0x974; // Vector
            }
            // Parent: CBaseTrigger
            // Fields count: 12
            ...
            namespace CPointProximitySensor {
                constexpr std::ptrdiff_t m_bDisabled = 0x788; // bool
                constexpr std::ptrdiff_t m_hTargetEntity = 0x78C; // CHandle<CBaseEntity>
                constexpr std::ptrdiff_t m_Distance = 0x790; // CEntityOutputTemplate<float32>
            }
            // Parent: None
            // Fields count: 5
            //
            ...
            namespace CPhysTorque {
                constexpr std::ptrdiff_t m_axis = 0x7E8; // Vector
            }
            // Parent: CBaseEntity
            // Fields count: 5
            namespace CMultiSource {
                constexpr std::ptrdiff_t m_rgEntities = 0x788; // CHandle<CBaseEntity>[32]
                constexpr std::ptrdiff_t m_rgTriggered = 0x808; // int32[32]
                constexpr std::ptrdiff_t m_OnTrigger = 0x888; // CEntityIOOutput
            ...
            namespace CLogicAuto {
                constexpr std::ptrdiff_t m_OnMapSpawn = 0x788; // CEntityIOOutput
                constexpr std::ptrdiff_t m_OnDemoMapSpawn = 0x7A0; // CEntityIOOutput
                constexpr std::ptrdiff_t m_OnNewGame = 0x7B8; // CEntityIOOutput
                constexpr std::ptrdiff_t m_OnLoadGame = 0x7D0; // CEntityIOOutput
                constexpr std::ptrdiff_t m_OnMapTransition = 0x7E8; // CEntityIOOutput
                constexpr std::ptrdiff_t m_OnBackgroundMap = 0x800; // CEntityIOOutput
                constexpr std::ptrdiff_t m_OnMultiNewMap = 0x818; // CEntityIOOutput
                constexpr std::ptrdiff_t m_OnMultiNewRound = 0x830; // CEntityIOOutput
                constexpr std::ptrdiff_t m_OnVREnabled = 0x848; // CEntityIOOutput
                constexpr std::ptrdiff_t m_OnVRNotEnabled = 0x860; // CEntityIOOutput
                constexpr std::ptrdiff_t m_globalstate = 0x878; // CUtlSymbolLarge
            }
            // Parent: CBaseEntity
            // Fields count: 1
            ...
            namespace CInfoDynamicShadowHint {
                constexpr std::ptrdiff_t m_bDisabled = 0x788; // bool
                constexpr std::ptrdiff_t m_flRange = 0x78C; // float32
                constexpr std::ptrdiff_t m_nImportance = 0x790; // int32
                constexpr std::ptrdiff_t m_nLightChoice = 0x794; // int32
                constexpr std::ptrdiff_t m_hLight = 0x798; // CHandle<CBaseEntity>
            }
            // Parent: CBaseModelEntity
            // Fields count: 1
            ...
            // Fields count: 6
            namespace CPathNode {
                constexpr std::ptrdiff_t m_vInTangentLocal = 0x788; // Vector
                constexpr std::ptrdiff_t m_vOutTangentLocal = 0x794; // Vector
                constexpr std::ptrdiff_t m_strParentPathUniqueID = 0x7A0; // CUtlString
                constexpr std::ptrdiff_t m_strPathNodeParameter = 0x7A8; // CUtlString
            ...
            namespace CLogicGameEventListener {
                constexpr std::ptrdiff_t m_OnEventFired = 0x798; // CEntityIOOutput
                constexpr std::ptrdiff_t m_iszGameEventName = 0x7B0; // CUtlSymbolLarge
                constexpr std::ptrdiff_t m_iszGameEventItem = 0x7B8; // CUtlSymbolLarge
                constexpr std::ptrdiff_t m_bEnabled = 0x7C0; // bool
                constexpr std::ptrdiff_t m_bStartDisabled = 0x7C1; // bool
            }
            // Parent: None
            // Fields count: 0
            ...
            namespace CLogicAutosave {
                constexpr std::ptrdiff_t m_bForceNewLevelUnit = 0x788; // bool
            ...
            namespace CSingleplayRules {
                constexpr std::ptrdiff_t m_bSinglePlayerGameEnding = 0xC9; // bool
            }
            // Parent: None
            // Fields count: 17
            //
            ...
            namespace CPointPrefab {
                ...
                constexpr std::ptrdiff_t m_forceWorldGroupID = 0x790; // CUtlSymbolLarge
                constexpr std::ptrdiff_t m_associatedRelayTargetName = 0x798; // CUtlSymbolLarge
                constexpr std::ptrdiff_t m_fixupNames = 0x7A0; // bool
                constexpr std::ptrdiff_t m_bLoadDynamic = 0x7A1; // bool
                constexpr std::ptrdiff_t m_associatedRelayEntity = 0x7A4; // CHandle<CPointPrefab>
                constexpr std::ptrdiff_t m_ProceduralRelaySources = 0x7A8; // CUtlVector<CHandle<CBaseEntity>>
            }
            // Parent: None
            // Fields count: 1
            //
            ...
            namespace CEnvInstructorVRHint {
                ...
                constexpr std::ptrdiff_t m_iTimeout = 0x798; // int32
                constexpr std::ptrdiff_t m_iszCaption = 0x7A0; // CUtlSymbolLarge
                constexpr std::ptrdiff_t m_iszStartSound = 0x7A8; // CUtlSymbolLarge
                constexpr std::ptrdiff_t m_iLayoutFileType = 0x7B0; // int32
                constexpr std::ptrdiff_t m_iszCustomLayoutFile = 0x7B8; // CUtlSymbolLarge
            ...
            namespace CEnvGlobal {
                constexpr std::ptrdiff_t m_outCounter = 0x788; // CEntityOutputTemplate<int32>
                constexpr std::ptrdiff_t m_globalstate = 0x7A8; // CUtlSymbolLarge
                constexpr std::ptrdiff_t m_triggermode = 0x7B0; // int32
                constexpr std::ptrdiff_t m_initialstate = 0x7B4; // int32
                constexpr std::ptrdiff_t m_counter = 0x7B8; // int32
            }
            // Parent: None
            // Fields count: 0
            ...
            namespace CSceneEntity {
                ...
                constexpr std::ptrdiff_t m_iszTarget2 = 0x7A0; // CUtlSymbolLarge
                constexpr std::ptrdiff_t m_iszTarget3 = 0x7A8; // CUtlSymbolLarge
                constexpr std::ptrdiff_t m_iszTarget4 = 0x7B0; // CUtlSymbolLarge
                constexpr std::ptrdiff_t m_iszTarget5 = 0x7B8; // CUtlSymbolLarge
                constexpr std::ptrdiff_t m_iszTarget6 = 0x7C0; // CUtlSymbolLarge
                constexpr std::ptrdiff_t m_iszTarget7 = 0x7C8; // CUtlSymbolLarge
                constexpr std::ptrdiff_t m_iszTarget8 = 0x7D0; // CUtlSymbolLarge
                constexpr std::ptrdiff_t m_hTarget1 = 0x7D8; // CHandle<CBaseEntity>
                constexpr std::ptrdiff_t m_hTarget2 = 0x7DC; // CHandle<CBaseEntity>
                constexpr std::ptrdiff_t m_hTarget3 = 0x7E0; // CHandle<CBaseEntity>
                constexpr std::ptrdiff_t m_hTarget4 = 0x7E4; // CHandle<CBaseEntity>
                constexpr std::ptrdiff_t m_hTarget5 = 0x7E8; // CHandle<CBaseEntity>
                constexpr std::ptrdiff_t m_hTarget6 = 0x7EC; // CHandle<CBaseEntity>
                constexpr std::ptrdiff_t m_hTarget7 = 0x7F0; // CHandle<CBaseEntity>
                constexpr std::ptrdiff_t m_hTarget8 = 0x7F4; // CHandle<CBaseEntity>
                constexpr std::ptrdiff_t m_hLocatorOrigin = 0x7F8; // CHandle<CBaseEntity>
                constexpr std::ptrdiff_t m_sTargetAttachment = 0x800; // CUtlSymbolLarge
                constexpr std::ptrdiff_t m_bIsPlayingBack = 0x808; // bool
                constexpr std::ptrdiff_t m_bPaused = 0x809; // bool
                constexpr std::ptrdiff_t m_bMultiplayer = 0x80A; // bool
                constexpr std::ptrdiff_t m_bAutogenerated = 0x80B; // bool
                constexpr std::ptrdiff_t m_flForceClientTime = 0x80C; // float32
                ...
                constexpr std::ptrdiff_t m_flAutomationDelay = 0x828; // float32
                constexpr std::ptrdiff_t m_flAutomationTime = 0x82C; // float32
                constexpr std::ptrdiff_t m_nSpeechPriority = 0x830; // int32
                constexpr std::ptrdiff_t m_bPausedViaInput = 0x834; // bool
                constexpr std::ptrdiff_t m_bPauseAtNextInterrupt = 0x835; // bool
                constexpr std::ptrdiff_t m_bWaitingForActor = 0x836; // bool
                constexpr std::ptrdiff_t m_bWaitingForInterrupt = 0x837; // bool
                constexpr std::ptrdiff_t m_bInterruptedActorsScenes = 0x838; // bool
                constexpr std::ptrdiff_t m_bBreakOnNonIdle = 0x839; // bool
                constexpr std::ptrdiff_t m_bSceneFinished = 0x83A; // bool
                constexpr std::ptrdiff_t m_hActorList = 0x840; // CNetworkUtlVectorBase<CHandle<CBaseModelEntity>>
                constexpr std::ptrdiff_t m_hRemoveActorList = 0x858; // CUtlVector<CHandle<CBaseEntity>>
                constexpr std::ptrdiff_t m_nSceneStringIndex = 0x8A0; // uint16
                constexpr std::ptrdiff_t m_OnStart = 0x8A8; // CEntityIOOutput
                constexpr std::ptrdiff_t m_OnCompletion = 0x8C0; // CEntityIOOutput
                constexpr std::ptrdiff_t m_OnCanceled = 0x8D8; // CEntityIOOutput
            ...
            namespace CTonemapController2 {
                constexpr std::ptrdiff_t m_flAutoExposureMin = 0x788; // float32
                constexpr std::ptrdiff_t m_flAutoExposureMax = 0x78C; // float32
                constexpr std::ptrdiff_t m_flExposureAdaptationSpeedUp = 0x790; // float32
                constexpr std::ptrdiff_t m_flExposureAdaptationSpeedDown = 0x794; // float32
                constexpr std::ptrdiff_t m_flTonemapEVSmoothingRange = 0x798; // float32
            }
            // Parent: CBaseEntity
            // Fields count: 1
            ...
            namespace CGameGibManager {
                constexpr std::ptrdiff_t m_bAllowNewGibs = 0x7A0; // bool
                constexpr std::ptrdiff_t m_iCurrentMaxPieces = 0x7A4; // int32
            ...
            namespace CSkyCamera {
                constexpr std::ptrdiff_t m_skyboxData = 0x788; // sky3dparams_t
                constexpr std::ptrdiff_t m_skyboxSlotToken = 0x818; // CUtlStringToken
            ...
            namespace CPhysPulley {
                constexpr std::ptrdiff_t m_position2 = 0x7E8; // VectorWS
                constexpr std::ptrdiff_t m_offset = 0x7F4; // Vector[2]
            ...
            namespace CSoundStackSave {
                constexpr std::ptrdiff_t m_iszStackName = 0x788; // CUtlSymbolLarge
            }
            // Parent: None
            // Fields count: 1
            //
            ...
            namespace CLogicMeasureMovement {
                constexpr std::ptrdiff_t m_strMeasureTarget = 0x788; // CUtlSymbolLarge
                constexpr std::ptrdiff_t m_strMeasureReference = 0x790; // CUtlSymbolLarge
                constexpr std::ptrdiff_t m_strTargetReference = 0x798; // CUtlSymbolLarge
                constexpr std::ptrdiff_t m_hMeasureTarget = 0x7A0; // CHandle<CBaseEntity>
                constexpr std::ptrdiff_t m_hMeasureReference = 0x7A4; // CHandle<CBaseEntity>
                constexpr std::ptrdiff_t m_hTarget = 0x7A8; // CHandle<CBaseEntity>
                constexpr std::ptrdiff_t m_hTargetReference = 0x7AC; // CHandle<CBaseEntity>
                constexpr std::ptrdiff_t m_flScale = 0x7B0; // float32
                constexpr std::ptrdiff_t m_nMeasureType = 0x7B4; // int32
            }
            // Parent: CBaseEntity
            // Fields count: 4
            namespace CLogicActivityEvent {
                constexpr std::ptrdiff_t m_nEventType = 0x788; // int32
                constexpr std::ptrdiff_t m_flDuration = 0x78C; // float32
            ...
            namespace CEnvDetailController {
                constexpr std::ptrdiff_t m_flFadeStartDist = 0x788; // float32
                constexpr std::ptrdiff_t m_flFadeEndDist = 0x78C; // float32
            }
            ...
            namespace CEnvSoundscapeProxy {
                constexpr std::ptrdiff_t m_MainSoundscapeName = 0x818; // CUtlSymbolLarge
            }
            // Parent: None
            // Fields count: 1
            //
            ...
            namespace CPhysThruster {
                constexpr std::ptrdiff_t m_localOrigin = 0x7E8; // Vector
            }
            // Parent: CPointEntity
            // Fields count: 3
            namespace CInfoPlayerStart {
                constexpr std::ptrdiff_t m_bDisabled = 0x788; // bool
                constexpr std::ptrdiff_t m_bIsMaster = 0x789; // bool
                constexpr std::ptrdiff_t m_pPawnSubclass = 0x790; // CGlobalSymbol
            }
            // Parent: None
            // Fields count: 10
            namespace CEntityFlame {
                constexpr std::ptrdiff_t m_hEntAttached = 0x788; // CHandle<CBaseEntity>
                constexpr std::ptrdiff_t m_bCheapEffect = 0x78C; // bool
                constexpr std::ptrdiff_t m_flSize = 0x790; // float32
                constexpr std::ptrdiff_t m_bUseHitboxes = 0x794; // bool
                constexpr std::ptrdiff_t m_iNumHitboxFires = 0x798; // int32
                constexpr std::ptrdiff_t m_flHitboxFireScale = 0x79C; // float32
                constexpr std::ptrdiff_t m_flLifetime = 0x7A0; // GameTime_t
                constexpr std::ptrdiff_t m_hAttacker = 0x7A4; // CHandle<CBaseEntity>
                constexpr std::ptrdiff_t m_flDirectDamagePerSecond = 0x7A8; // float32
                constexpr std::ptrdiff_t m_iCustomDamageType = 0x7AC; // int32
            }
            ...
            namespace CSkeletonInstance {
                ...
                constexpr std::ptrdiff_t m_bDirtyMotionType = 0x3C2; // bool
                constexpr std::ptrdiff_t m_bIsGeneratingLatchedParentSpaceState = 0x3C3; // bool
                constexpr std::ptrdiff_t m_materialGroup = 0x3C8; // CUtlStringToken
                constexpr std::ptrdiff_t m_nHitboxSet = 0x3CC; // uint8
                constexpr std::ptrdiff_t m_bForceServerConstraintsEnabled = 0x42C; // bool
            }
            // Parent: None
            // Fields count: 0
            ...
            namespace CPointTeleport {
                constexpr std::ptrdiff_t m_vSaveOrigin = 0x788; // VectorWS
                constexpr std::ptrdiff_t m_vSaveAngles = 0x794; // QAngle
                constexpr std::ptrdiff_t m_bTeleportParentedEntities = 0x7A0; // bool
                constexpr std::ptrdiff_t m_bTeleportUseCurrentAngle = 0x7A1; // bool
            }
            // Parent: CBaseTrigger
            // Fields count: 3
            ...
            namespace CMessageEntity {
                constexpr std::ptrdiff_t m_radius = 0x788; // int32
                constexpr std::ptrdiff_t m_messageText = 0x790; // CUtlSymbolLarge
                constexpr std::ptrdiff_t m_drawText = 0x798; // bool
                constexpr std::ptrdiff_t m_bDeveloperOnly = 0x799; // bool
                constexpr std::ptrdiff_t m_bEnabled = 0x79A; // bool
            }
            // Parent: CBaseEntity
            // Fields count: 1
            namespace CEnvEntityIgniter {
                constexpr std::ptrdiff_t m_flLifetime = 0x788; // float32
            }
            // Parent: None
            // Fields count: 2
            //
            ...
            namespace CMultiLightProxy {
                constexpr std::ptrdiff_t m_iszLightNameFilter = 0x788; // CUtlSymbolLarge
                constexpr std::ptrdiff_t m_iszLightClassFilter = 0x790; // CUtlSymbolLarge
                constexpr std::ptrdiff_t m_flLightRadiusFilter = 0x798; // float32
                constexpr std::ptrdiff_t m_flBrightnessDelta = 0x79C; // float32
                constexpr std::ptrdiff_t m_bPerformScreenFade = 0x7A0; // bool
                constexpr std::ptrdiff_t m_flTargetBrightnessMultiplier = 0x7A4; // float32
                constexpr std::ptrdiff_t m_flCurrentBrightnessMultiplier = 0x7A8; // float32
                constexpr std::ptrdiff_t m_vecLights = 0x7B0; // CUtlVector<CHandle<CLightEntity>>
            }
            // Parent: None
            // Fields count: 0
            ...
            namespace CFogController {
                constexpr std::ptrdiff_t m_fog = 0x788; // fogparams_t
            ...
            namespace CInfoOffscreenPanoramaTexture {
                ...
                constexpr std::ptrdiff_t m_szLayoutFileName = 0x7A0; // CUtlSymbolLarge
                constexpr std::ptrdiff_t m_RenderAttrName = 0x7A8; // CUtlSymbolLarge
                constexpr std::ptrdiff_t m_TargetEntities = 0x7B0; // CNetworkUtlVectorBase<CHandle<CBaseModelEntity>>
                constexpr std::ptrdiff_t m_nTargetChangeCount = 0x7C8; // int32
                constexpr std::ptrdiff_t m_vecCSSClasses = 0x7D0; // CNetworkUtlVectorBase<CUtlSymbolLarge>
                constexpr std::ptrdiff_t m_szTargetsName = 0x7E8; // CUtlSymbolLarge
                constexpr std::ptrdiff_t m_AdditionalTargetEntities = 0x7F0; // CUtlVector<CHandle<CBaseModelEntity>>
            }
            // Parent: CPointEntity
            // Fields count: 16
            namespace CPointAngularVelocitySensor {
                constexpr std::ptrdiff_t m_hTargetEntity = 0x788; // CHandle<CBaseEntity>
                constexpr std::ptrdiff_t m_flThreshold = 0x78C; // float32
                constexpr std::ptrdiff_t m_nLastCompareResult = 0x790; // int32
                constexpr std::ptrdiff_t m_nLastFireResult = 0x794; // int32
                constexpr std::ptrdiff_t m_flFireTime = 0x798; // GameTime_t
                constexpr std::ptrdiff_t m_flFireInterval = 0x79C; // float32
                constexpr std::ptrdiff_t m_flLastAngVelocity = 0x7A0; // float32
                constexpr std::ptrdiff_t m_lastOrientation = 0x7A4; // QAngle
                constexpr std::ptrdiff_t m_vecAxis = 0x7B0; // VectorWS
                constexpr std::ptrdiff_t m_bUseHelper = 0x7BC; // bool
                constexpr std::ptrdiff_t m_AngularVelocity = 0x7C0; // CEntityOutputTemplate<float32>
                constexpr std::ptrdiff_t m_OnLessThan = 0x7E0; // CEntityIOOutput
                constexpr std::ptrdiff_t m_OnLessThanOrEqualTo = 0x7F8; // CEntityIOOutput
                constexpr std::ptrdiff_t m_OnGreaterThan = 0x810; // CEntityIOOutput
                constexpr std::ptrdiff_t m_OnGreaterThanOrEqualTo = 0x828; // CEntityIOOutput
                constexpr std::ptrdiff_t m_OnEqualTo = 0x840; // CEntityIOOutput
            }
            // Parent: CBaseEntity
            // Fields count: 6
            namespace CPlayerVisibility {
                constexpr std::ptrdiff_t m_flVisibilityStrength = 0x788; // float32
                constexpr std::ptrdiff_t m_flFogDistanceMultiplier = 0x78C; // float32
                constexpr std::ptrdiff_t m_flFogMaxDensityMultiplier = 0x790; // float32
                constexpr std::ptrdiff_t m_flFadeTime = 0x794; // float32
                constexpr std::ptrdiff_t m_bStartDisabled = 0x798; // bool
                constexpr std::ptrdiff_t m_bIsEnabled = 0x799; // bool
            }
            // Parent: None
            // Fields count: 2
            //
            ...
            namespace CFilterAttributeInt {
                constexpr std::ptrdiff_t m_sAttributeName = 0x7C0; // CUtlSymbolLarge
            }
            // Parent: CPointEntity
            // Fields count: 8
            namespace CKeepUpright {
                constexpr std::ptrdiff_t m_worldGoalAxis = 0x790; // Vector
                constexpr std::ptrdiff_t m_localTestAxis = 0x79C; // Vector
                constexpr std::ptrdiff_t m_pController = 0x7A8; // IPhysicsMotionController*
                constexpr std::ptrdiff_t m_nameAttach = 0x7B0; // CUtlSymbolLarge
                constexpr std::ptrdiff_t m_attachedObject = 0x7B8; // CHandle<CBaseEntity>
                constexpr std::ptrdiff_t m_angularLimit = 0x7BC; // float32
                constexpr std::ptrdiff_t m_bActive = 0x7C0; // bool
                constexpr std::ptrdiff_t m_bDampAllRotation = 0x7C1; // bool
            }
            // Parent: CBaseEntity
            // Fields count: 12
            namespace CPointTemplate {
                constexpr std::ptrdiff_t m_iszWorldName = 0x788; // CUtlSymbolLarge
                constexpr std::ptrdiff_t m_iszSource2EntityLumpName = 0x790; // CUtlSymbolLarge
                constexpr std::ptrdiff_t m_iszEntityFilterName = 0x798; // CUtlSymbolLarge
                constexpr std::ptrdiff_t m_flTimeoutInterval = 0x7A0; // float32
                constexpr std::ptrdiff_t m_bAsynchronouslySpawnEntities = 0x7A4; // bool
                constexpr std::ptrdiff_t m_clientOnlyEntityBehavior = 0x7A8; // PointTemplateClientOnlyEntityBehavior_t
                constexpr std::ptrdiff_t m_ownerSpawnGroupType = 0x7AC; // PointTemplateOwnerSpawnGroupType_t
                constexpr std::ptrdiff_t m_createdSpawnGroupHandles = 0x7B0; // CUtlVector<uint32>
                constexpr std::ptrdiff_t m_SpawnedEntityHandles = 0x7C8; // CUtlVector<CEntityHandle>
                constexpr std::ptrdiff_t m_ScriptSpawnCallback = 0x7E0; // HSCRIPT
                constexpr std::ptrdiff_t m_ScriptCallbackScope = 0x7E8; // HSCRIPT
                constexpr std::ptrdiff_t m_OnEntitySpawned = 0x7F0; // CEntityOutputTemplate<CUtlVector<CEntityHandle>>
            }
            // Parent: CBaseEntity
            // Fields count: 36
            namespace CEnvVolumetricFogController {
                constexpr std::ptrdiff_t m_flScattering = 0x788; // float32
                constexpr std::ptrdiff_t m_TintColor = 0x78C; // Color
                constexpr std::ptrdiff_t m_flAnisotropy = 0x790; // float32
                constexpr std::ptrdiff_t m_flFadeSpeed = 0x794; // float32
                constexpr std::ptrdiff_t m_flDrawDistance = 0x798; // float32
                constexpr std::ptrdiff_t m_flFadeInStart = 0x79C; // float32
                constexpr std::ptrdiff_t m_flFadeInEnd = 0x7A0; // float32
                constexpr std::ptrdiff_t m_flIndirectStrength = 0x7A4; // float32
                constexpr std::ptrdiff_t m_nVolumeDepth = 0x7A8; // int32
                constexpr std::ptrdiff_t m_fFirstVolumeSliceThickness = 0x7AC; // float32
                constexpr std::ptrdiff_t m_nIndirectTextureDimX = 0x7B0; // int32
                constexpr std::ptrdiff_t m_nIndirectTextureDimY = 0x7B4; // int32
                constexpr std::ptrdiff_t m_nIndirectTextureDimZ = 0x7B8; // int32
                constexpr std::ptrdiff_t m_vBoxMins = 0x7BC; // Vector
                constexpr std::ptrdiff_t m_vBoxMaxs = 0x7C8; // Vector
                constexpr std::ptrdiff_t m_bActive = 0x7D4; // bool
                constexpr std::ptrdiff_t m_flStartAnisoTime = 0x7D8; // GameTime_t
                constexpr std::ptrdiff_t m_flStartScatterTime = 0x7DC; // GameTime_t
                constexpr std::ptrdiff_t m_flStartDrawDistanceTime = 0x7E0; // GameTime_t
                constexpr std::ptrdiff_t m_flStartAnisotropy = 0x7E4; // float32
                constexpr std::ptrdiff_t m_flStartScattering = 0x7E8; // float32
                constexpr std::ptrdiff_t m_flStartDrawDistance = 0x7EC; // float32
                constexpr std::ptrdiff_t m_flDefaultAnisotropy = 0x7F0; // float32
                constexpr std::ptrdiff_t m_flDefaultScattering = 0x7F4; // float32
                constexpr std::ptrdiff_t m_flDefaultDrawDistance = 0x7F8; // float32
                constexpr std::ptrdiff_t m_bStartDisabled = 0x7FC; // bool
                constexpr std::ptrdiff_t m_bEnableIndirect = 0x7FD; // bool
                constexpr std::ptrdiff_t m_bIsMaster = 0x7FE; // bool
                constexpr std::ptrdiff_t m_hFogIndirectTexture = 0x800; // CStrongHandle<InfoForResourceTypeCTextureBase>
                constexpr std::ptrdiff_t m_nForceRefreshCount = 0x808; // int32
                constexpr std::ptrdiff_t m_fNoiseSpeed = 0x80C; // float32
                constexpr std::ptrdiff_t m_fNoiseStrength = 0x810; // float32
                constexpr std::ptrdiff_t m_vNoiseScale = 0x814; // Vector
                constexpr std::ptrdiff_t m_fWindSpeed = 0x820; // float32
                constexpr std::ptrdiff_t m_vWindDirection = 0x824; // Vector
            ...
            namespace CPhysLength {
                constexpr std::ptrdiff_t m_offset = 0x7E8; // Vector[2]
                constexpr std::ptrdiff_t m_vecAttach = 0x800; // VectorWS
                constexpr std::ptrdiff_t m_addLength = 0x80C; // float32
                constexpr std::ptrdiff_t m_minLength = 0x810; // float32
                constexpr std::ptrdiff_t m_totalLength = 0x814; // float32
            }
            // Parent: CBaseEntity
            // Fields count: 4
            namespace CTeam {
                constexpr std::ptrdiff_t m_aPlayerControllers = 0x788; // CNetworkUtlVectorBase<CHandle<CBasePlayerController>>
                constexpr std::ptrdiff_t m_aPlayers = 0x7A0; // CNetworkUtlVectorBase<CHandle<CBasePlayerPawn>>
            ...
            namespace CLogicNPCCounterAABB {
                constexpr std::ptrdiff_t m_vDistanceOuterMins = 0xA08; // Vector
                constexpr std::ptrdiff_t m_vDistanceOuterMaxs = 0xA14; // Vector
                constexpr std::ptrdiff_t m_vOuterMins = 0xA20; // VectorWS
                constexpr std::ptrdiff_t m_vOuterMaxs = 0xA2C; // VectorWS
            }
            // Parent: None
            // Fields count: 1
            //
            ...
            // Fields count: 11
            namespace CEnvShake {
                constexpr std::ptrdiff_t m_limitToEntity = 0x788; // CUtlSymbolLarge
                constexpr std::ptrdiff_t m_Amplitude = 0x790; // float32
                constexpr std::ptrdiff_t m_Frequency = 0x794; // float32
                constexpr std::ptrdiff_t m_Duration = 0x798; // float32
                constexpr std::ptrdiff_t m_Radius = 0x79C; // float32
                constexpr std::ptrdiff_t m_stopTime = 0x7A0; // GameTime_t
                constexpr std::ptrdiff_t m_nextShake = 0x7A4; // GameTime_t
                constexpr std::ptrdiff_t m_currentAmp = 0x7A8; // float32
                constexpr std::ptrdiff_t m_maxForce = 0x7AC; // Vector
            ...
            namespace CSoundOpvarSetAutoRoomEntity {
                constexpr std::ptrdiff_t m_traceResults = 0x920; // CUtlVector<SoundOpvarTraceResult_t>
                constexpr std::ptrdiff_t m_doorwayPairs = 0x938; // CUtlVector<AutoRoomDoorwayPairs_t>
                constexpr std::ptrdiff_t m_flSize = 0x950; // float32
                constexpr std::ptrdiff_t m_flHeightTolerance = 0x954; // float32
            ...
            namespace CPhysicsEntitySolver {
                constexpr std::ptrdiff_t m_hMovingEntity = 0x7A0; // CHandle<CBaseEntity>
                constexpr std::ptrdiff_t m_hPhysicsBlocker = 0x7A4; // CHandle<CBaseEntity>
                constexpr std::ptrdiff_t m_separationDuration = 0x7A8; // float32
                constexpr std::ptrdiff_t m_cancelTime = 0x7AC; // GameTime_t
            }
            // Parent: CBaseEntity
            // Fields count: 7
            namespace CLogicCollisionPair {
                constexpr std::ptrdiff_t m_nameAttach1 = 0x788; // CUtlSymbolLarge
                constexpr std::ptrdiff_t m_nameAttach2 = 0x790; // CUtlSymbolLarge
                constexpr std::ptrdiff_t m_includeHierarchy = 0x798; // bool
                constexpr std::ptrdiff_t m_supportMultipleEntitiesWithSameName = 0x799; // bool
                constexpr std::ptrdiff_t m_disabled = 0x79A; // bool
                constexpr std::ptrdiff_t m_succeeded = 0x79B; // bool
                constexpr std::ptrdiff_t m_allowMissing = 0x79C; // bool
            }
            // Parent: None
            // Fields count: 5
            namespace CTestEffect {
                constexpr std::ptrdiff_t m_iLoop = 0x788; // int32
                constexpr std::ptrdiff_t m_iBeam = 0x78C; // int32
                constexpr std::ptrdiff_t m_pBeam = 0x790; // CHandle<CBeam>[24]
                constexpr std::ptrdiff_t m_flBeamTime = 0x7F0; // GameTime_t[24]
                constexpr std::ptrdiff_t m_flStartTime = 0x850; // GameTime_t
            }
            // Parent: None
            // Fields count: 1
            //
            ...
            namespace CMathRemap {
                constexpr std::ptrdiff_t m_flInMin = 0x788; // float32
                constexpr std::ptrdiff_t m_flInMax = 0x78C; // float32
                constexpr std::ptrdiff_t m_flOut1 = 0x790; // float32
                constexpr std::ptrdiff_t m_flOut2 = 0x794; // float32
                constexpr std::ptrdiff_t m_flOldInValue = 0x798; // float32
                constexpr std::ptrdiff_t m_bEnabled = 0x79C; // bool
                constexpr std::ptrdiff_t m_OutValue = 0x7A0; // CEntityOutputTemplate<float32>
                constexpr std::ptrdiff_t m_OnRoseAboveMin = 0x7C0; // CEntityIOOutput
            ...
            namespace CSoundOpvarSetOBBWindEntity {
                constexpr std::ptrdiff_t m_vMins = 0x830; // Vector
                constexpr std::ptrdiff_t m_vMaxs = 0x83C; // Vector
                constexpr std::ptrdiff_t m_vDistanceMins = 0x848; // Vector
                constexpr std::ptrdiff_t m_vDistanceMaxs = 0x854; // Vector
                constexpr std::ptrdiff_t m_flWindMin = 0x860; // float32
                constexpr std::ptrdiff_t m_flWindMax = 0x864; // float32
                constexpr std::ptrdiff_t m_flWindMapMin = 0x868; // float32
                constexpr std::ptrdiff_t m_flWindMapMax = 0x86C; // float32
            }
            // Parent: None
            // Fields count: 3
            //
            ...
            namespace CCSGO_TeamPreviewCharacterPosition {
                ...
                constexpr std::ptrdiff_t m_nOrdinal = 0x790; // int32
            ...
            namespace CMessage {
                ...
                constexpr std::ptrdiff_t m_MessageVolume = 0x790; // float32
                constexpr std::ptrdiff_t m_MessageAttenuation = 0x794; // int32
                constexpr std::ptrdiff_t m_Radius = 0x798; // float32
                constexpr std::ptrdiff_t m_sNoise = 0x7A0; // CGameSoundEventName
                constexpr std::ptrdiff_t m_OnShowMessage = 0x7A8; // CEntityIOOutput
            }
            // Parent: CPointEntity
            // Fields count: 6
            namespace CPointVelocitySensor {
                constexpr std::ptrdiff_t m_hTargetEntity = 0x788; // CHandle<CBaseEntity>
                constexpr std::ptrdiff_t m_vecAxis = 0x78C; // Vector
                constexpr std::ptrdiff_t m_bEnabled = 0x798; // bool
                constexpr std::ptrdiff_t m_fPrevVelocity = 0x79C; // float32
                constexpr std::ptrdiff_t m_flAvgInterval = 0x7A0; // float32
                constexpr std::ptrdiff_t m_Velocity = 0x7A8; // CEntityOutputTemplate<float32>
            }
            // Parent: None
            // Fields count: 28
            //
            ...
            // Fields count: 5
            namespace CEnvSpark {
                constexpr std::ptrdiff_t m_flDelay = 0x788; // float32
                constexpr std::ptrdiff_t m_nMagnitude = 0x78C; // int32
                constexpr std::ptrdiff_t m_nTrailLength = 0x790; // int32
            ...
            namespace CPointOrient {
                constexpr std::ptrdiff_t m_iszSpawnTargetName = 0x788; // CUtlSymbolLarge
                constexpr std::ptrdiff_t m_hTarget = 0x790; // CHandle<CBaseEntity>
                constexpr std::ptrdiff_t m_bActive = 0x794; // bool
                constexpr std::ptrdiff_t m_nGoalDirection = 0x798; // PointOrientGoalDirectionType_t
                constexpr std::ptrdiff_t m_nConstraint = 0x79C; // PointOrientConstraint_t
                constexpr std::ptrdiff_t m_flMaxTurnRate = 0x7A0; // float32
                constexpr std::ptrdiff_t m_flLastGameTime = 0x7A4; // GameTime_t
            }
            // Parent: None
            // Fields count: 6
            //
            ...
            namespace CCSPlayerController_ActionTrackingServices {
                ...
                constexpr std::ptrdiff_t m_matchStats = 0xD0; // CSMatchStats_t
            ...
            namespace CBodyComponentBaseAnimGraph {
                constexpr std::ptrdiff_t m_animationController = 0x4F0; // CBaseAnimGraphController
            }
            // Parent: None
            // Fields count: 2
            //
            ...
            namespace CTimerEntity {
                constexpr std::ptrdiff_t m_OnTimer = 0x788; // CEntityIOOutput
                constexpr std::ptrdiff_t m_OnTimerHigh = 0x7A0; // CEntityIOOutput
                constexpr std::ptrdiff_t m_OnTimerLow = 0x7B8; // CEntityIOOutput
                constexpr std::ptrdiff_t m_iDisabled = 0x7D0; // int32
                constexpr std::ptrdiff_t m_flInitialDelay = 0x7D4; // float32
                constexpr std::ptrdiff_t m_flRefireTime = 0x7D8; // float32
                constexpr std::ptrdiff_t m_bUpDownState = 0x7DC; // bool
                constexpr std::ptrdiff_t m_iUseRandomTime = 0x7E0; // int32
                constexpr std::ptrdiff_t m_bPauseAfterFiring = 0x7E4; // bool
                constexpr std::ptrdiff_t m_flLowerRandomBound = 0x7E8; // float32
                constexpr std::ptrdiff_t m_flUpperRandomBound = 0x7EC; // float32
                constexpr std::ptrdiff_t m_flRemainingTime = 0x7F0; // float32
                constexpr std::ptrdiff_t m_bPaused = 0x7F4; // bool
            }
            // Parent: None
            // Fields count: 14
            ...
            namespace CSMatchStats_t {
                ...
                constexpr std::ptrdiff_t m_flHealthPointsRemovedTotal = 0x90; // float32
                constexpr std::ptrdiff_t m_flHealthPointsDealtTotal = 0x94; // float32
            ...
            namespace CInfoVisibilityBox {
                constexpr std::ptrdiff_t m_nMode = 0x78C; // int32
                constexpr std::ptrdiff_t m_vBoxSize = 0x790; // Vector
                constexpr std::ptrdiff_t m_bEnabled = 0x79C; // bool
            }
            // Parent: CBaseToggle
            // Fields count: 4
            ...
            namespace CSoundEventConeEntity {
                constexpr std::ptrdiff_t m_flEmitterAngle = 0x844; // float32
                constexpr std::ptrdiff_t m_flSweetSpotAngle = 0x848; // float32
                constexpr std::ptrdiff_t m_flAttenMin = 0x84C; // float32
                constexpr std::ptrdiff_t m_flAttenMax = 0x850; // float32
                constexpr std::ptrdiff_t m_iszParameterName = 0x858; // CUtlSymbolLarge
            }
            // Parent: None
            // Fields count: 0
            ...
            namespace CSoundOpvarSetPathCornerEntity {
                constexpr std::ptrdiff_t m_bUseParentedPath = 0x938; // bool
                constexpr std::ptrdiff_t m_flDistMinSqr = 0x93C; // float32
                constexpr std::ptrdiff_t m_flDistMaxSqr = 0x940; // float32
                constexpr std::ptrdiff_t m_iszPathCornerEntityName = 0x948; // CUtlSymbolLarge
            }
            // Parent: CPointEntity
            // Fields count: 0
            ...
            namespace CModelState {
                ...
                constexpr std::ptrdiff_t m_nBodyGroupChoices = 0x248; // CNetworkUtlVectorBase<int32>
                constexpr std::ptrdiff_t m_nIdealMotionType = 0x292; // int8
                constexpr std::ptrdiff_t m_nForceLOD = 0x293; // int8
            ...
            namespace CLogicActiveAutosave {
                constexpr std::ptrdiff_t m_TriggerHitPoints = 0x794; // int32
                constexpr std::ptrdiff_t m_flTimeToTrigger = 0x798; // float32
                constexpr std::ptrdiff_t m_flStartTime = 0x79C; // GameTime_t
                constexpr std::ptrdiff_t m_flDangerousTime = 0x7A0; // float32
            }
            // Parent: CBaseEntity
            // Fields count: 11
            namespace CMathCounter {
                constexpr std::ptrdiff_t m_flMin = 0x788; // float32
                constexpr std::ptrdiff_t m_flMax = 0x78C; // float32
                constexpr std::ptrdiff_t m_bHitMin = 0x790; // bool
                constexpr std::ptrdiff_t m_bHitMax = 0x791; // bool
                constexpr std::ptrdiff_t m_bDisabled = 0x792; // bool
                constexpr std::ptrdiff_t m_OutValue = 0x798; // CEntityOutputTemplate<float32>
                constexpr std::ptrdiff_t m_OnGetValue = 0x7B8; // CEntityOutputTemplate<float32>
                constexpr std::ptrdiff_t m_OnHitMin = 0x7D8; // CEntityIOOutput
            ...
            namespace CEnvVolumetricFogVolume {
                ...
                constexpr std::ptrdiff_t m_bIndirectUseLPVs = 0x7A5; // bool
                constexpr std::ptrdiff_t m_flStrength = 0x7A8; // float32
                constexpr std::ptrdiff_t m_nFalloffShape = 0x7AC; // int32
                constexpr std::ptrdiff_t m_flFalloffExponent = 0x7B0; // float32
                constexpr std::ptrdiff_t m_flHeightFogDepth = 0x7B4; // float32
                constexpr std::ptrdiff_t m_fHeightFogEdgeWidth = 0x7B8; // float32
                constexpr std::ptrdiff_t m_fIndirectLightStrength = 0x7BC; // float32
                constexpr std::ptrdiff_t m_fSunLightStrength = 0x7C0; // float32
                constexpr std::ptrdiff_t m_fNoiseStrength = 0x7C4; // float32
                constexpr std::ptrdiff_t m_TintColor = 0x7C8; // Color
                constexpr std::ptrdiff_t m_bOverrideTintColor = 0x7CC; // bool
                constexpr std::ptrdiff_t m_bOverrideIndirectLightStrength = 0x7CD; // bool
                constexpr std::ptrdiff_t m_bOverrideSunLightStrength = 0x7CE; // bool
                constexpr std::ptrdiff_t m_bOverrideNoiseStrength = 0x7CF; // bool
            }
            // Parent: None
            // Fields count: 0
            ...
            namespace CPointValueRemapper {
                constexpr std::ptrdiff_t m_bDisabled = 0x788; // bool
                constexpr std::ptrdiff_t m_bUpdateOnClient = 0x789; // bool
                constexpr std::ptrdiff_t m_nInputType = 0x78C; // ValueRemapperInputType_t
                constexpr std::ptrdiff_t m_iszRemapLineStartName = 0x790; // CUtlSymbolLarge
                constexpr std::ptrdiff_t m_iszRemapLineEndName = 0x798; // CUtlSymbolLarge
                constexpr std::ptrdiff_t m_hRemapLineStart = 0x7A0; // CHandle<CBaseEntity>
                constexpr std::ptrdiff_t m_hRemapLineEnd = 0x7A4; // CHandle<CBaseEntity>
                constexpr std::ptrdiff_t m_flMaximumChangePerSecond = 0x7A8; // float32
                constexpr std::ptrdiff_t m_flDisengageDistance = 0x7AC; // float32
                constexpr std::ptrdiff_t m_flEngageDistance = 0x7B0; // float32
                constexpr std::ptrdiff_t m_bRequiresUseKey = 0x7B4; // bool
                constexpr std::ptrdiff_t m_nOutputType = 0x7B8; // ValueRemapperOutputType_t
                constexpr std::ptrdiff_t m_iszOutputEntityName = 0x7C0; // CUtlSymbolLarge
                constexpr std::ptrdiff_t m_iszOutputEntity2Name = 0x7C8; // CUtlSymbolLarge
                constexpr std::ptrdiff_t m_iszOutputEntity3Name = 0x7D0; // CUtlSymbolLarge
                constexpr std::ptrdiff_t m_iszOutputEntity4Name = 0x7D8; // CUtlSymbolLarge
                constexpr std::ptrdiff_t m_hOutputEntities = 0x7E0; // CNetworkUtlVectorBase<CHandle<CBaseEntity>>
                constexpr std::ptrdiff_t m_nHapticsType = 0x7F8; // ValueRemapperHapticsType_t
                constexpr std::ptrdiff_t m_nMomentumType = 0x7FC; // ValueRemapperMomentumType_t
                constexpr std::ptrdiff_t m_flMomentumModifier = 0x800; // float32
                constexpr std::ptrdiff_t m_flSnapValue = 0x804; // float32
                constexpr std::ptrdiff_t m_flCurrentMomentum = 0x808; // float32
                constexpr std::ptrdiff_t m_nRatchetType = 0x80C; // ValueRemapperRatchetType_t
                constexpr std::ptrdiff_t m_flRatchetOffset = 0x810; // float32
                constexpr std::ptrdiff_t m_flInputOffset = 0x814; // float32
                constexpr std::ptrdiff_t m_bEngaged = 0x818; // bool
                constexpr std::ptrdiff_t m_bFirstUpdate = 0x819; // bool
                constexpr std::ptrdiff_t m_flPreviousValue = 0x81C; // float32
                constexpr std::ptrdiff_t m_flPreviousUpdateTickTime = 0x820; // GameTime_t
                constexpr std::ptrdiff_t m_vecPreviousTestPoint = 0x824; // VectorWS
                constexpr std::ptrdiff_t m_hUsingPlayer = 0x830; // CHandle<CBasePlayerPawn>
                constexpr std::ptrdiff_t m_flCustomOutputValue = 0x834; // float32
                constexpr std::ptrdiff_t m_iszSoundEngage = 0x838; // CUtlSymbolLarge
                constexpr std::ptrdiff_t m_iszSoundDisengage = 0x840; // CUtlSymbolLarge
                constexpr std::ptrdiff_t m_iszSoundReachedValueZero = 0x848; // CUtlSymbolLarge
                constexpr std::ptrdiff_t m_iszSoundReachedValueOne = 0x850; // CUtlSymbolLarge
                constexpr std::ptrdiff_t m_iszSoundMovingLoop = 0x858; // CUtlSymbolLarge
                constexpr std::ptrdiff_t m_Position = 0x878; // CEntityOutputTemplate<float32>
                constexpr std::ptrdiff_t m_PositionDelta = 0x898; // CEntityOutputTemplate<float32>
                constexpr std::ptrdiff_t m_OnReachedValueZero = 0x8B8; // CEntityIOOutput
                constexpr std::ptrdiff_t m_OnReachedValueOne = 0x8D0; // CEntityIOOutput
                constexpr std::ptrdiff_t m_OnReachedValueCustom = 0x8E8; // CEntityIOOutput
                constexpr std::ptrdiff_t m_OnEngage = 0x900; // CEntityIOOutput
                constexpr std::ptrdiff_t m_OnDisengage = 0x918; // CEntityIOOutput
            }
            // Parent: None
            // Fields count: 3
            ...
            namespace CAI_ChangeHintGroup {
                constexpr std::ptrdiff_t m_iSearchType = 0x788; // int32
                constexpr std::ptrdiff_t m_strSearchName = 0x790; // CUtlSymbolLarge
            ...
            namespace CPhysHinge {
                constexpr std::ptrdiff_t m_soundInfo = 0x7F0; // ConstraintSoundInfo
                constexpr std::ptrdiff_t m_NotifyMinLimitReached = 0x888; // CEntityIOOutput
                constexpr std::ptrdiff_t m_NotifyMaxLimitReached = 0x8A0; // CEntityIOOutput
                constexpr std::ptrdiff_t m_bAtMinLimit = 0x8B8; // bool
                constexpr std::ptrdiff_t m_bAtMaxLimit = 0x8B9; // bool
                constexpr std::ptrdiff_t m_hinge = 0x8BC; // constraint_hingeparams_t
                constexpr std::ptrdiff_t m_hingeFriction = 0x8FC; // float32
                constexpr std::ptrdiff_t m_systemLoadScale = 0x900; // float32
                constexpr std::ptrdiff_t m_bIsAxisLocal = 0x904; // bool
                constexpr std::ptrdiff_t m_flMinRotation = 0x908; // float32
                constexpr std::ptrdiff_t m_flMaxRotation = 0x90C; // float32
                constexpr std::ptrdiff_t m_flInitialRotation = 0x910; // float32
                constexpr std::ptrdiff_t m_flMotorFrequency = 0x914; // float32
                constexpr std::ptrdiff_t m_flMotorDampingRatio = 0x918; // float32
                constexpr std::ptrdiff_t m_flAngleSpeed = 0x91C; // float32
                constexpr std::ptrdiff_t m_flAngleSpeedThreshold = 0x920; // float32
                constexpr std::ptrdiff_t m_flLimitsDebugVisRotation = 0x924; // float32
                constexpr std::ptrdiff_t m_OnStartMoving = 0x928; // CEntityIOOutput
                constexpr std::ptrdiff_t m_OnStopMoving = 0x940; // CEntityIOOutput
            }
            // Parent: CBaseTrigger
            // Fields count: 1
            namespace CBuyZone {
            ...
            namespace CInfoChoreoAnchor {
                constexpr std::ptrdiff_t m_vecTargetEntries = 0x788; // CUtlVector<CInfoChoreoAnchorPosition>
                constexpr std::ptrdiff_t m_vecTargetWarps = 0x7A0; // CUtlVector<CInfoChoreoAnchorPosition>
            }
            // Parent: None
            // Fields count: 0
            ...
            namespace CInfoWorldLayer {
                constexpr std::ptrdiff_t m_pOutputOnEntitiesSpawned = 0x788; // CEntityIOOutput
                constexpr std::ptrdiff_t m_worldName = 0x7A0; // CUtlSymbolLarge
                constexpr std::ptrdiff_t m_layerName = 0x7A8; // CUtlSymbolLarge
                constexpr std::ptrdiff_t m_bWorldLayerVisible = 0x7B0; // bool
                constexpr std::ptrdiff_t m_bEntitiesSpawned = 0x7B1; // bool
            ...
            namespace FilterDamageType {
                constexpr std::ptrdiff_t m_iDamageType = 0x7C0; // int32
            }
            // Parent: CBaseEntity
            // Fields count: 26
            namespace CPointCamera {
                ...
                constexpr std::ptrdiff_t m_bUseScreenAspectRatio = 0x7A5; // bool
                constexpr std::ptrdiff_t m_flAspectRatio = 0x7A8; // float32
                constexpr std::ptrdiff_t m_bNoSky = 0x7AC; // bool
                constexpr std::ptrdiff_t m_fBrightness = 0x7B0; // float32
                constexpr std::ptrdiff_t m_flZFar = 0x7B4; // float32
                constexpr std::ptrdiff_t m_flZNear = 0x7B8; // float32
                constexpr std::ptrdiff_t m_bCanHLTVUse = 0x7BC; // bool
                constexpr std::ptrdiff_t m_bAlignWithParent = 0x7BD; // bool
                constexpr std::ptrdiff_t m_bDofEnabled = 0x7BE; // bool
                constexpr std::ptrdiff_t m_flDofNearBlurry = 0x7C0; // float32
                constexpr std::ptrdiff_t m_flDofNearCrisp = 0x7C4; // float32
                constexpr std::ptrdiff_t m_flDofFarCrisp = 0x7C8; // float32
                constexpr std::ptrdiff_t m_flDofFarBlurry = 0x7CC; // float32
                constexpr std::ptrdiff_t m_flDofTiltToGround = 0x7D0; // float32
                constexpr std::ptrdiff_t m_TargetFOV = 0x7D4; // float32
            ...
            namespace CCSGameRules {
                ...
                constexpr std::ptrdiff_t m_hPlayerResource = 0x1130; // CHandle<CBaseEntity>
                constexpr std::ptrdiff_t m_RetakeRules = 0x1138; // CRetakeGameRules
                constexpr std::ptrdiff_t m_arrTeamUniqueKillWeaponsMatch = 0x1328; // CUtlVector<int32>[4]
                constexpr std::ptrdiff_t m_bTeamLastKillUsedUniqueWeaponMatch = 0x1388; // bool[4]
                constexpr std::ptrdiff_t m_nMatchEndCount = 0x13B0; // uint8
                constexpr std::ptrdiff_t m_nTTeamIntroVariant = 0x13B4; // int32
                constexpr std::ptrdiff_t m_nCTTeamIntroVariant = 0x13B8; // int32
                constexpr std::ptrdiff_t m_bTeamIntroPeriod = 0x13BC; // bool
                constexpr std::ptrdiff_t m_fTeamIntroPeriodEnd = 0x13C0; // GameTime_t
                constexpr std::ptrdiff_t m_bPlayedTeamIntroVO = 0x13C4; // bool
                constexpr std::ptrdiff_t m_iRoundEndWinnerTeam = 0x13C8; // int32
                constexpr std::ptrdiff_t m_eRoundEndReason = 0x13CC; // int32
                constexpr std::ptrdiff_t m_bRoundEndShowTimerDefend = 0x13D0; // bool
                constexpr std::ptrdiff_t m_iRoundEndTimerTime = 0x13D4; // int32
                constexpr std::ptrdiff_t m_sRoundEndFunFactToken = 0x13D8; // CUtlString
                constexpr std::ptrdiff_t m_iRoundEndFunFactPlayerSlot = 0x13E0; // CPlayerSlot
                constexpr std::ptrdiff_t m_iRoundEndFunFactData1 = 0x13E4; // int32
                constexpr std::ptrdiff_t m_iRoundEndFunFactData2 = 0x13E8; // int32
                constexpr std::ptrdiff_t m_iRoundEndFunFactData3 = 0x13EC; // int32
                constexpr std::ptrdiff_t m_sRoundEndMessage = 0x13F0; // CUtlString
                constexpr std::ptrdiff_t m_iRoundEndPlayerCount = 0x13F8; // int32
                constexpr std::ptrdiff_t m_bRoundEndNoMusic = 0x13FC; // bool
                constexpr std::ptrdiff_t m_iRoundEndLegacy = 0x1400; // int32
                constexpr std::ptrdiff_t m_nRoundEndCount = 0x1404; // uint8
                constexpr std::ptrdiff_t m_iRoundStartRoundNumber = 0x1408; // int32
                constexpr std::ptrdiff_t m_nRoundStartCount = 0x140C; // uint8
            ...
            namespace CPhysConstraint {
                constexpr std::ptrdiff_t m_hJoint = 0x788; // IPhysicsJoint*
                constexpr std::ptrdiff_t m_nameAttach1 = 0x790; // CUtlSymbolLarge
                constexpr std::ptrdiff_t m_nameAttach2 = 0x798; // CUtlSymbolLarge
                constexpr std::ptrdiff_t m_hAttach1 = 0x7A0; // CHandle<CBaseEntity>
                constexpr std::ptrdiff_t m_hAttach2 = 0x7A4; // CHandle<CBaseEntity>
                constexpr std::ptrdiff_t m_nameAttachment1 = 0x7A8; // CUtlSymbolLarge
                constexpr std::ptrdiff_t m_nameAttachment2 = 0x7B0; // CUtlSymbolLarge
                constexpr std::ptrdiff_t m_breakSound = 0x7B8; // CGameSoundEventName
                constexpr std::ptrdiff_t m_forceLimit = 0x7C0; // float32
                constexpr std::ptrdiff_t m_torqueLimit = 0x7C4; // float32
                constexpr std::ptrdiff_t m_minTeleportDistance = 0x7C8; // float32
                constexpr std::ptrdiff_t m_bSnapObjectPositions = 0x7CC; // bool
                constexpr std::ptrdiff_t m_bTreatEntity1AsInfiniteMass = 0x7CD; // bool
                constexpr std::ptrdiff_t m_OnBreak = 0x7D0; // CEntityIOOutput
            }
            // Parent: CBaseEntity
            // Fields count: 3
            namespace CLogicAchievement {
                constexpr std::ptrdiff_t m_bDisabled = 0x788; // bool
                constexpr std::ptrdiff_t m_iszAchievementEventID = 0x790; // CUtlSymbolLarge
                constexpr std::ptrdiff_t m_OnFired = 0x798; // CEntityIOOutput
            }
            // Parent: None
            // Fields count: 3
            ...
            namespace CLogicLineToEntity {
                constexpr std::ptrdiff_t m_Line = 0x788; // CEntityOutputTemplate<Vector>
                constexpr std::ptrdiff_t m_SourceName = 0x7B0; // CUtlSymbolLarge
                constexpr std::ptrdiff_t m_StartEntity = 0x7B8; // CHandle<CBaseEntity>
                constexpr std::ptrdiff_t m_EndEntity = 0x7BC; // CHandle<CBaseEntity>
            }
            ...
            namespace CInfoSpawnGroupLoadUnload {
                constexpr std::ptrdiff_t m_OnSpawnGroupLoadStarted = 0x788; // CEntityIOOutput
                constexpr std::ptrdiff_t m_OnSpawnGroupLoadFinished = 0x7A0; // CEntityIOOutput
                constexpr std::ptrdiff_t m_OnSpawnGroupUnloadStarted = 0x7B8; // CEntityIOOutput
                constexpr std::ptrdiff_t m_OnSpawnGroupUnloadFinished = 0x7D0; // CEntityIOOutput
                constexpr std::ptrdiff_t m_iszSpawnGroupName = 0x7E8; // CUtlSymbolLarge
                constexpr std::ptrdiff_t m_iszSpawnGroupFilterName = 0x7F0; // CUtlSymbolLarge
                constexpr std::ptrdiff_t m_iszLandmarkName = 0x7F8; // CUtlSymbolLarge
                constexpr std::ptrdiff_t m_sFixedSpawnGroupName = 0x800; // CUtlString
                constexpr std::ptrdiff_t m_flTimeoutInterval = 0x808; // float32
                constexpr std::ptrdiff_t m_bAutoActivate = 0x80C; // bool
                constexpr std::ptrdiff_t m_bUnloadingStarted = 0x80D; // bool
                constexpr std::ptrdiff_t m_bQueueActiveSpawnGroupChange = 0x80E; // bool
                constexpr std::ptrdiff_t m_bQueueFinishLoading = 0x80F; // bool
            }
            // Parent: CSoundAreaEntityBase
            // Fields count: 2
            ...
            namespace CBaseModelEntity {
                ...
                constexpr std::ptrdiff_t m_pChoreoComponent = 0x7A8; // CChoreoComponent*
                constexpr std::ptrdiff_t m_nDestructiblePartInitialStateDestructed0 = 0x7B0; // HitGroup_t
                constexpr std::ptrdiff_t m_nDestructiblePartInitialStateDestructed1 = 0x7B4; // HitGroup_t
                constexpr std::ptrdiff_t m_nDestructiblePartInitialStateDestructed2 = 0x7B8; // HitGroup_t
                constexpr std::ptrdiff_t m_nDestructiblePartInitialStateDestructed3 = 0x7BC; // HitGroup_t
                constexpr std::ptrdiff_t m_nDestructiblePartInitialStateDestructed4 = 0x7C0; // HitGroup_t
                constexpr std::ptrdiff_t m_nDestructiblePartInitialStateDestructed0_PartIndex = 0x7C4; // int32
                constexpr std::ptrdiff_t m_nDestructiblePartInitialStateDestructed1_PartIndex = 0x7C8; // int32
                constexpr std::ptrdiff_t m_nDestructiblePartInitialStateDestructed2_PartIndex = 0x7CC; // int32
                constexpr std::ptrdiff_t m_nDestructiblePartInitialStateDestructed3_PartIndex = 0x7D0; // int32
                constexpr std::ptrdiff_t m_nDestructiblePartInitialStateDestructed4_PartIndex = 0x7D4; // int32
                constexpr std::ptrdiff_t m_bDestructiblePartInitialStateDestructed0_GenerateBreakpieces = 0x7D8; // bool
                constexpr std::ptrdiff_t m_bDestructiblePartInitialStateDestructed1_GenerateBreakpieces = 0x7D9; // bool
                constexpr std::ptrdiff_t m_bDestructiblePartInitialStateDestructed2_GenerateBreakpieces = 0x7DA; // bool
                constexpr std::ptrdiff_t m_bDestructiblePartInitialStateDestructed3_GenerateBreakpieces = 0x7DB; // bool
                constexpr std::ptrdiff_t m_bDestructiblePartInitialStateDestructed4_GenerateBreakpieces = 0x7DC; // bool
                constexpr std::ptrdiff_t m_pDestructiblePartsSystemComponent = 0x7E0; // CDestructiblePartsComponent*
                constexpr std::ptrdiff_t m_OnDestructibleHitGroupDamageLevelChanged = 0x7E8; // CEntityOutputTemplate<CBaseModelEntity::OnDamageLevelChangedArgs_t>
                constexpr std::ptrdiff_t m_flDissolveStartTime = 0x810; // GameTime_t
                constexpr std::ptrdiff_t m_OnIgnite = 0x818; // CEntityIOOutput
                constexpr std::ptrdiff_t m_nRenderMode = 0x830; // RenderMode_t
                constexpr std::ptrdiff_t m_nRenderFX = 0x831; // RenderFx_t
                constexpr std::ptrdiff_t m_bAllowFadeInView = 0x832; // bool
                ...
                constexpr std::ptrdiff_t m_fadeMinDist = 0x9DC; // float32
                constexpr std::ptrdiff_t m_fadeMaxDist = 0x9E0; // float32
            ...
            namespace CCitadelSoundOpvarSetOBB {
                constexpr std::ptrdiff_t m_iszStackName = 0x788; // CUtlSymbolLarge
                constexpr std::ptrdiff_t m_iszOperatorName = 0x790; // CUtlSymbolLarge
                constexpr std::ptrdiff_t m_iszOpvarName = 0x798; // CUtlSymbolLarge
                constexpr std::ptrdiff_t m_vDistanceInnerMins = 0x7A0; // Vector
                constexpr std::ptrdiff_t m_vDistanceInnerMaxs = 0x7AC; // Vector
                constexpr std::ptrdiff_t m_vDistanceOuterMins = 0x7B8; // Vector
                constexpr std::ptrdiff_t m_vDistanceOuterMaxs = 0x7C4; // Vector
                constexpr std::ptrdiff_t m_nAABBDirection = 0x7D0; // int32
            }
            // Parent: CBaseEntity
            // Fields count: 2
            ...
            namespace CEnvViewPunch {
                constexpr std::ptrdiff_t m_flRadius = 0x788; // float32
                constexpr std::ptrdiff_t m_angViewPunch = 0x78C; // QAngle
            }
            // Parent: None
            // Fields count: 15
            ...
            namespace CVoteController {
                ...
                constexpr std::ptrdiff_t m_iOnlyTeamToVote = 0x78C; // int32
                constexpr std::ptrdiff_t m_nVoteOptionCount = 0x790; // int32[5]
                constexpr std::ptrdiff_t m_nPotentialVotes = 0x7A4; // int32
                constexpr std::ptrdiff_t m_bIsYesNoVote = 0x7A8; // bool
                constexpr std::ptrdiff_t m_acceptingVotesTimer = 0x7B0; // CountdownTimer
                constexpr std::ptrdiff_t m_executeCommandTimer = 0x7C8; // CountdownTimer
                constexpr std::ptrdiff_t m_resetVoteTimer = 0x7E0; // CountdownTimer
                constexpr std::ptrdiff_t m_nVotesCast = 0x7F8; // int32[64]
                constexpr std::ptrdiff_t m_playerHoldingVote = 0x8F8; // CPlayerSlot
                constexpr std::ptrdiff_t m_playerOverrideForVote = 0x8FC; // CPlayerSlot
                constexpr std::ptrdiff_t m_nHighestCountIndex = 0x900; // int32
                constexpr std::ptrdiff_t m_potentialIssues = 0x908; // CUtlVector<CBaseIssue*>
            ...
            namespace CBaseEntity {
                ...
                constexpr std::ptrdiff_t m_think = 0x540; // BASEPTR
                ...
                constexpr std::ptrdiff_t m_pfnTouch = 0x570; // ENTITYFUNCPTR
                constexpr std::ptrdiff_t m_pfnUse = 0x580; // USEPTR
                constexpr std::ptrdiff_t m_pfnBlocked = 0x590; // ENTITYFUNCPTR
                constexpr std::ptrdiff_t m_pfnMoveDone = 0x5A0; // BASEPTR
                ...
                constexpr std::ptrdiff_t m_nPreviouslySetMoveType = 0x5D4; // MoveType_t
                constexpr std::ptrdiff_t m_nActualMoveType = 0x5D5; // MoveType_t
                constexpr std::ptrdiff_t m_nWaterTouch = 0x5D6; // uint8
                constexpr std::ptrdiff_t m_nSlimeTouch = 0x5D7; // uint8
                constexpr std::ptrdiff_t m_bRestoreInHierarchy = 0x5D8; // bool
                constexpr std::ptrdiff_t m_target = 0x5E0; // CUtlSymbolLarge
                constexpr std::ptrdiff_t m_hDamageFilter = 0x5E8; // CHandle<CBaseFilter>
                constexpr std::ptrdiff_t m_iszDamageFilterName = 0x5F0; // CUtlSymbolLarge
                constexpr std::ptrdiff_t m_flMoveDoneTime = 0x5F8; // float32
                constexpr std::ptrdiff_t m_nSubclassID = 0x5FC; // CUtlStringToken
                constexpr std::ptrdiff_t m_flAnimTime = 0x608; // float32
                constexpr std::ptrdiff_t m_flSimulationTime = 0x60C; // float32
                constexpr std::ptrdiff_t m_flCreateTime = 0x610; // GameTime_t
                constexpr std::ptrdiff_t m_bClientSideRagdoll = 0x614; // bool
                constexpr std::ptrdiff_t m_ubInterpolationFrame = 0x615; // uint8
                constexpr std::ptrdiff_t m_vPrevVPhysicsUpdatePos = 0x618; // VectorWS
                constexpr std::ptrdiff_t m_iTeamNum = 0x624; // uint8
                constexpr std::ptrdiff_t m_iGlobalname = 0x628; // CUtlSymbolLarge
                constexpr std::ptrdiff_t m_iSentToClients = 0x630; // int32
                constexpr std::ptrdiff_t m_sUniqueHammerID = 0x638; // CUtlString
                constexpr std::ptrdiff_t m_spawnflags = 0x640; // uint32
                constexpr std::ptrdiff_t m_nNextThinkTick = 0x644; // GameTick_t
                constexpr std::ptrdiff_t m_nSimulationTick = 0x648; // int32
                constexpr std::ptrdiff_t m_OnKilled = 0x650; // CEntityIOOutput
                constexpr std::ptrdiff_t m_fFlags = 0x668; // uint32
                constexpr std::ptrdiff_t m_vecAbsVelocity = 0x66C; // Vector
                constexpr std::ptrdiff_t m_vecVelocity = 0x678; // CNetworkVelocityVector
                constexpr std::ptrdiff_t m_vecBaseVelocity = 0x6A8; // Vector
                constexpr std::ptrdiff_t m_nPushEnumCount = 0x6B4; // int32
                constexpr std::ptrdiff_t m_pCollision = 0x6B8; // CCollisionProperty*
                constexpr std::ptrdiff_t m_hEffectEntity = 0x6C0; // CHandle<CBaseEntity>
                constexpr std::ptrdiff_t m_hOwnerEntity = 0x6C4; // CHandle<CBaseEntity>
                constexpr std::ptrdiff_t m_fEffects = 0x6C8; // uint32
                constexpr std::ptrdiff_t m_hGroundEntity = 0x6CC; // CHandle<CBaseEntity>
                constexpr std::ptrdiff_t m_nGroundBodyIndex = 0x6D0; // int32
                constexpr std::ptrdiff_t m_flFriction = 0x6D4; // float32
                constexpr std::ptrdiff_t m_flElasticity = 0x6D8; // float32
                constexpr std::ptrdiff_t m_flGravityScale = 0x6DC; // float32
                constexpr std::ptrdiff_t m_flTimeScale = 0x6E0; // float32
                constexpr std::ptrdiff_t m_flWaterLevel = 0x6E4; // float32
                constexpr std::ptrdiff_t m_bGravityDisabled = 0x6E8; // bool
                constexpr std::ptrdiff_t m_bAnimatedEveryTick = 0x6E9; // bool
                constexpr std::ptrdiff_t m_flActualGravityScale = 0x6EC; // float32
                constexpr std::ptrdiff_t m_bGravityActuallyDisabled = 0x6F0; // bool
                ...
                constexpr std::ptrdiff_t m_OnUser2 = 0x710; // CEntityIOOutput
                constexpr std::ptrdiff_t m_OnUser3 = 0x728; // CEntityIOOutput
                constexpr std::ptrdiff_t m_OnUser4 = 0x740; // CEntityIOOutput
                constexpr std::ptrdiff_t m_iInitialTeamNum = 0x758; // int32
                constexpr std::ptrdiff_t m_flNavIgnoreUntilTime = 0x75C; // GameTime_t
                constexpr std::ptrdiff_t m_vecAngVelocity = 0x760; // QAngle
                constexpr std::ptrdiff_t m_bNetworkQuantizeOriginAndAngles = 0x76C; // bool
                constexpr std::ptrdiff_t m_bLagCompensate = 0x76D; // bool
                constexpr std::ptrdiff_t m_pBlocker = 0x770; // CHandle<CBaseEntity>
                constexpr std::ptrdiff_t m_flLocalTime = 0x774; // float32
                constexpr std::ptrdiff_t m_flVPhysicsUpdateLocalTime = 0x778; // float32
            ...
            namespace CRagdollMagnet {
                constexpr std::ptrdiff_t m_bDisabled = 0x788; // bool
                constexpr std::ptrdiff_t m_radius = 0x78C; // float32
                constexpr std::ptrdiff_t m_force = 0x790; // float32
                constexpr std::ptrdiff_t m_axis = 0x794; // VectorWS
            }
            // Parent: None
            // Fields count: 0
            ...
            namespace CPointAngleSensor {
                constexpr std::ptrdiff_t m_bDisabled = 0x788; // bool
                constexpr std::ptrdiff_t m_nLookAtName = 0x790; // CUtlSymbolLarge
                constexpr std::ptrdiff_t m_hTargetEntity = 0x798; // CHandle<CBaseEntity>
                constexpr std::ptrdiff_t m_hLookAtEntity = 0x79C; // CHandle<CBaseEntity>
                constexpr std::ptrdiff_t m_flDuration = 0x7A0; // float32
                constexpr std::ptrdiff_t m_flDotTolerance = 0x7A4; // float32
                constexpr std::ptrdiff_t m_flFacingTime = 0x7A8; // GameTime_t
                constexpr std::ptrdiff_t m_bFired = 0x7AC; // bool
                constexpr std::ptrdiff_t m_OnFacingLookat = 0x7B0; // CEntityIOOutput
            ...
            namespace CGenericConstraint {
                constexpr std::ptrdiff_t m_bPlaceAnchorsAtConstraintTransform = 0x7F0; // bool
                constexpr std::ptrdiff_t m_nLinearMotionX = 0x7F4; // JointMotion_t
                constexpr std::ptrdiff_t m_nLinearMotionY = 0x7F8; // JointMotion_t
                constexpr std::ptrdiff_t m_nLinearMotionZ = 0x7FC; // JointMotion_t
                constexpr std::ptrdiff_t m_flLinearFrequencyX = 0x800; // float32
                constexpr std::ptrdiff_t m_flLinearFrequencyY = 0x804; // float32
                constexpr std::ptrdiff_t m_flLinearFrequencyZ = 0x808; // float32
                constexpr std::ptrdiff_t m_flLinearDampingRatioX = 0x80C; // float32
                constexpr std::ptrdiff_t m_flLinearDampingRatioY = 0x810; // float32
                constexpr std::ptrdiff_t m_flLinearDampingRatioZ = 0x814; // float32
                constexpr std::ptrdiff_t m_flMaxLinearImpulseX = 0x818; // float32
                constexpr std::ptrdiff_t m_flMaxLinearImpulseY = 0x81C; // float32
                constexpr std::ptrdiff_t m_flMaxLinearImpulseZ = 0x820; // float32
                constexpr std::ptrdiff_t m_flBreakAfterTimeX = 0x824; // float32
                constexpr std::ptrdiff_t m_flBreakAfterTimeY = 0x828; // float32
                constexpr std::ptrdiff_t m_flBreakAfterTimeZ = 0x82C; // float32
                constexpr std::ptrdiff_t m_flBreakAfterTimeStartTimeX = 0x830; // GameTime_t
                constexpr std::ptrdiff_t m_flBreakAfterTimeStartTimeY = 0x834; // GameTime_t
                constexpr std::ptrdiff_t m_flBreakAfterTimeStartTimeZ = 0x838; // GameTime_t
                constexpr std::ptrdiff_t m_flBreakAfterTimeThresholdX = 0x83C; // float32
                constexpr std::ptrdiff_t m_flBreakAfterTimeThresholdY = 0x840; // float32
                constexpr std::ptrdiff_t m_flBreakAfterTimeThresholdZ = 0x844; // float32
                constexpr std::ptrdiff_t m_flNotifyForceX = 0x848; // float32
                constexpr std::ptrdiff_t m_flNotifyForceY = 0x84C; // float32
                constexpr std::ptrdiff_t m_flNotifyForceZ = 0x850; // float32
                constexpr std::ptrdiff_t m_flNotifyForceMinTimeX = 0x854; // float32
                constexpr std::ptrdiff_t m_flNotifyForceMinTimeY = 0x858; // float32
                constexpr std::ptrdiff_t m_flNotifyForceMinTimeZ = 0x85C; // float32
                constexpr std::ptrdiff_t m_flNotifyForceLastTimeX = 0x860; // GameTime_t
                constexpr std::ptrdiff_t m_flNotifyForceLastTimeY = 0x864; // GameTime_t
                constexpr std::ptrdiff_t m_flNotifyForceLastTimeZ = 0x868; // GameTime_t
                constexpr std::ptrdiff_t m_bAxisNotifiedX = 0x86C; // bool
                constexpr std::ptrdiff_t m_bAxisNotifiedY = 0x86D; // bool
                constexpr std::ptrdiff_t m_bAxisNotifiedZ = 0x86E; // bool
                constexpr std::ptrdiff_t m_nAngularMotionX = 0x870; // JointMotion_t
                constexpr std::ptrdiff_t m_nAngularMotionY = 0x874; // JointMotion_t
                constexpr std::ptrdiff_t m_nAngularMotionZ = 0x878; // JointMotion_t
                constexpr std::ptrdiff_t m_flAngularFrequencyX = 0x87C; // float32
                constexpr std::ptrdiff_t m_flAngularFrequencyY = 0x880; // float32
                constexpr std::ptrdiff_t m_flAngularFrequencyZ = 0x884; // float32
                constexpr std::ptrdiff_t m_flAngularDampingRatioX = 0x888; // float32
                constexpr std::ptrdiff_t m_flAngularDampingRatioY = 0x88C; // float32
                constexpr std::ptrdiff_t m_flAngularDampingRatioZ = 0x890; // float32
                constexpr std::ptrdiff_t m_flMaxAngularImpulseX = 0x894; // float32
                constexpr std::ptrdiff_t m_flMaxAngularImpulseY = 0x898; // float32
                constexpr std::ptrdiff_t m_flMaxAngularImpulseZ = 0x89C; // float32
                constexpr std::ptrdiff_t m_NotifyForceReachedX = 0x8A0; // CEntityIOOutput
                constexpr std::ptrdiff_t m_NotifyForceReachedY = 0x8B8; // CEntityIOOutput
                constexpr std::ptrdiff_t m_NotifyForceReachedZ = 0x8D0; // CEntityIOOutput
            }
            // Parent: None
            // Fields count: 1
            //
            ...
            namespace CSoundOpvarSetEntity {
                constexpr std::ptrdiff_t m_iszStackName = 0x7A0; // CUtlSymbolLarge
                constexpr std::ptrdiff_t m_iszOperatorName = 0x7A8; // CUtlSymbolLarge
                constexpr std::ptrdiff_t m_iszOpvarName = 0x7B0; // CUtlSymbolLarge
                constexpr std::ptrdiff_t m_nOpvarType = 0x7B8; // int32
                constexpr std::ptrdiff_t m_nOpvarIndex = 0x7BC; // int32
                constexpr std::ptrdiff_t m_flOpvarValue = 0x7C0; // float32
                constexpr std::ptrdiff_t m_OpvarValueString = 0x7C8; // CUtlSymbolLarge
                constexpr std::ptrdiff_t m_bSetOnSpawn = 0x7D0; // bool
            }
            // Parent: CBaseEntity
            // Fields count: 2
            namespace CEnvBeverage {
                constexpr std::ptrdiff_t m_CanInDispenser = 0x788; // bool
                constexpr std::ptrdiff_t m_nBeverageType = 0x78C; // int32
            }
            // Parent: CBaseEntity
            // Fields count: 15
            namespace CPhysMotor {
                constexpr std::ptrdiff_t m_nameAttach = 0x788; // CUtlSymbolLarge
                constexpr std::ptrdiff_t m_nameAnchor = 0x790; // CUtlSymbolLarge
                constexpr std::ptrdiff_t m_hAttachedObject = 0x798; // CHandle<CBaseEntity>
                constexpr std::ptrdiff_t m_hAnchorObject = 0x79C; // CHandle<CBaseEntity>
                constexpr std::ptrdiff_t m_spinUp = 0x7A0; // float32
                constexpr std::ptrdiff_t m_spinDown = 0x7A4; // float32
                constexpr std::ptrdiff_t m_flMotorFriction = 0x7A8; // float32
                constexpr std::ptrdiff_t m_additionalAcceleration = 0x7AC; // float32
                constexpr std::ptrdiff_t m_angularAcceleration = 0x7B0; // float32
                constexpr std::ptrdiff_t m_flTorqueScale = 0x7B4; // float32
                constexpr std::ptrdiff_t m_flTargetSpeed = 0x7B8; // float32
                constexpr std::ptrdiff_t m_flSpeedWhenSpinUpOrSpinDownStarted = 0x7BC; // float32
                constexpr std::ptrdiff_t m_pFixedWorldBody = 0x7C0; // IPhysicsBody*
                constexpr std::ptrdiff_t m_pMotorJoint = 0x7C8; // IPhysicsJoint*
                constexpr std::ptrdiff_t m_motor = 0x7D0; // CMotorController
            }
            // Parent: CBaseEntity
            // Fields count: 1
            ...
            namespace CSplineConstraint {
                constexpr std::ptrdiff_t m_vAnchorOffsetRestore = 0x838; // Vector
                constexpr std::ptrdiff_t m_hSplineEntity = 0x844; // CHandle<CBaseEntity>
                constexpr std::ptrdiff_t m_pSplineBody = 0x848; // IPhysicsBody*
                constexpr std::ptrdiff_t m_bEnableLateralConstraint = 0x850; // bool
                constexpr std::ptrdiff_t m_bEnableVerticalConstraint = 0x851; // bool
                constexpr std::ptrdiff_t m_bEnableAngularConstraint = 0x852; // bool
                constexpr std::ptrdiff_t m_bEnableLimit = 0x853; // bool
                constexpr std::ptrdiff_t m_bFireEventsOnPath = 0x854; // bool
                constexpr std::ptrdiff_t m_flLinearFrequency = 0x858; // float32
                constexpr std::ptrdiff_t m_flLinarDampingRatio = 0x85C; // float32
                constexpr std::ptrdiff_t m_flJointFriction = 0x860; // float32
                constexpr std::ptrdiff_t m_flTransitionTime = 0x864; // float32
                constexpr std::ptrdiff_t m_vPreSolveAnchorPos = 0x880; // VectorWS
                constexpr std::ptrdiff_t m_StartTransitionTime = 0x88C; // GameTime_t
                constexpr std::ptrdiff_t m_vTangentSpaceAnchorAtTransitionStart = 0x890; // Vector
            }
            // Parent: CBaseEntity
            // Fields count: 6
            namespace CLogicCompare {
                constexpr std::ptrdiff_t m_flInValue = 0x788; // float32
                constexpr std::ptrdiff_t m_flCompareValue = 0x78C; // float32
                constexpr std::ptrdiff_t m_OnLessThan = 0x790; // CEntityOutputTemplate<float32>
                constexpr std::ptrdiff_t m_OnEqualTo = 0x7B0; // CEntityOutputTemplate<float32>
            ...
            namespace CMapVetoPickController {
                constexpr std::ptrdiff_t m_bPlayedIntroVcd = 0x788; // bool
                constexpr std::ptrdiff_t m_bNeedToPlayFiveSecondsRemaining = 0x789; // bool
                constexpr std::ptrdiff_t m_dblPreMatchDraftSequenceTime = 0x7A8; // float64
                constexpr std::ptrdiff_t m_bPreMatchDraftStateChanged = 0x7B0; // bool
                constexpr std::ptrdiff_t m_nDraftType = 0x7B4; // int32
                constexpr std::ptrdiff_t m_nTeamWinningCoinToss = 0x7B8; // int32
                constexpr std::ptrdiff_t m_nTeamWithFirstChoice = 0x7BC; // int32[64]
                constexpr std::ptrdiff_t m_nVoteMapIdsList = 0x8BC; // int32[7]
                constexpr std::ptrdiff_t m_nAccountIDs = 0x8D8; // int32[64]
                constexpr std::ptrdiff_t m_nMapId0 = 0x9D8; // int32[64]
                constexpr std::ptrdiff_t m_nMapId1 = 0xAD8; // int32[64]
                constexpr std::ptrdiff_t m_nMapId2 = 0xBD8; // int32[64]
                constexpr std::ptrdiff_t m_nMapId3 = 0xCD8; // int32[64]
                constexpr std::ptrdiff_t m_nMapId4 = 0xDD8; // int32[64]
                constexpr std::ptrdiff_t m_nMapId5 = 0xED8; // int32[64]
                constexpr std::ptrdiff_t m_nStartingSide0 = 0xFD8; // int32[64]
                constexpr std::ptrdiff_t m_nCurrentPhase = 0x10D8; // int32
                constexpr std::ptrdiff_t m_nPhaseStartTick = 0x10DC; // int32
                constexpr std::ptrdiff_t m_nPhaseDurationTicks = 0x10E0; // int32
                constexpr std::ptrdiff_t m_OnMapVetoed = 0x10E8; // CEntityOutputTemplate<CUtlSymbolLarge>
                constexpr std::ptrdiff_t m_OnMapPicked = 0x1108; // CEntityOutputTemplate<CUtlSymbolLarge>
                constexpr std::ptrdiff_t m_OnSidesPicked = 0x1128; // CEntityOutputTemplate<int32>
            ...
            namespace CPhysSlideConstraint {
                constexpr std::ptrdiff_t m_axisEnd = 0x7F0; // VectorWS
                constexpr std::ptrdiff_t m_slideFriction = 0x7FC; // float32
                constexpr std::ptrdiff_t m_systemLoadScale = 0x800; // float32
                constexpr std::ptrdiff_t m_initialOffset = 0x804; // float32
                constexpr std::ptrdiff_t m_bEnableLinearConstraint = 0x808; // bool
                constexpr std::ptrdiff_t m_bEnableAngularConstraint = 0x809; // bool
                constexpr std::ptrdiff_t m_flMotorFrequency = 0x80C; // float32
                constexpr std::ptrdiff_t m_flMotorDampingRatio = 0x810; // float32
                constexpr std::ptrdiff_t m_bUseEntityPivot = 0x814; // bool
                constexpr std::ptrdiff_t m_soundInfo = 0x818; // ConstraintSoundInfo
            }
            // Parent: CBaseEntity
            // Fields count: 2
            ...
            namespace CPointGamestatsCounter {
                constexpr std::ptrdiff_t m_strStatisticName = 0x788; // CUtlSymbolLarge
            ...
            namespace CPhysFixed {
                constexpr std::ptrdiff_t m_flLinearFrequency = 0x7E8; // float32
                constexpr std::ptrdiff_t m_flLinearDampingRatio = 0x7EC; // float32
                constexpr std::ptrdiff_t m_flAngularFrequency = 0x7F0; // float32
                constexpr std::ptrdiff_t m_flAngularDampingRatio = 0x7F4; // float32
                constexpr std::ptrdiff_t m_bEnableLinearConstraint = 0x7F8; // bool
                constexpr std::ptrdiff_t m_bEnableAngularConstraint = 0x7F9; // bool
                constexpr std::ptrdiff_t m_sBoneName1 = 0x800; // CUtlSymbolLarge
                constexpr std::ptrdiff_t m_sBoneName2 = 0x808; // CUtlSymbolLarge
            }
            // Parent: CBaseEntity
            // Fields count: 2
            namespace CLogicNavigation {
                constexpr std::ptrdiff_t m_isOn = 0x790; // bool
                constexpr std::ptrdiff_t m_navProperty = 0x794; // navproperties_t
            }
            // Parent: CBaseEntity
            // Fields count: 3
            ...
            namespace CPhysBallSocket {
                constexpr std::ptrdiff_t m_flJointFriction = 0x7E8; // float32
                constexpr std::ptrdiff_t m_bEnableSwingLimit = 0x7EC; // bool
                constexpr std::ptrdiff_t m_flSwingLimit = 0x7F0; // float32
                constexpr std::ptrdiff_t m_bEnableTwistLimit = 0x7F4; // bool
                constexpr std::ptrdiff_t m_flMinTwistAngle = 0x7F8; // float32
                constexpr std::ptrdiff_t m_flMaxTwistAngle = 0x7FC; // float32
            }
            // Parent: None
            // Fields count: 1
            namespace CDebugHistory {
                constexpr std::ptrdiff_t m_nNpcEvents = 0x3E87C8; // int32
            }
            // Parent: CBaseEntity
            // Fields count: 11
            namespace CSoundOpvarSetPointBase {
                constexpr std::ptrdiff_t m_bDisabled = 0x788; // bool
                constexpr std::ptrdiff_t m_hSource = 0x78C; // CEntityHandle
                constexpr std::ptrdiff_t m_iszSourceEntityName = 0x7A8; // CUtlSymbolLarge
                constexpr std::ptrdiff_t m_vLastPosition = 0x800; // VectorWS
                constexpr std::ptrdiff_t m_flRefreshTime = 0x80C; // float32
                constexpr std::ptrdiff_t m_iszStackName = 0x810; // CUtlSymbolLarge
                constexpr std::ptrdiff_t m_iszOperatorName = 0x818; // CUtlSymbolLarge
                constexpr std::ptrdiff_t m_iszOpvarName = 0x820; // CUtlSymbolLarge
                constexpr std::ptrdiff_t m_iOpvarIndex = 0x828; // int32
                constexpr std::ptrdiff_t m_bUseAutoCompare = 0x82C; // bool
                constexpr std::ptrdiff_t m_bFastRefresh = 0x82D; // bool
            }
            // Parent: None
            // Fields count: 5
            //
            ...
            namespace CPathKeyFrame {
                constexpr std::ptrdiff_t m_Origin = 0x788; // Vector
                constexpr std::ptrdiff_t m_Angles = 0x794; // QAngle
                constexpr std::ptrdiff_t m_qAngle = 0x7A0; // Quaternion
                constexpr std::ptrdiff_t m_iNextKey = 0x7B0; // CUtlSymbolLarge
                constexpr std::ptrdiff_t m_flNextTime = 0x7B8; // float32
                constexpr std::ptrdiff_t m_pNextKey = 0x7BC; // CHandle<CPathKeyFrame>
                constexpr std::ptrdiff_t m_pPrevKey = 0x7C0; // CHandle<CPathKeyFrame>
            ...
            // Fields count: 4
            namespace CBlood {
                constexpr std::ptrdiff_t m_vecSprayAngles = 0x788; // QAngle
                constexpr std::ptrdiff_t m_vecSprayDir = 0x794; // Vector
            ...
            namespace CCSTeam {
                ...
                constexpr std::ptrdiff_t m_nShorthandedRoundBonusStartRound = 0x844; // int32
                constexpr std::ptrdiff_t m_bSurrendered = 0x848; // bool
                constexpr std::ptrdiff_t m_szTeamMatchStat = 0x849; // char[512]
                constexpr std::ptrdiff_t m_numMapVictories = 0xA4C; // int32
                constexpr std::ptrdiff_t m_scoreFirstHalf = 0xA50; // int32
                constexpr std::ptrdiff_t m_scoreSecondHalf = 0xA54; // int32
                constexpr std::ptrdiff_t m_scoreOvertime = 0xA58; // int32
                constexpr std::ptrdiff_t m_szClanTeamname = 0xA5C; // char[129]
                constexpr std::ptrdiff_t m_iClanID = 0xAE0; // uint32
                constexpr std::ptrdiff_t m_szTeamFlagImage = 0xAE4; // char[8]
                constexpr std::ptrdiff_t m_szTeamLogoImage = 0xAEC; // char[8]
                constexpr std::ptrdiff_t m_flNextResourceTime = 0xAF4; // float32
                constexpr std::ptrdiff_t m_iLastUpdateSentAt = 0xAF8; // int32
            }
            // Parent: CRuleEntity
            // Fields count: 1
            ...
            namespace CEnvCubemapFog {
                constexpr std::ptrdiff_t m_flEndDistance = 0x788; // float32
                constexpr std::ptrdiff_t m_flStartDistance = 0x78C; // float32
                constexpr std::ptrdiff_t m_flFogFalloffExponent = 0x790; // float32
                constexpr std::ptrdiff_t m_bHeightFogEnabled = 0x794; // bool
                constexpr std::ptrdiff_t m_flFogHeightWidth = 0x798; // float32
                constexpr std::ptrdiff_t m_flFogHeightEnd = 0x79C; // float32
                constexpr std::ptrdiff_t m_flFogHeightStart = 0x7A0; // float32
                constexpr std::ptrdiff_t m_flFogHeightExponent = 0x7A4; // float32
                constexpr std::ptrdiff_t m_flLODBias = 0x7A8; // float32
                constexpr std::ptrdiff_t m_bActive = 0x7AC; // bool
                constexpr std::ptrdiff_t m_bStartDisabled = 0x7AD; // bool
                constexpr std::ptrdiff_t m_flFogMaxOpacity = 0x7B0; // float32
                constexpr std::ptrdiff_t m_nCubemapSourceType = 0x7B4; // int32
                constexpr std::ptrdiff_t m_hSkyMaterial = 0x7B8; // CStrongHandle<InfoForResourceTypeIMaterial2>
                constexpr std::ptrdiff_t m_iszSkyEntity = 0x7C0; // CUtlSymbolLarge
                constexpr std::ptrdiff_t m_nHeightFogType = 0x7C8; // int32
                constexpr std::ptrdiff_t m_nFogHeightBlendMode = 0x7CC; // int32
                constexpr std::ptrdiff_t m_nFogHeightCoordinateSpace = 0x7D0; // int32
                constexpr std::ptrdiff_t m_nDistanceFogType = 0x7D4; // int32
                constexpr std::ptrdiff_t m_DistanceFogCurveString = 0x7D8; // CUtlSymbolLarge
                constexpr std::ptrdiff_t m_HeightFogCurveString = 0x7E0; // CUtlSymbolLarge
                constexpr std::ptrdiff_t m_hFogCubemapTexture = 0x878; // CStrongHandle<InfoForResourceTypeCTextureBase>
                constexpr std::ptrdiff_t m_bHasHeightFogEnd = 0x880; // bool
            ...
            namespace CSceneListManager {
                constexpr std::ptrdiff_t m_hListManagers = 0x788; // CUtlVector<CHandle<CSceneListManager>>
                constexpr std::ptrdiff_t m_iszScenes = 0x7A0; // CUtlSymbolLarge[16]
                constexpr std::ptrdiff_t m_hScenes = 0x820; // CHandle<CBaseEntity>[16]
            }
            // Parent: CPointEntity
            // Fields count: 4
            namespace CEnvTilt {
                constexpr std::ptrdiff_t m_Duration = 0x788; // float32
                constexpr std::ptrdiff_t m_Radius = 0x78C; // float32
                constexpr std::ptrdiff_t m_TiltTime = 0x790; // float32
                constexpr std::ptrdiff_t m_stopTime = 0x794; // GameTime_t
            }
            // Parent: None
            // Fields count: 0
            ...
            namespace CPhysWheelConstraint {
                constexpr std::ptrdiff_t m_flSuspensionFrequency = 0x7E8; // float32
                constexpr std::ptrdiff_t m_flSuspensionDampingRatio = 0x7EC; // float32
                constexpr std::ptrdiff_t m_flSuspensionHeightOffset = 0x7F0; // float32
                constexpr std::ptrdiff_t m_bEnableSuspensionLimit = 0x7F4; // bool
                constexpr std::ptrdiff_t m_flMinSuspensionOffset = 0x7F8; // float32
                constexpr std::ptrdiff_t m_flMaxSuspensionOffset = 0x7FC; // float32
                constexpr std::ptrdiff_t m_bEnableSteeringLimit = 0x800; // bool
                constexpr std::ptrdiff_t m_flMinSteeringAngle = 0x804; // float32
                constexpr std::ptrdiff_t m_flMaxSteeringAngle = 0x808; // float32
                constexpr std::ptrdiff_t m_flSteeringAxisFriction = 0x80C; // float32
                constexpr std::ptrdiff_t m_flSpinAxisFriction = 0x810; // float32
                constexpr std::ptrdiff_t m_hSteeringMimicsEntity = 0x814; // CHandle<CBaseEntity>
            }
            // Parent: CBaseEntity
            // Fields count: 2
            namespace CSkyboxReference {
                constexpr std::ptrdiff_t m_worldGroupId = 0x788; // WorldGroupId_t
                constexpr std::ptrdiff_t m_hSkyCamera = 0x78C; // CHandle<CSkyCamera>
            }
            // Parent: None
            // Fields count: 0
            ...
            namespace CColorCorrection {
                constexpr std::ptrdiff_t m_flFadeInDuration = 0x788; // float32
                constexpr std::ptrdiff_t m_flFadeOutDuration = 0x78C; // float32
                constexpr std::ptrdiff_t m_flStartFadeInWeight = 0x790; // float32
                constexpr std::ptrdiff_t m_flStartFadeOutWeight = 0x794; // float32
                constexpr std::ptrdiff_t m_flTimeStartFadeIn = 0x798; // GameTime_t
                constexpr std::ptrdiff_t m_flTimeStartFadeOut = 0x79C; // GameTime_t
                constexpr std::ptrdiff_t m_flMaxWeight = 0x7A0; // float32
                constexpr std::ptrdiff_t m_bStartDisabled = 0x7A4; // bool
                constexpr std::ptrdiff_t m_bEnabled = 0x7A5; // bool
                constexpr std::ptrdiff_t m_bMaster = 0x7A6; // bool
                constexpr std::ptrdiff_t m_bClientSide = 0x7A7; // bool
                constexpr std::ptrdiff_t m_bExclusive = 0x7A8; // bool
                constexpr std::ptrdiff_t m_MinFalloff = 0x7AC; // float32
                constexpr std::ptrdiff_t m_MaxFalloff = 0x7B0; // float32
                constexpr std::ptrdiff_t m_flCurWeight = 0x7B4; // float32
                constexpr std::ptrdiff_t m_netlookupFilename = 0x7B8; // char[512]
                constexpr std::ptrdiff_t m_lookupFilename = 0x9B8; // CUtlSymbolLarge
            }
            ...
            namespace CBaseFilter {
                constexpr std::ptrdiff_t m_bNegated = 0x788; // bool
                constexpr std::ptrdiff_t m_OnPass = 0x790; // CEntityIOOutput
                constexpr std::ptrdiff_t m_OnFail = 0x7A8; // CEntityIOOutput
            }
            // Parent: None
            // Fields count: 1
            ...
            // Fields count: 15
            namespace CMapInfo {
                constexpr std::ptrdiff_t m_iBuyingStatus = 0x788; // int32
                constexpr std::ptrdiff_t m_flBombRadius = 0x78C; // float32
                constexpr std::ptrdiff_t m_iPetPopulation = 0x790; // int32
                constexpr std::ptrdiff_t m_bUseNormalSpawnsForDM = 0x794; // bool
                constexpr std::ptrdiff_t m_bDisableAutoGeneratedDMSpawns = 0x795; // bool
                constexpr std::ptrdiff_t m_flBotMaxVisionDistance = 0x798; // float32
                constexpr std::ptrdiff_t m_iHostageCount = 0x79C; // int32
                constexpr std::ptrdiff_t m_bFadePlayerVisibilityFarZ = 0x7A0; // bool
                constexpr std::ptrdiff_t m_bRainTraceToSkyEnabled = 0x7A1; // bool
                constexpr std::ptrdiff_t m_bGPUCullSkybox = 0x7A2; // bool
                constexpr std::ptrdiff_t m_flEnvRainStrength = 0x7A4; // float32
                constexpr std::ptrdiff_t m_flEnvPuddleRippleStrength = 0x7A8; // float32
                constexpr std::ptrdiff_t m_flEnvPuddleRippleDirection = 0x7AC; // float32
                constexpr std::ptrdiff_t m_flEnvWetnessCoverage = 0x7B0; // float32
                constexpr std::ptrdiff_t m_flEnvWetnessDryingAmount = 0x7B4; // float32
            }
            // Parent: CBaseEntity
            // Fields count: 16
            namespace CGradientFog {
                constexpr std::ptrdiff_t m_hGradientFogTexture = 0x788; // CStrongHandle<InfoForResourceTypeCTextureBase>
                constexpr std::ptrdiff_t m_flFogStartDistance = 0x790; // float32
                constexpr std::ptrdiff_t m_flFogEndDistance = 0x794; // float32
                constexpr std::ptrdiff_t m_bHeightFogEnabled = 0x798; // bool
                constexpr std::ptrdiff_t m_flFogStartHeight = 0x79C; // float32
                constexpr std::ptrdiff_t m_flFogEndHeight = 0x7A0; // float32
                constexpr std::ptrdiff_t m_flFarZ = 0x7A4; // float32
                constexpr std::ptrdiff_t m_flFogMaxOpacity = 0x7A8; // float32
                constexpr std::ptrdiff_t m_flFogFalloffExponent = 0x7AC; // float32
                constexpr std::ptrdiff_t m_flFogVerticalExponent = 0x7B0; // float32
                constexpr std::ptrdiff_t m_fogColor = 0x7B4; // Color
                constexpr std::ptrdiff_t m_flFogStrength = 0x7B8; // float32
                constexpr std::ptrdiff_t m_flFadeTime = 0x7BC; // float32
                constexpr std::ptrdiff_t m_bStartDisabled = 0x7C0; // bool
                constexpr std::ptrdiff_t m_bIsEnabled = 0x7C1; // bool
                constexpr std::ptrdiff_t m_bGradientFogNeedsTextures = 0x7C2; // bool
            }
            // Parent: None
            // Fields count: 0
            ...
            namespace CSoundEventEntity {
                constexpr std::ptrdiff_t m_bStartOnSpawn = 0x788; // bool
                constexpr std::ptrdiff_t m_bToLocalPlayer = 0x789; // bool
                constexpr std::ptrdiff_t m_bStopOnNew = 0x78A; // bool
                constexpr std::ptrdiff_t m_bSaveRestore = 0x78B; // bool
                constexpr std::ptrdiff_t m_bSavedIsPlaying = 0x78C; // bool
                constexpr std::ptrdiff_t m_flSavedElapsedTime = 0x790; // float32
                constexpr std::ptrdiff_t m_iszSourceEntityName = 0x798; // CUtlSymbolLarge
                constexpr std::ptrdiff_t m_iszAttachmentName = 0x7A0; // CUtlSymbolLarge
                constexpr std::ptrdiff_t m_onGUIDChanged = 0x7A8; // CEntityOutputTemplate<SndOpEventGuid_t>
                constexpr std::ptrdiff_t m_onSoundFinished = 0x7D8; // CEntityIOOutput
                constexpr std::ptrdiff_t m_flClientCullRadius = 0x7F0; // float32
                constexpr std::ptrdiff_t m_iszSoundName = 0x820; // CUtlSymbolLarge
            ...
            // Fields count: 4
            namespace CEnvFade {
                constexpr std::ptrdiff_t m_fadeColor = 0x788; // Color
                constexpr std::ptrdiff_t m_Duration = 0x78C; // float32
                constexpr std::ptrdiff_t m_HoldDuration = 0x790; // float32
                constexpr std::ptrdiff_t m_OnBeginFade = 0x798; // CEntityIOOutput
            }
            // Parent: None
            // Fields count: 15
            //
            ...
            namespace CLogicBranchList {
                constexpr std::ptrdiff_t m_nLogicBranchNames = 0x788; // CUtlSymbolLarge[16]
                constexpr std::ptrdiff_t m_LogicBranchList = 0x808; // CUtlVector<CHandle<CBaseEntity>>
                constexpr std::ptrdiff_t m_eLastState = 0x820; // CLogicBranchList::LogicBranchListenerLastState_t
                constexpr std::ptrdiff_t m_OnAllTrue = 0x828; // CEntityIOOutput
                constexpr std::ptrdiff_t m_OnAllFalse = 0x840; // CEntityIOOutput
                constexpr std::ptrdiff_t m_OnMixed = 0x858; // CEntityIOOutput
            }
            // Parent: None
            // Fields count: 1
            ...
            namespace CFuncTimescale {
                constexpr std::ptrdiff_t m_flDesiredTimescale = 0x788; // float32
                constexpr std::ptrdiff_t m_flAcceleration = 0x78C; // float32
            ...
            namespace CSoundOpvarSetPointEntity {
                constexpr std::ptrdiff_t m_OnEnter = 0x830; // CEntityIOOutput
                constexpr std::ptrdiff_t m_OnExit = 0x848; // CEntityIOOutput
                constexpr std::ptrdiff_t m_bAutoDisable = 0x860; // bool
                constexpr std::ptrdiff_t m_flDistanceMin = 0x8A4; // float32
                constexpr std::ptrdiff_t m_flDistanceMax = 0x8A8; // float32
                constexpr std::ptrdiff_t m_flDistanceMapMin = 0x8AC; // float32
                constexpr std::ptrdiff_t m_flDistanceMapMax = 0x8B0; // float32
                constexpr std::ptrdiff_t m_flOcclusionRadius = 0x8B4; // float32
                constexpr std::ptrdiff_t m_flOcclusionMin = 0x8B8; // float32
                constexpr std::ptrdiff_t m_flOcclusionMax = 0x8BC; // float32
                constexpr std::ptrdiff_t m_flValSetOnDisable = 0x8C0; // float32
                constexpr std::ptrdiff_t m_bSetValueOnDisable = 0x8C4; // bool
                constexpr std::ptrdiff_t m_bReloading = 0x8C5; // bool
                constexpr std::ptrdiff_t m_nSimulationMode = 0x8C8; // int32
                constexpr std::ptrdiff_t m_nVisibilitySamples = 0x8CC; // int32
                constexpr std::ptrdiff_t m_vDynamicProxyPoint = 0x8D0; // Vector
                constexpr std::ptrdiff_t m_flDynamicMaximumOcclusion = 0x8DC; // float32
                constexpr std::ptrdiff_t m_hDynamicEntity = 0x8E0; // CEntityHandle
                constexpr std::ptrdiff_t m_iszDynamicEntityName = 0x8E8; // CUtlSymbolLarge
                constexpr std::ptrdiff_t m_flPathingDistanceNormFactor = 0x8F0; // float32
                constexpr std::ptrdiff_t m_vPathingSourcePos = 0x8F4; // VectorWS
                constexpr std::ptrdiff_t m_vPathingListenerPos = 0x900; // VectorWS
                constexpr std::ptrdiff_t m_vPathingDirection = 0x90C; // Vector
            ...
            namespace CEnvCubemap {
                constexpr std::ptrdiff_t m_Entity_hCubemapTexture = 0x808; // CStrongHandle<InfoForResourceTypeCTextureBase>
                constexpr std::ptrdiff_t m_Entity_bCustomCubemapTexture = 0x810; // bool
                constexpr std::ptrdiff_t m_Entity_flInfluenceRadius = 0x814; // float32
                constexpr std::ptrdiff_t m_Entity_vBoxProjectMins = 0x818; // Vector
                constexpr std::ptrdiff_t m_Entity_vBoxProjectMaxs = 0x824; // Vector
                constexpr std::ptrdiff_t m_Entity_bMoveable = 0x830; // bool
                constexpr std::ptrdiff_t m_Entity_nHandshake = 0x834; // int32
                constexpr std::ptrdiff_t m_Entity_nEnvCubeMapArrayIndex = 0x838; // int32
                constexpr std::ptrdiff_t m_Entity_nPriority = 0x83C; // int32
                constexpr std::ptrdiff_t m_Entity_flEdgeFadeDist = 0x840; // float32
                constexpr std::ptrdiff_t m_Entity_vEdgeFadeDists = 0x844; // Vector
                constexpr std::ptrdiff_t m_Entity_flDiffuseScale = 0x850; // float32
                constexpr std::ptrdiff_t m_Entity_bStartDisabled = 0x854; // bool
                constexpr std::ptrdiff_t m_Entity_bDefaultEnvMap = 0x855; // bool
                constexpr std::ptrdiff_t m_Entity_bDefaultSpecEnvMap = 0x856; // bool
                constexpr std::ptrdiff_t m_Entity_bIndoorCubeMap = 0x857; // bool
            ...
            namespace CPointHurt {
                constexpr std::ptrdiff_t m_nDamage = 0x788; // int32
                constexpr std::ptrdiff_t m_bitsDamageType = 0x78C; // DamageTypes_t
                constexpr std::ptrdiff_t m_flRadius = 0x790; // float32
                constexpr std::ptrdiff_t m_flDelay = 0x794; // float32
            ...
            namespace CBasePlayerController {
                constexpr std::ptrdiff_t m_nInButtonsWhichAreToggles = 0x790; // uint64
            ...
            namespace CNmAimCSNode__CDefinition {
                ...
                constexpr std::ptrdiff_t m_nWeaponActionNodeIdx = 0x14; // int16
                constexpr std::ptrdiff_t m_nWeaponDropNodeIdx = 0x16; // int16
                constexpr std::ptrdiff_t m_nIsDefusingNodeIdx = 0x18; // int16
                constexpr std::ptrdiff_t m_nCrouchWeightNodeIdx = 0x1A; // int16
                constexpr std::ptrdiff_t m_flHandIKBlendInTimeSeconds = 0x1C; // float32
                constexpr std::ptrdiff_t m_flActionBlendTimeSeconds = 0x20; // float32
                constexpr std::ptrdiff_t m_flPlantingBlendTimeSeconds = 0x24; // float32
            }
            // Parent: None
            // Fields count: 4
            //
            ...
            namespace CNavPathCost {
                constexpr std::ptrdiff_t m_bAllowLadders = 0xC; // bool
                constexpr std::ptrdiff_t m_bCanFly = 0xD; // bool
                constexpr std::ptrdiff_t m_bCanSwim = 0xE; // bool
                constexpr std::ptrdiff_t m_flWaterToGroundMaxHeight = 0x10; // float32
                constexpr std::ptrdiff_t m_flGroundToWaterMaxHeight = 0x14; // float32
                constexpr std::ptrdiff_t m_flGroundToWaterTransitionDistance = 0x18; // float32
                constexpr std::ptrdiff_t m_flWaterToGroundTransitionDistance = 0x1C; // float32
                constexpr std::ptrdiff_t m_flFlyingTransitionTolerance = 0x20; // float32
                constexpr std::ptrdiff_t m_bOptimizeFlySpacePathfinds = 0x24; // bool
                constexpr std::ptrdiff_t m_bStringPullFlySpacePathfinds = 0x25; // bool
                constexpr std::ptrdiff_t m_bSupportsTransitions = 0x26; // bool
                constexpr std::ptrdiff_t m_flTransitionPenalty = 0x28; // float32
            }
            // Parent: None
            // Fields count: 3
            //
            ...
            namespace CNmSnapWeaponNode__CDefinition {
                constexpr std::ptrdiff_t m_nFlashedAmountNodeIdx = 0xC; // int16
                constexpr std::ptrdiff_t m_nWeaponCategoryNodeIdx = 0xE; // int16
                constexpr std::ptrdiff_t m_nWeaponTypeNodeIdx = 0x10; // int16
            }
            // Parent: None
            // Fields count: 3
            //
            ...
            namespace CNavVolumeBreadthFirstSearch {
                constexpr std::ptrdiff_t m_vStartPos = 0x88; // VectorWS
            ...
            namespace CCSPlayerAnimationState {
                constexpr std::ptrdiff_t m_currentMoveType = 0x10; // CCSPlayerAnimationState::MoveType_t
                constexpr std::ptrdiff_t m_groundMoveState = 0x11; // CCSPlayerAnimationState::GroundMoveState_t
                constexpr std::ptrdiff_t m_groundActionDirection = 0x12; // CCSPlayerAnimationState::Direction_t
                constexpr std::ptrdiff_t m_airAction = 0x13; // CCSPlayerAnimationState::AirAction_t
                constexpr std::ptrdiff_t m_bWasOnGroundLastUpdate = 0x14; // bool
                constexpr std::ptrdiff_t m_bWasStationaryLastUpdate = 0x15; // bool
                constexpr std::ptrdiff_t m_actionStartTick = 0x18; // GameTick_t
                constexpr std::ptrdiff_t m_staticAimTimerStartTick = 0x1C; // GameTick_t
                constexpr std::ptrdiff_t m_plantAndTurnStartTick = 0x20; // GameTick_t
                constexpr std::ptrdiff_t m_flTurnOnSpotAngle = 0x24; // float32
                constexpr std::ptrdiff_t m_flPreviousAimYaw = 0x28; // float32
                constexpr std::ptrdiff_t m_flPreviousHorizontalSpeed = 0x2C; // float32
                constexpr std::ptrdiff_t m_flFootIKOffsetLeft = 0x30; // float32
                constexpr std::ptrdiff_t m_flFootIKOffsetRight = 0x34; // float32
                constexpr std::ptrdiff_t m_flWeaponDropPercentageDueToMovement = 0x38; // float32
                constexpr std::ptrdiff_t m_flWeaponDropSmoothDampVelocity = 0x3C; // float32
            }
            // Parent: None
            // Fields count: 6
            //
            ...
            namespace CNavVolumeSphere {
                constexpr std::ptrdiff_t m_vCenter = 0x58; // VectorWS
